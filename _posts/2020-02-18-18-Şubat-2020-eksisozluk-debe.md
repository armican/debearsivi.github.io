...
- entry_name: |
    darbeyi kemalistler uşaklığını fetö pkk yapacak
  entry_id:  102211674
  entry_writer: excelsior was here
  entry_fav_count: 434
  entry_content: |
    "bu ülkede bu toplumun müslüman omurgasını oluşturan ve koruyan yegâne ve sarsılmaz kaynaklar olan cemaatler, tarikatlar aşağılanacağı kadar aşağılandı"<br/><br/>demiş. <br/><br/>kendisine atatürk'ün şu sözünü gönderiyor ve 3 siktirle uğurluyoruz: "efendiler ve ey millet, iyi biliniz ki, türkiye cumhuriyeti şeyhler, dervişler, müritler, mensuplar memleketi olamaz."<br/><br/>edit: meczup vs mensup konusunda sayısız mesaj alıyorum. arkadaşlar, doğrusu <a class="b" href="/?q=mensup">mensup</a>tur. internette ufak bir araştırma ile siz de bu bilgiye ulaşabilirsiniz. <br/><a rel="nofollow noopener" class="url" target="_blank" href="https://tr.wikisource.org/wiki/Atatürk%27ün_Kastamonu_Nutku" title="https://tr.wikisource.org/wiki/Atatürk%27ün_Kastamonu_Nutku">kaynak</a><br/>kaynak 2: (bkz: <a class="b" href="/entry/35479315">türkiye şeyhler dervişler memleketi olamaz/#35479315</a>)
...
- entry_name: |
    17 şubat 2020 hindistan'ın türkiye'ye nota vermesi
  entry_id:  102224847
  entry_writer: nordka
  entry_fav_count: 300
  entry_content: |
    texas'ın bağımsızlık isteğine de bir el atsak.
...
- entry_name: |
    imamoğlu'nu eleştiren kişiye yapılan baskı
  entry_id:  102229138
  entry_writer: pesimist adam
  entry_fav_count: 181
  entry_content: |
    şantaj öyle olmaz gülüm. uzlaşmacıya giden dosyada müşteki taraf taleplerini iletmiş olay bundan ibaret.<br/><br/>edit: başlık taşınmış şantaj yerine baskı denilmiş. küfür yerine eleştiri denilmiş. baskı değil talep. eleştiri değil küfür. bu ne cahilliktir ekşi yönetimi!
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 159
  entry_content: |
    evli bayanın sevgilisinde kalmasından daha normaldir.
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 142
  entry_content: |
    ya ali bi siktir git amına koyim.<br/>kaybettiğin her maçtan sonra seni mi dinleyeceğiz.<br/><br/>anası babası yok mu bunu haber verin gelip alsınlar.
...
- entry_name: |
  ...
  entry_fav_count: 134
  entry_content: |
    bu ülkede galericiler ve müteahhitler kazanamadığı zaman kriz olduğunu görüyor hükümet. çünkü çevreleri hep bu adamlarla dolu.
...
- entry_name: |
  ...
  entry_fav_count: 110
  entry_content: |
    cebinden vermemiştir. tüyü bitmemiş yetimin hakkını futbolcu müsveddelerine vermiştir. haram zıkkım olsun.
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    jennifer lopez vs shakira vs 100 bin dolar
  entry_id:  102233360
  entry_writer: franku
  entry_fav_count: 52
  entry_content: |
    bu da soru mu amk. 100 bin of course.
  entry_channels: anket,ilişkiler
- entry_name: |
    mustafa kapı
  entry_id:  102220120
...
- entry_name: |
  ...
  entry_id:  102201347
  entry_writer: pasarella
  entry_fav_count: 43
  entry_content: |
    bi kaç yol köprü felan yapıcam vatandaşın cebinden hiç para çıkmıycak
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 38
  entry_content: |
    lemina gustavo kapışması hayal ederken selçuk inan - tolga ciğerci savaşı görme rezaleti...<br/><br/>t: galatasaraylı topçu.
  entry_channels: spor
- entry_name: |
    ekşi itiraf
  entry_id:  102199241
...
- entry_name: |
  ...
  entry_fav_count: 26
  entry_content: |
    her zaman ki rutin akşam yemeği faslını bitirdikten sonra tv de bir film seyrediyordum. o esnada eniştem aradı. darbe oluyor dedi. enişte ciddi misin dedim, evet dedi. telefonu kapattım. biz bunların inlerine girmedik mi. nasıl oluyor bu böyle diye bir nara attım. hainler ne istediniz de vermedik ki dedim. kara kara düşünmeye başladım kimler sattı kimler arkamızda diye. önce hulusiyi aradım açmadı. çay bardağı dibi kadar bir ufak kaçırdım. orgeneraldi sonuçta. sonradan öğrendim ki rehin tutuluyormuş. binaliyi aradım. neyse ki açtı. hemen haber kanallarına telefon ile bağlanmasını istedim. binali bana ne yapacağımı sordu. bende ona “ onları kendi silahlarıyla, teknolojileriyle vuracağım” dedim. hemen cnn kanalını aradım ve facetime ile yayına bağlanmak istedim. hikayenin geri kalanını biliyorsunuz zaten
  entry_channels: anket,ekşi-sözlük,tarih
- entry_name: |
    16 şubat 2020 malatyaspor'un verilmeyen penaltısı
  entry_id:  102205670
  entry_writer: zahne86
  entry_fav_count: 24
  entry_content: |
    görmesek bizi sikecekler amnm. kafa mı biliyorsunuz taşak mı geçiyosunuz? net elle oynama var burda. gördüğümüz bir şeyi beynimizden silemezsiniz ya. anladık kötü niyetlisiniz de bu kadar da düşmeyin. net görülen bir pozisyon için orasına çarpıyo burasına çarpıyo diyorsunuz. ben kör müyüm amına kodum çocuğu?
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    friends nostaljidir. ekşi de nostalji hastasıdır. mesela şimdi istanbul'un 1940'lı yıllarının boklu, sefil hallerini paylaş dibi düşer bunların. mesela eski anadolu'nun veremli topraklarında açlık, hastalık, bit değil huzur, sevgi ve aşk görürler. hasta lan bunlar. ellemeyin. he he friends daha iyi falan deyin. ciddi söylüyorum şimdi sikimin fotoğrafını çekip biraz sepya biraz eskitme biraz siyah beyaz atayım nostaljik bir hava yakalasın altında ekşicilerin: "ah o eski sikler" diye iç geçirdiğini görebilirsiniz. deli lan bunlar.
  entry_channels: tv
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    hiçbir şey yapmaz. gerçekten kırılan bir kadın eğer gururlu bir kadınsa sadece çeker gider. ne kendini değiştirir, ne bir farklılık yaratmaya çalışır ne de bir şeyleri oldurmaya çalışır. intikam almaya bile çalışmaz. kalbini gerçekten kıran adam onun için yok hükmünde olur. kendini bir daha asla açmaz, ruhunu göstermez, o adama bir daha güvenmez, kendini asla bırakmaz.<br/><br/>intikam almak bile değer verdiğin kişilere yapılır. bir kadın gerçekten kırıldıysa bunu bağıra çağıra yaşamaz. gider kendi kendini tamir eder, kalbinin parçalarını tekrar birleştirir ve onu yeni bir zırhla kaplar. kendi değerini bilir ve onu kırmayı seçen insana son bir söz bile söylemeden, gururuyla gitmeyi seçer.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    ciddi cevap veriyorum; <br/><a class="b" href="/?q=bas%c4%b1">bası</a>yı ayarlayabilen bir <a class="b" href="/?q=gercek">gercek</a>bir masoz/masor.<br/>basiyi ayarlayamiyorsa agziniza sicabilir. <br/>rahatlayacagim derken uzerinizden tir gecmis gibi hissedip. eve kapanip beni cok<br/>kotu dovduler diye aglayabilirsiniz...
  entry_channels: anket
- entry_name: |
    billie eilish
  entry_id:  102239657
...
- entry_name: |
    2019-2020 sezonu fenerbahçe'nin hakem bilançosu
  entry_id:  102238985
  entry_writer: ondokuzelli
  entry_fav_count: 1
  entry_content: |
    mhk hakemlerin kızağa çekilmesi yetmez demiştir.fenerbahçe'nin alanya maçını katleden serkan tokat'ı ankaragücü maçına gözlemci atamıştır.<br/><br/>fenerbahçe'nin puanını çalan adamların haftalık istikakı eksik edilmiyor.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    pek umudum yok ama <a class="b" href="/?q=kaligrafi">kaligrafi</a> ve <a class="b" href="/?q=ebru">ebru</a>dan anlayan var mı?<br/><br/>ayrıca parapsikoloji, rüyalar konusunda bilgi sahibi yazarlar yeşillendirebilir.
  entry_channels: anket,ilişkiler
---
