...
- entry_name: |
  ...
  entry_fav_count: 398
  entry_content: |
    bıktık artık her uzun boylu kadının ayakları ile ilgili entry okumaktan. dünya tarihinde hiç kimsenin aklına gelmemiş bir benzetme ile en yaratıcı tespiti yapıştırıyorsunuz.<br/><br/>fırıncı küreğiymiş...<br/><br/>fizik kuralları gereği uzun boylu bir kadının küçük ayakları olamaz, hem at gibi kadın istiyoruz diyorsunuz hem de küçük ayak arıyorsunuz. insan oğlum bunlar insan, ayakta duracak, yürüyecek...
...
- entry_name: |
  ...
  entry_channels: siyaset,ilişkiler,tv,sanat,sinema,haber,magazin
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    verilere göre türkiye'nin %52.4'ü mutlu
  entry_id:  102215858
  entry_writer: darkestroom
  entry_fav_count: 167
  entry_content: |
    geri zekalılar. bu memlekette şu şartlar altında bile mutluysan su katılmamış bir ahmaksın. budalasın.
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    güne ingilizce bir deyim bırak
  entry_id:  102213152
  entry_writer: sheriff78
  entry_fav_count: 80
  entry_content: |
    i will check the horses.<br/><br/>bir toplulukta çişe gidiyorum demenin kibar hali.<br/><br/>edit : çok soran oldu özetleyeyim. örneğin arkadaşlarınızla birinin evinde toplu olarak bira içiyorsunuz. tuvalete gitmeniz gerekti. eskiden birlikte içerken zaman zaman atlar huysuzlanır ve herhangi bir tehlike var mı diye kontrol edilirlermiş. amerikan filmlerini hatırlayın, ahıra tüfekle gelen kovboy. bu nezih içki ortamını bozmamak için de tuvalet ya da çiş gibi kelimeleri kullanmak yerine bunu kullanırlar.
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 75
  entry_content: |
    mesai saatleriyle hayalarından, borçlanmışlığıyla göbek bağından, cinsellik ve şiddet içerikli mesajlarla medyanın tecavüz ettiği beyninden, sahte idollerle hedeflerinden, kullandığı ilaçlarla iç organlarından, sürekli izlenmesiyle özel hayatından bağlanmış ve hareket kabiliyeti sıfıra düşmüş z kuşağı köleliğe son verecekmiş. buna sadece gülerler.
  entry_channels: anket
- entry_name: |
    a çocuğu değil asi çocuk dedim
  entry_id:  102234474
  entry_writer: tovbebismillah
  entry_fav_count: 67
  entry_content: |
    kıvır o.ç. !<br/><br/>(oraların çocuğu anlamında)<br/><br/>tanım: alıştığımız kıvırmalardandır.
...
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    ilk olmak değil son olmak marifettir.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    "hiç de bileeee!!! bak, ben ne kadar da güzelim!!!" nidaları eşliğinde kendisine nude fotoğraflar, buluşma ve sevisme teklifleri yagacagini sanan yazarimsi başlığı. ha goçuma, ha aslanıma!!!!
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    yalnız kalmayı tercih edecektir.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=cenevre">cenevre</a>) (bkz: <a class="b" href="/?q=lyon">lyon</a>)
  entry_channels: anket,seyahat
---
