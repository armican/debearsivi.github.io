...
- entry_name: |
    8 şubat 2018 spotify'ın türkiye ofisini kapatması
  entry_id:  74084584
  entry_writer: didierdrogba07
  entry_fav_count: 21
  entry_content: |
    türkiye'nin günden güne daha sıkıcı bir yer haline geldiğini hatırlatmıştır.<br/><br/>alışveriş üç kuruş parayla sınırlı, spotify yok, amazon yok, ebay yok, ... ne var lan it!
- entry_name: |
...
- entry_name: |
    meslek örgütlerinin lağvedilmesi
  entry_id:  74069600
  entry_writer: redsun
  entry_fav_count: 7
  entry_content: |
    çok iyi hızla sona yaklaşıyoruz. ordu,yargı,medya falan derken zaten ortada muhalif stk kalmamıştı meslek odaları da tamamen sıfırlanacak. tek renk olmak uğruna tüm renkleri yok ettik. sona kalan rengin uzun ömürlü olmayacağı tarihsel tecrübeyle sabittir.<br/><br/>laf anlatmanın hiç bir anlamı yok, enerjinizi boşa tüketmeyin reise tam destek verin, o gerisini halleder.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    (bkz: <a class="b" href="/?q=hallac-%c4%b1+mansur">hallac-ı mansur</a>)<br/><br/>(bkz: <a class="b" href="/?q=ene%27l-+hak">ene'l- hak</a>)
- entry_name: |
...
- entry_name: |
    ekşi sözlük iş ağı
  entry_id:  74076875
  entry_writer: spor muha biri
  entry_fav_count: 0
  entry_content: |
    mersin'de daha önce yurt dışı gümrük deneyimi olan arkadaşımıza yurt içi/yurt dışı gümrük işi arıyoruz. yeşillendirebilirsiniz...
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=hani+ensar+bizdik">hani ensar bizdik</a>)
---
