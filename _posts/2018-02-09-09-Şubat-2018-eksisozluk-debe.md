...
- entry_name: |
  ...
  entry_fav_count: 36
  entry_content: |
    bunu diyenin bir önceki başlığı:<br/><br/>(bkz: <a class="b" href="/?q=kad%c4%b1nlar%c4%b1n+baz%c4%b1+haklar%c4%b1n%c4%b1n+geri+al%c4%b1nmas%c4%b1+gerekti%c4%9fi">kadınların bazı haklarının geri alınması gerektiği</a>)<br/><br/>hadi yavrum, hadi. ikile. sana ekmek çıkmaz buradan.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    harika bir proje.<br/>projede türkiye'nin de katkısı var.<br/>mars'a yollanan tesla marka aracın ötv'sinin türkiye'de üretildiği açıklandı...<br/><br/>kaynak: <a rel="nofollow noopener" class="url" target="_blank" href="http://zaytung.com/haberdetay.asp?newsid=336413" title="http://zaytung.com/haberdetay.asp?newsid=336413">zaytung.</a>
- entry_name: |
    elon musk
  entry_id:  74071504
  entry_writer: birsonrakiistasyon
  entry_fav_count: 19
  entry_content: |
    nerede oldugunu hatirlamiyorum ama bir kaynakta ustun zekali insanlarin ayni anda cok fazla ihtimali hesaplayip laflarinin sonunu ongorebildikleri icin konusurken kelime secmekte zorluk cektiklerini ve genellikle kendilerini daha zor ifade ettiklerini gormustum. ne zaman bu adami dinlesem, o urkek cumlelerini, takilmalarini, tam yapamayip sadece kendi guldugu sakalarini gorsem aklima bu onerme geliyor. ne kadar kanitlanmis bir onermedir bilmiyorum ama en azindan elon musk'in bunun bariz bir ornegi olduguna inaniyorum.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    0.20787957635<br/><br/>sözlüğün geldiği yere bak.kimse de i üssü i olduğunu ve euler özdeşliğinden sonucun çıkması gerektiğini söylememiş. <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup> <br/><br/>e^(i.pi) = cos.pi + i.sin.pi<br/>e^(i.pi)= -1 <br/>// her iki tarafın da kökünü al. <br/>e^(i.pi.1/2) = i<br/>// şimdi de her iki tarafın da i'nci kuvvetini al. <br/>e^(pi/2.(i^2)) = i^i<br/>// i^2 = -1 ise <br/>e^(-pi/2) = i^i<br/>// e^(-pi/2) sayısı da 0.20787957635'e eşittir. <br/><a class="b" href="/?q=sonu%c3%a7">sonuç</a> <br/>__i^i__ = i^i = 0.20787957635
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    cam-sil gibi sprey kabına su koyup fısfıslayarak kovabilirsiniz. bu cümlemi dil kurallarına uygun hale getirene bu martta bi yavru kedi vericem. camsil, sprey kabı, fısfıslamak ney lan?<br/><br/>bakmayın siz alın besleyin diyenlere. bunu diyen kaç sokak hayvanına bakıyor? kaçına daha bakabilecek? bunun sonu var mı? realizmle romantizmi ayırın. scottish alan hayvansever kesildi amk. kovulması gereken yerde kovulacak elbette.
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    (bkz: <a class="b" href="/?q=ibrahim+tatl%c4%b1ses%27le+m%c4%b1na+ha">ibrahim tatlıses'le mına ha</a>)
- entry_name: |
    nüfusa oranla ankara'da araba sayısı ilk sırada
  entry_id:  74083053
  entry_writer: the ultimate driving machine
  entry_fav_count: 9
  entry_content: |
    maalesef ki toplutaşıma konusunda ne kadar başarısız bir başkent olduğunun yansımasıdır. hala daha dümdüz bir metro hattında 3 kere aktarma yapıyoruz. metrodan inip dümdüz karşıya yürüyüp başka bir metroya biniyoruz. <br/><br/>bunun yanında birbirine yakın herhangi iki semt arasında direk bir ulaşım pek olmuyor. örneğin batıkentten ümitköye gitmek isterseniz ya illaki "merkez" olarak kabul edilen bir yerde aktarma yapmanız lazım. <br/><br/>mesela şaşmaz'a arabanızı tamire bıraktınız. arabanızı bıraktıktan sonra en yakın toplu taşımaya gidebilmeniz için ustanıza sizi bir durağa bırakması için rica etmeniz lazım, arabanızı teslim almaya gelirken de arayıp "abi beni şurdan al" demeniz lazım.<br/><br/>halbuki trafiğe çıktığınızda her yer metro durağı, her yer otobüs, her yer halk otobüsü, her yer dolmuş...
- entry_name: |
    tarkan
  entry_id:  74083632
  entry_writer: rang my door
  entry_fav_count: 8
  entry_content: |
    adamın heyecanı sevinci gözlerinden, ses tonundan belli oluyor. <br/><br/>darısı başımıza:)
- entry_name: |
    sen anlat karadeniz
  entry_id:  74071209
  ...
  entry_fav_count: 7
  entry_content: |
    karadeniz erkeklerini abartan dizi. kadınları tamam ama erkekleri tırttır. ben karadenizliyim ondan biliyorum. ayrıca bomboş, hamaset üzerine kurulu bir dizidir.
- entry_name: |
    isaiah thomas
  entry_id:  74083490
...
- entry_name: |
    gazi ve şehit olmak millettin en büyük özelliğidir
  entry_id:  74084005
  entry_writer: patryn
  entry_fav_count: 5
  entry_content: |
    ' türkiye'nin en büyük ihracı askeridir.' diyen <a class="b" href="/?q=soros">soros</a> 'u doğrular nitelikte, aynı basiretsiz ya da daha art niyetle söylenmiş siyasetçi beyanı.<br/><br/>türk yaşar ve dünyayı değiştirir. ölmek için ölmez, gerekirse yeni canları yaşatmak için ölür. fakat bu da kimsenin diline düşmez, düşemez.<br/><br/>tanım: vasat siyasetçinin basiretsiz beyanı.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    aktif ingilizce kullanması zaruri olmak şartıyla, bir otomotiv şirketinde satınalma departmanında çalışmak isteyen, tercihen endüstri ya da makina mühendisi arkadaşların mesaj kutumu yeşillendirmesine yardımcı olmasını umduğum ağ. <br/><br/>ilgilenen arkadaşların özelden yazmasını rica ederim. yukarıda da yazdığım gibi, aktif bir şekilde, yurt dışı iş ortakları ile görüşüleceği için, ingilizce yeterliliğinin olması gerekiyor. <br/><br/>otomotiv deneyimi olması güzel olur ama çok da elzem değil. <br/><br/>lokasyon: istanbul/şişli
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    banlamak için referans linki veren yazar aratan cryptocoin borsası
---
