...
- entry_name: |
  ...
  entry_id:  83814605
  entry_writer: mmdhpan
  entry_fav_count: 12
  entry_content: |
    bunu neden topic yaparlar sorunsalına katıldığım bir başlık, arkdaşlar erkekler seks seviyor. bu heryerde böyle hatta avrupada kadınlarda seks seviyor bizde sadece toplum baskısı var.
...
- entry_name: |
    aras kargo
  entry_id:  83811076
  entry_writer: oyle haller icindeki halim
  entry_fav_count: 3
  entry_content: |
    önce klasik geldik evde yoktunuz muhabbetiyle başladılar. sonra şehir dışında olacağımı 3 iş günü içinde alamayacağımı ama 4. günün şafağında koşa koşa gelip şubeden teslim alabileceğimi belirtip; kargomu şubede bekletmelerini, iade yapmamalarını rica ettim. aa tabi olur ne demek diye karşıladılar sağolsunlar. bugün şubeye gittim. sürpriz olmayan son, aa biz sizin kargonuzu dün gece iade ettik dediler. ne diyebilirim ki? <br/>bir kez olsun beni şaşırtırlar belki diye inandığım ama yine şaşırtamayan kargo şirketidir.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    allama bin şükür basic kodlama yapmıştım.
