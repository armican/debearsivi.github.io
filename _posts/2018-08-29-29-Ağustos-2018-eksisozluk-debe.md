...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    kanunlar kim için vardır
  entry_id:  80719614
  entry_writer: isnetus
  entry_fav_count: 24
  entry_content: |
    siz daha dünyanın acı gerçeklerini öğrenememiş çaylaklarsınız. bu kafayla giderseniz hiç ayıkamayacaksınız. <br/><br/>öncelikle geçin o evrensel hukuk mukuk ayaklarını.<br/><br/>tüm gerçeklik şu:<br/><br/>"kanunlar, iktidarların fahişesidirler"
  entry_channels: anket
- entry_name: |
...
- entry_name: |
    ik departmanı ile iş görüşmesi
  entry_id:  80724435
  entry_writer: weimar royce
  entry_fav_count: 8
  entry_content: |
    cogu ik'cinin mudurune ''bu ay su kadar kisiyle gorusme yaptik'' demek icin adaylari bosu bosuna onca yoldan cagirip geyik yaptiklari gorusmelerdir...
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    götümüze bakıyor musunuz doğru söyleyin ?
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    yerli kredi derecelendirme kuruluşumuzun bir an önce hayata geçirilmesi gerektiğini gözler önüne seren olaydır.<br/><br/>önce şaak iki not arttıracaksın bir affalayacaklar, ardından şaak üç not daha arttıracaksın çil yavrusu gibi dağılacaklar.
  entry_channels: siyaset,haber,ekonomi
- entry_name: |
    tişörtü belde düğüm yapmak
  entry_id:  80727764
  entry_writer: sapmasacan
  entry_fav_count: 4
  entry_content: |
    (bkz: <a class="b" href="/?q=kad%c4%b1nlar%c4%b1+%c3%a7ekici+yapan+detaylar">kadınları çekici yapan detaylar</a>)<br/><br/>hele o bel incecikse +10 puan kazandırır.
  entry_channels: moda
- entry_name: |
...
- entry_name: |
    bursa özel jimer hastanesi rezaleti
  entry_id:  80704897
  entry_writer: detmold
  entry_fav_count: 2
  entry_content: |
    çok enteresan şekilde yardımcı olmak yerine kabulleneceksin ıvır zıvır yazılar yazılmış, suriyeli duyarı kasılmış. bursa’da durum nedir haberiniz var mı? mersin’de, antep’te? şimdi konu bu değil burdan uzatmayayım ama yazarı çok iyi anlayabiliyorum. <br/><br/>yazar para vermekten kaçma derdinde de değil. acilden giriş yaptım zorla bir sürü evrak imzalattılar, fatura da vermiyorlar a... koyayım onların, katakulli var diyor. eşim hamile derdim var bu durumdayken dolandırılmayayım böyle bir muamele görmeyeyim, kural ne ise onu uygulasın diyor hastane. o yüzden biraz insan olup bilgimiz varsa paylaşmak geken, yoksa konu üzerinden kavramsal tartışmalara en azından çözüm önerilene kadar girmemek lazım gelen durum. <br/><br/>yok efendim paran varsacılar, suriye kankitoları bi rahat versin böyle sıkıntılı ve haklı bir durumda.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    bir süredir kafamda yerleşme planları vardı, ev arkadaşımla girdiğim tartışma sonrası da gerçekleştirmeye karar verdim. kira fiyatları, iş durumu vs nasıldır, bilen arkadaşlar, bir yeşil uzağınızdayım.<br/>doğup büyüdüğüm, ilk aşkım olan istanbul'dan beni soğutmayı başaran kişiler, inandığınız ne varsa belanızı versin...
  entry_channels: siyaset,tarih,müzik,edebiyat,haber,yeme-içme,seyahat
- entry_name: |
    venezuela gibi asgari ücrete %50 zam yapmak
  entry_id:  80726663
  entry_writer: one above all
  entry_fav_count: 0
  entry_content: |
    eyvah. lan adamlar 1600 tl alıyor, asgari ücret 600 tl zamanındaki 1600 tl zannediyor. böyle bir zam olursa, bu akp tayfası recep erdoğanı allah ilan edebilir. lütfen dikkat.
  entry_channels: ekonomi
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    konu bir çocuk olduğunda para sorun olmamalı hele ki durumu iyi olanlar için. hadi pamuk eller cebe.<br/>iyi, sağlıklı günlerini de görmek dileğiyle.
  entry_channels: 
- entry_name: |
