...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    add genel başkanının bankamatik memuru çıkması
  entry_id:  92466205
  entry_writer: patronun cocugu
  entry_fav_count: 78
  entry_content: |
    ee orospu çocuğu adam mesai saati dışında dernek başkanlığı yapıyorum diyor ne var bunda. ticari bir kazancıda yok add başkanlığının. çankaya belediyesinde işinin başındaysa gündüz yani sizin gibi “atm faresi” değilse size ne be amk çocukları,size ne ?
...
- entry_name: |
  ...
  entry_fav_count: 68
  entry_content: |
    akitten çıkması şaşırtıcı olan doğru haberdir.<br/>bilim, masalları çöp eder.
  entry_channels: bilim,haber,eğitim
- entry_name: |
    türk erkeğinin en yetenekli olduğu konu
  entry_id:  92466192
  entry_writer: nebulabunela
  entry_fav_count: 62
  entry_content: |
    normalde böyle başlıklara yazmam ama madem türk kızının en yetenekli olduğu konu başlığını kadın nefretinizle hınca hınç doldurdunuz, yazalım bakalım bir iki bişi.<br/><br/>-yolda yürüyen kadının götüne gözlerini 1 sn dahi ayırmadan bakabilmek. (takip becerisi üst düzey)<br/>-karşıdan gelen kıza laf atma becerisi (ister cinsel içerikli, ister türkü çığırarak. şairlik ve müzisyenlik)<br/>-çok süper şoförüm yauu diyip makas atarken hem kendi ölmek hem aileleri öldürmek (ama gadınlar frene basımüyü)<br/>-cinayet ve tecavüz suçlarını işlemek (ama erkekler daha çok intihar ediyo tmm mı!)<br/>-karısını sevgilisini her fırsatta aldatmak, gözünün içine baka baka acımasızca yalan söylemek, bir de kadına deli muamelesi yapmak (ee doğamız gereği kızım.. tek eşlilik erkeğin doğasına aykırı yav)<br/>-eşi/annesi/kız kardeşi ev işi yaparken ayaklarını uzatıp geniş maç özeti izlemek (ya ben beceremem şimdi hiç daha zorlaştırmıyım işini canım!)<br/>-seks yapamıyor oluşunun sorumlusu olarak kendi eksikliklerini değil kadınları görmek. (ama annem yakışıklısın demişti :( )<br/>-avrupa’nın en çirkin 3 erkeğinden biri olmasına karşın gayet güzel kadınlarla dolu ülkemizdeki kadınlara laf söylemek, kadın 1000 tane bakımından birini geciktirse söylenmek ama daha burun kıllarını almamak ( erkek dediğin bakımlı olmaz öyle karı gibi)<br/>-bir kızla asla arkadaş olamamak, iki sohbet ettiği kızla ilgili yatak senaryoları kurmak (o da istiyor ama)<br/><br/>sabaha kadar devam edebilirim ama işim gücüm var. herkese hayırlı forumlar. gelecek mesajlara şimdiden cevap vereyim: evet canım 280 kiloyum tek kaşlıyım çirkin ve öfkeli feministim şuanlık kasiyerlik yapıyorum tek isteğim bir koca bulmak işte o zaman feminizmi bırakıp gadınlığın özüne döneceğim.
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 56
  entry_content: |
    ülkeyi save edin beyler , güzel bir bölüm geçtik.
...
- entry_name: |
  ...
  entry_channels: ekşi-sözlük
- entry_name: |
    son 1 ayda 333 bin kişinin işsiz kalması
  entry_id:  92459593
  entry_writer: realsanto
  entry_fav_count: 30
  entry_content: |
    şu aşağıdaki şirketerin bir ayda tüm çalışanlarını çıkardığını düşünün. yaşadığımız tam budur.<br/><br/>türk telekom - 34 bin<br/>arçelik -30 bin<br/>thy -31 bin <br/>lc waikiki - 42 bin<br/>migros - 27 bin <br/>turkcell - 16 bin<br/>vestel - 16 bin<br/>enka - 22 bin<br/>şişecam - 22 bin<br/>anadolu efes - 17 bin<br/>carrefoursa - 12 bin<br/>ereğli demir çelik -12 bin<br/>acıbadem sağlık -21 bin<br/>tav -30 bin
  entry_channels: siyaset,haber,ekonomi
- entry_name: |
...
- entry_name: |
    ekşi'ye gelen konukların ziyan ettiği a4 kağıtları
  entry_id:  92472380
  entry_writer: imamihanife
  entry_fav_count: 8
  entry_content: |
    üstadım bu ne çeşit bir işsizliktir.
...
- entry_name: |
    psikiyatrist sevgilinin hayatı çekilmez kılması
  entry_id:  92474651
  entry_writer: tasaltinda kurba
  entry_fav_count: 3
  entry_content: |
    psikiyatrist sevgilinden ayrıl, başka psikiyatri doktoruna gözük.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    emre mor’un gelişiyle birlikte forvet arkası 10 numara mevkisine çekilse nasıl olur diye düşündüğüm canımız, ciğerimiz. milli takımında o mevkiide oynuyor.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=bitik+adam">bitik adam</a>)
  entry_channels: anket,edebiyat,eğitim
- entry_name: |
    suriyece bir kelime yaz
  entry_id:  92476344
  entry_writer: paolno
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=abi+ben+suri">abi ben suri</a>)
  entry_channels: 
- entry_name: |
    erkek yazarlardan kadın yazarlara sorular
  entry_id:  92438686
  entry_writer: kozmopolit barbar
  entry_fav_count: 0
  entry_content: |
    türkiye'de kadın olmanın zorluklarından çok defalar bahsettik. <br/><br/>eğer erkek olmak bir seçenek olsaydı, tercih eder miydiniz ?
  entry_channels: anket,ilişkiler,ekşi-sözlük
---
