...
- entry_name: |
    halk ekmek'te maaş vurgunu
  entry_id:  90615251
  entry_writer: kartalbafilerrr
  entry_fav_count: 31
  entry_content: |
    ahmed sarıduman bu başlığı mahkeme kararıyla engellemiş,<br/><br/>yahu bunlar güneşi balçıkla sıvamaya çalışıyorlar, <br/><br/>acınası...
  entry_channels: haber
- entry_name: |
    chernobyl (dizi)
  entry_id:  90601554
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    şimdilik içinde 1 liram olmayan paradır. bir de bireysel emekliliği isteğe bağlı olmaktan çıkaracaklarını iddia ediyorlar. seçim bitsin, o da olacak. siz hâlâ ahaber, akit, kanal7 haberleriyle uyuşturmaya devam edin kendinizi. adamlar attı ellerini cebimize. <br/><br/>(bkz: <a class="b" href="/?q=buras%c4%b1+%c3%a7okomelli">burası çokomelli</a>)
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    cinsel içerikli başlıkların tutmasının asıl sebebi
  entry_id:  90629598
  entry_writer: makmuhdevmem
  entry_fav_count: 2
  entry_content: |
    (bkz: <a class="b" href="/?q=cinsel+a%c3%a7l%c4%b1%c4%9f%c4%b1n+afrika%27s%c4%b1d%c4%b1r+t%c3%bcrkiye">cinsel açlığın afrika'sıdır türkiye</a>)
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    umutsuz durumlar yoktur, umutsuz insanlar vardır. ben hiçbir zaman umudumu yitirmedim.<br/>ne güzel de demiş atam. <br/>hem de bunu celladını bekleyen bir ulusun umutsuzluğun en derinden hissedildiği zamanlarda söylemiş. <br/>büyüksün be atam.
  entry_channels: siyaset,anket,tarih,edebiyat
- entry_name: |
    türk havayolları lego2 filmi güvenlik videosu
  entry_id:  90631064
  entry_writer: eses2697
  entry_fav_count: 1
  entry_content: |
    türk havayollarının ne kadar başarılı reklamcılarla iş yaptığını bir kez daha göstermiş çalışmadır. yürüyedurun.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    sözlüğü değiştirecek yazarın gelecek olması
  entry_id:  90629015
  entry_writer: aragorn the grey
  entry_fav_count: 0
  entry_content: |
    inançla beklenen hadisedir. sözlüğün peygamberi bir gün gelecek ve her şey kutsanacak şüphesiz.. ey inananlar, yazın, onun adıyla yazın!!<br/>sözlük inanç olma yolunda sağlam adımlarla ilerliyor bence.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=dallas+comegys">dallas comegys</a>) ribauntların, sert oyunun efendisi. fenerbahçe için bir damla ter dökenler unutulmaz.
  entry_channels: spor,anket
- entry_name: |
    1.91 boyunda omuzları geniş yakışıklı türk erkeği
  entry_id:  90630001
  entry_writer: tursusuyu
  entry_fav_count: 0
  entry_content: |
    kesin bi bit yeniği var diye düşündürür.
  entry_channels: anket
---
