...
- entry_name: |
    starbucks'da bardağın yarısına buz koyulması
  entry_id:  90979137
  entry_writer: kloro mloro karbon
  entry_fav_count: 78
  entry_content: |
    maliyet analizi bilmeyen dalyarakları başlık altında toplamış durum. adam dükkan kirası, personel maaşı, franchise için ödenen ücret, fire gideri ve daha bir sürü şeyi maliyetten saymıyor. neden? çünkü cahil. ama yine de yorum yapmaktan ve hatta insanlara aptal demekten çekinmiyor.<br/><br/>buz olayına hak veriyorum ama "maliyet 2 tl zaa xd doğal seleksiyon hehe ben cahilim" yazan dalyarak arkadaşa da ahkam kesmeden önce araştırma yapmasını tavsiye ederim.
...
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    hiç kimsenin itiraz edemeyeceği sebepleri belli gerçek.<br/><br/>peşin edit: türk erkeğinin amsalak oluşundan kaynaklanan durum. bu kızlarımız da audi, bmw ye binmek para sıkıntısı çekmemek için domuz gibi heriflerin leş kokusunu çekiyor o ayrı.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    mevcutta yaşadığım yer olan “fıstıkağacı” bana kalırsa üsküdarın en yaşanılası yeri olabilir. <br/><br/>mahalle kültürü ayakta, insanlar eski,nezih ve temiz, komşuluk ölmemiş ama laçkalaşmamış da. ulaşım desen burası istanbulun merkezi kadıköye de beşiktaşa da 15 dakika. <br/><br/>acıbadem ve koşuyolu yazanlar görüyorum. buralarda oturanlar üsküdar’da oturmuyorlar, moda caddesinin denizden uzak bir köşesinde oturuyorlar ve aslen kadıköylüler.<br/><br/>edit: yalnız kiralık ev arayan arkadaşlar için belirteyim, eğer 1600-2400 tl arası bir kira ödeme gücünüz yoksa, üsküdarda çok boktan evleri gezdirirler sizlere ve ne için yaşıyorum amk ben diye sorgulayarak sigara içerek bol bol düşünürsünüz.
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    hanımın 30 tane elbisesi var dolapta hepsi tek tek askıya asılı benim sadece üç tane gomlegim var ve yengeniz üçünü aynı askıya asmış <br/><br/>evlenmeyin arkadaşlar :) <br/><br/>bir arkadaştan gelen bildirime istinaden anlayış diyorum
  entry_channels: anket,ilişkiler
- entry_name: |
    mühendislerin matematikte doktorlardan iyi olması
  entry_id:  90999357
  entry_writer: cypresless bluehead
  entry_fav_count: 6
  entry_content: |
    matematik bir dildir, kullanılmadıkça zayıflar. doktorların bu dilin bilgileri sürekli taze tutmaya ihtiyaçları yoktur. mühendisler sürekli hesap (statik) ve maliyet çalıştıkları için bu bilgiler daha taze kalır ama zamanla yavaşlarlar. bir üniversite hazırlık öğrencisi ile 10 yıllık bir mühendisin önüne aynı matematik testini koyarsan öğrenci büyük ihtimalle daha çabuk bitirir.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    7.000'de 1 ihtimal üzerine yapılan haber ve bu haberden yola çıkılarak açılan başlıktır.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/8Wm2AnhfZtg" title="https://youtu.be/8Wm2AnhfZtg">renklerin içinde</a>
...
- entry_name: |
    iyi menemenin sırrı
  entry_id:  90999348
  entry_writer: morsari
  entry_fav_count: 1
  entry_content: |
    her şeyden önce iyi, mis gibi kokan domatestir efendim. bir de soğanı tereyağında hafifçe kavururken biraz karabiber atmayı unutmayın. afiyet olsun.
  entry_channels: yeme-içme
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    tuvalete giderken de götürürüm, kapalı da koyarım. kapalı koyarım, sürekli oradan buradan bildirim düşüp ekran aydınlandığı için göz alıyor diye. ister istemez göz kayıyor ve hem benim hem karşımda oturanın dikkati anlık da olsa dağılabiliyor. tuvalete götürme sebebim tamamen içeride kilitli kalmaktan korkmam. kapalı kalmaktan korkmam meğer güvensizlik yaratıyormuş, öğrenmiş oldum sağolun.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    belli ki üzerinde uzun uzun düşünülmüş ve planlar yapılmış. mağduriyet yaratmak için ellerinde büyük bir plan olduğu kesin.
  entry_channels: siyaset,tv,haber
- entry_name: |
    ben tecrübeli olması açısından uğur dündar isterim
  entry_id:  90997929
  entry_writer: moguk
  entry_fav_count: 0
  entry_content: |
    gerçekse ve gerçekleşirse, ülke olması gereken normalleşme sürecine, bu vesile ile girmesini umudediyorum, bir muhalif olarak.
