...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    kesinlikle armada’nın karşısında bulunan (bkz: <a class="b" href="/?q=yda+center">yda center</a>) ben böyle çirkin, kent dokusunu bozan bir yapı daha görmedim.
  entry_channels: 
- entry_name: |
    ekşi itiraf
  entry_id:  90352589
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    mutfaktaki musluğun contasını tamir ederken kestiği elinin-kolunun hikayesini ne diye merak ediyorsunuz, anlamadım.<br/><br/>ok atan, at binen erkek pek kalmadı hani, haberiniz olsun.
...
- entry_name: |
    bir kadına kilo almışsın demek
  entry_id:  90330306
  entry_writer: uc kurusluk marijuana
  entry_fav_count: 5
  entry_content: |
    uzun soluklu ve rutine binen alkolizmimin eseri bira göbeğim aslında görünüşüm açısından çok fazla sorun teşkil etmese de hoşuma gitmediği için 2 ay önce spor yapmaya karar verdim. ulan azıcık bir göbeği iki ayda eritemedim, vücut şekle giriyor göbek gitmiyor. en az bir dört ayı daha var. eğer içinizi boğan, kafanızı bozan, canınızı sıkan bir olay ya da düşünce varsa bence kendinizi koşu bandına ya da kardiyoya vurun. hem koşup o düşüncelerden kaçıyormuşsun hissine kapılıyorsunuz hem de uzun uzun düşüncelerle ve sıkıntılarla kendinizi yemekle meşgulken koştuğunuzun farkına varmadan yüzlerce kalori yakıyorsunuz.bugün yine o iç sıkıntımı elipticalda koşarak giderirken, önde koşan kilolu kadına dikkat ettim, bir parça göbek için çektiklerimi onu bekleyenlerle kıyasladım, sonra dedim ki başarı mı arıyorsun, bir kaç ayda onlarca kilo veren kadınların yeniden dirilttikleri özgüvenini başarı olarak kabul etmelisin. sanırım seferden dönen antonius'un zafer takı altından geçerken insanların ona tezahürat ettiği bir psikolojiyle eşdeğer. kendimi o kızın yerine koydum bir kadın oldum ve hislerini düşündüm, kilolu bir kadın olmanın özgüvensizliğini herhangi bir özgüven düşüren özellikle kıyaslayacak bir şey bulamadım. göbekli, kel , kıllı hatta çirkin erkekler bile toplumda azınlık olduğunu hissettiren ve üzerinde özgüven kırıcı herhangi estetik baskı hissetmezken, bakımlı olmanın artık bir özellik değil de fabrika ayarlarından sayıldığı bir düzende, plastik cerrahinin dur durak bilmez artan talebinde kadınlara söylenen kilo mu aldın beyanı farklı bir incelik gerektiriyor. öncesinde belki psikolojik durumunu sorup öğrenmek gerekebilir, boş zamanlarını spora yönlendirici teşvik konuşmaları yapılabilir ya da kendi vucudunuza sporun kattığı güzelliklerden ona hiç dem vurmadan bahsedilebilir. bazen bir şeyi dosdoğru söylemek en doğru yol olmayabilir. karşıdaki kadına verilen değer onun hislerini incitmemek için hangi söylem yollarını dolambaçlı hale getirdiğimizle ince bir hale bürünebilir. erkeklerin ince olması önündeki en büyük engelin bu empati gerektiren incelikten mahrum kalmaları olduğunu düşünüyorum.
  entry_channels: ilişkiler
- entry_name: |
    ali koç
  entry_id:  90329261
...
- entry_name: |
    chp tek başına iktidara gelirse olabilecekler
  entry_id:  90362876
  entry_writer: sozlugun en guzel kizi
  entry_fav_count: 3
  entry_content: |
    sokakta çarşıda aniden saygı duruşu isterim diye kriz geçiren laik teyzelerin ve mustafa kemalin askerleriyiz diyerek birbirini tokatlayan kişilerin sayısında artış olacaktır.
  entry_channels: siyaset,anket
- entry_name: |
    cnn türk
  entry_id:  90332830
  ...
  entry_fav_count: 1
  entry_content: |
    yarıda kesilen ekrem imamoğlu programının devamının ne zaman gerçekleşeceğini öğrenmek için arayacağım tv kanalı.<br/><br/>kendilerine, çakma cihangir solcusu, sakallı omurgasız çalışanlarının çenelerini biraz az çalıştırmalarını tavsiye edeceğim.
  entry_channels: tv,haber
- entry_name: |
    an itibarıyla yazarların nerede olup ne yaptığı
  entry_id:  90354343
  entry_writer: yorumsuzsizofrenik
  entry_fav_count: 1
  entry_content: |
    mesainin bitmesi için dakikaları sayıyorum.
