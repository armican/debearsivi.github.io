...
- entry_name: |
  ...
  entry_fav_count: 35
  entry_content: |
    salaklarla eğlenebiliyorsanız zaten zeki kadını hak etmiyorsunuzdur arkadaşlar. çok şeapmayın yani.<br/><br/>tanım: bir soru.
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    pop-siyaset ile sorulmuş sorudur.<br/><br/>1. dünya monolitik ülke yapılarından oluşmaz, daha kompleks süreçlerin ürünüdür. israil ve amerika diye sabit ülkeler yoktur. en azından analiz yapmak için. spesifik senaryolarda fikir deneyi yapabilmek için bu soyutlamaları kullanırız. işte amerika mı israil mi güçlü böyle bir fikir deneyidir. böyle bir durumda ülkenin kağıt üstündeki hardware'ine bakarız.<br/><br/>2. sorunun cevabı, tabiki amerika güçlü amk. iki tane devletin kapasitesini kıyaslamak ayrı şey, siyasi yapılar yüzünden kimin ne yapacağı üzerine fikir yürütmek ayrı şey.
  entry_channels: 
- entry_name: |
...
- entry_name: |
    tipsiz kızların da yakışıklı erkek araması
  entry_id:  90361206
  entry_writer: erkencokenkisaksami
  entry_fav_count: 4
  entry_content: |
    bu dengesizliğin sebebi amsalak hemcinslerimin suratına tükrülmeyecek kezbanlara kendini prenses hissettirmesidir.
  entry_channels: 
- entry_name: |
    akrep burcu erkeği
  entry_id:  90357042
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    bir <a class="b" href="/?q=ipswich+town">ipswich town</a> ya da <a class="b" href="/?q=anderlecht">anderlecht</a> dahi olamayanları hasedinden çatlatan slogan.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    şok çalışanlarının terbiyesiz olması
  entry_id:  90362881
  entry_writer: aklazarar
  entry_fav_count: 2
  entry_content: |
    bizim burdaki şubede de skini açıp gezen kasiyer var. çok terbiyesizlik.
  entry_channels: ekonomi
- entry_name: |
    taze fasulye yemeği
  entry_id:  90362989
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    evrim zincirinde bulunmuş ara fosil gibi bizi anlattıkları programdır.
  entry_channels: 
---
