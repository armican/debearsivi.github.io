...
- entry_name: |
    21 mayıs 2019 bir çaylağın yardım isteği
  entry_id:  90362120
...
- entry_name: |
  ...
  entry_channels: anket,seyahat
- entry_name: |
    asansörde kapıcının kızına oral seks yaptırmak
  entry_id:  90364824
  entry_writer: bungalow bill
  entry_fav_count: 38
  entry_content: |
    sözlük nerelere gidiyor aq böyle insanlar nasıl yazar oluyor yönetim yok mu özlüyorum eski günleri
  entry_channels: 
- entry_name: |
...
- entry_name: |
    rpg oyunlarında hep ayak işlerine bakmamız
  entry_id:  90364122
  entry_writer: theagent
  entry_fav_count: 14
  entry_content: |
    tam olarak: rpg oyunlarında hep ayak işlerine bakmamız sorunsalı olacaktı.<br/><br/>süper güçlerin olsa ve kahraman olarak lanse edilsen bile, şu kişiden şunu al getir bakalım bana koçum tarzından çıkılması gerekiyor artık.<br/><br/>her rpg oyununda aynı oluyor. üst akıl aynı sanırım. bethesda'nın oyunlarında durum daha da vahim. ejderhaları sinek gibi öldürüyorsun ama çiftçi sana gelip bak sebzelerimi ezersen sonun olur diye tehtid edebiliyor.<br/><br/>gece karşına bıçakla hırsız çıkıp ya paran ya canın diyebiliyor. ( full zırh ve silahlısınız)
  entry_channels: oyun
- entry_name: |
    ekşi itiraf
  entry_id:  90352589
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    benim babamın siki kutu kola gibidir.<br/>(bkz: <a class="b" href="/?q=%c3%b6l%c3%bcml%c3%bc+d%c3%bcnya">ölümlü dünya</a>)
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    yanlış tanım. hayatı bitirse iyi. acılar ızdıraplar içerisinde süründürüyo amk.
  entry_channels: ilişkiler
- entry_name: |
    akrep burcu erkeği
  entry_id:  90357042
  ...
  entry_channels: ilişkiler
- entry_name: |
    polisle kavga eden oyuncuya 19 yıl istenmesi
  entry_id:  90363254
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    akp'nin ekrem imamoğlu ismini satın alması
  entry_id:  90363375
  entry_writer: anonimyus
  entry_fav_count: 2
  entry_content: |
    ismi satın almak ne be hahahhaha. klasik google reklamcılığı. rakip aramalarında gözükmek. güzel haber.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    utanmazlar, “ekrem imamoğlu bu akşam cnn türk ekranlarında” kabilinden bir tweet bile atamamışlar. gazetecilik mesleğinin yüz karaları sizi. ulan alacağınız bir kuru maaş be. biraz onurunuz olsun. talimatla programı erkenden kesecek kadar çok mu korkuttu imamoğlu sizi?
  entry_channels: tv,haber
- entry_name: |
    bir erkeğe yara izinin hikayesini sormak
  entry_id:  90362062
  entry_writer: cizeradam
  entry_fav_count: 0
  entry_content: |
    pisikletimin vidasi saplandi. tam kaval kemigimin sag kenarina. korkuyla geri cektim ayagimi. sonuc; 9cm yirtik olustu. ‘99 senesinden tatli bir hatira kaldi. edremitte o yaz denize giremedim.
