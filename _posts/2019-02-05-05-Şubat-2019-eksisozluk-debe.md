...
- entry_name: |
  ...
  entry_fav_count: 94
  entry_content: |
    (bkz: <a class="b" href="/?q=bunu+al%c4%b1n+d%c4%b1%c5%9far%c4%b1ya">bunu alın dışarıya</a>)
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    içsel bezginlik ve yaşamdan çekilmişlik.
...
- entry_name: |
  ...
  entry_id:  86290981
  entry_writer: diptekalanmeyvesuyutanesi
  entry_fav_count: 5
  entry_content: |
    tartışmasız (bkz: <a class="b" href="/?q=sertab+erener">sertab erener</a>)dir
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    benim bu. bir türlü de anlayamıyorum neden karıştığına. neymiş yarroşum görünüyormuş. bahanenin saçmalığına bakar mısınız?
  entry_channels: anket,ilişkiler
- entry_name: |
