...
- entry_name: |
    sütyen takmadan merdiven inmek
  entry_id:  94935039
  entry_writer: drako
  entry_fav_count: 146
  entry_content: |
    (bkz: <a class="b" href="/?q=longidi+longidi">longidi longidi</a>)
...
- entry_name: |
  ...
  entry_fav_count: 42
  entry_content: |
    akp'nin stad hediye ettiği, örtülü ödenek aktardığı, kupayı ince çalışmalarla trabzon'a getirmeye çalışanların, sahaya inip hakem dövenlerin veya rehin alanların, seçimde <a class="b" href="/?q=%2561">%61</a> oy verenlerin, rte'ye "dünya lideri" isimli forma hediye eden <a class="b" href="/?q=kutup+ay%c4%b1">kutup ayı</a>larının böğürerek akp'li olmakla suçladığı 112 yıllık çınar. allah düşmanın da mertini versin diyecem de virüs gibi çoğalmaya başladı bu parazitler, bitmiyor anam.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  94910785
  entry_writer: yemenli tercuman
  entry_fav_count: 35
  entry_content: |
    karşı taraftan o yönde hiçbir hareket görmemiştir veya annesinin yakışıklı oğludur (ben) yani çirkindir.<br/><br/>yakışıklı erkek: merhaba canım<br/>herhangi bir kız: aa merhaba canımmm<br/><br/>çirkin erkek: merhab...<br/>herhangi bir kız: selpak lazım değil canım
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    toplu imza töreninde yeni transferlerinden radamel falcao'ya 3'lü çektirdikten sonra beşiktaş'ın sosyal medya hesabından 3'lü çektirmenin ilk kendilerine ait olduğunu iddia ederek hakkında göndermelerde bulunduğu spor kulübü.<br/><br/>''fikret orman: "üçlünün patenti biz de çünkü türkiye'de en çok biz üçüncü olduk."<br/><br/>zaytung haber.
  entry_channels: spor
- entry_name: |
    behzat ç.
  entry_id:  94930041
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    kedi alınmaz! sahiplenilir! açın sokak kapınızı, ilk karşınıza çıkan kediye bir yuva verin. kırk yılın başı güzel bir şey yapın. onlar sokaklarda özgürce geziyor diye konuşan çok bilmişlere aldırış etmeyin!
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    bugün bir kez daha gördüğümüz operasyon.3 maç 3 kırmızı yetmedi silahla tehdit eden adama ceza vermeyen fenerasyon hoca ağzını açtığı anda bastı 4 maç cezayı.hem de fener maçını da dahil ederek.bu kadar da belli etmeyin fenerbahçeyi şampiyon yapmak istediğinizi.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    evdeyim (bkz: <a class="b" href="/?q=youtube">youtube</a>)'den (bkz: <a class="b" href="/?q=ma%c5%9fa+ile+koca+ay%c4%b1">maşa ile koca ayı</a>) izliyorum.
  entry_channels: anket
- entry_name: |
    #nihatözdemiristifa
  entry_id:  94945733
  entry_writer: eenertas
  entry_fav_count: 1
  entry_content: |
    bosuna tt yapmaya gerek yok. gs sampiyon olunca birileri tarafindan istifa ettirilir.
  entry_channels: spor
- entry_name: |
    mustafa cengiz
  entry_id:  94947089
  ...
  entry_fav_count: 0
  entry_content: |
    federasyon art niyetliyse başkan niye ceza alacak şekilde konuşsun ki? gayet karşısındaki engellere fırsat vermeyecek şekilde en ılımlı şekilde konuşmuştur. bakmayın siz, fatih terim’in başkanı olmak da çok zor bir iş. abdürrahim albayrak, i love you hocam, marka, değer, motivasyon, kenetlen falan ayağına başkanlığı layıkıyla götürmektedir.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  94912656
  entry_writer: invalid
  entry_fav_count: 0
  entry_content: |
    sohbet, muhabbet etmek isteyeni beklerim.<br/><a rel="nofollow noopener" class="url" target="_blank" href="http://connected2.me/invalid">http://connected2.me/invalid</a><br/><br/>tanım: sözlük yazarlarının yeni insanlar tanıdığı, insanlarla dertleştiği veritabanı.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    koca ülkenin futbol camiası oturdu, bu adamın ve ailesinin geçen sene çizilen karizmasını toparlamaya çalışıyor. ali koç'un başarısız olması, koç ailesinin de itibarını sarsıyor. <br/><br/>öyle ya da böyle bu adam başarılı olmalı. kendi yapamıyorsa yardım edecekler, orası belli oldu. daha fazla çizilmemeli koç ailesinin karizması. kahvedeki adamın diline düşmemeli artık bu mavi gözlü çocuk.
