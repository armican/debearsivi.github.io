...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    organize whatsapp grubu ergenleri algı için bugün fazla mesai yapıyorlar anlaşılan. <br/><br/>ayrıca olmamış olaylar için olmuş gibi başlık açan bu troll sözlükten uçurulur umarım.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    türkiye futbol federasyonu resmen ve alanen bir örgüt olmakla suçlanıyor. demokratik ülkelerde bunun karşılığı lisans iptaliyken bizde dört maçlık bir ödül oluyor maalesef.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    x'i kazandım. dört yıllık mı
  entry_id:  94949611
  entry_writer: paranoid humanoid
  entry_fav_count: 4
  entry_content: |
    vay amk. açılan başlığa bak. hey gidi sözlük.<br/><br/>bana sözlüğü artık bırakma vaktimin geldiğini hatırlatan sıçmık.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    sirf su siimarik yali cocugu sevinsin diye turk futbolunu mahvettiler. hayati boyunca simartilmis bir adami baskan yaparsan olacagi bu.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    moderatör arkadaşlardan bu tarz başlıklar açıp aklınca milleti aptal yerine koyup kendini troll zanneden, komik zanneden ergen arkadaşları sözlükten uçurmasını talep ediyoruz.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    isviçre maç sonunda milli takımımızın teknik direktörünün sporcularımıza, saldırın emri vermesidir.
...
- entry_name: |
  ...
  entry_channels: siyaset
- entry_name: |
    5 eylul 2019 ultraslan aciklamasi
  entry_id:  94950742
  entry_writer: relativity
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=5+eyl%c3%bcl+2019+ultraslan+ciyaklamas%c4%b1">5 eylül 2019 ultraslan ciyaklaması</a>)
  entry_channels: spor
- entry_name: |
