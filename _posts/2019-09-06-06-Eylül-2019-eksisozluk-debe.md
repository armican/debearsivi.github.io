...
- entry_name: |
  ...
  entry_id:  94946128
  entry_writer: kutusayamam
  entry_fav_count: 32
  entry_content: |
    (bkz: <a class="b" href="/?q=avatar+the+last+airbender">avatar the last airbender</a>)
...
- entry_name: |
  ...
  entry_fav_count: 29
  entry_content: |
    etrafa organize, profesyonel bir suç örgütü imasında bulunan adanalı hergelenin fanboyları tarafından hakaret edilen adam gibi adam.<br/>yok mu bir avukatı toplasın şu ergen oğlanları?
...
- entry_name: |
  ...
  entry_fav_count: 27
  entry_content: |
    imamoğlu'na ait olmayıp, imamoğlu göreve gelmeden önce akp’li yöneticiler tarafından açılmış ihalenin şartlarıdır. <br/><br/>ayrıca bu ihale imamoğlu tarafından iptal edilmiştir. <br/><br/>yine baltayı taşa vurdun aktroll.
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    fatih terim'e cezanın tam olarak 19:05'te verilmesiyle gerçek olduğu kanıtlanan operasyon.
  entry_channels: spor
- entry_name: |
    behzat ç.
  entry_id:  94930041
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    5 eylül 2019 galatasaray'ın algı operasyonu
  entry_id:  94947189
  entry_writer: alobabacigim
  entry_fav_count: 8
  entry_content: |
    tipik terim hareketleri, 2 yıldır şampiyon olan ve ileri gitmesi gereken takım bir bok oynamadığı için, tepkileri başka yöne çekiyor ve milyonlarca sığıra yediriyor.<br/><br/>edit. (bkz: <a class="b" href="/?q=terim%27in+disiplin+kuruluna+cagirilmasi+gerekliligi">terim'in disiplin kuruluna cagirilmasi gerekliligi</a>)
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    bu ülkede gerçek şikecinin kim olduğunu herkes bilir.<br/>bu yavşak yapı menfaati olduğu zaman terör örgütünün bile kucağına oturur.<br/>ona buna bok atacağınıza 2 tane efsaneniz niye kırmızı bültenle aranıyor onu açıklayın dalyaraklar.
  entry_channels: spor
- entry_name: |
    #nihatözdemiristifa
  entry_id:  94945733
...
- entry_name: |
  ...
  entry_id:  94949718
  entry_writer: abudugudu
  entry_fav_count: 0
  entry_content: |
    ali koç galatasaray'ı satın alırmış, sen kendin mi sandın koskoca galatasaray'ı. fetö'ye götverene bak sen galatasaray'ı fetö'cülükle suçluyor bir de.
  entry_channels: 
---
