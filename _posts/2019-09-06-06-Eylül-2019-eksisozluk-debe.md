...
- entry_name: |
    uzaylıya inanıp cinlere inanmiyorum demek
  entry_id:  94917146
  entry_writer: activator
  entry_fav_count: 177
  entry_content: |
    birincinin olabilme ihtimali matematiksel olarak kanitlanmistir. ve olma yüzdesi gayet yüksektir. digeri ise sadece ortadoguda dogdugun icin inanman gereken hurafedir. zaten nedense dünyanin baska yerlerinde de görülmez.<br/><br/>edit: <a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/T5kuE6XQ-Zw">https://youtu.be/t5kue6xq-zw</a> dünya disi yasamin formüle edilis sekilleri<br/><br/>edit2: hala x yerde hayaletler, cadılar var vs diyolar. tamam işte bizde cin, batıda hayalet, hindistanda fil kafalı adam, japonya’da küçük kız çocuğu. hepsi tenhada yaşanıyor. fil görmemiş kültür fil mitine sahip olsa anormal derdim, ama hepsi açıklayamadığı şeye kendi kültüründen bişey bulmuş. cin başka yerde yok, çekik gözlü küçük kız görmek da bizde yok. zihinsel stabiliteye sahip olan insan bunun beynin, kişisel kültürel korkularına göre bir oyunu olduğunu anlar.
  entry_channels: siyaset,anket,ilişkiler,bilim
- entry_name: |
...
- entry_name: |
    istanbul'da hayat durmuş durumda
  entry_id:  94939105
  entry_writer: terlikli hayvan
  entry_fav_count: 90
  entry_content: |
    birilerinin cebine akan para durunca hayat durdu sanıyorlar. vatandaş senelerdir parasız yaşıyor. geçiniz boş haber kanalının boş bir haberi.
...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    "yazdıklarını okudum. sen deli şevişen birine benziyorsun. x şehrindeysen ve güzelsen tanışalım. ama çirkinsen olmaz. çirkin kadınla işim yok"<br/><br/>yamuk siklerinizin izdırabı bitmiyor be kardeşim. kadın güzel olsun, çirkinse işim yok, illa sevişelim, şevişmeyecek masraf yapmayayım, kadın benden sevgili olmamı istemesin, konuşmayalım, aramayalım, sadece sevişelim... sevişsevişsevişsekseksekssiksokammemegötseks.<br/><br/>vaadiniz de bir tane yamuk sik, 15 dakika kadının üstünde debelenme, ayı gibi bağırarak boşalma. valla sevişmek için masraf yapmanız gerekiyorsa hiç kaçırmayın. insan gibi davranmadığınızı öğrenirlerse suratınıza sümüklerini atmazlar.<br/><br/>he bir de düzenli görüşmediğiniz kadınlara gecenin abuk subuk saatinde mesaj atmayın. yanında başka adam olabilir, sevgilisi olmuştur belki. kıskanç olabilir, kadına bir zorbalık yapabilir. insanca iletişim kuramadığınız için kadınların güvenliğini düşüneceğinizi sanmıyorum. o yüzden bari ben söyleyeyim dedim.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    yenikapı'ya götürülmeyen lüks makam araçları
  entry_id:  94940792
  entry_writer: koministimam2
  entry_fav_count: 13
  entry_content: |
    (bkz: <a class="b" href="/?q=bir+akpli+a%c4%9fl%c4%b1yordu+g%c3%b6zleri+ya%c5%9fl%c4%b1">bir akpli ağlıyordu gözleri yaşlı</a>)
  entry_channels: siyaset
- entry_name: |
    camilerin üretim ve ilerlemeye olan katkısı
  entry_id:  94929866
  entry_writer: klaasjanhuntelaar
  entry_fav_count: 11
  entry_content: |
    sıfır olsa yemin ediyorum birşey demem.<br/><br/>eksidir. eksilerde...
  entry_channels: siyaset,bilim,tarih,sağlık,eğitim,ekonomi
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    çok büyük ahlaksızlıktır. alenen taşak geçtiğini sanmak ve tarafsızlığı yok etmektir.<br/><br/>akp bütün kurumları kendisi gibi yaptı. yüzsüzlüğün bu kadarı. <br/><br/>koca ülkede fener magandası nihat’ı başkan yaptılar. haliyle tarafsızlık beklemek ne mümkün. arsız soysuzlar.
  entry_channels: spor
- entry_name: |
    erkek yazarlardan kadın yazarlara sorular
  entry_id:  94910377
  entry_writer: hknkaya
  entry_fav_count: 8
  entry_content: |
    din allahla kul arasında sana ne aq dedirten sorular sorduran başlık.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: spor,haber
- entry_name: |
    berat albayrak boşandı mı
  entry_id:  94942206
  entry_writer: liberta1404
  entry_fav_count: 5
  entry_content: |
    boşansaydı şuan hala o makamda olamazdı rahat olunuz
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    benim değişmeyeceğim. <br/>bir kere aldatan hep aldatır
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    güzel zamanları hatırlatan küçük detaylar
  entry_id:  94934493
  entry_writer: fndy
  entry_fav_count: 2
  entry_content: |
    kapağı sıkıca kapalı, dibinde bir damlası kalmış parfümüyle boş bir parfüm şişesi. <br/><br/>güzel zamanları hatırlatmakla kalmaz. koklandığı an ve geçen 1 saniye 35 salise boyunca size zaman yolculuğu yaptırır, ışınlar. koku; zihinsel etkileri mucizevi bir zaman çarkıdır aslında.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    oran: ratio<br/><br/>dikmen: will descend <br/><br/>hatta meşhur bir lafı vardır. ankara's will descend. fuck me if i come again. onun ingilizcesi de budur.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    yarım saattir aspor’da fatih terim yalakalığı yapmakta olan cisim. dayanamadı en son lafı fenerbahçe’ye de getirdi. kudurun lan. bitti hegemonyanız.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    ayrılmanın hayırlısı olacağı kızdır.<br/>böyle bi tehdit yok.<br/>işine gelirse.<br/>o zaman yarın tersoya düşünce de bırakır, aman aman.<br/>allah 'in sevgili kuluymuşsun. at o yüzüğü aslanım. denizde balık çok...
  entry_channels: ilişkiler
- entry_name: |
    nihat özdemir
  entry_id:  94941896
...
- entry_name: |
    60 dakikada 20 kişiyle sevişiyoruz
  entry_id:  94938130
  entry_writer: deathjp
  entry_fav_count: 0
  entry_content: |
    hippi ve rednecklerden bilimum aids ve hepatit kapacak kişi beyanı.üzerine bir de taco yemişler 1 saat tuvaletten çıkamaz artık.
  entry_channels: 
---
