...
data:
- entry_name: |
    tayyip erdoğan'ın ekonomik kriz var açıklaması
  entry_id:  81736421
  entry_writer: saintly
  entry_fav_count: 807
  entry_content: |
    inşallah, reis kendisini fetö'den tutuklatmaz.
...
- entry_name: |
  ...
  entry_fav_count: 65
  entry_content: |
    yaptığınız ince bir espiriyi anladıktan sonra yüzündeki kötü kız gülümsemesi.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    kendini komik zanneden insanlardan oluşan vasat kanal.
  entry_channels: tv
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: tv
- entry_name: |
    dış borcun 457 milyar dolar olması
  entry_id:  81744278
  entry_writer: fernando58
  entry_fav_count: 2
  entry_content: |
    ben cb olsam daha 500 olmamış 500'e tamamlayayım deyip 43 milyar doları daha cukka ederdim düz hesap olsun.
  entry_channels: 
- entry_name: |
    çaylak onay listesi
  entry_id:  81722015
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (null)<br/><br/>(bkz: <a class="b" href="/?q=ek%c5%9fici+ne+arar+la+cennette%3f">ekşici ne arar la cennette?</a>)
  entry_channels: anket,ekşi-sözlük
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  81729217
  entry_writer: benjamin barker
  entry_fav_count: 1
  entry_content: |
    dün de yazdım, 5 gündür sabah 10 a kadar yükselip sonra yüzde 1.x (hatta dün 2 civarı) düşen kurda haftanın son işlem gününün kuru olacak. ben kendi adıma yeniden bu fiyattan alamam diye satmaya cesaret edemiyorum. içimden bir ses 5.95 in altında haftayı kapatacak diyor ancak ben içimdeki sese güvenemiyorum.<br/>geçen haftadan bugüne ne değişti mesela? cb konuşmuyor tabi o büyük artı, rahibin salınması fiyatlanıyor belki ama demekki salınmaz ise 7 den kapıyı açacak bu kur 12 ekimde, bu rahib fetöye üye denmişti bizzat en üst makam tarafından şimdi nasıl salınacak? ( bu ülkede her şey olur, siz bu kardeşinize yetkiyi verin faizle nasıl uğraşılır görün lafından sonra tarihin en yüksek artırımı yapıldı) bence pek oynama yapılmaması gereken bir dönem. 5.7 lere geleceğini sebepleriyle yazan çok yazı fikir okudum, bütün gün de okuyorum ama burası türkiye, ne olacak belli olmaz. ben kendi adıma güvenemiyorum.<br/><br/>kesinlikle ytd
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bırakın sürünsünler bu itler.<br/>acımayın lan şunlara.
  entry_channels: ekşi-sözlük
- entry_name: |
    kasırganın konya'yı değil de izmir'i vurması
  entry_id:  81744730
  entry_writer: gods of war
  entry_fav_count: 0
  entry_content: |
    amk salakları gene toplanmış başlığa.<br/>(bkz: <a class="b" href="/?q=troll">troll</a>)
