...
- entry_name: |
    neden beyaz saray'ı bombalamıyoruz
  entry_id:  73969796
  entry_writer: redkitincinselhayati
  entry_fav_count: 100
  entry_content: |
    abi salacaksın akdeniz kıyısından 3-5 tane bordo bereli, yarım saate 82 <a class="b" href="/?q=washington">washington</a>.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 89
  entry_content: |
    kendim ve ailem ve de çoğu arkadaşımın katıldığı düşünce. hdp denen terörün meclis uzantısıyla ittifak yapan chp, chp değildir. ychp'dir.<br/><br/>içerisinde attaürk düşmanı olan partiye oy vermem. umarım sayın ince kazanır ve chp'yi yine chp yapar.
- entry_name: |
    kaan terzioğlu'un attığı efsanevi tweet
  entry_id:  73968502
  entry_writer: cathars
  entry_fav_count: 84
  entry_content: |
    soyle bir sey anlatmaya calisiyor galiba:<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://lh3.googleusercontent.com/proxy/xRx3kg6ttVSscnwwKX59pA20mrbgM6wHgJTxSeTYznr2HdaazYociUuU4Quil06Z8Y6ilJrr6CvEYVRxNouiG6Gt-bEgf9UOldw=w303-h485-nc" title="https://lh3.googleusercontent.com/proxy/xRx3kg6ttVSscnwwKX59pA20mrbgM6wHgJTxSeTYznr2HdaazYociUuU4Quil06Z8Y6ilJrr6CvEYVRxNouiG6Gt-bEgf9UOldw=w303-h485-nc">https://lh3.googleusercontent.com/…ldw=w303-h485-nc</a><br/><br/>ben bir fark goremedim.
- entry_name: |
...
- entry_name: |
    bir bardak coca-cola'daki küp şeker adedi
  entry_id:  73960215
  entry_writer: valar m0rghulis
  entry_fav_count: 48
  entry_content: |
    sıfır..içmeden sürekli bakıyorum tek bir kesme şeker göremedim..
- entry_name: |
...
- entry_name: |
    penisim kesildi ne yapmalıyım
  entry_id:  73969417
  entry_writer: diffarentiationation
  entry_fav_count: 41
  entry_content: |
    (bkz: <a class="b" href="/?q=g%c3%b6t%c3%bcne+sok">götüne sok</a>)<br/><br/>tutamadım kendimi.
- entry_name: |
    cenk tosun
  entry_id:  73969318
  ...
  entry_fav_count: 38
  entry_content: |
    garibim, aykut kocamanın ingiltere şubesine denk gelmiş. kendi aldırıyor, sonra oynatmıyor. demek her ligte var bunlardan.
- entry_name: |
  ...
  entry_fav_count: 31
  entry_content: |
    kayınbabası can çekişirken elinden geleni yapmaya çalışmış kadın, sevdiğiniz biri ölürken ne yapacaktınız ya? silahı olsa kullanır ama yok. <br/>cesaretine hayran kaldığım, ölmemesine sevindiğim kadını barındıran olay.<br/>adam da yakacak toplarken saldırıya uğramış, o kurtulamamış ne yazık ki
- entry_name: |
    fi
  entry_id:  73952002
...
- entry_name: |
  ...
  entry_id:  73960136
  entry_writer: lepetitbohemian
  entry_fav_count: 22
  entry_content: |
    --- <a class="b" href="/?q=spoiler+i%c3%a7ermekte">spoiler içermekte</a> ---<br/><br/>oturup bunu mu düşündün diyenlere peşin peşin cevabım: evet!<br/><br/>adam şarkısının başında üniversiteli oya kulaklıkla şarkıyı dinliyormuş gibi verdiler ve o detay hoşuma gitti. neyse konu bu değil nostaljik otobüste teyzeyle konuşan oya izmir'de tıp fakültesi okuduğunu istanbul'a sevdiği grubun konserini izlemeye gittiğini söyledi. eski bölümlerde oya üniversite yıllarında edip hocayı aramıştı "intöğrnüm" diye altını çizmişti! o zamanki flashbackte oya karakteri (bkz: <a class="b" href="/?q=g%c3%b6k%c3%a7e+bahad%c4%b1r">gökçe bahadır</a>) iken son bölümde otobüste teyzeyle konuşan oyanın küçüklüğü de üniversiteliydi. e bu kızcağız bir tıp fakültesi lisans süresinde gökçe bahadıra mı dönüştü? vallahi pokemonda pikachu raichu'ya bu kadar hızlı evrilmedi be canısı! neyse!<br/><br/>--- <a class="b" href="/?q=spoiler+i%c3%a7ermekte">spoiler içermekte</a> ---
- entry_name: |
...
- entry_name: |
    anne olmak istemeyenlerin bekar ve sorumsuz olması
  entry_id:  73969586
  entry_writer: etkisizzelaman
  entry_fav_count: 14
  entry_content: |
    oğlum, kadınlar zaten istemediklerini dile getirmiş. ne tarz bir manyaksın sen ? hayır sonuna kadar okudum bir de.<br/><br/>edit : imla ve erkeğim arkadaşlar lütfen...
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    blmediğimden soruyorum, teknik direktör eski takımına nasıl yatıyor?<br/><br/>maçtan önce oyuncularına "beyler çok da kasmayın, sonuçta eski takımım" mı diyor?<br/><br/>ya da antremanda<br/><br/>+hocam, pas çalışması falan yapmıyor muyuz? kontra atak organizasyonları falan?<br/>-yok olum be, sonuçta fenerle oynayacağız, fazla kasmayalım diyorum. <br/>+ ha doğru hocam, haklısınız. <br/><br/>falan gibi bir muhabbet mi geçiyor? <br/><br/>not:gs
- entry_name: |
    la casa de papel
  entry_id:  73966443
...
- entry_name: |
    akp'nin bayrağını liselerde dalgalandıralım
  entry_id:  73968779
  entry_writer: yine ucurun
  entry_fav_count: 5
  entry_content: |
    şehit tabutlarını da akp bayrağına sarın. hem oy olur.
- entry_name: |
    penise kan gitmemesi
  entry_id:  73968075
  entry_writer: mejdu nami
  entry_fav_count: 3
  entry_content: |
    başlık sahibini idam ettiniz amk..<br/>penise kan gitmemesi durumu ciddi bir sorundur..<br/>penis kas ve süngersi bir yapıdan oluşur..<br/>bu süngersi yapı kan ile dolduğunda ereksiyon (sertleşme)oluşur..<br/><br/>belki sevgili yazarımız tam iş tutacakken penisine<br/>kan gitmedi ve panikleyerek bu başlığı açarak<br/>bizlerden yardım istedi ancak siz adamı<br/>gömdünüz amk..<br/><br/>neyse siz şimdi atomu parçalayarak soğuk füzyon<br/>ve nükleer sıçıntı meselelerine devam edin...
- entry_name: |
    o ses türkiye
  entry_id:  73969106
  ...
  entry_fav_count: 2
  entry_content: |
    gökhan biraz önce şampiyonlar yarışsa dodan birinci olur diyerek acun'a o ses türkiye all star pası atmıştır.
- entry_name: |
    mete kalkavan
  entry_id:  73967261
  ...
  entry_fav_count: 2
  entry_content: |
    2. sarıyı verip atmadığı adam daha maçın başında 1 dakika sonra oyundan alınınca herhalde anlamıştır yaptığı hatayı.
- entry_name: |
    chp kurultayında delegelere polis çemberi
  entry_id:  73969880
  entry_writer: cethov
  entry_fav_count: 2
  entry_content: |
    kemal kılıçdaroğlu'nun devleti arkasına alarak, parti içi muhalefeti budamasının göstergelerinden biridir.<br/><br/>muhtemelen, kurultayı ince kazanırsa; mahkeme yoluyla iptal ettirirler.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    beyler bir sezonda kendi kendine 1 milyon tane cenabet gol yiyen takımın şampiyon olmaz şansı yoktur. neyse sezon sonu aziz yıldırım'ın gitmesini kolaylaştırır bu durum en azından. her şerde bir hayır vardır işte.
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    kesinlikle yapılması gereken eylem.neden mi? özet geçeyim;<br/><br/>arabamı parkettim kapısını kilitledim, derken dikkatimi simsiyah bir araba çekti. cam falan hakgetire dersin ki batman'ın arabası o derece siyah. arabamın kapısını kontrol ettim o da ne açık! kilitlenmemiş! tekrar killtledim kontrol ettim bu defa tamamdı. <br/>gitmem gereken yer olan hastane güvenliğine söyledim, sinyal kesici ile kilitlenmesine engel olup soygun yapıyorlar iyi farketmişsiniz cevabını aldım.<br/><br/>çıktığımızda sonradan gelen başka bir aracı bu yöntemle soyduklarını gördük. polis bekliyordu aracın sahibi.<br/><br/>neyse bu da böyle ekşınlı bir anımdı pek özet olmadı ya neyse.umarım kulaklara küpe olur.<br/><br/>not: olayın geçtiği yer esencan hastanesi arka sokakları.ıspartakule tarafında da çok oluyor bu tarz soygunlar aman diyim işi düşen dikkat etsin.
- entry_name: |
    ölümlü dünya (film)
  entry_id:  73970642
  ...
  entry_fav_count: 0
  entry_content: |
    bence paralı veya parasız, gönüllü veya rica minnet, ısmarlama ya da doğaçlama burada övülmesi yerlere göklere sığdırılamaması daha çok izleyiciye ulaşmasını sağlasa bile kime iyilik yapıldığı düşünülüyorsa işte tam ona kötülük yapılıyor. daha çok kişinin izlemesi daha çok kişinin beğenmemesine üstelik daha büyük bir tepki göstermesine neden ola”bilir”.hele hele “çok beğendim..çokk..aşırı” şeklinde sıçıp “kesinlikle gidin” diye tüy dikenler var ki artık dayanılacak sayıda değiller. sanata ve sanatçıya en büyük zararı ucuz basit mesnetsiz propaganda veriyor sanırsam galiba.<br/>e yani notu: filmi özgür iradesi ile beğenenler hariç, beğenmediği halde beğenmiş gibi yapanlar dahil.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    tıpkı eyfel’in görünmediği tek yer olduğu için sürekli eyfel’de takılan <a class="b" href="/?q=guy+de+maupassant">guy de maupassant</a> gibi, serra yılmaz’ın görünmediği ve görünmeyeceği tek ferzan özpetek içeren film olduğu için gitmeyi düşündüğüm film.
- entry_name: |
    altered carbon
  entry_id:  73954558
  ...
  entry_fav_count: 0
  entry_content: |
    5. bölümüne kadar izledim. <br/>felsefi yönden çok kuvvetli bir dizi. <br/>mindfuck konusunda eh işte.. <br/>güzel bir evreni var, hayran kitlesi oluşur gibi. <br/><br/>5. bölüm tabii ki favorim. anlayan anladı.
---
