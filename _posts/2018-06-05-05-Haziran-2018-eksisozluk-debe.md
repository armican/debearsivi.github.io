...
- entry_name: |
    aktrolllerin hesabımı satın almak istemesi
  entry_id:  77706175
  entry_writer: drink
  entry_fav_count: 120
  entry_content: |
    sizinle bariz kafa buluyorlar hocam, diyeceğim başlıktır.
...
- entry_name: |
  ...
  entry_fav_count: 104
  entry_content: |
    (bkz: <a class="b" href="/?q=ed+sheeran">ed sheeran</a>)
...
- entry_name: |
  ...
  entry_id:  77720425
  entry_writer: ne nicki o ne ola
  entry_fav_count: 81
  entry_content: |
    on altı yıldır memleketi yönetiyorsunuz hala başlangıç peşindesiniz. başka kapıya.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    aylardır devam eden operasyonlardır. meme ve siyaset içermediği için sözlük yazarlarının ilgisini çekmemiştir sadece. zeytin dalı harekatı ile eş zamanlı başladı neredeyse, sessiz sessiz ilerliyoruz. itlerin inlerine gireceğimiz günler yakındır.<br/><br/>edit: operasyona dair şok görüntüleri paylaşmak istedim. tc ordusu, bölgede yaşayan kürt kardeşlerimize iftar paketi dağıtarak zulüm <a rel="nofollow noopener" class="url" target="_blank" href="https://twitter.com/Acemal71/status/1002471085990871040" title="https://twitter.com/Acemal71/status/1002471085990871040">ediyor!</a><br/><br/>edit2: operasyonun yeni başladığını zannedenlere ve türk ordusu hakkında atıp tutan embesillere belirtmek isterim, operasyonlarda bugüne kadar kontrol altına alınan bölge neredeyse afrin büyüklüğünde.
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    puding ve petibör bisküvi ile yapılan fakir pastası
  entry_channels: anket,yeme-içme
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    (bkz: <a class="b" href="/?q=troll+ba%c5%9fl%c4%b1klar%c4%b1na+entry+girmeyelim+kampanyas%c4%b1">troll başlıklarına entry girmeyelim kampanyası</a>)
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    herkes cumali koçovalı'yı beklerken <a class="b" href="/?q=john+wick">john wick</a>'in yamaç koçovalı olarak kadrosuna katıldığı dizi.<br/><br/>o nasıl kopya bir bar baskını sahnesiydi ya haha.
