...
- entry_name: |
  ...
  entry_fav_count: 36
  entry_content: |
    fenerbahçe'nin tutunacak tek dalı da kopar diye sayılan goldür.<br/>dünyanın neresine gidersen git o gol iptal edilir. ama burası türkiye unutmayalım.
...
- entry_name: |
  ...
  entry_fav_count: 23
  entry_content: |
    önce topu kontrol etsene saçını sktgm. o pozisyonda topa gelişine birinci sınıf forvetler bile iyi vuramaz amk.<br/><br/>edit: gg olmasın diye küfürler çıkarıldı.
  entry_channels: spor
- entry_name: |
    mbaye diagne
  entry_id:  88904017
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    ligin ikinci yarısında erzurum fenerbahçe ve kayseri maçlarında bırakılan 6 puan sampiyonluk sansini bitirdi malesef. kazanabileceğimiz maçlardı ve takim ikinci yarı günden güne daha iyiye gidiyor hadi geçtim 6 puanı 4 bile almış olsak şimdi başakşehir'in ensesindeydik ama gecti artik. sezon en kotu ikinci bitirilip seneye sampiyonlar ligi kovalanmalı
  entry_channels: spor,tarih
- entry_name: |
    ersun yanal
  entry_id:  88937277
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    aynı soruları görmekten ben bile sıkıldım mk.<br/>neyse benim orjinal sorum en çılgın fanteziniz? <br/>tamam tamam, bulunduğunuz il veya içlede kadın olmak zor mu? taşınsanız nereye taşınırdınız? ülke şehir vb?
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    at hırsızı tipli erkeklerden hoşlanan kız
  entry_id:  88935282
  entry_writer: aristonunpilavi
  entry_fav_count: 1
  entry_content: |
    yukarıdaki arkadaşın görgüsüne güveniyoruz. bravo kardeşim, iyi bir analiz.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    gördünüz mü laleler belhanda'sız galatasaray'ı. 10 kisilik takim pozisyon bulamadı. belhanda mental olarak kötü olabilir ama galatasaray'ın yarısıdır.
  entry_channels: spor
---
