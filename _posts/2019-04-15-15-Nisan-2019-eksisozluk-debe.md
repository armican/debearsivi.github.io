...
- entry_name: |
    no dm + kün feyekün + imitasyon balenciaga
  entry_id:  88923429
  entry_writer: serguzestyani
  entry_fav_count: 97
  entry_content: |
    (bkz: <a class="b" href="/?q=s%c3%bcmeyyeleri+koruma+derne%c4%9fi">sümeyyeleri koruma derneği</a>)<br/><br/>(ya bu entry tutmuş bi dakika, burdan köyde yaşayan babaanneme çok selam söylemek istiyorum ayrıca fransaya gidip bizi unutan kuzenime ayrı bi selam söylemek istiyorum.)
...
- entry_name: |
  ...
  entry_fav_count: 22
  entry_content: |
    eminönünde satılan, enflasyonla topyekun mücadele kapsamında fiyatı uygun tutulmuş sağlıklı ve doyurucu menü.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://eksiup.com/bfa342c7e872" title="https://eksiup.com/bfa342c7e872">link</a> <br/><br/>az önce 3 tane yedim hem iyice doydum hem param cebimde kaldı. şimdi bu mosmor caddede dev tavşanların arasından keyifle yürüyerek evime gidiyorum.
...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    hakemler hata yapar ama sen orospu çocuğusun.
  entry_channels: spor
- entry_name: |
    alper potuk
  entry_id:  88935211
  ...
  entry_fav_count: 19
  entry_content: |
    önce topu kontrol etsene saçını sktiğim. o pozisyonda topa gelişine birinci sınıf forvetler bile iyi vuramaz amk.<br/><br/>edit: gg olmasın diye küfürler çıkarıldı.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    yillardir fenerbahceyi yenmek icin oynadi ama bu sefer sampiyonluk icin oynayacak. hedef bu olunca daha saglam oynayacaklarini dusunuyorum.
  entry_channels: spor
- entry_name: |
    tolgay ali arslan
  entry_id:  88933582
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    bugün golü var. yazın kenara. maç sonu görüşürüz.
  entry_channels: spor
- entry_name: |
    fatih terim
  entry_id:  88935484
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    beceri yoksunu, aldığı 1,3 milyon euro haram olan, kendisinin sahada yaptıklarını 95-02 arasında mahallede top oynamış herhangi bir cabbar cevval türk gencinin de yapabileceğini düşündüğüm canlı.<br/><br/>bencilliği ve oyunu okuma yoksunluğuna da yazacak yorum bulamıyorum.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    öncesinde faul olmasına rağmen hakemin tekrar izlemeye gerek duymadığı goldür. yazık.<br/><br/>not: atiba fc.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    kesinlikle bir sevgilisi, nişanlısı, eşi, vb... olduğu halde gözü dışarıda olan erkeklerdir. aldatmaya meyilli olan, aldatmaya kılıf uyduran erkeklerdir.
  entry_channels: anket,ilişkiler
- entry_name: |
    o sene bu sene
  entry_id:  88936846
  ...
  entry_fav_count: 1
  entry_content: |
    böbreği, dalağı, tarlayı, hanımı, çocuğu bu sene gs'ye basan adamların mottosu idi.<br/><br/>şu an ne yapıyorlardır acaba..
  entry_channels: spor
- entry_name: |
    ersun yanal
  entry_id:  88935648
  ...
  entry_fav_count: 1
  entry_content: |
    bugün fatih terimle yer değiştirseydi ersun yanal fener fark yerdi, o alper potuk hamlesi ne kadar akıllıca bir hamleydi, lakin boyalı sarı saçını siktiğimin alperi kontradan atamadı fenerliler saç baş yolmuştur, bizse ndiaye çıkarıp sinan gümüş aldık, feghouli çıkarıp mitroglou aldık. hadi feghouli neyse de ndiayeyi çıkarıp sinan gümüşü almak nedir ya. 10 kişi fener daha iyi ileri oynadı ortasahadan. valla ne diyeyim, artık çoluğumuz çocuğumuz görecek kadıköy galibiyeti. bu fatih terimle falan olacak iş değil
  entry_channels: spor
- entry_name: |
    bülent yıldırım
  entry_id:  88910813
  ...
  entry_fav_count: 1
  entry_content: |
    <a class="b" href="/?q=14+nisan+2019+fenerbah%c3%a7e+galatasaray+ma%c3%a7%c4%b1">14 nisan 2019 fenerbahçe galatasaray maçı</a>'nın var hakemi olacağı iddia edilen şahıs.<br/><br/>sahada fenerli, monitör başında fenerli... ikisi de tetikçi...<br/><br/>yanına da avar olarak aziz yıldırım'la mahmut uslu'yu verin bari şerefsizler, ayıp olmasın.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    bazen görüyorum yolda falan. şu klasik hırbo tıraşlı, bol paça pantolon altına fosforlu ayakkabı giyip tek el cepte veya belde yürüyen kekoların yanında baya baya güzel kızlar oluyor. kızın giyimi, görünüşü falan normal görünüyor ama yanında at hırsızı var. anlam veremiyorum tabi. demek ki bazı kadınlarda bir bug var ve bu hırbolar bunu keşfetmiş.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    fb bu sezon oynadigi 4 derbide geriden gelip 4 beraberlik aldi. gs'i 2-0 dan bjki 3-0 dan cevirdi. kendi evinde de geriye dustugu halde 1-1 bitti maclar.
  entry_channels: spor
- entry_name: |
    ali koç
  entry_id:  88937546
  ...
  entry_fav_count: 0
  entry_content: |
    ali koç vizyonu, ali koç modeli top toplayıcı çocukları eğitmekle gerçekleşir.<br/>auta giden topu sahaya atmamalar. atınca iki top birden atmalar..<br/>23 puan farkını korumak için değer mi vizyon reis.
