...
- entry_name: |
  ...
  entry_fav_count: 190
  entry_content: |
    (bkz: <a class="b" href="/?q=ankara">ankara</a>)<br/><br/>işin kötüsü, çok iyi araba kullandıklarını sanıyorlar.<sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    ne sikindirik bir silahtır g3 varya.. toplamayı açmayı bilsen ne olacak anasını satayım. ota boka tutukluk yapar adamı deli eder
  entry_channels: anket,ilişkiler
- entry_name: |
    döner ayran 4 tl
  entry_id:  88928864
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    kimsenin<sup class="ab"><a title="(bkz: haklı olarak)" href="/?q=hakl%c4%b1+olarak" data-query="haklı olarak">*</a></sup> siklemediği sözlük özelliği. bir futbol maçına binlerce entry giren adamlara ne sorayım, neyin cevabını bekleyeyim allah aşkına. kaldırın şu özelliği, görüntülü arama falan koyun yerine de canımız sıkıldıkça arayıp sövelim millete.
...
- entry_name: |
    o sene bu sene
  entry_id:  88916713
  entry_writer: smyrna1925
  entry_fav_count: 1
  entry_content: |
    o sene bu sene diye diye tam 20 sene oldu. bence 21'e doğru yol alıp gidecek.
  entry_channels: spor
- entry_name: |
    ersun yanal
  entry_id:  88935648
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    kızların babalarını arzulaması durumunun tezahürüdür.
  entry_channels: anket,ilişkiler
- entry_name: |
    ali koç
  entry_id:  88925939
  ...
  entry_fav_count: 0
  entry_content: |
    secim konusmalarinda, " aziz yildirim kendi sahamizda rakibimize sampiyonluk yasatti" deyip alttan alttan vuruyordu. bakalim 20 senelik bu rituelin bozulmasi sonucunda vizyon reisin hali nice olacak.
