...
- entry_name: |
    bakan albayrak'ın baş döndüren ekonomi diplomasisi
  entry_id:  88913974
  entry_writer: eksi peace
  entry_fav_count: 122
  entry_content: |
    leş hürriyet haberi.<br/><br/>toplantıya katılan ekonomistler twitter’da dalga geçiyor bizim damatla, hürriyet'e göre ise türkiye’nin ekonomi politikaları ve krizden çıkışı büyük beğeni toplamış.<br/><br/>at yalanı sikeyim inananı.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    baharı yaz uğruna tükettik, <br/>aşkı naz uğruna<br/>ve papatyaları seviyor sevmiyor uğruna; derken ömrü tükettik <br/>bir hiç uğruna. <br/><br/><a class="b" href="/?q=sezai+karako%c3%a7">sezai karakoç</a>
...
- entry_name: |
    ali palabıyık
  entry_id:  88932729
  entry_writer: sidartha
  entry_fav_count: 1
  entry_content: |
    hakemin fenerbahçenin lehine maç yönettiğini söyleyenlere akıl fikir diliyorum.
  entry_channels: spor
- entry_name: |
    younes belhanda
  entry_id:  88932677
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bugün volkanla kavga edip karşılıklı kırmızı kart göreceklerdir.
  entry_channels: spor
- entry_name: |
    ali koç
  entry_id:  88925939
