...
- entry_name: |
  ...
  entry_fav_count: 89
  entry_content: |
    balık resmi paylaşıp göç yılları yazan ve canım büyük dedem diye bitiren insan, çok yaşa emi deminden beri gülüyorum amk.<br/><br/>edit1 : malum hayvanın türü semendermiş. cahilliğin gözü kör olsun. bilgilendiren arkadaşa teşekkürler.
...
- entry_name: |
  ...
  entry_fav_count: 26
  entry_content: |
    (bkz: <a class="b" href="/?q=hollanda">hollanda</a>)<br/><br/>(bkz: <a class="b" href="/?q=at+yalan%c4%b1+sikeyim+inan%c4%b1">at yalanı sikeyim inanı</a>)
...
- entry_name: |
    baba kapıyı kapatır mısın sevişiyorum diyen kız
  entry_id:  79733989
  entry_writer: api alper
  entry_fav_count: 19
  entry_content: |
    namus kompleksi ile çok da alakasının olmadığını düşündüğüm, extra large bir babaya sahip bir kızın kurduğu yakışıksız cümledir. cinsiyet ayrımı yapmaksızın bakmak lazım aslında, bu cümleyi bir erkek de kursa yine aynı şekilde yakışıksız olur. nasıl ki babanız sizin yanınızda sevişmiyor, siz de onun yanında sevişmeyin.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: anket,ekşi-sözlük
- entry_name: |
    türkiye'de esrar satışının serbest olacağı gün
  entry_id:  79736426
  entry_writer: sherlockholbes
  entry_fav_count: 2
  entry_content: |
    nedense bana esrarın yasallaşmasına en çok tarikat ve cemaatler sevinecekmiş gibi geliyor.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    sadece; taraflardan birinin gorece daha az cekici ve guzel oldugu durumda mumkundur...seksuel enerji aciga cikmayacak yani..anlatildi olum bunlar hep buralarda..
  entry_channels: ilişkiler
- entry_name: |
