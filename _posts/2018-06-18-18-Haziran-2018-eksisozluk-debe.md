...
- entry_name: |
    17 haziran 2018 binali yıldırım'ın linç yemesi
  entry_id:  78142703
  entry_writer: otoban kedisi
  entry_fav_count: 528
  entry_content: |
    ekonomiyi donanım haber ölücülerine teslim edin , 10 sene içinde g5'e girmezsek yakama yapışın.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
    rte'nin ince'ye karsi 2.turda beklettigi kozlar
  entry_id:  78166674
  entry_writer: 17december
  entry_fav_count: 11
  entry_content: |
    olmayan kozlardir.<br/><br/>zaten yukarida yazilanlardan “ramazanda bira icti” maddesi haricinde hepsini meydanlarda soylemektedir.
  entry_channels: siyaset
- entry_name: |
    muharrem ince tarzı şiir yazma rehberi
  entry_id:  78166384
  entry_writer: denizin kentini yakan adam
  entry_fav_count: 7
  entry_content: |
    bisiklet<br/>traktör<br/>selo ya özgürlük <br/>abazayım gelsene<br/>yalova <br/>yalama
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    uzun senelerdir kullanırım. bir de puanlama sistemi getirdiler. her siparişte puan kazanıyorsun falan. merak ettim bir baktım, neymis puanina göre muhtar oluyormuşsun, ünvan alıyormuşsun. ergen miyiz ulan biz? yap doğru düzgün indirim vs. sushico uygulamasından çift kişilik yemek kazanmışlığım, sürekli indirim almışlığım vardır. burada ancak muhtar oluyorsun puanlarınla dalga geçer gibi.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    terörist deyip geçmek kolay. ne yapmış, neden yapmış, neler anlatmış, nasıl engellenmiş ve cezalandırılmış iyi analiz etmek lazım.
  entry_channels: siyaset
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ilçe seçim kurulu kararıyla sultanahmed'de yapılamayan program. <br/><br/>iyi parti ise mitinglerin görsellerini paylaşıp nedir sizi bu kadar korkutan başlığı ile paylaşımlar yapıyor.
  entry_channels: siyaset,tv
---
