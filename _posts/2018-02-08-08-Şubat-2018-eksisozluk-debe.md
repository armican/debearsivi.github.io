...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    senin ben ecdadını sikiyim, amk orospusu. <br/><br/>hiç mi vicdanın sızlamadı orospu, küçücük çocukları ailelerinin maddi gelirlerine göre sınıflandırırken? o fakir çocuklarını ayağından ayakkabıyı çıkartarak dövmek için nasıl bir sebebin, nasıl bir kinin vardı? o en ön sıraya oturttuğun zengin aile çocuklarına bir fiske bile vurmamışken bizleri evire çevire nasıl dövebildin vicdanını siktiğim. dersi bile tüm sınıfa değil sadece o zengin piçlerine anlatırdın. şaka maka sen nasıl bir orospuydun ya, hala düşündükçe çıldırasım geliyor. tez zamanda geberir gidersin umarım. dursane orospusu.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    klasik bir gülse birsel dizisi.<br/><br/>formül basit:<br/>* 4-5 farklı mekan belirle.<br/>* birbirinden garip, şiveli konuşan karakterler tasarla.<br/>* bu karakterler aynı zamanda aptal hareketler ve mimikler de yapsın.<br/>* yüzyıllardır yapılan esprileri yap.<br/><br/>avrupa yakası yedi çünkü yeniydi. sene olmuş 2018, yeter da.
- entry_name: |
    ilber ortaylı üslubu
  entry_id:  74047995
  entry_writer: mohendisbeyy
  entry_fav_count: 8
  entry_content: |
    1960 anayası (bkz: <a class="b" href="/?q=biliyosun">biliyosun</a>) bıdı bıdı.<br/>bilmiyoruz amk bilmiyoruz
- entry_name: |
    emre belözoğlu
  entry_id:  74053045
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    bahar arif'le olmalı. kadına bir katkısı olsun istiyorsa senarist, lütfen bir defa daha sevebileceğini göstermek olsun bu. <br/><br/>sarp'ı diri görmek istemediğim dizi. en iyi sarp ölü sarp.
- entry_name: |
...
- entry_name: |
    ekşi sözlük iş ağı
  entry_id:  74054456
  entry_writer: windows kullanan mac hayrani
  entry_fav_count: 0
  entry_content: |
    ankara üniversitesi, italyan dili ve edebiyatı mezunuyum. acil işe ihtiyacım var. <br/><br/>italyanca öğretmenliği de dahil olmak üzere italyanca ile ilgili her işi yapabilirim. özel ders verebilirim. a1-a2-b1-b2 ders içeriği hazırlayabilirim. dış ticaret şirketlerinde ofis işi de yapabilirim. <br/><br/>ancak esas istediğim; yayınevinde editör asistanlığı yapmak ve işi öğrenip deneyim kazanmak. yayıncılık çok içine kapanık bir sektör olduğu için, böyle bir şey bulmak çok zor. yine de bir umut buraya da yazayım dedim.<br/><br/>lokasyon olarak istanbul ya da izmir.
- entry_name: |
