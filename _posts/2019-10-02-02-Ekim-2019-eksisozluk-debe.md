...
- entry_name: |
    beymen'de 629 tl'ye satılan poşet mendil
  entry_id:  96028912
  entry_writer: uykuludomates
  entry_fav_count: 39
  entry_content: |
    %100 ipek mendilin a101deki kağıt peçetelerle karşılaştırılmasına neden olan fiyat.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    sevilen aşık olunan insanla yapıldığında uzun soluklu bir oynaşmaya dönüşebilir. kalbi, kan dolaşımını hızlandırır, ruhu gençleştirir. bağları güçlendirir, hisleri tazeler...<br/><br/>(bkz: <a class="b" href="/?q=ayriyetten+aganigi+naganigi">ayriyetten aganigi naganigi</a>)
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    doğru düzgün kafaniza göre bir eş seçmiş olmaktan başka hiçbir neden geçerli ve güzel olamaz. <br/><br/>doğru insanı seçin. mantıklı olun.
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    (bkz: <a class="b" href="/?q=100+bin+lira+para+m%c4%b1+lan+it">100 bin lira para mı lan it</a>)
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    nasıl yeni vergileriniz hoşunuza gitti mi, iyi miymiş böyle ? <br/><br/>güle güle kullanın :)<br/><br/>sizinle ilgili sürprizlerim daha bitmedi. yakında çocuklarınızla ve yakın akrabalarınızla ilgili çok güzel sürprizlerim olacak; bayılacaksınız size hazırladığım bu sürprizlere.
  entry_channels: anket,ilişkiler,edebiyat
- entry_name: |
    buz gibi erkek götü
  entry_id:  96025314
  ...
  entry_fav_count: 1
  entry_content: |
    dondurma kaşığını daldırıp külahın üstüne konan iki top dondurma gibidir. kimi kızlar buna bayılır. kimisi demek hata olabilir geneli bayılır. <br/>afiyet olsun hanımlar.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    çirkinim ulan var mı amk? <br/><br/>beni görsen anana tanrı diye taparsın; benim gibi çirkin yaratık olmadığın için.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    acil şifalar diliyorum. umarım daha geniş kitleye duyurma imkanımız olur.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    altyazı için bir şey diyemeyeceğim yaşlılar ve çocuk-ergen kısmın çoğu ingilizceye o kadar hakim değil.<br/><br/>diğer yandan dublaj izlemek harbi amelelik.
  entry_channels: 
---
