...
- entry_name: |
    cübbeli ahmet ve fatih nurullah'ın muaviye kavgası
  entry_id:  74325088
  entry_writer: joco
  entry_fav_count: 80
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    parababaları tarafından beslenen "türk" kimlikli işbirlikçiler tarafından katledilmiş olan devrimci önderdir.<br/><br/>katledilmesinin nedeni, bazı parababası yandaşları gibi 6. filoya secde durmadığı içindir.<br/><br/>dünyanın en büyük terör örgütü nato ve işbirlikçisi akp-mhp'nin sempatizanlarına duyrulur!
- entry_name: |
...
- entry_name: |
    tarımda iyi para olması
  entry_id:  74332376
  entry_writer: haciz mahallinde tango
  entry_fav_count: 2
  entry_content: |
    hiç zengin çiftçi-köylü görmediğimden, siktir git diyor ve uğurluyorum.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    ben uyurken <br/>duvarıma tırmandın<br/>güllerimi yoldun.<br/><br/>ve bütün şikayetin<br/>sen uyurken<br/>bahçene girenlerden.<br/>(bkz: <a class="b" href="/?q=%c3%b6zdemir+asaf">özdemir asaf</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    en yanlış psikoloji şu;<br/><br/>"11 bin'den satıp 6'binden alabilirdim, yanlış yaptım".<br/><br/>11 bin seviyesindeyken fırlayıp 25 bine çıkmayacağını nereden bilecektin? şimdi biliyor musun mesela yarın ne olacak?<br/><br/>diyelim 11 bin seviyesindeyken düşeceğini öngördün ve sattın... 6 bin'den döneceğini nereden bilecektin? bilemeyecektin tabiki. 6 bin olduğunda açgözlülükle "bu biraz daha düşsün, 5500'ü görür bu" diyecektin ve sen beklerken tekrar 7 bin'e çıkacaktı.<br/><br/>şu uçlardaki seviyelere göre hesap yapıp "şu kadar zararım var" demeyi bırakın. daha önce de söyledim, bitcoin uzun vadede yükselir ama kısa vadede yaşananlar tam bir kaos. bilemezsiniz. dolayısıyla al-sat yapmak da net bir şekilde kumardır. asla kazanacağınızın garantisi yoktur ve bence kaybetmeniz daha olasıdır.
- entry_name: |
    ölümlü dünya (film)
  entry_id:  74330229
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    kesin soylenmistir ama yine soyleyeyim. <br/>abi yemeyin. yediklerinizde az porsiyon olsun. 3 beyazdan tatlidan aburcuburdan kahve cay meyvesuyu alkolden uzak durun. pis bogaziniza hukmedin.<br/>bunlari yaptin ablam abim ve veremedin mi bak acik konusayim saglik problemin vardir.<br/>6temmuzda 141 kilo olan ben bugun itibati ile 92 kilo 180cm boy ile omrumu devam ettiriyorum. yeter mi?
- entry_name: |
    19 şubat 2018 gençlerbirliği göztepe maçı
  entry_id:  74336368
  entry_writer: nickolangelo
  entry_fav_count: 0
  entry_content: |
    göztepe galibiyet dışında bir sonuç ile ayrılırsa çok üzüleceği maç olacaktır.<br/><br/>bu maç ligi nasıl takip edeceğimizi gösterecek olan maç. eksiklerimiz vs. var eyvallah ama tam kadro kaçırdığımız fırsatların telafisi için bu maçta eksiklikler bahane olmamalı. <br/><br/>özellikle defans ve kaledeki eksiklerimizden dolayı, en iyi savunma saldırıdır anlayışı ile ofansif bir kadro ve oyun bekliyorum.
---
