...
- entry_name: |
    bjk münih ile maç yaparken fb ile gs ne yapacak
  entry_id:  74344990
...
- entry_name: |
  ...
  entry_fav_count: 23
  entry_content: |
    birisinin hayatının neresinde olduğunuzu belli değilse, hiçbir yerinde olmayın. çünkü, belirsizlik değersizliktir.
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    (bkz: <a class="b" href="/?q=k%c3%b6pekler+istedi+diye+atlar+%c3%b6lmez">köpekler istedi diye atlar ölmez</a>)
- entry_name: |
    çukur (dizi)
  entry_id:  74344001
...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    alp kırşan:<br/><br/>1- bu ödül benim de favorim<br/>ödül: mercimek<br/><br/>2- büyük ödüller bu sene çok erken başladı<br/>ödül: muratbey kaşarlı sandviç <br/><br/>3- ödülüme çok güveniyorum<br/>ödül: eti topkek<br/><br/>sonuç: tüm takımlar aşırı sevinip alkışlarlar, tezahürat yaparlar.<br/><br/>adamla dalga mı geçiyorsunuz?
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    diğer çocukları fark etmediğimiz için olabilir mi?<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?time_continue=9&amp;v=MQcN5DtMT-0" title="https://www.youtube.com/watch?time_continue=9&amp;v=MQcN5DtMT-0">https://www.youtube.com/…e_continue=9&amp;v=mqcn5dtmt-0</a><br/><br/>bütün çocuklar güzel. yüzlerine, gülüşlerine, gözlerine bakmak yeterli.<br/><br/>kıyafetine, saçına başına bakınca finansal algılar insanı yanlış yönlendiriyor. ceketinin ne kadar marka ve tatlı olması, bazen o çocuğun daha sıradan giyinmiş başka bir çocuktan daha güzel olduğu algısını getiriyor. <br/><br/>tabii beslenme, daha iyi yaşam koşulları vs. diyen bütün arkadaşlara da katılıyorum bunları söylerken. bunlar da çok önemli boyutlar.
- entry_name: |
    sylvester stallone
  entry_id:  74333881
...
- entry_name: |
    fatih terim'in bayılan gomis'i oyundan çıkarmaması
  entry_id:  74338828
  entry_writer: percemkus
  entry_fav_count: 6
  entry_content: |
    40 yıllık hekimim( yalan tabi 23 yıl oldu ama) böyle bir şey ilk defa duyuyorum.<br/>bayılıp ayıldıktan sonra daha güçlü oluyor lafını hangi dr söyledi ise tanışmak istiyorum
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    kış vakti açta açıkta bırakmıştır biz sevenlerini.
- entry_name: |
    19 şubat 2018 özel marmaradent hastanesi rezaleti
  entry_id:  74345406
  entry_writer: de nada
  entry_fav_count: 2
  entry_content: |
    dostoyevski'den bir ilham var. (yer altından notlar) (insanın kendini başkasını sonra yine kendini sonra yine başkasını suçlaması...)<br/><br/>yazı bilinç akışı tekniği ile yazılmış.<br/><br/>rezilliği tam olarak anlayamıyorsunuz ama çok yoğun hissediyorsunuz. <br/><br/>bence yazı müthiş.
- entry_name: |
    engin geçtan
  entry_id:  74343405
  ...
  entry_fav_count: 1
  entry_content: |
    ismi gibi uçsuz bucaksız bir insan. kitaplarından biliyorum bunu tabii. ne yazık ki hiç tanışma imkanım olmadı ve bugün vefat haberini aldım. türk psikiyatrisinin başı sağolsun, en çok da hayatına dokunduğu, yaşama tutunmasına vesile olduğu hastalarının.
- entry_name: |
