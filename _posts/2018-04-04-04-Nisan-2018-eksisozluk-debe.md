...
- entry_name: |
    türk erkeğinin sekse olan abartı düşkünlüğü
  entry_id:  75661242
  entry_writer: at herif
  entry_fav_count: 413
  entry_content: |
    yokluktandir.<br/>dünya üzerinde 20 25 yil yasayip çiftleşmeyen canli var mi.bak insan demiyorum.bizim ülkedeki gençliğin yarisi böyle amk.
- entry_name: |
...
- entry_name: |
    ege'nin abartılmış balon bir bölge olması
  entry_id:  75658586
  entry_writer: yedinci element
  entry_fav_count: 68
  entry_content: |
    ege, türkiye'nin tüm kültürel yükünü sırtında taşır. beş bölgenin yobazlığını ege, akdeniz bir de trakya dengeler.<br/><br/>siz ege'ye gelip de çayır, çimen; su, deniz aramayın. insan arayın insan.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    keşke gerçekten afrin'e inseydi uçak. istedikleri model silah verip salsalardı bunları sahaya. panik atağı görürdüm o zaman.<br/><br/>keselerini doldurmaya çalışan tiplerin neşeyle yaptıkları turistik geziyi anlattıkları röportaj.
- entry_name: |
...
- entry_name: |
    ilk adımı kadından bekleyen erkek
  entry_id:  75659152
  entry_writer: piskoku
  entry_fav_count: 12
  entry_content: |
    tanım: ilk adımı erkekten bekleyen kadından farksızdır. yanlış yapmak istemez, kalp kırmaktan çekinir, karşısındakinin samimiyetinden emin olmak ister, temkinlidir, <a class="b" href="/?q=tongaya+d%c3%bc%c5%9fmek">tongaya düşmek</a> istemez, genelde aşk adamıdır, pislik peşinde değildir.
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    defter sayfalarının soluna kenar süsü yaparak büyümüş neslin kaçınılmaz hastalığıdır.<br/><br/>edit: kolon ne yahu! sütun olacaktı.
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  75658597
  entry_writer: sarki soyleyen ringo
  entry_fav_count: 6
  entry_content: |
    biz onları çok severken onlar bizi pek sevmez. en çok bu zoruma gittiği için aklıma bu gelir.
- entry_name: |
    ibrahim tatlıses
  entry_id:  75677192
  entry_writer: snifff
  entry_fav_count: 5
  entry_content: |
    o kafada keleş mermisi bile beyni bulamadı gerisini siz düşünün
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    aklını derse getirsin, getirmekle kalmasın kullansın, ezberletmek yerine analitik düşünmeyi ve bu yolla kendini geliştirmeyi öğrencilerine aşılasın, kişisel inanç ve değerlerini empoze etmesin, inanç ve değerlerini kendine yakın gördüklerine ayrım yapmasın, objektif değerlendirme kriterleri ile başarım ölçümü yapsın da ne giyerse giysin....
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    yok daha neler aq. biz paltoyla giriyoruz lan günah diye.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    “her an iptal edebilirim, sıkıldım, ne yapsam acaba” gibi entry’ler yazan suserlarla iletişime geçip 2 ay bedava üyelik tanıyorlar herhalde diye düşünüyorum. netflix ve netflix turkiye başlıklarını takip ediyorum, sık sık yazılıyor bunlar iki üç satır. bunlar şifreli konuşma falan değilse kesin bedava veriyor netflix.<br/><br/>- hşşt, netflixte izlenecek dizi kaldı mı?<br/>- yok şimdilik, bekliyoruz bakalım<br/>- 3 kişi bi araya gelmeden abone olmayın ha.<br/>- tabi tabii aklımda, haftaya geliyor 2 yeni abone. şimdi televizyon bakıyoruz.
- entry_name: |
    kelebekler
  entry_id:  75673893
  ...
  entry_fav_count: 1
  entry_content: |
    tolga karaçelik'le film hakkında şöyle bir söyleşi yapılmış: <a rel="nofollow noopener" class="url" target="_blank" href="http://www.milliyetsanat.com/haberler/sinema/yonetmenlik-olarak-en-zor-filmimdi-kelebekler-/9834" title="http://www.milliyetsanat.com/haberler/sinema/yonetmenlik-olarak-en-zor-filmimdi-kelebekler-/9834">http://www.milliyetsanat.com/…imdi-kelebekler-/9834</a><br/><br/>şahsen filmi merak ediyorum ve henüz izlemedim ama, tolga karaçelik'in sürekli "gerçeküstücülük" vurgusu yapmasından dolayı hafif önyargı kazandım. sarmaşık'taki bir "sarmaşık" sahnesiyle film hemen gerçeküstücü mü oldu? bir sahne buna yeter mi? hayır, hatta bence alakası yok ve olmasına da gerek yok. marquez'ler, borges'ler, "latin amerika'nın gerçeküstücü damarı" falan, tamam çok şahane, tamam çok popi, ama sen zaten güzel film yapıyorsun, nedir "marquez'in oğlu dedi ki babam senlen gurur duyardı beeh" vurgusu bilemedim.<br/><br/>neyse, filmi muhtemelen beğeneceğim gene de.
- entry_name: |
