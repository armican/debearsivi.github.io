...
- entry_name: |
    babam adam ol dedi bende ak partili oldum
  entry_id:  75682107
  entry_writer: hadi git
  entry_fav_count: 82
  entry_content: |
    dahi anlamındaki de’yi ayıramayan cahil evlatların kuracağı cümle.
- entry_name: |
    midyeci ahmet
  entry_id:  75665536
  entry_writer: yule
...
- entry_name: |
  ...
  entry_fav_count: 27
  entry_content: |
    sürekli erteleyip durduğu, yapılması gerken can sıkıcı şeyleri yapması. hem de motive olmaksızın, hazır hissetmeyi beklemeksizin bir anda karar verip yapması. mesela yarın sınavın var ama oturup çalışmak hiç içinden gelmiyor. hiçbir şey düşünmeksizin oturup o işi yapmaya başla. beynin seni o işi yapmaya hazırlayacak. çalışmayı bitirdiğinde kendini çok mutlu hissedeceksin ve kendine büyük bir iyilik yapmış olacaksın. projeyi yetiştirmen gerekiyor, zamanın az kalmış ama projeye devam etmek istemiyorsun, sıkılmışsın. bir yerden başla. ingilizlerin dediği gibi, <a class="b" href="/?q=just+do+it">just do it</a>.<br/><br/>özdisiplin, insanı sonunda mutluluğa götürecek başarının anahtarı. öncelikle ona sahip olmak gerekiyor. dolayısıyla insanın kendine yapacağı en büyük iyilik, iradesini güçlendirmesi ve özdisiplini sağlaması.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    yeni türkiye, türban vurgusu falan yaparak bölücülere sahip çıkan, aslında türkiye'nin ne yenisi ne eskisi, ne başörtülüsü/örtüsüzü ile bugüne kadar ilgilenmemiş, ekşi terör sevici başlığı.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    boş zamanını kadikoy'de geciren basortuluden ziyade malum zihniyete 7/24 yalamalık yapıp hayatını laik seküler kesim sayesinde kazanan, malum zihniyete kalsa işsiz kalacak sanatcılar bana daha garip geliyor.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    sınıf öğretmeni tunç’un seneler sonra john lennon olduğu dizi.
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    "ihtimallerin heyecanına üzülmek sadece aptallara özgüdür."
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    18.06.2008 tff'den aliağa belediyespor'un isminin göztepe olarak değiştirmesine onay.<br/>türkiye futbol federasyonu, tff 3. lig'de mücadele eden aliağa belediyespor'un isim, renk ve logo değiştirme talebine onay verdi. yapılan başvuruyu inceleyen futbol federasyonu hukuk kurulu, profesyonel liglerdeki geçmiş örnekleri de inceleyerek değişiklik talebini uygun buldu. <br/><br/>şu an göztepe adıyla süper ligde oynamaktadır. asıl göztepe nerede?
- entry_name: |
    erkek yazarlardan kadın yazarlara sorular
  entry_id:  75660975
  entry_writer: bendebirben
  entry_fav_count: 2
  entry_content: |
    hakikaten entelektüel, okumuş, kültürlü yoksul biri mi yoksa parası pulu olan düz ya da egoist bir adam la mı birlikte olursunuz ? nedeni nedir?
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    insan olmakla açıklanmaya çalışılan kaynak. insan deyince işin içine dünya savaşları, sömürü, işkence, toplama kampları, gaz odaları da girer. demek ki savunulması gereken insan olmak değil olamamak olmalı. onu geçtim, darwin’in tezi evrim’de nihai bir amaç olduğu varsayımını reddeder. darwin canlıların rastlantı sonucu nihai bir amaçları olmadan doğal seleksiyon mekanizması çerçevesinde evrildiğini iddia eder.insan dünyanın ve doğanın skinde değildir. dünyanın ve doğanın herhangi bir amacı yoktur, darwin abimizin tezi basit anlamıyla budur. o yüzden kalkıp iyiliğin kaynağını insan olmakla açıklamak cahillikten başka bi şey değildir. lütfen ateistliğinizin hakkını verin, dinlere vurayım derken kendinize de yazık ediyorsunuz.
- entry_name: |
    kediyle ev almak haramdır
  entry_id:  75682390
  entry_writer: fahdedi
  entry_fav_count: 0
  entry_content: |
    bugün beni de benden almış yanlış okumadır.<br/><br/>kucağımda bir kedi ile ev ev gezdiğimi düşündürdü, neden haram olaki diye sorgulattı.<br/><br/>köpek olsa neyseydi... köpek , beyinsizlerce zaten haram idi. ama kedi mübarek hayvan değil miydi?
- entry_name: |
    ekşi itiraf
  entry_id:  75662791
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bu akşamki maçta dybala’ya haklı sarı kart çıkarmış hakem. kendisini bariz atıyor. juve’nin penaltısı ise bence değil. göğsüne çarpıyor gibi gördüm emin olmamakla birlikte.
---
