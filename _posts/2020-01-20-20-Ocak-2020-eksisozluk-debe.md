...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    bakkaldan ekmek arası salam kaşar yaptırmak
  entry_id:  100768993
  entry_writer: esine patik oren orkestra sefi
  entry_fav_count: 4
  entry_content: |
    yanında da küçük kutu meyve suyu varsa sizi hazzın doruğuna ulaştıracak eylem.
  entry_channels: 
- entry_name: |
...
- entry_name: |
    fatih aksoy
  entry_id:  100769315
  entry_writer: gorilla
  entry_fav_count: 3
  entry_content: |
    4 ay sonra donecegi takimina abuk subuk hareketler yaparak kafasinin hic calismadigini anladigim topcu
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    şurada bile bir şeye eleştirel yaklaşsak ana avrat küfür yiyoruz. bu toplumun farklı katmanları varken 134. olmak bile hayret verici.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ilk çarşamba gülleri ve silahlar.
  entry_channels: anket,müzik
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    yine ben yine bu başlık. tinder yükledim az önce dedim ulan vardır bi hikmeti diye. e anasını satim sınırlıymış. sikerim öyle işi. mis gibi ekşi dururken ne işim var benim tinder ile? lan o uygulamayı da anlamadım ha. ilik gibi hatun pişt dese yatağına 45 kişi doluşur karı tinder'da takılıyor. bunlar bizi mi yiyo lan anlamadım.
