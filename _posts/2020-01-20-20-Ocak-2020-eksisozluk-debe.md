...
- entry_name: |
  ...
  entry_id:  100745900
  entry_writer: seksi fotograflari icin tiklayiniz
  entry_fav_count: 912
  entry_content: |
    bu fotoğrafta asıl düşünülmesi gereken girdiği iki büyükşehir başkanlığı seçimini de kaybeden binali yıldırım'ın "akıllı şehirler ve belediyeler" kongresinde protokolde yeri olmadığı halde ikinci sırada bulunmasıdır.<br/><br/>edit: iki farklı büyükşehirde toplam üç seçim.
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    türk kadınının para harici tav olduğu şeyler
  entry_id:  100744721
  entry_writer: omuzdas
  entry_fav_count: 66
  entry_content: |
    daha çok para, yine para, biraz penis, tekrar para
...
- entry_name: |
  ...
  entry_fav_count: 56
  entry_content: |
    ustteki yazara cevap veriyorum:<br/><br/>hepsi oyle.
  entry_channels: ilişkiler,sağlık,eğitim
- entry_name: |
    zeynep bastık türkiye'nin muazzez ersoy'udur
  entry_id:  100755406
  entry_writer: whoyagonnacall
  entry_fav_count: 47
  entry_content: |
    muazzez ersoy zaten türkiye'nin değil miydi en başından beri
  entry_channels: müzik
- entry_name: |
    hakan şükür'ün sıfırı tüketmiş olması
  entry_id:  100757859
  entry_writer: arjantin mafyasi
  entry_fav_count: 42
  entry_content: |
    (bkz: <a class="b" href="/?q=sen+de+bunu+yedin%3f">sen de bunu yedin?</a>)<br/><br/>edit: başlığı açan arkadaşımı kırmak için yazmadım o laf işin gırgırı. gerçekte bu fetocular öyle serefsiz ki her yalanı söyleyebilir, kendini mağdur gösterip yavaş yavaş insanların gönlünü yumuşatmaya çalışabilirler. o yüzden bu fetocu ibneye de inanmıyorum.
  entry_channels: spor
- entry_name: |
    marcelo saracchi
  entry_id:  100760034
...
- entry_name: |
    kürtlerin köroğlu'nu sahiplenmesi
  entry_id:  100755515
  entry_writer: bak yazdim kank
  entry_fav_count: 34
  entry_content: |
    yukarıda görüldüğü üzere sözlükte de sayıları çoktur.<br/>siz kürtçüler doğu'da alevi, ermeni, süryani, keldani mi bıraktınız? çoğunu öldürdünüz.<br/><br/>götündeki bok, altında şalvarla doğu'daki tüm kültürü yok etmiş gelmiş türk'e dil uzatıyor.<br/><br/>bu ülkede siz kürtçüler kadar gerizekalısını görmedim.<br/>kelimelerin başına, ortasına ê, î, x, w, û vs. harfler ekleyerek onu kürtleştiremezsiniz.<br/>anadolu'da kürtlerin tarihin 500 yılı geçmez ama gider 1300 yıl önce arap-bizans savaşlarında anadolu'ya gelmiş battal gaziyi sahiplenir. tam bir ezik gerizekalısın.<br/><br/>hewal sizin o sahiplendiğiniz diyarbekir'in adını da araplar koymuştur.<br/>o çok sahiplendiğiniz cizre'ye cizîr diyerek kürtçeleştirmeye çalıştığınız yerin adı da yine arapların oraya cezire adını koymasından gelir.<br/>bunlar gibi binlerce örnek var.<br/><br/>kürtleri kılıçtan geçiren şah ismail'i bile kürt yapacak kadar gerizekalısınız.<br/>eğer yavuz selim olmasaydı bir tane kürt kalmayacaktı, şah ismail hepinizi doğrayacaktı.<br/>bugün gelmiş ama şah ismail'e kürt diyen ahmak kürtçüler var.
  entry_channels: siyaset,anket,tarih
- entry_name: |
    sevgilisinin kıyafetine karışmayan erkek
  entry_id:  100751003
  entry_writer: yazarolucakadam
  entry_fav_count: 32
  entry_content: |
    kıyafeti seni rahatsız ediyorsa sevgili olmayacaksın. olduysan da kıyafetine karışıp hayatı zehir etmeyeceksin.
...
- entry_name: |
    karakomik filmler 2
  entry_id:  100735673
  entry_writer: hani bize kuku kuku
  entry_fav_count: 18
  entry_content: |
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    muhalifleri sokağa dökmek için kurulan tezgah
  entry_id:  100765304
  entry_writer: ceviz suyu
  entry_fav_count: 17
  entry_content: |
    " kimseden korkmuyoruz evelallah ama sokağa dökülmenizi iyiliğiniz için tavsiye etmiyorum."<br/><br/>kimsin len sen totoş kimi tehtit ediyorsun dalyarak.
  entry_channels: siyaset,anket
- entry_name: |
    kara deliğe düşerken dinlenilecek şarkılar
  entry_id:  100733182
  entry_writer: excelsior was here
  entry_fav_count: 16
  entry_content: |
    ışığı bile emen kara deliğin sesi emmeyeceğini düşünen türk gençliğine selam olsun.<br/><br/>(bkz: <a class="b" href="/?q=hay%c4%b1rl%c4%b1+forumlar">hayırlı forumlar</a>)
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    disketten dos 6.22 kurmuş yazarlardan yaşça küçüktürler.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    sizin yaptığınız organizasyonu skeym. açık açık torpil, adam kayırma, ırkçılık, her ne derseniz deyin işte onun yapıldığı yarışmadır. tiksiniyorum sizden namussuz şerefsiz haysiyetsiz gtverenler.
  entry_channels: spor
- entry_name: |
    en güzel kız isimleri
  entry_id:  100741985
  entry_writer: joedeghade
  entry_fav_count: 5
  entry_content: |
    şeyma'ya en güzel kız ismi diyen zevksiz insanları da görmüş olduk. şeyma lan. şeyma aq.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    +siz hanımefendi, beyefendiyi eşliğe kabul ediyor musunuz? <br/>-nasıl etmem memur bey? sevişiyoruz.
...
- entry_name: |
  ...
  entry_id:  100736965
  entry_writer: yastiklagezen
  entry_fav_count: 2
  entry_content: |
    net olarak gülmesi. gülen insan güzeldir. <br/>tabi ruhlar aleminde de...
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  100761211
  entry_writer: siberyadan
  entry_fav_count: 0
  entry_content: |
    1-) tolstoy mu dostoyevski mi?<br/>2-) yaz mı kış mı?<br/>3-) seinfeld mi friends mi?<br/><br/>not: mesaj atan arkadaşlar, sorulara cevap vermeyin çünkü sevgili aramıyorum.
  entry_channels: anket,ilişkiler
- entry_name: |
    mario lemina
  entry_id:  100759995
  ...
  entry_fav_count: 0
  entry_content: |
    ligin başlarında ilk yarıyı zor çıkarıyordu, bugünkü oyunuyla tam bir melo resitali sunuyor. <br/>bizimle kal kaytan bıyık
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    doğduğumdan beri bu ülkedeyim, hiç karşılaşmadığım tip, hiç duymadığım söz öbeğidir.
  entry_channels: 
- entry_name: |
