...
- entry_name: |
    2018-2019 süper lig sezonu isimlendirmesi
  entry_id:  77005837
  entry_writer: kedisini arayan sahip
  entry_fav_count: 4
  entry_content: |
    ilhan cavcav'ın adının koyulduğu sene gençlerbirliği'nin düşmesi gibi bir vahameti görünce;<br/>çok ısrarcı olunmaması gereken isimlendirmedir.
  entry_channels: spor
- entry_name: |
    survivor 2018 all-star
  entry_id:  77013858
  entry_writer: procyon
  entry_fav_count: 2
  entry_content: |
    yağmur'un anlat bakalım oynarkenki tavırlarınının bana <a class="b" href="/?q=%c3%a7ok+g%c3%bczel+hareketler+bunlar">çok güzel hareketler bunlar</a>'daki <a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/_zWnKIn1TkU?t=7m28s" title="https://youtu.be/_zWnKIn1TkU?t=7m28s">tabu skeci</a>ndeki burcu'yu hatırlattığı program.
  entry_channels: tv,magazin
- entry_name: |
    şu anda çalan şarkı
  entry_id:  77016976
  entry_writer: tncserap
  entry_fav_count: 0
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=eqJcCmxZYdM&amp;app=desktop" title="https://www.youtube.com/watch?v=eqJcCmxZYdM&amp;app=desktop">bonnie raitt - burning down the house</a>
  entry_channels: anket,müzik
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    insan ve tavuk genomunun %60 oranında aynı oluşuna bakınca özel yaşantısında horuz taklidi yapmayı seven bir grubun da ortaya çıkma ihtimaline işaret eden tesbit.
  entry_channels: 
---
