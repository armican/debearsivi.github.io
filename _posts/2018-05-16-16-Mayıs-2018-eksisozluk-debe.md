...
- entry_name: |
    gangbang için türkçe karşılık önerileri
  entry_id:  76987352
  entry_writer: rahmaykin
  entry_fav_count: 220
  entry_content: |
    (bkz: <a class="b" href="/?q=kim+vurduya+gitmek">kim vurduya gitmek</a>)
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
    abd'den ambargo yiyen tek hükümet
  entry_id:  77008662
  entry_writer: zero limit
  entry_fav_count: 22
  entry_content: |
    abd ambargo koyuyorsa o hükümet vatan için çalışıyor demektir. abd kendisine hizmet etmeyen çıkarlarına ters düşen hükümetleri zor duruma sokmaya çalışır.
  entry_channels: siyaset
- entry_name: |
    ekşi itiraf
  entry_id:  76988830
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    eski sevgiliyi mutlu mesut halde yeni sevgilisine sarılmış halde görülen andır. çok dramatik değil mi sizce de dostlar?
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    (bkz: <a class="b" href="/?q=forrest+gump">forrest gump</a>)<br/>tabii ki o bankta.
  entry_channels: anket,ilişkiler
- entry_name: |
    bohemian rhapsody
  entry_id:  77004887
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    beyler, tibet"ten yazıyorum, yok öyle bir olgunluk.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    orospu çocuğu çomarların uğramayacağı başlıklardan birisidir.
  entry_channels: siyaset,haber
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=dombra">dombra</a>)<br/>ama hep birlikte <a class="b" href="/?q=izmir+mar%c5%9f%c4%b1">izmir marşı</a> söyleyeceğimiz günler de gelecek.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    nasıl yani 2002 den önce iktidarda chp yok muydu? yalan söyleme fetöcü hayin.
  entry_channels: siyaset
- entry_name: |
