...
- entry_name: |
  ...
  entry_fav_count: 138
  entry_content: |
    zeki insan rol yapmayi sevmez. evliligin yurumesi icin bol bol rol yapmak zorundasin.
...
- entry_name: |
  ...
  entry_channels: ilişkiler,sağlık
- entry_name: |
    ölmüş insanın dna'sını kopyalayıp klonlamak
  entry_id:  80324223
  entry_writer: morales
  entry_fav_count: 58
  entry_content: |
    anlamsız bir durumdur çünkü tek yumurta ikizi gibi bir sonuç çıkarır ortaya. klonlanan kişi bebek olarak doğar ve aynı kişi olmaz. doğması için de taşıyıcı anneye ihtiyaç duyar tabii doğal olarak.<br/><br/>öte yandan klonlanan canlılarda bazı kanser türlerinin ve kalp damar hastalıklarının yaygın olarak görüldüğü ve yaşam sürelerinin normal canlılardan çok daha kısa olduğu bilinmektedir.<br/><br/>bilginize.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 28
  entry_content: |
    bu baslik altinda gelip yayinci kuruluslari savunanlarin tumu suzme gerizekalilar. hemen aciklayayim;<br/><br/>yayinci kuruluslar tek bir urun satmiyor, sezonluk ve kupa organizasyonlari icin para aliyorlar. o zaman sozgelimi akhisar-alanyaspor maci da ilgi cekmiyor zarar ederiz, yeterli reklam yok diye o maci da yayinlamasin, madem hakli. ya da buyuk takimlardan birinin cok kotu gittigi sezon o takimin maclarini vermesin. mantikli mi?<br/><br/>ya da siz gittiniz burger king’e, bir whopper istediniz, dedi ki bu restorana ozel whopper satmiyoruz gitmiyor cunku, ha bir de salonun isiklari da kapali cunku bu ara isler dusuk. <br/><br/>kendinize gelin kapitalizm sadece saticinin kar elde etmesi uzerine kurgulanmaz, tuketici de fayda elde edecek ki cark donsun. <br/><br/>bugun bunu hakli gorenler kendi kisisel yasantisinda taahhut edilmedigi halde genelde aldigi bir hizmet eksilsin ortaligi yikar.<br/><br/>bu memleketi bok eden bu “adam zarar ediyorsa yayinlamaz tabi abi” kafasi. isin ucu kendine dokunmadigi icin baskasinin hakkinin gasp edilmesine, firmalarin milleti sikmesine destek veren mallar her bokun musebbibi.<br/><br/>aferin, super devam.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    "söyle bana may söyle, bu dünyada ruhunun dilini anlayan kaç kişi var? merak ediyorum, seni sessizliğinde dinleyebilen ya da sükunetinde anlayabilen birine kaç kez rastladın?"<br/><br/>halil cibran-may ziyade'ye mektuplar
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    jartiyeri olan kadın özel kadındır
  entry_id:  80324057
  entry_writer: ylz
  entry_fav_count: 18
  entry_content: |
    aşkından öldükleri, evlilikle ödüllendirmeyi düşündükleri kadınların çekmecelerinde jartiyer görünce topukları kıçlarına vura vura kaçacak olan erkekler varken özel demeyelim lütfen. her kadın jartiyeri kaldırır da her erkek kaldıramaz. <br/><br/>maalesef biraz daha zamana ihtiyacınız var. o zamana kadar medeniyet görmüş güzel erkekler o jartiyerli kadınları alıp gittiler. kadının kezbanına, külodun pamuklusuna kaldınız çomarlar.
  entry_channels: ilişkiler
- entry_name: |
    emre akbaba
  entry_id:  80334049
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    maalesef kanserle mücadele ediyor şuan. kurtulması bir mucize çünkü amerikalıların (bkz: <a class="b" href="/?q=hospice">hospice</a>) dedikleri yere nakledilmiş. seni çok sevdik “the queen of soul music.” umarım bi mucize olur da kaldığın yerden devam edersin hayatına. <br/>edit: bugün 76 yaşında hayatına veda etmiş. rip soul queen. <br/>hatrı için açalım bi (bkz: <a class="b" href="/?q=respect">respect</a>)
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    evde su samuru beslemek
  entry_id:  80340257
  entry_writer: drunkenshoe
  entry_fav_count: 4
  entry_content: |
    pek de rahat ve mutlu görünen bir adet piç kurusu içerir. ısırıcan böyle.<br/><br/>ama evde yaşayacak hayvan değil ki bu ya.
  entry_channels: 
- entry_name: |
    enzo roco
  entry_id:  80340617
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    giymese daha az dikkat çekecektir.
  entry_channels: moda
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    bir miktar <a rel="nofollow noopener" class="url" target="_blank" href="https://www.ulusal.com.tr/m/?id=33819" title="https://www.ulusal.com.tr/m/?id=33819">link</a> kamu arazisinin ( evet senin arazinin) gaspı ile yapılmıştır. olan ise yolun karşısındaki travesti ve diğer hayat kadınlarına olmuştur. zira milyon ödeyenler önlerindeki pazarı görmek istememekte ve bu sebeple polis bile dikilmiştir.<br/><br/>not: bu yazı ucubelerin 1 km ötesinden yazılmıştır. korkuyorum lan bildiğin ucubelerden.<br/><br/>edit + ek: 1. derece deprem bölgesi imiş sanırım. 40 kat izin mevzusu karışık. ben var anlamamak.
