...
- entry_name: |
    sokak kedilerini besleyip komşuları rahatsız etmek
  entry_id:  80326149
  entry_writer: markovic
  entry_fav_count: 76
  entry_content: |
    northampton düklerini ve sussex düşeslerini rahatsız eden olay. kendi halinde yaşayan canlılara iki yemek su falan verilmesinden rahatsız oluyorsanız toplum için de değil de bu yabanilikle tek başınıza dağın başında yaşayın tutan yok sizi. şu el kadar canlıların beslenmesinden niye rahatsız olur insan hiç anlamıyorum.
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    iyi bir yönetmen ya da oyuncu olması ve dahi hatta solcu olması katil ve kadın döven bir tip olduğu gerçeğini değiştirmeyecek oyuncu/yönetmen. üstelik işlediği cinayetin cezasını çekmemek için yurtdışına kaçtığını da eklemeden geçmeyelim.
  entry_channels: siyaset,sinema
- entry_name: |
    satrançta at mı fil mi daha değerlidir sorunsalı
  entry_id:  80325109
  entry_writer: cok ayip
  entry_fav_count: 10
  entry_content: |
    duruma ve rakibe göre değişen önem sıradadır.
...
- entry_name: |
  ...
  entry_channels: yeme-içme
- entry_name: |
    ciddi ciddi gül dövmesi yaptıran insan
  entry_id:  80334258
  entry_writer: zencikedi
  entry_fav_count: 6
  entry_content: |
    gül dövmesi denilince aklıma gelen 3 şey;<br/>-40+ yaş <br/>-raki ve sigara içmekten dolayı kalınlaşmış ses<br/>-pavyon <br/><br/>nedendir bilmem.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    en çok biz fb taraftarını etkiler.<br/>zira, turksat üzerinden yayın yapan ve taraftarının kolaylıkla ulaştığı tek kanaldı.<br/>basketbol, futbol, voleybol maçlarının tekrarlarını izliyorduk ne güzel.<br/>bir fenerbahçeli olarak karşı olduğum karar..
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    kahveye gofret bandıranlar derneği onursal başkanı olarak buradayım.
