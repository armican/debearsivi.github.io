...
- entry_name: |
    akp'yi yenmek için eddard stark'tan tavsiyeler
  entry_id:  71021056
  entry_writer: yeni bela husnu
  entry_fav_count: 29
  entry_content: |
    yarısında çıktığım tavsiyeler. hani aslında başlığı görünce hiç okumam da okumadan konuşmuş demesin diye bir yere kadar dayandım.<br/><br/>zaten bu maddelerin çoğunu uyguladığınızda ya akpli oluyorsunuz ya da bahçeli gibi stepneye dönüşüyorsunuz yenmek gibi bir probleminiz kalmıyor.<br/><br/>bizim akp'yi yenmemiz için tek şart cehaleti yenmemizdir. çünkü cehalet ancak bu kadar mükemmel bir şekilde temsil edilebilir.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    şu adamı beğenmeyen siktirsin gitsin futbol izlemesin.<br/><br/>not: gs
- entry_name: |
    ekşi itiraf
  entry_id:  71013538
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    10 senedir ayrı yaşamanıza rağmen 2 haftalık tatilde eve döndüğünüzde "burası benim evim, çarşamba'ya kadar kalabilirsin." dediği andır.<br/><br/>gittiğimde zaten arkadaşlarım için gidiyorum, aramız hiç iyi olmadı.<br/><br/>ayrıca kapıyı çaldığımda anahtarla açmadığım için laf etmişti. üşeniyor ben eve geldiğimde bir şeyler hazırlamaya falan.<br/><br/>yarın öleceğini bilsem yine barışmam.
- entry_name: |
    vega
  entry_id:  71013291
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=%c3%a7abuk+%c5%9farjc%c4%b1lar+gelmeden">çabuk şarjcılar gelmeden</a>)
- entry_name: |
...
- entry_name: |
    türk hava yolları
  entry_id:  71014115
  entry_writer: parcxerox
  entry_fav_count: 0
  entry_content: |
    "bilet degistirme" islemi adi altinda yaptigi fiyatlandirma ve hesaplamalar yolcuyu enayi yerine koyup kaziklama prensibini guden havayolu seysi. <br/><br/>biletiniz yakip yeniden satin almanin degistirme cezasi+islem ucreti+fiyat farkinin toplamindan daha ucuza geldigi, ve bunu da bikbikbik sartlar surtlar diye hakli gostermeye calisan dunyalideri seysi.<br/><br/>lafa gelince global, adam kaziklamakta local.
- entry_name: |
    şu anda çalan şarkı
  entry_id:  71013756
  entry_writer: obirkiuc
  entry_fav_count: 0
  entry_content: |
    vega - ve tekrar
- entry_name: |
