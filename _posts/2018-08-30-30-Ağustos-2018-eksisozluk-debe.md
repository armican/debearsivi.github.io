...
- entry_name: |
  ...
  entry_fav_count: 88
  entry_content: |
    kendi vatanında savaş var diye kuyruğunu sıkıştırıp kaçan it sürüsü bizim memleketimizde aslan kesiliyor. <br/><br/>suriyeliler bizim kardeşimiz goygoyu yapanlar, izleyin de görün!
...
- entry_name: |
  ...
  entry_channels: anket,seyahat
- entry_name: |
    vurulan domuzun son nefesindeki intikam çabası
  entry_id:  80751468
  entry_writer: yesilsahalarincasusu
  entry_fav_count: 25
  entry_content: |
    birgün küçük bir çocuk iken cinlerden korkan bana, köyde yaşayan yaşlı bir teyze nasihat vermişti. <br/><br/>oğlum dedi: "onlardan korkmana gerek yok sana onlardan hiçbir zarar gelmez. şeytanda cinde insandır.<br/><br/>bu sözler kulağımdan hiç çıkmadı ve küçük yaştaki bu korkumu bu sözlerle yenmiştim. toplumda bu tür olaylar gördükçe her seferinde o teyzeyi anarım yine haklı çıktın teyze derim hiç istemeyerek...
  entry_channels: haber
- entry_name: |
    aşkım kapışmak
  entry_id:  80758817
...
- entry_name: |
  ...
  entry_id:  80759704
  entry_writer: lasthit
  entry_fav_count: 8
  entry_content: |
    adının; nereye sıçacaklar? olarak değiştirilmesini istediğim fest.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    (bkz: <a class="b" href="/?q=bojack+horseman">bojack horseman</a>)<br/>1 farkım var sadece, hollywood manzaralı dağ eteğinde malikanem yok. <br/>onun dışında birebir perfect match.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    türk'te değilim kürt'te değilim bu yüzden rahatlıkla söyleyebilirim ki başlığa katılıyorum ama bu kürt halkı ile alakalı bir olay değil tamamen bulundukları coğrafya ile alakalı . kürtler alp dağlarının eteklerinde, almanya, avusturya gibi devletlere komşu yaşayan bir halk olsaydı eminim ki biji biji diye dolanmazlardı hatta gıpta ile bakardık adamlara ama coğrafya kaderdir ve o kader onları ilkelliğe itiyor.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    ister gelsin ister gelmesin “emek hirsizi” kolyesi her zaman boynunda kalacak futbolcu. <br/><br/>ben, takimimin gidisatini dusunen, isimlere bagli kalmayan biriyim. hicbir isim besiktas’tan buyuk degildir. kim gelmis kim gitmis beni baglamaz. sene sonunda elde avucta bir sey var mi yok mu beni o ilgilendirir. fakat bu zat-i muhteremin gelmesi halinde, ilk defa bir besiktas oyuncusuna karsi onyargili ve nefret dolu olacagim. atacagi gole sevinmeyi birak; tebessum dahi etmeyecegim. <br/><br/>senin atacagin gollerle sampiyon olmaktansa; mustafa pektemegin 10 gol atarak kariyer rekoru kirdigi bos bir sene gecirmeyi yeglerim. <br/><br/>su noktada; basina yansiyan haberlerin yalan olmasini ummaktan baska elden bir sey gelmiyor. fakat su cok net ki; herkesin hazmi olur ama bunun olmaz.
  entry_channels: spor
- entry_name: |
    yazarların favori savaş uçağı modeli
  entry_id:  80767616
  entry_writer: morgonoid
  entry_fav_count: 0
  entry_content: |
    tasarım olarak bir efsane olan (bkz: <a class="b" href="/?q=mig-29">mig-29</a>), ama avrupaya ve amerikaya yıllarca kök söktürmüş olan bir diğer efsane (bkz: <a class="b" href="/?q=mig-25">mig-25</a>)
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=kad%c4%b1nlar%c4%b1n+seksi+pozlar%c4%b1n%c4%b1n+maddi+endi%c5%9fe+i%c3%a7ermesi">kadınların seksi pozlarının maddi endişe içermesi</a>)
