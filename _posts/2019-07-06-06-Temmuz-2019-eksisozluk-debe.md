...
- entry_name: |
  ...
  entry_fav_count: 495
  entry_content: |
    - biz sana demedik, dondurmaya dedik<br/><br/>bir insan dondurmaya yüksek sesle neden yalarım der?<br/><br/>ilgili: (bkz: <a class="b" href="/?q=kul+hakk%c4%b1+dini">kul hakkı dini</a>)
  entry_channels: haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    evlendiğinde verebileceği en önemli şeyin soyadını olduğunu sanan, bir de bunun güç göstergesi olduğunu düşünen erkeklere dert olan kadındır.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
    2. entrylerin 1. entrylerden daha fazla fav alması
  entry_id:  92198972
  entry_writer: redkitin neden sevgilisi yok
  entry_fav_count: 0
  entry_content: |
    biri bu adamı (bkz: (<a class="b" href="/entry/92193752">#92193752</a>)) favlasın. göt gibi kalmış ortada.
  entry_channels: ekşi-sözlük
---
