...
- entry_name: |
  ...
  entry_fav_count: 160
  entry_content: |
    bizde konyada bir bebek soğuktan donarak ölmüştü, ne demişti insanlık tarihinin en aşağılık güruhu olan aktroller yalan haber. <br/><br/>bence bu da yalan sayın troll .
...
- entry_name: |
    suriye'nin ermeni soykırımını kabul etmesi
  entry_id:  102028974
  entry_writer: kholat syakhl
  entry_fav_count: 86
  entry_content: |
    karşılık olarak golan tepelerinin israil toprağı olduğu kabul edilirse bence harika bir misilleme olur. <br/><br/>sizin sikko kabul etmeniz kimsenin umrunda değil fakat bizim golan tepelerini israil toprağı olarak kabul etmemiz sizin korkmanıza yeter.<br/><br/>edit : umarım diğer arap ülkeleri de daha fazla kaşınır da kudüs'ü de israil başkenti olarak tanırız. yeter bu sikik araplar yüzünden gördüğümüz zararlar amk.
...
- entry_name: |
    ibb mönüsüne antrikotun geri dönmesi
  entry_id:  102034212
  entry_writer: bir nevi teselli
  entry_fav_count: 81
  entry_content: |
    üst düzey yöneticiler antrikot yerken, işçilerin musakka yemesinden doğan adaletsizliğe ses çıkaran ekrem imamoğlu'nu, götünden anlayan yazar beyanı.
  entry_channels: haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 57
  entry_content: |
    2020 yılında da lüks sayılmaktadır. çünkü alınan sucuklar ya tavuk sucuk, ya da bim'den alınan ne idiğü belirsiz dana sucuklardır.<sup class="ab"><a title="(bkz: ekseri)" href="/?q=ekseri" data-query="ekseri">*</a></sup>
...
- entry_name: |
  ...
  entry_channels: haber,yeme-içme
- entry_name: |
    messi'nin gece kulubünde bir kadını ellemesi
  entry_id:  102030972
  entry_writer: haalivelihaveliali
  entry_fav_count: 51
  entry_content: |
    karın olduğunu bilmiyordum messi, vur beni.
  entry_channels: spor,magazin
- entry_name: |
    sivasspor taraftarının a spor dışarı tezahüratı
  entry_id:  102040383
  entry_writer: i was in heaven
  entry_fav_count: 46
  entry_content: |
    yarı zuvaslı olarak desteklediğim tezahürat. ananın amına kadar yolun var a spor ve a haber.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 44
  entry_content: |
    ankara’nın gerisinde kalmıştır. <br/>sonuçta bir çöpe yediyüzelli milyonn dolaaaar harcayacak kadar zengin ve savurganız. <br/>eğlenecektik güüya ama elektrikler gitti kapandı. tühh!<br/>neyse melihciğim sağ olsun!
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 26
  entry_content: |
    hoşgeldin mustafa abi, 1996 yılı kral tv müzik ödülleri gecesi finalinde, mahsun kırmızıgül'ün "araba" şarkını seslendirdiğinde neler hissettin.
...
- entry_name: |
  ...
  entry_id:  102005321
  entry_writer: dittohead
  entry_fav_count: 20
  entry_content: |
    bir nokta gelir ve flaubert'in dediği gibi artık bilmek istemiyorum dersin. yorulmuşsundur.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
    30 yaşında az koşunca nefes nefese kalmak doğal mı
  entry_id:  102039396
  entry_writer: erken oten civciv
  entry_fav_count: 14
  entry_content: |
    (bkz: <a class="b" href="/?q=s%c3%b6zl%c3%bc%c4%9f%c3%bcn+k%c4%b1zlar+soruyor+sitesine+evrilmesi">sözlüğün kızlar soruyor sitesine evrilmesi</a>)
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    bedava zevk. trip yok, dırdır yok, pahalı hediyeler almak yok. kişisel temizliğime de dikkat ederim ki omzumu iki kere lifliyorum. mis gibi ılık ılık öpüyorum istediğim kadar. insan şu hayatta kendine yetebilmeli.
  entry_channels: ilişkiler
- entry_name: |
    ekşi itiraf
  entry_id:  102006076
  ...
  entry_fav_count: 5
  entry_content: |
    bir seneye yakın süredir işsizim ve çevremdeki akıl hocalarından ciddi anlamda sıkıldım artık. <br/><br/>herkesin bir fikri var ama hepsi boş. <br/><br/>konuşan insanların çoğu da tuzu kuru tipler. <br/><br/>bunlara göre ülkede kriz mriz yok, işsiz gezmemin tek sebebi benim "düzgün" iş arayışı içinde olmamam. <br/><br/>hassiktirin oradan be.
  entry_channels: anket,ilişkiler,ekşi-sözlük,spoiler
- entry_name: |
    13 şubat 2020 sivasspor antalyaspor maçı
  entry_id:  102040274
  entry_writer: bombaci muallim
  entry_fav_count: 3
  entry_content: |
    a spor dışarı tezahüratı sansürlendi az önce.<br/><br/>memlekette tezahürat yapmak da yasak beyim.<br/><br/>edit: yine sansür yedi taraftar.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    tanım: dertleşmek isteyen tüm sözlük mecrasının her gece üşüştüğü başlık.<br/><br/>boktan mecralarda nereye kadar sosyalleşeceksiniz? sizi alsakta ekşi sözlük discord sunucusuna mı götürsek ne yapsak? hem sesli sohbet yaparız. katılmak isteyenlere link: <a rel="nofollow noopener" class="url" target="_blank" href="https://discord.gg/scbE2M">https://discord.gg/scbe2m</a><br/><br/>ön edit: sunucu not official.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    kocaman bir kar küresinin içinde zarif ay ışığını, usul usul geçip giden bulutları, “beyaz karlar kraliçesi” suretine bürünmüş ağaçları ve sokak lambalarını seyrediyorum. sabah herhangi bir alarma bölünmemiş bir rem uykusu yetiştirme telaşım yok. zaten kurtlar ovaya inmez de köpekler bağrışmazlarsa uykumun bölünme ihtimali de pek yok. yer gök buzdan ama yürekler sıcacık. dünya detoksu diyorum bunun adına.
  entry_channels: anket
- entry_name: |
    mucize doktor
  entry_id:  102043162
  ...
  entry_fav_count: 1
  entry_content: |
    bu haftaki yayınlanan geçen bölümün özetinde sanırım gelen tepkilerden ötürü kemik iliği nakli kısmını göstermeyen ve severek izlediğim dizi.
  entry_channels: tv
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    yok mu şöyle aranızda 1.70 boyunda, beyaz tenli, kızıl saçlı, 36 numara ayakkabı giyen, yaşı 34 olan, nişantaşı’nda reklam ajansı sahibi olup yanında 10 kişi çalıştıran, galata kulesi manzaralı bir evde oturan ve altında 2020 range rover’i olan bir kadın? arabayı evi tarlayı satıp üstüne yapalım, ajansa ortak olalım?
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
...
- entry_name: |
    amerika ve rusya'da aniden beliren türkiye aşkı
  entry_id:  102040909
  entry_writer: semsipasapasajindasesibuzusmeyen
  entry_fav_count: 1
  entry_content: |
    birkac gundur hasil olan ask. sosyal medya uzerinden her iki ulkenin de turkiye'ye yazmasi, sirin gozukmeleri falan. yakinda twitter'da dm'den yurumezse bunlar turkiye'ye ben de birsey bilmiyorum!
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    oldukça şanslı bir dönemde yaşamışlardır gençliklerini. kariyer üstüne kariyer eklemişlerdir. onlardan bize bir b...k kalmadı zira.
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=bolu+t%c3%bcneli">bolu tüneli</a>)
  entry_channels: ilişkiler
- entry_name: |
    jagermeister
  entry_id:  102042495
  ...
  entry_fav_count: 0
  entry_content: |
    2 space cake yediğiniz gecede içmemeniz gereken likör...
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    yabancılaşma sancısı, hislerin bastırılması, alışkanlıklardan sıyrılmak, yalnızlık, yolunu kaybetmişlik, boşluk, kızgınlık, hatıralar, hediyeler, fotoğraflar, merak, kıvranışlar ve sair.
  entry_channels: anket,ilişkiler
---
