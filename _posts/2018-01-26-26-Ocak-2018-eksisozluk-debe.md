...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    alamayanların çok gereksiz gördüğü için almadığını iddia ettikleri telefon..
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    birçoğunun sonradan görme olmasından kaynaklanan sorundur. biraz kendini geliştiren futbolcuların gerek giyimleri gerek de sosyal medyada paylaşımları ayırt ediliyor zaten. <br/><br/>(bkz: <a class="b" href="/?q=ergin+kele%c5%9f">ergin keleş</a>)
- entry_name: |
