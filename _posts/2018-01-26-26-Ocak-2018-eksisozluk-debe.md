...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    kayganlastirici kullanacaklar herhalde.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    veganların genelde ahmak olması hocayı doğruluyor.
- entry_name: |
...
- entry_name: |
    mercedes c serisi
  entry_id:  73741103
  entry_writer: gorunmez ferrarisi olan tikky
  entry_fav_count: 0
  entry_content: |
    bu araba hakkında net konuşacağım sınıfındaki diğer arabalara oranla mercedes logosundan ekstra hiçbiri şeyi bulundurmuyor <br/><br/>bulundurdukları ekran nasıl bir ekran bilmiyorum ama hayatımda takılarak geçen gördüğüm tek ekran kendilerine ait olabilir. biraz daha yüksek işlemcili ve ramli bir ekran koymak bu tarz bir arabada zor olmasa gerek diğer yandan 1.6 motorlu seçeneği bildiğiniz hayal kırıklığı yaratıyor 156 beygir olmasına rağmen beklendiği kadar atik ve sportif değil. <br/><br/>dışarıdan bakınca almak için deli gibi tutuştuğum ama içine girince iyi ki almamışım dedirten bir araba
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bugün ilk defa annemden nefret ettim. cahilliğinden, salaklığından, sinirli olmasından, bana güvenmemesinden nefret ettim. artık bu hep böyle sürecek..
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    maçın hakeminin açıklanmasıyla, trabzonspor 3-0 hükmen mağlup olmuştur. bu kaçıncı lan.
---
