...
- entry_name: |
  ...
  entry_fav_count: 59
  entry_content: |
    keske ülkem dış siyaseti arapci olacağına bu ülke insanına daha çok benzeyen, ortak geçmişimiz olan ülkelerle daha iyi ilişkiler kurmak üzerine olsaydı. kelepir toprak almak yerine ne zaman depremle başımız ağrısa yanimizda olan insanlarla daha iyi olurduk.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 31
  entry_content: |
    insanlar haklı olarak vergiler nerede diye sorduğunda "şimdi siyaset yapmanın sırası değil" diyen zihniyetin deprem sonrasında hasar ölçümü yerine algı ölçümü yapmakla meşgul olduğunu gösteren utanç verici bir cümle.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    parayı suriye'deki teröristlere gömdünüz, kendi vatandaşınız için dileniyorsunuz.<br/><br/>bu utanca taş olsa çatlardı..
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    rusya'da yaşanmışsa şaşırmam aga, kadınları her anlamda taş gibi.
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    ılkokul çocuğu gibi burç yaristiriyorlar resmen.<br/><br/>yemin ederim ağır zekasız dolu burası.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    25 gün önce "bu sene her şey çok güzel olacak! bu, benim senem" diyerek yeni yıla girmiştik.<br/>aynen de öyle oluyor, galiba bu sene bizim senemiz.<br/>deprem, savaş, salgın hastalık derken finali israfil'in sur'a üflemesiyle yapıp zirvede bırakacağız.<br/>zaten bizim dönemin görmediği tek şey kıyamet, o da bize nasip olsun ki şanımız yürüsün.<br/>öte tarafa gidince "lan olm siz ne gördünüz ki, hey yavrum hey!" diye hava atalım, yaratıcıdan ekstra beş puan isteyip, bazı sınavlar için muafiyet talep edelim.
...
- entry_name: |
  ...
  entry_id:  101047549
  entry_writer: imthedreaf
  entry_fav_count: 4
  entry_content: |
    en son terk edilişimden bir kaç saat sonra yaşadığım acıyı sevgilime anlatmak istemiştim. eski sevgilim olduğunu o an hatırlamak ayrılıktan daha acıydı.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    daha önce “karma” başlığında paylaşılanın aynısı olan şu (<a class="b" href="/entry/101022565">#101022565</a>) entry’yi copy paste yapıp burda paylaşınca ufkumuzu iki katına çıkardın suser dostum.<br/><br/>ilgili entry: (<a class="b" href="/entry/65285035">#65285035</a>)<br/><br/>tanım: bazen hayret içinde bırakan başlık.
...
- entry_name: |
  ...
  entry_id:  101043091
  entry_writer: zerkalov
  entry_fav_count: 0
  entry_content: |
    cam silme hariç, yazılı eylemlerin hepsini büyük bir zevkle yapıyorum hatta inanır mısınız tefekkürüm ve iç meditasyonum artıyor bu eylemler esnasında.
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    çavuş bayıldı kardeşim yeter insaf.
  entry_channels: anket
- entry_name: |
