...
- entry_name: |
  ...
  entry_fav_count: 743
  entry_content: |
    sıradan insanın sıradan insana yaptğını kimse yapamaz bu dünyada. <br/><br/>kadın soruyor bu vergiler n'oldu diye. bu deprem vergileri amacında kullanıldı mı diye soruyor. sorduğu için linç ediliyor.
...
- entry_name: |
    maalesef 22 ex dediğimiz ölümüz var
  entry_id:  101046525
  entry_writer: quat
  entry_fav_count: 276
  entry_content: |
    adam ex ne onu öğrenmiş cümle içinde kullanmak istemiş, olmamış.<br/><br/>işte az şey bilip çok şey biliyormuş gibi göstermeye çalışınca böyle oluyor.
...
- entry_name: |
  ...
  entry_fav_count: 195
  entry_content: |
    artık rahatsız edici düzeyde bu kelime. vatandaşlarımız enkaz altında, adamlar yaranma peşinde.<br/>ne yani, cumhurbaşkanı talimat vermese sen sana verilen görevi yerine getirmeyecek misin?
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
    enkaz çalışmalarında kürtçe konuşan personel
  entry_id:  101040191
  entry_writer: ben ne dedim
  entry_fav_count: 132
  entry_content: |
    ne güzel insan. bu konumdaki tüm çalışanlar keşke işaret diline kadar tüm dilleri bilseler ülkede konuşulan.
  entry_channels: ilişkiler,sağlık
- entry_name: |
    25 ocak 2020 aktrollerin fairy boykotu
  entry_id:  101040668
  entry_writer: ismini vermek istemeyen anonim
  entry_fav_count: 118
  entry_content: |
    bugün itibariyle twitter'da gündeme girmiş olan boykot kararı. gerekçeside fairy'nin reklam yüzü olarak berna laçin'i kullanmasıymış. ilgili <a rel="nofollow noopener" class="url" target="_blank" href="https://imgyukle.com/i/VZcYpP" title="https://imgyukle.com/i/VZcYpP">görsel</a>.<br/><br/>bilindiği üzere berna laçin elazığ depremi sonrası depremin şiddetinin 6.5 olarak güncellenmesinin deprem sonrası yapılan vergi muafiyetini engellemek için alınan bir karar olduğunu yazmış ve toplanan deprem vergisi paraları nerede diye sormuştu.<br/><br/>tabi bizim çomarlar da kadına verebilecekleri mantıklı bir cevap bulamadıkları için sürü halinde bir linç kampanyası başlattılar ve iş kadının ekmeğiyle oynamaya kadar gitti. kadın sırf paralar nerede diye sorduğu için vatan haini ilan edilme noktasına geldi. bir söz vardır. koyun çok olursa koyan da çok olur diye. bu kadın koyun olmamayı ve hesap sormayı göze aldığı için çobanına sadık kitle tarafından böyle alaşağı edilmeye çalışılıyor. resmen bu düşük iqlu kitle yüzünden olan bizim cebimizden çıkan paraya oluyor. ülkece çoğunluk neyi hak ediyorsa o şekilde yönetilmek zorunda kalıyoruz.
...
- entry_name: |
  ...
  entry_fav_count: 73
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=rhNY83BlKn4" title="https://www.youtube.com/watch?v=rhNY83BlKn4">burada</a> muhammed hakkında konuşurken "hiçbir tarihi karakteri aşağılayan adam akıllı olamaz" derken <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=OqEwMRPFTWk" title="https://www.youtube.com/watch?v=OqEwMRPFTWk">burada</a> tarihi karakter olan kanuni ile ilgili "kanuni sultan süleyman gibi bir salak" ifadesini kullanan süper jeolog.
...
- entry_name: |
    aliexpress'in koronavirüsü yayma olasılığı
  entry_id:  101040444
  entry_writer: tatli limoncu
  entry_fav_count: 54
  entry_content: |
    çin'den gelen kargonun ptt posta işleme merkezinde 3 ay beklemesinin bir faydasını göreceğiz sonunda.
...
- entry_name: |
  ...
  entry_fav_count: 40
  entry_content: |
    <a class="b" href="/?q=24+ocak+2020+elaz%c4%b1%c4%9f+depremi">24 ocak 2020 elazığ depremi</a> 'ni bir gün öncesinden tahmin edip uyaran akademisyen. <br/><br/>şu adamın dediklerini bir <a class="b" href="/?q=%c5%9feyh">şeyh</a> ya da <a class="b" href="/?q=cemaat+lideri">cemaat lideri</a> söylese itibar görür, gerekli önlemler alınırdı. <a class="b" href="/?q=profes%c3%b6r">profesör</a> olduğundan yetkililer tarafından pek umursanmamıştır.<br/><br/>(bkz: <a class="b" href="/?q=t%c3%bcrkiye%27de+liyakat">türkiye'de liyakat</a>)
...
- entry_name: |
  ...
  entry_fav_count: 34
  entry_content: |
    mahidevran bakıyorum hiç akıllanmamışsın, yine sultan sülüman’ın peşindesin. adam yine kaçacak senden şehzadenle kalacaksın bak gör.
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    şu "algı yaratma" sözcüğünü nerede tanırım. ulan ne algıymış yarat yarat bitmedi.<br/><br/>doğruları yüzlerinize vurmak "algı yaratmak" olmuş.
  entry_channels: siyaset,ekonomi
- entry_name: |
    7 8 hasan paşa fırını kurabiyede kıl çıkması
  entry_id:  101045563
  entry_writer: ikisibirisi
  entry_fav_count: 16
  entry_content: |
    saç kılına pek benzemiyor.
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    arada zevkine 21 haziran -o en uzun gecenin rüyası- seçim sonucuna bakıp sayesinde keyiflendiğim kişi.<br/><br/>sağol başgan.<br/><br/>ekrem imamoğlu<br/>chp 4.741.870 oy %54,21<br/><br/>esenyurt'tan %57 oyu nereden, nasıl çıkardın başkan sen ya hahahha. süper.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://secim.haberler.com/">https://secim.haberler.com/</a>
  entry_channels: siyaset,haber
- entry_name: |
    çamaşır asan cam silen ütü yapan evi süpüren erkek
  entry_id:  101042807
  entry_writer: kasiginpembesapi
  entry_fav_count: 8
  entry_content: |
    bunları yapınca bize yardımcı olmuyorsunuz sevgili erkekler, bunları yapınca evinizin, kendinizin işini yapmış oluyorsunuz. bunlar kadının görevi ama erkek bunu yapmış olunca ona yardım etmiş oluyor gibi düşünenler var bence öyle düşünmeyin. tanım :yapması gerekeni yapan erkektir.
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    ılkokul çocuğu gibi burç yaristiriyorlar resmen.<br/><br/>yemin ederim geri zekalı dolu burası.
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    <a class="b" href="/?q=%c3%a7ok+basit+bi%c3%a7imde+anlatay%c4%b1m">çok basit biçimde anlatayım</a>. bunu da anlamazsanız diyecek bir şeyim yok: <br/><br/>türkiye'den yurt dışında bir ülkeye, elinizde 1-2 milyon tl olan bir valizle gidemezsiniz. bunun için özel izinler vs gerekiyor. bu durum her ülke için geçerli. örneğin abd'den, almanya'dan, fransa'dan 1 milyon dolar dolu bir valizle çıkamazsınız. <br/><br/>ama, kolunuza 1-2 milyon liralık/dolarlık bir saat takar, tıpış tıpış yurt dışına çıkabilirsiniz. o saatin değeri hiç değişmez, dünyanın her yerinde nakite çevirebilirsiniz.
  entry_channels: anket,moda,ekonomi
- entry_name: |
    sıcacık çadırlarında mutlu oturan depremzedeler
  entry_id:  101050327
  entry_writer: her fotografta mal gibi cikan adam
  entry_fav_count: 3
  entry_content: |
    ıcimden gelen sozler:<br/>"ulan sikik, git sen otur ailenle o cadirda huzurla, o drami yasayan aileyi de kendi evine gonder"<br/><br/>ama ailesinin ne gunahi var iste.
  entry_channels: 
- entry_name: |
  ...
  entry_channels: bilim
- entry_name: |
    1000'lik özel puzzle yapan hiçbiryerin olmaması
  entry_id:  101049795
  entry_writer: valonqar
  entry_fav_count: 3
  entry_content: |
    hiçbiryer ne amk? (bkz: <a class="b" href="/?q=neverland">neverland</a>)
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    modern dönemde mi tarihten beri mi diye bir soru ile karşılık verilmesi gerekendir. <br/><br/>modern dönemde evet pek fazla icadımız yok gibi görünüyor. ancak bu yaşadığımız dönem ile ilgili bir durumdur. "ahanda şunu ben buldum" diyemiyorsun. çünkü ne icat ediliyorsa kolektif akılla icat ediliyor. fiber kablo ve sensör teknolojileri dışında yazılım ve yeni prototip dışında "yer çekimi kanunu" gibi ya da "fotoğraf makinesi" gibi yeni icatlar maalesef yok. daha çok kamera ve uçan cihazları bir araya getirme, onlara sensör takma, yazılım ile bunları senkronize etme gibi işler var. <br/><br/>ancak bir tarihçinin söylediği gibi; "tarihten türkleri çıkarırsanız, tarih diye bir şey olmaz." bunun gibi de tarihten türk icatlarını çıkarırsanız o savaş tarihi de göç tarihi de gerçekleşemezdi. <br/><br/>buna göre; <br/><br/>yoğurtun fermantasyonu,<br/>konserve (göç edenler için idealdir),<br/>bir malzeme mühendisliği harikası yatağan kılıcı, <br/>atlar için üzengi ve eğer takımları.<br/>vs.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    bence yalnızlığı tercih etmiştir. rahat bırakın.
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=de+nada">de nada</a>)
  entry_channels: ekşi-sözlük
- entry_name: |
    burnuna hızma takarak güzelleşeceğini sanan kız
  entry_id:  101040829
  entry_writer: kobayashisoze
  entry_fav_count: 1
  entry_content: |
    etnik kezbanları ayıklamamda çok işime yarayan zamazingo..
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ben alkolik psikoloğuyum, avrupa yakasında istediğiniz yerde içersiniz. ben içmem dinlerim sonrada arabayla sizi eve bırakırım ciddiyim. içen insanları ayık kafayla dinlemeyi ve izlemeyi seviyorum.
