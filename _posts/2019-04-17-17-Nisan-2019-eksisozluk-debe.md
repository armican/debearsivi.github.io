...
- entry_name: |
    istanbul'da seçim tekrarı yatırımları etkilemez
  entry_id:  89000464
  entry_writer: defoe
  entry_fav_count: 502
  entry_content: |
    yatırım olmadığı için doğru varsayım.<br/>ekonominin anasını siktiniz. ne yatırımı olmasını bekliyorsunuz.
...
- entry_name: |
  ...
  entry_channels: haber
- entry_name: |
    rte imzalı çok gizli belge
  entry_id:  89000365
  entry_writer: phuggy sweetrock
  entry_fav_count: 250
  entry_content: |
    olm belgeleri yok edin diye belge mi hazırlanır?
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 41
  entry_content: |
    merak ettiğim bir şey var bu paylaşımın altında mansur yavaş'a küfür edenler için dava açılsa yaptırımı olur mu? eğer cidden ceza alacaklarsa bir ekip kurup bunları avlamak lazım.<br/><br/>not:az kaldı "ataput,atalarının putu yada put dikecekler" diyenleri gidip tek tek bulup ben sikeceğim.<br/>sinirlenme editi: az önce çocukluk arkadaşımın yanına uğradım orada bir hödük vardı ankara'da zarar edip kapatılacak şirketler için; "kendi ailesinden birilerine şirket kurdurup dağdan getirdikleri pkklıları orada çalıştıracaklar." dedi delirdim orada. bunu söylerken öyle inançlıydı ki gözlerindeki o inancı görünce bende bir dakika durup düşündüm. şu son 16 günde olanlardan ve söylenenlerden dolayı inanılmaz derecede öfkeli ve nefret doluyum bu salaklara karşı.
  entry_channels: siyaset,haber
- entry_name: |
    ciddi ciddi güldür güldür / çgh izleyip gülen tip
  entry_id:  88990267
  entry_writer: birliktelik
  entry_fav_count: 39
  entry_content: |
    eli klavye tutabilecek, tuşlara basıp bir şeyler yazmayı becerebilecek yaşa gelmiş bi yazarın, halen daha insanların farklı farklı zevklerinin olabileceğini anlayamayarak sıçtığı başlık..<br/>"allah allah, buna nasıl gülerler yaaaa, allah allah ben bu programları sevmiyorum nasıl olur da başka insanlar bunları sevebilir yaaaa" diye düşünüp kafası bir türlü almıyor herhalde..<br/><br/>sonra da edit büdüt..
  entry_channels: ilişkiler,tv,sanat
- entry_name: |
...
- entry_name: |
    17 nisan 2019 imamoğlu'nun mazbatasını alması
  entry_id:  88998926
  entry_writer: carmex
  entry_fav_count: 20
  entry_content: |
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    game of thrones izlemenin zorlaşması
  entry_id:  89011744
  entry_writer: anonimyus
  entry_fav_count: 8
  entry_content: |
    2019 yılında kendi imkanlarıyla internet üzerinden got izleyemeyen kanald açıp arka sokaklar izlesin.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    doların bu çıkışı çıkış değil benden söylemesi. bu ülkede dolar ciddi miktarlarda yükseleceğinde bu şekilde gıdım gıdım değil bir anda inanılmayacak seviyelere tırmanıyor. şu bir hafta on gündür olduğundaki gibi olduğunda ise 2 ileri adım atıp bir anda 3 geriliyor. <br/>yalancı bahar bunlar. hasta eder adamı! mazbatanın verilme kararı ve kabine değişikliği kararlarıyla ciddi düşüşler gelebilir. tedbiri bırakmayın!
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    16 nisan 2019 salı günü ülker sports arena'da oynanacak ve bein 3 kanalından canlı yayınlanacaktır. ayrıca bu maç için <a class="b" href="/?q=bogan+bogdanovic">bogan bogdanovic</a> ta amerikalardan gelerek misafirimiz olacak. <br/><br/>zalgiris buraya bu sene için tam anlamıyla rüya gerçekleştirerek geldi. ancak euroleague 2018-2019 sezonunu burada kapatacaklarını düşünüyorum. keşke rakibin biz olmasaydık saras hocam. <br/><br/>son söz de doygunluğa ulaşmış olan taraftara. lütfen sarı giyip salona gidin ve maç boyu susmayın. rica ediyorum <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=FmmCrpsteKk" title="https://www.youtube.com/watch?v=FmmCrpsteKk">bu</a> ve <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=aVIXqlF7U4M" title="https://www.youtube.com/watch?v=aVIXqlF7U4M">bunun</a> gibi.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    geçtiğimiz hafta yaşadığım fiyaskodan sonra bu hafta kesinlikle yapmak istediğim olay. bu sefer 2 arkadaş daha gelecek benimle.
  entry_channels: anket
- entry_name: |
    ekşi itiraf
  entry_id:  89013580
  ...
  entry_fav_count: 1
  entry_content: |
    okulumdan bir çocuk yurt odasında dolabına kendini asmış. babası aramış ulaşamamış çocuğa. yurt görevlileri bakmış odaya çocuğun cansız bedenini bulmuşlar dolabın içinde. içim cız etti. ah kardeşim benim. istemsizce instagram hesabına baktım. sanki kardeşim gitmiş gibi hissediyorum hiç tanımadığım halde. neyi nasıl anlatayım ki sen de anlatamamışsın belli. anlayan olmamış. belki bi kere göz göze gelsek anlaşırdık. ben biliyorum çünkü o yılmışlığı ve çaresizliği. güzel kardeşim. tek dileğim burada çok fazla acı çekmemiş olman.
...
- entry_name: |
    karayipler'e tatile gitmek
  entry_id:  89012222
  entry_writer: biscuits
  entry_fav_count: 0
  entry_content: |
    karayiplerdeki denizi ve kumsalı türkiyede kendinizi kesseniz göremezsiniz.dünyanın en iyi 10 plajının 6si falan karayiplerde.muadili hawaii olabilir sadece.apaçi denilen tipler de mevcut değildir. ama ufak bir not: plajda eşyalarınıza dikkat edin.
  entry_channels: 
- entry_name: |
    16 nisan 2019 kadir mısıroğlu'un ölmesi
  entry_id:  89014472
  entry_writer: beyaztenlizenci
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=bahoz+erdal%27%c4%b1n+infaz+edilmesi">bahoz erdal'ın infaz edilmesi</a>)
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ortada herhangi bir bilgi akışı yokken gün içinde 80 ler bandında seyreden doların 75 seviyesine gelmesidir. <br/><br/>oynaklık o kadar fazla arttı ki neler olduğuna yetişemeden değişiyor kur seviyeleri. <br/><br/>neyse yarın seyredip göreceğiz neden özellikle piyasalar kapandığı zaman aşağıdaki bir banda geldiğini.
  entry_channels: 
---
