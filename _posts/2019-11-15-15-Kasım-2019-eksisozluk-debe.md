...
- entry_name: |
    atatürk yaşasaydı türkiye'nin benzeyeceği ülke
  entry_id:  97769712
  entry_writer: graylion
  entry_fav_count: 260
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 89
  entry_content: |
    rteye göre suriyede yaşayan 3 milyon suriyeliye düzenli yardım yapıyormuşuz. <br/>yardım derken? maaş mı bağladınız onlara da yani?<br/>türkiyede de 4 milyon suriyeli var. etti sana 7 milyon.<br/>türkiye gibi yoksul bir ülke 7 milyon suriyeliye bakıyor yani.<br/>bulgaristanın nüfusundan daha fazla.<br/>kendi 5 milyon işsizine milyonlarca eytli vatandaşına "para bulamayan", onları yoksulluğa mahkum eden akp zihniyeti 7 milyon suriyeliye bakıyor yani.<br/>bizim cebimizden çalıp elaleme veriyor.<br/>böyle bir rezillik dünya siyasi tarihinde görülmemiştir.<br/>kendi vatandaşına bu muameleyi reva görmek gerçekten tarih kitaplarına geçecek bir utanç.
  entry_channels: siyaset,haber,ekonomi
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 31
  entry_content: |
    kurban bayramına vahşet diyen adamların asıl vahşeti spor adı altında yapması da ayrı bir ironi. her ne kadar kurban bayramını da eleştirsem de en azından kurban bayramında kesilen hayvan dini ritüeli bir kenara koysak bile birinin boğazından geçiyor. yapacağınız sporu, festivali, eğlenceyi s.keyim.
  entry_channels: haber
- entry_name: |
    yokuşa bayır diyen ağır köylüdür
  entry_id:  97782155
  entry_writer: birmilyonunvarmi
  entry_fav_count: 27
  entry_content: |
    rampaya yokuş diyen ağır köylüdür. yokuş ne lan allah'ın köylüsü?
  entry_channels: 
- entry_name: |
    masterchef türkiye
  entry_id:  97755965
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    hiç bir kadın yoktur ki. direyetli bir erkeğin karşısında yelkenleri indirmesin. dominant kadın yoktur. direyetsiz erkek vardır.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    milli takıma yedek kontenjandan göt zoruyla bir oyuncu gönderebilen himmetçi ezmelere dert olmuş oyuncu.<br/><br/>türkiye'nin adam eksiltebilen ve oyun görüşü yüksek en iyi box to box oyuncularından biridir, takımının en iyi adamı sol bekten bozma bir teneke peyniri olan tipler pek anlamaz.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    izlanda nın defanstaki en büyük kozu. bu akşam yılmazsson u geçersek kazanırız.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    hoşlandığı erkeğe açılan 'güzel' türk kızı olmaması olarak değiştirilmesi gereken başlıktır.buraya ben açıldım, sonuç hüsran vs. yazanlar ortalama veya ortalama altı güzelliğe sahip olduklarına eminim.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
    14 kasım 2019 8e otobüsünde gördüğüm hanımefendi
  entry_id:  97789464
  entry_writer: amd radeon hd 7670m
  entry_fav_count: 4
  entry_content: |
    (bkz: <a class="b" href="/?q=ilk+ta%c5%9f%c4%b1+g%c3%bcnahs%c4%b1z+olan%c4%b1n%c4%b1z+ats%c4%b1n">ilk taşı günahsız olanınız atsın</a>)
  entry_channels: 
- entry_name: |
    çiğköfte vs kısır
  entry_id:  97786431
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://eksiup.com/p/59292982rm7t" title="https://eksiup.com/p/59292982rm7t">pokemon tasosu koleksiyonu</a>m var, bütün mahalleyi üterek; sonra kumarda kazandığım bu tasoları "sıfır" ayarda, iyi kondisyonda olanlarla 10'a 1, 20'1 verip takas edip -ki sonradan o takasladıklarımı da ütmüşümdür ahah- zar zor 1-151 arası pokemonları eksiksiz biriktirmiştim.<br/><br/>isteyene güzel bir fiyattan itelerim, 1 milyondan açıyorum.
  entry_channels: anket,ekşi-sözlük
- entry_name: |
    bir kediye verilebilecek en güzel isim
  entry_id:  97783545
  entry_writer: yelegincemberi
  entry_fav_count: 3
  entry_content: |
    can dostumun yıllar önce bir kedisi vardı bembeyazdı zilli, adını(bkz: <a class="b" href="/?q=peri">peri</a>) koymuşlar. bir isim bir kediye ancak bu kadar yakışabilir.
  entry_channels: anket,ekşi-sözlük
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    tek başınıza içiyorsunuz derin bir düşünme faaliyetidir. herhangi bir sanat dalıyla hemhal olmak şarapla çok iyi gider. <br/>tek değilseniz şarapla iyi giden şey güzel bir sohbettir.
  entry_channels: anket,yeme-içme
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    yine hortlattı pezevenkler
  entry_channels: anket,yeme-içme
- entry_name: |
    kasım 14 2019 ny uçuşunda biz class'taki dişi
  entry_id:  97791577
  entry_writer: kontrolsuz guc is not power
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=let+the+lin%c3%a7+begin">let the linç begin</a>)
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    ona <a class="b" href="/?q=a%c4%9flak">ağlak</a> demek yerine örgütlenip hakkını aramasını bilen meslek grubu demek daha doğrudur.<br/><br/>çalışanların <a class="b" href="/?q=emek">emek</a> mücadelesine köstek olacağınıza siz de örgütlenin kendi mücadelenizi oluşturun. eminim öğretmenler size sizin gibi tepki vermeyeceklerdir.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    insanı devamlı işiyle tehdit eden, kendinden başka herkesi böcek gibi gören bir işverene sahip eşim için iş arayışımız vardır. kendisi antalya'da biri kırtasiye malzemeleri, diğeri tekstil sektöründe hizmet veren iki firmada muhasebe tecrübesine sahip. iki firma da antalya'da kendi sektörlerinde önde gelen firmalardan. <br/><br/>kendisi işletme mezunu ve 4 - 4.5 yıllık bir muhasebe geçmişi var. 28 yaşında, kadın.<br/><br/>cv ve iletişim için dm ya da estoque@windowslive.com
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    diyette olduğumu unutmam benim yaptığım en büyük hatadır.
  entry_channels: sağlık,yeme-içme
- entry_name: |
    prag denince akla gelenler
  entry_id:  97791125
  entry_writer: hoz oryo
  entry_fav_count: 0
  entry_content: |
    ümit özat
  entry_channels: anket,seyahat
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    eskişehir'den dahil olduğum veritabanıdır. birer bira yuvarlayıp muhabbetin dibine vurmak isteyen yazar veya çaylak arkadaşlar yesillendirebilir.
