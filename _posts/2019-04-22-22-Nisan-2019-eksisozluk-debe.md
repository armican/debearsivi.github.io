...
- entry_name: |
    21 nisan 2019 devlet bahçeli açıklamaları
  entry_id:  89182660
  entry_writer: dustiyatrosu
  entry_fav_count: 57
  entry_content: |
    artık iyice zıvanadan çıkmış bir bunağın ağzından saçılan açıklamalardır. <br/><br/>lütfen biri artık şu herifin kasetini çıkarsın da, siktirsin gitsin türkiye siyaset gündeminden.
  entry_channels: 
- entry_name: |
    devlet bahçeli
  entry_id:  89177624
...
- entry_name: |
  ...
  entry_fav_count: 24
  entry_content: |
    ömrüm yeterse bağımsız ve adil bir mahkemede yargılanmasını görmek istiyorum.<br/>bütün suçları ve bütün ihanetleri için hesap vermesini... hem onun hem de ailesinin...<br/>hayatımızı kararttıkları için, ülkeyi bu hale getirdikleri için...
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    ersun yanal'ın artık eşeğin amına su kaçırdığı gerçeğiyle yüzleştiren maç. cocu'ya iki ay tahammül edemeyen, gece gündüz ersun yanal diye götünü yırtan denyo renkdaşlarımın hepsine ayrı ayrı teşekkür ederim. orta sahasında meireless-emre, forvetinde kuyt-sow vs. olmayınca sonucun böyle asitli sonuçlara yol açacağını söyledik diye az küfür yemedik kendilerinden.<br/><br/>başkan bu adamı bu yüzden istemiyordu. umarım şimdiden yerine biriyle anlaşma yapılmıştır. yoksa gelecek sezon babel kılıklı bir sürü gereksizi toplayıp mehmet topal orta sahasıyla devam edecek. şu tolgay'ın tek maçta yaptığı hatalı pas oranını jailson bir yılda yapamadı ama ısrarla bunu oynatıyor. zajc gibi gayet yetenekli daha bir hafta önce milli takımında coşmuş adam yedekte oturuyor. hadi genç takımdan kimseyi düşünmedin de yedekte asli işi forvet olan adam otururken bir yıldır elinde bandajla gezinip top ezmekten başka bir halta yaramayan ayew'i neden bize izletiyorsun hocam.<br/><br/>hakikaten bu ayew'in eline ne oldu bilen varsa yeşillendirsin. herif bir yıl oldu elde bandajla geziyor. bilekten kesip yerine kadavradan çıkma el taksalar şu zamana kadar uyum sağlardı amk.<br/><br/>edit: sinirden coşup alex yazmışım. dobro'ya düzeltme için teşekkürler.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    hepiniz tek tek hesap vereceksiniz kanı bozuklar insanları bu terörist bu değil diye kışkırtanlar hepiniz bu halka karşı hesap vereceksiniz,bu olayın tek suçlusu malum partinin başındaki şahıs sensin.
  entry_channels: siyaset,haber
- entry_name: |
    meral akşener
  entry_id:  89183074
  ...
  entry_fav_count: 15
  entry_content: |
    (bkz: <a class="b" href="/?q=susurluk+belediyesinin+h%c3%b6%c5%9fmerim+ve+pi%c5%9fmaniye+borcu">susurluk belediyesinin höşmerim ve pişmaniye borcu</a>)<br/><br/>istanbul ve ankara'yı birilerinin ellerinden alan lider.<br/><br/>silinip gitsin diye başlığında kudurarak ayin yapıyorlar. <sup class="ab"><a title="(bkz: lol)" href="/?q=lol" data-query="lol">*</a></sup><br/><br/>türk siyasetinde bu saatten sonra yapacağınız tüm hesapları, kuracağınız tüm denklemleri iyi parti'ye göre yapacaksınız.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    bu ülkede olmaz ama almanya'da basit bir suç duyurusuyla anasının amını tersten görmesi çok kolay olan piç.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    izmir’e gitmek için:<br/>6:45’te evden araçla çıkıp burayı kullanıp izmir’de taksiye atlayıp 11:45’te son noktaya ulaştım.<br/>arabasıyla 7:00’da istanbul’dan çıkan arkadaş ile giriş kapısında karşılaştık.<br/><br/>diyeceklerim bu kadar.<br/><br/>edit: aşağıdaki sesli gülen arkadaş söylediklerimin açık izahını yapmaya çalışarak neyi amaçlamış anlamadım doğrusu.<br/>buradan izmir'e gitmek arabayla gitmekten daha zor diyorum. sesli gülüyor ve evet daha zor diyor. abartacak hiçbir şey yokmuş. yavrum ilk defa gitmiyoruz izmir'e uçakla. ödediğim otopark, otoban ücretlerini konuya dahil de etmedim. daha pahalıya daha kötü hizmet alıyorum. siyasi görüşten bağımsız bir hakikat bu.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    burada mı ersun yanalı başımıza saranlar ?? imza kampanyaları başlatıp, parklarda toplaşanlar. <br/><br/>sizin ben futbol ile alakanızın ta aq.
  entry_channels: spor
- entry_name: |
    çubuk
  entry_id:  89187731
  ...
  entry_fav_count: 3
  entry_content: |
    iyi, köpeği, satılmışı, yavşağı meşhur ilçedir.<br/><br/>tarih boyunca da böyle anılacaktır.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    hdp'ye gitse kemalist olmakla suçlarlar, chp'de de kemalist olmamakla suçlanıyor. bu, türk solcuların/sosyalistlerin genelde başına gelir.
  entry_channels: siyaset,haber
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    beşte beş yaparsak bu mümkün. <br/><br/>geçen senenin aynısı şu an her şey. son beş maç ve içlerinde evimizde oynayacağımız beşiktaş ve akbil maçları var.<br/><br/>had be gs. artık top oynayın amk.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    pkk nın faydası nekadarsa bunlarında okadar. amk bölücü paçavraları. senelerce islamcıların sırtında, yancılığında kiralık katillikten, tetikçilikten başka bi sik yapamadılar.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    (bkz: stabil piyasa isteyen iskandinav piyasasında oynasın)<br/>(bkz: <a class="b" href="/?q=burada+siki%c5%9f+var+siki%c5%9f">burada sikiş var sikiş</a>)
