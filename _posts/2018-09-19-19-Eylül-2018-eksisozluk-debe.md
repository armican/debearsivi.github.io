...
- entry_name: |
    maduro'nun nusret'te ziyafet çekmesi
  entry_id:  81394303
  entry_writer: hecadux
  entry_fav_count: 136
  entry_content: |
    kimi nusrette ziyafet çeker kimi katardan uçak alır, gönüller bir olsun.
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    eljif elmas'ın 25 milyon euro'ya serbest kalması
  entry_id:  81411858
  entry_writer: man of constant sorrow
  entry_fav_count: 127
  entry_content: |
    hatadır. elmas'ın sözleşmesine 150 milyon + messi'ye serbest kalır ifadesi eklemelilerdi ki çocuğun takımdaki yerini sağlamlaştırabilsinler.
...
- entry_name: |
    yeşil kundura'nın konkordato ilan etmesi
  entry_id:  81398122
  entry_writer: themeret
  entry_fav_count: 72
  entry_content: |
    dün toplantımız konularından biriydi yeşilin çekleri döndü diye, konkordato haberi geç bile kaldı... musluk açıldığı an patır patır dökülecek firmalar yazık.. maalesef geçtiğimiz 10 yılda alınmayan aksiyonu seçim sonrası 100 gün planında çözmeye çalışmak ne güzel bir plan değil mi? <br/>sonuç olarak 2 kişiden biri aynı kişiye oy verdi ama şu an iki kişi de mağdur. hadi bakalım hepinizin mottosu "kandırıldık!"
...
- entry_name: |
  ...
  entry_fav_count: 31
  entry_content: |
    evlenmek isteyenlere kezban ,30 yaşında olup evlenmeyenlere de evde kalmış dediğinize göre.<br/>e bir karar verin nasıl yapalım ?
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 25
  entry_content: |
    90 lı yıllarda oynasaydı efsane sayılacaktı. tanjuyu karbon kağıdı ile s.ker şuanki defans oyuncuları.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    hiçbirşey kaybetmemiş insandır!
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    (bkz: <a class="b" href="/?q=be%c5%9fikta%c5%9f%27%c4%b1n+asl%c4%b1nda+asla+ma%c3%a7+kaybetmeyecek+olmas%c4%b1">beşiktaş'ın aslında asla maç kaybetmeyecek olması</a>)
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    kara deliğin yüzeyinde durarak, uzayın yarınına bakılabilir mi ?<br/><br/>atomlar belli paternlerle hareket ederken gerçekten de hür iradeden bahsedebilir miyiz ?<br/><br/>dünyada tek bir insan kalsa dahi ahlaktan bahsedebilir miyiz ?<br/><br/>karakterimizi kimyasal reaksiyonlar belirlerken 'iyi' ve 'kötü' tanımları neden mevcut?
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    sen sevilmeyecek, bir ömür paylaşılacak bir adam değilsin, kimse sana bir kaç aydan daha fazla katlanamaz, en iyisi kendi yoluna bak, men going their own way yani (bkz: <a class="b" href="/?q=mgtow">mgtow</a>)
  entry_channels: anket,ilişkiler
---
