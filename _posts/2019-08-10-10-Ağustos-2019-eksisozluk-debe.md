...
- entry_name: |
    1 metre boyundaki pornocu
  entry_id:  93715170
  entry_writer: the guy from batman
  entry_fav_count: 42
  entry_content: |
    başlıkta 1 metre, entry'de 109 cm, haber metninde 106 cm olan pornocu. anladığıma göre boyu yer ve zamana bağlı olarak değişiyor.
...
- entry_name: |
    evdeki cetvelle penis boyu ölçülmüş olması
  entry_id:  93696121
  entry_writer: spinapubica
  entry_fav_count: 11
  entry_content: |
    beklenen karikaturun bir turlu gelmemesi sorununa cozum geldi:<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://eksiup.com/p/e373599i9ov5">https://eksiup.com/p/e373599i9ov5</a>
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    kadınlarınki masum kalır.<br/>inanır mısın erkekler üstsüz giriyor.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    1,90 boylu, +25cm penise ve aktif cinsel hayata sahip, en az 5 tane pasaport defterini doldurmuş, şirket sahibi, aylık minimum $200k kazançlı ekşi sözlük kitlesi için büyük loserdır. <br/><br/>(bkz: <a class="b" href="/?q=ek%c5%9fi+s%c3%b6zl%c3%bck+hi%c3%a7bir+siki+be%c4%9fenmeme+timi">ekşi sözlük hiçbir siki beğenmeme timi</a>)
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    kadın/erkek fark etmez diyenlerin gelen ilk mesajda kişinin cinsiyetini anlamak için girilerini didik didik ettiklerini biliyorum, eziksiniz ve acınası haldesiniz.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
