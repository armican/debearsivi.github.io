...
- entry_name: |
    kadınların sütyen ve külot ile denize girmeleri
  entry_id:  93720384
...
- entry_name: |
  ...
  entry_fav_count: 117
  entry_content: |
    parka gidecekmiş iki gözümün çiçeği.<br/><br/>(bkz: <a class="b" href="/?q=%c3%a7%c3%b6p%c3%a7%c3%bcler+kral%c4%b1">çöpçüler kralı</a>)
...
- entry_name: |
    eljif elmas'ın muhteşem performansı
  entry_id:  93701447
  entry_writer: nitro
  entry_fav_count: 42
  entry_content: |
    ex fb'li artik napoli'li o yuzden basarili olmasini isterim. (not; gs)<br/><br/>sag ayiginin disiyla ikisinin arasindan gecmeye calisirken topu iskalamasa o iki barcali sik gibi kalirdi orada sanssizlik olmus. adam tek basina gidiyor napoli nin geri kalani nerede amk. cesareti takdir edilesi bence. pes etmesin. cabasi iyi.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    2019 yılında hala tanrılara kurban kesmek
  entry_id:  93722252
  entry_writer: veribigket
  entry_fav_count: 18
  entry_content: |
    dinlerin hak olmadığı, ya da herhangi bir dinin hiçbirinin hak din olmadığı yüzde 100 kanıtlanmış gibi bir ifade geçiyor da, bu kanıtın bize de sunulmasını talep etmek bizlerin hakkı olsa gerek. nerede geçiyor bu yüzde 100 kesinlik ve neden bizlerin haberi yok bu hata ve şüphe götürmez kesinlikten? bu ifade sorunlu bir ifadedir. asla o şekilde bir kanıtlama söz konusu değildir. gerek bilimsel, gerek metafiziksel olarak bu kanıtlamayı yapan herhangi bir çalışma falan yoktur, milleti kandırmayın yalan ya da eksik bilgiler vererek.
  entry_channels: 
- entry_name: |
    akp'nin gençlerden çaldıkları
  entry_id:  93721273
  entry_writer: bigbrother
  entry_fav_count: 17
  entry_content: |
    gelecek<br/>doğa<br/>vatan sevgisi<br/>din sevgisi
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    spor, iyi beslenme, düzenli uyku, sıfır masturbasyon ve hayal gücü.
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    <a class="b" href="/?q=yemin+t%c3%b6reni">yemin töreni</a>nden sonra rahmetli babam söylemişti;<br/><br/>''20 sene önce, o ilkbahar akşamı iyi ki ananın verdiği o cevizi ve fındığı yemişim oğlum. gurur duyuyorum seninle''<br/><br/>şakacı adamdı vesselam. huzur içinde yatsın.
  entry_channels: anket
- entry_name: |
    9 ağustos 2019 isbak'taki istifa
  entry_id:  93721047
  entry_writer: fakirpislik06
  entry_fav_count: 7
  entry_content: |
    <a class="b" href="/?q=imamo%c4%9flu%27nun+isbak%27a+yapt%c4%b1%c4%9f%c4%b1+skandal+atama">imamoğlu'nun isbak'a yaptığı skandal atama</a> başlığı altında bu şahsı liyakat ühühü diye savunan liboşlar için sevindirici haberdir. <br/><br/>muhteşem cv’ye sahip bu trollü rahatlıkla kendi şirketlerine müdür yapabilirler. hadi yine iyisiniz kaptınız süper bilgili adamı.
  entry_channels: siyaset
- entry_name: |
    canlı performansı stüdyo kaydını aşan parçalar
  entry_id:  93718810
  entry_writer: littlepea
  entry_fav_count: 6
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="http://youtu.be/I2dyKtSbsbM" title="http://youtu.be/I2dyKtSbsbM">red hot chili peppers - californication live at slane castle</a>
  entry_channels: müzik
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    9 ağustos 2019 liverpool norwich city maçı
  entry_id:  93721976
  entry_writer: s10
  entry_fav_count: 1
  entry_content: |
    emre özcan çok güzel ekledi; “futbol bayramımız kutlu olsun!”
  entry_channels: spor
- entry_name: |
