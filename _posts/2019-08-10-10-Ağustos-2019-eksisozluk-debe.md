...
- entry_name: |
  ...
  entry_fav_count: 335
  entry_content: |
    badinizin sizden alt mevkide olmamasına dikkat edin. aksi takdirde;<br/>(bkz: <a class="b" href="/?q=sekreterini+siken+%c3%a7ay%c4%b1n%c4%b1+kendi+al%c4%b1r">sekreterini siken çayını kendi alır</a>)
...
- entry_name: |
    9 ağustos 2019 yiğit bulut'un sahalara dönmesi
  entry_id:  93698457
...
- entry_name: |
    türk rap tarihinin en iyi diss'leri
  entry_id:  93699544
  entry_writer: northroma
  entry_fav_count: 135
  entry_content: |
    (bkz: <a class="b" href="/?q=sagopa+kajmer">sagopa kajmer</a>)<br/><br/>(bkz: <a class="b" href="/?q=disstortion+e.p">disstortion e.p</a>)
...
- entry_name: |
  ...
  entry_id:  93690250
  entry_writer: sag olasin
  entry_fav_count: 18
  entry_content: |
    mavi ışıklar- <a class="b" href="/?q=helvac%c4%b1">helvacı</a>
  entry_channels: anket,müzik
- entry_name: |
    behzat ç.
  entry_id:  93706796
...
- entry_name: |
  ...
  entry_id:  93716569
  entry_writer: bulentakten
  entry_fav_count: 0
  entry_content: |
    ünye - yason burnu yazacaksın, fakat sen çınarsuyundan taşbaşına kadar bu sahil şeridinde ilerleyeceksin.<br/>aksi taktirde tünellerin tadı sana kalmış
  entry_channels: anket
---
