...
- entry_name: |
    ergenekon ve fetö'cüler birlikte darbe yapabilir
  entry_id:  102432953
...
- entry_name: |
  ...
  entry_id:  102428311
  entry_writer: yukarda yazanlarin tamami hayal urunudur
  entry_fav_count: 22
  entry_content: |
    3-5 cihatçıdan çok idlibteki 4 milyon suriyeliden dolayı bu adımlar atılıyor diye düşünüyorum. zira 4 milyon suriyeli daha gelse tayyip bi daha seçim filan kazanamaz.
...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    devlete koyayım; gariban askere içim gidiyor ! <br/><br/>dün gibi hatırlıyorum çocukluğumu, meşeler, saklambaçlar, 2 taşla kale kurup deli gibi terleyene kadar top koşturmalar. <br/><br/>anasını siktiniz ülkenin, her bakımdan bu ülkeyi bataklığa başımızdaki bu basiretsizler çekti. çok üzülüyorum o tankın içindeki insanlar için !<br/><br/>edit: başlık açıldığında kaynak vardı, başlığı açan kaçtığı için başlık bana kaldı. kaynak ekleyeceğim.<br/><br/>rus saldırısı iddiası için <a rel="nofollow noopener" class="url" target="_blank" href="https://mobile.twitter.com/JulianRoepcke/status/1230912973805408256" title="https://mobile.twitter.com/JulianRoepcke/status/1230912973805408256">kaynak</a><br/><br/>rus saldırısından önce türk tarafının saldırısı olduğu iddiasına dair <a rel="nofollow noopener" class="url" target="_blank" href="https://mobile.twitter.com/JulianRoepcke/status/1230914733928275968" title="https://mobile.twitter.com/JulianRoepcke/status/1230914733928275968">kaynak</a>
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    --- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>aç ve zor durumda olmayan bir köpeğin hiç bir insana zarar vermeyeceğini bilip<br/><br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>iyi ya bu başlık sayesinde yeni şeyler öğreniyoruz anladığım kadarıyla bir köpek asla insana zarar vermez, çeteymiş bölgecilikmiş haşa yapmaz. her hafta üçten az kitap okuyan köpek de yoktur zaten. köpek hayvan değildir insan üstü bir canlıdır.
...
- entry_name: |
  ...
  entry_channels: siyaset,tarih
- entry_name: |
    önyargıyı yıkıp geçen sakallı kardeşim
  entry_id:  102433155
  entry_writer: zamanda
  entry_fav_count: 10
  entry_content: |
    basortulu musluman bir kadin olarak soylediklerinin hepsinin altina imzami atarim.<br/>helal olsun!<br/>edit: bu entry bir baska onyarginin<sup class="ab"><a title="(bkz: butun basortululerin akpli sanilmasi)" href="/?q=butun+basortululerin+akpli+sanilmasi" data-query="butun basortululerin akpli sanilmasi">*</a></sup> yikilmasi amaciyla girilmistir.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    (bkz: <a class="b" href="/?q=suriyeli+s%c4%b1%c4%9f%c4%b1nmac%c4%b1lar">suriyeli sığınmacılar</a>)
  entry_channels: siyaset,anket,tarih
- entry_name: |
    reglken yemek pişiren kadın köpek olarak doğacak
  entry_id:  102434026
  entry_writer: garipbasci
  entry_fav_count: 7
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    üçlükler göksenin'e kaldıysa zaten yandık da sonucu yine son topların belirleyeceği maç olacak gibi. sallamasak bari. melih, kartal şahsi oynayın beyler...
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    ankaradaki evsizler gidip hem okuyup hem sıcak çay içip kek yemelidir. lütfen sokaktaki insanımızı yönlendirin. <br/>gerçekten millet için mi yapılmış görmeliyiz.
  entry_channels: edebiyat,eğitim
- entry_name: |
    mutsuzken yapılanlar
  entry_id:  102431999
  entry_writer: herzamanpilavyiyenpapaz
  entry_fav_count: 1
  entry_content: |
    kedilerimi sevmek<br/>uyumaya çalışmak<br/>battaniyeyle koltukta yaşamak<br/>düşünmemek için çeşitli aktiviteler yapmaya çalışmak
  entry_channels: anket,ilişkiler,sağlık
- entry_name: |
    lanet olası açık yumurtada yetiştirilen civciv
  entry_id:  102413072
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    o dediklerin bende olsa sana neden bakayım amk?
  entry_channels: anket,ilişkiler
- entry_name: |
    erkek yazarlardan kadın yazarlara sorular
  entry_id:  102428231
  entry_writer: dogarkenpatinajyapanadam
  entry_fav_count: 0
  entry_content: |
    neden sevgiliniz, nisanliniz hatta esiniz varken, mahkeme duvari surati sergiledigi halde baska bir erkege ilgi gosterip surekli yaninda oluyorsunuz, anlam veremiyorum. notingo; iskandinavya ulkesi, evlilik yasi dusuk.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    watsap grubumuza hijyene önem veren elit beyler ve aşırı seksi,yakışıklı, güzel memeli arkadaşları bekliyoruz. alkolsüz girmek yasaktır!<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://chat.whatsapp.com/HcJfHOLnJqh39Ds5RJ03EB">https://chat.whatsapp.com/hcjfholnjqh39ds5rj03eb</a>
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    putin çıkaracak, bizimkinin yüzüne çarpacak anca akıllanacak bizimki. saldırı emrini çıkaracak, ne sandınız? <br/>tanım: trajikomik durumdur.<br/>not: şehit/yaralı/hasar yok diyorlar.
  entry_channels: siyaset,haber
---
