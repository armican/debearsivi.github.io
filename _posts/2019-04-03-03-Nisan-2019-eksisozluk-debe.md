...
- entry_name: |
  ...
  entry_fav_count: 67
  entry_content: |
    3 gun once akp'ye oy vermeyen herkese terorist vatan haini derken, ne olduysa birden eksici saftirik solcular tarafindan sempatik bulunmaya baslamis, yok hatta ıstanbul'u bilerek kaybetmis bir bildigi varmis, yok yandaslarini sokaga dokmedigi icin ovguyu hak ediyormus.<br/><br/>siz akillanmazsiniz arkadaslar, asil koyun sizsiniz, tayyip de en cok sizi gutmekten zevk aliyor, yarin cikar demokrasi kelimesini cumle icinde kullanir, hepinizin aklini celer gene.
...
- entry_name: |
    25 yaşında olmak
  entry_id:  88443208
  entry_writer: gingivitis
  entry_fav_count: 12
  entry_content: |
    yaşam tarihinin en önemli kararlarının alınmak üzere olunmasından mütevellit sürekli değişen bir ruh hali ve sabit bir endişe duygusuyla harmanlanmış izotonik bir çözelti halidir. zordur.
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    ibb seçimlerinde farkın yeniden 35.000 e çıkması
  entry_id:  88458889
  entry_writer: al bi de burdan yak
  entry_fav_count: 5
  entry_content: |
    akpnin son başvurularından sonra farkın daha da açılması durumudur. boşuna demiyorlar, “akılsız başın cezasını ayaklar çeker” <br/>ekrem imamoğlunun olaylara fazla müdahale etmeden izlemesi yeterli şuan.. akp onun için de çalışıyor..
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
    şu anda çalan şarkı
  entry_id:  88441715
  entry_writer: mistikkelebek
  entry_fav_count: 3
  entry_content: |
    beni yak, kendini yak, her şeyi yak... <br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=g4dCKrgKrQY">https://www.youtube.com/watch?v=g4dckrgkrqy</a>
...
- entry_name: |
    a haber kapatılsın ak partinin oyu artar
  entry_id:  88459478
  entry_writer: eraslim
  entry_fav_count: 2
  entry_content: |
    son dönemlerin analizi
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    pedofili muhtar adayidir. bu ne lan.
  entry_channels: siyaset
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=huzur+veren+yerler">huzur veren yerler</a>)
  entry_channels: 
- entry_name: |
    yalnızlık
  entry_id:  88459410
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    seçim süreci kavga gürültü derken bu aralar bir hayli yıprandık.<br/><br/>şehrin kargaşasından uzaklaşarak konuşalım, dertleşelim normale dönelim.<br/><br/>sözlük dışı: <a rel="nofollow noopener" class="url" target="_blank" href="http://connected2.me/scepticone" title="http://connected2.me/scepticone">c2</a>
