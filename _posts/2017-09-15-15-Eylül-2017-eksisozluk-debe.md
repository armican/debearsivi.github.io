...
- entry_name: |
  ...
  entry_fav_count: 195
  entry_content: |
    cenk tosun hakkında çok sağlam bir yorum yapmışır:<br/><br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>cenk yabancı sınırına en güzel cevabı verdi bu akşam. üstelik de konuşarak <a class="b" href="/?q=ben+adam%c4%b1m">ben adamım</a> falan diyerek yapmıyor bunu. sahada gösteriyor. hak eden adam türk de olsa formayı alıyor. boşa konuşmayın.<br/>--- <a class="b" href="/?q=spoiler">spoiler</a> --- <br/><br/>dedi bu akşam. adamlığa vurgusu efsaneydi.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 69
  entry_content: |
    gelmis gecmis en iyi turk teknik direktordur. <a class="b" href="/?q=fatih+terim">fatih terim</a> denilen ballilik abidesi sahsiyetle karsilastirmak kendisine hakarettir.<br/><br/>en buyuk hayalim de hangi takimla oldugu zerre umrumda degil ama bir turk takimi ile avrupa'da kupa kaldirip su bitmeyen <a class="b" href="/?q=imparator">imparator</a> goygoyunu kapatmasi oldu hep. kendisinin de besiktas'in da yolu acik olsun.<br/><br/>not: galatasaray
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 40
  entry_content: |
    mükemmele yakın oynadı bugün. özellikle pepe ile uyumu çok iyi. adam harcamaya yer arayanlara fırsat verdi ama maçın geri kalanında çok iyi toparladı. helal olsun sırp kartalı.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    (bkz: <a class="b" href="/?q=53n1n+y4p4c4%c4%9f1n+151+53v3y1m">53n1n y4p4c4ğ1n 151 53v3y1m</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    erken yatmam gerekiyordu. hadi ryan atta uyuyacam ben dedim. attı uyuyamıyorum.
- entry_name: |
...
- entry_name: |
    14 eylül 2017 nuriye ve semih'in mahkemesi
  entry_id:  70794504
  entry_writer: iyotzin
  entry_fav_count: 6
  entry_content: |
    tutuklandıklarından beri, kamuoyu son durumlarını görmesin, bilmesin diye ziyaretçi yasağından tutun da fotoğraf çekilmeleri bile yasaklandı. bugün yapılacak mahkemeye, jandarma 'yeterli personelimiz yok, kaçırılacaklar diye ihbar' aldık gerekçesiyle getirilmeyecekleri bildirildi. nuriye ile semih'in adil yargılanma hakkı, avukatlarının önceki gün gözaltına alınmalarıyla beraber bu durum ile tekrar gasp ediliyor. mahkeme onlar olmadan ertelencek, esaret halleri, açlık grevi ile beraber devam edecek.
- entry_name: |
    south park
  entry_id:  70799781
  ...
  entry_fav_count: 2
  entry_content: |
    yeni sezona güzel bir başlangıç yapan dizi. amerikan çomarları beklediğimiz bir konuydu ama beklemediğimiz bir altyapıyla sundular (dekorasyon programı nedir ahahah). güldük eğlendik, yeni bölüm için hafta saymaya başladık. hayırlısı.<br/><br/>not: beğenmeyeni de "ortadoğulu ıyyy" diye yaftalamaya gerek yok. birinin south park'ın yeni sezonunun ilk bölümüne "vasat" demesi onun recep ivedik'i sevdiği anlamına gelmez. bunu yaparsan onu yerin dibine geçirmiş olmazsın, yalnız kendi sığlığını ve sığırlığını alenen tescillemiş olursun.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    az önce <br/>sana baktım <br/>aynadan;<br/>gülüştük.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bildiğim kadarıyla <a class="b" href="/?q=it">it</a> çalışanlarının<sup class="ab"><a title="(bkz: it guy)" href="/?q=it+guy" data-query="it guy">*</a></sup> en büyük derdi.<br/><br/>aranmayı geçin, tatilinin ortasında saatlerce yol katedip işyerine geri dönup boktan bir problemi çözüp tekrar tatile geri dönenini gördüm.
- entry_name: |
    kendime not
  entry_id:  70802663
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    slovenya'nın turnuvanın başından beri gösterdiği muhteşem performansı sürdürdüğü maç.<br/><br/>ilk maçlarından itibaren bu anın geleceğinin sinyallerini veriyorlardı zaten.<br/><br/>herkes luka doncic'ten bahsetmiş, katılıyorum tabii ki ama goran dragic'in hakkını vermek lazım. yine her zamanki gibi muhteşem oynuyor.<br/><br/>bu keyifli maçta beni tek üzen nokta ise bana göre avrupa'nın yetiştirdiği en büyük basketbol yıldızlarından biri olan pau gasol'ün bu kadar istemesine rağmen kaybediyor oluşu. 2015'te tek başına getirmişti kupayı ama bu sefer olmayacak gibi görünüyor.
---
