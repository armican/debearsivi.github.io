...
- entry_name: |
  ...
  entry_fav_count: 183
  entry_content: |
    düşünsene edinburgh'tan çıkıp ailece tatil için istanbul'a gelmişsin. uçağın 8 gibi inecek, rezervasyonun hazır, otele gidip dinlenirim diyorsun ve hop bursa'dasın.<br/><br/>turizm böyle yapılır. herkes istanbul'u mu gezecek?
...
- entry_name: |
  ...
  entry_id:  100167908
  entry_writer: neyleseki
  entry_fav_count: 19
  entry_content: |
    bu kızcağızı yolda görseler ağzını eğecek, zihninde tanımladığı bayan tanımına kalıbına sığmadığı için her türlü alaya mizaha konu edecek adamlar burada duyar kasar olmuş. aslında duyar felan hikaye kendi bok çukuru zihninde bulunan irini ide adı altında sırf siyasi malzeme amacıyla sonuna kadar kullandılar dedikleri çıkmayınca ailesine sardılar aklınca çıkarım yapıp çelişki arıyorlar.. az kahpe değilsiniz..
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    kamp yaptığım zaman. özelikle güneşin batışını ve doğuşunu izlerken.
...
- entry_name: |
    jesse sekidika
  entry_id:  100206733
  entry_writer: ezhellll
  entry_fav_count: 5
  entry_content: |
    garry rodrogues ve onyekuru karisimi fakir mane si. bir cok macini canli izledim. telekomdaki maçlarda gercekten sikerticek bir oyuncu
  entry_channels: spor
- entry_name: |
    jelibon yiyen erkek
  entry_id:  100203597
  ...
  entry_fav_count: 5
  entry_content: |
    sağlıklı olmadığından haftada birkaç gün ancak yiyebiliyorum. sorun olmayacağını bilsem çekirdek gibi cebimde taşırım.
  entry_channels: yeme-içme
- entry_name: |
