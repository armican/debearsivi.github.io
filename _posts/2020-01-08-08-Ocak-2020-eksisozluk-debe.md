...
- entry_name: |
  ...
  entry_channels: tv
- entry_name: |
    şişli etfal'de yanlışlıkla öldürülen genç
  entry_id:  100208374
  entry_writer: tommati
  entry_fav_count: 21
  entry_content: |
    ''kutlu'nun 3 kasten yaralama ve görevi yaptırmamak için direnmekten suç kaydı olduğu belirlendi.''<br/><br/>başka sözüm yok hakim bey.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    evren bir similasyon değildir evren bir canlıdır. her galaksi bir hücre ve bunların bir araya geldiği evren bir dokudur. sonra başka bir doku. belki de biz bir canlının götünün kenarındaki bir yağ tabakasının içindeki bir hayatız. <br/>belkide o canlı kendi evrenindeki serengeti düzlüklerinde gezen öküz başlı bir antiloptur. <br/>bunca galaksi falan antilopun kıçındaki bir yapıtaşı. <br/>o antilopun evrenide bir koalanın göz hücresinin bir yapı taşıdır.
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    mutlaka yazılmıştır ama<br/>(bkz: <a class="b" href="/?q=raskolnikov">raskolnikov</a>)
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    "senden borç isteyen hiç kimseyi geri çevirme, kaybetmeyi göze alabileceğin bir miktarsa hepsini ver, değilse, geri ödemediğinde üzülmeyeceğin kadar bir miktar teklif et ama kesinlikle 'hayır' deme. geri öderse ne ala, ödemezse unut."
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    hamurudur.. her pizza da peynir olması gerekmez, domates sos olması gerekmez, başka bir şey olması gerekmez ama hamur olmazsa pizza olmaz.
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    evli kadınlar da mutluluktan uçuyorlardı :))
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    bu konu hakkında ahkam kesmek veya benim bulunduğum pozisyonda durmayan birilerini yaftalama gibi bir hadsizliğim olamaz fakat bu konuda emin olduğum bir ortak noktaları var; <br/>tartışmada asla "evet ikna oldum, haklısın galiba, sen haklısın, gözümden kaçmış" gibi cümleler sarf etmiyorlar. onlar için tartışmak bir fikir alışverişi değil, bir savaş. kazanmak veya kaybetmek olarak bakıyorlar olaya. dövüş gibi. ilkel güdülerini, fikri tartışmalarda bile muhafaza ediyorlar. <br/>"onu tartışmada yendim" gibi cümleler kurarlar. haklılarsa "muzafferdirler" ama karşı taraf haklı ise "mağlup" oluyorlar.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    olay bize patlar. kimin tarafındaysak onlar kaybeder.
  entry_channels: 
- entry_name: |
    şu anda çalan şarkı
  entry_id:  100197998
  ...
  entry_fav_count: 1
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=L7vWSz2_pR0">https://www.youtube.com/watch?v=l7vwsz2_pr0</a>
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    yeni moda mı la bu başlıklar, sabahtan beri yok onun dediği gibi, yok şunun dediği gibi..<br/>gidip efendi gibi alakalı başlıklara yazsanıza olum? mal mısınız?<br/><br/>tanım: bir başka çeşit mal versiyonu başlık.
  entry_channels: anket,müzik
- entry_name: |
    jesse sekidika
  entry_id:  100211552
  ...
  entry_fav_count: 1
  entry_content: |
    yaşı yetenler bu sezonki gs transfer politikasını 2. ft dönemine benzetmiyor mu? yaşlı eski yıldızlar, ne çıkacağı belli olmayan genç oyuncular ve uzun zamandır oynamayan oyuncular. hepsi bir umut. 2.ft döneminde nerdeyse hepsi fos çıkmıştı. umut işte.<br/><br/>umut barındıran transfer
  entry_channels: spor
- entry_name: |
    dini işletim sistemi
  entry_id:  100212348
  entry_writer: apistogramma
  entry_fav_count: 1
  entry_content: |
    apple fanboyları gibi adamlarsınız amk. sizin gibi bir cahiller de inanmayanlara hakaret edip onlarla dalga geçen insanlar. bir gemide zıt yönlere kürek çeken insanlarsınız, aynı yerde saymaya devam.<br/><br/>örnek almak için (bkz: <a class="b" href="/?q=hindistan">hindistan</a>)<br/>her türlü inanç ve yaşayış biçimi var ve adamlar bu mantaliteyle bizden daha ilerideler.
  entry_channels: 
- entry_name: |
    şu an okunan kitap
  entry_id:  100211350
  ...
  entry_fav_count: 0
  entry_content: |
    bir taraftan j. r. r. tolkien'den hobbit fantazi romanını bir taraftan the martian eseriyle tanıdğımız andy weir'in artemis bilim kurgu romanını okuyorum.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    doğa kampını bilmem ama bozcaada akvaryum koyu'nda koyu ikiye bölen burna sıçanların ağzına sıçayım. bir yürüyelim manzaraya bakalım dedik boktan adım atacak yer kalmamış. götünüz kopsun, dübürünüz kurusun.
  entry_channels: 
- entry_name: |
    bursa'da bilerek köpeği ezen cani
  entry_id:  100208553
  entry_writer: gelismekteolanyazar
  entry_fav_count: 0
  entry_content: |
    sanki yayaya çarpmamak için manevra yapıyormuş gibi geliyor bana.<br/>elindeki poşetle yolun ortasında dikiliyor allah'ın köylüsü.
  entry_channels: haber
---
