...
- entry_name: |
  ...
  entry_id:  89995945
  entry_writer: inferius
  entry_fav_count: 164
  entry_content: |
    sütyenden başka bir şey değildir.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    yanında zurnacısı da dahil olmak üzere anasını avradını siktiklerimdir. gürültülerinden kendim rahatsız olmasam da olanlar var... gerçi kimsenin rahatsız olmaması bu şeyin yanlış, saçma, salakça olduğu gerçeğini değiştirmiyor. bu davulcu denen ufak çaplı çete oluşturmuş arizona kertenkeleleri oruç tutanı da tutmayanı da rahatsız ediyorlar. hem de ne idüğü belirsiz şeyler çalarak bu rahatsızlığın şiddetini arttırıyorlar. bir de bahşiş almaya kalkıyorlar utanmadan sıkılmadan.
  entry_channels: siyaset,tarih,müzik,edebiyat,yeme-içme
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    eline tutuşturulan metni okuyamayan kimyager.<br/><br/>ulan senin neyine avrupa edebiyatı. rotasyon ayağına avrupa maçlarını veren tipitipsin.<br/><br/>üç hafta önceki özgüven artistlik gitmiş ağlamaklı facebook edebiyatçısına dönmüşsün.<br/><br/>(bkz: <a class="b" href="/?q=biraz+i%c3%a7erlemi%c5%9f+gibisin+eruhlu">biraz içerlemiş gibisin eruhlu</a>)
  entry_channels: spor
- entry_name: |
    ekşi sözlük dertleşecek insan veritabanı
  entry_id:  89984319
  entry_writer: valparaiso
  entry_fav_count: 0
  entry_content: |
    bana yazmayın evliyim, yengeniz sıkıntılı.
