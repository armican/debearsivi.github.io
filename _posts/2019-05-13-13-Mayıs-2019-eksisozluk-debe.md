...
- entry_name: |
  ...
  entry_fav_count: 51
  entry_content: |
    şikecilerin ve tinerci şikecilerin son umudu olan maç.
  entry_channels: spor
- entry_name: |
    garsona yaptığım acımasız şaka
  entry_id:  90009411
  entry_writer: jack da ripper
  entry_fav_count: 45
  entry_content: |
    (bkz: <a class="b" href="/?q=embesillerde+bug%c3%bcn">embesillerde bugün</a>)
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 43
  entry_content: |
    ruh hali yuzune vuruyor. ne yediginden ne ictiginden ne uykusundan ne de aldigi nefesten zevk aliyordur. muthis bir korku ve tedirginlik hakim. hic bir seye benzemez halkini satanlarin korkusu...
...
- entry_name: |
    selahattin demirtaş
  entry_id:  89982284
  entry_writer: cani sikilan insan
  entry_fav_count: 34
  entry_content: |
    kendisi türkiye siyasetinde oldukça önemli bir yer edinmiş ve ileride de siyasetin şekillenmesinde önemli roller alacaktır diye düşündüğüm siyasetçi. demirtaş, hdp'yi hdp'nin hayal dahi edemeyeceği yerlere taşımış, türkiyelileşmek temelli bir siyasetle neler başarılabileceğini göstermiştir. hak mücadelesinin yolunu doğru çizdiklerinde toplumun her kesiminden destek alabileceklerini göstermiştir. türkiye gibi karizmatik liderlere neredeyse tapanların bulunduğu bir ülkede elbette kendisi partisinden daha önemli bir yerdedir. farklı bir partide olsa ne olurdu sorusunun cevabını rte ile görmek mümkün. <br/><br/>her siyasetçi gibi sevabı da günahı da vardır. fakat en büyük hatası başarısının iktidarın yanı sıra pkk ve hatta hdp içinde rahatsızlık yarattığını görememesi veya önüne geçememesidir. kendisine gösterilen destek pkk'nın kendini dayandırdığı zeminin ve gücün kaybedilmesi anlamında gelmekteydi. bu sebeple bugün içinde olduğu durumun bir sebebi iktidarın çıkar hırsı ise diğer sebebi de pkk'nın gücünü kaybetme korkusudur. bunları aşmak için en büyük sorumluluk kendisi ve etrafındakilere düşmektedir. tabi bunun için önce gerekli zemini bulabilmesi gerekiyor. chp'nin bile terörle anılmaya çalışıldığı, ak partinin bile mhp'lileştiği bu ortamda pek mümkün olmasa da önündeki uzun ve zorlu yolu aşacağını düşünüyorum, umuyorum. çünkü türkiye'de gerçek anlamda bir barış bir gün olacaksa kendisinin önemli bir rolü olacaktır.
...
- entry_name: |
    21 mayıs 2019 kulüpler birliği toplantı kararı
  entry_id:  90009156
  entry_writer: little mr sunshine
  entry_fav_count: 19
  entry_content: |
    hakemler aslında insan diil hata yapamazlar diye bildiri cıkacak toplantı. topunuz gelin amkoduklarım
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    mazbatayı çaldınız sıra sloganımıza mı geldi. hoşt köpekler.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    korsan bildirinin mimarlarından.<br/><br/>yüz yıllık kulüpler bunların götünde kelebek olmuştu.<br/><br/>17'ler yavaş yavaş çözülürken haftaya bunların hesabını keseriz bu dramda sona erer.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    bir <a class="b" href="/?q=izban">izban</a> ahır kokusu değildir.
  entry_channels: seyahat
- entry_name: |
    12 mayıs 2019 tavuk dünyası rezaleti
  entry_id:  90008763
  entry_writer: ozi buyudu
  entry_fav_count: 5
  entry_content: |
    buna benzer ama daha farklı bir terbiyesizlik sebebi ile tavuk dünyasının torium avm şubesinin tüm personellerini değiştirtmişliğim vardır. sözde klas bir yer ama bildiğin gravatlı öküz çalıştırıorlar. <br/><br/>yemek yemek için gelen insana ne sebeple olursa olsun bağırılmaz, böyle pislik yapılmaz.
  entry_channels: yeme-içme
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    abd ancak ırak'a, afganistan'a saldırır. götü yemez iran'a saldırmaya. iran'a saldırıdığı anda başta rusya olmak üzere bir kaç büyük devleti karşısında bulur. 80-90 milyonluk ülkeye saldırmak o kadar kolay değil.
  entry_channels: 
- entry_name: |
