...
- entry_name: |
  ...
  entry_fav_count: 49
  entry_content: |
    şikecilerin ve tinercilerin son umudu olan maç.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: spor,haber
- entry_name: |
    türk lirasını 6 kat değersiz sanmak
  entry_id:  89978202
  entry_writer: buralara nerden geldim
  entry_fav_count: 13
  entry_content: |
    6 kat diyen iyimser bile yaklaşmış. kaç kat olduğunu hesaplayamıyoruz bile.
