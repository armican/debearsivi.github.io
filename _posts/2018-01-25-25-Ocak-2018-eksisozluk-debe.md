...
- entry_name: |
    23 ocak 2018 afrin operasyonunun detaylı analizi
  entry_id:  73716242
  entry_writer: oakpost
  entry_fav_count: 39
  entry_content: |
    yarrak gibi analiz.<br/><br/>a haber ayarında tam aktrollere özgü bir analiz olmuş. rusya'daki başkanlık seçimlerinden girmiş petrolden çıkmış.zamanıma yazık.<br/><br/>eğer bir siyasi analizde hamaset edebiyatı varsa itibar etmeyin. zaten yazı bütünüyle çelişkili. e tabi herkes siyasi uzman.
- entry_name: |
    ekşi itiraf
  entry_id:  73713379
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    amk teroristlerinin propagandasini yapip ta yalandan ah vah tuh tuh diyen orrrrrul orrrul orospu cocugu iceren basliktir. tesadufunu sikiyim.
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  73723436
  entry_writer: bluecve
  entry_fav_count: 3
  entry_content: |
    “you will ride life straight to perfect laughter. <br/>it’s the only good fight there is.”<br/><br/>(bkz: <a class="b" href="/?q=charles+bukowski">charles bukowski</a>)
- entry_name: |
    erbatur ergenekon
  entry_id:  73732988
  entry_writer: tucek
...
- entry_name: |
    kadın
  entry_id:  73714377
  entry_writer: realdreamer
  entry_fav_count: 1
  entry_content: |
    "bir insanın sevdiği kaç kere ölür, bir insan sevdiğinin ölümüne kaç kere dayanır?" diye haykıran enver bey ne güzel tükürüyor şirin'in suratına. bu dizideki oyuncular gerek piskopat şirin, gerek enver dede, gerek kahveci arif olsun aşırı iyi oyuncular. çocuklar bile kaliteli rol yapıyor resmen. bütün bölümlerini izledim diyemem ama bazen bakıyorum ve bence saygıyı hak eden bir iş oluyor. arif'i oynayan oyuncunun önünde ayrıca şapka çıkarırım. özge özpirinççi'yi de dandik roller yerine daha özgün projeleri seçtiği için tebrik etmek gerek.<br/><br/><a class="b" href="/?q=edit">edit</a> bunca acıdan sonra sarp geri dönmez, fakat bahar da artık yaşayamaz. dizinin sonunda bahar ölecek bence. bu arada arif aşırı güzel seviyor. hem sevgi neydi, sevgi emekti.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    erkeklerin arayıp bulmadığı bulduğunda ise ağzına sıçacağı kadındır.
- entry_name: |
