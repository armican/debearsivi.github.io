...
- entry_name: |
    türk ordusunun en güçlü sekizinci ordu olması
  entry_id:  74519692
  entry_writer: sevdim seni cok kere
  entry_fav_count: 225
  entry_content: |
    gönül isterdi ki en demokratik, en adil, en gelişmiş, en yaşanılır 8. ülke olalım. bunlar olmadan tek başına güçlü orduya sahip olmak vatandaşa hiçbir şey kazandırmaz.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 73
  entry_content: |
    (bkz: <a class="b" href="/?q=ablan+reisci+bebe%c4%9fim">ablan reisci bebeğim</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 59
  entry_content: |
    yıl dönümünde tüm şehitlerimizi saygıyla anıyoruz. <br/><br/>hepiniz ermeniyseniz hocalı'nın hesabını verin.
- entry_name: |
...
- entry_name: |
    vergi iadesi zarfı doldurmak
  entry_id:  74513348
  entry_writer: doctor ross geller
  entry_fav_count: 45
  entry_content: |
    90 yillarda yapilan ilginc ötesi eylem. <br/><br/>simdi bu basligi gorunce aklima bizim tam turk kafasinda olan uc kagitcilik masteri yapmis komsu aklimiza geldi. kadin bize gelip, nasil olsa hepsine bakmiyorlar siz 60.000'lik fisi 100.000 yazin cinsinden birseyler geveliyordu. ben de o yasimla, daha okuma yazmayi ogreneli 1 yil bile olmamisken, ben asla yanlis yazmam, ne yaziyorsa o mantigi ile hepsini kurusuna kadar dogru yaziyordum. iyki ailemdekiler, bu isi bana birakiyordu. kendimi su an ilyas salman-sener sen filmlerindeki ilyas salman'in dogruluktan ayrilmayan karakteri gibi hissettim<sup class="ab"><a title="(bkz: asdfgh)" href="/?q=asdfgh" data-query="asdfgh">*</a></sup>
- entry_name: |
    ekşi itiraf
  entry_id:  74509929
...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    "atiba medel tolgay orta sahasını ben ilk 11 çıkarmadım sevgili gençler."<br/><br/>oğuzhan maçtan hemen önce mide sorunundan dolayı mecburen kadrodan çıkarıldı. talisca sarı kart cezalısıydı. hangi ortaya sahayla çıksaydı sayın amına koyduğum çok bilmişi? önde love arkada negredo mu yapacaktı?<br/><br/>ülen azcık insaflı olun oğlum, azcık lan. çok zor değil bu.
- entry_name: |
...
- entry_name: |
    henüz çaylaklardan mesaj almamış yazar
  entry_id:  74509894
  entry_writer: goz onunde sakli
  entry_fav_count: 2
  entry_content: |
    ben hep sözlüğün "herkese mesaj atayım ama kimseden mesaj almayayım" özelliğini kullandığım içün beni ırgalamayan konu. ohh miss.
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    çaylaklarla mesajlaşma imkanı tanınmışken halen alternatif linkler üretenleri gördüğümüz başlık. çaylaklar fazlasıyla yeter gençler, biraz güvenin onlara.
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    bilekleri kesik piyano çalıyordu karanlık odada ...
- entry_name: |
    otizmli çocuklara bağış için oyna projesi
  entry_id:  74534452
  entry_writer: muya pesito
  entry_fav_count: 1
  entry_content: |
    bir hekim olarak hastalıkla mücadele eden insanlara yapılan her türlü iyiliği ayakta alkışlıyorum
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    bir bilimkurgu yapımında <a class="b" href="/?q=battlestar+galactica">battlestar galactica</a> seviyesini zaten hiçbir diziden beklemiyorum, zaten yapımların tarzları da farklı. cyberpunk var, ölümsüzlük ve fütürist öğeler de olunca izleniyor. efsane mi, hayır. sci-fi sevenlere uyar mı, evet.<br/><br/>-- spoiler--<br/>peki bu "idare eder" hissiyatını ne yaşatıyor?<br/><br/>- ortega isimli azimli idealist kadın polis kontenjanından giriş yapan kadın. yamuk ağzı, itici mimikleri, her bir şeye dahil olması, salak hareketleri ve saçma salak ailesi ile gına getirtti. (ki kitapta rolü çok daha azmış, çok mantıklı) illa klişe amaçlı şöyle baskın ve sıkıcı bir karakter koymasalar ölecekler yapımcılar.<br/><br/>- stronghold muharebesi diye verdiler gazı verdiler gazı, biz de bu elçi aka envoylar çok süper bir savaşa girmişler ölümüne çatışmışlar diye heyecanlandık durduk. tamam iyi eğitilmişler ancak muharebe denen şey bir çeşit kimyasal saldırı sonucunda neredeyse tüm elçilerin saklandıkları yerde ölmesi. (ya da birbirini öldürmesi)<br/><br/>- final bölümünün son 15-20 dakikasının tarzı ile adeta 235 dk'lık herhangi bir türk pembe dizisinden farkının olmaması.<br/><br/>- tak'ın kardeşinin klonlarının ortega ile dövüştükleri sahne. o seviyede eğitilmiş bir kadının bir klonu ölür ikincisi ölür ama üçüncüsü kadını paramparça eder. bir de duvara katana koymuşlar daha ne olsun. robotik eli var diye ölümsüz olmuyor bu kadın. <br/><br/>dizinin yıldızı ise gönüllerin a.i'ı poe idi; mükemmel olmuş. canlandıran oyuncuya saygılar. harcanması çok üzücüydü.
- entry_name: |
    4 saat boyunca çıkarmamak
  entry_id:  74534695
  entry_writer: swollenmember
  entry_fav_count: 1
  entry_content: |
    müzik dinlemek için kulaklığı taktığımda gerçekleştirdiğim eylemdir.
- entry_name: |
    tıp bilimi sayısal mi yoksa sosyal bilim mi
  entry_id:  74534757
  entry_writer: swollenmember
  entry_fav_count: 0
  entry_content: |
    acilde kan kaybından ölmek üzereyken tıp doktoruna sormayacağım sorudur.
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    başakşehir takımından nefret ederim ama sabaha kadar oynansa gençlerbirliği puan alamaz bu maçtan. çok kötü.
---
