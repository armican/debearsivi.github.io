...
- entry_name: |
  ...
  entry_fav_count: 56
  entry_content: |
    (bkz: <a class="b" href="/?q=t%c3%bcrkan+saylan">türkan saylan</a>)<br/>(bkz: <a class="b" href="/?q=%c3%a7i%c4%9fdem+ka%c4%9f%c4%b1t%c3%a7%c4%b1ba%c5%9f%c4%b1">çiğdem kağıtçıbaşı</a>)<br/>(bkz: <a class="b" href="/?q=canan+da%c4%9fdeviren">canan dağdeviren</a>)<br/>(bkz: <a class="b" href="/?q=asuman+%c3%b6zda%c4%9flar">asuman özdağlar</a>)<br/>(bkz: <a class="b" href="/?q=bilge+demirk%c3%b6z">bilge demirköz</a>)<br/>(bkz: <a class="b" href="/?q=feryal+%c3%b6zel">feryal özel</a>)<br/>(bkz: <a class="b" href="/?q=zuhal+balta%c5%9f">zuhal baltaş</a>)<br/>(bkz: <a class="b" href="/?q=zeynep+aycan">zeynep aycan</a>)<br/><br/>ayrıca kız değil kadın.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    abd'de satın aldıktan aylar sonra sorgusuz sualsiz iphone'u iade edebildiğiniz apple'ın bile tamamen türkiye'ye özel tüketici aleyhine kurallar getirdiği bir e-ticaret piyasasında fazla umut beslemediğim gelişme. hepsibilmemne gibi "bu ürün açılmış, kime satalım bunu" diye mail atarlarsa şaşırmam.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    "o yüzden savcılar zekeriya öz ile mehmet berk'in olumlu yansımalarını 2-3 yıl sonra görebileceğimiz 'doğru-dürüst futbol' ortamının milat isimleri olarak görüyorum."<br/><br/>zamanında bunları yazan, kandırılanlar tayfasından biri. biz vatanını severleri hapislerde çürütenleri destekleyenleri unutmayacağız serdar ali. sen de onlardan birisin. devran dönünce avm tuvaletlerine yapıştırılan sümükten farkın kalmayacak ve unutulacaksın.
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  74533896
  entry_writer: eliaria
  entry_fav_count: 4
  entry_content: |
    (bkz: <a class="b" href="/?q=dr.+king+schultz">dr. king schultz</a>) <br/>(bkz: <a class="b" href="/?q=django+unchained">django unchained</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    ya benim kafamı kurcalayan bir durum var. bir çok kişi 150 yıllık dedelerinin felan sağ olduklarıyla ilgili espiri yapıyorlar eyvallah da, benim aklıma takılan konu şu: <br/><br/>bu sağ olarak gösterilen kişiler, oy zamanı sanki oy kullanmış gibi sayılıyor olabilir mi?<br/><br/>herkesin hatta benim soy ağacı bilgilerimde bile böyle bir iki dede nine vardı, hala sağ gözüken.<br/><br/>peki bunlar toplanıp (binlerce kişiden bahsediyoruz) birileri tarafından, oy kullanmışlar gibi gösterilebilir mi?<br/><br/>düzeltme: bir arkadaş uyardı konu hakkında. aynen gönderdiği mesajı buraya bırakıyorum, kendisine teşekkür ediyorum <br/><br/>"seçmen kaydı ile nüfus kaydı aynı şey değil yalnız. nüfusa kayıtlı olduğu halde adres kaydı olmayanlar seçmen olamadığı için oy kullanamaz. geçmiş senelerde sağ bir insan olarak bu sebeple oy kullanamadığım oldu. hele ki şimdi adrese dayalı nüfus kayıt sistemi varken biraz daha zor bu bahsettiğiniz ihtimal"
- entry_name: |
    kedi
  entry_id:  74509966
  entry_writer: lickycat
  entry_fav_count: 2
  entry_content: |
    boşlukta yer kaplayan, ağırlığı ve hacmi olan, tüylü, bıyıklı ve tripli varlığa kedi denir.
- entry_name: |
    şu anda çalan şarkı
  entry_id:  74537901
  ...
  entry_fav_count: 1
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=NrgcRvBJYBE" title="https://www.youtube.com/watch?v=NrgcRvBJYBE">noir desir-le vent nous portera</a>
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    lise yıllarıma tekabül eden an’dır.<br/><br/>ortaokulda bayağı düş ermeni, rum, yunan ne varsa düşmandım. kaynağı da sosyal bilgiler dersine ve hocasına dayanırdı.<br/><br/>liseye geçip biraz da boş vakitlerimi wiki gibi ortamlarda ve yabanci tv kanallariyla hasir nesir gecirince etkisinden de kurtuldum.
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    bir efsaneye göre böyle düşüyormuş.
---
