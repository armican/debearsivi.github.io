...
- entry_name: |
  ...
  entry_fav_count: 36
  entry_content: |
    bu <a class="b" href="/?q=yirmi+iki">yirmi iki</a> filmin tamamını izleyip, <a class="b" href="/?q=yirmi+iki">yirmi iki</a>sini de beğenmemiş olanlar size iki sorum var.<br/><br/>1. beğenmediğiniz ve hatta bok gibi dediğiniz filmlere ısrarla neden gidiyorsunuz? bundan keyif mi alıyorsunuz?<br/>2. acaba siz süper kahraman filmi sevmiyor olabilir misiniz?<br/><br/>hadi topluca bir beyin fırtınası yapalım.
...
- entry_name: |
  ...
  entry_fav_count: 29
  entry_content: |
    (bkz: <a class="b" href="/?q=hamsi+pub+ne+a.q.">hamsi pub ne a.q.</a>)
  entry_channels: 
- entry_name: |
...
- entry_name: |
    bedelli askerlikle dalga geçen fahişeler
  entry_id:  89505402
  entry_writer: bana bi de bakem
  entry_fav_count: 22
  entry_content: |
    ceni üzdüler mi? cen sinirlendin mi? ak yapıcam onları ben. hadi cen ağlama.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    yok ruhsal çöküntülermiş, karakter dalgalanmasıymış bilmem ne.<br/><br/>düpedüz orospuluktur. daha iğrenç bi tanımlama da yoktur.
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    suistimale açık bir karardır.<br/>böyle bir karar demokrasi, hukuk ve insan hakları konusunda geri kalmış rusya gibi bir ülkeden beklenir.
  entry_channels: haber
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    burhan altıntop'un hamile olduğunu öğrendiği an mini etekle bacak bacak üstüne atıp "kimdenmiş ki?" diye sorması.
  entry_channels: anket,tv
- entry_name: |
    hiç yüzünden öldüresiye dövülen 11 yaşındaki çocuk
  entry_id:  89505088
  entry_writer: sereflibirsinek
  entry_fav_count: 10
  entry_content: |
    başlıktaki "hiç yüzünden" yazısı acilen kaldırılmalı, başlık uygun bir hale getirilmelidir. bir çocuk ne olursa olsun böyle vahşi bir saldırıya maruz kalmamalıdır. bu vahşiliği yapan hayvanın da cezasını çekmesi gereklidir.
  entry_channels: haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    hayret kimse de dememiş.<br/>çay ulan <a class="b" href="/?q=%c3%a7ay">çay</a>. pipetle çay içebilecek bir delikanlı varsa saygıyla önünde eğilirim.<br/><br/>ciğer kalmaz dil dayanmaz bu acıya.
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    şarkımı götürür bilmem ama çok uzaklara gidesim var. dönmemek üzere. öyle sıkılıyor insan bu hayattan.
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    saat 00:00 trollü de gelmiş.<br/>maç sonrası bu başlıkta bol bol "etkileşim" alır.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    (bkz: <a class="b" href="/?q=arya+stark">arya stark</a>)
  entry_channels: ilişkiler
- entry_name: |
    çukur (dizi)
  entry_id:  89470503
  ...
  entry_fav_count: 3
  entry_content: |
    ulan utc'de 4 sosyete karısının karıştığı edip cinayetini iki sezon çözemeyen adam koçovalı ailesini psikolojik olarak darmadağın etti 4-5 bölümde... <br/>vay be..
  entry_channels: tv
- entry_name: |
    en sinir olunan imla hatası
  entry_id:  89501432
  entry_writer: rockpunzel
  entry_fav_count: 3
  entry_content: |
    üçde<br/>beşde<br/>cicekden<br/>(bkz: <a class="b" href="/?q=%c3%bcns%c3%bcz+sertle%c5%9fmesi">ünsüz sertleşmesi</a>) <br/>(bkz: <a class="b" href="/?q=f%c4%b1st%c4%b1k%c3%a7%c4%b1+%c5%9fahap">fıstıkçı şahap</a>) <br/>(bkz: <a class="b" href="/?q=p%c3%a7tk">pçtk</a>)
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    arkadaş ne çok merakınız varmış şu kadınlarla ilgili bir bitmedi her gün hortlatıyor sunuz şu başlığı.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    30 yaşından sonra aşk meşk işinin bitmesi
  entry_id:  89506176
  entry_writer: nicklausse
  entry_fav_count: 2
  entry_content: |
    30 yaşına kadar oynadıkları oyunun aşk olduğunu sananların yanılgısı.<br/><br/>35 ten sonra , hele kırklarında iken, farkına vara vara, tadını ala , çıkarta yaşanan duygu ile tanışmadan büyük konuşmamakta fayda var.
  entry_channels: ilişkiler
- entry_name: |
    türkiye'nin gelişmesi neden istenmiyor
  entry_id:  89506095
  entry_writer: williamtell
  entry_fav_count: 1
  entry_content: |
    büyük resmi görmüşsün kardeşim. bu ekonomik sıkıntı, eğitimdeki saçmalıklar hep reisin en iyisini ben bilirim politikalarından değil dış güçlerin bizi istememesinden kaynaklanıyor. reis sanki o dediğin güçlerin adamı değil reis bir vatan millet sevdalısı
  entry_channels: 
- entry_name: |
    avam kesimin yaptığı ufak tefek şımarıklıklar
  entry_id:  89505691
  entry_writer: byzantium
  entry_fav_count: 1
  entry_content: |
    a101 ve bim'de sevişmek.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    dahil olduğum veritaban.<br/><br/>kızlar kıpssssss
