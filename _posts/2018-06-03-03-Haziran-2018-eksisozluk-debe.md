...
- entry_name: |
    hem chp'li hem de namazlı abdestli olmak
  entry_id:  77622915
  entry_writer: miller
  entry_fav_count: 255
  entry_content: |
    (bkz: <a class="b" href="/?q=hem+h%c4%b1rs%c4%b1z+hem+m%c3%bcsl%c3%bcman+olmak">hem hırsız hem müslüman olmak</a>)
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    arda turan olsa: “baktım babamla bi laf dalaşı var, bi olay var. çıktım sahadan, geldim kenarıya. kestim raconu. bi yol bulsam türbüne de çıkar, verirdim küsküyü. beni eleştirenler önce adam olsunlar.”<br/><br/>emre belözoğlu olsa: “benim orda evet bi sinirli anım oldu fakat çarpıtılıyor. tribüne doğru sertçe bir uyarıda bulunduk, tabi mesafe var, sesim ulaşsın diye biraz fazla bağırdım, boğazım kırçıllandı böyle. boğazımı kaşırken bazı art niyetli basın mensupları kafa kesme işareti yaptığımı iddia etmiş.”<br/><br/>volkan demirel olsa: “anuna bile gorun!”<br/><br/>cenk tosun: “yaptığım yanlıştı, üzerimde milli forma varken böyle hareketler yapmamalıydım, bir daha asla böyle bir hareket olmayacak, tüm türkiye'den özür diliyorum"<br/><br/>o halde yapacağınız karakter kıyasını skeyim ey romalılar.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  77619755
  entry_writer: larencan
  entry_fav_count: 10
  entry_content: |
    "hayatımda böyle 'sorun'olacaksan ben artık görüşmek istemiyorum."<br/>duyduğum en ağır cümle bu oldu.sevdigim adam tarafından sorun olarak görüldüğümü o ana kadar bilmiyordum.<br/>çok acıttı, hala acıtıyor.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  77644025
  entry_writer: what is wrong with me
  entry_fav_count: 5
  entry_content: |
    eşcinsellik hastalık değil aksine <a class="b" href="/?q=homofobi+psikolojik+bir+hastal%c4%b1kt%c4%b1r">homofobi psikolojik bir hastalıktır</a> diye katıldığım önerme.
  entry_channels: anket,ilişkiler
- entry_name: |
