...
- entry_name: |
  ...
  entry_id:  103073214
  entry_writer: kulagimahosgeldi
  entry_fav_count: 89
  entry_content: |
    suriyelileri kendi saf vatandaşları gibi sanıyor zavallı. adamlar feleğin çemberinden geçmiş gelmiş kandırabileceğini mi sanıyosun?
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
    babaanne deyince akla ilk gelen şey
  entry_id:  103036149
...
- entry_name: |
  ...
  entry_id:  103071841
  entry_writer: ama keskin nisanci
  entry_fav_count: 27
  entry_content: |
    son 2 yıldır ekran koruyucusuz kullanıyorum. sadece kasa kısmını koruyan bir kılıf kullanıyorum. cihaza özellikleri için bir ton para verip kullanmamak ülkemizde has özellik sanırım. klima alıp elektrik faturası çok gelir diye açmamak gibi. <br/><br/>ali ağoğlu'nun bu konuda meşhur bir sözü var. bentley de olsa rolls royce de olsa şantiyeye girerim. daha az para ile sahip olduğum araçların yapabildiğini bunlar niye yapamasın?
...
- entry_name: |
  ...
  entry_fav_count: 24
  entry_content: |
    bu sadece bir kayıp değil. aynı zamanda şehitler tepesini boş bırakmadığı için putin'e edilmiş bir teşekkürdür.
  entry_channels: siyaset,haber
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    genelde kadınlarla ilgili başlıklarda en çok erkekler yazar.<br/><br/>sanırım bu başlık kadınları ilgilendiren ve erkeklerin sustuğu tek başlık.
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    erkeğin arkasını toplamak istemeyen kızdır. gül gibi kendi kendine yaşarken neden bir başkasına minnet etsin ki?
  entry_channels: anket,ilişkiler
- entry_name: |
    ekşi itiraf
  entry_id:  103036990
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    isveç ilkokullarda öğrenci ve öğretmen için dini simge ve başörtüsünü yasakladı.<br/><br/>yasağa direnen bir öğretmen ile yasağı destekleyen politikacı iki kadın biraraya geldi.<br/><br/>ilerleme partisi, yerel okul ve eğitim komisyonuna başkanlık eden loubna stensaker göransson, dinin giyim kuşamla ilgili bir şey olmadığını, hicabın dini dogma bağlamında kadının ezilmesiyle ve kız çocuklarının cinsel istismarıyla bağlantılı olduğunu anlattı.<br/><br/>sığınmacıların ülkenin hakim kültürüne uyum sağlaması gerektiğini savunarak "laik ve eşitlikçi bir ülkeye gelip ortaçağ değerleriyle yaşayamazsınız" dedi.<br/><br/>başörtüsü yasağına direnen sığınmacı öğretmenden yasağı savunan siyasetçiye gelen cevap ilginç: rahatsız oluyorsan isveç’i terket!!!<br/><br/>isveçliler; "artık müslümanlar biz isveçlileri ülkemizi terk etmeye çağırmaya başladı. sığınmacıların biz isveçlilere yönelik ırkçı saldırıları son bulmalı” diyor.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://tr.sputniknews.com/avrupa/202003031041524839-basortusu-yasagina-direnen-ogretmenden-yasagi-savunan-siyasetciye-rahatsiz-oluyorsan-isveci-terk-et/" title="https://tr.sputniknews.com/avrupa/202003031041524839-basortusu-yasagina-direnen-ogretmenden-yasagi-savunan-siyasetciye-rahatsiz-oluyorsan-isveci-terk-et/">haber</a>
  entry_channels: haber
- entry_name: |
  ...
  entry_channels: anket,tarih,oyun,teknoloji
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    o iyi cevabı hep olaydan sonra evde düşünen insan
  entry_id:  103080939
  entry_writer: aldandi
  entry_fav_count: 0
  entry_content: |
    yaptımsa yaptım pişkinliğindeki insana lanet okumaya bile değmez.
  entry_channels: 
---
