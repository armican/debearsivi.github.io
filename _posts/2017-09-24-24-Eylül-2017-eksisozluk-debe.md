...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    (bkz: <a class="b" href="/?q=biraz+i%c3%a7erlemi%c5%9f+gibisin+eruhlu">biraz içerlemiş gibisin eruhlu</a>)<br/><br/>jimnastikci sinekler alinmi$lar kiyamam. :)
- entry_name: |
    orhan pamuk
  entry_id:  70961381
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    attığı nizami gol <a class="b" href="/?q=ali+palab%c4%b1y%c4%b1k">ali palabıyık</a> tarafından iptal edilmiştir.
- entry_name: |
    gary medel
  entry_id:  70964288
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    bir minicik kız çocuğu bak duruyor orada hala,<br/>anlatamam gördüklerimi, o neşeli <a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/zB6eXED7SMw" title="https://youtu.be/zB6eXED7SMw">çocuğa</a>
- entry_name: |
    minimal rakı masası
  entry_id:  70958839
  ...
  entry_fav_count: 2
  entry_content: |
    en güzel tarifini vereceğim vasat masadır. brokoli, pekmez , karışık tost ve kondomdan oluşur. kondom rakı içme adabı edebiyatı, rakı içen kadın güzellemesi yapan yavşakları sikmek için.
- entry_name: |
    ios 11
  entry_id:  70956955
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    kendisine <a class="b" href="/?q=mahmut+uslu">mahmut uslu</a> denen .... (istediğiniz gibi doldurabilirsiniz) tarafından <a class="b" href="/?q=arsen+orman">arsen orman</a> denerek hırsıza benzetilmiş beşiktaş kulübü başkanı.<br/><br/>(bkz: <a class="b" href="/?q=arsene+lupin">arsene lupin</a>)<br/><br/>sayın fikret orman ilgili belagata uygun karşılığı verecektir diye düşünüyorum.
- entry_name: |
