...
- entry_name: |
    tek stoperli 3-1-3-3 sistemi
  entry_id:  71354102
  entry_writer: mike ehrmantraut
  entry_fav_count: 57
  entry_content: |
    o tek stoperin eline tabanca verilmediği sürece defansif zaafiyet yaratacak sistem.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    q7 + 9 kişi &gt;&gt; lens + 10 kişi <br/>olduğunu uygulamalı göstermiştir, bundan sonra q7 varken lens diyen otomatik engellenecektir
- entry_name: |
...
- entry_name: |
    meltem banko başlıklarına yazmıyoruz kampanyası
  entry_id:  71352053
  entry_writer: etsiz cig kofte olmaz
  entry_fav_count: 3
  entry_content: |
    (bkz: <a class="b" href="/?q=meltem+banko+ba%c5%9fl%c4%b1klar%c4%b1+kapat%c4%b1ls%c4%b1n+kampanyas%c4%b1">meltem banko başlıkları kapatılsın kampanyası</a>)<br/><br/>1 yıl kadar olmuştu ben bu başlığı açalı. bunu bile sildirmiş. taciz, linc diyen meriçlere kulak asmayın. hoşuna gidiyor hanımefendinin. bedava reklam. ekşi ile derdi olan buna koşuyor. aybike ve koru hastanesi örneklerinde gördüğümüz gibi.
- entry_name: |
    melih gökçek
  entry_id:  71356700
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    açık ara türkiye liglerinde oynayan en uyuz, en sevimsiz, en karaktersiz futbolcu. anlayamadığım ise bjk gibi bir kulüpte kendisine nasıl yer bulduğudur.
- entry_name: |
    meral akşener
  entry_id:  71347896
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    (bkz: <a class="b" href="/?q=%c5%9feyh+said+havaliman%c4%b1">şeyh said havalimanı</a>)<br/>(bkz: <a class="b" href="/?q=abdullah+%c3%b6calan+anaokulu+ve+imam+hatip+lisesi">abdullah öcalan anaokulu ve imam hatip lisesi</a>)
- entry_name: |
    13 ekim 2017 antalya zirvesi
  entry_id:  71363552
  entry_writer: otomatik sanziman
  entry_fav_count: 1
  entry_content: |
    az önce ayrılıp pilli bebek konserine geldiğim zirve. konserden sonra oralarda olanlarla görüşürüz zira sohbet muhabbet beklediğimden iyi çıktı efenim.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    eski uydunet kullanıcısı olarak iplemediğim iss. bulunduğum yere 16 mbps veriyormuş. fiyatı da 59tl. şu anda kullandığım uydunet tarifesi 50 mbps 50gb akk, akk dolunca 16 mbps. akk dolsa bile gece 2 ile sabah 8 arası 50mbps + nat geo vs içeren kablo tv. fiyatı 49 tl. yine de turk.net'in akk'yi kaldırması güzel bir başlangıç.
- entry_name: |
    cingöz recai
  entry_id:  71362860
  entry_writer: tzoey
