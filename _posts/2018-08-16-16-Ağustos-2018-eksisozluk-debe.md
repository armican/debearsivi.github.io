...
- entry_name: |
  ...
  entry_fav_count: 103
  entry_content: |
    teoman'ın "gönülçelen" parçasında,<br/>"güzel vücutlar boş suratlar" sözüyle selam gönderdiği kız.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
    marmara'da 7.7'lik deprem an meselesi
  entry_id:  80300945
...
- entry_name: |
    hadi bugün biz de çomar olalım
  entry_id:  80300635
  entry_writer: all good things to those who wait
  entry_fav_count: 30
  entry_content: |
    dolar 5'den 6'ya düştü yaşasın.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: anket,sağlık
- entry_name: |
    ateist insan vs sümüklü böcek
  entry_id:  80293584
  entry_writer: buralarda11
  entry_fav_count: 26
  entry_content: |
    ataları develerle, ailesi eşşeklerle çiftleşerek çoğalmış bir yobazın, içler acısı yazısıdır. itibar etmeyiniz.
  entry_channels: 
- entry_name: |
    yavuz çetin
  entry_id:  80277450
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    tecrübe.<br/><br/>tecrübe arttıkça beynin kalp ile ilişkisi kaybolur demiş freud.<br/><br/>yaşanmışlıkları vardır, tecrübe edinmiştir, güvensizlikleri katlanmıştır, kadınlara düşmanlık ediyordur...<br/><br/>aynı şekilde kadınlar tarafından düşünülen erkek düşmanlığı altında da aynı sebepler yatar.
...
- entry_name: |
    katar'ın türkiye'ye 15 milyar dolar yardım etmesi
  entry_id:  80300164
  entry_writer: radau
  entry_fav_count: 4
  entry_content: |
    ülkeye 15 milyar dolar girecek diye sevinen varsa gitsin kekoluk kağıdını alıp alnına yapıştırsın.<br/><br/>muhtemelen inşaat sektörüne gömecekler o parayı. klasik. yine inşaatçılar kazanacak, komisyoncular zenginliğine zenginlik katacak, aile şirketleri ihaleleri kapacak, para yine betona itelenecek. yine üretim olmayacak. yine fason bir istihdam gösterilecek. <br/><br/>bugünkü krizin ana nedeni şeyler bir sonraki seçime kadar ötelenecek, sonra aynı şeyler yine karşımıza çıkacak. arabın parası halka yansır diye sevinin siz sevinin.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    adamin tipi de, futbolu da, compliation videosu da ozer hurmaci amk.
  entry_channels: spor
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    konyaspor'un formasına tl simgesi eklemesi
  entry_id:  80298754
  entry_writer: kirkimusvedde
  entry_fav_count: 2
  entry_content: |
    (bkz: <a class="b" href="/?q=nike">nike</a>) marka formalara işlenmiştir.<br/><br/>amerikan menşeili firmayı bırakın önce.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    ne salak salak<sup class="ab"><a title="(bkz: konular bunlar ya)" href="/?q=konular+bunlar+ya" data-query="konular bunlar ya">*</a></sup>
  entry_channels: 
- entry_name: |
    kişiye 17 yaşındaki halinin vereceği tepki
  entry_id:  80300809
  entry_writer: arkheramos
  entry_fav_count: 0
  entry_content: |
    ne gemisi amk.
  entry_channels: anket,ilişkiler
