...
- entry_name: |
    kız arkadaşını sürekli aşağılayan erkek
  entry_id:  80305506
  entry_writer: monsieur boduc
  entry_fav_count: 14
  entry_content: |
    (bkz: <a class="b" href="/?q=a%c5%9fal%c4%b1yan+derken">aşalıyan derken</a>)
  entry_channels: 
- entry_name: |
    kedilerime isim arıyorum
  entry_id:  80305372
  entry_writer: pulpman
  entry_fav_count: 12
  entry_content: |
    öncelikle merhabalar :)<br/><br/>birinin adını format koyun lütfen.hem sitenin formatını parçalamanızı hatırlatır hem çok fena isim de değil ^^
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    bu tipleri çoluğun çocuğun arasına görevlendirenlerin, işe alanların ta yedi ceddini sikeyim dedirten olaydır. soruşturma açılmalıdır.
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    gavs hazretleri doları düşürdü
  entry_id:  80305602
  entry_writer: hayallere dalan dalgic
  entry_fav_count: 2
  entry_content: |
    sonra müridi eğilip yerden aldı ve üç kere öpüp alnına koydu. göğüs hizasında taşıyıp gavs'a geri verdi.<br/>suphesiz ki o kutsalımızdı.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    maalesef güzel karpuz bulamayınca anlamsız olan üçlü
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    özellikle bir mesaj beklentim yok ancak çaylaklardan da mesaj alınabilmesi için ayarlarda değişiklik yapılması gerektiğini yeni farkettim. kayıtlara geçsin :)
  entry_channels: anket,ekşi-sözlük
---
