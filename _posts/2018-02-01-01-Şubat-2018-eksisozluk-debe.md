...
- entry_name: |
    chp genel başkan adaylarının tv'de tartışması
  entry_id:  73881584
  entry_writer: better call jimmy
  entry_fav_count: 22
  entry_content: |
    olmasını istediğim şey. <br/><br/>amerika'da seçimler sırasında gördük. cumhuriyetçi partinin başkan adayları çıktı kendi aralarında tartıştı. demokrat partinin adayları kendi aralarında tartıştı. eskiden türkiye'de de olurdu. açın youtube'da 91 seçimleri için yapılan programı izleyin. tüm parti adayları oturup fikrini açıklıyor. ecevit, perinçek, erbakan, mesut yılmaz vs dönemin tüm siyasi figürleri karşı karşıya.<br/><br/>hadi parti başkanları bir araya gelmiyor, getiremiyoruz. bari parti içi demokrasi olduğunu söyleyen chp bunu yapmalı. <br/><br/>sesimizi duymaları için iletişim bilgilerini bırakıyorum. mail, telefon, faks yoluyla ulaşınız. ilk maili ben attım.<br/><br/>chp@chp.org.tr mail adresi. <br/>telefon: +90 (312) 207 40 00 <br/>faks: +90 (312) 207 40 39<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="http://www.chp.org.tr/Iletisim">http://www.chp.org.tr/iletisim</a>
- entry_name: |
    yuto nagatomo
  entry_id:  73889126
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    transfer döneminde izlenecek yol haritası için wenger ve kurmayları bir araya gelmiştir. wenger tinerinden son bir fırt çeker ve masanın başına oturur.<br/><br/><a class="b" href="/?q=steve+bould">steve bould</a>: efendim direkt konuya gireyim. stoper lazım takıma. takım savunması zaten berbat. bireysel yetersizlikleri kaldıracak durumda değiliz. <br/><a class="b" href="/?q=neil+banfield">neil banfield</a>: ayrıca orta sahaya mutlaka transfer yapmalıyız. defansif yönü ağır basan dinamik bir orta saha lazım. mutlaka alınması gerek. <br/><a class="b" href="/?q=boro+primorac">boro primorac</a>: aslında kanatlara da takviye gerekiyor. en azından bir oyuncu ile takviye etmeliyiz.<br/><a class="b" href="/?q=steve+bould">steve bould</a>: zaten 25 maçta 46 gol attık ama 34 gol yedik. sorunu direkt görebilmemizi sağlayan bir istatistik. gol atmada sıkıntımız yok. savunma zaafiyetlerimiz zorluyor bizi. neyseki forvet hattımız kuvvetli ve işlevsel.<br/><a class="b" href="/?q=gerry+peyton">gerry peyton</a>: cech'in yerine de birini bakmamız gerekiyor. birkaç kaleci var listemizde. teklif götürebiliriz isterseniz.<br/><a class="b" href="/?q=arsene+wenger">arsene wenger</a>: sorunları çok güzel tespit ettik. yapacağımız takviye ile bu sorunları gidereceğiz. <a class="b" href="/?q=aubameyang">aubameyang</a>'a teklif yapın.<br/><a class="b" href="/?q=steve+bould">steve bould</a>: fakat...<br/><a class="b" href="/?q=arsene+wenger">arsene wenger</a>: kaç paramız var.<br/><a class="b" href="/?q=neil+banfield">neil banfield</a>: 70.<br/><a class="b" href="/?q=arsene+wenger">arsene wenger</a>: hepsini basın aubameyang'a.<br/><a class="b" href="/?q=steve+bould">steve bould</a>: tineri acilen bırakmalısın.
- entry_name: |
    ekşi itiraf
  entry_id:  73880194
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    işgal edilen bölgelerdeki ganimeti,işgalci "ypg,pkk,ypj,sdg,ahsh, fndn,kdkgka" klavyede random basılmış gibi isimlerle oturmadık kucak bırakmayan işgalci it sürülerine sormak lazım. buradaki militanları merak ediyor,hem biz de öğrenmiş oluruz.<br/><br/>abisinin karısına,"berdel" diye çöken adamlarsınız sonuçta ;)
- entry_name: |
    efsanevi yalanlar
  entry_id:  73898172
...
- entry_name: |
  ...
  entry_id:  73885028
  entry_writer: cluster
  entry_fav_count: 6
  entry_content: |
    (bkz: <a class="b" href="/?q=best+of+yapmazsa+%c3%b6lecek+hastal%c4%b1%c4%9f%c4%b1">best of yapmazsa ölecek hastalığı</a>)
- entry_name: |
    çukur (dizi)
  entry_id:  73879949
...
- entry_name: |
    ölümlü dünya (film)
  entry_id:  73884569
  entry_writer: munchausen by proxy zooey deschanel
  entry_fav_count: 1
  entry_content: |
    müzikler süper, senaryo vasat, diyaloglar zayıf. diyaloglar harbiden daha iyi olabilirdi, birkaç yerde çok iyiydi mesela kahkahalara boğuldum. yani filmi izlerken hep bi patlamasını bekliyorsun ama bi türlü patlamıyor. öylece de bitiyor. düşünce güzel ama tam olmamış sonuç olarak. yine de izlenir.
- entry_name: |
...
- entry_name: |
    elinden her iş gelen adam
  entry_id:  73880364
  entry_writer: gozleriniz cok ses cikariyor
  entry_fav_count: 1
  entry_content: |
    babam.<br/><br/>cocuklugumda gecekonduda oturuyorduk. malum rutubet, cati vs.sorunlar bitmek bilmezdi. cocuklugumun hafta sonlarinin da katilidir babam. cati mi aktarmadik, elektrik tesisati mi yenilemedik, bahcedeki afedersiniz bok cukurunu mu tamir etmedik, bahcenin son kismina ek oda mi yapmadik. <br/><br/>hepsink de yapardi, hala da yapar. adamin kafa ve el becerisi gelismis. simdi koyde kimin bir derdi olsa babama gelir. keske biraz da genlerden bize biraksaymis.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    lisansı çıkmış wonderkid. şenol güneş adettendir deyip birkaç maç oynatmaz.
- entry_name: |
    sen anlat karadeniz
  entry_id:  73900497
  entry_writer: alpino
  entry_fav_count: 0
  entry_content: |
    türk televizyon tarihindeki en <a class="b" href="/?q=feti%c5%9fist">fetişist</a> dizi olabilir. seks sırasında şiddet, seks sırasında küfür, suni teneffüs fantezisi , ayak yıkama fantezisi , çocuklu kadın fantezisi ... libidosu yüksek yenge bile var. <br/><br/>değişik dizi.
- entry_name: |
    ozan tufan
  entry_id:  73890349
  ...
  entry_fav_count: 0
  entry_content: |
    leganes sezon sonuna kadar kiralamak istiyor. giderse iyi olur.
---
