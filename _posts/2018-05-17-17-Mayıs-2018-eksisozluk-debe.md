...
- entry_name: |
  ...
  entry_fav_count: 89
  entry_content: |
    ne mutlu ki bir kişicik de çıkıp “eğitim konusunu tartışmak siyasetçilerin, gazetecilerin haddi değildir. bu iş eğitimcilerin, pedagogların işidir” demiştir. <br/><br/>bilim be...
...
- entry_name: |
  ...
  entry_fav_count: 68
  entry_content: |
    iyi bir haber sunucusudur fakat kesinlikle başarısız bir tartışma programı moderatörüdür.<br/><br/>tarafsız davranmaya çalışırken kantarın topuzunu kaçırıyor, benzer saçmalıkları geçtiğimiz senelerde kılıçdaroğlu'na da yapmıştı. bazı arkadaşlar "ya işte adam tarafsız herkese eşit davranıyor" demiş. öyle bir şey yok, akp'li biri gelirse aynı üslupla davranmaz kesinlikle. akp'yi desteklediğinden değil, tutarsız ve patavatsız oluşundan kaynaklı bu.
  entry_channels: siyaset,tv,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 48
  entry_content: |
    acik kahverengi,keten,buz mavisi gomlek nedir allasen.nargile cafe canlaniyor aklimda.<br/>duz siyah giyim her zaman tercihtir.illa ki renk katmak istiyorsaniz haki iyidir.<br/>siyah-siyah, haki-siyah baskasi goz yorucu oluyor.
...
- entry_name: |
  ...
  entry_fav_count: 25
  entry_content: |
    babamin biraz önce akparti reklami sandigi burunlarin selameti reklamidir. deodorant reklami oldugunu anlayinca guldurmustur..
...
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    hangi partinin seçmeni olduğu ilk bakışta belli oluyor.
  entry_channels: haber
- entry_name: |
    ekşi itiraf
  entry_id:  77018867
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    aramızda birleşik krallık’ı batı dünyasının bir parçası olarak kabul etmeyen ahmak uzunyalarlar olduğunu gördüğümüz başlık.<br/><br/>çin-katar-rusya-ingiltere ve türkiye. kokteyle bak sen.
  entry_channels: siyaset,haber,ekonomi
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    oy vermeyi göt vermekten kolay sananların atıp tuttuğu şeyler...<br/><br/>evet arkadaşlar... sizinki kaça? ilgiyle okuyorum, not alıyorum.
  entry_channels: siyaset,anket
- entry_name: |
    lebron james
  entry_id:  77023642
  ...
  entry_fav_count: 14
  entry_content: |
    oruçlu haliyle şov yapan kral. imanıyla bostonlı kafirleri dize getirecek inşallah.<br/><br/>edit: getiremedi.
  entry_channels: spor
- entry_name: |
    abd gülen'i iade etmezse incirlik'i boşaltırız
  entry_id:  77047758
  entry_writer: anani siken kadi
  entry_fav_count: 13
  entry_content: |
    fetö'nün vatan hainliği 15 temmuzda başlıyor sananları göstermiş vaat.<br/>adam 2000 yılında dgm'de terör örgütü liderliğinden yargılanıyordu,onun için amerikalara kaçtı gitti, sizin allah diye taptıklarınız geldi kurtardı. hatırlatayım.<br/><br/>üstelik 15 temmuzun tiyatro olsa da olmasa da başrolünde fetö vardır, onu tiyatro yapacak şey, engelleme imkanı varken engellemeyenlerdir. darbeye zamanında müdahale etmeyenler yargılandı mı? yoksa el üstünde tutulmaya devam mı ediliyorlar?
  entry_channels: siyaset
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    polisin hdp'lilere bozkurt işareti yapması
  entry_id:  77047629
  entry_writer: slashindonu
  entry_fav_count: 7
  entry_content: |
    açık net iş ahlaksızlığıdır
  entry_channels: siyaset,haber
- entry_name: |
    bedelli askerlik
  entry_id:  77047724
  ...
  entry_fav_count: 7
  entry_content: |
    muharrem ince bugün "ben yaptım oğlum yaptı o zaman herkes yapacak." anlamında bir açıklama yaptı. bu mantıkla o zaman herkes iki sene boyunca askerlik yapsın. sonuçta dedelerimiz iki sene kadar askerlik yaptı. hatta en önce muharrem ince yapsın bunu. tanımlama yapacak olursak muharrem ince zamanın gerekliliklerini kavrayamamış başkan adayıdır.<br/>not: chp
  entry_channels: siyaset,haber,ekonomi
- entry_name: |
    ahmet şık'ın hdp'den aday adayı olması
  entry_id:  77046656
  entry_writer: klarkkent
  entry_fav_count: 7
  entry_content: |
    milletvekilliğini en çok hak eden kişi olmasından dolayı umarım milletvekili de olur diye istediğim olay.<br/><br/>dokunulmazlığı yokken gözünü budaktan sakınmıyor iken bir de dokunulmazlığı olunca nasıl olur düşünemiyorum.
  entry_channels: siyaset
- entry_name: |
    ömer üründül
  entry_id:  77047819
  ...
  entry_fav_count: 6
  entry_content: |
    spiker: luis gustavo çok iyi bir yıl geçirip yılın takımına seçildi. nasıl sizce?<br/>ömer üründül: iyi yani.<br/><br/>adam net. <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    başka başlıkta konsantrasyon yazan adam gelmiş buraya şu torbadan şu gelse hesabı yapıyor.<br/><br/>(bkz: <a class="b" href="/?q=allah+ak%c4%b1l+fikir+versin">allah akıl fikir versin</a>)
  entry_channels: spor
- entry_name: |
    emre olur
  entry_id:  77045676
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    ekşi de geceleri yapacak bir şey bulamayanların izlemiş olduğu maç.<br/><br/>kopya: italya ligi, 0-0
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=s%c3%b6zl%c3%bck%c3%a7%c3%bclerin+favori+%c3%a7izgi+filmleri">sözlükçülerin favori çizgi filmleri</a>)<br/>(bkz: <a class="b" href="/?q=aramaya+inanmak">aramaya inanmak</a>)
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    insanların dediğini değil yaptığını yap.
  entry_channels: anket,ilişkiler
- entry_name: |
    sözlük nick'lerinden meslek tahmini yapmak
  entry_id:  77048819
  entry_writer: laviniaya git diyen adam
  entry_fav_count: 0
  entry_content: |
    bekokm - beyaz eşya ve oto galeri işi ile uğraşan gelecek dönem potansiyel vekil adayı.
  entry_channels: anket,ekşi-sözlük
---
