...
- entry_name: |
    recep tayyip erdoğan'ın seks yapıyor olması
  entry_id:  77046314
  entry_writer: seylann
  entry_fav_count: 6
  entry_content: |
    (bkz: <a class="b" href="/?q=zorla+kapatt%c4%b1racaks%c4%b1n%c4%b1z+s%c3%b6zl%c3%bc%c4%9f%c3%bc">zorla kapattıracaksınız sözlüğü</a>)
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: siyaset,haber,ekonomi
- entry_name: |
    orhn gencebay'ın rexona reklamında oynaması
  entry_id:  77044633
  entry_writer: kimi2015
  entry_fav_count: 2
  entry_content: |
    bu kadar sacma deodorant reklami gormemistim nerdeyse kor oluyordum.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  77039489
  entry_writer: ac filan
  entry_fav_count: 1
  entry_content: |
    akp'ye rağmen yaşanan devrimdir.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=sevan+ni%c5%9fanyan">sevan nişanyan</a>)
  entry_channels: 
- entry_name: |
