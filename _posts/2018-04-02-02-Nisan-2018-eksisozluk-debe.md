...
- entry_name: |
  ...
  entry_fav_count: 244
  entry_content: |
    açık açık “soccer değil football amına koyduklarım “ demiştir.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    sabah evden çıktığında karşıdaki insana günaydın demeyen , satıcılara selamlamadan geçen yolculukta kulaklığı takıp dünya ile bağlantısını kesen insan kalkıp burda dertleşmek istiyor . <br/><br/>(bkz: <a class="b" href="/?q=ev+bo%c5%9f+bize+gidelim+mi">ev boş bize gidelim mi</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    demin muslera'ya attığı geri pas yine ve yeniden rakibin araya girmesiyle tehlike yarattı. bu adam 8 milyon euro etmez.<br/><br/>transfer döneminde götüne tekme vurulmalı. tabii alıcı bulabilirsek. bu malı kim alır bu fiyata.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    o değil de gezi zamanı, yazın balkonlardan akşamları gelen tava, tencere seslerini özledim. ne günlerdi yahu. biz de az vurmamıştık. çapulcu olmak güzeldi.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    uzun süredir yokluktayım. 30'luk ablaların uygun bir şekilde maddi, manevi ve özellikle fiziki yardımda bulunmasını bekliyorum. isteyenler özelden ulaşabilir.
- entry_name: |
    fernando muslera
  entry_id:  75617136
  ...
  entry_fav_count: 0
  entry_content: |
    az önce şampiyonluğu kurtaran kaleci.
- entry_name: |
    ekşi sözlük iş ağı
  entry_id:  75617374
  ...
  entry_fav_count: 0
  entry_content: |
    sömürelecek öğrenci arayaşında olan abilerin de bir şekilde dahil olduğu ağ.
- entry_name: |
