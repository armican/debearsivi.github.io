...
- entry_name: |
    recep tayyip erdoğan'ın kamuflaj giymesi
  entry_id:  75615419
...
- entry_name: |
    özgecan'ın babasının nihat doğan ile buluşması
  entry_id:  75615745
...
- entry_name: |
    çay bahcesinde anne ile oturup gazoz içilen yıllar
  entry_id:  75608610
  entry_writer: onepagememories
  entry_fav_count: 31
  entry_content: |
    kahverengi cam şişedeki tamek meyve suyu ile özdeşleşmiştir bu çay bahçeleri bende. hey gidi yıllar.
- entry_name: |
  ...
  entry_fav_count: 30
  entry_content: |
    sıcacık yere yavrulamış minnoş kedidir. yalnız yavrular anneyi karıştırabilir. saçma bir oyuncağa masaj yapıp süt bekleyebilirler<sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
- entry_name: |
    olcay şahan
  entry_id:  75619037
  ...
  entry_fav_count: 19
  entry_content: |
    az önce fena saçmaladı.<br/><br/>edit: ne dediğini de yazalım. maç sonrası canlı röportajda "galatasaray taraftarını tebrik ediyorum, şikeci trabzon diye bağırdılar, demek ki onlar da fenerbahçe'yi destekliyor. böyle rakiplerin birbirini desteklemesi çok güzel" gibi bir şeyler söyledi. ceza alacak mı göreceğiz.
- entry_name: |
    şahsiyet (dizi)
  entry_id:  75606911
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    maşallah bi sol bekde olmasi gereken ne varsa bu arkadaşta mevcut,o kadar enerjik ki baski yapip zorlaya zorlaya ya golu atiyor,ya kendi etrafinda dönup yikilmayarak bi şekilde pasi veriyor,hucuma katki desen var, orta desen var,yakalayinca sut da atiyor e daha nolsun.<br/><br/>allah sana uzun omur versin japon reyiz.
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    hayatın kendisi, soğuk hava ve sessizlik.
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    olgunlaşır insan;<br/>yenilmenin yeniden başlamak olduğunu öğrenince,<br/>beklememenin hafifliğini hissedince,<br/>mutluluğun bakış açısında olduğunu anladıkça,<br/>karşılıksız sevmeyi başarabilince,<br/>kötünün içinde iyiyi, iyinin içinde kötüyü fark edince,<br/>söylenilene değil söylenmek istenileni anlayınca,<br/>kelimeleri değil, gözleri okumaya başlayınca,<br/>asıl sevilmeye layık olanı bulunca,<br/>kendini tanıyınca,<br/>boş gururdan vazgeçince,<br/>kendi kendinin gözlemcisi olunca,<br/>kendini eleştirip kendiyle barışık olunca,<br/>olgunluğun sonu olmadığını anlayınca...<br/>olgunlaşır insan.
- entry_name: |
    younes belhanda
  entry_id:  75617066
  entry_writer: azuma
...
- entry_name: |
    hafızası zayıf insanlara tavsiyeler
  entry_id:  75619814
  entry_writer: asklepios26eses
  entry_fav_count: 12
  entry_content: |
    beyninizi kullanmayı öğrenin. insan beyni gördüğü duyduğu her şeyi depolar. ancak yeterli bağlantı yapılmayan bilgiler derinlerde depolanır ve lazım olduğunda bulunamaz. dikkat etmediğiniz bir bilgi önemsiz kabul edilir ve diplere saklanır. <br/><br/>dikkatli olun. unutmamanız gereken bilgileri hayalinizde canlandırın. örnek vermeden anlatmak biraz zor. o yüzden diyelim ki aramızda bir parola var. ben elalem dediğimde sen oral seks dersen olay çözülecek. şimdi iki yıl sonra sana gelip elalem dersem unutmuş olursun bu okuduğunu. neden çünkü önemsiz bir bilgi ayrıca bir bağlantı kurmadın.<br/><br/>şimdi bir bağlantı kuralım. eminim ki on yıl sonra bile parolayı unutmayacaksın. elalem el al em. şimdi gözünde canlandır ve bunu sesli oku. dilin beynine veri versin kulakların duysun zihnin canlandırsın. el eline bak al eline bir penis aldığını hayal et ve usulca em. el al em. cevabın oral seks. şimdi bu beynine kazındı sevgili okur. ortamlarda biri elalem dediğinde aklına oral seks gelecek.<br/><br/>beyin kullanılmayan bilgileri geri plana iter. o yüzden tekrar önemlidir. ancak farklı açılardan tekrar edilen şeyler çok zor unutulur. örnekleyelim. diyelim ki hijyen kelimesini unutmayacağız. dilimize de girmiş. hijyenin bir çok tanımı olsa da temizlik manasına geliyor günümüz türkçesinde. sağlıklı olmanın ilk kuralı. hijyen kelimesi nereden geliyor diye beynimiz snapsları arasında bir bağlantı atarsak unutmamız güçleşir. hijyen yunan mitolojisinde nickimin yani asklepios'un tıp ve şifa tanrısının kızıdır. pisliğin hastalıkların nedeni olduğunu asklepios kızına öğretmiş. farklı bir bilgi verelim beynimize. gıda çalışanları hijyen eğitimi almadan işe başlayamaz.<br/><br/>yani size vereceğim tavsiye dikkat edin hayalinizde canlandırın farklı bilgilerle birleştirin tekrar edin ve siz siz olun kimseye borç vermeyin. <br/><br/>ayrıca hayat kötüyse unutmak iyidir. biraz daha yazarsam başlığın ne olduğunu unutacağım.
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    kimse de dememiş ki birkaç sene önce teröristlerle elele "megri megri" diye anıran sen değil miydin?
- entry_name: |
    bir yıldır öz kızına tecavüz eden babanın itirafı
  entry_id:  75621694
  entry_writer: usluyorum
  entry_fav_count: 8
  entry_content: |
    birden fazla orospu çocuğu içeren videodur. eli sopalı şahıs da senin bacını............ diyerek ayrı bir tecavüz işlemektedir.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    çıkıp şimdi ampır ampır konuş da görelim, hazımsız hamsi beyinli.<br/><br/>koyduk mu?
- entry_name: |
    şampiyonların kupası müzesinde olur
  entry_id:  75620588
  entry_writer: teknik ressam
  entry_fav_count: 4
  entry_content: |
    fenerbahçe’ye olan göndermedir. heyecanına yenik düşenlere sakin olun gençler demek lazım gelir.
- entry_name: |
    detay maxinet
  entry_id:  75620620
  ...
  entry_fav_count: 4
  entry_content: |
    "azıcık risk aldık para kazanalım dedik ne çomarlığımız kalmış ne muhafazakarlığımız ne enayiliğimiz. cayır cayır para kazanıyorum olm ben. sistem tıkanana kadar da devam edicem ne de olsa yatırdığım parayı çoktan çıkardım. "<br/><br/>biz enayi demiyoruz, muhafazakar demiyoruz, çomar demiyoruz, biz size dolandırıcısınız diyoruz sevgili ekşi yazarı <a class="b" href="/?q=ciyann">ciyann</a>.
- entry_name: |
    burak yılmaz
  entry_id:  75616370
  entry_writer: hellespontos
...
- entry_name: |
    midyeye hallenen ve hastanelik olan genç
  entry_id:  75620459
  entry_writer: bi degisik ormanci
  entry_fav_count: 3
  entry_content: |
    mumya siken adam haberinden sonra beni şaşırtmıyor hiçbir şey. <br/>biri çıkar hızar falan sikerse ona şaşırırım bak.<br/>dikine.
- entry_name: |
...
- entry_name: |
    bırak yılmaz'ın ofsayta yakalandığı an
  entry_id:  75621305
  entry_writer: peynirsiz cheeseburger
  entry_fav_count: 3
  entry_content: |
    &lt; o &gt;<br/>.. | <br/>. /\
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    sadece ülkemizde degil dünya genelinde de maalesef olagan disi artmis yozlasma, adam kayırma, paraya tapma, ruhunu satma, fayda gelecegi dusunulen haksizliga ses etmeme gibi alt seviye ruhani hareketlere maruz kalan güzel takimdir. hayal kırıklığı yaşatmiştır dursun özbek olayinda. bu aksam trabzon macinda bari yüzümüz gülsün.
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    yazılanların yarisi yalandır. hayır dogru yazsaniz ne olacak sanki aptala bak 40 kurus yakiyor mu diyecegiz. <br/><br/>yalanlarınıza sokayim.
- entry_name: |
    şu anda çalan şarkı
  entry_id:  75620338
  ...
  entry_fav_count: 0
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=2q9_ZEtuTR8" title="https://www.youtube.com/watch?v=2q9_ZEtuTR8">stereophonics - maybe tomorrow</a>
- entry_name: |
    jet sosyete (dizi)
  entry_id:  75621084
  entry_writer: seferometrik
  entry_fav_count: 0
  entry_content: |
    hahahahahahahaha gündüzle alara nın organik gıdaların akıl hastası alara üzerine etkilerini konuştukları sahneye kahkaha attım.<br/>3 dişim sallanıyor ??
- entry_name: |
    cocacola ürünleri hakkında ciddi uyarı mesajı
  entry_id:  75621191
  entry_writer: eksi peace
  entry_fav_count: 0
  entry_content: |
    hep prezervatif kullandığımdan umrunda olmayandır.
---
