...
- entry_name: |
  ...
  entry_fav_count: 163
  entry_content: |
    reis barış pınar harekatını anlatırken teröristlerden arındırılacak bölgeye 1 milyon suriyeli gidecek diyordu, vaz mı geçmiş?
...
- entry_name: |
    arınç'ın damadının beraat gerekçesi
  entry_id:  97545493
  entry_writer: 3310merkez
  entry_fav_count: 56
  entry_content: |
    --- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/>cumhurbaşkanlığı yüksek istişare kurulu üyesi bülent arınç'ın damadı ekrem yeter hakkında fetullahçı terör örgütü'ne (fetö) üye olmak suçlamasıyla açılan davada verilen beraat kararının gerekçesi açıklandı. kararda, yeter'in fetö elebaşı fetullah gülen'e ait kitap ve cd'leri bulundurması, 2013 yılı öncesi örgütün toplantılarına katılması, örgüte müzahir olduğu değerlendirilen bir dernekte yöneticilik yapması, bank asya'da rutin hesap hareketlerinin olması şeklindeki eylemlerinin sempati ve iltisak boyutunu aşan, örgüt üyesi olduğunu ispat etmeye yeterli örgütsel faaliyetler kapsamında değerlendirilemeyeceği belirtildi.<br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>"kulakları vardır duymazlar, gözleri vardır görmezler, dilleri vardır gerçekleri söyleyemezler" a'râf suresi - 179 . ayet
...
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    istanbul boğazı’ndan; <br/><br/>2017 boyunca 42978 gemi yani günlük 117 gemi geçmiştir. <br/><br/>2018 boyunca 41103 gemi yani günlük 113 gemi geçmiştir.<br/><br/>2019 eylül sonu itibariyle 9 ayda 30352 yani günlük 112 gemi geçmiştir.<br/><br/>kaynak: <a rel="nofollow noopener" class="url" target="_blank" href="https://atlantis.udhb.gov.tr/istatistik/gemi_gecis.aspx" title="https://atlantis.udhb.gov.tr/istatistik/gemi_gecis.aspx">https://atlantis.udhb.gov.tr/…istik/gemi_gecis.aspx</a><br/><br/>bir gemi kaptanı olarak kanal istanbul hakkında yazdığım (<a class="b" href="/entry/83214255">#83214255</a>)<br/><br/>edit: gemi sayısı azalmasıyla ilgili soru soru soranlar olmuş. azalmasının nedenleri çok çeşitli olabilir ; <br/>- birinci neden karadeniz limanlarında yüklenecek yükün azalması veya tam tersi gelen yükün alıcısının azalması. (gemiyle sadece son ürün taşınmıyor, maden, hammadde vs. daha fazlalıkla taşınmakta)<br/>- ikinci neden ise gemi boyutları ve taşıma kapasitesinin artması. birkaç sene önce feeder dediğimiz (besleyici) hatlara küçük gemiler gelmekteyken şimdilerde daha büyük boyutta gemiler yerlerini aldı. yani birkaç geminin taşıdığı yükü tek gemi taşımaya başladı.
  entry_channels: 
- entry_name: |
    berkcan güven
  entry_id:  97545152
  ...
  entry_fav_count: 19
  entry_content: |
    babacım siz kaç para alıyosunuz da bunları yazıyosunuz. adam dalga geçer gibi klibi çok iyi demiş. hani nesi müthiş kardeş? uçak içinde garip hareketler yapmasının nesi müthiş olabilir? madem 50 100 tl para alıyosunuz burada entry girmek için, bari biraz gerçekçi yorumlar yazın. gerçek yorum okuyamıyoruz lan sizin gibiler yüzünden.
...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    cumhurbaşkanı geldiğinden yollar kapandığı içindir. güneşli'den çıkabilen yok. ben ibb yerinde olsam akom'dan cumhurbaşkanından dolayı şu yollar kapalıdır, şu istikametleri kullanmayın diye paylaşırdım.
  entry_channels: 
- entry_name: |
    karayılan'ı ölü yılan haline getireceğiz
  entry_id:  97540780
  entry_writer: tourist eomer
  entry_fav_count: 14
  entry_content: |
    süleyman yılan yap kendini kanka.
  entry_channels: haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    babel ile belhandayı dövmeye geliyor reyiz.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    kislikgiyimadresi instagram dolandırıcılığı
  entry_id:  97545667
  entry_writer: doksanlardakalmisadam
  entry_fav_count: 7
  entry_content: |
    bu sitelerden alışveriş yapanların televizyondan çük uzatma kremleri alanlardan farkı yok. iki grubun da çüke sürelecek aklı yok. <br/>rezalet puanım 1/10
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    amına koyim fenerlisi beşiktaşlısı galatasaraylısı trabzonlusu her hafta birinize operasyon yapılıyor dimi. kumpas var her hafta size operasyon yapıyorlar. bi bitmediniz amk paranoyakları.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    hekimoğlu (dizi)
  entry_id:  97544342
  entry_writer: blowmeaway
  entry_fav_count: 2
  entry_content: |
    hahahaha hekimoğlu nedir lan.ameliyattan sonra sıra gecesi mi düzenliyorlar :)
  entry_channels: tv
- entry_name: |
    yalova
  entry_id:  97546663
  ...
  entry_fav_count: 1
  entry_content: |
    gereğinden fazla kalabalık, çok kalabalık. daha az nüfusu olduğu yıllar çok daha güzeldi. çok fazla göç alıyor ve yabancı nüfus çok çok fazla. trafiği dert hatta haftasonları işlek caddelerinde kaldırımda yürümek bile dert. yürünmüyor, arabayla hareket edilemiyor. eskiden yazın tatil, kışın emekli şehri denirdi. şimdi her mevsim kaos ve kalabalık şehri olma yolunda ilerliyor.<br/><br/>büyüdüğüm şehir; kalabalığından nefret eder hale gelsem de hangi şehire gidersem gideyim maksimum 10 gün sonra burnumda tütmeye başlıyor. farklı bir büyü var bu şehirde. ah bir de kalabalık olmasa... göç etmeyin artık bu şehre, sığmıyoruz, sığamıyoruz...
  entry_channels: sanat,müzik,yeme-içme,eğitim,havacılık,seyahat
- entry_name: |
    tbmm kürsüsünde zazaca konuşmak
  entry_id:  97546132
  entry_writer: fevkaddeha
  entry_fav_count: 1
  entry_content: |
    bu zazalar da enteresan. adamlar sözde hdp karşıtı ama hdp'nin başında bir zaza var ve zaza vekiller dolu.<br/><br/>kürtler zazaları resmen içinde eritti bitirdi halen daha bunların peşinden gidiyorlar haha.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    trump’in korkmasi gereken tek kisi. 52 milyar dolar net worth kimi olsa korkutur.<br/><br/>biden’in poll’lardaki durumu dusunuldugunde bloomberg’in girmesi icin dogru zaman diye <br/><br/>edit: net olarak oyumu alacak kisi
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    akşam 10-11 gibi arkadaşlarımla kaleiçine eğlenmeye gideceğiz, antalyadaki yazarlar yeşillendirebilir.
