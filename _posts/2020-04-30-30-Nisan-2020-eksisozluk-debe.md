...
- entry_name: |
    hazırlanıp evden çıkma süresi 12 dakika olan kız
  entry_id:  106268355
  entry_writer: sifremyanlis
  entry_fav_count: 20
  entry_content: |
    makyajsız kızlara "çirkin" demesine rağmen evden 12 dakikada çıkan kız isteyen erkek ikiyüzlülüğüne kanmaması gereken kızdır.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: anket,müzik
- entry_name: |
    ölen kişiyi telefon rehberinden silme eşiği
  entry_id:  106283043
  entry_writer: gozyaslarimizi bitti mi sandin
  entry_fav_count: 12
  entry_content: |
    annem 2016 yılında vefat etti. numarasını silsem tamamen gidecek diye korkuyordum silmedim. o yıl mutlu olduğumda ve üzüldüğümde bir çok kez duygularımı paylaşmak için annemi arama girişimim oldu..ölümü kabullenmediğimi farkettiğim gün sildim.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
    gidenin arkasından söylenebilecek en iyi söz
  entry_id:  106280653
  entry_writer: corsairsgold35
  entry_fav_count: 2
  entry_content: |
    giderken kapıyı kapat cereyan yapıyor.
  entry_channels: 
- entry_name: |
