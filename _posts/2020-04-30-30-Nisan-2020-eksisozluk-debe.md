...
- entry_name: |
    sigara faydalı bir şey olsaydı olacaklar
  entry_id:  106279500
  entry_writer: tekgozlubillcarson
  entry_fav_count: 9
  entry_content: |
    kimse kullanmayacaktı
  entry_channels: anket,sağlık
- entry_name: |
    netflix ve spotify'e para veren şahıs
  entry_id:  106275483
  entry_writer: empatikurunkafanizacimaz
  entry_fav_count: 9
  entry_content: |
    ben bu milletin cebini düşünen andavalları da anlamıyorum. sana ne olum kim nereye harcamak istiyorsa harcasin. isteyen hayrını yapar isteyen keyfine yatırım yapar. sen iki saatlik film için salak saçma sitelerde reklam kapatmakla uğraşırsın beriki açar abone olduğu uygulamasını kaldığı yerden devam eder dizisine filmine. bitin mk.
  entry_channels: anket,müzik,sinema,teknoloji
- entry_name: |
...
- entry_name: |
    29 nisan 2020 ingiltere covid-19 ölüm sayısı
  entry_id:  106281523
  entry_writer: herostratus
  entry_fav_count: 2
  entry_content: |
    bir günde ölenlerin sayısı değildir. salgın başladığından beri huzurevlerinde hayatını kaybedenlerin sayısının eklenmesidir.
  entry_channels: sağlık,haber
- entry_name: |
    rastlantı (film)
  entry_id:  106282127
  entry_writer: profpektus
  entry_fav_count: 0
  entry_content: |
    fragmandan anladığım kadarıyla normal hayatımızda karşılaşabileceğimiz bir konuya sahip. babamda da aynı kanser sorunu olduğu için izleyebileceğimi düşünmüyorum. insanları içine çekip güzel izlenme sayılarına çıkacağını düşünüyorum.
