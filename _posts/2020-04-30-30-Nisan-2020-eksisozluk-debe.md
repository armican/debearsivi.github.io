...
- entry_name: |
    ali el hemdan'ı vuran polisin ifadesi
  entry_id:  106237907
  entry_writer: noelmat
  entry_fav_count: 1255
  entry_content: |
    silah elde, mermi namlu ağzında, namlu hedefte, emniyet açık, parmak tetikte ama suç orucun.<br/><br/>(bkz: <a class="b" href="/?q=allah+kabul+etsin">allah kabul etsin</a>)
...
- entry_name: |
  ...
  entry_fav_count: 161
  entry_content: |
    lan olum bari burada bizimle dalga geçmeyin, ayıp lan. kötü insanlarsınız lan siz...<br/><br/>edit: suserler bu yazıyla ilgili o kadar çok mesaj geldi ve destek verdiler ki, vicdan yaptım açıklama ihtiyacı bulundum kel kısa boylu ve gözlüklü değilim, profil resmim çok beğendiğim les grossman karakteri. sadece empati yaptım.çok duygusal milletiz...
...
- entry_name: |
    1 haziran 2020 okulların açılması
  entry_id:  106286379
  entry_writer: trendline
  entry_fav_count: 53
  entry_content: |
    haberi okuyorsun 1 haziran'da açılabileceği yazıyor. burada kesinmiş gibi konuşuyorsunuz. ben size söyleyeyeyim okullar eylül'e kadar açılmaz. sezon kapandı o iş bu dönemlik bitti. okul deyince zannediliyor ki herkes eve en yakın okula yürüyerek gidiyor. yatılı okulu var taşımalı eğitimi var servisi var mini mini birleri çalışkan ikileri var. kolay mı sadece 2 3 haftalığına bütün bunları yeniden organize etmek? o çocuk okulda ne yiyecek? ne içecek? zaten leş olan kantinden mi? yemekhaneden mi? için rahat eder mi?
...
- entry_name: |
  ...
  entry_id:  106285732
  entry_writer: derinsesizlik
  entry_fav_count: 21
  entry_content: |
    iyi daha görevliyi siken ekşici çıkmamış
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    (bkz: <a class="b" href="/?q=entel+feridun%27un+yeri">entel feridun'un yeri</a>)
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    öğretmenler ptt'de kargocu olsun
  entry_id:  106287482
  entry_writer: nick arayan adam
  entry_fav_count: 11
  entry_content: |
    bence öğretmenler boş boş duracağına öğretmenlerden rahatsız olanları siksin.
  entry_channels: haber,eğitim
- entry_name: |
    erdoğan'ın lgbt'lileri savunması
  entry_id:  106286176
  entry_writer: cemaat abisi
  entry_fav_count: 11
  entry_content: |
    - sen lgbt'lileri savundun!<br/>+savunmadim
...
- entry_name: |
  ...
  entry_id:  106248592
  entry_writer: grocose
  entry_fav_count: 9
  entry_content: |
    tahammülsüzlük.<br/><br/>bonus: empatiden yoksun olmak.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    fragmanına herkesin gerçeklikten uzak ısmarlama fabrikasyon yorum yaptığı film. benim fragmanda gördüklerim şunlar: gerçeklikten uzak abartılı oyunculuk, normalde kimsenin kurmayacağı eğreti diyaloglar, korkunç bir müzik kullanımı (3.sınıf muhafazakar dizi efekti vermiş), etkileyicilikten uzak klişe bir ajitasyon ve bolca kullanılmış gereksiz cutlar. fragman zaten filmin tamamını veriyor, ekstra olarak filmi izlemeye de gerek yok.<br/><br/>(bkz: <a class="b" href="/?q=konu+kilit">konu kilit</a>)
...
- entry_name: |
    demet akalın'a efsane kapak
  entry_id:  106286224
  entry_writer: birdamlakan
  entry_fav_count: 2
  entry_content: |
    demet akalın kapak takılma eşiğini geçeli çok oluyor bence. o kadar çok kapağa maruz kaldı ki bu saatten sonra takılan her kapak boşa dönüyor.<br/><br/>(bkz: <a class="b" href="/?q=yalama+olmak">yalama olmak</a>)
  entry_channels: 
- entry_name: |
    29 nisan 2020 fatih portakal'dan imamoğlu'na ayar
  entry_id:  106284223
  entry_writer: lowpoly
  entry_fav_count: 1
  entry_content: |
    ak gavatlar öyle karaktersizlerdir ki örnek vereyim;<br/>kim imamoğlu'na karşıysa onun tarafını tutarlar. <br/>ateist olsa ateisti tutarlar, papaz olsa papazı tutarlar, kılıçdaroğlu olsa onu tutarlar.<br/><br/>pelikancı uzaktan kumandalı çomar. <br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="http://prntscr.com/s86kmn" title="http://prntscr.com/s86kmn">pelikancı</a>
  entry_channels: 
---
