...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    oğlum için gözlerim ve böbreklerim satılıktır
  entry_id:  99441322
  entry_writer: punkthesystem
  entry_fav_count: 175
  entry_content: |
    "dünyadaki açlık ve sefaletin sebebi; yoksulları doyuramadığımız için değil, zenginleri doyuramadığımız içindir."<br/><br/>seni çaresiz ve muhtaç bırakan dünyanın adalet terazisini sikeyim güzel insan. <br/><br/>umarım evladına çare bulunur ve yıllarca güzel günler görürsünüz.
...
- entry_name: |
    insanların artık yas tutmaması
  entry_id:  99451246
  entry_writer: sonbahar yolcusu
  entry_fav_count: 84
  entry_content: |
    mezarlıkları ziyaret ederek çürütülebilecek bir iddia. özellikle şehitliklere gidildiğinde, genç yaşta evladını kaybedip tüm gününü orada geçiren annelere rastlayabilirsiniz. hayata küsüp sadece nefes alan ve yasını ölene kadar sürdüren nice insan tanıyorum.
...
- entry_name: |
  ...
  entry_fav_count: 28
  entry_content: |
    -gluten ağırlıklı beslenen insan sayısı<br/>-omega 3 eksikliğinden görülen depresiflik hali<br/>-güneşlenme bilinci olmadığından d vitamini eksik insan sayısı<br/>-bu üç etken yüzünden sorgulama yetileri zayıf kalmış mutsuz insan sayısı<br/>-bu dört etken yüzünden dine yönelip mutlu olmaya çalışan insan sayısı
...
- entry_name: |
  ...
  entry_fav_count: 26
  entry_content: |
    şurada, kabataş'a martı adında bir proje yapmaya kalkıp da eline yüzüne bulaştıranlar ve istanbul'un en değerli limanlarından birini mezbelelik hâline getirip öylece sümüklü mendil gibi bırakanlar, karadeniz ile marmara arasına kanal yapacaklarmış öyle mi! bu kent halkı, deresinden ağacına, bitkisinden hayvanına, otundan kuşuna, balığından insanına yakanızdadır beyler! bence hesabınızı fazla şişirmeyin, altından kalkamazsınız. <br/><br/>(bkz: <a class="b" href="/?q=kabata%c5%9f+mart%c4%b1+projesi">kabataş martı projesi</a>)<br/>(bkz: <a class="b" href="/?q=kabata%c5%9f+mart%c4%b1+projesinin+iptal+edilmesi">kabataş martı projesinin iptal edilmesi</a>)
  entry_channels: siyaset,tarih,teknoloji,haber,ekonomi,seyahat
- entry_name: |
    22 aralık 2019 gençlerbirliği sivasspor maçı
  entry_id:  99454771
  entry_writer: experimental
  entry_fav_count: 26
  entry_content: |
    hala sivasımızın adını tarihte yaşanan elim olayla anan zevzekler var bunu futbol ile bağdaştıranların bu olayı çıkaranlardan hiçbir farkı yok. sizin zihniyetiniz anca madımak, maraş, çorum gibi olaylardan prim yapmaktır. ama size inat biz hep birlikte mutluluk içinde yaşamaya devam edeceğiz.ve inşallah bu güzel birlikle şampiyonda oluruz.
  entry_channels: spor
- entry_name: |
    pedro rebocho
  entry_id:  99469338
  ...
  entry_fav_count: 25
  entry_content: |
    durduğu yerden halay çekmeye çalışınca aleyhimize penaltıya sebep olan beyinsiz.
  entry_channels: spor
- entry_name: |
    çok ilişki yaşamış insan
  entry_id:  99462323
  entry_writer: mademoisellefridakahlo
  entry_fav_count: 24
  entry_content: |
    karşısındakine istese de değer veremeyen, sizin için özel olan bazı şeyleri defalarca yaşamış olduğundan ilişkiye sizin gibi bakamayan insandır.
  entry_channels: anket,ilişkiler
- entry_name: |
    gereksiz pahalı olan şeyler
  entry_id:  99439806
  entry_writer: oneem
  entry_fav_count: 22
  entry_content: |
    cips + 1 lt kola. ikisi 10 lira. inanılır gibi değil
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    1.85 boyundaki henry cavill'in götten bacaklı ve dar omuzlu olduğunun söylendiği dizi.
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    benim ruh eşim öldü galiba... artık ahirette buluşuruz :)
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    gençler burda ahkam kesiyorsunuz ama hesap ödemeyen kadının yanında kendinizi daha çok erkek hissediyorsunuz. <br/><br/>bu ne perhiz bu ne lahana turşusu
  entry_channels: ilişkiler
- entry_name: |
    ozan tufan
  entry_id:  99471272
  ...
  entry_fav_count: 9
  entry_content: |
    real madrid’e de atmışlığı var, lütfen..
  entry_channels: spor
- entry_name: |
    ersun yanal
  entry_id:  99467177
  entry_writer: yedekstoper
  entry_fav_count: 9
  entry_content: |
    maç öncesi röportajda "bazen 1 puan bizi büyük takım yapar" dedi.<br/>hoca senin ben kalıbına tüküreyim e mi ? ulan aykut kocaman böyle kadroyla çıkmazdı kadıköyde inanılır gibi değil.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    bu başlığa <a class="b" href="/?q=entry">entry</a> giren yeni yazarların daha önce girdikleri entry’lere şöyle bir baktım. genellikle <a class="b" href="/?q=anket">anket</a> başlıklarına entry girmişler. diğer entryler de genelde <a class="b" href="/?q=tek+c%c3%bcmle">tek cümle</a>. <a class="b" href="/?q=okumaya+de%c4%9fecek">okumaya değecek</a> şeyler değil. böyle böyle sözlüğün anasını ....<br/><br/>ne diyorlardı.... <a class="b" href="/?q=kutsal+bilgi+kayna%c4%9f%c4%b1">kutsal bilgi kaynağı</a>... <a class="b" href="/?q=yersen">yersen</a>...
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    her pozisyonda rakibi kart görsün diye oscarlık performans gösteren futbolcu. üstelik bu pozisyonların %90 unda faulü kendı yapar. emek hırsızıdır, utanmazdır
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    altı satırlık girdinin temel amacı "instagramda bana dmden yazan erkekler" yazabilmek.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  99450689
  entry_writer: daughter of venus
  entry_fav_count: 2
  entry_content: |
    “ı’ve searched the universe and found myself within your eyes.”
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    transfer ettirdiği diaby, boyd, douglas gibi çöpleri de alıp bu akşam son maçına çıkacak olan yaşayan futbol dehası. hayreti mucip.
  entry_channels: spor
- entry_name: |
    vedat muriqi
  entry_id:  99468512
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    pozisyon bilgisi ve top kapma yeteneği tek kelimeyle inanilmaz. orta sahayı tek başına domine ediyor yine klasik bir şekilde. nazar değmesin.
  entry_channels: spor
- entry_name: |
    burak yılmaz
  entry_id:  99472772
  ...
  entry_fav_count: 1
  entry_content: |
    karşı karşıya kaldığı on pozisyondan sekizini kaçıran usta! golcü.
  entry_channels: spor
- entry_name: |
    22 aralık 2019 fenerbahçe lehine verilen penaltı
  entry_id:  99472178
  entry_writer: workingclasshero
  entry_fav_count: 1
  entry_content: |
    bu kadar bariz bir penaltıya bile "penaltı değil" diyebilen insanların yaşadığı bir ülke asla huzur bulamaz, bu kadar salak bir insan toplulugu da olamaz..
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    facebook aldığından beri özel hayatın gizliliği konusunda endişeler yaşadığım site. sıkıldım gerçi çizim sayfamı da kapattım diğerini de kapatabilirim her an.
  entry_channels: teknoloji
- entry_name: |
    google'ın telefonları dinlemesi
  entry_id:  99473660
  entry_writer: throwexception
  entry_fav_count: 0
  entry_content: |
    bunca avamın eline, böylesine yüksek teknolojiyi boşuna verdiklerini düşünmüyorsunuz öyle değil mi ?<br/><br/>siz olsanız verir miydiniz :)<br/><br/>(bkz: <a class="b" href="/?q=nginx">nginx</a>) başına gelenleri, rusya'da yazılımcıların ve nitelikli gençlerin avrupaya neden kaçmak istediklerini tekrar gözden geçirelim.<br/><br/>uberin rusyada satın alınmış, yandex tarafından domine edilmiş olmasindan tutun da, son zamanlardaki libya türkiye rusya yakınlaşması neticesinde yandex ile türkiye android pazarına yonelik yapilan haberler, google'a ceza kesilmesi ve sunucuların anavatana taşınıyor olması. <br/><br/>elinizdeki şeyin ne kadar tehlikeli olduğunu yeni anliyorsaniz, brava
  entry_channels: programlama,teknoloji
- entry_name: |
    22 aralık 2019 cüneyt çakır şerefsizliği
  entry_id:  99472462
  entry_writer: post translational regulation
  entry_fav_count: 0
  entry_content: |
    aynı başlığa defalarca yazan ezik bir troll'un ağlamalarını izliyoruz sayın seyirciler.
  entry_channels: spor
---
