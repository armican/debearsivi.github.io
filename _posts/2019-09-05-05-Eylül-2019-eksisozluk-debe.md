...
- entry_name: |
    bedevi kültürünü aşağlayıp yörükleri yüceltmek
  entry_id:  94884622
  entry_writer: betada don bebegim yok diye uye oldum
  entry_fav_count: 130
  entry_content: |
    hangi yörük kız çocuğunu diri diri gömüyor lan diye sordurtur insana.<br/><br/>kültür önemli olan, gezmeleri değil.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 83
  entry_content: |
    adam türkiye'yi tanımıyor bence. tanısaydı kadıköy galibiyetine 1milyon euro bonus isterdi:)
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 67
  entry_content: |
    sonuna kadar haklı tespittir. bizim möllö öçöcök diye içtiğimiz bu zerzevatı avrupalı grappa adı altında sokaktaki keşlere apaçilere veriyor pet şişeye doldurup, son derece kalitesiz bir içkidir rakı. <br/><br/>kültürü güzeldi eskiden, artık onun da boku çıktı. sevmesem de üç beş ayda bir meyhaneye gidip rakı içmekten keyif alırdım, şu soktuğumun yeni nesil meyhaneleri ortaya çıkıp meyhane kültürünü sikerttiğinden beri ona da gidesim gelmiyor.
  entry_channels: yeme-içme
- entry_name: |
    dünyaya gelme hakkı
  entry_id:  94893992
...
- entry_name: |
    de da eklerinin yazımı için çözüm yolu
  entry_id:  94893420
  entry_writer: delirmeyetekbilet
  entry_fav_count: 23
  entry_content: |
    bu kadar uzun yazıyı okuyacak kadar sabırlı olsalar zaten de/da ile sorun yaşamazlardı.
...
- entry_name: |
  ...
  entry_fav_count: 22
  entry_content: |
    anca okuduk ettik, iş güç sahibi olduk para harcamaya başladık ya... hayatımızın baharında teyze mi olduk şimdi, yok yok olsa olsa ergenler için ablayızdır daha
...
- entry_name: |
  ...
  entry_fav_count: 22
  entry_content: |
    yeni rejim için haklı istektir. artık laz mütehitlerin yaptığı stadlarda bağımsızlık günümüzde (15 temmuz) füze gezdirip iktidar için gözyaşları içinde dua edeceğiz.<br/><br/>(bkz: <a class="b" href="/?q=ye%c5%9fil+kom%c3%bcnizm">yeşil komünizm</a>)
...
- entry_name: |
    öldükten sonra kurtulduğuna en çok sevinilicek şey
  entry_id:  94868446
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    bu adam ciddi ciddi mariano ve nagatomo'dan kötü durumda mı? savunması özellikle mariano'ya göre çok daha iyi.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    dostum bu kızlar bir <a class="b" href="/?q=harika">harika</a><br/><br/>bir gün kızım olursa ya voleybolcu ya yüzücü yapacağım<br/><br/>set kaybetmeyen hollandaya karşı ilk seti aldık<br/><br/>işte gerçek türk kadını
  entry_channels: spor
- entry_name: |
    gotham'a kayyum atanması
  entry_id:  94889359
  entry_writer: kentbozukcalari
  entry_fav_count: 5
  entry_content: |
    (bkz: <a class="b" href="/?q=penguen+bunu+be%c4%9fendi">penguen bunu beğendi</a>) halkı penguen belgeselleri ile uyuturken belediyenin başına geçti.
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    şu an yok öyle biri ama <a class="b" href="/?q=whitesnake">whitesnake</a> <a class="b" href="/?q=is+this+love">is this love</a>
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    işini severek yapan insan olmaması
  entry_id:  94875981
  entry_writer: zumazumazum
  entry_fav_count: 2
  entry_content: |
    (bkz: <a class="b" href="/?q=%c3%a7al%c4%b1%c5%9fmak+iyi+bir+%c5%9fey+olsa+%c3%bcst%c3%bcne+para+verilmezdi">çalışmak iyi bir şey olsa üstüne para verilmezdi</a>)
  entry_channels: ekonomi
- entry_name: |
    türkçe şarkılarda geçen mükemmel sözler
  entry_id:  94897810
  entry_writer: dagilinlan
  entry_fav_count: 1
  entry_content: |
    âhımın rüzgârı üşütür seni<br/>benden başkasına ısınamazsın<br/>yorgun şarkılarla anarsın beni<br/>öyle kolay değil, unutamazsın
