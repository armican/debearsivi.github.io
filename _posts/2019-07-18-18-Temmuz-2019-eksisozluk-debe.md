...
- entry_name: |
  ...
  entry_fav_count: 74
  entry_content: |
    trollün <a class="b" href="/?q=matematik">matematik</a> bileni daha değerlidir.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 35
  entry_content: |
    ahahaha f-35i kötüleyenler doluşmuş gene<br/>elin ingilizi hollandası norveçi japonu israili abdsi bilmiyor siz biliyorsunuz
  entry_channels: siyaset,haber
- entry_name: |
    inşaat mühendisliği
  entry_id:  92725650
  entry_writer: belki bir gun buyurum
  entry_fav_count: 30
  entry_content: |
    mezun olduğunuz takdirde www.kariyer.net i anasayfanız yapın.<br/><br/>(bkz: <a class="b" href="/?q=ac%c4%b1+ger%c3%a7ekler">acı gerçekler</a>)
...
- entry_name: |
    kadıköy'e gelince içe çöken huzur
  entry_id:  92736778
...
- entry_name: |
  ...
  entry_id:  92737978
  entry_writer: gori mese
  entry_fav_count: 10
  entry_content: |
    milli silah endüstrimiz bu karardan güçlenerek çıkar ümit ediyorum. amarika denen haydut devlet yıllarca bizi sırtımızdan vurdu. önce asala sonra pkk yı yıllarca besleyip silahlandirip karşımıza çıkardı. irak in kuzeyi ve şimdi suriye. şimdi daha çok destek olacak ve teröristlere daha çok silah yardımı yapacak.acele davranmalı ve silâhımızı kendimiz yapmalıyız.firsatini bulduklarında desteği nasıl çekiyorlar geçmişte görmüştük şimdi de gördük.
  entry_channels: siyaset,haber
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    (bkz: <a class="b" href="/?q=adam+hakl%c4%b1+beyler">adam haklı beyler</a>)
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    uzun zaman sonra birine değer vermiştim. farkli bir enerji almıştım. sonunda bitirdin gözün aydın. şimdi git ve değer vermeyen biriyle ol.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    bir an 10 sene sonraki bir maçın tahmini tarihiymiş gibi geldi. halbuki bu sezon ve bir kaç ay sonrası sadece. inanılır gibi geçmiyor zaman.<br/><br/>t: galatasaray ve beşiktaş'ın mücadele edeceği süper lig maçının tarihidir.
  entry_channels: spor
- entry_name: |
    şu an okunan kitap
  entry_id:  92703956
  ...
  entry_fav_count: 0
  entry_content: |
    başıma bir şey gelmeyecekse;<br/><br/>(bkz: <a class="b" href="/?q=o%c4%9fuzhan+u%c4%9fur">oğuzhan uğur</a>)<br/>(bkz: <a class="b" href="/?q=mevzular">mevzular</a>)
...
- entry_name: |
  ...
  entry_channels: ekşi-sözlük
- entry_name: |
    10 mayıs 2020 beşiktaş fenerbahçe maçı
  entry_id:  92736750
  entry_writer: ricky sanchez
  entry_fav_count: 0
  entry_content: |
    fenerbahçe'nin potansiyel tff 1. lig şampiyonu olarak çıkacağı maç.
  entry_channels: spor
---
