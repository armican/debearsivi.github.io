...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    "gülüşüne yağmur damlası çarpsa, şiir olur. bunu bir ben bilirim, bir de gökyüzü."<br/><br/><a class="b" href="/?q=ismet+%c3%b6zel">ismet özel</a>
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    (bkz: <a class="b" href="/?q=b%c4%b1rak+ay+gitsin+sen+kal+bu+gece+vay+anam">bırak ay gitsin sen kal bu gece vay anam</a>)
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    sıralamaların geriye çekilmesi mi. <br/>kör oldum türkçe öğretmeni çağırın.
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    bizim yolumuz başka derken, direkt fetö artığı beyoğlu yosması suri barzoların hedef alındığı formalar.
  entry_channels: spor
- entry_name: |
    karpuz vs kavun
  entry_id:  92726287
...
- entry_name: |
    ısparta'da yayalara trafik cezası kesilmesi
  entry_id:  92727176
  entry_writer: ebuomer
  entry_fav_count: 4
  entry_content: |
    bu ülkede cezalar maalesef sorun düzeltmek, caydırmak için değil; devletin kasasına para sokmak için uygulanıyor.<br/><br/>oturduğum semtte ayda 1 kere trafik polisi caddede bekler ayakta yolcu alan minibüslere ceza keserdi. sonra bir sonraki aya kadar denetleme yapılmaz, minibüsçüler yine tıklım tıkışık yolcu almaya devam ederdi. olan da ayda 1 kere yapılan denetleme günü minibüslere binemediği için işine okuluna geç kalan vatandaşa olurdu. her uygulamamız yalan yanlış maalesef. bu ülke coca cola'nın üzerinde yerli üretim etiketi gördü var mı ötesi?
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  92736052
  entry_writer: batarmur
  entry_fav_count: 2
  entry_content: |
    kimsenin aklına götü kliplerdeki berbat parçalar gelmesin.<br/><br/>bir çok kez etraftan duyduğum, benim de az önce yediğim mükemmel kavun ile tasdiklediğim muhteşem bir kavun, karpuz yılı yaşıyoruz.<br/><br/>darısı kabakların başına. malum dünyanın en güzel tatlısının kabak tatlısı olmasından mütevelli.
  entry_channels: 
- entry_name: |
    17 temmuz 2019 stsl 19-20 sezonu fikstür çekimi
  entry_id:  92736365
  entry_writer: xprofessorx
  entry_fav_count: 2
  entry_content: |
    fikstür rastgele çekilmiyor, her sene benzer olması bu yüzden. insanlarımızda biraz okuma ve araştırma kültürü olsa bu kadar yanılgı olmayacak aslında. önceden ayarlanılan bir şablon var, yayıncı kuruluş menfaatleri de dikkate alınarak 3 büyük takım aynı anda iç sahada oynatılmıyor, derbi haftaları falan hep ayarlı zaten.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    50000 tl. çok şey istemiyorum bence.
...
- entry_name: |
    mesaj atılan 20 kadın yazarın hiçbirinin dönmemesi
  entry_id:  92733925
  entry_writer: nebiliyimolcmedimki
  entry_fav_count: 0
  entry_content: |
    boşa dertlendiğin konu. bırak onlar sana mesaj atsın.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ilkleri yasatmasi. sadece bir tespit yapayim;<br/><br/>1985-1986 yillari..<br/><br/>dizel-otomatik vites-otomatik klima-hiz sabitleyici-hafizali elektrikli koltuklari olan dünya üzerinde ikinci bir marka yoktur. mercedeste vardir.
...
- entry_name: |
    jean michael seri'nin galatasaray'a transferi
  entry_id:  92734809
  entry_writer: tayfurbayram
  entry_fav_count: 0
  entry_content: |
    hoş geldin aslan, buralar yangın yerine döner merak etme.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=fuck+buddy+i%c3%a7in+t%c3%bcrk%c3%a7e+kar%c5%9f%c4%b1l%c4%b1k+%c3%b6nerileri">fuck buddy için türkçe karşılık önerileri</a>)
  entry_channels: anket,ilişkiler
- entry_name: |
