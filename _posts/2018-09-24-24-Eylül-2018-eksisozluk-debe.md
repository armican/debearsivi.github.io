...
- entry_name: |
  ...
  entry_fav_count: 75
  entry_content: |
    lidere selam durun len mq!<br/><br/>h2 yaz geç...<br/><br/>ve evet seleznov'a özellikle dikkat edin, sahada görürseniz de ihbar edin zira kendisi kırmızı kart cezalısı... oynamasını bekleyenlere de acil şifalar diliyorum!
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    gel dövmeyeceğim dedikten sonra döven baba
  entry_id:  81575931
  entry_writer: vakittamamdir
  entry_fav_count: 5
  entry_content: |
    mütemadiyen döven babadır. gitmeyin olum
  entry_channels: ilişkiler
- entry_name: |
    yusuf namoğlu
  entry_id:  81578539
  ...
  entry_fav_count: 4
  entry_content: |
    galatasaray'a gol atılmasını yasaklamıştır.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    orospu cocugudur .o dudugu evde bile bu kadar rahat calamazsin be ibine , hic mi vicdanın sızlamaz amın cocuğu
  entry_channels: spor
- entry_name: |
    fifa 19
  entry_id:  81569061
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bugün kadınlar biraz eksik insanlar diyen insanımsı yarın öbür gün...<br/><br/>neyse devam edip yoksun köpeklere daha fazla prim kazandıramayacağım. engelle geç
  entry_channels: haber,eğitim,havacılık,seyahat
- entry_name: |
    faceit major 2018
  entry_id:  81579463
