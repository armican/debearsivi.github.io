...
- entry_name: |
    itü'lülerden çok konuşulacak dans videosu
  entry_id:  81559902
...
- entry_name: |
    üretim ekonomisine geçmeliyiz goygoyu
  entry_id:  81561177
...
- entry_name: |
  ...
  entry_fav_count: 324
  entry_content: |
    istanbul üniversitesi'ne başladığım senenin başlarında mecidiyeköy'den okula gitmek için metroya biner, o zamanlar arka kapıyı bilmediğim için okula büyük kapıdan girer çıkardım, dolayısıyla metrodan indikten sonra okula gitmek için beyazıt meydanı'ndan geçmem gerekirdi.<br/>bir gün yine okula gitmek için metroya bindim ve metroda gerçekten ama gerçekten güzel bir kız gördüm. metrodan indikten sonra kız yanıma gelip "pardon beyazıt meydanı'na nasıl gidebilirim?" diye sordu. ben de kıza bakıp dedim ki<br/>"bilmiyorum."
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
    1999'da çekilen lord of the rings ekibi fotoğrafı
  entry_id:  81557587
  entry_writer: proleterburjuva
  entry_fav_count: 272
  entry_content: |
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    türkiye'nin en büyük takımının beşiktaş olması
  entry_id:  81564430
  entry_writer: aloha martini
  entry_fav_count: 87
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 79
  entry_content: |
    kanatta rodriguez, emre akbaba, onyekuru gibi isimler varken quaresma ile babel'i tabii ki istemeyecek olan taraftar. ulan quaresma sizin taraftarı bile kanser ediyor, 35 yaşındaki adamın nesini isteyelim.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  81557132
  entry_writer: jet ali
  entry_fav_count: 69
  entry_content: |
    bugün cumhurbaşkanlığı armalı uçakla gittiği teknofestte giydiği üniformaya, omuzlarda iki, göğüste bir şapkada bir olmak üzere toplam 4 tane cumhurbaşkanlığı arması işletmiş, şapkasına da "cumhurbaşkanı" yazdırmış sonra da bu kılıkla, cumhurbaşkanlığı armasının olduğu kürsüye geçmiş cumhurbaşkanı.. hatta en cumhurbaşkanı.. tamam peki cumhurbaşkanı.. yani cumhurbaşkanı daha ne olabilir ki.. vallahi de, billahi de cumhurbaşkanı..
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    22 eylül 2018 uber rezaleti
  entry_id:  81566880
  entry_writer: benyokumki
  entry_fav_count: 50
  entry_content: |
    taksici oraya gidemem diyince --&gt; orospu çocuğu taksici<br/><br/>uber oraya gidemem diyince --&gt; adam zorunlu değil tabi ki ne rezaleti<br/><br/>ilkeli ekşicilerin beğenmediği rezalet. lan olm anlamadığım sizin taksicilerden nefret etmenizin sebebi kısa mesafe götürmemesi, trafik sebebiyle gitmemesi, iyi hizmet vermemesi değil mi hepsi var işte. rezalet gibi rezalet.
...
- entry_name: |
  ...
  entry_fav_count: 26
  entry_content: |
    on libero icin gerekli istatistiklerin hic biri olmadigi icin anlamsiz bir karsilastirma. <br/><br/>hani pas yuzdesi, hani tackling, hani top calma?
  entry_channels: spor,anket
- entry_name: |
  ...
  entry_fav_count: 25
  entry_content: |
    başta zor gelebilir, ama her şey başta zor gelir.<br/><br/>5 rings - miyamoto musashi (japon kılıç ustası)
...
- entry_name: |
    şaka maka erkek yazarların ideal erkek olmaları
  entry_id:  81572314
  entry_writer: mgmar48
  entry_fav_count: 18
  entry_content: |
    (bkz: <a class="b" href="/?q=ek%c5%9fi+s%c3%b6zl%c3%bc%c4%9f%c3%bcn+erkekleri+50+kilo+zay%c4%b1f+g%c3%b6stermesi">ekşi sözlüğün erkekleri 50 kilo zayıf göstermesi</a>)
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    poi standart bir amerikan polisiye dizisi tadındayken senaryosunun ve kurgusunun çok sağlam yazılmış olması sebebiyle kendini sevdirmiştir. dünyadaki tüm dijital kayıt cihazlarının gerçek zamanlı işlenmesi ile insanların izlenmesi ve "tahmin" yapılarak olaylara müdahale edilmesi hem iyi bir kurgudur hem de adım adım koştuğumuz bir gerçekliktir. o gerçekliği 10 sene öncesinden bize yaşattığı için evet poi kral dizidir !
  entry_channels: tv
- entry_name: |
    gökhan zan
  entry_id:  81577847
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    şunun iade politikasına da laf eden oldu ya kapatak gidek sözlüğü.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    o değil de gerçekten bazı akp'liler bu festival ile ülkede sanayi devrimi yapacaklarına inanıyorlar.<br/><br/>gerçekten çok aptallar var. bu tip festivaller sadece havacılık vs özendirici olur o da güzel bir şeydir o kadar. <br/><br/>ne eksik ne fazla..
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    beşiktaşlıyım demenin alternatif yolları
  entry_id:  81566437
  entry_writer: tecrubeli yargic
  entry_fav_count: 4
  entry_content: |
    arkadaşa bir türkçe sözlük ile bir ph cetveli verelim.
  entry_channels: spor
- entry_name: |
    ios 12
  entry_id:  81573125
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    senede temiz 20 tane hatalı gol yer, lig istatistikleri sıradan anadolu kulübü kalecilerinin dahi gerisindedir, bazıları için ligin en iyi kalecisidir, o kadar iyidir ki; senede en az 5-6 kez 15+ milyon euro transfer teklifi alır.
  entry_channels: spor
- entry_name: |
    galatasaray
  entry_id:  81574469
  ...
  entry_fav_count: 2
  entry_content: |
    basının size nasıl bilmem ne çocuğu olduğundan bahsetmiş miydim?<br/><br/>ligin üçüncü haftası galatasaray'ın 6 attığı alanyaspor ile ilgili daha hafta 3, 3 lan 3, ama maşallah alanya'yı 3.lig kırmızı grupa göndermişti bu basın. o alanya şimdi de kasımpaşa karşısında ilk yarıyı galip kapattı. hayır yenilebilir, ama çıkıp çatır çatır oynuyor hiç de düşecek gibi görünmüyor.<br/><br/>hep diyorum bu takım 5'te atsa 10 da atsa medyadaki tavır şu;<br/><br/>" bu rakip zayıf ya. bugün kötü oynadı. aslında o 43. dakikada bi pozisyon var, galatasaray orda golü yese şimdi mağluptu"<br/><br/>lan istisnasız her rakipe aynı şey papağan gibi tekrarlanıyor bu basında. o zaman real'in kazanabileceği maç yok.<br/><br/>bu basına hangi takımın para yedirdiğine dair iyi teorilerim var da, bırak bana kalsın. tüyo mu? 3-0 yendikleri boktan takıma karşı aynı basının destan yazdığını iddia ettiği bir takım işte.
  entry_channels: spor
- entry_name: |
    fifa 19
  entry_id:  81569061
  ...
  entry_fav_count: 1
  entry_content: |
    hakkında söylenen “bu oyuna bu kadar para vermeyip eski oyunlara yama yapın” = eşeklerinize motor takın.<br/><br/>ea geçen yıl 800milyon dölar kazanmış sadece oyun içi online satış işinden (oyunu satın alma bedeli dahil değil). <br/><br/>bu yama fikri onları bitirir eminin.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    akhisarspor - galatasaray maçında muslera'yı ikinci sarıdan atmaması dışında gayet güzel maç yönetmiştir. <br/><br/>özellikle galatasaray'a verilen penaltıyı eleştirenler olmuş. bugün hakemi beğenmemin en temel kararı o penaltıyı vermesidir. bu tarz penaltılar ligimizde verilmiyor diye defans oyuncuları forvetleri her duran topta yaka paça indiriyorlar. bu gözler ne forması çıkan forvetler gördü! <br/><br/>verilen penaltının diğer lig maçlarında da çalınması dileğiyle...
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=format+neydi+format+emekti">format neydi format emekti</a>)
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ı love you baby demek istiyorum da başa geçse chp de bir şey değişmeyeceği için içimden gelmiyor.
  entry_channels: siyaset,anket
- entry_name: |
