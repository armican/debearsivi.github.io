...
- entry_name: |
  ...
  entry_fav_count: 95
  entry_content: |
    adam 5 tane parfüm yazmış amk, hepsinin orijinalini alsa 3700 tl tutuyor. iki entry öncesinde işsizim diye ağlıyor. metroda denk gelsek ter kokusundan bizi bayıltacak.
...
- entry_name: |
  ...
  entry_id:  90656184
  entry_writer: naberkedi
  entry_fav_count: 27
  entry_content: |
    sokak eşyası ne lan adjkgasj
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
    28 mayıs 2019 ankara barosu işkence raporu
  entry_id:  90642609
  entry_writer: varamaarjantincikarttirmiyor
  entry_fav_count: 19
  entry_content: |
    insanlık suçunu görmezden gelen yaratıkları da barındıran başlık. 1-bir insana bunları hiçbir gerekçe ile yapamazsınız. 2-şüpheli olmanız bir insanın aha bu demesine bağlı. 3-insanlara neredeyse rastgele terörist denmesini destekleyenlere yarın bir gün salakça bir nedenle arkasında kamuoyu olan birileri terörist damgası vurabilir, bunun olasığını hiç düşünmüyor musunuz? <br/>işkence karnesi zaten berbat olan türkiyede geçen rapordur.
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    bir insan kitabında pedofiliyi anlatmak isteyebilir, pedofillerle ilgili kitap yazabilir ve bunda hiçbir sakınca yoktur. <br/><br/>fakat dünyanın her yerinde çocuk pornosu suçtur. bu kitap dediğiniz şey alenen çocuk pornosudur ve düşünce özgürlüğü kapsamında değildir. çocuk pornosu suçtur. bir daha söylememe gerek var mı karga kadar beyne sahip olmaktan çoook geri yayıncı ve yazar, çocuk pornosu suçtur.
  entry_channels: edebiyat
- entry_name: |
    ak partililerin kışkırtıcı başlık açma sebebi
  entry_id:  90644000
  entry_writer: clercofnobottle
  entry_fav_count: 15
  entry_content: |
    adam kuşluk vakti oturmuş, neden iğrenç bir şekilde toplumu kışkırtıp kaotik ortamda tuttuklarını her zamanki sikko argümanlarıyla pişkin pişkin açıklamaya çalışıyor. gerçekten eğitilmezsiniz ve kötüsünüz, sizin bu zihniyetinizi kökünden temizlemek için maalesef çok yıllar harcayacağız.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    allahın adını verdim şu kurtköy de ikamet eden piçi biriniz ortamına sokup bir daha çıkarmasın, şu başlık bir bu piçe bir de kadıköy de söz de ikamet edenlerin mesajlarıyla meşgul oluyor yeter.<br/><br/>plâna göre rakı da olur diyor. bak amk her kuşu becerdi...<br/>daha yaşın kaç senin oğlum ? başına bir iş gelse kime anlatacaksın derdini müptezel pezevenk.
