...
- entry_name: |
    reynmen'in şarkısının youtube'dan kaldırılması
  entry_id:  86909258
  entry_writer: wohan
  entry_fav_count: 168
  entry_content: |
...
- entry_name: |
    eve girince hoşgeldin aşkım diyen rus kızı
  entry_id:  86887079
  entry_writer: en dandik nick
  entry_fav_count: 123
  entry_content: |
    asimile olmuştur. bir süre sonra aşkım asiyeler yeni koltuk takımı almış falan demeye başlar.
  entry_channels: ilişkiler
- entry_name: |
    nusret'in çiğ süt içmesi
  entry_id:  86911313
  entry_writer: vampire lestat
  entry_fav_count: 115
  entry_content: |
    doğrusu nusret'in çiğ süt içer gibi yapmasıdır zira kameranın kendisini çekmediği sırada bardağı değiştirdiği bariz belli oluyor bardağa dikkat ederseniz.
...
- entry_name: |
  ...
  entry_fav_count: 65
  entry_content: |
    (bkz: <a class="b" href="/?q=i%c5%9f%c3%a7i+partisi%27nin+i%c5%9f%c3%a7ilerden+oy+alamamas%c4%b1">işçi partisi'nin işçilerden oy alamaması</a>)
...
- entry_name: |
  ...
  entry_fav_count: 52
  entry_content: |
    bakın ben bunu savunanlardan birinin organ naklini kötülediği instagram postunun altında, <br/>organ nakli ille de gerekli miymiş, hacamat yaptırsınlar,<br/>diye yorum yapan insan gördüm. yemin ediyorum gördüm. siz bu insanlara aşının gerekliliğini anlatamazsınız. taşa anlatırsınız ama bu kafaya anlatamazsınız. <br/><br/>katılana da, savunana da saygı duymadığım, duymayacağım harekettir. bahane falan yok. çok saygılıyımdır, çok anlayışlıyımdır ama bunu savunan insan sabaha kadar anlatsın, dinlemem. anlamak için tek bir beyin hücremi bile kullanmam.
...
- entry_name: |
    alman porno sektörünün bitmesinin nedenleri
  entry_id:  86910467
  entry_writer: schoko pirens
  entry_fav_count: 40
  entry_content: |
    topu topu 7 pozisyon var, kac farkli film cekilebilir ki?<br/><br/>edit:baslik basa
...
- entry_name: |
    rte'nin 15 temmuz gazisiyle duygu dolu konuşması
  entry_id:  86913019
  entry_writer: insan donuna girmis telli turna
  entry_fav_count: 33
  entry_content: |
    (bkz: <a class="b" href="/?q=ma%c4%9fdur+olmam+laz%c4%b1m+diyorum+anlam%c4%b1yor+musun">mağdur olmam lazım diyorum anlamıyor musun</a>)
  entry_channels: siyaset,ilişkiler,tv,tarih,sağlık,haber
- entry_name: |
    sigarayı bırakmak
  entry_id:  86889667
...
- entry_name: |
  ...
  entry_id:  86886960
  entry_writer: gulelimbari
  entry_fav_count: 20
  entry_content: |
    iliski yonetimini iyi yapabilmektir. <br/><br/>yukselmek istiyorsaniz calisma arkadaslarinizla, yoneticilerinizle, mudurlerinizle aranizin iyi olmasi, surekli gulmeniz guldurmeniz, ancak kendinizi asla ezdirmemeniz gerekiyor.<br/><br/>yeni mezun olupta is hayatina atilan biriyseniz cok buyuk ihtimalle bunlarin hepsini ayni anda yapamayip bocalayacak ve kapasiteniz cok daha fazla iken sizin kotu bir calisan oldugunuzu dusundurteceksiniz. <br/><br/>ama merak etmeyin ikinci isinize basladiginizda iliski yonetimi nedir, nasil yapilir, nelere dikkat edilmelidir gibi detaylari zaten halletmis olacaksiniz.
  entry_channels: anket,ekonomi
- entry_name: |
    kişinin 17 yaşındaki haline vereceği öğüt
  entry_id:  86890387
  entry_writer: aylaklaklak
  entry_fav_count: 16
  entry_content: |
    annecigine doya doya sarıl ve doktora götür belki kurtarırsın.
  entry_channels: anket,eğitim
- entry_name: |
    şokopop
  entry_id:  86916384
  entry_writer: dokunma lan
  entry_fav_count: 15
  entry_content: |
    (bkz: <a class="b" href="/?q=%c5%9fokopop+kim+amk">şokopop kim amk</a>)
  entry_channels: teknoloji,magazin
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    <a class="b" href="/?q=kuru+iftira">kuru iftira</a> olur mu öyle şey ne münasebeseks.
...
- entry_name: |
    instagramda ürün satan sözlük yazarları
  entry_id:  86910624
  entry_writer: galove
  entry_fav_count: 8
  entry_content: |
    (bkz: <a class="b" href="/?q=maliye+bunu+be%c4%9fendi">maliye bunu beğendi</a>)
  entry_channels: anket,ekşi-sözlük,teknoloji,ekonomi
- entry_name: |
    mehmet ali alabora'nın müebbet ile yargılanması
  entry_id:  86916304
  entry_writer: karanliktaki kilic
  entry_fav_count: 7
  entry_content: |
    bu iddianameyi yazan kişiye savcı demek savcılık makamının kendisine hakarettir. hepiniz uşaksınız, hepiniz kulsunuz, yargılanacaksınız.
  entry_channels: siyaset,haber
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    son dakika olarak düşmeye başlayan haber;<br/><br/>"mahkeme konkordato daha önce isteyen ulusoy ulaşım petrol sanayi ticaret anonim şirketinin iflasına karar verdi. ulusoy'un avukatı yaz sezonunun görülmesi için kesin mühlet talep etti. mahkeme ulusoy'un kesin mühlet talebini reddederek iflasına karar verdi."<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.sozcu.com.tr/2019/ekonomi/son-dakika-ulusoy-iflas-etti-3610044/" title="https://www.sozcu.com.tr/2019/ekonomi/son-dakika-ulusoy-iflas-etti-3610044/">https://www.sozcu.com.tr/…lusoy-iflas-etti-3610044/</a><br/><br/>zaten daha önce iflası nedeni ile isim hakkı devredilen firma yeni sahibi ile tekrar iflas etmiş.
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    2000’li yıllarda bar honda takımının japon pilotu. gündemde adını görünce mutlu oldum. f1 ile ilgili olan başlıklar sevilir.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    biri yukarıda şunu yazmış:<br/><br/>"patatese dönmüş beşiktaş orta sahasının topal jailson eljif orta sahasına fiziken ezileceği maç olacaktır. ligin ilk yarısındaki maç bu maçın nasıl geçeceği konusunda önemli bir done. gollü beraberlik veya fenerbahçe galibiyeti bekliyorum."<br/><br/>oğlum siz ciddi misiniz? son 10 maçta 2 galibiyet alabilmiş takım beşiktaş'ı ezecekmiş? harbi, eljif denen embesilin beşiktaş orta sahasını ezeceğini inanıyor musunuz? <br/><br/>oğlum her hafta çakacaz diye maçı açıyorsunuz, öpüp gönderiyorlar sizi. bu nasıl kafa arkadaş? küme düşmeye oynuyorsunuz cidden, gelmiş 3. takım olan beşiktaş'ı ezeceğini hatta yeneceğini falan iddia ediyor. <br/><br/>inanamıyorum lan! nasıl kafalar var.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  86914967
  entry_writer: snake54
  entry_fav_count: 1
  entry_content: |
    mutfakta sigara içerken tabletten ekşiye girip çaylaklıktan kurtulduğumu fark ettim :)
  entry_channels: anket,ekşi-sözlük
- entry_name: |
    ali koç
  entry_id:  86914528
  ...
  entry_fav_count: 1
  entry_content: |
    al dürüst tarafsız olmalı ama nihat özdemir fb'yi temsilen orada olmalı çok tutarlı gerçekten.
  entry_channels: spor,haber,ekonomi
- entry_name: |
    2000 yılında çekilmiş ankara videosu
  entry_id:  86916373
  entry_writer: maguruz
  entry_fav_count: 1
  entry_content: |
    40. saniye sonrasında görüntülerin çekildiği nokta 2016 da bombalı katliam yapılan durağın olduğu yerdir.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    <a class="b" href="/?q=halil+cibran">halil cibran</a> - <a class="b" href="/?q=ermi%c5%9fin+bah%c3%a7esi">ermişin bahçesi</a>
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    festival vb organizasyonlar için konsiye kumaş çanta verebilirim veya beraber stand açabiliriz, baskılı çeşitli kumaş çantalar yapıyoruz keyifli bir minimal ama etkili atölyemiz var.
