...
- entry_name: |
  ...
  entry_fav_count: 128
  entry_content: |
    olursa deprem anında başlığı açıp sizi bilgilendireceğim.<br/>edit: depremler basladi. telefonum ve bilgisayarimla sizi bilgilendirmek icin hazirim esen kalin.
...
- entry_name: |
  ...
  entry_channels: siyaset
- entry_name: |
    2019 aylık aile bütçesi
  entry_id:  86902340
  entry_writer: frankyanke
  entry_fav_count: 52
  entry_content: |
    2020 tl ye evini geçindiren bir babadan acilen iktisat dersi almalısın. <br/>musluk akarken doldurmak lazım. şu an karı-koca iyi bir gelir sahibi olabilirsiniz. standartlarınızı biraz düşürüp, tutumlu olursanız yarın birgün çocuğunuz olduğunda sıkıntı yaşamazsınız. ayrıca mutfak masrafı 2000 tl ise o evde yemek pişmiyordur.<br/>edit: merak eden arkadaşlar oldu. bütçe planlamasını<br/>gelir 7600 tl evliyim, çocuk yok<br/>kira 500 tl<br/>telefon faturası digiturk netflix internet 380 tl<br/>kredi 550 tl<br/>elektrik su yok <br/>spor salonu 400<br/>benzin 200 tl arabam 0.65 alto<br/>mutfak ve ihtiyaçlar 1500 tl <br/>4000 tl ye yakın bir para da tasarrufumda, bunun 2000 tl si kesinlikle köşededir.
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    konya'nın başı çektiği listedir.<br/>konya ve trabzon bu sevgisizliğin nirvanasıdır.
  entry_channels: 
- entry_name: |
    ali ismail korkmaz
  entry_id:  86919992
  ...
  entry_fav_count: 12
  entry_content: |
    anayasal hakkını kullanmak için sokaktaydı. dövülerek öldürüldü. katili onu dövenlerle birlikte emri verenlerdi. zeka seviyesi anlamaya yetmeyenler şuraya bakabilir:<br/><br/>(bkz: <a class="b" href="/?q=emri+ben+verdim">emri ben verdim</a>)<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.cnnturk.com/haber/turkiye/erdogan-esnaf-gerektiginde-asker-polis-ve-hakimdir" title="https://www.cnnturk.com/haber/turkiye/erdogan-esnaf-gerektiginde-asker-polis-ve-hakimdir">https://www.cnnturk.com/…de-asker-polis-ve-hakimdir</a>
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    gerizekalı taraftarların fener'in yenilmesini istediği maç. ulan mal! sikmişim beşiktaş maçını. elde kalmış sadece avrupa ligi. gittiği yere kadar gitmeli takım. sizin kafanızı sikeyim. elenelim diyorlar şaka gibi.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    3-4 ay sonra 4000tl civarına alınabilecek telefondur. bekleyin öyle alın.
  entry_channels: teknoloji
---
