...
- entry_name: |
    doğa koleji'nin down sendromlu çocuğu reddetmesi
  entry_id:  78680410
  entry_writer: dabsem
  entry_fav_count: 152
  entry_content: |
    çoğunlukla özel öğretim ve özel eğitim birbirine karıştırılmakta. özel okullar özel öğretim kurumlarıdır ancak down sendromlu çocuklar "özel eğitim" alması gereken çocuklardır. normal çocuklarla eğitim öğretim alacağı bir özel okul o çocuk için uygun olmayabilir.
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    ingilizce bilen kişi ile bilmeyen arasındaki fark
  entry_id:  78679068
  entry_writer: durbidakka
  entry_fav_count: 65
  entry_content: |
    (bkz: <a class="b" href="/?q=maa%c5%9f">maaş</a>)<br/>(bkz: <a class="b" href="/?q=ya%c5%9fam+kalitesi">yaşam kalitesi</a>)<br/>(bkz: <a class="b" href="/?q=ortam">ortam</a>)
...
- entry_name: |
  ...
  entry_fav_count: 39
  entry_content: |
    daha üniversitede okuyan insanlar milletvekilliği nasıl yapabilir diye sorgulatmamıştır. nasıl yapacağı açık; liderlerinin maşası olacaklar, itaat edecekler, vs.<br/><br/>sonuç; oylamaya açıyorum, kabul edenler? kabul edilmiştir.
  entry_channels: siyaset
- entry_name: |
    250 ülke arasından türkiye'de doğma şansızlığı
  entry_id:  78679064
  entry_writer: seviyorsevmiyorseviyorsevmiyorseviyor
  entry_fav_count: 32
  entry_content: |
    o kadar da değil abartmayın. bence asıl problem, türkiye’nin inanılmaz potansiyeli olmasına rağmen , eğitim ve kültür nedeniyle bunun yarısına bile gelememesi ve de ilerleyeceğine geri gitmesi.<br/><br/>ya afganistan’da doğsaydın?
  entry_channels: siyaset
- entry_name: |
    fernando muslera
  entry_id:  78695469
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    canlıların ilk kez karaya çıkış anı. hatta tekmeyi koyar denize geri yolardım çıkanları. sonra "çıkanın anasını sikerim" diye bağırarak sahilde dolaşırdım bir süre. ilk hatayı burda yaptık biz.
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    cavani tam aykut kocaman'lık forvet.<br/>düşünsenize adam forvet ve köpek gibi defans yapıyor. aykut bu maçtan sonra cavani'nin resmine sarılıp uyur bence.
  entry_channels: spor
- entry_name: |
    özgür demirtaş
  entry_id:  78695729
  ...
  entry_fav_count: 3
  entry_content: |
    çok iyi bir mühendistir, çok iyi calculus bilir... calculus uygulamalarının finans karşılıklarını anneye anlatır gibi anlatır... dersleri çok theatral geçer ancak aşırı enerjisinden dolayı bir süre sonra kendisini izlemekten dersi takip edemiyorsun, dersten çıkınca "ne anlattı lan bu?" diyorsun...<br/><br/>ideolojik olarak liberteryenim dese de ben hayatımda ilk kez liberalizmi bir faşist gibi savunan birini kendisi ile tanıdım... ben de kendimi liberal demokrat olarak tanımlıyorum ancak diğer tüm fikirlere ve ideolojilere de saygım var - bu ideolojileri savunanları aşağılamıyorum, "salak" olduklarını düşünmüyorum, dinliyorum, anlamaya çalışıyorum ve savundukları ideolojinin hatalarını kendime göre anlatmaya çalışıyorum... <br/><br/>ancak, ideolojilerin de sosyal sınıflar ile bir ilgisi olduğunu düşünüyorum...<br/>"homeless" bir amerikana liberalizm çok iyi dersen ağzına kürekle vurur, çünkü o adama sistem ne iyi bir eğitim sağlayabildi, ne bir kapital verdi, ne de fırsat eşitliği sundu... bunu anlayabilmek için suriye'den göçmek zorunda kalmış, eskiden "liberal" olan bir aile ile biraz zaman geçirmek, 2. dünya savaşında toplama kamplarına kapatılan varlıklı ailelerin hatıratlarını okumak anlayabilen için yeterli veri sunar... <br/><br/>işin bu kısmını "sindiremediğini" düşünüyorum... bir de kendisini sahalarda görmek istiyoruz, girişimcilik, innovasyon falan - eee, sen ne zaman yapacaksın? ben de biliyorum tribünlerden bağırmayı - sahaya in bir çalım at, bir gol at hocam artık, bekliyoruz. <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
  entry_channels: siyaset,ekonomi
- entry_name: |
    dizi karakterlerinin cb seçimleri
  entry_id:  78696492
  entry_writer: isolde
  entry_fav_count: 3
  entry_content: |
    oya: ince<br/>pelin: ince<br/>arzu: akşener<br/>mehmet: akşener, mecliste mhp<br/>taylan: ince, mitinge gitmiştir<br/>burcu: ince<br/>serhan: ince <br/>edip: demirtaş<br/>komiser kemal: akşener<br/>derya: demirtaş<br/>ayşe: tatildeydi<br/>merve: merve aksak<br/><br/>tam bir laikçi dizisi ondan izliyorum
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    dünya kupasında gol atmıştır. 35 yaşındadır ve beşiktaşımızın stoperidir. ben gurur duydum.
  entry_channels: spor
- entry_name: |
    künefe vs waffle
  entry_id:  78696656
  entry_writer: shadowwalker
  entry_fav_count: 2
  entry_content: |
    künefe=uber. waffle=sarı taksi.
...
- entry_name: |
    ekşi sözlük şarkı önerme platformu
  entry_id:  78670728
  entry_writer: eksimtrack
  entry_fav_count: 1
  entry_content: |
    b*tch is ekşi diyo la. <br/><a rel="nofollow noopener" class="url" target="_blank" href="https://soundcloud.com/dirtyduckaudio/b-tche-original-mix-trapski" title="https://soundcloud.com/dirtyduckaudio/b-tche-original-mix-trapski">https://soundcloud.com/…b-tche-original-mix-trapski</a>
  entry_channels: anket,müzik
- entry_name: |
    bisiklet sporu yapanlara tavsiyeler
  entry_id:  78687914
  entry_writer: kulelili
  entry_fav_count: 1
  entry_content: |
    ucuz bisiklet alma. ilk bisiklet ortalama bir bisiklet olmalı. devam etmek istersen daha iyisini devamında alırsın. temiz ikinci el al.
  entry_channels: spor
- entry_name: |
    sokak düğünü
  entry_id:  78696598
  ...
  entry_fav_count: 0
  entry_content: |
    memleketim olan manisada halen aktif olarak yaşatılan bir adettir. zırbalar ses mes diye ortalığı ayağa kaldırır ama düğünü yapanların düğün salonu kiralayacak bile bütçelerinin olmadığını bilmez, bilmezden gelir.<br/><br/>genelde sokak belediyenin izni dışında kapatılır. sokağı kullanmak isteyen ve bunu bilen sürücüler (eğer alkollü iseler mutlaka) ise tatlı sert düğün sahiplerinden ufak bir hediye beklerler. düüğün sahipleri de sırf bunlar için hediyelerini ayarlamıştır zaten önceden.<br/><br/>batmasın lan. adamların parası olsa neden sokak ortasında yapsın düğün.
  entry_channels: ilişkiler
- entry_name: |
    luis suarez
  entry_id:  78696561
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    cool mool olmayacagim. 4 gundur disarida yemek yiyorum, her defasinda garson yalniz miyiz gelecek var mi diye sorup rencide ediyor resmen. adana var mi adana?
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    büyük olaylardan sonra 24 saat beklemeden önemli kararlar almayın.<br/><br/>kaybettiğiniz seçimlerden sonra 1 ay önemli kararlar almayın! <br/><br/>sözlükte chp’li olup olmadığı net olmayan insanların gazına gelip karar almayın! (chp’li arkadaşlar için geçerli değil bu paragraf)<br/><br/>ve evet, bir sıkıntı var ortada zaten. çözme sorumluluğu olanlarla çözmeye istekli olanları bir bekleyin, neler yapacaklarını görün, sonra kararınızı verirsiniz.
  entry_channels: siyaset
---
