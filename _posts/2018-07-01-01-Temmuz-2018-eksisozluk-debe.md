...
- entry_name: |
  ...
  entry_fav_count: 22
  entry_content: |
    böyle orospu çocuğu topçu görmedim ömrümde
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    aslı : ince<br/>cem : ince<br/>makbule : rte<br/>sacit : belirsiz<br/>gaffur : rte<br/>bülent : ince<br/>fatoş : ince <br/>yaprak : ince<br/>kubilay : ince<br/>tanriverdi : demirtaş<br/>saadettin : rte<br/>iffet : ince<br/>tahsin : rte<br/>burhan : çikilata yemeliyim
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    124 stk'nın lgbt yürüyüşüne karşı çıkması
  entry_id:  78698155
  entry_writer: a very composite material
  entry_fav_count: 7
  entry_content: |
    stk dediğin azınlıkları ve dışlanması muhtemel grupları korur. alperen ocakları eğitim kültür ve dayanışma vakfı diye stk mı olur allasen.
  entry_channels: siyaset
- entry_name: |
    edinson roberto cavani gomez
  entry_id:  78698106
  entry_writer: 36 etnik unsur
  entry_fav_count: 4
  entry_content: |
    yunan tanrısı gibi adam.<br/><br/>her hareketinde bir zerafet saklı, izlemek büyük keyif.
  entry_channels: spor
- entry_name: |
    bir ülkeyi tanımanın en iyi yolu
  entry_id:  78696512
  entry_writer: danonlio
  entry_fav_count: 4
  entry_content: |
    hayvanların da nasıl öldüğüne bakılmalıdır.
  entry_channels: 
- entry_name: |
    aşık olduğun kişiye bir şarkı bırak
  entry_id:  78692162
  entry_writer: seaward
  entry_fav_count: 4
  entry_content: |
    geçtim borandan, kardan..yitirdim bahçeleri.. ellerini tutmazsam gülüm yakarım geceleri... ellerini tutmadım ya yatamam geceleri..
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    aşırı gururlu, kibirli, her an "ne demek ulan dediklerime katılmazsın" diyebilecek, kendini gerçekleştirmediğini hissettiğinden içten içe sinir sahibi, eleştiriye gelemeyen birisi olarak hissettiğim bir akademisyen. <br/><br/>ayrıca bir yazarımızın <a class="b" href="/?q=daron+acemo%c4%9flu">daron acemoğlu</a> hakkındaki tespitlerinde, yazarın yanlışlarını nezaket kuralları çerçevesinde açıklamak yerine <a class="b" href="/?q=yazar%c4%b1ms%c4%b1">yazarımsı</a> diyerek aklınca küçümsemiş <a class="b" href="/?q=avukat%c4%b1ms%c4%b1">avukatımsı</a>dır.
  entry_channels: siyaset,ekonomi
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    bugün bu adam sadece messiye inadından. bakın futbol azminden demiyorum sadece messiye inadından ilk uruguayı sonra arjantini fransa eledi diye yarı finalde de fransayı tüm var gücüyle eleyerek finale kalır. finalde de muazzam çabası ve takımı yönlendirmesi, gaza getirmesi ile avrupa kupasının yanına dünya kupasını da koyarsa vah vah.<br/><br/>ah messi. hayranım bu ikisine de. bu adamda bitmeyen azim, hırs var. takımı sırtlayabilecek arzusu var.<br/>ancak bunlar messide yok.<br/>bir ronaldocu değilim. ikisi de benim futbolu izleme sebebim. arjantini tutuyordum şimdi portekizliyim.<br/>hadi ronaldo. messi alamadı sen al. <br/><br/>gerçi messiye inadından fransayı yeneceğinden final garanti. <br/>tek mevzu final
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=erke%c4%9fi+okuyana+kadar+olu%c5%9fan+heyecan">erkeği okuyana kadar oluşan heyecan</a>)
  entry_channels: ilişkiler
- entry_name: |
    sokak düğünü
  entry_id:  78697009
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=bir+%c3%bclkenin+geri+kalm%c4%b1%c5%9f+oldu%c4%9funu+anlama+yollar%c4%b1">bir ülkenin geri kalmış olduğunu anlama yolları</a>)
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    hitman ama hangi serisi olduğunu bilmiyorum. baslangic bölümü olarak postacıyı öldürüp villaya girip dehşet saçıyorduk.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bana 10.000 lira verirsen sana diş macunu olarak geri ödeyeceğim. o zaman anlarsın.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    amatör yarışlara vs. katılmıyorsanız komponent (daha doğrusu donanım-ekipman) budalası olmayın.
  entry_channels: spor
- entry_name: |
    belediye seçimlerinde chp'ye oy vermiyorum
  entry_id:  78671953
  entry_writer: semo pedro led
  entry_fav_count: 0
  entry_content: |
    belediye seçimlerinde partiye değil kişiye bakarak oy vermesi gerektiğini henüz öğrenememiş ergen beyanı.
  entry_channels: siyaset
---
