...
- entry_name: |
  ...
  entry_fav_count: 227
  entry_content: |
    yeni cumhuriyete sandık sandık altınları görünce baş kaldırmış, sonrasında bedelini o sandıkların birer birer itinayla götüne sokulmasıyla ödemiştir.
...
- entry_name: |
  ...
  entry_fav_count: 169
  entry_content: |
    düğün salonu sahibinin taksici ruhu taşıdığını gösteren olay.
  entry_channels: ilişkiler
- entry_name: |
    sevişirken video kaydı yapmak
  entry_id:  78679367
  entry_writer: icimdeki sey gibi bilmem ki ney gibi
  entry_fav_count: 168
  entry_content: |
    (bkz: <a class="b" href="/?q=yak%c4%b1nda+g%c3%b6t%c3%bcnden+kan+al%c4%b1nacak+yazarlar">yakında götünden kan alınacak yazarlar</a>)
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
    yuto nagatomo
  entry_id:  78681174
  entry_writer: hayat bir jamiryo
  entry_fav_count: 33
  entry_content: |
    inter galatasaray'a transferini resmen duyurdu.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.inter.it/en/news/63199/yuto-nagatomo-joins" title="https://www.inter.it/en/news/63199/yuto-nagatomo-joins">https://www.inter.it/…ews/63199/yuto-nagatomo-joins</a><br/><br/>hayırlı olsun. hoşgeldin son samuray !
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    sürpriz bir seyahat...<br/><br/>kapıma dayanıp, "kalk hadi gidiyoruz" dese biri... cinsiyetten ve ilişki biçiminden bağımsız olarak diyorum bunu. her şeyi planlamış olsa... ya da planlamadan da olur. bir şort bir tişört atsam çantaya... kitap bile almam yanıma, mutluyken çenem düşer çünkü fena halde, okuyamam<sup class="ab"><a title="(bkz: gülücük)" href="/?q=g%c3%bcl%c3%bcc%c3%bck" data-query="gülücük">*</a></sup> <br/><br/>yemin ederim, sormam bile, nereye diye<sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    emanuel mas’ı transfer ettiğimizde arjantin milli takımının sol beki nasıl bize geldi diyorduk. meğer kamil ahmet çörekçi arjantinli olsa o oynayacakmış. insan gerçekten hayret ediyor.
  entry_channels: spor
- entry_name: |
    benjamin pavard
  entry_id:  78692115
  ...
  entry_fav_count: 3
  entry_content: |
    adam turnuvanın en güzel golune, kupa tarihinin de belki de en güzel 10 golunden birine imza attı. özel durumlar haricinde ( arjantinli olmak, bahis yapmış olmak) su golu görüp ilk tepkisi, kaleci hatası var, olan insanın kafa yapısını çok merak ediyorum. arka kameradan topun dönüşüne bir bakın. muazzam. boyle bir zihniyet var. üç kaleciyi yan yana koysan çıkarilamayacak bir gol oluyor, adamın biri geliyor kaleci hatası var yazıyor. çok defa gördüm bunu.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    millet niye bu kadar sevindi anlamıyorum.<br/><br/>1. aktüelde olacak diye sevinen var. sigaranın reklamı kampanyası yasak bildiğim kadarıyla. piyasa ile aynı fiyata satılacak zaten.<br/><br/>2. kredi kartıyla alcam diye sevinenler olmuş. heryerde zaten migros jet, migros vb zincir market var komisyon hırsızlığı yapmayan. <br/><br/>3. pine, esse falan diye sevinenleri hiç anlamak mümkün değil. ikisi de leş. <br/><br/>4. le tütün tadında kendi markaları olmayacaktır. <br/><br/>5. küçük esnafın amk.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    işsizler doluşmuş 20 şer bin liralik saatlerini anlatıyorlar.. o işsizlikle nasıl alındıysa..
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=sa%c3%a7ma+ba%c5%9fl%c4%b1klar">saçma başlıklar</a>) (bkz: <a class="b" href="/?q=ba%c5%9fl%c4%b1ktan+zeka+seviyesi+tespiti">başlıktan zeka seviyesi tespiti</a>)
  entry_channels: 
---
