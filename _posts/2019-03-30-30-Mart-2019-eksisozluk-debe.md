...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    yıllar geçti, andımız içindeki ibareler bile değişti. yalnız değişmeyen tek şey <a class="b" href="/?q=mine+kora%c5%9f">mine koraş</a> zihniyetindeki faşizm, tepeden bakmacılık, ukalalık.
  entry_channels: siyaset,tarih,edebiyat,haber,eğitim
- entry_name: |
    kürtler oy vermesin kampanyası
  entry_id:  88277861
  entry_writer: cay yok bok icin
  entry_fav_count: 1
  entry_content: |
    öff ya başlığa bak içeriğe bak
  entry_channels: siyaset
- entry_name: |
