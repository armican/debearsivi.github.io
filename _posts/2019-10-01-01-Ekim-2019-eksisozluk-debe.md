...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    çukur'u savunacağım diye breaking bad'e bok atmak nedir canım kardeşim? günlük tuttuğun sadece kendinin okuduğu defter değil, sözlük burası. başkaları da okuyor, ayıp.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    iyi adamlar da çok, <br/>iyi kadınlar da.<br/>ama birbirlerine hep<br/>çok geç rastlıyorlar…<br/><br/>cemal süreya
...
- entry_name: |
  ...
  entry_id:  95998919
  entry_writer: buyur kardes musaaade senin
  entry_fav_count: 3
  entry_content: |
    kesinlikle ve kesinlikle <br/><br/>(bkz: <a class="b" href="/?q=anime">anime</a>)
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    tabi ki <a class="b" href="/?q=tar%c4%b1k+akan">tarık akan</a> dır. dünyada bile eşi benzeri yoktur benim için. mekânı cennet olsun.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    hangi yasta oldugu farketmez, buyuk bir kalp kirikliginin ardindan kendilerini ruhen ve bedenen yeniden kesfettikleri o yastir.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bugün kendisini ruşen çakır'ın medyascope kanalında izledim ve akp ile sıkı bir pazarlıkta olduğuna kanaat getirdim.
  entry_channels: siyaset
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    yadırganmayacak bir durum. <br/><br/>ancak başlıktakiler hemen g-string bildikleri için yardırmışlar. c-string de var gençler. google it.
  entry_channels: anket
---
