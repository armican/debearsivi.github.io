...
- entry_name: |
    yerli otomobilin fiyatının 250 bin tl olması
  entry_id:  99673593
  entry_writer: karizmatik bir nick olsun
  entry_fav_count: 314
  entry_content: |
    daha aşağıya yapamazlar, sırf aküleri bı dünya paraya ithal edilir, hangi lisansla yerli elektrikli araba aküsü yapacaksın? sen önce akü arge yap sonra yerli elektrikli otomobil yaparsın. teknoljiden haberi olmayan milleti gazlamak için ülkede montaj yapar ortamlarda yerli otomobil dersln, kim nereden bilecek
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    sayın cumhurbaşkanım ayağa kalksınlar mi? müsade eder misiniz?
  entry_channels: anket,edebiyat
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    kendi götümü kaşıyacak vakit bulamazken bir de başkalarına dert yanmak, dert dinlemek? aklım almıyor selim.<br/><br/>not: akrep.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    (bkz: <a class="b" href="/?q=ne+var+ne+yok">ne var ne yok</a>)<br/><br/>robotların cevap veremediği bir soruymuş. hep hoşuma gider.
