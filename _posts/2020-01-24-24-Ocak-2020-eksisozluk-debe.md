...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    (bkz: <a class="b" href="/?q=komodo+ejderi">komodo ejderi</a>)
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    acilen müge anlı tarafından "senin götün yok! götün yok senin!" şeklinde azarlanıp squat yapmaya teşvik edilmeli.
  entry_channels: tv,tarih,müzik,magazin
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    (bkz: <a class="b" href="/?q=1+%c5%9fubat+ek%c5%9fi+s%c3%b6zl%c3%bck+emekli+maa%c5%9f%c4%b1+kuyrugu+zirvesi">1 şubat ekşi sözlük emekli maaşı kuyrugu zirvesi</a>) <br/>buluşalım, kaynaşalım.
...
- entry_name: |
    you (dizi)
  entry_id:  100930360
  entry_writer: she says her name is goldie
  entry_fav_count: 4
  entry_content: |
    erken boşalan adama ikinci şansı verince ortaya çıkan sorunlar silsilesini konu alan dizi
  entry_channels: tv,sinema,spoiler
- entry_name: |
    askere gideceklere öğütler
  entry_id:  100924479
  entry_writer: eksiyazari
  entry_fav_count: 4
  entry_content: |
    hayatınızın en bitmek bilmeyen 6 ayı olacak.psikolojinizi buna hazırlayıp da gidin.
  entry_channels: anket
- entry_name: |
    instagram
  entry_id:  100964614
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    y kromozomunun boyutunun küçülmesi nedeniyle erkeklerde sıkça rastlanan, sözüm meclisten dışarı, "sığır sığır" hareketlerin azalması durumudur.
...
- entry_name: |
  ...
  entry_id:  100963129
  entry_writer: lord of loser
  entry_fav_count: 1
  entry_content: |
    ölümün eşiği çok farklı. bir kaç defa ölümle burun buruna geldim. uludağa çıkıp inemeyenler gibi. yaşamayan bilmez.
...
- entry_name: |
  ...
  entry_id:  100948282
  entry_writer: diplomatik
  entry_fav_count: 0
  entry_content: |
    kötü olduklarını fark edene kadar herkes iyi insan
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    izmir’de yaşayan varsa yeşillendirebilir.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    yakinda blutv platformunda alef dizisi başlayacagi icin yarin eksiye gelmeyen oyuncudur. nereden cikardiniz? keyfini yasayin, güzel sorular sorun.
  entry_channels: tv
- entry_name: |
    1.90 boyundaki türk erkeği
  entry_id:  100963138
  entry_writer: bratwurst
  entry_fav_count: 0
  entry_content: |
    çoğu 186-187 cm civarındadır en fazla 1.90 boyundayım diyorsa. boyu 1.85 olan bir yabancı sporcuyla yolda fotograf çektiren 2 arkadaşım ( biri 190 diğeri 191cm olduğunu iddia ediyor) adamla anca aynı boyda duruyorlardı. bizim insanımız kendini ölçerken minimum 4-5 cm yukarı kaydırıyor ölçüyü.
  entry_channels: ilişkiler
---
