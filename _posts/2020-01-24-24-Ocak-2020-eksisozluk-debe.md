...
- entry_name: |
  ...
  entry_fav_count: 155
  entry_content: |
    yeri gelmişken dünya'yı malesef küresel ısınma kaynaklı patojenik salgınlar da bekliyor. <br/><br/>buzullar içerisinde milyonlarca yıldır hapis kalan virüsler var. <a rel="nofollow noopener" class="url" target="_blank" href="https://www.nbcnews.com/science/environment/ancient-viruses-never-observed-humans-discovered-tibetan-glacier-n1120461" title="https://www.nbcnews.com/science/environment/ancient-viruses-never-observed-humans-discovered-tibetan-glacier-n1120461">tibet buzullarında</a> daha önce hiç görmediğimiz 28 tür virüs tespit edilmiş.<br/><br/>evrim bilenler durumun ne kadar korkutucu olduğunu anlayacaklardır. çünkü evrim bir insanın hayatını video kaydına almak gibidir. bir sonraki kareyle bir önceki kare aynı değildir ama çok benzer.<br/><br/>hayatımızda gördüğümüz karşılaştığımız patojenler bu sebeple daha önce " çalışılmış " olan versiyonlarına çok benzerler.<br/><br/>bu da bilim insanlarının tedavi/aşı geliştirmelerini kolaylaştırır.<br/><br/>ancak milyonlarca yıl öncesinden hiç karşılaşmadığımız, hiçbir bağışıklığımızın ve tedaviye dair fikrimizin olmadığı bir virüsün dünya çapında yayılması yaşadığımız dünyayı her an bir " distopya'ya " çevirebilir.<br/><br/>küresel ısınmanın böyle bir tehlikesi var. dünya'nın sonu muhtemelen wuhan ile gelmeyecek. ya da büyük kitlesel ölümler vs.<br/><br/>ancak o buzullar eridikçe ciddi ciddi orta çağ kara vebası gibi bir döneme girebiliriz.
...
- entry_name: |
    türk kızlarının cacık olması
  entry_id:  100943428
  entry_writer: pismissogan
  entry_fav_count: 87
  entry_content: |
    türk erkeklerinin hıyar olmasıyla bi bağlantısı olabilir.
...
- entry_name: |
  ...
  entry_fav_count: 29
  entry_content: |
    en az van dijk kadar yetenekli bir stoper dünya üzerinde bulunmadığı için taş gibi stoper olan joe gomez ile 2024'e kadar sözleşme uzatan kulüptür.<br/>elbette gönül ister ki çağlar gelsin yerleşsin tandeme dynasty'nin bir parçası olsun.
  entry_channels: spor
- entry_name: |
    yarasa çorbası
  entry_id:  100940621
...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    yeter artık yeter. erkekler sizin seks objeniz değildir kadınlar. onları bir meta gibi görüp kafanızdaki fantezili düşüncelere göre şekillendirezsiniz. düşün artık yakamızdan!
...
- entry_name: |
    corona virüsünün yarasa çorbasından bulaşması
  entry_id:  100938825
  entry_writer: proyorummm
  entry_fav_count: 10
  entry_content: |
    çin gibi leş ülkelerde farkli tur hayvan etlerini pazarda toplu olarak yığıyorlar etler kanlar birbirine karisiyor düşün manzarayı koca koca balık eti büyükbaş eti küçükbaş eti egzotik hayvan etleri böcekler birbirine karışmış bulamaç gibi olduğu yerde dünyayı yokedecek virüs çıkar aq.
  entry_channels: sağlık,haber
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    aile hekimiyim. <br/><br/>--- 18+ ---<br/>bizim mahallede bana gelen bir hasta var, seni yapanın amına koyayım dayaklık orospu çocuğu.<br/>--- 18+ ---
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    löseve yapacağınız cüzi bir yardım karşılığı biletimi ücretsiz devredeceğim.
  entry_channels: spor
- entry_name: |
    mansur yavaş'ın makam odasındaki gizli oda
  entry_id:  100960962
  entry_writer: amelieninkocasi
  entry_fav_count: 1
  entry_content: |
    kim bilir kiminle konuşuyordu? <br/><br/>benim aklıma kripto telefonlarla konuşma yapılabilecek, dinlemeye karşı önlem alınmış bir oda geldi. ses yalıtımı dışarıdan dinlemeye, elektrik bağlantısı olmaması ise böceklere karşı önlem.
  entry_channels: siyaset
- entry_name: |
    bira içmelik arkadaş veritabanı
  entry_id:  100950521
  entry_writer: szimpla
  entry_fav_count: 1
  entry_content: |
    mesai sonu icin geri sayim içerir. <br/><br/>4<br/>2<br/>0<br/>.<br/><br/>ıstanbul avrupa.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ben değilim. dünyaya bir daha gelsem yine aynı işi yapmak isterdim. çünkü hobim, aynı zamanda işim.
  entry_channels: anket,ekonomi
- entry_name: |
    izmir'in en iyi hamburgerleri
  entry_id:  100960182
  entry_writer: 324
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=akb%c4%b1y%c4%b1k+et">akbıyık et</a>) yeşilova'da akbıyık'ta hamburger yemeyen gelip buraya hamburger yedim, güzeldi demesin.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    anal seksi sevdiginizi neden itiraf etmiyorsunuz?
