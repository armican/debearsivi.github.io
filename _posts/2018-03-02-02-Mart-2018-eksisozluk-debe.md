...
- entry_name: |
    türkiye'nin elon musk'u berat albayrak'tır
  entry_id:  74612223
  entry_writer: guest22474
  entry_fav_count: 172
  entry_content: |
    (bkz: <a class="b" href="/?q=kendi+kendine+konu%c5%9fana+deli+derler">kendi kendine konuşana deli derler</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    aval aval gökyüzüne bakmayıp, azıcık kenarıya çekilmektir.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    işteyken karısı fanatik beşiktaşlı bir holigana vurduracaktır
- entry_name: |
