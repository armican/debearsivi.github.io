...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    lensi ittirdik, kaktirdik, caktik diyen adamlarin kanadinda dirar ile atif kaşekuşe oynuyor.. super kaktirmissiniz hakkaten.<br/><br/>aksam fenere cakacagi hissini aldığım topcu.
- entry_name: |
...
- entry_name: |
    letgo da satılan ankarakartlar
  entry_id:  74618284
  entry_writer: wallcan
  entry_fav_count: 11
  entry_content: |
    (bkz: <a class="b" href="/?q=letgo+da+sat%c4%b1lan+anakartlar">letgo da satılan anakartlar</a>)<br/><br/>bir süre beynim yandı "anakart'a 1300 yüklemek ne amk " diyorum deminden beri.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    kaynak kodunu sözlüğe yapıştıracak kadar kafası değişik insanların kullandığı dil.
- entry_name: |
