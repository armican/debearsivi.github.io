...
- entry_name: |
  ...
  entry_fav_count: 38
  entry_content: |
    herif aşırı derecede haklı.<br/><br/>dilerim başlık da konunun önemine dikkat çekmek için bilinçli olarak provokatif açılmıştır.<br/><br/>gerçekten de halkımız utanmıyor. zerre kadar bir utanmaları olsa, şunu yapmazlar zaten.
  entry_channels: 
- entry_name: |
    kapıyı çalsa misafir edilecek şarkıcı
  entry_id:  94491090
  entry_writer: snowman
  entry_fav_count: 36
  entry_content: |
    snoop dogg tabi ki. eli boş gelmez diye umuyorum.
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    iyi icmek cok icmek degildir, nerede duracagini bilmektir. ayrica cok icmek de marifet degildir. kararinda icersin, kalkarsin. <br/><br/>su kadar zamanda bu kadar ictim demek dupeduz salakliktir.
  entry_channels: anket,sağlık,yeme-içme
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    <a class="b" href="/?q=eyyorlamam+bu+kadar">eyyorlamam bu kadar</a>
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    ersin düzen geçen gün bein sports'un özetler için geçen yılın iki katı para istediğini bu yüzden anlaşamadıklarını söyledi ama bu kesinlikle bahane değil. her yerden vergi akıyorsa, devletin kanalıysa, trt bir şekilde bu özetleri yayınlamalı. neredeyse aldığımız nefesten bile aldığı verginin hakkını vermeli. özetler pahalı demek bahane değil.
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    ahahha serbest oyuncuyu belhanda ile takas edince ne oluyor merak ettim, belhanda fernandes'in tapulu malı mı olacak, kime neye takas edilecek.
  entry_channels: spor
- entry_name: |
    ekşi itiraf
  entry_id:  94491004
