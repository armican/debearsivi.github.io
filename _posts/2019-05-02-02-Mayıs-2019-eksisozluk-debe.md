...
- entry_name: |
  ...
  entry_fav_count: 58
  entry_content: |
    insanlardan uzak durun, insanlarla değil makinalarla veya hayvanlarla ilgili bir işte çalışın.
...
- entry_name: |
  ...
  entry_fav_count: 26
  entry_content: |
    cep telefonu eskinin araba fiyatlarına yaklaşıyor. araba fiyatları ise zaten alınamayacak düzeylere geldi, satışların %60-%70 oranında azaldığı neredeyse her ay haber oluyor. ev fiyatlarına değinmeye gerek bile yok...<br/><br/>bu olaylar her ülkede vuku bulmuştur. şimdilerde venezuela. eskiden mustafa kemal atatürk'ün de gördüğü ve türk gençliğine direkt olarak söylediği hitabede "bütün bu şeraitten daha elim ve daha vahim olmak üzere, memleketin dahilinde, iktidara sahip olanlar gaflet ve dalâlet ve hatta hıyanet içinde bulunabilirler. hatta bu iktidar sahipleri şahsi menfaatlerini, müstevlilerin siyasi emelleriyle tevhit edebilirler. millet, fakr-ü zaruret içinde harap ve bitap düşmüş olabilir." diye bir cümlesi var.<br/><br/>özetle diyor ki iktidar sahipleri vatana hıyanet içinde bulunabilirler dikkatli olun. şu an atatürk yaşasaydı emin olun iktidardakilerin vatana ihanet ettiğini net bir şekilde söylerdi ve gereğini yapardı. biz ise bunu dillendiremeyecek kadar aciz hale getirildik.<br/><br/>şu an venezuela'da kriz var. insanlar yiyecek yemek bulamıyor, ülke iktidar tarafından diğer ülkelerin temasına açık hale getirilmiş.<br/>türkiye, yiyecek temel gıdaları zor buluyori et vb. zaten yok asgari ücretliye. simit hesapları yapılıyor. ülke askeri kararlar alırken bile diğer ülkelerin kararlarına boyun eğen hale getirilmiş.<br/><br/>mevcut iktidar yerine vatanını seven insanlar bu memleketi yönetmeli. gerisi zaten gelir.
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    saçmalamayın ne evlenmesi... en zor zamanlarımızı tek başımıza atlattık. bundan sonrasını da halledebiliriz.
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    ilk iki dakikası türkiye'ye ait olmayan görüntülerdir.
  entry_channels: tarih,seyahat
- entry_name: |
    müge anlı ile tatlı sert
  entry_id:  89556936
  entry_writer: covered
  entry_fav_count: 7
  entry_content: |
    büşra = küçük ferluga hanım.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    ustune hic hasta oldugumu hatirlamiyorum ama o kopuklu halinin uzerinde kayarken, saga sola rasgele sabun tozu savururken ve hortumla su tuttugum yerler israrla kopurup beni delirtirkenki mutlulugumu cok net hatirliyorum, evet benim o cocuklardan biri.
  entry_channels: ilişkiler,tarih
- entry_name: |
    beraber yaşlanalım denilen kadının ölümsüz çıkması
  entry_id:  89565518
  entry_writer: bipolar express
  entry_fav_count: 5
  entry_content: |
    yunan mitolojisinde çok sık rastlanılan bir trajedidir.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    her yemekten sonra tatlı diye çıldıran, bulduğu her fırsatta tatlı gömen biri olarak başardığım eylemdir. 1.5 ay oldu ve artık önümde tatlı yeseler bile canım çekmiyor. şekeri bırakmanın en sevdiğim yanı yemekten sonra gelen tatlı krizinden kurtulmak oldu. 21 gün kuralı kişiden kişiye değişiyor, 21 günün sonunda hala deli gibi tatlı çekiyor canım deyip salmayın kendinizi. herkesin bünyesi farklı sonuçta. tatlı aramamak güzel. anca yurtdışına veya gaziantep gibi tatlılarıyla ünlü bir ilimize gitsem tatlı yerim herhalde. onun dışında imkanı yok.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ilgili entryi görür görmez eksiyi basarken bir yandan ben fazla duyarlıyım herhalde düşündüğüm durumun dile getirilme hali.
  entry_channels: haber
- entry_name: |
    iker casillas
  entry_id:  89565544
...
- entry_name: |
  ...
  entry_id:  89569737
  entry_writer: dandikhalkozani
  entry_fav_count: 0
  entry_content: |
    21-) eflak ve boğdanı üzerime yapacasın
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    derdi boşverinde sikişmek isteyen kadın var mı lan merak ettim.
  entry_channels: ilişkiler,ekşi-sözlük
---
