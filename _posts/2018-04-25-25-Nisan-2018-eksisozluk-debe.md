...
- entry_name: |
  ...
  entry_fav_count: 117
  entry_content: |
    züğürt tesellisidir.<br/><br/>zeki olduğunuz için değil, sizi sevmediği için sevmiyor. kendinizi kandırmayın.
...
- entry_name: |
  ...
  entry_channels: siyaset,haber,eğitim
- entry_name: |
    düşük model arabaya binen zengin adam
  entry_id:  76304999
  entry_writer: epifiz
  entry_fav_count: 46
  entry_content: |
    benim. estetik algım yok, pintiyim ve can güvenliğimi düşünmem ama para bende.
...
- entry_name: |
  ...
  entry_fav_count: 35
  entry_content: |
    fenerbahçelilerin "bize yıllarca neler neler atıldı hiç sahayı terk etmedik" diyerek olası bir hükmen mağlubiyet kararını çürütme çabaları var. bu cümle ile fenerbahçe'nin ne kadar dirayetli, delikanlı, cesur vs. bir takım olduğundan bahsedebilirsiniz fakat anlamadığınız şey şu ki, hukuk böyle işlemez.<br/><br/>bu maçın hükmen beşiktaş lehine tescil edilmemesi gerektiğini bu şekilde savunmak nedir biliyor musunuz? örneğin sokakta gücünüzün yetmeyeceği bir adam geldi ve size yumruğu yapıştırıp burnunuzu kırdı. ne yapmanız gerekir? o adamla ilgili kasten yaralama suçundan şikayette bulunursunuz değil mi? şimdi düşünün ki adam savunmasında "daha önce bana sokakta böyle 50 kişi yumruk atmıştır, ben hiçbirinden şikayetçi olmadım. nerede adalet?" diyor. ne kadar mantıksız değil mi? sizce hakim o adama bu savunması sebebiyle kanunda yazandan daha az bir ceza verir mi? vermez tabi ki.
  entry_channels: spor,anket
- entry_name: |
    24 nisan 2018 liverpool roma maçı
  entry_id:  76322393
  entry_writer: eski zelandali
  entry_fav_count: 35
  entry_content: |
    twitterda biri salah için "best muslim attacker since bin laden" yazmış. güldürdü
  entry_channels: spor
- entry_name: |
    mohamed salah ghaly
  entry_id:  76321443
  ...
  entry_fav_count: 34
  entry_content: |
    bu gece 2 gol daha atarsa secdeye yata kalka yatsının farzını da kılmış olacak.
  entry_channels: spor
- entry_name: |
    abdullah gül
  entry_id:  76291176
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    iyice kafayı yedi adam.<br/>bir parti seçime giremesin diye türlü ayak oyunları yapıp demokrasi ve halk iradesinden bahsediyor. utanmazlığın da bu kadarı.<br/><br/>saçma sapan, sinirden kudurmuş bir kafayla atılan twitlerdir.
  entry_channels: siyaset
- entry_name: |
    bahçeli'nin chp amblemine paslanmış 6 ok demesi
  entry_id:  76321746
  entry_writer: ozgenetikci
  entry_fav_count: 10
  entry_content: |
    terbiyesiz ahlaksız herif. alçak herif.
  entry_channels: siyaset
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    (bkz: <a class="b" href="/?q=b%c3%bct%c3%bcn+s%c4%b1rr%c4%b1+bozdun+yaa">bütün sırrı bozdun yaa</a>)<br/><br/>edit: beyler mesele vw çıkması değil. siz hala anlamadınız mı? motor zaten ortak onu herkes biliyor. motor kapağının dahi maliyet düşünülerek sadece vw olarak üretilmesinden bahsediyor adam.
...
- entry_name: |
    şu anda çalan şarkı
  entry_id:  76295091
  entry_writer: mojo jojo27
  entry_fav_count: 3
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=q1Jddoh3-JE" title="https://www.youtube.com/watch?v=q1Jddoh3-JE">anathema - regret</a>
...
- entry_name: |
  ...
  entry_channels: siyaset
- entry_name: |
    herkesçe güzel bulunan kadının kendini beğenmemesi
  entry_id:  76321761
  entry_writer: return of the kedi
  entry_fav_count: 2
  entry_content: |
    övülmek istiyordur, "yaa olur muuğ şuraların şöyle güzel buraların böyle güzel, herkes kıskanıo" şeklinde (hafifce) övünüz
  entry_channels: anket
- entry_name: |
    sivas'ın ortasında sevişen dayılar
  entry_id:  76322707
  entry_writer: ebced1234
  entry_fav_count: 1
  entry_content: |
    --- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>aman tanrım birbirlerini emiyorlar<br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/>ahahahahaha
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    kadim bir işsiz olarak beni iyice diplere batıran ağ.<br/><br/>bilişim uzmanlarının, psikologların, çevirmenlerin, mühendislerin bile iş arayıp bulamadığı bu dünyada, bu vasıfsız elemana, 'bu solan bahçede bülbüllere yer yok.'<br/><br/>pazar yerlerinde yaşlı teyzelerin, amcaların torbalarını taşımayı düşünüyorum; fıtığım var amk.
