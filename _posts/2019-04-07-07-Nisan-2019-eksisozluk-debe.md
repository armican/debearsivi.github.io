...
data:
- entry_name: |
    ikbal gürpınar'ın attığı tweet
  entry_id:  88591260
  entry_writer: alessio facchetti
  entry_fav_count: 1325
  entry_content: |
    "kimi yalayarak yaşar, kimileri yalamadan yaşar."
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    rte'nin belediye gelirleri ile ilgili açıklaması
  entry_id:  88613608
  entry_writer: wings of jairon invictus
  entry_fav_count: 102
  entry_content: |
    e siz batirmis olmadiniz mi o halde belediyeleri?
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
    ezana kızıp mozart dinletmeye destek vermek
  entry_id:  88604591
  entry_writer: le fougueux
  entry_fav_count: 15
  entry_content: |
    çelişkiye dikkat çekmektir:<br/><br/><a class="b" href="/?q=mozart+dinlemeye+zorlamak+fa%c5%9fistli%c4%9fin+dik+alas%c4%b1d%c4%b1r">mozart dinlemeye zorlamak faşistliğin dik alasıdır</a> deyip ezanı savunmak hem de türkçe ezanı değil de arapça ezanı savunmak çelişkidir. ya ikisini de kabulleneceksin ya da ikisini de hor göreceksin.
  entry_channels: siyaset,anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    antalya dışında çok nadir görülen piyazdır. aslında bu muhteşem lezzeti tüm ülkeye yaymak gerekir. adana kebap nasıl her yerde varsa bu muhteşem piyaz da her yerde olmalı ve herkes tadına bakmalıdır. bunu yiyen bir daha asla adına piyaz denilen haşlanmış fasulyeli çoban salatasını yemez.
...
- entry_name: |
  ...
  entry_id:  88597652
  entry_writer: az otede oynayin
  entry_fav_count: 1
  entry_content: |
    hüseyin sözlünün giderayak festival organizatörü bürokratlarının istifa etmesi ilçe ve il zabıtanın vatandaş ile karşı karşıya bırakıldığı, asıl sorumlu olan kültür daire personelinin ise ortalıkta görünmediği, yeni gelen başkan zeydan karaların kucağına bomba olarak bırakılan “aman olay, sıkıntı olsada sonra fısıltı gazetesi ile dedikodu yapsak” diye düşünüldüğü hemen hemen tüm katılımcılar tarafından emin olunan ve bu yıl yedincisi yapılan, katılımcısı olduğum festival. <br/><br/>trafik falan hikaye, festival şahane! ve yine hemen herkesin ortak noktası “zeydan gelecek sene bunu çok daha iyi yapacak” düşüncesi.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    sayesinde yaşlı teyzelerin aniden bism bismil bismillah dediği gibi kısmen sessiz ve derinden “ulan ne top oynuyor be” zikiri çekiyorum. allah affetsin.<br/><br/>not: gözümün nuru, adanmış hayatların linnesi
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    herkesin ne düşündüğünü bilmem ama bana “keşke buralarda da çalsa...” diye düşündürmüş uygulamadır. <br/><br/>milletin ruhu dinlenirdi, düşünce gücü gelişirdi. <br/><br/>(bkz: <a class="b" href="/?q=klasik+m%c3%bczi%c4%9fin+faydalar%c4%b1">klasik müziğin faydaları</a>)<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://ceotudent.com/bilimsel-aciklamalariyla-klasik-muzik-dinlemenin-5-sasirtici-faydasi" title="https://ceotudent.com/bilimsel-aciklamalariyla-klasik-muzik-dinlemenin-5-sasirtici-faydasi">günümüz sorunlarını çözecek gibi görünüyor.</a>
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    az önce dortmund net bir pozisyonda direği geçemedi ve şimdi hummels kornerde 1-0 öne geçirdi bayern'i. belki de ligin kaderi değişti o pozisyonda.<br/><br/>edit: şimdi de akanji'nin aptalca ötesi hatasını lewa çok güzel bir golle değerlendirdi 2-0.
  entry_channels: spor
---
