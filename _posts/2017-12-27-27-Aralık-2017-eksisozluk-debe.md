...
- entry_name: |
  ...
  entry_fav_count: 71
  entry_content: |
    yemeğe başlamadan tabağın fotoğrafı çekilip sosyal medyada paylaşılmaz.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 66
  entry_content: |
    bir türkiye gerçeği. anadolu'nun her yanından gelen yobaz, çomar istilasına rağmen akdeniz'in incisi olan bu şehrimiz ve insanlarımız geriye kalan 80 ile nasıl medeni olur dersi vermektedirler. bu ne kardeşim rizeli trabzonlu hödüklüğünden gına geldi artık. <br/><br/>hangi mafyatik tipe baksan ya rizeli, ya trabzonlu. mersinliler hiç öyle mi? hristiyan, musevi ve müslüman bireylerin mezarları bile yanyanadır. diğer dinlerden olan vatandaşlar hiç yan gözle bakmaya maruz kalmadan, tacize uğramadan rahatça yaşarlar. bu ülkeyi mersinli insanlar yönetmeli ki insanlar naif ve adil yönetici görsünler.
- entry_name: |
...
- entry_name: |
    ilişkisini kavga çıkartarak yöneten kız
  entry_id:  73071455
  entry_writer: zombi temsilcisi
  entry_fav_count: 58
  entry_content: |
    futboldaki karsiligi <a class="b" href="/?q=fatih+terim">fatih terim</a>'dir.
- entry_name: |
...
- entry_name: |
    kulning'le sürüsünü çağıran isveçli elf çoban kız
  entry_id:  73075415
  entry_writer: ravinrabbid
  entry_fav_count: 49
  entry_content: |
    iki dakikalık video beni adeta <a class="b" href="/?q=orta+d%c3%bcnya">orta dünya</a>'ya götürdü, ve tekrar dönmek istemedim. hepimiz çok önemli işler yapıyoruz, kimimiz bankada piyasanın seyrine yön veriyor, kimimiz inşaat şirketinde binlerce insanın yaşayacağı yapılar inşa ediyor, ama şu videoyu izleyince insan hepsini tekrar sorguluyor.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 33
  entry_content: |
    siz kıvırcık saçlı bir kadının saçlarını taramayı kolay mı zannettiniz? sahibine bile ayak direyen bukleler adama ne yapmaz kim bilir. <br/>romantizminizi düz saçta deneyin :/
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    sanırım 2017 yılına teşekkür ediyor. bir nevi yılbaşı kutlaması gibi.<br/><br/>ayrıca gitmesini benden fazla isteyen dünya üstünde sadece gökhan gönül vardır sanırım.
- entry_name: |
    üsküdar'da 1+1'lerin yasaklanması
  entry_id:  73079788
  entry_writer: sarcastica
  entry_fav_count: 13
  entry_content: |
    üst merciler tararfından 1+1'in, 1 erkek + 1 kadın şeklinde anlaşıldığını düşündüren yasak. <br/><br/>öyle değil olm o. oda sayısı, oda.
- entry_name: |
...
- entry_name: |
    orta açmak &amp; orta yapmak
  entry_id:  73075423
  entry_writer: ortalama insan dusuncesine sahip insan
  entry_fav_count: 12
  entry_content: |
    en doğru tabiri orta kesmektir. özelikle islami usüllere göre kesilen orta daha makbuldur.
- entry_name: |
    koç holding'in çalışanlarına %100 zam yapmaması
  entry_id:  73083960
  entry_writer: mcleod
  entry_fav_count: 10
  entry_content: |
    devlet asgari ücret vermeye devam etsin, ama koç %100 zam yapsın gibi garip bir kafa sahibinin düşüncesi.<br/><br/>devlet çatır çutur vergi toplasın. zamma gelince me.
- entry_name: |
...
- entry_name: |
    bebekli ailelere sinema yapılsın kampanyası
  entry_id:  73067336
  entry_writer: abukkraker
  entry_fav_count: 9
  entry_content: |
    bebekli insanların sosyal hayata katılmalarını sonuna kadar destekliyorum ama bu tarz özel oluşumlara hayır. bebekli ailelere özel sinema, bebekli ailelere özel cafe, bebekli ailelere özel alışveriş merkezi...<br/><br/>dünyada bebeği oldu diye kendini başka bir evrene nakledildi sanan başka bir millet daha yoktur herhalde. bu bayağı doğal bir süreç. doğuyoruz, büyüyoruz, sevişiyoruz, aşkımızın meyvesini dünyaya getiriyoruz... aynı süreç dünyaya gelen için de tekrarlanıyor. bunda ekstrem ve özel muamele gerektiren ne var anlamak hakikaten güç. insanlar el kadar bebeleri ile <a class="b" href="/?q=machu+picchu">machu picchu</a>'ya tırmanıyorlar. çünkü bebek emanete bırakılacak eşya değil. yapıyorsan onu da hayatına entegre etmeyi bileceksin. bebeklilere özel machu picchu'ya çıkan tren talep etsen başka memlekette millet kıçıyla güler. <br/><br/>böyle belirli bir kesime özel bir hizmet talep etmek yerine devletin her semtte gündüz saatlik bakım evleri açması, özel işletmelerde kreş / oyun ablası / abisi zorunluğu gibi sosyal politikaları tartışırsan sana can feda tabi, orası ayrı.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    çay demledim çay içiyorum gece 4 te. bilirsin gece oturmayı ve çayı çok severim. radyo çalıyor uzak yakında. bardağı hüpletiyorum şehir uyurken. önümde ders notları, mandalina kabukları, kurşun kalem....
- entry_name: |
    ekşi itiraf
  entry_id:  73069228
...
- entry_name: |
    şu anda çalan şarkı
  entry_id:  73087824
  entry_writer: asiamaria
  entry_fav_count: 0
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=e8LzTyXGnSQ" title="https://www.youtube.com/watch?v=e8LzTyXGnSQ">deniz üstü köpürür- haluk levent</a>
- entry_name: |
