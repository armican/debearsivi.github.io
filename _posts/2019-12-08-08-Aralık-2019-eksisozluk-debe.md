...
- entry_name: |
    koton'da satılan transparan erkek kazağı
  entry_id:  98785967
  entry_writer: deadgodinme
  entry_fav_count: 252
  entry_content: |
    heykel gibi herif bunu giyince oluyor. sen ben giysek fatih ürek gibi görünürüz.
  entry_channels: moda
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 192
  entry_content: |
    milliyetçi cephenin gazını almak için ayda bir savaş açıyorlar. aynı bokun sarısı.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 90
  entry_content: |
    dünya'nın en soğuk yeri antarktika: -93,2<br/><br/>dünya'nın en soğuk yerleşimi vostok: -89,2<br/><br/>dünya'nın en soğuk şehri yakutsk: -64,0<br/><br/>türkiye'deki en soğuk yerleşim çaldıran: -46,4<br/><br/>türkiye'nin ortalama en soğuk yerleşimi ardahan: -16,9
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 51
  entry_content: |
    çok net haksız rekabet. türkiye futbol tarihinin en iyi yabancı kalecisi.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    7 aralık 2019 galatasaray alanyaspor maçı
  entry_id:  98802901
  entry_writer: mr and mrs brown
  entry_fav_count: 21
  entry_content: |
    manchester derbisi varken niye bu maçı izliyormuşuz, manchester maçı varken sen niye bu başlıktasın onu anlamadım, git o başlığa. <br/><br/>gs’nin 2’yi bulmazsa zorlanabileceği maç.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    172'yim. 30 yaşımı geçtim. şu ana kadar gördüğüm, bildiğim tanıdığım kızların yüzde 90'ı benden minimum 10 cm kısaydı. konu kapanmıştır. dağılın.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    hepsiburada'nın ibretlik deposu
  entry_id:  98805820
  entry_writer: suclu kalem
  entry_fav_count: 15
  entry_content: |
    32'li papia tuvalet kağıdımı göremediğim için gerim gerim germiş fotoğraftır.
  entry_channels: 
- entry_name: |
    hepsiburada.com
  entry_id:  98783205
...
- entry_name: |
    resim derslerinde çizilen ev dere dağ kombinasyonu
  entry_id:  98805610
  entry_writer: ziyaa
  entry_fav_count: 5
  entry_content: |
    gökyüzünde m'den yapmış göçmen bir kuş sürüsü de görülebilir. <br/>yaz kış hep bir yere göçmektedir o kuşlar nereye gidiyorlar hala çözülmemiştir.
  entry_channels: 
- entry_name: |
    7 aralik 2019 manchester city manchester utd maçı
  entry_id:  98802743
  entry_writer: azinlik haklari savunucusu eric cartman
  entry_fav_count: 5
  entry_content: |
    skysport'da maci yorumlayan eski manu sag beki (bkz: <a class="b" href="/?q=gary+neville">gary neville</a>) macin hizi ve temposundan dolayi "boyle bir macta bek olarak oynamak istemezdim" dedi. oyle bir mac.
  entry_channels: spor
- entry_name: |
    sıcak şarap
  entry_id:  98797436
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    ezel dizisinin karakteri hangi soyadi kullanirmis! bunun genel kultur yarismasi oldugundan eminler mi acaba?
  entry_channels: tv
- entry_name: |
    fatih terim
  entry_id:  98804985
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    bir <a class="b" href="/?q=zeki+demirkubuz">zeki demirkubuz</a> filmidir.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    bende almıştım bir tane, karnı doyup ısınınca, elimi ısırıp kaçtı.
...
- entry_name: |
    yazarların yalnızlık nedeniyle gelişen özellikleri
  entry_id:  98801308
  entry_writer: geldimgordumictim
  entry_fav_count: 0
  entry_content: |
    ben çok fena bir şekilde alkol içmeyi öğrendim. ama öyle böyle değil komaya girip çıktım
  entry_channels: anket,ilişkiler
- entry_name: |
    trendyol
  entry_id:  98790011
  ...
  entry_fav_count: 0
  entry_content: |
    <a class="b" href="/?q=black+friday">black friday</a> adı altındaki dandik oluşumdaki en beceriksiz, en yeteneksiz firma. anladık beceremedin sana göre değil <a class="b" href="/?q=olmuyorsa+zorlamayacaks%c4%b1n">olmuyorsa zorlamayacaksın</a> ama tedarik edemediğin ürünün iptal hakkını vermemek ne demek ? bir de utanmadan yardım masası size gelince açmadan iade edersiniz diye akıl veriyor . sağol sana da çok zahmet oldu bende zaten 1 ay beklediğim ürünü hiç bir şey olmamış gibi güle oynaya kabul edecektim . <br/>sizden alışveriş yapan <a class="b" href="/?q=kafama+s%c4%b1%c3%a7ay%c4%b1m">kafama sıçayım</a>
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    telegram grubuna dahil olmak isteyen galatasaraylılar bana mesaj atabilirler. <br/><br/>(bkz: <a class="b" href="/entry/98782563">#98782563</a>)
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    papazınız günah çıkarmanız için online..
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    alanyaspor'un galatasaray'a döşeyeceği boru
  entry_id:  98780659
  entry_writer: viliverr
  entry_fav_count: 0
  entry_content: |
    galatasaray kazanırsa cidden şaşırırım. psg, alanya bunların hiçbir farkı yok şu an gs için. tamamen kaos içinde.<br/><br/>ama net beraberlik diyorum. 0-0, 1-1.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    9 avrupa kupası 9 dunya şampiyonası görüp , kendileriyle karşilaşamadiğimdir.
  entry_channels: ilişkiler
---
