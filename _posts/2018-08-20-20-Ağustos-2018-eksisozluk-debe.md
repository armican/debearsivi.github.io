...
- entry_name: |
    türkiye'nin sovyetler birliği'ne dönmüş olması
  entry_id:  80425524
  entry_writer: drongo cengiz
  entry_fav_count: 84
  entry_content: |
    o zaman sscb'nin sonunu anlatayım da dinleyin<br/>1985 yılında <a class="b" href="/?q=mihail+gorba%c3%a7ov">mihail gorbaçov</a> iktidara geldi.sonrasında sscb'nin düşüşü başladı.önce yenilik ülkeyi eski gücüne kavuşturacağım dedi.sonra <a class="b" href="/?q=ba%c5%9fkanl%c4%b1k">başkanlık</a> görevi tesis etdirdi.kendisi de ilk <a class="b" href="/?q=ba%c5%9fkan">başkan</a> oldu.kendisi gizli bir şekilde batılı devletlerle görüşmeler yaptı ama güya batı kendisine karşıymış gibi bir imaj çizdi.ha bir de kendisine karşı şaibeli bir darbe vardı o darbeyi de yakın adamı b.y(boris yeltsin) engelledi.ama garip tiyatral bir darbeydi.darbe sonrası bir diktatör oldu.sonra ülkeyi federallere böldü.sonra halkına kurşun sıktı.bunu yapmasının da nedeni tarihte kalmaktı.kıps
...
- entry_name: |
    18 ağustos 2018 yeni malatyaspor fenerbahçe maçı
  entry_id:  80412694
  entry_writer: denekadam
  entry_fav_count: 44
  entry_content: |
    volkan demirel'in futbolu bırakması gerektiğini gösteren maçtır.<br/><br/>ahmet çakar'a sonuna kadar katılıyorum: "sevgili volkan demirel. bırak git artık. refleks ve çabukluk bitmiş. tatil yap, çık dağlara... dön yuvana..."
  entry_channels: spor
- entry_name: |
    şenol güneş
  entry_id:  80415014
...
- entry_name: |
  ...
  entry_fav_count: 33
  entry_content: |
    fener sattığı paraya böyle bir oyuncu filan bulamaz yazanlar görüyorum allahım sabır ver...<br/><br/>bak kardeşim bize 10 numara değil 8 numara lazım bir 6 numara ve 2 tane 8 numara oynayacak hoca. anlıyor musunuz ? 4-3-3 hani ? 10 numarasız oynanan taktik hani ? kanser etmeyin gece gece arkadaşlar.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    lpgli araba benzinliden daha hızlı gider
  entry_id:  80421881
  entry_writer: 120sekiz
  entry_fav_count: 28
  entry_content: |
    bu nedenle formula 1 de araclar lpg ye gecilmesi icin yonetime baski yapiyorlar.<br/><br/>ferrari takim sozcusu sadece daha yuksek hiz degil yakit tasarrufu da olacagini. su anda ferrari araclarinin km de 50 kurus yaktigini lpg sistemine gecilmesi halinde bunun 40 kurusa kadar inebilecegini acikladi.
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    gecenin bir yarısı, "bu biran da benden olsun" deyip para yollaması, şerefe kızım demesi altında milyonlarca kez ezilmem.. bunu unutamayacağım baba. yalnız olduğumu bildiğin bu sahilde, özellikle doğum günüm olan bu gecede, olympos'un güzelliği altında sana bir şişe bira kaldırmamı istemeni ömrüm boyunca unutamam. keşke şu an aylarca bana rol yapan adam yüzünden değil de senin için burada olsaydım. <br/>yarın senin için daha güçlü uyanacağım. kafama tüküreyim.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bunu daha önce imzalamamış mıydık?
