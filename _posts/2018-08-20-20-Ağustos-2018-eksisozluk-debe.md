...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    k. kartının asgarisini ödeyip kıt kanaat geçinmek
  entry_id:  80439245
  entry_writer: aminogullari
  entry_fav_count: 76
  entry_content: |
    (bkz: <a class="b" href="/?q=k.kart%c4%b1n%c4%b1n+askerleriyiz">k.kartının askerleriyiz</a>)
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 23
  entry_content: |
    oo siz yeni mi farkına vardınız reis ümmet diyor rabia diyor, ülkece 'yerli ve milli' görevimiz bilumum suri, arap vb. kardeşlerimizi beslemek artık.<br/><br/>welcome to siyasal islam, goodbye turkey..
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    (bkz: <a class="b" href="/?q=19+a%c4%9fustos+2018+adana%27daki+kokuya+ate%c5%9f+edilmesi">19 ağustos 2018 adana'daki kokuya ateş edilmesi</a>)
...
- entry_name: |
    avmlerin boşalmaya başlaması
  entry_id:  80438097
  entry_writer: justfriends
  entry_fav_count: 2
  entry_content: |
    inanmadığım durumdur. bu millette para sıfır olsa da gider yine alışveriş yapar, hiçbir kriz durduramaz bizi. maalesef. bayram öncesinin durgunluğudur o.
  entry_channels: ekonomi
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    şu adama kalmış goztepe kume düşmeye oynar. o kadar vasıfsız bir adamdır kendisi. mariano geri bile dönmez şu an oynanan maçta.
  entry_channels: spor
- entry_name: |
