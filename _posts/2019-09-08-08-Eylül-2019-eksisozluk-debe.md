...
- entry_name: |
  ...
  entry_fav_count: 107
  entry_content: |
    insanların kendisi için uğraşıp zahmet etmesini istemeyen ve daha önce de çokça bahsedildiği gibi ilgi odağı olmayı sevmeyen insandır.<br/><br/>yaklaştıkça beni kendi içimde sıkıntıya sokan gündür doğduğum gün.
...
- entry_name: |
  ...
  entry_fav_count: 30
  entry_content: |
    sabah 8:30 daki uçuş için bi saat önce havaalanına gittik. yurtdışı uçuşu. ne kadar erken gitmek gerekir bilmiyorum, cahillik, tecrübesizlik :)<br/><br/>check-in de sira bana geldi, eleman dedi,<br/><br/>- "ekonomide yer kalmamış " <br/><br/>overbook olayini bilmiyorum tabi. <br/><br/>- "ne demek yer kalmamış biletim var benim, bi ton para verdim, napcam ben şimdi?!" diyorum.<br/><br/>eleman gayet sakin, <br/><br/>- "size business'tan yer vereceğiz " dedi<br/><br/>şaşırdım, rahatladım, sevindim :)<br/><br/>geçtim uçağa, oturdum yerime. önce şu kaynar sudan çıkardıkları minik havlulardan dağıttılar. hayatimda görmemişim duymamışım, bakiyorum öyle napiyo bu diye. maşa gibi biseyle bıraktı önümdeki tabağa. dumanı tütüyor hala. etrafimdakilere baktim, alıp yüzlerine koyuyolar. içimden diyorum manyak bu business kismisi, surati yanacak hepsinin. ama hiçbirinde çıt yok, gayet memnunlar. uydum hemen racona, havluyu suratıma atmamla bütün benligimin eriyerek yere yığılması bir oldu :) o nasıl bi rahatlamadir öyle:))) dedim zenginlik böyle bisey heral. <br/><br/>10 dk sonra hostes bi tur döndü, menü bıraktı herkese. sonra geldi, ne içersiniz dedi. menüde direkt dikkatimi çeken, şampanya. tabi saat hala sabah, 9 ya var ya yok. dedim ben şampanya rica ediyorum. ilk şampanyami sabahin köründe içmiş oldum :)<br/><br/>değişik bi tecrübeydi vesselam :)
  entry_channels: havacılık
- entry_name: |
    ebrar karakurt
  entry_id:  95036476
  entry_writer: mevzumu var
  entry_fav_count: 30
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    hiç kimsenin acısını küçümsemeyin çünkü gerçekleri bilmiyorsunuz.
  entry_channels: anket,edebiyat
- entry_name: |
    1.50 boyuyla 1.83 boyundaki erkeği reddeden kız
  entry_id:  95013512
  entry_writer: ocean ocean
  entry_fav_count: 9
  entry_content: |
    ayaktayken de görüşebileceği birini istiyordur.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
    7 eylul 2019 khabib nurmagomedov vs dustin poirier
  entry_id:  95034799
  entry_writer: drogbari
  entry_fav_count: 8
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="http://notes.io/7wMn">http://notes.io/7wmn</a><br/><br/>bu notta yazan tüm linkleri şikayet edin arkadaşlar. ben böyle bir rezillik görmedim, işim olmasa ben şikayet ederdim inanın.<br/><br/>edit: @birdokuzsifir7 adlı yazara teşekkürler bu arada
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    bir anket.<br/><br/>benim için kaliteli caz, klasik müzik ve rock parçaları yayınlayan <a class="b" href="/?q=trt">trt</a> <a class="b" href="/?q=radyo+3">radyo 3</a>’tür. gün içinde çeşitli saatlerde tatlı haber bültenleride yaparlar.
  entry_channels: 
- entry_name: |
    7. koğuştaki mucize
  entry_id:  95002403
  ...
  entry_fav_count: 3
  entry_content: |
    bizimkiler ağlamayı sevdiği için bizim millete hitap eder. elalem gülmeye, bizimkiler ağlamaya gider sinemaya.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    tamamı türkiye'de pahalı olan ürünlerdir. dolayısıyla sebebi de yüksek vergiler+döviz kurudur. bunu hala anlayamayan binlerce insan olması üzücü. gerçekten anlayamıyor musunuz yoksa salak taklidi mi yapıyorsunuz?
  entry_channels: anket,teknoloji,yeme-içme,moda,ekonomi
- entry_name: |
    sevgilisinin cep telefonunu karıştırmayan kadın
  entry_id:  95035528
  entry_writer: dilaralar
  entry_fav_count: 1
  entry_content: |
    yeterince sevmiyordur , severse öyle yapamaz.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    tam bir kaptan. polonya maçında takımın modu inanılmaz düşmüşken ebrar ile birlikte ayakta kaldı ve bütün takımı da ayağa kaldırdı.<br/><br/>hastasıyız.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    8 eylül 2019 türkiye sırbistan final maçı
  entry_id:  95039032
  entry_writer: başlık taşıyan
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=8+eyl%c3%bcl+2019+t%c3%bcrkiye+s%c4%b1rbistan+voleybol+ma%c3%a7%c4%b1">8 eylül 2019 türkiye sırbistan voleybol maçı</a>)
  entry_channels: 
---
