...
- entry_name: |
    18 ocak 2018 pentagon açıklaması
  entry_id:  73577666
  entry_writer: umdugunu bulamayan misafir
  entry_fav_count: 75
  entry_content: |
    başka bir deyişle şunların gazını alalım da sonra devam ederiz açıklaması <br/><br/>huylu huyundan vazgeçmez ne de olsa
- entry_name: |
    meral akşener
  entry_id:  73578382
...
- entry_name: |
  ...
  entry_fav_count: 30
  entry_content: |
    istanbul' da önce gençlik kolları, sonra kadın kollarında çalışmış bir chp' li olarak söylüyorum ki; yerinde gördüm, içinde yetiştim bunlardan bir halt olmaz. <br/><br/>eski bdp, hadep, ödp, emep.. vb kim varsa orda... hepsi iş buluruz derdinde "katlanıyorlar" chp' ye!! atatürk' ümüzün partisine biz sahip çıkmadığımız için il başkanlıklarina kadar çıkıyorlar işte!<br/><br/>sonra bu adamlar, kadınlar çıkıp chp adına, atatürk ile ilgili açıklamalar yapıyor, bizde izliyoruz böyle!
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="http://www.spk.gov.tr/SiteApps/Yayin/YayinGoster/1130" title="http://www.spk.gov.tr/SiteApps/Yayin/YayinGoster/1130">spk raporu</a>nda şöyle diyor:<br/><br/>3) bitcoin balon mudur veya bir tür saadet zinciri midir ?<br/>bitcoin kaldıraç etkisiyle işlem görmez, satın alınması tam finansmanla olur, bu sebeple balon değildir. bitcoin'in sahibi yoktur, fiyatı tamamen piyasa koşullarında belirlenir, fiyatındaki oynaklık sebebiyle kar veya zarar edilmesi önceden tahmin edilemez. bu sebeplerle, bir tür saadet zinciri de (ponzi scheme) değildir.<br/><br/>ponzi diyenler spk ile iletişime geçip adamları aydınlatsa iyi olur. yazıktır, keriz gibi paralarını kaptırmasın adamlar şimdi. <br/><br/>ayrıca (bkz: <a class="b" href="/entry/73530301">#73530301</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    en fazla babasının mahalle arası telefon bayiinde kasada durabilecek bir arkadaşın ceo olduğu hadise. yahu gerçekten, şu fadıl'a para kaptırana bile bir kılıf buldum anlamaya çalıştım falan da, şu arkadaşın fotoğrafına bir kez bakıp para gönderen adamı hakikaten çözemiyorum. nasıl hayatlarınız var lan?
- entry_name: |
...
- entry_name: |
    kötülerin eline geçmemesi gereken makamlar
  entry_id:  73590017
  entry_writer: muhammed kohen
  entry_fav_count: 3
  entry_content: |
    muhalefet partisi liderligi. 2'si de hem de.
- entry_name: |
...
- entry_name: |
    türk kadınlarının seks yapmayı becerememesi
  entry_id:  73590261
  entry_writer: desade
  entry_fav_count: 1
  entry_content: |
    hayret, onca kadınla birlikte oldum bir tane bile seks yapmayı beceremeyene rastlamadım.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    hayattan beklentileri farklı olan iki insanın durumu oturup birbirini anlaması sırasında kurulabilecek bir cümle.<br/><br/>birisi, erkek ya da kadın, evlenmek istiyordur, çocuk sahibi olmak istiyordur, yurt dışında yaşamak istiyordur ya da taşraya taşınmak istiyordur, hiç fark etmez, bunu sevgilisine söylemek durumunda. sevgilisi durumu tartıp devam edip etmeme kararı alabilir. <br/><br/>eğer birbirlerini çok seviyorlarsa bir orta yol bulunabilir, ya da taraflardan birisi durumu kabullenebilir. gözlemim durum kabullenmenin genellikle toplumsal baskı yönünde olduğuna işaret ediyor ama sevdiği için evlilik ya da çocuk hayalinden vazgeçmiş insanlar da görüyorum. yok taraflardan birisi o kadar da bu ilişkiye devam etmek istemiyorsa diğer taraf daha az oyalanmış olur.<br/><br/>ben burada abes bir durum görmüyorum. şimdi bırakın kendi doğrularınızı başkalarına dayatmayı
- entry_name: |
    bitconnect
  entry_id:  73587386
