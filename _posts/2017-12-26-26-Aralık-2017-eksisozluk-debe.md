...
- entry_name: |
    sigaraya 12 tl verip et fiyatları pahalı demek
  entry_id:  73050479
  entry_writer: biyolojik saat tamircisi
  entry_fav_count: 608
  entry_content: |
    sigara da et de pahalı.<br/>oldu mu yalnız mühendis bey.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 248
  entry_content: |
    (bkz: <a class="b" href="/?q=sudan+ucuzmu%c5%9f">sudan ucuzmuş</a>)<br/><br/>ekşi sözlük böyle böyle bitiyor işte.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 159
  entry_content: |
    maketi bile putlaştıran zihniyete diyecek bir şey yok. cahiliyet kanser hücresi gibidir.
- entry_name: |
...
- entry_name: |
    izmirlilerin çoğunun aslında izmirli olmaması
  entry_id:  73050503
  entry_writer: genckartal301
  entry_fav_count: 124
  entry_content: |
    yıllar yılı izmirli diye bildiğimiz bir bayan arkadaşın düğününde fark ettiğim olay. <br/><br/>ben doğu akdenizli olarak halay falan severim düğünlerde. ama ülkenin batısında halay kültürü çok az. bu yüzden düğünde oynamayı seven birisi olsam da batıdaki düğünlerde tam performans sergileyemiyorum swh. neyse bizim izmirli'nin düğüne bi gittik paso şemmame, üç ayak, delilo, halebi falan çalıyor. acayip halay oldu düğünde. meğersem yıllardır bize çiğdem, boyoz, 35,5 aaağbi diyen arkadaşımız aslen karslıymış. kız öyle davranıyor ki dedesi yunanlıları bizzat kovalamış falan sanıyorsun. ama gel gelelim kız karslı çıktı abi.
- entry_name: |
...
- entry_name: |
    25 aralık 2017 izmir depremi
  entry_id:  73049258
  entry_writer: hasirt to the blackboard
  entry_fav_count: 26
  entry_content: |
    kahvaltıda yakalandığım deprem.<br/>istifimi bozmadım; deprem nasılsa biterdi, önemli olan kahvaltıydı.<br/><br/>ölmek kötü, aç ölmek daha da kötü.
- entry_name: |
    bitcoin
  entry_id:  73046711
...
- entry_name: |
    25 aralık 2017 şok market rezaleti
  entry_id:  73059294
  entry_writer: ayka
  entry_fav_count: 13
  entry_content: |
    az önce kardeşimle birlikte yaşadığımız rezalettir. kardeşimle birlikte bir adet ufak yoğurt ve mandalina almamızın ardından kasaya gittik ödemeyi yapacağız. mandalinayı tartarken kasada bir şeyler oldu, daha sonra kurcaladılar vs. mandilanayı tarttılar. 1440 gr mandilina ve ufak yoğurdun ödemesini yaptık. kardeşim mandalinanın gramajından şüphelendi ve yan markete gitti. orada tarttılar. 1140 gr çıktı. iade etmeye gittiğimizde market müdürü kasalarında problem olmadığını söyledi. biz yinede iade etmek istediğimizi söyledik. buraya kadar pek can sıkıcı değil.<br/><br/>iş tam burada kopuyor. ben bu markete 4-5 ay önce iş başvurusunda bulunmuştum. ardından aylar geçti haber filan çıkmadı. neyse bu çalışan bunun gramajından şüpheliyim iade istiyorum dediğim anda yaran mı var gocunuyorsun dedi.<br/><br/>yahu arkadaş benim iş başvurusu yaptığım 4-5 ay olmuş. sürekli alışveriş yapıyorum bir gün bile lafı geçmemiş. sen hatanı kabul etmemek için nasıl böyle bir kelimeyi kullanırsın. ayıptır arkadaş. en az 10 kişinin arasında böyle laf mı edilir.<br/><br/>bu arada kendimden bahsedeyim biraz 26 yaşındayım. üniversite uzadı. ailemin yanında kalıyorum. biraz destek olmak başvuruda bulunmuştum. sonra unutuldu gitti. insan kendi hatasını kabul etmemek için yaran mı var gocunuyorsun kelimesini kullanmamalı.<br/><br/>edit: bu lafı söyleyen marketin müdürü ayşen adında bir çalışanmış. yer ankara/polatlı mehmet akif mahallesi şok market.<br/><br/>edit2: gramaj üzerinden espri yapan arkadaşlar var aslında işin buralara gelmesinin sebebi gramaj olsa da mevzu yaran mı var gocunuyorsun nezaketsizliği üzerine genişledi.
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  73044246
  entry_writer: ainothia
  entry_fav_count: 2
  entry_content: |
    (bkz: <a class="b" href="/?q=s%c3%b6zl%c3%bck%c3%a7%c3%bclerin+stadyumda+izledikleri+ilk+ma%c3%a7">sözlükçülerin stadyumda izledikleri ilk maç</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    20 lira bu yaratıklara vermiyorum, ne yapıyorum, 25 lira gibi bir paraya 400 gr (2 adet) antrikot kestiriyorum..<br/><br/>atıyorum tavaya, on numara mühürlüyorum.. bi tane de pattis kızartıp, tv de de, netflix i açıp, afiyetle gömüyorum afedersin..
- entry_name: |
    çukur
  entry_id:  73062965
  ...
  entry_fav_count: 1
  entry_content: |
    <a class="b" href="/?q=spoiler">spoiler</a><br/><br/>10. bölüm itibarıyla vartolu'nun god mode on girip yardırdığı dizidir.<br/><br/><a class="b" href="/?q=spoiler">spoiler</a>
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    akrabalarımın hepsi gerizekalı. ben de galiba çok zeki değilim.
- entry_name: |
    aile arasında
  entry_id:  73050431
  ...
  entry_fav_count: 0
  entry_content: |
    gülse birsel'in oynadığı karakteri çok itici bulup laf söyleyenler olmuş (bkz: <a class="b" href="/?q=swh">swh</a>) amaç zaten itici bir kadın oynamak. bunu anlamak zor mu
---
