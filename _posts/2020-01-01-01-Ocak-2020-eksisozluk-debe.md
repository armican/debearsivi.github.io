...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    lütfen o deliğe sokma diyen kadın iticiliği
  entry_id:  99881333
...
- entry_name: |
  ...
  entry_fav_count: 59
  entry_content: |
    eskişehirspor'un eski hırvat kalecisi ivesa<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://ibb.co/XF1LLMv">https://ibb.co/xf1llmv</a>
...
- entry_name: |
  ...
  entry_fav_count: 36
  entry_content: |
    --- <a class="b" href="/?q=al%c4%b1nt%c4%b1">alıntı</a> ---<br/><br/>yoksa, toplama kamplarında kalanlardan ölenler olduğu doğrudur.<br/>--- <a class="b" href="/?q=al%c4%b1nt%c4%b1">alıntı</a> ---<br/><br/>yapma ya? hakikaten mi? sağol be...<br/><br/>ciddi ciddi böyle yazmış adam. istersen almanların musevi tatsızlığı diye tanımla olayı. <br/><br/>insanlıktan nasibinizi almamışsınız.
...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    universitenin ne oldugunu bilmeyen, ogrencilerin nerelerden geldiklerini bilmeyen, hayatinda universite kapisindan girmemis, ya da derslik kantinden baska etrafini gozlemekten aciz adamlar burada kizimin yemegi 10 tl yea bu ne diye kisnek kisnek yazanlar var.<br/><br/>ıhtiyaci olan kahvaltiyi ihtiyacindan okulda yapar yoksa cikar acik menu limitsiz kahvalti yapmayi bilir insanlar.<br/><br/>cahil adamlar baslamis zirvalamaya yine. okulda dersi bitse bile yokluktan 5 saat yemek saatini bekleyen ogrenciler biliyorum ben. salak salak konusmadan once dusunun sonra yazin. aptalligin alemi yok. amac kar etmek degil bazi harcamalarda kar amaci gudulmez bunu bilmiyorsaniz zaten ot saman gibi yasiyorsunuz. okul bundan kar etmez zaten ustune para oder ogrencinin verdigi ucret uzerine yemek sirketine. bu arada universiteyi de uzun yillar once bitirdim disarida da yemek yedim okulda da yemek yedim. bazen ihtiyaci olanlarin yemege erisebilmesi icin ozellikle yemekhaneye gitmedim cunku yemek kalmadigi zamanlar oluyordu. <br/><br/>bos yapmayin. cocuklarin yedigi ogune laf edecegine meclisteki yemeklerin fiyatina edin.
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    (bkz: <a class="b" href="/?q=ben+anlatam%c4%b1yorum+sen+anla">ben anlatamıyorum sen anla</a>)
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    dimes'in %100 meyve suları hepsinden üstündür.
  entry_channels: anket,yeme-içme
- entry_name: |
    yalnızlık
  entry_id:  99844973
  ...
  entry_fav_count: 5
  entry_content: |
    aşkın arzuları beni boğsa da,<br/>birgün seversin diye bekleyeceğim.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    felsefeci olan kız kendini tüm türkiye'ye ne güzel rezil ediyor vallahi.<br/><br/>kızım okuma sen boşver.<br/>kendini nerede bulduysan tam bulamamışsın.<br/><br/>akşama kadar sofi'nin dünyasını mı okuyorsunuz. insanı oturduğu yerden sinirlendiriyorsunuz ya.
  entry_channels: tv
- entry_name: |
    30 yaşından sonra enstrüman çalmaya niyetlenmek
  entry_id:  99853940
  entry_writer: composer
  entry_fav_count: 5
  entry_content: |
    yukarıdaki yazarın, çalgı çalmak ile kasları ilişkilendirip insanları yanlış yönlendirmesi üzerine konuya açıklık getirmek isterim. kesinlikle saçma ve yanlış bir önermedir. müzik aleti çalmak veya müzik yapmak tamamen bilişsel zeka ürünü ve onun uzantısı olan sinir ağı ile mümkündür. kas ezberi diye nitelendirilen şey aslında sinirsel monotonluk veya alışkanlığıdır.<br/>avrupa’da (ilk olarak almanya’da) ve dünyada bir çok sanat laboratuvarları kurulmuştur ve araştırmalar sonucu; müzik aletleri çalmak tamamen bilişseldir, fiziksel yatkınlık artı teknik bir yere kadar önemli. (kaynağı editleyip koyarım)<br/>yani, yaşınız ne olursa olsun gün içinde hangi elinizi (sağ-sol) daha çok kullandığınızın bir önemi yok. piyanoya veya başka bir çalgıya başladığınız andan itibaren mucize gerçekleşir, beyin kısa bir sürede yeni bir sinir ağı inşa ederek bu yeni duruma kolaylıkla adapte olmanızı sağlar.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    eskilerin anlattığı bir rivayete göre kıyamet, hadise'nin seks kasedi çıkınca kopacaktır.<br/><br/>t: seksi şey.
