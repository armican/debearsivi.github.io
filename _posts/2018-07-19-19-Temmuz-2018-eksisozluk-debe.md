...
- entry_name: |
    kawhi leonard
  entry_id:  79298170
  entry_writer: at kulagina konan kelebek
  entry_fav_count: 44
  entry_content: |
    artık siktir olup gitse de şanlı spursumuz ile bağı kalmasa dediğim kürek. umarım toronto soğuğunda araban çalışmaz sabahları da it gibi titreye titreye metrobüsle antrenmana gidersin terbiyesiz.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    takımda forvet olmadığını bilmeyen sığırların "cocu defansif, forvetsiz çıkıyor" diyerek algı kastığı maç. bir de şike diye ağlamış ya kıyamam.
  entry_channels: spor
- entry_name: |
    dökme demir tava
  entry_id:  79304538
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    -sadece bana diktatör diyenleri hapse atmayıp "bak, diktatör olsam bunu diyebilir misin?" demek.
  entry_channels: siyaset,anket
- entry_name: |
    otobüsteki ahlak bekçisi dayı
  entry_id:  79312013
  entry_writer: mehin
  entry_fav_count: 5
  entry_content: |
    bin kere söylense de şu iki hata hep yapılıyor. öncelikle kadının dizinin kaç cm üstünde etek giydiğinin önemi yok. bunu özellikle belirtmek, bakın aslında etek çok da kısa değildi demek oluyor. etek 10 cm kısa olsa bu tacizi, laf atmayı vs. meşru mu kılacaktı? bu açıklamayı yapınca o saatte dışarıda tek başına ne işi varmış diyen kişiye benziyorsunuz . ikinci olarak da şu tipleri dayı diyerek normalleştirmeyin lütfen. bu adam potansiyel sapıktır, tacizcidir, kadına psikolojik şiddet uygulamıştır. ne yazık ki erkeklerin çoğu, kadınların da azımsanmayacak bir kısmı daha somut bir şey olmadıkça (elle taciz, tecavüz, şiddet vs.) bu gibi durumları görmezden geliyor, önemsemiyor. tacize uğramış olmak ya da kadın olmak gerekmiyor empati yapabilmek için, bu da böyle biline.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    insanlar uyum sağlamak için biraz değişmeli. ben değişmem sen değiş denilirse ona ilişki diyemeyiz zaten.
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    guzel bacaklara sahip oldugunu bilip kisa etek giyen bir kadinla ayni amaclari vardir.<br/><br/>her varlik guclu yanini one cikarir.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    tam olarak neye baktığınızı söyleyin de biz de rahatlayalım siz de. ama kariyer yaparken bi yandan da enstrüman çalsın sosyal olması çok önemliii gibi yemek tarifi gibi bişey olmasın. <br/><br/>ben açık açık söylüyorum kadında güzelliğe&amp;çekiciliğe bakarım. kariyeri olmayan bir kız arkadaşım vardı ama kız güzeldi. gayet de memnundum kendisinden. kariyerli olan ama beğenmediğim kızdan bi süre sonra nasıl ayrılırım diye düşünmeye başladım. kişisel bakımınıza kıyafetinize saçlarınıza bakarsanız beni tavlarsınız.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    whatsapp grubu varmi? benide araniza alabilirsiniz.
  entry_channels: anket,ilişkiler,ekşi-sözlük
---
