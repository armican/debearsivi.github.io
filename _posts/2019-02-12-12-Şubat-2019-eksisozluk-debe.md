...
- entry_name: |
    fenerlilerin başakşehir e yenilmek istemesi
  entry_id:  86550849
  entry_writer: bordon
  entry_fav_count: 200
  entry_content: |
    lan sanki fark atmak istese başarabilecek amk.
  entry_channels: spor
- entry_name: |
    2019 ekonomik krizi
  entry_id:  86556493
...
- entry_name: |
    bir erkek için ağlayan kadın
  entry_id:  86545384
  entry_writer: alain badiou
  entry_fav_count: 4
  entry_content: |
    insan yitip giden için ağlar. yaşamdan bir parça kopmuştur sonuçta. fakat, hırsından ve nefretinden ağlayanları ayrı tutmak gerekiyor. "ben nasıl terk edilirim" ezikliği de ağlatır insanı, ki bu en tehlikelisidir. boğazınıza çöktüğü an kahkahaya dönüşebilen bir ağlayıştır bu.
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    başakşehir gibi kancıklık yapmayıp ülkeye puan kazandırmaya çalışan galatasarayımla sevgililer gününde tt arena'da buluşacağımız maç.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    4 ya da 5 dönüm arazi. zeytin, yaban mersini üretimi. ufak bir taş ev. sağ omzumda eşim, sol omzumda çocuğum. <br/><br/>yaşlanıyorum sanırım.
  entry_channels: anket
- entry_name: |
