...
- entry_name: |
  ...
  entry_fav_count: 78
  entry_content: |
    ulan 24 haziran öncesi de böyle dediniz içimiz umut doldu akşamına bütün umutlarımız söndü. bu sefer hiçbirşey umut etmiyorum ben.<br/>görecekseniz o kadar krize, devalüasyona rağmen bu halk gidip gavura vurur gibi mühürü akpye mhpye basacak.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 47
  entry_content: |
    biz kızlarımıza hep güvendik.<br/>ama sokaklar, insanlar kötüydü.<br/>seni unutmadık. unutmayacağız.<br/>üzerinden 4 sene geçmiş ama değişen hiçbir şey yok...
  entry_channels: haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 25
  entry_content: |
    kendisini maicon veya servet'e benzetenler ya maç seyretmiyor ya da hafıza problemleri var. <br/><br/>ilk yarıdaki 4-0 kaybettiğimiz trabzon maçında nwakame, mariano - maicon ikilisinin içinden geçmişti. dünkü maçta luyindama nwakame ile 3-4 pozisyonda bire bir kalmasına rağmen hiç fırsat vermedi. <br/><br/>benim görebildiğim kadarıyla standart altı denilebilecek hiçbir özelliği yok. fizik gücü, temaslı oyun, hava üstünlüğü çok iyi; tekniği stoperlere göre standardın biraz üstü, hızlı veya çabuk sayılmaz ama ne ağır ne de hamleleri maicon kadar falan yavaş değil. <br/><br/>sıkıntı hamle zamanlamasında. bazen geç bazen erken davranabiliyor, zaman zaman yerini kaybediyor veya yanlış duruyor ama o kadar olur. <br/><br/>bizim gibi takımların 9/10'luk genç stoper yakalaması mümkün değil. örneğin marcao ve luyindama 7/10'luk oyuncular diyelim. birlikte ve beklerle uyumları, takım savunmasının gelişimi ve önlerinde daha iyi bir orta sahayla 8-8.5 seviyesine çekebilir miyiz buna bakmak lazım. ona da bu sezon karar veremeyiz bence. önümüzdeki sezon başlasın ancak öyle anlaşılır. bence bu ikili için daha çabuk, hareketli bir 6 numara bulmak gerekecek. donk veya fernando'nun hem ağır hem de düşük dinamizmli olmaları üstüne alan tutma sıkıntısı yaşamaları stoper ikilisini de olduğundan kötü gösteriyor ve zor duruma sokuyor.
  entry_channels: spor
- entry_name: |
    atmnin verdiği parayı saymak
  entry_id:  86566737
  entry_writer: nimda
  entry_fav_count: 25
  entry_content: |
...
- entry_name: |
  ...
  entry_content: |
    çalınan taç
  entry_channels: spor,anket,sinema,haber,magazin
- entry_name: |
    temizlik ürünlerine de gireceğiz
  entry_id:  86557115
  entry_writer: silinen yazar
  entry_fav_count: 23
  entry_content: |
    ben ilgili linki açamadım ama devlet akaryakıt ve genelev işine de girerse oyum akp ye amk.
  entry_channels: siyaset,ekonomi
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    uefa eleme turu ilk maçı. herkesin kendi takımına bakması elzem olan maç.<br/>fenerbahçe çıkar oynar oyununu. turu verir veya alır önemli değil.<br/>başlığına uğramıyormuşuz? amk troll'ü, tuttuğu takım bile belli değil.<br/>son 20 entrysinden 15 fenerbahçe ile alakalı laf konuşuyor burada.<br/>lan bi siktir git!!
...
- entry_name: |
  ...
  entry_channels: anket,teknoloji
- entry_name: |
    galatasaray şampiyon olacağına başakşehir olsun
  entry_id:  86560015
  entry_writer: sesver
  entry_fav_count: 14
  entry_content: |
    <a class="b" href="/?q=k%c3%b6pekler+istedi+diye+atlar+%c3%b6lmez.">köpekler istedi diye atlar ölmez.</a><br/><br/>bir rumen atasözü.
  entry_channels: spor
- entry_name: |
    izmir satılık yalıdaki ilginç heykel
  entry_id:  86566390
  entry_writer: uberallessuperfantastik
  entry_fav_count: 13
  entry_content: |
    heykeli geçtim de milyon liralık yalının tuvaleti gecekondu tuvaleti gibi. heykel de tüy dikmiş gibi olmuş biraz.
  entry_channels: haber,ekonomi
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    birkaç gün önce ''günün rap sözü'' başlığında 24 adlı parçasının nakaratının bir bölümünü paylaşmıştım. tam 16 yıl sonra bu şarkıyı tekrar seslendirmesi hem duygulandırmış hem de çok mutlu etmiştir. çok yaşa sen güzel adam...
...
- entry_name: |
    11 şubat 2019 lucescu'nun görevi bırakması
  entry_id:  86561908
  entry_writer: trnntkrng
  entry_fav_count: 6
  entry_content: |
    tff'nin yaptigi 120. hatadan donme olayi. herkesi gonderirler ama kendileri kalir.
  entry_channels: spor,haber
- entry_name: |
    şenol güneş
  entry_id:  86561608
  ...
  entry_fav_count: 4
  entry_content: |
    mayısa şurda 3 ay kaldı. <br/><br/>kimse tepki çekmek istemez. milli takımı muhtemelen 1-2 ay başkası çalıştırır. tayfur havutçu vs <br/><br/>şenol güneş 2 senedir bir kez olsun "benim tek hedefim beşiktaştır" demedi. diyemedi. sürekli lafı eveledi geveledi. <br/><br/>"kovmazlarsa gitmem, gidersem sadece milli takıma giderim, taraftr beni çok sahiplendi ondan kalırım, gitmek için bir şey yapmadım, kalmak için çok şey yaparım, milli takıma gitmek isterim ama ben trabzonsporlum ama beşiktaş taratarı beni sever onları üzmem ama milli takım vs vs "<br/><br/>bütün açıklamaları böyle. 2 kez gitti tüpçüyle birebir görüşme yaptı. yani hiç öyle hocanın ayağını kaydırıyorlar durumu yok kimse kusura bakmasın. <br/><br/>bu söylentilerin ana kaynağı şenol güneştir. <br/><br/>tıpkı fikret orman-şenol güneş kavgası var söylentisini ilk şenol güneşin çıkarması gibi. <br/>tıpkı negredo-şenol gerginliğinin ilk şenolun açıklaması gibi<br/>tıpkı tolgay-şenol gerginliğini ilk şenolun açıklaması gibi. <br/><br/>bütün söylentileri şenol güneş çıkartıyor. kimse bi yerden uydurmuyor. bir kez olsun hayır kardeşim milli takım konusu gündemimde asla yoktur, ben beşiktaş hocasıyım ve tek hedefim burasıdır demedi. di-ye-me-di. <br/><br/>dediğim gibi muhtemelen mayısa kadar milli takımı tayfur vs çalıştırır. hoca imzasını mayıs sonrası için gidip atar bu hafta. <br/><br/>beşiktaşı lig 3. ya da 2. olarak bırakıp çeker gider.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    sözlüğe entry girilmemeli.
  entry_channels: 
- entry_name: |
    yaşını 100 ile çarp maaşına böl
  entry_id:  86565202
  entry_writer: başlık taşıyan
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=ya%c5%9f%c4%b1+100+ile+%c3%a7arp%c4%b1p+maa%c5%9fa+b%c3%b6lmek">yaşı 100 ile çarpıp maaşa bölmek</a>)
  entry_channels: siyaset,anket,ekonomi
- entry_name: |
    türk kızlarının spor yapmama sorunsalı
  entry_id:  86567511
  entry_writer: budenmayer
  entry_fav_count: 0
  entry_content: |
    tartismaya acik olmayan bir mevzudur. sorunsalligini bilemem ama turk kadinlari turk erkeklerinin 10'da biri kadar spor yapmayan bir topluluktur. bunu zengin fakir farketmeksizin spor salonlarindaki erkek kadin oranlarina gore tespit edebilirsiniz kolaylikla. 10 sene kadar bir ozel universitede bulundum. cok kere de spor salonuna gittim. hicbir zaman kadinlar erkeklerden fazla degildi salonda. oyle bir an o spor salonunun tarihinde olmamistir. <br/><br/>yurt disinda da bircok yer gordum. kadin-erkek bircok kisi spor yapiyor. ve eger kadinlar mi erkekler mi daha cok yapiyor diye sorulsa muhtemelen kadinlar derim. 51-49 falan. hic oyle cinsiyetle baglantili degil buralarda bu is. turk erkekleri gercekten dunyadaki en talihsiz topluluklardan birisi.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    son günlerde bolca izlediğim/izlettiğim <a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/Gtzp6W9VzMY" title="https://youtu.be/Gtzp6W9VzMY">şu</a> videodur.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    sohbet etmek ve dertlesmek amacli insanlarin entry girdigi baslik.<br/>sözlük yazar ve okuyucularının kullandığı bir sohbet kanalımız var. kapımız saygı duymak kelimesini bilerek sohbet akışına ayak uydurabilen herkese açıktır. <br/>+25 yaş.<br/><a rel="nofollow noopener" class="url" target="_blank" href="https://discord.gg/7eer3xr">https://discord.gg/7eer3xr</a>
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    11 şubat 2019 çekmeköy helikopter kazası
  entry_id:  86568839
  entry_writer: başlık taşıyan
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=11+%c5%9fubat+2019+%c3%a7ekmek%c3%b6y+askeri+helikopter+kazas%c4%b1">11 şubat 2019 çekmeköy askeri helikopter kazası</a>)
