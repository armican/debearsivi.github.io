...
- entry_name: |
    ekşi sözlük'ün 40 milyona demirören'e satılması
  entry_id:  86541734
...
- entry_name: |
  ...
  entry_fav_count: 407
  entry_content: |
    <a class="b" href="/?q=%c3%a7ocuk">çocuk</a> öldüren bir kadının idamıdır.<br/>öyle fazla duyar kasmaya gerek yok.<br/><br/>not: idam konusu tartışılır ama olaylar dönemine göre değerlendirilmelidir.
...
- entry_name: |
  ...
  entry_channels: siyaset,haber,yeme-içme,ekonomi
- entry_name: |
    beynin bir parazit olması
  entry_id:  86545257
  entry_writer: limitsiz karakter iceren nick
  entry_fav_count: 263
  entry_content: |
    (bkz: <a class="b" href="/?q=hayat%c4%b1n+cinsel+yolla+bula%c5%9fan+bir+hastal%c4%b1k+olmas%c4%b1">hayatın cinsel yolla bulaşan bir hastalık olması</a>)
  entry_channels: bilim
- entry_name: |
    medyumla cinsel ilişkiye giren öğretmen
  entry_id:  86539759
  entry_writer: inflexibleuser
  entry_fav_count: 260
  entry_content: |
    oğlan haklı. annesinin kim bilir başka ne salakliklari vardı ki dayanamamış kaçmış.
...
- entry_name: |
  ...
  entry_fav_count: 110
  entry_content: |
    başlık sahibinin diğer entrilerine baktım ve buram buram negatif enerji salan bir insan. kendisinin çok mutsuz olduğunu düşünüyorum. acil şifalar.
  entry_channels: anket,ilişkiler
- entry_name: |
    2019 ekonomik krizi
  entry_id:  86556493
...
- entry_name: |
    10 şubat 2019 bir dolandırılma hikayesi
  entry_id:  86558453
  entry_writer: atina gore kisneyen sahip
  entry_fav_count: 106
  entry_content: |
    dolandırılma değil gerizekalılık hikayesidir.<br/><br/>parayı önden alıp ürünü göndermeyen versiyonlarını çok gördük de elden satış için gidip para almadan ürünü bir dükkana bırakıp çıkıp gideni ilk defa duydum.
...
- entry_name: |
    fatih terim
  entry_id:  86538602
  entry_writer: voicestopper
  entry_fav_count: 96
  entry_content: |
    türkiye'den neden siktir olup gitmeli diye soran olursa bu basliktakileri açıp okutmak lazım. koskoca ekşi sözlükte tek bir fenerbahçeli, beşiktaşlı da çıkıp dememiş ki "arkadaş galatasaraylilar ilk olarak tff'nin istifasını istedi ama bizim takımımız dahil olmak üzere 17 takım ortak bildiriyle bu talebi resmi olarak reddetti. şimdi onlarin aleyhine olan hataları savunurken onlar da bizim açıklamamizi kullaniyor, gayet normal" diye. yazıklar olsun hepinize
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    yusuf namoğlu'nun istifasını istemeyen tek camia
  entry_id:  86558550
  entry_writer: nickbulamadimnolcak
  entry_fav_count: 91
  entry_content: |
    galatasaray değildir. galatasaray yusuf namoğlu dahil tüm federasyonun istifasını istemiştir.<br/><br/>burada galatasaray iması yapan kimse açık ara piç kurusudur.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 58
  entry_content: |
    <a class="b" href="/?q=7+ekim+2018+konyaspor+be%c5%9fikta%c5%9f+ma%c3%a7%c4%b1">7 ekim 2018 konyaspor beşiktaş maçı</a>nda beşiktaş aleyhine fahiş bir penaltı vermiş kiralık futbol katili. pozisyon olur olmaz tereddütsüz penaltıyı vermişti. var'dan gelen uyarıya ve pozisyonu izlemesine rağmen kararını değiştirmedi.<br/><br/>beşiktaş düdük astırmaya kalkmadı. onun yerine sistemdeki tutarsızliklara dikkat çekti. galatasaray'in kendi maçındaki bir hata için düdük astırmaya çalışması ile bu tutarsızlıklar galatasaray taraftarının gerizekalı bir şekilde dillerine doladıkları 17 kulüp bildirisine dönüştü.<br/><br/>yine aynı kiralık katil, bugün trabzonspor lehine net bir müdahaleyi var odasından gelen uyarıya rağmen göremedi. hakemin var odasıyla olan konuşmaları halka açıklanmalı ve banka hesapları ile telefon görüşmeleri incelenmelidir.<br/><br/>galatasaray lobisi türk futbolunun kanseridir. 17 takımın imzaladığı bildirinin ne kadar haklı olduğunu bu maçtan sonraki fatih terim açıklamalarıyla, utanmaz galatasaray taraftarının söylemleriyle gördük. ümit öztürk'ün fotoğrafıyla da pekiştirdik. şu anda 17 takımın yapması gereken şey teker teker mücadele edemeyecekleri kadar güçlü galatasaray lobisine karşı ortak bir savaşa girişmek ve ümit öztürk'e düdük astırmaktır.
  entry_channels: spor
- entry_name: |
    akp döneminde çekilmiş manav kuyruğu fotoğrafı
  entry_id:  86555073
  entry_writer: buyrunnickiniz
  entry_fav_count: 58
  entry_content: |
    manav kuyruğunda bekleyen efsane nesil olarak tarihe geçtik çok şükür.gelecekte torunlarımıza "siz bilmessiniz biz 2 kilo patates almak için saatlerce ayakta beklerdik" diyebileceğiz.bizi bundan mahrum bırakmayan bize tarihi hatırlatan sayın cumhurbaşkanı pardon başkanımıza çok teşekkür ediyorum.
...
- entry_name: |
  ...
  entry_fav_count: 34
  entry_content: |
    önce şuraya bir götümle güleyim: ahahahahahha<br/><br/>iş yokmuş, vasıfsızsan, milyon dolarların yoksa new york/new jersey dışında barınamazmışsın, iş bulamazmışsın, çok tehlikeliymiş...<br/><br/>siz bunlara inanmayın hepsi yalancı, kıskanç oluşumlar. korkmayın! fırsatınız, imkanınız varsa, green card çıktıysa, çıkın çıkın gelin.<br/><br/>gelmeden önce araştırın ama hangi iklimde, hangi koşullarda yaşamak istersiniz. ama şunu da bilin; burada çalışmak isteyen hiç kimse aç kalmaz. herkese en az asgari ücretli bir iş var. az kazanıp ucuz yaşayım, sakin olsun, sıcak olsun dersen güneye yerleşirsin. soğuk bana koymaz, çok kazanırım, çok harcarım, dersen doğuya, kuzey doğuya gelirsin (batı hakkında bilgim yok). her şekilde yolunu bulursun. <br/><br/>kaç zamandır bir vasıfsız mevzusu dönüyor. diplomam geçerli olmadığı için burada vasıfsız sayılıyorum. delivery işi yaparak toplamda 3-4 saat çalışarak günde 100 dolar rahat yapıyorum. sıkı çalışan gençler var günde 8-10 saat çalışarak 200-250 dolar yapıyorlar. en kötü saati 10 dolar asgari ücretten 10 saat pizzacıda çalışır 100 dolar yine yaparsın.<br/><br/>yordum yine kendimi boş boş. gelmek aklında olan varsa kötüleyenlere sakın inanmasın. sizin gelmenizi istemiyorlar, onlar gibi rahat edin istemiyorlar çünkü.<br/><br/>sırf bu yüzden yutubır yapacaklar beni. neyse sakinim. kalın sağlıcakla.
...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    kadrosunda 11 yabancı oyuncusu bulunan ve sakatlık vs olmasa hepsini oynatacak olan kulübün başkanı.<br/><br/>tabii bu transfer tahtası kapalı olduğu için mecburen böyle, transfer yapabilse en az 3-5 yabancı daha katardı kadrosuna(eldekini de satmazdı), kendi alamayınca kimse alamasın istiyor. o yaptığı çanakkale benzetmesi ise tek kelimeyle skandal, kıçı kırık futbol maçını bir ülkenin var oluş çabasıyla bir tutmak nedir yahu? 90 dakika koşup maç sonu mercedeslerine ferrarilerine binip villalarına gidecek bu adamlar, en çömez dediğin futbolcu milyon eurolara oynuyor, insanda biraz utanma olur aç karnına kendini mermi önüne atanla bunları nasıl bir tutuyorsun sen?
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    kesin kovuldu mu lan. her maçtan sonra yabancı sınırlaması muhabbeti yapamayacak mı artık. gerçekten mi?<br/><br/>tanım - bunak.
  entry_channels: spor
- entry_name: |
