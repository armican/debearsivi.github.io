...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    12 mart 2020 öğretmenlerin 4 ayak üzerine düşmesi
  entry_id:  103412044
  entry_writer: tgyblk
  entry_fav_count: 569
  entry_content: |
    yuhh artık yuhh. öğretmenler siksin sizi.
...
- entry_name: |
  ...
  entry_fav_count: 322
  entry_content: |
    dünya: elimde her türlü virüsün antikoru bulunuyor. insanların da
...
- entry_name: |
  ...
  entry_fav_count: 123
  entry_content: |
    türk lirası bile çöp olabilir demiş arkadaş ama türk lirası zaten şu an çöp.
...
- entry_name: |
  ...
  entry_fav_count: 61
  entry_content: |
    arkadaşlar hemen gaza gelmeyelim. daha bizim için bu sınav yeni başladı. umalım ki gerçekten sağlık sistemimiz iyi olsun.
  entry_channels: sağlık
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 40
  entry_content: |
    açacağınız başlığı sikeyim.<br/>süper lig ertelensin, süper lig seyircisiz oynansın desen anlayacağız. toptan tüm spor müsabakaları için desen bunu anlayacağız.<br/>ama her zaman derim, beşiktaş taraftarı en sahte sosyal sorumluluk grubudur. böyle bir misyonu bu taraftar grubuna kim verdiyse onlara da yazık. işleri güçleri showtime.
  entry_channels: spor
- entry_name: |
    borsa istanbul
  entry_id:  103386802
...
- entry_name: |
    coronanın esenler otogarı tuvaletine bulaşması
  entry_id:  103414379
  entry_writer: dynamico
  entry_fav_count: 28
  entry_content: |
    ehuehueuheuheuhe öyle mi amına koduğumun salağı seni
  entry_channels: sağlık
- entry_name: |
...
- entry_name: |
    corona ayağına ense yapan öğretmen
  entry_id:  103413346
  entry_writer: mistiranderson
  entry_fav_count: 23
  entry_content: |
    öğretmen olmak varmış amk. sözlükte ne kadar orospu evladı varsa hepsini kudurtuyon hiç bişey yapmadan. ne kadar kutsal meslek.
  entry_channels: sağlık,eğitim
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: sağlık,haber,eğitim
- entry_name: |
    türkiye'nin koronavirüs sürecini iyi yönetmesi
  entry_id:  103412065
  entry_writer: redblack000
  entry_fav_count: 17
  entry_content: |
    kesinlikle iyiye yakın bir yönetim görüyoruz. vakaların sayısı artmadan okulların tatil edilmesi, maçların seyircisiz oynanması kararı... bunlar olumlu güzel şeyler. hele de avrupa’nın halini gördükten sonra.
  entry_channels: sağlık
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    18 yıldır yaptığı en iyi iş olabilir.
  entry_channels: siyaset,sağlık
- entry_name: |
    ayasofya'nın 500 yıl öncesine ait sesi
  entry_id:  103413949
  entry_writer: insanfaktoru
  entry_fav_count: 11
  entry_content: |
    kaynakta 1453'te istanbul'un osmanlı tarafından işgal edildiği yazıyor. yazana göre hala işgal altında. <br/>bu stanfordlu geri zekalılara amerika kıtası da 1492'den beri işgal altında o zaman desen boş boş bakarlar.
  entry_channels: 
- entry_name: |
    madem online eğitim oluyor okullar kapatılsın
  entry_id:  103414818
  entry_writer: vosvos 1303
  entry_fav_count: 9
  entry_content: |
    madem yapay döllenme oluyor seks yapılmasın.
  entry_channels: eğitim
- entry_name: |
    hande soral'ın karantinaya alınması
  entry_id:  103415366
  entry_writer: theres nothing like this
  entry_fav_count: 9
  entry_content: |
    ifadesi alındıktan sonra savcılığa mı sevk edilecekmiş?
  entry_channels: sağlık,magazin
- entry_name: |
    12 mart 2020 dolar kuru
  entry_id:  103408501
  entry_writer: zenci damat
  entry_fav_count: 9
  entry_content: |
    nasıl bir para bu dolar lan, savaş çıkıyor dolara yarıyor, kriz oluyor dolara yarıyor, virüs salgını oluyor dolara yarıyor, taş yağsa yine dolara yarar amk. üstelik fed daha yeni faiz indirdi, yine indireceği söyleniyor. bildiğin diğer paralara karşı haksız rekabet lan bu.
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    direnmeyiniz!.. bakmamaya çalışmak dekolteyi verene saygısızlıktır.<br/><br/>ama ne kadar da ironiktir ki, o memeyi çıplak görseniz bu kadar iç geçirmezsiniz.<br/><br/>bakın, geçin. takılı kalmayın... biliyorum, fotoğrafını çekip saatlerce bakasınız geliyor ama yapmayın.
  entry_channels: ilişkiler,moda
- entry_name: |
    bitcoin
  entry_id:  103398017
  entry_writer: ekosistem
  entry_fav_count: 7
  entry_content: |
...
- entry_name: |
    istanbul'un corona sürecini iyi yönetememesi
  entry_id:  103415133
  entry_writer: teraskat
  entry_fav_count: 5
  entry_content: |
    (bkz: <a class="b" href="/?q=ibb%27nin+koydu%c4%9fu+dezenfektan+cihazlar%c4%b1n%c4%b1n+k%c4%b1r%c4%b1lmas%c4%b1">ibb'nin koyduğu dezenfektan cihazlarının kırılması</a>)<br/>bazılarına ne yapsan boş. hastaneleri de imamoğlu yönetiyor, evet.
  entry_channels: 
- entry_name: |
    ekşi itiraf
  entry_id:  103380142
  ...
  entry_fav_count: 4
  entry_content: |
    bütün öğleden sonra yerlerde süründüm ağladım zırladım gece 1 oldu yoğurt mayalıyorum. tam bir türk kadınıyım teşekkür ederim genlerim.<br/>neyse yoğurt mayalamakla kurtardım olayı temizliğe de sarabilirdim.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    corona virüsü
  entry_id:  103384945
  entry_writer: binicktirgitaq
  entry_fav_count: 4
  entry_content: |
    virüsün bulaştığı insan sayısı <a class="b" href="/?q=lineer">lineer</a> ölçekteki bir grafikle incelendiğinde açısını a-normal gözüken bir 90 dereceye yaklaştırarak, dünyadaki etkisinin ivmelenerek arttığı "yanılgısı"na vardırıyor. fakat ölçek <a class="b" href="/?q=logaritmik">logaritmik</a> olarak düzenlenirse bulaştığı insan sayısı artmakla beraber, ivmesini yani eski gücünü kaybettiği görülüyor. ölen insan sayısı da, haliyle, yukarıdaki tespitlere korale bir seyir izliyor. <br/><br/>şubatın 12'sinden sonra bu durum net bir şekilde gözlemlenebilir. ki şubatın 11'inde 45134 olan total pozitif sayı 12'sinde son büyük atağını 59287 seviyesine yapıyor. bu tarihten sonra <a class="b" href="/?q=parabolik">parabolik</a> eğrinin "uyku/yatış" moduna geçtiği açık. mart ayının önemi, virüsün genel anlamda kuzey yarım kürenin özellikle de orta kuşağında etkin olduğunu varsayarsak sıcaklıklardaki artışla ters orantılı olacak şekilde corona-insan ilişkilerinin zayıfladığı bilgisi hekimlerce teyit edilmese de istatistik bilimince doğru olabilir. bu demek değildir ki ikinci ve güçlü bir corona atağı gelmez. fakat bu demek değildir ki bu virüs bulaştığı insan sayısı arttığı için gittikçe güçlenmekte. keza geçmiş verilere göre azalmakta hatta durağan bir seyir <a rel="nofollow noopener" class="url" target="_blank" href="https://www.worldometers.info/coronavirus/#coronavirus-deaths-log" title="https://www.worldometers.info/coronavirus/#coronavirus-deaths-log">izlemektedir</a>.<br/><br/>yukarıdaki tezi çürütecek önemli bir ayrıntı şubatın son iki haftası ile mart ayının bugüne kadar olan sürecinde her ne kadar geçmiş günlere nazaran bariz bir durağanlık gözlemlense de martın ilk haftasından sonra eğri biraz biraz yukarı yönde uyanmaya başlamış. bunda virüsün yeni bulaştığı ülkelerdeki etkinliğini dikkate almalıyız. global grafiği etkileyen en büyük ikinci oyuncu italya o yönelimin en büyük sebebidir. şubatın 15'inde italya'da yayılmaya başlayan virüs martın ilk haftasını güçlü bir atakla geride bırakmıştır. fakat ikinci hafta itibariyle eğrinin y ekseninden ayrıldığı, ayakta durmaktansa yatağa geçmeye çalıştığı görülüyor. peki neden? bence virüsün yeni tanıştığı coğrafyadaki ilk tepkisi onu etkileyecek sıcaklık faktörünün önüne geçebiliyor. yani bölge yeniyse zorluklar onu yıldıramıyor. bunu daha iyi görebilmek için bir başka örnekten bahsedeceğim. neticede global grafiğin büyük etkeni çin'dir. ve yalnız çin'i baz alan <a rel="nofollow noopener" class="url" target="_blank" href="https://www.worldometers.info/coronavirus/country/china/" title="https://www.worldometers.info/coronavirus/country/china/">grafikte</a>mart ayında şubata nazaran x eksenine iyice uzanmış başka bir deyişle adeta kış uykusuna yatmıştır. bu eğri nisan ve mayıs dönemlerinde yataktan düşecek bir hale gelebilir. ayrıca çin'i baz alan grafik öncü bir göstergeye dönüşebilir. çünkü zaman faktörü çin'i mesela italya'dan bir adım önde tutmakta. çünkü eğrinin aşağı yöne doğru yöneleceği ilk ülke zaman faktörü gereğince italya değil çin olacaktır. çin'in eğrisi yataktan aşağı yuvarlanacaksa bu muhtemelen global ortalamanın iyice uyku moduna geçtiği bir dönem olabilir.<br/><br/>edit:virüsün insanlığın %100'üne yayılma olasılığı da yukarıdaki ihtimallerle söz konusu. ki metinde yayıldığı insan sayısı ile değil, yayılma gücüyle ilgileniliyor. parobolik eğrinin bu tempoyla aşağı kırdığı ihtimal görülebilir demek bir olasılıktır. yukarıda yazılanlardan virüsün hafife alındığının düşünülmesi, tek bir irrasyonel detayın metni yönlendirmediğini anlayamamış olmaktır. geçmiş verilerden insanların iyi ve kötü olarak tanımladığı ihtimallerden herhangi biri olacak denilmeden olasılıklar sunulmuş, konu rasyonel verilerle açıklanmaya çalışılmıştır. bu arada lütfen kararlarınızı dünya sağlık örgütü'nün bir sözü değil, kanıtlarına biçtiğiniz değer belirlesin.
  entry_channels: bilim,sağlık,haber
- entry_name: |
    100 ml dezenfektanın 45 lira olması
  entry_id:  103386000
  entry_writer: the orijinals
  entry_fav_count: 4
  entry_content: |
    zor zamanda ne kadar güzel destek oluyoruz birbirimize sağolun türk milleti. 1 litresinin 27 tl aldığım dezenfektan 100 tl olmuş.<br/>amk fırsatçıları virüsten daha tehlikeli yaratıklar.<br/>eeee nolcak şimdi parası olamayan ölsün mü? yahu kardeşim sen bunu uygun fiyata vercenki millet korumaya çalışsın kendini. haram zıkkım zehir olsun size o para.
  entry_channels: siyaset,sağlık,ekonomi
- entry_name: |
    corona yayılırken izlenebilecek film ve diziler
  entry_id:  103415378
  entry_writer: erdemliadam
  entry_fav_count: 3
  entry_content: |
    "contagion" <br/>filmdeki virüsün öldürme oranı %30'du, covid 19'un %0,2. ama olsun, izleyerek paranoyamızı besleyebiliriz yine de.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    personel yetersizliği nedeniyledir. italya emekli sağlık personelini göreve çağırdı.
  entry_channels: sağlık,eğitim
- entry_name: |
    16 mart okulların tatil olması
  entry_id:  103411336
  entry_writer: evsizogrenci
  entry_fav_count: 2
  entry_content: |
    16 mart itibariyle 1 hafta tatil ediliyor. 23 mart itibariyle uzaktan eğitime geçiliyor. üniversiteler de 3 hafta tatil edildi.
  entry_channels: haber,eğitim
- entry_name: |
    13 mart 2020 cuma namazına gidecek insan
  entry_id:  103414156
  entry_writer: sanalsanri
  entry_fav_count: 2
  entry_content: |
    eğer kimse gitmezse ben gidebilirim.
  entry_channels: anket
- entry_name: |
    turizmde çalışanlar şimdi ne yapacak sorunsalı
  entry_id:  103413922
  entry_writer: fiyodor
  entry_fav_count: 1
  entry_content: |
    mardinli ve urfalı kardeşlerimi başlığa bekliyorum
  entry_channels: ekonomi
- entry_name: |
    bein sports şifresi yayın yapsın
  entry_id:  103416130
  entry_writer: başlık taşıyan
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=bein+sports%27un+%c5%9fifresiz+yay%c4%b1n+yapmas%c4%b1+gereklili%c4%9fi">bein sports'un şifresiz yayın yapması gerekliliği</a>)
  entry_channels: spor,tv
---
