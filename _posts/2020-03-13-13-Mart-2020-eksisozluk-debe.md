...
- entry_name: |
  ...
  entry_fav_count: 78
  entry_content: |
    twerkten hic hoslanmam ancak su arkadasin gotune kalem soksan tolkien gibi hikaye yazar. oyle yetenekli bir calkalama bu.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
    cuma namazlarının her şartta kıldırılacak olması
  entry_id:  103415936
  entry_writer: fjack
  entry_fav_count: 35
  entry_content: |
    3 ay içinde ülkedeki partiler arası oy dağılımını komple değiştirebilecek durum.<br/><br/>(bkz: <a class="b" href="/?q=ince+g%c3%b6r">ince gör</a>)
  entry_channels: haber
- entry_name: |
    kadın çişi
  entry_id:  103419524
  entry_writer: o artik mezun oluyor
  entry_fav_count: 32
  entry_content: |
    (bkz: <a class="b" href="/?q=ne+ba%c5%9fl%c4%b1klar+var+arkada%c5%9f">ne başlıklar var arkadaş</a>)
  entry_channels: bilim,sağlık
- entry_name: |
  ...
  entry_fav_count: 30
  entry_content: |
    size karşı boşsa umrunda olmaz.<br/>boş değilse naber desen hoşuna gider.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  103420614
  entry_writer: depresifpollyanna12
  entry_fav_count: 13
  entry_content: |
    spor salonları, koronavirüsün yayılma riskinin en yüksek olduğu mekanların başında geliyor<br/><br/>iskoç asıllı doktor norman swan, aşırı derece ter ve rutubet barındıkları için spor salonlarının koronavirüsün yayılma riskinin en yüksek olduğu mekanların başında geldiğini söyledi. swan, spor salonuna giden kişilerin ellerinde tuttukları ağırlıkların virüs barındırma ihtimallerinin çok yüksek olduğunu ifade etti.<br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.google.co.uk/amp/s/www.haberler.com/amp/spor-salonlari-koronavirusun-yayilma-riskinin-en-13003330-haberi/" title="https://www.google.co.uk/amp/s/www.haberler.com/amp/spor-salonlari-koronavirusun-yayilma-riskinin-en-13003330-haberi/">kaynak</a>
  entry_channels: spor
- entry_name: |
    adliyeler tatil edilsin kampanyası
  entry_id:  103415662
  entry_writer: gerek yok bence
  entry_fav_count: 11
  entry_content: |
    adım atacak yer olmayan icra dairelerini düşününce benim de katıldığım kampanyadır. valla salsan bi tanecik virüsü o göt içi kadar dairelere onyüzbin milyon olurlar.
  entry_channels: 
- entry_name: |
    12 mart 2020 kombine bilet sahiplerinin hak kaybı
  entry_id:  103420357
  entry_writer: pamuk prenses ve en az uc cuceler
  entry_fav_count: 11
  entry_content: |
    amk ülkesinde hakkını aramak değil bundan bahsetmek bile suç olmuş.
  entry_channels: spor,haber
- entry_name: |
    istanbul'un ıslağı mı ankara'nın aspava'sı mı
  entry_id:  103420941
  entry_writer: 0game
  entry_fav_count: 7
  entry_content: |
    (bkz: <a class="b" href="/?q=%c4%b1slak+ne+lan">ıslak ne lan</a>)<br/><br/>ssk'ya ayıptır.
  entry_channels: 
- entry_name: |
    22 gün sonra dünya çapında olacak olay
  entry_id:  103424011
  entry_writer: blind dog
  entry_fav_count: 7
  entry_content: |
    (bkz: <a class="b" href="/?q=anan%c4%b1n+am%c4%b1+olmas%c4%b1">ananın amı olması</a>)<br/>(bkz: <a class="b" href="/?q=k%c3%bcf%c3%bcr+yemek+i%c3%a7in+a%c3%a7%c4%b1lan+ba%c5%9fl%c4%b1klar">küfür yemek için açılan başlıklar</a>)
  entry_channels: 
- entry_name: |
    fed'in 500 milyar dolar likidite enjeksiyonu
  entry_id:  103416942
  entry_writer: nbafan
  entry_fav_count: 6
  entry_content: |
    an itibariyle gerçekleşen ve piyasaları bir miktar sakinleştiren karar.<br/><br/>new york fed 3 ay vadeli repo işlemleri yoluyla 500 milyar dolarlık menkul kıymet alarak piyasaya likidite enjekte etti.<br/><br/>ekleme: fed para basmıyor. <br/><br/>ekleme-2: fed 500 milyar repo piyasaya sürerken doların artma sebebi fed'in "500 milyar dolar" piyasaya sürmek zorunda kalmasıdır.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    dünyanın değil insanlığın sonudur o. tüm insan ırkı dünya üzerinden bir gecede silinse dünya ertesi gün hiç bişey olmamış gibi dönmeye devam eder.
  entry_channels: anket,bilim,sağlık
- entry_name: |
    türk cumhuriyetlerinde virüs olmaması
  entry_id:  103423131
  entry_writer: eoamt
  entry_fav_count: 5
  entry_content: |
    suriye'de o kadar çok virüs var ki, dünya'da bir tek oraya bulaşmaz. herkes inkar etse de, türk devletlerinde, ilginç bir şekilde bu virüs yayılmıyor. genlerden ziyade, beslenme alışkanlıklarına bağlıyorum. türklerin yediği ortak bir besin, bu virüse iyi geliyor ama bu besin ne?
  entry_channels: sağlık,haber
- entry_name: |
    öğretmenlerin tatillerde karayollarında çalışması
  entry_id:  103423173
  entry_writer: bombaci muallim
  entry_fav_count: 2
  entry_content: |
    tarihçi arkadaşlar da göbeklitepe'de kazı yapsın. göbekleri erisin ibnelerin.<br/><br/>not: tarihçiyim.
  entry_channels: 
- entry_name: |
    sikmişim koronayı gel yarasa yiyelim diyen kız
  entry_id:  103422801
  entry_writer: macenas
  entry_fav_count: 2
  entry_content: |
    evlenilecek kiz degildir. zira agzina sahip cikamayan kiz amina da sahip cikamaz.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    virüs aşısı.<br/><br/>babalar ozelden cok soru geliyo, tek tek cevap vermek yerine burdan yanitliyim: 2007’den beri yazarim. bu nicki aldigimda ortada salgin yoktu. corvus: karga, corona: taç demek. bir tur tacli karga yani. virusle yeminle bi alakamız yok :)
  entry_channels: anket,ekşi-sözlük
- entry_name: |
    insanlar ikiye ayrılır
  entry_id:  103407618
  entry_writer: ben kazandim
  entry_fav_count: 2
  entry_content: |
    sonra derisi yüzülerek büyük bir kazanda kaynatılır.
  entry_channels: siyaset,anket,ilişkiler,sinema,edebiyat
- entry_name: |
    en iyi 3 yerli aktör
  entry_id:  103390553
  entry_writer: birkizilderiliatasozu
  entry_fav_count: 2
  entry_content: |
    en iyi 3 metod oyuncusu ;<br/>1) münir ozkul<br/>2) şener şen <br/>3)haluk bilginer <br/>bu üçü her role girer ve rolünü hem yaşar hem de yaşatır...
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    devre arasında yorum yapan ilker yağcıoğlu hocanın oyuna müdahalesi konusu açılınca yanlışlıkla 'başakşehir'in yedek kulübesinde kim var şimdi bilmiyorum ama' dedi. daha neler duycaz tehh. adam yorumladığı maçın kadrosunu bilmiyor. bi de avrupa kupası maçı.
  entry_channels: spor
- entry_name: |
    ya yaşadığımız hayat bir varlığın rüyasıysa
  entry_id:  103422948
  entry_writer: rosense
  entry_fav_count: 1
  entry_content: |
    o varlık kesin götü açık yatmıştır.
  entry_channels: 
- entry_name: |
    corona virüsü sözlük yazarı olsa kullanacağı nick
  entry_id:  103423892
  ...
  entry_channels: 
- entry_name: |
    ücretli öğretmenlik maaşlarının yatırılmaması
  entry_id:  103422857
  entry_writer: frostpunk
  entry_fav_count: 0
  entry_content: |
    ücretli öğretmenler derse girmediklerinde kadrolu ve sözleşmeliler gibi ücret almaz. yani bir maaşları yoktur. <br/>işte <a class="b" href="/?q=e%c5%9fit+i%c5%9fe+e%c5%9fit+%c3%bccret">eşit işe eşit ücret</a> sloganı tam olarak da bu ahlaksızlığın kaldırılması içindi.
  entry_channels: 
---
