...
- entry_name: |
  ...
  entry_fav_count: 38
  entry_content: |
    yarın itibari ile corona olmayan şehir kalmayacak.<br/><br/>hoşgeldin corona bebek.
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    (bkz: <a class="b" href="/?q=28+days+later">28 days later</a>)
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    paraya tapın. salak olmayın. erkeklerin çoğu, sizin iyi kalbiniz için birlikte değil. güzelleşmek ve bakım da parayladır. fakir tipleme nasıl güzel ve bakımlı kadınları kendine hak görüyorsa, siz de zengin ve yakışıklı erkekleri kendinize hak görün.
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    12 mart 2020 turna.com rezaleti
  entry_id:  103418400
  entry_writer: lafsokanherif
  entry_fav_count: 4
  entry_content: |
    yeni nesil yazarlar mal ya.<br/>gülen surat
  entry_channels: 
- entry_name: |
    ziya selçuk
  entry_id:  103398432
  ...
  entry_fav_count: 3
  entry_content: |
    milli eğitime gelmiş en balon bakan kendisidir. bunu bizzat kendi genel müdürlerinden de duymuşluğum çoktur. ama hakkını yemeyeyim pr konusunda üstüne yoktur.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    akşamdan elma sirkesinde beklettiğim bağışıklık sistemini güçlendirici fungus immunabis mantarının suyunu sabahları kalkınca kahvaltıdan önce içiyorum.
