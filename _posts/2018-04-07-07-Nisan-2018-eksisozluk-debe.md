...
- entry_name: |
    2019 seçimlerini akp'nin kaybedeceğinin ispatı
  entry_id:  75757309
  entry_writer: naletcix
  entry_fav_count: 404
  entry_content: |
    ysk’yı ne yapacağız peki? mühürsüz oyları falan?<br/><br/>hala referandum oranlarını gerçek sananlar var!
- entry_name: |
...
- entry_name: |
    ayda 2.5 milyon tl ile krallar gibi yaşamak
  entry_id:  75750799
  entry_writer: eksi peace
  entry_fav_count: 58
  entry_content: |
    "boş zamanlarımda da sözlükte kafa sikerim" şeklinde devam edecek eylem.
- entry_name: |
    sözlükteki hizliresim.com dan link verme hastalığı
  entry_id:  75754014
  entry_writer: babasini bakkala gonderen cocuk
  entry_fav_count: 39
  entry_content: |
    imgur hastalığından iyidir dediğim.
- entry_name: |
  ...
  entry_fav_count: 37
  entry_content: |
    (bkz: <a class="b" href="/?q=refl%c3%bc+is+coming">reflü is coming</a>)
- entry_name: |
...
- entry_name: |
    iyiyse atatürk kötüyse hükümetler yaptı
  entry_id:  75771702
  entry_writer: pasahazar
  entry_fav_count: 19
  entry_content: |
    adam sizin gibilerin zamanında nasıl ciğerini söktüyse, canınız sıkıldıkça ona sarmaya çalışıyorsunuz dedirten önerme... buyrun kötülüklerini örneklerle açıklayın da görelim.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    kadın şarj aleti sora sora hem adamı hem parayı buldu. bizim suçumuz powerbankimiz olması mı gardaş?
- entry_name: |
...
- entry_name: |
    öğretmene karşı hak arama
  entry_id:  75770869
  entry_writer: acikcasi dehsete kapildim
  entry_fav_count: 4
  entry_content: |
    kopya meselesinde hak aramadan önce sağlam kafayla oturup düşünülmelidir. kardeşimiz hiçbir şey yapmadan sınav kağıdına odaklanmışken öğretmeni gelip kağıdını almış olabilir mi? bu ne kadar mantığa uygundur?<br/><br/>kardeşimiz gerçekten kopya vermemiş olsun fakat sınav esnasında herhangi bir sebeple arkasında oturanla iletişime geçmiş olsun. dünya kardeşimizin etrafında dönmediğine göre kardeşimizin herhangi bir sebeple sınavın huzurunu bozmaya hakkı yoktur. evet belki kopya vermemiştir ama aynı şeyi üniversite sınavlarında da yapsa kopya muamelesi görecektir. <br/><br/>hak aramadan önce sorumluluk kısmını halletmekte fayda var.
- entry_name: |
...
- entry_name: |
    kişisel verilerinizi koruyoruz hatırlatması
  entry_id:  75772125
  entry_writer: ne yazsam aceb
  entry_fav_count: 2
  entry_content: |
    7 nisan 2018 sirketlerin kvkk icin musterilerini aydinlatma yapmasi icin gereken son gun oldugu icindir. bu tarihten sonra devlet firmalara ceza kesebilecek. dolayisiyla butun firmalar bugun sms yagmuruna tutmustur.
- entry_name: |
    digiturkplay
  entry_id:  75770299
  ...
  entry_fav_count: 2
  entry_content: |
    gün itibarı ile android uygulaması ve web sitesini güncellemiş ve içine etmiş. eskiden hangi maçın hangi kanalda olduğu yazıyor ve tek tıkla ulaşıyordunuz. şimdi sadece kanallar var ve ara dur hangi kanalda olduğunu. bir şeyi de saçma sapan yapmayın gözünüzü seveyim. umarım en kıss zamanda bu aptallık düzeltilir.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    hable con ella filminden <br/>caetano veloso -<a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=-CsA1CcA4Z8" title="https://www.youtube.com/watch?v=-CsA1CcA4Z8">cucurrucucu paloma</a>
- entry_name: |
...
- entry_name: |
    çaykovski dinlerken çay içmek
  entry_id:  75763636
  entry_writer: highpriestess
  entry_fav_count: 1
  entry_content: |
    bir liszt dinlerken listerine'le gargara yapmak değildir.
- entry_name: |
    volkan bayar
  entry_id:  75750434
  entry_writer: zerkalostalker
  entry_fav_count: 0
  entry_content: |
    ''bulundurma'' ruhsatlı bir silahı bu orospu çocuğu nasıl alabilmiştir ?<br/>kim? ne amaçla? hangi gerekçeyle bu ruhsatı vermiştir?<br/>söylenilenler doğruysa yüzlerce kişi için ihbarda bulunan bu katil nasıl olup da 15 temmuz'dan bu yana sürdürülen bunca soruşturmadan azade olmuştur?<br/>kendisi hakkında verilen onca dilekçe kim tarafından sümenaltı edilmiştir?<br/>biri gözden kaçtı, büyükelçi öldürüldü.<br/>biri gözden kaçtı, dört ailenin ateşi söndürüldü.<br/>aslında göz önünde bulunanlar yaptı hepsini. <br/>o ''nedamet getirdi'', bu ''vallaha bir daha yapmam'' dedi diye göz yumduklarınız bu ülkenin altını kazmaya devam ediyor.<br/>ve edecekler. tıynetleri bu çünkü.
---
