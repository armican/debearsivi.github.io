...
- entry_name: |
    çaylak onay listesi
  entry_id:  75749347
  entry_writer: kartal babasi
  entry_fav_count: 21
  entry_content: |
    allah kurtarsın ben kurtuldum darısı sizin başınıza
- entry_name: |
    jennifer aniston
  entry_id:  75763787
  entry_writer: fluvio
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    200 tane yılanın olduğu odada kafa kaldıran kobrayı tokatladım diye anlatsa inanmamız gerekecek bir abidir aynı zamanda. helal olsun.
- entry_name: |
    twitter
  entry_id:  75769411
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    inançsız olup kendini çok zeki sanan bir insanın gerçekten zeki olma ihtimalinden daha kuvvetli bir ihtimaldir. birçok kişinin inançsız olma nedeni de bu hava işte. "ben inançsızım çok zekiyim." havaları.<br/><br/>zeki adam her açıdan kendini belli eder gerçi de yine de zeka da göreceli bir şey aslında. neye göre zeki, kime göre zeki? din bir insanın zekasını kullanmasına engel midir?
- entry_name: |
