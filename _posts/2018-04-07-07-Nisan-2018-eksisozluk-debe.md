...
- entry_name: |
  ...
  entry_fav_count: 72
  entry_content: |
    taşak geçmeyin orospu çocukları üzülüyoruz duygusalız.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    yalancıyı sikseler şu başlıkta 10 entry kalır mı acaba merak ediyorum.
- entry_name: |
    la casa de papel
  entry_id:  75752911
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    dostum sen ayakkabi demissin ama bu bildigin besik. yavrucaklar usumuyordur umarim icinde.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    ilk olarak ekşi sözlük ile başlayan ardına son 1 saatte 13 ayrı firmadan (bankalar,turkcell, pepsi, vatan bilgisayar vb) gelen hatırlatma mesajı yada mail'leri alıyorum. durduk yere kıllanmaya başladım açıkçası. neden birden bire firmalar kişisel verilerimin korunduğunu ardı ardına bana hatırlatıyor merak ettim. <br/><br/>bu yasal bir zorunluluktur falan anlarım ama neden şimdi ve neden peş peşe? bilmediğimiz bir skandal mı oldu gene.
- entry_name: |
