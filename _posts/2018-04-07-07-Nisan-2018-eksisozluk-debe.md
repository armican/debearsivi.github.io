...
- entry_name: |
  ...
  entry_fav_count: 293
  entry_content: |
    yani 20 senedir kadının başlığı açılmadı da sen mi açtın amk?
- entry_name: |
...
- entry_name: |
    seni sevdim be tosunum
  entry_id:  75754571
  entry_writer: welcometofreakshow
  entry_fav_count: 195
  entry_content: |
    çiftlik bank mağdurlarının isyanı olması gerekirken bambaşka bir olayda geçmiş söylem.
- entry_name: |
...
- entry_name: |
    mustafa tuna'ya akp'li diye oy vermemek
  entry_id:  75764030
  entry_writer: az dusunur cok konusur arada yazar
  entry_fav_count: 67
  entry_content: |
    bütün ankara işemeye aşti'ye gittiği ve arabasını ulus'a park ettiği için doğru bir tespit.
- entry_name: |
...
- entry_name: |
    şeytan'ın hatalı olduğunu anlayıp özür dilemesi
  entry_id:  75749077
  entry_writer: kesinlikle dengesizim
  entry_fav_count: 52
  entry_content: |
    onun da özür dileyip tövbe edip yırtacağı, bizim de gene mal gibi ortada kalacağımız olaydır.<br/><br/>alıştık zaten.
- entry_name: |
    james hetfield
  entry_id:  75763048
  ...
  entry_fav_count: 52
  entry_content: |
    amına koduklarım olur olmadık yazmayın şu başlığa. öldü sandım. betim benzim attı başlığa tıklarken..
- entry_name: |
...
- entry_name: |
    popçu olunsa kullanılacak sahne adı
  entry_id:  75765604
  entry_writer: forgosin
  entry_fav_count: 19
  entry_content: |
    sarkan. ilk tekli çalışmamın ismi de "dalarım sana" olurdu. bestelerimi gezen paksu'dan aldım mı, bitti bu iş.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    beter olun ibneler.sen 100 milyara daire mal et.sonra git 1 trilyona satmaya çalış.yok öyle kolay yoldan para kazanma.ortalık rizeli akp yalağı inşaatçılardan geçilmiyor.hepsinin altında son model bmwler audiler.bunlar zevk içinde yaşayacaklar diye ben ömrümü kredi ödeyeceğim diye tüketiyorum.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    (bkz: <a class="b" href="/?q=%c3%a7ay">çay</a>)<br/>(bkz: <a class="b" href="/?q=rak%c4%b1">rakı</a>)<br/>(bkz: <a class="b" href="/?q=ahmet+kaya">ahmet kaya</a>)<br/>(bkz: <a class="b" href="/?q=tuncel+kurtiz">tuncel kurtiz</a>)<br/>(bkz: <a class="b" href="/?q=cengiz+%c3%bcnder">cengiz ünder</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=k%c4%b1zarm%c4%b1%c5%9f+ekmek">kızarmış ekmek</a>) bunun kokusunda huzur var huzur...
- entry_name: |
...
- entry_name: |
    sözlükçülerin en iyi suç temalı diziler listesi
  entry_id:  75770838
  entry_writer: bay locke
  entry_fav_count: 0
  entry_content: |
    şu ana kadar çok fazla dizi seyredip en çok zevki suç temalı dizilerden aldığımı farketmemden mütevellit başlattığım anket. komedi, aksiyon vs. dizileri kendi başına sadece çerezlik kalıyor gözümde.<br/><br/>bana göre (buraya dikkat, şahsi düşünce içerir) en iyi suç temalı diziler şu şekilde sıralanıyor:<br/><br/>(bkz: <a class="b" href="/?q=the+wire">the wire</a>)<br/>(bkz: <a class="b" href="/?q=oz">oz</a>)<br/>(bkz: <a class="b" href="/?q=breaking+bad">breaking bad</a>)<br/>(bkz: <a class="b" href="/?q=peaky+blinders">peaky blinders</a>)<br/>(bkz: <a class="b" href="/?q=fargo">fargo</a>)<br/>(bkz: <a class="b" href="/?q=the+sopranos">the sopranos</a>)<br/>(bkz: <a class="b" href="/?q=narcos">narcos</a>)<br/>(bkz: <a class="b" href="/?q=sons+of+anarchy">sons of anarchy</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    varınızı,yoğunuzu,olanınızı,biteninizi,üstünüzdeki gömleği,ayağınızdaki donu,cebinizdeki sümüklü mendili satın ve başakşehir'e basın..zira sanırım erol bulut aynısını yapmış..bu sene başakşehir'in galibiyeti ile alakalı abdullah avcı bile bu kadar inançla hiç konuşmadı..ben herşeyimi sattım,oynadım..bugün sokakta çırılçıplak gezeceğim..yarın kralım nasılsa..
---
