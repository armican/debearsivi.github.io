...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    bana "dişisiniz sanırım" diye mesaj atanlar; size neler sorup, neler yazıyordur kim bilir?<br/><br/>böyle primatlarla cidden uğraşıyor musunuz?<br/><br/>ayrıca (bkz: <a class="b" href="/?q=di%c5%9fisiniz+san%c4%b1r%c4%b1m">dişisiniz sanırım</a>) nedir allah aşkına ? nerenin malısınız anlamadım ki !
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    sebebi 25 mayis 2018 den itibaren uygulanmaya baslanacak ab genel veri koruma tüzüğü'dür.<br/>bkz, <a rel="nofollow noopener" class="url" target="_blank" href="https://www.eugdpr.org/">https://www.eugdpr.org/</a>
- entry_name: |
    ekşi itiraf
  entry_id:  75752829
  entry_writer: 1998
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    2 gün önce 8 bin küsürlerdeyken sanırım dün gece itibariyle çıktığım listedir.
- entry_name: |
...
- entry_name: |
    selahattin demirtaş'a selamlarımı söyleyin
  entry_id:  75772217
  entry_writer: uzak yolculuk
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=insan+hayret+ediyor+partisi">insan hayret ediyor partisi</a>)
---
