...
- entry_name: |
  ...
  entry_fav_count: 39
  entry_content: |
    adamlar moussa sissoko'yu beğenmiyor amk. inanılmaz bir şey ya. mesela benim buna benzer bir lüksüm olmadı hiç şu hayatta. acayip bi platforma dönüştü burası. gerçekliğimi soruluyorum bazen bu sitede.
  entry_channels: spor
- entry_name: |
    pepsi vs coca-cola
  entry_id:  80675466
...
- entry_name: |
  ...
  entry_fav_count: 33
  entry_content: |
    kendisini becermek için takılan erkeği ona aşık zannetmektir.
...
- entry_name: |
  ...
  entry_fav_count: 25
  entry_content: |
    ilkokula giderken de üst düzey oynuyordu doktora biterken de.<br/><br/>form is temporary class is permanent cümlesinin sözlük karşılığı olan arjantinli büyük adam.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    scorpions dinlerken akrep sokması
  entry_id:  80698947
  entry_writer: cevirimanyagi
  entry_fav_count: 15
  entry_content: |
    (bkz: <a class="b" href="/?q=hadise+dinlerken+olay+%c3%a7%c4%b1kmas%c4%b1">hadise dinlerken olay çıkması</a>)
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    ezeli rakibimiz, ebedi dostumuz. diğer takımların taraftarlarına göre daha objektif bir camiadır. aramızdaki rekabet seviyelidir. yanıcı madde içermez.
  entry_channels: spor
- entry_name: |
    sinan gümüş
  entry_id:  80698718
  ...
  entry_fav_count: 8
  entry_content: |
    dörde bir gittiğimiz atağın amına koymuş yeteneksiz. senin galatasaray'a geldiğin günü *ikeyim.<br/><br/>edit: istersen dünya gol ve asist yap. o pozisyonu kaçıran adamın bu takımda işi olamaz. hatta ezeli rakibimiz fenerbahçe'de de olamaz. git beşiktaş'a.
  entry_channels: spor
- entry_name: |
    ekşi itiraf
  entry_id:  80676768
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    çok güzel adam eksilten, güçlü, golcü özelliği de olan, eski takımına attığı golden sonra -büyük bir takımdaki ilk golü olmasına rağmen- sevincini içinde yaşayacak kadar nezaketli bir çöp. <br/><br/>not:alex<br/><br/>edit: önceki entrileri görmeyip entrimin sonunu ilginç bulan arkadaşlar için "çöp"e açıklama getireyim. 3-5 kişi çöp deyip durmuş da. entrimin sonundaki "çöp" onlara atıftı. taraftar gözlüğünü at gözlüğü zanneden arkadaşlar var. adamın kalitesi ortada. bunu itiraf etmek neden bu kadar zor? az daha bize geliyordu adam. kıskanıyorum itiraf edeyim. yıllarca da üzüleceğiz "az daha bize geliyordu adam" diye. hakan şükür'de olduğu gibi, selçuk inan'da olduğu gibi.<br/><br/>edit 2: çöp diyenleri morartmaya devam ediyor. maç 6-0. ilk golde çok güzel bir korner kullandı. oralar karıştı biri geldi attı karambolden golü. 5. golde soldan daldı kamikaze gibi ceza sahasına. inatla topun dışarı çıkmasını engelledi. gollük pas verdi verdiği adamın şutu direkten döndü bir başkası attı golü. 2 golü de direkt kendi attı. 4 golde net katkısı var. biri(leri) çöp mü demişti?
  entry_channels: spor
- entry_name: |
    menzil şeyhinin zikir çeken ineklerinin yoğurdu
  entry_id:  80698455
  entry_writer: ceza
  entry_fav_count: 6
  entry_content: |
    bu gün terlik aldığım iş yerinin sahibi sakallı bir amcaydı. terliği satın alınca elime bir badem şekeri verdi. menzilden geldi dedi. bir şey demeden ağzıma attım. sonucu haber ederim.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    istisnasız hepsi ya birkaç ay sonra veya birkaç yıl sonra geri dönüyor. <br/><br/>bazen bir rüya bahanesiyle bazen bir bayram ya da yılbaşı veya doğum günü kutlama bahanesiyle geri dönerler. <br/><br/>peki neden?<br/><br/>gitme denildiğinde giden, en zor zamanlarda yalnız bırakan, kal denildiğinde ardına bile bakmayan, ardında kocaman bir boşluk ve dayanılmaz acılar bırakıp da giden biri neden geri döner ki_?
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
    almanya'nın abd karşısında türkiyeyi desteklemesi
  entry_id:  80698398
  entry_writer: kinq7
  entry_fav_count: 4
  entry_content: |
    kimsenin bir yere yöneldiği yok, almanya da diğer ülkeler gibi kendi çıkarlarını korumak için türkiyeyi ya da başka ülkeleri desteklemek zorunda.
  entry_channels: siyaset
- entry_name: |
    27 ağustos 2018 manchester utd-tottenham maçı
  entry_id:  80699782
  entry_writer: 2 gb ram
  entry_fav_count: 3
  entry_content: |
    aptal çocuk lukaku boş kaleye yuvarla topu artık bir zahmet amk.. <br/><br/>bir daha bu salağa böyle fırsat gelmez. ikinci yarı kane veya moura gol atacak gibi hissediyorum. bakalım
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    moda, boğa, fenerbahçe
  entry_channels: anket
- entry_name: |
    an itibarıyla yenebilecek en uygun tatlı
  entry_id:  80700125
  entry_writer: sezai karesort
  entry_fav_count: 2
  entry_content: |
    (bkz: <a class="b" href="/?q=s%c3%bctl%c3%bc+nuriye">sütlü nuriye</a>)<br/><br/><a class="b" href="/?q=d%c3%bcnya+bar%c4%b1%c5%9f%c4%b1">dünya barışı</a>nın sütlü nuriye ile geleceğine inanıyorum.
  entry_channels: anket,yeme-içme
- entry_name: |
...
- entry_name: |
    27 ağustos 2018 fernando'nun attığı gol
  entry_id:  80699624
  entry_writer: hakikiasamoah
  entry_fav_count: 1
  entry_content: |
    ne kadar yüzsüz orospu cocukarı var lan. anasının ami gibi eren faulü yapmış. illa götünüze mi sokalım pozisyonları?? tiner miş? tineri ananın müsait bir yerine sok.
  entry_channels: spor
- entry_name: |
    younes belhanda
  entry_id:  80701168
  ...
  entry_fav_count: 0
  entry_content: |
    hakkı en fazla yenen adam. çok korkuyorum transfer dönemi bitene kadar satacaklar diye. bu adam olmadığı zaman galatasaray anadolu takımı gibi oynuyor. kimse farkında değil.
  entry_channels: spor
- entry_name: |
    şu anda çalan şarkı
  entry_id:  80673553
  ...
  entry_fav_count: 0
  entry_content: |
    ah canım babam, jenerasyonuma aykırı bir şekilde iyi ki vermişsin münir nurettin selçuk dinleyebilmenin ayrıcalığını bana ta 13, 14 yaşlarında... istanbul'u hep sevdim, aşkı çok<sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup> gönül akşamda saran şarap rengi dumanlı eski zemanlarda <a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/FcVQIZlAZlA" title="https://youtu.be/FcVQIZlAZlA">kaldı</a>
  entry_channels: anket,müzik
- entry_name: |
