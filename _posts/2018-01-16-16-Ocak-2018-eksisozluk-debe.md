...
- entry_name: |
  ...
  entry_fav_count: 50
  entry_content: |
    80 milyonun hiçbir şekilde sesini çıkarmadan yaptığı ve yapmaya devam edeceği eylem.<br/><br/>benzinin bayi karı dahil bugünkü toplam litre fiyatı 2,48 tl. buna eklenen vergiler:<br/><br/>2,37 tl ötv<br/>+<br/>0,87 tl kdv<br/><br/>son tüketici fiyatı: 5,72 tl.
- entry_name: |
    pegasus airlines
  entry_id:  73504920
...
- entry_name: |
  ...
  entry_fav_count: 44
  entry_content: |
    buna en güzel cevabı <a class="b" href="/?q=ya%c5%9far+kemal">yaşar kemal</a> vermiştir.<br/><br/>“o insana güvenmeyen, bu insana güvenmeyen, her insanda bir kötülük gören, insanı insan saymayan ‘insan‘ değil piçtir yavrum.”
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 23
  entry_content: |
    takribi 1 dakika falan suruyor.<br/><br/>kimse o beni o surenin 10 dakika olduguna inandiramaz.
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  73505430
  entry_writer: cumhurunkizi
  entry_fav_count: 12
  entry_content: |
    yoksun. ve bu çok saçma.
- entry_name: |
    ümit kocasakal
  entry_id:  73505258
  ...
  entry_fav_count: 11
  entry_content: |
    chp’nin kuruluş ayarlarına dönmesini sağlayabilecek en uygun isim.<br/><br/>fakat seçimi kazanacağına dair inancım yok. kazansa da o koltukta barındırmazlar. chp’nin kendisiyle özdeşleşen hizipçilik kavramını yeni nesil de öğrenir.<br/><br/>inşallah kazanır. biz de, geçmişinde fetullah, zihninde pkk olmayan bir liderin peşine düşeriz.<br/><br/>not: cumhuriyet halk partisi’nde liboş, kürtçü, pkk sempatizanı, fethullahçı, sorosçu görmek istemeyen biri.
- entry_name: |
    bitcoin
  entry_id:  73505076
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    vatandaşa betondan zengin olma hayallerini öyle bir zerk ettiler ki memleketin mafya dizisi bile eskiden toz, kan davası gibi konular üzerinden yürürdü artık mafya rolleri müteahhitlerin oldu. <br/><br/>inşaat ya resullah.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    bu herif geldiğinde çok umutluydum. yıllarca ispanya`da ingiltere'de oynamış bir kanat oyuncusu olması çok önemli bir özellikti gözümde. ama hamurunda ortadoğu olduğunu hesaba katmamışım.<br/><br/>geldiğinden beri faydalı olduğu maç sayısı 2. yaptığı itliğin pisliğin mallığın haddi hesabı yok. sorsan elhamdülillah müslüman, görsen tam bir pezevenk.<br/><br/>bu son olsun keloğlan. top oynamaya gelmediysen yallah katar'a.<br/><br/>tanım: sabrımızı sınamakta olan cezayirli dallama.
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    en iyi ihtimalle 2 saat, en kötü ihtimalle 4 saat.(gidiş-dönüş), bu iyileştirilmiş hali.<br/>vakti zamanında şöyle bir yolculuk rutinim vardı, baktıkça kendime inanamıyorum.<br/>(otobüs+ otobüs+ metro+metrobüs+otobüs)*2<sup class="ab"><a title="(bkz: sabah akşam)" href="/?q=sabah+ak%c5%9fam" data-query="sabah akşam">*</a></sup>= metrodan mı indim en son ..?<br/>(bkz: <a class="b" href="/?q=mecidiyek%c3%b6y%27den+mecidiyek%c3%b6y%27e+40+dakikada+gitmek">mecidiyeköy'den mecidiyeköy'e 40 dakikada gitmek</a>)
- entry_name: |
    turan özdemir
  entry_id:  73522464
  entry_writer: ogu
...
- entry_name: |
    chp'nin artık bölünmesi gerektiği gerçeği
  entry_id:  73513135
  entry_writer: mandir
  entry_fav_count: 1
  entry_content: |
    doğru tespit. bugünkü chp, baykal’ın isim hakkını alarak kurduğu partidir. eski chp kadroları daha çok shp’de toplanmıştı. erdal inönü’nün shp’si sosyal demokrat, avrupa tipi gerçek bir sol partiydi. o zaman kendisinden daha küçük olan chp ile birleşti, sonuçta baykal’ın ayak oyunlarıyla daha küçük olan chp, kendisinden büyük shp’yi yuttu. o zamandan beridir partiden hayır gelmiyor zaten. sıradan milliyetçi, gardrop atatürkçüsü partiye dönüştü. burada bile chp olmazsa sağcı partiye oy vereceğini söyleyen dünya kadar insan var. nereden nereye...
- entry_name: |
    kasım bebek için yardım kampanyası
  entry_id:  73525571
  entry_writer: yujnirayon
  entry_fav_count: 0
  entry_content: |
    destek verilmesi gereken kampanya.
- entry_name: |
    binance
  entry_id:  73522244
  entry_writer: lth
  entry_fav_count: 0
  entry_content: |
    her gun ozel olarak bu basliga bakip referansli link verenleri blokluyorum. boylece coinler ile ilgili basliklarda bu kisilerin yazilarini okumak zorunda kalmiyorum. bu da boyle bir tavsiyemdir. kanalimiz sadece coin paylasimlari icindir, hoscakalin.
---
