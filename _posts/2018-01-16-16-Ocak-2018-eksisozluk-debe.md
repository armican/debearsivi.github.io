...
- entry_name: |
  ...
  entry_fav_count: 125
  entry_content: |
    kendisinden sonra kendimde meydana gelen değişimler gerçekten çok keskin. aslında bazıları da baya kötü ve çoğunun eleştireceği şeyler. neler bunlar;<br/><br/>1 )dinden çok uzaklaştım. hiçbir dini program izlemiyor, dua etmiyor, namaz kılmıyorum. kısacası ibadet namına gerçekleştirdiğim hiçbir eylem yok.<br/><br/>2) ülkemi ve halkımı eskisi kadar sevmiyorum hatta bu ülkeye karşı sevgimi ayakta tutan tek şey atatürk ve çanakkale ruhu. onun dışında iç anadoludaki bir çiftçinin ağlaması sikimde bile değil. herkes beter olsun.<br/><br/>3) türbanlı ve chpli bir anneye sahip olarak ben tüm türbanlı kadınlara karşı muazzam bir ön yargı besliyorum. evet bu hiç hoş bir şey değil hatta akpyi eleştirdiğimiz konuların başında gelen bir madde ama yapacak bir şey yok. truth hurts.<br/><br/>4) dincilerden nefret ediyorum. sakallı bir adam gördüğümde küçük kız kardeşimi taciz edeceklermiş gibi hissediyorum. hatta nedense bunu garanti olarak görüyorum.<br/><br/>5) gazete almıyorum, tv izlemiyorum. <br/><br/>6) beyin göçüne karşı olup, olabildiğince ülkemiz için çalışmayı düşünürken; tası tarağı toplayıp arkama bakmadan ülkeden kaçmak istiyorum.
- entry_name: |
...
- entry_name: |
    işçilere birayla ödeme yapılması
  entry_id:  73518504
  entry_writer: garipbasci
  entry_fav_count: 72
  entry_content: |
    bira hamallık lafı buradan gelmektedir.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 62
  entry_content: |
    (bkz: <a class="b" href="/?q=okuyan%c4%b1+siksinler">okuyanı siksinler</a>)<br/><br/>not : yazarların attığı entry ile konuyu anlamış bulunuyorum ve tekrar ediyorum.<br/><br/>(bkz: <a class="b" href="/?q=okuyan%c4%b1+siksinler">okuyanı siksinler</a>)
- entry_name: |
    canan kaftancıoğlu
  entry_id:  73506300
...
- entry_name: |
  ...
  entry_fav_count: 41
  entry_content: |
    gerçekleri bize gösteren görüntülerdir.<br/>şu olayı savunmaya çalışanlar önce şunun cevabını verin; <br/>yerli filmlerde pek sık duyduğumuz bir söz vardır.<br/><br/>"türk'e aman dileyene el kalkmaz."<br/><br/>görüntülerde bunu görüyoruz.<br/>teslim olmuş, muhtemelen orada ne işi olduğunu dahi bilmeyem masum erlerin 'aman dilemesi'ni.<br/><br/>peki karşılığı nedir? <br/>köprüden atılmak, boğazlanmak, darp edilmek, lince uğramak.<br/><br/>bir de utanmadan bunu savunurken askerleri kötülemek için ya senin de anne babanı öldürmüş olsalardı minvalinde cümleler kuranlar var.<br/><br/>gören de karşılarında fethullah gülen var sanır.<br/><br/>"askerlere o emri verenin, türk askerine o emri verdirecek duruma gelmesini sağlayanlara sandıkta oy atmayı bilirsiniz."<br/><br/>kilit cümle bu.<br/><br/>daha söylenecek birşey yok.
- entry_name: |
    kalçasının üstüne dövme yaptırmanın amacı
  entry_id:  73518993
  entry_writer: ama bak simdi
  entry_fav_count: 35
  entry_content: |
    (bkz: <a class="b" href="/?q=t%c3%bcrk%c3%a7esinin+am%c4%b1na+koyman%c4%b1n+amac%c4%b1">türkçesinin amına koymanın amacı</a>)
- entry_name: |
    nuri bilge ceylan
  entry_id:  73514555
...
- entry_name: |
    meral akşener'e sitem eden musevi asıllı vatandaş
  entry_id:  73519221
  entry_writer: hgzr
  entry_fav_count: 25
  entry_content: |
    amerika'daki yanlı yahudi lobisinden cesaret madalyası alınmasını eleştirmek yahudi düşmanlığı değildir. kimse kimseyi kandırmasın.
- entry_name: |
    chp'li kaftancıoğlu'nun eşi domuz yiyor iddiası
  entry_id:  73505802
  entry_writer: kurbanlikdomuz
  entry_fav_count: 24
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    arkadaşlar ciddi misiniz? çok ender görülen bir olay için beşiktaş'ın görüntüleri kesildi, biraz anlayış! iki senedir ayağına top değmemiş bir <a class="b" href="/?q=adam">adam</a> ilk defa topla buluşuyor.
- entry_name: |
    ekşi itiraf
  entry_id:  73505244
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    kaliteli pop muzik, dogallik, komsuluk. her sey cöp artik.
- entry_name: |
    arif v 216
  entry_id:  73507209
  entry_writer: dergus
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="http://screencrush.com/black-mirror-easter-eggs-connected-timeline-theory/" title="http://screencrush.com/black-mirror-easter-eggs-connected-timeline-theory/">şurada</a> görebileceğiniz üzere 4 sezonun bütün bölümleri bir timeline içerisinde sıralanmış, aynı zamanda bölümlerin birbirleriyle bağlantılı olduğu noktalardan bahsedilmiş. baştan sona okuyunca her şey birbiriyle bu kadar bağlantılı mıymış diye hem şaşırdım hem de verilen emeği takdir ettim. ayrıca ben biziyi neremle izliyorsam artık bu bağlantıların ancak onda birini fark edebilmişim izlerken.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    kendisi <a class="b" href="/?q=onur+%c3%b6ymen">onur öymen</a>’le dersim meselesi sebebiyle tartıştığında ipi çekilmeliydi. <a class="b" href="/?q=onur+%c3%b6ymen">onur öymen</a> ve onun gibi chp’nin kemik kadrosu tasfiye edildi. <br/><br/>sonrasını hepimiz biliyoruz. chp, y-chp oldu. işgal dönemi ne kadar zararlı cemiyet varsa her birini temsil edercesine partiyi vatan hainlerine teslim etti.<br/><br/>def olup gidecek o koltuktan. bu adam gitmeden rte gitmez. devlet bahçeli ile birlikte rte’nin en büyük destekçisi.<br/><br/>düzeltme: onur öymen ismi düzeltildi.
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    destekliyorum yalnız yazar arkadaşa dikkatli ve seri olmasını tavsiye ederim.<br/>rahmetli levent kırca çıtayı çok yüksek bir yere koydu çünkü <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    birbirini seven, sağlıklı iki bireyin yan yana olduğu her yer bir araba kadar heyecan veremez :) <br/><br/>arabanın yeri ayrı. olay public takılmak değil, plansız bir anda hormonların kabarması bir de aşk varsa işin içinde peh diyorum. her dört koltuğu yatırdığında iki kişilik yatak olabilen bir arabam var, renault twingo. bu konuda rahatlık diz boyu, bir de tavanım açılıyor. yaz günü yıldızlar, bir kamp alanı ve sevdicek ile oluşan voltron ancak bu kadar iyi hissettirebilir.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bu sefer iyi parti gençlik kolları genel başkanı'nı terletmeye gidiyoruz. ekşi siyaset'in milliyetçi bıçkınları bi' yanda olacak, soldan bakan hevaller de diğer tarafta. dehşet bi' zirve olacağını garanti ediyorum.<br/><br/>betler açılsın, iyi olan kazansın. <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
---
