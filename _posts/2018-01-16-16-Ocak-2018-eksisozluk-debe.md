...
- entry_name: |
  ...
  entry_fav_count: 34
  entry_content: |
    en son "iş güvenliği uzmanı" furyası çıktı herkes kurslara koştu falan tabi onun da boku çıktı dolayısıyla.
- entry_name: |
...
- entry_name: |
    erdoğan bayraktar'ın para verdiği kızın ölmesi
  entry_id:  73504781
  entry_writer: you are no longer a prisoner of fate
  entry_fav_count: 24
  entry_content: |
    bir kez gönül yıktın ise<br/>bu kıldığın namaz değil<br/>yetmiş iki millet dahi<br/>elin yüzün yumaz değil <br/><br/>bir gönülü yaptın ise<br/>er eteğin tuttun ise<br/>bir kez hayır ettin ise<br/>binde bir ise az değil <br/><br/><a class="b" href="/?q=yunus+emre">yunus emre</a>
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    magnum ile beraber çocukluğumdan beri hala alamayacakmışım gibi bir düşünceye sevkeden ürün.<br/><br/>demek ki bazı şeyler asla değişmiyor. :/
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  73504631
  entry_writer: gecelaciverti
  entry_fav_count: 8
  entry_content: |
    altıgen adlı kafesinde bir yiyecek alıp oturduğunuzda birkaç dakika içerisinde yanınızda kedi beliriyorsa aynı yerdeyizdir.<sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    şimdiki kaburga kemikleri neden kadın olmuyor?
- entry_name: |
...
- entry_name: |
    kemerle dayak yiyen kadının kocasını affetmesi
  entry_id:  73518495
  entry_writer: garipbasci
  entry_fav_count: 3
  entry_content: |
    (bkz: <a class="b" href="/?q=hatunlar%c4%b1n+efendi+adam+yerine+lin%c3%a7+tercihi">hatunların efendi adam yerine linç tercihi</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    çok zamanlı bir zirve. merak edilenler doldu taştı, iyi parti ile ilgilibirinci ağızdan bilgi almak için güzel fırsat. istanbul ayağını da isteruk.
---
