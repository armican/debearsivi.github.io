...
- entry_name: |
    gezi'den sonra insanların eylem yapmaya korkması
  entry_id:  84214956
  entry_writer: gkhns
  entry_fav_count: 87
  entry_content: |
    sebebi basit. can güvenliği yok. bugün bir eylem yapıp, gözaltına alınsanız 2 yıl bedavadan yatarsınız ortada iddianame bile olmadan. sonrasında canları isterse sizi fetöcü yaparlar, bir kaç yılda öyle yatarsınız.<br/><br/>(bkz: <a class="b" href="/?q=korku+imparatorlugu">korku imparatorlugu</a>)
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    su anda yarisan yarismacinin ilgi alanlarinin simdiye kadar 60 bin ettigi yarisma.<br/><br/>adam oyle ki, soyle bir soru cevap yasanabilir:<br/><br/>- hangi dinazorun omurgasi, digerlerine gore zayiftir?<br/>+ simdi murat bey, benim jurassic park'im var. ben baktim, spinolarin boyle bir zayif noktasi var. o yuzden c diyorum
  entry_channels: tv
- entry_name: |
    fenerbahçe
  entry_id:  84194618
...
- entry_name: |
  ...
  entry_id:  84224764
  entry_writer: karga tulumba
  entry_fav_count: 2
  entry_content: |
    babama 175 bana da 35 tl ceza geldi geçen seneden. işin tuhafı ikimiz de bu sene muayene yaptırdık. gelen cezada bu borçların muayeneye engel olacağı yazıyor. ayrıca 2017 nisan ayındaki geçişin cezası nasıl oluyor da aralık 18de kesilebiliyor? <br/><br/>deli dumrul sen misin?
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    <a class="b" href="/?q=lanetli+%c3%a7aylak">lanetli çaylak</a>lığımın bitmesi şerefine burdayım. genelde çalışırım, fazlaca müzik dinlerim, düzenli olarak spora giderim, kalan zamanımda da kitap okurum. <a class="b" href="/?q=ffm">ffm</a> hakkında konuşmak veya bire bir takılmak isteyen hanımefendiler yeşillendirebilir.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    doğa için çal 10
  entry_id:  84210681
