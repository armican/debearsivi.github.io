...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    her şey bir yana akıllı adam. <br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://twitter.com/bjksolidarity/status/1238940246211006476" title="https://twitter.com/bjksolidarity/status/1238940246211006476">twitter</a>
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    galatasaray'ın taraftarsız bir hiç olması
  entry_id:  103566488
  entry_writer: mozambik asilliyim
  entry_fav_count: 9
  entry_content: |
    demek ki türkiye'nin iyi taraftarı da galatasaray tarafıdır. oyuna ve şampiyonluğa doğrudan etkisi vardır...<br/><br/>yani madem öyle bir mantık yürütüyorsunuz, bunun sonucu böyle çıkar.
  entry_channels: spor
- entry_name: |
    komik ad soyad kombinasyonları
  entry_id:  103553022
  entry_writer: cokcocuk
  entry_fav_count: 7
  entry_content: |
    sadik koca
  entry_channels: anket
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    galatasaray'dan 180 dk boyunca gol yememiş kaleci, adamın bu sezon ligde tek gol yemediği takım g.saray oldu<sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    eski sevgilim çok yapardı. restoran sahibi bir yavşağa pardon lavuğa kaçmadım.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    geçen hafta sivasta ve bugün az önce kaçırdığı iki pozisyonla şampiyonluğu vermiş olabilir.
  entry_channels: spor
- entry_name: |
    corona virüsü
  entry_id:  103534871
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    prezervatif ücretsiz olmalı temalı.
  entry_channels: 
- entry_name: |
    korona kadar hızlı yayılan şey
  entry_id:  103566485
  entry_writer: ozgur beyrut
  entry_fav_count: 1
  entry_content: |
    aptallık<br/><br/>karantina diye binlerce insanı yurda koydular. birbirlerinden tecrit etmediler. 1 kişi koronaysa 1000 kişi korona olacak o yurtta.
  entry_channels: anket,sağlık
- entry_name: |
    fatih terim
  entry_id:  103566313
  entry_writer: igorkovayev
  entry_fav_count: 1
  entry_content: |
    sergen yalçını 9 maçta sadece bir kere yenmiş <br/>o da sinan'ın son dakika attığı bala gol , küçük takımlarda sergeni yenemiyorsa , beşiktaş gibi türkiye'nin en büyüğünde hiç yenemez <br/><br/>bugün sergen yalçına taktik olarak cevap veremeyen adanalı
  entry_channels: spor
- entry_name: |
    ekşi itiraf
  entry_id:  103557693
  entry_writer: silenus
  entry_fav_count: 1
  entry_content: |
    son iki rulo tuvalet kağıdım kaldı ve insanlar “aaa bu da stokçuluk” yapıyor demesin diye gidip alamıyorum. <br/><br/>online olarak sipariş edince kurye çocuğun “seni pis stokçu” bakışı ile karşılaşacağımı düşünüp sepete eklediğim halde onay veremiyorum.<br/><br/>yarın iş çıkışı tüm cesaretimi toplayıp alacağım. “elalem ne der” diye yaşamaktan ne zaman kurtulacağıma dair hiçbir fikrim yok..
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    1.zehirli insanları hayatınızdan cikarin<br/>2.sebze yemeklerine yönelim<br/>3.çorba için sarımsaklı limonlu sirkeli<br/>4.sigara kullanıyorsunuz günde 3 e düşürün <br/>5.el yüz hijyeni önemli bol bol sabunlu suyla yıkayın<br/>5.muge anli vs programlar izlemeyin<br/>6.bol bol sevişin..partneri olmayanlar çavuşu tokatlasin(vücut ısısı yükseldikçe mikropları öldürür..terlersin bir duş)sıcacık uyuyun
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    mistik konular, büyü, üc harfliler, fal, astroloji bilimi, astral seyahat, diş çekme, nal çakma, hacemat konularinda sohbete beklerim
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    1994 beyaz şahin sene 2007 o zamanların modası 9-16 borbet jant, set, açık egzost, olimpia yesul cam vardı tam bir çakal arabasıydı. 2 yıl üniversitede o araci kullandım.
