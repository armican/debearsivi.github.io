...
- entry_name: |
    sevgilisine kilo ver diyen erkek
  entry_id:  83083532
  entry_writer: agresifcan
  entry_fav_count: 134
  entry_content: |
    anasını satayım algı ve duyar kanallarınız sadece kadınlar söz konusu olunca çalışıyor. erkeğin:<br/><br/>- giyimine hakaret edilir<br/>- zayıfsa "öyle adama erkek demem anca bacım derim" denir<br/>- kiloluysa "yağ fıçısı, kendine bakmıyor, pis" denir<br/>- spor yapan biriyse "bunun gözü dışarda, çok kaslı, kafası protein tozu dolu" denir<br/><br/>ama söz konusu kadınlar oldu mu kadın her şeyi giyer, istediği kiloda olur, istediğini yapar. karışamazsınız!!! 1!1!1!!bir!! sevgilisi de olsa karışamaz hebele höbölö falan bi değişik hareketler.<br/><br/>bunu destekliyorsanız siz de erkeklere karışmayın arkadaşım. erkek sizi olduğunuz gibi kabul etmek ve saygı duymak zorundaysa aynısını siz de yapacaksınız. bulunmaz hint kumaşı değilsiniz. şu iki yüzlülüğü bi kenara bırakın artık çünkü cidden mide bulandırıyorsunuz.
...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    lütfen metro için rezalet başlığı açmayı bırakın. bıktık artık... bu kadar olaydan sonra metro kullanan insan bir zahmet rezaletini kendi başına yaşasın, bizi alet etmesin.
  entry_channels: anket,seyahat
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    sözlük erkeğinden yana oy verdiğim kıyaslama... hatta ınstagram bile kullanmayan, en kuul olandan yana <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup> bunca görünür olma hevesimiz zayıflıktan başka şey değil çünkü.
  entry_channels: ilişkiler
- entry_name: |
    jet sosyete (dizi)
  entry_id:  83103206
  ...
  entry_fav_count: 3
  entry_content: |
    dizide gülse'nin karakteri 'zengin kocayla evlenen embesil genç kadın' ve bu karakterin ülkede oturduğu isim şeyma subaşı. kaldı ki dizide gülse en azından bir aralar manken olduğundan bahsediyor. şeyma'da o da yok, kadın vasıfsızın önde gideni. dizinin en komik kısmı da bu bence.<br/><br/>bir tv8 dizisi.
  entry_channels: tv,spoiler
- entry_name: |
    %a çarpı %b'nin hiçbir zaman %100 etmemesi
  entry_id:  83102977
  entry_writer: aynshinqaf iki
  entry_fav_count: 3
  entry_content: |
    ilginç bir matematik "sorunsalı" değildir. 1+3'un hiçbir zaman 5738 etmemesi kadar ilginç olabilir en fazla.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    doğduğum an heralde çünkü en son o zaman mutlu oldum...
