...
- entry_name: |
  ...
  entry_fav_count: 138
  entry_content: |
    birkaç gün önce esenboğa havaalanına 2-3 kez git-gel yapmam gerekti. gün içerisinde 200 km kadar yol yaptım.ilk defa bir gün içerisinde bu kadar yol yaptığımdan, yol boyunca sıkıntıdan gözlemledim.. aracımın dibine kadar yapışıp arkadan selektör yakarak geçmeye çalışan, makasa giren, virajda sollama yapmaya kalkan ne kadar araç varsa istisnasız hepsi bmw'ydi. ekseriyetle 320 ve 520 (birkaç tane 116'ya da denk geldim)<br/><br/>araçlar güzel onlara lafım yok da. marka, barzoluğun resmi sponsoru olmuş durumda.
- entry_name: |
    avukat şımarıklığı
  entry_id:  68808600
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    'geçenlerde şey oldu' diyerek mevzuya girmek. halbuki bir bok olduğu yok.
- entry_name: |
    ekşi itiraf
  entry_id:  68796919
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    o dökülen kömür ya da odun her neyse onu her sabah 5 kat indirip kömürlükten kömür doldurarak 5 kat çıkarmanın acısını muhtemelen şimdi bel ağrısı olarak çekiyorum. zor günlerdi. ama çok mutluyduk be abi. o sobada pişirilen kestanenin tadını, o sobanın sıcaklığını ve o soba yanan odadan çıkıp tuvalete gitmenin ızdırabını hiç bir zaman bulamadım hayatta(:
- entry_name: |
...
- entry_name: |
    hem erkeklere hem kadınlara hitap eden oyunlar
  entry_id:  68812571
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    ataol behramoğlu'na göre; "<a class="b" href="/?q=a%c5%9fk+iki+ki%c5%9filiktir">aşk iki kişiliktir</a>", atilla ilhan'a göre tek kişiliktir; "<a class="b" href="/?q=pia">pia</a>" kimi romantikler üç kişilik yaşar; "<a class="b" href="/?q=sen%2c+o+ve+sezen+aksu">sen, o ve sezen aksu</a>", edip cansever çoğullaştırır; "<a class="b" href="/?q=yer%c3%a7ekimli+karanfil">yerçekimli karanfil</a>", cemal süreyya ise son noktayı koyar ve şöyle der;<br/><br/>daha nen olayım isterdin<br/>onursuzunum ya<br/><br/><a class="b" href="/?q=a%c5%9fk+ki%c5%9filiksizdir">aşk kişiliksizdir</a>
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    ''ofise gelmene gerek yok, evden çalışabilirsin''
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=ben+%c3%bcst%c3%bcme+rahat+bir+entry+al%c4%b1p+geliyorum">ben üstüme rahat bir entry alıp geliyorum</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    film buyunca beni şaşırtan tek şey bu tom hayvanının otuzbeş yıldır hala nasıl değişmeden kalabildiği oldu. onun dışında sıradan bir film olduğunu söyleyebilirim.
- entry_name: |
    gecenin şarkısı
  entry_id:  68797929
  ...
  entry_fav_count: 0
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/-JpY8__-kNY" title="https://youtu.be/-JpY8__-kNY">beni hatırla</a>
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=amokachi">amokachi</a>) <br/><br/>o dönem yabancı sınırı şimdiki gibi olsaydı fenerbahçe alırdı(çünkü 3 futbolcu ile de ilgilenmiş sınırdan dolayı ikisini almıştı) ve uche-okocha-amokachi 3lüsü ile avrupa'da final bile oynardı
---
