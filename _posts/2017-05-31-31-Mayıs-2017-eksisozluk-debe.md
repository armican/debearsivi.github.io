...
- entry_name: |
  ...
  entry_fav_count: 26
  entry_content: |
    medya sektöründen birinin yazdığını görmediğim başlık. bu sebeple gençlere bilgi vermek istedim.<br/>sektör: medya<br/>şirket: haber kanalı<br/>pozisyon: program yapımcısı, sunucu<br/>tecrübe: 9 yıl<br/>çalışma saatleri: her hafta programı yetiştir de nerde çalışırsan çalış<br/>maaş: 6.700 tl + yemek + yol + faturasını getirdiğin takdirde kitap ve dvd<br/>artıları: kendini gerçekten geliştirmek isteyene sınırsız imkanlar sunan bir meslek <br/>eksileri: özgür bir şekilde haber ya da program yapamamak ve bunu ister istemez içselleştirerek otosansür uygulayacak duruma gelmek
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    --- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>5.bölümde efsane göndermeler vardı. karakterin medya olarak david bowie tipi ile arzı endam etmesi ve konuşurken şarkılarına gönderme falan yapması iyiydi. onu geçtim daha önemlisi bahsettiği mars istilası zamanında medya için magic bullet teorisinin ortaya çıkmasını sağlayan bir radyo programı. orson welles'in dünyalar savaşı romanından bir kesiti gerçekmiş gibi radyoda okumuşlardı. millet inandı ve cidden herkes sokağa döküldü. inanılmaz şekilde inanmıştı millet. bu olay medyanın verdiği mesajın çok hızlı bir şekilde direk yayıldığını gösteriyordu. o yüzden adı büyülü mermi. gerçi sonra paradigma kırıldı. medya mesajı iki aşamalı olarak yayılıyor falan dendi. ohio seçimlerinde gözlemlendi bu olay. ama o ayrı konu. <br/><br/>diğer ilginç kısım ise, orson amcamızın o zamanlar kendine ait radyo programı var. adı da ne tesadüf ''the shadow'' harbiden iyi bölümdü<br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    her halükarda izmir marşı kazanacak.
- entry_name: |
    bursaspor
  entry_id:  68498560
  ...
  entry_fav_count: 1
  entry_content: |
    "düşürün bu takımları" diye ucube bir argümanla küme düşmemesi gerektiği savunulan takım. kimmiş kardeşim bu düşürecek olanlar. bursaspor camiası adam olsaydı da futbolcularını dövdürtmeyip, top oynatıp kümede kalsaydı. beşiktaş üzerinden mastürbasyon yapan kertenkelelere su veren itfaiyenin hortumunu seveyim.
- entry_name: |
    netflix türkiye
  entry_id:  68491862
  ...
  entry_fav_count: 0
  entry_content: |
    aylık ücreti, bir paket sigaradan, bir adet sinema biletinden, bir adet dürüm dönerden falan daha ucuzdur.
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    uykuyu tatlı bir sohbete değişmek isteyenler....<br/><a rel="nofollow noopener" class="url" target="_blank" href="http://connected2.me/yazarkafka">http://connected2.me/yazarkafka</a>
---
