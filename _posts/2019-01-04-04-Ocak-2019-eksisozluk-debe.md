...
- entry_name: |
    3 ocak 2018 özgür demirtaş tweet'i
  entry_id:  85083633
...
- entry_name: |
  ...
  entry_fav_count: 78
  entry_content: |
    1 litre rakının vergisi 154 tl olmuştur.<br/><br/>rakılı vergi için kaldıralım kadehlerimizi.<br/><br/>şerefsizliğinize..
...
- entry_name: |
  ...
  entry_id:  85059737
  entry_writer: aidiyet duygusu
  entry_fav_count: 48
  entry_content: |
    (bkz: <a class="b" href="/?q=eski+sevgiliyle+yeniden+ba%c5%9flamak">eski sevgiliyle yeniden başlamak</a>)
...
- entry_name: |
  ...
  entry_fav_count: 32
  entry_content: |
    (<a class="b" href="/entry/85056516">#85056516</a>) sana duyar kasma demiyorum ama haksızlık karşısında önce bıçakla yaralama daha sonra da ateşli silahla adam öldüren adamın masumiyet karinesinden bahsetme. işte senin gibi tipler hakim olduğu zaman kravat takınca iyi hal indirimi veriyorlar.<br/><br/>ortada kendi can güvenliğini tehlikeye düşürecek bir durum yoksa öldürmeyecek arkadaşım, şiddete başvurmayacak. başvurdun mu linci de yersin küfrü de.<br/><br/>ha maktul çekmecesinde silah olmadığını nereden biliyorsun da dersin sen şimdi.
  entry_channels: haber
- entry_name: |
    volkan demirel
  entry_id:  85063771
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    an itibariyle knight online binlerce private server oynayan oyuncuyu farkedip, version 1299 server için geri sayım başlatmıştır. at fav'a bekle.<br/><br/>edit: imla
  entry_channels: oyun
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    benim vatandaşım afedersiniz zombinin kıçına atleti tıkamak suretiyle etkisiz hale getirmiştir
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    "esen yelde senin kokun var" <br/><br/>(bkz: <a class="b" href="/?q=bundan+%c3%b6te+ayr%c4%b1l%c4%b1k+var">bundan öte ayrılık var</a>)
  entry_channels: anket,müzik
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    (bkz: <a class="b" href="/?q=sedat+sana+laflar+haz%c4%b1rlad%c4%b1m+s%c3%b6zl%c3%bck+hakk%c4%b1nda">sedat sana laflar hazırladım sözlük hakkında</a>)
  entry_channels: magazin
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    nasil trafik cezalarinin artisi insan guvenligi icin degilse, bu posetlerin de parayla satilmasi cevre icin degil. hatta bunlardan gelecek paralarin fakirlere dagitildigini soyleyecek kadar omurgasiz ve yalanci politikacilarin bu isi yaptiklarini dusunursek "olay edilememsi" en hafif tabiriyle saflik, dogru tabiriyle salaklik olur.<br/><br/>isterseniz cuvalla gidin umrumda degil ama gericilerin bir uygulamayi insanlarin iyiligi icin yapiyor oldugunu soyleyip kafa sikmeyin.
