...
- entry_name: |
    bu millete 25 kuruş kadar hiç bir şey koymamıştır
  entry_id:  85077298
  entry_writer: arkanabakmassankuserim
  entry_fav_count: 83
  entry_content: |
    asıl batan şey, verdikleri paranın nereye gittiğini görmeleri<br/><br/>ah ulan ah,,keşke aynısı vergilerde olsa<br/><br/>mesela, bir siyasi kafayı kırıp; <br/><br/>bundan böyle size maaşlarınızı brüt ödeten sistemi getiriyorum, al asgari ücretli maaşın 2,558 lira, sen her ay sonunda beyanname doldurup , bunun xxx lirasını gelir vergisi, yyy lirasını sgk primi, zzz lirasını carta zzz lirasını curta yatıracaksın....ve sana kala kala 2,020 lira kalacak...her ay bana, beyanname doldurup, 538 lira geri vereceksin...<br/><br/>dese<br/><br/>en fazla 10 sene içinde, koyun memlekettten, her kanun için her karar için hesap soran bir kitleye dönüşürüz. <br/><br/>ah ulan ah..<br/><br/>mesela her alışverişte etikete vergisiz fiyat yazılsa, sen kasaya gidince verigisi eklense...<br/><br/>ah ulan ah.<br/><br/>keşke benzin, keşke alkol, keşke sigara vergisiz fiyattan satılsa, etiketlerde...sen kredi kartını uzatınca görsen asıl vergiyi...<br/><br/>10 sene bile değil 10 ay içinde, toplumsal bilinç 100 sene ileriye gider amk<br/><br/>edit. imla
  entry_channels: ekonomi
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 71
  entry_content: |
    ''mezardaki, en az yüzde 50 evliyayı zor tutuyorum.''
  entry_channels: siyaset
- entry_name: |
    burak yılmaz
  entry_id:  85059335
...
- entry_name: |
  ...
  entry_fav_count: 46
  entry_content: |
    istanbul-fatih’te, uzungöl’de, ayder’de türkçe tabela kalmadı neredeyse, gelmiş edirne’deki turizm afişi diyor.<br/>taksim’de bayrak açanlara kas bu milliyetçiliğini delikanlı.
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    jennifer lawrence'ın habertürk'te spiker olması
  entry_id:  85085707
  entry_writer: galaios
  entry_fav_count: 24
  entry_content: |
    uzmanlar, yılda en az bir kere göz doktoruna muayene olmanızı tavsiye ediyor. başlığı açan arkadaş bunu bir değerlendirsin.
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    (bkz: <a class="b" href="/?q=mefat+itti">mefat itti</a>)
  entry_channels: 
- entry_name: |
    çaylak onay listesi
  entry_id:  85070537
...
- entry_name: |
    turizm bakanı'nın koyu kendi için imara açması
  entry_id:  85087016
  entry_writer: nikkalmamisla
  entry_fav_count: 3
  entry_content: |
    (bkz: <a class="b" href="/?q=%c3%bclkeyi+%c5%9firket+gibi+y%c3%b6netmek">ülkeyi şirket gibi yönetmek</a>) sorun değil de, esas sorun (bkz: <a class="b" href="/?q=%c3%bclkeyi+mafya+gibi+y%c3%b6netmek">ülkeyi mafya gibi yönetmek</a>)<br/><br/>mafyatik hareketlerdir. mafya, kanunsuzluk demektir, kanunları kendi çıkarları için eğip bükmek demektir. turizm deyip geçmemek lazım, yarın elindeki tarlaya el koymak için beyaz torosla alıp ormana gömerler, o zaman "ben ne bok yedim?" diye sorarsın kendine.
  entry_channels: siyaset,haber,ekonomi
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    şenol güneş tarafından kamp kadrosuna alınmayan futbolcu. quaresma gönderilecek bari hazır gitsin diye kamp kadrosuna son anda dahil edildi, babel'in takımda kalıp kalmayacağı belli değilken neden bu kadar kolay harcandığını merak ediyorum. adam sezon başında da kamp yüzü görmedi şimdi de götürmüyorsunuz. adamın sakatlığı varsa çıkın açıklayın, gidecek kanat oyuncularının yerine yenilerini alacağız diyin. gideceklerin yerine yeni futbolcu almayacaksanız orada kendiniz mi oynayacaksınız bunlara bir cevap verin.
  entry_channels: spor
- entry_name: |
  ...
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    03.01.2019 manisa'da yapılan swinger baskını
  entry_id:  85088579
  entry_writer: başlık taşıyan
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=3+ocak+2019+manisa%27da+yap%c4%b1lan+swinger+bask%c4%b1n%c4%b1">3 ocak 2019 manisa'da yapılan swinger baskını</a>)
  entry_channels: haber
---
