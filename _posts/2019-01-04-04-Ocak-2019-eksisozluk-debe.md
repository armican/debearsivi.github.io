...
- entry_name: |
  ...
  entry_channels: haber,eğitim
- entry_name: |
    kaygısızlar vs sıdıka vs tatlı hayat vs 7 numara
  entry_id:  85076309
  entry_writer: trendline
  entry_fav_count: 50
  entry_content: |
    gözlerin <a class="b" href="/?q=bir+demet+tiyatro">bir demet tiyatro</a>'yu aradığı versus zinciri. size <a class="b" href="/?q=sald%c4%b1ray">saldıray</a>'ı yedirmeyiz...<br/><br/>(bkz: <a class="b" href="/?q=%c5%9furdan+%c5%9furaya+sevi%c5%9fmek+nasip+olmas%c4%b1n">şurdan şuraya sevişmek nasip olmasın</a>)
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    siyah beyaz<br/>gaga manjero<br/>kıtır<br/>dost kitabevi <br/>serender pastanesi<br/>büyülüfener<br/>akün<br/><br/>peşin edit: 30 yıllık ankaralıyım efem.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=emrah+serbes+okuyucusu+olarak">emrah serbes okuyucusu olarak</a>) <br/><br/>hayırlı forumlar.
