...
- entry_name: |
  ...
  entry_fav_count: 250
  entry_content: |
    en büyük talihsizliği türkiye'de doğması ve burada bilim yapmasıdır. <br/>rusya'da rus bilimler akademisi başkanı olurdu, avrupa'da büyük bir doğa tarihi müzesi başında olurdu.<br/><br/>buradaysa yobazlara laf anlatmakla meşgul. <br/>doğa bilimci bir türk. danışman hocam.<br/><br/>not: bu adam 33 bin kitaplık bir kütüphaneye sahip. anadolu'daki üniversitelerde bu kadar kitap yok.
...
- entry_name: |
  ...
  entry_fav_count: 34
  entry_content: |
    o kadar çok işi maaş almadan yapmaları.
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    uyuz olunan hocanın kızını 6 ay taciz etmek
  entry_id:  95947922
  entry_writer: suntii
  entry_fav_count: 11
  entry_content: |
    şu tip nasıl taciz edebilir deyip olayı normallestirmemek lazim.<br/><br/>bu ülke muhabbet kuşu tipli seri katil gördü.
  entry_channels: 
- entry_name: |
...
- entry_name: |
    duş almayan deodorant ve parfüm kullanmayan erkek
  entry_id:  95923413
  entry_writer: siyahkotlu
  entry_fav_count: 9
  entry_content: |
    diş de fırçalamaz böyleleri, sanki ağzında fare ölmüş gibi kokar hiç de rahatsız olmaz.<br/><br/>otobüse binmek istemiyorum artık ya..
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    normal yayın zamanında izlemediğim ve tavsiye üzerine başladığım <a class="b" href="/?q=ezel">ezel</a> dizisinin 34. bölümünü açtım bugün ekranda bir hata mesajı;<br/><br/>bulunduğunuz ülkede bu içerik izlenememektedir. <br/><br/>kafamı kaldırdım dışarı baktım ulan istanbul burası! meğer künyeyi görmüş diyerek bir cem yılmaz esprisi sıkıştırayım meğer yayından kaldırılmış. ulan bu ezel paraguay'da izlensin diye mi çekildi.
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    aldatmanın popülerleşmesi
  entry_id:  95933622
  entry_writer: barkap
  entry_fav_count: 5
  entry_content: |
    tuhaf bir tespit.<br/><br/>popülerleşme deyince böyle sanki dalga dalga aldatma akımları geliyormuş, gençler aldatma partileri yapıp bina önünde kuyruk oluyormuş gibi bir şey canlandı gözümde. kimsenin birilerinden görüp sırf moda diye yaptığını sanmıyorum.<br/><br/>aldatma olayı, geçmişte var olduğu gibi yüz yıl sonra da var olacak. sıradanlaşma derseniz ona hak veririm. sebebini de bozulan ahlaki değerlere bağlarım. insanlar, özgürlük kavramını her istediğini yapmak zannettikleri için bu oluyor. aslında ilkokulda öğretilen bilgidir özgürlüğün başkalarının hakkının başladığı yerde bittiği. yani sen birlikte olduğun insanı sırf canın öyle istedi diye aldatamazsın. bunun adı, eşinin bu durumdan zarar görme ihtimaliyle birlikte -ki öğrense zarar görecek- özgürlük olmaktan çıkıyor. burada ahlakımızın devreye girmesi gerekiyor normalde ama o da bozulmuş olduğu için işlevsiz kalıyor. bizi hayvandan ayıran sayılı şeyden birinin bozulması işte tam olarak bu şekilde sonuçlanıyor. aldatmayı değişik aromalı cips almakla veya yakıt tüketimini karşılaştırmak için farklı firmadan benzin almakla bir tutmaya başlıyoruz. halbuki konu, özünde çok farklı.
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    siyah zeytin.<br/><br/>böyle bol yağlı ve limon sıkılmış.
  entry_channels: anket,yeme-içme
- entry_name: |
    beşiktaş
  entry_id:  95950065
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    abdullah avcı türkiye'nin pep guardiolasıdır
  entry_id:  95949969
  entry_writer: dominar rygel xvi
  entry_fav_count: 1
  entry_content: |
    kendisinden ancak kek guardiola olur. tam enseye tokat atıp ağzından kekini kapmalik hocadır. son 2 sezonda fatih terim keki alıp yemiştir.
  entry_channels: spor
- entry_name: |
    şu an okunan kitap
  entry_id:  95949795
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    yalnızca 165den kısa, hanım hanımcık görünüp içinde bir şeytan yatan çaylarlar bekleniyorsunuz ;)
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bu hafta takımı düşürdüğü durumdan sonra kendisini seçecek bir üyeler topluluğu varsa kulübümüzde, biz zaten bu durumları hak ediyoruz.
  entry_channels: spor
---
