...
- entry_name: |
  ...
  entry_fav_count: 261
  entry_content: |
    eymen<br/>eymen efe<br/>hira<br/>hiranur<br/>esila <br/>aleyna<br/>ebrar<br/><br/>bu isimler inanılmaz itici.özellikle eymen.cennetin 7 kapısından birinin adı diye bu ismi çocuguna koyup ahirette özel muamele görceğini sanan kişiler 2015 ten beri çocuklarına eymen ismi koyuyor.yeter bi lan artık sizin yüzünüzden ortalık eymen den geçilmiyor hey man!
- entry_name: |
...
- entry_name: |
    seks esnasında ehonomi çoh eyi diyen kız
  entry_id:  75803936
  entry_writer: atletico mardin
  entry_fav_count: 183
  entry_content: |
    sikildiğinin farkında değildir
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 91
  entry_content: |
    alenen aptallık yapan kadındır. kocamın ayaklarını gerekiyorsa yıkarım, sağlıktır hastalıktır.<br/><br/>ancak beni böyle çekip sosyal medyada yayınlarsa dalga geçer gibi, ağzına sçarm.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    insanın başına bişi gelirse ya merağdan ya yarağdan demişler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    (bkz: <a class="b" href="/?q=akp+gen%c3%a7lik+kollar%c4%b1">akp gençlik kolları</a>)
- entry_name: |
...
- entry_name: |
    7 nisan 2018 ışınlanma makinesinin icadı
  entry_id:  75804705
  entry_writer: 260611
  entry_fav_count: 11
  entry_content: |
    menteşeli ışınlama makinesidir. ışınlanmadığınız zamanlar yoğurt mayalayabilirsiniz. ama bir hevesle alıp bir iki ışınlanıp sonra balkona koyarsınız. benden demesi.
- entry_name: |
...
- entry_name: |
    türk muhalifinin isyan etmeme sebebi
  entry_id:  75802568
  entry_writer: bocekim
  entry_fav_count: 7
  entry_content: |
    iktidar ile gizli bir işbirliği içerisinde olmasından kaynaklanmaktadır.<br/><br/>bu ülkede 1 günde 2.5 milyon mühürsüz oy kabul edildi. kimse mühürsüz oylar neden sayılıyor diye sormadı. ne muhalefeti?
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    sonsuz yaşama isteğim olmadığı için umrumda olmayan olay.
- entry_name: |
    mahzuni şerif türkülerinde geçen kahreden sözler
  entry_id:  75795594
  entry_writer: ysam
  entry_fav_count: 7
  entry_content: |
    tek kaşıkla çorba içer dördümüz<br/>kul başından ırak ola derdimiz<br/>senden benden asker ister ordumuz<br/>candan da mı yeğdir para doktor bey<br/><br/>(bkz: <a class="b" href="/?q=doktor+bey">doktor bey</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    sampiyon olmasi halinde 16 besiktasli kardesime 6 şar ay beleş iptv verecegim takimim. <br/>edit.<br/>sözünde durmayan toptur. <br/>tek sart eksi sozluk yazari olmak ve ilk 16 kişi arasinda olmak.
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    bu arada babanın söylediğine göre çocuğun hayatını kaybetme riski varmış, bugün tansiyonunu ölçmüşler ve 7lerde imiş. gerçekten üzüldüm. bizler hiç olmazsa birkaç gün gündemde tutsak gerekli yerlere ulaşır diye düşünüyorum.
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    bir çift meme neyinize yetmiyor da paragraflarca entry kasıyorsunuz bre fularlılar
- entry_name: |
    göztepe taraftarı
  entry_id:  75801969
  ...
  entry_fav_count: 4
  entry_content: |
    35. dakikada atkı açıp çığlık attılar o ana kadar stada geldiklerinden bile haberim yoktu, allah allah aynı maçı mı izledik acaba.
- entry_name: |
    erkek tıraşının şaka maka 20tl olması
  entry_id:  75804307
  entry_writer: medeniyet
  entry_fav_count: 4
  entry_content: |
    bugün itibariyle benim de yüzleştiğim gerçek. şakayla karışık "hayırdır yav ne bu zam" dedim, "abi enflasyon malum, ehehehe" dedi. ha bi de berberler odası mı ne belirliyormuş fiyatı. duvara asılı pembe çerçeveli bir tablo gösterdi ama gözlerim miyop olduğu için inceleyemedim. teşekkür ettim, ayrıldım. <br/><br/>bundan böyle 20 tl. vay be. 3 yıl önce aynı berber aynı traşa 10 lira alıyordu. şimdi 20. 3 yılda %100 zam. 3 yılda benim maaş %25 artmış. <br/><br/>neyse yav. <a class="b" href="/?q=ehonomi+%c3%a7o%c4%9f+eyi">ehonomi çoğ eyi</a>.
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    selamun aleyküm, <br/><br/>ulan senin erkekliğini sikeyim. insan hiç zümresine gelip de sınav başarı ortalaman benimkinden yüksek olursa kaldıramam der mi? orada yds öğretmenliği yaptım, burada uçtum kaçtım diye hava atıyordun. başarısız oluyorsun işte, neyin hasetliği ya. siktir git <a class="b" href="/?q=do+your+best">do your best</a>.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    enigma-sadeness.<br/><br/>not: sevişmiyorum :/
- entry_name: |
    kelebekler
  entry_id:  75778317
  ...
  entry_fav_count: 0
  entry_content: |
    bazı filmler vardır, o kadar normaldir, öyle içindedir, içinde gibisindir ki, film bitince hala kendini bir film sahnesinde gibi hissedersin.<br/><br/>işte öyle bir film.
---
