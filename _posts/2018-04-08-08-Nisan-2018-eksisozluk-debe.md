...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    iki sezondur (biri başakşehir, biri beşiktaş formasıyla) taş gibi top oynuyor. beğenmeyenler bizzat siktir olup gidebilir bence.
- entry_name: |
    jeremain lens
  entry_id:  75797829
  entry_writer: gaizer
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    6 gol atmayarak bugün takımının yenilmesine sebep olmuş oyuncu. yazıklar olsun böylelerine
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    altyapı takımlarından biri, <a class="b" href="/?q=alt%c4%b1nordu">altınordu</a>'nun akli melekerini yitirmiş yöneticilerinden dolayı katıldıkları turnuvadan ihraç edilen kulüp. <br/><br/>sadece ülkemizde yaşanabilecek bu saçmalık neymiş bir bakalım; (bkz: <a class="b" href="/entry/75793959">#75793959</a>)
- entry_name: |
    başakşehir şampiyonluğunu kim kutlayacak sorunsalı
  entry_id:  75789705
  entry_writer: jenga06
  entry_fav_count: 0
  entry_content: |
    dün tribünlere baktım az da olsa bir taraftar grubu oluşmuş. kim bunlar? gerçekte hangi takımlı diye kendime soramadan edemedim.
---
