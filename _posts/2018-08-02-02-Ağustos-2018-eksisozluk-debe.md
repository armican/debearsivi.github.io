...
- entry_name: |
    hulusi akar'ın intikam yemini etmesi
  entry_id:  79786398
  entry_writer: kalemi kilicindan keskin olan adam
  entry_fav_count: 486
  entry_content: |
    devlet; vatandaşını korumakla mükelleftir, can veren vatandaşının ardından intikam yemini etmekle değil.<br/><br/>gelen onlarca tepki üzerine edit:<br/>yol yaptık diye övünmeyeceksin. o yolların güvenliğini sen sağlayacaksın. yola mayın, tnt, eyp mi döşeniyor?<br/>bunun üzerini asfaltla örten hangi belediye? tut kulağından ve al o başkanları. valiye kadar uzat elini. sor hesabını.<br/>nihayetinde bu eyp, 5 dakikada döşenmiyor. o yol trafiğe kapatılıyor. işte o yol trafiğe kapatıldığında, senin haberin olmuyorsa devlet orada yok demektir. acı ama gerçek. ve bunun vebali de siyasilerin omuzlarındadır.<br/>sırf kendi siyasi düşüncenizi savunmak adına kalkıp zırvalamayın. bu kadar alçalmayın, düşmeyin. <br/>can gidiyor can. siz makamda oturanların götünü yalamakla meşgulsünüz hala.
...
- entry_name: |
    kardeş oldukları pek bilinmeyen ünlüler
  entry_id:  79786122
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=ETxmCCsMoD0" title="https://www.youtube.com/watch?v=ETxmCCsMoD0">abba - money, money, money</a>
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    fenerbahçe’nin 19 şampiyonluğu vardır, 18 değil. tiner kullanımı hızla artıyor.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ögrencilerinin kendilerini sanatci zannettigi ama sanatla alakasi olmayan bölüm.<br/><br/>(bkz: <a class="b" href="/?q=zanaat">zanaat</a>)
...
- entry_name: |
  ...
  entry_id:  79784052
  entry_writer: leonardo
  entry_fav_count: 0
  entry_content: |
    <a class="b" href="/?q=k%c3%bcl+tigin">kül tigin</a> - <a class="b" href="/?q=kayg%c4%b1s%c4%b1zlar">kaygısızlar</a>
