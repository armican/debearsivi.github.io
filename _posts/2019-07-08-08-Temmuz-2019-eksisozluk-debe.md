...
- entry_name: |
    içine girilince oh be denilen şeyler
  entry_id:  92274969
  entry_writer: kemostapi
  entry_fav_count: 115
  entry_content: |
    aradığım entryi bulamamak. <br/><br/>(bkz: <a class="b" href="/?q=vajina">vajina</a>)
...
- entry_name: |
  ...
  entry_fav_count: 77
  entry_content: |
    kalabalık bir ortamda tek başına yemek yemek.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    hdp'nin oylarıyla koltuklarınızda oturacaksınız
  entry_id:  92268548
  entry_writer: aboboyt
  entry_fav_count: 27
  entry_content: |
    william göttingen’in meşhur sözünü aklıma getirmiş önerme;<br/><br/>“sizin hakkınızda başkalarının dediği her şey doğrudur.”<br/><br/>o nedenle hdpli vekilin bu iddiasını, ergenekon davasına gizli tanıklık eden pekekeliler kadar ciddiye alıyoruz.<br/><br/>edit: ironiden anlamayıp william göttingen’i google’dan aratan, insanların sizin hakkında tüm söyledikleri doğrudur sözünü bile sorgulamaktan aciz gençlere selam olsun. işte 17 yıldır türk eğitim sisteminin geldiği nokta ve yetiştirdiği ürünler...
  entry_channels: 
- entry_name: |
    hasan sel
  entry_id:  92269700
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    trafik kavgası için tavsiyeler
  entry_id:  92266876
  entry_writer: leytirain
  entry_fav_count: 11
  entry_content: |
    abi durmayın basın gidin ülke gerizekalı dolu yol verme tartışması bile ölümle sonuçlanıyor.<br/><br/>edit baktınız kaçış yok şahısta sopa vs. varsa ve üç dört kişiyle size saldıracak durumdaysalar delikanlılık muhabbeti yapın belki bir kişi dalar.<br/><br/>silah tornavida bıçak vb. gördüysen hiç arabadan inme üstüne sür pezevengin.
  entry_channels: anket,ilişkiler
- entry_name: |
    ekşi itiraf
  entry_id:  92254136
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    bu başlık altında biri gelmiş mustafa cengiz’i küçümsüyor aklınca nizipli çomar falan yazmış.mülkiye mezunu eski bir bürokrata diyor bunu.konuşmayı bilmiyor demiş üstelik.ya adamın bir tane açıklamasını bile dinlemedin ya da daha kötüsü söylediklerini anlayacak kapasiten yok.fener taraftarlarının bir bölümü gerçekten rezil
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    boy, post, heybet, 658 yıllık gelenek...<br/><br/>bizim ülkede birazcık akıl olsa şu adamı yağlı güreşin yüzü yaparlar. uluslararası fuarlara vs gider. yağlı güreşin dünyada tanıtımına katkı sağlar. fizik, yakışıklılık, başarı... her şeyi var. boktan boktan şeylere mlyonlarca lira tanıtım parası harcıyoruz. ata sporumuzun başpehlivanına verilen para 52 bin tl. sıradan bir türkiye ikinci lig futbolcusunun bir aylık maaşı kadar.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  92289456
  entry_writer: behlulveznedar
  entry_fav_count: 4
  entry_content: |
    sayın bakanımız'ın sandalye üzerinden "arkadaşlar" diye bağırması ve kimse tarafından ciddiye alınmaması durumu<br/><br/>videonun kim tarafından nerede çekildiği ve yaşanan olaylar hakkında hiçbir bilgi yok henüz.<br/><br/>ayrıca cumhurbaşkanı'da kameraya yansıyor ve önünde birinin bayıldığı görünüyor.<br/><br/>video: <a rel="nofollow noopener" class="url" target="_blank" href="https://twitter.com/MahirAcemi/status/1147927624687247366?s=19" title="https://twitter.com/MahirAcemi/status/1147927624687247366?s=19">https://twitter.com/…tatus/1147927624687247366?s=19</a>
  entry_channels: siyaset
- entry_name: |
    türkiye'de gereğinden fazla olan şeyler
  entry_id:  92288130
  entry_writer: herneyyse
  entry_fav_count: 2
  entry_content: |
    lokmacı
  entry_channels: anket
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=haks%c4%b1zl%c4%b1k+kar%c5%9f%c4%b1s%c4%b1nda+susan+dilsiz+%c5%9feytand%c4%b1r">haksızlık karşısında susan dilsiz şeytandır</a>)
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    aman biz çıktık ta noldu. otobüslerde ağlattılar, metrolarda kırdılar kalbimizi. haklısın bacım madem öyle de böyle de ağzına sıçıyor aşk insansın, bari naaşını kapıya kadar bıraksınlar hiç değilse.
  entry_channels: anket,ilişkiler,otomotiv
- entry_name: |
    çaylaklardan mesaj bekleyen yazarlar veritabanı
  entry_id:  92253969
  entry_writer: dr cooper
  entry_fav_count: 0
  entry_content: |
    kendine eğlenceli olma konusunda güvenen arkadaşları bekliyoruz. sıkıcı bir cumartesi gecesi oldu...
  entry_channels: ilişkiler,ekşi-sözlük
- entry_name: |
    iki sevgili arasındaki mide bulandırıcı yazışma
  entry_id:  92274543
  entry_writer: kime diyom
  entry_fav_count: 0
  entry_content: |
    ben geçenlerde iş arkadaşımın telefonuna gelen mesajını okudum adamın karısı şey yazmış.<br/><br/>- teşekkürler totosu düzüşüm. <br/><br/>bu mesajı anlamak için biraz düşündüm ve midem bulandı. bu ne lan dedim. <br/><br/>ve tekrar düşündüm acaba arkadaşım karısına ne diye hitap ediyor diye tekrar midem bulandı.<br/><br/>sizi gidi sapıklar sizi...
  entry_channels: ilişkiler
---
