...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    babanın parasını mi harciyosun pezevenk ?
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    ne güzel lan adamlarda başbakan falan değişiyor kıskandım valla. umarım türkiye ile sınırını bilerek barışçıl bir siyaset izlemeye çalışır.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
    premier league trt spor'da
  entry_id:  92292379
  entry_writer: sacr0
  entry_fav_count: 1
  entry_content: |
    sadece cumartesi günleri haftada 1 adet maç yayınlayacak trt spor. o maç da saat 17:00'da oynanacak olan maç olacak. güzel bir hamle fakat büyütüldüğü kadar da önemli bir olay değil
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: ilişkiler,ekşi-sözlük
- entry_name: |
    ingiltere premier ligi'ni trtspor'un yayınlaması
  entry_id:  92292988
  entry_writer: baymimar
  entry_fav_count: 0
  entry_content: |
    cumartesi saat 17'de bir maç yayımlayacakları için futbola doyamayacağız. her hafta 1 maç. yine de yoktan iyidir.
