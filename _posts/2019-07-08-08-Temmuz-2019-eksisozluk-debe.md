...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    sözlüğün en ezik trollü multinet'in sözlüğe sıçtığı çöp başlıktır.<br/><br/>şu başlıktan kopya çekmeye çalışmış ama olmamış: (bkz: <a class="b" href="/?q=michael+phelps%27i+denizde+tokatlar%c4%b1m">michael phelps'i denizde tokatlarım</a>)
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  92282706
  entry_writer: galibaben
  entry_fav_count: 1
  entry_content: |
    düğünleri gereksiz gören kadındır. adetlerle çevrili dört bir yanımız ama iki tarafta istese yapılmayabilir. aileleri ikna edemem demek, istemem yan cebime koy durumunun üstü kapalı versiyonudur. yakınanlar hep erkekler olmasına rağmen, düğün istemeyen erkek görmedim henüz.
  entry_channels: anket,ilişkiler
- entry_name: |
    otlanan kediye rastlamak
  entry_id:  92285895
  entry_writer: sakazi zosuk
  entry_fav_count: 0
  entry_content: |
    kediler paket bitince otlanırlar, diye biliyorum.
  entry_channels: 
---
