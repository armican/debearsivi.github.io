...
- entry_name: |
  ...
  entry_channels: haber
- entry_name: |
    en sevilen kalem markaları
  entry_id:  93610623
  entry_writer: oggiethebrewbuddy
  entry_fav_count: 56
  entry_content: |
    (bkz: <a class="b" href="/?q=rotring">rotring</a>)
  entry_channels: anket
- entry_name: |
...
- entry_name: |
    ideal lahmacun garnitürü
  entry_id:  93599054
  entry_writer: dreamerdorian
  entry_fav_count: 49
  entry_content: |
    benim için çok az sumaklı soğan,biraz domates, az biraz yeşillik ve birkaç damla limondur.
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    tarihi eminönü balıkçılarını boykot etmek
  entry_id:  93627409
  entry_writer: tekil cogunluk
  entry_fav_count: 33
  entry_content: |
    (bkz: <a class="b" href="/?q=tarihi+emin%c3%b6n%c3%bc+bal%c4%b1k%c3%a7%c4%b1s%c4%b1nda+ya%c5%9fanan+vah%c5%9fet">tarihi eminönü balıkçısında yaşanan vahşet</a>)<br/><br/>bu vahşet ve zorbalık nedeniyle acilen başlatılması gereken ve +2 ile, eşimle desteklediğim boykottur. çevremdeki herkesi, ömrüm boyunca bu balıkçılardan uzak tutacağım. bu şerefsizlerin yanına kalmamalı bu durum. <br/>herkesi +1 olarak destek vermeye davet ediyorum.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    <a class="b" href="/?q=gerzek+%c5%9faban">gerzek şaban</a> filmi ile beraber adında şaban olup içinde şaban olmayan iki filmden birisi olan bu müthiş eser bu akşam 20.00'da star tv ekranlarında.
...
- entry_name: |
    trump'ın obama'nın like sayısını kıskanması
  entry_id:  93631808
  entry_writer: atom bombaciyan
  entry_fav_count: 1
  entry_content: |
    --- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>ı know a lot of people, and absolutely none of them like obama.<br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>adam çevresine "hünkarım hünkarım" deyu inleyen conileri doldurmuş olmalı. 'diktatörlerle iyi anlaşıyorum' derken samimiymiş.
  entry_channels: 
- entry_name: |
    kuru patlıcan dolması vs kabak çiçeği dolması
  entry_id:  93633850
  entry_writer: casiotuxy
  entry_fav_count: 1
  entry_content: |
    yufka arası kuru patlıcan dolması ve datça'da yenilen iyi yapılmış kabak çiçeği dolmasının yanında diğer dolmaların esamesi okunmaz
  entry_channels: 
- entry_name: |
    erkek yazarlardan kadın yazarlara sorular
  entry_id:  93603577
  entry_writer: mr nemesis
  entry_fav_count: 1
  entry_content: |
    bana cevap vermeyin de . şu abazalardan kurtulmanın bir yolu var mı sizce ? amk sözlükte her gün size soruyorlar bitmediler .
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    izlerken ben de "hakem israilli amk" tribine girdim lakin adamın tüm kartları doğru. kusura bakılmasın alışık değiliz diye bize garip gelebilir.
  entry_channels: spor
- entry_name: |
    ozan tufan
  entry_id:  93633991
  ...
  entry_fav_count: 0
  entry_content: |
    ronald<a class="b" href="/?q=ozan">ozan</a><br/><br/>sadece'o' su bile benzese yeter.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    kelebekler vadisi'nin yapılaşmaya açılması
  entry_id:  93624201
  entry_writer: ayaginaltindakikivrimlarisevenadam
  entry_fav_count: 0
  entry_content: |
    bir kaç yıldır düşünülen ancak yeni yeni kamuoyuna duyurulan durum.<br/><br/>nereden mi biliyorum? orasını boşverin.<br/><br/>orayı komple almaya cesaret edecek bir yabancı yatırımcıya söz verilecek ve işlem başlayacak.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    aynı şarkıyı beraber söylemek mi , farklı şarkıları birbirne sevdirmek mi çözemediğim mevzu..
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    post rock şarkısı istiyorum, beni yeşilleyin.<br/><br/>not: bu entry kendini imha edecektir, dertliyim, idare ediniz...
  entry_channels: anket,müzik
---
