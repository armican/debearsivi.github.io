...
- entry_name: |
  ...
  entry_fav_count: 459
  entry_content: |
    (bkz: <a class="b" href="/?q=nagehan+sen+misin%3f">nagehan sen misin?</a>)
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    sadece karşılıklı aşk. <br/>yaşarsan eğer anlarsın; koy gözüne<sup class="ab"><a title="(bkz: ehi)" href="/?q=ehi" data-query="ehi">*</a></sup> dünyanın rahvan gitsin. başka hiçbir şey zerre umurunda olmaz.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    her cumartesi- pazar düzenli olarak entry girdiğim başlık teklifim standart haftasonu teklifidir. <br/>ilk biralar benden ikinciyi herkes kendisi alıyor efendim. <br/>yer:alsancak/kordon/çimler.
