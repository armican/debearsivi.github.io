...
- entry_name: |
  ...
  entry_fav_count: 129
  entry_content: |
    (bkz: <a class="b" href="/?q=inception">inception</a>)<br/><br/>adamlar turnuva içinde turnuva yapacaklar. <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 71
  entry_content: |
    ilk çağrıda o hakkımı kullanırım ama eğer karşı taraf kısa bir süre sonra ikinci aramayı yaparsa mutlaka açarım. kimse ikinci sefer önemsiz bir durum ya da duygu için aramaz diye düşünürüm, bu hal hatır sorma bile olsa.<br/><br/>herkes iletişim konusunda ölçülü olmak kaydıyla esnekliğe sahip olmalıdır, öteki türlüsü saygısızlığa girer.<br/><br/>not: bu durum aile üyelerini hiçbir koşulda kapsamaz.
...
- entry_name: |
  ...
  entry_fav_count: 61
  entry_content: |
    29 yaşındayım 29 yıldır kadıköy'de yaşıyorum .<br/><br/>farklı semtlerde oturup barlar sokağı be ağğğbi, rexx be ağbiii, moda sahili be ağbiiii gibi yazarak kadıköy'ü yaşadığını, anladığını zannedenler yüzünden gına gelmiştir . <br/><br/>kadıköy'lü olmak, kadıköy'de takılmaktan ziyade insanlara bu muhitte vakit geçirdiğini göstermeye çalışan seküler kesimin kekoları yüzünden yozlaşmaktadır . <br/><br/>son yıllarda gözle görülür biçimde artan közde kahveciler ilçenin dokusuna uygun değildir,zira kadıköy eminönü değildir, her hangi bir cafenin, büfenin önünde insanları içeri davet eden bir garsona bu muhitte ihtiyaç yoktur .ama bu durum yetkililerin sikindemidir ? değildir .
...
- entry_name: |
  ...
  entry_fav_count: 40
  entry_content: |
    7 yıllık avukat olan ebru'nun acilen profesyonel destek alması gereken psikolojik sorunları olduğuna inancım tam. <br/><br/>koşulsuz sevgiymiş, indigoymuş, sayfa sayfa özgeçmişi varmış. yürüyen ego amk.<br/><br/>ilaveten adettendir: <a class="b" href="/?q=iskur.gov.tr">iskur.gov.tr</a><br/><br/>edit: olm kız ağır işsiz. vallahi dünyaya hiç bir faydası yok.<br/><br/>edit2: öss'de anlatım bozukluğunda full yapmış.
  entry_channels: tv
- entry_name: |
    3.500.000 tl'ye satılan instagram hesabı
  entry_id:  98500359
  entry_writer: hazretisamidayi
  entry_fav_count: 40
  entry_content: |
    reklam için sen kaç para aldın koç?
...
- entry_name: |
  ...
  entry_id:  98496149
  entry_writer: okurbaz
  entry_fav_count: 32
  entry_content: |
    o değil de adamlar bir de f grubuna düşmek için play off oynayacaklar amk ya hahahaha. lan tünelin ucu bombok bir yere çıktı, maç oynatmak külfet olur, rızaya göre isteyen gelsin denilebilir.<br/>hatta kim katılmak istemiyor diye maç yapsınlar, kazanan katılmama hakkı elde etsin.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 26
  entry_content: |
    yok ulan ne fetösü dıj güçlerle fbi nsaa usa hepsiyle savaşıyorsunuz. sığır seni
  entry_channels: spor,ekonomi
- entry_name: |
    konya'da yazılan efsanevi yüksek lisans tezi
  entry_id:  98499767
  entry_writer: ahizeli telefon
  entry_fav_count: 25
  entry_content: |
    bence gayet doğru bir çalışma olmuş. sosyal bilimler için doğru bir konu seçimi, hatta bu dizi ve müzik gruplarının etkisi reklamcılık alanı ile ilgilide çalışma yapılmalı.
...
- entry_name: |
  ...
  entry_fav_count: 23
  entry_content: |
    koyar geçeriz (nerden çektin bunları aq)<br/><br/>ceyhun gülselam milli takıma çağırılıp bu maçta ilk 11 çıkmalı,mancini'nin dikkatini dağıtırız
  entry_channels: spor
- entry_name: |
    30 kasım 2019 fenerbahçe üzerine oynanan oyun
  entry_id:  98498583
  entry_writer: youwereright
  entry_fav_count: 22
  entry_content: |
    emre bolezoglu'na verilmeyen kirmizi kartla desteklenen önerme.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    beyaz tenli kızların yüz vermemiş olmasıdır. beyazı dururken niye esmeri beğenelim yoksa ya.
  entry_channels: anket,ilişkiler
- entry_name: |
    30 kasım 2019 fenerbahçenin doğranması
  entry_id:  98500479
  entry_writer: xenraiken
  entry_fav_count: 14
  entry_content: |
    (bkz: <a class="b" href="/?q=30+kas%c4%b1m+2019+fenerbah%c3%a7enin+marine+edilmesi">30 kasım 2019 fenerbahçenin marine edilmesi</a>)
  entry_channels: spor
- entry_name: |
    serdar aziz
  entry_id:  98495640
  ...
  entry_fav_count: 13
  entry_content: |
    falcao ile olan gol yarışında bugün attığı golle 2 - 1 öne geçmiş oyuncu.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    bugün penaltı konusunda oldukça haklı bir kriz çıkaracak. kuralsa kural, var'sa var. bir kural fenerbahçe'nin attığı golü iptal ettirip penaltıyı tekrarlatacak kadar katıysa, aynı kural geçen hafta neredeydi diye sorulacak. bu soruya bakalım kim cevap verecek?
  entry_channels: spor
- entry_name: |
    ersun yanal
  entry_id:  98495361
  ...
  entry_channels: spor
- entry_name: |
    dışarıda gezerken en çok görülen araba
  entry_id:  98497556
  entry_writer: rbtaskiran
  entry_fav_count: 8
  entry_content: |
    (bkz: <a class="b" href="/?q=clio+4">clio 4</a>)<br/>(bkz: <a class="b" href="/?q=megane+4">megane 4</a>)
  entry_channels: anket,otomotiv
- entry_name: |
    yazılımcı egosu
  entry_id:  98486092
  entry_writer: the ungroundable
  entry_fav_count: 6
  entry_content: |
    aklı selim yazılımcılarla yapılacak bir code review’a bakar. önce bi öfke nöbeti, sonrası hüsran, sonrası hüzün...<br/><br/><a class="b" href="/?q=code+review">code review</a>, <a class="b" href="/?q=agile+software+development">agile software development</a>
...
- entry_name: |
    bir kızın sevdiğini anlama yöntemleri
  entry_id:  98477026
  entry_writer: bangelero torpedo
  entry_fav_count: 5
  entry_content: |
    bir filmden bahsettiniz diyelim sizi anlamak için gider o filmi izler fakat bunun siz bahsettikten hemen sonra olması lazım.<br/><br/>kendine sürekli güzel kıyafet vs alıyor size de durduk yere seveceğiniz bir şey alıyor ardından şu mesajı atıyor "kendime bir sürü güzel şey aldım sana da almak istedim"<br/><br/>doğum gününüzde size özel bir şeyler hazırlıyor kendi emeğiyle yaptığı bir şey.<br/><br/>(daha uzun yazmak isterdim ama benden daha zeki siz değerli suserler hangi inceliklere gönderme yaptığımı çoktan anladınız.)
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    cahil birer erkek olmaları. üstünlük duygusundan vazgeçememeleri. kadınları insan olarak görmemeleri. <br/>gerisi faso fiso ve bahane.
  entry_channels: anket,ilişkiler
- entry_name: |
    1 aralık 2019 trabzonspor galatasaray maçı
  entry_id:  98500562
  entry_writer: odunbudu
  entry_fav_count: 3
  entry_content: |
    normal şartlar altında trabzonspor'un içinden geçeceği maç.. lakin haramileri ligde tutmak adına büyük bir hakem operasyonu çekileceğini ve trabzonspor'un doğranacağını tahmin ediyorum.
  entry_channels: spor
- entry_name: |
    erman toroğlu
  entry_id:  98501240
  ...
  entry_fav_count: 2
  entry_content: |
    (bkz: <a class="b" href="/?q=kolpa%c3%a7ino+%c3%b6zg%c3%bcr">kolpaçino özgür</a>)
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    aşti otogarında gibi hissettiren başlık.<br/><br/>- var mı istanbul? istanbul istanbul istasdfgg..
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    yürümek. kulakligini takip yürümek
  entry_channels: anket,moda
- entry_name: |
    xiaomi marka telefon kullanan yazarlar veritabanı
  entry_id:  98493892
  entry_writer: sworncubasi
  entry_fav_count: 1
  entry_content: |
...
- entry_name: |
    atatürk'ün çocuğu olsa ne olurdu
  entry_id:  98499803
  entry_writer: konusan yalniz hakikattir
  entry_fav_count: 1
  entry_content: |
    buyuk sahsiyetlerin kendi nesli ayni potansiyele sahip olamayabiliyorlar. <br/><br/>mesela reyizimizin oglu bilal. oyle bir sey olacagina hic olmasin daha iyi
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    sevgi, arkadaşlık, dostluk gibi kavramlar.<br/>bunların altında yatan temel motivasyonu öğrenince bi aydınlanma yaşanıyor.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    masterchef bu programdan çok daha kaliteli. düşünün artık ne kadar rezalet bir yarışma olduğunu. muhtemelen yarışmacıların %75 i falan yemekle alakasız insanlar.
  entry_channels: tv,yeme-içme
- entry_name: |
    aşık olduğun kişiye bir şarkı bırak
  entry_id:  98502558
  entry_writer: cihanpercemi
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=mevsimsiz+sabahlar">mevsimsiz sabahlar</a>)
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    yerime yattım, uyuyu valla. çok da memnunum. hafta sonu dinlenmektir.
  entry_channels: anket,ekşi-sözlük
---
