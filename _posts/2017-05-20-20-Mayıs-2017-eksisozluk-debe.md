...
- entry_name: |
  ...
  entry_fav_count: 577
  entry_content: |
    hemen yafta yapıştırılmış; "inançsızlık mı yoksa ???" <br/><br/>aynen kardeş. inançsızlıktır kesin. hak yolunu bulmuş olsalar, bu genç yaşlarında kendilerini uçurumdan atmazlardı. onun yerine kendilerini minareden atarlardı... <br/><br/>tanım: ölümde bile insanın dinini sorgulayanları ortaya çıkaran üzücü haber.
- entry_name: |
...
- entry_name: |
    ölümünden 79 yıl sonra bile it gibi korkulan insan
  entry_id:  68247945
  entry_writer: ayuttudum
  entry_fav_count: 149
  entry_content: |
    tanım: (bkz: <a class="b" href="/?q=mustafa+kemal+atat%c3%bcrk">mustafa kemal atatürk</a>)<br/><br/>bu topraklardaki son emperyalist bükücü, son yobaz sikici.
- entry_name: |
...
- entry_name: |
    kılıçdaroğlu'dan sözcü operasyonuna sert tepki
  entry_id:  68257675
  entry_writer: fech
  entry_fav_count: 99
  entry_content: |
    kılıçdaroğlu, şöyle konuştu:<br/>"gerçekten bizi derinden yaraladı. sözcü'ye yapılan operasyon kabul edilemez (kabul edildi)..... bütün yargı mensuplarına çağrı yapıyorum: siz adalet dağıtmakla yükümlüsünüz. sizin bulunduğunuz makamlar kutsal makamlardır. bu makamlar siyasi otoriteye teslim edilemez (teslim edildi)."<br/><br/>sayın kılıçdaroğlu, bugun sozcü'ye feto operasyonu yapıldıgında hala insanları sokaklara dökemiyorsanız, cumhuriyet gazetesinin geri kalanı da içeri atıldığında aynı sözleri söyleyecekseniz, zaten sizin için geldiklerinde bundan kimsenin haberi olmayacak bile. ellerim ayaklarım beynim uyuştu sizin muhalefetinizi izlerken.
- entry_name: |
...
- entry_name: |
    türkiye'nin ilk yerli savaş uçağı tanıtım videosu
  entry_id:  68260925
  entry_writer: anlamsiz duygu
  entry_fav_count: 45
  entry_content: |
    şimde benim aklımda iki tane soru var.<br/><br/>1. altay tankının motoru nerede<br/>2. adil öksüz nerede
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 30
  entry_content: |
    göte göt dediği için ekşi sözlükte eleştirilen sanatçı. <br/><br/>başlıkların bir kısmının bakire olmayan kadınlar üzerine olduğu, bir kısmının tayt giyen kadının niyeti ve hatları üzerine olduğu, kalan kısmında yazarların birbirine futbol başlıklarında ana avrat küfür ettiği sözlük elbetteki ekşi sözlük değil, ayıp ceylan!
- entry_name: |
    ekpe udoh
  entry_id:  68265531
...
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    sevmesinler, seviyor gibi de yapmasınlar. bizim sevgimiz yeter. saygı duysunlar. duymaya çalışsınlar. yoksa kimin ne olduğunu herkes görebiliyor.
- entry_name: |
...
- entry_name: |
    murat kosova
  entry_id:  68266836
  entry_writer: kendine nick diyen adam
  entry_fav_count: 17
  entry_content: |
    "inanılır gibi değil" dediği her şeyin gayet normal olması dışında iyi maç anlatan spiker.
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    "mustafa kemal'in askerleriyiz" tezahüratı eşiliğinde ilk 45 dakikası biten maç. <br/>galatasaray'ın 2-0'lık üstünlüğü var.<br/><br/>maç gibi maç amına koyim, valla kendime geldim.
- entry_name: |
...
- entry_name: |
    230 adamla yatıp geçmişi boşver senleyim diyen kız
  entry_id:  68262718
  entry_writer: karmic koala
  entry_fav_count: 9
  entry_content: |
    belden aşağısı tutmuyodur, ama olsun sizinledir ehehe.
- entry_name: |
    rudy fernandez
  entry_id:  68266293
...
- entry_name: |
    vatanım sensin
  entry_id:  68249200
  entry_writer: daisy fay
  entry_fav_count: 6
  entry_content: |
    bizim kuvvacıların telgrafı bozulunca cevdet yakup'a ethem beyi bulun o çeksin telgrafı ankara'ya dedi bu ethem bey çerkes ethem mi yoksa hadi bakalım<br/><br/>edit: aha salihli dedi. çerkes ethem diziye hayırlı olsun kim oynayacak acaba.<br/><br/>bölüm sonu editi: yıldız sen ne kadar uyuz bir insansın ya hiçbir şey demiyorum sana ali kemal yerine sen mi evlatlıksın acaba?
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    onu <a class="b" href="/?q=yoksaymak">yoksaymak</a>tır.
- entry_name: |
    jelko obradoviç
  entry_id:  68264517
  ...
  entry_fav_count: 4
  entry_content: |
    kendisinin asistanlarından josep maría ızquierdo, obradavic'in kendisini arayıp beraber çalışmayı teklif ettiğinde ona verdiği cevabı as gazetesindeki röportajında şöyle anlatır:<br/><br/>"cuando obradovic me llamó en 2013 y me ofreció trabajar junto a él, le respondí: ‘si me das dos o tres horas, preparo la maleta y me voy nadando a estambul’. tengo muy claro que con zeljko juegas para ganar."<br/><br/>"obradovic 2013 yılında beni arayıp onunla birlikte çalışmayı teklif ettiğinde, şöyle cevap verdim: ' eğer bana iki, üç saat verirsen, bavulumu hazırlar ve istanbul'a doğru yüzmeye başlarım."<br/><br/>-------------------------<br/><br/>not: dolayısıyla sizin ücretsiz staj konusu biraz karışık sevgili dostlar.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    biletini zor da olsa aldığım maç. ilk kez göreceğim mabedi. bursa'dan uğur getireceğim 5 tane atarız. :)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    enteresan bir şekilde son bölümlerinde karakterler hızlı bir dönüşüme girmiştir. duygusallıktan çıkamayan her türk dizisi gibi. bir de ozan güvene biraz daha insani mimikler refleksler verilmeli adam kasap değil sonuçta. ayrıca yaşadığı aşk mekanikleşme ve acımasızlığa doğru evrilme yönünde.
- entry_name: |
    ekşi itiraf
  entry_id:  68253415
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    fenerbahçe'ye 2500 tl basacağım maç. fenerde teodosic malı yok. her türlü fener çakar. fenerbahçe bu maçı kaybetsin bikini giyerim.
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    orda yüksek standartta yaşarken oy vererek burdaki standartı düşürmeye çalışmaları yeterli sanırım. kimin ne kadar kazandığı yoksa sikimizde değil.
- entry_name: |
    görünen adam
  entry_id:  68254948
  ...
  entry_fav_count: 0
  entry_content: |
    biraz baktım. olmamış. <br/><br/>hala eski işlerinin ekmeğini yiyor bu adamlar.<br/><br/>edit: lan susun ne demek ? <br/>beğenme zorunluluğum mu var amk ? <br/>bu nasıl bir zeka seviyesi ?<br/><br/>(bkz: <a class="b" href="/?q=beyin.dll+bulunamad%c4%b1">beyin.dll bulunamadı</a>)
- entry_name: |
    19 mayıs 2017 steam sunucularının çökmesi
  entry_id:  68266898
  entry_writer: doxanikee
  entry_fav_count: 0
  entry_content: |
    bi' <a class="b" href="/?q=tf+2">tf 2</a> keyfimiz vardı akşam akşam, onu da hiç eden çökme.
---
