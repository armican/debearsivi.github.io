...
- entry_name: |
  ...
  entry_fav_count: 124
  entry_content: |
    kimse kusura bakmasın da tespit gibi tespittir. <br/><br/>sirf para için bir adamın yanında dolaşan kadın mal olmayı yerden göğe kadar hakediyor.
- entry_name: |
...
- entry_name: |
    öldürülen pitonun içinden çıkan ölü adam
  entry_id:  67155566
  entry_writer: dinozorunyunu
  entry_fav_count: 63
  entry_content: |
    öldürülen pilotun içinden çıkan ölü adam olarak okuyup bir süre kafa yorduğum başlık.<br/><br/>(bkz: <a class="b" href="/?q=yaran+yanl%c4%b1%c5%9f+okumalar">yaran yanlış okumalar</a>)
- entry_name: |
    samsung galaxy s8
  entry_id:  67146903
...
- entry_name: |
  ...
  entry_fav_count: 34
  entry_content: |
    adamın karşısına mert bir şekilde çıkıp, milletin önünde tartışalım diyen yok. herkes olduk olmadık yerde kılıçtaroğlu'na saldırıyor. buna kaçak dövüşmek derler. maçan sıkıyorsa çıkacaksın 70 milyonun karşısına orda tartışacaksın. <br/><br/>erdoğan hakkında düzmedikleri methiyeler yok: öyle lider, böyle lider, yok dünyayı dize getirdi. madem öyle çık ekrana kılıçdaroğlu'na göster gününü. mitinglerde, hayır çadırında "sizin genel başkanınız yalancı" demek kolay. hakan çelik'i karşına alıp istediğin soruyu sordurtmak kolay. yüreği yeten, kendine güvenen politikacı çıkar, hem politikasını hem de yapmak istediğini kendi denginin veya muhalefetin karşısında savunur. <br/><br/>kılıçtaroğlu'nun duello teklif ede ede dilinde tüy bitti. ama evet cephesinden bu çağrıya cevap verecek bir baba yiğit göremedik. kısaca (bkz: <a class="b" href="/?q=akp%27nin+k%c4%b1l%c4%b1%c3%a7tar%27la+d%c3%bcelloya+ma%c3%a7as%c4%b1+yememesi">akp'nin kılıçtar'la düelloya maçası yememesi</a>)
- entry_name: |
...
- entry_name: |
    ekonomide italya ve kanada'yı geçeceğiz müjdesi
  entry_id:  67139691
  entry_writer: madonnanin yagli zencisi 2
  entry_fav_count: 29
  entry_content: |
    türkiye her sene dolar bazında %3.5 büyür ve önümüzdeki 8 ülke 20 yıl boyunca hiç büyümezse olabilecek şey
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    "..ama efendim su an fiilen zaten baskansiniz. bakanlar kurulu emrinizde. milletvekilleri iki dudaginizin arasina bakiyorlar. yargiyi, yargiclari, savcilari göreve cavirdiginizda, isteginiz dogrultusunda zaten görevlerini yapiyorlar".<br/><br/>"polis emrinizde. ordu emrinizde. yagveriniz fetöcü cikinca, genelkurmay baskanini bile yaver yaptiniz. heryerde yaninizda. ülkede sizin yapmak isteyip de yapamayacaginiz birsey yok"<br/><br/>"15 senedir iktidardasiniz. hala mi eksiklik var ülkede? hala mi yeni yasalara ihtiyac duyuyoruz?"<br/><br/>"ben evet vermeye megilli bir secmen olarak(yalan) hangi maddeden ötürü bana terörün bitecegini, issizligin azalacagini, üretimin artacagini, dis politikada daha saygin bir yer edinebilecegimizi aciklar misiniz?"<br/><br/>su dört paragrafi yazmam 1 dakika sürdü. söylemem 30 saniye. "hani kadin konusamiyoruz" diyor ya, hah iste sunlari söylemeye baslasaydi, muhtemelen "konusturulmazdi".<br/><br/>iste bu yüzden "hayir"
- entry_name: |
    bitaksi
  entry_id:  67137836
...
- entry_name: |
    29 mart 2017 ankara'da gökyüzünde beliren ışıklar
  entry_id:  67156120
  entry_writer: kendime nick bulamadim yahu
  entry_fav_count: 8
  entry_content: |
    chp genel merkezi üzerindeyse, kılıçdaroğlu evine dönecektir.<br/><br/>(bkz: <a class="b" href="/?q=kemal+k%c4%b1l%c4%b1%c3%a7daro%c4%9flu+uzay+yarat%c4%b1%c4%9f%c4%b1na+benziyor">kemal kılıçdaroğlu uzay yaratığına benziyor</a>)<br/><br/>edit : ekleme
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    bu herifin maliyetinin büyük bir kısmını west ham'a kiralayarak çıkardık zaten. başkan, allah'ını seversen üçe beşe bakma, sat şunu. isterse gittiği takımda cristiano ronaldo olsun. sen bunu gönder, yerine adam bulamasan bile bir sezon ağzımızı açmayalım biz de. hatta sırf bu adam gitti diye isterse şampiyonluk gitsin, umrumda bile değil.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    bugun itibariyle booking.com kapatilma karariyla uzerine bir guzel tuy dikilmis krizdir.<br/><br/>turkiye turizm krizi yok diye savunan kaldiysa, kendilerine booking.com sayesinde gelirimizin yaklasik yuzde 50 sini yaptigimiz butik bir turizmci olarak selam ederim.
- entry_name: |
    celal şengör
  entry_id:  67153046
  ...
  entry_fav_count: 4
  entry_content: |
    görkemli kütüphanesini hiç sıkılmadan <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=65u_sdNT3ns" title="https://www.youtube.com/watch?v=65u_sdNT3ns">izlediğimdir.</a> 1580 yılından kitap var ya adamın kütüphanesinde. kütüphane benim yaşadığım evden büyük ulen! şaka bir yana saygı duyulası bir beşer kendisi. daim olsun.
- entry_name: |
...
- entry_name: |
    ssg
  entry_id:  67153501
  entry_writer: foxydevil
  entry_fav_count: 2
  entry_content: |
    son <a rel="nofollow noopener" class="url" target="_blank" href="https://twitter.com/esesci/status/846863537938952192" title="https://twitter.com/esesci/status/846863537938952192">tweet</a>'i bana avrupa'da yaşayıp ak partiye oy verenleri anımsatmıştır.
- entry_name: |
    ekşi itiraf
  entry_id:  67148629
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    sevmek etken bir fiil ya da duygudur, sevilmek edilgen. sevmek kısmında siz etken olursunuz, sevilmek kısmında karşı taraf etken siz edilgen. sevgili olur, kardeş olur, anne baba, arkadaş olur hiç olmadı bir köpek edinseniz sizi sevecek birini bulursunuz. ama sevme duygunuz yoksa somurtkan sevimsiz hiç kimseyi sevmeyen bir tipseniz hayat çekilmez olur.<br/><br/>o nedenle sevmek, sevebilmek daha önemli ve ön plandadır bana göre. çünkü sevmekte aktif kısım sizsiniz. tabii genel olarak herkesin de söylediği gibi karşılıklı sevme ve sevilme olayını yakalayabilmek. yoksa sen birini seversin, o başka birini, onun sevdiği başka birini. karmaşık bir döngü çıkar ortaya.<br/><br/>sevilmek önemli diyenler; karşı taraf seni sevdi diyelim, sen onu sevmiyorsun var mı bunun önemi? verebilecek misin o kişinin duygularına karşılık? hayır. peki onun sevgisi karşısında sen ona ne vereceksin sadece acı. direkt sevilmek demek bir nevi bencilliktir.
- entry_name: |
    prison break
  entry_id:  67136303
  entry_writer: paluka
  entry_fav_count: 1
  entry_content: |
    t-bag 'in kadroda olduğunu görmek beni mutlu etti.<br/><br/>geliyor gönlümün efendisi.
- entry_name: |
    it
  entry_id:  67153236
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    o kadar ama o kadar çok üzüldüm ki.<br/><br/>ben cenazem var diye 1 gün işe gidemedim diye aylarca üzerinde çalıştığım projenin altına imzanı atmışsın. bu beni o kadar üzdü ki anlatmam mümkün değil.<br/><br/>para da senin olsun statü de proje de yemin ederim hiçbir şeyde gözüm yok. istesen verirdim lafını ikiletmeden. ben her sekilde her seyle yetinebilirim. ben seni abim saydım ama. seni sevdim, sana güvendim. abi dedim ya, abim gibi sevdim seni. daha nasıl anlatabilirim ki bunu.<br/><br/>gerçekten çok çok üzüldüm. kızmadım, kızamıyorum. ama asla düzelmeyecek bir kırgınlık olacak içimde seninle ilgili. bunu onaramayacağımı bilmek her şeyden çok üzüyor beni.<br/><br/>nefret ediyorum allahım bu şekilde çalışmaktan. satış benim asla yapamayacağım bir şey. yalvarırım bana, benim karakterime daha uygun bir sektörde ve daha uygun bir ortamda bir iş imkanı sun. dayanamayacağım ben çünkü.
- entry_name: |
    vakko'da 1510 tl'ye satılan havyar kaşığı
  entry_id:  67155394
  entry_writer: dedigimin tersi
  entry_fav_count: 0
  entry_content: |
    vakko'da kaşık satılmasından ilginç değildir.<br/><br/>şaka maka vakko ne zamandan beridir kaşık satıyor lan? en son baktığımda en değişik ürün olarak ayakkabı satıyorlardı.
- entry_name: |
    ios 10.3
  entry_id:  67147002
  entry_writer: axt
