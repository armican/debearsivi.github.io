...
- entry_name: |
    pisi pisine ölen motosikletli adam
  entry_id:  78605395
  entry_writer: vebeci
  entry_fav_count: 197
  entry_content: |
    aynadan bakmadan kapısını açan zeka özürlü bir yaratığın yüzünden ölen bir motosiklet sürücüsü için söylenebilecek söz öbeği.
...
- entry_name: |
  ...
  entry_id:  78604589
  entry_writer: pinkmood
  entry_fav_count: 7
  entry_content: |
    metroda gözyaşlarını eliyle silerek ağlayan kadın.
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    (bkz: <a class="b" href="/?q=regl">regl</a>) gibi bok püsür sorunların olmaması
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
    sabah kahvaltısında poğaça yiyen insan
  entry_id:  78601202
  entry_writer: harry tuttle
  entry_fav_count: 4
  entry_content: |
    bazı zabahlar yapıyorum. sanki çok bir bok yapabilecekmişim gibi hayaller de kuruyorum. <br/><br/>sinema filmi çektiğimi düşlüyorum. kitap yazdığımı hayal ediyorum. yabancı bir şehre yerleşip yeni bir hayat kurduğumu düşünüyorum vesaire.<br/><br/>ama sonra bir bakıyorum yine hep aynı yerimdeyim. poğaça bitmiş, vişne suyu genzimi yakmış halde buluyorum kendimi. pipeti meyve suyunun dibinde gezdiriyorum lühüqqqqqkhhhhhhüüüüüükkkqqqhhhh biçiminde. zerre bile kalmıyor içinde. poğaçanın kırıntılarını parmağıma yapıştırıp ağzıma götürüyorum. sonra bir bakıyorum ben yine benim. böyle bir erke dönergecim var enerji üretmeyen.
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    basketbolu futboldan daha fazla sevdiğimi gösteren maç. yemişim dünya kupasını vamos turcos.
  entry_channels: spor
- entry_name: |
    şarık tara
  entry_id:  78624088
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    sadece bir kuşak önce doğup 2 albüm yaptıktan sonra bi otel odasında kusmuğunda boğulup geberip gitseydi, bugün kendisini eleştirenler tarafından sabah akşam dinlenip övülecekti. sesiyle, karizmasıyla, gitaristliğiyle ve besteciliği ile metal camiasının efsanelerindendir. bakmayın siz bok attıklarına.<br/><br/>gerçi kimse bok atmamış ama gaza geldim bu kadar entry girilince. psikolojimi bozdunuz amk.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    ağacın tepesine çıkmasının ödülü <a class="b" href="/?q=y%c4%b1ld%c4%b1r%c4%b1m+%c3%a7arpmas%c4%b1">yıldırım çarpması</a>ydı.
  entry_channels: anket,edebiyat
- entry_name: |
    pegasus airlines
  entry_id:  78613728
  entry_writer: mrandmrssmith
  entry_fav_count: 0
  entry_content: |
    ağustos ayı itibariyle istanbul-paris tek yön biletleri neredeyse her gün 2000 tl civarı görünen havayolu firması. döviz ağustos'tan itibaren mi vuracak ülkeyi anlamadım.
  entry_channels: ekonomi,havacılık,seyahat
- entry_name: |
    mhp'nin meclis başkanı adayı çıkarmaması
  entry_id:  78624349
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    koskoca sözlükten van’da bulunan tek bir hatun kişisi yok mu? kaliteli sohbete hasret kaldık.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="http://connected2.me/nedemektryagain">http://connected2.me/nedemektryagain</a>
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
