...
- entry_name: |
  ...
  entry_fav_count: 27
  entry_content: |
    " dağıstan'da <a class="b" href="/?q=avarlar">avarlar</a>, <br/>hayatlarını istediği gibi yaşayamamış insanların mezar taşlarına <br/>"yüz yaşına kadar yaşadı ama <a class="b" href="/?q=d%c3%bcnyaya+gelmedi">dünyaya gelmedi</a>" diye yazarlarmış."<sup class="ab"><a title="(bkz: şükrü erbaş)" href="/?q=%c5%9f%c3%bckr%c3%bc+erba%c5%9f" data-query="şükrü erbaş">*</a></sup><br/><br/>dünyaya gelmeniz dileğiyle!
...
- entry_name: |
  ...
  entry_fav_count: 23
  entry_content: |
    müşterilerin ahlaksız ve orospu çocuğu olmaları söz verdikleri tarihlerde ödeme yapmamaları, az yapmaları, içerde bakiye tutmaları.<br/>girişimcilerin müşterileri iyi niyetli insanlar zannedip onlara taviz vermeleri.<br/>likidite krizi.
...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    bu dizi olmadı be. maalesef. olmadı işte. maalesef diyorum, çünkü sağlam bir cast ve emek var.<br/><br/>ama bir samimiyetsizlik, bir bayağılık, bir zorlama var dizide. itici tipler, abartı hareketler, bağırıp çağırarak konuşlamalar. safi ziyan.<br/><br/>azalarak bitecek muhtemelen. fazla da zorlamaya gerek yok.
...
- entry_name: |
    çukur (dizi)
  entry_id:  82154503
  entry_writer: message
  entry_fav_count: 14
  entry_content: |
    yanlış insanlardan intikam alınan dizi. çukuru ele geçiren sadettin’di. ayrıca bu adam koçovalı kardeşlerden birini öldürdü. karakuzular ise görünen o ki bir tek berber muhittin’i öldürebilmiş. erkeklerin berber sadakati vardır da bu kadarı da abartı.
  entry_channels: tv,müzik,spoiler
- entry_name: |
    yokum'daki k'nin yumuşamaması
  entry_id:  82176033
  entry_writer: diyilizdiyil
  entry_fav_count: 12
  entry_content: |
    gayet de yumuşamasıdır. <br/><br/>(bkz: <a class="b" href="/?q=burhan+altintop">burhan altintop</a>) <br/>(bkz: <a class="b" href="/?q=ben+asl%c4%b1nda+yo%c4%9fum">ben aslında yoğum</a>)
  entry_channels: edebiyat
- entry_name: |
    30 polise fırça atan amerikan askeri
  entry_id:  82175874
  entry_writer: frkr
  entry_fav_count: 10
  entry_content: |
    izlediğimde gördüğüm hürmet filan değil de, dengesize bulaşmamak için istifini bozmayan, sükuneti muhafaza eden bilinçli polisler oldu.
  entry_channels: haber
- entry_name: |
    şu anda çalan şarkı
  entry_id:  82165310
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    pezevenk arkadaşın rol keserek kendisini koca olarak tanıtıp keriz silkelediği ilişki türündeki koca rollü pezevenktir.
  entry_channels: ilişkiler
- entry_name: |
    mikasa futbol topu
  entry_id:  82175248
  ...
  entry_fav_count: 3
  entry_content: |
    takım arkadaşının çektiği şuta kafa uzatarak gol atmaya çalışan mallar asla unutmaz bu gülleyi. misal ben. <br/><br/>bir savaştan arta kalan top mermisiydi bu şerefsiz. spor için kullanılabileceğine kimse ikna edemez beni.<br/><br/>hele bir keresinde mahallede top oynarken inşaat işçisi abiler geldi, gençler maç yapalım mı diye. yedişerden maç yapıp üç şehit verdik aq. ben şuta kafa uzatayım da topun yönü değişsin gol olsun gibi bir salaklıkla bayılacak gibi oldum, kustum falan ama iyi kötü devam ettim. amelelerden biri pis burun vurdu, ömer vardı, çocuğun göğsüne geldi top. ilk defa öyle bir şey gördüm lan. hııııııııkkkkkghhh diye bir ses çıkardı, olduğu yerde ayakta kaskatı kesildi yere yatırdık hala kaskatı. zor bela kendine geldi. en sonunda da kalecimiz olacak angutun topa uzattığı kolu kırıldı. en sonunda birimiz gebermeden bitsin diyerek öyle bitirdik maçı.<br/><br/>şimdiki gençler okuduğu zaman garip gelir ama hakikaten mikasa diye bir gerçek vardı ve suratına mikasa isabet eden bir çocuğun hayatı asla eskisi gibi olmaz.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    sınıfta bir erkek arkadaşımla oturmuş aynı kitaptan test çözerken beni çağırıp "bi kız, bi erkekle böyle oturur mu? ancak kocanla bu şekilde oturabilirsin, bu ne rezillik?!" diye azarlayan pislik, bugün karşıma çıksa keşke. bana söylediği iğrenç sözleri hatırlatıp yüzüne tükürürdüm sadece o aşağılık kadının.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    erkek suserlerin kadın cinsinin suratına sormaya çekinip de buradan suallerini ilettikleri başlık isminin hedesidir<sup class="ab"><a title="(bkz: sonunu getiremedim)" href="/?q=sonunu+getiremedim" data-query="sonunu getiremedim">*</a></sup><br/><br/>- kadın rızasına son derece önem veren biri olarak, bazen beraber yattığım kişiye bile yaklaşamıyorum. sizce de aynı yatağa girildiyse, işin sonuna kadar gidilmesi için onay verilmiş midir? sizin hiç 'aynı yatakta uyuyorsak sevişeceğiz diye bir şey yok' dediğiniz oluyor mu? ben mi çok safım? <br/><br/>- eğer cevap evetse, neden hiçbir zaman ilk hamleyi siz yapmıyorsunuz?<br/><br/>- eğer cevap evetse, neden ilişkiyi orada sonuçlandırıyorsunuz?<br/><br/>- eğer cevap hayırsa, bu ne demek?
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    10 ekim 2018 dünya borsalarının çökmesi
  entry_id:  82177405
  entry_writer: casper53
  entry_fav_count: 0
  entry_content: |
    hissedar olarak kalp atışımı hızlandıran çöküştür. sarı pipi nin ticaret savaşından kaynalıklı degildir sanırsam ?<br/><br/>not : şu borsalar toplasın bir dahada girersem tüm sözlük beni sikebilir.
