...
- entry_name: |
  ...
  entry_fav_count: 88
  entry_content: |
    merak edenlerin bana bi gelirse farkı yakından göstereceğim, aradıkları cevapları ellerine verebilecegim, bir kahve dolosu gereksiz adamın sorusu.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    hackerlarin, ciplak fotograflarini ele gecirmelerini merakla bekledigim kisi.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    savaştık, korkmadık.<br/><br/>her zaman olduğu gibi.
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    yüz ortadoğulunun üç avrupalı,bir amerikalı kadar değeri yok bunu daha anlayamadız mı?
---
