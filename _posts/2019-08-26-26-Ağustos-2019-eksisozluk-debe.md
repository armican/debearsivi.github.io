...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    adamlar 2 açıdan bir arkadan bir önden çekilmiş karanlık sorgu odası sahneli teaser yayınlamış, mal oğlu malın teki de bok atmak için çölde çekim olmadığı için breakin bad havası alamadım demiş. hahsgahegsa olum nasıl tiplerle aynı başlıklara yazıyoruz tiksiniyorum alayınızdan.
...
- entry_name: |
  ...
  entry_id:  94401983
  entry_writer: everything4you
  entry_fav_count: 11
  entry_content: |
    hâlâ kınayt diyorlar
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    anneme sen git bekleme demiştim. o da hakkaten eve gitmişti. sonra gitti diye ağlamıştım.
  entry_channels: anket,tarih,eğitim
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    hep kahır; ömrüm; sevdan beni; unutamadığım; kara sevda; zeyno
