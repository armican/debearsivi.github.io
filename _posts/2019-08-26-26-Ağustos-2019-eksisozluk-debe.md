...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    25 ağustos 2019 gaziantep'te suriyelilerin kavgası
  entry_id:  94433234
...
- entry_name: |
    derin devlet imamoğlu dönemini hazırlıyor
  entry_id:  94442043
  entry_writer: at mi bu
  entry_fav_count: 62
  entry_content: |
    kurtlar vadisi izlemekten beyni süngere dönen kişi beyanı.
  entry_channels: siyaset
- entry_name: |
    25 ağustos 2019 tsk'da generallerin şok istifası
  entry_id:  94430171
  entry_writer: deli simyaci
  entry_fav_count: 61
  entry_content: |
    yıllardan beri orduyu içten içe niteliksizleştirdiler. şimdi üç beş atatürkçü vatansever subay kalmıştı,onlar da istifa ediyor.<br/>yazık bu ülkeye...
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 41
  entry_content: |
    az önce yarışmakta olan yarışmacı ali nazik yaptı. ne eti kullandın diye soruldu, dana eti dedi, dananın neresi dediler, cevap veremedi, bir şeyler geveledi. domatesi közleyemedi, yemek tam yetişmedi.<br/><br/>ardından önce gereksiz abartı gülmeler vs sempatik olma çabaları, yetmedi bir anda, durduk yere bu arada altı ay önce kocam böbrek nakli oldu, yanında oldum dedi. bi zahmet, herhalde olacaksın. ağlamalar, sarılmalar, gözyaşları durmadı ama..<br/><br/>italyan olan ve somer pek etkilenmedi bu ajitasyondan. bunu anlayınca da italyan olana ben pizza da iyi yaparım, bir şeyini beceremiyorum, onu da sizden öğrenmek isterim vs dedi. <br/><br/>en son artık ben dayanamadım, odadan çıktım.<br/><br/>döndüğümde bir gördüm ki yaptığı ali nazikte ne eti kullandığını bilmeyen bacımız turu geçmiş. <br/><br/>helaaaaalllll..<br/><br/>edit: reklam girdi de, yarın da birisinin annesi ölüyor sanırım.
...
- entry_name: |
  ...
  entry_fav_count: 39
  entry_content: |
    "adam" yazmış hahahah. kendisi kekodur. güzellik bir şeyi kapatmıyor, böyle iki kelime ettiği zamanlarda içindeki kezbanlık ortaya çıkıyor işte. olayı çok yanlış anlamış kendisi, böyle saçmalıkları yazmadan önce birilerine sorsaydı keşke.
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    istanbul bb'ye kayyum atanması
  entry_id:  94440253
  entry_writer: justin mcleod
  entry_fav_count: 36
  entry_content: |
    bir şekilde iç savaş çıkartmalı, yoksa bu kadar pisliği örtemez. kaşıyabildiği her yerden kaşıyor. onun tek kurtuluşu iç savaş. tüm pislikleri örtecek bir iç savaş.
  entry_channels: siyaset,haber
- entry_name: |
    25 ağustos 2019 ankara depremi
  entry_id:  94439084
  entry_writer: stuffed shirt
  entry_fav_count: 36
  entry_content: |
    burası harbiden kutsal bilgi kaynagı daha rasathanenin haberi yok amk.
  entry_channels: haber
- entry_name: |
  ...
  entry_fav_count: 33
  entry_content: |
    tek bir şey olmadığı kesindir.<br/><br/>sanırım en güzellerinden biri de sevdiğin insana sarılıp; birine anlatamadığımız, anlatmaya çalışsak da tam ifade edemediğimiz iyi olma halidir.<br/><br/>hiç bir şey olmasa bile, sadece sen sarıl dediğimiz insan olsa.
...
- entry_name: |
  ...
  entry_fav_count: 33
  entry_content: |
    bir galatasaraylı olarak söylüyorum bence de net penaltıdır. böyle olmasın işler yaa,yani şu hakemler olumlu ya da olumsuz etki etmesin artık şu oyunlara. hayır var odasındakiler bu pozisyon olurken başka pozisyonlar mı izliyorlar acaba. monitörlerde pornhub üyelik falan var da bizden mi saklıyorlar ?? var odası bey ne yapıyorsunuz ??
  entry_channels: spor,haber
- entry_name: |
    talat paşa'yı aşağılayan ermeni anıtı
  entry_id:  94438314
  entry_writer: alles im wasser tiefer
  entry_fav_count: 25
  entry_content: |
    (bkz: <a class="b" href="/?q=sen+t%c3%bcrk+oldu%c4%9funu+unutsan+da+d%c3%bcnya+asla+unutmaz">sen türk olduğunu unutsan da dünya asla unutmaz</a>)<br/><br/><a class="b" href="/?q=hepimiz+ermeniyiz">hepimiz ermeniyiz</a> sloganı atanları rahatsız etmeyecek anıttır.
  entry_channels: siyaset,haber
- entry_name: |
    aslan191919
  entry_id:  94401976
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    çay içen birinin entelektuel olmasını beklemek
  entry_id:  94439530
  entry_writer: devekusunungozu
  entry_fav_count: 15
  entry_content: |
    eskinin trollerinde bir zeka, bir espri, bir incelik vardı. şimdikiler dümdüz moron. <br/><br/>trollük biraz ince zeka gerektiriyor be kardeşim. iki üç kelimeyi yanlış yazarak gülücükler koyarak trollük yapılmaz. biraz dersini çalış öyle gel. bu olmamış
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    senden tek bi istegim var. ne yap et subat ayından berı galıbıyet alamadıgın konyadan 11. haftadakı kadıkoy macına kadar kovulma.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  94440961
  entry_writer: mintiminti1
  entry_fav_count: 4
  entry_content: |
    dante'nin ilahi komedyası. dipnotlar yüzünden ilgi dağılıyor.<br/><br/>benim adım kırmızı. orhan pamuk post modern yazacağım diye aklına gelen kelimeleri sıralamış. halbuki bir mantığı olmalı.<br/><br/>katre-i matem. yazarın diğer kitaplarını hızlıca okumama rağmen bu bitmedi. sanırım sanat yapmak isterken fazlaca arapça ve farsça kelime kullanmış. <br/><br/>sultanı öldürmek. gereksiz tasvirler sıktı.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    oldukça. kadınlardan daha çok erkekler beğeniyor ama olsun.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    ryan babel
  entry_id:  94442004
  ...
  entry_fav_count: 3
  entry_content: |
    futbolu kafasında bitirip kariyerine çilekli puding olarak devam eden topçu.
  entry_channels: spor
- entry_name: |
    jean michael seri
  entry_id:  94441934
  ...
  entry_fav_count: 3
  entry_content: |
    yani ikinci maçını izliyoruz şu an ve ben türkiye'de bu topu oynayabilecek bir sürü türk oyuncu sayabilirim. fazla bir artısını göremedim. dürüst olmak gerekirse...
  entry_channels: spor
- entry_name: |
    parkurumda yiyişme sigara içme it gezdirme
  entry_id:  94441172
  entry_writer: charriere
  entry_fav_count: 2
  entry_content: |
    yüzde yüz haklı serzeniş. koşu için yapılan parkurların başka herhangi bir şey için kullanılması alanı asıl amacı için kullanılamaz hale getiriyor.<br/><br/>kamu malı demek, herkesin her istediğini yapabileceği yerler değildir arkadaşlar. bakın kimse size şehir ortamında dogo pitbull beslemek gibi eziklikler yapmayın demiyor. ciğerlerinize çektiğiniz zehirli duman da -normalde- kimsenin umrunda değil fakat her şeyin yeri var, zamanı var. lütfen.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    ömrümde sadece bir kez karşılıklı<sup class="ab"><a title="(bkz: ki evliyiz kendisiyle)" href="/?q=ki+evliyiz+kendisiyle" data-query="ki evliyiz kendisiyle">*</a></sup>, bir kez de karsiliksiz olarak asik olunan kisi oldum. <br/><br/>karsilikli olan iyi guzel, kuşlar kelebekler modunda takiliyorsunuz ama, karsiliksiz olan çok fena her iki taraf icin de. ılgisi bir yandan mutlu hissettiriyordu, bir yandan da geriyordu. ümit vermek istemiyordum, ama kırılmasını da istemiyordum. tuhaf bir surecti. ki kirilmasina engel olamadim. onu uzecek bir suru şey yaptim. ben bu kadar kötü biri miyim ki beni seven birini üzdüm diye bunalima sokar adami. degisik...<br/><br/>aşkın en guzel hali karsilikli olan evet, ikincisi herhalde o da benden hoslaniyor mu acaba heyecaniyla gecen platonik evre, ama en kotu olan kesinlikle sevilmedigini bile bile aşık olmak. her iki taraf icin de cok zor.
  entry_channels: ilişkiler
- entry_name: |
    steven n'zonzi
  entry_id:  94438125
  ...
  entry_fav_count: 0
  entry_content: |
    yanılmıyorsam ismi zonzi olarak telafuz ediliyor. beinsports'da vs. ısrarla enzonzi olarak okunuyor.
  entry_channels: spor
- entry_name: |
    mbaye diagne
  entry_id:  94424311
  ...
  entry_fav_count: 0
  entry_content: |
    gitmeyeceği aşağı yukarı kesinleşen futbolcu.<br/><br/>ve mevcutta elimizdeki tek golcü.<br/><br/>burayı okuyan ve bugün benimle birlikte tribünde olacak dostlara sesleniyorum; ıslıklamak, yuhlamak gibi bir hata yapmayın.<br/><br/>bu adamda 8 yaşındaki bir çocuğun zekası var.<br/><br/>işleri daha da berbat edersiniz.
  entry_channels: spor
- entry_name: |
    futbol başlıklarına tıklamayan erkek
  entry_id:  94442593
  entry_writer: parapapam
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=helal">helal</a>) (bkz: <a class="b" href="/?q=adam">adam</a>) (bkz: <a class="b" href="/?q=erkek">erkek</a>) (bkz: <a class="b" href="/?q=karizma">karizma</a>) (bkz: <a class="b" href="/?q=entelekt%c3%bcel">entelektüel</a>) (bkz: <a class="b" href="/?q=zeki">zeki</a>) (bkz: <a class="b" href="/?q=modern">modern</a>) (bkz: <a class="b" href="/?q=helal+demi%c5%9f+miydim">helal demiş miydim</a>) (bkz: <a class="b" href="/?q=atomu+par%c3%a7alarken+kolay+gelsin">atomu parçalarken kolay gelsin</a>)<br/><br/>ulan iyi gıcıklık yaptım, ben de tıklamıyorum halbuki çok. :(
  entry_channels: 
- entry_name: |
