...
- entry_name: |
  ...
  entry_id:  73627979
  entry_writer: nameless
  entry_fav_count: 39
  entry_content: |
    (bkz: <a class="b" href="/?q=her+ku%c5%9fu+siktik+bir+kuzgun+kald%c4%b1">her kuşu siktik bir kuzgun kaldı</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    "dağda piknik yapan kürt gençleri olduğu" yazılır birazdan. tabii aralarında üç de çocuk olduğunu söylemeden olmaz.
- entry_name: |
    25 yaşında olmak
  entry_id:  73634045
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    konur sokakta bir yandan çığırarak bildiri dağıtmakta bir yandan da iki haftadır yıkamadığı saçları ile topluma dehşet saçmaktadır.
- entry_name: |
    nabil dirar
  entry_id:  73637815
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    teröristler entrylerini silerek kendiliğinden başlığa gelmeye başladı. hepsinin ekran görüntüleri alındı merak etmeyin.<br/><br/>(bkz: <a class="b" href="/?q=ho%c5%9fgeldiniz+orospu+%c3%a7ocuklar%c4%b1">hoşgeldiniz orospu çocukları</a>)
- entry_name: |
    20 ocak 2018 g.saray'ın dursun özbek'i göndermesi
  entry_id:  73639332
  entry_writer: aegeus
  entry_fav_count: 1
  entry_content: |
    <a class="b" href="/?q=demokrasi">demokrasi</a>nin, eğitimli ellerde nasıl da doğru sonuçlar verdiğinin güzel bir örneğidir.
- entry_name: |
    selçuk şahin
  entry_id:  73639085
  ...
  entry_fav_count: 0
  entry_content: |
    gökhan gönül'ün, caner'in falan takımı sattığı bir ortam da bu adamın fenerbahçe'liğine güvenmek komik olurdu...<br/><br/>öyle artık volkan demirel gibi, sabri sarıoğlu gibi bağlılığı olan adamları bulmak imkansızdır. hepsi paraya tapan tipler artık. bütün takımlar için geçerli bu.
- entry_name: |
