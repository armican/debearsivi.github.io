...
- entry_name: |
  ...
  entry_fav_count: 23
  entry_content: |
    6 oyuncu değişikliği olmuş, göztepeli defans oyuncusunun sakatlık numarası esnasında 1 dakika, kalecisinin sakatlığında 1,5 dakika durmuş, "6 dakika uzatacak ne var?" diye kafa sikenler var.
- entry_name: |
...
- entry_name: |
    av agir hewa welat ultra edition
  entry_id:  73630434
  entry_writer: hirhiz
  entry_fav_count: 17
  entry_content: |
    pkk sempatizanı çocuk katillerinin savunucusu biri. sözlükten şutlanması gerekiyor.
- entry_name: |
...
- entry_name: |
    tsk afrin'i bombalarken kem küm eden çakma solcu
  entry_id:  73635109
  entry_writer: metafor yapim teknikleri
  entry_fav_count: 5
  entry_content: |
    normalde bir insanın gerçek solcu olabilmesi için herhangi bir savaş durumunda direk "allah askerimizin yar ve yardımcısı olsun" yazması gerekir. aksi takdirde bu kişiye solcu denmez. sağcı denir. <br/><br/>bazı insanlara okuma yazma öğretilmemeli. arka arkaya kelimeler yazınca bunların türkçede bir anlamı var zannediyor amın feryatları.
- entry_name: |
    nabil dirar
  entry_id:  73637815
  ...
  entry_fav_count: 5
  entry_content: |
    yıllardır fenerbahçeyi izlerim, heralde bu kadar boş bir futbolcu görmedim. artık o da bazı şeylerin farkında ki oynamıyor, koşmuyor, bir bok yapmıyor. babası aykut kocamana kıçını dayamış fenerbahçenin parasını yiyor. gerçekten senin allah belanı versin, rvp gibi en yakın zamanda gidersin inşallah.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    sk gaming gibi bir takıma saçma sapan roundlar vererek major'daki ilk maçını kaybeden takım. bu maçı sk almadı, biz kaybettik. mac10'inize sokayım ss. alacağınız maçı verdiniz. major şampiyonluğu olan takımı elinizden kaçırdınız. uykumdan feragat ettim lan. ayıp be.
- entry_name: |
    eleague major 2018
  entry_id:  73625048
  ...
  entry_fav_count: 1
  entry_content: |
    28. raund şanssızlıkla değil avellikle açıklanır maalesef. a girerken shadow check yapmadıkları an kaybettiler oyunu. evet taco son vuruşta şanslıydı ama işin oraya kadar gelebilmesi de bizimkilerin şansıydı. bence sk gaming kadrosunun signature iki haritasından biri olan mirage’da hiç de fena oynamadılar ama beleşten o kadar raund verirsen kaybedersin. yazık oldu. bakalım ikinci turda kim gelecek. ben gözüme big’i kestirmiş durumdayım astralis falan gelmez umarım.<br/><br/>ekleme: cloud9 geldi. shroud reyiz önderliğindeki clown9 zamanı olsaydı ss alır derdim de mevcut kadroyla oldukça zor eşleşme.
- entry_name: |
    ekşi sözlük dertleşecek insan veritabanı
  entry_id:  73637847
  entry_writer: uctupak
  entry_fav_count: 0
  entry_content: |
    yaş: 0-6<br/>cinsiyet: farketmez<br/>şehir: zeon<br/>meslek: serbest<br/>din: göktanrı <br/><br/>bunlar aradıklarım. gel bul beni...
---
