...
- entry_name: |
  ...
  entry_fav_count: 109
  entry_content: |
    kentsoylu olup da köylüleri aşağılayan pek insan görmedim. genelde, bir-iki nesil önce şehirle tanışmış insanlarda görülür, bu tür vakalar.
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    türk kızlarının yabancı erkek merakı
  entry_id:  101340691
  entry_writer: drbaris
  entry_fav_count: 3
  entry_content: |
    aslında arka planda olan düşünce bu hayattan kurtulup başka ülkede yaşamaya çalışmadır.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  101336597
  entry_writer: halditls
  entry_fav_count: 1
  entry_content: |
    eskiyen bir özleme sığınmak, durulmak isterdim. güzel olabilirdi sahiden. “özlem duyulan kişi-ler?” düşündüm birkaç on saniye. aklıma kimse, hiçbir şey gelmedi. siz, özlemlerinize tutunun.
  entry_channels: anket,ilişkiler
- entry_name: |
    peşinden koşulacak hatun
  entry_id:  101372223
  entry_writer: gokyuzunden habersiz ucurtma ucurmusum
  entry_fav_count: 1
  entry_content: |
    hatun aşşa hatun yukarı. hayır dayanamıyorum giriyorum bende yazıyorum :d
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    yılbaşında kırmızı fes hediye ederek tutkulu bir jest yapılması gereken mütedeyyin sevgili.
  entry_channels: 
- entry_name: |
...
- entry_name: |
    burger king
  entry_id:  101352652
  entry_writer: triancula
  entry_fav_count: 1
  entry_content: |
    bir mcdonald's değildir
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    aslında çaylak yazar fark etmeden yazabilirsiniz. yeni biriyle tanışmak isteyen herkesi beklerim. boş da konuşabiliriz önemli bir meseleyi de. siz karar verin. yeşillendirebilirsiniz.<br/><br/>yaş 29. erkek.
