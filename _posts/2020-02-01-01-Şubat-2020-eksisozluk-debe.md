...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    (bkz: <a class="b" href="/?q=mihal%c4%b1%c3%a7%c3%a7%c4%b1k">mihalıççık</a>)
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    benim yaptığımdır. yoksa araya kaynak yapıyorlar kavga çıkıyor. başıma geldi.
  entry_channels: ilişkiler
- entry_name: |
    osmanlı'dan hiç ünlü iç mimar çıkmaması
  entry_id:  101372015
  entry_writer: sokonugeri
  entry_fav_count: 0
  entry_content: |
    iç mimarlığın sektör olarak adlandırılması 20. yüzyılın sonlarına doğru olmasından ötürü olabilir mi acaba aq?<br/>mimarlık mesleği henüz böyle bi sektörelleşmeye uğramamış, herkes mimar, içi dışı yok. adam ciddi ciddi iç mimar çıkmaması yazmış ya ahahah.<br/><br/>edit: ulan nasıl sinirlendim ya.. aç cüzdanını çıkar içinden 20 lirayı al sana mimar aq.. ha pardon iç mimar değil doğru dedin..
  entry_channels: 
- entry_name: |
    okunması zor kitaplar
  entry_id:  101372682
  entry_writer: otokontrol delisi
  entry_fav_count: 0
  entry_content: |
    sineklerin tanrısı.<br/><br/>mecburen okumaya çalisiyorum ama patlayacağım artık!
  entry_channels: anket,edebiyat
---
