...
- entry_name: |
  ...
  entry_fav_count: 374
  entry_content: |
    tacizi uluslararası boyuta taşımak istemişler herhalde.<br/><br/>skandal açıklama.
...
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    "irfan halleder" <br/>"irfan yapar"<br/><br/>diye diye adamın belasını belledi kadın. yapamayınca da hakaret ediyor.<br/><br/>böyle kadınlar adamı hırsızda yapar katilde. ibret alın eheh.
...
- entry_name: |
    maaşınızın size söyleyeceği ilk söz
  entry_id:  101374921
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    yıkarken iğne ucu kadar boş yer bırakma.
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    ocak ayi bitmeden uzaydan da geldi demek bir seyler.<br/>hadi 2020, basarabilirsin
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    ölçüsüzlüktür;<br/>davranışlarda<br/>söylemlerde<br/>insan ilişkilerinde<br/>yemede içmede<br/>kural-kaide koymakta<br/>çalışmakta<br/>yorulmakta<br/>dinlenmekte<br/>itikatte<br/><br/>sınır koymamaktır. basiretsizliktir.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    yıllardır parayı gömüp başarı sağlayamayan çok takım var. ilk aklıma gelen khimky. son zamanlarda milano, zenit, maccabi takımları da ciddi yatırımlar yapıyor. en fazla orta-üst takım olabildiler. ama efes bu takımlardan daha az bütçeyle çok çok çok kısa bir sürede elit bi takım oldu.<br/><br/>teşekkürler ergin ataman.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  101374105
  entry_writer: homeross
  entry_fav_count: 0
  entry_content: |
    <sup class="ab"><a title="(bkz: kurtlarla koşan kadınlar)" href="/?q=kurtlarla+ko%c5%9fan+kad%c4%b1nlar" data-query="kurtlarla koşan kadınlar">*</a></sup>
  entry_channels: anket,edebiyat
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=adil+gevrek">adil gevrek</a>)
