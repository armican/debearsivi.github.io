...
- entry_name: |
    eşim yemek seçiyor boşanmak istiyorum
  entry_id:  82118919
  entry_writer: duyulmasi gerektigi kadar
  entry_fav_count: 452
  entry_content: |
    para istemenin adı boşanma olmuş amk memleketinde.
...
- entry_name: |
    sen giderken ben dönüyordum ingilizcesi
  entry_id:  82124166
  entry_writer: ofsayttandogan
  entry_fav_count: 113
  entry_content: |
    (bkz: <a class="b" href="/?q=i+wasn%27t+born+yesterday">i wasn't born yesterday</a>)
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    galatasaray'ın her devrin kulübü olması
  entry_id:  82122998
  entry_writer: highdegree
  entry_fav_count: 71
  entry_content: |
    (bkz: <a class="b" href="/?q=fikret+orman%27n%c4%b1n+m.+kemal+pankart%c4%b1na+siyasi+demesi">fikret orman'nın m. kemal pankartına siyasi demesi</a>)<br/><br/>(bkz: <a class="b" href="/?q=fikret+orman%27%c4%b1n+akp+batman+kongresine+kat%c4%b1lmas%c4%b1">fikret orman'ın akp batman kongresine katılması</a>)
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 50
  entry_content: |
    9 ekim 1967 yılında, <a class="b" href="/?q=bolivya">bolivya</a> semalarında haince ve kalleşçe öldürüldü bir aslan...<br/><br/>51. ölüm yıldönümünde saygı ve özlemle andığım büyük devrimci! güzel insan.<br/><br/><a class="b" href="/?q=che+guevara">che guevara</a>: <br/><br/>"biliyorum, bu sözlerimi birileri yanlış yerlere çekecek hatta gülecekler lakin bu bir gerçektir; devrimci olabilmek için sevmesini bilmelisin!"<br/><br/><a class="b" href="/?q=hasta+siempre">hasta siempre</a>!
  entry_channels: siyaset,ekşi-sözlük,tarih,edebiyat
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    cahiliye devrinde neden kız çocukları gömülüyordu
  entry_id:  82131730
  entry_writer: sutterkane
  entry_fav_count: 37
  entry_content: |
    sözde cahiliye devri ve o dönemde olduğuna inanılan herşey gerizekalı dinci propagandasıdır, başarılı olmak isteyen her din önceki dönemi kötüleyerek ve onun putlarını yıkarak işe başlar. lat, uzza ve menat zaten islamiyet öncesi arap'ların tapındığı tanrıçaları temsil ediyordu. tanrıçalara tapan bir toplumun kız çocuklarını gömdüğünü iddia etmek aynı şekilde gerizekalıca bir iddiadır.
...
- entry_name: |
    eminönü'ndeki bedava seks izdihamı
  entry_id:  82124194
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    olmayan kadındır. kadınlar seviştikleri erkeklerle duygusal bağ kurarlar. bu nedenle bu argüman çöker.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    pazarda işportada satabileceğim, pahalı olmayan, düşük kalite<br/>bayan-çocuk giyim ürünleri, çorap, havlu vs. toptan tekstil işleri yapan arkadaşlar varsa yeşillendirsin lütfen.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    100 milyon euro transfer butceside vereceksen hic durma hemen getir. ama bu adamin ekibiyle birlikte getirmen zaten 100 milyon euro tutatacagi icin geriye transfer butceside kalmiyor. cunku tek basina ayni kadroya getirirsen sadece havan olur belki ondan dolayi biraz daha iyi sonuclar alirsin
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    isminden tam emin olmamakla beraber "choker kolye" . iyidir. baya yükseltir ratingi.
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ankara katliamı'nda yıldız olan dostları anarak:<br/><br/>...çünkü kanları, kanları, kanları hatırlarım<br/>çünkü ölülerimiz toplanacaktır<br/>ve yüceltilecektir bir mavide.
