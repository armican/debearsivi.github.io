...
- entry_name: |
  ...
  entry_fav_count: 68
  entry_content: |
    pw2.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://mega.nz/#F!qA8nTTTA!dmIM8eZ7tPGdavFyT5mnLQ!3EVGUTDQ" title="https://mega.nz/#F!qA8nTTTA!dmIM8eZ7tPGdavFyT5mnLQ!3EVGUTDQ">mega link</a><br/><br/>hatırlatma: azw3 veya mobi'ye çevireceksiniz calibre veya online çeviriciler ile.
...
- entry_name: |
  ...
  entry_fav_count: 43
  entry_content: |
    amcanın küçük kızı çektiği videoyu izlediğimde çocuğun spor ayakkabısı giydiğini gördüm. bu çocuk eve teslim edilip tekrar kimseden habersiz evden çıkıp diğer çocuğun arkasından gittiyse demek ki ayakkabısını eve girerken çıkarmadı. çünkü 3 yaşını doldurmamış çocuk o ayakkabıyı mümkün değil kendi başına giyipte tekrar evden çıkamaz. sonrasında amcanın röportajını izlediğimde “eve bıraktım hatta ayakkabısını da çıkardım “ dediğini görünce anlaşılan şu , bu çocuk evden tekrar çıkmadan önce buna ayakkabısını biri giydirdi. ve çıktığından haberi var.
  entry_channels: haber
- entry_name: |
    muharrem ince
  entry_id:  78340916
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    insanların ne söylediklerini değil, ne yaptıklarını baz almak. kuru laf çook... söz uçar, fiil baki kalır çocuklar, bunu da bir kenara not edin.
...
- entry_name: |
    işmerkezindeki çöp kutusuna sıçan adam
  entry_id:  78366034
  entry_writer: generalcock
  entry_fav_count: 3
  entry_content: |
    birileri ne zaman bir yerlere sıçsa ülkece farklı yerlere savrulduğumuz dönemde bu adam çöp bidonuna sıçarak <a class="b" href="/?q=ne+yapmak+nereye+varmak+istemektedir">ne yapmak nereye varmak istemektedir</a>.
  entry_channels: haber
- entry_name: |
  ...
  entry_channels: siyaset
- entry_name: |
    ince neden akşener'den daha başarılı oldu
  entry_id:  78371094
  entry_writer: mimarishvili
  entry_fav_count: 1
  entry_content: |
    meral akşener in mitingleri daha az yayınlandı. bir de yeni kurulan partiye göre bu kısa sürede büyük bir oy oranı alacaktır. biraz da bu taraftan bakın. chp ve akp yıllardır var. türkiye’de erişilmedik nokta bırakmadılar. iyi parti kısa sürede büyük bir iş yapmadı mı sizce?
  entry_channels: siyaset,anket
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    anlamadığım sekilde gece 12'den sonra hortlayan başlık ve soru niteliği hep bel altı.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
