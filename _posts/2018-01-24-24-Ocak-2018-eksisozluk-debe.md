...
- entry_name: |
    ev sahibi olmadan evlenen insan
  entry_id:  73699358
  entry_writer: cigarillo
  entry_fav_count: 29
  entry_content: |
    babamdır. ev yok araba yok evlenmiş utanmadan, iki tane de çocuk koymuş bak bak, hala aklı başına gelmemiş onları okutmuş birini mühendis diğerini öğretmen yapmış.<br/>sen kimsin be adam?<br/><br/>insan gerçekten hayret ediyor.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    ben izlediğim, okuduğum, oynadığım ürünleri "keşke şöyle olsaydı" diye eleştirme taraftarı değilim; "sen öyle yaparsın o zaman" diyerek tadını çıkarmaya çalışırım. hele senaryolara, "bence mahmut leyla'yı öpmeliydi" tadında yaklaşanlara ağır uyuz oluyorum.<br/><br/>ancak ağır bir star trek fanı olarak ilk defa sıkım sıkım sıkılarak, canımdan bezerek, iki üç parça halinde bitirebiliyorum bir bölümünü. deep space 9 nerede, bu nerede diyorum şahsen ben ama yeni nesil böyle şeyleri seviyor demek ki. <br/><br/>sebeplerim de şöyle; bütün bölümleri boyunca bilimsel temeli olan, teknolojik gelişme temsil eden, "star trek'in misyonu" bağlamındaki aklımda kalan tek şey hologram ayna idi ki onu da bağır bağır gösterdiler zaten. ayrıca şu spore drive, tardigrad filan olayları cidden can sıkıcı derecede temelsiz, fantastik geliyor bana. geçmişte de her detayını bilimsel olarak temellendirmek derdi elbette yoktu ama alcubierre drive, gezegenler/türler arası federasyon (multiculturalism), silikon bazlı yaşam formu, quantum entanglement, yapay zeka, ne bileyim dyson sphere filan hep geniş kitlelere ilk olarak star trek ile anlatılmıştı. star trek bir bilimsel iletişim platformudur yani bir yanıyla.<br/><br/>sebebi şu olabilir, ki sözlükteki yorumlar da destekliyor nitelikte; abd'de, hele bilimkurgu dizileri arasında çok sert bir rating sistemi var, bunlar rating getiriyordur, hayatta kalmak için bu yola girmiştir. sonuç itibariyle bir belgesel değil.<br/><br/>bir de şu konuda hak veriyorum aslında. brexit gibi bir vakanın hayata geçebildiği, trump, rte gibi şahısların hızla hakimiyet alanını genişlettiği, çok ulusluluk yerine faşizmin, birlikteliğin naiflik addedilmesiyle zenofobinin tercih edildiği bir dünyada star trek evreni yerine böyle bir evrenin gösterilmesi de nafile bir çaba değil.<br/><br/>avrupa birliği'nin insanlık için gerçekten bir şans olduğu dönemleri ve star trek the next generation'ı özlüyorum ben.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    sistemlerindeki problem artık bir utanç halini almıştır. zaten düzgün çalıştığında da çoğu yerde geçmiyorken bir de bozulup cebinde kartları dışında yemek parası olmayan arkadaşlarımı mağdur etmişlerdir. bir şekilde bu rezaleti yaşayan herkese şirketleri üzerinde baskı kurup başka bir karta geçmeye çalışmalarını öneriyorum.<br/><br/>bu arada, eğer düzgün yedekleme yapmıyorlarsa ve insanların paralarını yuttularsa asıl o zaman izle hengameyi.
- entry_name: |
