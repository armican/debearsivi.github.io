...
- entry_name: |
    oğuzhan uğur
  entry_id:  73691342
  entry_writer: zeljko obradovic
  entry_fav_count: 16
  entry_content: |
    son mevzular videosunda anlattıgı şeylerin %99 una katılıyorum ama aklıma takılan bir şey var suriyede bu kadar aktif rol alan rusya hakkında en ufak bir cümle kurmamasının babasının siyasi görüşüyle ilgisi var mı çok merak ediyorum.
- entry_name: |
    ekşi itiraf
  entry_id:  73694720
...
- entry_name: |
  ...
  entry_id:  73707010
  entry_writer: emcekare olmadi einstein olsun bari
  entry_fav_count: 8
  entry_content: |
    -x bey siz internet kullanıyor musunuz? (muhtemelen kullandığımı biliyor)<br/>+evet kullanıyorum.<br/>-ya biz de kullanmak istiyoruz da nasıl yapsak? (burada nasıl internet bağlatılır diye soruyor sandım)<br/>+nasıl yani?<br/>-biz de kullanabilir miyiz sizin interneti? (haaa)<br/>+valla zaten telekom taahhüt ettiği internet hızını sağlayamıyor. bana gelene kadar internet hızı baya düşüyor. benim için de hız önemli, kusura bakmayın.<br/>-tamam o zaman.<br/><br/>doğruyu söyleyin yeter.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    bu durumda ben allame-i cihan oluyorum herhalde.
- entry_name: |
    demarcus cousins
  entry_id:  73705126
  ...
  entry_fav_count: 1
  entry_content: |
    allahın bi yerden alıp bi yerden vermesinin en güzel örneklerinden biri bu adam. bunun beynini kuşa taksan kuş ters uçar o derece gerizekalı biri. yine de çok yetenekli, dominant bir basketbolcu. biraz akıllı biri olsa herkes nba'de ondan bahsediyor olurdu.
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    saçma sapan bir tespit. hakkıyla para kazanandan kimse nefret etmez. örneğin cem yılmaz, daha da çok kazansın isterim. elon musk, j.k. rowling, charlie brooker vs.
- entry_name: |
    akp'li başkanın akıllara ziyan afrin mesajı
  entry_id:  73708450
  entry_writer: zamazingonun tam ortasi amazing
  entry_fav_count: 0
  entry_content: |
    15 milyon <a class="b" href="/?q=deli+ibrahim">deli ibrahim</a> birleşmiş, parti kurmuş, 15 yıldır da iktidardalar...<br/><br/>şaka mısınız amk?
---
