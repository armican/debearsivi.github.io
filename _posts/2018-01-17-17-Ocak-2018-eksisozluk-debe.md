...
- entry_name: |
    sahibinden.com'daki galeriden satılık anadol
  entry_id:  73548297
  entry_writer: mastor
  entry_fav_count: 21
  entry_content: |
    (bkz: <a class="b" href="/?q=araba+tak%c4%b1nt%c4%b1s%c4%b1+olan+aramas%c4%b1n">araba takıntısı olan aramasın</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    gezi direnişinde -kıt beyinleri nedeniyle- direnişin ruhunu bir türlü kavrayamamış, o yüzden ellerinde taşlarla, molotoflarla, flamalarla ortaya çıkıp, oraya temiz yürekleriyle gelmiş insanları bezdirip kendilerine lanet ettirirek evlerine geri dönmelerine yol açan ufak kitlenin bir nevi lideri.<br/><br/>sinek gibi ufaklar ama maalesef mide bulandırıyorlar. gezi'yi bitirdiler oradaki insanları tiksindirerek parçalayıp küçültme misyonlarının devamını da ana muhalefette yerine getirmeye devam ediyorlar bu sefer <br/><br/>bir de eleştirenleri mahkemeye vermekle tehdit etmiş haspam. rica ediyorum kanzuk benim ip'mi bu kadına özellikle versin, bugüne kadar hakkında söylediklerimi ve daha fazlasını mahkemede bir de gözlerinin içine bakarak, suratına tükürerek söylemeyen adam değildir. sizden korkan sizin gibi olsun lan, ahlak, onur yoksunu omurgasız sülükler!
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    ilker yağcıoğlu'nun maç boyunca en az 10 kez "her şey aykut kocaman'ın istediği gibi gidiyor" dediği maç olmaktadır.<br/><br/>biz izleyiciler olarak sorun da tam olarak bu zaten.
- entry_name: |
...
- entry_name: |
    kola kapalı ayran ve toplu iğne
  entry_id:  73547811
  entry_writer: rocky43
  entry_fav_count: 5
  entry_content: |
    (bkz: <a class="b" href="/?q=5+lt+su+%2b+1.5+lt+su+%2b+ayran+%2b+toplu+i%c4%9fne">5 lt su + 1.5 lt su + ayran + toplu iğne</a>)
- entry_name: |
    ripple
  entry_id:  73535758
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=vazge%c3%a7tim+anketten">vazgeçtim anketten</a>)
- entry_name: |
    eljif elmas
  entry_id:  73540284
  ...
  entry_fav_count: 1
  entry_content: |
    van persie'den daha fazla katkı sağlayacaktır. hayırlı olsun.
- entry_name: |
    boş minibüste en öndeki koltuğa oturan kız
  entry_id:  73547930
  entry_writer: smete
  entry_fav_count: 1
  entry_content: |
    "bunu sana sormak lazım" tepkisi verdiğim vakadır.<br/>minibüs boş. minibüs şoförünün kalitesini beğenmediğine göre minibüs şoförü sen değilsin. o zaman o "boş" minibüste kalan tek kişi sensin dostum.<br/><br/>hadi minibüs tam boş değil ve üçüncü kişi olarak sen varsın diyelim. o halde de sen nasıl bir tipsin ki kızcağız seni görünce koşa koşa "kalitesiz" minibüs şoförüne sığındı.
- entry_name: |
    black mirror
  entry_id:  73528501
  ...
  entry_fav_count: 1
  entry_content: |
    — spoiler 4. sezon 2. bölüm arkangel -<br/>ileride çoluk çocuğumuzun çevresinde olup onları kötü etkileyecek ruh hastası gençler içerir. <br/>arkadaş 15 yaşında her türlü haltı yiyip, her boku deneyecek özgürlük ya da özgüven tanımıyorum ben. haydi gözün döndü iki kefe vurdun ama o tabletle tam gücüyle annesine defalarca vurması yok mu?<br/>ha birde o yaşta annenin suratını dağıtıp daha sonra bir spor çantasıyla evden çıkıp nereye gideceksin acaba. dünya hakkında ne biliyorsun beyinsiz. <br/>umarım tırcılar ve minibüsçüler arasında tecavüzlerden tecavüz beğenir dediğim anda bir tır bulup yoluna devam etmiştir.
- entry_name: |
    şu anda çalan şarkı
  entry_id:  73532381
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    tanımında yavuz çetin var. arkadaş bütün boktan kıskançlıklarımı törpüledim, bu adamın bir yerde çalıp bilinmesi kıskançlığını törpüleyemedim.
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    istanbul, 24, yazılımcı..<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="http://ribony.com/cmkcmk">http://ribony.com/cmkcmk</a><br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="http://connected2.me/cmkcmk">http://connected2.me/cmkcmk</a>
- entry_name: |
    ekşi itiraf
  entry_id:  73546016
  entry_writer: mastor
