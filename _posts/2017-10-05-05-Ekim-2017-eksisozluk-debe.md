...
- entry_name: |
    azimle sıçan duvarı deler ingilizcesi
  entry_id:  71172816
  entry_writer: calemityceyn
  entry_fav_count: 129
  entry_content: |
    dıııt yanlış. <br/><br/>daha turkcesini ogrenmeden ingilizce cevirisini yapmak, akil sahibi olmadan fikir sahibi olmaya benzer. <br/><br/>dogrusu; <br/><br/>(bkz: <a class="b" href="/?q=azimli+s%c4%b1%c3%a7an+duvar%c4%b1+delermi%c5%9f">azimli sıçan duvarı delermiş</a>)<br/><br/>edit: kiyamam aciklama da yaparmis. olmamis ama o aciklama. cevirin de olmamis. otur, <a class="b" href="/?q=s%c4%b1f%c4%b1r">sıfır</a> ssfgfdasfg. <br/><br/>(bkz: <a class="b" href="/?q=%c3%b6nce+g%c3%bcld%c3%bcm+sonra+bast%c4%b1m+eksiyi">önce güldüm sonra bastım eksiyi</a>)
- entry_name: |
    selanik yahudileri
  entry_id:  71183909
  entry_writer: garda
...
- entry_name: |
  ...
  entry_fav_count: 27
  entry_content: |
    hayatımı değiştiren adamsın.<br/>bir gün televizyonda tartışma programında seni izliyordum.<br/>hanım ekrana baktı.<br/>- sen tartışınca kızınca aynı bu adama benziyorsun <br/>dedi.<br/>ekrana baktım.<br/>senin gülümseyişine baktım.<br/>kendime baktım.<br/>tövbe ettim.<br/>hala tartışırken aklıma senin o sırıtan ifaden geliyor ve daha sabırlı daha anlayışlı daha asil olmaya çalışıyorum.<br/>melih başkan bilmeyerek hayatımı yoluna koydun sağolasın.<br/>seni fışkıyelerini beyaz tv. yi hiç özlemiyeceğim.<br/>by by.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    bana dedemi hatırlatan dizi.<br/><br/>o da rick gibi aşağılık kendini beğenmiş çıkarcı orospu çocuğunun tekiydi.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    tinercilerin daha şimdiden “abiğcim lütfen şunları yenin bee” diye ağlaştığı maç. hadi al şu 1 lirayı kaybol. hem uzay takımıyız diyorlar hem de başka takımdan medet umuyorlar. <br/><br/>(bkz: <a class="b" href="/?q=yallah+nalbura">yallah nalbura</a>)
- entry_name: |
