...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    öyle bir anlatmış ki kendi yaptığı belli olan,vicdanını rahatlatmak için buraya yazan iki yüzlü bir adamın tespitidir.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    orta yapıldığı anda rizesporlu oyuncunun iki eliyle kaleciyi engellediği için iptali doğru olan karardır.
  entry_channels: spor
- entry_name: |
    fernando muslera
  entry_id:  84144956
  ...
  entry_fav_count: 3
  entry_content: |
    rakip atak yapıyor top musleraya geliyor sonra tekrar atak yapıyorlar. neden çünkü muslera her topu adamlara veriyor, oyuna bu kadar kötü top sokan kaleci inatla ileri gidin diyor. bir de ağır ağır hareket ediyor. izlerken sinir krizi geçiriyorum iyi top çıkarıp maçı kurtarmış, olm atakların yüzde sekseni musleranın rakibe şişirdiği toplardan oluyor. bir allahın kulu da uzun top kullanma diyemiyor teknik ekipten. söz geçiremiyor,
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    eşcinseller ülkenin gerçeğidir çünkü bir köylünün oğlu, bir öğretmenin kızı, bir askerin evladı vs. toplumun bir parçasıdır.<br/>toplumun bunu kabullenmesi zor, bunu da anlamak lazım. tabular zor yıkılır hele ki ortadoğu toplumlarında. ama bir ağaç, bir masa, bir doktor, bir dağ ne kadar gerçekse bir eşcinsel de o kadar gerçek, o kadar normaldir.<br/><br/>eşcinsellerin eksiği toplum nazarında yalnızca seksle ilişkilendirilmiş olmaları. daha görünür oldukça eşcinseller, hayatın her alanında oldukları anlaşıldıkça halkın bakışı da değişecek eminim. <br/><br/>bir kere geldiğimiz hayatın hiçbirimize zehir olmasına gerek yok, sadece hoşgörü ve karışmamak yeterli.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=m%c3%bc%c5%9fk%c3%bclpesent">müşkülpesent</a>)<br/><br/>hastasıyım.
  entry_channels: tarih,edebiyat
- entry_name: |
    geceye bir şarkı bırak
  entry_id:  84150912
  entry_writer: slapbass
  entry_fav_count: 0
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=yjIUkiGCFTg" title="https://www.youtube.com/watch?v=yjIUkiGCFTg">jim morrison : indian summer remix</a>
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    iki bira veya iki kahve ve biraz muhabbet. <br/><br/>ankara, 34, erkek.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    geçen gün merdivenden düşerek 2 cumartesi olmayı garantilediğim insan. <br/>ışıkları açın, edison'u sevin..
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    robot karı yapın, realistik vajinası (amı) olsun.
