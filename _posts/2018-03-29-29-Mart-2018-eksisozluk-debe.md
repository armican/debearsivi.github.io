...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    tuhaf falan olmayan, efemine hiç olmayan kıyafettir.<br/><br/>bisikleti performans amaçlı kullandığınız zaman aero forma ve taytın önemini anlarsınız zaten.<br/><br/>pedli taytın önemini de bisiklet üzerinde ciddi vakit geçirdiğiniz zaman anlıyorsunuz. zaman zaman pedli tayt tek başına yeterli olmuyor, bu durumda daha gelişmiş bir ped ve chamois krem desteği alıyorsunuz.<br/><br/>ayrıca bisikletçi giyiminde vazgeçilmez parçalar olan kask, gözlük ve eldivenin öneminden de bahsedebilirim dilerseniz.<br/><br/>önyargılı olmak kötüdür.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    ulen daha istanbul'daki üç milyon suriyeliyi gönderemiyorsun, kimi göndereceksin?
- entry_name: |
    ekşi itiraf
  entry_id:  75487354
  entry_writer: karanliktan korkan vampir
...
- entry_name: |
    başlığın onuncu entrysinden sonra entry giren ezik
  entry_id:  75486606
  entry_writer: frisbee doge
  entry_fav_count: 6
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    boğaz'da ev sahibi olmayı yeğlerim. satar, kordon'dan birkaç ev alırım.<br/><br/>edit: birtakım imla
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    eğer beni sadece bazı anlarda özlüyorsan, hiç özleme<br/><br/>eğer benden daha iyi birisini bulamadın diye adımı anıyorsan, hiç anma<br/><br/>ve eğer benim sevdamın unutulmayacak kadar büyük olduğunu unuttuysan da, hiç hatırlama..<br/><br/>ola ki geri mi dönmek mi istedin; giden sendin, dönecek olması gereken de sensin çünkü ben hala aynı yerimdeyim, aynı adam hala eskimeyen sevgisiyle karşında..<br/><br/>ama son bir şey sormak istiyorum sevdiğim, <a rel="nofollow noopener" class="url" target="_blank" href="https://eksisozluk.com/entry/74466012" title="https://eksisozluk.com/entry/74466012">beni anladın mı?</a>
- entry_name: |
...
- entry_name: |
    popstar 2018
  entry_id:  75464728
  entry_writer: kumsallarin istenmeyen kum tanesi
  entry_fav_count: 0
  entry_content: |
    popstar yarışmalarından genelde star değil de, koca adayı çıkıyor sayın ersoy'a. <br/>henüz eli yüzü düzgün, münasip birini göremedim ben. <br/>onu bilemem ama.
- entry_name: |
    jet sosyete (dizi)
  entry_id:  75481815
  entry_writer: ug tek
  entry_fav_count: 0
  entry_content: |
    5. ve 6. bölümlerde izlediğimiz kimi olayları daha önceki dizilerde izlediğimiz için şöyle bir başlık açtım: (bkz: <a class="b" href="/?q=g%c3%bclse+birsel%27in+dizilerinde+ayn%c4%b1+olaylar%c4%b1+i%c5%9flemesi%2f%40ug+tek">gülse birsel'in dizilerinde aynı olayları işlemesi/@ug tek</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    kurt işareti yapıp sonrasında dolar o dolar diye lafı çevirebilmektir.
- entry_name: |
