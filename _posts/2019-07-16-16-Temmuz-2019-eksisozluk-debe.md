...
- entry_name: |
  ...
  entry_id:  92642617
  entry_writer: olmemisiz
  entry_fav_count: 37
  entry_content: |
    burda kimse tip hiç umrumda değil diyemez lakin "hoş ama boş" tipi erkekler hiçbir zaman tercih sebebi olamaz bence. olanlar varsa da bilemiyorum tabii. zamanla kişiliğinizle bir kadına çekici hale gelebiliyorsunuz ama baştan çekici gelen bir insanın sönmesi de çok muhtemel bir olay. ikisini de yaşadım, akılda kalan her zaman kişiliğiyle sizi etkilemiş tipler oluyor, benden söylemesi.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 24
  entry_content: |
    tanım: aldatılmaya mahkum erkektir. <br/><br/>böyle bir arkadaşım var. <br/><br/>dünya tatlısı bir adamdır. entelektüel birikimine saygı duyarım. kız olsam düşünmeden evlenmeyi isteyebileceğim kadar naif bir insandır. anlayışlıdır. hanımefendinin çantasını 6 saat taşıdığını hatırlarım mesela. hanımefendiye hiç ses yükselttiğini de hiç hatırlamam. evcimendir. benim dahil ve şahit olduğum 3 yıllık bir ilişki süreci bu. 3 yıldan öncesine çok vakıf değilim. ama o 3 yıl benim için yeterli. <br/><br/>bu adamı aldattılar. tabi kimsenin başına gelmesin ama bu adam dünyada bu muameleyi en son hakedecek 3 insandan biri yahu. <br/><br/>aldatıldığını öğrendiği gecenin ertesinde ki yüz ifadesini 8 yıldır unutmadım. aha daha dün gece yaşanmış gibi aklımda. <br/><br/>bu insanı hakedecek bir dişi henüz evrenimize teşrif etmedi bence. <br/><br/>sabırsız, ayarsız, kaba, sadakatsiz erkekler her zaman hanımefendilerin öncelikli tercihi olacak. eee zaten size müstehak olan da bu.
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 24
  entry_content: |
    başka biriyle yattıysa asla alınmaması gereken karar. bir insanın senden öncesi olabilir ama senden sonrası olmamalı.
  entry_channels: anket,ilişkiler,magazin
- entry_name: |
    ekşi'nin psikolojiyi bozması
  entry_id:  92652865
  entry_writer: kaymakam halil hilmi
  entry_fav_count: 22
  entry_content: |
    bugüne kadar gördüğüm en doğru tespitlerden.<br/><br/>bir de bağımlılık yapıyor namussuz, bırakamıyorum.
  entry_channels: ekşi-sözlük,sağlık
- entry_name: |
    şu an okunan kitap
  entry_id:  92615868
  entry_writer: turkish hamam
  entry_fav_count: 9
  entry_content: |
    son yıllarım - albert einstein<br/><br/>kendilerini okumaktan büyük bir haz alıyorum. sadece büyük bir bilim insanı olmaktan öte duyarlı, centilmen, alçakgönüllü ve barışçıl bir kişiliği olan birisi einstein.
...
- entry_name: |
    14 temmuz 2019 kamil koç rezaleti
  entry_id:  92651016
  entry_writer: benburayaciplakgeldim
  entry_fav_count: 7
  entry_content: |
    lezzetli bir rezalet. <br/><br/>8/10 verdim. 2 puanı da sunumdan kırdım. çok uzun
  entry_channels: ekşi-sözlük
- entry_name: |
    tyler boyd
  entry_id:  92645900
  ...
  entry_fav_count: 6
  entry_content: |
    gazi koşusu şampiyonu at ismi bu resmen.
  entry_channels: spor
- entry_name: |
    alaçatı
  entry_id:  92647733
...
- entry_name: |
    okuyan sözlük yazarları bir adım öne çıksın
  entry_id:  92648653
  entry_writer: kambax
  entry_fav_count: 2
  entry_content: |
    b.kum gibi bir kitabın reklamıdır <br/>kitabın tanıtım yazısı; <br/>“akşamdı minik kutuların deliklerinden sarı ışıklar fışkırıyordu. caddelerde hızla yürüyerek kutularına dönen otomat insanlar yorgundular, sevgizdiler, duygusuzdular, katıydılar, kirliydiler, bıkkındılar, hırslıydılar, kıskançtılar, terliydiler, açtılar. yürüyorlardı. hepsi de nereye gittiğini biliyordu. oysa hiç kimse nereye gittiğini bilmiyordu.”<br/><br/>not: katılmıyorum
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    peki müzede cemaatin bu denli orduda yapılanmasında ona en çok destek verenlerin de kim olduğunu gösteren bir eser bulunacak mı. <br/><br/>edit : sonuçta hafızayı tazelemek gerek. gerçi kimse unutmadı da.
  entry_channels: siyaset,tv,tarih,haber
- entry_name: |
    15 temmuz 2019 polislere verilen kumanya
  entry_id:  92654842
  entry_writer: sincabimezelden
  entry_fav_count: 2
  entry_content: |
    polisin kumanyaya ihtiyaci mi var. 7 bin tl maas aliyorlar civarda illa lokanta sahibi bir öküz bulunur. yemekler ona yıkılır.
...
- entry_name: |
    erkekte para aramayan kadın
  entry_id:  92653630
  entry_writer: zinharyalan
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=erkekte+yak%c4%b1%c5%9f%c4%b1kl%c4%b1l%c4%b1k+aramayan+kad%c4%b1n">erkekte yakışıklılık aramayan kadın</a>) başlığından geliyorum, orada konu ile ilgili fikrimi beyan etmiştim, bu başlığı görünce açık yüreklilikle söylüyorum ki şahsen para da aramıyorum. tanım olarak da zenginlik konusunda doyuma ulaşmış para ile satın alınacak değerlere karnı tok olan kadındır diyeceğim.<br/><br/>sonuç olarak bir üçüncü başlığa gerek duymadan net bir biçimde söylüyorum ki ben erkek aramadığıma karar verdim. <br/><br/>yalnız olmak gerçekten çok keyifli...
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    erotik çağrışımların sinerjisi: <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=HQmmM_qwG4k" title="https://www.youtube.com/watch?v=HQmmM_qwG4k">whole lotta love</a>
  entry_channels: anket,müzik
- entry_name: |
