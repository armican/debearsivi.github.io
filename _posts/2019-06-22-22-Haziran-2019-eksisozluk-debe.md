...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    ulan altinci macta fenerli diye sovuyorlardi, simdi efesli diyorlar. siz gerizekalisiniz. kendine taraftar diyen kitlenin buyuk bolumunde ciddi zeka sorunu var takimdan bagimsiz olarak.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    etliye sütlüye karışa karışa sonunda el birliğiyle yaptıracağınız şey. üç maymunu oynayamadınız yani bi afferim. bu sefer durum ciddi.<br/><br/>(bkz: <a class="b" href="/?q=al+k%c4%b1rd%c4%b1n+k%c4%b1rd%c4%b1n">al kırdın kırdın</a>)
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    pazara akşam gidince güzel mal bulabilirseniz ne ala. 30 yaş üstü düzgün erkek neredeyse yok. <br/>varsa bile mutlaka sevgilisi vs vardir kadın tarafı ise evlenmeyi geciktiriyordur.
  entry_channels: ilişkiler
- entry_name: |
    bitcoin
  entry_id:  91532799
  ...
  entry_fav_count: 0
  entry_content: |
    yav aminoasit, kimse de demiyor ki siz nasıl sürekli kazanıyorsunuz aga? <br/>ben bu sırrı veriyorum arkadaşlar. birileri kaybetmeden birileri kazanamaz bu dünyada. şimdi kendi btc bilginizi kefenin bir tarafına diğer tarafına da kalan yatırımcıları koyun tekrar düşünün.
  entry_channels: teknoloji,ekonomi
---
