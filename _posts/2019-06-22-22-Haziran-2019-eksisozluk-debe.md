...
- entry_name: |
  ...
  entry_channels: spor,ilişkiler,haber,yeme-içme
- entry_name: |
  ...
  entry_fav_count: 81
  entry_content: |
    4 yıl sonra twitter'da tt:<br/><br/>(bkz: <a class="b" href="/?q=20.000+yapay+zeka+m%c3%bchendisi+atama+bekliyor">20.000 yapay zeka mühendisi atama bekliyor</a>)
...
- entry_name: |
  ...
  entry_fav_count: 35
  entry_content: |
    düzgün erkekleri düzdünüz, ondandır.
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    keşke bende olsaydı denen şeyler
  entry_id:  91518406
  entry_writer: gonanabi
  entry_fav_count: 21
  entry_content: |
    (bkz: <a class="b" href="/?q=istenildiginde+uyumak">istenildiginde uyumak</a>) istediginde uyuyan insanlara hep imrenmisimdir. arkadas yastiga basinizi koydugunuzda hic mi bir sey dusunmuyorsunuz? hele ucak zangir zangir turbulans icindeyken uykusundan uyanmayan tipler var tam dayaklik.
  entry_channels: 
- entry_name: |
    ekşi kapatılsın
  entry_id:  91544778
...
- entry_name: |
    temel karamollaoğlu'nun 180 derece rte videosu
  entry_id:  91546341
  entry_writer: sozlukinsani
  entry_fav_count: 7
  entry_content: |
    dede'nin yine acımadan sağlı sollu kroşeleri salladığı videodur. saadet cidden cesur muhalefet yapıyor.
  entry_channels: siyaset
- entry_name: |
    muhaliflerin özelleştirmelere karşı çıkma sebebi
  entry_id:  91545676
  entry_writer: kimseye hayir diyemeyen hiyar
  entry_fav_count: 7
  entry_content: |
    özelleştirmeye değil özelleştirmelerin yapılış şekline karşı çıkan gerçek vatanseverlerdir.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    herkesin çok işine yarayacak bir veritabanı.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    sloukas'ın "sikeyim böyle adamı, içimizden geçti şerefsiz" diyerek özetlediği fırlama.<br/><br/>evet ağız okudum, yunanca.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    nasıl oluyor da bir taraftan türk kızı başlıklarını hakaretlerle doldurup diğer taraftan sürekli sözlükten kız düşürmeye çalışabiliyorsunuz? sözlükte leh, rus kızlar varsa ben de arayayım.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    yanıltıcı bilgidir. ben daha 2 ay önce topuna 10? ödedim. 2 top aldım 20? ısıra ısıra yedim. güzel dondurma fakat.<br/>bu arada istanbulda oturduğum mahalledeki dondurmacıdan kilosunu 25? ya aldım dün.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    bana göre yürürken aşağı yukarı sallanan memeleridir.
  entry_channels: anket,ilişkiler
- entry_name: |
    fenerbahçe'nin en başarılı olduğu konu
  entry_id:  91543952
  entry_writer: uskts
  entry_fav_count: 2
  entry_content: |
    kadıköy’de yenilmemek <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    (bkz: <a class="b" href="/?q=s%c4%b1d%c4%b1ka">sıdıka</a>) dizisine bile konu olmuş olay.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=g%c3%bcven">güven</a>) <br/><br/>şimdiki erkekler pezevenk gibi. vücudun güzelse seviyor. sanırsın satacak başkasına gerçi biz onu da gördük. allah esirgesin öylesinden.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
    21 haziran 2019 binali yıldırım tv100 yayını
  entry_id:  91524868
  entry_writer: eksi peace
  entry_fav_count: 1
  entry_content: |
    abdullah öcalan’a teşekkür edecek mi merak ettiğim yayın.
