...
- entry_name: |
  ...
  entry_id:  97353082
  entry_writer: biralagul
  entry_fav_count: 1
  entry_content: |
    çerkesler kürtleri sever mi sevmez mi haklı mı haksız mı aralarında nasıl bir ilişki var bilmiyorum ama farklı ortamlarda ben çerkesim diye soy sop anlatanlarda ben de o hafiften bir böbürlenme havası sezdim. aynı tavıra arnavutlarda da rast geldim. nedendir hiçbir fikrim yok.
  entry_channels: 
- entry_name: |
