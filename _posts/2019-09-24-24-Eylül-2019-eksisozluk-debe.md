...
- entry_name: |
    kapüşonlu sweatshirt'ün altına şort giymek
  entry_id:  95697165
  entry_writer: baydag
  entry_fav_count: 169
  entry_content: |
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    almanya'da bir kilo muzun 88 cent olması
  entry_id:  95719574
  entry_writer: redblack000
  entry_fav_count: 42
  entry_content: |
    80 milyon insan bir araya gelip böyle ülke kurmak, böyle ekonomi böyle vergi sistemi, böyle ceza kanunu... biz büyük bir günah işlemişiz besbelli. yeryüzü cennet gibi, biz bu cennette cehennemi yaşıyoruz.
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    talas belediyesi'nin selena gomez'e türban takması
  entry_id:  95716748
  entry_writer: gayri safii milli ariza
  entry_fav_count: 16
  entry_content: |
    birkaç ay yurtta kaldıktan sonra talas anayurt'ta ev tutacaktır. los angeles'tan anayurt'a giden bu yolda kendisine başarılar dilerim.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    5 maçta 4 sarı kart gören 10 numaranız varsa, o kulüp çiftliğe dönmüş demektir.
  entry_channels: spor
- entry_name: |
    suat arslanboğa
  entry_id:  95721070
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    dağıtıcı reis. ilk önce avrupa kupası, lig kupası ve türkiye kupası alan beşiktaş basketbol takımını dağıttı. sonra yetmedi şampiyonluk kazanmış, grubundan namağlup lider çıkmış futbol takımını dağıttı. ardından başarısız bir sezon geçiren takımda, bütün sorumluluğu takımı stadsız şampiyon yapmış hocaya yükleyerek onu davullarla zurnalarla milli takıma gönderdi. sonra vurucu hamle geldi. takımın yeni teknik direktörü olarak abdullah kartal avcısını, nam-ı diğer sistem reisi seçti. ve takım küme düşme potasına girdi. avrupa'da köy takımlarından 4 gol yemeye başladı. bu arada kulübün borçlarına hiç değinme gereği bile duymuyorum. mal meydanda.<br/><br/>ancak bütün bu yaptıklarına karşın fiko reis'in hakkını yememek lazım. mesela hentbol takımını dağıtmadı. onun için daha yaratıcı bir çözüm buldu. takımı şampiyonlar ligi'nden çekti. neme lazımdı. takım şampiyonlar ligi'nde düşük bütçesine rağmen flaş galibiyetler alabilir adını avrupa'da duyurabilirdi. sonra takımı dağıtmakla kim uğraşacaktı? riske gerek yoktu. vizyon hak getireydi. böylece hentbol takımımız dandik bir kupada mücadele edecekti. <br/><br/>ancak en acısı da bütün bunlara rağmen yarın seçim olsa ve adaylığını koysa yine seçilir, yine seçilir..
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  95719662
  entry_writer: marksist34
  entry_fav_count: 2
  entry_content: |
    bakıyorum'da herkes markaları sıralamış bir tek ben'mi parfüm kullanmıyorum lan?
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    kırmızı kafalı pelikan kaltağının olmaması şaşırtmıştır. oysa alışmıştı chpliler tarafından canlı yayında arkalı önlü düzülmeye.<br/><br/>açalım bakalım prensimiz neler diyecek.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  95721025
  entry_writer: turkmen balasi
  entry_fav_count: 1
  entry_content: |
    takımın am’n kodou. bunun aldığı maaşın 1/25 ine ben yaparım bunun yaptığı işi. valla bak. rakibin yanından at geçmeye çalış. muhtemelen geçemez. geçerse in çizgiye at içeri ve hoop top kalecide.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    2 hafta kazanamadık diye takıma küsecek değilim.<br/><br/>sorunlar var mı, var.<br/>eksikler, hatalar var mı, var.<br/>ama umut var mı? her zaman var!<br/><br/>ünal hoca da, bu çocuklar da geçen sene açmazdan çok iyi çıkıp bizi gururlandırmışlardı, yine yapacaklardır.<br/><br/>sivas dişli bir rakip, akşam iyi bir futbol zor gözüküyor ama 3 puanla, olmazsa 1 puanla dönmeyi umuyorum.
  entry_channels: spor
- entry_name: |
    sahibinden.com'da 1 milyon dolar istenen taş
  entry_id:  95722139
  entry_writer: whitehorse
  entry_fav_count: 0
  entry_content: |
    bende var, aramadığım iyi olmuş.
  entry_channels: 
---
