...
- entry_name: |
  ...
  entry_fav_count: 342
  entry_content: |
    ilker paşa, videonun sonlarına doğru saçma telefon kayıtlarıyla kahvehane ortamına çevrilen mahkemeyi onurlu, şerefli bir şekilde terketmiştir.<br/><br/>bu onurlu ve şerefli hareketi alkışlayan izleyicileri de mahkeme başkanı dışarı çıkartmaya çalışmıştır. <br/><br/>suçlamayı yapan savcıları, bu davalar uğruna intihar eden subayları ve bu davaları destekleyen siyasileri tarih yazdı, unutmayacak.
...
- entry_name: |
    10 mayıs 2018 batman'da petrol bulunması
  entry_id:  76827931
  entry_writer: enver behnan sapolyo
  entry_fav_count: 236
  entry_content: |
    uranyumla çalışan, ucunda taramalı, içinde mescit bulunan uzay taramalısı da bulunur bir 10-15 güne kadar. <br/><br/>hamdolsun çok güzel gelişmeler var ülkede.
...
- entry_name: |
  ...
  entry_fav_count: 217
  entry_content: |
    <a class="b" href="/?q=esenyurt">esenyurt</a><br/><br/>her 2 kişiden 3'ü suriyeli.
...
- entry_name: |
  ...
  entry_fav_count: 93
  entry_content: |
    yok öyle bedavaya finale çıkıp bedavaya kupa kazanmak aq çapulcuları sizi. <br/><br/>(bkz: <a class="b" href="/?q=ilahi+adalet">ilahi adalet</a>)
  entry_channels: spor
- entry_name: |
    coğrafya dersinde öğrenilip unutulmayan bilgiler
  entry_id:  76819229
...
- entry_name: |
  ...
  entry_fav_count: 63
  entry_content: |
    eyfel ve pisa kulesinin çevresinde salak salak fotolar çekmek yerine ara sokaklarda bir bar bulup birasını yudumlar.
  entry_channels: seyahat
- entry_name: |
    ekşi sözlük'ün köylü dolması
  entry_id:  76839425
  entry_writer: donatien
  entry_fav_count: 56
  entry_content: |
    tarifini merak ettiğim. köylü mü tıkıyoruz biberin içine?
...
- entry_name: |
  ...
  entry_fav_count: 51
  entry_content: |
    manisa'da koydu yetmedi, ıstanbul'da koydu yetmedi şimdide diyarbakır'da koyuyor adamlar türkiye'nin dört bir yanını gezdire, gezdire koyuyorlar adamlar
  entry_channels: spor
- entry_name: |
    ekşi itiraf
  entry_id:  76819558
  ...
  entry_fav_count: 49
  entry_content: |
    aşk konusunda lanetlenmiş olabilirim. otuzuma merdiven dayadım ama şu <a class="b" href="/?q=uzak+mesafe+ili%c5%9fkisi">uzak mesafe ilişkisi</a> lanetinden bir türlü kurtulamıyorum.<br/>işimi garantiye alıp tekirdağ emniyet müdürünün kızıyla sevgili oldum, adamın bayburta tayini çıktı amk. elli tane kadını yanyana dizip; bir tanesini seçmemi isteseler, ne yapar eder ertesi sabah ankaraya otobüsü olan hatunu seçerim. öyle boktan bir lanet. <br/><br/>üstelik bu ilişki türü için en uygunsuz adam da ben olabilirim. kelimenin tam anlamıyla telefonla konuşma özürlüyüm örneğin. ne konu açmayı ve saatlerce bu konu hakkında sevgili sohbeti yapmayı becerebilirim, ne de romantik iltifatlar edebilirim.<br/><br/>çiçekçiye işe giren sevgilime; "insan hiç kendini satar mı" diye iltifat etmişliğim var lan benim. çiçek gibisin demeye çalışıyordum kendi aklımca, nasıl bir öküz olduğumu siz düşünün.<br/><br/>her seferinde ülkenin en geveze hatunlarına aşık olmam da cabası. uyurken bari kapatalım arkadaş şu telefonu. ama yoook!<br/><br/>elalemin sevgilisi "önce sen kapat" muhabbeti yapar, bana da hep ruh hastaları denk gelir.<br/><br/>- aşkım kapatalım mı artık?<br/>+ noldu? sıkıldın mı yoksa benden?<br/>- 4 saattir konuşuyoruz kızım, yeter.<br/>+ yok yok sen kesin sıkıldın benden.<br/><br/>kapatmasan daha da büyük dert.<br/><br/>- yaaa aşkım. nolur biraz daha konuşalım.<br/>+ peki peki tamam.<br/>-<br/>+<br/>- eee??<br/>+ eee derken!!<br/>- ee anlat hadi bir şeyler.<br/>+ manyak mısın kızım sen? konuşalım diyen sen değil miydin?<br/>- sen artık beni sevmiyorsun!!<br/><br/>aga siz hiç sevgilinizi aramadan önce; bir kağıda "konu başlıkları" not ettiniz mi? yemin ederim ben yaptım. "ee anlat" cümlesini her duyduğumda; prompter'dan miting yapan reis gibi kopya çekiyor ve muhabbete devam ediyorum.
...
- entry_name: |
  ...
  entry_fav_count: 44
  entry_content: |
    oh ne güzel memleket dedirten ankettir;<br/><br/>akp'nin oyunu koru<br/>hdp'yi baraj altı bırak<br/>ip baraj altı bıraksan herkes götüyle güleceği için kıl payı geçir<br/>chp'ye muharrem ince'de yaramadı hesabı oyunu düşür<br/><br/>bu hesapları yapmaktan mhp'yi kayıramamışlar,baraj altı bırakmışlar (bkz: <a class="b" href="/?q=adam%c4%b1n+gol+diyor">adamın gol diyor</a>)<br/><br/>gülün geçin diyoruz t a m a m mı?
...
- entry_name: |
  ...
  entry_fav_count: 36
  entry_content: |
    aklıma direkt murat başoğlu’nu getiriyor artık. <br/><br/>bak içim kalktı yine.<br/><br/>edit: 62638 kez mesaj aldım, o facesitting değil o facesitting değil diye. ekşi sözlüğe duyurulur, o facesitting değil arkadaşlar tamam mı?<br/><br/>yine de tekrar açıp bakmıcam fotoğrafa. ben inandım, siz de inanın.
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_channels: haber
- entry_name: |
    tavuk yiyen erkekliğini kaybeder
  entry_id:  76847266
  entry_writer: wohan
  entry_fav_count: 25
  entry_content: |
    (bkz: <a class="b" href="/?q=akit+haberlerini+s%c3%b6zl%c3%bc%c4%9fe+ta%c5%9f%c4%b1yan+dangalak+yazar">akit haberlerini sözlüğe taşıyan dangalak yazar</a>)
...
- entry_name: |
  ...
  entry_channels: siyaset,haber,eğitim
- entry_name: |
    3 tabancası 1 tüfeği olan sosyal demokrat
  entry_id:  76847725
  entry_writer: eksi peace
  entry_fav_count: 23
  entry_content: |
    bir muhalif olarak can güvenliğinin olmadığı bir ülkede yaşamasındandır.<br/><br/>bunu eleştirenin reis'i 3000 koruma ile dolaşıyor, vay yavrum vay.
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    bizi bu sene 2 kez yenen tek takım akhisar diyor fakat sezon basında vardar'in kendisini 2 kez yendiğini hatırlamıyor. ya da isine geleni hatırlıyor.
  entry_channels: spor
- entry_name: |
    ak parti'nin kaybedeceğini sanan muhalif kesim
  entry_id:  76847331
  entry_writer: silver raven
  entry_fav_count: 19
  entry_content: |
    bırak akp'nin kazanmasını, bu kadar oy alması bile ne kadar iğrenç insanlarla yaşadığımızın acı bir göstergesidir.<br/><br/>imza: realist
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    kupayı alabilmek için türlü orospu çocukluğu yapıp yine de başarısız olan takım.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    cuma günü camideki içki görüntüleri yayınlayacağız.<br/><br/>(bkz: <a class="b" href="/?q=yay%c4%b1nlayamad%c4%b1">yayınlayamadı</a>)
  entry_channels: siyaset,anket
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    şirinevler et yiyelim burger diyorum
...
- entry_name: |
    çaylak onay listesi
  entry_id:  76821992
  entry_writer: nesli3vaktekadartukenecekhayvan
  entry_fav_count: 1
  entry_content: |
    sözlüğün bir anda 10.000'i aşkın çaylağı yazar yaptığını düşünüyorum.<br/>nasıl yaptılar, neden yaptılar, strateji mi değiştirdiler??? <br/>belkide sözlüğü devren satacaklardır?<br/>kafamda deli sorular?<br/>yetkili bir abi yeşillendirirse sevinirim.
  entry_channels: ekşi-sözlük
- entry_name: |
    vincent janssen
  entry_id:  76849182
  ...
  entry_fav_count: 0
  entry_content: |
    vay babam vay. at da biraz usturuplu at kendini be. <br/><br/>atıcı. kendini.
  entry_channels: spor
---
