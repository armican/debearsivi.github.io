...
- entry_name: |
  ...
  entry_fav_count: 132
  entry_content: |
    15 cm ne bamya spor? <br/><br/>gülü seven 'diken'ine katlanır anlamında mı?
...
- entry_name: |
  ...
  entry_fav_count: 73
  entry_content: |
    tek sözüyle başbakan, bakan, belediye başkanı istifa ettiren adam kabzımallara laf geçiremediği için ucuz patates satmaya başladı. güldürdün reis.
...
- entry_name: |
    kaç paraya annene sağlam bir yumruk atarsın
  entry_id:  86606111
  entry_writer: deretor
  entry_fav_count: 49
  entry_content: |
    adam piyasa araştırması yapıyor sanırım anası ucuza gitmiş belli.
  entry_channels: anket
- entry_name: |
  ...
  entry_channels: ilişkiler,tv,ekşi-sözlük,teknoloji,sağlık,haber,eğitim,ekonomi
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 43
  entry_content: |
    alıştıkları ortamdan ayrılmaya, düzenlerini bozmaya gelemezler.
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    sıralı şekilde <a rel="nofollow noopener" class="url" target="_blank" href="https://eksisozluk.com/biri/fakfukfon" title="https://eksisozluk.com/biri/fakfukfon">hiçbir maça gidemeyenlerin</a> biletlerini sattıkları maç.adam her maç satmış biletini ama arkadaş ile gidemiyoruz yazmış.<br/><br/>maça gelirsek , geçtiğimiz hafta benfica rakibine 10 tane atmış.rakip güçlü olsa da maç avrupa maçı olunca gs gerçek gücünü göstermek isteyecektir.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    aldatıyosunuz çünkü amk larım. amacımın sizle "gönül eğlendirmek" olmadığından, "ciddi düşündüğümden" emin olur olmaz başlıyorsunuz başka adamlara bakmaya. "tamam bunu hallettik başka kimler benlen evlenmek istiyo acabağğ"<br/><br/>ulan beni affet diye hüngür hüngür ağlarken diğer adamla watsaptan yazışmaya devam edenleriniz hep bana denk geliyor.<br/><br/>attığınız salakça yalanları "yemiş" görününce, kavga ederken bile yüzünüze vurmayınca entrika işlemcinizin kapasitesini düşürüyorsunuz. "tamam ya bu herif salak ben ne desem inanır" diyorsunuz ve gardınızı düşündüğünüz için o an kaybetmiş oluyosunuz söyliyim. bütün entrikalarınız 20bin km uzaktan görünüyor.
  entry_channels: anket,ilişkiler
- entry_name: |
    lost
  entry_id:  86603920
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    başlığı görünce dur bende bakayım dedim. en yakınımda stefan zweig'in bilinmeyen bir kadının mektubu adlı kitabı vardı<br/>55.sayfada son buluyor, 56.sayfa boş, 57.sayfadan sonra da sonsöz kısmı var. <br/>hayattaki şansımı bundan daha iyi tarif edemezdim sanırım.
...
- entry_name: |
    sinyal veren taşıta yol vermemek için hızlanmak
  entry_id:  86588581
  entry_writer: agosizman
  entry_fav_count: 8
  entry_content: |
    bazı durumlarda elzemdir. mesela her sabah anadolu yakasından avrupa'ya geçmek için 1. köprüyü kullanıyorum.<br/><br/>1. köprüye çıkan, nakkaştepe'den beylerbeyi'ne inen kıvrımlı bir yol vardır bilirsiniz. bu yolun sol şeridi köprüye çıkar, sağ şeridi ise beylerbeyi'ne iner. burada karışıklık olmaması için insanlar sol şeritte, köprüye girmek için, sıraya girerler ve sağ şerit bomboşken sol şerit ta köprüden nakkaştepe'ye kadar araç kuyruğu olur.<br/><br/>fakat her sabah, birtakım orospu çocukları, sağ şeritten köprü ayrımına kadar yardırıp tam ayrımın orda "sola sinyal vererek" insanların önüne kırıyorlar. işte bu puştlara dip gaz yapıp araya girmesini engellemek farzdır.<br/><br/>kısacası sinyali, büyükşehir trafiğinde milleti enayi yerine koymak ve piçlik yapmayı meşrulaştırmak için kullanıyorsanız, kusura bakmayın, saygısız bir puştun tekisiniz.<br/><br/>bunun haricindeki durumları tenzih ederek söylüyorum tabii ki. burada yazan birçok kişi normal trafik akışındaki olaylardan bahsetmiş. ona diyecek bir şey yok.
...
- entry_name: |
    zara'dan giyinen fakir
  entry_id:  86601402
  entry_writer: ruhu sarisin
  entry_fav_count: 6
  entry_content: |
    zamanın birinde bir yönetmen arkadaşım "aslında çocuk için zara'dan almak lazım. nasıl olsa hemen büyüyorlar. öyle pahalı şeyler almaya gerek yok. zara'dan ucuz ucuz giydiricen." tabi o an diyemedim biz çocuğa pazardan corci sports alıyoruz diye.
  entry_channels: moda,ekonomi
- entry_name: |
    11 şubat 2019 iddaa ihalesi
  entry_id:  86587571
  entry_writer: su ekmek zeytin
  entry_fav_count: 6
  entry_content: |
    ağırlıklı kısmnı futbol maçlarının oluşturduğu bahisleri tertipleyecek ihaleye futbol federasyonu başkanı yıldırım demirören'in firması da katılmıştır ve muhtemelen kazanacaktır. kazanmasa da bişey değişmez. katılmış sonuçta. federasyon başkanı. futbol bahisleri. federasyon. bahis.
  entry_channels: spor,oyun,haber,ekonomi
- entry_name: |
    13 şubat 2019 büyük beşiktaş taraftar protestosu
  entry_id:  86605639
  entry_writer: northroma
  entry_fav_count: 3
  entry_content: |
    (bkz: <a class="b" href="/?q=lassie+bize+bir%c5%9fey+anlatmaya+%c3%a7al%c4%b1%c5%9f%c4%b1yor">lassie bize birşey anlatmaya çalışıyor</a>)
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    beni instagramdan engellemiş kişi. inşallah yağmurda ıslanırsın da boyun çeker ufalırsın 1.60 olursun hadi 1.65 ol kıyamadım. inşallllllah rabarbayı yaparken zırt pırt mikrofonun tutukluk yapar inşşşşşaaalllah sana ilişki testinde bi rakip çıkar formatını kopyalar da delirirsin hırstan.iiiinşallah...<br/><br/>sonuncu biraz fazla oldu onu geri alıyorum.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    [<a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=zOvsyamoEDg" title="https://www.youtube.com/watch?v=zOvsyamoEDg">faun - federkleid</a>]
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bugünden sonra gitmemek bir seçenek değil. aksine gidip akp'ye vermek gerekiyor eğlencenin devamı için..
  entry_channels: siyaset,anket
---
