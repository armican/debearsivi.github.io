...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    22 yaşında her yerine dövme yaptıran adam
  entry_id:  84163236
  entry_writer: sunbred
  entry_fav_count: 115
  entry_content: |
    genç yaşta intihar edecektir
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    şirine'nin seksi olduğu gerçeği
  entry_id:  84183105
  entry_writer: money never sleeps
  entry_fav_count: 12
  entry_content: |
    yokluktan sirine’ye halenen insanlar bile varmis.
  entry_channels: tv
- entry_name: |
...
- entry_name: |
    barış alıcı
  entry_id:  84181973
  entry_writer: yaabisennediyon
  entry_fav_count: 10
  entry_content: |
    bu çocuğa 1.5 milyon, oynamayan ferdiye 1.5 milyon, sadece kupada 1 maç oynayan berkeye 2.5k milyon, freye 2.5 milyon bonservis ödendi ve takımda ne ilk 11 oyuncusu var ne ilk 18 oyuncusu var. geleceğe yatırım yapman için as takımının elle tutulur olması lazım. bu takımla 10 milyon gençlere yatırırsan böyle siktiğimin deplasmanında bile hamle olarak ismail köybaşını oyuna sokarsın
  entry_channels: spor
- entry_name: |
    ali koç
  entry_id:  84181386
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    süper lig’den dandik bir takım satın alıp ismini değiştirin. <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    şu anda küfürleri ağzına gelip gelip yutan eski futbolcu, güncel spor yorumcusu.<br/>aslında kendini çok sevmem ama hak veriyorum. koskoca spor kulübünü ne hale getirdiniz demeye getiriyor dili döndüğünce.<br/>not:lesferdinandspor
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=a%c4%9f%c4%b1zas%c3%bcr%c3%bclenpulbiber">ağızasürülenpulbiber</a>)
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    1-devamlı dert yan <br/>2-karanlık bi tablo çiz <br/>3-gene de şunu bunu yaptık duzelttik diyerek küçük umutlar ver <br/>4-bu noktada baklayı agzindan çıkar ve taraftara rağmen aldigin karari acikla ki kimse itiraz edemesin.<br/>5-aldigin kararda sıçarsan profesyonelliği bahane edip vakit kazan sabır iste<br/>6-hala duzelmediyse yeni dertler yan vakit kazan.<br/>7-baktin hala olmuyor fenerbahceliyim ben ulen de kelle al.<br/>8-yeni karar alana kadar profesyonellikten dem vur ve madde 1 e geri donup bastan basla.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    erzurum'un frey'i almadığı için başını taşlara vuracağı maç. frey'in hattriği var.
  entry_channels: spor
---
