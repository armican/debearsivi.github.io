...
- entry_name: |
    ikinci el araç satanlardan ekstra vergi alınması
  entry_id:  100248703
  entry_writer: xenon adam
  entry_fav_count: 7
  entry_content: |
    zaten öyle bir şey var. yıl içinde 3 ve daha fazla araç alıp satarsanız vergi mükellefi olursunuz. denemesi bedava
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  100252642
  entry_writer: emeklimuhendis
  entry_fav_count: 3
  entry_content: |
    (bkz: <a class="b" href="/?q=yaln%c4%b1z">yalnız</a>)
  entry_channels: 
- entry_name: |
    8 ocak 2020 iphone rezaleti
  entry_id:  100244591
  entry_writer: deadastronautinspace
  entry_fav_count: 3
  entry_content: |
    şunu bize okuttun ya. sana bir şey demiyorum. altı üstü yüz lira verip bilmem kaç yıldır kullandığın telefona yeni bir pil taktıracaksın ya. ota boka rezalet başlığı açarsanız gerçekten rezalet olan başlıkları da okumayacak millet. telefonun soğukta kapanırken gidip apple’a yazmamışsın. yıllar sonra buraya gelip yazıyorsun. napıcak sana yeni telefon mu verecek apple. ya bi git ya.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    evlilik teklifi etmek kadar saçma değildir.
  entry_channels: anket,ilişkiler
- entry_name: |
