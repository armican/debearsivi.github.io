...
- entry_name: |
  ...
  entry_fav_count: 76
  entry_content: |
    üstteki arkadaş mesaide sakso çekiyor galiba. işin içinde olmasak inanacağız.<br/><br/>data science mış<br/>tecrübe 10ay cıkmış<br/>maas 14bin tl iiimiiş<br/><br/>edit: üstteki arkadaş yurt dışında tl ile maaş alıyor sanırsam(bu bizim oranın sanırımı, akraba çıkmasak bari), yazsana maaşını aldığın kur ile, heycan yaratıyorsun sonra udemy'den ders alan bilgisayar bilimcisiyim diye geziyor. matematik fena sayılmaz ama tabi kime göre hangi mesleğe göre.
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    cahil ve eğitimsiz bir kitleye laf anlatmak
  entry_id:  80129192
  entry_writer: danonlio
  entry_fav_count: 25
  entry_content: |
    “asla bir salakla tartışmayın. çünkü dışarıdan bakanlar hanginizin salak olduğunu anlamayabilir”<br/><br/>bob dylan<br/><br/>kendinizi yormaya gerek yok.harcadığınız zamana yazık olur.
  entry_channels: 
- entry_name: |
    2018 ekonomik krizi
  entry_id:  80103347
...
- entry_name: |
    tayyip erdoğan'ın yedi düveli dize getirme destanı
  entry_id:  80128874
  entry_writer: runwhileucan
  entry_fav_count: 18
  entry_content: |
    tanım: toz duman dağıldığında tüm yolsuz din bezirganları ve onların köpekleri aziz türk milletinin bağımsız mahkemelerinde hesap verecek.
  entry_channels: 
- entry_name: |
    donald trump
  entry_id:  80118377
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    günlük 50 içeriğe, haftalık 300 lira önerdiği editörler arayan vampirleri de barındırdığını unutmamamız gereken başlık. asgari ücretin 1600tl, doların 6tl olduğu gün önermiştir kendisi bu "iş ilanını". <br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://prnt.sc/kh0fri">https://prnt.sc/kh0fri</a>
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    (bkz: <a class="b" href="/?q=adim+rte+mekanin+sahibiyim">adim rte mekanin sahibiyim</a>)
  entry_channels: 
- entry_name: |
    a haber
  entry_id:  80102523
  ...
  entry_fav_count: 7
  entry_content: |
    doların 6.20'yi gördüğü sabah "vatandaştan dolar oyununa geçit yok" diye haber yapan site.<br/><br/>bu kadar olmaz.
  entry_channels: siyaset,tv,haber
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    bugün artık yapılması gereken şeydir.<br/>papazı versek bile artık doların ineceğini düşünmek için saf olmak gerek.
  entry_channels: siyaset,haber
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    yokluğun her yerde. yokluğun şu geceden de karanlık.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    burada “bayan” kelimesini kullananların ta evveliyatını sikeyim. bu kadar mı düştünüz lan ? andaval gibi sözlükte kadınlarla iletişime geçmeye çalışacağına çık dışarı 2 insan gör. o göt beyninle kafanı telefondan kaldırmazsan burada “bayan arkadaş” aramaya devam edersin. <br/><br/>hayatım boyunca bu kadar sığırı bir arada görmediğim veritabanı. insanlık edip bazılarına mesaj atıyoruz erkek olduğumuz için tabiri caizse iplenmiyoruz bile. alın götünüze sokun dertlerinizi
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    13 ağustos 2018 otomobil zamları
  entry_id:  80131811
  entry_writer: andom
  entry_fav_count: 2
  entry_content: |
    renault modellerinin örnek gösterilmesini yadırgadığım fiyat artışlarıdır.<br/><br/>2011 yılından beri renault kullanıyorum. dizel otomatik ve en dolusu olmak üzere iki adet megane aracım oldu, birini halen kullanıyorum.<br/><br/>bu ülkede bu kadar çok servisi, bu kadar bol ve ucuz yedek parçası, ülkede kurulu fabrikası olan bir markaya hala önyargıyla yaklaşılması ve küçümsenmesi müthiş rahatsız ediyor beni.<br/><br/>peki mutlu olun diye söylüyorum devamlı renault marka araç kullanıyorum, bu ülkeye faydası olan bir marka olmasına rağmen ben bir geri zekalıyım, orgazm olduysanız tamamdır.
  entry_channels: siyaset,haber,ekonomi
- entry_name: |
    zaman makinesi olsa ilk gidilecek zamanlar
  entry_id:  80092094
  entry_writer: orchid
  entry_fav_count: 1
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    mantık evliliğini hiç düşündünüz mü? sizce günümüzde mantık evliliği mi aşk evliliği mi?
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    futbol adına son zamanların en önemli kampanyası ki ali koç başkanlığa başladıktan sonra böyle bir şey bekliyorum. umuyorum ki türk futboluna yayılır da tribünlerde şu iğrenç küfürleri duymayız artık.
  entry_channels: spor
- entry_name: |
