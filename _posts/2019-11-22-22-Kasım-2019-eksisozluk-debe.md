...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    görseldeki kadının bir gözü dışarı bakıyor zaten
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  98101139
  entry_writer: ne olursan ol justice for all
  entry_fav_count: 6
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=karamazov+karde%c5%9fler">karamazov kardeşler</a>) by (bkz: <a class="b" href="/?q=dostoyevski">dostoyevski</a>)
  entry_channels: anket,edebiyat,eğitim
- entry_name: |
    erkekleri çözmüş kadın
  entry_id:  98103437
  entry_writer: therustler
  entry_fav_count: 0
  entry_content: |
    çözse çözse pantolonun düğmesini çözmüştür o.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    muhabbet etmek istediğim ve beni badilediklerini bildiğim bir takım badiler var ama çekingenliğimden yazamıyorum. mesajlarım zaten badilere açık, konuşası gelenler uplasın bence. en kötü müzikleşiriz.
  entry_channels: anket,ilişkiler,ekşi-sözlük
---
