...
- entry_name: |
  ...
  entry_fav_count: 135
  entry_content: |
    başka birisine uzun cevaplar veriyordur
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    rakı ile en ufak benzerlik göstermeyen içkilerdir. tadı rakıdan daha kötü olan bir içecek yoktur. bak içki demedim, içecek dedim.<br/><br/>rakının tadına güzel diyen kişi çocuğunuz bile olsa selamı sabahı kesin. o ki şekilci, aşağılık kompleksli, varoş, basit bir insandır.
  entry_channels: anket,yeme-içme
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  98101478
  entry_writer: son orbital
  entry_fav_count: 3
  entry_content: |
    do not try to enter the train<br/><br/>ingiliz tekerlemesiymiş gibi olan metroda,marmarayda her duyduğumda beni gülümseten cümledir.
  entry_channels: anket,edebiyat
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  98106988
  entry_writer: sessuzluk
  entry_fav_count: 2
  entry_content: |
    bir kere verseler sonrakileri çok rahat vericekler ama o ilk verişi çok geçe bırakıyorlar. sonra millet abazalıkta çığır açıyor ülkede.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  98104802
  entry_writer: mavi kirlangic
  entry_fav_count: 1
  entry_content: |
    bu konu hakkında yazanlardan bazılarının o aşağılık adamdan farkı yok.<br/><br/>"allah neden korumadı" diyen de, "iç savaş çıksın da islam düşmanlarını öldürelim" çığırtkanlığı yapan da kara vicdanlıdır. hatta ilki vicdansızken, ikincisi potansiyel canidir.<br/><br/>medeniyetin yıkıldığı, her yerin otlarla kaplandığı bir dünya daha mı iyi olur; kim bilir...
...
- entry_name: |
    greta thunberg
  entry_id:  98106466
  entry_writer: valinorlu
  entry_fav_count: 0
  entry_content: |
    zaman makinesinin bulunduğu ancak karbon salınımını durduran bir teknolojinin geliştirilemediği bir gelecekten gelerek ilkel insanlara "geleceğimi çaldınız" diyen küçük kız. bari gelirken zamanının teknolojisini de getirseydin de kirliliği çözecek bu fikirleri hemen uygulasaydık be çocuk. insanlar delirdi lan gerçekten.
  entry_channels: siyaset,bilim,haber
- entry_name: |
    erkek yazarlardan kadın yazarlara sorular
  entry_id:  98105479
  entry_writer: soleil se
  entry_fav_count: 0
  entry_content: |
    şu sorulara ilk defa bakıyım dedim ve genel anlamda derlemek gerekirse;<br/><br/>neden paranın köpeğisiniz?<br/>neden ilgi manyağısınız?<br/>neden evlilik meraklısısınız?<br/>neden dünya sızın etrafınızda dönüyormuşmuş ?<br/><br/>belaltı muhabbetler yapanlara hiç <br/>girmiyorum.<br/><br/>bu tip sorular soranlara toplu cevap veriyorum .<br/><br/>acilen çevrenizi değiştirin.<br/>ya da o çevreye layık olduğunuzu kabul edin ve eleştirmeyi bırakın.
  entry_channels: anket,ilişkiler
---
