...
- entry_name: |
  ...
  entry_id:  76853477
  entry_writer: negerekvarkisanki
  entry_fav_count: 23
  entry_content: |
    bu ikilemde kalıp mesaj attığımda hiç hayır görmedim onu baştan söyliyim ama bu kafaya da 28 yılın sonunda geldim. siz isterseniz atın. sobaya elini değmeden anlamazsın ne kadar sıcak olduğunu.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    <a class="b" href="/?q=mustafa+kemal%e2%80%99in+askerleriyiz">mustafa kemal’in askerleriyiz</a> tezahüratlarıyla başlayan maçtır.
  entry_channels: spor
- entry_name: |
