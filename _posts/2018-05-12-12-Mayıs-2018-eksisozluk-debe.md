...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    haydi bakalım türkiye'ye bekliyoruz. görelim osmanlı torunlarını.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
    ekonomi batarken vatandaş ne yapmalı
  entry_id:  76884995
  entry_writer: psyhic neuron
  entry_fav_count: 5
  entry_content: |
    durumu biliyorsunuz. dolar euro artışı, alım gücünün düşmesi, ülkenin ödemek zorunda olduğu fakat ödeyemeyeceği dış borcu vb. durumlar (çokça arttırabilirim bunları). belirli bir kapasitenin üzerindeki herkesin çökmeye doğru gittiğimizi farkettiğini biliyorum. <br/><br/>bu konuda en azından faydalı olabilecek fikirleri olanlar varsa, burdan yazsın lütfen. kimsenin bizi bu gidişe hazırladığı falan yok. ben dondum kaldım iyice. <br/><br/>yurtdışına mı gitsem, daha doğrusu tüm gücümü ülkeden ayrılmak için mi harcasam gidebilinceye kadar böyle sürse, yoksa tası tarağı toplayıp istanbul'dan ayrılıp ıssız bir yerde sığınak felan mı yapsam yer altına, herşey bitinceye kadar orda mı beklesem. napsam bilemiyorum cidden :d birçok kişinin de benle aynı hisleri paylaştığını düşünüyorum.
...
- entry_name: |
  ...
  entry_id:  76880298
  entry_writer: c kuzey
  entry_fav_count: 1
  entry_content: |
    yıllara meydan okuyan bilgi (bkz: <a class="b" href="/?q=f%c4%b1st%c4%b1k%c3%a7%c4%b1+%c5%9fahap">fıstıkçı şahap</a>) ünsüz benzeşmesi kuralı unutulmaz.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    evlenince çalışmaktan vazeçiyor musunuz ? <br/><br/>erkek eve ve size bakmak zorundadır kalıbını kabullenip ortamlarda modernim ben eşit haklardayız diyor musunuz ?
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    buraya "benimdir" yazdigi icin ilgi istedigi asikar olan kizdir. instagram kullanmamasi baska sebeplerdendir.
  entry_channels: anket,teknoloji
- entry_name: |
    endüstri 4.0
  entry_id:  76884564
  entry_writer: aiquidie
  entry_fav_count: 0
  entry_content: |
    hükümetin son hamlesi olan konut kredilerindeki indirime bakılırsa inşaat endüstrisidir.
