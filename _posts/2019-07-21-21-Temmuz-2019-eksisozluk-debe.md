...
- entry_name: |
  ...
  entry_fav_count: 162
  entry_content: |
    lan biz kendi kendimize inanacağız, inanmaya hazırız da...<br/>niye çıkıp araya böyle saçma sapan şeyler ekliyorsunuz kardeşim?<br/>haber: yerli araba geliyor!<br/>tamam birader biz inanırız. iyi kötü akla uygun bir iddia.<br/>neden altına "yerli arabamız aynı zamanda uçacak" gibi yarak kürek bir açıklama eklemek zorundasınız?<br/>bırak biz inanırız olduğu haliyle.<br/>detay verdikçe sıçıyorsunuz. yalanın sadesi iyidir, çok süslemeyin.<br/>amfibi saldırı gemisi yapmışlar, uçak gemisi diye reklamı yapılıyor. tamam abi, biraz tipi de andırıyor zaten, yeriz biz. neden altına amerikan uçak gemileri kaçacak delik arıyor diye ekliyorsun. biri açıp resimleri karşılaştırınca ortaya çıkıveriyor işte.<br/>"milli traktör yaptık!"<br/>tamam abi itirazımız yok. bu devirde yapamaman utanılacak bir şey olurdu zaten.<br/>ama altına "7 liralık şarjla 8 saat tarla sürer" yazmasan ne olacaktı? incilerin mi dökülecekti?<br/>sade haliyle zaten inanırdık biz. saçmalayınca yalan olduğu ortaya çıkıyor.
...
- entry_name: |
    hayatın eczacılara güzel olması
  entry_id:  92845813
  entry_writer: lmrvnx
  entry_fav_count: 16
  entry_content: |
    bir <a class="b" href="/?q=t%c4%b1p+doktoru">tıp doktoru</a> olarak reddedemeyeceğim gerçeklik. güvenilir bir <a class="b" href="/?q=eczac%c4%b1+kalfas%c4%b1">eczacı kalfası</a> bulduktan sonra ara sıra <a class="b" href="/?q=eczane">eczane</a>ye uğrayarak kasadaki parayı almak yeterli olabiliyor. eczanenin yeri de güzelse aylık <a class="b" href="/?q=en+az">en az</a> 20-25 bin tl kazanç var. doktorların çok büyük bir kısmının saatlerce çalışarak kazanamadığı parayı, ayda sadece 1-2 defa eczaneye uğrayarak kazanabiliyorlar.<br/>(bkz: <a class="b" href="/?q=eczane+sahibi+eczac%c4%b1lar+ne+i%c5%9f+yap%c4%b1yor">eczane sahibi eczacılar ne iş yapıyor</a>)
...
- entry_name: |
    keanu reeves
  entry_id:  92858905
  entry_writer: mephisto cal
  entry_fav_count: 8
  entry_content: |
    şu dünyada 3 adamın "adam"lığını tartışmam.<br/>1. john mcclane<br/>2. keanu reeves<br/>3. spike spiegel<br/><br/>1 ve 3 numaranın hayali karakterler olması listenin ciddiyetini azaltmaz. özellikle john mcclane kırmızı çigimdir, kalp kırarım.
  entry_channels: tv,sinema
- entry_name: |
    en son gerçekten mutlu hissedilen an
  entry_id:  92831229
  entry_writer: kapaligozleronundeki
  entry_fav_count: 7
  entry_content: |
    hatırlayamamak.
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    çükünü görmezseniz olmaz.<br/><br/>oruçluyken unutup su içmek gibi. niyet önemli. fdjsfj.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=pub">pub</a>)
...
- entry_name: |
  ...
  entry_id:  92853556
  entry_writer: iluvatar
  entry_fav_count: 0
  entry_content: |
    ön grup var mı? yoksa niye etkinlik başlama saati 19:00? sırf gidelim de bira içelim diye mi erken saat söylüyorlar? hiç bir bilgi yok internette.
  entry_channels: sanat,müzik
---
