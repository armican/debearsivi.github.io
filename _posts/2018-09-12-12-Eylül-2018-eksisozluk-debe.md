...
- entry_name: |
  ...
  entry_fav_count: 27
  entry_content: |
    (bkz: <a class="b" href="/?q=fenerbah%c3%a7e+k%c4%b1rmak+%c3%bczereyken+tan%c4%b1mlanan+rekorlar">fenerbahçe kırmak üzereyken tanımlanan rekorlar</a>)
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    ziya selçuk
  entry_id:  81167002
  entry_writer: vallabilla
  entry_fav_count: 20
  entry_content: |
    2000'lerin başında şimdiki bu saçma sistemi başlatan ttk başkanıydı kendisi. uyandırayım.
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    (bkz: <a class="b" href="/?q=my+girl">my girl</a>)<br/><br/>türkçesi;<br/><br/>(bkz: <a class="b" href="/?q=k%c4%b1z+arkada%c5%9f%c4%b1m">kız arkadaşım</a>)<br/><br/>unutulmaz.
...
- entry_name: |
  ...
  entry_id:  81192050
  entry_writer: toshtosh
  entry_fav_count: 0
  entry_content: |
    içini dökmek isteyen yeşillendirebilir. dinlerim, okurum.
