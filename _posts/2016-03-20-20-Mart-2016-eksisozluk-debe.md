...
- entry_name: |
  ...
  entry_content: |
    ...
    başbakan atatürk olsaydı durum muhtemelen şu olacaktı::<br/><a class="b" href="/?q=hangi+patlama">hangi patlama</a>?
...
- entry_name: |
  ...
  entry_writer: siphonensis lacus
- entry_name: |
    erdoğan gidene kadar patlatacağız
  entry_id: 59342855
  entry_content: |
    
    siktirin gidin erdoğan'ı patlatın ozaman.
...
- entry_name: |
  ...
  entry_content: |
    ...
    sağcılardan mizahçı çıkmadığı gibi insan da çıkmadığını gösteren kara katür.
