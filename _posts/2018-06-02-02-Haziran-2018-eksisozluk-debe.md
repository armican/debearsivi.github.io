...
- entry_name: |
    pilot maaşının 32 bin lira olması
  entry_id:  77590622
  entry_writer: emardo
  entry_fav_count: 47
  entry_content: |
    ayrıca şunu da eklemek lazım, thy'de pilot olmak istiyorsanız, tüm aşamaları geçtikten sonra 10 yıllık bir sözleşme imzalıyorsunuz. size yaklaşık 150 bin euro değerinde bir pilotaj eğitimi aldırılıyor ve euro bazında 10 yıl boyunca her ay bu bedel maaşınızdan kesiliyor.<br/>asıl kur farkından dolayı yaşanan sıkıntı bu noktada.<br/><br/>not: rakamlarda hatalarım olabilir ama esasta böyle bir durum var.<br/><br/>not2: lan bir entry girdik, 1000 defa mesaj geldi. pilot falan değilim amk, bu işleri de bilmiyorum, geçen kuzenim merak salmış, araştırmış bana anlattı benden ondan duydum. bırakın lan peşimi.
...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    (bkz: <a class="b" href="/?q=eksi+forum">eksi forum</a>)<br/><br/>ne bekliyorsunuz anlamiyorum ki? <br/><br/>eksi sozluk twitter, forum tarzi bir seye donustu zaten coktandir. kalite de <a class="b" href="/?q=forumtr">forumtr</a> seviyesinin biraz uzerinde iste. <br/>entry'ye bak:<br/>"biletimi alip, birazdan en arka koltuk'ta izleyecegim film."<br/><br/>git bunu whatsapp'dan arkadasina yaz kanka, sozlugu sikmek icin parayla mi tutuldunuz siz, anlamiyorum ki.
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    bence çok doğru transfer olur. hatta ersan da geliyormuş demba da gelsin.<br/><br/>mali kriz var oğlum ucuz adam almak zorundayız. alt yapıdan oyuncu falan çıkar ne bileyim scout ekibi çalışmak zorunda kalır falan mazallah. <br/><br/>allahın izniyle yaz sonu q7 yi satıp yerine serdar özkan’ı getirdik mi tamamdır. hele bir de babel’i okutup aydın karabulut’u alabilirsek şanpiyonnuk bizim kupa bizim.
  entry_channels: spor
- entry_name: |
    ekşi itiraf
  entry_id:  77602147
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    çok amatörce bir açıklama yaparak; bir alman fon şirketine ait raporu zor bela okuyup; erdoğan'ın 51.3 oy alacagini belirtmiştir. fotokopi falan istemiş vermemişler. ayak üstü elde ettiği bilgiyi tahmin diye ortaya koymaya hakkı yok.<br/><br/>şurda kalmış 20 gün daha profesyonel davranmak zorunda herkes. manipülasyona gerek yok.<br/><br/>bu arada baktığı rapor geçen seneki referandum sonuçları olabilir. bir daha kontrol etsin karıştırıyor olabilir. sonuçlar aynı çünkü.
  entry_channels: siyaset,tarih,sinema,eğitim
- entry_name: |
    erdoğan ile polemiğe girmek
  entry_id:  77607869
  entry_writer: otkisi
  entry_fav_count: 1
  entry_content: |
    cahil ilen etme sohbet , her taşı bir baş incitir. cahilde boş söz çok olur, kendisini derya bilir.
  entry_channels: siyaset
- entry_name: |
    şişman biriyle sevişmek
  entry_id:  77610374
  entry_writer: bira sisesindeki izmarit
  entry_fav_count: 0
  entry_content: |
    şu şekilci kafayı bıraksanız, siz de sekslerden sekslere, zevklerden zevklere koşacaksınız ama, kafa hiç çalışmıyor şekilciliğine koduğumun şekilsizlerinde ya!
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=zeren+zerengil">zeren zerengil</a>)
  entry_channels: 
---
