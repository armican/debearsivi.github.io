...
- entry_name: |
  ...
  entry_fav_count: 876
  entry_content: |
    bim'e a-101'e giden adam çöpünü bile alır unutmaz. <br/><br/>çünkü hesabını bilen insandır. aldığı ürünleri cebindeki paraya göre alır. kasada da bir ürününü unutanı asla göremezsin. <br/><br/>tanım: olanaksız bir durumdur iftiradan öteye geçmez.
...
- entry_name: |
    akp'lilerin geç de olsa gözlerinin açılması
  entry_id:  82355316
  entry_writer: northroma
  entry_fav_count: 340
  entry_content: |
    bir akp'linin yaşam döngüsü;<br/><br/>seçim öncesi: bu sefer vermeyeceğim.<br/>seçim günü: cehape'ye mi verseydik...<br/><br/>bu kadar.
...
- entry_name: |
  ...
  entry_fav_count: 143
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://eksiup.com/c7ffa6cb3176">https://eksiup.com/c7ffa6cb3176</a>
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
    başakşehir'in arda'ya 2.5 milyon tl ceza vermesi
  entry_id:  82362261
  entry_writer: sabirsizadam
  entry_fav_count: 123
  entry_content: |
    kontratı euro üzerinden, cezalar tl üzerinden. tıpkı adalet sistemi gibi.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    aldatıldığı itiraf edilen kızla son kez sevişmek
  entry_id:  82367861
  entry_writer: oyuncak bulut
  entry_fav_count: 62
  entry_content: |
    (bkz: <a class="b" href="/?q=yazar+sevi%c5%9fmek+demi%c5%9f+fakat+tecav%c3%bcz+lan+bu">yazar sevişmek demiş fakat tecavüz lan bu</a>)
  entry_channels: ilişkiler
- entry_name: |
    bir günlüğüne çocukluğa dönülse yapılacak ilk şey
  entry_id:  82352034
  entry_writer: metrobusdeoturanadam
  entry_fav_count: 54
  entry_content: |
    anneeeeeee su sallll diye bağırırdım, rahmetli de sepetle suyu salardı.bir de derdi ki uzaklaşma oğlum, terleme.<br/><br/>onu bir kere daha canlı görmüş olurdum.<br/><br/>gözlerim doldu sabah 5 de kına yak başlık sahibi.
...
- entry_name: |
  ...
  entry_fav_count: 52
  entry_content: |
    taahhütünüzü böyle yaptınız bitene kadar devam edeceksiniz demesinler sonra. bu dönemde taahhütlü internet alınmaz bence.
...
- entry_name: |
  ...
  entry_fav_count: 41
  entry_content: |
    çocukken yüksek gerilim direklerini allah zannederim, hele bir de plastik oyuncak gitarıma elektro gitar yapma amacıyla tel bağlayıp ucunu da prize sokup ben bir yana eriyen gitar bir yana fırladıktan sonra elektriğe bakış açım çok değişmişti.<br/><br/>sonra normal insanlar gibi ben de elektrikten bağımsız bir tanrıya inanmaya başladım.<br/>ama şu günlerde tekrar kafamı kurcalıyor bu ihtimal. neden olmasın?
...
- entry_name: |
  ...
  entry_fav_count: 32
  entry_content: |
    çoğunluğu zaten kıt kanaat yaşayan insanlara mezarda emeklilik dayatmak en hafif tabirle adaletsizliktir, hayat sömürüsüdür. bunun çözümü türkiye için ne köy güzellemesi, ne herkes ticarete atılsındır. çözümü ülkenin para birimini değerli hale getirebilmek, insanların saatlerini hatta ömürlerini harcayıp kazandığı parayı değerli kılıp enflasyona yedirmemektir. japonya'da tanıdığım 21 yaşında biri part-time olarak yazın bir restorantda garsonluk yapıyordu. oradan kazanıp biriktirdikleriyle bir ay amerika'da tatil yaptı,arkadaşlarıyla araba kiralayıp route 66'yı geçti. ülkemizde part time'ı , asgari ücretliyi bırak, kaç tane orta düzey yönetici böyle bir tatil yapabilir. ortalama bir japon gencin tatilde kazandığı parayı biriktirebilmek için ne kadar çalışmanız gerekir. maalesef hayatlarımız hatalı devlet politikaları ile güçsüzleştirilen paramızla birlikte tükeniyor.
...
- entry_name: |
  ...
  entry_fav_count: 27
  entry_content: |
    askerliğimi jandarma asteğmen olarak yaptım. çocuklarla birlikte(o zaman bile aramızda 10 yaş vardı yavrularımla) harlem shake yapmıştık. sosyal medyaya da koymuştuk. dağın başında eksi 20 derecede sırt sırta verdiğim çocuklar eğlenmeyecek de kim eğlenecek? duyarını al da münasip yerine yerleştir.
  entry_channels: siyaset,haber
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    (bkz: <a class="b" href="/?q=ulusalc%c4%b1l%c4%b1k">ulusalcılık</a>)
  entry_channels: siyaset
- entry_name: |
    devlet bahçeli'nin olumlu yanı
  entry_id:  82368159
  entry_writer: pezetel
  entry_fav_count: 11
  entry_content: |
    konuşurken - eğer alkış istiyorsa- cümle sonuna doğru sesini yükseltip cümleyi tamamlıyor, böylece dinleyenlerine alkış için ipucu veriyor. dinleyenler " len ne zaman alkışlayacağız" diye düşünmüyorlar . yorulmuyorlar. ses yükseldi mi bitişinde alkışlama gelmelidir. bence adamın tek olumlu yanı budur. başka da bulamadım valla.
  entry_channels: siyaset
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    arda turan'ın masum olma ihtimali
  entry_id:  82367786
  entry_writer: nuktedan
  entry_fav_count: 7
  entry_content: |
    kadına sark , 1 taciz. <br/>adama kafa at , 2 adam yaralama. <br/>adama etmedik laf etme 3 hakaret.<br/>hastaneye silahla gir. nerden baksan 4 ruhsatsız silah taşıma.<br/>hastanede silah sık . 5 silahlı tehdit ve meskun mahalde silah kullanma. <br/><br/>bütün bu bokları yedikten sonra polislerin suratına bakıp ‘’ kusura bakmayın abi masumum ‘’ diyemezsin. adamın götünden kan alırlar kamil kan. <br/><br/>hadi berkay yavşak ki bu ibneler delikanlı davrandı diyorlar. yavşak adam nasıl delikanlı davranır ben anlamadım gitti. <br/><br/>her neyse. karı açık giyinmişti taciz ettik , herif yavşaktı dövdük , silahla tehdit ettik. demezler mi ‘’ ulan siz misiniz bu kentin zaptiyesi’’ sikerler oğlum hepimizi sikerler. amk arda’sı neler açtı başımıza.
  entry_channels: magazin
- entry_name: |
    90'lı yılların unutulan pop şarkıcıları
  entry_id:  82347485
  entry_writer: laplasyen
  entry_fav_count: 7
  entry_content: |
    <a class="b" href="/?q=mert+ekren">mert ekren</a> - <a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/Qi-McCyG8WQ" title="https://youtu.be/Qi-McCyG8WQ">alo orda mısın?</a><br/><br/>güzel şarkıydı vesselam.
  entry_channels: anket,tarih,müzik,magazin
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    yerli ve millisi yapılamayacak şey
  entry_id:  82367926
  entry_writer: ne guzel komsumuzdun sen fahriye abla
  entry_fav_count: 5
  entry_content: |
    monica belluci. bundan iyisini yapamayız bence.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    3 ay evvel babama inme gelmeden önce evimde tatlı tatlı dizi izlediğim an.<br/>gerisi 3 aydir hemen her gün hastane odalarında sabahlara kadar babamın çığlıklarını dinleyip uykusuz, moralsiz, tükenmiş bir şekilde işe gidip sonra yine hastaneye dönmek.<br/><br/>ulan şu lafı diyeceğim hayatta aklıma gelmezdi ama gerçekten dostlar hayatın tadını çıkarın. boktan konuları dert etmeyin kendinize.
  entry_channels: anket,ilişkiler
- entry_name: |
    zengin olunca telefon rehberinden silinecekler
  entry_id:  82371270
  entry_writer: ramses0017
  entry_fav_count: 0
  entry_content: |
    kendi numaram tabi ki artik 34 lu hat mi kullanılır
  entry_channels: 
---
