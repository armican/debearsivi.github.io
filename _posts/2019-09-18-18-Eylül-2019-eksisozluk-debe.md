...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    volvo'ya arkadan çarpan symbol'un hazin sonu
  entry_id:  95459193
  entry_writer: tommati
  entry_fav_count: 311
  entry_content: |
    aslında beklenen sondur. zira araçların ön kısmı arka kısmına göre kaza olduğunda daha fazla hasar alacak şekilde tasarlanır. amaç yolcuyu korumaktır. mekanik enerji yolcuya yansıyacağına araca yansır. hee tüm bunlardan bağımsız volvo kral araçtır o ayrı. ama başlık olmamış kardeş.
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    üç öğün kırmızı et yemenin bünyeye etkisi
  entry_id:  95470007
  entry_writer: bogulanbalik
  entry_fav_count: 269
  entry_content: |
    bu devirde bu eylemi yapacak kişi ayın ilk 5 gününden sonrasını aç geçirip açlıktan ölür.
  entry_channels: anket,sağlık,yeme-içme
- entry_name: |
    17 eylül 2019 istanbul akbil kuyruğu rezaleti
  entry_id:  95470914
  entry_writer: da ci lan bu
  entry_fav_count: 221
  entry_content: |
    geçen sene de böyleydi burası, sanırım kartal metro durağı. her sene aynı olur, nedeni de yeni akbil çıkartan öğrenciler ve aileleridir. sıranın yarısı, ya evrak eksiği ya da herhangi bir yanlışlıktan dolayı boşuna bekliyordur ve işin yavaşlamasına neden olur.<br/><br/>bu yıl ilk defa olan bir şey değil, bu hafta dışında gidin bomboştur. rezalet hususunda emin değilim ama modern bir toplumda olmaması gerektiğini bildiğim bir durumdur.
...
- entry_name: |
    rus gençliği nereye gidiyor
  entry_id:  95462518
  entry_writer: lowpoly
  entry_fav_count: 213
  entry_content: |
    sen bir de yanlışlıkla tik tok'a gir de, türk gençliğinin halini gör.
...
- entry_name: |
    zorla flüt çaldıran eğitim sistemi
  entry_id:  95456814
  entry_writer: varolan
  entry_fav_count: 168
  entry_content: |
    zorla dua ezberleten eğitim sisteminin yanında sütten çıkma ak kaşıktır.
  entry_channels: müzik,eğitim
- entry_name: |
    killa hakan'ın faruk sabancı'yı tehdit etmesi
  entry_id:  95471799
  entry_writer: hnnn
  entry_fav_count: 150
  entry_content: |
    bu herifin suratını görmeyi o kadar istemiyorum ki linke tıklamadan, verdiğin habere doğrudan inanıyorum.
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    ustabaşı mühendis ilişkisi
  entry_id:  95467163
  entry_writer: arslanmarley
  entry_fav_count: 124
  entry_content: |
    mühendis: usta filizlenmeyi yanlış yapmışsın, kalıplar çakılamaz bak sonra.<br/>ustabaşı: ben çakarım.<br/>mühendis: çak abi.<br/>müteahhit: ne yapıyorsunuz orospu çocukları, yakacak mısınız beni?<br/>bakanlık denetmeni: ananızı siktim şimdi.
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    17 eylül 2019 susamam'a suç duyurusu
  entry_id:  95475524
  entry_writer: jet lag
  entry_fav_count: 96
  entry_content: |
    o halde biz de rahatsızlık duyduğumuz her şey hakkında suç duyurusunda bulunalım. ne ala memleket.
...
- entry_name: |
  ...
  entry_fav_count: 63
  entry_content: |
    şarkıcı demeyelim, "sanatçı" diyelim; erkan oğur...
...
- entry_name: |
    16 eylül 2019 alanyaspor lehine kural hatası
  entry_id:  95446569
  entry_writer: for let the angel rise
  entry_fav_count: 59
  entry_content: |
    az önce ahmet çakar kuralı net olarak açıklamıştır. kural hatası bir yana, bizzat kurala uygun gol olmuştur. kurallara göre oyunun akışkanlığı için kalecinin aut atışını oyunu hızlandırmak adına kendi topçusuna hızlıca aktarma hakkı vardır. yani rakibin yürüyerek 9 metre gitmesini beklemek zorunda değil diyor kural. dolayısı ile fener kalecisi alanyalı götünü dönmüş giderken diğer çaprazda fenerli savunmacıya pas verebilir diyor. fenerli salak da bu pası alıp, 5 saniye bakınıp topu kaptırıyor. olay ne burada kardeş?<br/>neresi kurala aykırı?<br/>edit : olmayan hata.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    direksiyon sınavında caddeden aşağı uçmak
  entry_id:  95474126
  entry_writer: o kadar haklisin ki
  entry_fav_count: 22
  entry_content: |
    gözetmen müdahale etmemiş çünkü "arabayı uçurumdan aşağı mı atacak sanki yok artık aq" diye içinden geçirmiş bence.
  entry_channels: haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    sorun sende değil bende. (seni istemiyordur)<br/>bu aralar bir ilişkiye hazır değilim (kafasında birisi vardır. fırsat yakaladığı ilk an onunla olacaktır)
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    brugge'ü hiç bilmiyorum takım olarak da, diagne'yi alan bir teknik ekibe sahip takım ne kadar iyi olabilir amk. basar geçeriz.<br/><br/>(geçen sene siz vermediniz mi bu adama 10 milyon demeyin, karıştırmayın orasını <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>)
  entry_channels: spor
- entry_name: |
    ekşi itiraf
  entry_id:  95453119
...
- entry_name: |
  ...
  entry_channels: anket,sağlık
- entry_name: |
    17 eylül 2019 inter slavia prague maçı
  entry_id:  95480455
  entry_writer: 3lly
  entry_fav_count: 3
  entry_content: |
    aq inter'i küme düş, yıkıl, yok ol.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    skoda'nın gereksiz bir araba olması
  entry_id:  95479660
  entry_writer: ersensener
  entry_fav_count: 2
  entry_content: |
    insanlarin yuzde doksansekizinin, geri kalan yuzde ikinin cabalari sayesinde hayvandan farkli bir yasami vardir. yani aslinda diyebiliriz ki yuzde doksansekizimiz luzumsuz.<br/><br/>insanlar bu gercegi fark ettiklerinde, bazilarinin aklina manyak bir fikir geldi;<br/><br/>“madem bu adamlar luzumsuz, neden bunlari yavas yavas elimine edip, yuzde ikinin soyundan devam etmiyoruz?”<br/><br/>(bkz: <a class="b" href="/?q=eugenics">eugenics</a>)<br/>(bkz: <a class="b" href="/?q=fasizm">fasizm</a>)<br/>(bkz: <a class="b" href="/?q=nazizm">nazizm</a>)<br/><br/>bu manyakliklar, nihai sonucu (ve dolayisiyla anamizin amini) gormemizden once, bazi cok mantikli sakincalari fark etmemizle sonra erdi.<br/><br/>sakinca suydu ki; sadece luzumsuz olmayan yuzde ikiden devam eden soyun da yuzde doksansekizi luzumsuz olacak, toplam ise yarar insan sayisi onceki kusaktaki sayinin yuzde ikisine dusecekti.<br/><br/>cesitlilik, aslinda varligimizin devaminin yegane garantisidir.
