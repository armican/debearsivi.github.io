...
- entry_name: |
  ...
  entry_channels: anket,sağlık
- entry_name: |
    porno filmlerinde görülmeyen sahte kamera arkası
  entry_id:  95482904
  entry_writer: m aysar ongel
  entry_fav_count: 11
  entry_content: |
    porno film çekimi değil bu herhangi bir filmin seks sahnesi. porno backstage'i bu şekilde değil.<br/><br/>ayrıca o başlık nedir birader. sahte kamera arkası ne demek? <a class="b" href="/?q=porno+filmlerin+kamera+arkas%c4%b1ndaki+sahtekarl%c4%b1k">porno filmlerin kamera arkasındaki sahtekarlık</a> de bari. senin açtığın başlık şu anlama geliyor: porno filmlerin kamera arkası görüntüleri sahte.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    “ne kadar seviyorsun dersen;<br/>nar kadar derim.<br/>dışımdan bir ben görünürüm,<br/>içimden binlerce sen dökülür…”
  entry_channels: anket,sanat,edebiyat
- entry_name: |
    17 eylül 2019 fatih terim'in ağzından kaçan itiraf
  entry_id:  95483114
  entry_writer: pink ja
  entry_fav_count: 10
  entry_content: |
    dear uefa
  entry_channels: 
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    ya kafayı mı yediniz amına koyim? am arıyorum diye de başlık açın.
  entry_channels: anket,ekşi-sözlük
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    aklıma güzel ilen taş taşınır, çirkin ilen bal kaşıklanmaz sözünü getiren sorudur.
  entry_channels: anket,ilişkiler
- entry_name: |
    17 eylül 2019 napoli liverpool maçı
  entry_id:  95482964
  entry_writer: 26 haziran
  entry_fav_count: 2
  entry_content: |
    liverpool'da firmino psikopatını hayran hayran seyrettiğim maç. sen ne biçim bir adamsın aq. salah ile mane'ye duvar oluyor,orta sahaya kadar gelip hayvan gibi pres yapıyor,fiziğiyle rakip savunmayı yoruyor. bayılıyorum bu adama. liverpool'un virgil ile birlikte en iyi oyuncusu bence.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=d%c3%bcnyan%c4%b1n+en+k%c4%b1sa+f%c4%b1kras%c4%b1">dünyanın en kısa fıkrası</a>)
