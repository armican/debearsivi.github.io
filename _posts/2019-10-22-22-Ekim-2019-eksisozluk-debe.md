...
- entry_name: |
  ...
  entry_fav_count: 138
  entry_content: |
    olmayan rezalettir.<br/><br/>çıkan şey tahmin ettiğiniz ped değildir. et bekledikçe bir miktar su salar, etin suyunu çekmesi için altına bu zımbırtıdan koyulur.<br/><br/>edit: ironiymiş, bir daha yapma dostum.
  entry_channels: yeme-içme
- entry_name: |
...
- entry_name: |
    2000 tl maaş+iphone11+gucci çanta+rolex saat
  entry_id:  96829631
  entry_writer: derindusunce
  entry_fav_count: 13
  entry_content: |
    sol framede görünce iş ilanı sandığım başlık.<br/>az daha cv yollayacaktım.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    moğolla evlenirdim amk. sinsi gibi hiç bir şeye karışmıyorlar.
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    zengin ibaresini çıkarırsanız kadınlardan gördüğü talep yarı yarıya düşecektir.
  entry_channels: 
- entry_name: |
    gbt
  entry_id:  96826301
