...
- entry_name: |
  ...
  entry_fav_count: 191
  entry_content: |
    anıtkabir'i, yalnızca <a class="b" href="/?q=bir+insan%c4%b1n+mezar%c4%b1">bir insanın mezarı</a> olarak görebilecek kadar vatan sevgisinden yoksun mahlukları ortaya çıkarmış başlık.
  entry_channels: siyaset,anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 58
  entry_content: |
    <a class="b" href="/?q=s%c4%b1f%c4%b1r+s%c4%b1k%c4%b1nt%c4%b1">sıfır sıkıntı</a> adlı rap şarkısını dinleyip bizim kültürümüzde protest yok demiş boş insan. bizim kültürümüzde protest yoksa selda bağcan, ahmet kaya, zülfü livaneli, cem karaca, grup yorum şarkılarında neyden bahsediyor acaba? türkiye gibi bir ülkede protest rap yapmayın demek cahillikten başka bir şey değildir. yıllarca protest türküler söylendi, rock müzik yapıldı şimdi de rap olarak yapılıyor.<br/><br/>"azınlıksın da hakların mı yeniyor beyaz türksün işte" diyerek de sıçıp sıvamış. eminem de beyaz o zaman o da protest rap yapmasın senin bakış açına göre. italya doğumlu amerika'da yaşayan beyaz tenli vinnie paz abimiz de yapmasın mesela dimi. ayrıca bir insanın protest tavır alması için illa varoştan gelmesine azınlık olmasına ihtiyacı mı var ya? bir şeylerin farkında olup ona tavır alması gayet yeterli bir sebep.<br/><br/>neyse jahreincim taa polonya'lardan hayat sana güzel ama sen bu konulara çok girme bence boş koy oyununu oyna çocukları eğlendir.
...
- entry_name: |
  ...
  entry_id:  75934515
  entry_writer: yavshaq
  entry_fav_count: 33
  entry_content: |
    kendi başına vakit geçirebilmesidir. tek başına keyifli vakit geçirebilen insan dünyanın her yerinde, her şartta yaşayabilir.
...
- entry_name: |
  ...
  entry_fav_count: 26
  entry_content: |
    (bkz: <a class="b" href="/?q=zone.com+dan+gelenler+parmak+kald%c4%b1rs%c4%b1n">zone.com dan gelenler parmak kaldırsın</a>)<br/><br/>bu konuda en iyisi sanıldığı gibi pers değil goth dur çünkü barracklardan şimdi adını hatırlayamadığım bir kale birimi basabiliyordunuz ve rakip, kaleyle uğraşırken siz çoktan orduyu kurmuş oluyordunuz. genelde oyuna başlamadan önce kimin rush atacağı, aldığı ülkeden belli oluyordu ve bu nedenle millet odaların başlığına no turk pers goth yazardı. kore de sonradan bu listeye katılmıştır. oyun oynamaktaki amaç zevk almaksa, rush yapanlar bu oyunun emre belözoğlusu, bülent korkmazı, volkan demirelidir.
  entry_channels: oyun
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    ismi kalben, egosu rihanna.<br/><br/>kilo vermek için yüzmeye başlamış, kaprislerini kussa yirmi kilo verir.<br/><br/>gitar çalan kezban.
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    la casa de papel'in arturo'sunun hikmet bey kod adıyla dahil olduğu yarışma programı. <br/>esma hanımı eziklemekten vazgeçseler de eğlenmeye baksalar azıcık. böyle saf insanlara bu eziyetleri yapmalarından nefret ediyorum. <br/>kazanamayacaksın arturo!
...
- entry_name: |
    abdülkadir yusuf ve okay'ın beşiktaş'a transferi
  entry_id:  75947997
  entry_writer: rakirikirealdo
  entry_fav_count: 9
  entry_content: |
    kulübün resmi açıklamasıymış gibi , bir gazetenin uydurma başlığına esprili cevap yazmaya çalışan mallardan önce yazalım; her ne kadar bahsedilen ölçüde yüksek bonservisleri olmasa da bu arkadaşların yeri avrupa olmalıdır. <br/><br/>trabzonspor’un oğuzhan, tolgay, talisca hamlesi nasıl komik olacaksa bunun gibi başlıklar uydurmak okuyucuyu mal yerine koymaktan başka bir şey değildir.
  entry_channels: spor
- entry_name: |
    bitcoin
  entry_id:  75948812
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    amerikaya tarihinin en buyuk "u" sunu cizdirmis, amerika bu hamle ile ortadoguda buyuk kaybetti; odetirler! (ha iyi ki de o fuzeler gitmedi orasi ayri)
  entry_channels: siyaset,tv,haber,ekonomi
- entry_name: |
    osmangazi üni morgunda ölülere tecavüz iddiası
  entry_id:  75956843
  entry_writer: başlık taşıyan
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=osmangazi+%c3%bcniv.+morgunda+%c3%b6l%c3%bclere+tecav%c3%bcz+iddias%c4%b1">osmangazi üniv. morgunda ölülere tecavüz iddiası</a>)
