...
- entry_name: |
  ...
  entry_fav_count: 54
  entry_content: |
    yarak başı &gt; mikadonun pelerini<br/><br/>doğruluğu 15 saniye içerisinde ispatlanmıştır. fava atıp beklemenize lüzum yok. kimilerini oksijen çarpıyor amk. <br/><br/>comolli abimize gelince genç ve enerjik görünüyor. ali koç gibi türkiye'nin en büyük girişimi olan koç ailesinin varisinij olduğu yerde, bu kulüpten kimse bir kuruş çalamaz çırpamaz.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: tv
- entry_name: |
    ak partililerin çok çirkin olması
  entry_id:  79589883
  entry_writer: dondurmayacipsbananadam
  entry_fav_count: 24
  entry_content: |
    daha zengin, daha güzel, daha ünlü, daha elit insanları kıskanan bir topluluk oldukları içindir. götlörönö öçmöyö görök olmadığı için değil.
  entry_channels: siyaset,anket
- entry_name: |
...
- entry_name: |
    habire götten ambargo
  entry_id:  79601541
  entry_writer: yagsag
  entry_fav_count: 17
  entry_content: |
    abd başkanı sayın donald trump'ın sürekli götünden uydurduğu lakin bir türlü uygulamaya geçiremediği ambargo.
  entry_channels: yeme-içme,motosiklet
- entry_name: |
...
- entry_name: |
    27 temmuz 2018 dolar kuru
  entry_id:  79597412
  entry_writer: zalim olma imana gel
  entry_fav_count: 3
  entry_content: |
    papaz'a bağlı kurdur. papaz hakkında abd tarafında olumlu görülebilecek bir gelişme olursa düşüyor, aksi taktirde yükseliyor. ne papazmış arkadaş. bizim merkez bankasından bile daha etkili.
  entry_channels: ekonomi
- entry_name: |
    fiat egea
  entry_id:  79579655
  ...
  entry_fav_count: 2
  entry_content: |
    şaka gibi ya adamlar işi gücü bırakmış bmw ile egea nın kalkışını gelip anlatıyor.<br/><br/>bu başlıkta kimse bu araba 5.35 den hızlı kalkar demiyor.aksine fiyat/performansı gayet iyi olduğu belirtiliyor. ben 67 bin tl ye yıl başında benzinli lpg li orta paketini aldım.sıfır kilometre sorunsuz araçın neresi beğenilmiyor insan gerçekten hayret ediyor.egea kilometre de 0,22 kuruş yakan trim sesi olmayan gayet makul bir araçtır.
