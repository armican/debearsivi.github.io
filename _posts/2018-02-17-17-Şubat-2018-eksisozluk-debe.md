...
- entry_name: |
  ...
  entry_fav_count: 46
  entry_content: |
    (bkz: <a class="b" href="/?q=hewal%2c+l%c3%bctfen">hewal, lütfen</a>)<br/><br/>girdiği her entry buram buram kürt milliyetçiliği, türk düşmanlığı kokan bir pkk sempatizanının açtığı başlık.
- entry_name: |
    ahmet altan
  entry_id:  74267396
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    hayır gören de adam gezinin lideri, solun mihenk taşı falan sanacak. ortalama bir muhalif gibi twitterde paylaşımlarda bulunan bir ünlü sadece memoli. onu bu kadar "önemli" yapan iktidar ve yandaş medyası tarafından hedef gösterilerek sanki gezi'nin lideri bir ajanmışcasına muamele yapılmasıdır. e adamın da canı tatlı, sikerler diyip kaçmış yurtdışına. kalıp işkence/ölüm tehditleri altında yaşamına devam etmeye mi çalışsaydı? adamın öyle bir dava adamlığını falan görmedim ki neyine mücadele etsin hayatı pahasına? zaten adam varoluş savaşı verip geziye katılmış değil, otoriterlikten şikayetçi bir yurdum insanıydı.<br/>ayrıca o iş göt ister, oturduğu yerden tivit atmaya benzemez risklerine rağmen türkiye'yi terk etmemek. gerçekten hayatın zaten pamuk ipliğinde olacak o risklere girecek cesareti bulabiliyorsan. seversin sevmezsin terörist dersin ayrı ama hdp'nin lider kadrosundan tek bir kişi kaçmamıştır örneğin yurtdışına, başlarına gelecekleri bile bile söylemlerini değiştirmemişlerdir. bunun sebebi de bedel ödemeye alışık bir gelenekten gelmeleri denebilir. memolinin ya da genel olarak laik solcu muhalifin hiç öyle riskli bir hayatı olmamıştı geziye kadar.<br/><br/>not: yurtdışınakaçanspor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    modemin altı.<br/><br/>geçenlerde fazladan bir miktar para çekmiş tamamını üstümde taşımak istemediğimden paramın iki bölü üçünü modemin altına, kalanın bir bölü ikisini giymediğim bir ceketin cebine koymuştum.<br/><br/>başlığı görünce paralarım aklıma geldi bak.<br/><br/>gideyim de bir bölü altısıyla yemek, bir bölü onuyla tatlı yiyeyim.
- entry_name: |
    bitcoin
  entry_id:  74253025
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    onlar "sonunda beni sürüklediği felâkete rağmen onun kollarına atıldığım gecenin tadını unutamıyorum," diye başlayan hikayeler isterlerdi.<br/><br/>yusuf atılgan
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    chp kuşadası ilçe yöneticisi (bkz: <a class="b" href="/?q=mehmet+y%c3%bccel">mehmet yücel</a>) tarafindan yapildigi haberleri dolaniyor.<br/><br/>ışıklar kapaninca 13 yasindaki erkek cocuguna otobuste tacizde bulunmus. ve sadece cebine para konup otobusten atilmis. vay arkadas. rezillik
- entry_name: |
...
- entry_name: |
    black panther
  entry_id:  74264443
  entry_writer: onepointzero
  entry_fav_count: 1
  entry_content: |
    bir eksik geldi film nedense. çizgi romanını okumadım, belki orijininde de böyledir fakat sürekli olarak bir siyahilere yapılan haksızlıkların intikamı üzerine kurgulanmış gibi geldi senaryo.kadro ful zenci. yönetmen dahil. süper kahraman filminden çok zenci ırkçılığı yapılan bir filme dönüşmüş.renk çeşitliliği olsun diye bir beyaz katılmış oyuncuların arasına ama onu da konusturmuyorlar.
- entry_name: |
    ekşi sözlük iş ağı
  entry_id:  74269744
  entry_writer: malmen
  entry_fav_count: 0
  entry_content: |
    abim için antalya'da bekçilik, çamaşır, bulaşık, artik ne olursa iş bakiyorum aga 52 yaşında, çalıştığı fabrika kapandi. ayazda kaldi yiğidim. yatili olmakla birlikte başka iller de olabilir. <br/>ortam kötü allah herkese yardim etsin.
---
