...
- entry_name: |
  ...
  entry_fav_count: 557
  entry_content: |
    bu yüzden hep diyoruz; <br/>ülkede ideolojik, siyasi ve dini bir sorun yok! ülkede karakter, zeka ve zihniyet sorunu var.
...
- entry_name: |
  ...
  entry_fav_count: 534
  entry_content: |
    ya furki!!! <br/><br/>dava yoldaşın din fırıldağı tuğçe hakkında dava açılmış ve sen üzülmüşsün! çok normal! <br/><br/>sana şimdi atatürk’ten ve cumhuriyetin ilkelerinden bahsetmeyeceğim çünkü senin gibi provakatif ve ruhu paslanmış biri anlamaz maalesef. <br/><br/>gerçekten dünya görüşü olarak sana en yakın kişinin tuğçe kazaz olması nasıl bir duygu!? <br/><br/>allah sakınsın, ben intihar ederdim.
...
- entry_name: |
  ...
  entry_id:  100413140
  entry_writer: bilmiyorumbilemiyorum
  entry_fav_count: 77
  entry_content: |
    2 bin 500 çok olmuş hatta asgari ücretin altında başlasınlar
...
- entry_name: |
  ...
  entry_fav_count: 48
  entry_content: |
    eğer bu işler ah ile olsaydı malum kişi çoktan hakkın rahmetine kavuşurdu <br/><br/>allah sana acil şifalar versin , senin gibi fırlaması bir daha kolay gelmez
...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    biraz düşünmesine izin verilse hüküm dağı'na yer altından, kazarak ulaşma fikrini ortaya atabilecek kapasitede bir divan üyesinin madara edilmesi ile sonuçlanan hadisedir.<br/><br/>"sayın gimli, hüküm dağı'nda şey etmemiz gerekiyor. acaba nasıl yapsak?" diye sorsalar gimli zaten bu dahiyane fikre ulaşırdı çabucak.<br/><br/>nazgullar arasın dursun yukarıda...<br/><br/>@tünel kazmak 10 yıl sürer demişler.<br/>khazad dum'u yapan teknoloji ve emek 1 kişinin içinde yürüyebileceği tüneli 3-5 ayda yapar.
...
- entry_name: |
  ...
  entry_id:  100434003
  entry_writer: erdemliliyim
  entry_fav_count: 12
  entry_content: |
    artık birileri haritadan silinse de kurtulsak amk.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    tinder kullanırken sevgiliye yakalanmak
  entry_id:  100434110
  entry_writer: cevirimanyagi
  entry_fav_count: 9
  entry_content: |
    eşim karışmıyor sana ne oluyor amk diye üste çıkılması gereken durum.<sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
  entry_channels: 
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    fb'yi devletin kucağına oturtma operasyonu
  entry_id:  100430718
  entry_writer: dbracgn
  entry_fav_count: 8
  entry_content: |
    (bkz: <a class="b" href="/?q=orospu+%c3%a7ocuklar%c4%b1n%c4%b1n+u%c4%9framayaca%c4%9f%c4%b1+ba%c5%9fl%c4%b1klar">orospu çocuklarının uğramayacağı başlıklar</a>)<br/>veya daha yüzsüz orospu çocuklarının gelip salak salak konuşacağı başlık<br/><br/>fenerbahçe üzerine oynanan oyunlar gün gibi ortadayken fanatik zihniyetlerinin kurbanı olan mahlukatlar buna ne diyecekler bakalım.
