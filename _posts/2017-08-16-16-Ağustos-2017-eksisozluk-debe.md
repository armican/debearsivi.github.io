...
- entry_name: |
    15 ağustos 2017 kuzey kore'nin geri vites yapması
  entry_id:  70200827
  entry_writer: sibiuspor
  entry_fav_count: 200
  entry_content: |
    açıkçası ben üzüldüm. keşke nükleer savaş çıksaydı ve milyarlarca insan acı çekseydi.<br/><br/>hayattan bir beklentim yok. keyif de almıyorum. dünya bugün yansa yıkılsa zerre sikimde olmaz.
- entry_name: |
    game of thrones
  entry_id:  70190268
...
- entry_name: |
    kemalizmi aşamayan entelektüel
  entry_id:  70197083
  entry_writer: no country for old men
  entry_fav_count: 111
  entry_content: |
    fularlı bir ergenin, nasıl entel oldum, içerikli başlıği ve komik yazısı.özne, oksimoron gibi soslarla marine edilmiş, bir tutam edvard said, iki tatlı kaşığı isaiah berlin eklenerek sıradanlığın ve sakız olmuş eleştirinin kısık ateşinde hiç olmamış tatsız karışım.<br/><br/>edt: ergen hız kesmiyor. grodo diye bir kelime kullandi. levi strauss'tan alınti yaptı.<br/><br/>varan2: fuko dan alintı yaptı. habermas'tan da bir alıntı beklentisi oluştu...
- entry_name: |
...
- entry_name: |
    kızlarsoruyor'a ekşi sözlük'ten daha çok girilmesi
  entry_id:  70190578
  entry_writer: eksi peace
  entry_fav_count: 107
  entry_content: |
    ekşi sözlüğe isteseler de soramayacaklarından normal olandır.<br/><br/>soru sormak için kayıt olmak isteseler çaylak olacaklar, 2 yıl sonra yazarlıkları onaylanacak.<br/><br/>bu kızlar nereye soracak?
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 61
  entry_content: |
    her şey iyi hoş da ara ara "<a class="b" href="/?q=mutlu+bana+bi+%c5%9feyler+oluyo">mutlu bana bi şeyler oluyo</a>" der gibi bakması korkutuyor. düşüp bayılacak sanıyorum. <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    merdi kıpti şecaat arzederken sirkatin söylermiş.<br/><br/>lumpenlik radikalleştikçe millet neyle övüneceğini şaşırıyor.<br/><br/>"5 yaşındayken babam odama nobel ödülü alanların listesini astı." veya "8 yaşındayken 1 ayda 1000 sayfa kitap okudum diye babam bisiklet aldı" gibi bir tecrübesi olmayan böyle saçma sapan şeylerle övünür.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    kramaric dingilinin abuk subuk bi penalti vurdugu mac. fifa'da ve fm'de bi kac senedir hoffenheim ile kariyer yaparim. bu malı yollamak hep yaptigim ilk iştir. boyu uzun olmamasina ragmen kalas gibi adamdir. yedeklerde de uth diye bi forvet var. kramaricin uzun boylu hali. ıkinci yari girsin onun malliklarni da görürüz.
---
