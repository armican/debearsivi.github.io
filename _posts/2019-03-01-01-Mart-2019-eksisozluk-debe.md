...
- entry_name: |
  ...
  entry_fav_count: 646
  entry_content: |
    attan düşen birini biliyorum ve onun mustafa kemal atatürk olmadığından çok eminim. <br/><br/>tanım: başlıkları engellenmesi gereken troll zırvası
...
- entry_name: |
    tek bir yıldırımın 300 ren geyiğini öldürmesi
  entry_id:  87212093
  entry_writer: pangeya
  entry_fav_count: 224
  entry_content: |
    allah'ın rekor denemesi.
...
- entry_name: |
  ...
  entry_channels: haber
- entry_name: |
    her hafasonu ölüdeniz'e gelen ingiliz
  entry_id:  87199216
...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    (bkz: <a class="b" href="/?q=murti%c3%a7i">murtiçi</a>)<br/><br/>ben murtiçili olsam hemen bi murtiçi kargo açarım..
  entry_channels: anket
- entry_name: |
    şenol güneş
  entry_id:  87209326
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    sorunlarının aşamayacağı büyüklüğe ulaştığını fark ettiği andır.<br/><br/>aşamayacaktır.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    çok konuşmaz, genelde dinlerim. sigaram yanıyor, <a class="b" href="/?q=%c5%9f%c3%bckr%c3%bc+erba%c5%9f">şükrü erbaş</a> dinliyorum. buyursunlar.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    şu anda çalan şarkı
  entry_id:  87196206
