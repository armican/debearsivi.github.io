...
- entry_name: |
    akp'nin bursa adayının skandal açıklamaları
  entry_id:  87207084
  entry_writer: dur birsey dicem
  entry_fav_count: 135
  entry_content: |
    niye şaşırıyorsunuz ki biat ettiği reisi daha dün ülkenin yarısını vatan haini ilan etti. belediye başkan adayı eksik kalmamak için yapıştırdı etiketi tabiki
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    sabah uyandığınızda sizi yataktan çıkaran şey
  entry_id:  87197462
  entry_writer: deniz kestanesi
  entry_fav_count: 97
  entry_content: |
    dolu bir idrar torbası.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 49
  entry_content: |
    sokaklardaki kedi ve köpek sayısında patlama olur.
...
- entry_name: |
  ...
  entry_fav_count: 43
  entry_content: |
    evren, özal, demirel ve sezer'in cumhurbaşkanlığı dönemlerini yaşadım. (korutürk zamani bebeydim) ben hiçbir devlet reisinin ağzından böyle vatandaşı ortadan ikiye ayıracak bir söyleme şahit olmadım. <br/>çok önemli ise bu belediyeler vs. aman verelim oyumuzu sana da senin olsun. ülkeyi bölme yeter. nasıl bir zamanda dünyaya geldiysek lanet olsun zamanına.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
    ingilizce öğretmenlerine tavsiyeler
  entry_id:  87217076
  entry_writer: bakken
  entry_fav_count: 32
  entry_content: |
    işe başlar başlamaz hamile kalmayın.<br/>(bkz: <a class="b" href="/?q=i%c5%9fe+ba%c5%9flar+ba%c5%9flamaz+hamile+kalan+ingilizce+hocas%c4%b1">işe başlar başlamaz hamile kalan ingilizce hocası</a>)
  entry_channels: anket,eğitim
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    devamlı olarak akp’li ve tayyipist yazar ve çaylaklardan, ana bacıya hakarete varıncaya kadar hakaret ve küfür mesajları alan bir atatürkçü olarak, kabul etmediğim durum.
  entry_channels: 
- entry_name: |
    şenol güneş
  entry_id:  87209326
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    anlatmadan anlaşılmayı beklemek.<br/><br/>(bkz: <a class="b" href="/?q=kendimden+biliyorum">kendimden biliyorum</a>)<br/><br/>oysa <a class="b" href="/?q=ben+ne+bileyim+senin+karanl%c4%b1kta+g%c3%b6z+k%c4%b1rpt%c4%b1%c4%9f%c4%b1n%c4%b1">ben ne bileyim senin karanlıkta göz kırptığını</a>...
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
    darbe olmasaydi turkiye dunyanin 7. ekonomisiydi
  entry_id:  87220501
  entry_writer: amkya
  entry_fav_count: 3
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    sözlükte görürdüm adını ama hiç dinlememiştim bugün dinledim ilk defa. lan dedim çocuk mu çıkarmışlar programa bu bıdık kim amk meğer uğur buymuş. bunu mu övüyordunuz lan sabahtan.
