...
- entry_name: |
  ...
  entry_fav_count: 45
  entry_content: |
    doğru hamle. şahsı akp havada kapar şimdi.
  entry_channels: siyaset,haber
- entry_name: |
    2020 grip salgını
  entry_id:  100548193
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    çekici mafyasının kurbanı olmuş zavallı kadın.<br/>cinayete tam teşebbüsten yargılanması gerek bu barbarların.<br/>milletten daha fazla haraç almak için resmen terör estiriyorlar sokaklarda.
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    milli takımımıza yusuf yazıcı'dan daha faydalı olacağını düşündüğüm futbolcu. her türlü golü atıyor.<br/><br/>not : fb
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    tek başına koskoca evde önümde bilgisayar, tabakta kemirilmiş bir elma , bir tarafta izlemediğim halde dıngırdayan tv ve elimde bir fincan çay...rahatım fena değil aslında. fakat aşağı katta oturan kalabalık ailenin muhtemelen oturma odalarındaki çocuklarının boğuşma seslerini duyunca, ta çocukluğumdan beri yaşayamadığım böyle cıvıl cıvıl bir aile ortamının hasreti düşüyor yüreğime. ne güzel diyorum ya.keşke kapılarını çalıp aranıza bu akşam beni de alındiyebilsem. bir gün olsun abimle ve kardeşlerimle akşamları şöyle kanepelerin tepesinde, harala gürele bir zıpırdaşmamız olamadı. sert bir adamdı , hep babamdan korkardık. şimdi bak, çok sakiniz baba kimse yok yanımızda. ses yok, seda yok açık tv den başka. mutlu musun baba? gurur duy evladınla..
  entry_channels: anket,ilişkiler
- entry_name: |
    loris karius
  entry_id:  100578062
  ...
  entry_fav_count: 5
  entry_content: |
    sayesinde alisson dünyanın en pahalı kalecisi oldu.<br/><br/>liverpool camiası artık nasıl cinnet haline büründüyse, kaleci için 63 milyon euro harcadı
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    başladığın işi bitir, yarım bırakma.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=overqualification">overqualification</a>) <br/><br/>sanirim kotu insanlardan korunuyorum da...<br/>cunku tanisir gibi bile oldugumda tiksindigim cok oldu. gereksiz drama ile ugrasacak halim ve zamanim da yok. oyle yasiyorum iste..
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    adam yine gol atamadı<br/><br/>sen nasıl bir reissin be tosuncuk 1 sen 2
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  100583760
  entry_writer: uncleiroh
  entry_fav_count: 0
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/5fe9W1gZPUs" title="https://youtu.be/5fe9W1gZPUs">hans zimmer - davy jones theme</a>
  entry_channels: anket,müzik
---
