...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    maçın başında kontrayı kesip benzia’yı çektiği pozisyonda sarıyı, son dakika soldada’ya şamar atıp kırmızıyı görmeyen torpilli oyuncu. terime baksan federasyon tukaka.
  entry_channels: spor
- entry_name: |
    loris karius
  entry_id:  82958641
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=m%c3%bcge+boz">müge boz</a>)
