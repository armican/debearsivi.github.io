...
- entry_name: |
  ...
  entry_fav_count: 49
  entry_content: |
    kendisine güvenen, egosuna teslim olmuş değil, onunla dost olmuş erkektir. erkekler, yapısı gereği ilişkilerde dominant olma eğilimi içindedirler. kendisinden daha zeki bir kadın görünce özgüven problemleri tetiklenir ve kendilerini geri çekerler. halbuki karşı tarafın zekasından faydalanarak kendilerini geliştirebilir, kendi zekası ile de karşısındaki insanı pekiştirebilir bir erkek. zaten bu erkeklerin birinci planı vücut kıvrımları değil, beyin kıvrımlarıdır. hormonlardan ziyade fikirlerden, tensel temastan ziyade fikirsel temastan hoşlanırlar. bakın cinselliği düşünmezler demiyorum. her erkek cinsellik düşünür; ancak kimisi bunu ön plana atarak ilişkinin derinliğini kaybeder, kimisi ise ikinci plana atarak ilişkinin derinliklerine iner.
...
- entry_name: |
    renault clio
  entry_id:  95756888
  entry_writer: bilardotopu
  entry_fav_count: 27
  entry_content: |
    avrupalıların gocunmadan şehir içi kullanıp bindiği araba, gayet güzel iş gören bir alet. ne var ki bizim türk asilzadeler bmw veya mercedes'ten aşşağısını araba kabul etmezler. neyse ki ucuz kredi ve likidite bolluğu dönemi kapandı ebelerinin örekesini görüyorlar ve geçmişte bu tarz araçlara burun kıvıran bir çok tanıdıgımı eleştirdikleri aracların 0'ını bile alamayacak hale geldiğini görmek güzel oluyor.<br/><br/>o yüksekten uçan egolarınız ve götleriniz birer birer yere çakılacak amk'larım. o üç kuruş maaşla 500 taksit krediyle bmw'lere abanma dönemi bitti.
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    sayesinde <a class="b" href="/?q=orospu+skyler">orospu skyler</a> yazan tüm gerizekalıları engellediğim film.
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    (bkz: <a class="b" href="/?q=selamaleyk%c3%bc%c3%bc%c3%bcm">selamaleyküüüm</a>) mümkünse bu sesin blokflütten çıktığını hayal edin.
  entry_channels: siyaset,anket
- entry_name: |
    3000 lirayı beğenmeyen yeni mezun diş hekimi
  entry_id:  95761906
  entry_writer: omuzdas
  entry_fav_count: 4
  entry_content: |
    3000 lira için çalışan diş hekiminden daha karlıdır
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    çok yazılmış ama bir daha yazayım (bkz: <a class="b" href="/?q=dead+poets+society">dead poets society</a>) özellikle amerikan edebiyatı dersinde whitman konusu işleniyorsa ve (bkz: <a class="b" href="/?q=oh+captain+my+captain">oh captain my captain</a>) okunmuşsa üzerine çok iyi gider. peki bir hayat dersi verir mi? bence verir. ama o dersi almak isteyen olur istemeyen de olur. şurası kesin ki iyi edebiyatın insan hayatına anlam katan bir derinliği var. filmden belki bin farklı anlam ve ders çıkarılabilir ama benim için ilk sırada bu var. <br/>bir de arthur miller'ın müthiş oyunu (bkz: <a class="b" href="/?q=the+crucible">the crucible</a>)nin başrolünü (bkz: <a class="b" href="/?q=daniel+day+lewis">daniel day lewis</a>)'in oynadığı sinema uyarlaması püritenlerin yaşam ve inanç sistemini örneklemesi açısından oldukça faydalıdır. gerçi hikayenin tamamı bir metafordur. aslında başka bir şeyi anlatır. her türden yobazliğın neden olduğu sosyal ve psikolojik sorunları ve toplumsal baskının bireyler üzerindeki etkisini çok başarılı bir şekilde gösterir. insanın gözüne sokar adeta.<br/>alice walker'ın (bkz: <a class="b" href="/?q=color+purple">color purple</a>) romanının usta yönetmen spielberg elinden çıkan efsanevi uyarlaması da olmazsa olmazlarımdan biridir. öyle ki kitabın mı yoksa romanın mi daha iyi olduğu konusunda hala kararsızım. bazı uyarlamalar sıkıcı ve yavan olabiliyor. ancak bu öyle değil. uyarlama senaryo ve oyunculuklar müthiş. gelelim filmin vereceği hayat dersine, tüm kötülük ve tüm iyilik diye birşey yoktur. karakterleri ve seçimleri büyük ölçüde koşullar belirler. bizim kontrolümüzde olmayan etkenlerden dolayı başımıza çok kötü şeyler gelse bile gerçek dostlar bize direnme gücü verir. walker'ın kızkardeşlik vurgusunu film de başarılı bir şekilde yansıtmış. kadın erkek herkese izletilmesi gerek kanımca.<br/>son olarak da (bkz: <a class="b" href="/?q=12+angry+man">12 angry man</a>) bir kez değil hayat boyunca düzenli aralıklarla izlenmesi gereken bir film. hiçbir şey göründüğü gibi değildir ve bakış açısı algılarımızı tamamen değiştirebilir. fikirler değişebilir asla körü körüne bağlanmak gerek.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    <a class="b" href="/?q=ios+13">ios 13</a>'ün hata düzeltmelerini içerecek olan sürüm. <br/>sonra 13.1.1 çıkar 13.2 çıkar 13.3, 13.4 derken bir bakmışız ios 14. <br/>hayat da böyle sayılardan ibaret değil mi işte.
  entry_channels: teknoloji
- entry_name: |
    natalee.007
  entry_id:  95762143
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=1+milyon+dolara+rus+ruleti+oynamak">1 milyon dolara rus ruleti oynamak</a>)
