...
- entry_name: |
    saadet partisi'nin penguenli reklam filmi
  entry_id:  86468513
  entry_writer: tarihci76
  entry_fav_count: 285
  entry_content: |
    saadet kıt imkanla chp den iyi partiden çok daha iyi kullanıyor sosyal medyayı.<br/>oturup biz daha iyisini yapalım diyeceğinize hala saadet dinci yok gezi parkı diye zırlıyorsunuz. <br/>bravo saadet. <br/>solcu tayfa siz eğitilemezsiniz.
...
- entry_name: |
  ...
  entry_fav_count: 86
  entry_content: |
    insanları kaderleri karşılaştırır,<br/>karakterleri yakınlaştırır,<br/>davranışları uzaklaştırır.
...
- entry_name: |
  ...
  entry_id:  86495955
  entry_writer: ambitchous
  entry_fav_count: 26
  entry_content: |
    yine boş beleş bi tip geldi kamyon arkası edebiyatı yapıyor kendince aptal aptal gülüp duruyor ve eminim çok kolay sorular çıkacak, önceden sanatsal elit bi yanı vardı şu yarışmanın herşeyin olduğu gibi bu programında içine ettiler
  entry_channels: tv
- entry_name: |
...
- entry_name: |
    cumartesi gecesi dışarı çıkmamak için bir neden
  entry_id:  86495966
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ne diyeceğimi bilemedim , rutine bağlamayacaksan gel.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    beşiktaşlı duruşu
  entry_id:  86493540
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    dönemin ingiliz başkanı lloyd george 1. dünya savaşından sonra şöyle demiştir.<br/><br/>“insanlık tarihi birkaç yüzyılda bir dahi yetiştirebiliyor. şu talihsizliğimize bakınız ki küçük asya’da çıktı. hem de bize karşı.. elden ne gelebilirdi?”<br/><br/>şimdi soruyorum, sadece türkiye'nin mi ?
