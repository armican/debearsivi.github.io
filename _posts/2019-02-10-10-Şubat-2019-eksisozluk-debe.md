...
- entry_name: |
    9 şubat 2019 fransa sarı yelek olayları
  entry_id:  86491159
  entry_writer: kayravekinyas
  entry_fav_count: 75
  entry_content: |
    gezi olayları sırasında gözlerini kaybedenleri, öldürülenleri unuttunuz herhalde. oranın polisi de buranın polisi de emre göre aşırı şiddetten kaçınmıyor. başka ülkelerdeki polis şiddetini gösterdiğinizde burada yaşananlar meşrulaşmıyor.
  entry_channels: 
- entry_name: |
    şenol güneş
  entry_id:  86478688
...
- entry_name: |
  ...
  entry_fav_count: 41
  entry_content: |
    şuan türkiye'nin son 17 yılını hızlandırılmış şekilde izliyoruz. teşekkürler atv.
  entry_channels: tv
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    100 yıl önce uefa kupasında adını bile hatırlamadığım bir israil takımı ve fener maçı dışında aldığı maçlar bir sayılsa keşke. <br/><br/>tanım: götümün efsanesi.
  entry_channels: spor
- entry_name: |
    ekşi itiraf
  entry_id:  86468016
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    çöken binadan anlaşıldığı üzere istanbul depremi ülkenin beka meselesi olmuş.<br/>düşünün binlerce bina var bu hâlde, devlet diye birşey kalmadığına göre kimin kime faydası olacak belli değil.
  entry_channels: siyaset,bilim,tarih,haber
- entry_name: |
    apex legends
  entry_id:  86472249
  entry_writer: ethoxyethanol
  entry_fav_count: 6
  entry_content: |
    az once bala gote tek basima 1. oldugum oyun.<br/><br/>takim arkadaslarim 7 bucuk dakika olmusken 3 grubun birbirine saldirmasiyla öldüler. ben durbunlu kullandigimdan geride kaldim ve ölmedim ama onlari da kurtaramadim. kactim. oyunun sonuna kadar catismalardan uzak durup son 3 ekip kaldi yazana kadar pustum. pusmak derken dusman beklemedim. sona kalan ekibe saldirip olecektim ama en azindan ikinci olayim dedim. sona kalan ekiplerden birinin oyuncusu oyun basindan bari ben diyeyim 10 siz diyin 20 kisi öldurdu. bu adam, diger ekibin son adamiyla catisip onu da öldürdü. etrafi sis yapip, cantasini lootluyordu. ben de o sirada kapsulumsu loot kutusu ile bir dag parcasinin arasinda sikisip kalmistim. tesadufen catisma onumde oldu ve sisin icini gorebiliyordum. catismadan dolayi adamin cani kalmamis sanirim cunku tek vurusta öldü ve sampiyonsun yazisi cikti. 25 dakika boyunca saklana saklana son adami vurarak 1. oldum. utaniyorum. boyle akici oyunu, hitman gibi oynadim. hitman'de bile daha cok etkilesim oluyor gerci.
  entry_channels: oyun
- entry_name: |
    4 sayfa borç yazıp hayatına son veren müteahhit
  entry_id:  86495203
  entry_writer: elista
  entry_fav_count: 5
  entry_content: |
    bir ölüm karşısında <a class="b" href="/?q=svihs">svihs</a> edebiyatı yapabilenler bu kadar duygusuz ve vicdansız nasıl oldu?<br/>küçükken anneniz babanız hiç mi sevmedi de bir intihara bile sevinir oldunuz?
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    sahneyi çekerken figüranlara ne olursa olsun <a class="b" href="/?q=asla+g%c3%bclmeyin">asla gülmeyin</a> demişler. <br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/kx_G2a2hL6U" title="https://youtu.be/kx_G2a2hL6U">sonuç</a>
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    clive cristian'dir. sıkıp metrobuse falan binmeyin vallahi sikerler.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    hazırlan boşanıyoruz.<br/><br/>nafaka is loading.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: anket,ekşi-sözlük
- entry_name: |
    sözlüğün kurtuluşu icin için çözüm önerileri
  entry_id:  86495645
  entry_writer: freshengineers
  entry_fav_count: 0
  entry_content: |
    tanım yapmayan yazarları bulup sınır dışı etmekle başlanabilir dediğim önerilerdir. yorumla karışık tanım yine bir nebze kabul edilebilir ancak sadece yorum hatta aşırı küfür gerçekten rahatsız edici ve amacının dışında. yazar alımlarında daha seçici olunabilir daha ince elenip sık dokunulabilir. başlık altında birbiriyle atışan yazarlar uyarı alabilir. birde şifre sistemi, yazar velev ki hastalık geçirdi veya bir şey oldu şifresini unuttu tekrar girmesi imkansız, bu da iyi yazarların kaybına yol açacaktır.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    insan yaşamı boyunca bir kez aşık olur, gerisi ya kaçıştır ya da aldanış demiş goethe.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    e-5 kenarında bekleyen emekçi duruşudur.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    umarım bu olayın suçluları bir an önce en ağır cezayı alır.milletce kanıksıyoruz bu tür olayları. gerçekten çok acı
