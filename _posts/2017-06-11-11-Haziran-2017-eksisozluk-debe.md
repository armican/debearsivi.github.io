...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    (bkz: <a class="b" href="/?q=5+bin+tl%27yi+zenginlik+sanan+fakir">5 bin tl'yi zenginlik sanan fakir</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    "ama arap da degildir" ile desteklenmesi gereken önerme.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    dinsizliğe saygısızlık yapan da uçurulacaksa bence problem olmayacak durum.
- entry_name: |
...
- entry_name: |
    edebiyatta en başarılı milliyet
  entry_id:  68750986
  entry_writer: kor nokta
  entry_fav_count: 6
  entry_content: |
    romanda ruslar'dır. şiirde türkler ve iranlılar, tiyatroda ingiliz ve yunanlar, deneme fıkra türünde fransızlar.<br/><br/>edit: türkler derken sadece anadolu türkler'i değil tabi ki.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    sadece toprak kazanarak tarihin en iyisi filan olamaz o kadar da uçmayın rafanlar çarpılırsınız :)
- entry_name: |
    the mummy
  entry_id:  68735232
  ...
  entry_fav_count: 2
  entry_content: |
    <a class="b" href="/?q=rotten+tomatoes">rotten tomatoes</a> ve <a class="b" href="/?q=metacritic">metacritic</a>'te yerin dibine sokulmuş film. beklenmiyor muydu? fragmanını seyrettikten sonra bile, "öfff bu ne biçim bir remake," demiştim. demek ki varmış bir şey. bana '99 yapımı <a class="b" href="/?q=the+mummy">the mummy</a> filmiyle gelin, botokslu tom cruise ile değil.
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=akordeon">akordeon</a>)<br/>neden bugüne kadar öğrenmedim bilmiyorum sanırım orta boy 40 bas olanlarının fiyatının bile oldukça yüksek olması buna bir sebepti, ikinci el olanlarını ise bir bilenle almak gerekiyor, körüğü, tuşları , klavyesi derken kazıklanmak an meselesi.. bu bileşenleri bir araya getiremediğim için de uktem içimde saklı hala..
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=uP6Ma33_ZkI" title="https://www.youtube.com/watch?v=uP6Ma33_ZkI">yeter ki...</a>
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    san marino vatandaşlığı geçip şu san marino milli takımında banko oynamak vardı ya. çok şanslı adamlar aslında bakmayın. türkiye'nin amatör kümelerinde kadroya girmekte zorlanacak adamlar almanya'ya, ispanya'ya karşı forma giyebiliyor... büyük lütuf yahu. tadını çıkarın ne diyim. isterseniz 10 tane yiyin diyecem de 10 tane yiyorsunuz zaten. <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
---
