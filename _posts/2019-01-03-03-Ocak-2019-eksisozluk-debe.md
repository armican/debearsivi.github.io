...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    banka vasıtasıyla sevgiliyle mesajlaşmak
  entry_id:  85042103
  entry_writer: trendline
  entry_fav_count: 52
  entry_content: |
    (bkz: <a class="b" href="/?q=ona+k%c3%bc%c3%a7%c3%bck+havaleler+yap%c4%b1n">ona küçük havaleler yapın</a>)
  entry_channels: ilişkiler
- entry_name: |
    burak yılmaz
  entry_id:  85023738
...
- entry_name: |
  ...
  entry_fav_count: 39
  entry_content: |
    maklubeciler artık sempati beslemiyormuş. oysaki tüm misyonumuz bu amcık ağızlıların bize sempati duymasıydı.<br/><br/>bir sonraki himmete kadar kapatalım kulübü.
...
- entry_name: |
    çin alışveriş sitelerini protesto ediyoruz
  entry_id:  85056293
  entry_writer: atticus fetch
  entry_fav_count: 13
  entry_content: |
    felak nas okuyarak destek verdiğim protesto.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    iki büklüm izlediğim görüntülere sahip acı olaydır. ben izlemeye dayanamazken o hayvanların çektiği acıyı tahmin edemiyorum. gözlerini gördüğümde ise içim gerçekten cızz etti. oysaki ben ışid'in kafa kesme videolarını gözümü kırpmadan yemek yiyerek izleyen insanım. bu hayvanların sessiz çığlıkları beni çok üzüyor. hiçbir şey yokmuş gibi durması ... bilemiyorum altan...
