...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    ahmet şık'ın ahmet altan hakkındaki konuşması
  entry_id:  85042120
  entry_writer: mdwho
  entry_fav_count: 10
  entry_content: |
    "prensipler söz konusuysa yanlış insanlar için doğru şeyler söyleyebilirsiniz." gibi harika bir cümle içeren konuşmadır.
  entry_channels: siyaset,haber
- entry_name: |
    ekşi itiraf
  entry_id:  85039076
...
- entry_name: |
    fethiye'deki tuhaf çocuklara yardım kampanyası
  entry_id:  85034741
  entry_writer: serbulentabi
  entry_fav_count: 8
  entry_content: |
    (bkz: <a class="b" href="/?q=tuhaf+cocuklar">tuhaf cocuklar</a>)
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    karşı tarafa boşluk bırakmamak, ara sıra yalnız kalmak veya başka şeyler yapmak isteyebileceğini düşünmemek..
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  85052045
  entry_writer: too tired to fight
  entry_fav_count: 0
  entry_content: |
    kızım her espri yapıp güldürdüğünde...<br/>aman da büyümüş de espri mi yaparmış diye ısırmak geliyor içimden de, yeltenince çok kötü kızıyor.
  entry_channels: anket
- entry_name: |
    çaylak onay listesi
  entry_id:  85046486
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    sadece yanınızda değil, sosyal bir ortamdayken bile sürekli telefonunu kurcalaması ve kendini soyutlaması. <br/><br/>onlar için 5 inç ekranda izleyecekleri diğer her şeyden daha önemlidir, bu yüzden fazla uğraşmayın ve telefonlarıyla aralarına girmeyin.
  entry_channels: anket,ilişkiler
---
