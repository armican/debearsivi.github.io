...
- entry_name: |
    erman toroğlu
  entry_id:  95651804
  entry_writer: yeter ki onu mutlu etsin
  entry_fav_count: 20
  entry_content: |
    az önce a-spor'da<br/>"şike olayı bende kapanmadı" <br/>"ben yaptım oldu yok öyle abi" cümlelerini kuran kişi. kalsın burda.
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    sanki bu ligde 1 aydır oynuyormuş gibi gs'li arkadaşların "çözüldü yaaa" diye hayıflandığı oyuncu.<br/><br/>adamın oyunu bu ligde çözüldüğünde abdülhamit tahttaydı beyler.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    ancak otorite bağımlısı kazmalar tarafından güzellenmesi muhtemel patron sıçmığı.<br/>şirketinin sahiplenilmesini <sup class="ab"><a title="(bkz: niye)" href="/?q=niye" data-query="niye">*</a></sup> de isteyen bu davarlar yeri geldiğinde insanlık dışı mesai saatlerini bu dediklerine yedirmeye çalışır. söylediği ailede sizden yana bir sıkıntı olunca da birden işveren ilişkisini hatırlayıp patrona dönüşür cibiliyetine döşediklerim.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    odamın penceresi üst üste 3-4 gün kapalı kalıyorsa geceleri, hoş geldin kış.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    fenerbahçeli adam gelmiş burada "artık yüksek sesle dillendirilmeli" yazıyor, başka biri de "geçen sene sizi şampiyon yaparken iyiydi" diye cevap veriyor. çalın çalın oynayın beyler. fatih terim istifa eder belki.<br/><br/>edit: hemen üstümdeki de birilerinin kendisine kedicik dediğini söyleyen zat da galatasaray'lı gibi davranan bir beşiktaşlı. son 5-6 entry'sine "bir galatasaraylı olarak" diye başlamış bir beşiktaşlı. bari önceki entrylerinizi silin be. fatih hocadan nasıl korkuyorsunuz siz öyle?<br/><br/>edit: çok özür dilerim. beşiktaşlı değilmiş bu vatandaş. kendi başkanına destek olmak için bir entry'de de beşiktaşlı gibi davranan bir fenerbahçeli imiş. ne acayip adamlar var yahu.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    valla şok ve a101’den yaparım da, bim hakikaten çok kötü.
  entry_channels: 
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    sözlük yazarları olarak mutsuz insanlarız
  entry_id:  95680833
  entry_writer: renksiz hayat
  entry_fav_count: 0
  entry_content: |
    kafayı hayatın her alanında kutuplaşmayla bozmuş olmanızdan ileri gelen durum. doğru tespittir. sosyal medya bu işin katalizörüdür.
  entry_channels: 
- entry_name: |
    mario lemina
  entry_id:  95682241
  ...
  entry_fav_count: 0
  entry_content: |
    bu malı transfer edecez diye linnes gibi adamı yaktılar. daha ne diyeyim...<br/><br/>donk buna bin basar. donk varken bu adama gerek falan yoktu... en büyük hata ise bu adamın transferinden ziyade bu adam için linnesi yakmak oldu.
  entry_channels: spor
- entry_name: |
    florin andone
  entry_id:  95681460
