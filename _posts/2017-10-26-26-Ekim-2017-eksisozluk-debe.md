...
- entry_name: |
    verdiler gazı en son silivri'yi boylattılar bana
  entry_id:  71629595
  entry_writer: donatien
  entry_fav_count: 191
  entry_content: |
    atilla taş'ın ilk kez yapıyor olmadığı açıklama. ayrıca kötü veya yanlış veya gereksiz bir şey de görmüyorum bunda. aksine tam tarzı biçimde eğlenceli. adam hapse girdi aylarca yattı anlamsız yere, hayatından gitti, halâ bunu bu kadar light biçimde dile getirebilecek kadar naif. daha ne olsun.<br/><br/>edt: ilk entry silinmiş.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 101
  entry_content: |
    mirkelam, yarın akşam siz ekşi sözlük yazarlarının sorularını cevaplayacak. gözünüz sol frame'de olsun.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 86
  entry_content: |
    beşiktaş'ın mağdur olmasıyla sonuçlanan bir olaya imza atmıştır.
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  71633817
  entry_writer: whatthefcuk
  entry_fav_count: 45
  entry_content: |
    maaşla hava atmaya çalışmak nasıl bir görgüsüzlük aman yarabbi. yeni türkiye bu olsa gerek. <br/>neyse efenim. fed başkanı seçimlerinden sonra 4ü göreceğine inanıyorum.
- entry_name: |
    kıyafetsiz insan bedeni uzayda patlar mı sorunsalı
  entry_id:  71638314
  entry_writer: imana geldik ama yoktunuz
  entry_fav_count: 40
  entry_content: |
    uzayda kıyafetsiz halde kalınca 2 dakika içinde insan bünyesinde ortaya çıkacak etmenleri şuradan <a rel="nofollow noopener" class="url" target="_blank" href="http://evrimagaci.org/photo/tr/kiyafetsiz-olarak-uzayda-2-dakika-dayanmak" title="http://evrimagaci.org/photo/tr/kiyafetsiz-olarak-uzayda-2-dakika-dayanmak">öğrenebiliriz.</a>
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 22
  entry_content: |
    yemin ederim zavallısınız.<br/><br/>tanım: zavallısınız.<br/><br/>not: ekşi'nin haline bak.
- entry_name: |
    çaylak onay listesi
  entry_id:  71628128
  ...
  entry_fav_count: 21
  entry_content: |
    tam 18 sene beklediğim liste. 1999'da aldığım çaylak hesabım onaylanmış. tam 18 yıl her gün sözlüğe girip okuyor ve sıramı kontrol ediyordum ama beklediğime değdi. en son anket, spor ve sikiş başlıklarındaki entrylerimi sildim ve çotank diye onaylandı. <br/>not: maaşlar için hesap numarası esprisi yapılmış, bu espri için 18 sene beklemiştim ama olsun. çok mutluyum :)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    amerika sağdan vuruyor almanya(ab) soldan. şimdi dünya liderini ve büyük resmi görebilen herkesi ringe davet ediyoruz.
- entry_name: |
...
- entry_name: |
    satranç oyununu bir vezirin icat ettiği gerçeği
  entry_id:  71638747
  entry_writer: taksi kime
  entry_fav_count: 14
  entry_content: |
    g..ten uydurulmuş bir elementtir.<br/>şah sensin, <br/>veziri yönlendiren de sensin.<br/>uzaklara kendin gitmezsin, veziri gönderirsin. <br/>veziri kaybetsen de oyun devam eder,<br/>akıllı hareket edersen vezirsiz de kazanabilirsin. <br/>oyunda yeni bir vezir, hatta birkaç vezir edinme şansın var. <br/>şahı kaybettiğin an kendi canını kaybettin, yani oyunu kaybettin.<br/>ayrıca, (bkz: <a class="b" href="/?q=her+konuyu+akp%27ye+ba%c4%9flamak">her konuyu akp'ye bağlamak</a>)
- entry_name: |
    aşık veysel
  entry_id:  71630807
  entry_writer: pul
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    karakter olarak değerli, fakat bu nafaka konusunda etik problemleri olan bir arkadaşım vardı. çok genç yaşta evlenmiş, bir nevi kocaya kaçmış. birlikte antalya'ya gidiyorlar. adam biraz varlıklı sayılır. bir süre sonra evlilikleri baya buhranlı hale gelmiş. boşanma davasının ardından nafaka hesaba işlemeye başlıyor. kız üniversiteye de başlamış, ardından okuldan sevgilisi olmuş. ailesinden gelen parayla kirasını ödüyor, eski eşinden gelen nafaka ile hayatının önemli bir kısmını idame ettirebiliyordu. mezun olduktan sonra da nafaka yatsın diye bir süre çalışmadı. bu manzarayı görünce nafakanın suistimale açık olduğunu anlamak mümkün. açıkçası aklı başında olan kimse böyle bir kumarı oynamaz. bunun "kadın karakteri" gibi ayrımcı bir ifadeyle de ilgisi yok. mağduru oynamanın prim yaptığı bir kültürde yaşıyoruz. bana her türlü güveni veren bir kadının, üç yıl sonra, ağzımdan kızgınlıkla çıkmış bir söz için intikam almak istemeyeceğinin garantisinini bulunmadığını düşünüyorum.
- entry_name: |
...
- entry_name: |
    istanbul valisine ulaşılamaması
  entry_id:  71644497
  entry_writer: kerkenezzz
  entry_fav_count: 6
  entry_content: |
    hacı biz yetkili birine ulaşamıyoruz daha sen diyosun vali bey.<br/>(bkz: <a class="b" href="/?q=kurumun+%c3%a7ayc%c4%b1s%c4%b1na+durumu+anlatmak">kurumun çaycısına durumu anlatmak</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    bazıları kısasa kısas olarak havaalanında gelen yolcuları köpeklerle arar ve ülkenin güçlü olduğunu iddaa eder<br/><br/>ama işin aslı öyle değildir <a class="b" href="/?q=25+ekim+2017+dolar">25 ekim 2017 dolar</a> kuru alman bankalarının türkiye'ye aktarılan fonların kısılacağı <a class="b" href="/?q=s%c3%b6ylenti">söylenti</a>leri ile bir anda 3,80 seviyelerini gördü<br/><br/>bakalım ülkemizden karşılık olarak nasıl bir hamle gelecek<br/>benin tavsiyem olarak tv ye çıkıp almanyaya <a class="b" href="/?q=sen+kimsin+ya">sen kimsin ya</a> diyerek gücümüzü göstereceğiz
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  71644998
  entry_writer: rahmet li amazan usta
  entry_fav_count: 2
  entry_content: |
    (bkz: <a class="b" href="/?q=ya+ne+olaca%c4%9f%c4%b1d%c4%b1">ya ne olacağıdı</a>) <br/><br/>severek dinlediğin bir şarkının sözlerini türkçe okuduğunda meğerse bambaşka şeylerden bahsettiğini farketmen ve büyünün bozulması hâlidir.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    senin yüzünden o favorilerin uçları sivri sivri gezdik yıllarca. sana türlü türlü sorular hazırladım mirkelam!
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    "ıt's necessary for me sometimes just to be alone and quiet and doing nothing."
- entry_name: |
    ekşi itiraf
  entry_id:  71628795
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bence 2018 cl ve uefa ihalesi için yapılmış bir hamle. bu sene ihaleye cıkacak olan uefa organizasyonlarını alma ihtimali var bein'in böylece bütün organizasyonları tek elde toplayacaklar. karasalda şifresiz yayın yapan bir kanal lazımdı bu iş için tivibu trt ile yapmıştı bu işi bunlar kendi kanallarını kurma yoluna gitmişler. uefa ara ara dinlendiriyor cl olması gereken degerin cok altında bütün maçların aynı saate oynanması seyirci oranını düşürüyor. sistemde köklü değişikliklere gidecekler beinde pastadan tr payını almak için hazırlıklara başlamış gibi.
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    efes kolay maç olmayacağının sinyalini ilk çeyrekte vermişken, fenerbahçe'nin ikinci çeyreğe iki 3'lükle başlayarak aynen bro dediği maç.
---
