...
- entry_name: |
    elektriğin element sayılmaması
  entry_id:  71637449
  entry_writer: eylul firtinasi
  entry_fav_count: 47
  entry_content: |
    (bkz: <a class="b" href="/?q=g%c3%b6t%c3%bcnden+element+uydurmak">götünden element uydurmak</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    gören de işkenceyle zorla içirdi sanacak. istemeyen içmesin amk bu mu derdiniz.
- entry_name: |
    ekşi itiraf
  entry_id:  71628795
