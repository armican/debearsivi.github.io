...
- entry_name: |
  ...
  entry_fav_count: 55
  entry_content: |
    bakır leğen ve bizimkiler,<br/>döner ile ayranın son yudumu,<br/>fatih marka siyah ve kırmızı kurşun kalemler,<br/>hugo ile tolga abi,<br/>çakal ile roadrunner,<br/>köpek ile horoz (foghorn leghorn),<br/>9999 ve takılamayan kaset.
  entry_channels: 
- entry_name: |
    serie a tarihinin en iyi 11'i
  entry_id:  105912406
  entry_writer: jr invincible
  entry_fav_count: 54
  entry_content: |
    kolarov yazmış adam. tarihin en iyi 11'ine yazmış.<br/><br/>diyecek başka sözüm yok.
  entry_channels: spor,anket
- entry_name: |
    tunç soyer'in 23 nisan'ı çocuklar gibi kutlaması
  entry_id:  105920151
  entry_writer: beyaztenlizenci
  entry_fav_count: 50
  entry_content: |
    babası türkiye de fetoyu ilk tutuklayan adamdır.<br/>(bkz: <a class="b" href="/?q=nurettin+soyer">nurettin soyer</a>) diğerleri gibi kandırılmamıştır. yolun açık olsun aydın insan
  entry_channels: siyaset,haber
- entry_name: |
    ercüment ovalı
  entry_id:  105888453
...
- entry_name: |
  ...
  entry_fav_count: 38
  entry_content: |
    başlığı altında hala binali yıldırım ismi sayıklanan ibb başkanı. <br/><br/>beyler hadi rte sevginizi bir şekilde anlıyorum da binali yıldırım nedir birader? hayır, cidden babanız ananız ne yedirdi de binali yıldırım fanı oldunuz?
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 28
  entry_content: |
    çok beylik çok klişe tespitleri olan bir abimiz. <br/><br/>türkiye'de bu kadar izlenmesi ve sevilmesi piyasanın halini ortaya koyuyor. korona ile ilgili hazırladığı video serisini zar zor izlerken birkaç kere yarısında kapatmaktan son anda döndüm. <br/><br/>kapitalizm karşıtı olmasını "asya'da bir dolara emeği sömürülen" falan gibi suyunun suyu çıkmış tespitlere dayandırması, koronanın bu düzeni yıkacağını iddia etmesi falan tam kahvehane muhabbeti kıvamındaydı.<br/><br/>tarihsel olarak baksa anlayacak ki o fabrikalar oraya kurulduğu için kişi başına düşen milli gelir onlarca katına çıkmış. ayakkabı kemirmekten, günde 200 kaloriyi bile bulamadığı ilkel tarım ya da avcı toplayıcı toplumdan sanayileşmeye geçmişler.<br/><br/>kapitalizm yüzünden düştükleri bir durum yok, o şartlara düşmemiş, yükselmiş o toplumlar. kapatsan o fabrikaları iyilik mi yapmış olacaksın? önceki şartlarından daha iyi şartlar olmasa gelir mi o işçiler taşradan şehire çalışmaya?<br/><br/>bugün çin'in kişi başına düşen milli geliri türkiye'ye yetişmiş. hala aynı eski ezberlerle kapitalizm eleştirisi yaptığını sanıyor amcam. he amca he, haklısın. koronadan sonra uzay komünü kurucaz. neden? çünkü ceketimizi yapan adamın yaşadığı şartları gördük, çok içimiz burkuldu.<br/><br/>ne diyorsun allasen ya? aç bir bak bakalım tarihe gelir adaletsizliği artmakta mı azalmakta mı şu an dünyada. bilmiyorsan söyleyeyim zirve yaptığı yıllar 20. yüzyıl başlarıydı. o zaman yıkılmadıysa kapitalizm artık siksen yıkılmaz. boş beleş popülizmi bırak, aktüel ekonomiyi takip et biraz.
  entry_channels: tv,edebiyat,teknoloji
- entry_name: |
    camilerin kapalı olup anıtkabir'in açık olması
  entry_id:  105929508
  entry_writer: halukdemir
  entry_fav_count: 28
  entry_content: |
    akp camileri kapattı...
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 26
  entry_content: |
    yurtdisinda yasadigim icin turkce karakerli acamiyorum basligi.<br/><br/>tayfun kulacoglu'nun ifsa ettigi teror orgutudur.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://mobile.twitter.com/TaylanKulacogIu/status/1253038243148431361" title="https://mobile.twitter.com/TaylanKulacogIu/status/1253038243148431361">https://mobile.twitter.com/…tus/1253038243148431361</a>
...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    red dead redemtion 2'yi getirecek oluşum (oha). yemin ederim şu dönemde ps alan aklını kaybetmiştir.
  entry_channels: oyun
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    iyilesen sayisi ilk kez gunluk 2bini gecti.
  entry_channels: sağlık,haber
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    oç cia ajanı yeşil pçleri çıldırtan durum. yanın ölün geberin oçları.
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    parasını vermişiz ki alınmış. alan kendi cebinden mi verdi parayı. senden benden alınan vergiyle alındı.<br/><br/>editleyim şunu da ekleyelim: o dönemde milletin buzdolabı doluydu. şimdi boş.<br/><br/>şu an için iyi diyenler bunu demek için şuradan buradan para alan tipler. tabi iyi olur sizin için. yıkama yağlama işi yapıyorsunuz.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    ben direk kim olursa olsun siktiri çekerim. arkadaşmış, sevgiliymiş, eşmiş, dostmuş dinlemem ve ağzıma geleni söylerim. çünkü bir insanı kırmak bu dünyada en çok korktuğum şeydir. iyi niyetimi suistimal eden insanlara ağzının payını vermek haktır. bu beni ahlaksız yada kötü birisi yapmaz çünkü kırılan kalp yerine gelmez hele ki karşındaki insana karşı iyi niyet besleyip insan gibi davrandıysan ve karşıdaki de bunu kullanıyorsa senin iyi niyetinden saflığından yararlanıyorsa çekin siktiri. neden susacakmışım ki çatır çatır konuşurum ben.<br/><br/>insanlara güvenmek mi bir daha hayır.
  entry_channels: anket,ilişkiler
- entry_name: |
    sigara içenlerin covid'e daha az yakalanması
  entry_id:  105927923
  entry_writer: puser
  entry_fav_count: 3
  entry_content: |
    fransa'da yapılan araştırmalar neticesinde ortaya konulan iddiadır.<br/><br/>not: habere inanıp sigara başlanılmaması, içenlerin de bir an önce bırakması temenni olunur.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://tr.euronews.com/2020/04/22/arast-rma-sigara-icenler-aras-nda-covid-19-a-yakalanma-oran-daha-az" title="https://tr.euronews.com/2020/04/22/arast-rma-sigara-icenler-aras-nda-covid-19-a-yakalanma-oran-daha-az">haberin linki</a><a rel="nofollow noopener" class="url" target="_blank" href="https://soz.lk/i/2r3qzv6v" title="https://soz.lk/i/2r3qzv6v">görsel</a><br/><br/>euronews haberinden alıntı:<br/>"fransa'da 480 kişi üzerinde yapılan bir araştırma, sigara içenlerin covid-19 salgınından daha az etkilendiğini ortaya çıkardı. fransa'nın başkenti paris'in pitie salpetriere hastanesi'nde yapılan araştırma sigarada bulunan nikotinin virüsle mücadelede etkili olduğunu işaret etti.<br/><br/>academie des sciences'ta yayınlanan araştırma, covid-19 testi pozitif çıkmış ve hastanede tedavi gören 350 kişi ile tedavisi hastane dışında devam eden 130 vaka üzerinde yapıldı. araştırmada bu kişilerin sadece yüzde 5'inin sigara içtiği tespit edildi.<br/><br/>nikotinin covid-19'a karşı koruyucu bir yanı olduğuna dair tezler amerika birleşik devletleri ve çin'de geçen aylarda ileri sürülmüştü. martta çinli araştırmacıların yaptığı bir çalışma new england journal of medicine'de yayınlandı. bin kişi üzerinde yapılan çalışma sigara içenlerin sadece 5'te birinin salgına yakalandığını gösterdi."
  entry_channels: sağlık,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    ben hep gözlükle kapattığım için beni ilgilendirmeyen durum.
