...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    deli dolu bi hayat yaşamıştır.<br/>sonunda kafasına sıkacağını bilse ne yapardı acaba.<br/>dünyayı gelmiş geçmiş en çok etkileyen adamıdır gününüzde bile hala hitlerin etkilerini hissediyoruz.<br/><br/>kendisi faşist değildir kankası faşisttir<br/>kendisi nasyonal sosyalisttir yani ırkçıdır.
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    çin restoranı için isim önerileri
  entry_id:  106340477
...
- entry_name: |
    ingilizce dertli türkü olmaması
  entry_id:  106341387
  entry_writer: frkr
  entry_fav_count: 3
  entry_content: |
    oy dağlar, ölem ben, anam anam... tarzı yanık türkülerin olmaması durumu.<br/><br/><a class="b" href="/?q=ba%c4%9flama">bağlama</a> olmamasına bağlıyorum ben. o gitardan yanık ses çıkmayınca demek ki..
  entry_channels: 
- entry_name: |
    1 mayıs 2020 emek ve dayanışma günü
  entry_id:  106340082
  entry_writer: ruhsuz korsakof
  entry_fav_count: 3
  entry_content: |
    işçi sıfının mücadele günü olan 1 mayıs'ın tam adı " 1 mayıs birlik, mücadele ve dayanışma" günüdür. 2008 yılında mecliste bir dizi şarlatan bu ismi koydu diye bir asrı aşkındır mücadele üzerinden algıladığımız bu günü tipik bir bahar bayramı gibi anlatılmasına, adlandırılmasına izin vermeyelim. 1 mayıs'ın ismi üzerinden bilinç çarpıklığı yaratanlar 8 mart emekçi kadınlar gününün mücadele içeriğini silip bir " karanfil, gül verme gününe" çevirenler ile aynı kişilerdir. bu kişiler emeğe, mücadele edene, örgütlenene düşman puşt zulasından yemlenip, gafil ile aşık atanlardır.
  entry_channels: siyaset,haber
- entry_name: |
    kadıköy'ü akp alsa avm yapacağı yerler
  entry_id:  106341256
  entry_writer: pocoyo
  entry_fav_count: 2
  entry_content: |
    (bkz: <a class="b" href="/?q=barlar+soka%c4%9f%c4%b1">barlar sokağı</a>)<br/><br/>bir <a class="b" href="/?q=demir%c3%b6ren+avm">demirören avm</a> yakışır.
  entry_channels: siyaset
- entry_name: |
    burak erdamar
  entry_id:  106334354
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    verecek cevabım yoksa son gönderiye iki kez dokunup kalp koyuyorum. niye görüp cevap yazmıyorsun kuzum?<br/>kalpsiz insan işidir.
...
- entry_name: |
    coca cola şekersiz'i pazarda tutundurma çabası
  entry_id:  106341839
  entry_writer: makinistfanlari
  entry_fav_count: 1
  entry_content: |
    diyabetliler bi bok yemesin içmesin demi aq.
...
- entry_name: |
    ercüment çözer'in covid-19 aşısını bulması
  entry_id:  106341800
  entry_writer: bigkahuna
  entry_fav_count: 0
  entry_content: |
    başlığı okumadan yorum yapanlar gerçekten komik oluyor:)<br/>tanım: yaman şakacı bir delikanlı ürünü.
  entry_channels: tv
- entry_name: |
    bir de benden dinle
  entry_id:  106341921
  ...
  entry_fav_count: 0
  entry_content: |
    üçüncüsü <a class="b" href="/?q=onur+ataman">onur ataman</a>’ın açılışı ile <a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/fjwHeFeXXFU" title="https://youtu.be/fjwHeFeXXFU">başladı</a>, davulların yerine gitarlar konuşuyor bu sefer. <br/><br/>ne diyeceğimi bilemiyorum, tıpkı ilk ikisinde olduğu gibi bu sefer de alemin en iyi müzisyenleri hayal güçlerinin kapılarını bize açıyor. erdal’ın ve emek veren bitirme tezi kıvamında emek veren bütün müzisyenlerin önünde saygıyla eğiliyorum.
