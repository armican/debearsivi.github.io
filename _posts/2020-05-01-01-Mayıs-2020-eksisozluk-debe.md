...
- entry_name: |
    anime tarihinin en güçlü karakteri
  entry_id:  106320386
  entry_writer: stuartcain
  entry_fav_count: 38
  entry_content: |
    tabi ki one punch saitamasıyanık
...
- entry_name: |
  ...
  entry_channels: sağlık,haber
- entry_name: |
    arap mitolojisine inanıp 30 gün aç gezen kitle
  entry_id:  106337188
  entry_writer: peyroux
  entry_fav_count: 34
  entry_content: |
    akp'ye inanıp yıllardır aç gezen cahil kitlenin yanında esamesi okunmaz. götünde donu yok kanal istanbul diyor ahahahahhahh..
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    bence nötrler.<br/>seviştikleri sürece, zeki ya da aptal olmasını umursamıyorlar.
  entry_channels: ilişkiler
- entry_name: |
    ceyda karan'ın göğüs dekoltesi
  entry_id:  106338320
