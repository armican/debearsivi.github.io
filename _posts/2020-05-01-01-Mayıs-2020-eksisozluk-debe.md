...
- entry_name: |
  ...
  entry_fav_count: 97
  entry_content: |
    adam insanların 30 gün boş yere aç gezmesini anlamadığını söylemiş. hemen bir tatlı su müslümanı gelip olayı siyasete ve muhaliflere bağlamış amk. bayılıyorum şu günah çıkarma yöntemine. "mevcut yönetim sizin gibiler yüzünden var!!!"<br/><br/>hayır bedevi kardeş o iş öyle değil. mevcut yönetim senin gibi mitolojik inanışları olanlar yüzünden var. eğer bu inanışa sahip hiç kimse olmasaydı mevcut yönetim de olmazdı. bal gibi de biliyorsun bunu. onları alt edecek kadar kurnaz olmayanlara suç atma boşuna. bunlarla uğraşacağına siktir git sebebini bile bilmeden aç bıraktığın vücudunu doyur şimdi.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    istanbul kart varsa yazmış biri, lan ben bursada yaşamıyorum, bursa kart bile var cüzdanımda. istanbul var, izmir var. fakir olduğumu buradan mı anladın çapsız?
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    boşanma avukatı olarak bekliyorum
...
- entry_name: |
    mansur yavaş'ın parti kurması
  entry_id:  106337132
  entry_writer: tembeliks
  entry_fav_count: 4
  entry_content: |
    başlığı açan ve katkıda bulunanların algı yönetiminde birer piyon olduğunu düşünüyorum.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    bugün üzülerek vefatını öğrendiğim dünyalar iyisi bir insandı.tüm sağlık camiasının başı sağolsun.
  entry_channels: sağlık
- entry_name: |
    adolf hitler
  entry_id:  106333217
  entry_writer: eksimsi tat
  entry_fav_count: 3
  entry_content: |
    ona rahmet okutturacak çağın diktatörlerine de yer açsın cehennemde.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    çekme oğlum beğenmezler beni. atalım oltamızı ama haydi rast gele.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    aman ha baskan korkutma bizi, acil sifalar dilerim.<br/><br/>en yakin zamanda sagligina kavusmasini bekledigimiz baskandir.
  entry_channels: spor
- entry_name: |
  ...
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    kardeşi ve annesine şiddet uygulayan şahıs serbest
  entry_id:  106338385
  entry_writer: simderun
  entry_fav_count: 0
  entry_content: |
    "umarım, o devranın dönmesi olayı en kısa zamanda gerçekleşir." dediğim bir saçmalık. ama bir dakika ya, burası berlin değil ki!
  entry_channels: 
- entry_name: |
