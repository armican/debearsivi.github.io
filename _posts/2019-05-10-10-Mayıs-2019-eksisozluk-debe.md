...
- entry_name: |
    adaletinizin terazisini sileyim
  entry_id:  89861724
  entry_writer: kalemi kilicindan keskin olan adam
  entry_fav_count: 805
  entry_content: |
    seni müjdeleyen leyleklerin yol haritasını sikeyim diyor ve kendisine cesaret dersi veriyorum.<br/><br/>(bkz: <a class="b" href="/?q=bak+%c5%9furadan+siktir+git">bak şuradan siktir git</a>)
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
    2030'da türkiye dünya'nın 5. büyük ekonomisi
  entry_id:  89872363
  entry_writer: otostopcu musunuz ne ayak lan
  entry_fav_count: 337
  entry_content: |
    bu sayılar neden her geçen sene artıyo aq? 2008 de 2014 diyolardı sonra 2023 yaptılar şimdi 2030 nasipse 2100 e kadar yolu var.<br/><br/>edit: bi yazar arkadaş yeşillendirdi bi de arada 2071 varmış lol
...
- entry_name: |
    20 tl para uzatan akp'liye 5 tl'si sahte demek
  entry_id:  89890134
  entry_writer: cemu
  entry_fav_count: 95
  entry_content: |
    az önce berberde denediğim olaydır. traş ederken beni ikna etmeye çalışan, sandıklarda oy çalınmış, organize suç işlenmiş, geçerli oyları geçersiz yapmışlar, sandık kurul başkanları kamudan olmayan çete üyeleriyle doldurulmuş diyen berber abimin anlattıklarını dinledikten sonra dedim ki madem öyle neden ilçe belediyesi veya belediye meclisinde yapmamışlar diye sorduğumda abi o kadarına cüret edememişlerdir, belli olmasın diyedir falan gibi bir şeyler dedi.<br/><br/>traş bittiğinde eline sağlık diyip 50 tl uzattım. verdiği para üstünden 20 tl' yi şöyle havaya kaldırdım, sağa sola çevirdim sonra abi bu 20 tl nin 5 tl sinin sahte olduğunu hissediyorum, hiçbir şey olmasa bile bir şeyler olabilir yine de bunu değiştirir misin? dediğimde suratının aldığı ifade harikaydı ve akabinde parayı değiştirmesiyle olur böyle şeyler takma kafana abi her şey çok güzel olacak diyip evimin yolunu tuttum.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 56
  entry_content: |
    olm biz bolu tüneli çatladığında içini betonla dolduran bir milletiz. nükleer reaktörde süpürgeyle uranyum silmezlerse ben birşey bilmiyorum, karikatür gibi ülke.<br/><br/>abi siyasal islamcılara tavuk bile emanet edilmez ama adamlar nükleer reaktör inşa ediyor... zaten başından kopmuş iş, temel çatlamış falan bunlara gelene kadar ooooo
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    ali palabıyık’la beraber türkiye’nin açık ara en başarılı hakemidir... operasyonda.
  entry_channels: spor
- entry_name: |
    it chapter two
  entry_id:  89889420
  entry_writer: idiotequa
  entry_fav_count: 5
  entry_content: |
    çıplak ve boş boş gülen yaşlılardan korktuğum kadar başka hiçbir şeyden korkmadığımı öğretmişti <a class="b" href="/?q=hereditary">hereditary</a> bana. korku-iğrenme karışık tarif edemeyeceğim duygular yaşatmıştı. it chapter two fragmanına bakılırsa yine benzer duygular yaşayacağım galiba ama gelsin heyecanlandırdı.
...
- entry_name: |
  ...
  entry_channels: haber
- entry_name: |
    taze fasulye ile oluşan kırılma noktası
  entry_id:  89888906
  entry_writer: osgiliathburns
  entry_fav_count: 3
  entry_content: |
    yerken niye sormuyosun lan sevgiline it herif. yemiş bitirmiş sen niye yemedin diyo. bok ye.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    bu başlık dün açılmıştı zaten.<br/><br/>(bkz: <a class="b" href="/?q=%c3%bcvey+babas%c4%b1n%c4%b1n+istismar%c4%b1na+u%c4%9frayan+%c3%a7ocuk">üvey babasının istismarına uğrayan çocuk</a>)
  entry_channels: haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    kurnazlık yapmaya çalışan alışveriş sitesi.<br/><br/>indirim deyip, kargo ücretlerini alıcıdan saklayıp, müşteriye çaktırmadan kazık atmaya çalışan alışveriş sitesi.<br/><br/>neden müşteri kargoya ne kadar verdiğini göremiyor. bu alemde sadece siz mi akıllısınız?
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    hisleri azalttığı bir gerçek. en fazla sinirler o kısımda ve çocuklara sorulmadan bedenine müdahele edilmesi çok yanlış. çocuğunuz ilerde isterse yaptırsın. illa küçük yaşta olma zorunluluğu da yok, 18 yaş sınırı getirilmeli.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    götüm kaşınıyor. tekrar istiyorum sanırım. benim sebebim, anlaşılma isteği ve bir şeyler paylaşırken keyifli vakit geçirebilecek nihai kadına ulaşma isteği olsa gerek. <br/><br/>bilemiyorum altan.
  entry_channels: anket,ilişkiler
- entry_name: |
