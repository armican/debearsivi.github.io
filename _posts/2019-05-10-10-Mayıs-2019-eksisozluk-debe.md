...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    dövizi saldılar artık. aynı anda enflasyon, döviz ve faizle mücadele edilmez. yavaş yavaş öğrenecekler ama halkın canı çok ama çok yanacak.<br/><br/>faiz 18'den 26'ya hopladı yine durmuyor.
  entry_channels: 
- entry_name: |
    amazon.com.tr
  entry_id:  89886220
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    arabada baltanın ne işi var lan. bunlar yakında arbalet falanda saklar bagajda.
  entry_channels: 
- entry_name: |
    serkan çınar
  entry_id:  89876317
