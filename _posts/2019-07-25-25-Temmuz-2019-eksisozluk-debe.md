...
- entry_name: |
  ...
  entry_fav_count: 207
  entry_content: |
    ben erkek olarak erkeklerin tayt giymesini istemiyorum beni saymayın lütfen.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    çalışma bakanlığı'nın sadece tabeladan ibaret olduğu ve çalışan hakkının zerre kadar değeri ve önemi olmayan bir ülkenin standartları söz konusu olduğunda gayet normal ve olağan şeylerden biridir.
  entry_channels: siyaset,haber,ekonomi
- entry_name: |
    türkiye'deki waffle ın belçika'dakinden iyi olması
  entry_id:  93030115
  entry_writer: maydanozsevmem
  entry_fav_count: 2
  entry_content: |
    waffle olarak adlandırılan yiyeceğin aslında sadece hamur işine dendiğini bilmeyen yazar beyanı. belçika’da yapılan ve satılan waffle temelde sadedir ve istendiği takdirde üstüne çeşitli meyve ve soslar eklenir (bu meyve, sos ve envai çeşit “topping”le bir bakıma süslenen ve hatta sade olarak da dçeşitli formlarda hazırlanan waffle da ülke ve bölgelere göre farklılık gösterir-hepsinin kendine has waffle türü vardır), türkiye’de ise waffle olarak satılan şey düz/sade waffle değil, meyveli ve soslu waffledır. karşılaştırılacaklarsa ya sade waffle (hamuru) ya da meyveli ve soslu waffle olarak karşılaştırılmalıdır, yine de her iki durumda da (bence) belçika alır zaten.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    emek istiyor, bazen sadece emek de yetmiyor, çok daha fazlası gerekiyor. ha, ayda yılda bir ekstra sürprizler de olmuyor değil, ama biliyorsunuz ki istisnalar...<br/><br/>işte sırf bu yüzden bazen, insan olmak yerine serengeti'de erkek bir aslan ya da ne bileyim en kötü ihtimalle, bir tavşan bile olsam daha mı iyi olurdu acaba diye düşünmeden edemiyorum. <br/><br/>ömrümüzün önemli bir kısmını seks peşinde koşarak geçirmek, erkeklere oynanan büyük bir oyun değildir de nedir a dostlar?
  entry_channels: ilişkiler
- entry_name: |
    rutger hauer
  entry_id:  93029030
  ...
  entry_fav_count: 2
  entry_content: |
    75 yaşında bu dünyadan göçmüştür.<br/><br/>(bkz: <a class="b" href="/?q=rip">rip</a>)
  entry_channels: tv,sinema
- entry_name: |
    kaftancıoğlu'nun pkk filmcilerine destek vermesi
  entry_id:  93008162
  entry_writer: cirbocee
  entry_fav_count: 2
  entry_content: |
    ilginç olan <a rel="nofollow noopener" class="url" target="_blank" href="https://eksiup.com/p/s560483mif5h" title="https://eksiup.com/p/s560483mif5h">hayallerde yaşıyor bazı ipneler</a> haritasında kürtten çok türk yaşıyor... batı azerbaycan eyaleti %90 türk’tür. suriye ve ırak kuzeyinde 5 milyon türkmen nüfusu vardır. bizim doğu ve güneydoğu’da da türk nüfusu kürtlerle hemen hemen aynıdır.
  entry_channels: siyaset,ilişkiler,tv,sinema,haber
- entry_name: |
