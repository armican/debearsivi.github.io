...
- entry_name: |
  ...
  entry_fav_count: 180
  entry_content: |
    asla bir <a class="b" href="/?q=queue">queue</a> değildir.<br/>q'dan sonrasına gerek yoktur. <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup><br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://memeguy.com/photo/206522/-queue" title="https://memeguy.com/photo/206522/-queue">bonus</a>
...
- entry_name: |
  ...
  entry_fav_count: 37
  entry_content: |
    amcamız 10bin yazmaya çalışırken 10milyon yazmış.<br/>malın teki de gelip başlık açmış.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 25
  entry_content: |
    millet bağımlısı olmuş resmen. göremeyince yoksunluk çekip aranıyor.
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    kazara kendi evladını ezen kadın sürücü
  entry_id:  93015942
  entry_writer: kurumsal serzenis
  entry_fav_count: 16
  entry_content: |
    allah rahmet eylesin. çok üzücü.<br/>herkesin başına debriyaja basmadan viteste araç çalıştırma durumu gelebilir. <br/>öndeki veya arkadaki araca veya duvara vurursunuz.<br/><br/>ama bu örnekte çocuğun araç dışında tek başına olmasını anlamıyorum ben.<br/>2.5 yaşında çocuğu gözünün önünden ayırmaman gerekir. hele yol üzerinde veya araçların sıklıkla bulunduğu yerlerde (otopark gibi).<br/><br/>herkes aracı viteste bırakıp çalıştırmaya odaklanmış ama asıl hata çocuğu başıboş bırakmak. araç kullanıyorsan ilk önce çocuğunu oturtursun sonra sen oturursun.<br/>plan neydi ?, aracı çalıştırayım sonra çocuk binsin miydi ? cidden anlamak çok güç.
  entry_channels: haber
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    en sevilen mitolojik karakter
  entry_id:  92999685
  entry_writer: eksiayran
  entry_fav_count: 10
  entry_content: |
    (bkz: <a class="b" href="/?q=dionysos">dionysos</a>)<br/>kısacası, doğa tanrısı olan dionysos, coşkunun, mutluluğun ve<br/>yaşama sevincinin tanrısıdır. üzümle simgelenen şarabın ve şarabın yarattığı sarhoşluğun, taşkınlığın ve sınır tanımazlığın da tanrısıdır.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    anlaşılamamak. anlaşılmak için de defalarca tekrara düşmek, kendini yeniden anlatmak.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    başlığı açan yazar çok eleştirilmiş ama iki yönden de bakmak lazım şimdi. kızarmış hamur işi pek çok tatlı malzeme ile nefis gidebiliyor. dolayısıyla hakikaten de dominos stayla doldurulan wafflelarda çok güzel kombinasyonlar yakalanabiliyor ki bu sade hamur yemekten daha keyifli kanımca. neticede waffle hamurunda kullanılan malzeme ve teknik çok da komplike bir şey değil. waffle bir kruvasan, sushi ne bileyim bir noodle değil, bir pizza değil. <br/><br/>bu arada türkiyedeki wafflelar da sadece o dürüm yapılan çiçek wafflelardan sanılmasın. artık pek çok yerde çıtır waffle da satılmakta ki denemeyene şiddetle öneririm.
  entry_channels: 
- entry_name: |
    kanser hastasına yardım kampanyası
  entry_id:  92995937
  entry_writer: gigaman
  entry_fav_count: 1
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    efes özel seri<br/><br/>çifte kavrulmuş
  entry_channels: anket,yeme-içme
- entry_name: |
    çaylaklardan mesaj bekleyen yazarlar veritabanı
  entry_id:  93030970
  entry_writer: thementor1
  entry_fav_count: 0
  entry_content: |
    kanada’ya eğitim yoluyla gidenler varsa onlar yeşillendirebilir dediğim veritabanı.
