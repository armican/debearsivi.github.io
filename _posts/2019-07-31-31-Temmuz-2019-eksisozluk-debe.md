...
- entry_name: |
    bahçeliyi eleştirdi diye dağa kaldırılan adam
  entry_id:  93247274
  entry_writer: dunya cizgi cizgimiymis neymis
  entry_fav_count: 416
  entry_content: |
    bu kadar ifade özgürlüğü, demokrasi bünyeme fazla geldi. ileri demokrasi maşallah. dünyaya bir faydanız yok, zararınız olmasın bari. lan bunlardan daha zeki maymunlar var ya kafayı yiycem amk.
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    markette alışveriş yapan kadının üzerine boşalmak
  entry_id:  93268614
  entry_writer: lendunhalger
  entry_fav_count: 270
  entry_content: |
    göte teflon tava bağlayıp çıkmak lazım evden.
  entry_channels: haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 22
  entry_content: |
    bayern, real ve tottenham’in oldugu 4lu turnuvaya katilmayi hangi kamil akil etti?
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    belki bir kaç yüz dışında özlenecek bir şeyi yoktur.<br/><br/>neyini özleyeceğim?<br/>karnıyarık demiş!<br/>doğrudur patlıcan hayvanıyla kıyma ağacı sadece çorumda bulunuyor.
