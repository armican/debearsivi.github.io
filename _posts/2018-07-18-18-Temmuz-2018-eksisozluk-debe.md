...
- entry_name: |
  ...
  entry_channels: siyaset
- entry_name: |
    hoşlanılan kızın 33. dereceden mason çıkması
  entry_id:  79252684
  entry_writer: meksika post
  entry_fav_count: 240
  entry_content: |
    33. dereceden çıktıysa o seni bulmuştur. sevdiklerinle vedalaş
  entry_channels: siyaset,anket,ilişkiler,tarih
- entry_name: |
    norveç'in ıssız bir köyünde yaşamak
  entry_id:  79252468
  entry_writer: xeuszt
  entry_fav_count: 213
  entry_content: |
    norvec'te domates yetistirebilirsen peygamberligini ilan et kardes, hic durma. <br/><br/>tanim; hayalperest birinin aslinda cok mantiksiz olan hayali. kendisine cografya calismasini tavsiye ediyorum.
...
- entry_name: |
  ...
  entry_fav_count: 23
  entry_content: |
    (bkz: <a class="b" href="/?q=bir+%c5%9feyi+ilk+fark+eden+oldu%c4%9funu+sanmak">bir şeyi ilk fark eden olduğunu sanmak</a>)<br/><br/>edit: bazı arkadaşlar makara yapanlara ayar vermeye çalışmış. bir şeyi bilenlerden olduğu için böbürlenmek derdinde değil kimse. ama araştırılmaması, okunmaması sıkıntı. halbuki bu, daha önce yazılmış mı diye araştırma yapmak en fazla otuz saniye alır.<br/><br/>herkes yeni öğrendiği şeyi gelip buraya yumurtlasa ne olacak? hiçbir şey... sadece komik olacak ve gereksiz bilgiler, alaylar, ayarlar, ayara ayarlar artmış olacak. al sana gevezelik, vakit kaybı!
  entry_channels: 
- entry_name: |
    her inançlı insanın bir başka dinin kafiri olması
  entry_id:  79262216
  entry_writer: corsan
  entry_fav_count: 22
  entry_content: |
    bütün dinlere inanarak çürüttüğüm varsayım,<br/><br/>şalom amına istavroz çaktıklarım..
  entry_channels: siyaset
- entry_name: |
    ekşi itiraf
  entry_id:  79249944
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    türk erkeklerinin yüzde 90'ı falan böyle olduğunu düşünüyor lan vallahi billahi yazık. ben beyaz kulaklık taktığı için havalı gözüktüğünü sanan insan gördüm amk yerinde. umut harbiden zehirdir.<br/><br/>not: erkeğim.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    daha hos olan hatunlarin kendisinden cirkin olana surekli "ay burnum soyle" "ay saclarim cirkin" gibi seyler soyleyerek ego tatmin etmeleri. bu arada asil karsisindakinin burnu oyledir ve saci cirkindir.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    dedeleri 'kağıt para insanlık tarihinin en büyük dolandırıcılığıdır' diyen gerici yobazların dolandırıcılık olarak gördüğü devrimdir. <br/>(bkz: <a class="b" href="/?q=alemin+kral%c4%b1+geliyor">alemin kralı geliyor</a>)
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    <a class="b" href="/?q=jamal+bir+sevgi+faresi">jamal bir sevgi faresi</a>'nin çizeridir. mizah dergilerinin en tatlı yazar ve çizerlerinden biri. karikatürü ve mizahı facebook'tan öğrenen beyinsizler bilmez ki. bu kodumun sosyal medyası yüzünden dergiler kapandı. izinsiz bir şekilde haldır huldur paylaştılar karikatürleri, millet dergi almadı.<br/><br/>emrah hocam buyrun gelin, başımızın tacısınız.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    <a class="b" href="/?q=suat%27%c4%b1n+mektubu">suat'ın mektubu</a>'nu okuyabilmek ve olayın öncesini anlayabilmek için: <a class="b" href="/?q=huzur">huzur</a>.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    dinine düşman din adamlarının düzenli olarak yabancı örgütlerden para yemeleridir. bu rezillik yüz yıldır böyledir. <br/><br/>kuran’ın türkçesi de meal olarak sorunludur. ingilizce veya fransızca okursanız apaçık yazan bazı şeylerin türkçe mealde gizlendiğini, geçiştirildiğini görürsünüz. bu durum yanlış çeviriyle açıklanamaz, bu bildiğiniz dine ihanettir.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    çaylak 2-3 hatun düşürürüm dedim ama bunların akıllısı zekisi yok ki, küfürbaz bu çaylaklar. hiç şaşırtmıyorlar beni kızlar bile küfürbaz
  entry_channels: anket,ekşi-sözlük
- entry_name: |
    bedelli askerin 25 gün askerlik yapması
  entry_id:  79266339
  entry_writer: sick city
  entry_fav_count: 0
  entry_content: |
    99 yılında çıkarılan bedelli gibin bişeydir.
  entry_channels: siyaset
- entry_name: |
    25 günlük askerlik için gerekli izin
  entry_id:  79279164
  entry_writer: 29 haziran
  entry_fav_count: 0
  entry_content: |
    patron olup, kanundan haberi olmayan insanlar içeren başlık.<br/><br/>hadi bakalım askere gidiyorum diyeni koy kapıya, hadi bakalım döndüm diyeni alma işe.
  entry_channels: 
---
