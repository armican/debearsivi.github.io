...
- entry_name: |
  ...
  entry_fav_count: 53
  entry_content: |
    kullanmayı sevmediğim döngüdür.<br/><br/>kodu döngü sayısı kadar alt alta kopyalayıp çalıştırmak daha samimi geliyor.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    amk başlığında onlarca aynı semti yazan var <br/>maden amacınız bira içmek, sohbet ermek entry yazmak yerine birbirinize mesaj atın buluşun.<br/><br/>karı kız düşmez boşuna sohbet bilmem ne havalarına girmeyin.<br/>burdan dişi bir birey kalkıp da size mesaj atacak değil amk neyin kafasındasınız.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    myers briggs’le ilgileniyorsanız humanmetrics’teki testin çok daha başarılı sonuç verdiği aklınızda olsun.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="http://www.humanmetrics.com/cgi-win/jtypes2.asp">http://www.humanmetrics.com/cgi-win/jtypes2.asp</a>
