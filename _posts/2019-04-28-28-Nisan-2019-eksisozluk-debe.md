...
- entry_name: |
    gençlerimizi kıraathanelerde meşgul edelim
  entry_id:  89407923
  entry_writer: saintly
  entry_fav_count: 457
  entry_content: |
    rte'nin durduk yere beşiktaşlıları hedef aldığı açıklaması.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 65
  entry_content: |
    belki de övünebileceği başka bir vasfı olmayan insandır.
  entry_channels: ilişkiler
- entry_name: |
    the protector (dizi)
  entry_id:  89393104
...
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    herhangi bir robottur.<br/><br/>dengesini sağlama adına herhangi bir sistemi olmayan, yana devrilmemesi sadece kalkan ayakların azıcık kalkmasına bağlı robottur. kontrolsüz bir şekilde sağa sola sallandığı gayet net görülebilir.<br/><br/>arazi testi dediği de dümdüz çimen.<br/><br/>takdir etmek istiyorum, beğenmek istiyorum. gerçekten deniyorum. ama bana verdiğiniz malzemeyle bu kadar oluyor.
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    bu adam fenerbahcenin yeni mahmut uslusu. ne soylediklerinin mantigi var, ne de yaptiklarinin. amaci gundemi ve konulari manipule edip, taraftarla oynamak. uzucu, ali kocun boyle birini yonetime getirecegini bilseydim, destek vermezdim. <br/><br/>tanim: bos, fanatik, gereksiz bir adam
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    aradığım yalnızlık.. <br/>yalnız olayım ve dilediğim kadar uyuyayım.. <br/>(bkz: <a class="b" href="/?q=kedi+taraf%c4%b1ndan+uyand%c4%b1r%c4%b1lmak">kedi tarafından uyandırılmak</a>)<br/>(bkz: <a class="b" href="/?q=%c3%a7ocuk+taraf%c4%b1ndan+uyand%c4%b1r%c4%b1lmak">çocuk tarafından uyandırılmak</a>)<br/><br/>sabah 6'da derdinize ne oldu bebem..
...
- entry_name: |
    fenerbahce sampiyon mu oldu
  entry_id:  89422418
  entry_writer: nickibitli
  entry_fav_count: 7
  entry_content: |
    kurgunu sikeyim senin.<br/>yan masadaydım,trabzon formalı çocuk babasına "bu sene de mi olmadı babaaağ" demişti oysa
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    madrugada - majesty<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://m.youtube.com/watch?v=LfGx1Eo1nSY">https://m.youtube.com/watch?v=lfgx1eo1nsy</a>
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    herkes roman yazmis, tek kitap turu roman mi. ıntroduction to conformal field theory. di francesco.
