...
- entry_name: |
  ...
  entry_channels: siyaset
- entry_name: |
    öğrenci indiriminin saçma bir kavram olması
  entry_id:  84465312
  entry_writer: elestiri
  entry_fav_count: 212
  entry_content: |
    (bkz: <a class="b" href="/?q=okumad%c4%b1m+karde%c5%9f+durumumuz+yoktu">okumadım kardeş durumumuz yoktu</a>)
...
- entry_name: |
  ...
  entry_id:  84456085
  entry_writer: illetxmor
  entry_fav_count: 15
  entry_content: |
    niye çaylaklardan mesaj bekliyoruz dedirten başlıktır. <br/><br/>yazarları tavlamak zor mu oluyor? çaylaklar için biz bir üst ligde miyiz? yazarlık onayımız hangi kritere göre yapıldı? ya da bize mesaj atacak hatunun benim ekşi yazarı arkadaşım var deyip övüneceğini mi düşünecez? bizle sohbetinde ufkunu mu, götünü mü açmaya çalışacağız? nedir? tutunacak bir dal arıyorum.
  entry_channels: anket,ekşi-sözlük
- entry_name: |
    atatürk'ün hiçbir gazeteciyi tehdit etmemiş olması
  entry_id:  84485598
  entry_writer: mdh
  entry_fav_count: 14
  entry_content: |
    aranızda hala atatürk’ü tayyip’le karıştıranlar var.<br/>yazık,çok yazık.<br/>ne demek istediğim başlık altı dolmaya başladığında daha net anlaşılacaktır.
  entry_channels: siyaset
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    murat özdemirin kuşa işkence etmesi
  entry_id:  84486232
...
- entry_name: |
  ...
  entry_id:  84485194
  entry_writer: onlar insansa ben hayvanim
  entry_fav_count: 2
  entry_content: |
    - oh yeah, fuck me and fuck that black hole<br/>- meali: oh evet, lanet olsun bana ve lanet et o kara delige
  entry_channels: ilişkiler
- entry_name: |
    en son gerçekten mutlu hissedilen an
  entry_id:  84459072
  entry_writer: beyinsizberat
  entry_fav_count: 1
  entry_content: |
    anamın amındayken
  entry_channels: anket
