...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    bu defa da otel odasında arkadaki çalışma masasının üstünde partnerinin ceketini ve yerdeki ayakkabılarını sergileyerek “acun’a selam pompaya devam” demiştir.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    mutluluğun çok uzun süre devam etmeyeceği.<br/>ya siz ya bi başkası yada hayat mutlaka mutlu hissetmenizi durduracaktır.<br/>genelde de siz bi aptallık yapıp herşeyi bok edersiniz.
  entry_channels: anket,ilişkiler
- entry_name: |
    şu anda çalan şarkı
  entry_id:  87308058
...
- entry_name: |
  ...
  entry_id:  87326399
  entry_writer: donjoganss
  entry_fav_count: 0
  entry_content: |
    yani futbolun doğasında hata var, bu gayet normal bir şey. dünyanın en büyük stoperleri de hata yapıyor. siz eleştiri yapmıyorsunuz, direk sizin yaptığınız adamı bitirmek. gayet memnun olduğum stoper. hele ki serdar aziz ile falan karşılatırma yapıyorsunuz ya çok komik oluyor. insanlar kötü gününde olabilir bazen. anlayış sıfır bizde.<br/><br/>tanım : brezilyalı, çok iyi stoper.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=bu+bir+vir%c3%bcs+olabilir+mi">bu bir virüs olabilir mi</a>)
  entry_channels: spor
- entry_name: |
