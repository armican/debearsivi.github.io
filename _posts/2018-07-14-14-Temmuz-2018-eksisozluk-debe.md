...
- entry_name: |
  ...
  entry_id:  79138128
  entry_writer: sunicin
  entry_fav_count: 32
  entry_content: |
    "yürürlükte olan hep aynı kanundur; bir kez zora başvuran buna devam etmek zorundadır-teröre bir kez bulaşanın onu arttırmaktan başka çıkar yolu yoktur."<br/><br/>(bkz: <a class="b" href="/?q=stefan+zweig">stefan zweig</a>)<br/>(bkz: <a class="b" href="/?q=vicdan+zorbal%c4%b1%c4%9fa+kar%c5%9f%c4%b1">vicdan zorbalığa karşı</a>)
...
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    yukarıda şöyle bir entry var.<br/><br/>"atak helikopteri satışımızı istemeyen dış güçlerin yaptığı saldırı."<br/><br/>oğlum sizde var ya sike sürülecek akıl yok. aferin çok komik bir espri gerçekten. 128 insan ölmüş orada kafasını siktimin çomarı seni.
  entry_channels: haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    her şeyi anladım da,<br/><br/>nefret söylemi olarak spermin testislerde oluştuğunu bilmiyor yazmış adam.<br/><br/>güler misin ağlar mısın, tek derdi karşı çıkmak.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    <a class="b" href="/?q=%c5%9fule+%c3%a7et">şule çet</a> cinayetinin süphelisi, adli tıp kurumunun yayınladıgı rapora göre de tecavüzcüsü. <br/><br/>(bkz: <a class="b" href="/?q=reddedilince+tecav%c3%bcz+edip+balkondan+atan+erkek">reddedilince tecavüz edip balkondan atan erkek</a>)
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  79143524
  entry_writer: kardes burasi berlin mi
  entry_fav_count: 4
  entry_content: |
    gözlüğünü koyduğun yerde bulamamak.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=t%c3%bcrk+hatunlar%c4%b1n%c4%b1n+%c3%a7o%c4%9funun+hobitinin+olmamas%c4%b1">türk hatunlarının çoğunun hobitinin olmaması</a>)
  entry_channels: 
- entry_name: |
    sugar daddy'ye türkçe isim önerileri
  entry_id:  79142376
  entry_writer: swollenmember
  entry_fav_count: 1
  entry_content: |
    <a class="b" href="/?q=para+babas%c4%b1">para babası</a> diye bir şey yok mu zaten?
  entry_channels: anket
- entry_name: |
    öpüşürken parmak ucuna kalkan hatun
  entry_id:  79143566
  entry_writer: justice is might
  entry_fav_count: 1
  entry_content: |
    185 boyum ile başlık sahibine katılmadığım hatun.<br/><br/>niye. 185-8=177. <br/><br/>177 kız çok uzun lan. topuklu giyse aynı boyda oluruz. o sekizi minimum on beş yapalım. benim için 160-170 boy idealdir. öpüşürken de bir zahmet oturarak öpüşelim.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  79137035
  entry_writer: sizofren06
  entry_fav_count: 1
  entry_content: |
    ankara sakaryada bira olur raki olur arkadas araniyor. devamli olsun ayda 1-2 kere icelim.
