...
- entry_name: |
    customer ile client arasındaki fark
  entry_id:  79136321
  entry_writer: korki48
  entry_fav_count: 14
  entry_content: |
    customer ve client türkçe'de aynı şeydir, müşteri.<br/>aralarındaki fark ise;<br/>customer bir ürün satın alır,<br/>client bir hizmet satın alır.<br/>örnek: customer modem satın alan kişidir,<br/>client internet hizmeti satın alan kişidir.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    gereğinden fazla vakit geçirmek, kişisel mahremiyetin sıfıra inmesi.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    muhtemelen 14 temmuza sarkacak değerlendirme.<br/><br/>(bkz: <a class="b" href="/entry/79113111">#79113111</a>)
  entry_channels: siyaset,haber,ekonomi
- entry_name: |
    kredi kartı kullanımındaki tehlike
  entry_id:  79138406
  entry_writer: kayitsiz ol
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=sanal+kart">sanal kart</a>)
  entry_channels: teknoloji,ekonomi
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    uykusuz yazarı ergin ergönültaş
  entry_id:  79140526
  entry_writer: darkcape
  entry_fav_count: 0
  entry_content: |
    40 yıl öncesinin türkiye'sinde; mizah dergiciliğinin öncüsü gırgır'ın değerli çizeri ergönültaş'ı tanımayan bir gencin çemkirmesi olduğunu varsayıyorum.<br/><br/>torpille mi dergiye girdin demiş. (bkz: <a class="b" href="/entry/79139486">#79139486</a>)<br/><br/>bir de "ergin" yazmış ya...
