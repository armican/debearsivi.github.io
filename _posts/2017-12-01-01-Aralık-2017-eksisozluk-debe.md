...
- entry_name: |
  ...
  entry_fav_count: 48
  entry_content: |
    twitter'da birinin "sirada muammer güler var, boynu olmadıgı icin belinden asacaklar donup duracak garibim" yorumuyla akıllara gelmiş gülümsetmiştir.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    özünde, <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=EJmg8T03Hjc" title="https://www.youtube.com/watch?v=EJmg8T03Hjc">şu video</a>dakinden farklı bir şey mi yapıyor? <a class="b" href="/?q=duru+%c3%b6nver">duru önver</a> italya'dan aldığı ıvır zıvırı gösteriyor, bu kız ise gidip a101'den çilekli link, kek falan alıp bunları gösteriyor. italya'ya gitme fırsatı olsa italya'daki marketten aldığı şeyleri gösterirdi yahut çok uçmaya gerek yok, pahalı mekanlara oturmaya gücü yetse dışarıda piknik yaparken değil de oralarda yemek yerken vlog çekerdi. çektiği diğer videolara bakıyorsun; bu ayki makyaj malzemesi favorileri, oje koleksiyonu, kutu açılımları, storytelling, challengeler falan. bu kızın tüketim kültürünü pohpohlayan diğer vloggerlardan farkı nedir? diğer vloggerlarda olmayan hangi içeriğe sahip? kameraya gözlerini belertip tekdüze bir ses tonuyla, mimik bile kullanmadan konuşan ve sürekli aldığını, gittiğini, yaptığını; kısacası sahip olduğu şeyleri anlatan bir kızın nesi doğal? bir şeyin düşük bütçeli olmasının onu doğal yaptığını düşünmüyorum. aksine bu kızdan yapaylık akıyor.<br/><br/>çünkü belli ki izlemiş, özenmiş, kendi imkanlarıyla o videoların benzerini yapmış.<br/><br/>"bak, sevgilim var, piknik de yaptık, alışveriş de yaptık, bana bak, bana! makyaj malzemesi aldım bir sürü, ojelerim var renk renk, bak nelere sahibim, bak bak bak sadece bana bak"<br/><br/>aynı haltın lacisi.<br/><br/>satırlarca güzelleme yapan var, sabır.
- entry_name: |
...
- entry_name: |
    tc kimlik numarası 11111111110 olan adam
  entry_id:  72502781
  entry_writer: duz yolda kaybolan adam
  entry_fav_count: 6
  entry_content: |
    (bkz: <a class="b" href="/?q=binary+y%c4%b1ld%c4%b1r%c4%b1m">binary yıldırım</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    sitede 32 bitcoin var. adamlar kapatıp gitse fena vurgun değil ama bence hedef olarak 100 bitcoin koydular biraz vakti var. 15 güne kapanır. dilencilik yapmayın, ben de yaptım zamanında ama günde 1 dolar nedir lan o kadar düştük mü ?
- entry_name: |
    ekşi itiraf
  entry_id:  72501953
  entry_writer: mahlep
...
- entry_name: |
    aras kargo
  entry_id:  72494141
  entry_writer: alporler
  entry_fav_count: 0
  entry_content: |
    istanbul kadıköyden istanbul kartala 5 gündür kargo teslim edemeyen berbat kargo firması. halen hiçbir güncelleme yok, şubelerin telefonu hep meşgul, müşteri hizmetlerini arayınca da özür dileyip yarın teslim edeceğiz demekten başka birşey söyledikleri yok.
- entry_name: |
