...
- entry_name: |
    trafiğe takılmamak için benzincinin içinden geçmek
  entry_id:  84279579
...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    faturayı görünce atatürkçü olan reis sevdalısı
  entry_id:  84282687
  entry_writer: 126
  entry_fav_count: 255
  entry_content: |
    yalnız bedel ödeyen insanlar atatürk’ün kıymetini anlar zaten
  entry_channels: siyaset,ekonomi
- entry_name: |
    açıldığı caddeye değer kaybettiren işletmeler
  entry_id:  84283865
  entry_writer: sinirliyim
  entry_fav_count: 241
  entry_content: |
    (bkz: <a class="b" href="/?q=nargile+cafe">nargile cafe</a>)
  entry_channels: anket,ekonomi
- entry_name: |
...
- entry_name: |
    12 aralık 2018 istanbul kar yağışı
  entry_id:  84282946
  entry_writer: koluncumuofele
  entry_fav_count: 67
  entry_content: |
    instagram ve facebook'ta paylaşmak için yaşadığı ilçede de başlamasını bekleyenleri heyecandan strese sokan yağıştır. bazıları var ki hadımköy'de, beylikdüzü'nde olan tanıdıklarından kar yağışı videosu ithal ediyorlar. kar yağışını normal doğa olayı olarak gören diğer illerde yaşayanlar için çok enteresan olabilir ama istanbullu mutlu olmak, istanbullu layklara boğulmak, birazcık olsun işin stre... istanbullunun ben ta.. neyse ben de istanbul'dayım.<br/><br/>edit: imla hatası<br/><br/>@coolmaxandlovelymary @izmirrasyonel<br/><br/>teşekkürler.
...
- entry_name: |
    4bin 500tl ile amelelik vs 3bin tl ile mühendislik
  entry_id:  84288638
...
- entry_name: |
    zengin koca avcısı öğretmen kız
  entry_id:  84273857
  entry_writer: mimarbihanim
  entry_fav_count: 41
  entry_content: |
    öğretmenlikle alakası olmayan durum. pilotluk bölümünü okuyup "erkeğin sözü geçmeli bence" "erkek tarafı tabiki de daha güçlü olmalı" diyen beynini geçmişte bir yerlerde unutmuş arkadaşım var benim. hayır bir ayda normal beyaz yakalinin 6 aylık maaşını kazanacaksın yakında bu neyin derdi?<br/><br/>aile şirketi olmayan erkeklerin yüzüne bile bakmaz, yalvartıp yalvartıp "ben seni arkadaşım olarak görüyorum" deyip tekmeler sonra "beni neden kimse olduğum gibi sevmiyor?" "beni neden kimse gerçekten sevmiyor?" diye sizlanır durur. acaba niye gizli kadın düşmanı gold digger? hayatın boyunca mutlu olabilecek misin bu olmayan beyninle?<br/><br/>kendisiyle 5 aydır tek kelime dahi konuşmadım. bundan sonra da konuşmak istemiyorum.
...
- entry_name: |
  ...
  entry_fav_count: 24
  entry_content: |
    neden vermiyorlar diye kimsenin çıldırmadığı, sadece neden amına koyduğumun uygulamasını kullanıp da sanki bir kaza eseri gibi yüklediği ölü taklidi yaptığı konusunda erkeklerin çıldırdığı uygulamadır. <br/>ben burada network marketing yapan gördüm ulan.
...
- entry_name: |
    12 aralık 2018 iyi parti ve chp'nin anlaşması
  entry_id:  84302193
  entry_writer: baba24
  entry_fav_count: 18
  entry_content: |
    fiyasko filan değildir. aday gösterse ne olacak, %10 oyla ankara istanbul izmir kazanılacak mı ? şimdi ise balıkesir ve mersin'in kazanılma ihtimali çok çok yüksek; akp-mhp ittifakından kazanılacak üstelik. akp bile mhp ile ittifaka mecbur kalmışsa bu anlaşma elzemdir başarılıdır; aktroller istediği kadar fiyasko desin.<br/><br/>edit: denizli'ye de baktım kazanılması ihtimali yüksek. eder 3. samsun ve erzurum için umut yok ama...<br/><br/>edit 2: iyi parti de antalya ve adana için chpyi destekleyecekmiş. antalya yine yüksek ihtimal adana muhtemel. eder 5.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    böyle bir kişinin kötü biri olma ihtimali çok düşüktür.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    turgay demir' in içinde olduğu aspor kanalında olduğu iddia edilen yapılanmadır. nasıl bir yapılanmaysa bir turgay demir' i ne susturabiliyorlar, ne gönderebiliyorlar. bir adamla bile başa çıkamayan yapılanmadan(!) korkmayın bence.<br/><br/>bu arada algı operasyonunuzu sikeyim!!
...
- entry_name: |
  ...
  entry_id:  84301915
  entry_writer: emrece81
  entry_fav_count: 4
  entry_content: |
    istanbul u almak imkansız gibi ama ankara da mansur abi aday gösterilirse olabilir gibi. izmir in kaybedilmesi pek mümkün değil.
  entry_channels: siyaset,haber
- entry_name: |
    çaylak onay listesi
  entry_id:  84290449
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    hiç unutmuyorum taraftarla, medyayla olan ilişkide <a class="b" href="/?q=%c5%9feffaf">şeffaf</a> olacağız demiştin başkan. kusura bakma da takım <a class="b" href="/?q=%c5%9feffaf">şeffaf</a> oldu. <br/><br/>gelenin geçenin 3 attığı, <a class="b" href="/?q=yar%c4%b1+saydam">yarı saydam</a> olan neustadter'in <a class="b" href="/?q=tam+ge%c3%a7irgen">tam geçirgen</a> olduğu, benzia, reyes meyes ne sikim olduğu belli olmayan bir ton çöp futbolcunun dolduğu, <a class="b" href="/?q=fenerbah%c3%a7e+taraftar%c4%b1">fenerbahçe taraftarı</a>'nın kanser olduğu bir takım yarattın başkan, sağol.<br/><br/>tamam seviyoruz seni falan da <a class="b" href="/?q=fenerbah%c3%a7e+ba%c5%9fkan%c4%b1">fenerbahçe başkanı</a> 2 gündür kaçacak delik arayıp durmaz. <a class="b" href="/?q=cocu">cocu</a>'yu yollayamıyorsun tamam elin kolun bağlı belki ama çıkıp taraftara iki laf söyleyemiyorsan, kusura bakma da bu taraftar sana da sırtını döner yakında benden demesi.<br/><br/>tüketme kredini, yapacağını yap.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    (bkz: <a class="b" href="/?q=unutulmamas%c4%b1+gereken+ba%c5%9fl%c4%b1klar">unutulmaması gereken başlıklar</a>)
  entry_channels: haber
- entry_name: |
    ekşi sözlük iş ağı
  entry_id:  84298550
  ...
  entry_fav_count: 0
  entry_content: |
    freelance grafiker arıyoruz.<br/><br/>istanbul avrupa yakasındaki ofisimizde haftada bir gün, bir kaç saat görüşebileceğimiz, işleri ise uzaktan halledebilecek kişiler tercihimizdir.
