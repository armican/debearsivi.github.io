...
- entry_name: |
    macron'un afrikalılar'a 8-9 çocuk yapmayın demesi
  entry_id:  82788149
  entry_writer: batub
  entry_fav_count: 127
  entry_content: |
    bizdeki kürtlere, suriyelilere, araplara da aynı cümle kurulabilir.<br/><br/>kısaca ortadoğulular ve afrikalılar (bkz: <a class="b" href="/?q=prezerlatif">prezerlatif</a>) takın <br/><br/>(bkz: <a class="b" href="/?q=prezervatif">prezervatif</a>)
...
- entry_name: |
  ...
  entry_fav_count: 40
  entry_content: |
    nerelisin deyince "elbistan" diyen bi arkadasim vardi. vay a.q. adam yurt dışından gelmis derdim.
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 39
  entry_content: |
    fenerbahçe'nin mağlup olarak, bugünkü rizespor maçı öncesi beşiktaş'ın sırtına ayrı bir sorumluluk yüklediği müsabaka. şimdi biz bugün rize'ye yenilsek, bursalılar'dan sonra bu sefer de fenerbahçeliler bize düşman olacaklar rize'ye yattınız bizi düşme hattına soktunuz diye. ulan rize sende bir ibnelik var demek ki.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    ''herkes kendi gücü ve emeği kadar nasip alır. senin kabın az su alıyorsa deryanın günahı ne''<br/><br/>(bkz: <a class="b" href="/?q=mevlana">mevlana</a>)
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    seçilmesine şaşıranları gördükçe hayrete düştüğüm siyasetçi. suç oranları, yolsuzluk almış başını gidiyor. ülkenin büyük kısmı favelalarda oturan beyni yıkanmış kitle yığınlarından oluşuyor zaten. 18-25 yaş arası genç seçmenden çok yüksek oranda oy almış. ayrıca evanjelistler ve brezilya'nın sermaye sınıfı da kendisinden yana olunca başkan seçilmesi çok da şaşırtıcı olmadı. <br/><br/>1986'da orduda maaşların düşük olmasını ulusal bir gazetede yazmış ve 15 gün hapis yatmış. bu mağduriyet hikayesiyle aktif siyaset hayatına başlamış. trump'a benzetiyorlar da trump'ın söylediklerinden bile daha vahim olan bir sürü demeci var. trump'ın tam tersine -2016'da her 2 beyaz kadından biri trump'a oy verdi- brezilya'daki kadınların sadece %36'sı ona oy verecek diyen anketler de vardı. gençlerin ona oy verme sebebi tamamen güvenlik sorunlarıyla alakalı. brezilya solu otursun aptallığına yansın, bu kadar yozlaşmadan ve asayiş sorunundan sonra böyle leş ötesi bir adam o demeçlerine rağmen zafer kazanır, hiç şaşırmıyorum. neyse yarın uluslararası medya yangın yerine döner merakla bekliyorum yazılacakları. faizleri düşürcem diye bağırıyormuş zaten asjdhsjdhjsdhj.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    kakanın o kadar uzun sürmesi ki tekrar çiş gelmesi
  entry_id:  82793246
  entry_writer: mauna kea
  entry_fav_count: 2
  entry_content: |
    ileride hemoroidal hastalık, anal fissür gibi şeylerle uğraşacağınıza işaret eder. kuru kayısı yeyin bana teşekkür edin.
  entry_channels: sağlık
- entry_name: |
    en üst katta oturmak
  entry_id:  82793431
  entry_writer: type7c
  entry_fav_count: 0
  entry_content: |
    bir dönem en üst katta oturmuş olan birisi olarak;<br/><br/>avantajları :<br/><br/>1. tüm binada aynı cephe için en güzel manzara sizindir <br/>2. üstünüzden herhangi bir ses gelmesi derdiniz yoktur<br/>3. yoldan uzak olduğunuzdan dolayı, yol gürültüsü en azdır<br/>4. isteyerek veya istemeyerek evinize bakacak olan göz sayısı daha az olacaktır<br/><br/>dezavantajları :<br/><br/>1. tüm alttaki dairelerin yemek pişirme kokusuna maruz kalabilirsiniz<br/>2. yukarıda ne kadar izolasyon olursa olsun, ısı yönünden ara kata benzemeyecektir<br/>3. soğuk kalan köşe noktalarda, yoğuşmadan dolayı küf oluşabilir<br/>4. çatı arasında iyi bir ilaçlama yoksa, börtü böceğin ilk tercihi si olacaksınız<br/>5. su debisi en düzensiz siz olacaksınız
  entry_channels: 
- entry_name: |
    ekşi sözlük dışarı çıkmalık arkadaş veritabanı
  entry_id:  82792840
  entry_writer: trounleinc
  entry_fav_count: 0
  entry_content: |
    dışarı çıkmak şöyle dursun, bu maraş’tan yazar bile çıkmaz. sevdiğimin maraş’ı!!!
  entry_channels: anket,ilişkiler,ekşi-sözlük
---
