...
- entry_name: |
  ...
  entry_channels: siyaset,tarih
- entry_name: |
    aralık 1942 letonya'da çekilen korkunç fotoğraf
  entry_id:  82799552
...
- entry_name: |
  ...
  entry_fav_count: 28
  entry_content: |
    hangi koşulda, nasıl, neden ve ne kadar direnilmiş olsa da; gerçeğin tüm çıplaklığıyla farkındalığına erişilmiş buruk bir andır.<br/><br/>sevilmediğini kabul etmek büyük devrimdir.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    cenk tosunun dembaba ve gomezle yetişmesi vs güven yalçının pektemek ve vagner ile yetişmesi.<br/>bu çocukta potansiyel var dememe yeten bir versus :)
  entry_channels: spor
- entry_name: |
