...
- entry_name: |
    lewis hamilton
  entry_id:  82779463
  entry_writer: yesil 357
  entry_fav_count: 6
  entry_content: |
    formula tarihinde teorik olarak adını ilk 3'e yazdırmış pilot.<br/><br/>yalnız anlamadığım bu hamilton size ne etti kardeşim. ferrari bu sene gayet iyi araç geliştirdi, sezon başında şampiyon olacaklarına kesin gözüyle bakıyordum ama sizin sarının ve pit duvarının eli ayağı dolaştı. daha temkinli ve tecrübeli davranan hamilton şampiyonluğu temiz şekilde aldı.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    arkadaş türkiye cumhuriyeti’nde yaşayan bir çocuğun “türküm, doğruyum, çalışkanım” demesi nasıl ırkçılık olarak değerlendirilir aklım almıyor.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    buyuk kolaylik. yolda cekeceginiz miktari hazirlar 15 sn de cekersiniz.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    korku oyunları dışında da indirime gidilen etkinlik.<br/>scs software oyunları (%75-80))<br/>left 4 dead 1-2 (%80) <br/>crysis serisi (%75) (collection paketi 16.25 tl)<br/>square enix oyunları (%75-80)<br/>sims 3 (%75)<br/>cities skylines (%75)<br/>europa universalis serisi (%75)<br/><br/>klasik halloween korku oyunu indirimleri de mevcut.<br/>outlast serisi (%75-80)<br/><br/>şimdilik gözüme çarpan yüzdr 75 üstü indirimler bunlar.<br/><br/>edit: square enix oyunlarının indirimi bugün bitiyordu, 1 kasım'a kadar uzatmışlar. 1 haftadır indirimdeydiler.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    adamın futboldan ne kadar anladığını; orta yaparken gol atmasından anlayabilirsiniz...<br/><br/>aslında gayretli ve koşan agresif yapısı ile defansif orta saha oynatılabilir. nasılsa ha düştük ha düşeceğiz, will smith kılıklı jailson da çöp oğlu çöp çıktı.<br/><br/>yürüyedur sarı oğlan.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    her seyrettiğimde "ulan <a class="b" href="/?q=emre+akbaba">emre akbaba</a>. sen harbiden büyük futbolcuymuşsun" dediğim futbolcu.
  entry_channels: spor
- entry_name: |
    ekşi sözlük iş ağı
  entry_id:  82789840
  ...
  entry_fav_count: 0
  entry_content: |
    istanbul’da barlarda ekstra garsonluk için iş arayışım devam ediyor. çarşamba cuma cumartesi akşamları çalışabilirim.
