...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    yalnızca para çekmek değil tüm bankacılık işlemleri için hayat kurtarıcı. <br/>mario oynamaya gelenlerin anlamsızlığına "dırıt dırıt dırıt" tarzında iyi günler diliyorum.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    kozmosların tartışmasız en kötü penaltıcısı. adam hangi köşeye nasıl vuracağını sabah kahvaltısından belli ediyor, ben ekran başından anlıyorum kaleci napsın hayatının en kolay kurtarışını yapıyor.<br/><br/>ikınci tanım: son 8 penaltının 4'ünü kaçırmış sol kaçık.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    cümle yerine geçebilecek bir kelime var lügatimizde. (bkz: <a class="b" href="/?q=bilmiyorum">bilmiyorum</a>) demek. mamafih bunu diyebilen türk insanı gerçekten dahidir, engin bir bilgiye gebedir. kendini bilen kişi bilmiyorum diyebildiği gibi dolaylı olarak cevap bekleyen muhattabını da araştırmaya teşvik etmiş olur. lütfen ukala olmayın, <a class="b" href="/?q=herbokolog">herbokolog</a> hiç olmayın.
  entry_channels: anket
- entry_name: |
    vagner love
  entry_id:  82796162
