...
- entry_name: |
    şuana kadar tarih sahnesindeki en adaletli devlet
  entry_id:  68881451
  entry_writer: haciz mahallinde tango
  entry_fav_count: 84
  entry_content: |
    sscb olmadığı, tartışmaya ve kuşkuya mahal bırakmayacak derecede açıktır.
- entry_name: |
    ak parti'nin uygun bulduğu protesto tarzı
  entry_id:  68876856
  entry_writer: ismin e hali
  entry_fav_count: 78
  entry_content: |
    meydanlara çıkmak yasak, yürümek yasak, oturma eylemi yasak, açlık grevi yasak, tribünlerde marş söylemek yasak, televizyon programlarına katılıp itiraz etmek yasak, sokak ortasında öylesine durmak bile yasak ...<br/><br/>ne yasak değil peki?<br/>söyleyin size ne uygun, ona göre hareket edelim.<br/>hayalinizde nasıl bir muhalefet var?<br/><br/>taraflı hakimlerle adaleti öldüreceksiniz, özgür basın diye bir şey bırakmayacaksınız, seçimlerde hileye başvuracaksınız, insanları sürekli elinde silah tutan adamlarla tehdit edeceksiniz, insanlar da bu durumu kabullenecek, sinecek, susacak.<br/>ulan bu ülkede sedat peker çıktı, falancaların kanlarında yıkanacağız dedi. ne bekliyorsunuz bu halktan? <br/><br/>ne yapalım? bu halk sesini nasıl duyursun? söyleyin.
- entry_name: |
...
- entry_name: |
    karadeniz şarkılarında geçen acımasız sözler
  entry_id:  68865919
  entry_writer: oh lilian
  entry_fav_count: 43
  entry_content: |
    (bkz: <a class="b" href="/?q=dostum+ac%c4%b1mas%c4%b1z+s%c3%b6zler+demi%c5%9fsin+ama+bunlar+beddua">dostum acımasız sözler demişsin ama bunlar beddua</a>)
- entry_name: |
...
- entry_name: |
    kuvvet ile kütleyi karıştıran mühendis
  entry_id:  68879836
  entry_writer: micro megas
  entry_fav_count: 41
  entry_content: |
    (bkz: <a class="b" href="/?q=kuveyt+ile+k%c3%bctleyi+kar%c4%b1%c5%9ft%c4%b1ran+m%c3%bchendis">kuveyt ile kütleyi karıştıran mühendis</a>)<br/>(bkz: <a class="b" href="/?q=yaran+yanl%c4%b1%c5%9f+okumalar">yaran yanlış okumalar</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 35
  entry_content: |
    allah belasını versin öyle modanın.<br/>bunlar yüzünden normal çorapla takım elbise giydiğimiz zaman keko gibi duruyoruz.<br/>cesaretimi toplayıp çorapsız deneyeyim dedim, yakışmıyor aga. komik duruyorum, sanki herkes bana gülüyormuş gibi hissediyorum. sanki birşeyi unutmuşum gibi dengesiz dengesiz yürüyorum.<br/>kim başımıza bela etti lan bunu?
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 26
  entry_content: |
    hayallerin hammaddesidir.<br/><br/>ciddili yazarsam:<br/><br/>2017'de bir havadis değeri içeren 30 yaşına gelmiş bir kadının evlenmemiş olması değil, 20'lerindeki bir kadının evlenmiş olmasıdır.
- entry_name: |
    keanu reeves
  entry_id:  68865763
  entry_writer: dersleri hep 2 olan cocuk
  entry_fav_count: 24
  entry_content: |
    ismini sol framede görünce, acaba metrobüste yine kime yer vermiş diye düşündüğüm adam gibi adam. <br/><br/>parti kur oy verelim keynu reis
- entry_name: |
    engin ardıç
  entry_id:  68873951
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    hakkında tutuklama kararı çıkan kişi. <br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="http://www.cumhuriyet.com.tr/haber/turkiye/762601/Topbas_in_damadi_hakkinda_tutuklama_talebi.html" title="http://www.cumhuriyet.com.tr/haber/turkiye/762601/Topbas_in_damadi_hakkinda_tutuklama_talebi.html">http://www.cumhuriyet.com.tr/…tutuklama_talebi.html</a><br/><br/>edit: linki değiştirdim. habertürk vardı. cumhuriyet yaptım. denizde kum kadar etkileyecek olsa bile tık kazanmasın yandaşlar.
- entry_name: |
...
- entry_name: |
    haziran 2017 türkiye adalet yürüyüşü
  entry_id:  68873030
  entry_writer: severek izliyoruz
  entry_fav_count: 5
  entry_content: |
    bugun yeni şafak'a bile haber olan yürüyüş. demek ki doğru yolda yürünüyor. <br/>dün tüm haber kanallarındaydı. sahte iftar konuşmaları dinlemekten bıkmıştık. iyi oldu.
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    “ayakkabılarını kapımın önünde görmeyi istiyorum!<br/>çünkü bu,<br/>seni seviyorumun içine nal salmak demektir.<br/>ve hareketinin bana durduğunu akla uydurur.<br/>oysa seni sevmem toplumu meşru kılar<br/>ve gitmen beni dile indirger sevgilim”
- entry_name: |
    interstellar
  entry_id:  68865724
  ...
  entry_fav_count: 1
  entry_content: |
    bir sahnede de yıldız kayıyordu hatırladınız mı? bir filmde durup dururken yıldız kayar mı? peki filmin türkçe ismi neden <a class="b" href="/?q=y%c4%b1ld%c4%b1zlaras%c4%b1">yıldızlarası</a>? küçük ayı takımıyla büyük ayı arasındaki muhabbet de nedir? küçük ayının ödipal saplantısını ve amerikanya'nın oyununu hala görmediniz mi? ferdi tayfur'un bize vermek istediği mesaj çok açık değil mi? <br/><br/>işte bunlar hep sekstir arkadaşlar sekz sekz sekzz...
- entry_name: |
