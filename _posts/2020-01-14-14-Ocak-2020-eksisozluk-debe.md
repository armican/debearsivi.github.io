...
- entry_name: |
    tayyip erdoğan'ın ismailağa şeyhini ziyaret etmesi
  entry_id:  100448545
  entry_writer: buralarda11
  entry_fav_count: 217
  entry_content: |
    hala akıllanmadıklarını gösteren cemaat ziyaretidir. bu ülke 2. kandırılmayı, kaldıramaz.
...
- entry_name: |
  ...
  entry_fav_count: 114
  entry_content: |
    (bkz: <a class="b" href="/entry/100484640">#100484640</a>)<br/>cevap: insan
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    birçok yobaz şehir bulunmakla birlikte, en yobazı soruluyor ise;<br/><br/>oyumu <a class="b" href="/?q=sakarya">sakarya</a> 'dan yana kullanıyorum.
...
- entry_name: |
    ismet özel
  entry_id:  100477763
  entry_writer: torkvedengesiz
  entry_fav_count: 9
  entry_content: |
    "intihar geride kalanlara yönelik ağır bir suçlamadır." demiştir. ne ince bir söz yahu.
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    galiba kendini önemli biri zannediyor.
  entry_channels: moda,magazin
- entry_name: |
    imamoğlu'nun istanbul için hiçbir şey yapmaması
  entry_id:  100488071
  entry_writer: veys zimmer
  entry_fav_count: 4
  entry_content: |
    sevgili yazar arkadaşlar, eğer aktroll değilseniz aşağıdaki yazımı okuyun, ve lütfen bu başlığa yazmayın. <br/><br/>(bkz: <a class="b" href="/?q=aktrollerin+yapmaya+%c3%a7al%c4%b1%c5%9ft%c4%b1%c4%9f%c4%b1+imamo%c4%9flu+operasyonu">aktrollerin yapmaya çalıştığı imamoğlu operasyonu</a>)<br/><br/>tanım: bir aktrollün algı çalışması.
  entry_channels: 
- entry_name: |
    düşün ki o bunu okuyor
  entry_id:  100448014
  entry_writer: stakozunhikayesi
  entry_fav_count: 4
  entry_content: |
    adi, soysuz, it, köpek, şerefsiz, haysiyetsiz, cibiliyetsiz, ezik, hardal böceği, çatal dilli yılan, dikenli kirpi, semeder, zehirli kör yılan, dokumacı örümcek, sakırga, solucan şu dizeler benden sana gelsin;<br/><br/>ben sana bok demem,<br/>boklar duyar ar eder.<br/>bir zerren düşse boka,<br/>onu da mundar eder.<br/><br/>tanrı senin hamurunu<br/>necasetle yoğurmuş,<br/>anan seni s.ç.r iken<br/>yanlışlıkla doğurmuş<br/><br/>düşün ki "o" bunu okuyor cümlesinde o zamirine koyacak birini tanımıyorum hayatımda. ama kim isterse cümlede geçen o zamirine kendini koyup bu cümleleri ve şiiri ona sarfetmişim gibi kabul edebilir.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    1500 kez yazılmış ama yine yazılır; sıkıntı yok.<br/>biri elimde kalacak bunun yüzünden.
  entry_channels: anket
- entry_name: |
    şu anda çalan şarkı
  entry_id:  100478897
  ...
  entry_fav_count: 1
  entry_content: |
    <a class="b" href="/?q=evrencan+g%c3%bcnd%c3%bcz">evrencan gündüz</a> <a rel="nofollow noopener" class="url" target="_blank" href="http://youtu.be/ji56YNIGckM" title="http://youtu.be/ji56YNIGckM">tık tık</a>
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    nargile kafe canlısıyla karşılaştırıldığın da bence daha gelişmiş bir canlıdır. bol nargile tütününe maruz kalmaktan ve acı mırra içmektense insan evladı gibi bir kahveyi içmeyi tercih etmiş olabilir.
  entry_channels: 
- entry_name: |
    şu an okunan kitap
  entry_id:  100451356
  entry_writer: birtaksesi
  entry_fav_count: 0
  entry_content: |
    sartre- yıkılış <br/><br/>üçlemenin sonunu görmek üzereyim. sayfa 305 lerdeyim birazda dalgınım bu aralar şu 15 dakika dayanma bölümünde mathieu ölüyor mu?
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    alkol. hayatımız pahasına şaka şaka maddi olarak dayanacak gücümüz kalmadı.
  entry_channels: anket,ekşi-sözlük,magazin,ekonomi
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    can sikintisi.<br/><br/>spor yapmayinca resmen kendimi sikesim geliyo
  entry_channels: spor,anket
- entry_name: |
    imamoğlu'nun trabzonspor'a 300 bin euro vermesi
  entry_id:  100490041
  entry_writer: korndelapunci
  entry_fav_count: 0
  entry_content: |
    fenerlinin akpliside hiç çekinmiyor arkadaş .adam açıkladı ben her sene kendi paramla trabzonspordan loca alırım diye . valla kaynak falan ekleyemem kimse kusura bakmasın google da arayıp bulsun
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    burnu ve göğüsleri estetikli olan kız
  entry_id:  100485353
  entry_writer: silvermaiden
  entry_fav_count: 0
  entry_content: |
    meme estetiğinde o alttaki kesik izi tüm heyecanı alıyor.doğal olsun bizim olsun.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    büte girmek için <a class="b" href="/?q=yt%c3%bc">ytü</a>'ye gidiyorum (beşiktaş kampüsü).
  entry_channels: anket
---
