...
- entry_name: |
    facebook'a 2007'de katılmış biriyle çıkmak
  entry_id:  99541173
...
- entry_name: |
  ...
  entry_channels: tv,spoiler
- entry_name: |
    hiç elif şafak okumamış insan
  entry_id:  99558567
  entry_writer: ballikaymak
  entry_fav_count: 1
  entry_content: |
    pek fazla bir kaybı olmayan insandır. eğlencelik olarak alınıp okunabilir de okunmayabilir de. size bir şeyler katar mı, yeni bir şey öğretir mi bilemem. ancak öğretirse de taraflı, yanlış bir şey öğretir. bunu yemek için de yeni yetme olmanız gerekir. <br/><br/>not: vakti zamanında aşk, baba ve piç, mahrem kitaplarını okudum.
