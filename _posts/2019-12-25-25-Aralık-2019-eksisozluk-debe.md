...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    joker nereden adam buluyor
  entry_id:  99560313
  entry_writer: hosvelkam
  entry_fav_count: 135
  entry_content: |
    (bkz: <a class="b" href="/?q=linkedin">linkedin</a>)
  entry_channels: tv
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    şu açıklamaya da art niyetli diyorsanız; sizin ruhunuzda bir gariplik var. göte göt denmiş, hiç de 'ya ağlamayın' tribine girmeden, mertçe yenilen takımın açıklamasını destekliyoruz demiştir canım kulübüm.<br/><br/>daha önce böyle bir şey olduğunu hatırlamıyorum ben hiç bir kulüpten. bence örnek olmuş.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    yüzyıllardır kullanıyoruz şu dümdüz siteyi. ya ben anama babama bu kadar sık uğramıyorum. adamlar sırtımızdan zibilyon para kazandı. kimse gelip iyi hizmet, kolaylık falan demesin. mevzu daha derin. <br/><br/>insaf aç gözlü nevzat, 1000'de 5 de olsa bir puan ver ne bileyim müşterilerini gör biraz. sadık müşterilerine bir içecek ne bileyim bir zeytinyağlı ekle hediye. azıcık bir rakibin çıksa anında seni sallamaya hazır bir müşteri kitlen var. <br/><br/>hadi bizi geçtim, restoranlardan aldığı marjlar da cabası. joker indirimi denen şey önce bindirim sonra indirim. telefonla sipariş verince artık daha ucuz menüler sunuluyor. ayrıca müşteri servisi denen robot chat de doğrudüzgün çalışmıyor yarım saat bekliyorsun. <br/><br/>çekiliş diye kaktırılan markalar da hediye verebilmek için üstüne para veriyorlar.<br/><br/>çok kinliyim sana yemeksepeti.
  entry_channels: 
- entry_name: |
    ekrem imamoğlu
  entry_id:  99550169
  ...
  entry_fav_count: 9
  entry_content: |
    "erdoğan'ın karizması yanında çok sönük kalıyor."<br/><br/>imamoğlu kaf dağının arkasındaki sümbülü getirse, senin aşkına engel olamaz zaten. aşkın gözü kördür genç.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  99566271
  entry_writer: ohhlala2
  entry_fav_count: 3
  entry_content: |
    buna eziklik diyebilen tiplerle dolu ortadogu batakliginda bulunuldugunun hatirlatildigi baslik. sonra neden beyin gocu var? bunlarla ayni havayi mi soluyalim?
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    10 dakikaya bu zulümden kurtuluyorsun. millet yerinde olmak için ölüyor.
  entry_channels: anket
- entry_name: |
