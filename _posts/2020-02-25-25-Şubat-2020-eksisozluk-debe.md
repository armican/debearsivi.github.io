...
- entry_name: |
  ...
  entry_channels: spor,ilişkiler,haber,magazin
- entry_name: |
    fenerbahçe
  entry_id:  102538304
...
- entry_name: |
    okul müdürlerinin akp'li olması
  entry_id:  102566351
  entry_writer: ateyizayi
  entry_fav_count: 46
  entry_content: |
    eğitimin, dolayısıyla ülkenin geleceğinin .mına koyan şey.<br/><br/>yan yana iki kelimeyi getiremeyecek andavalları sırf eğitim bir-sen'li diye, ağır akp'li diye müdür yaptılar. bakın bu sığırlar ordusu bırakın yöneticiliği, kendi branşlarına bile hakim değil. türk gencinin son 10 senesini s.kip attılar. bir nesil embesil yetişti.
...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    babasının biricik prensesi olmadığı ve annesi üşürsün kızım diyerek srtına şal atmadığı için bunları yapabiliyor. <br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.liveleak.com/view?t=9gOoy_1582480903">https://www.liveleak.com/view?t=9gooy_1582480903</a><br/><br/>bu kadının tek artısı şımartılmamış olması. başka bir numarası yok.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    tahminimden az olan rakamdır. 20 yıla yakın süredir her allahın günü milyonlarca dolarlık yolsuzluktan pay aldığını düşünürsek, gerçek rakam çok daha yüksek olabilir. dünyanın en zenginleri arasında olduğunu düşünüyorum. koca ülkeyi yedi dile kolay...
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    clio'nun boş paketi mi duster'ın boş paketi mi
  entry_id:  102573032
  entry_writer: 0game
  entry_fav_count: 3
  entry_content: |
    euro ncap göz önüne alınırsa clio.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    başakşehir'in penaltısını var'a bile bakmadam es geçen, ardından rize'nin durumu 1-1'e getirdiği tff'nin görev adamı cüneyt çakır'ın yönettiği 23. hafta karşılaşması.
  entry_channels: spor
- entry_name: |
    şu anda çalan şarkı
  entry_id:  102563379
...
- entry_name: |
    turşusever yazarlar veritabanı
  entry_id:  102579168
  entry_writer: pointless facts
  entry_fav_count: 1
  entry_content: |
    yüzümü güldüren başlık... böyle başlıklar istiyorum..:))<br/><br/>bu kervana beni de ekleyebilirsiniz... bayılıyorum... her canım isteyiş de gözümü kırpmadan koca bir kase götürüyorum...:)) her çeşit turşuyu seviyorum; lahana, kornişon, kelek, fasulye, karışık, vs.... suyunu da çok seviyorum... muhteşem bir lezzet... biz de sofrada salatayla eş değer diyebilirim.... <br/><br/>turşularımızı ise yıl olarak net tarih veremem ama uzun bir zamandır kendim yapıyorum. çok da güzel oluyor, bu yıl ufak bir sıkıntı (her yıl kullandığım sirkenin dışında bir sirke kullandığımdan) yaşadım ama problemi fark ettim... muhtemelen bir daha yaşamayacağım....<br/><br/>tarif için: <a class="b" href="/entry/70720815">#70720815</a>
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    oranları sebebiyle çok alternatif kaçmaya başladı xperia'lar. halbuki bi normal boy bi de bunu "wide" gibi bi isimle salsalar ortama daha çok satarlar. beceremiyorlar mı acaba...<br/><br/>isimde de saçmalıyorlar.
  entry_channels: teknoloji
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    ara ara aklıma düşen konudur.<br/><br/>saray dili türkçe olacağı için halk ile bürokrasi arasındaki bağlar daha güçlü olacak, türklük aşağılanmayacak, doğudaki türklerle uğraşıp hilafeti getirmeye çalışmak yerine batıda italya sınırlarına dayanılıp vatikan vergiye bağlanmaya aday olabilirdi.
  entry_channels: 
- entry_name: |
