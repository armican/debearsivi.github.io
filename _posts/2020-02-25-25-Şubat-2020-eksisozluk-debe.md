...
- entry_name: |
  ...
  entry_id:  102540945
  entry_writer: kedilokumu
  entry_fav_count: 10
  entry_content: |
    senin oynadığın tiyatro hiçbir sahnede sergilenmiyor.<br/>helal olsun.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    elimde rte'ye ait 38 tane yolsuzluk kasedi var
  entry_id:  102583594
  entry_writer: merihberlin
  entry_fav_count: 5
  entry_content: |
    ahan da sonunda kasetci ortaya cikti.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
    imkanın olsa ölüm tarihini öğrenir miydin
  entry_id:  102583342
  entry_writer: oturarak sican japon baligi
  entry_fav_count: 3
  entry_content: |
    diziye başlamadan önce son bölümünü izliyor musunuz?
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    ölçü olarak recep tayyip erdoğan alınırsa, evet öyle...
  entry_channels: anket,eğitim
- entry_name: |
    yazarlara whatsapp'tan gelen son mesaj
  entry_id:  102539546
  entry_writer: visneli bitter cikolata
  entry_fav_count: 1
  entry_content: |
    tanımadığım bir numaradan gelen mesaj;<br/>-"<a class="b" href="/?q=ba%c5%9fi">başi</a> "<br/>bana bişey anlatmaya çalışıyor galiba..<br/><br/>iki defa da görüntülü aramış<sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup> derdi neydi ki acaba.<br/><br/>edit: google'dan baktım kürtçe "<a class="b" href="/?q=iyi+misin">iyi misin</a> " anlamına geliyormuş. <br/>şimdi de çağrı atıp kapattı, benim aramami bekliyor herhal.<sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
...
- entry_name: |
  ...
  entry_id:  102585235
  entry_writer: sazcalanmetalci
  entry_fav_count: 0
  entry_content: |
    vibrant leather<br/><br/>seoul'dan buna geçiş yaptım. gittikçe zengin oluyorum galiba sözlük!
  entry_channels: anket,moda
- entry_name: |
    24 şubat 2020 kobe bryant cenaze toreni
  entry_id:  102584811
  entry_writer: asabi
  entry_fav_count: 0
  entry_content: |
    cenaze değil anma törenidir.. kobe bryant gizli bir törenle günler önce defnedildi..
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    hakan isimli bir şahsı durduramadığımız ve berbat bir kadroya sahip olduğumuzu gösteren bir maç dahadır.
  entry_channels: spor
---
