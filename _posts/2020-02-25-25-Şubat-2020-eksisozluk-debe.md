...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    bilgisayarı kasadan açmış efsane nesil
  entry_id:  102574766
  entry_writer: renksiz hayat
  entry_fav_count: 23
  entry_content: |
    suyu bardaktan içen nesille kapışır.
  entry_channels: teknoloji
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    istanbul büyükşehir belediyesinin adı "imamoğlu" olarak mı değişti merak ettiren zamlardır.<br/><br/>her kurum vatandaşı bir yerinden tutup sikiyor. bunlar hala fanatizm peşinde.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    çocuklar gibi. sabahattin ali ve sezen aksu
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    makarna daha proteinli daha doyurucu daha lezzetli... üç nokta sonsuzluğa yolcu
  entry_channels: anket,yeme-içme
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bu ülkedeki tüm arabalar ve evler benim üstüme olsa bile bu ülkede yaşamam.
  entry_channels: anket
---
