...
- entry_name: |
  ...
  entry_fav_count: 122
  entry_content: |
    üniversitede ilk sevgilisi ile 3 yıl , sonrasında 2 sene başka bir sevgilisiyle yaşamış ve okulu uzattığı 6. senesinde benim gayretlerimle mezun olmuş biri ile evlendim. bunun böyle bir tanımı olduğunu bu başlığı görünce yapabildim. <br/><br/>anlayamadığım durum; bunda ne var? hatta eşim evlenmeden önce 1 sene kadar da ingilterede yüksek lisans yaptı ve onu bekledim. o süre zarfında iki ev arkadaşından biri erkek bir fransızdı. güven olayı çok farklı bir şey arkadaşlar. siz karşınızdakine güvendiğiniz müddetçe bırakın gitsin. hata yapmadan geri döner zaten.<br/><br/>edit1: özelden neler geliyor neler.. ne genişliğim kaldı, ne midesizliğim. küfür edenler mi dersiniz. utanmaz herifler. siz türlü türlü ahlaksızlıklar yaptıktan sonra evlenin ve normal karşılayın, ama kadın beraber yaşadığı için sorun çıkarın değil mi? hadsiz herifler.<br/><br/>edit2: engellenecek kişileri başlıkta toplamam güzel olmuştur isteyen için. artık devamı sizde...
...
- entry_name: |
    24 şubat 2020 sgk tasarruf tedbirleri
  entry_id:  102573001
...
- entry_name: |
  ...
  entry_id:  102573608
  entry_writer: zampara ferit
  entry_fav_count: 54
  entry_content: |
    bir üstteki entry tarihin en büyük meriçliklerinde ilk 5'i zorlar.
...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    ağır enayiliktir. gelecekte babasi gibi aldatılırsa dımdızlak kalacaktır. bu sefer de lady diana olayı gibi suikast falan tezgahla uğraş dur. meghan'ı ortadan kaldır cinayete kaza süsü ver vs. uzun iş.<br/><br/>megan bunu sen artık prens değilsin diye terk ederse şaşırmayın. sonuçta kadın kadındır. statüye önem verir. neyseki eleman hâlâ zengin.
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    24 şubat imamoğlu metro zammı
  entry_id:  102574961
  entry_writer: uber insan
  entry_fav_count: 19
  entry_content: |
    aktroll başlıklarına yazmayın. lütfen.<br/><br/>(bkz: <a class="b" href="/?q=24+%c5%9fubat+2020+sgk+tasarruf+tedbirleri">24 şubat 2020 sgk tasarruf tedbirleri</a>)
...
- entry_name: |
  ...
  entry_channels: anket,sağlık
- entry_name: |
    atakan yüzünden flörtümü kaybetmem
  entry_id:  102566788
  entry_writer: ghemgg
  entry_fav_count: 14
  entry_content: |
    bu veletin bir işe yarayacağı aklıma gelmezdi. <br/>flörtünün zekasını ortaya çıkarmış daha ne?
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    (bkz: <a class="b" href="/?q=svihs">svihs</a>)<br/><br/>nasıl olsa emekli olamıyorum. beni ilgilendirmiyor. <br/><br/>alkole ve sigaraya gelen vergilere akp cenahının verdiği tepki birebir aynıydı. "nasıl olsa içmiyorum" diyorlardı. şimdi ben vergiden muaf ev yapımı biramı yudumlarken onlar düşünsün. <br/><br/>benim sgk primleri doldu ama 15 yıl beklemem gerekiyor emekliliği. o zamana kadar da kim öle kim kala. akp'ye oy veren emekli amcalara teyzelere kocaman sevgiler. biz yıllardır tadını çıkarıyoruz. şimdi zevk alma sırası sizde. <br/><br/>ekleme.
  entry_channels: siyaset,sağlık,haber,ekonomi
- entry_name: |
    kürtlerin çoğunlukla galatasaraylı olma nedeni
  entry_id:  102573474
  entry_writer: seylann
  entry_fav_count: 10
  entry_content: |
    kürt vatandaşlarımızın çoğunlukla galatasaraylı olduğu doğrudur. bu bence mükemmel bir şey. onların bu topraklarla olan bağlarını güçlendiriyor ve ortak noktalarımızı arttırıyor. bundan mutluluk duymalıyız.
  entry_channels: spor,siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    orospu çocuğu ak trollerin ortaya sictigi başlık
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  102564278
  entry_writer: ilk and son entry
  entry_fav_count: 3
  entry_content: |
    daha sonra asla asla daha iyi olmayacak.
  entry_channels: anket,sanat,edebiyat,sağlık,eğitim
- entry_name: |
    ekşi sözlük reklam ajansından iş teklifi almam
  entry_id:  102574658
  entry_writer: jurukhai
  entry_fav_count: 3
  entry_content: |
    bana da gelen ilginç mesajdır.<br/><br/>gönderen: @ormanlar krali bal porsugu<br/><br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>merhabalar, ekşi sözlük reklam ajansımızda freelancer olarak entry başına 20tlye çalışacak yazarlar aranmaktadır. size hazır başlık ve entry iletilecek, sizden istenen yere kopyala yapıştır yapmanız. eğer ilgileniyorsanız tylereksi@gmail.com adresine mail atabilirsiniz.<br/><br/>11.02.2020 17:02<br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>20 lira ne lan it?
...
- entry_name: |
  ...
  entry_channels: siyaset,tarih
- entry_name: |
    fenerbahçe'nin övünecek bir şeyinin kalmaması
  entry_id:  102575607
  entry_writer: skiptomyloujr
  entry_fav_count: 1
  entry_content: |
    ezeli rakibinin 100. yılında şampiyon olmuştur ve bunu başaran tek takımdır ve ülkemizde başka hiçbir büyük takim bunu başaramayacaktır çünkü bu durumun telafisi yoktur. bide ezeli rakibinin eski stadının kapanışını yapıp yeni stadının açılışını yapmıştır. hatta 2 ezeli rakininin de statlarinin açılışını yapmıştır. bunlar rencide edici gerçekler goygoyu bırakıp ciddi konuşacak olursak lig şampiyonlukları ve şampiyonlar lifi çeyrek finali vardır. şampiyonlar liginde o çıtayı ulaşılmış ancak geçilmemiştir. uzun zamandır şampiyonlar ligine gitmemesine rağmen son gittiği sene yakalanan çeyrek final başarısının üstüne hiçbir türk takımı çıkamamıştır. 20 sene sonra maç kazanınca ezeli rakibi şampiyon olmuş gibi sevindiğini görmesine rağmen övünecek bir şeyi yok diyorsa bunu diyen fanatik 10 yaşında olabilir.
  entry_channels: spor
- entry_name: |
