...
- entry_name: |
    kadınların aldatması sadakatsizlik sayılmamalı
  entry_id:  102574078
  entry_writer: umaci
  entry_fav_count: 25
  entry_content: |
    boktan trol. umarım evlendiğinde eşi beş çocuk yapar da hiçbiri kendinden olmaz, genlerini saçamaz. doğal seçilim bunu gerektirir çünkü.<br/><br/>edit: ekleme.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
    şaka maka galatasaray'ın liverpool'a dönüşmesi
  entry_id:  102580262
  entry_writer: dejavumu
  entry_fav_count: 14
  entry_content: |
    bir şeyi de abartmayın amk.<br/>not.gs
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    2010-2011 sezonu şampiyonu büyük camiadır.<br/><br/>fenerbahçe algı operasyonlarından, kamuoyu manipülasyonlarından çıkmış, bu sezon en zor psikolojik savaşları vermiş ve bulunduğu sıralamadaki konumunu futbolu ile hak eden spor kulübüdür. tıpkı sivasspor ve başakşehir gibi...<br/><br/>şimdi artık yine bulunduğu noktayı hak eden ve ülkenin tartışmasız en büyük futbol markasının, dillere destan son haftalardaki baskısını hissedecek ve kendini sınayacak...<br/><br/>sizinle yarışmak çok keyifli olacak fırtınalar... önümüzdeki haftaları sabırsızlıkla bekliyorum.<br/><br/>your move trabzon!
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    barış manço.<br/>anketörlük yapıyordum, moda'da evinin önünden geçiyordum.<br/>çıksa da imza alsam diye içimden geçirirken, çıktı ve suzuki vitarasına bindi.<br/>yaklaştım, camı açtı. tabi ver kalem var mı, dedi kalemin ucu içine kaçtı. korktum bir an yazmayacak diye. ama yazdı. imzasını attı, hadi bakalım dedi gitti...
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    iyice rezil olmuştur.<br/><br/><a class="b" href="/?q=ismail+saymaz">ismail saymaz</a> <br/><br/>"yarın çin pkk'yla barışsa yarın dağdasınız"
  entry_channels: siyaset,haber
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    kapalı bacılara hep kolay soran program. amcanın amına koydular bi de kapalı kıza gelen sorulara bak.<br/><br/>edit: yuh ebesinin amı, 30 binlik soruya bak: hangisinin çapı daha küçüktür, cevap plüton. az önceki adama gelen sorulara bak, heheyttt. zaten ses sistemini deniyodum, bi daha da izleyeni siksinler.
  entry_channels: tv
- entry_name: |
...
- entry_name: |
    üst kattan gelen koşan çocuk sesi
  entry_id:  102580304
  entry_writer: always good
  entry_fav_count: 2
  entry_content: |
    3.5 ay boşuna ev aramadım. yaklaşık 30 üzeri ev kovaladım. sorduğum birinci soru şu idi üst ve alt katında kim oturuyor, çocuğu var mı? ev sahibi mi?. ev sahibi değilse kaç zaten. yarın malın birine kiralar yanarsın maksat kira gelsin.<br/><br/>dağ ayılarının ortak alan kullanımı sonucu oluştu. gecekonduda ömrü geçmiş adama apartman dairesi verirsen böyle olur. üzerine bir de 120-130 m2 ev yaparsın kabile gibi yaşarlar.<br/><br/>yakıttan yana düşünceniz yoksa en üst katı kiralayın ya da satın alın, altınızdakini de iyi seçin. malum yeni binaların kolon ve kiriş dışındaki duvarları bildiğin kağıt. osursanız duyuluyor ve alt-üst farketmiyor.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
    sonu ak ile biten sözcükler
  entry_id:  102580958
  entry_writer: mgkgunay
  entry_fav_count: 1
  entry_content: |
    seviye tespit sınavı gibi başlık.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
    şu an okunan kitap
  entry_id:  102582590
  entry_writer: ladybyron
  entry_fav_count: 0
  entry_content: |
    nar ağacı - nazan bekiroğlu<br/>sen öyle çağırmasan ben böyle gelmezdim...
...
- entry_name: |
  ...
  entry_id:  102581782
  entry_writer: endemikbitkiortusu
  entry_fav_count: 0
  entry_content: |
    sadece göksenin’e odaklanın hücumda. ne yapıyor bakın bi. çok eğlenceli.
  entry_channels: spor
---
