...
- entry_name: |
  ...
  entry_fav_count: 107
  entry_content: |
    6 yıldır fenerbahçe'yi kadıköy de yenemiyoruz o sene bu sene inşallah...
...
- entry_name: |
    türkiye'nin çöküşün eşiğine gidiyor oluşu
  entry_id:  102578001
  entry_writer: vivra
  entry_fav_count: 77
  entry_content: |
    “herkes biliyor, geminin su aldığını. herkes biliyor, kaptanın yalan söylediğini. ve herkes biliyor, zarların hileli olduğunu.” <br/><br/>leonard cohen
...
- entry_name: |
  ...
  entry_fav_count: 66
  entry_content: |
    yer istanbul<br/>mecidiyeköy bi arkadasımın tavsiye si ve ısrarı üzerine eskort randevusuna gittim,<br/>sonuç baskın oldu<br/>apar topar sivil arabalar la ismini vermiyim<br/>karakola götürüldüm,<br/>sadece ifademin alınacağını söylediler hiç birşeyini etkilemez karsına cıkmaz der gibisinden.<br/>yaklaşık 3 saat bekletildim<br/>sonra beni ifade için odaya aldılar<br/>memur:kaç para verdin lan buna<br/>ben:.......verdim<br/>memur:ulan o paraya bumu yapılır dedi<br/>ve telefondan cıkarıp bana eskort resimleri göstermeye basladı gidiceksen bunlara git... :)<br/>biraz güldüler eğlendiler, sonra saldılar beni
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    kişilik olarak benzenen film karakteri
  entry_id:  102570513
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    çirkin kızlardan hoşlanmak
  entry_id:  102565335
  entry_writer: mahoney1907
  entry_fav_count: 25
  entry_content: |
    porno izlerken benim de hissettiğim duygu. nedense kusursuz güzellikteki "bebek gibi" diye tabir edilen kızların videolarını asla izlemem. çünkü tahrik etmiyor. sanki gercek değilmiş gibi geliyor bana. ama soyle cok hafif göbekli, porselen makyajı olmayan, memeleri doğal olan tipi yani çarsıda pazarda karşılaşacağınız kadar ortalama bir hatun görürsem anında acar izlerim. baha gerçekçi geliyor sanırım ondan. az çirkin kız güzeldir.
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 24
  entry_content: |
    adım atmayı sevmiyordur.<br/><br/>öyle adım adım değil de koşa koşa seviyordur.<br/>mıymıymıy uzatmalı uzatmalı hallerle uğraşmak istemiyordur.<br/>ya vardır ya yoktur kafasındadır.<br/>karşısındakinin "karışık sinyalleri" nedeniyle "yok anam babam ben bunlarla uğraşamam" diyordur. <br/><br/>net olun, net olak... varsa var, yoksa yok. gerek yok öyle adım adım, mıy mıy mıy...
  entry_channels: anket,ilişkiler
- entry_name: |
    migros bozuk et rezaleti
  entry_id:  102578371
  entry_writer: meslekden cikip ituden mezun olan adam
  entry_fav_count: 23
  entry_content: |
    küflenme değil mühürlü kısmı gelmiş dedirten, olmayan rezalet.<br/><br/>migros, tarım bakanlığı tarafından birşey bulsak da ceza yazsak diye sık sık denetim yiyen kurumdur.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    çok bilindik bir gerçek vardır o da; osmanlı, beylik dönemindeyken dikkatleri olumsuz yönde üstüne çekmemiştir. hamken, gücünü daha kazanmamışken etliye sütlüye bulaşmamış diğer beyliklerle gayet iyi geçinmiştir. karesioğulları'nı bildiğimiz miras yoluyla, germiyanoğulları'ndan çeyiz yoluyla ve parayla da hamitoğulları'ndan toprak alarak asla ama asla tepki çekmemiştir. üstüne üstlük sürekli ortodoks hristiyan olan doğu roma ile mücadelesi ile de takdir kazanmayı bilmiştir. <br/><br/>bu bilinen bilgilerden sonra işin sosyo-kültürel boyutuna biraz derinlemesine bakmak gerekiyor zannımca. osmanlı, beylikten devlete geçiş sürecindeki olaylarda yine hoşgörülü ve serinkanlı davranmayı başararak aslında yıldızını parlatmayı bilmişti. moğol(tatar) zulmünden kaçan tengrici türkmenler olabildiğince uzak yerlere yerleşmek istemişlerdi. bu topraklar osmanlı toprağından başka topraklar olmayacaktı elbette. bu türkmenler islamiyet'e geçiş yaparken işin aslı tasavvuf ekolünün başlangıcı sayılabilecek isimlerin de aracılığıyla günümüzdeki anadolu islamiyet'inden daha farklı, ilerleyen yıllarda karşımıza ''bektaşi'' olarak çıkacak ama o dönem hoca ahmet yesevi'nin öğrencilerinin yaymaya başladığı genel manada kızılbaşlığın temeli atılan bir dönemi göreceğiz. orhan gazi'nin kardeşlerinden alaaddin bey(şehzade ali ya da alaaddin) bektaşi geleneğini osmanlı'ya sokacaktır. bu da osmanlı'nın 80'ler dönemi siyasi terimiyle ''kültür mozaiği''nin ilk mozaiklerini döşemeye başlayacaktır. babai isyanı'na göz atmanız o dönemki anadolu din anlayışını anlamakta çok faydalı olacaktır. bunları anlatmamın sebebi, herkes osmanlı beyliği'ni kendine yurt görmek için nedenler buluyordu. moğol zulmünden kaçanlar, bektaşi geleneğini sürdürmek isteyenler, hristiyanlar ile savaşıp gazi ve şehit olmak isteyenler ve herkes, bir neden buluyordu.<br/><br/>işte tüm bunların ışığında osmanlı o dönem için çok önemli olan insan ihtiyacını fazlasıyla karşılıyordu. ayrıca diğer beylikler kendi aralarında birbirleriyle cenk ederken ya da moğol'u ile tatar'ı ile uğraşıp kan kaybederken osmanlı emin adımlarla kısık ateşte yavaş yavaş büyüdü. bilirsiniz kısık ateşte pişen yemeğin tadı bir farklı olur. osmanlı'da bu kısık ateşin bir ürünüydü ve tarih bize aradaki kalite farkını fazlasıyla gösterdi.<br/><br/>kabaca bunları anlatabildim. elbette fazlasıyla yetersiz. bu başlığa kalınca bir kitap dahi yetersiz gelir çünkü her anlamda ele alınması gereken bir konu fakat kendimce en önemli gördüğüm iki konuyu yani siyasi ve sosyal konuları ele almak istedim. bu konuda bana göre okunacak en büyük iki isim fuat köprülü(özellikle osmanlı'nın kuruluşu hakkında paris'te verdiği konferanslar bir çok otoriteye cevap niteliği taşır) ve halil inalcık'tır elbette.<br/><br/>osmanlı'nın içerisindeki mezhepler, dini anlayış bence hiçbir yerde doğru anlatılmıyor ve atlanması çok yanlış konular. çünkü türkiye cumhuriyeti, osmanlı imparatorluğu'nun bir yansıması. hala o dönemden kalma sorunlarla uğraşıp duruyor, birbirimizi yiyoruz. tarihin bana öğrettiğin en net şeylerden biri; siyasi birliğini tamamlayan her millet güçlenmiş ve güçlü kalmıştır. osmanlı bu birliği sağladı. doğrusuyla yanlışıyla ama sağladı.
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    kes lan diye diye izliyorum şu tıp okuyan kızı.<br/>allahın iticisi. <br/>anladık sen yaptın sen istedin her şeyi yaptın. sen sen sen
  entry_channels: tv
- entry_name: |
    buzu kırıp soğuk suda köpek kurtaran rus kadın
  entry_id:  102573970
  entry_writer: amyleegod
  entry_fav_count: 16
  entry_content: |
    t: insanlığına hayran kaldığım pırıl pırıl bir hanımefendi<br/><br/>çok affedersiniz yine sayın amına koduğumun biri damlamış "bizdiki şirifsizlir di kipiksiz sikik istiyiriz diyi iğliyirlir"<br/><br/>2 gram ingilizcenle oku bakayım haberi sokak köpeği miymiş o kurtarılan köpek ? toplam kaç tane sokak köpeği var avrupa'da ve türkiye'de kaç tane var aç bak bakayım. bakılma şartlarına falan bakmayı da unytma ama. eğitilmez medeniyetsiz barzolarsınız başka bir şey değil. köpekleri gerçekten seven bir insan onların sokakta kalmaması gerektiğinin farkındadır. bununla ilgili de uzunca bir entry döşeme vaktim geldi geçiyor da başka güne saklayacağım.
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    sony firmasının tanıtmış olduğu akıllı telefon.<br/><br/>telefonun özellikleri şu şekilde;<br/><br/>181gr ağırlık<br/>ip 65/68 suya ve toza karşı dayanıklılık<br/>snapdragon 865 işlemci<br/>8gb ram<br/>4k 1644x3840 oled 21:9 ekran (643ppi)<br/>4000mah batarya<br/>12 megapixel 3 arka ve 8 megapixel ön kamera<br/>5g uyumlu altyapı <a rel="nofollow noopener" class="url" target="_blank" href="https://www.sony.com/electronics/cell-phones/xperia-1m2" title="https://www.sony.com/electronics/cell-phones/xperia-1m2">kaynak</a> <br/><br/>telefon piyasasında sony bir çöküş döneminde. şayet eski bir sony kullanıcısı olarak ben sony'i çok severdim ama saçma fiyat politikasından ve yazılım desteğini kesmesinden sonra uzak durdum ama eğer ucuz olsa hâlâ alacağım ilk android telefon olurdu.<br/><br/>sony'nin açıkladığına göre telefondaki kameralar, zeiss lensle birlikte sony'nin profesyonel kameralarda kullandığı cinealta serisinden sensör, işleme yeteneğine sahip bir kamera yazılımıyla gelecek. bu durumda dxomark'ta xiaomi'nin şu anlık oturduğu koltuğu sallayacaktır.<br/><br/>edit: imla
  entry_channels: teknoloji
- entry_name: |
    serdar aziz
  entry_id:  102552614
  ...
  entry_fav_count: 14
  entry_content: |
    <a class="b" href="/?q=maldiv+fatihi">maldiv fatihi</a> ikinci yarının başında falcao ile bir ikili mücadeleye girdi. hava topu esnasında yer alma mücadelesiydi. gelen top yüzünün tam ortasına geldi. bu da acıdan yere yattı. feghouli, galatasaray atak yapacakken topu taca attı. fenerbahçe'li bir iki isim hakeme var kontrolü yapmasını istedi. bu da burnunu tutarken "vurdu" işaretleri yaptı. hakem oyunu hava atışı ile fenerbahçe lehine başlattı.<br/><br/>maldiv fatihi de kendine yakışır şekilde centilmence topu galatasaray'a vermedi. topu aldı, sağına çekti. jailson'a pas verdi. takımı atağa başlattı.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    "créme de la créme"<br/><br/>ne var lan? ben hiç görmedim babanemi :(
  entry_channels: anket
- entry_name: |
    survivor 2020 ünlüler-gönüllüler
  entry_id:  102549211
  entry_writer: nikimmikimyok
  entry_fav_count: 3
  entry_content: |
    acuncu'ğum okumuş yorumları. sponsor adidas olmuş, oyunlar bazen 5'te bitiyor, ada hayatı daha uzun veriliyor. ama en önemlisi, yarışmacılara cılbak yarışabilirsiniz denmiş. erkeklerden tek özgüvenli de, kıllı yufka ersin çıktı iyi mi? barış'cığım, bence sen de ersin abine katılabilirsin bu konuda. tişikkirler acun.
  entry_channels: tv,magazin
- entry_name: |
    şu anda çalan şarkı
  entry_id:  102563379
  entry_writer: madame borderline
  entry_fav_count: 2
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://open.spotify.com/track/2mZIlQojKiKxql5hRvccOP?si=JuDR09RHQLGdUcpssPHR8g" title="https://open.spotify.com/track/2mZIlQojKiKxql5hRvccOP?si=JuDR09RHQLGdUcpssPHR8g">utanmazsan unutmam - adamlar</a><br/><br/>“ömrümüzün en güzel yıllarına<br/>patlayanın ne evinde bir ayna var<br/>ne içinde bir yürek<br/>gençliği haybeye yenmiş<br/>yorgun ve yalnız nesil<br/>birbirini buldukça<br/>düşmedi, düşmeyecek”<br/><br/>“albümü tümüyle bırakayım en iyisi” editi:<br/><a rel="nofollow noopener" class="url" target="_blank" href="https://open.spotify.com/album/1IiugjbB8zJ439hxoIgm2m?si=x6WupdqqQJi2qV07a1bdaQ" title="https://open.spotify.com/album/1IiugjbB8zJ439hxoIgm2m?si=x6WupdqqQJi2qV07a1bdaQ">eski dostum tankla gelmiş - adamlar</a>
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    20 yıl önce portakalda vitamin olanlara dert olmuş yazardır.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    ender‘in giydigi leylak rengi takimin üstüne sürdügü mavi ruj gercek miydi?
  entry_channels: tv,tarih,müzik,edebiyat
- entry_name: |
    osmanlı yerine karamanoğulları olsaydı olabilecek
  entry_id:  102578818
  entry_writer: career a
  entry_fav_count: 1
  entry_content: |
    devşirme sistemi olmadığı için ülke evlilikler yoluyla saraya giren sülaleler nedeniyle kısa sürede parçalanır, karamanoğullarını ya bizans tekrar güçlenip bitirir ya da memlükler (kölemenler) bitirirdi. coğrafi olarak da yıkılmaya osmanlılardan daha yakın bir konumdalardı.<br/><br/>kimisi osmanlıları devşirmeler bitirdi dese de, ortadoğu kültürü ile bu denli uzun hükümranlık sürmesinde en büyük etkinin devşirmeler olduğunu düşünüyorum.
  entry_channels: 
- entry_name: |
    ekşi sözlük dertleşecek insan veritabanı
  entry_id:  102569493
  entry_writer: kafam1milyar
  entry_fav_count: 1
  entry_content: |
    kadın dayanışmasının olduğu, rahat ve özgürce sohbet edilebilen, anonim kalmakta hiçbir beis görülmeyen güzide dertleşme ve hoşbeş platformu.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://discord.gg/ZEzDDxk" title="https://discord.gg/ZEzDDxk">discord kanalı.</a>
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    24 şubat 2020 çaykur rizespor başakşehir maçı
  entry_id:  102580138
  entry_writer: aronfellers
  entry_fav_count: 1
  entry_content: |
    ulan okan buruk'a bak sen ya herif 83 de cift forvete döndü forvete koydugu 2. adamda skertel, tuhaf olan skertel gölünu forvet olarak atti ve direk savunmaya gecti takdiklere baksen ya .akfkdk
  entry_channels: spor
- entry_name: |
    şu an okunan kitap
  entry_id:  102580294
  entry_writer: abiquiu
  entry_fav_count: 0
  entry_content: |
