...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    herkes sıfırından daha pahalı 2.el fiyatından şikayetçi lakin galerilerde sıfır araç yok 3-4 ay sonrasına sıfır araç opsiyonlasan fiyat garantisi yok bu durumda bugün için 2.elin sıfırdan yüksek olması çok normal, üstelik dolar ve euro yeniden artış trendinde bir kur krizi daha yaşarsak şimdiki fiyatlara temizinden en az %30 daha eklenir. ihtiyacı olan alsın bu ülkede ne sıfır ne 2.el araç fiyatı düşmez daha doğrusu bu ülkede insan hayatı dışında hiçbir şey ucuzlamaz.
...
- entry_name: |
    e-devlet isim değişikliği hizmeti
  entry_id:  102541232
  entry_writer: ladydudley
  entry_fav_count: 6
  entry_content: |
    bir an için gerçek sandım. adımı feriha koyacaktım.
...
- entry_name: |
  ...
  entry_id:  102578332
  entry_writer: uzun ot
  entry_fav_count: 1
  entry_content: |
    eşik çoktan aşıldı. problem doğrudan ekonomi değil. problem devletin çökmesi. devlet yok. adalet yok. eğitim yok. güvenlik yok. sağlık yok teknoloji yok. mülkiyet hakkı yok. gelecek kaygısı var. kültür çatışması var. <br/><br/>bu bir devlet çöküşüdür. üçüncü sayfa haberleri normalimiz oldu.
  entry_channels: 
- entry_name: |
    sony xperia 1 ii
  entry_id:  102561246
