...
- entry_name: |
  ...
  entry_fav_count: 32
  entry_content: |
    ulan biz boşa evdeyiz şu otobüse bak lan
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    fatih terim'in 4 gün sonra ölme ihtimali gerçeği
  entry_id:  104085028
...
- entry_name: |
    migros'a genelde güzel kadınların gitmesi
  entry_id:  104085052
  entry_writer: sernevist
  entry_fav_count: 12
  entry_content: |
    artık marketleri bile güzel kızlara göre ayırdıysanız bugünkü abazalık gününüzü kapatmış bulunmaktasınız tebrikler, gün birincisi oldunuz
  entry_channels: 
- entry_name: |
    24 mart ülke genelinde dua okunması
  entry_id:  104085258
  entry_writer: ayaaan
  entry_fav_count: 11
  entry_content: |
    camilerden şu an okunuyor.. bizi korona değil bu cahillik öldürecek.. iflah olmaz orospu çocukları bunun 15 temmuzla ne alakası var?
  entry_channels: 
- entry_name: |
    ekşi itiraf
  entry_id:  104040493
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    markette hazır sütü içip yerine koymak
  entry_id:  104083082
  entry_writer: natalya tommiks texas julyet
  entry_fav_count: 7
  entry_content: |
    ülkedeki o. çocuğu sayısı virüsten daha hızlı artıyor....
...
- entry_name: |
    coronanın yaşlı nüfusu azaltma projesi ihtimali
  entry_id:  104084851
  entry_writer: biravekahve
  entry_fav_count: 5
  entry_content: |
    projeyse proje. önleyebiliyor musun? yok. sıkıldım komplodan. hayır komplo hastası adamım ama ben bile sıkıldım amq.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    kim neyden o kadar bahsederse onda o yoktur.<br/>yanı ahlak, erdem, şu bu bahseden varsa. <br/>en büyük ahlaksız kendisidir.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=fettah+kahraman">fettah kahraman</a>)
  entry_channels: haber
- entry_name: |
    24 mart 2020 camilerden dua ve sela okunması
  entry_id:  104086547
  entry_writer: nicholsonn
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=sela+ve+dua+ile">sela ve dua ile</a>)
  entry_channels: 
---
