...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    marmaris'in 1986 yılında çekilmiş görüntüleri
  entry_id:  104086204
...
- entry_name: |
  ...
  entry_fav_count: 61
  entry_content: |
    yeni nesil bilmez eskiden ehueuhueuheuhuehuehue vardı.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: haber,ekonomi
- entry_name: |
    tanrının saf enerji olma ihtimali
  entry_id:  104077466
  entry_writer: workerbee
  entry_fav_count: 59
  entry_content: |
    tanrı enerji ise, durecell reklamındaki tavşan peygamberdir.
  entry_channels: bilim,tarih,eğitim
- entry_name: |
    arapça bağırarak virüsle savaşmak
  entry_id:  104088096
  entry_writer: sevimsiz karga
  entry_fav_count: 53
  entry_content: |
    bana biraz olmaz gibi geliyor. <br/>ayrıca; (bkz: <a class="b" href="/?q=hayatta+en+hakiki+m%c3%bcr%c5%9fit+ilimdir">hayatta en hakiki mürşit ilimdir</a>)
  entry_channels: siyaset,sağlık
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  104084083
  entry_writer: grammaton rahibi
  entry_fav_count: 50
  entry_content: |
    ulan biz boşa evdeyiz şu otobüse bak lan<br/><br/>edit: dikkat ettim de video eskiymiş.. eski bir video. ah eski günler.
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    24 mart erkan akçay twitter paylaşımı
  entry_id:  104086796
  entry_writer: garipbasci
  entry_fav_count: 45
  entry_content: |
    şu adam mecliste seni beni temsil ediyor. sonra niye geri kaldık.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
    camiler kapalıyken imamların maaş alması
  entry_id:  104074981
  entry_writer: birdposing
  entry_fav_count: 31
  entry_content: |
    öğretmenler doktorlar eleştiriliyor sürekli maaşlarıyla.zaten islamda imamların para alması dinin para kazanmak için kullanılması mekruhtur <br/>kurandan kaynaklar (bkz: <a class="b" href="/entry/104089527">#104089527</a>)<br/>buradan kampanya başlayıyorum şuanda corona virüs nedeniyle kapalı camiler sebebiyle çalışmayan imamların maaşları aşı çalışması için ayrılmalıdır.diyanetin bütçesi tamamına yakını aktarılabilir.akşamları sela okunacağına aşı çalışması için kullanılırsa bu bütçe ile 1 yıl içinde ülkemizin aşıyı ilaç şirketlerinden önce bulacağına inancım tam.
...
- entry_name: |
  ...
  entry_fav_count: 24
  entry_content: |
    korona'nın ek paketi mi bu şerefsizler, bu kadar çoğaldılar son zamanlarda? <br/><br/>bir de aldığı yere değil, aralara koyuyor. eskilerden beri alışkanlığımdır, ürünleri seçerken önden değil de ortadakilerden birini alırdım. artık bir işe yaramadığını öğrenmiş oldum.<br/><br/>tanım: koronavirüsten daha az gelişmiş tek hücreli canlı.<br/><br/>edit: bu görüntüyü savunmuşlar bazı yazar arkadaşlar. belki satın aldı sonradan ya da marketle anlaşmalıdır diye. fakat çekilen görüntü bana sözde şaka amaçlı pis bir eylem yapıldığının imajını veriyor mu? veriyor. bunun reel olduğunu varsaymalıyım çünkü eğer reel değilse bile bu iğrenç videonun potansiyel gerçek versiyonlarına yol açacağı bir gerçek.<br/><br/>o zaman gidin amcayı korkutan, başka bir amcanın kafasına kolonya döken adamı da savunun. amcalarla anlaşmışlardır belki onlar da.
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    “çocuklar ve karşılıksız aşk yaşayan kadınlar, aynı görmezden gelinmişlik dünyasında yaşarlar ve ellerinde olmadan zalim olurlar”<br/><br/>(bkz: <a class="b" href="/?q=yukio+mishima">yukio mishima</a>)
  entry_channels: anket,sanat,edebiyat
- entry_name: |
    sela'nın virüsler üzerindeki etkisi
  entry_id:  104087696
  entry_writer: manasicokderin
  entry_fav_count: 12
  entry_content: |
    ben virüs. şuan domestos reklamında üzerine domestos dökülen mikroplar gibi avazım çıktığı kadar bağırıyor ve eriyorum.. bunlar son sözl...
  entry_channels: siyaset,sağlık
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    maddi ve manevi bir çok zararı var. fakat bir tane bile gerçekçi faydası yok. <br/>içenlerin fayda diye söylediği her şey kendileri öyle görmek isteyip, psikolojik olarak ona inandıkları için öyle hissettirmesi. sigarayı bırakmak isteyenlerin, öncelikle sigarayı algılama biçimlerini değiştirmeleri gerek. haliyle inancı değiştirmek en zor olan olduğu için bırakmak zor geliyor.
  entry_channels: anket,sağlık,yeme-içme
- entry_name: |
    tutunamayanlar (dizi)
  entry_id:  104087375
  entry_writer: cehovunvisnebahcesi
  entry_fav_count: 5
  entry_content: |
    asuman dabak tiyatrosu gibi hahaahqhq
  entry_channels: tv,sanat,sinema,edebiyat,spoiler
- entry_name: |
    baraj (dizi)
  entry_id:  104086726
  entry_writer: lsd
  entry_fav_count: 4
  entry_content: |
    umarım patlar. tam bir ala gavat dizisi. o değil, ısparta’nın adını çıkaracak.
  entry_channels: tv
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    suç amk. biraz insan olun insan.<br/><br/>not:fatih terim düşmanı
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    kullandığı telefonla ilgi toplayacağını düşünüp, beklediği ilgiyi göremeyen bur geri zekalının açtığı başlık. daha ucuz ve daha özellikli olan xiaomi kullanıcıları olarak o ilgiyi biz görüyoruz. sen şu arkada tek oturan sığırsın herhalde.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    700 kişi kesinlikle ölmedi. ölü sayısı 70 gibi açıklamalar duyarız. ölü sayısının 700 olduğunu söyleyenler de bölücü hain ve terörist ilan edilir. çok şükür cenazeleri yıkayacak imam konusunda sıkıntı çekmeyiz.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    karakol komutanım üsteğmen. zaten küçücük karakol olduğu için en yüksek rütbeli oydu. <br/>bir gün karargah binasına girdim, arkadaşa sordum abdullah geldi mi, sonra yan odadan bir ses bağırdı abdullah kim ulan !?! meğer gelmiş :)
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    hayattan soğutan o iğrenç, zehir zıkkım kokunun içmeyen birisini ne kadar rahatsız ettiğini bir düşünün yeter. <br/><br/>bazılarıda içerken çok cool olduğunu, sosyal ortamlarda şekil yaptığını falan zannediyor. ben size bir şey diyeyim mi, kül tablası gibisi mide bulandırıyorsunuz.
  entry_channels: anket,sağlık
- entry_name: |
    cem adrian
  entry_id:  104089894
  entry_writer: bloodymaryninhayaleti
  entry_fav_count: 0
  entry_content: |
    yağmur şarkısını yağmur yağarken dinlemek muazzam.
