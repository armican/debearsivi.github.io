...
- entry_name: |
  ...
  entry_fav_count: 39
  entry_content: |
    büyük ihtimalle zerre varlık gösteremeden, 2-3 farklı bir mağlubiyet ile döneceğimiz maç olacak.<br/><br/>galatasaray uzun süredir rezalet oynuyor. türkiye liginde rakipler beceriksizliklerinden ve galatasarayın adından korkup bunu cezalandıramasa da avrupada bu durum tam tersi oluyor genelde. <br/><br/>hücum planımız yok, form durumumuz çok kötü, defansımız zaten evlere şenlik, beklerimizin kıçını kaldırmaya hali yok, orta sahamız zaten tam oturmadı... galatasaray bu maçta 1 puan alacaksa, o da maksimum, muslera sayesinde alır. o da formda olmazsa kıçımıza baka baka geri döneriz bu deplasmandan.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    traktörün altında kalarak can veren öğrenci
  entry_id:  95425582
  entry_writer: askinizm
  entry_fav_count: 14
  entry_content: |
    karşıdan karşıya geçmeye çalışırken traktör çarpmış. traktör, trakt, trak.<br/>çok saçma, traktörün maksimum yapabileceği hız ne ki kampüs içinde kavşakta yayaya çarpsın. ya ağır bir ihmal var ya da başka bir şey.
  entry_channels: haber
- entry_name: |
    luiz gustavo dias
  entry_id:  95435407
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    türk aile yapısına aykırı bir davranıştır. şöyle ki; işe başlayan genç akrabalar tarafından borç istenebilecek, daha ne masrafı var ki düşüncelerine konu olan bir insan evladıdır. ve söylememe gerek yok sanırım o borçlar geri dönmeyecek. <br/>dolayısıyla böyle üç beş çarpılan genç 'ulan bi araba alayım da bari borç var diye kimse istemez' mantığına girer ve mevcut döngüye katılır. eğer insanın borcu biterse alacağı çoğalmaya başlar. buna borç alacak kaosu diyebiliriz. bi ara eğrisini çizeriz.
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    <a class="b" href="/?q=adana">adana</a><br/>şehir olan.
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    gün gelecek bin ladin gibi saçma sapan bir şekilde alelacele tarihin karanlığına yollanacak. gönül ister ki ibreti alem için, yaptıklarının bedelini ödesin.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    yalnızlığın zaten biraz da kendinle sevgili olmak değil mi ki? seviyorum kendimi, çok akıllı kadın. <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    çok dertliyim sözlük. kanadım kırıldı kaldım burada. yine yalnızlık yine alkol yine soğuk yine yalnızlık yine soğuk yine alkol.. yok mu bir çaresi?
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    bira içmelik arkadaş veritabanı
  entry_id:  95434368
  entry_writer: cunku kavganin gobegidir benim yerim
  entry_fav_count: 0
  entry_content: |
    izmirdekiler yeşili yakın.
