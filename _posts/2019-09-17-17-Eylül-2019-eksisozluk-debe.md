...
- entry_name: |
  ...
  entry_fav_count: 82
  entry_content: |
    sitede fenerli kalmadı vpn ile wikipediaya girip geçmişten bir şampiyonluk daha çıkarmaya çalışıyorlar galiba.<br/><br/>linç yemeden gelen edit; fenerbahçe, her sene kadrolarının daha geri gittiğini görmeyen taraftara sahip türkiyenin iki büyüğünden biri. son 6-7 senedir her sene bir öncekinden daha kötü kadro kuruyorlar fakat hep bir şekilde başkanları tarafından güdüldükleri için bunu farkedemiyorlar. umarım başkanlarının 29. şampiyonluk saçmalığıyla gezmesine tepki gösterip,uyanıp neden sol bek ve stoper almadığını sormaya başlarlar ve en yakın zamanda eski günlerine dönerler. uyanın beyler jailson ve zankayla hurra diye 6. haftayı kovalıyorsunuz.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 35
  entry_content: |
    maç sonu "alanya'ya yenilerek <a class="b" href="/?q=belki+de+galatasaray%27%c4%b1+%c5%9fampiyonluktan+ettik">belki de galatasaray'ı şampiyonluktan ettik</a>" demesini beklediğim türk futbolunun şişirilmiş zeplini.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    üç tarafı açık olan ve burada sigara içilebilir ibaresi olan her yerde sigara içebilir.<br/><br/>yasalara uygun davranıyordur. <br/>sigara içilmez ibaresi olan bir yerde sigarasını içiyorsa hayvandır. <br/><br/>buna rağmen aksini iddia eden hayvanoğlu hayvandır.
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    formunun zirvesinde olan fenerbahçe ile formunun dibinde olan galatasaray 4. hafta itibari ile aynı puandalar.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    "gerçekten" çok yorgunum. gerçekten vurgusu önemli.
  entry_channels: anket,ilişkiler
- entry_name: |
    ekşi itiraf
  entry_id:  95414001
...
- entry_name: |
  ...
  entry_id:  95441364
  entry_writer: bickhead
  entry_fav_count: 1
  entry_content: |
    neden hala birisi “parola kurtarma güvenlik sorusu değil mi lan bu?”diye işkillenmemiş acaba
  entry_channels: anket
- entry_name: |
    ulaşılan en yüksek kilo ile şu anki kilo farkı
  entry_id:  95440408
  entry_writer: konuronko
  entry_fav_count: 0
  entry_content: |
