...
- entry_name: |
    kürtleri akp'ye oy vermeye çağırmak
  entry_id:  89909739
  entry_writer: otobana durdum seyrettim aleni
  entry_fav_count: 569
  entry_content: |
    bir kürt olarak avucunu yalarsın aktroll diyeceğim önermeler dizisi.
...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    ysk'nın tespit ettiği usulsüzlükler
  entry_id:  89904922
  entry_writer: sen gelsene bi
  entry_fav_count: 351
  entry_content: |
    yalana gerekce arayan birilerinin çırpınışı.<br/><br/>sandık kurullarına itiraz 2 martta bitmisti. akp ve ysk o zamana kadar tavir almaliydi. ondan sonraki itirazlar gecersizdir.<br/><br/>tam kanunsuzluk icin itiraz zorunlu degildir. o sandıklardaki 42 bin oy tartismaliysa etkisi diger oylara da etki eder. o oylarin degisimiyle belediye baskanliklari da degisebilir. hele meclis uye sayisi ve muhtarliklar kesinlikle degisebilir. <br/><br/>khk ile atilanlarin secimlerde gorev alamayacagina dair bir duzenleme yoktur.hala da yoktur. bu fikri ysk secimden sonra gelistiemistir secimden once boyle bir yorumu yoktu.<br/><br/>sadece chp li degil akp li belediyelerden de calisanlar sandikta gorev yapmistir. gerek banka calisanlarinin gerekse belediye calisanlarin sandik kurullarinda calismasina yasal bir engel yoktur, daha onceki aecimlerde de yoktu, 23 haziranda da olmayacaktir.<br/><br/>sandık kurulu baskan ve uyelerinin partilere uye olmalarina yasal bir engel yoktur. parti uye olma yasagi sadece memurlar icin gecerlidir. sandik kurulu uyelerinin memur olma zorunlulugu da yoktur.<br/><br/>jandarma artik yasal olarak silahli kuvvetler mensubu sayilmamaktadir. dolayisiyla sandik kurullarinda jandarma kokenli uyeler gorev yapabilir.<br/><br/>emeklilerin sandik kurullarinda gorev yapmasinda yasal bir engel yoktur.<br/><br/>kapatilan sirketlerde is akdiyle calisanlarin sandik kurulunda gorev yapmasina yasal engel yoktur.<br/><br/>aktrolumuz partisinin hukuk birimine sorsun, onlar da aynisini soyleyecektir. zaten secim kanunu ilkokul cocugunun bile kolayca anlayacagi kadar basitce yazilmistir.<br/><br/>butun surecleri diledigi gibi yonlendiren akp iken hileyi nerede aramak lazim?
...
- entry_name: |
  ...
  entry_fav_count: 262
  entry_content: |
    muhtemelen ay'a ilk ayak basan türk, bir liseli olmayacağı için;<br/>(bkz: <a class="b" href="/?q=istikbal+g%c3%b6klerdedir">istikbal göklerdedir</a>)
  entry_channels: anket
- entry_name: |
...
- entry_name: |
    imamoğlu kitlesinin aşırı küfürbaz olması
  entry_id:  89919060
  entry_writer: hazy
  entry_fav_count: 191
  entry_content: |
    ananı sileyim sildir git.
...
- entry_name: |
    en karizmatik dizi repliği
  entry_id:  89910484
  entry_writer: sentenza
  entry_fav_count: 159
  entry_content: |
    (bkz: <a class="b" href="/?q=i+am+not+in+danger+i+am+the+danger">i am not in danger i am the danger</a>)
  entry_channels: anket
- entry_name: |
    iyi başladıktan sonra boka saran diziler
  entry_id:  89903727
  entry_writer: rulesonbullets
  entry_fav_count: 155
  entry_content: |
    iyi başlayıp boka sarmayan tek dizi aklıma geliyor.<br/>(bkz: <a class="b" href="/?q=breaking+bad">breaking bad</a>)
...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    ekrem imamoğlu'nun sandık videosunun sorunları
  entry_id:  89925441
  entry_writer: tourist eomer
  entry_fav_count: 124
  entry_content: |
    denizde kum ekşi’de aktroll aq.
  entry_channels: siyaset,anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 43
  entry_content: |
    garip bir mantık.<br/>savaş çıkmasın diye yarın ülkeyi işgale gelen düşmana da kurşun sıkmaz bu çocuk.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  89899735
  entry_writer: bendesizin
  entry_fav_count: 34
  entry_content: |
    babam 67 yaşında hiç sağlık sorunu yokken üç yıl önce ramazan da yetersiz sıvı alımına bağlı göz merceğinin arkasında kanama olmuş bayram sonu "bir gözümün yan tarafını ramazanda görmediğimi fark ettim" dedi doktora götürdük %40 görme kaybı yaşadığını ve geriye dönüşü olmadığını öğrendik. doktora babama oruç tutmamasını söylemesini rica ettim günahına giremem oruca bağlı olmamış olabilir dedi. bir sonraki yıl ramazanda o görme kaybı % 70 e çıktı...<br/>hastalara farz değil bedelini ödeyebilir diyenler için tekrar ediyorum babamın sağlık sorunu yoktu, kullandığı ilaç vs yoktu. <br/>bir de not bırakayım oruç tutmuyorum. çünkü açken kafam çalışmaz hele susuzluğa hiç dayanamam ayrıca kör olmak da istemiyorum.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    anadan anaya fark var tabi. buradan bin farklı cevap çıkacaktır haliyle.<br/>ben kendi istediğim hayatı seçtim. annem çok söylendi, çevreme, tüm arkadaşlarıma kötüledi beni. hatta arkadaşlarım bu yüzden konuşmaz oldu. bu kadar bahsettim, neydi buna sebep olan?<br/>ayrı eve çıkmak. olay oldu resmen. ayda yılda bir kez görürüm, hâlâ işe yaramaz biri olduğumdan bahseder. sağ olsun.
  entry_channels: ilişkiler
- entry_name: |
    şener şen
  entry_id:  89926552
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    hiç geçmişten ders almıyor bu troller sonra ileride rezil rüsva oluyorlar, alın size bu linkte bu avanak yazar gibi biri daha vardı<br/><br/>(bkz: <a class="b" href="/entry/72329280">#72329280</a>)
  entry_channels: ekonomi
---
