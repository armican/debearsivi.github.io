...
- entry_name: |
    antrikot ekrem'e saat alıyoruz kampanyası
  entry_id:  89899462
  entry_writer: kacamak
  entry_fav_count: 712
  entry_content: |
    2 milyon 163 bin liralık saati unutmadın değil mi? allah'ını seviyorsan onun hakkında da yorum yap! şu mübarek günde o değerli yorumunu görmek istiyorum.<br/><br/>edit: gelen mesajlar üzerine saatin şu an ederi 2 milyon 163 bin tl.'ymiş.<br/><br/>en azından özel mesaj at dostum. lütfen cevabını bekliyorum. mesajım hemen mesajının altında. görmemene imkan yok. değerli cevabını bekliyorum.
...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    10 mayıs 2019 binali yıldırım'ın tweeti
  entry_id:  89905315
  entry_writer: syd barrett in kedisi
  entry_fav_count: 417
  entry_content: |
    imamoğlu’na söyleyin, binali yıldırım dişi deve ile erkek deveyi ayırt edemeyen yüzbinlerce taraftara sahip.
...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    hoşlanmak reversible aşık olmak irreversibledır.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
    türkiye neredeydi nereye geldi diyen adam
  entry_id:  89918297
  entry_writer: strobist
  entry_fav_count: 19
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=oThZ9PatsyU">https://www.youtube.com/watch?v=othz9patsyu</a><br/><br/>yaşadığı ülkeden yaşadığı hayattan bir gram haberi olmayan insandır.. 1 ay almanya'da kalmış almanya'yı türkiye'yi karşılaştırarak herşeyi çözmüş.. moraliniz bozuksa gülmek için bile izleyebilirsiniz..<br/><br/>+ türkiye nerdeydi nereye geldi?<br/>- nerdeydik nereye geldik?<br/>+ nerdeydik abi?<br/>- nerdeydik abi?<br/>+ çok kötü bi yerdeydik?
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    eskiden çok yaptığım eylem. sonra horizon(ufuk) kelimesini kullanarak hatırlamaya başladım ve aklımda iyice oturdu.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    oh olsun. keşke kafan, ayağın, bacağın da kırılsaydı da daha bir şahane bir görüntü ortaya çıksaydı. piç kurusu.
  entry_channels: haber
- entry_name: |
    şu anda çalan şarkı
  entry_id:  89931092
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    eskişehir'den dahil olduğum veritabanıdır. gelin ramazan ramazan bira içelim:)<br/><br/>not: 26/e
  entry_channels: anket,ilişkiler,ekşi-sözlük
---
