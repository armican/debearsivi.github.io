...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    türklerin en az gülen dört milletten biri olması
  entry_id:  89901139
  entry_writer: spacetimereality
  entry_fav_count: 72
  entry_content: |
    bir arkadaş 1 yıla yakın yaşadığı japonya'dan döndükten sonra durumu "bir geldim, herkes at hırsızı gibi amk" sözleriyle özetlemişti.
  entry_channels: haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 56
  entry_content: |
    çatır çatır istanbulu yönetecektir .adama kişiye kişilere vakıflara cemaatlere hizmeti kesecektir .
...
- entry_name: |
  ...
  entry_fav_count: 44
  entry_content: |
    zamanı gelince bu lafı yüzünden bile extra ceza alacak kişi (bkz: <a class="b" href="/?q=swh">swh</a>)
...
- entry_name: |
    şener şen
  entry_id:  89928437
  entry_writer: ytcaydin
  entry_fav_count: 24
  entry_content: |
    sizin geçmişinizi sikerim lan! kendisine bir şey oldu sandım.
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    bir insan kendi halinde yürüyen bir kuşa neden tekme atmak ister? <br/>bir insan kendisine zararı olmayan bir canlıya neden zarar vermeye çalışır? <br/>sadece hayvan dürtüsü ile hareket eden hayvanlar bile bu şekilde davranmazken allah bize akıl vermiş diye övünen bu insanlar nasıl bu kadar yabani ve gerzek olabiliyor aklım almıyor.
  entry_channels: haber
- entry_name: |
    digiturk aboneliği iptal kampanyası
  entry_id:  89934691
  entry_writer: yolundacocuklar
  entry_fav_count: 13
  entry_content: |
    ekşi sözlüğü de üstü kapalı tehdit eden şirkete karşı yapılması mantıklı hareket. <br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://twitter.com/DigiAntiFraud/status/1126912073382993927" title="https://twitter.com/DigiAntiFraud/status/1126912073382993927">https://twitter.com/…aud/status/1126912073382993927</a><br/><br/>ekşi'yi zamanında kapattık, illegal iş yaparsanız bulur çıkarırız, hukuk önünde hesap verirsiniz falan demişler. <br/><br/>yahu siz değil misiniz <a rel="nofollow noopener" class="url" target="_blank" href="https://www.mevzuat.gov.tr/MevzuatMetin/1.5.6502.pdf" title="https://www.mevzuat.gov.tr/MevzuatMetin/1.5.6502.pdf">tüketicinin korunması hakkındaki kanun'un madde 52, 4. fıkrası;</a> 1 yıldan uzun süreli abonelik sözleşmesi yapılamaz yapılırsa da tüketici istediği zaman hiçbir cezai bedel olmaksızın feshedebilir demesine rağmen herkese 2 yıllık sözleşme kitleyen, erken çıkanlara fatura ve icra kitleyen, kanunu yıllarca katleden. <br/><br/>müşteri temsilcilerinize bu durum söylendiğinde bile efendim bize bunu söylememizi istiyorlar diyor. müşteri temsilcilerine bile kanunsuzluğu dayatan siz değil misiniz. <br/><br/>bence 2 yıllık abonelik sözleşmesi olan herkes cezai şart olmadan sözleşmeyi feshetsin. onlar size astronomik bir fatura çıkarırlar. e-devletten 10 dakikanızı ayırıp tüketici hakem heyetine şikayet edince hemen iptal ediyorlar. <br/><br/>peki ne izleyelim diyenler:<br/><br/>popcorn time ve stremio kullanabilirsiniz. bunlar hem reklamsız, hem açık kaynak kodlu, hem eşekherif altyazılarını otomatik alıyor, hem engellenemez/yasaklanamaz programlar. hem de tek tıkla hem bilgisayar, hem telefonda, hem de android tv'lerde kullanabilirsiniz. tabi bu bir seçenek ama bunu önerdiğim anlamı çıkmasın. bu eme hırsızlarını ben de kınıyorum. <br/><br/>ekşi'yi kapatırız falan demeyecektin digitürk kardeş.
  entry_channels: tv
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    adamların genel başkanı canlı yayında terör örgütü olarak görmüyorum dedi zaten. sakın kimse " ypg için dedi" demesin. ha ypg ha pkk!! ikiside terör örgütü, sempatizanlarıda terörist.
  entry_channels: siyaset,anket,ilişkiler
- entry_name: |
    13 mayıs 2019 ali babacan'dan manifesto
  entry_id:  89935962
  entry_writer: mamadu niang
  entry_fav_count: 8
  entry_content: |
    bir ak parti yetmiyordu, sağolsunlar ikinci ak partiyi kuruyorlar.
  entry_channels: siyaset
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    şey değil mi bu ya, eski <a class="b" href="/?q=nokia">nokia</a> telefonlarda (bkz: <a class="b" href="/?q=3310+vb.">3310 vb.</a>) <a class="b" href="/?q=besteleyici">besteleyici</a> vardı hani. <br/><a class="b" href="/?q=zerda">zerda</a>’nın dizi müziği notaları?<br/>o değil mi? <br/>t: tanım manım yok.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    2007 senesinde daha ağzı süt kokan bir ortaokul öğrencisiyken tanıştım sözlükle. yazar abi ve ablalarımızın gizemi, kıvrak zekası ve entelektüel birikimi ağzımın suyunun aka aka okumamı sağlıyordu sözlüğü. olduğum şehirde bir zirve yapılması ve gidip onlarla tanışmak en büyük hayalimdi.<sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup> tesadüf eseri bir bayram gezmesinde tanıştım ilk sözlük yazarıyla, heyecanımı hala içimde hissederim o anın.. (bkz: <a class="b" href="/?q=s%c3%b6zl%c3%bc%c4%9f%c3%bcn+yeti%c5%9ftirdi%c4%9fi+yazarlar">sözlüğün yetiştirdiği yazarlar</a>) başlığı açılırsa ilk sıraya the lodger'ı eklemeyi unutmayın sevgili suserlar. fikri gelişmemi doğrudan etkileyen yer ailemden sonra burası oldu benim sonra şehir sonra okul vs. lan iyi ki varsınız! <br/>sözlüğün şimdiki halini görüp üzülen <a class="b" href="/?q=s%c3%b6zl%c3%bc%c4%9f%c3%bc+1999%27dan+beri+takip+eden+g%c3%bcruh">sözlüğü 1999'dan beri takip eden güruh</a> 'tan abilerimiz ablalarımız varsa eğer hepsine selam eder gözlerinin arkada kalmamasını temenni ederim. <br/><br/>kanzuk bana dürüm ısmarla allahsız.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    ahiretteki umrumda değil, meyhaneye vereceğimiz hesabın derdi daha önemli. rakısı, birası, yemeği, mezesi hepsinin fiyatı ikiye katlanmış bir yılda.
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    <a class="b" href="/?q=petrus+van+schendel">petrus van schendel</a> ve eseri <a rel="nofollow noopener" class="url" target="_blank" href="https://eksiup.com/p/jy5681hjgxsv" title="https://eksiup.com/p/jy5681hjgxsv">market by candlelight</a>
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    yeni bölüm fragmanında yine bir adet "çocuğum olmuyor, çocuk çocuk!!" yakarışına yer verilmiş. <br/><br/>daha fazla mı çocuk istiyorsunuz sayın senaristler? ajanslar kurudu, bebek oyuncu kalmadı, takım kurdunuz, yetmedi mi? <br/><br/>bebek sevdasını bir türlü çözemediğim dizi. ağalı töreli dizilerde bile kadınlar bu kadar doğurmadı, bu kadar çocuk meraklısı olmadı. tamam, toplumumuzda çocuk bazlı dertlere programlanıyor kadınlar, haklısınız. <br/><br/>ama değişimi hissedip, biraz da ileriyi görmek, kadınlara "saçını bebeğine süpürge etmek" harici misyonları yükleyebilmek, yazdığınız satırlar milyonlarca kadına ulaşırken "bak, farklı bir yol buldum!" dedirtebilmek daha keyifli olmaz mı? <br/><br/>reyting kaygınız da yok artık, gerçi dizide hamile bıraktırmadığınız bir tek esma kaldı, artık çok geç. <br/><br/>ama yeni işlerinizde kadınların rolleri, misyonları ve her kadının ana olma arzusundan çatlamadığı ve bunun inanılmaz normal olduğu, çünkü her kadının canı nasıl istiyorsa öyle yaşayabileceği mesajlarını verirsiniz.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    2 gündür ekrem bey'i destekleyen ünlüler hedef gösteriliyor, tehdit ediliyor, hakaretlere uğruyor, fişleniyor ama fetö öğrencisi o.çocuğu ak troller gelmiş imamoğlu'nu desteklemeyenlere karşı yapılan faşizm falan filan diyor.<br/><br/>seçim iptalinden sonra, lağım fareleri gibi ortaya çıktı bu fetöcu troller. günde 10 başlık açıp, kendilerine müslüman demelerine rağmen, ramazan ayında yapmadıkları allahsızlık, kitapsızlık kalmadı.<br/><br/>ariel şaron, hitler hatta şeytan bile bu korkunç zihniyet yanında iyilik meleği kalır lan, melek.
  entry_channels: siyaset
- entry_name: |
