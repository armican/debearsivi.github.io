...
- entry_name: |
    fetö beslemesi meral akşener
  entry_id:  76176746
  entry_writer: herseysuperolacak
  entry_fav_count: 337
  entry_content: |
    fetö beslemesi görmesek inanacağız.
...
- entry_name: |
    24 haziran'da kemalist cumhuriyet ortadan kalkacak
  entry_id:  76174820
  entry_writer: gayim ama para bende
  entry_fav_count: 194
  entry_content: |
    ulan gerizekalı sana ne benim ülkemden göt!<br/><br/>elin avrupalısı neden cumhuriyet bitsin ister. <br/>zamanında atatürk fena koymuş bunlara ki ülkenin sonu gelsin diye uğraşıyorlar.<br/>çomarlarda bunları alkışlayıp çomak tutuyorlar.<br/><br/>tamamınız geberin pislikler.<br/><br/>edit: avrupa bize karşı değil. tayyip erdoğan'ın başta olması işlerine geliyor. (ülkenin içten içe bitmesi için)
...
- entry_name: |
  ...
  entry_fav_count: 90
  entry_content: |
    sahaya yabancı madde yağmış mı? yağmış. taraftar çığırından çıkmış mı? çıkmış.<br/>bu maddeler sahadakilerin hayatını riske atmış mı? atmış. bu boku ye, sonra üste çık.<br/><br/>ince hesaptan haklılık türetmeye çalışan cibilliyetinizi sikim sizin.<br/><br/>not: alikoçspor
...
- entry_name: |
  ...
  entry_fav_count: 64
  entry_content: |
    keşke şenol güneşin başına atılan dikişler zamanında anasının a......... atılsaydı da bu herif hiç doğmasaydı.<br/><br/>aldğığı nefesi daha fazla almaması gereken mahluk.
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    referandumdan itibaren dillendirilen erken seçime hazır olmayan, olamamış, 1 senedir plan yapamamış parti.<br/><br/>devlet bahçeli erken seçim mevzusunu açıkladıktan sonra bile oturup 10-12 saat toplantı yaparak bir plan oluşturamadılar. geç kalmışlardı ama yapabilirlerdi yapmadılar.<br/><br/>aylar sonrası için bile kendisine bir yol çizemeyen bir partinin beni temsil edebileceğine inanmıyorum. doğu perinçek bile adaylığını açıklarken kendilerinden ses çıkmadı. öngürüsüzlük ve stratejisizlik diz boyu.<br/><br/>sizin işiniz siyaset ve siyasi gelişmelere karşı konum almanızı bekliyor seçmenleriniz.<br/><br/>16 senedir bu partiye oy atıyorum, en saçma kararlarında dahi arkalarında oldum, savundum. ekmeleddin rezaletinde bile tatava yapma bas geç dedik umutla. <br/><br/>kendilerine her attığım oy için tam şu an pişmanım. bu da sinirlerimi bozuyor. <br/><br/>en çok sinirlerimi bozan konu da arka arkaya gelen adayların "demokrasi" kılıfı ile açıklanması. birileri dincilik yapıyor diye eleştirirken siz demokrasicilik yapmayacaksınız. kendi kurultayında demokrasi mi vardı sanki? şu kritik anda mı aklına geldi demokrasi bilmem ne?<br/><br/>bunun adı plansızlıktır, öngörüsüzlüktür ve hatta beceriksizliktir. var sayalım yarın falan bi aday çıkarttın, 3 gün olmuş seçim tarihi açıklanalı, bu mesnet ile mi yöneteceksiniz ülkeyi?<br/><br/>daha da chp ye oy vermem. meral akşener an itibariyle nezdimde tek adayımdır.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    başlığı "kalp satın alma" hastalığı olarak okudum, artık ne kadar mutsuzsam...
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    kız arkadaşı varken başkasına yüz, iki yüz, üç yüz, beş yüz veren de var.<br/>tl, $, ...
  entry_channels: ilişkiler
- entry_name: |
