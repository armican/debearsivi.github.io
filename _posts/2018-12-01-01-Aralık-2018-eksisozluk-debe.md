...
- entry_name: |
    linkedin'i yazıldığı gibi okuyan sığır
  entry_id:  83846588
  entry_writer: kirkbirincikarakter
  entry_fav_count: 87
  entry_content: |
    ben hep linkin park diye okuduğum için beni ilgilendirmeyen tespit.
...
- entry_name: |
    bu kadar çok öğrencinin olduğu yerde ölümler olur
  entry_id:  83855249
  entry_writer: gamsizmuhendis
  entry_fav_count: 6
  entry_content: |
    bu kadar çok milletvekilinin olduğu mecliste...
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    "fizikte matematiksel metotlar"<br/><br/>"kuantum mekaniğine giriş"<br/><br/>adları bile ürkütücü<br/><br/>(bkz: <a class="b" href="/?q=fizik+m%c3%bchendisli%c4%9fi">fizik mühendisliği</a>)
