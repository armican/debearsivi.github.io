...
- entry_name: |
  ...
  entry_channels: siyaset,anket
- entry_name: |
    yiğit bulut'un genel af istemesi
  entry_id:  76567400
  entry_writer: deg grager
  entry_fav_count: 65
  entry_content: |
    o zaman anketler yalan söylüyor. demek ki oylar %35'e kadar düştü.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    genelde uzun hava ve ağıtlarda nida şeklinde belirir: "oy, oy, oy..." şeklinde.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    16 yilin sonunda buna degil rte ye oy veririm diyen chp li gerizekalıdır.
  entry_channels: siyaset,ekonomi
- entry_name: |
    meral akşener'deki inanılmaz mantık hatası
  entry_id:  76579198
...
- entry_name: |
    tivibu
  entry_id:  76579053
  entry_writer: comte dartagnan
  entry_fav_count: 3
  entry_content: |
    tek para verilmez gerekçesi olan şampiyonlar ligi yarı final maçı öncesi toptan gitmiş lanet platform. <br/>şikayet için telefon ettiğinizde de ahizeyi kaldırıp siktrolup gitmişler, sürekli meşgul telefon.<br/>haram zıkkım olsun aldığınız para. burnunuzdan gelsin.
  entry_channels: tv,ekşi-sözlük,teknoloji
- entry_name: |
    ölüm fikrinin insanları çıldırtmıyor oluşu
  entry_id:  76573408
  entry_writer: benucabiliyorum
  entry_fav_count: 3
  entry_content: |
    doğuştan kafalarımızın bir nebze güzel olduğundan algılayamadığımız durum. <br/><br/>şunu söyleyebilirim ki dopamin seratonin vb mutluluk hormonu olarak adlandırdığımız şey bu fikrin korkunçluğunu ve gerçekliğini uzak tutar. bana kalırsa bunların eksikliği asıl gerçekliktir. depresyonun da bir nevi gerçekliğin salt biçimde anlaşılması olarak yorumlamışımdır hep. depresyon ve bu gerçekliğin korkunçluğu arasındaki fark ise depresyondaki ölümü kabulleniştir. <br/><br/>bu çıldırmayı zaman zaman yaşamış olanlar beni anlayacaklardır: ani bir korku, salt gerçekliğin aydınlatışı, ve kimsenin farkına varamadığını düşündüğümüz bu gerçeklikle baş etme/edememe/çaresizlik hissetme durumu. ''zaman zaman'' diyorum çünkü ''sık sık'' yaşadığınızın ardından bu gerçeklik o kadar ağır gelir ki ölümle ilgili başlıklara dahi bakmak istemezsiniz. muhtemelen bu durumu yaşayanlar entrymi okumayacaklardır.<br/><br/>asıl ilginç olan sık sık yaşandığında korkuyla/çıldırmayla birlikte, korkunun aksine kişinin kendine zarar verme eğilimi görülür. depresyondaki kabulleniş ve -bana göre- aydınlanma arasındaki o ince çizgi nedir merak ediyorum.<br/><br/>not: tecrübelerime dayanarak yazılmıştır.
...
- entry_name: |
  ...
  entry_id:  76551218
  entry_writer: kapak kizii
  entry_fav_count: 2
  entry_content: |
    abartısız yarım saattir güldüğüm yetkin bir akp seçmeninin demeçi...<br/><br/>keşke bu hallere düşmeyecek kadar eğitim alabilseydi... <br/>çok acıklı...
  entry_channels: siyaset,haber
- entry_name: |
