...
- entry_name: |
    vapur ve metrolar müzisyenlere ücretsiz olsun
  entry_id:  97650247
  entry_writer: sonadora
  entry_fav_count: 202
  entry_content: |
    gürültü kirliliğinden başka bir şey olamayan bu embesillere işgaliye bedeli uygulanması gerekirken, dile getirilen saçma talep.
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    müjde ar denince akla gelenler
  entry_id:  97632154
  entry_writer: o nick buraya gelecek aga
  entry_fav_count: 195
  entry_content: |
    başın sıkışınca kimsenin yardıma gelmemesi.
  entry_channels: anket,tv,sinema,magazin
- entry_name: |
    tuba ünsal'ın kalıpların dışına çık mesajı
  entry_id:  97649117
  entry_writer: oyuncak bulut
  entry_fav_count: 185
  entry_content: |
    kalıpların dışına götümüzü açmadan çıkamadığımızı gösteren mesajdır.<br/><br/>tuba hanım, götümüzü başımızı açmadan kalıpların dışına çıkıp orjinal olabileceğimiz bir mesaj alabilir miyiz? kalıpların dışına çıkacaz diye götü mındar etmeyek.<br/><br/>edit: <br/>1. ablanın mağbadında don yok neyin iç çamaşır reklamı? ne idüğü belirsiz bir sütyen mi reklamın parçası veya sadece markayı etiketlemesi mi? ürün olmadan nasıl oluyor bu reklam işi? <br/>2. instagram kullanmıyorum, kaç yılında ne boklar döndü bilmiyorum bu başlıkla gördüm yazdım. mal mal, eski bu diye ahkam kesmeyin kulak memenizi ısırırım.<br/>3. engellemekle tehdit eden mal. elini korkak alıştırma. ilk 10 az olur, ilk 11 i engelle de sahaya çıkarız.
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    hong kong'da protestocuların vatandaşı yakması
  entry_id:  97642643
  entry_writer: dood
  entry_fav_count: 113
  entry_content: |
    gostericiler arasinda fink atan sivil cin polisi de yapmis olabilir gayet. yapmadiklari bir sey degil gostericileri kotu gostermek icin. <br/><br/>bir guc mu var dangalakligina gelelim. mutlu mesut utopik ulkende yasiyorsun her sey cok guzel, her sey mukemmel. sonra bir guc geliyor "shh genc al su bes lirayi git disarda eylem yap" diyor "utopik ulkenin polisi yakalarsa maf edecek, hayatini karartacak sirf senin degil tum aileni bitirecek, bir daha gun yuzu goremiyceksin ama olsun sen rahatini boz hayatini tehlikeye at benim icin eylem yap." mal degnegi gencimizde e adam 5 lira verdi gidim eylem yapim bari diyor. <br/><br/>tum dunyada olaylar oluyormus tum dunya cok guzel bir yerdi o olaylarin oldugu ulkeler dunyanin ornek ulkeleriydi insanlar mutlu mesut yasiyordu dert tasa olmadan hayret niye olaylar oluyor acaba?
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    futbol tarihinin başarılı frikikçileri
  entry_id:  97653742
  entry_writer: zirkarmen
  entry_fav_count: 53
  entry_content: |
    <a class="b" href="/?q=juninho+pernambucano">juninho pernambucano</a> ve diğerleri.
...
- entry_name: |
  ...
  entry_fav_count: 49
  entry_content: |
    paralı trollün açtığı bir başlık . 2 taktikleri var . biri dededen chp liyim ve imamoğlu na verdim ama pişmanım . diğeri de mansur yavaş çok daha iyi kardeş , imamoğlu patladı.<br/>daha önce de yazdım , yavaş gerçekten iyi ve seviyoruz ama troller de biliyor ki reise karşı cumhur seçimini kazanamaz. yemezler, 2023 de güle güle.
...
- entry_name: |
  ...
  entry_fav_count: 41
  entry_content: |
    çok şükür 30 u geçip patates olanlardan değilim<br/>hep patatestim kendimi hiç bozmadım
  entry_channels: ilişkiler,sağlık
- entry_name: |
    20.19.2019 saat 20.19'da evlenmek
  entry_id:  97652405
  entry_writer: yedinci element
  entry_fav_count: 38
  entry_content: |
    2019'un 19. ayı 2020'nin 7. ayına denk geldiğinden<br/><br/>gerçek tarih 20.07.2020 olacaktır.<br/><br/>yine fena değil.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    lavaboya sıçılmasından rahatsız olmuyorsan askerlik derim. var mı böyle güzel anı yeaaa? askerlik gibisi var mı yeaaa? he.
  entry_channels: anket,ekonomi
- entry_name: |
...
- entry_name: |
    en erkeksi müzik yapan grup
  entry_id:  97654907
  entry_writer: unakkum enakkum
  entry_fav_count: 15
  entry_content: |
    (bkz: <a class="b" href="/?q=manowar">manowar</a>)<br/><br/>bi’ kere grubun adı “man of war” yani. adamlar daha ne yapsın...
  entry_channels: anket,müzik
- entry_name: |
...
- entry_name: |
    dünya bekarlar günü
  entry_id:  97644475
  entry_writer: heihachi mishima is dead
  entry_fav_count: 2
  entry_content: |
    günümüz kutlu olsun tüm yakışıklılar !
