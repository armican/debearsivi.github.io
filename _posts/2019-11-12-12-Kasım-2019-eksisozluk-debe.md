...
- entry_name: |
  ...
  entry_fav_count: 129
  entry_content: |
    diğer zamlara sesini çıkartmayıp "güncelleme" diye yiyen dalyaraklar üşüşür başlığa birazdan.
...
- entry_name: |
  ...
  entry_fav_count: 44
  entry_content: |
    zavallı bir padişah olduğuna katılmıyorum ama bugün ülkemizde bir “kürt” sorunu varsa müsebbibi yavuz’dur. doğu anadolu’da yaşayan bütün türkmenleri iran’dan getirttiği “kürtlere” öldürterek türkmenlerin topraklarını “kürt” ağa ve mirlerine yurtluk, ocaklık, mir-i miranlık olarak peşkeş çekmişti. akkoyunluların başkenti diyarbakır bugün tebriz gibi bir şehir değilse, artuklulara başkentlik yapmış mardin’de, hasankeyf’te bugün türk yoksa sorumlusu yavuz’dur.<br/><br/>yavuz’un savaştığı bütün devletler türk ve islam devletleriydi. hilafeti bile memlüklülerden zorla gasp etmişti. düşünsenize sen bir müslüman devletsin ve halifene savaş ilan edip devletini yıkıyorsun. o yüzden kimse türk milletinin kurtarıcısı ve türklüğün dirilmesini sağlayan mitolojik bir yarı tanrısal figür olan ulu önderimiz gazi mustafa kemal atatürk’ün hilafeti ve saltanatı kaldırmasına laf etmesin.
  entry_channels: siyaset,tarih
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 25
  entry_content: |
    baktım, başlık 10 sene önce falan açıldı sandım ama bu sene açılmış. <br/>50 bin liraya arasan kendisi gibi biriyle 1 gece geçiremezsin. <br/>o vaatle seni kandırırlar, paranı alırlar üstüne bir de sikerler. 1 gece geçireceğim derken senle geçirirler 1 gece. sen hep 50 lira verdiğin için 50 bin fazla geliyor heralde. <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup><br/><br/>tanım: bir karşılaştırma.
...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    bu nasıl bir zevksizliktir. bakarken gözlerim yoruldu.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    walla benim ki limit 18 bin. platin card falan. baya baya da bir havalı. <br/>çalıştığım iş yerine çok şatafatlı bir kargo ile gelmişti. <br/>hava yapıyor muyum. heee evet yapıyorum. bim den bu platinium card ile dost yoğurt, barbunya falan alırken kartı bir çıkartıyorum mağazanın müşteri profil ortalaması birden yükseliyor.. gerçi eskiden sürekli limit yükseltme mesajları gelirken şimdi hiç gelmiyor.. sanırsam ana merkez, benim bim den 18 binlik kart ile kilosu 10 tl olan salam aldığımı görünce bu heveslerinden vaz geçtiler.
  entry_channels: ekonomi
- entry_name: |
    iski'nin suya %20 zam yapması
  entry_id:  97662893
  entry_writer: penguhan
  entry_fav_count: 16
  entry_content: |
    2020 iski bütçesi 7 milyar 776 milyon 456 bin tl <br/>2019 iski bütçesi 8 milyar 501 milyon 502 bin tl<br/>bu verilere dayanarak iski bu sene yaklaşık 725 milyon tl daha az bütçe alacak. zammın genel sebeplerinden birisi de budur. yani imamoğlu'nun yapabileceği bir şey maalesef yok. canın sağolsun imamoğlu, imkanlar dahil olduğunda sen yine indirim yapacaksın.
  entry_channels: 
- entry_name: |
    masterchef türkiye
  entry_id:  97665203
  entry_writer: yohaman
  entry_fav_count: 12
  entry_content: |
    az önce suna hic simit yapmadim diyor. kıvanç ben sorduğumda yaptığını söylemiştin diyor. suna hayır yapsam soylerdim deyince kamera kayıtlarını gosteriyorlar ve suna yaptim demiş. somer şef bunun üzerine kivanci çağırıp sunanin simitlerinden veriyor laf sokuyor. bu kadar da olmaz şefler taraf tutuyor bir kez daha görmüş olduk.
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    taşralılara garip gelir çünkü onlar her işlerini en az 16 tane akrabaları ile beraber yaparlar. tek başına olan kimse zavallı, kimsesiz, çaresiz filan sayılır.
  entry_channels: yeme-içme
- entry_name: |
    çağatay ulusoy'un 500 kilo olması
  entry_id:  97663695
  entry_writer: masterofdeath
  entry_fav_count: 4
  entry_content: |
    (bkz: <a class="b" href="/?q=steroid+k%c3%bcrlerinden+sonra+%c3%b6dem+toplamak">steroid kürlerinden sonra ödem toplamak</a>)
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    ana sebebi erkeklerin dış görünüşe önem vermeyi ve anaç(!) kadın arama olayını abartması, kadınların da çocuk yapma olayını profesyonel mesleğe dönüştürmesi.
  entry_channels: 
- entry_name: |
    arabada köpeği yumruklayan vahşi yaratık
  entry_id:  97661356
  entry_writer: songeneral
  entry_fav_count: 3
  entry_content: |
    demek insan boşuna katil olmuyormuş bu şeref yoksunu herifi videoyu izlerken öldürmeyi çok ama çok istiyorum.
  entry_channels: 
- entry_name: |
    şu an okunan kitap
  entry_id:  97629209
  entry_writer: mavinin ucuk tonu
  entry_fav_count: 2
  entry_content: |
    kumral ada mavi tuna-buket uzuner
  entry_channels: anket,edebiyat,eğitim
- entry_name: |
    malatya'ya gideceklere tavsiyeler
  entry_id:  97661593
  entry_writer: fatality44
  entry_fav_count: 2
  entry_content: |
    öz güngör, çobanoğlu, çakı’dan kebap yemeden, battalgazi ilçesindeki tarihi yapıları gezmeden, aslantepe höyüğü’nü görmeden, yeşilyurt ve gündüzbey ‘de kahvaltı yapmadan dönmeyin. bi de benim hamamoğlanı enişteye selam söylesin bundan sonra havaalanına geldiğimde gelip alsın beni ibne.
  entry_channels: 
- entry_name: |
    robot olmadığını kanıtla
  entry_id:  97660442
  entry_writer: esmer seven adam
  entry_fav_count: 1
  entry_content: |
    nereye tikliyoruz? tiklamali olsun lutfen. trafik lambalarini bulmak zor oluyor.
  entry_channels: 
- entry_name: |
    amazon.com.tr
  entry_id:  97664449
  ...
  entry_fav_count: 1
  entry_content: |
    kaliteli hizmet veren alışveriş sitesi. hem kargo hem satış sonrası desteği(iade vs) rakipsiz. “amazon.com tarafından satılır ve gönderilir” ibaresini gördüğüm ürünü gözüm kapalı alırım. (bkz: <a class="b" href="/?q=logosunu+g%c3%b6r%c3%bcnce+g%c3%bcvendeyim+hissi+veren+markalar">logosunu görünce güvendeyim hissi veren markalar</a>) kategorisinde benim için.
  entry_channels: teknoloji,moda,ekonomi
- entry_name: |
    şu anda çalan şarkı
  entry_id:  97629669
  entry_writer: nivelman
  entry_fav_count: 0
  entry_content: |
    o nasıl karizmatik şarkı yorumlamaktır. buyrun zat-ı şahanesi;<br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=sV2BiD9LCn8" title="https://www.youtube.com/watch?v=sV2BiD9LCn8">beth hart - fire on the floor</a><br/><br/>ı don't wanna love him anymore<br/>he's nothing like the man ı loved before<br/>but the pain gets real comfortable<br/>when it's all ya got
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    kendinizi içinde en seksi hissettiğiniz kıyafet nedir?<br/>balıketli tanımınız nedir?<br/>aynaya bakınca ne hissediyorsunuz?<br/>erkek olsaydım şununla yapardım dediğiniz ünlüler kim?
