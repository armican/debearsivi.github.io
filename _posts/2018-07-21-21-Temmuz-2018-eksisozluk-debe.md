...
- entry_name: |
  ...
  entry_fav_count: 524
  entry_content: |
    cuma hutbesi nedir? cuma namazını kimler kılar? tabii ki hutbe bu şekilde olacaktır. sana düğününde şarap iç diyecek hali yok hutbede. he,ben çoğu hutbeyi beğenmem.<br/>ama hem burada gelip türk kızı evlenirken erkeği batırıyor diyeceksin hem de "en bereketli nikah külfeti en az olan nikahtır." hadisinin geçtiği hutbeyi eleştireceksin!<br/>eleştirecekseniz komşusu açlıktan kırılırken,kilo kilo altın ve para dağıtan düğün sahiplerini; etrafa silah sıkan magandaların olduğu düğünleri eleştirin.<br/>bıktık şu sözlükte yobazın her türlüsünden.
...
- entry_name: |
    gbt yaptığı kızı instagramdan ekleyen bekçi
  entry_id:  79375280
  entry_writer: cerkez prens
  entry_fav_count: 253
  entry_content: |
    işe yaramaz ne kadar çomar varsa polis, bekçi, zabıta, memur yapıldı.<br/>ne bekliyordunuz ki ?<br/><br/>zihniyet belli...<br/><br/>edit: buyrun işte, zihniyet diye boşuna söylemedik.<br/>böyle bir konuyu bile, sırf kendi çomarları diye savunan karaktersiz dalyaraklar var.<br/><br/>mesai saati dışında eklemişmiş de görevi kötüye kullanma sayılmazmış...<br/>geri zekalı ! görev sırasında ve sayesinde ulaştığı bilgiyi, isterse yıllık izinde kullansın, bu görevi kötüye kullanmaktır !<br/><br/>sizin ben etik, ahlak anlayışınızı sikeyim !!
...
- entry_name: |
  ...
  entry_fav_count: 200
  entry_content: |
    keşke yapsaydınız da iyi parti %30 alsaydı.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 180
  entry_content: |
    (bkz: <a class="b" href="/?q=e%c5%9fe%c4%9fin+zikinden+dolay%c4%b1">eşeğin zikinden dolayı</a>)<br/><br/>her şeyde de bir sebep aramayın arkadaş.<br/><br/>şu başlığı her gördüğümde "yine boş boş konuşuyorlar" diyorum.<br/><br/>her şeyi açıklamaya çalışıyorsunuz çok saçmasınız.<br/><br/>erkek gelip kadına uzvunu sokuyor, bunu düşünmüyorsunuz, gidip memeye takılıyorsunuz.<br/>lan erkek bir şeyi sertleştirip karşısındakine sokuyor bu daha garip değil mi?
...
- entry_name: |
  ...
  entry_fav_count: 155
  entry_content: |
    "biz demireller'den, türkeşler'den milliyetçilik dersi almayız. sevgili kardeşlerim! biz milliyetçiliği sokak duvarlarına değil, kıbrıs'ın topraklarına, ege'nin deniz yataklarına yazmışız. biz milliyetçiliği batı anadolu'nun haşhaş tarlasına yazmışız"<br/><br/>ruhun şad olsun karaoğlan!
...
- entry_name: |
  ...
  entry_fav_count: 153
  entry_content: |
    hemen gidin kendinize canavar bir oyun bilgisayarı, üst düzey elektro gitar, motosiklet vs bütçenizin amına koyacak bir şeyler alın. para da vermeyin, bankadan alışveriş kredisi kullanın 48 ay.<br/><br/>ekonomik sıkıntı kadar etkilisini görmedim.
...
- entry_name: |
  ...
  entry_fav_count: 71
  entry_content: |
    piyasadaki bu kaleci kıtlığında dünyanın en iyi kalecilerinden olduğu söylenen muslera tek bir transfer teklifi dahi almıyor ama hiçbir milli takımda oynamamış fabri'ye premier ligden teklif geliyor. <br/><br/>bence kudurmakta haklısınız.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    yıl sonuna kadar 10 bin bekçi alınacak
  entry_id:  79366698
  entry_writer: aloha martini
  entry_fav_count: 31
  entry_content: |
    geceleri gezen icen insanlara mudahale etmeyi yasal hale getirme cabalari bunlar.
...
- entry_name: |
  ...
  entry_fav_count: 30
  entry_content: |
    (bkz: <a class="b" href="/?q=olivier+giroud">olivier giroud</a>)<br/>dünya kupasına kadar iyi sanıyordum lâkin izlediğim kadarıyla ağır, pozisyonları bitiremiyor. sadece fizik avantajı var onu da etkin kullanamıyor
...
- entry_name: |
  ...
  entry_fav_count: 28
  entry_content: |
    uefaya sorsan haberi yoktur böyle bi takımdan aq.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  79358077
  entry_writer: caglarpegai
  entry_fav_count: 20
  entry_content: |
    'hakikat yüzünden ölmeyelim diye var sanat.'
  entry_channels: edebiyat
- entry_name: |
    20 temmuz 2018 chp kurultay açıklaması
  entry_id:  79385931
  entry_writer: rumuz ararken deliren adam
  entry_fav_count: 20
  entry_content: |
    lütufmuş gibi söylemenin anlamı yok.<br/>gerekli imza toplanırsa, tüzük gereği <a class="b" href="/?q=sike+sike">sike sike</a> yapacaksınız o kurultayı zaten.
  entry_channels: siyaset,haber
- entry_name: |
    danla bilic
  entry_id:  79365569
  ...
  entry_fav_count: 16
  entry_content: |
    obezite ameliyatı olmuş, daha yeni saçma sapan zayıflama ürünlerini insanlara övüp "çok zayıflıyorum siz de için harika bunlar" diyordu. bu kadar ikiyüzlü, kaba, yalan söyleyen bir insan görmedim galiba. ameliyat olduğu ortaya çıkmasa daha ne "bunları yedim zayıfladım" reklamları yapardı, düşünemiyorum. ayı diyerek aşağıladığı insanlardan biri olmak istemiyor demek.
...
- entry_name: |
  ...
  entry_id:  79377376
  entry_writer: readytogo
  entry_fav_count: 9
  entry_content: |
    eskilerden gelsin ;<br/><br/>how do you turn this on<br/><br/>(bkz: <a class="b" href="/?q=age+of+empires+ii+the+age+of+kings">age of empires ii the age of kings</a>)
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    (bkz: <a class="b" href="/?q=gavs+kim+amk">gavs kim amk</a>)
  entry_channels: siyaset,haber
- entry_name: |
    chp'li delegelerin kurultay için imza toplaması
  entry_id:  79386075
  entry_writer: get out of my chair
  entry_fav_count: 6
  entry_content: |
    kurultay toplanır ve yine oy çokluğuyla k. kılıçdaroğlu'nun lehine bi karar çıkarsa demokrasi olayını oturup bir düşünmem gerekecek artık. başımıza ne geliyosa oy çokluğundan geliyor.
  entry_channels: siyaset,haber
- entry_name: |
    2 tane evi olup hala çalışan keriz
  entry_id:  79375829
  entry_writer: bana bi de bakem
  entry_fav_count: 6
  entry_content: |
    nasıl bir kiraymış o öyle merak ettim, birinde oturup diğerinin kirasını yiyip geçinebiliyorsa, diğer ev milyon dolarlık demektir.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    doğru olabilir şimdiye dek beraber olduğum kadınların hepsinden daha düzgün... bu arada nasıl kadınlar girmiş lan benim hayatıma..
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    <a class="b" href="/?q=behzat+%c3%a7.">behzat ç.</a>'deki harun'dur.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=sak%c4%b1n+gelme">sakın gelme</a>) hazır değilim deliyim kaç gündür falan filan diye uzayan giden sözler öbeği. istemiyorum sevmek aşık olmak falan. uzak olsun bunlar benden. sen de uzak dur. sevgin çoksa git başkasına ver, bende harcanmasın. <br/>adamsan gelmezsin! sıkıyorsa hadi gel bakayım şimdi hıa!
  entry_channels: anket,ilişkiler
- entry_name: |
    şu anda çalan şarkı
  entry_id:  79362177
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    fotoğrafçı.<br/><br/>edo photography
  entry_channels: anket,ekşi-sözlük
- entry_name: |
    insanların hiç savaş çıkmayacakmışçasına yaşaması
  entry_id:  79386682
  entry_writer: tatli okur
  entry_fav_count: 0
  entry_content: |
    ırak, suriye gibi sömürülen ülke olacaksan bir savaş çıkar. bu dünya çapında bir savaş değil senin ülken bazında 1-2 ülke arasındaki bir savaş olur. fakat dünya çapında hala kapital düzen, endüstri 4.0, yapay zeka çalışmaları devam eder. <br/><br/>veya kapital sömürü düzeni işlememeye başlayınca savaş çıkar. bu dünya savaşıdır. şu an hala sistem işlediğine göre neden savaş çıksın ki?<br/><br/>bir ikincisi insanlar mutlu olmak istiyorlar. olumlu bakmak istiyorlar. güvende hissetmek istiyorlar. aksi takdirde yaşayamazlardı zaten, çıldırırlardı.
  entry_channels: 
---
