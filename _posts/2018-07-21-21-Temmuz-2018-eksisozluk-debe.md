...
- entry_name: |
    20 temmuz 2018 abd'nin türkiye'ye ambargo tasarısı
  entry_id:  79368781
...
- entry_name: |
    filipin polisine türk malı silah satılması
  entry_id:  79366779
  entry_writer: agirseviyorum
  entry_fav_count: 296
  entry_content: |
    (bkz: <a class="b" href="/?q=ama+saman+ithal+ediyoruz+amk">ama saman ithal ediyoruz amk</a>)<br/><br/>edit: güzel bir gelişme olduğu hakkında herkesin hemfikir olduğundan şüphem yok fakat "omo somon othol odoyoroz doyonlor bordo mo?" diye bulduğun her fırsatta insanları ötekileştirmeye çalışırsan insanlar da sana bir güzel giydirir oldu mu canım kardeşlerim?
...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    öğretmenlerin ek ders ücreti alması saçmalığı
  entry_id:  79359345
...
- entry_name: |
    halep'in türkiye'ye verilmesi müjdesi
  entry_id:  79381921
  entry_writer: dynamico
  entry_fav_count: 88
  entry_content: |
    (bkz: <a class="b" href="/?q=ileri+s%c3%bcr%c3%bcld%c3%bc+iddia+edildi+tarz%c4%b1+habercilik">ileri sürüldü iddia edildi tarzı habercilik</a>)<br/>(bkz: <a class="b" href="/?q=star">star</a>)
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 45
  entry_content: |
    sultan–ı yegah adlı parçayı çok güzel seslendiren bursasporlu kaleci.
  entry_channels: spor,sanat,müzik
- entry_name: |
...
- entry_name: |
    at bana göz kırparak onay verdi
  entry_id:  79377861
  entry_writer: swollenmember
  entry_fav_count: 18
  entry_content: |
    zihnin ne kadar gunlu ve yaniltici olduguny gozler onune seren durumdur. insan yapmak istedigi seyi yapmak icin kendisini ikna etme konusunda cok basarili. biz inanmak istedikten sonra beynimiz o seyin hakli ve normal oldugu konusunda kendisini cok iyi ikna edebiliyor.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    açık ara (bkz: <a class="b" href="/?q=volkswagen">volkswagen</a>)<br/><br/>tamam kötü marka değil ama türkiye'de abartıldığı kadar iyi bir marka da değildir. hele ülkemin güzel insanlarındaki premium marka algısı ise kesinlikle çok yanlıştır.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    istanbul-münih mi yazıyordu lan otobüsün üstünde?<br/><br/>(bkz: <a class="b" href="/?q=%c3%b6%c4%9frenildi%c4%9finde+ufku+iki+kat%c4%b1na+%c3%a7%c4%b1karan+%c5%9feyler">öğrenildiğinde ufku iki katına çıkaran şeyler</a>)
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    ya birisi su agzina sictigimin sozlugunu kapasin. bi forum scripti ile isi bitirsin. ya büyük kufredecegim ya... yok mu lan bi coder su isi yapacak.? <br/><br/>yazin yazin biraz daha yazin.!
  entry_channels: anket,tv
- entry_name: |
    yabancı olup da arabesk tadı veren parçalar
  entry_id:  79362769
  entry_writer: iconium
  entry_fav_count: 0
  entry_content: |
    bu gerçekten tam tanım olabilir. <br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=AAVn4-17Bjs">https://www.youtube.com/watch?v=aavn4-17bjs</a>
