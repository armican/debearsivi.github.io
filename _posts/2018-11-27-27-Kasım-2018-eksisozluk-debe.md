...
- entry_name: |
  ...
  entry_fav_count: 83
  entry_content: |
    hakikaten sözlük erkeklerinin içindeki bazı acayipler olduğunu gösteren olay. <br/><br/>baştan söyleyim meriç değilim, kız düşürme hayalim yok zaten futbol dışında da pek yazmam. <br/><br/>konuya girelim. bu hanım zamanında bir seyler yapmış, başından kötü olaylar geçmiş. nerdeyse tüm türkiye videosunu izlemiş. sonra kendince bir karar almış ve kendini tv’den çekmiş. yardım kuruluşlarına ve o tarz çalışmalara vermiş. sonra da kapanmış. bize ne, size ne? daha önce hata yapanlar yaşamayı hak etmiyor mu? ikinci şansı hak etmiyor mu? <br/><br/>nasıl olsa ifşa oldum, ohh herkese vereyim, mi deseydi? kendi kendine yeni bir yol çizmiş ve o yolda yaşamaya devam etmiş. bize de saygı duymak düşer. insanların geçmişte yaptıklarını çıkarıp çıkarıp durmak acizliktir.
...
- entry_name: |
  ...
  entry_fav_count: 75
  entry_content: |
    çok başarılı ve vizyoner olduğundan bahsediliyor.adamın en büyük başarısı doğmak.ülkenin en zengin ailesinin çocuğu olmaktan başka neyi başarmış merak ediyorum?
...
- entry_name: |
    3d printer'ın abartılmış balon bir icat olması
  entry_id:  83697480
  entry_writer: alpineksi
  entry_fav_count: 62
  entry_content: |
    moleküler biyoloji ve genetik de işin içine girince aklın başına gelir.
  entry_channels: anket,teknoloji
- entry_name: |
    25 kasım 2018 trabzonspor fenerbahçe maçı
  entry_id:  83699481
  entry_writer: ahwet79
  entry_fav_count: 57
  entry_content: |
    olaya farklı yönden bakalım. hep şampiyonluk kovalayacağız diye bir kaide yok ligin dibine renk kattık bence.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    turist kadınların yüzüne tükürmek
  entry_id:  83715624
  entry_writer: big manager
  entry_fav_count: 55
  entry_content: |
    türk taksicinin yaptığı hareket.<br/><br/>şerefli taksicimiz, 8 tl lik mesafe için turist kadınlardan 44 € istiyor. kadınlar çok fazla deyip 50 tl uzatıyor. taksici hem 50 tl alıyor hem kadınların yüzüne tükürüyor.<br/><br/>50 orospu birleşse sizin gibi çocuk doğuramaz.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="http://www.hurriyet.com.tr/gundem/taksici-dehseti-dolandiramayinca-yuzune-tukurdu-41031668" title="http://www.hurriyet.com.tr/gundem/taksici-dehseti-dolandiramayinca-yuzune-tukurdu-41031668">link</a>
...
- entry_name: |
  ...
  entry_channels: moda
- entry_name: |
    tokat atmak istenilen ünlü
  entry_id:  83708304
  entry_writer: dnazr
  entry_fav_count: 46
  entry_content: |
    kim kardashian’ın kıçı.
  entry_channels: anket
- entry_name: |
    25 kasım 2018 ukrayna rusya gerginliği
  entry_id:  83697181
  entry_writer: der meister
  entry_fav_count: 46
  entry_content: |
    jasfsjfsj 3-5 entry önce elemanın biri donetsk'in tek taraflı bağımsızlık ilan ettiğini yazmış. ulan cehalet neyse de bilmediğin şeyi biliyormuş gibi aktarma çılgınlığı muazzam bir şey. ukraynalı ve rus tanıdıklarım var, bizzat savaşmış adamlar tanıyorum, 4 yıldır bu savaşla yakından ilgileniyorum ama ben şuraya gelip "şu olmuştur" yazacak yeterliliğe sahip değilim henüz, adam "donetsk tek taraflı bağımsızlık ilan etmiş" diyor.<br/><br/>ulan o dediğin şey 4 sene önce oldu, yuh.
  entry_channels: siyaset,tarih,haber
- entry_name: |
    yapay zeka kontrolden çıktığında olacaklar
  entry_id:  83700167
  entry_writer: porn creep
  entry_fav_count: 44
  entry_content: |
    bilim kurgunun diger urunleri olan zombilerin ve kurt adamlarin insanlara savas acip kontrolden cikmasi ile ayni ihtimal dahilinde olan durum.<br/><br/>bir bilgisayar bilimcisi olarak 'yapay zeka' denen kavramin tamamen bir pazarlama tabiri oldugunu ve ortada bir zeka olmadigini, her seyin aslinda matematiksel bir modelleme oldugunu soylebilirim ama siz bu konuyu benden daha iyi bildiginiz icin yine sovmeye baslarsiniz
  entry_channels: anket,teknoloji
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 32
  entry_content: |
    dolar bir lira olursa milli hasılamız kabaca 5 trilyon dolar seviyelerine gelir ve türkiye dünyanın en büyük 4. ekonomisi haline gelir, bir senede milli gelirimizi 5 kattan fazla artıracağımız konusunda piyasada yeterli coşku yok.<br/><br/>bugünkü fiyatlamanın sebebi (bkz: <a class="b" href="/entry/83699038">#83699038</a>)
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    uyandıktan sonra tepki vermeleri için bir on altı yıla daha ihtiyaç vardır.
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    26 kasım 2018 dolar kuru
  entry_id:  83708925
  entry_writer: nutellali balik ekmek
  entry_fav_count: 7
  entry_content: |
    4'lü seviyelere doğru yelken açan kurdur.<br/><br/>sosyal medyada üzerinden dolar'ı olanlara büyük bir öfke var anlamak mümkün değil.<br/><br/>dolar'ı 4-5 seviyesinden alanlar vurdu kaçtı zaten.<br/><br/>6-7 seviyesinden alan adamların hangi motivasyon ile bu dolar'ı aldı onu iyi irdelemek lazım.<br/><br/>bu adamalar "dur lan kar yapayım" diye almadı dolar'ı. zira öyle bir bilinçte olsalardı muhtemelen 4-5 seviyesinden alırlardı.<br/><br/>bu insanlar; nasıl olsa hükumet olaya el koyar dolar çok artmaz diye diye doları izleyen sonra da cumhurbaşkanının "ben yaşadığım sürece o terörist salınmayacak" türü söylemleri ile panik yapıp dolar alan yatırımcılar.<br/><br/>yönetenlerin sorumsuzca davranışları, atar giderleri, gereksiz polemikleri dolar'ı haddinden fazla hararetlendirdi.<br/><br/>insanlar da haklı olarak panik yaptı.<br/><br/>ha bir de ben söylemiştimçiler var.<br/><br/>onlar recep tayyip erdoğan ile aynı ortamda takılıp bilgi aldılarsa haklılar ama onun dışında kimsenin bildiği bir bok yoktu. olay sadece tek bir kişinin kararına dayanıyordu.
  entry_channels: ekonomi
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    benim değil de arkadaşın aldığı not: 4/100.<br/><br/>işin ilginç tarafı hocanın standart puanı 5/100. adını yazana 05 verip geçiyor, bir nevi prensip meselesi yapmış hoca beyimiz. bizim paşa 4 alınca sorduk nasıl olur hocam diye. üşenmedi kağıtları çıkarttı. çocuğun adı özgür b xxx. bizim mal ise yazarken ögür b xxx yazmış.<br/><br/>adam döndü "ya evladım sövsem kırılacaksın 04 vermişim, sus işte" dedi<sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup> .<br/><br/><a class="b" href="/?q=bu+da+b%c3%b6yle+bir+an%c4%b1md%c4%b1r">bu da böyle bir anımdır</a>
  entry_channels: anket,eğitim
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    yurtiçi mng falan sövüyorsunuz da ben ne zaman aras kargodan gelecek bir ürün yolu gözlesem acaba şimdi bizi ne maceralar bekliyor kafasında oluyorum.<br/>inanın yurtiçi ups mng hatta sürat de bile bu kadar gerilmiyorum ki aras mutlaka bir sorun çıkarıyor. bundan sonra aras kargo ile çalışan bir yerden alışveriş yapmama kararı aldım. umarım sözlük bu konuda bir işe yarar, belki bir boykot olur malum önümüz yine indirim donemi işte o vakit en azından kendilerine çeki düzen verirler.<br/>ben anlamıyorum atanamayan öğretmenlerin inşaatta çalıştığı bir ülkede sımsıcak arabasında tek işi kargo teslimatı yapmak olan adam nasıl oluyor da sülalesi raat biri gibi davranabiliyor istediğin yere şikayet et bana bişi olmaz diye üstümüze yürüyebiliyor, evlerimizin kapısına kadar gelen çalışanlarınız güvenlik soruşturmasından geçiyor mu aras kargo? sabıka kaydı istiyor musunuz ya manyağın sapığın tekiyse bu insanlar? ben şahsen biraz önce yaşadığım olayda can güvenliğimin olmadığını düşünüyorum bir daha aras kargo mu asla buraya rezalet başlığı da açardım ama aras kargo adı yeterli bence..
  entry_channels: ekonomi,seyahat
- entry_name: |
    ezel ve çarpışma dizisindeki fetö mesajları
  entry_id:  83716074
  entry_writer: eksiyazariolmayaaday
  entry_fav_count: 2
  entry_content: |
    ilgiyle takip edeceğim başlık.<br/><br/>zira bu fetö akp den öncede vardı, akpyle de vardı, sonrasında da olacak.<br/><br/>devletini korumak biz sade vatandaşa kalıyor yine.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    (bkz: <a class="b" href="/?q=bajrangi+bhaijaan">bajrangi bhaijaan</a>)<br/><br/>müteaddit filmler şahsımı ağlatmıştır ama akla ilk gelen filmdir.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ne yazık ki bu zamanda facebook ve instagram'ın bulduğu kızlar ile evleniliyor.
