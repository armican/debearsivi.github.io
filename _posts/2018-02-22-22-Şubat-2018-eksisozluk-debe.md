...
- entry_name: |
  ...
  entry_fav_count: 37
  entry_content: |
    dolar: 3790<br/>euro: 4670<br/>ypg : 1780<br/><br/>ypg bu hafta da yükselişte.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    (bkz: <a class="b" href="/?q=eme%c4%9fi+ge%c3%a7en+herkesin+allah+belas%c4%b1n%c4%b1+versin">emeği geçen herkesin allah belasını versin</a>)<br/><br/>alnınızın arkasındaki et parçasını çalıştırın azıcık! <br/>sadece adı değişiyor olsa bu kadar tartışır mıydık? <br/>akademisyenlerden, bilim insanlarından, hatta eğitimli herkesten ölesiye nefret eden bu adam ismi seksi dursun diye bu ünvanı değiştirmiş olabilir mi?<br/>bu değişiklik kimin işine yarayacak? <a class="b" href="/?q=yanda%c5%9f">yandaş</a> olduğu halde <a class="b" href="/?q=do%c3%a7ent">doçent</a> olamayan kimler tek adımda doçentlik alacak?<br/>bu adım zaten boka batmış olan türk akademisini nasıl etkileyecek?<br/><br/>"türkiye'den başka yerde yardımcı doçentlik<sup class="ab"><a title="(bkz: assistant professor)" href="/?q=assistant+professor" data-query="assistant professor">*</a></sup> yoktu zaten" diyeni ıslak sopayla döverim bak, allah'ın adını verdim!<br/><br/>"milli eğitim bakanı ismet yılmaz, üniversitelerdeki mecut yardımcı doçent sayısını 35 bin 995 olarak açıkladı. yılmaz, bu sayının yasanın çıkmasıyla birlikte doktor ve öğretim üyesi olacağını söyledi.<br/><br/>yılmaz, teklif yasalaştığında eser inceleme araştırmasında başarılı olan adayların üniversiteler arası kurulca sözlü sınava gerek kalmaksızın doçentlik unvanının verileceğini, unvan alınmasıyla birlikte de diğer sürelerin başlayacağına işaret etti. yılmaz, eski kriterler ışığında eser inceleme araştırmasında başarılı olup, sınavda başarısız olanların güncel doçentlik kriterlerine tabi tutulmayacağını bildirdi."<br/><br/>meali: <br/>"bizim çocuklar jüri karşısına çıktı mı şebeğe dönüyorlar. iyisi mi şu jürilik işini kaldıralım.<br/>eserleri pakistan dergilerinde bassalar, yazılı sınavı da biz hallederiz (öbür sınavlardan deneyimliyiz), ver elini doçentlik!"<br/><br/>edit: (trmert'in uyarısıyla)<br/>zaten milli eğitim bakanının bu olayla ne alakası var? ne hakla akademik ünvanlara karışıyor? üniversite ilkokul gibi işleyen bi yapı mı? hani bi araştırma vardı n'oldu o? tank mank yapacaktık. dil bilmeyen, makale okuyamayan konyalı bilim adamları mı yapacak o tankı?
- entry_name: |
    makyajla elde edilen güzelliği genlerle aktarmak
  entry_id:  74393587
  entry_writer: kahve muptelasi
  entry_fav_count: 3
  entry_content: |
    güzellik yüzeyde kalır. önemli olan daha derinlerde gizli olanlar. sen aynaya bakarsın, tanrı ise ruhunun içine...
- entry_name: |
    #taraflımhkyandaştff
  entry_id:  74392562
  entry_writer: gorkmm
  entry_fav_count: 2
  entry_content: |
    feghouli ve belhandaya yapılanlardan sonra aklı selim her galatasaraylı destek verir bence.
- entry_name: |
    netflix türkiye
  entry_id:  74382327
  entry_writer: guesey
...
- entry_name: |
  ...
  entry_id:  74392934
  entry_writer: radomir
  entry_fav_count: 1
  entry_content: |
    malesef istedigin kiyafeti giyip rahatca sokakta dolasmak, soyle bir agacin golgesinde uzanip kitap okumak parayla satin alinamiyor. ha sen bahceli ev alip hep ayni agacin altinda uzanmaktan zevk aliyorsan, mini etegini giyip surekli bebek'te gezmekten hoslaniyorsan o baska ama
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    x'den y yaparsa, z olacaktır.<br/><br/>bakıyorum herkes bir senaryo yazıp çiziyor. ya hu siz lise de 2 bilinmeyenli denklemleri çözemiyordunuz, ne ara 3 bilinmeyenli denklemlerde uzman oldunuz.
---
