...
- entry_name: |
    çiçeksepeti'nin bana yaşattığı trajikomik olay
  entry_id:  79830518
...
- entry_name: |
    2 ağustos 2018 abd f-35 yaptırımı
  entry_id:  79815272
...
- entry_name: |
    abd'nin türk yargısına müdahalesini haklı görmek
  entry_id:  79834329
  entry_writer: sodyumklorur
  entry_fav_count: 22
  entry_content: |
    orospu çocuğu dincilere dert olandır.<br/><br/>siz değil misiniz ülkenin yargısının içine eden? ben kendim güvenmiyorum yargıya, elin gavuru neden güvensin? yargımız bağımsız değil, yukarıdan ne emir gelirse onu yapıyorlar, casus olduğu bilinen rahibi yukarıdan gelen emirle saldılar, amerika biraz daha bastırınca da suçsuz diyecekler.<br/><br/>suçlusu da solcular ha? nasıl kansız, şerefsiz organizmalarsınız siz ya? <br/><br/>amerika'nın desteğiyle iktidar olup yıllarca ortadoğuda amerikan emperyalizminin maşası olan kim? bop eşbaşkanıyım diye açıklama yapan kim? o da mı solcu?
  entry_channels: siyaset
- entry_name: |
    bedelli askerlik
  entry_id:  79822069
  ...
  entry_fav_count: 21
  entry_content: |
    evet saçımı kestirmek bile zul geliyor amına koyduğumun tırrekleri-gereksizleri-6 ay erlik yapmış yarrakları. siz gram sikimizde değilsiniz.<br/><br/>21 gün kalksın, internetten video falan izlemeli dersler olsun işte. next, next , next.
...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    yaşamak için hayatımızı kiraya veriyoruz.
...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    benim gibi birçok insanın oy vermiş olmaktan gurur duyduğu, gönül rahatlığıyla "vekilim" dediği kişidir. bir yığın vasıfsızın milletvekili yapıldığı bir ülkede vekilim demekten gurur duyduğum bir milletvekili en son ne zaman oldu hatırlamıyorum.<br/><br/>bir de hatırlatmakta fayda var: kendisini vekili olarak gören kişiler, twitter, sözlük gibi mecralardaki dinci faşist soslu propagandaların etki edebileceği, aklını bulandırabileceği kişiler değildir.
  entry_channels: siyaset,haber
- entry_name: |
    meslek sahibi erkek vs lise mezunu zengin erkek
  entry_id:  79831298
  entry_writer: teo the leo
  entry_fav_count: 16
  entry_content: |
    2018 ekonomik şartlarında bütün kadınlar ikinciyi seçecektir. ha buraya birinciyi seçeceklerini yazacaklar tabi ki inanmayın.
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    nerdesiniz amk aktrolleri, amk çomarları. çıkınlan ortaya. bu sizin eseriniz. ne hale getirdiniz ülkeyi, 17 senedir kemire kemire devirdiniz. dolar 5 oluyor, devlet erkanı toplantılarını 5 yıldızlı otellerde yapıyor. ben de yanacağım ama zevkle izleyeceğim ülkenin iflasını, kapanan dükkanları. belki işsiz kalacağım ama her şirket battığında bir keyif sigarası daha yakacağım.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    siyah ekran ihtimali
  entry_channels: anket
- entry_name: |
    doların 5 oluşuna halkın tepkisiz kalma sebebi
  entry_id:  79839746
  entry_writer: insan donuna girmis telli turna
  entry_fav_count: 6
  entry_content: |
    2002'de dolar 1,4 lira iken tepki gösteren halkın, doların 5'i geçişine sessiz kalmasının nedeni.<br/><br/>sanırım recep teyyip erdoğan ismine olan güven ve kendisinden bir zarar gelmeyeceğine olan inanış.<br/>gün geçtikçe fakirleşmemize rağmen çoluğunu çocuğunun geleceğinden kaygı duymayan halktaki rahatlığın sebebi bu sanırım.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    yonetimindeki bazi kliklerin kurultay olmasin diye canla basla calistigi partidir.<br/><br/>bakin cok enteresan, bu tipler kurultay olmasin diye gosterdikleri cabayi 180.000 sandiga gorevli bulmak, oylari arttirmak icin harcada partinin oyu ilk secimde %5 artar.
  entry_channels: siyaset,haber
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    burda kutsal meslek yapıyorum diye zırlayan daha çok maaş isteyen öğretmenlere gelsin bu sonuçlar. baya kutsalmışsınız harbiden. öğretmenin matematiği ne ki öğrenciye ne öğretecek aq? yetiştirdiğiniz nesil işsiz, siz de vasıfsızsınız.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    ben bunu sevgilime hep yapıyorum. ozellikle duştan çıktıktan sonra yanımdayken bile o lavaboya gitsin odasından hemen nude fotomu atıyorum. <br/><br/>en son telefonum bozulmuştu. açılmadığı için direkt tamirciye götürmüştüm. <br/><br/>çok rahat bir kadın olduğum için telefonda sifre de yoktu. tüm hafta gebermistim stresten.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    sahilde elinde yeni açılmış buz gibi bira varken ufukta midyeciyi görmek.
  entry_channels: anket,ilişkiler
- entry_name: |
    digiturk
  entry_id:  79833770
  ...
  entry_fav_count: 0
  entry_content: |
    gereksiz platform. bence paralı platformların hepsi gereksiz. yaşasın bağımsız <a class="b" href="/?q=t%c3%bcrksat">türksat</a> 4a!
