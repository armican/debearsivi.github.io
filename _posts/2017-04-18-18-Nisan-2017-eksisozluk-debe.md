...
- entry_name: |
    afd'nin evetçiler türkiye'ye dönsün açıklaması
  entry_id:  67533117
  entry_writer: gelecomp
  entry_fav_count: 289
  entry_content: |
    kesinlikle desteklediğim açıklama, gelin da, yiyorsa gelin.
- entry_name: |
...
- entry_name: |
  ...
  entry_content: |
    hile yapmasin yeter
- entry_name: |
    17 nisan 2017 agit açıklaması
  entry_id:  67533368
  entry_writer: 80 li yillari cok ozluyorum lan
  entry_fav_count: 59
  entry_content: |
    la saçmalamayın olm..<br/><br/>dünya liderleri daha dün gece aradılar başkanımızı..<br/><br/>cibuti, katar, pakistan, bahreyn mahreyn emirleri, prensleri, kralları, kontları hep aradı dün gece..<br/><br/>hiç mi sabah okumuyorsunuz..<br/><br/>biz hedefimiz olan ligdeki liderlerden meşazları aldık..<br/><br/>kim takar agit'i..<br/><br/>agit ney amk?
- entry_name: |
    bayburt
  entry_id:  67523702
...
- entry_name: |
    pusulaya mühür basmayı unutan sandık görevlileri
  entry_id:  67531404
  entry_writer: gilestel
  entry_fav_count: 43
  entry_content: |
    ülkenin kaderini belirleyecek bir referandumda, karşılığında ödeme alarak görevlendirilmelerine rağmen, yapmaları gereken en basit işi bile yarım yamalak yapmış görevlilerdir. <br/><br/>madem ysk hatanın seçmende değil bu görevlilerde olduğunu beyan etmektedir, bu görevliler hakkında cezai işlem yapılması elzemdir. görev aldıkları referandumun, en temel gerekliliklerini bile yerine getirmekten aciz bu görevlilerin cezalandırılması, mühürsüz pusula skandalının kurmaca olduğu şüphesini hafifletecektir. <br/><br/>bu görevliler hakkında işlem yapılmaması, bu "unutma" eylemini talimat doğrultusunda yaptıklarının bir göstergesi niteliğinde olacaktır.
- entry_name: |
    fatih portakal
  entry_id:  67535087
  entry_writer: wxivi
...
- entry_name: |
    abd'nin 16 nisan referandum sonuçlarını tanımaması
  entry_id:  67538856
  entry_writer: nerede o eski bayramlar
  entry_fav_count: 30
  entry_content: |
    asıl acınası olanlar referandumdaki hırsızlığı görmezden gelip zafer kutlamaları yapanlardır. eğer bu iş türkiye içinde çözülemiyorsa, yani hukuk bitmişse, dış güçler müdahil olacaktır. bu her ne kadar bizim için üzücü olsa da bu işin buraya geleceği, modern türkiye cumhuriyeti'ni basit bir ortadoğu diktatörlüğüne dönüştürmeden önce düşünülmeliydi.
- entry_name: |
...
- entry_name: |
    mühürsüz oy pusulalarının tamamında evet çıkması
  entry_id:  67535666
  entry_writer: adet adet insan
  entry_fav_count: 13
  entry_content: |
    akam'ın <a rel="nofollow noopener" class="url" target="_blank" href="http://ilerihaber.org/icerik/akamin-sahibi-ozkiraz-muhursuz-oy-pusulularinin-tamaminda-evet-cikti-70669.html" title="http://ilerihaber.org/icerik/akamin-sahibi-ozkiraz-muhursuz-oy-pusulularinin-tamaminda-evet-cikti-70669.html">açıklaması</a>.<br/><br/>bu konuda kimsenin dillendirmediği bir husus var. açıklamalara göre bu kaos önceki seçimlerin aksine oy pusulalarının seçim günü sandık başkanlarına emanet edildiği için çıktı. madem öyle, ülkenin kaderini etkileyecek bir referandum öncesi bu karar neden alındı? takibin zor olduğu doğu illerinde oranı artıracak hayali evet oylarının meşruluk kazanabilmesi için olmasın? mis gibi gerekçe. evet basılı mühürleri de geçerli saymamız lazım ama ortada hiçbir sebep yokken mühürsüz pusulaları geçersiz sayamayız, pusulaları geç dağıtalım mühürleme işlemi yetişmedi deyip oyları geçersiz sayarız. <br/><br/>(bkz: <a class="b" href="/?q=minareyi+%c3%a7alan+k%c4%b1l%c4%b1f%c4%b1n%c4%b1+haz%c4%b1rlar">minareyi çalan kılıfını hazırlar</a>)
- entry_name: |
    selman öğüt
  entry_id:  67541730
...
- entry_name: |
    bunlar gezici tencere tava hep aynı hava
  entry_id:  67539367
  entry_writer: asiriciddilibifindik
  entry_fav_count: 1
  entry_content: |
    şu lafı ne zaman duysak bizim ülkede güzel birşeyler oluyor hadi inşallah diyelim. ayrıca bi mutfak alet edevatından ne kadar korkulabilirse korkan ama dünyaya kafa tutan yüce reisimiz!
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    gerçeği herkes biliyordu, yalanı kimse yenemedi.
- entry_name: |
    17 nisan 2017 memurlar.net'te yayınlanan yazı
  entry_id:  67541157
  entry_writer: kerevizyon
  entry_fav_count: 0
  entry_content: |
    ya ne olacaktı. açık açık 657'yi değiştireceğiz diyorlar. bundan sonra hala bunları destekleyen memur da başına geleni hak ediyordur.
---
