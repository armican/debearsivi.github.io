...
- entry_name: |
    sevişmeden hemen önce tuvalete giren kadın
  entry_id:  84867205
  entry_writer: ruhum kirmizi
  entry_fav_count: 163
  entry_content: |
    çişimiz geliyor ve eğer yapmazsak orgazma yaklaştığımızda altımıza işeyecek gibi oluyoruz. bunun yanında bizim cinsel organımız içeride duran, terleyebilen ve hatta kokabilen bir organ. girip bir kontrol etmek, çantamızda bulunan genital bölgeye özel yapılmış ıslak mendille temizlemek istiyor olmamız da çok doğal. bunu geçtim diş fırçalamak, şöyle kendine bir bakıp çeki düzen vermek, belki parfümü tazelemek de tuvalete gitmek için bir sebep olabilir. <br/><br/>olaya başlamışken kalkıp gitmek heyecanı azaltıyor ama biz de ihtiyaçları olan insanlarız. hayat porno filmlerdeki gibi olmuyor ne yazık ki.
...
- entry_name: |
  ...
  entry_fav_count: 159
  entry_content: |
    son zamanlarda uyumak sanki şeytani bir şeymiş gibi algı yaratılmaya çalışılıyor. bence şu hayatta bedava olan en güzel şey uyumak. insanların bu uyumayla derdi ne anlamıyorum. yok 3 saat uyuyormuş, yok 5 saat uyuyormuş. gören de uyanıkken atomu parçalıyorlar zanneder. <br/><br/>şahsen 9 saat uyuyorum. 15 saat uyanık kalıyorum. 3 saat uyusam 21 saat mal mal gezerim ortalıkta. günde 15 saat uyanık kalmak neyinize yetmiyor. <br/>ayrıca, <a class="b" href="/?q=hayat+%c3%a7ok+mu+g%c3%bczel+lan">hayat çok mu güzel lan</a>.
...
- entry_name: |
    ekrem imamoğlu cumaya gitti diye çıldıran basın
  entry_id:  84879024
  entry_writer: xrated
  entry_fav_count: 53
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 23
  entry_content: |
    kısa bir araştırma sonucu ceza ilk albümü olan medcezir’i 2002 yılında çıkarmış, bu arkadaş o sıra 11 yaşındaymış. başka bir sözüm yok.<br/>edit: solo olarak ilk albümüymüş. daha öncesinde 2000 yılında albümü varmış.
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    cem yılmaz dendiği an komedi filmi beklemeniz elbette algıdan ve kendisinin mesleğinden dolayı ancak bu adam komediyi bırakıp gerçek manada sinema filmi yapmaya karar vereli çok oldu. o yüzden komedi bekleyenler beğenmeyebilir. <br/><br/>fragmana gelirsek ilk film dram ikinci film ise bilim kurgu ağırlıklı. tiyatro sahnesi gibi iki perdeli, farklı bir film olacağı kesin. bilim kurgu olanının efektleri çok sağlam gibi duruyor. cem yılmaz’ın sürekli değişik şeyler denemesi bir sinemasever olarak beni çok mutlu ediyor şahsen.<br/><br/>bir cem yılmaz filmi.
...
- entry_name: |
  ...
  entry_id:  84856891
  entry_writer: kadir3448
  entry_fav_count: 3
  entry_content: |
    babam ve oğlum sessiz sessiz inmişti damlalar yamağından ..
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    az onceki smacindan sonra vesely'ye artistlik yapan randolph'un 10 saniye sonra, vesely'nin smacina yukselmeye bir tarafinin yemedigi mac
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  84881753
  entry_writer: alparslan cagatay
  entry_fav_count: 0
  entry_content: |
    şehir efsanesi olduğunu düşündüğüm, en azından benim için öyle olan kadın türü.
  entry_channels: anket,ilişkiler
- entry_name: |
