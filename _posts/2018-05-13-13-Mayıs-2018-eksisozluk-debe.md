...
- entry_name: |
    selçuk bayraktar'ın endüstri 4.0 yorumu
  entry_id:  76889382
  entry_writer: iydeiydedupdubudupdupdupdudupdudupdupdup
  entry_fav_count: 134
  entry_content: |
    yav bu adam yerli milli diye gazel okuyor da, <br/>osmangazi köprüsü'nü ve marmaray'ı yapmak için niye yerli ve milli bir yol izlemediler. lan marmarayın açılışında japon başbakan yok muydu? kadıköy metrosu kore malı lan. osmangazi'den geçiş dolara endeksli. sen iki tane siha, iha yaptın diye kime artistliğin? o kadar artisliği tübitak'ın reddedip yurtdışındaki bilimsel yarışmalarda ar-ge ödülü alan liseli çocukların haklarını savunmak için kullan be iktidar yalakası. neymiş endüstri 4.0 terminolojisi dış mihrakların işiymiş. aynı kafa matbaayı geciktiren osmanlıda vardı. elindeki işi kaybetmek istemeyen yazıcılar ayaklandı. bunun aynısı übere ayaklanan sarı taksilerde de görebilirsiniz. lan ürettiğin iha'daki kadar aklın olsa, muhalefete laf çakcam diye muhalefete yaptığın muhalefeti tübitak'taki ar-ge çalışmalarında dönen rezaletlere ses çıkarırdın.
...
- entry_name: |
  ...
  entry_fav_count: 103
  entry_content: |
    hoşgörü ve saygı dini olarak insanlara anlatılan islamiyeti hoşgörü ve saygı bekleyip islama aykırı tüm davranışlatı kısıtlamaya çalışma ve aksi durumlarda tekme tokat dalma dinine çevirenlerin son uygulamalarından biri. <br/><br/>sonra gençler deizme kayıyor diye sonuçlar çıkınca şaşırıp panikliyorlar. neden oluyor diye bi düşünseler keşke.
  entry_channels: siyaset,haber,yeme-içme,eğitim
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    hz. diye başlayan dini diziler.<br/><br/>(bkz: <a class="b" href="/?q=nihat+hatipo%c4%9flu">nihat hatipoğlu</a>)
  entry_channels: 
- entry_name: |
    furkan bölükbaşı
  entry_id:  76892927
  ...
  entry_fav_count: 13
  entry_content: |
    (bkz: <a class="b" href="/?q=%c5%9fizofren">şizofren</a>)
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    dikkat et son maçta kombine kartı yakmayasın koca oğlan:)
  entry_channels: spor
- entry_name: |
    hayatın anlamını bulduktan sonra yapılacak ilk şey
  entry_id:  76916705
  entry_writer: madamdavinci
  entry_fav_count: 2
  entry_content: |
    bi' çay koyulur.<br/>(bkz: <a class="b" href="/?q=umut+sar%c4%b1kaya">umut sarıkaya</a>)<br/><a rel="nofollow noopener" class="url" target="_blank" href="http://komeditarlasi.blogspot.com.tr/2012/11/umut-sarkaya-hayatn-anlamn-bulduktan-3.html" title="http://komeditarlasi.blogspot.com.tr/2012/11/umut-sarkaya-hayatn-anlamn-bulduktan-3.html">http://komeditarlasi.blogspot.com.tr/…duktan-3.html</a>
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=S_E2EHVxNAE" title="https://www.youtube.com/watch?v=S_E2EHVxNAE">richard marx-right here waiting</a>
