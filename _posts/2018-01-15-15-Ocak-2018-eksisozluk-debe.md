...
- entry_name: |
  ...
  entry_fav_count: 157
  entry_content: |
    ocak 2016 dolar kuru: 2,95<br/>ocak 2018 dolar kuru: 3,75<br/><br/>aynı fiyata sattığında değer kaybı: %25 civarı<br/><br/>evet tam bir değer koruma aracı.
- entry_name: |
...
- entry_name: |
    14 ocak 2018 chp istanbul seçim rezaleti
  entry_id:  73488788
...
- entry_name: |
  ...
  entry_fav_count: 38
  entry_content: |
    sikerim "tiki-taka"sını...<br/>yaşasın dikine, hızlı futbol
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 35
  entry_content: |
    (bkz: <a class="b" href="/?q=az+uzakla%c5%9f+dedirten+siyonist+z%c4%b1rvalar%c4%b1">az uzaklaş dedirten siyonist zırvaları</a>)
- entry_name: |
    arda turan
  entry_id:  73483797
  entry_writer: n8
...
- entry_name: |
    14 ocak 2018 sonar anketi
  entry_id:  73501011
  entry_writer: onurdemir
  entry_fav_count: 25
  entry_content: |
    eğer seçim bu ankete yakın oranda çıkarsa;<br/>1) seçim akp ve yavrusu mhp tarafından provoke edilir.<br/>2)medya baskısı yapılarak seçim yenileme gündeme gelir.<br/>3) seçim yenileme kararı alınır.<br/>4)yeni seçime kadar şehit haberleri artar, birkaç bomba patlar.<br/>5)medya, ''erdoğansız türkiye'nin sonu böyle olur'' başlıkları atar.<br/>6) halk korkar, dolayısıyla kararsızların ve medyaya göre şekillenen korkakların oyları değişir.<br/>7)yenilenen seçimi erdoğan kazanır.<br/>8)basın ''erdoğan'ın muhteşem zaferi'' diye duyurur.
- entry_name: |
...
- entry_name: |
    14 ocak 2018 zaytung rezaleti
  entry_id:  73497355
  entry_writer: stockholm sen de mi
  entry_fav_count: 19
  entry_content: |
    paranın her sorunu çözdüğü günümüze iyi bir gönderme olmuş.<br/><br/>kaybetseydi, ölseydi, olsaydı varsayımlarını pas geç.
- entry_name: |
    arif v 216
  entry_id:  73483508
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    evet futbol dersi vermiştir. city defansının yaptığı 1000 tane hatayı liverpool ve klopp yaptırmıştır, mecbur bırakmıştır. şunu da hatırlatmam gerekiyor sanırım defansının bok gibi kalecilerinin kova olduğu takım city değil liverpool.<br/><br/>edit: sanırım iyi hatırlatamadım. sezon boyu ederson'a kusursuz denildi. olayın şansla felan ilgisi yok yani. 80. dakikada ve 4-1 öndeyken bile sol bek robertson kaleciye pres yapıyordu görmediniz sanırım. hayır siz mane'nin attığı gole de şans kaleci hatası falan dersiniz.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    hadep'in olası operasyon ile ilgili görüşü;<br/><br/>başarılı olursa iç savaş çıkar, başarısız olursa darbe olur.<br/><br/>bu saçma açıklamadan benim anladığım eğer afrin'i alırsanız türkiye'de yaşayan kürtler niye afrin'i alıyorsunuz diye türklere saldırır. adam bildiğin istanbul'da ankara'da falan cadde ortasında kürtlerin türklere pompalı, havalı-kelebek falan dalacağını düşünüyor. niye? ordu afrin'e girdi. doğu'dan bahsetmiyordur çünkü en son rojava'da öğrendiklerine güvenip hendek kazdılar son karede kilotla kelepçeleniyorlardı. :) bu sahne 1984 yılından beri bir an bile değişmedi bu arada.<br/><br/>başarısız olursa kısmına girmiyorum zaten kendileri de 140 karakter dolsun diye yazmıştır.<br/><br/>kuzey suriye'de yaşanacak savaşı türkler seçmedi. bu savaşı bilerek ve isteyerek ayrılıkçı kürtler seçti. türk ordusu ve milleti durup dururken oraya saldırıyormuş gibi saçma bir algı var. hem g.tüm s.k.lmesin hem ayranım dökülmesin yok. savaş kapıya geldi çıkın sahiplenin.
- entry_name: |
    bikini giymediği için karısını boşayan laik erkek
  entry_id:  73501326
  entry_writer: garbaged
  entry_fav_count: 10
  entry_content: |
    tipik bir <a class="b" href="/?q=furkan+b%c3%b6l%c3%bckba%c5%9f%c4%b1">furkan bölükbaşı</a> karalama kampanyası. "çocuğumuzun her hangi bir inanca sahip olması konusunda baskıcı olmamamız gerektiğini ..." diye yazan adam için "çocğunun ateist olmasını isteyen biri" diye bahsediyor. eşine iç çamaşırı alan birine "muhtemelen fantezi için" diyor. gerisini okuma ihtiyacı bile duymadım, gerisi de muhtemelen böyle çarpıtmalarla dolu. bu utanmaz arlanmaz hala ekşi sözlükte yazıyor, yazmakla kalmıyor iftira atıp ve yalan söylüyor.<br/><br/>bu kadar rahat yalan söyleyen, başkalarının onuruyla oynayabilen, bu derece haysiyetsiz adamların ekşi sözlükte yazması artık skandal değil. hele hele hakkında <a class="b" href="/?q=fet%c3%b6">fetö</a> iddiaları bu kadar güçlü olan biri olmasına rağmen değil. asıl skandal bunları rahatlıkla yazabilmesine ekşi sözlük yazarlarının göz yumması.
- entry_name: |
...
- entry_name: |
    bursa'da engelli kadının halk otobüsüne alınmaması
  entry_id:  73497524
  entry_writer: massax
  entry_fav_count: 7
  entry_content: |
    özel halk şoförlerinin çoğu afedersiniz malum ırk, o yüzden kendilerini yolların ve bursa’nın ağası zannediyorlar.<br/><br/>bunları şikayet etsen de denetim mekanizması yok.
- entry_name: |
    antidepresan
  entry_id:  73499050
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    malum memleket malum ırk ne desek ne söylesek tesiri yok. cidden utanıyorum sıkılıyorum bu döl artıkları ile aynı havayı solumaktan aynı ülkede yaşamaktan. neden danimarka, isveç,norveç,finlandiya,izlanda bu ülkelerden herhangi birinde doğmadık biz ya. ne günah işledik de buralara düştük. bize de piyangodan orta doğu çıkmış ne yapalım.
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    doktor öğretim görevlisi olarak güncellendi.<br/>ıvır zıvır bir şeyler daha eklenmiş.<br/>ıvır zıvır diyorum çünkü isim ve prosedürü değiştirmenin yenilik yada devrim niteliğinde olmaması...
- entry_name: |
    şu anda çalan şarkı
  entry_id:  73486626
  ...
  entry_fav_count: 2
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/5D3Nl1GZzuw" title="https://youtu.be/5D3Nl1GZzuw">chris isaak - wicked game</a>
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    bu sözlük kapatılamaz, rahat olun. buraya hükümetin de ihtiyacı var. nefretten besleniyorlar. burada da karşı cenahı sürekli aşağılayan nefret dolu bir kitle var. sözcü, halk tv vs. dokunulmaz. iyi parti, abdullah gül gibi oluşum ve kişiler onlar için asıl tehlike. çünkü tek amaç ortalama yüzde 42-43'lük kemik kitleyi korumak.
- entry_name: |
    ekşi itiraf
  entry_id:  73485472
...
- entry_name: |
    bedelli askerlik
  entry_id:  73501759
  entry_writer: anton kopegi
  entry_fav_count: 1
  entry_content: |
    daha bu konu hakkında ne söylemek lazım. insanları bu kadar kıvrandırmaya gerek yok. bu bir düzene oturtulabilir. belli periyotlarla yapılması lazım artık. <br/><br/>şu an askerdeyim, 369. kısa dönem olarak bi yerlerde vatani görevimizi yapıyoruz da ne faydam var burada orduya çok merak ediyorum. <br/><br/>imkanı olan gelmesin :)<br/><br/>$: 92 aq
- entry_name: |
    yalnızlık
  entry_id:  73486165
  ...
  entry_fav_count: 0
  entry_content: |
    yemeden içmeden...<br/>geçen sene önceydi kesilmeden.<br/>gece ikibuçuk, nehrin kenarında uyandım. en son dans ettiğimi hatırlıyorum. bir de tuvaletten çıkışta iki herifin üzerime yürüdüğünü.bırakmışım kendimi yere, hızlı düşmekten sağlam sopa bile yiyememişim.<br/><br/>ertesi sabah koşarak adnan geldi."abi iyi misin?" dedi.<br/><br/>hafiften çenem çıkmış, oturtmuşum yerine ama adnan'ın sadece iç çamaşırları var üzerinde.o güzelim çifkartal atleti yırtılmış boydan boya, kolları morluk içinde.adnan ustam kaşın açılmış, iyi misin, hayırdır dedim. abi sen nasıl sağ çıktın oradan dedi. nereden? diyebildim sadece.son hecemde gözüm daldı.<br/><br/>den...<br/><br/>den... <br/><br/>ısrarla, tutkuyla dövülmüş ama hissetmiyordum.adnan son âna dek beni korumuş ama ağır darbe alıp pantolon da parçalanınca ya skerim satafaranızı diye bağırıp donuyla ormana doğru kaçmış.abi vallahi bırakıp kaçmazdım ama takdir edersin ki benim de geçmişimi sikti orospu çocukları ayrıca döndüm baktım, sen zaten ölmüştün, dedi.ölmedim adnan, dedim müstehzi ama epey yamuk dudağımla. her sey için şağol adnan, şaol.yalnızlıktan un ufaktım. etrafımdakiler darmadağın.yine öyle.
- entry_name: |
    black mirror
  entry_id:  73496009
