...
- entry_name: |
  ...
  entry_fav_count: 168
  entry_content: |
    netflix'i takip eden ve haberi olan insanlar evlilik programlarından ve esra erol'dan hazzetmiyor.<br/><br/>ve netflix'in yaptığı reklama bak. memleketin her kurumunda insanlarla taşşak geçen birileri var. sanki inadına yapıyorlar.
- entry_name: |
    volkswagen polo
  entry_id:  73490827
...
- entry_name: |
    abd'nin türkiye sınırına 30 bin ypg'li yığması
  entry_id:  73497109
  entry_writer: mazda
  entry_fav_count: 100
  entry_content: |
...
- entry_name: |
  ...
  entry_id:  73499259
  entry_writer: birnevihastalik
  entry_fav_count: 3
  entry_content: |
    dünden önceki güne kadar niye açılmadığını merak etmekteyim.
- entry_name: |
