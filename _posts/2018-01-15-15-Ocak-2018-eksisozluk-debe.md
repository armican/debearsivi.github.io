...
- entry_name: |
    açılacak sexshop mağazası için isim önerileri
  entry_id:  73484302
  entry_writer: not et anonim olmasin
  entry_fav_count: 107
  entry_content: |
    (bkz: <a class="b" href="/?q=karde%c5%9fler+seks+market">kardeşler seks market</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    üç dört gün önce evraklarımı yollayıp abonesi oldum, geçen gün telefonu bağladılar bugün de bir çalışanı arayıp adres tarifi sordu, telefonu kaydedip whatsapp'tan konum yolladım. neyse bu çalışan geldi, bağlantıları kurdu kendi modemi ile internetimi aktif hale getirdi fakat modemimin mevcut sistemi karşılayamayacağını söyleyip farklı bir modem almam konusunda beni ayrıntılı bilgilendirdi.<br/><br/>velhasıl, akşam 11 gibi eve geldim yeni modemimle kurulum yaptım ama bir türlü bağlantı sağlayamadım. wp'tan bana gelen arkadaşa yazdım, durumu anlattım. üç beş dakika sonra hemen ilgileniyorum "abi" diyip bilgisayara teamviewer kurmamı istedi. neyse, bilgisayarıma bağlanıp uzaktan kontrolle iki dakika içinde internetimi aktif hale getirdi.<br/><br/>ben böyle hizmet görmedim ömrü hayatımda.<br/><br/>bu bahsettiğim olay gece yarısına doğru saat 11:45'te sonlandı.<br/><br/>teşekkür ederim turk.net.<br/><br/>benim açımdan şu ana kadar müşterisinin her an, her saat yanında bir internet sağlayıcısıdır.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    cenk everton'a transfer oldu diye sevinirken, şimdi de bu çocuk bu takımda nasıl gol atacak dye düşünmeye başladık.<br/><br/>allah yardımcısı olsun, çok zor o takımda gol atmak. hele de pl'de
- entry_name: |
    sözlükteki doktorlar
  entry_id:  73494513
  entry_writer: teres
  entry_fav_count: 4
  entry_content: |
    psikiyatri ve nöroloji tahsisi yapmış olanlarına çok iş düşecek tıp doktorlarıdır.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    teşekkürler siyonist kardeş ama, natalie portman'ı al, gerisini at çöpe, bildiğin kuduz köpeklerin barınağıdır, ülke demiyorum bak, filistin topraklarında bir barınak.
- entry_name: |
