...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/r9p8N9hb7F8" title="https://youtu.be/r9p8N9hb7F8">seçil - uhde</a>
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    tinerci tayfanın dansöz gibi bir karaktere sahip olduğunu gösteren çin malı qral.<br/><br/>karakter sahibi bjk taraftarını tenzih ederim.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    "– bu çalan nedir?<br/>+ edith piaf diye bir kadın..<br/>– ne anlatıyor bu şarkıda?<br/>+ ne kadar sevdiğini… ama terk edilmiş.. hep hayal kırıklığı yaşamış..<br/>– bunu bir süre daha dinlersek, almanların beni öldürmesi gerekmeyecek."<br/><br/>(bkz: <a class="b" href="/?q=steven+spielberg">steven spielberg</a>) (bkz: <a class="b" href="/?q=er+ryan%27%c4%b1+kurtarmak">er ryan'ı kurtarmak</a>) (1998)
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    özelden link bekliyorum.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    araç sollarken selektör yapan barzo
  entry_id:  87811140
  entry_writer: pruvikasit
  entry_fav_count: 0
  entry_content: |
    sollamak için serit degistirdigimde bir kere selektör yaparım ki sollayacagim aracın yanından geçerken tedbirli olsun diye ama böyle tampona yapisip selektör yapan net oçdur.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bugün öğleden sonra sürekli evde takıldım, haber kanallarına bakayım dedim. saydım tam 5 kez tüm haber kanallarında yayın kesilip ak parti genel başkanının mitingine canlı bağladılar. diğerlerinin adını anmaktan imtina ediyor tarafsız ve bağımsız medyamız.<br/>muhalefet acilen kanalların onunde miting düzenlemeli. bu haksızlığı dile getirmeli.
  entry_channels: siyaset,haber
---
