...
- entry_name: |
  ...
  entry_fav_count: 27
  entry_content: |
    kadınların kuaförde banyo yaptığını sananlara dert olur.
...
- entry_name: |
  ...
  entry_channels: siyaset
- entry_name: |
    negatif cenazenin pozitif çıkması rezaleti
  entry_id:  105277817
  entry_writer: ucap
  entry_fav_count: 25
  entry_content: |
    dogruysa rezillik filan degildir ailenin yaptigi malliktir.<br/><br/>bu devirde taziye ye giden mevlut okutan yada herhangi bir sosyal aktive yapan ve bu aktiviteye katilan herkes maldir.
  entry_channels: sağlık,haber
- entry_name: |
...
- entry_name: |
    savci sayan'ın ağrı dağı'na kafe açma hayali
  entry_id:  105271230
  ...
  entry_channels: siyaset,haber
- entry_name: |
    türkiye'nin tek tarafsız kanalının fox tv olması
  entry_id:  105273895
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    bugun turkiye saati ile aksam 8'de mukemmel bir performans sergileyecek.<br/><br/>kendi youtube kanalindan canli izlenebilir.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/huTUOek4LgU">https://youtu.be/hutuoek4lgu</a>
  entry_channels: sanat,müzik
- entry_name: |
    koronavirüs ölü sayısındaki gariplik
  entry_id:  105276874
  entry_writer: arkadas bi niki de begenin be
  entry_fav_count: 13
  entry_content: |
    yaşlı bir kadın vardı, yüksek yaşına rağmen koronadan taburcu olmuştu. röpotajında nefesi kesile kesile konuşuyordu. hatta konuşamıyordu desem yeri. ben de demiştim ki "yahu bu kadın iyileşmemiş, bizi yiyorlar. başarı hikayesi falan işleri işte..." neyse. o kadın tesadüfen 1 gün sonra öldü. kalp krizi mi, beyin kanaması mı ne dediler. araştırdım, otopsi falan yapılmamış. e üstüne üstlük bir de yalancıyı skmiyorlar.
...
- entry_name: |
    sevgilinin whatsapp'ını karıştırmak
  entry_id:  105262970
  entry_writer: profunhocasi
  entry_fav_count: 8
  entry_content: |
    whatsappını karıştırmıyordur, şüphelerini araştırıyordur.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    murat kekikli - bu akşam ölürüm<br/>o dönem millet kendini camdan atmıştı.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    bir taraf isyandır,anarşidir,entellektüeldir,endistüriyel herşeyin paraya dayalı olduğu düzene direnen son kaledir çarşı.şu an her ne kadar siyasi yıpratılmalar sebebi ile kırıntıları kalmış olsa da taşıdığı felsefe bakidir.abi kardeştir,tanışmış olmak,beraber olmaktır beşiktaş semtinde yaşayan bir semt kültürüdür çarşı.halkın çocuklarıdır halden anlar vicdani dayanışma etkinliklerinin başrolüdür çarşı.<br/>diğer tarafta liderleri cemaat yurtlarında büyüyen dalkavukluk yandaşlık üzerinden hayatını idame eden bi topluluktan bahsediyoruz.(bkz: <a class="b" href="/?q=alparslan+dikmen">alparslan dikmen</a>) tenzih ederim.yönetimden cukkalanan paralardan arta kalan ile karton alıp kareografi yapan,maçlarda megafon ile bağıran,ölü ıslıklayan ve 7 kişi kalmış takıma oley çeken aciz sürüleri ile karşılaştırılması hakaretin en büyüğüdür.hiç bir duruş ve felsefe taşımayan kökeni olmayan uefa kupası sonrası ortaya çıkmış bu gruptur ultraslan.
  entry_channels: spor
- entry_name: |
  ...
  entry_channels: sanat,müzik
- entry_name: |
    hayvanların bilinci var mı sorunsalı
  entry_id:  105278284
  entry_writer: lyrica
  entry_fav_count: 2
  entry_content: |
    benim bir kedim vardı, çoğu insandan daha onurluydu. bir kez seslendim bakmadı diye küfür etmiştim. bir hafta benim servis ettiğim yemeği bile yememişti. şu whiskasın ıslak mamasını bile yemiyordu. önce yemeğe sonra bana bakıyor, burun kıvırıp köşesine çekiliyordu. herhalde bir hafta cezanın yeterli geleceğini düşündüğünden ve de pişman olduğumu fark ettiğinden bir gece ben uyurken gelip yanıma kıvrılmıştı da akabinde güzel günlerimize geri dönmüştük.
  entry_channels: anket,bilim
- entry_name: |
    bir yazarı engelleme kriteri
  entry_id:  105276778
  entry_writer: daemon
  entry_fav_count: 2
  entry_content: |
    kadın düşmanı ve cinsiyetçi entryler girmesi. kadın düşmanlığı yardırılan başlıklarda toplu temizlik yapıyorum genelde.
  entry_channels: ekşi-sözlük
- entry_name: |
...
- entry_name: |
    almanya'nın ölü sayısını gizlemesi
  entry_id:  105275679
  entry_writer: lahmacunmania
  entry_fav_count: 1
  entry_content: |
    tanıdık geldi nedense.
  entry_channels: sağlık
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=12+nisan+2020+s%c3%bcleyman+soylu%27nun+istifa+etmesi">12 nisan 2020 süleyman soylu'nun istifa etmesi</a>)
  entry_channels: siyaset,haber
- entry_name: |
    zeki kız vs skinny kız
  entry_id:  105279460
  entry_writer: pembe zeytin
  entry_fav_count: 0
  entry_content: |
    annelerinden "yakışıklı oğlum" gazını alan erkeklerin kadınları seçebildikleri yanılgısı ile açtıkları bir başlık daha.<br/>zeki/skinny/zeki olmayan/zayıf/şişman/güzel/çirkin...<br/>kadınların umursadığı kadarsınız aslında.
  entry_channels: ilişkiler
- entry_name: |
    türk kızlarının aşırı asabi olması
  entry_id:  105278722
  entry_writer: robert denir ona
  entry_fav_count: 0
  entry_content: |
    “sana ne?” ve “üffff sıkıldım” başı çeken jargonlardır. asabi bir kız, gözlerini saniyede 8 kere belertebilir.
  entry_channels: ilişkiler
- entry_name: |
    mesleğinle vatandaşa haddini bildir
  entry_id:  105276535
  entry_writer: sicario2
  entry_fav_count: 0
  entry_content: |
    buyrun seks terapistiyim
  entry_channels: anket
- entry_name: |
    karantina günlerinde dinlenecek bir müzik bırak
  entry_id:  105279800
  entry_writer: vindovs ikspi
  entry_fav_count: 0
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/vqyLTtfPbFg" title="https://youtu.be/vqyLTtfPbFg">cheaps - moliendo cafe</a>
  entry_channels: anket,müzik,sağlık
- entry_name: |
    12 nisan 2020 kılıçdaroğlu teke tek özel yayini
  entry_id:  105280931
  entry_writer: başlık taşıyan
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=12+nisan+2020+k%c4%b1l%c4%b1%c3%a7daro%c4%9flu+teke+tek+%c3%b6zel+yay%c4%b1n%c4%b1">12 nisan 2020 kılıçdaroğlu teke tek özel yayını</a>)
  entry_channels: siyaset,tv,haber
---
