...
- entry_name: |
    dürüm + ayran + salata + puding + çay 6 tl
  entry_id:  76597334
  entry_writer: mukemmelermis
  entry_fav_count: 741
  entry_content: |
    6 tl yi yerim daha iyi.
...
- entry_name: |
    ateist erkeğe kız verilmemesi
  entry_id:  76592481
  entry_writer: bukkake
  entry_fav_count: 234
  entry_content: |
    sen de yani tam yeri tam zamanında şeetmissin. <br/>ben de bunu anlamıyorum arkadaş. söylemeyiver yani annen baban da bilmeyiversin. <br/>bunun dini söylemlerle dini siyasallaştırmaktan ne farkı var, nasıl ibadet ettiğini anlatan riyakarlardan ne farkı var.<br/>sorulmuş olsa hadi yine neyse. aile ortamı bırak adamlar gördükleri gibi, gelenekleriyle yaşasın. eğer ateizm haklıysa zaten adamların kaybedeceği bir şey yok bunun için de endişelenmene gerek yok. saatlerce süren sancılı din sohbetlerine girip anneni babanı sevdiklerini üzmenin ne manası var.<br/>ben veganım ben veganım diye ortalarda dolananlardan ne farkın var. <br/>cihad ın tersi bir içgüdüyle ateistliği mi yayacaksın. onu söylediğin anda duyan herkes dinini bırakıp sana hak mı verecek.
...
- entry_name: |
  ...
  entry_fav_count: 137
  entry_content: |
    nurgül yeşilçay yataktan ateş bile çıkarıyor olabilir.
...
- entry_name: |
  ...
  entry_fav_count: 123
  entry_content: |
    gonlundeki aday gul, abdul, levo olan yetmez ama evetci libos godoslarin , selocu-seyit rizaci sozde ataturkcu ozde bolucu cumhuriyet dusmanlarinin ve megri megrici aktrollerin hedefi olmus buyuk insan.
  entry_channels: siyaset,eğitim
- entry_name: |
    muharrem ince'nin sigortasız öğretmen çalıştırması
  entry_id:  76611152
  entry_writer: ozgenetikci
  entry_fav_count: 101
  entry_content: |
    ulan tüm milleti milyarlarca dolar soydular, amına bile koydular, bir sefer sesiniz çıkmadı be.<br/><br/>(bkz: <a class="b" href="/?q=bu+milletin+am%c4%b1na+koyaca%c4%9f%c4%b1z">bu milletin amına koyacağız</a>)
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
    sarhoş kavgasına karışan köpek
  entry_id:  76601105
  entry_writer: bna
  entry_fav_count: 45
  entry_content: |
    daha öncesinde "bir daha burada kavga edeni sikerim" diye posta koymuş olabilir.<br/><br/>günümü 40 saniyeliğine güzelleştiren köpektir
...
- entry_name: |
  ...
  entry_fav_count: 39
  entry_content: |
    yalan dolan gösterilerle sahadan kaçan fenerbahçe olduğu için (!)<br/><br/>her fırsatta siyasilerle ve hatta onların yakınlarıyla içli dışlı olan fenerbahçeli yöneticiler olduğu için (!)<br/><br/>sabah namazına gidip bunu habersizce (!) fotoğraflatıp basına servis eden fenerbahçe başkanı olduğu için (!)<br/><br/>ülkenin her stadında, her maç onlarca madde yiyen takım fenerbahçe olmadığı için (!)<br/><br/>otobüsü kurşunlanan, buna rağmen bir şekilde lige devam eden takım fenerbahçe olmadığı için (!)<br/><br/>federasyon ve tüm kurullarındaki çoğunluk fenerbahçeli yöneticilerden oluştuğu için(!)<br/><br/>kuyruk acısından dolayı koskoca camiayı aklınca kendi işine alet eden fenerbahçe'nin hocası ve yedek kalecisi olduğu için (!)<br/><br/>medyada her türlü köşe başı ve ağır yazarlar fenerbahçeliler tarafından kapıldığı için (!)<br/><br/>soran olursa fenerbahçe rezilliği der geçersiniz, kim bilecek amk.
  entry_channels: spor
- entry_name: |
    aykut kocaman
  entry_id:  76602745
...
- entry_name: |
  ...
  entry_fav_count: 23
  entry_content: |
    bir ibrahim tatlıses beyanı. bu kadar kolay mı ya kelle vermek? milyon dolarlar harcadıydın halbuki..<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://onedio.com/haber/ibrahim-tatlises-citayi-yukseltti-ak-parti-icin-kellemi-veririm-820677" title="https://onedio.com/haber/ibrahim-tatlises-citayi-yukseltti-ak-parti-icin-kellemi-veririm-820677">kaynak</a>
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    ssg'nin beyin yakan hatalı entry örneği
  entry_id:  76610455
  entry_writer: return of the kedi
  entry_fav_count: 18
  entry_content: |
    2000 öncesi doğanların anlamakta zorlanmadığı, antik siteden kalma yazıtlardır<br/><br/>tercüme:<br/><br/>ba$lik: elma<br/>1. cok guzel bir meyve (duzgun) -&gt; ("elma" = "çok güzel bir meyve" , bok gibi tanım, ama "tanım", yani legal entry)<br/>2. cok guzel bir meyve (hatali) -&gt; (üstteki entrynin birebir aynısı, hatalı)<br/>3. severim (duzgun) -&gt; ("elma" hakkında anektod, bu da düzgün entry)<br/>4. severim (ba$ka yazar yazdiysa duzgun, ayni yazar yazdiysa hatali -&gt; (hala anlamadıysan allah'a havale ettim muck)
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    şiir okuyan adamın iyi seks yapma ihtimali
  entry_id:  76611406
  entry_writer: her zaman ki
  entry_fav_count: 6
  entry_content: |
    şiir okuduktan sonra, 16 yıl ülkeyi sikeni düşününce, oldukça yüksek olabilir.
  entry_channels: 
- entry_name: |
    ekşi itiraf
  entry_id:  76584029
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    (bkz: <a class="b" href="/?q=zombi+istilas%c4%b1+olabilir+mi+l%c3%bctfen+olsun">zombi istilası olabilir mi lütfen olsun</a>)
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    bu nedir bilen var mı? biraz önce telefonuma krizsms adı altında “bu mesaj kriz smsc platformu tarafından gönderilmiştir” diye bir mesaj geldi. internette pek bir şey bulamadım. yeşil lütfen.
  entry_channels: 
- entry_name: |
    kedi isimleri
  entry_id:  76593934
  ...
  entry_fav_count: 1
  entry_content: |
    bilenler bilir kedi isimlendirmede bir dünya markasıyım. en son kiz nicki, bulduğu kalçası kırık kediyi benim isimlendirmemi istedi. ben de bundan sonra sadece sevdiğim yemeklerin isimlerini koyacağım kedilerime diyerek kendisinin adını iskender koydum. <br/><br/>kedi iskender, bursa'dan sahip buldu. bugün bursa'da yeni evinde. <br/><br/>sırada şalgam var. adanalılar mesaja çöksün.
  entry_channels: anket
---
