...
- entry_name: |
  ...
  entry_fav_count: 311
  entry_content: |
    bir kız bir erkeğin gözüne 1 saniyeden fazla bakarsa ona iş atmış sayılıyor bu memlekette. ben artık sert sert bakan kızlara, selam vermeyen, kimsenin yüzüne bakmayan kızlara birşey demiyorum. eskiden olsa "ne biçim insan lan bu" derdim ama artık hak veriyorum. geçenlerde saat 22:00 civarı kaldırımda yürüyorum önümde de bi kız var. kız o kadar gerildi ki karşı kaldırıma geçip hızlanıp gözden kayboldum rahatsız olmasın diye. insanlar özellikle de kadınlar korkuyor. işin üzücü yanı haklılar. kocasının yanında kadınlara yiyecekmiş gibi bakıyor aşağılık orospu çocukları, tek olduklarında önüne bakmış çok mu.
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 268
  entry_content: |
    asıl amaç, doğanın korunması olsaydı plastik poşet kullanımı tamamen yasaklanırdı, değil mi?<br/><br/>bu haliyle parası olana doğayı kirletme hakkı veren bir saçmalıktan fazlası değil.<br/><br/>ya da birilerinin fena halde gelir elde edeceği bir düzenleme.<br/><br/>aksini düşünmek büyük saflık olur.
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    suriyelilerin ne yapsa yaranamaması
  entry_id:  85008118
  entry_writer: tugsavul
  entry_fav_count: 212
  entry_content: |
    (bkz: <a class="b" href="/?q=suriye%27ye+d%c3%b6nerlerse+yaran%c4%b1rlar">suriye'ye dönerlerse yaranırlar</a>)
...
- entry_name: |
  ...
  entry_channels: moda,magazin
- entry_name: |
    1 ocak 2019 paralı poşet protestosu
  entry_id:  85000793
  entry_writer: penguent
  entry_fav_count: 129
  entry_content: |
    (bkz: <a class="b" href="/?q=sar%c4%b1+po%c5%9fetliler">sarı poşetliler</a>)<br/>(bkz: <a class="b" href="/?q=halk%c4%b1+isyana+te%c5%9fvik">halkı isyana teşvik</a>)
...
- entry_name: |
    haftada 2 kitap bitiren yazarlar listesi
  entry_id:  85003489
  entry_writer: umittaciri
  entry_fav_count: 76
  entry_content: |
    karılarını kocalarını sosyal medyada yarıştıran güruhtan bir farkınız olsun. milletteki bu <a class="b" href="/?q=yar%c4%b1%c5%9ft%c4%b1rma">yarıştırma</a> merakı ne anlamıyorum. çocuklukta yeteri kadar <a class="b" href="/?q=takdir">takdir</a> görmediğinize bağlıyorum.<br/><br/>okuduğunuz kitapların niceliği değil <a class="b" href="/?q=niteli%c4%9fi">niteliği</a> önemlidir. bilgi mahiyetinde içeriğine dair bir şeyleri burada paylaşmak anlamlı olur, sayısını değil.
...
- entry_name: |
  ...
  entry_fav_count: 76
  entry_content: |
    sadece kupa toplamaya yarayan bombok sistem.<br/><br/>öyle sistem mi olur lan? avrupadan bile kupa getiriyor ben böyle rezillik görmedim, derhal gereğini yap!!!
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: ekonomi
- entry_name: |
    1 ocak 2019 viyana filarmoni orkestrası konseri
  entry_id:  85004604
...
- entry_name: |
    1 ocak 2019 sabahı hissedilenler
  entry_id:  84999423
  ...
  entry_channels: anket
- entry_name: |
    an itibarıyla sarhoş olan sözlük yazarları
  entry_id:  84990296
  entry_writer: aegishjalmur
  entry_fav_count: 24
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    (bkz: <a class="b" href="/?q=entry+nick+uyumu">entry nick uyumu</a>)<br/><br/>şahsen bende bu tip söylemler ve başlıklardan nefret ediyorum. sözlük yönetimi bir şekilde buna çözüm bulmalı bence.
  entry_channels: 
- entry_name: |
...
- entry_name: |
    süleyman soylu'nun üs bölgesi ziyaretindeki foto
  entry_id:  85011421
...
- entry_name: |
    hayattaki en büyük pişmanlık
  entry_id:  85008896
  entry_writer: delfina
  entry_fav_count: 7
  entry_content: |
    18 yasında hem okuyor hem çalışıyordum.<br/>en büyük pismanligim, ise giriş yaptirmamis olmak. 1999 şubat bu dediğim.<br/><br/>eğer o zaman ise giriş yaptırmış olsaydım, bu sene itibariyle (38 yasında) eksik primleri ödeyerek emekli olabiliyordum galiba. öderdim de...<br/><br/>hayattaki sanırım tek pismanligim bu
  entry_channels: anket
- entry_name: |
    2019
  entry_id:  84991605
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    çeneni avuçlarının içine alıp,<br/>duvara dalıp<br/>kalma!<br/><a class="b" href="/?q=%c3%a7eneni+avu%c3%a7lar%c4%b1n%c4%b1n+i%c3%a7ine+alma">çeneni avuçlarının içine alma</a>!.<br/>kalk!<br/>pencereye gel!<br/>bak!<br/>dışarda gece bir cenup denizi gibi güzel,<br/>çarpıyor pencerene dalgaları..<br/>gel!<br/>dinle havaları:<br/>havalar seslerin yoludur,<br/>havalar seslerle doludur:<br/>toprağın, suyun, yıldızların<br/>ve bizim seslerimizle...<br/>pencereye gel!<br/>havaları dinle bir:<br/>sesimiz yanındadır,<br/><a class="b" href="/?q=sesimiz+seninledir">sesimiz seninledir</a>...<br/><br/>nazım hikmet <br/><br/>umut seviyemi bir doz arttırıyor bu şiir.
  entry_channels: edebiyat
- entry_name: |
    1 ocak 2019 ekrem imamoğlu'nun metrobüse binmesi
  entry_id:  85011771
  entry_writer: alonehidden
  entry_fav_count: 2
  entry_content: |
    güzel bir davranış olmuş. eleştirmek yerine tüm adayların, seçilmişlerin, siyasetcilerin, bürokratların da aynı şekilde davranmasını istiyoruz.
