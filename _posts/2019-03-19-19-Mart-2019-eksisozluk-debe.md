...
- entry_name: |
  ...
  entry_fav_count: 42
  entry_content: |
    yahu ne kadar iğrenç, testosteronlu, daşşaklı başlıklar bunlar. midemi hatta miydemi bulandırıyor. iğrençsiniz amk. scarlett johansson, olivia wilde varken kimlere bakıyorsunuz. yazıklar olsun, hiç yakıştıramadım beyler.
...
- entry_name: |
    1 yaşındaki bebeğin penisinin sertleşmesi
  entry_id:  87887175
  entry_writer: yavrucum
  entry_fav_count: 31
  entry_content: |
    ya bu ne bilimsizliktir, şaka olsun diye mi açtın bu başlıgı arkadaş.<br/>penis sadece ciftleşme için ereksiyon haline geçmez kaldı ki o bebenin de hormonları var. <br/>sinir uçlarıyla donatılmış bir organın uyarılmasına şaşırıyor.
...
- entry_name: |
  ...
  entry_fav_count: 26
  entry_content: |
    ebesinin nikahı gibi dolu olan metrobüse binmeye çalışan hayvanlar vardır bildin mi?<br/><br/>bazen denk geliyorum, öyle olmaz amına koyduğum bekle ben ineyim sen bin diyesim geliyor.<br/><br/>(bkz: <a class="b" href="/?q=lanet+girsin+istanbula">lanet girsin istanbula</a>)
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    sagda solda mahalle mahalle gezip muhalefet partilerinin teroristlerle sozlesme imzaladığını vs anlatıyor. arkadas bir allahin kulu da demez mi madem boyle birşey var. bunu biliyorsun e yargilayin o zaman cikarin belgeleri? yok insanlar duyduklarina inanırlar çünkü. <br/><br/>tüm muhalifleri terorist olmakla suçluyor. korku siyaseti parçalarından akıyor. yanlisini yuzune vuran bir saadet partiliye bagira bagira sen kim oluyorsun tarzinda kahvehane mudavimi agziyla cevap verdi. ustelik polise verdigi talimatla adami gozaltina aldirdi.<br/><br/>boyle siyasiler oldugu sürece bu ülkeden cacık olmaz.. kaçın kurtarin kendinizi.
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    (bkz: <a class="b" href="/?q=ablan%c4%b1n+bilinen+bir+evlili%c4%9fi+yoksa+c%c3%bcmb%c3%bc%c5%9f+yarat%c4%b1r">ablanın bilinen bir evliliği yoksa cümbüş yaratır</a>)
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    ab ile vize / calisma izni zorunlulugu olmasa, yas ortalamasi 28-29, genc issizligin %25'lerde dolandigi bir ülkeden 4-5 milyon kisi yurtdisina göc eder. <br/><br/>bu güruha "siktir git" diyen denyoyu oldugu yerde birakin. keza zaten hak ettigi ülkede yasiyor.
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    pimapen yaptırırım, yoksa ısınmaz
  entry_channels: anket,spoiler
- entry_name: |
    sevişemeyecek kadar çok sevmek
  entry_id:  87863186
  entry_writer: arnawutgs
  entry_fav_count: 6
  entry_content: |
    14 yaş sendromu.
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_id:  87880289
  entry_writer: netiyifikir
  entry_fav_count: 6
  entry_content: |
    yıldızları seyretmek, aynı gökyüzüne bakmak.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
    akp gidince isviçre olunacak sanmak
  entry_id:  87888184
  entry_writer: illuminatron
  entry_fav_count: 4
  entry_content: |
    bunu sanan muhalifler olduğunu sanan akplilerin varlığı kadar kesin olmayan yanılsama.
  entry_channels: siyaset
- entry_name: |
    hatunların en güzel oldukları yaş
  entry_id:  87881422
  entry_writer: antirikot
  entry_fav_count: 3
  entry_content: |
    tartışmaya açıktır tabiki ama kişisel görüşüm 30-35 yaş aralığı.
  entry_channels: anket,ilişkiler
- entry_name: |
    gram altının 500 lira olması
  entry_id:  87887221
  entry_writer: bakken
  entry_fav_count: 3
  entry_content: |
    (bkz: <a class="b" href="/?q=olmam%c4%b1%c5%9f+olaylar%c4%b1n+olmu%c5%9f+gibi+ba%c5%9fl%c4%b1%c4%9f%c4%b1n%c4%b1+a%c3%a7mak">olmamış olayların olmuş gibi başlığını açmak</a>)
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    3-5 tel beyaz saçım vardı ya da yoktu.<br/>son bir yıl içerisinde belki 50 60 tel daha dahil oldu var olanlara.<br/>üzdü.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    'o arkadaşı oslo'ya ben gönderdim.'<br/><br/>'sayın öcalan aldığı kellelerin hesabını veriyor' <br/><br/>(haburdan ypglilerin geçişinden sonra) 'bu bir demokrasi şenliğidir.' <br/><br/>gibi cümleleri ve öcalan'ın mektubunun okunduğu nevruz kutlamalarını unutan yazar beyanı.
  entry_channels: siyaset
- entry_name: |
    a101 önündeki psikopat kedi
  entry_id:  87888166
  entry_writer: sabaherkenci
  entry_fav_count: 1
  entry_content: |
    kedi videosu başlığına girip, muhtemelen videoyu izleyip yorumları okuduktan sonra izleyenleri eleştiren sığırları görmemizi sağlamış video. evet sığırsın cüce!
  entry_channels: haber
---
