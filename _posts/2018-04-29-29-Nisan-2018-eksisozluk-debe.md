...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    hoşlanılan kızın bir oturuşta 4 teneke sıçması
  entry_id:  76449453
  entry_writer: isiklarinedenkapattiniz
  entry_fav_count: 3
  entry_content: |
    teneke hesabı nedir arkadaş, mandırada mı sıçıyor bu kız?<br/><br/>edit:imla
  entry_channels: anket,ilişkiler
- entry_name: |
    digiturkplay
  entry_id:  76444837
  ...
  entry_fav_count: 2
  entry_content: |
    seneye kesinlikle yenilemeyi düşünmüyorum. oysaki 4 yıldır kullanıyordum. şerefsiz kardeşlerimizin yapmış olduğu illegal yayınları izleyeceğim, daha da arap zengin etmem.<br/>not: maçaçıkmayanspor
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    pek inandırıcı gelmeyen dikiş. dikiş uzmanlarını göreve çağırıyorum.
  entry_channels: spor
- entry_name: |
