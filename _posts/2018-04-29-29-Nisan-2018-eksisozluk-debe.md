...
- entry_name: |
  ...
  entry_fav_count: 93
  entry_content: |
    beyin göçünü engelleyeceğiz<br/><br/>anadolu ve fen liselerine eski itibarını geri kazandıracağız<br/><br/>trt'yi bağımsız yapacağız<br/><br/>eurovision'a tekrar katılacağız<br/><br/>formula 1 için tekrar aday olacağız ve bu sefer kalıcı olacağız<br/><br/>olimpiyatlarda daha başarılı olacağız<br/><br/>futbola (en azından milli takıma) siyaset karışmayacak, daha başarılı olacağız<br/><br/>yatay mimariye geçeceğiz<br/><br/>gereksiz köprüleri yıkacağız<br/><br/>vergileri kısacağız<br/><br/>akademiyi düzelteceğiz<br/><br/>bilim insanları çıkaracağız<br/><br/>benzin ve mazottan alınan vergiler düşecek<br/><br/>ötv'ye indirim yapılacak<br/><br/>komşularımızla iyi geçineceğiz<br/><br/>doğu sınırlarımıza duvar öreceğiz<br/><br/>yabancı ülkelerle sabah dost akşam düşman olmayacağız<br/><br/>siyaset programlarına kısıtlama getireceğiz<br/><br/>yurtdışı temsilciliklerimizi güçlendireceğiz<br/><br/>vatandaşımızı bütün dünya birleşti türkiye'ye karşı oldu diye kandırmayacağız<br/><br/>toki'yi lağvedeceğiz<br/><br/>akit ve türevleri kapanacak<br/><br/>halkı kin ve düşmanlığa tahrik edenler anında cezasını bulacak<br/><br/>bebeği olanlar, loğusa anneler hapishanelere girmeyecek<br/><br/>bunlar bir çırpıda aklıma gelenler, daha bir sürü vardır eminim. daha da yazarım.
...
- entry_name: |
    meral akşener'in a.gül projesini bozması
  entry_id:  76435861
  entry_writer: baytarafli
  entry_fav_count: 78
  entry_content: |
    iyi parti ve meral akşener'in parti kurulduktan sonra elde ettikleri en büyük başarı.<br/><br/>günlerdir bir takım liberaller ve batıcıların saadet partisi üzerinden muhalefete dayattığı abdullah gül projesi akşener'in tavrından dolayı yalan oldu.<br/><br/>abdullah gül'ün tüm muhalefetten istediği desteğe chp ve sp onay verirken iyi parti ve akşener karşı çıktı. tüm muhalefetin desteğini alamayan abdullah gül de aday olma cesaretini gösteremedi.<br/><br/>akşener olmasa ciddi ciddi abdullah gül gibi iktidara bir kez bile sesini çıkaramamış bir ismi çatı aday diye bizlere oylatacaklardı resmen.<br/><br/>ekleme: chp ve sp'nin artniyetli olduğunu söylemiyorum ama artniyetlilerin oyununa geldiklerini söylüyorum.
  entry_channels: siyaset,anket
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    meral'in parti kurmayacağım söylemi
  entry_id:  76441084
  entry_writer: olgunisik
  entry_fav_count: 41
  entry_content: |
    aktrollerin nasıl bir kuyruk acısı var ki merale nerden pislik atacaklarını şaşırdılar. tabi alıştınız reis de reis diyen milliyetçilere hooop dur bakalım diyen biri olunca dengesiz kayıyor. partisi olan, umudu olan biri ile partisinden çıkarılmış birini kıyaslamak için baya baya midesiz olmak lazım.
  entry_channels: siyaset
- entry_name: |
    demba ba
  entry_id:  76423132
  ...
  entry_fav_count: 36
  entry_content: |
    demba ba’ya değil de şuna takıldım. bir göztepe taraftarı yazmış. “ holdinglerden değil mahalle aralarından tribünden gelen başkan görmek isterseniz izmir’e bekleriz!”<br/><br/>mehmet sepil türkiye’nin en varlıklı işadamlarından biri. her sene düzenli olarak en zengin 100 kişi listesine girer. dev şirketleri var. garibim daha başkanını tanımıyor.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    tam bir proje adamı. içi boş bir figür. kurtuluş savaşında yaşasaydı kesinlikle 'ingiliz muhipleri cemiyeti' üyesi olurdu. iddaa kuponu yapsaydı en banko maça bile çifte şans oynardı.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    şuan iki farklı ortamdan iki farklı arkadaşım japonya’ya doğru yola çıktı. ben de metrobüse bindim avcılara gidiyorum. <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    kadın ve erkeğe ayrı yaş sınırları koydukları için cinsiyetçi kuralları olan gruptur. pis cinsiyetçi adi yazarlar sizi. yeter artık. yether. bütün cinsiyetçi yazarlar ölsün.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    çaya batırılan bisküvi düşmeden yiyebilmek ;)
