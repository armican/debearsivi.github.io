...
- entry_name: |
  ...
  entry_fav_count: 344
  entry_content: |
    - sayın milletvekili süreniz doldu lütfen yerinize.<br/><br/>+ uff snne be slak .s .s .s
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
    28 nisan 2018 fenerbahçe'nin attığı gol
  entry_id:  76445738
  entry_writer: mofha
  entry_fav_count: 20
  entry_content: |
    böyle goller olmaz. kasımpaşa derhal soyunma odasına dönmeli ve federasyon da maçı beşiktaş lehine 3-0 vermelidir.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    erkeğe 25, kadına 22 yaş sınırı konulmasının sebebini bir türlü anlayamadığım grup.<br/>izdivaç grubu gibi bir şey ise, söyleyin bilelim, bilgilenelim.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    sessiz sedasız,kimseye çaktırmadan gerçekleşen yürüyüş.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    gecen temmuzda 399 liraya aldiğim sezonluk paketi bu sene 540 liraya veriyor.<br/><br/>ben anlamadim böyle işi, ligin marka değeri falan mi artti ne sikime 150 lira zam geldi buna?
...
- entry_name: |
    tuvalet sırasındayken gelip dolu mu diye soran tip
  entry_id:  76445208
  entry_writer: bayanhayalperest
  entry_fav_count: 2
  entry_content: |
    ve bazen tuvaletlerden biri gerçekten boş çıkıyor üzgünüm ama.
  entry_channels: anket
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    chp'nin başkan adayını gizleme sebebi
  entry_id:  76445502
  entry_writer: veniceviolins
  entry_fav_count: 2
  entry_content: |
    televizyon izlemeyen insanların merak ettiği sebeplerdir.<br/><br/>adamlar 36 kanal 7/24 ağızlarıyla nefret sıçıyorlar. hatta geçen gün açıp baktım n'apıyorlar diye; baktılar chp'nin adayı ortada yok, olası adayların tamamına bir liste halinde karalama haberleri düzenlemişler. <br/><br/>ağızlarından salyalar akarak hazır olda bekliyorlar, aday açıklansın da içimizdeki tüm lağımı üzerine kusalım diye...
  entry_channels: siyaset,anket
- entry_name: |
    şu anda çalan şarkı
  entry_id:  76427438
  ...
  entry_fav_count: 0
  entry_content: |
    sorum yok soranım yok<br/>(bkz: <a class="b" href="/?q=bir+harman%c4%b1m+bu+ak%c5%9fam">bir harmanım bu akşam</a>)
