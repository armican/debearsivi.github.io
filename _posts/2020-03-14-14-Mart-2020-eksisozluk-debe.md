...
- entry_name: |
  ...
  entry_fav_count: 82
  entry_content: |
    bari şu salgın bitene dek ayrıştırıcı şeyler yazmayın be; yok deve sidiği yok olmayan bilim. git isviçre'yi eleştir gece gündüz övdüğün ülke vak'a açıklamama kararı aldı. git italya'yı eleştir bize bir şey olmaz dediler şimdi drone ile hastalık kontrolü yapıyorlar.
...
- entry_name: |
    kayınvalidenin eski sevgiliyi daha çok sevmesi
  entry_id:  103462215
  entry_writer: muzu bicakla soyan adam
  entry_fav_count: 0
  entry_content: |
    çok seviyorsa kendi koynuna alsın, saygılar.
  entry_channels: ilişkiler
- entry_name: |
