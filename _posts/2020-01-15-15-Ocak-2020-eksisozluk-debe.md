...
- entry_name: |
    13 ocak 2020 gıdada taklit ve tağşiş listesi
  entry_id:  100505723
  entry_writer: cozulemeyen adam
  entry_fav_count: 299
  entry_content: |
    hepsine tek tek baktım. zannedersem en masumu, "tam yağlı keçi peynirine, inek sütü karıştıran" firmadır.
...
- entry_name: |
  ...
  entry_fav_count: 70
  entry_content: |
    - türkiye’de kaç ilçe var? 957 tane ilçe var. 957 tane bina demek. <br/>- her ilçeye kendi büyüklüğü ile orantılı, içinde banyosu, dolabı, yatağı olan tek kişilik, 4x3=12 metrekare oda yapacaksın. <br/>- orta ölçekli bir ilçede, o binada 50 tane oda olsa, 50 evsize derman olur. <br/>- binanın büyük bir yemekhanesi olsa, orada sıcak çorbasını içsin, yemeğini yesin, çıksın odasında yatsın. <br/>- ben şuna inanıyorum, devlete 1 kuruş masraf çıkmaz, kendi ilçesindeki bu yerlere insanlar para akıtır. kendi tok ve sıcak yatarken kimseyi aç ve soğukta yatırmaz. bu millet 8 milyon suriyeliye bakıyor kendi insanına mı bakamayacak. <br/>- benim ilçemde böyle bir yer olsa her ay düzenli para yatırır, kılık kıyafet götürür, yardım yaparım. <br/>- devletin yapacağı bina yapmak ve güvenliği sağlamak, gerisini bu millet yapar. <br/>- bazı evsizler gece yarısı önünüze geçip para isteyebiliyor, bazen de gasp gibi olaylar yapabiliyor, çünkü adam aç ve çaresiz. böyle bir yer yapılırsa sokaklarda güvenli olur. <br/>- polis dışarıda kalan insanları toplasın, gelen kişilerin kimliğini çıkarsın, devlet evsiz yurtsuz olanı, akıl sağlığı yerinde olmayanı, parası pulu olmayan kişiyi, 1 tuşla çıkartır. devlet bunu yaparsa, gerçekten ihtiyaç sahibi insanlar, dışarıda karton üstünde betonda yatmaz.
  entry_channels: haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 31
  entry_content: |
    son on yılda kendimi çokça geliştirdiğim yeteneğim. bir kalemde silmek deyimi hayat mottom haline geldi. kimseyi kazanmaya filan çalışmıyorum. baktım ki bana zararı var, negatif enerjisi var kaç yıllık arkadaşımmış diye bakmadan hemen hayatımdan çıkarıyorum.
...
- entry_name: |
    hekimoğlu (dizi)
  entry_id:  100536499
  entry_writer: kitapsiz adam
  entry_fav_count: 3
  entry_content: |
    hekimoğlunun evinin kapı numarasıyla gülümsetmiştir.<br/><br/>(bkz: <a class="b" href="/?q=221b">221b</a>)<br/>(bkz: <a class="b" href="/?q=221b+baker+street">221b baker street</a>)
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    bu aralar nerelere saldıracaklarını şaşırdı bu troller. bu ülkenin kurucusuna şimdilik laf ediyorsunuz ama elbet bu devran da dönecek. allah ıslah etsin sizler gibileri.
  entry_channels: siyaset
- entry_name: |
    şu anda çalan şarkı
  entry_id:  100501710
...
- entry_name: |
    testosteron yükselten şeyler
  entry_id:  100535910
  entry_writer: neomargarin
  entry_fav_count: 1
  entry_content: |
    fazla yükselmesin sonra benim gibi testesteron fazlalığından saçlarınız dökülür. herşeyin fazlası zarar.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    başkalarına rahatsızlık verenler, dolayısıyla medeniyetsizler.
  entry_channels: anket,ekşi-sözlük
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ülke resesyonda demektir, ayrıca ölmüşüz ağlayanımız yok demektir, ya da bizi saksıya fesleğen gibi oturtmuşlar anlamı da çıkar.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    <a class="b" href="/?q=kefenimizi+giydik+de+geldik">kefenimizi giydik de geldik</a>
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    öz tek ve sabittir. farklılıklar arızidir.
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    eğlenceli bir hafta ortası muhabbeti arayan kişileri beklerim. yazarlar veya çaylaklar yeşillendirebilir.
...
- entry_name: |
  ...
  entry_channels: anket,ekonomi
- entry_name: |
    14 ocak 2020 iran'ın abd üssünü vurması
  entry_id:  100539379
  entry_writer: başlık taşıyan
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=14+ocak+2020+%c4%b1rak%27ta+abd+%c3%bcss%c3%bcne+roket+sald%c4%b1r%c4%b1s%c4%b1">14 ocak 2020 ırak'ta abd üssüne roket saldırısı</a>)
