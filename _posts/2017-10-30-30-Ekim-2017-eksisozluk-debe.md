...
- entry_name: |
  ...
  entry_fav_count: 38
  entry_content: |
    küfre 6 maç ceza veriliyorsa, yumruğa 10 maç ceza verilmesi lazım. ama yumruğu atan takımın forma renkleri siyah-beyaz olmadığı için <a class="b" href="/?q=pfdk">pfdk</a>'ya sevk edileceğini bile düşünmüyorum.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    türk halkı duygusal, çabuk gaza gelebilen bir millet. din ve milliyetçilik ise tam bunu vurabilecek yöntemler. şu an memnuniyetsiz bir şekilde chp'ye, alternatifsizlikten de akp'ye oy veren çok büyük bir kitle var hepiniz biliyorsunuz. mhp'yi zaten ezip geçecektir iyi parti, malum mhp resmen çöp bir hal almış durumda. kürtlerden pek oy alacağını sanmam ama bizzat kendi çevremden biliyorum ki tek derdi vatanın bütünlüğü ve din olan kürt sayısı hiç de azımsanacak bir seviyede değil ülkemizde. her kürt, pkk sevici hdp seçmeni gerilla güzellemesi yapan biri değil. koyu chp'li kürt arkadaşım var amk. <br/><br/>alternatifsizliğe, aynı boş adamların sesini duyup durmaya, icraatsizliğe iyi gelecek bu parti. birkaç gündür yapılan işlerden görüyoruz ki siyaset arenasına iyi giriş yaptılar. hem akp, hem chp, hem mhp'den geçerli bir oy alacak belli ki. hatta mhp'nin neredeyse tamamını alabilir. mhp'nin şu haline kör kütük bağlı olacak pek insan olduğunu sanmıyorum. bbp, sp, dp gibi çok düşük yüzdelerle oy toplayan partilerin seçmenleri, "ulan çok farklı değil zaten bu sefer şuna oy verelim de oyumuz geçerli olur" diyerek iyi partiyi destekleyebilir. <br/><br/>sosyal demokrat, liberal düşünceye yatkın bir seçmen olarak türk siyasetine iyi bir hareket katacağını düşünüyorum. çoğu insana saçma gelsede logo ve isim olarak iyi düşünülmüş pr olarak. saçma sapan kısaltmalardansa ak parti gibi bilinç altına oynayan bir çalışma gerçekleştirilmiş. liderin kadın olması, endüstri 4.0'dan bahsetmesi, atatürk'ü ve türklüğü daima ön plana çıkarması, ülkenin kanayan yaralarından söz etmesi ülke genelinde şimdiden ilgi çekmiş durumda. muhafazakarlık olarak şahsımla pek uyuşmasa bile özellikle iç anadolu insanının sıradaki seçimlere heyecan katacağını düşünüyorum. öncelikli olarak ekonomi, genç nüfus, işsizlik, göçmenler üzerinden muhalefet yapması çok iyi bir oy sağlayacaktır.
- entry_name: |
    trabzonspor
  entry_id:  71740645
...
- entry_name: |
    her hafta galatasaray'a kırmızı kart kampanyası
  entry_id:  71740618
  entry_writer: tavuksuyu
  entry_fav_count: 8
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.transfermarkt.com.tr/super-lig/fairnesstabelle/wettbewerb/TR1/saison_id/2017" title="https://www.transfermarkt.com.tr/super-lig/fairnesstabelle/wettbewerb/TR1/saison_id/2017">şuradaki</a> tabloya göre 4 büyükler arasında en az sarı + kırmızı kart cezası alan takım galatasaray olduğu için yanlış iddia.
- entry_name: |
    ayla
  entry_id:  71722455
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    namağlup is coming:)<br/><br/>fikstür kolay dedik inanmadınız.<br/><br/>hahahahahah
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    8 tane atsın 8 maç kazandırsın. yeter
- entry_name: |
    stranger things
  entry_id:  71721770
...
- entry_name: |
    jason denayer
  entry_id:  71740778
  entry_writer: tuzsuzdelibekirinemmisi
  entry_fav_count: 4
  entry_content: |
    denayer ama olmuyor
- entry_name: |
...
- entry_name: |
    cb erdoğan'ın ilber ortaylı'ya verdiği ödül
  entry_id:  71742639
  entry_writer: cathars
  entry_fav_count: 2
  entry_content: |
    boş yorumlar yapılıyor. bu ödül ilber ortaylı'nın kariyerinde "cumhurbaşkanlığı kültür sanat ödülü" olarak geçecek. "rte özel ödülü" falan değil. 30 sene sonra kimse rte'yi hatırlamaz. isimler geçici makamlar kalıcıdır. gururla gidip alması lazım.
- entry_name: |
    börü
  entry_id:  71740799
  entry_writer: sdfghj
  entry_fav_count: 2
  entry_content: |
    biz yatağımızda rahat uyuyalım diye canını hiçe sayan vatan evlatlarını konu alan dizidir. daha evde karısının elinden kumandayı almaya izni olmayan, alsa bile milletin birbirini <a class="b" href="/?q=k%c3%bcsk%c3%bc">küskü</a>lediği dizilerden başka bir şey izleyemeyen <a class="b" href="/?q=d%c3%bcrz%c3%bc">dürzü</a>lere dert olmuştur.<br/><br/>dizi sezonu bittikten sonra sinema filmi çekilecektir.<br/><br/>ek bilgi : fragmanda logo gözükürken 1 kareliğine araya giren yazıda "ya atarına ya batarına" yazıyor.
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    yaş ilerledikçe gelen hantallıktan ötürü ortaya çıkan durum. <br/><br/>adam linç yememek için başlığı "biraz" kötü olarak açmış lütfen üstüne gitmeyiniz.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    boku çıkarılan veritabanıdır.<br/>cep telefonu paylaşılmış lan. iyice kontrolü kaybettiler a.k.
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    regülatör.<br/>şehir elektriği tv'yi çalıştırmaya yetmeyebiliyordu ve evet bir tv'miz vardı.
- entry_name: |
    bein sports
  entry_id:  71732558
  entry_writer: ageyik
  entry_fav_count: 1
  entry_content: |
    77 ve 78. kanallarında an itibariyle oynanan iki maçta da genelde sol üst köşede verilen dakika, anlık skor durumu gibi bilgileri vermeyen yayıncı. <br/><br/>hangi maçı izliyoruz, durum kaç-kaç, kaçıncı dakika oynanıyor nereden bileceğiz? 19:30'da da trabzonspor-galatasaray maçı var, o da böyle olursa maç zevki diye bir şey kalmaz.<br/><br/>edit: bursaspor-antalyaspor maçında da yok. sorun varmış, çalışmalar devam ediyormuş. en kısa zamanda düzelecekmiş.<br/><br/>edit 2: sorun düzeldi.
- entry_name: |
    papa alioune ndiaye
  entry_id:  71740255
  ...
  entry_fav_count: 0
  entry_content: |
    bugün muhteşem oynadı ve güzel oyununu son anlarda da olsa kartla süsledi. <br/>maç boyu çok uğraştı, çabaladı, kartı görmese emeğine yazık olacaktı.
- entry_name: |
    o ses türkiye
  entry_id:  71742521
  entry_writer: yehhu
