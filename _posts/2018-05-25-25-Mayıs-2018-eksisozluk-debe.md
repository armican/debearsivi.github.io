...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    (bkz: <a class="b" href="/?q=another+anket+in+the+wall">another anket in the wall</a>)
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    hep erkeklerin entry girdiği başlık. bırakın da kadın yazarlar yazsın. ne gizli gaysiniz arkadaş.
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    24.05.2018 cnnturk'e belediyelerin ilan vermesi
  entry_id:  77315837
  entry_writer: severek izliyoruz
  entry_fav_count: 6
  entry_content: |
    işin aslı...yandaş markaların turkcell, telekom, ülker, torku, demirdokum, doguscay ve bilumum markanın g.t korkusundan reklam vermemesinden dolayı oboş kalan ve ucuza düşen alanları belediyelerin uygun fiyata kapatmasıdır.<br/><br/>yandaş markalara reklam vermeyin ulen demiş birileri
  entry_channels: 
- entry_name: |
    vatanım sensin
  entry_id:  77317250
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    arada baktığımda mustafa denen bir yalaka itici uyuz yapmacık tipi gördüğüm yarışma. lan çok uyuza benziyorsun varya ıslatıp ıslatıp dövesim var seni.
...
- entry_name: |
    geleneksel ekşi sözlük satranç turnuvaları
  entry_id:  77290628
  entry_writer: tavuksuyu
  entry_fav_count: 2
  entry_content: |
    fikir olarak güzel başlık. yine de başlığın kalıcı olması adına yakın zamanda bir turnuva olayına girişilmeli burası üzerinden. ancak pazar akşamının genel için uygun olmayacağını düşünüyorum, zira genelde tam o saatler ütü, duş ve yatış saati çalışanlar için. cumartesi geceleri evde oturan ezik insanlar derneğinin başkanı olarak en uygun zamanın yine bu günün gecesi olduğunu düşünüyorum. ayrıca turnuvalar hep belli format üzerinden yürümemeli, bir hafta 1+0, bir hafta 3+0, bir hafta 5+2 vs. oynanmalı.
