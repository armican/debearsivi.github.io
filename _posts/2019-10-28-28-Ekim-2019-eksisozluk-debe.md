...
- entry_name: |
  ...
  entry_channels: haber
- entry_name: |
    yarınlar yokmuşcasına öpüşen türbanlı kadın
  entry_id:  97070935
  entry_writer: quarrygirl
  entry_fav_count: 35
  entry_content: |
    eminim ki bu video ortamlara düşsün de ifşalardan ifşa beğenilsin diye çekilmedi. herkesin yaptığı bir eylemi yapmış ama mahrem kalması gerekirken ortalığa düşmüş kadındır. böyle şeylerin paylaşılmaması gerekir bana göre.
  entry_channels: ilişkiler
- entry_name: |
    direksiyon sınavı
  entry_id:  97052383
...
- entry_name: |
    anneni yabancı bir erkekle yakalasan ne yaprsın
  entry_id:  97069469
  entry_writer: fakir ama sempatik
  entry_fav_count: 34
  entry_content: |
    (bkz: <a class="b" href="/?q=ba%c5%9fl%c4%b1k+a%c3%a7ard%c4%b1m">başlık açardım</a>)
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    ordadogunun 2 les takımını izleyeceğime mis gibi premier lig derbisi izlerim.<br/><br/>not:bjk
  entry_channels: spor
- entry_name: |
    younes belhanda
  entry_id:  97041004
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    o zaman biraz büyük konuşayım dedirtten fırsat.<br/>dünyanın en güzel kadını peşimde koşsa bile bakmam.<br/>100 milyon dolar koysalar önüme tenezzül etmem.
  entry_channels: ilişkiler
- entry_name: |
    pedro rebocho
  entry_id:  97069999
  ...
  entry_fav_count: 5
  entry_content: |
    geldiğinden beri çok güveniyordum da ritim bulamamıştı. derbi 2. yarısında sahanın kesinlikle en iyisi.
  entry_channels: spor
- entry_name: |
    ekşi itiraf
  entry_id:  97051247
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    son dakkalarda girdi, iki dakkada sari kart gordu ustune kendi kalesine ucarak kafa golu atmasini karius engelledi. ve tum bu 10 dakka icin mac basi para alcak. tesekkurler besiktas.
  entry_channels: spor
- entry_name: |
    garanti bankası
  entry_id:  97061410
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    galatasarayın gol atamamasının pozisyon üretememesinin orta açamamasının şut çekememesinin tek sebebi kendisidir. belhanda feghouli mariona nagatomo formsuzmuş geçiniz bunları. sezon başından beri tüm ataklar sol kanata babele gidip çürüyor. geçen senin şampiyonluğunun mimarı olan sağ kanattan bırakın hücum etmeyi geçmiyoruz bile. 10 maçın birinde sağına çekip 25-30 metreden gol atacak diye bu adamı izlememeliyiz. evet diğer elemanlar formsuz ama ana sorun babelin takıma katılışı
  entry_channels: spor
- entry_name: |
    florin andone
  entry_id:  97067087
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    "herif iki sene üst üste cimboma beleşten şampiyonluk hediye etmiş loser oğlu loser bu akşam yense ne yazar ki?" diyecegim ama muhtemelen bu akşamda yenilecek zaten.<br/>ve sonrasinda "adamsan istifa edersin"feryatları.sanki bilmiyordunuz huyunu suyunu,uzaydan yeni gelmişti herif.<br/>avucunuzu yalarsiniz,yok öyle istifa falan.son kuruşuna kadar tazminati,maaşı vs ödenecek herif öyle gidecek.
  entry_channels: spor
- entry_name: |
    mete kalkavan
  entry_id:  97066732
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    stabil hayatından şaşmasan mı diyorum. gerekli olmayan yollara giriyosun, 2 gün veriyorum rutine dön :/
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bakalım hangi hangi marka fail edecek. erişilebilir hiç bir şey olmadığına göre firewall’dan başlar bu iş ama ben yine de oyumu omurga anahtardan yana kullanıyorum.
  entry_channels: ekonomi
- entry_name: |
    galatasaray
  entry_id:  97069240
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ancak sarışın ve mavi gözlü bir kadın ile dertleşesim var!!
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    bir kadının hazırlanıp evden çıkma süresi
  entry_id:  97068961
  entry_writer: the bends
  entry_fav_count: 0
  entry_content: |
    gideceği yere ve görüşeceği kişiye bağlıdır. sabah 10’daki buluşma için 6’da uyandığımı bilirim.
  entry_channels: anket,ilişkiler
---
