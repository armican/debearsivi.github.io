...
- entry_name: |
    ölen sahibini telefonda gören kedinin tepkisi
  entry_id:  74481765
  entry_writer: rigorvita
  entry_fav_count: 184
  entry_content: |
    gece gece üzen kedi<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="http://youtu.be/oca6XX8tgJM" title="http://youtu.be/oca6XX8tgJM">sözkonusu video</a>
- entry_name: |
...
- entry_name: |
    salih muslim'in prag'da yakalanması
  entry_id:  74488713
  entry_writer: tucoramires
  entry_fav_count: 154
  entry_content: |
    kendisi prag'larda gezerken, militanları dağda eşşek kertiyor, ulan ne geri zekalı salaklar var dünyada.
- entry_name: |
...
- entry_name: |
    her kadınla yatıp bakire kız arayan erkek
  entry_id:  74477908
  entry_writer: thinking green
  entry_fav_count: 12
  entry_content: |
    ikiyuzlu asagilik pisligin tekidir. çağdisi zihniyetli bir ahlaksizdir.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    yok fuckbody arayan yazarlar, yok dertleşecek yazarlar, yok dışarı çıkmalık arayanlar, yok evde çakmalık arayanlar.. arkadaşlar çıtayı öyle bir alçalttınız ki 40 yıllık limbocuyum diyen geçemez. dedirten başlık. olm ananıza babanıza söyleyin bi kız bulsunlar evlendirsinler. bu nasıl bir acizlik bu nasıl bir yokluk? <br/>eğer amacınız sözlük aracılığıyla çiftleşmekse vallahi çok yanlış gelmişsiniz. hee sözlükten hatun bulan yok mu? var. ama o adam zaten başka taraflardan da bulabiliyor. hayatının ilk ciddi ilişkisini buradan yaşamak isteyen arkadaşlar, üzgünüm öyle bir dünya yok.
- entry_name: |
    aykut kocaman
  entry_id:  74503918
  ...
  entry_fav_count: 10
  entry_content: |
    bu saatten sonra seni alkışlayan herkesin amına koyayım.
- entry_name: |
