...
- entry_name: |
  ...
  entry_fav_count: 382
  entry_content: |
    doğru bir tespit. gelişi 1 lira olan maskeye 10 lira fiyat çekmek isteyen eczacılar çok zor durumda kalırlar.<br/><br/>edit: bir takım eklemeler.
...
- entry_name: |
    12 ada'nın yunanlara bırakılması
  entry_id:  106672217
  entry_writer: handemir
  entry_fav_count: 137
  entry_content: |
    12 adalar 1912 yılında sultan reşat tarafından italyanlara bırakıldığında ismet inönü düşük rütbeli bir osmanlı subayı idi.<br/>lozan'da 12 adaların statüsü değişmedi.<br/>2. dünya savaşından sonra ismet inönü bastırıp geri alamadı diye ona hakaret etmek, sultan reşat'a bir şey diyememek.<br/>cahil cahil konuşmak size çok yakışıyor.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 79
  entry_content: |
    "canın sağolsun", "ne demek", "tabii ki", "olabilir", "bakarız", "belki" gibi; onaycı, ezik, muğlak ve muallak tavırlar sergileyip kişisel alanımızı mütecaviz ataklar için elverişli hale getirmeyerek, "hayır" demeyi içselleştirip, "hayır" demenin gücünü ortaya koyabilmek.<br/><br/>ha bir de, "elalem ne der" hapishanesinden firar edip davranışlarla birlikte benliği özgür bırakmak.
...
- entry_name: |
  ...
  entry_channels: siyaset
- entry_name: |
    kızılay'a kan vermek istemeyen cahil
  entry_id:  106687585
  entry_writer: birdeniz
  entry_fav_count: 57
  entry_content: |
    cahil ? <br/>ben tam 24 defa kan verdim kızılaya.<br/>gösteriş için gümüş madalya falan yolladılar.<br/>dün babaannem için kan lazım oldu acil.<br/>beklediğim şey o an yoksa bile kan "sizi sıraya alıyorum" ifadesiydi.<br/>aldığım tepki başınızın çaresine bakın şeklinde bir tepki oldu.<br/>şimdi ben bir daha kızılaya kan verir miyim ?<br/>vereni siksinler.<br/>hı ben bir şey kaybetmem şahsen gider veririm hastanelere.<br/>kızılay ise kaybedeceğini çoktan kaybetmiş bir kere.
  entry_channels: sağlık
- entry_name: |
    erkekte vücut kılı sevmeyen kadın
  entry_id:  106691938
  entry_writer: chessboard
  entry_fav_count: 54
  entry_content: |
    (bkz: <a class="b" href="/?q=entry+ve+nick+uyumu">entry ve nick uyumu</a>)<br/><br/><a class="b" href="/?q=tayyarahmet">tayyarahmet</a> nickli bir herifin sırtında kıl yoksa gelin suratıma tükürün.<br/><br/>denize girerken "üstündeki kazağı çıkart" diye taşak geçilenler, maymunluklarını normalleştirmeye çalışıyorlar...
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    6 mayıs 2020 fahrettin koca'nın açıklamaları
  entry_id:  106693666
  entry_writer: busefer
  entry_fav_count: 24
  entry_content: |
    açıklamalardan anladığımız kadarıyla allaha emanet sürecine girmiş bulunuyoruz.
  entry_channels: siyaset,sağlık,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    6 mayıs 2020 zloty kuru
  entry_id:  106665745
  entry_writer: formati idrak etmis harkovcan
  entry_fav_count: 12
  entry_content: |
    --- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>05.05.2017 = 0,9223<br/>06.05.2020 = 1,6940<br/><br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>3 sene önce 1 lira bile değilmiş. çok da zengin bir ülkeden bahsetmiyoruz. polonya'lilarin çoğu almanya ve ingiltere'ye göç etme peşinde.
  entry_channels: ekonomi
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    12 haziranda başlayacak futbola takmıştır kafayı.<br/><br/>asgari ücret alır, ama milyon eurolar kazanan sosa’yı düşünerek olamaz, olamaz, kesinlikle olamaz diye kavgalar çıkarır.<br/><br/>üst düzey sağlık hizmeti alıp kontroldeki adam için kafa şişirir , ama ertesi sabah 7.30’da dolu otobüsle işe gider.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    bugune kadar gordugum, calistigim orta seviye yoneticilerin kadin, erkek farketmez nerdeyse hepsi dandikti maalesef. hala da ayni dandik insanlar ayni dandik pozisyonlarda. <br/>bu arkadaslar, bi ust seviyeye cikacak kapasiteleri olmadigindan, elindekini kaybetmemek icin her turlu terbiyesizligi, serefsizligi, “bu kadarini da yapmaz canim” diyebileceginiz ne kadar entrika varsa yapacak karakterdedir. <br/>ust pozisyonlarda dandiklik daha az ama, yine kadin erkek farketmez.
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    mesela bir film izleyeceğim diyelim. yatağıma uzanıyorum ve laptopu kucağıma alıyorum. bu noktada her şey kusursuz olmalı. bacak açım 1 derece yanlış olmamalı, sol kolumun uzanma mesafesinde içeceğim olmalı, yastığın çıkıntısı sırtımı rahatsız etmemeli,çişimin olmaması lazım,boxerın araya kaçmaması lazım,ayaklarım yorganım salamura yapılmış ve üstüne atılmış; ayaklarımın yüksekliği sağ ve sol arasında eşit olmalı.
  entry_channels: anket,ekşi-sözlük
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    ps5 ve normal bir televizyon almak 15 bin liraya mal olacakken, nasil pc oyuncularini cildirtacagini anlamadigim oyun. allah'im yaratiyorsun bari takip et.
  entry_channels: oyun
- entry_name: |
