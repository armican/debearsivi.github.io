...
- entry_name: |
    evrimin bilimsel bir gerçek olmadığı gerçeği
  entry_id:  83374975
  entry_writer: sauerst
  entry_fav_count: 108
  entry_content: |
    olmayan gerçeklik.<br/><br/>evrim bilimsel bir gerçek değil. islamcı, dinci hokkabazların yaradılışçı hikayeleri bilimsel gerçek tabii.
...
- entry_name: |
  ...
  entry_fav_count: 24
  entry_content: |
    (bkz: <a class="b" href="/?q=pokeimam">pokeimam</a>)
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    neredeyse hiç tanımadığım biri beyaz şarap sevdiğini söylediği için ona beyaz kendime kırmızı şarap aldım. lakin benimki bitmek üzere, onunki ise açılmadı. bu evrenden bir şey dilenmek gibi bir şey sanırım. annemin müzmin bekar bir arkadaşı daima 2 servis açardı tek başınayken, evrenden bir eş istediğini dile getirerek. sanırım sonum ona benzeyecek. lütfen benzemesin
