...
- entry_name: |
  ...
  entry_fav_count: 43
  entry_content: |
    çalıştığım iş yerinde çay, kahve, şeker, su gibi şeyler için aramızda para topluyoruz. kendimiz yapıyoruz. topladığımız para da aylık 10 lira.<br/><br/>güvenlik görevlisi ile konuşuyoruz. <br/><br/>g.g. : ekonomi şöyle güzel böyle güzel. uçuyor uçuyor. milletin cebi para gördü. asgari ücret 1400 diyorlar yalan. asgari ücretle çalışan mı var sanki? <br/><br/>ben : madem böyle uçuyorsun, cebinde para görmüş. 3 aydır neden çay parası vermiyorsun?<br/><br/>g.g. : abi ay başında vereyim<br/><br/>ben : ay başına kadar cebinde 10 lira yoksa bu nasıl uçmak?<br/><br/>g.g. : iptal.<br/><br/>aradan 1 saat geçtikten sonra yanıma tekrar geldi<br/><br/>g.g. : yerli arabayı üretmeye başlamışız. <br/><br/>ben : çok güzel abi. neredeymiş fabrika?<br/><br/>g.g. : gizli tutuyorlar. söylemiyorlar.<br/><br/>ben: peki üretilen arabalar da mı gizli? ben hiç göremedim.<br/><br/>g.g. :göremezsin tabi. hepsini ihraç ediyormuşuz. öyle talep var ki yurt dışından.<br/><br/>ben = bu sefer ben iptal .<br/><br/>ben bu adama enflasyon, ekonomik kriz, usd/try, euro/try desem ne?<br/><br/>asgari ücretli kesim arasında anket yapılsın, ben eminim %75 oy alacaklarına.<br/><br/>edit: imla
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    6 aylık bir dönem yeter derseniz bahar ve yaz aylarına getirmek kaydıyla en iyisi kanada, toronto'dur.<br/>herkes bir yerlerden göçüp geldiği için başka kültürlerden gelen insanlara karşı muazzam bir hoşgörü var.<br/>düzen var, sosyal imkanlar var, bedava sosyal aktiviteler var. amerika'dan ve ingiltere'den ucuz.
- entry_name: |
    ekşi itiraf
  entry_id:  71755362
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    fb - kayseri maçı sonrası tabi üzgün ,tabi ağlak kabul ama yorumcu işte gördüklerini yorumlayacak iş ahlakı gereği ve yorumluyor objektif.<br/><br/>maç sonu r d ; yanlış olan ozan'ın faulündeki gole çubuklu ile atılmaz dedik ama ikinci yarı kayserili kana bıyık'ın jansen'e yaptığı faul hem kırmızı kart hem penaltı,bunu söylemem lazım.<br/>maç sonu murat kosova ; hangi pozisyon hocam ? <br/>maç sonu r d ; çizgideki top ikinci yarı çok net kırmızı kart ve penaltı pozisyon.<br/>maç sonu lig tv muhabiri ; jansen acaba 2.yarı sana yapılan penaltı pozisyonu için ne diyeceksin ?<br/>maç sonu janssen ; hangi pozisyon ?<br/>maç sonu lig tv muhabiri ; ikinci yarı olan pozisyon<br/>maç sonu janssen; hatırlamıyorum.<br/>...
- entry_name: |
...
- entry_name: |
    turk.net
  entry_id:  71762461
  entry_writer: the whore times
  entry_fav_count: 0
  entry_content: |
    kesinlikle yanına dahi yaklaşılmaması gereken bir iss'dir. evde halihazirda bir internet bağlantısı vardı. buna rağmen 14 ekim'den beri internet bağlantısını yapamamışlardır. 16 gündür internetim yok. arayıp derdimi anlayabileceğim bir muhatap da yok. ttnetin söktüğü kabloyu tekrar aynı yere takmak ne kadar zaman alabilir. ben bu kadar beceriksiz adamları aynı çatı altında barındıran başka bir firma görmedim. yarın sabah ilk işim iptal dilekçesini fakslamak olacak. hayattan soğuttular resmen. <br/><br/>burada bir ay ücretsiz kullanın geyiklerine kanmayin. saçı başı yoldurur bu firma. <br/><br/>madem bu kadar talebi kaldiramiyorsun, o zaman yeni başvuru alma kardeşim.
- entry_name: |
    enes ünal
  entry_id:  71765437
  entry_writer: zaireatasesijemalbumbo
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    30’unu geçtim hala şu sıcak soğuk su ayarını yapamıyorum.<br/>1.5 saat o sürede hamama gidip keselenip yıkanırdım ben, şu soğuk musluk sıcak musluk ayarı kadar uyuz eden bir şey yok beni.
- entry_name: |
    3 kasım 2017 galatasaray gençlerbirliği maçı
  entry_id:  71760155
  entry_writer: tyler durlan
  entry_fav_count: 0
  entry_content: |
    kuşların ümitlerini kırmak gibi olmasın ama galatasaray'ın kanırta kanırta kazanacağı maçtır.<br/><br/>zaten kuşlar neden ümitleniyor onu anlamış değilim. biri 4 haftadır 3 puanı unuttu bu hafta hatırladı takımın içi cadı kazanı, diğerinin akhisar ve galatasaray olmak üzere son iki deplasmanda golü yok bu iki 2 maçta kaleyi bulan toplam şut sayısı 1 (bir).<br/><br/>tamam gençliğiniz, çocukluğunuz galatasaray'ın başarılarını izlemekle geçti, geçiyor galatasaray korkunuzu çok iyi anlıyorum ama gerçekleride görmek lazım.
---
