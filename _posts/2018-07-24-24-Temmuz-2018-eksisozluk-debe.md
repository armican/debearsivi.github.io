...
- entry_name: |
    a haber aracına uçak çarpması
  entry_id:  79483750
  entry_writer: oyadabu
  entry_fav_count: 11
  entry_content: |
    ele geçirdikleri <a class="b" href="/?q=gta">gta</a> şifrelerini bile yanlış yazdıklarına işarettir. tank şifresi yerine uçak şifresi girmişler sanırım.<br/><br/>(bkz: <a class="b" href="/?q=u%c3%a7%c3%b6">uçö</a>)
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    karısını aldatıyor, konserleri iptal ediliyor.<br/>konseri iptal edildiği için karısını ifşa ediyor, konserleri gene iptal ediliyor...<br/>ceceli artık sen hiçbir şey yapma istersen, konserlerin ne yapsan iptal ediliyor. demek ki sende ağır bir tırtlık var ki halk senin şeytani suratını görmek istemiyor.
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    üniforma ve bot üreten firması olduğu söyleniyor. bedelli askerlik için 21 gün gidilmesini o yüzden öneriyor ısrarla.
  entry_channels: siyaset
- entry_name: |
    ekşi itiraf
  entry_id:  79460208
...
- entry_name: |
  ...
  entry_id:  79480719
  entry_writer: ama istersen bosver
  entry_fav_count: 4
  entry_content: |
    ayakta işemek.<br/><br/>şu halimle denedim mesela ben, sol bacak boydan boya çiş oldu.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
    cenk 22 milyonsa vida'nın 50 milyon olması
  entry_id:  79470449
  entry_writer: lazybones
  entry_fav_count: 2
  entry_content: |
    kupa bitti hâlâ değerleniyor herif. ne olmuş tatilde şezlong performansı göz mü doldurmuş amk.
  entry_channels: 
- entry_name: |
    gaye su akyol
  entry_id:  79483456
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=memlekette+kimler%2c+nerelerden+para+kazan%c4%b1yor..">memlekette kimler, nerelerden para kazanıyor..</a>)
  entry_channels: tv
---
