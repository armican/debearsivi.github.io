...
- entry_name: |
    önümde temizinden 50 yıl var diyenler
  entry_id:  98671073
  entry_writer: ziplayankaplan
  entry_fav_count: 28
  entry_content: |
    yaş 35 yolun yarısı eder şiirini yazan (bkz: <a class="b" href="/?q=cahit+s%c4%b1tk%c4%b1+taranc%c4%b1">cahit sıtkı tarancı</a>) 46 yaşında vefat etmiştir.
...
- entry_name: |
    facebook'un sürekli arkadaş önermesi
  entry_id:  98663578
  entry_writer: eylul firtinasi
  entry_fav_count: 16
  entry_content: |
    bir kere önerdiği arkadaşı ekledim.<br/>eklenen kişi beni şikayet etmiş, hesabımı geçici kapadılar.<br/>"okuduğumu anladım" falan diye de teyit ettirdiler.<br/>gururum feci kırıldı.<br/>tanım: kıl bir durum.
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    bunu bilmem kaçıncı kez yazıyorum ve (bkz: <a class="b" href="/?q=celal+%c5%9feng%c3%b6r">celal şengör</a>) hoca da milyon kez söyledi ama tekrar edeyim. türkiye’de önce üniversite olsun da bunları sonra konuşalım. <br/><br/>şu anki liseden hallice kurumlar için söylenecek pek bir şey yok hepsi leş.
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    para diyorum ve konuyu kapatıyorum.<br/>şimdi başlarlar özelden “benim sevgilim fakir,asgari ücretli “ falan yazmaya.<br/>daha iyisini bulamamışsınız da ondan. sanki milyarder birisi seni çok istiyordu da sen asgari ücretliyi seçtin amk.<br/><br/>edit: evet tahmin ettiğim gibi mesaj kutusu dolmaya devam ediyor. yok para ikinci planmış,aşkımla,sevgiymiş.<br/>parası olmayan bir adamın, eğer zengin bir rakibi varsa,o kadını elde etmek için bu maça 5-0 geriden başladığını çok iyi biliyoruz, hiç anlatmayın kendinizi. <br/>heee sonradan parası olmayanla birlikte olabilirsiniz,ama o zengin önce bir kere kesin denenmiştir.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    açık açık sincaplar partisi yazdaydınız daha iyiydi ya siz bilirsiniz hocam. <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    türkiye'nin fiyasko eurovision şarkılarında rastlanması olasıydı. (bkz: <a class="b" href="/entry/58663284">#58663284</a>)
...
- entry_name: |
    çağatay aksu
      <li data-id="90707579" data-author="ekşisözlük" data-author-id="8275" data-flags="share report vote" data-isfavorite="false" data-ispinned="true" data-favorite-count="43" data-seyler-slug="" data-comment-count="0">
    entry_content: |
        ankara batı 2. sulh ceza hakimliği'nin çağatay aksu’nun talebi üzerine verdiği 29.05.2019 tarih ve 2019/2586 d.iş sayılı kararı uyarınca şule çet ile ilgili başlıklarda bulunan içeriklere erişimin engellenmesi kararıyla ilgili bir açıklama yapmak isteriz.<br/><br/>ekşi sözlük, türk hukukuna tabi bir internet sitesi olarak mahkeme kararlarını uygulamak yükümlülüğündedir. dolayısıyla bu ve benzeri durumlarda elimize ulaşan mahkeme kararları doğrultusunda hareket ederek, ilgili başlıklardaki içerikleri kaldırmak durumundayız. <br/><br/>bu karara itiraz edecek olmakla beraber, itiraz sürecinin kararı uygulamayı ertelemediğini belirtmek isteriz.<br/><br/>tarafımıza iletilen kararların uygulanması yasa gereği olup, kararı benimsediğimiz veya olumladığımız anlamına gelmemektedir. <br/><br/>hukuk sistemimizdeki hataların, yanlışların, adalet duygusunu zedeleyen uygulama ve kararların giderilmesinin yolu, eleştirilerin doğru makam ve mercilere yöneltilmesinden geçer. genel olarak mahkemelerin içerik kaldırılmasına ilişkin kararlarındaki hoyratlık ve bu kararlara ilişkin itirazların incelenmesi süreçlerindeki özensizlik nedeniyle oluşan kamuoyu tepkisinin ilgili ve yetkili mercilere yönelmesi halinde bu hatalı işleyişin düzelmesi yönünde olumlu adımlar atılır diye umuyoruz.
  entry_channels: haber
---
