...
- entry_name: |
  ...
  entry_fav_count: 722
  entry_content: |
    ben ömrümde bu kadar muhteşem bir entry-nick uyumu görmedim.<br/>allah yolunu açık etsin...
...
- entry_name: |
  ...
  entry_channels: tv,spoiler
- entry_name: |
    imamoğlu'nun fetöye pkkya karşı cümlesini duymadık
  entry_id:  90855852
  entry_writer: kalbim temiz benim
  entry_fav_count: 82
  entry_content: |
    bu adam da tam bir mal oldu çıktı arkadaş ya. ülkücülüğün tohumunda mallık var sanırsam.
...
- entry_name: |
  ...
  entry_fav_count: 65
  entry_content: |
    içerisinde bulunduğum ve bunu yaşam tarzı haline getirmiş insanları saygıyla gözlemlediğim insan grubudur.<br/><br/>bu insanlar kişisel alanlarında kalmayı severler ve diğer insanların kişisel alanlarına saygılıdırlar. üretkenliği genellikle yüksek insanlardır. odaklanmayı ve genelde kendilerine yatırım yapmayı severler.<br/><br/>en önemlisi ise topluma zararsız insanlardır.
...
- entry_name: |
  ...
  entry_fav_count: 28
  entry_content: |
    10-15 milyon eurolari avrupa piyasasinda cok sanan sigirlari gostermistir. oglum asin artik bunlari, euro'yu da 7 ile carpmayin. atletico madrid, inter, tottenham gibi kulupler icin 15 milyon euro harcamak koymaz, rotasyon oyuncusuna bu kadar para bonservis verebilirler yani. <br/><br/>bu bedeller turk kulupleri icin yuksek, cunku ulke ekonomisi batik. bu kadar basit.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    en sonunda ses acip kaparken ekranin ortasi kapanmayacak ya, su an icin en cok buna seviniyorum. ne gerizekalilikti, gec bile kalindi...
  entry_channels: bilim,programlama,teknoloji
- entry_name: |
    turkcell'in 500 bin abone kaybetmesi
  entry_id:  90857024
  entry_writer: dim nick
  entry_fav_count: 12
  entry_content: |
    diğer operatörleri her ne kadar sevmesem bile turkcell'in bu denli abone kaybı yaşaması sevindirici bir gelişme. (bkz: <a class="b" href="/?q=mehmet+em%c4%b1n+karamehmet">mehmet emın karamehmet</a>) in ahı hep bunlar.
  entry_channels: 
- entry_name: |
    tsk'da ne pilot ne de harbiyeli subay kalmaması
  entry_id:  90856307
  entry_writer: isen buga
  entry_fav_count: 12
  entry_content: |
    ergenekon ve balyoz kumpaslarının eşbaşkanı olan akp'nin marifetlerinden biridir. <br/><br/>turk ordusu şu anda balkan savaslari öncesi hâlde , umarım sonu benzemez .
...
- entry_name: |
    tek başına yapılacak en mükemmel aktiviteler
  entry_id:  90845925
  entry_writer: varolan
  entry_fav_count: 8
  entry_content: |
    dostoyevskinin st petersburg şehrinde dolaşması gibi amaçsızca istanbulun sokaklarında dolaşabilir, gece yürüyüşleriyle şehrin öteki yüzünü gözlemleyebilirsiniz.<br/><br/>unutmayın "kendinizi akışa bırakmak" sadece tek başına olduğunuzda yapılabilecek bir eylem.
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    şayet bu film imdb’de sonuncu olsa; ki olmalı enes batur denen gerizekalıyı üzmeyecek filmdir. öyle bi durumda -yaa ben yapmak istedim yaptım , olsun beğenilmese de ben beğenildğini düşünüyorum, bence saygı gösterilmeli- olarak yorumlayacaktır mutlaka.<br/><br/>içinden gelen en gerçek hisler ise; amk filminin de, sinemasının da çokta tın. daha çok ünlü oldum, daha fazla para indirdim cebe. zaten sinemanın amacı bu değil mi <br/><br/>altan erkekli sen de tam bir vizyonsuzmuşun.
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    bayram zamanı biraz çekilmesini ve köyünü ziyaret etmesini gayet doğru bir hamle olarak görüyorum. <br/>bayramdan sonra seçime kadar olan surecte de daha cok vaatlerini anlatması lazim. son 3 5 günde de mağduriyeti ve mazbatanin elinden alınması olayina vurgu yapıp son gun ise yolsuzluk rakamları ile vurmalıdır. böyle bir sürecin ekrem imamoğlu icin zaferle sonuçlanacağını düşünüyorum.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    küvette, lavaboda, klozette ve sabun üstünde saç, kıl görünce çok iğreniyorum, kendi saçım dahil.<br/>ama kıllı ve yaldır yaldır saçlı erkek seviyorum.
...
- entry_name: |
    köpeğine balkonda işkence eden cani
  entry_id:  90857596
  entry_writer: merihberlin
  entry_fav_count: 1
  entry_content: |
    cimer aq onun, oraya yazin. sahsen tecrübe edip yasadim. 5 kez karakol 3 kez belediye‘ye yazdim cirt cikti. birisi cimer‘e yaz dedi 3. gün ayni karakol‘un tüm araclari geldi. firca‘yi yiyince karakoldakiler görevleri‘nin „toplum‘un huzurunu saglama“ oldugunun farkina varmislar. dene bence.
  entry_channels: haber
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    bu tarz başlıklara yazmayı sevmesem de;<br/><br/>at sahibine göre kişner.
  entry_channels: 
- entry_name: |
    ipados
  entry_id:  90851230
  ...
  entry_fav_count: 1
  entry_content: |
    apple'in ipadler icin kullanacagi "yeni" isletim sistemi.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    türklerin partisi gibi veya buna benzerlikte, oldukça sivri bir isim koyacak ve muhafazakar milliyetçi oyları bölerek yine ak partiye çalışacaktır. ne zannediyorsunuz, burası almanya mı ki mecliste yüzelli tane parti olsun.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    hayret bir ekonomi bakanı gelipte bu devirde viskimi içilir, biz daha bira içecek parayı bulamıyoruz lan hepinizmi zenginsiniz yazmamış.<br/>sözlük beni şaşırtıyosun.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    söylediklerinin sadece doğru olmasına değil, <br/>konuştuğun kimsenin bu doğruya katlanabilecek olmasına da <br/>dikkat et.<br/><br/><a class="b" href="/?q=do%c4%9fruyu+s%c3%b6ylemek">doğruyu söylemek</a><br/><a class="b" href="/?q=michel+foucault">michel foucault</a>
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/entry/90823824">#90823824</a>) bu nedir allah aşkına. çok mu yalnızsın yiğidim?<br/>cesaret hapı içen bir yazarın da içinde bulunduğu veritabanı.<br/><br/>edit: telefon numarasını yazmış suser, kaldırmış.
  entry_channels: anket,ilişkiler,ekşi-sözlük
---
