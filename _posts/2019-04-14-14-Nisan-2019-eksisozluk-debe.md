...
- entry_name: |
  ...
  entry_fav_count: 234
  entry_content: |
    insanın kendi canıdır.allah muhafaza bir hastalanın bakalım o zaman bu saydıklarımız umurunuzda olur mu?
...
- entry_name: |
  ...
  entry_fav_count: 180
  entry_content: |
    hayalimdeki kızdır. boş ritüellerle kafa sikmek yerine imzamızı atar olayı resmileştiririz ardından ver elini bal ayı. gerek yok sikik sokuk adetlere. inş bigün karşılaşırız böylesiyle. evet.<br/><br/>edit. aşağıda bi arkadaş şöyle demiş. <br/><br/>" türk erkekleri bayılır bedavadan gelin almaya : )))) " <br/><br/>arkadaşın fiyatı kaç acaba çok merak ettim .
...
- entry_name: |
    devlet bahçeli'nin %18.8 oy aldık açıklaması
  entry_id:  88880910
  entry_writer: quatre vingt trois
  entry_fav_count: 82
  entry_content: |
    en azından %100’ün üzerinde bir oran vermemiş olması da olumlu bir gelişmedir.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    bir mesaja bu kadar anlam yüklemeyin. boşa taktikler yapıp karşınızdakinin kafasını karıştırmayın, keza karşı taraf sanıldığı kadar salak olmuyor çoğunlukla; bu taktiksel ve de matematiksel biraz da olasılık hesabı ile harmanlanmis durum sadece karşı tarafta güvensizlik yaratmakla kalmıyor derin bir paranoya hali de yaratıyor aynı zamanda. flortleri bir taktik savaşına döndürmeyin, içinizden geldiyse atin o mesajı, düsünmeyin . ve hatta bosverin mesajı, arayın. kısa vadede reddedilseniz bile uzun vadede kafanız rahat eder. en azından denediniz
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ooo başlığın mevsimi gelmiş. yine iyi entry yapar..
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    hani bu siyasal islamcı tayfa 90'ları işaret ediyor ya. chp böyle, shp şöyle. biraz tırtıkladı mı neler çıkıyor! adeta sahtekarlıklar dökülüyor. zülfü livaneli geç kalmış olsa da içindekileri tutamamış. <br/>artık herkes ne biliyorsa aktarsın. bilelim de aydınlanalım.
  entry_channels: 
- entry_name: |
