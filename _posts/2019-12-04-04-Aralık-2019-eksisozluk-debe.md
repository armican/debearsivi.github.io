...
- entry_name: |
  ...
  entry_fav_count: 30
  entry_content: |
    ilk sordugu soru tartisilabilir, hatta soguk savas doneminde olsak cevabi "haklisin" bile olabilirdi o sorunun, ancak 2019 yilindayiz o sebepten o kadar basit degil.<br/>ancak ikinci konu, yani ypg'nin terorist bir orgut olmasi konusu, bunun tartisilabilir bir tarafi yok, tartisilabilir olmamasinin sebebinin turkiye ile de alakasi yok, 2016 yilinda nato'nun kabul ettigi guvenlik politikasi strateji belgesinde ypg zaten terorist bir orgut olarak niteleniyordu, sonradan nato uyesi ulkeler bu konuda yan cizmeye basladi. aga 2016'ya kadar terorist diyen sizdiniz, biz durdugumuz yerde duruyoruz, siz niye fikir degistirdiniz onu anlatin.
  entry_channels: siyaset
- entry_name: |
    halk bilginer vs can yaman
  entry_id:  98632644
  entry_writer: vpx
  entry_fav_count: 29
  entry_content: |
...
- entry_name: |
    rusya'nın yerli yazılıma hamlesi
  entry_id:  98632532
  entry_writer: bu da benim nickim husnu bey
  entry_fav_count: 19
  entry_content: |
    işin daha kötüsü biz de para verip alırız bu yazılımı sonra amerika istemediği için kullanmayız.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  98628903
  entry_writer: heyecanlandim
  entry_fav_count: 10
  entry_content: |
    özgürlük. çalışmak zorunda olmayacak kadar maddi özgürlük, istediğim ülkeye gidebilmemi sağlayacak kadar seyahat özgürlüğü favorilerim.<br/>bir de hızlı dil öğrenebilme yeteneğini çok isterdim.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    sadece taktik verecekler yazsin.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
