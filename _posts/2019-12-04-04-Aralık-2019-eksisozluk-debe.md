...
- entry_name: |
    3 aralık 2019 adıma hakaret davası açılması
  entry_id:  98634007
  entry_writer: celaliyimcelalisincelali1
  entry_fav_count: 106
  entry_content: |
    facebook ip vermiyor. çünkü türkiye'de ofisi yok diye biliyorum. ana merkezi amerikada. sadece terör (pkk, dhkpc, tikko, ışıd, el kaide propagandası), çocuk pornosu gibi suçlardan ip veriyor. adıma sahte hesap açılmış, ip istiyorum, ben yazmadım de, yırtarsın. fakat şunu hiç bir zaman unutmayın, türkiye cumhuriyeti sizi bulmak isterse yerin dibine de girseniz bulur.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    haluk bilginer vs can yaman
  entry_id:  98632644
  entry_writer: vpx
  entry_fav_count: 61
  entry_content: |
    ben <a class="b" href="/?q=halk+bank">halk bank</a> diyorum
  entry_channels: anket,ilişkiler,tv,sanat,sinema,magazin
- entry_name: |
    fatih altaylı
  entry_id:  98598654
  entry_writer: velon
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    milli piyango 2020 yılbaşı çekilişi
  entry_id:  98633053
  entry_writer: teks kolesi
  entry_fav_count: 36
  entry_content: |
    akp iktidarında milli piyangoya 1 kuruş veren bildiğin enayidir.
...
- entry_name: |
  ...
  entry_fav_count: 31
  entry_content: |
    ben beklerim de sen gelir misin?
...
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    intihar gerçekten anlamlı bir şeye dönüşebilirdi o zaman.
...
- entry_name: |
  ...
  entry_id:  98631758
  entry_writer: bu mu alem
  entry_fav_count: 14
  entry_content: |
    (bkz: <a class="b" href="/?q=arkada%c5%9fa+can+yaman+g%c3%b6nderelim">arkadaşa can yaman gönderelim</a>)
  entry_channels: 
- entry_name: |
    şeyma subaşı'nın aldatılması
  entry_id:  98634724
  entry_writer: uhud
  entry_fav_count: 12
  entry_content: |
    guido, acun'u yiyen bizi bir lokmada yutar, demiştir.
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    'hayatta hiçbir zaman kafamızdaki gibi harikulade şeyler olmayacağını henüz idrak etmemiştim' sabahattin ali
  entry_channels: anket
- entry_name: |
    emmanuel macron
  entry_id:  98623658
  entry_writer: iknowaghost
  entry_fav_count: 9
  entry_content: |
    türkiye'yi suriye'deki ortaklarına karşı savaşmakla suçlayan bir aptal.<br/><br/>bu aptala birisi kronolojik sıralamayı hatırlatmalı. bizim saldırdığımız örgüt zaten yıllardır sizin ve tüm nato ortaklarının terör örgütü saydığı bir organizasyon. önce sen türkiye'ye karşı terör eylemi gerçekleştiren bu örgütü destekledin.<br/><br/>şu adamı hayata karşı ümidini kaybetmiş herkes takip etmeli. bu aptal bile bir yerlere gelebiliyorsa siz niye başaramayasınız? inanın.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    (bkz: <a class="b" href="/entry/98622135">#98622135</a>)<br/><br/>şu söz ne anlama geliyor, açıklayayım:<br/><br/>bir insanı severken onun potansiyel olarak para kazanmasını seviyorum demektir. ayrıca, para kazanmayan insanı kimse sevmezmiş, sizin n’asıl arkadaşlık, dostluk, ya da diğer ilişkileriniz var! eşiniz büyük bir kaza geçirse ve çalışamayacak duruma gelse terk edeceksiniz o zaman bu bağlamda. benim arkadaşım var, hiç para kazanmıyordu, ama ben bunları hiç dert etmedim. veya kız arkadaşım olsa o da aynı durumda olsa onu da hiç problem etmem. yahu siz insanın yapabileceği şeylerin potansiyeline göre mi seviyorsunuz, bu n’asıl çıkarcılıktır? geçenlerde <a class="b" href="/?q=arthur+schopenhauer">arthur schopenhauer</a>’in <a class="b" href="/?q=hi%c3%a7li%c4%9fin+mutlu+sessizli%c4%9fi">hiçliğin mutlu sessizliği</a> kitabında şöyle bir satıra denk geldim, mantıklı gelmedi ama bu potansiyeldeki çoğunluk kadın için geçerli demek ki: “kadınlar içten içe para kazanmanın erkeklerin işi, harcamanın da kendi işleri olduğunu düşünür.”<br/><br/>paraya, menfî duygulara göre hareket eden herkes net olarak bayağıdır, utanç vericisiniz!
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    "nasılsınız hamınefendi?" dedi bana.<br/>(eşim diyor)
  entry_channels: anket
- entry_name: |
    baby yoda
  entry_id:  98603779
  ...
  entry_fav_count: 3
  entry_content: |
    9gag'i kasıp kavuran şirin şey.<br/><br/>her hareketi ayrı bir <a rel="nofollow noopener" class="url" target="_blank" href="https://9gag.com/gag/ayoqn9y" title="https://9gag.com/gag/ayoqn9y">olay</a>.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    nerede rahat sıçabiliyorsan orası evindir.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    snowy white - <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=Ntf0IVsQNGQ&amp;list=RDg4RS43ix158&amp;index=22" title="https://www.youtube.com/watch?v=Ntf0IVsQNGQ&amp;list=RDg4RS43ix158&amp;index=22">riding the blues</a>
  entry_channels: anket,müzik
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    1. "sıkıldım bu hayattan, gel beraber aykırı bir şey deniyelim" dersem bu ne olurdu?? <br/><br/>2. yıkmak isteyip de yıkamadığın tabun?<br/><br/>3. kendi cinsinden en nefret ettiğin özellik??
  entry_channels: anket,ilişkiler
- entry_name: |
    ekşi sözlük dertleşecek insan veritabanı
  entry_id:  98631218
  entry_writer: mhckomplex
  entry_fav_count: 0
  entry_content: |
    dertleriniz o kadar boktan ki dinlemeye değmez
  entry_channels: anket,ilişkiler,ekşi-sözlük
---
