...
- entry_name: |
  ...
  entry_fav_count: 24
  entry_content: |
    30 ve 30+ yasina gelmis, insanlari tanimis ve onlardan tiksinmis, hayvanlarin saf sevgisinin insanlarin yalan sevgisinden daha cok mutluluk verdigini ogrenen, hayatinda bencillik, adilik, serefsizlik istemeyen kadindir.
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    şimdi de <a class="b" href="/?q=skt">skt</a> rötuşlayan <a class="b" href="/?q=s%c3%bcta%c5%9f">sütaş</a>’ın ipliğini pazara çıkardı.<br/><br/>ülkenin acınası halini her gün kafamıza çakıp duruyor.
...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    tinerciler haklı galiba daha çok sövecez bu amk bencil pembe kafaya.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    (bkz: <a class="b" href="/?q=bensu+soral">bensu soral</a>) <br/><br/>(bkz: <a class="b" href="/?q=dilan+%c3%a7i%c3%a7ek+deniz">dilan çiçek deniz</a>)<br/><br/>(bkz: <a class="b" href="/?q=deniz+baysal">deniz baysal</a>)
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    ali palabıyık kötü hakem değil kötü niyetli bir hakem.
  entry_channels: spor
- entry_name: |
    18 ekim 2019 katoliklerin diyanet'e çağrısı
  entry_id:  96700630
  entry_writer: karni kasinan bidon kafa
  entry_fav_count: 5
  entry_content: |
    adamlar demiş ki biz yıllar önce bu haltı ettik hayatımızın içine sıçtık siz etmeyin bari. ama anlayan yok ne yaparsın işte. (bkz: <a class="b" href="/?q=allah%27%c4%b1+sava%c5%9fa+kar%c4%b1%c5%9ft%c4%b1rmay%c4%b1n">allah'ı savaşa karıştırmayın</a>) iyi bir laf olmuş ayrıca.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    bütün yiyeceklere pul biber atan insan
  entry_id:  96708284
  entry_writer: jassinpera
  entry_fav_count: 3
  entry_content: |
    kahramanmaraşlı olması muhtemel olan insandır.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    çatır çutur mesajlaşacak*siyah dışında farklı renk iç çamaşırı da giyebilen, seksi ve hoş sohbet kadınları beklediğim veritabanı.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    pil ömrünü fren yapan aracın hız göstergesi gibi izlediğim güncelleme. yüzde 90 iken 1 saat sonra yüzde 35 oldu. şarja taktım yüzde 69 oldu yarım saat olmadan. 10 dakika sonra kontrol ettim yüzde 59 olmuş. <br/><br/>sakın güncellemeyin. iphone 6s
  entry_channels: teknoloji
- entry_name: |
    en güzel erkek parfümü
  entry_id:  96710521
  entry_writer: medicalboss
  entry_fav_count: 0
  entry_content: |
    fahrenheit. kullandığım gün mutlaka birisi ismini soruyor. <br/>yazın toplu taşıma araçlarında kullanmamak şartıyla tabii.
...
- entry_name: |
  ...
  entry_id:  96707591
  entry_writer: oorangepie
  entry_fav_count: 0
  entry_content: |
    albany downtown da kahve içiyorum.
  entry_channels: anket
---
