...
- entry_name: |
    ahlaksızlığı özgürlük zannetmek
  entry_id:  66922461
  entry_writer: edie sedgwick
  entry_fav_count: 42
  entry_content: |
    bir kesim var ki ülkemizde, sevebilecek kadar özgür değiller. sevilebilecek kadar da değerli değiller kendileri için. sevgisiz ve mutsuzlar.<br/>bu, mutlu olmayı ahlaksızlık sananlar için çok üzülüyorum.<br/>keşke siz de sevilseniz... sonra zaten sevmeyi de öğrenirsiniz.
- entry_name: |
    ekşi itiraf
  entry_id:  66915537
...
- entry_name: |
  ...
  entry_fav_count: 27
  entry_content: |
    arkasında kimin olmadığını bilen, kimin oldugunu da bilir..<br/>(bkz: <a class="b" href="/?q=o+zaman+kim+say%c4%b1n+amk">o zaman kim sayın amk</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 22
  entry_content: |
    bu programlarla zerre alakası olmayan biri olarak bu kararı doğru bulmam.<br/>zira bugün kararname ile evlilik programı kaldırılırsa, yarın kararname ile tüm kanallara günlük 10 saat mevlüt yayımlama zorunluluğu getirilebilir.<br/><br/>bu programlardan kurtulmak için kararname çıkarmak yerine halkın eğitim düzeyini arttırmak daha faydalı olacaktır.<br/><br/>ama eğitimli kesim de oy vermiyor işte :(
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    başrolünde <a class="b" href="/?q=finn+jones">finn jones</a> olduğu ve kendisini <a class="b" href="/?q=loras+tyrell">loras tyrell</a> olarak tanıdığım için kafamı karıştıran dizidir.<br/>(bkz: <a class="b" href="/?q=iron+fisting">iron fisting</a>)
- entry_name: |
    galatasaray
  entry_id:  66929224
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    doğru olmayan açıklama.<br/><br/>birincisi işsiz tanım itibariyle iş arayıp bulamayan insan demek. çeşitli sebeplerden ötürü iş aramayan insanlar zaten işgücüne katılmış sayılmıyor.<br/><br/>ki zaten etraf böyle insanlardan kaynıyorsa o zaman devlet niye teşvik üzene teşvik açıklıyor değil mi?<br/><br/>bu "iş beğenmiyorlar" geyiğinin iki sebebi var<br/>1) türkiye'de kimse hatasını kabul etmiyor (asıl sebep bu). ekonomik gidişat iyi değil diyecek halleri yok<br/>2) işverenler asgari ücretin bir tık üstüne kalifiye eleman arıyor. 10 kuruşa domates satmayan pazar esnafı için "müşteri beğenmiyorlar" diyor muyuz?
- entry_name: |
    zeka insanın çevreye uyum yeteneğidir
  entry_id:  66932136
  entry_writer: i believe
  entry_fav_count: 0
  entry_content: |
    tanıdığım tüm fazla zeki insanların iflah olmaz uyumsuzlar olmasına dayanarak çürütebileceğim önerme.
- entry_name: |
...
- entry_name: |
    dağ 2
  entry_id:  66931583
  entry_writer: usturasizkemall
  entry_fav_count: 0
  entry_content: |
    sniper'in okuduğu şiirlerin <a class="b" href="/?q=ats%c4%b1z">atsız</a>'dan olduğunu fark edince şaşırdığım film. <br/><br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>insan büyür beşikte <br/>mezarda yatmak için. <br/>ve........................... <br/>kahramanlar can verir <br/>yurdu yaşatmak için... <br/><br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---
- entry_name: |
    benim dışımda herkes sevişiyor hissi
  entry_id:  66930625
  entry_writer: el pajaro
  entry_fav_count: 0
  entry_content: |
    bende de var lan bu his. sanki herkes tavsan gibi sevisiyor, sikisiyor, ben oturuyorum bilgisayar basinda pogaca pogaca.
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    onu unutun, kendinizi hatirlayin. <br/><br/>illa acı çekeceğim diyorsanız da çok abartmayın. tadında bırakın. her aşk gelip gecicidir. hayat her halükarda bunu size gösterecektir.
---
