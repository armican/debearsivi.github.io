...
- entry_name: |
    istanbul semtlerinin ingilizce karşılıkları
  entry_id:  75872948
...
- entry_name: |
  ...
  entry_fav_count: 70
  entry_content: |
    ekşide götünün üzerinde oturarak hiçbir şey üretmeyen at kafaları tarafından eleştirilmiş kişi ve sikik egosunu tatmin etmek için eleştirdiği de gayet açık ve net.<br/><br/>kimisi gerçekten de "eger baris ozcan'i cok begeniyorsaniz, rakipsiz oldugunu dusunuyorsaniz ingilizce bilmeyen, internet erisimi kisitli bir cahil olma ihtimaliniz cok yuksek." olamaz mı, ey amcık hoşafı?<br/><br/>bak bak, lafa bak, at yarrağına bak hele. doğarken götüne usb stick sokup ingilizce öğretmişler sanki at skine. bir de milleti cahil diye aşağılıyor.<br/><br/>bunun gibilerine yağmurlu günde su vermeyeceksin, su.
- entry_name: |
...
- entry_name: |
    eşinin testisini sıkarak şiddet uygulayan gelin
  entry_id:  75892557
  entry_writer: periyodik muharrir
  entry_fav_count: 53
  entry_content: |
    (bkz: <a class="b" href="/?q=testisi+elinde">testisi elinde</a>)<br/><br/>edit: bu ne diye soranlara:<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://resimyukle.xyz/resim/JcNddG">https://resimyukle.xyz/resim/jcnddg</a>
- entry_name: |
    tek cümle ile kürk mantolu madonna kitabının özeti
  entry_id:  75883096
...
- entry_name: |
  ...
  entry_fav_count: 29
  entry_content: |
    26 yas ve uzeri ama 88'liler haric olarak cikacaktir.
- entry_name: |
  ...
  entry_fav_count: 28
  entry_content: |
    rabia’ya 4.1 güncellemesi gelmiştir. <br/>kur artışı olsa yerinde duramazsın.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    maçtaydım. gençlerbirliği taraftarı içinde kendini saklamadan maçı izleyen pek çok galatasaray taraftarı vardı ve gençlerbirliği taraftarı hiç saygısını bozmadı. cimbomumun yenilmesine çok üzüldüm ama gençlerbirliği için sevindim. aldıkları 3 puan helali hoş olsun. umarım ligde kalmayı başarırlar.
- entry_name: |
    olan biten
  entry_id:  75894423
...
- entry_name: |
    seks esnasında yol yabdı diyen kız
  entry_id:  75897951
  entry_writer: discodisco
  entry_fav_count: 12
  entry_content: |
    (bkz: <a class="b" href="/?q=kula%c4%9f%c4%b1ma+terbiyesiz+icraatler+f%c4%b1s%c4%b1lda">kulağıma terbiyesiz icraatler fısılda</a>)
- entry_name: |
    kalben
  entry_id:  75895110
...
- entry_name: |
    10 nisan 2018 bir kadın yazara aşık olmam
  entry_id:  75897254
  entry_writer: planoryum
  entry_fav_count: 9
  entry_content: |
    (bkz: <a class="b" href="/?q=bizden+tam+olarak+ne+istemen">bizden tam olarak ne istemen</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    meeerhaba henry hoooosgeldddin
- entry_name: |
    yatağa bağımlı necat'a yardım ediyoruz
  entry_id:  75895950
  entry_writer: sirhopkins
  entry_fav_count: 0
  entry_content: |
    acil sifalar diliyorum, basligi ustte tutalim.
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=kredi+kart%c4%b1+borcu">kredi kartı borcu</a>)<br/>önce alırken bedavaya alıyormuş hissi,ay sonunda ekstreyi görüş,allah'ım ben ne bok yedim yakarışları,istiklal marşı kapanış.
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    anlattıkça azalan bu dert bizim <br/>dinleriz efendim
- entry_name: |
