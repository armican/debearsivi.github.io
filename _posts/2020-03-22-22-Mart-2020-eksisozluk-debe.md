...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    ankara b.b.'nin 65 yaş üstü ücretsiz ulaşım iptali
  entry_id:  103902712
  entry_writer: onlyonechance
  entry_fav_count: 179
  entry_content: |
    mansur başkan, ekrem başkana göre hep bir adım önde gidiyor.<br/>aynı hareketi ekrem başkandan bekliyoruz.
...
- entry_name: |
  ...
  entry_channels: sağlık,haber
- entry_name: |
    kendisini uyaranlara bıçak çeken yaşlı
  entry_id:  103897732
  entry_writer: youtuber
  entry_fav_count: 55
  entry_content: |
    eeee ne var. bunlar gençkende bıçak çekiyor. kabadayı bunlar .....<br/>yaşlanınca insanın huyu değişiyor mu sanıyorsunuz ?<br/>doğal seçilim sürecinde böyle çok agresifler elenir. ota boka bıçak çekersen biride götünden kan alır bir gün.... <br/>bugüne kadar o biriyle tanışmamış olması üzücü olan 'yaşlı insan' .... dede demiyorum çünkü aklımdaki dede imgesini kirletecek bir insan...
  entry_channels: sağlık,haber
- entry_name: |
    hoşlanılan kızın sen bana fazla iyisin demesi
  entry_id:  103904937
  entry_writer: drbaris
  entry_fav_count: 53
  entry_content: |
    (bkz: <a class="b" href="/?q=ba%c5%9f%c4%b1ndan+defetmek+i%c3%a7in+uydurulan+1001+yalan">başından defetmek için uydurulan 1001 yalan</a>)
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    21 mart 2020 bütün mahalle tarafından alkışlanmam
  entry_id:  103912569
...
- entry_name: |
  ...
  entry_fav_count: 36
  entry_content: |
    "başkanımız istanbul seçimini kaale alsaydı hayatı boyunca seçim kazanamamış binali yıldırımı aday göstermezdi bir kere." <br/><br/>bazılarının cehaleti corona virüsünden daha tehlikeli anlaşılan.
  entry_channels: siyaset,haber
- entry_name: |
    koronalıları mancınıkla yunanistan'a fırlatmak
  entry_id:  103907845
  entry_writer: sigadam
  entry_fav_count: 31
  entry_content: |
    havada ilerlerken "bize bişeyyy olmağgggz mına koi.." diye bağıracak insandır
  entry_channels: 
- entry_name: |
    sokağa çıkma yasağı
  entry_id:  103868099
...
- entry_name: |
  ...
  entry_fav_count: 24
  entry_content: |
    kaçtığını zannederken kendine toslar insan. en uzun görünen dolambaçlı yol belki de en kestirme yoldur.<br/><br/><a class="b" href="/?q=ulysses">ulysses</a> - <a class="b" href="/?q=james+joyce">james joyce</a>
  entry_channels: anket,sanat,edebiyat
- entry_name: |
    cumhurbaşkanına sokağa çıkma yasağı uygulanması
  entry_id:  103907298
  entry_writer: xlinux
  entry_fav_count: 23
  entry_content: |
    65 üstü kişiler 21 mart gecesinden itibaren sokağa çıktıkları takdirde türkiye cumhuriyeti yasalarını ve içişleri bakanlığının kararına muhalefet olacağından suç olacaktır.<br/><br/>reis 66 yaşında? ve gördüğümüz kadarıyla yasada bir istisna yok. reisi nasıl eve kapatacaklar tövbest... zaten camiilerde kapandı.
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    rte den gelen korona mesajı
  entry_id:  103910598
  entry_writer: eksi peace
  entry_fav_count: 20
  entry_content: |
    bana gelmemiş mesaj.<br/><br/>evde zor tuttuğu yüzde 50'den değilim demek.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    (bkz: <a class="b" href="/?q=entelekt%c3%bcel+kad%c4%b1n+aramak+bulunca+da+sikmek">entelektüel kadın aramak bulunca da sikmek</a>)
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    (<a class="b" href="/entry/103771111">#103771111</a>) bir türk sitesinde, türkçe olarak afd öven yazanlar görüyorum. bir türk'ün neonazi bir partiyi neden desteklediğini anlamam imkansız sanırım. umarım bir gün beyni yerine gelir yazar arkadaşın.<br/><br/>tanım: 5000 üzeri covid-19 vakasında en düşük ölüm oranına sahip ülkedir.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    bugünlerde belli toplum katmanlarında çok marjinal bi duruş sahibi olmak anlamına gelir.<br/><br/>kadıköy tipleri arasında falan "wow! dövmen yok mu senin?! çok cool yhaa!" falan deniliyo mu acaba hiç?<br/><br/>ps. sanmam, zira (bkz: <a class="b" href="/?q=ayn%c4%b1+tornan%c4%b1n+marjinalleri">aynı tornanın marjinalleri</a>) :d<br/><br/>edit: <br/>engellenen sığır skoru: 2
  entry_channels: 
---
