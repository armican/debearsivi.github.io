...
- entry_name: |
    isteğini ağlayarak yaptırmaya çalışan çocuk
  entry_id:  67898838
  entry_writer: caffee latte
  entry_fav_count: 85
  entry_content: |
    ağladığımız zaman babam nazikçe dizlerinin üstüne çöker, göz hizamıza gelir ve şöyle derdi:<br/><br/>"şu an ağlamak için bir sebebin yok, ama istersen seni gerçekten ağlatabilirim"<br/><br/>gel de ağla.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    şirkette hoşlandığım adam beni farketsin diye yeni aldığım kıyafeti giydim. upuzun koyu kumral saçlarım hareket ettikçe güzel bir koku yaysın diye öne doğru saçlarımı alıp üzerine parfüm sıktım. sonra geriye doğru taradım. hafif bir makyajla da konuyu bitirdim.<br/><br/>şirkette sabahtan başlayarak en az 20 kız bugün çok güzel olduğumu söyleyip iltifat etti. ancak, tüm bu çabayı gösterdiğim kişi hiç bir kelam etmedi. başka bir erkek de bir iltifatta bulunmadı. <br/><br/>sanırım sadece kadınlara hitap ediyorum. lezbiyen olsaydım şimdiye alıp yürümüştüm bence.
- entry_name: |
