...
- entry_name: |
  ...
  entry_fav_count: 32
  entry_content: |
    bazen rüzgarın saçımı dağıtmasına,<br/>yağmurun yüzümü ıslatmasına,<br/>birilerinin kalbimi kırmasına izin veririm.<br/>sonra;<br/>saçımı toplarım,<br/>şemsiyemi açarım,<br/>kalbimi kapatırım.<br/>hepsi bu.<br/>(bkz: <a class="b" href="/?q=can+y%c3%bccel">can yücel</a>)
...
- entry_name: |
  ...
  entry_fav_count: 22
  entry_content: |
    noldu lan? dinden mi döndün o twitle?<br/><br/>gayet şirin bir görsel ile bayram tebriği yapan twittir.
  entry_channels: haber
- entry_name: |
    digimon vs pokemon
  entry_id:  93838633
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    başarılı bir tespittir. <br/><br/>evlenmeden olmaz demek senin yarağının katma değeri yok demektir.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: anket,müzik
- entry_name: |
    en iyi f/p oranına sahip alkolsüz içki
  entry_id:  93840021
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    kanada'da yaşıyor olsak bir sürü avantajdan bahsedebilirdim. orta doğu ülkesinde kadın olmanın nasıl bir avantajı olabilir?<br/><br/>gece yolda yürüyemezsin. dolmuşta yalnız yolculuk edemezsin. bu iki örnek yeter sanırım hiçbir avantajın dezavantajlardan sıyrılıp örneğe dönüşememesine.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    çoğu insan yalnız kalmaktansa hiç devam etmemesi gereken ilişkileri devam ettirebiliyor. kötü ilişki kanser gibidir ve bitirmediğin sürece sürekli devam eden, tüm bedenine saran bir kanser. daima sorunun vardır kavga, gürültü, endişeler... bir yerden sonra gözünde normalleşir insanın bu sıkıntılar yegane amacı aman ilişkiye bir sey olmasın yeter ki devam edelim olur. aman yalnız kalmayalım dünyanın sonu gelir... düşününce iki insan mutluluk için ilişkiye başlıyor olmalı buradaki mutluluk göreceli tabi herkesin beklentisi farklıdır ama kötü ilişki kötü ilişkidir ve mutluluk vermez e o zaman neden devam etsin hani mutlu olmak için vardı ilişkiler
  entry_channels: anket,ilişkiler
- entry_name: |
    şu an okunan kitap
  entry_id:  93836266
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    dürüst, sadece dürüst olsun yeterli.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    ekşi sözlük dertleşecek insan veritabanı
  entry_id:  93839400
  entry_writer: herkese ederim sikayet
  entry_fav_count: 1
  entry_content: |
    benim derdim yalnızlık. çok iyi dostlarım var, sırtımı yaslayabileceğim, kötü günümde bana destek çıkacak... ancak el ele tutuşup gezebileceğim, yastığa başımı koyduğumda düşleyebileceğim, hayatımı paylaşabileceğim biri yok ve ben bunun eksikliğini çekiyorum. belki şımarıklık dersiniz, daha çok gençsin, bu da dert mi lan diyebilirsiniz. ama ben sevebileceğim, sevilebileceğim birini arıyorum.<br/>24 / erkek / istanbul
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    düşün ki o bunu okuyor
  entry_id:  93810321
  entry_writer: damarlarinizdaki asil kan
  entry_fav_count: 1
  entry_content: |
    gurursuzluk, başkasını suçladığın şeyleri defalarca kere yapmış olmaktır.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    yüksek müsaadenizle ben bi depresyona giriyorum. şuan hayatımda yaptığım yanlışları sorgulama sürecindeyim. <br/><br/>depresyona girmeyi düşünen varsa buyursun gelsin.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    soft seks baharatsız yemektir, hard seks fazla baharatlı yemektir. dipnot beyaz yakalı kadınlar ve avukat kadınlar nedense hard seks tercih eder.
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bir erkegin seni arzuladigini bakisindan anlayabiliyor musun? ısyeri vs resmi bir ortam bile olsa?
  entry_channels: anket,ilişkiler,ekşi-sözlük
---
