...
- entry_name: |
    iyi bayramlar yazan adamı ifşa eden türk kızı
  entry_id:  93816693
  entry_writer: xix
  entry_fav_count: 505
  entry_content: |
    sevgilisi olan adam kızın bütün hikayelerine ifade bırakmış en sonunda da mesaj yazmış. özelin ifşası suçtur ama adam sanki hayır kurumuna kurban bağışı mesajı yazmış gibi aklamaya çalışmayın amk.
...
- entry_name: |
  ...
  entry_id:  93830253
  entry_writer: sallanmayan sandalye
  entry_fav_count: 98
  entry_content: |
    odadan hanıma mesaj atıp laptopu ve atıştırmalık bir şeyler getirmesini istiyorum.
  entry_channels: anket,ilişkiler
- entry_name: |
    mbaye diagne
  entry_id:  93812161
...
- entry_name: |
    kişinin evleneceği insanı ilk gördüğünde anlaması
  entry_id:  93806829
  entry_writer: henrique
  entry_fav_count: 50
  entry_content: |
    yaklaşık 30 defa başıma gelen hadise. ulan diyorum ben bunla evlenirim. sonra benden üç durak önce falan iniyor. bi keresinde de samsun'a giderken terminalde kesin konuşcam demiştim, çorum'da indi. aq senin gibi güzel kızın leblebiyle ne işi olur. ben sana fıstık alacağıdım.
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 40
  entry_content: |
    vagal inhibisyon tehlikesi vardir.<br/><br/>denemeyin kari elinizde kalir valla. aciklayamazsin da<br/><br/>onun yerine daha az riskli olan bogaz sikme fantezisini tercih edebilirsiniz
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    beymende ilk defa parasını hak edeb birşey buldum
  entry_id:  93836435
  entry_writer: pirintiks
  entry_fav_count: 8
  entry_content: |
    ama başlık açamıyorsun. sana verilen paraya, emeğe yazık.
  entry_channels: 
- entry_name: |
...
- entry_name: |
    en zenginlerin bilip diğerlerinin bilmediği şey
  entry_id:  93834741
  entry_writer: humility ftw
  entry_fav_count: 7
  entry_content: |
    pedofil zevklerini teshir edecek adami oldurtebilirsin mesela. ıntihar diyip tasak gecersin tum dunyayla.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    meriç yapmaz bunu. orgylerden gangbanglere koşmuş sevgilisini gerekirse canı çekmiştir diye eliyle götürür, sorun görmez.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    ülkenin yarısından fazlasının kim olduğu konusunda hemfikir olduğu kişidir.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    hah şimdi tamam düzlüğe çıkıyorum deyip yeni bir bela ile uğraşmak.
  entry_channels: anket
- entry_name: |
    instagram'a bakarken kullanılan en popüler cümle
  entry_id:  93808702
  entry_writer: riflessione
  entry_fav_count: 2
  entry_content: |
    aslında tuşlu telefon kullanacaksın...
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    kürt diasporasının almanya ve isveç'ten sonra en etkili olduğu ülkelerden biri norveç olduğu için çok şaşırtıcı gelmeyen görüntüler. kuvvetle muhtemelen soyunma odasındaki takımın içinde kürt asıllı oyuncular vardır.<br/><br/>isveç liginde direkt takımları var. mesela bu ülkelere gittiğinizde kürdistan bayrağı asılmış kebapçı dükkanlarını görürseniz de şaşırmayın. <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    zordur. anlamadı sanarsınız. ama anlıyoruz.<br/><br/>ben seni üzerim<br/>sen daha iyilere layıksın<br/>sorun bende<br/>bağlanamıyorum<br/>ailevi sorunlarım var...<br/><br/>dediğinize anlıyorum.
  entry_channels: anket,ilişkiler
- entry_name: |
