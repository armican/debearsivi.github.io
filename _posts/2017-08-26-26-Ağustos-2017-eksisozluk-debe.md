...
- entry_name: |
    adıyaman'da 9 dil bilen ugandalı gelin
  entry_id:  70406162
  entry_writer: hevesli bardak
  entry_fav_count: 109
  entry_content: |
    adıyamanlı cengiz'in tam bir ortam yılanı olduğunu gösterir. <br/><br/>alışveriş merkezinde hödük gibi bakarak tavladığı kızı facebook'ta evlenmeye razı etmiş. gerçek bir yetenek.
- entry_name: |
...
- entry_name: |
    arda turanın milli takıma geri dönmesi
  entry_id:  70414873
  entry_writer: bahara kadar bekle bandini
  entry_fav_count: 28
  entry_content: |
    yav yeter artık seni görmek istemiyorum,sesini duymak istemiyorum.siktir git ve sonsuza kadar kenarıya çekil.
- entry_name: |
    ousmane dembele
  entry_id:  70415093
...
- entry_name: |
  ...
  entry_fav_count: 24
  entry_content: |
    bir ara şunu okumuştum, gömleğin kollarını kıvırma hareketi, ellerini cebe sokma hareketi, boynunu kaşıma hareketi, saçlarını elleriyle tarama hareketi, gözleri kısarak bakma vs. bunlar kadınları aşık ettiriyor imiş.<br/><br/>beyler, elinize ayağınıza sahip olun.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    isimleri yabancılara fonetik olarak benzer gelebileceği için ozan'la oğuzhan'ı karıştırdığını düşündüğüm, yaşı hafiften ilerlemiş teknik direktör. kampta karşısında ozan'ı görünce ortaya ilginç diyaloglar çıkacak muhtemelen.<br/><br/>- bu ayıbalığını kim getirdi lan buraya, ayrıca ozan nerede?<br/>- hocam o ozan zaten.<br/>- ben bu ozan'ı istemedim ki, beşiktaş'takini istedim.<br/>- iyi de hocam, beşiktaş'ta ozan yok ki :/<br/>- nasıl yok, 10 numara giyen çocuk var ya işte...<br/>- hocam onun adı ozan değil, oğuzhan.<br/>- tamam işte, ozan.<br/>- hayır hocam o ikisi farklı isimler, bakın şöyle yazılıyor. *kağıt üzerinde gösterir*<br/>- yapma yav :|<br/>- :|
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    gramajıyla zam yaptıklarından dolayıdır. aynı fiyata zamanında kolum kadar snickers alıyordunuz, kuçule kuçule bamya oldu kendisi.
- entry_name: |
    bitcoin
  entry_id:  70409497
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    ezik trollük örneği olarak tarihe geçmiş ayardır. <br/>hikaye serin bile değil.
- entry_name: |
    robin van persie
  entry_id:  70402514
...
- entry_name: |
    östersunds fk vs vardar skopje
  entry_id:  70414414
  entry_writer: takeredpill
  entry_fav_count: 1
  entry_content: |
    metalist beşiktaş'ı yendiği sene galatasaray'ı da yenmiştir ve gruptan lider çıkmıştır. gruptan çıkana kadar oynadığı 8 karşılaşma içinde tek golü beşiktaş'tan yemiş tek malubiyetini de beşiktaş'tan almıştır. adamları vardar ve östra bilmem neyle kıyaslamak ağır acizliktir.<br/><br/>google'ye beşiktaş'ın yenildiği adı duyulmamış takımlar yazıp on sene önceki maçı yazmak ayrı acizliktir.
- entry_name: |
    ekşi sözlük iş ağı
  entry_id:  70413304
  ...
  entry_fav_count: 1
  entry_content: |
    izmir 'de kurduğumuz küçük çaplı yapım şirketimizle reklam, tanıtım filmleri çekiyoruz. yeni kurduk şirketi ve an itibariyle şirketlerle görüşme halindeyiz. ihtiyacı olan arkadaşlar buradan iletişime geçebilirler. ayrıca günlük ekipman (drone, kamera vs) kiralıyoruz. <br/><br/>senaryo, metin yazarlığı, sinema, tiyatro eleştirisi gibi alanlarda yardıma ihtiyaç olursa buralardayım.
- entry_name: |
    şu anda çalan şarkı
  entry_id:  70418205
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    kendi günlük rutininin dışına çıkmakla ilgilidir huzur dediğin. <br/><br/>kimsenin seni tanımaması, kendi hayatının seyircisi olmanla ilgilidir bu huzur.<br/><br/>10 gün sonra o sarı ışık, elm sokağı kabusu gibi evimi özledim diye ağlatır adamı.
- entry_name: |
