...
- entry_name: |
  ...
  entry_channels: haber
- entry_name: |
    erkek şiddeti yoktur cahil kadın vardır
  entry_id:  94350706
  entry_writer: and so forth
  entry_fav_count: 86
  entry_content: |
    döven adam cahil değil, döveceğini anlayamayan kadın mı cahil?<br/>bunda da kadın suçlu çıktı ya size bravo.<br/><br/>edit: bravo kardeşim, insanların şiddete eğilimi olduğunu ilk sen gösterdin, elini öpeceğimiz yere seni daha tanımadan etmeden yargıladık. başka önemli bir işimiz de yoktu zaten, keşke entry'lerine bakıp, "dur ya, olamaz, ses n bunu söylemiş olamaz" deseydik. <br/><br/>kimseye saygınız yok. kendinize bile.
  entry_channels: 
- entry_name: |
...
- entry_name: |
    boğazı kesilen bi insana nasıl müdahale edilmeli
  entry_id:  94348489
  entry_writer: monkeyisgonetoheaven
  entry_fav_count: 33
  entry_content: |
    yine her bokun ustası bilirkişiler konuşmuş, bir de "öldü zaten stret" demiş, küsüratlı yüzde vermiş.<br/><br/>damar kesiklerinde basit bir baskıyla hastaneye kadar yetiştirilip kurtarılan hasta sayısı hiç sanıldığı kadar az değildir. tıp ve teknoloji gelişti, artık bacağı kırılan atı kafasından vurmuyorlar.<br/><br/>hızlı müdahale ile mucizeleri gerçekleştirirsiniz, kamerayla bunu kayıt altına alarak değil.
...
- entry_name: |
  ...
  entry_fav_count: 29
  entry_content: |
    okudukça yaşadığım çağdan, içinde bulunduğum hayattan soğuyorum..
...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    <a class="b" href="/?q=emine+bulut">emine bulut</a> cinayeti ile ilgili kan dondurucu <a rel="nofollow noopener" class="url" target="_blank" href="https://twitter.com/srkninci/status/1164706984253431810" title="https://twitter.com/srkninci/status/1164706984253431810">tespitleri</a> olan, konuyu boşanmalardan ötürü erkeklere uygulanan zulme? bağlayıp bu erkeğin her şeyi yapabileceğini ve bunun <a class="b" href="/?q=normal">normal</a> olduğunu iddia eden, bu ülkede yemeğin tuzu az diye öldürülen kadınların varlığından habersiz bir cahil. cahil ve de kalpsiz. üç kuruşluk aklını böyle olaylara yorum yapmak için harcamasa keşke.
...
- entry_name: |
    mungke tengriyin kucudur
  entry_id:  94348683
  entry_writer: edgecrusher
  entry_fav_count: 10
  entry_content: |
    moderasyonun sikinin keyfi için uçurulan yazar.
  entry_channels: ekşi-sözlük
- entry_name: |
    tuba erkol
  entry_id:  94336467
  entry_writer: theshining
  entry_fav_count: 9
  entry_content: |
    “ben annemsiz uyuyamam ki. ben onsuz nasıl yatarım? ne olur doktorlara biraz daha para verin de annemi yaşatsınlar” diyen 9 yaşındaki kızın annesi...
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    ben bahçede hortumla fırçalıyorum, her konuda gericisiniz
  entry_channels: 
- entry_name: |
    _o0o_^ ^_o0o_
  entry_id:  94347909
...
- entry_name: |
  ...
  entry_id:  94349273
  entry_writer: amor gitana
  entry_fav_count: 6
  entry_content: |
    sir apo hunter hocamızın sol bek pozisyonunda bir problem olduğunu fark edip oraya ilaç gibi gelecek genç yetenek <a class="b" href="/?q=caner+erkin">caner erkin</a>'i ilk 11'e koyarak hocalığını konuşturduğu maç olacaktır.
  entry_channels: spor
- entry_name: |
    caner erkin
  entry_id:  94349775
  ...
  entry_fav_count: 4
  entry_content: |
    geldigi ilk sezon sakatliktan ve adriano'nun basarili performansindan dolayi pek oynayamamisti. buna ragmen bizim salak tribunler sampiyonlugu kutladığımız osmanli macinda adriano'dan once caner'i tribunlere çağırmıştı. adam da hakli; hakeme cemkirmek iyi oyun oynamaktan daha kolay. taraftar da nasil olsa yutuyor. tribunler futboldan anlamayinca adrianolar degil canerler el ustunde tutuluyor.
  entry_channels: spor
- entry_name: |
    aldırma gönül'e küfre girer diyen esnaf
  entry_id:  94351880
  entry_writer: 4grammaton
  entry_fav_count: 3
  entry_content: |
    bu hareketiyle tüm islam dünyasının itibarını kurtarmış, dünyadaki tüm kötülüklere son vermiştir. iyi bir mümin olarak prim ve terfi almaya adaydır. <br/><br/>(bkz: <a class="b" href="/?q=bir+sitem+yolla+allah%27a">bir sitem yolla allah'a</a>)
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    orda burda scout ayağına takılan gebeşlerin övdüğü rezil topçu. şu adamın beşiktaş'ta oynuyor olması skandaldır arkadaş. yani şunu söyleyeceğimi hiç düşünmezdim ama q7 ve lens bundan daha iyi lan. evet.
  entry_channels: spor
- entry_name: |
    oğuzhan özyakup
  entry_id:  94353753
  entry_writer: cat or raccoon
  entry_fav_count: 1
  entry_content: |
    göztepe maçının ilk yarısında beşiktaş’ın en istekli ve iyi futbolcularından biri. bir kaç kilit pas denemesi hedefe ulaşamayınca kendini bilmezler tarafından ıslıklanmıştır. ilk yarıda golü aradığı bir şutu direkte patlamıştır. bir grup ıslıkçı taraftar ve kripto gs’li muhabirler olmazsa çocuk oynamayı istiyor aslında.
  entry_channels: spor
- entry_name: |
    kürt düğünü vs ankara düğünü
  entry_id:  94354091
  entry_writer: kuba gibiyim kendi kendime yeti
  entry_fav_count: 1
  entry_content: |
    kürt düğününde damat ölürse erkek kardeşin abisinin yerine geçip damat olma ihtimali yüksektir. <sup class="ab"><a title="(bkz: hahahahaha)" href="/?q=hahahahaha" data-query="hahahahaha">*</a></sup>
  entry_channels: anket
- entry_name: |
    dideral
  entry_id:  94353685
  ...
  entry_fav_count: 1
  entry_content: |
    anksiyeteyi değil anksiyeteye bağlı gelişen taşikardiyi çözer. ayrıca tek başına hipertansiyon tedavisinde çok ekstrem noktalar dışında kullanılmaz.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    her hafta üzerine koyarak devam eden takımım.<br/><br/>ligin ilk haftasında deplasmanda berbat bir futbol sergilemiştik.<br/><br/>bu hafta hem evimizde hem de berbat bir futbol sergiliyoruz.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    e-devlet'e girip adıma düzenlenmiş trafik cezalarına bakıyorum. her seferinde yeni bir tane ile karşılaşıp ulan bunu nerde ve nasıl yedim acaba diye düşünüyorum. dolayısı ile uyumaya fırsat kalmıyor düşünmekten. tavsiye ederim.
  entry_channels: sağlık,otomotiv
- entry_name: |
    yazarların bugün aldıkları kararlar
  entry_id:  94353272
  entry_writer: nigresh
  entry_fav_count: 0
  entry_content: |
    gereksiz yere olmadık şeyleri kafama takıp küçük sorunları büyütmeme kararı aldım. önüme geleni yaşarım olur biter diyorum bundan sonra. zaten hayat planladıklarımız dışında gelişiyor. bir sıkıntı çıkar mı diye kaygılanmak sıkıntı çıktığı anda olur ancak ve ancak ki o da geçicidir. şimdiden olmayan ihtimalleri dert edinmeye ne lüzum var? bugünden itibaren takmıyorum, kurmuyorum!
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    askeri kantin (bkz: <a class="b" href="/?q=bedelli+askerlik">bedelli askerlik</a>)
  entry_channels: anket
---
