...
- entry_name: |
    ilk boşaldığınız yer nereydi ve saat kaçtı
  entry_id:  76544009
  entry_writer: choose and circle
  entry_fav_count: 42
  entry_content: |
    hafta içi işten gelip çocuk yapmayın. <br/>vitamini eksik demir %28 potasyum sıfır olur haberiniz ola yoksa başlık sahibi gibi bir meyveniz olur.
...
- entry_name: |
    sıkmabaş tabirinin çirkinliği
  entry_id:  76531221
  entry_writer: gilbertus albans
  entry_fav_count: 13
  entry_content: |
    tabirin çirkinliği falan tartışılırda buna kutsallık vermek nasıl bir kafanın ürünü anlamak mümkün değil. <br/><br/>özünde örtünmeyi anlarım ama alta bone, üste başörtüsü üstüne tepeye böyle üçgen çatı biçimi verme için iğne ile falan sabitleme (bazıları şekil düzgün olsun diye plastik parça kesip koyuyor) yahu böyle bir örtünme biçiminin çıkışı ülkede taş çatlasa 30-40 senedir ondan önce böyle birşey yoktur. ha benzerleri vardır onlar da modadır örtünme değildir.<br/><br/>doğduğundan beri türban görenler bunu dini birşey sanıyor. türban değil, örtünme dini bir olaydır. türban önce bir moda ardından bir aidiet, saf belirleme biçimidir, buna başkalarının sıkmabaş vs isim verilmesi gayet normaldir, çünkü temsil ettiği iddia edilen dini sembollerle, maneviyet ile alakası yoktur tamamen dünyevi, maddi getirileri olan bir eylemin temsilidir. siz dini maddiyata, dünyevi işlere bulaştırırsanız insanlarda bunu söyleyebilir.<br/><br/>şu an yükselen ve makbul olan bu olduğu için savunanlar ve tercih edenler çoğalıyor, ayrıca getirisi ve aidet belirleme olayı ile ortaya bununla ilgili bir maddi manada orta-üst sınıf çıktı ve parayı sonradan bulan her kesimin yapacağı gibi saçmasapan işlere giriştiler. şu an skinny kot, üstüne body giyip türban takan bir kesim var, ben kapri kot, kısa kollu dar gömlek giyen türbanlı gördüm. bunlar benim zerre umrumda değil, isteyen istediğini giyer lakin bu diğer kültürel, sosyal yozlaşmalardan farklı olarak dini yozlaşmanın izleridir.<br/><br/>ha sonra e oluyor? ramazanda nihat hatipoğlu'nun anlattıkları ile ağlayan arkasından islamın şartlarını, haram-helali, orucu bozan şeyleri soran 30-40 yaşında kadınlar adamlar görüyoruz...
  entry_channels: siyaset,anket,haber,moda
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    farkli entrylerde de ayni konuyu yazdim, burda tekrarlamis olalim. <br/>lutfen, baskanlik seciminin ittifak secimi oldugunu kavrayalim. yani belirleyeceginiz adayin %51 oy almasi gerekiyor, %49 kurtarmiyor. dolayisiyla farkli kesimlere'de hitap etmeniz gerekmekte.<br/>son 30 yildir %30 oy alamamis chp'nin, su katilmamis bir chp'liyi, nasil %51 oy aldirip baskan sectirecegini bana biri aciklasin.<br/><br/>tayyip erdogan bile tek basina oyunun %51 olmama risikini on gorerek mhp, bbp vs ile ittifak yaparken, burda muhharem ince, buyukresan, ilker basbug vb. isimleri zikredenler hangi ruyanin icindeler. iki adim sonrasini gormek bu kadar mi zor.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    keşke pc den anlamayanların kullanımına müsaade edilmese dediğim harika ötesi yazılım. bu gerizekalılar yüzünden sorunluymuş gibi sanılıyor.
  entry_channels: programlama,teknoloji
- entry_name: |
    fifa 18 ekşilig
  entry_id:  76530745
  entry_writer: beyazkobra
  entry_fav_count: 1
  entry_content: |
    ps4 için sezon yaklaşıyor, eşleşmeleri heyecanla bekliyoruz.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    başbakan yardımcısı bekir bozdağ'ın tespiti. <br/><a rel="nofollow noopener" class="url" target="_blank" href="https://twitter.com/bybekirbozdag/status/991304894631088128" title="https://twitter.com/bybekirbozdag/status/991304894631088128">https://twitter.com/…zdag/status/991304894631088128</a> <br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>chp genel başkanı, kazanacağına inansa kendi aday olurdu. belli ki chp genel başkanı kaybedeceği bir seçimde aday olmaktan ya da aday olmak zorunda kalmaktan korkuyor. adaylık cesareti gösteremeyen kılıçdaroğlu,halihazırda hem siyasi kayıptır hem de siyasi kaçaktır.<br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---
  entry_channels: siyaset,anket,haber
- entry_name: |
    ekşi sözlük 2018 dünya kupası tahmin yarışması
  entry_id:  76529520
  entry_writer: bilgisavar
  entry_fav_count: 0
  entry_content: |
    playstation 4 hediye edilecek müthis tahmin yarismasi. <br/>simdi söz fakirlerde. yaz fakir.
  entry_channels: 
- entry_name: |
