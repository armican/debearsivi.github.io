...
- entry_name: |
  ...
  entry_fav_count: 775
  entry_content: |
    (bkz: <a class="b" href="/?q=bir+arkada%c5%9f%c4%b1m+ekol%c3%bcnden+ger%c3%a7ekli%c4%9fi+muallak+entry">bir arkadaşım ekolünden gerçekliği muallak entry</a>) <br/><br/>osmanli alfabesi degil o. yazilisi arap alfabesi, okunusu turkce.
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    bir telefona 13 bin tl veren gerizekalılar
  entry_id:  86849292
  entry_writer: her biji recop wundebahg
  entry_fav_count: 244
  entry_content: |
    aple ve gizlilik diyenin suratına sıçılmaz bile.<br/>ulan kaç kez patladı o götler amlar saçıldı ortaya.<br/>ne mal adamlarsınız amk.
  entry_channels: anket,ekonomi
- entry_name: |
    nişan kıyafeti almadığı için terk edilen erkek
  entry_id:  86874990
  entry_writer: bacakkillarinitarayanadam
  entry_fav_count: 234
  entry_content: |
    ucuz kurtulmuş erkektir.<br/>sevinmelidir.
...
- entry_name: |
  ...
  entry_fav_count: 168
  entry_content: |
    doğrusu <a class="b" href="/?q=yokamina">yokamina</a> dır.
...
- entry_name: |
  ...
  entry_channels: anket,ekonomi
- entry_name: |
    masonluğun kadınlara yasak olmasının sebebi
  entry_id:  86875271
  entry_writer: kisa camel
  entry_fav_count: 68
  entry_content: |
    neden anasına soracak onu anlamadık. insan gibi bir sormuş. hemen ana bacı küfür. moderasyon da bunları görmez.
  entry_channels: siyaset
- entry_name: |
    dr'de 222 tl'ye satılan 4kg'lik dumbell
  entry_id:  86865003
  entry_writer: qualyn
  entry_fav_count: 61
  entry_content: |
    üşenmedim hesapladım 222 tl için 4440 tane demir 5 kuruş gerekli. o da tanesi 2.95 gramdan 13 kg 98 gram ediyor.<br/>bence parayı kaldırmak daha mantıklı.
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    ıssız adaya düşünce yanına alınacak üç tohum
  entry_id:  86865441
  entry_writer: honanim daber
  entry_fav_count: 49
  entry_content: |
    patates<br/>kenevir<br/>nifak
  entry_channels: anket,yeme-içme
- entry_name: |
    güzel olduğumuzu nasıl anlarız
  entry_id:  86881835
...
- entry_name: |
  ...
  entry_fav_count: 37
  entry_content: |
    sırf eşofmana karşı olan tutumuyla gönlümde taht kurmuş bir modacıydı, 85 yaşında vefat etmiştir, allah rahmet eylesin :(<br/><br/>ne demişti reis? <br/>“eşofman giyen bir insan hayatında kontrolü kaybetmiştir!”<br/><br/>(bkz: wer eine jogginghose trägt, hat die kontrolle über sein leben verloren!)
  entry_channels: moda,magazin
- entry_name: |
    30-40 bin liraya alınabilecek 2. el araç
  entry_id:  86877520
  entry_writer: ibrahimhasimi
  entry_fav_count: 37
  entry_content: |
    (bkz: <a class="b" href="/?q=kanzuk+mutlu+musun">kanzuk mutlu musun</a>)
...
- entry_name: |
  ...
  entry_fav_count: 28
  entry_content: |
    dün gece 3 yaşına yaklaşan oğlum ben koltukta yatarken yanıma sokuldu, sımsıkı sarıldı boynuma, "baba ben seni çok seviyorum" deyip öyle bir öptü ki, 3 yıldır yaşadığım yorgunluklar bir hiç oldu gözümde.<br/>evet hayatınız kayar ama ona sahip olunca hayatınızın en büyük neşesinin de yine o olduğunu görürsünüz
  entry_channels: ilişkiler,spoiler
- entry_name: |
    kışın etekli kızlara bakıp ya üşümüyorlar mı demek
  entry_id:  86858246
  entry_writer: sirri
  entry_fav_count: 27
  entry_content: |
    (bkz: <a class="b" href="/?q=nereye+d%c3%b6nersen+d%c3%b6n+g%c3%b6t%c3%bcn+arkada+kal%c4%b1r">nereye dönersen dön götün arkada kalır</a>)<br/><br/>bu özlü sözün ardından açıkta kalan götü kapama çalışmasıdır<br/><br/>hamdi, fuat abiye etekli kızlara bakarken yakalanır. fuat abi de hamdi’nin gözünün içine bakar, (ne bakıyon lan kızlara der gibi). bu bakış üzerine kendisiyle aynı frekansta olmadığını anladığı fuat abiden çekinen hamdi hemen muhabbeti çevirir. <br/>hamdi;<br/>— ben bu halimle donuyorum, üşümüyorlar mı bunlar böyle ? hayret bişi!<br/><br/>fuat abi; <br/><br/>— yaaa , yaaa
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    tanrım!<br/>lütfen beni duy. <br/>öyle yorgunum ki. öyle acınası bir haldeyim ki. herkes yolunu çizdi. ben kayboldum. korkuyorum. yaşamaktan, yalnızlıktan korkuyorum. bana bu günleri özletecek şeyler yaşatma. koca hayat boğazımda bir düğüm sadece, yutkunamıyorum. gözyaşımın geçtiği yerler üşüyor. anne diyorum saçlarımı okşa da geçsin her şey. ellerin annemin elleri oluverse; 'kapat gözlerini uyu, geçti hepsi, yeni güne merhaba de' dese. <br/>tanrım! <br/>lütfen beni duy.
