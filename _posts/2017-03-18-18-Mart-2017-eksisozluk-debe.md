...
- entry_name: |
    17 mart 2017 tsk'da kemalist kalkışma soruşturması
  entry_id:  66898793
  entry_writer: st stern
  entry_fav_count: 337
  entry_content: |
    (bkz: <a class="b" href="/?q=l%c3%bctfen+daha+%c3%a7ok+ma%c4%9fduriyet+yarat%c4%b1r+m%c4%b1s%c4%b1n%c4%b1z">lütfen daha çok mağduriyet yaratır mısınız</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 215
  entry_content: |
    insan hakları suçudur.<br/><br/>kahvaltı etmek için kafeden içeri girdim. camekanlı alanda oturup kahvaltı edecektim ki fosur fosur sigara içildiğini gördüm. "burada sigara mı içiriyorsunuz?" dedim. hazırlıksız yakalandı ve "sizi arkadaki bölüme alalım" dedi. bir gittim mutfağın hemen yanı ve leş gibi yağ kokuyor.<br/><br/>"pardon ben sigara kullanmadığım için mi buraya koyuluyorum?" dedim. anlattı da anlattı saçma sapan savunmalarını.<br/><br/>"peki, önce yemeğimi bir güzel yiyeceğim sonra da şikayet edeceğim" dedim. tam da öyle yapıyorum şu anda. bitirir bitirmez şikayet hattını arayacağım.<br/><br/>sigara içilmesine asla karşı değilim. mesela dev bacaları olan kocaman fanuslar caddelere konulabilir ve sigara içenler kendilerini istedikleri kadar zehirleyip kokutabilirler. onlar sigara içiyor ve çoğunluk diye ben ikinci sınıf vatandaş muamelesi görecek değilim. dünyaya sigarasız gelen benim. eğer sigara da bir organ olarak gelse idi anlaşılır bir durumdu. <br/><br/>devlet denetimlerini artırsın ve bu işletmeleri ağır cezalara tabi tutsun umurumda değil. ya da mutfakta içirsinler.<br/><br/>edit: memleket "hep beni mi görüyorsun x de, y de yapıyor" diyen kafalardan dolayı bok içinde. sigara içilen taksiye binmem. şoför içerse uyarır söndürmez ise iner şikayet ederim. yapmadığım şey değil.<br/><br/>edit: aleni şekilde insan sağlığına zararlı olan, hele de filtresiz olması nedeniyle içmeyene zararı çok daha fazla olan bir şeyi kendi keyfiniz için saçma sapan argümanlarla savunup x'in y'nin daha zararlı oluşunu referans gösteriyorsunuz. senin iğrenç sigara dumanın olmasa, hayattaki zararlı şeylerden bir tanesi eksik olurdu hiç olmazsa. kendin de biliyorsun başkasına zarar verdiğini ama bununla yüzleşmek işine gelmiyor. sonra da adaletsizlikten yakınıyorsun. ikiyüzlüsün.<br/><br/>edit: sigarasını çekerken hayata isyan eden instagram fotoları için yaşayan solcu yancısı yandan yemiş çakma can yücel'ler rahatsız.
- entry_name: |
...
- entry_name: |
    3.havalimanının aslında uçak fabrikası olması
  entry_id:  66900318
  entry_writer: aslagelmeyecektelefonubekleyenadam
  entry_fav_count: 138
  entry_content: |
    <a class="b" href="/?q=konya%27daki+%c3%a7ok+gizli+uzay+istasyonu">konya'daki çok gizli uzay istasyonu</a> ile koordineli çalışması beklenmektedir.<br/><br/>edit : <a class="b" href="/?q=%c5%9fehit+aileleri+derne%c4%9fi%27nin+hay%c4%b1r+%c3%a7a%c4%9fr%c4%b1s%c4%b1">şehit aileleri derneği'nin hayır çağrısı</a>na kulak verip, destek olma zamanıdır.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 39
  entry_content: |
    maç sonu tribün önünde o "ben bilmiyorum siz üçlü çektirin" diye misafirliğe gitmiş uslu çocukların utangaçlığı tüm taraftarı mest etti.<br/><br/>kasılma yok,artistlik yok,yürüyüş değişmesi yok,tip tip mimikler yok büyüksün hocam umarım uzun yıllar beşiktaş'ın başında kalırsın.
- entry_name: |
    emma watson
  entry_id:  66894437
  ...
  entry_fav_count: 39
  entry_content: |
    çocukluğunu biliyorum lan ben bunun. o düğme burnuyla, ufacık ağzıyla neredeyse kolu kadar asayı çekip "alahomora" deyişi dün gibi aklımda. adeta elimde büyüdü kerata. büyümüş de genç kız olmuş.<br/><br/>çıkıp diyorsunuz ya şöyle güzel hatun böyle seksi hatun yok meme ucu şöyle yok kalçası böyle falan diye, işte o anlarda ben kendimi kız babası gibi müşkül hissediyorum. demeyin olm öyle şeyler, ayıptır mahallemizin kızı sonuçta. <br/><br/>öyle kız hakkında seksli meksli konuşup benim asabımı bozmayın. niyetiniz ciddiyse alın ananızı, babanızı, çikolatanızı ve kolonyanızı gelin adam gibi isteyin. değilse basın gidin katil etmeyin beni, alayınızın canı bi avada kedavra'ya bakar!
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    geçenlerde internetten kitap sipariş etmiştim. hediye paketi seçeneğini seçip bir de kendime not yazdım. bugün geldi kitaplarım açtım notu gördüm mutlu oldum. o da yetmezmiş gibi "hediye" notumu instagramda paylaştım. tam bir yalnızım.
- entry_name: |
...
- entry_name: |
    trafik polisinin başbakanın arabasını çekmesi
  entry_id:  66910117
  entry_writer: hadi git
  entry_fav_count: 7
  entry_content: |
    başlığa asla türkiye'de olmamıştır diye tıklamak ne berbat bir duygu aq ya:(
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    adı üstünde <a class="b" href="/?q=insan">insan</a>dır. o kediciklerin bacaklarıma sürünmesi bile tüm stresimi alıyor, sevdikçe de kendimi pamuk gibi hissediyorum. iğrenmek ne demek? çoğumuzdan temizdirler üstelik.
- entry_name: |
    dick advocaat
  entry_id:  66911996
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    (bkz: <a class="b" href="/?q=a%c5%9fk%c4%b1m+%c3%a7%c4%b1kar+%c5%9funu+ezan+okunuyor">aşkım çıkar şunu ezan okunuyor</a>)
- entry_name: |
    ilk alınan kaset
  entry_id:  66894277
...
- entry_name: |
    dedelerim osmanlı deyip sevgilileri kameraya almak
  entry_id:  66900397
  entry_writer: mockdeath
  entry_fav_count: 2
  entry_content: |
    sanki ışınlanmış geriye nasıl döneceğini bilmiyor gibi ,<br/>zaman makinesi icat olsa şunları geriye postalasak , taş devri uygun olabili.<br/><br/>kaptan mağara adamının sayıklaması.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=r%c3%bc%c5%9fvet">rüşvet</a>)<br/>(bkz: <a class="b" href="/?q=her+i%c5%9fe+hile+katmak">her işe hile katmak</a>)<br/>(bkz: <a class="b" href="/?q=malzemeden+%c3%a7almak">malzemeden çalmak</a>)<br/>(bkz: <a class="b" href="/?q=her+i%c5%9fi+torpille+halletmek">her işi torpille halletmek</a>)<br/>(bkz: <a class="b" href="/?q=serbest+%c3%a7a%c4%9fr%c4%b1%c5%9f%c4%b1m">serbest çağrışım</a>)<br/><br/>edi büdü.<br/>çin seddi yedi harikadan biri olmamıştır.<br/>zira çin seddinin sanatsal olarak bir değeri yoktur.<br/>işte bu narsist tavırlar yüzünden bu hale geldiniz.
---
