...
- entry_name: |
    soylu'yu protesto edenler ekrem gibi pontuslu
  entry_id:  90911445
  entry_writer: deseptikonlarin megatron
  entry_fav_count: 585
  entry_content: |
    (bkz: <a class="b" href="/?q=recep+tayyip+erdo%c4%9fan+iktidar%c4%b1+nas%c4%b1l+kaybetti">recep tayyip erdoğan iktidarı nasıl kaybetti</a>) <br/><br/>hepsinin tarihe geçtiği sözler ve olaylar dizisi.
...
- entry_name: |
    dolar 5.70'e düşünce sus pus olan eksici
  entry_id:  90904867
  entry_writer: kacamak
  entry_fav_count: 354
  entry_content: |
    yeter ki düşsün, zarar edelim önemli değil! ekonomi düzelsin yeter.
...
- entry_name: |
    ideal seks süresi
  entry_id:  90896659
  entry_writer: degismeyenperde
  entry_fav_count: 231
  entry_content: |
    burda 3 saat reelde 2 dakika
...
- entry_name: |
  ...
  entry_channels: siyaset
- entry_name: |
    5 haziran 2019 ekrem imamoğlu'nun trabzon mitingi
  entry_id:  90911727
  entry_writer: henrikissenger
  entry_fav_count: 204
  entry_content: |
    imamoğlu’nun ekibinin strateji dehası olduğunu gösteren mitingdir. adam bayramda memleketlerine giden trabzonlu, rizeli, giresunlu seçmeni memleketlerine giderek, ayaklarına giderek kazanmaya çalışıyor. muhtemelen dönüp oy kullanmaları için de ikna etmeye çalışacak. istanbul yarışını istanbul dışında da sürdürüyor. hattı müdafaha yoktur sathı müdafaha vardır ve o satıh bütün vatandır anlayışı olduğunu gösteriyor. çok enteresan ve ilginç hamleler bunlar.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  90900425
  entry_writer: kemik gozluklu minyon
  entry_fav_count: 57
  entry_content: |
    (bkz: <a class="b" href="/?q=kibrit%c3%a7i+k%c4%b1z">kibritçi kız</a>) <br/>çocukluğumun travması.
...
- entry_name: |
  ...
  entry_fav_count: 32
  entry_content: |
    içkimiz kumarımız yok. bi zeromuz var. napppakkk kilo mu alalım. <br/><br/>akademisyen hocalarımızdan birisiyle diyalogumuz.<br/><br/>- hocam içebileceğimiz sağlıklı hiç bir şey yok. bak yemeği aldık. ayran içsek uyku yapacak. ne yapacağız .<br/><br/>- su iç. <br/><br/>- saygılar hocam.
...
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    bence yalan haber. "faşizmin dünyadaki en büyük sembollerinden olan kişiyi burada olumlayamazsın" cümlesini türkiye'de kurabilecek kaç kişi var?
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    (bkz: <a class="b" href="/?q=sandalet">sandalet</a>) <br/>baslik sahibi icin de (bkz: <a class="b" href="/?q=ilgi+orospusu">ilgi orospusu</a>)
  entry_channels: moda
- entry_name: |
    black mirror
  entry_id:  90904529
