...
- entry_name: |
  ...
  entry_id:  75099354
  entry_writer: amiyane
  entry_fav_count: 25
  entry_content: |
    kaybedenler kulübü yolda, özenilen hayatları yaşadıkları düşünülen iki kişinin aslında nasıl bir trajedi içinde olduklarını anlatıyor. şaka lan şaka yine yarrag gibi bi film olmuş.
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  75099672
  entry_writer: kerem1249
  entry_fav_count: 10
  entry_content: |
    laique -&gt; laiklik
- entry_name: |
    türk kızlarının oral sekste kötü olması
  entry_id:  75119626
  entry_writer: forumdayim
  entry_fav_count: 5
  entry_content: |
    “iyisine denk gelmemişsin.” denilecek yazar beyanıdır.<br/>kimisi var adını unutturur insana
- entry_name: |
    mehmet ekici
  entry_id:  75118034
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    "barok,rokoko-ancient romans-urbanization-coin-lingua-greeks-berlin wall-ghost rider-computer games- etc.<br/>....<br/>her konudan , yds gibi "nasıl tuzaga düşürürüm" amacı taşımayan , sadece bilgi ölçmeye çalışan beğendiğim sınav.<br/><br/>süre de gayet iyi.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    yıldızların yaşından, dünyanın yaşından, büyük patlamadan haberi olmayan dinler değil de ateizm çökmüş. yersen tabi.
- entry_name: |
    uber
  entry_id:  75119174
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    içinde bulunduğu her pozisyon galatasaray kalesi için tehlike olan defans oyuncusu.
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  75116482
  entry_writer: diamonyumfosfat
  entry_fav_count: 0
  entry_content: |
    - güzel ve şekilli bir burnun var.<br/>+ sağol <br/>- burnu güzel olanın aleti de güzel olurmuş.<br/>+ te te teş teşekkür ederim.
---
