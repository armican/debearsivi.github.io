...
- entry_name: |
  ...
  entry_id:  73568505
  entry_writer: kusura baklava
  entry_fav_count: 3
  entry_content: |
    bugün fpp duo girdim, random adam atsın anlaşırız dedim. <br/><br/>birbirimizle hiç konuşmadan med, boost, silah değişimi yaptık, silahlarımızdaki eksikleri tamamladık, düşünce kaldırdık, map'ten yer işaretleyerek anlaştık. drop kovalarken birbirimizi kolladık, binalara özel harekat timi gibi girdik ve sonunda tek bir kelime dahi konuşmadan birinci olduk, ikimiz de yaşıyorduk son adamı indirdiğimizde.<br/><br/>bu kahramanın oyun içindeki adı ise "ha4ikooo" idi, seni kalbime yazdım yiğidim<sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>. umarım bir kez daha karşılaşırız<sup class="ab"><a title="(bkz: kips)" href="/?q=kips" data-query="kips">*</a></sup>
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    fişsiz değişim yapan diğer markaların olduğunu görmemizi sağlayam söylenti.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    dost<br/><br/>bir gece habersiz bize gel <br/>merdivenler gıcırdamasın <br/>öyle yorgunum ki hiç sorma <br/>sen halimden anlarsın <br/>sabahlara kadar oturup konuşalım <br/>kimse duymasın <br/>mavi bir gökyüzümüz olsun kanatlarımız <br/>dokunarak uçalım. <br/><br/>insanlardan buz gibi soğudum,<br/>işte yalnız sen varsın <br/>öyle halsizim ki hiç sorma <br/>anlarsın.<br/>cahit külebi
- entry_name: |
    trump bana dönmediği sürece ben ona dönmem
  entry_id:  73567243
  entry_writer: datte bayo
  entry_fav_count: 0
  entry_content: |
    hiç takmadığım, geberseler umrumda olmayacak, bir adolfun tırnağı bile olamayacak iki heriften birinin diğeri için kendi çöplüğündeki kendi medyaları aracılığıyla ileri geri ötmesi.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    sevgili veritaban sakinleri,<br/><br/>bana gelecekten bir ses lazim. <br/><br/>23 yasinda yeni mezun sayilir bir muhendisim. kadinim. isim gucum yerinde, sadece daha iyisi ne olabiliri merak etmekteyim, biraz yol ayrimi gibi. iliskiler diyari ise bok cukuru benim icin.<br/><br/>kiminle konusmak istiyorum? 10 yil sonrasi ile. yani mumkunse 30 ustu kadin muhendislerden konusmak istemekteyim. evli ve bekar keske iki kisi ile konusabilsem, ne mutlu olurum.<br/><br/>konumuz kariyer ve evlilik yapmak/yapmamak karari uzerine olacak. <br/><br/>isbu entry girildi ve uyunuldu. musait bir zaman icin randevu istiyorum sizlerden sadece suan.<br/><br/>dipnot:avukat versiyonumu bir ust entryde gordum. tesadufun boylesi :)) ustteki yazara selam olsun.
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  73570352
  entry_writer: this one is called the drapery falls
  entry_fav_count: 0
  entry_content: |
    sigarasızlıktan parmaklarını kemirmeye başlayan giannakopoulos maçın en eğlenceli ögesi bence. <br/><br/>gerçi devre arasında liseli ergen gibi salonun önüne koşmuştur cuarasını tüttürmek için ahah.
---
