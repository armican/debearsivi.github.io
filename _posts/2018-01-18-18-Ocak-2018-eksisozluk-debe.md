...
- entry_name: |
  ...
  entry_fav_count: 37
  entry_content: |
    inditex türkiye'de (zara'nın ve bershka vs. gibi yan markaların sahibi olan grup) yönetici olan bir tanıdığıma fatih altaylı'nın "zara türkiye'den gidiyor" iddiasını sordum.<br/><br/>iddianın gülünç olduğunu, türkiye'den çıkmak bir yana bir çok yeni mağaza açmaya hazırlandıklarını, yazıdaki bilgilerin gerçeği yansıtmadığı ile ilgili olarak ispanya'dan da açıklama gelebileceğini söyledi.<br/><br/>tanım: sıklıkla güncellenen hoş ve görece hesaplı bir ürün gamına sahip giyim perakendecisi.<br/><br/>edit: aşağıda bir arkadaş bir dönem zara'nın ortağı olduğunu ve hisselerini 2017 içinde sattığını söylemiş. <a rel="nofollow noopener" class="url" target="_blank" href="https://m.zara.com/tr/tr/z-shirket-l1391.html" title="https://m.zara.com/tr/tr/z-shirket-l1391.html">şu linkten</a> görülebileceği üzere zara türkiye'nin yüzde 97'si inditex'e, yüzde 3'ü ise zara holding'e ait ve bu yapı 31.01.2015'ten bu yana değişmemiş. belki arkadaş "sivas zara kebap evi"ndeki hisselerini satıp yanlışlıkla bu başlık altına yazmış olabilir.<br/><br/>edit2: "üst düzey yönetici" ifadesini "yönetici" olarak değiştirdim. konuştuğum arkadaşım inditex türkiye yapılanmasında yk üyesi, genel müdür ya da genel müdür yardımcısı değil. dolayısıyla sadece kendi bilgisi dahilinde yorum yaptı. insanları yanıltmak istemem.
- entry_name: |
    ohal'in 3 ay daha uzatılması benimsendi
  entry_id:  73572601
  entry_writer: el zikembe
  entry_fav_count: 33
  entry_content: |
    doğrudur. kendi kendime khk çıkartmaya bile başladım.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 28
  entry_content: |
    bu oluşumların hepsi için istisnasız kandırılmaya çalışıldım. <br/><br/>ilk başlarda vaadlerin ne kadar gerçek dışı ve mesnetsiz olduğunu anlatmaya çalışırken <sup class="ab"><a title="(bkz: gerizekalı olduklarını)" href="/?q=gerizekal%c4%b1+olduklar%c4%b1n%c4%b1" data-query="gerizekalı olduklarını">*</a></sup>, sonraları "inanmak isteyen ama çekinen" bir role bürünerek kendimce eğlendim. <br/><br/>ve her seferinde facebook sayfalarına üye olup, yorumları tek tek okudum. evine haciz geleceği için ağlayan, yalvaran, küçücük bir umut arayan insanları gördükçe zevkten dört köşe oldum. göz yaşlarını sarap diye içtim. <br/><br/>ve şimdi yine oluyor. <a class="b" href="/?q=%c3%a7iftlik+bank">çiftlik bank</a> facebook grubunda, "hesabımı satıyorum" diyenlere mesaj atıp ciddi bir alıcı edasıyla neden sattıklarını soruyorum, hepsi istisnasız "zaman ayıramıyorum" diyor. pazarlığı tam alacakmış gibi yapıp vazgeçerek sonlandırıyorum. sonra da ağlamalarını okuyup yine zevkten dört köşe oluyorum. <br/><br/>çünkü hastalıklıyım. başka bir açıklaması olamaz. beni kazıklamaya çalışan, gözümün içine baka baka yalan söyleyen itin, hakettiği karşılığı aldığını gözlerimle görmek istiyorum. sanırım bu konuda yıllardır üzerimde hissettiğim sosyopolitik konulardan kaynaklı bir açlığım var...
- entry_name: |
...
- entry_name: |
    kara kedilerin uğursuzluk getirdiği inancı
  entry_id:  73560087
  entry_writer: wartenberg
  entry_fav_count: 10
  entry_content: |
    iki tane kara kedi beslemiş biri olarak çöp olarak değerlendirdiğim inanç. evimize mutluluk, neşe getirdiler. ayrıca ikisi de büyük kazalar atlatıp resmen ölümden döndüler, hiç de şanssız uğursuz değildiler yani.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    kaliteli yalnızlık yaşayın.<br/>yani sevgilin yoktur ama yedekte 40 adam vardır mesajlaştığın işte onu yapma.<br/>bir yerlerde o 40 adamdan 1inin ilgisine sevgisine ihtiyacı olan bir kadın var olabilir. millettin hakkını yemeyin aklıyla , kalbiyle de oynamayın.<br/>kısacası fingirdemeyin. sonra bu erkek denen organızmalar aynı fingirdekliği bizden de bekliyor. bulamayınca yallah çekiyor ki hiç sevmem.
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  73571803
  entry_writer: infinitepi
  entry_fav_count: 3
  entry_content: |
    bunu küçümseyenlerin evlerine allah ateşler salsın.<br/>karın ağrısı, kas ağrısı, kemik ağrısı, eklem ağrısı hepsi bir araya toplanıyor. acıdan uyuduğun uykudan uyanmak ne demek bilmeyenler abartı olarak görsün, dua etsinler başlarına bin beteri gelmesin.<br/>psikolojik etkilerinden hiç bahsetmiyorum, her ayın 1 haftası normal davranmaya çalışarak geçiyor.<br/>bütün kadınlar bu ağrıyı çekmiyor, sebepler çeşitli, fizyolojik yapı, üşütme, genetik vs. ama biraz anlayış...
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    yerli ve milli değerlerden uzak kaldığı için başarısız olan üniversite.
- entry_name: |
    şu anda çalan şarkı
  entry_id:  73556178
  ...
  entry_fav_count: 0
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="http://https//youtu.be/ee3splvregu" title="http://https//youtu.be/ee3splvregu">sagopa kajmer - bir kulaç daha atsam karadayım</a><br/><br/>"bir kulaç daha atsam karadayım, ben hiç böyle bir denize dalmadım."
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    niyetinin ne olduğu 10 km öteden belli o <a class="b" href="/?q=keva%c5%9fe">kevaşe</a>nin koyduğu her sikik fotoyu beğenmek zorunda mısın? takip kısmına düşüyorsun, sadece ben değil herkes görüyor. yapma, kendini küçültme.
---
