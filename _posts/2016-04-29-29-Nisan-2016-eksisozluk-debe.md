...
- entry_name: |
  ...
  entry_content: |
    ...
    - senin kuracağın hükümetin de, yöneteceğin ülkenin de, yapacağın anayasanın da taa....<br/><br/>öhm okumayacak dimi lan bak?
...
- entry_name: |
  ...
  entry_writer: ktrci
- entry_name: |
    laikliğin referanduma gitmesinden korkan kemalist
  entry_id: 60197435
  entry_content: |
  ...
  entry_writer: theli
- entry_name: |
    çirkin olmasına rağmen sevgilisi olan erkek
  entry_id: 60195049
  entry_content: |
