...
- entry_name: |
  ...
  entry_fav_count: 31
  entry_content: |
    çok dindarsınız ya, liseyi bile bitirmeden, kayrılarak, torpille girdiğiniz işlerden haram para yemekten kurtuldunuz :)
  entry_channels: haber
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  94574092
  entry_writer: yufinin
  entry_fav_count: 14
  entry_content: |
    neden kürtlerin diğer ırklara göre öne çıkan özellikleri diyince ırkçı olunuyor ben onu anlamıyorum. almanların öne çıkan özellikleri denilince akla sarı saç mavi göz kaba ses tonu geliyor mesela. norveçli diyince uzun boy sarı saç renkli göz örneğin. <br/>cevabı siyah saç siyah göz ve hafif esmerlik olan özelliklerdir.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    buraya entry giren yazarlar mı yoksa mesajınız var yeşili başlığına girenler mi daha ezik acaba diye düşündüren veritabanı. çaylaklara bi yeşil kadar yakııdsjkjkadsasj, allahın beyinsizleri.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
