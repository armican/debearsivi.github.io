...
- entry_name: |
  ...
  entry_fav_count: 148
  entry_content: |
    1 temmuz'da açılması gereken başlığın erken açılmasıdır, tabi eğitim öğretim hayatı boyunca bir halt öğrenemeyenlerin bunu da bilmemesi normaldir.<br/><br/>edit:başlığı açan piç kurusu yediği laflardan sonra kaçmış tabii ki!
  entry_channels: haber,eğitim
- entry_name: |
  ...
  entry_fav_count: 139
  entry_content: |
    odtülülerin geceleri içip içip başlığına yazdığı okul.<sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    ikili koltuğa uzanmış keyif yapıyorum ama gözüme 3lu koltuğu kestirdim.<br/>kalkmak için yeterli kuvvet ve enerjiyi bulunca biraz da orada camış gibi yatacağım.
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    söz konusu benzetmeyi yapmak için cinsel açlık yaşamaya gerek yok, bal gibi de andırıyor zira.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    kimsenin beklediği gibi bir yayın olmayacak. ekrem nakavt edemeyecek. binali bir cümleyi 3dk'da bitiremeyecek. sığ bir yayın olacak.
  entry_channels: siyaset,tv,haber
- entry_name: |
    ekşi itiraf
  entry_id:  91289646
