...
- entry_name: |
  ...
  entry_fav_count: 149
  entry_content: |
    çinden geldikten 10 gün sonra ateşlenip özel bir hastaneye gitmem üzerine 3264 tl corona test ücreti çıkarttıkları için test yaptırmamıştım ve beni öylece saldılar. siz gerçekten virüs gelmiş olsa ölümler gerçekleşmeden fark edileceğine inanıyor musunuz??
...
- entry_name: |
    uğruna ölünecek kişi
  entry_id:  102508687
  entry_writer: sultanahmetli
  entry_fav_count: 44
  entry_content: |
    bir ölü hiç kimse için hiçbir şey yapamaz.<br/>bu yüzden sevdiklerim için yaşamayı tercih ederim.<br/>güdük ortadoğu söylemidir "senin için ölürüm"<br/>ölmeyin yaşayın,yaşatın.
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    altay-jailson ve tolga’yı kanatta oynatma sevdası yüzünden daha derbiye çıkmadan şampiyonluk şansımızın bitmesine neden olmuş hoca. fb-gs skoru ne olursa olsun ersun hoca’nın istifa etmesi lazım.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    eğer bir kadın güzelse yolda yürümesi bile güzel gelir. yok ama çirkinse atomu parçalasa dönüp kimse bakmaz.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    uzaylılar dünyaya saldırsa "sigaranın alevini gördüler de öyle buldular bizi." diyecek seviyede kafayı sigarayla bozmuşların yeni yasağı.<br/><br/>bunların bi tık üstü "perdeler kirleniyor, içmeyin şunu evde" sloganıyla hayatımızın merkezinde yer alan annelerimiz, eşlerimiz. <br/><br/>yakında, yolda sigara içene terlik fırlatırsınız siz.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    çok uzun azıcık paçalardan aldırsın.
  entry_channels: ilişkiler
- entry_name: |
    serdar aziz
  entry_id:  102508944
