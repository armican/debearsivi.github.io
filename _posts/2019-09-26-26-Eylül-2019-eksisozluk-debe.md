...
- entry_name: |
    alkol firmalarını twitter'dan takibe yasak gelmesi
  entry_id:  95799847
  entry_writer: insanfaktoru
  entry_fav_count: 19
  entry_content: |
    siyanürle altın çıkarılarak toprak ve suyun bir daha iflah olmayacak şekilde tahrip ettirilmesinin olağan kabul edildiği ülkede alkolün zehir olduğu iddiasıyla savunulan özel hayat ve kişi hakları saldırısıdır.
...
- entry_name: |
    internette pdf'i var terör örgütü
  entry_id:  95800576
  entry_writer: gabr
  entry_fav_count: 4
  entry_content: |
    eserlerin pdflerinin sadece illegal yerlerden, bedava temin edinildiğini sananları gösteren başlık.
  entry_channels: edebiyat,eğitim
- entry_name: |
    hala facebook'ta paylaşım yapan insan
  entry_id:  95769657
  entry_writer: applied57
  entry_fav_count: 4
  entry_content: |
    büyük bir ihtimal aynı paylaşımı instagramda da yapmıştır.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    soru: bir erkeğin rahatsız olduğu bi giyimi neden inadına giyiyosnz ?<br/>ya da neyi giydiğinizi takmadığında neden deliriyosnz ?<br/><br/>cevap: soru sormadan önce en basit yazım kurallarını öğren önce. cahil bok.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
