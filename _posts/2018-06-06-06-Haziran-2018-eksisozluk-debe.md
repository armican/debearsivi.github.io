...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    (bkz: <a class="b" href="/?q=lara+croft">lara croft</a>)
...
- entry_name: |
  ...
  entry_channels: siyaset
- entry_name: |
    rusya'dan sığır eti ithal edilecek
  entry_id:  77754885
  entry_writer: geberik83
  entry_fav_count: 2
  entry_content: |
    tum dunyada ulkeler arasi gumruk sozlesmesinde su madde yazar:ulkenin ekonomik cikarlarina ters dusmedikce. ..<br/>finans sektoru yabanci teknolojimiz yok.tarim patatesi disardan alacak halde.gumruk kapilari disardan gelen bakliyat konteynirlariyla dolu.memleketi bu hale getirdigimize gore sigir cok burda gerek yok ithalata
  entry_channels: 
- entry_name: |
    kıskanılan insanlar
  entry_id:  77727459
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    24 haziran 2018'de ortaya çıkacak dip dalga
  entry_id:  77749084
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    aleyna tilki'nin yalnız çiçek klibi
  entry_id:  77755051
  entry_writer: baskasindanbaska
  entry_fav_count: 0
  entry_content: |
    klibin mesajını anlamayanları anlamıyorum. çok basit;<br/><br/>lolita, masum, çocuk, oyuncak, jartiyer, süt, kaçırma, zorlama, pembe, küçük, bisiklet, şiddet vs s.<br/><br/>en baştan beri bu kızı bir meta gibi pazarlıyorlar. yetişkinlere sarılan bir lolita imajı. bir önceki klibine de dönüp teyit edebilirsiniz. mutlaka görüntülerin üzerine medyada sürekli yer alan “daha 17 yaşında” haberlerini de sos olarak ekleyin. o zaman daha iyi anlarsınız.<br/><br/>iğrençsiniz ibneler.
  entry_channels: 
- entry_name: |
    abdülkadir ömür
  entry_id:  77755324
