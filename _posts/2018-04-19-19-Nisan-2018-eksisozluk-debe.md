...
- entry_name: |
    ilçe kongresinden dönen erdoğan'ın araç konvoyu
  entry_id:  76113347
  entry_writer: oci
  entry_fav_count: 1040
  entry_content: |
    araçlar hareket etmese, onun yerine alttan şehir kaydırılsa daha tasarruflu olabilecek konvoy.
...
- entry_name: |
    firari fetöcülerin meral akşener'i desteklemesi
  entry_id:  76119399
  entry_writer: genckartal301
  entry_fav_count: 389
  entry_content: |
    küfür edeceğim şimdi olmayacak. <br/><br/>ulan fetönün mağdur ettiği komutanların iyi parti saflarında fetullahçılara ve onun işbirlikçilerine savaş açtığını neden söylemiyorsunuz?<br/><br/>fetö ile akşener'i ilişkilendirmeye çalışmak namus yoksunluğuna delalettir. <br/><br/>trollük için para için şerefini satanlara işarettir.
...
- entry_name: |
    24 haziran 2018 iyi parti'nin seçimlere girememesi
  entry_id:  76125769
  entry_writer: zifir nikotin karbon
  entry_fav_count: 216
  entry_content: |
    artık oyum iyi partiye. böyle mağduriyet olamaz. işimi gücümü bırakır meral akşener için gece gündüz çalışacağım. sokak sokak dolaşıp gönüllü oy isteyeceğim. benim gibi bir adamı bile fanatik partici yaptınız. bravo türk siyasetine.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 150
  entry_content: |
    30 yıllık çocukluk arkadaşım yaptı bunu bana ya. hayır ikimiz de hetero erkeğiz diyorum yok ben çok sıkıldım artık diyor. ayıptır ya yılların dostluğu var.
...
- entry_name: |
  ...
  entry_fav_count: 50
  entry_content: |
    basligi acan "sozelci" arkadasi axe deodorant paklar bence. kesirler ucuncu sinif konusu halbuki.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    (bkz: <a class="b" href="/?q=mehmet+ayd%c4%b1n">mehmet aydın</a>)<br/><br/>ikna gücü yüksek.<br/><br/>slogan da hazır: <a class="b" href="/?q=seni+sevdim+be+tosunum">seni sevdim be tosunum</a>
  entry_channels: siyaset,anket
- entry_name: |
    la casa de papel
  entry_id:  76119767
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    maçı izledikçe diyorum ki iyi ki tolga ciğerci denen adam fener maçında o golü kaçırmış. böyle bir futbolcunun golü ile makus talihimiz değişsin istemezdim. bu ebedi rakip fenerbahçe'ye bile saygısızlık. adamlar kaç senelik seriyi bu adam bozsun diye mi yaptık diye dava açsalar hakim haklı bulur.
  entry_channels: spor
- entry_name: |
    cemal safi
  entry_id:  76110213
  ...
  entry_fav_count: 5
  entry_content: |
    benim için şiir dünyasında 2 unutulmaz isim vardır. biri abdurrahim karakoç, diğeri cemal safi. üstadı görmek, tanımak o kadar çok isterdim ki. muhteşem bir insandı ve muhteşem bir şairdir. umarım <a class="b" href="/?q=kainat%c4%b1n+ulu+imparatoru">kainatın ulu imparatoru</a> ona rahmetiyle, merhametiyle, sevgisiyle muamele eder. <a class="b" href="/?q=abdurrahim+karako%c3%a7">abdurrahim karakoç</a>'a selam söyle üstad, sen de gittikten sonra kim bizi teselli edecek ki.<br/><br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>nasıl ağıt yakalım dinlerken 'mihriban'ı<br/>derdimizi dökecek kafiye mi bıraktın?<br/>hece veznine âşık ettiğin garibanı<br/>teselli etsin diye safi'ye mi bıraktın<br/>--- <a class="b" href="/?q=spoiler">spoiler</a> --- <br/><br/>cemal safi'ye dair bir kaç video; <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=cwwGQRg_N1k" title="https://www.youtube.com/watch?v=cwwGQRg_N1k">yeni şeyler söylemek lazım 1. bölüm</a>, <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=1IMom0Xm0nM" title="https://www.youtube.com/watch?v=1IMom0Xm0nM">şiir ve şair cemal safi</a>
