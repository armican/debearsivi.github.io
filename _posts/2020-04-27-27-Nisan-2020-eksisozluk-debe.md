...
- entry_name: |
    26 nisan 2020 ekşi sözlüğün satılmış olması
  entry_id:  106106726
  entry_writer: fabrikator
  entry_fav_count: 31
  entry_content: |
    herhangi bir mahkeme kararı olmaksızın (bkz: <a class="b" href="/?q=fatih+tezcan+telegram+ter%c3%b6r+%c3%b6rg%c3%bct%c3%bc">fatih tezcan telegram terör örgütü</a>) başlığının sözlük yönetimi tarafından silinmesi ile ortaya çıkan durumdur. yazarlar (bkz: <a class="b" href="/?q=fatih+tezcan%c4%b1n+mahkeme+karar%c4%b1yla+ba%c5%9fl%c4%b1k+sildirmesi">fatih tezcanın mahkeme kararıyla başlık sildirmesi</a>) başlığını açmış ancak ortada bir mahkeme kararı yok. ya bir açıklama yaparsınız ya da alın sözlüğü götünüze sokun deriz. on küsür yıllık yazarım tatmin edici bir izahat yapmazsanız entrylerimi de siler giderim. bu yaptığınız yandaşlıktan öte tam bir şerefsizliktir.
...
- entry_name: |
    sigarayı bırakmak
  entry_id:  106077656
  entry_writer: coy sitik
  entry_fav_count: 7
  entry_content: |
    mütemadiyen yazdığım başlık. <br/><br/>"sigara bırakılmaz, ara verilir...bik bik" diye kafa ütüleyen korkaklara aldırış etmeyin. onlarda sigara bırakacak cesaret olmadığı için herkesi kendileri gibi görmek istiyorlar. bizim millette kroniktir bu davranış. sen yükselemiyorsan, yukarıdakini aşağı çek...<br/><br/>haa unutmadan: sigarayı bırakalı 11 yıl oldu. öncesinde 10 yıl boyunca kara tren gibi içiyorken hem de... <br/><br/>bu işin en etkili yolu inat etmek. yukarıdaki beyin ütüleyen salatalıklara inat edin. o tiplerden çok var etrafta. çok zorlanıyorsanız destek ürünler kullanın geçici bir süre.<br/><br/>ilk 6 ay çok zorlasa da sonunda ödülünüz paha biçilemez.<br/><br/>değil tekrar başlamak, şu an gırtlağımı kesseler bir nefes bile almam.
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    net parasızlık.<br/><br/>-yurtdışına çıkışın pahalı olması<br/>-araba kiralamanın pahalı olması<br/>-içki ve sigaranın pahalı olması<br/>-konser tiyatro festivallerin pahalı olması<br/><br/>belki de parasızlık değil her şeyin fahiş fiyata olması...
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    bedava asla çalışmaz , ne öldürür ne güldürür , dini imanı para .
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    bu konuyu daha önce yazdım doğada da bu durum böyle işlemez. hatta bununla ilgili güzel bir twit atılmıştı. <br/><br/>yumurta sperme koşar mı amın evladı ben mi yürüyeceğim!
  entry_channels: anket,ilişkiler
- entry_name: |
    kolpaçino 4
  entry_id:  106104584
  ...
  entry_fav_count: 1
  entry_content: |
    kötü adamı <a class="b" href="/?q=killa+hakan">killa hakan</a>'a oynatıp gurbette de iş yapacak filmdir;<br/>"<a class="b" href="/?q=kolpa%c3%a7ino">kolpaçino</a> <a class="b" href="/?q=z%c4%b1mbo">zımbo</a>"
