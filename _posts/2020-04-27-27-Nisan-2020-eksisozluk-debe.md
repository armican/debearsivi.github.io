...
- entry_name: |
  ...
  entry_id:  106105668
  entry_writer: caglar4441
  entry_fav_count: 20
  entry_content: |
    grup yorumu eleştirmek için önce açılım sürecini açıklamam gerekiyormuş, e ben onuda eleştiriyordum şimdi ne yapacaz
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    behzat ç. büroda butun isi hayaletin yapmasi
  entry_id:  106110380
  entry_writer: sphagetti
  entry_fav_count: 14
  entry_content: |
    karantina günlerinde <a class="b" href="/?q=behzat+%c3%a7.">behzat ç.</a>'yi tekrar izlerken fark ettiğim gerçek. bütün işi hayalet yapıyor. ercumenti buluyor, uçanı kaçanı buluyor, suleyi buluyor, la cekete islenmis iki harften katil buluyor, mobesede karanlik görüntüden adamı buluyor. ayrica adam da takip ediyor, sürekli çalışıyor adam.<br/><br/>harun anca bos bos konusup berbat espriler yapiyor. adam sorgulama da iyi soz de ama nerdee...<br/><br/>akbaba olay yerinde ya adam öldükten sonra taşınmış ya da bıçak yarasi bilmem ne diyor ki bu da bos otopsiyi bekliyolar hep.<br/><br/>eda adres buro memuru oldugunu kendi itiraf etti zaten. adres bulamayinca yine hayalete düşüyor iş.<br/><br/>e cevdet daha yeni öğreniyor. parmak kesen katili aziz olmasaydi bulamazdi.<br/><br/>behzat da otopsi sonucu ve hayaletin bulduklarini toplayip cinayeti cozdum diyor. bi de adam dövüyor anca.<br/><br/>yazik su hayalete valla. bi de kimi sevse iceri giriyor. üzüldüm akşam akşam.
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    doğu demirkol'un overrated bir oyuncu olması
  entry_id:  106104722
  entry_writer: buyurdu zerdust
  entry_fav_count: 11
  entry_content: |
    doğu demirkol oyuncu değildi ki.. oyna dediler adam da oynadı. benim bildiğim kendi iddiası standup üzerine.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    aklı başında her türkiye cumhuriyeti vatandaşının yapacağı şeydir. <br/><br/>uzmanlar çıkıp projeksiyon yapmışlar ve salgının 2021 sonuna kadar kesik kesik devam edeceğini söylemişlerdi. bunun da ötesinde salgının 1 ayda kontrol altına alınması için tam, 6 ayda kontrol altına alınması için yarım, 1 senede kontrol altına alınması için çeyrek izolasyon gerektiği saptanmış ve bugüne kadar türkiye'de uygulanan izolasyon %40'larda kalmıştı. insanlar her gün işe gidiyor, toplu taşıma kullanıyor, sokağa çıkma yasağı ilk uygulandığı dönem yaşanan bir izdiham var ve alınan önlemler ise yetersiz. <br/><br/>bu bilgiler ışığında henüz 1.5 aydır salgınla mücadele eden türkiye'de salgının birden zirveyi görüp vaka ve vefat sayılarının düşmesi sizce de garip değil mi?<br/><br/>veriler manipüle ediliyor, bu gayet açık. sosyal hayatı mayıs ayında normal düzenine döndürüp iş verenlerin batmasını engellemek adına verileri dezenforme ediyorlar.<br/><br/>sonuç olarak halka yalan söylenerek insan sağlığı yerine ekonomik kaygılar ön planda tutuluyor. verilerin doğru olduğuna inanan insan sorgulama yetisinden uzak ve sapına kadar yandaştır, kusura bakmayın.<br/><br/>edit: imla.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    parasız adam gereksiz adamdır. bu dünyada geçerli tek değer paradır. paranız yoksa ne yazık ki geri kalan tüm vasfınız toplumun büyük bir çoğunda çöptür.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    sokağa çıkma yasağı ve mevcut durum nedeniyle köpekler yalnızlığa alıştı ve daha agresif hareketler sergilemeye başladı. sokağa çıkma yasağında işe giden birinin çevresinin köpekler tarafından sarıldığına şahit oldum.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    hak yol islam deyip asrı saadete inanan kimselerle aynı hayalperesttir
  entry_channels: siyaset
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    van gogh, braque, duchamp, warhol, klee, picasso, malevitch, kandisnsky, dali, dürer, munch konuşabiliriz.<br/><br/>---------<br/>*karantinadan bezdim<br/>*sevgilim kapıyı gösterdi<br/>*ailemle ayrı dünyalardayızcılar= stay away pls
