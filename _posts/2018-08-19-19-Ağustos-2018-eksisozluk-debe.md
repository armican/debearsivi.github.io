...
- entry_name: |
  ...
  entry_channels: siyaset
- entry_name: |
    squatlı kalça vs squatsız kalça
  entry_id:  80403618
  entry_writer: memeuclarindansorumlubakan
  entry_fav_count: 70
  entry_content: |
    ibnetor son fotoda kendi götünüde araya sıkıştırmış.
  entry_channels: 
- entry_name: |
...
- entry_name: |
    akp atatürk'ün başlattığı mücadelenin temsilcisi
  entry_id:  80400934
  entry_writer: ikisidebir
  entry_fav_count: 66
  entry_content: |
    yine "atatürk" dediğine göre başı dertte demektir.<br/><br/>bir rte söylemi.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    çomarlara kurban payı vermiyoruz kampanyası
  entry_id:  80402902
  entry_writer: doktor moktor
  entry_fav_count: 57
  entry_content: |
    istanbul kurban etiyle rakı içenler derneği olarak aldığımız karar.<br/><br/>şahsen yıllardır kurbanda iki koç keserim veya büyükçe bir danadan hisseye girerim.<br/><br/>şimdiye dek kurban paylarını verdiğim kişinin siyasi görüşüne bakmaz fukaranın kursağından sayemde iki gram et geçiyor diye sevirdim.<br/><br/>lakin bir baktım kapıcıydı,eve gelen temizlikçiydi,işyerimdeki müstahdem di derken et yetirdiğim kişilerin alayı malum parti destekçisi.<br/><br/>benim güzel etimi ye,sonra her seçim yaptığın tercihlerle benim ve ailemin geleceğini karart.<br/><br/>biraz kararsızım ama bu kurban çomar kesime et yardımı yapmayacağım ya da hayvanın malum yerlerini paketleyip yollayacağım.<br/><br/>sen benim etimi ye ye azıt,oldu canıms
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 52
  entry_content: |
    bence yanlış iddiadır. diğer canlıların bilinçlerini tamamen bilmediğimize göre ölümün farkında olan tek canlı da insan diyemeyiz. kediyi gören fare neden kaçar acaba ?
  entry_channels: bilim
- entry_name: |
    kürt düşmanlığının en az olduğu şehirler
  entry_id:  80404139
  entry_writer: salmo gardineri
  entry_fav_count: 41
  entry_content: |
    en az neresidir bilmem ama en fazla olan yer muğla fethiye'dir.<br/>memleketimde simitçisinden kebapçısına kadar 92 yılında kovmuşlardı kürtleri.<br/>hatta yabancı gazeteler" kurden raus" diye haber yapmışlardı.<br/>fethiye'nin eğlence bölgesi hisarönü'nde bir midyeci bir kişinin "bu işi neden hep mardinliler yapıyor, kimseye yaptırmaz mı mardinliler bu işi diye sorunca", midyeci "babamın on tane oğlu var birini feda eder gerekirse" diye cevap vermiş ve beşkazalılar o on kardeşi birbirine bağlamıştı.o gün bugün hiç mardinli midyeciye rastlamadım.menteşe beyin torunları bizans ordularına bile eyvallah etmemiştir karttan kürtten korkmazlar.
  entry_channels: anket
- entry_name: |
    ee mühendislerinin hiçbir şey üretmemesi
  entry_id:  80399521
  entry_writer: fuzzy olmak istemistim
  entry_fav_count: 36
  entry_content: |
    (bkz: <a class="b" href="/?q=ee+m%c3%bchendisler+nab%c4%b1yonuz">ee mühendisler nabıyonuz</a>)
...
- entry_name: |
  ...
  entry_fav_count: 27
  entry_content: |
    bitirdiği okulları dereceyle bitiren, yurt dışındaki pek çok saygın eğitim kurumundan ekonomi alanında ders vermesi için çağrı alan alanında uzman bir adama, anonim kimliğe gizlenerek sağlam argümanlar sunmadan bok atmak zaten ancak bizim ülkenin insanlarına has bir özellik. bunu tekrar görmüş olduk.
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    küba'lı heykeltraşın yaptığı ilginç eser
  entry_id:  80404573
  entry_writer: xzxzxz
  entry_fav_count: 21
  entry_content: |
    kadın metaforlusunu da beklediğim çalışma. aynı bölgeye bir deste para mesela.
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    bana da geldi. seyimi cekip attim. fazla mi oldu? sadece hayir desem yeterdi sanirim. ilginc.
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    instagram'dan ve dolayısıyla kullanıcılardan şikayet edenlerden gına geldi, bıkkınlık geldi artık.<br/><br/>burada anonim olarak, o tiksindiğiniz arkadaşlarınızı şikayet ediyorsunuz ama gerçek hayatta o tiksindiğiniz arkadaşlarınızın yüzüne karşı hiçbir bok diyecek cesaretiniz yok.<br/><br/>yüzüne karşı birşey demeyi geçtim, onu takipten arkadaşlıktan çıkaracak kadar cesaretiniz yok.<br/><br/>hergün gelin buraya instagram şöyle, instagram böyle. siz de, o tiksindiğiniz insanlar kadar iğrençsiniz.
  entry_channels: teknoloji,moda
- entry_name: |
    18 ağustos 2018 şok market rezaleti
  entry_id:  80404104
  entry_writer: duygusalmemati
  entry_fav_count: 12
  entry_content: |
    şok market diye bir marketler zinciri var bilirsiniz. mis markalı süt ürünleri satıyorlar ve ben de yoğurtlarını pek severim. bugün yoğurt almak için mağazalarına girdim, en üstte duran tek bir ürün vardı altta ise bir sürü. üstteki ürün 27 ağustos son kullanma tarihli idi alttakiler eylül. alttaki ürünü almak için yöneldim ve bir anda mağaza görevlisi ablamız (muhtemelen aynı zamanda mağaza sorumlusu , ondan başka sadece kasiyer vardı mağazada) yanımda bitti:<br/><br/>- onu alamazsınız<br/>-- neden?<br/>- önce üsttekilerin satılması gerekiyor.<br/>-- nasıl yani?? reyona koymuşsunuz, istediğim ürünü almama engel mi oluyorsunuz, alacağım.<br/>- hayır alamazsınız <br/>-- müşteri hizmetlerini arıyorum.<br/>- istediğiniz yeri arayın.<br/><br/>(müşteri hizmetleri akşam 6ya kadar hizmet vermekeymiş, mağaza 9a kadar açık)<br/><br/>diyoloğu çok fazla uzatmadan aldığım diğer ürünleri de bırakarak mağazayı terk ettim. uzun bir süre de kendilerinden alışveriş yapmamayı düşünüyorum. umarım mis süt ürünleri satan başka bir yer bulurum.<br/><br/>edit: ben müşteri olarak mağazanın verimli satış stratejileriyle ilgilenmiyorum. sadece reyona konulmuş olan, üzerinde fiyat yazan ürünü satın almak istiyorum. yeterince basit değil mi?
  entry_channels: 
- entry_name: |
    btk'nın mesajlaşma uygulaması
  entry_id:  80405944
  entry_writer: cagri temur
  entry_fav_count: 8
  entry_content: |
    (bkz: <a class="b" href="/?q=fi%c5%9flenmek+i%c3%a7in+yap%c4%b1lmas%c4%b1+gerekenler">fişlenmek için yapılması gerekenler</a>)
  entry_channels: 
- entry_name: |
    sincapkiz
  entry_id:  80405029
  entry_writer: iyi denemeydi moliere
  entry_fav_count: 7
  entry_content: |
    erkekliğimden şüphe etmeme neden olan bot yazar.
  entry_channels: ekşi-sözlük
- entry_name: |
    bir kadının zengin olduğunu gösteren ayrıntılar
  entry_id:  80404568
  entry_writer: excell74
  entry_fav_count: 7
  entry_content: |
    canın sağ olsun diyorsa gönlü zengindir.
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    11 açıklanmış aşırı iddialı<br/><br/>volkan, hasa ali, skrtel, neustadter, şener özbayraklı, mehmet topal, josef de souza, mehmet ekici, ayew, barış alıcı, slimani<br/><br/>niyeti çok belli etmiş bir 11<br/><br/>helal olsun cocu
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    bir klasik olacak da:<br/><br/>işte premier lig bu
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    sahıbım var. sahıbımı sevıyorum.<br/>ama senınle de arkadas olabılırız. ara sıra bırbırımıze ıyı haberlerımızı verelım. dostluk paylasmaktır. sana kıymet verıyorum. ırtıbatı koparmayalım. ama sahıbımı kımselere degısmem....<br/>kedısıdır.
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    bisiklet terörü (her seferinde yaya için yeşil yandığında geçerken korkuyordum. sanki durmayacaklar gibi) <br/><br/>atlı polisler. <br/><br/>elmalı pay <br/><br/>lale pazarı <br/><br/>heineken <br/><br/>vlaams patates.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    zeki olsa ders çalışırmış hahaha. yeterince zeki olduğundan, sonunda ölüm olan bir dünya için çalışmaması gerektiğini bilendir zeki çocuk. gereğinden fazla ders çalışmak nedir ulan? hem de türkiye'nin eğitim sisteminde. ömür tüketecek daha kötü bir yol yoktur sanırım.<br/><br/>en güzeli:<br/>(bkz: <a class="b" href="/?q=oblomovluk">oblomovluk</a>)
  entry_channels: eğitim
- entry_name: |
    starbucksta farklı isim söylemek
  entry_id:  80391308
  entry_writer: nutellapilsen
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=starbucks%27ta+takma+isim+kullanmak">starbucks'ta takma isim kullanmak</a>)
  entry_channels: ilişkiler,ekşi-sözlük,moda,magazin,ekonomi
- entry_name: |
    rakıya en iyi meze
  entry_id:  80384391
  entry_writer: hey forrest
  entry_fav_count: 0
  entry_content: |
    süzme yoğurttan yapılan, naneli, buz gibi cacık ve az tuzlu salatalık turşusu favorimdir. bak şimdi canım çekti. <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
  entry_channels: anket,yeme-içme
- entry_name: |
    lokantadan ağızda kürdan bir el cepte çıkan adam
  entry_id:  80402078
  entry_writer: faraton
  entry_fav_count: 0
  entry_content: |
    kösele ayakkabı giyen adamdır.
