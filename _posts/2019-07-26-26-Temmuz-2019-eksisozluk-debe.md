...
- entry_name: |
  ...
  entry_fav_count: 330
  entry_content: |
    aşk yüzünden kırık bir kalbi varsa ve adam cidden adamsa, sanata, bilime ve sonunda da kendine gider.<br/>başka kadınlara gitmez.<br/>bunun geçici bir çözüm olduğunu bilir.<br/>edit: bi tarafıyla içip sapıtmamak kaydı ile şaraba, rakıya da gitsin bence.
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    1930'lu yıllarda çekilmiş esrarengiz fotoğraf
  entry_id:  93043241
  entry_writer: massayidonatello
  entry_fav_count: 90
  entry_content: |
    güzelim tamam da kimle konuşuyorsun? uydu yok, şebeke yok, kulağı yumuşasın diye sürtüyor olacak değil. manyak mısınız lan siz? herif kulağını kaşıyor belli ki...<br/><br/>edit: manyak manyak düşünceler savurmayın üzerime, ilk uyduyu ruslar 57'de attılar.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 64
  entry_content: |
    kadınlardan gelen olumlu tepkilere bakılırsa yakında bu da moda olacak.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.versace.com/gb/en-gb/men/clothing/underwear-socks/boxers/versace-logo-lace-boxers-a008/AUU10012-AZ00018_A008.html" title="https://www.versace.com/gb/en-gb/men/clothing/underwear-socks/boxers/versace-logo-lace-boxers-a008/AUU10012-AZ00018_A008.html">https://www.versace.com/…auu10012-az00018_a008.html</a><br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://twitter.com/CapaMagStyle/status/1154369040292491264?s=19" title="https://twitter.com/CapaMagStyle/status/1154369040292491264?s=19">https://twitter.com/…tatus/1154369040292491264?s=19</a><br/><br/>büyük konuşmayı sevmiyorum ama bir gün bunu giyersem götüm sözlüğündür.<br/><br/>edit: markanın doğru telaffuzu versaçe imiş. boxer a hazırlık olsun diye sondaki e'yi götüme sokmuşum. versace'nin diye düzeltilirse başlık güzel olur.
  entry_channels: moda
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 26
  entry_content: |
    bu gece de gelmemiştir. radamel falcao garcia nöbetini vukuatsız olarak devrediyorum komutanım.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  93057305
  entry_writer: olay yeri zirvalama
  entry_fav_count: 24
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 22
  entry_content: |
    --- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>messi, cr7, modric, ramos'u bile alsanız şampiyon olmazsınız.<br/><br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>buna katılıyorum. fakat adamların şampiyon olmalarına, hakemi, federasyonu, siyaseti, medyası sanki izin veriyorsunuz da adamlar olmuyorlar. her seferinde bir şekilde kestiniz önünü, bu sene olacak gibi olsun yine kesersiniz. bir de gururla "messi bile gelse trabzon şampiyon olamaz" diye dalga geçersiniz. eminim normalde haktan, hukuktan bahsedip ülkedeki adaletsizliklerden şikayet eden kişilersinizdir. trabzonspor'un karşılaştığı haksızlıklar sizin de başınıza gelirse o zaman görürüm sizi.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    mehmet ekici de sakatlanırsa oraya yapılacak takviyeler ile şampiyonluk yolunda önemli adımlar atabilirizi gösteren maç. mahalle takımı daha iyi oynar içim sıkıldı.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    100 bin dolar vs sevgili
  entry_id:  93068723
  entry_writer: tetikci muhabir
  entry_fav_count: 7
  entry_content: |
    alayım 100bini sevgili neymiş amk alın siz sikin
  entry_channels: anket
- entry_name: |
    25 temmuz 2019 yeni malatyaspor o. ljubljana maçı
  entry_id:  93052709
  entry_writer: sampmta
  entry_fav_count: 5
  entry_content: |
    saat 20:00'da başlayacak, yayın a spor.<br/>yeni malatyaspor'a bol şans dilediğimiz karşılaşma.<br/>galibiyet tur kapısını aralamak demek.<br/>en azından 1 tur atlamak dahi olumlu.<br/><br/>nk olimpija'ya bakarsak 2005'de finansal nedenlerle kapatılmış ve sonra nk bezigrad adında bir takım bu kulübün devamı olmuş bir bakıma.<br/>slovenya 5. liginden başlayıp ard arda 4 başarılı sezondan sonra 2009'da 1. lige çıkmışlar.<br/>avrupa ligi ve şampiyonlar liginde ön elemeleri hiç geçememişler 2010-11'den beri.<br/>ulaştıkları en yüksek seviye geçen sezon avrupa liginde play off'ta spartak trnava'ya elenmişler.
  entry_channels: spor
- entry_name: |
    25 temmuz 2019 galatasaray augsburg maçı
  entry_id:  93072693
  entry_writer: celebrimbor51
  entry_fav_count: 5
  entry_content: |
    transferler + çipe leş.
  entry_channels: spor
- entry_name: |
    dolar 1 tl olduğu gün yapılacaklar
  entry_id:  93072958
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    buraya şehir ile yaşınızı yazdıktan sonra cinsiyetinizi yazmanıza gerek yok aslan parçaları.<br/><br/>biz daha buraya bir kadının yazdığını görmedik.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    t.c. karıları için:<br/><br/>para, araba, göbek, kadına değer vermemek, cehalet, kıro olmak, sığ muhabbetler, psikolojik baskı, abazanlıktır.<br/><br/>etrafınızdaki kızların sevgililerine bakın hepsi hastalıklı ilişkiler yaşarlar, sürekli ağlarlar ve mutsuzdurlar ama birini seçip sevebilmeyi seçmek yerine kendilerini seçen abazanlarla aşk yaşadıkları için buna devam ederler.<br/><br/>kızın çevresi: ne buluyorsun onda ya bırak şu kekoyu<br/>kız: seviyorum aşkım o benim<br/><br/>3-4 ay sonra twitter:<br/>"şimdi size eski erkek arkadaşımın uyguladığı şiddeti anlatacağım.''
  entry_channels: anket,ilişkiler
- entry_name: |
    jean michael seri
  entry_id:  93070453
  ...
  entry_fav_count: 3
  entry_content: |
    onyekuruya luyindamaya iyi transfer dedik de iyi çıkmadı mı? bari doğru dürüst örnek verin.seri futbolu takip edenlerin bildiği bir oyuncu.senin bilmemen senin ayıbın.<br/><br/>ama fenere gelen iyi oyuncu dahi sanki bileklerine prangalar takılmış gibi yavaşlıyor kötü duruyor buda ezeli rakibin cenabetliğinden mi atmosferinden mi vallaha bilmiyorum.<br/><br/>tanım:ins 23. şampiyonluk yolunda bolca katkı verecek dinamik ortasahamız
  entry_channels: spor
- entry_name: |
    ilber ortaylı
  entry_id:  93044963
  ...
  entry_fav_count: 3
  entry_content: |
    ilkokul mezunu sümüklü bir vaizle hangi ilmi konularda hasbihâl ettiklerini merak ettiğim tarihçi.
  entry_channels: siyaset,tv,bilim,sanat,tarih,edebiyat,haber,eğitim
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    şeyma subaşı'na kitap imzalatırken ağlamak
  entry_id:  93073161
  entry_writer: gokcesadik
  entry_fav_count: 1
  entry_content: |
    para verip, editör tutup hyaluronik asit yerine yüzüne hidrolik asit (tuz ruhu) sürmeyi tembihleyen bir eski metresin eğitim sistemi sonucu ortaya çıkan potansiyel küçük şeymalar ile olan zavallı görüntüleri.
  entry_channels: 
- entry_name: |
    blutv
  entry_id:  93067332
  ...
  entry_fav_count: 1
  entry_content: |
    üç sene oldu, hala <a class="b" href="/?q=playstation">playstation</a> için uygulama geliştiriyorlar -kendi sitesinde öyle yazıyor-.<br/><br/>acele etmesinler bence, üç sene dediğin nedir ki.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    diyetteyken süte tarçın koyup yanında hurma güzel oluyor. değilken allah ne verdiyse yeni pişmiş çikolatalı kek, kurabiye... olsa güzel giderdi şimdi.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    görüldüğü üzere “o iki sözcüğü” söylemeden seni seviyorum diyemiyorsunuz.<br/><br/>gomiksin sözlük, kendinle çelişiyorsun.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    her bir araya geldiğimizde doğum haritam üzerinden beni astrolojinin gerçekliğine ikna etmeye çalışan bir arkadaşım var. şeytan tüyü var hatunda, çok sempatik bi salak, bu kadar boş lafı başkası anlatsa dinlemezdim. neyse, birkaç gün önce annemle telefonda konuşurken öğrendim ki ben doğum saatimi komple yanlış biliyormuşum. bu durum astrolojicilerin gözünde önemli anladığım kadarıyla, çünkü bu arkadaş dakikasına kadar öğrenmeye çalışmıştı, hatta "anneni ara da sor" da demişti. peki ben ne yapmıştım, aramışım gibi yapıp kendi bildiğimi söylemiştim. açıkçası bu saatten sonra gerçeği söylersem beni yolacakmış gibi bir his var içimde. hayır bir de inatla her dediğine itiraz ediyordum karının, "bana ne, ben öyle biri değilim işte" diye. canı çıktı aylardır laf anlatıyor bana. aman neyse ya bırakayım anlatsın, ne dese inanmayacağım zaten.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    doğa koleji'nin maaş ödememesi
  entry_id:  93066671
  entry_writer: gurme ateist
  entry_fav_count: 0
  entry_content: |
    çalışanlarına sürekli geç maaş veren ticarethane. okul veya eğitim kurumu falan değil bu ve bunun gibiler. zira sahipleri (bkz: <a class="b" href="/?q=metal+yap%c4%b1+konut">metal yapı konut</a>) bir beton firması.<br/>bu ay alınması gereken maaşın hala %70'ini yatırmamışlar. geçtiğimiz dönemde maaşlar 2 ay gecikmeli yatmıştı. <br/><br/>solda kalıp, desteklenmesi gereken skandal. <br/><br/>not: çalışan ben değilim, kız kardeşim.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    anne tarafından amcagillerin kötülenmesiyle olgunlaşan sevgidir.<br/>büyüdükçe bu olgu değişir.<br/>önce dayı-amca sevgi eşitliği, ardından amca sevgisi &gt;dayı sevgisi haline gelir.<br/>anne tarafı kaybeder baba tarafı kazanır.
  entry_channels: ilişkiler
---
