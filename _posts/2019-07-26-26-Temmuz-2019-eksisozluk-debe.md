...
- entry_name: |
  ...
  entry_fav_count: 53
  entry_content: |
    “hanım benim dantelli donu yıkadın mı?” <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
  entry_channels: moda
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    emrah'ın 17 milyon liraya deniz uçağı alması
  entry_id:  93063734
  entry_writer: eoamt
  entry_fav_count: 37
  entry_content: |
    emrah bu uçağı tatil yapmak için değil, kiralayıp para kazanmak için almıştır. pazardan 2 liralık domates alırken bile pazarlık yapan, masrafı olmasın diye oğlunu inkar eden adamdan bahsediyoruz.
  entry_channels: haber
- entry_name: |
  ...
  entry_fav_count: 34
  entry_content: |
    (bkz: <a class="b" href="/?q=o+memo+buras%c4%b1+teksas+%c4%b1merika">o memo burası teksas ımerika</a>)
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    barış manço'nun fettullah gülen ile olan fotoğrafı
  entry_id:  93076309
  entry_writer: asidi kacmis cola turka
  entry_fav_count: 25
  entry_content: |
    ulan ülkede fetoyla fotoğrafı olmayan tek kişi benim herhalde. <br/>amk adamı herkesle poz vermiş.
...
- entry_name: |
  ...
  entry_fav_count: 22
  entry_content: |
    3. sezonda bir sahnede profesör raquel’e seni yendim diyordu. 4. sezon, raquel’in aslında köstebek olduğu, profesörü ve bütün ekibi yakalatıp sen değil ben seni yendim profesör dediği bir finalle biterse şaşırmam.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    hiçbir şey olmazsa bile kesinlikle bir şeyler olur.
  entry_channels: anket,ilişkiler
- entry_name: |
    ersun yanal
  entry_id:  93076314
  ...
  entry_fav_count: 2
  entry_content: |
    <a class="b" href="/?q=okan+turp">okan turp</a>'un sakatlığı nedeniyle kamp kadrosunda bile olmadığını bilmeyen dingillerin akıl verdiği teknik direktör.
  entry_channels: spor
- entry_name: |
    düşün ki annen bunu okuyor
  entry_id:  93074046
  entry_writer: cocuklugumdakidomateskokusu
  entry_fav_count: 2
  entry_content: |
    eğer saglikliyken beni hatirladigi zamanlarda yazma şansım olsaydi:<br/>birgün alzhimer olursan ölünceye kadar sana bebek gibi bakacagimiza söz veriyorum yazmak isterdim.
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    'kavrulmuş dallarımdan haber etsinler diye<br/>nice kuşlar uçurdum, dönmediler geriye...'<br/><br/>(bkz: <a class="b" href="/?q=bozk%c4%b1rdaki+a%c4%9fa%c3%a7">bozkırdaki ağaç</a>)
  entry_channels: anket,müzik
- entry_name: |
    ssg'nin beyin yakan eşcinsellik yorumu
  entry_id:  93076688
  entry_writer: duhaman
  entry_fav_count: 1
  entry_content: |
    göte göt demiştir. "eşcinselliğe özendirme" diye bir saçmalığın olamayacağına dair gayet yerinde eleştirel bir açıklama.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    he ll hold the dick (esas şimdi siki tuttu)
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    güneye giderken-bulutsuzluk özlemi.uzun yolculuklarda birebirdir.mor ve ötesi'nin de güzel bir yorumu mevcuttur.
  entry_channels: anket,müzik
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bir adam varmış. aylık 10bin lira kazanıyormuş ama hiç yetmiyor, hemen parası bitiyormuş. bir gün hocaya hazretlerine bu konuyu danışmış. hoca da demiş ki; git patronuna söyle sana 5bin versin. adam demiş hocam deli misin ben yetmiyor diyorum, sen daha da az diyorsun. hoca da demiş ki demek ki kazandığın para helal değil. sonra adam hocayı bir dövmeye başlamış. ama böyle caminin ortasında.. <br/><br/>pardon, adam bunu karısı söylemiş. karısı bunu bir dövmüş. ama nasıl. her yer kan, revan. sen parayı nasıl karıyla kızla yersin, böyle viledanın o sert kısmıyla dövmüş bunu. sonra hoca efendi.. hoca yok, polis gelmiş sonra. polis kavgayı ayırmış. kadın da tabi boşanmış falan.<br/><br/>sonra bu kadını italyaya görüşler en son. sergileri basıp sprey boyayla duvarlara gerçek sanat bu değil yazıyormuş. adam hala parayı yetiştiremiyor.
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    bir dönemi temsil eden kıyafetler
  entry_id:  93076687
  entry_writer: sirketi hayriye vapuru
  entry_fav_count: 0
  entry_content: |
    kıyafet olmasa da ;<br/><br/>(bkz: <a class="b" href="/?q=badem+b%c4%b1y%c4%b1k">badem bıyık</a>)
