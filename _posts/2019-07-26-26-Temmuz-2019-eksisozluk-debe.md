...
- entry_name: |
  ...
  entry_fav_count: 41
  entry_content: |
    (bkz: <a class="b" href="/?q=ya%c5%9f%c4%b1m%c4%b1z%c4%b1n+yetmedi%c4%9fi+yerde+ya%c5%9fant%c4%b1m%c4%b1z+yeter">yaşımızın yetmediği yerde yaşantımız yeter</a>)
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    çocuklu aileler bu otellere gitmezler olur biter. <br/><br/>2 çocuğumuz var. bana hiç de duyar kasılması gereken bir durum gibi gelmedi. tercih meselesi. çocuklarımızı bırakacak yerimiz olsa, senede 1 hafta kafayı dinlemek için biz de tercih ederiz bu otelleri. bir çok ebeveyn de tercih eder.
...
- entry_name: |
    miami los angeles uçağındaki inanılmaz kavga
  entry_id:  93074163
  entry_writer: jonathan safran foer
  entry_fav_count: 18
  entry_content: |
    kadrajdaki iki yolcuda da airpods var. fiyatı 159 dolar. yani dolar'la kazandıklarını düşününce bizim ülkemize göre 160 lira'lara adam kulaklık alıyor. <br/><br/>ortalama bir macbook air ise 1000 dolar. o da yine onlara göre 1000 lira gibi. bir maaşları ile takımı diziyorlar aşağı yukarı anlayacağınız.<br/><br/>her neyse; kafada laptop kırma olayında bütün dikkatlerimiz maalesef laptop'a kayıyor. 'ulan yazık be' dediğinizi duyar gibiyim. ama işte osura osura alıyor arkadaşlar bu elektronik cihazları.
  entry_channels: ilişkiler,haber,havacılık
- entry_name: |
    ezhel norm ender ben fero dinleyenleye tavsiyeler
  entry_id:  93070559
  entry_writer: renksiz hayat
  entry_fav_count: 15
  entry_content: |
    gerçek rap diye bir şey yoktur. canınız neyi istiyorsa onu dinlemeye devam edin. ne dinleyeceğinizi başkası belirlemesin. zevkler tartışılmaz.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    kıymetlimiis havuçlu tarçınlı kek.
...
- entry_name: |
    güven bana
  entry_id:  93074909
  entry_writer: derin desen
  entry_fav_count: 6
  entry_content: |
    an itibari ile hangi yüzyılda olduğumuzun tartışıldığı yarışma programı.
  entry_channels: tv
- entry_name: |
    25 temmuz 2019 galatasaray augsburg maçı
  entry_id:  93074526
  entry_writer: partinin eglenmeyen cocugu
  entry_fav_count: 5
  entry_content: |
    "ahmet çalık kardeş, seni de yoruyoruz ya, kusura bakma" dediğim maç.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    yaptıkları tek şey küfür etmek, ne diye mesaj bekliyorsunuz lan?
  entry_channels: ilişkiler,ekşi-sözlük
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    sicak havalarda meme altinin terlemesi ile nasil bas ediyorsunuz? memelerim buyuk o yuzden soruyorum.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    sergen'in kadro muhendisligini ve oyuncularin kondisyonunu kotu buldugum mac.<br/><br/>erkan kas'tan olsa olsa şire pazarına esnaf olur. futboldan bihaber, gobekli oyuncu mu olur?<br/><br/>amk rakiptekiler bunlarin ceyregini kazanmiyo hepsi fit. bizimkiler lakayit, isine saygisi yok.<br/><br/>hala yabanci sinirini savunanin taaa amua koyayim!
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    elbetteki zaman konusudur. 1 saatte gitmek varken neden aynı paralara 7-8 saat bekliyeyim.<br/><br/>2. olayı ise insanların birbirine daha saygılı olması . otobüsteki gibi değiller biraz daha sakinler ve az konuşuyorlar davranışları daha insani.
  entry_channels: anket,havacılık
- entry_name: |
    kadınların bir erkekte aradığı en önemli şey
  entry_id:  93072671
  entry_writer: edoardomelone
  entry_fav_count: 0
  entry_content: |
    güven, saygı, zekâ, centilmenlik vs. vs. sıralanmış ama en önemli konulardan bir tanesi erkeğin kadını cinsel anlamda doyurabilmesidir. <br/><br/>her sevisme bir şölen tadında olmalı ve kadın mutlaka ama mutlaka orgazma ulastirilmalidir. <br/><br/>cinsel tatmin ve uyum önemli bir konudur.
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    kendisine erkek diyen bireyin en az 5 basamakli olmali
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    kadıköy moda taraflarında olanlar mesaj yeşili yakabilirler, bira içer sohbet ederiz. stoacılık, evrim, veya insan doğası üzerine konuşabiliriz. ya da en kötü boş yaparız maksat can sıkıntısı ve günün yorgunluğu geçsin. <br/><a rel="nofollow noopener" class="url" target="_blank" href="http://connected2.me/thegreghouse" title="http://connected2.me/thegreghouse">sözlük dışı iletişim linki</a>
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    düşün ki kaynanan bunu okuyor
  entry_id:  93074663
  entry_writer: siyah feraceli kadin
  entry_fav_count: 0
  entry_content: |
    keske üremeseydin... kadınlığı yüzkarası sensin. kıskanç pis. senin olduğun dünyadan baska cehennem var mı acaba? yediğin nanelerin farkındayım söylesem suç teşkil eder. tipsiz köpek
  entry_channels: ilişkiler,ekşi-sözlük
---
