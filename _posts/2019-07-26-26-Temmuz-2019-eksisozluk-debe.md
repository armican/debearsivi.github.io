...
- entry_name: |
    kadıköy'de kız düşürmenin çok kolay olması
  entry_id:  93055816
  entry_writer: askeriucret750tlolsun
  entry_fav_count: 70
  entry_content: |
    kız beni düşürsün amk. bırakın şu bi kız bana verir mi ezikliğini.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  93067969
  entry_writer: suvari07
  entry_fav_count: 14
  entry_content: |
    evet arkadaşlar sorum çok açık.<br/><br/>kız arkadaşınızın babası yabancı ve çok zengin bir iş adamı çıktı. <br/><br/>size de dediki "kızımın peşini bırak 100.000 dolar vereyim"<br/><br/>sorum şu<br/><br/>hangi arabayı alırsınız?
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    tırt dizi ve filmler çekmek bu yöntemler arasında sanırım. temiz...
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    <a class="b" href="/?q=behzat+%c3%a7.">behzat ç.</a>'nin yayına başladığı gün tüm başlıkları değiştirerek güzel bir jest yapmış platform.<br/>smart tv uygulamasındaki başlıklar şöyle:<br/><br/>-amirim sıkılmasın diye. (filmleri sıralamışlar)<br/><br/>-aga cinayet var. (cinayetle ilgili filmler, diziler, vs.)<br/><br/>-tepeden inme filmler. (filmler falan yine)<br/><br/>-bu filmler iyiymiş la! (ödüllü filmler)<br/><br/>-john wick misin oğlum sen? (aksiyon filmleri)<br/><br/>-seviyorum merkez! (romantik filmler)<br/><br/>-sırıtma la! (komedi filmleri)<br/><br/>-ne uyutan ne sızdıran filmler (korku falan)<br/><br/>-ver akbabuş'a izlesin (süper kahrman filmeri falan var. akbabuş ne alaka mk)<br/><br/>-dünya'nın eksenindeki diziler (bilim kurgu galiba. afişler var da tanımıyorum çoğunu)<br/><br/>-tabak iyi ama oscar'ın...(oscar almış filmler)<br/><br/>-şule sıkılmasın diye (godfather afişi de var broken da, bi kategoriye koyamadım)<br/><br/>-iyiler ilk görüşte tanınmaz (filmler milmler işte, bilmiyorum türünü)
