...
- entry_name: |
    konyaspor taraftarının izmir marşı kararı
  entry_id:  71042895
  entry_writer: beninsanimcunkucastielmelek
  entry_fav_count: 436
  entry_content: |
    bakın arkadaşlar şu üstte görmüş olduğunuz adam gibiler bu ülkeyi bölen, ayrıştıran ve silahlı terör örgütleri kadar tehlikeli adamlardır. işte bağırsaklarımızı temizleyeceğimiz an bu adamları susturduğumuz an'dır. izmir'den konya'ya, van'dan tekirdağ'a bu ülke bizim. izmir marşı ülkemizin en değerli marşlarından biri. <br/><br/>birleştirici gücü olan bu tarz güzel hareketleri alkışlayın. yoksa paramparça oluruz.
- entry_name: |
...
- entry_name: |
    beşiktaşlı taraftarların galatasaraylıları kovması
  entry_id:  71033871
  entry_writer: mozambik asilliyim
  entry_fav_count: 147
  entry_content: |
    o gs taraftarları adam gibi adamdır. taraftar gibi de taraftardır...<br/><br/>metin oktay ve özhan canaydın'ın centilmenliğini taşımaktadırlar. utanmadan ne işleri vardı orda diyorsunuz...
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 46
  entry_content: |
    ronaldo’nun pozisyonlarinda qral burak daha etkili olur diyen mal gordu bu gozler hkfkffkl. utanmamıs bir de burak birebirde daha etkilidir demiş öküzoğluöküz.<br/><br/>eksi’nin futbol seviyesidir bu adam.
- entry_name: |
...
- entry_name: |
    ilk kez kahvehaneye gideceklere tavsiyeler
  entry_id:  71041169
...
- entry_name: |
    1000 adet hurda telefona 170 bin € isteyen satıcı
  entry_id:  71045491
  entry_writer: supurgesini satan cadi
  entry_fav_count: 18
  entry_content: |
    sırf gıcıklık olsun diye "villa ile takas düşünür müsünüz?" diye mesaj attım.<br/><br/>edit: "olur" diye cevap gelmiş.
- entry_name: |
    pınar bekbölet
  entry_id:  71047606
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    zorla tutan mı var. gel yer değiştirelim.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    bu zamana kadar destek çıkan, anlayan versiyonuna denk gelemediğim için yaşamadığım andır.<br/><br/>belki bir gün bu anlardan birini aratacak bir sevgili çıkar karşıma.<br/><br/>(bkz: <a class="b" href="/?q=wait+for+it">wait for it</a>)
- entry_name: |
    sinemia
  entry_id:  71048718
