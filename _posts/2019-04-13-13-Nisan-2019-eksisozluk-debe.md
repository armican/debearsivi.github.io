...
- entry_name: |
    matematik öğretmenlerinin 18.500 tl kazanması
  entry_id:  88862079
...
- entry_name: |
  ...
  entry_fav_count: 133
  entry_content: |
    dışarı çıkmak için giyinirken ilk önce çorabını, daha sonra pantolonunu giyen insandır. kuvvetle muhtemel hayatının her anını planlayıp sürekli ileriyi görerek akıllıca davranmaya çalışan biridir. bunun sonucunda çorap giymek gibi konularda dahi öngörülü davranmaktır çünkü neden pantolondan sonra çorap giyip sonra pantolonu geri çorabın üzerine geri çekmekle zaman kaybetsin? işveren olsam mülakatta sorardım ben bunu. <br/><br/>oğlak ya da başak burcu olduğunu düşünüyorum.
  entry_channels: anket,moda
- entry_name: |
...
- entry_name: |
    mhp ve akp'nin maltepe sayımlarına müdahale etmesi
  entry_id:  88863333
  entry_writer: hadi git
  entry_fav_count: 78
  entry_content: |
    ben bir türkiye cumhuriyeti vatandaşı olarak cidden yoruldum be. 2 haftadan beri seçim sonucu takip ediyoruz, haber bekliyoruz. benim ömrümü tüketmeye kimin ne hakkı var lan! yıldım, yıldık, yıldıkkk. artık yeteeerrrrrrr!
  entry_channels: siyaset,haber
- entry_name: |
    ekrem imamoğlu
  entry_id:  88836691
...
- entry_name: |
    12 nisan 2019 kaybolan 12. sınıf öğrencisi
  entry_id:  88863168
  entry_writer: gomlegini ters giymis hunili
  entry_fav_count: 55
  entry_content: |
    12 sınıf öğrencim simay erdem hayatına son vereceğine söylemiş ve o saatten beri ulaşılamıyor. görenlerin, duyanlar aşağıdaki resimde bulunan telefona ulaşırsa çok seviniriz.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://eksiup.com/0cac564ab803" title="https://eksiup.com/0cac564ab803">resim</a><br/><br/>edit: hasmane tarafında görülmüş en son. babası bandırma’da akrabaları var. bir umut oraya gitmeye çalışıyor diye düşünüyoruz.
  entry_channels: haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 35
  entry_content: |
    siktiriboktan episode 7 ve 8'den sonra hala bu seriden medet umanların force yardımcısı olsun. <br/><br/>siktiriboktan serinin siktiriboktan 3. filmi.
  entry_channels: sinema
- entry_name: |
    otel odasındaki kettle'ın ayak kokması
  entry_id:  88862274
  entry_writer: cay yok bok icin
  entry_fav_count: 34
  entry_content: |
    için de çorap ya da boxer yıkanmasından dolayı olabilir
  entry_channels: anket
- entry_name: |
...
- entry_name: |
    öldürdüğü kuşlarla üç hilal yapan ülkücü
  entry_id:  88863337
  entry_writer: swollenmember
  entry_fav_count: 20
  entry_content: |
    çok ter dökmüş form tutmuş bir sporcudur.<br/><br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>ava gidip spormuzu yapıyoruz.<br/><br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>sanırsın sanki taş atıyor da kolu yoruluyor. şu lafı söyleyerek, tüm hayatlarını yaptıkları spora adayıp emek veren, gerçek sporcu ve atletlere saygısızlık etmeyin bari.
  entry_channels: haber
- entry_name: |
    balenciaga
  entry_id:  88846640
  ...
  entry_fav_count: 18
  entry_content: |
    herkeste görüyordum, geçen hafta merak edip google a önünde numara yazan spor ayakkabı yazdım direk bu çıktı. orijinali 4-5 bin tl arasında değişiyormuş. kızın ayağı 36 numara bu ayakkabıyla 45 numara görünüyor. köy yerinde falan giyilebilir çamura saplanmaz asfaltta ayağı gereğinden fazla yorar.
  entry_channels: sanat,moda
- entry_name: |
    uzay için yapılan yatırımların gereksiz olması
  entry_id:  88854735
  entry_writer: sagayaklisolbek
  entry_fav_count: 16
  entry_content: |
    rönesans ve coğrafi keşifler sırasında osmanlı'nın olup bitenleri aval aval izlemesi de aynı pragmatist yaklaşımın sonucudur. <br/><br/>bilimsel gelişmenin gereklisi gereksizi mi olur amk. senin gereksiz diye nitelediğin ve ilk bakışta gereksiz görünen olay başka bir bilimsel araştırmanın kapısını açıyor.
  entry_channels: 
- entry_name: |
    1 yıl sonraki kendine not
  entry_id:  88835218
  entry_writer: 2 gb ram
  entry_fav_count: 15
  entry_content: |
    salak salak hareketler yapma, zamanını boşa harcama. salak. kendine gel. ne değişti? niye zorluyosun? sen salak mısın? senin hiç gururun, onurun yok mu? hayatına devam et. kimseye bel bağlama, planlarını kendine göre yap. tasmanı eline al artık. rasyonel düşün. duygularınla hareket etmeyi bırak. canın çok acır. kendine zarar verme. biraz büyü artık ya, hala çocuk çocuk hareketler. sik kafalı, kendine gel artık. sen bağımsız bir bireysin. bağımsız bir birey ol. işini bil, kitap oku, derslerine çalış. beyhude şeylerle uğraşmayı bırak.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  88841768
  entry_writer: garibaldinonripete
  entry_fav_count: 13
  entry_content: |
    karşıyaka.
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    ülkemiz adına utanılacak bir başka konudur. şu güne kadar düzgün iş yapan 1 tane ustaya rastlamadım. adamlar o kadar yarım yamalak iş yapıyorlar ki bitse de paramı alıp gitsem kafasındalar. o kadar para alıyorlar bari sorunu gider onuda yapmıyorlar. yasal dolandırıcılık bu.<br/><br/>kombi arızalanır alakasız parçayı değiştirir, otomobil arızalanır gereksiz fiyat çeker, boya yapar ortalığı batırır, elektriği yapar izole etmez. dürüst olan adam da işi yapmayı bilmiyor, neyin nerede kullanacağını anlamıyor, kendini geliştirmiyor, elinin ayarı bozuk, özenmiyor.<br/><br/>bir de yabancı ustalara bakıyorsun mükemmel iş yapıyor. bunlar yüzünden her işi kendim yapmayı öğrendim çok zor durumda kalmadan muhattap olmamaya çalılıyorum.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    - o degil de bunu ösym baskani yapanlar, yaptiklarina göz yumanlar nerede?<br/><br/>+ ibb seciminde hak gaspetmeyle mesguller.
  entry_channels: siyaset,tv,sanat,eğitim,ekonomi
- entry_name: |
    12 nisan 2019 maltepe oy sayımında kavga çıkması
  entry_id:  88864779
  entry_writer: eksi peace
  entry_fav_count: 8
  entry_content: |
    polise saldıracak kadar gözü dönmüş teröristlerin çıkardığı kavgadır.<br/><br/>nerede süleyman soylu efendi?
  entry_channels: siyaset,haber
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    her türlü dert dinlenir, akıl fikir verilir.<br/><br/>"biz cenazenizde halay başı, düğününüzde göz yaşıyız."
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    sözlüğün yarısı kadıköy yazmış. madem hepiniz kadıköy'desiniz ne diye yüz kere entry giriyosunuz. toplanın için biranızı, başlık resmen abaza turnusolü olmuş, herkes kadın peşinde.
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    seni zamanında terk edenleri,hayatta kazandığın başarılarınla geride bıraktığını görmek ve onların her adımını izler duruma gelmesi.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    <a class="b" href="/?q=can+bartu">can bartu</a>'nun anisina oynanacaktir.
  entry_channels: spor
- entry_name: |
    sıçtık kelimesinin mesleklerdeki terminolojisi
  entry_id:  88842088
  entry_writer: emre amade
  entry_fav_count: 1
  entry_content: |
    dilerseniz odanızı değiştirelim.<br/><br/>(bkz: <a class="b" href="/?q=otelcilik">otelcilik</a>)<br/>(bkz: <a class="b" href="/?q=konaklama">konaklama</a>)
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    sürekli takıldığım ama normal bir kızla, mekanlara giriyorum çıkıyorum, her şey standart. ama bugün güzel bir kızla takılırken, hatunun biri ölümüne kesti beni. bu bir tesadüf müdür? yoksa yanımızdaki kadının çekiciliği, bizim çekiciliğimize mi ekleniyor. almanya çekici olunca, biz de çekici mi oluyoruz?
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    ya arkadaş başakşehir kim ki stadı oluyor. belediyenin stadı orası. bjk, fb, gs, paşa, sarıyer ve diğer tüm istanbulluların paralarıyla yapıldı. stadı yıktığımız dönemde destek olmayan ezeli rakiplere kırgınım ama başakşehir gibi ucube bir proje takımının yaptığı sözde kıyağı da bu kadar abartmamak lazım. <br/><br/>benim en büyük arzum ekrem başkan göreve başladığında belediye kasasından şu kulübe aktarılan paraların açıklanmasıdır. <br/><br/>not: kollandıkları su götürmez bir gerçek ama sportif açıdan abdullah avcı iyi iş çıkarıyor orası ayrı.<br/><br/>tanım: gollü geçmesini beklediğim süper lig 28. hafta maçı.
  entry_channels: spor
- entry_name: |
    thy take-off 2019
  entry_id:  88858658
  entry_writer: something happens
  entry_fav_count: 0
  entry_content: |
    sınavına nereden girildiği merak edilen şey.
  entry_channels: eğitim,havacılık
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    romantizm olmadan "one night stand" yapan hemcinslerini orospu diye etiketle. <br/><br/>sonuç: orospu diye etiketlediğin insanların sayısı düşsün.<br/><br/>toplam kız: romantizm olmadan sikişenler %20, romantizm olduktan sonra sikişenler %80.<br/><br/>toplam erkek: nefes alsın panpa %100.<br/><br/>%20 romantizm olmadan sikişen kadın, %20 erkeğin kucağına düşüyor.<br/><br/>tahmini toplam: romantizm olduktan sonra sikişenler %80, nefes alsın panpa erkekler %80.<br/><br/>sonuç: %80 aşık taklidi yapan götü götüren erkekler, %80 aldatılan hanım hanımcıklarımız.<br/><br/>ders: romantizm olmadan sikişen hemcinslerinize bi orospu demeyi bırakın, belki böyle erkekler de bu tip taklitleri yapmayı bırakırlar.
  entry_channels: ilişkiler
- entry_name: |
    ekşi itiraf
  entry_id:  88838843
