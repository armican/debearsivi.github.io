...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    küpe takmayan erkeğin kadından farkı neyse odur. sayko sayko cinsiyetçilik yapmazsanız sevinirim.<br/>bu arada hepimiz küpeyiz, alışın buradayız, hiçbiryere gitmiyoruz.<br/>#direnküpe #direnerkek #direnayol
- entry_name: |
...
- entry_name: |
    bahar cansın'a eğitim hakkı geri verilsin
  entry_id:  75737770
  entry_writer: alkolmetreye ufleyen polis
  entry_fav_count: 2
  entry_content: |
    bu toplumda bir kız çocuğu ve bir kadın olarak hayata devam etmek yeteri kadar zor, hatta imkansız bir hale gelmiş iken, okul müdürü ahbabı kontenjanından ruh hastası bir kadın, birçok travmasına rağmen sağlıklı olmaya çabalayıp hayatına devam etme çabasındaki başka bir kadının yeni kâbusu olabiliyor. adaletin batsın dünya. tek ses olabilirsek bahar cansın'a eğitim hakkını geri verebiliriz belki. sen de bahar'ın sesine ses ol!
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    b+ grubu kanı olan,<br/>tercihen sigara ve alkol kullanmayan,<br/>herhangi bir ameliyat geçirmemiş.<br/><br/>bursa içi bir arkadaş arıyorum. biraz laflarız falan..
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  75742936
  entry_writer: jilazem
  entry_fav_count: 0
  entry_content: |
    bi anlık erkek olduğunuzu düşünün ve bir erkek gibi düşünerek cevap verin . kadın olsanız ilk ne yapardınız?
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    eee siz bu boku neden yediniz? iktidara gelmeden önce sistem zaten buydu. isteyen sınavlara girerdi, isteyen de mahallesindeki okula yazılırdı ve olay kapanırdı siz şimdi bunu yeni sistem diye mi satıyorsunuz?
---
