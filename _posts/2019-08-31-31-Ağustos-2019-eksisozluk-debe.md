...
- entry_name: |
  ...
  entry_fav_count: 174
  entry_content: |
    (bkz: <a class="b" href="/?q=hepiniz+mi+darbeli+matkaps%c4%b1n%c4%b1z+ibneler">hepiniz mi darbeli matkapsınız ibneler</a>)
...
- entry_name: |
  ...
  entry_fav_count: 168
  entry_content: |
    istanbul'u fatih fethediyor ama kurtuluş savaşını halk kazanmış oluyor. yani afedersiniz, iki yüzünüzü de ayrı ayrı sikeyim...<br/><br/>kimin eşeğine binerse onun türküsünü okuyan bir kurumdan beklenen hutbedir.
...
- entry_name: |
  ...
  entry_fav_count: 49
  entry_content: |
    ömür boyu sohbet edemeyeceğiniz insanla evlenmeyin demiştim farklı bir başlıkta . <br/><br/>mutsuzluğu insanlar çağırıyor herhalde. aslında evlilik iki kişinin birbirine vardığı yoldur . yol; güzel, çirkin, genç, yaşlı bakmaz . yol sadece yoldaş olanlarındır. avucunun içine öpemeyeceğiz insanlarla evlenmeyin dostlarım. <br/><br/>yaşlandığınızda, bir bardak suyu çok gören ne güzeller, ne yakışıklı insanlar var . ama her şeyi alır götürür zaman . hürmete, sadakate bakın . geriye kalan her şeyi zaman götürecek, elinizden alacak . unutmayın derim bekar bir arkadaşınız olarak .
...
- entry_name: |
  ...
  entry_fav_count: 40
  entry_content: |
    girenin çıkanın belli olmadığını ima ediyor olsa gerek.<br/><br/>(bkz: <a class="b" href="/?q=s%c4%b1n%c4%b1r+kap%c4%b1s%c4%b1+nedir">sınır kapısı nedir</a>)
...
- entry_name: |
  ...
  entry_fav_count: 22
  entry_content: |
    niçin birbirinize küfür ediyorsunuz? ne kadar da kötü insanlarsınız! tinerci, fetöcü, şikeci, akpci, suriyeli diye diye insanlarda tat bırakmadınız.<br/><br/>maçınızı izleyin eğlenin evinize gidin. bu lig bunun için var, rica ediyorum.
  entry_channels: spor
- entry_name: |
    eşcinsellik geni hipotezinin çökmesi
  entry_id:  94662785
  entry_writer: the phantom of the seb i arus
  entry_fav_count: 19
  entry_content: |
    ve ardından “eşcinselliğin çok daha karmaşık faktörlere bağlı olduğunun” ortaya çıkması olayı.<br/><br/>ingilizce bilmeyince böyle aptal homofobik cümleler ortaya çıkabiliyor..<br/><br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/>a vast new study has quashed the idea that a single “gay gene” exists, scientists say, instead finding homosexual behaviour is influenced by a multitude of genetic variants which each have a tiny effect.<br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    tüm zamanların en iyi film introsu
  entry_id:  94652246
  entry_writer: pay
  entry_fav_count: 15
  entry_content: |
    bence lord of war filminin açılış sahnesidir. kendi başına ayrı bir film tadında.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=8LUEiKs2UAo">https://www.youtube.com/watch?v=8lueiks2uao</a>
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    şunların beceremediğini illegal bahisçiler bulgaristan'da apartman dairesinde yapıyor.
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    bunda beyin varsa ben orospu çocuğuyum.
  entry_channels: spor
- entry_name: |
    30 ağustos 2019 galatsaray'a verilen maç
  entry_id:  94672570
  entry_writer: siradan cinko karbon pil
  entry_fav_count: 8
  entry_content: |
    o.cocuklarinin eski yöneticisini federasyon başkanı yaptık hala daha gs lobisi diyorlar.<br/><br/>anasını siktiklerim.<br/><br/>algı kasacam diye başlığı bile açamamış.
  entry_channels: spor
- entry_name: |
    mohamed elneny
  entry_id:  94641716
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    tekme atan hayvanın derdi de, kedicik orada takılıyor kendi kendine
  entry_channels: haber
- entry_name: |
    fatih terim
  entry_id:  94668394
  entry_writer: yok boyle bir gol
  entry_fav_count: 6
  entry_content: |
    son 10 yılda şampiyon takımlara baktığınızda deplasmanda en az kazanmış takımlar 17'de 7 ve 17'de 8 ile son 2 yılın galatasaray'ı. sonra bir daha 17'de 8'le 2012/2013 fatih terim galatasaray'ı var.<br/><br/>kısaca, son 10 yılın deplasmanda en az kazanan 3 takımı da fatih terim'e ait.<br/><br/>çünkü top oynatamayıp gazla ittire ittire şampiyon olmaya çalışırsanız, buna anca içerde gücünüz yetiyor. plansız, sadece kalite farkıyla kazanmak 1-2 yıl oluyor, kötü transfer dönemiyle makas kapandığında da böyle patlıyorsunuz..<br/><br/>teknik direktörün futbol dışı sik sok işlerle, federasyonuyla, hakemiyle, fikstürüyle, yayıncısıyla uğraşması gerekince de futbol oynatması için bir hoca getiremiyorsun. tarihin en başarılı hocası fatih terim oluyor. oynattığı da bu. yazık.
  entry_channels: spor,tv
- entry_name: |
    nesine.com
  entry_id:  94667187
  entry_writer: ahsuahsu
  entry_fav_count: 4
  entry_content: |
    parayı çekti ama kupon gözükmüyor. ağız tadıyla bir bahis yapalım dedik o da olmadı<br/><br/>edit: kupon gözüktü , ilk oynadığım oranlar geçerli
  entry_channels: spor,teknoloji
- entry_name: |
    uzun süreli ilişkinin sırrı
  entry_id:  94671060
  entry_writer: barburbar
  entry_fav_count: 3
  entry_content: |
    dayanıklı olmaktan gecer. çelik gibi sinir olmalı
  entry_channels: anket,ilişkiler
- entry_name: |
    sanal seks
  entry_id:  94663283
...
- entry_name: |
    şu an okunan kitap
  entry_id:  94673065
  entry_writer: renksiz hayati olan kisi
  entry_fav_count: 0
  entry_content: |
    sahilde kafka
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    algı derken? milyonların gözü önünde maçın anasını belledi neyin algısı? fetö bitti, pkk bitti, vatan haini bitti şimdi yeni demagoji silahınız algı kelimesi herhalde. amatör kümede bile maç yönetemeyecek bir hakem olduğunu belli etti bugün. kimin maçını yönettiği önemsiz.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    istanbul beylikdüzü biralar benden. tek sorun benim daha dertli olmam muhtemel.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    debe
  entry_id:  94670070
  ...
  entry_fav_count: 0
  entry_content: |
    ulan acaba hangi ünlü bizimle olacak yarın acaba diye öyle üstün körü bakıp geri gelmesine aşırı sevindiğim bişey oldu. beklediğimiz hareketler bunlar :)
  entry_channels: ekşi-sözlük
- entry_name: |
    debe'nin geri gelmesi
  entry_id:  94671107
  entry_writer: jincha
  entry_fav_count: 0
  entry_content: |
    harika bir haber, debe geri dönüyor. hem de açıklandığı haliyle çok daha güzel olacak. sadece futbol, siyaset ve seksli entrylerle @2ler değil, farklı kanallardan da entryler göreceğiz debede.<br/>bir de şükela bugün modunda seçtiğimizde 00:00 itibariyle girilen enteyler değil de son 24 saatte girilen entrylet gözükse harika olacak. hem entry girmek için gece 12’yi bekleyen timsahlar götlerini avuçlayacak, hem de canlı mevzularda gece yarısı konu sıfırlanmamış olacak. yurt dışında yaşayanları saatler geriden gelirken daha da zorluyor bu mevzu.
  entry_channels: ekşi-sözlük
- entry_name: |
    dünün en beğenilen entry'leri
    <li data-id="94669788" data-author="ekşisözlük" data-author-id="8275" data-flags="share report vote" data-isfavorite="false" data-ispinned="true" data-favorite-count="280" data-seyler-slug="" data-comment-count="0">
    entry_content: |
        selam,<br/><br/>debe’yi, birtakım geliştirmelerle yeniden yayına alıyoruz!<br/><br/>yeni geliştirmelerle birlikte debe’nin kaldırılmasına neden olan amaca aykırı durumların ve kötüye kullanımların önüne geçmeyi planlıyoruz.<br/><br/>öncelikle, daha çok oy alma motivasyonuyla aynı kişinin farklı hesaplarından girdiği ilk entry’sini hedef alan bkz.’ların yazılmasını en aza indirmeyi ve doyurucu içerikler yazmayı teşvik etmeyi amaçlıyoruz.<br/><br/>bunun dışında, en çok entry girilen on kanal, kendi içinden her gün beşer tane debe entry’si çıkaracak. bu sayede çok sesliliği koruyarak, spor ve siyasetten bağımsız konuları da debe aracılığıyla sizinle buluşturmak istiyoruz. <br/><br/>ayrıca, günün sonunda girilen beğenilen bir entry’nin zaman farkından dolayı yeterli oya ulaşamaması sorununu çözme amacıyla, günün başında ve sonunda girilen entry'lerin değerlendirilme algoritmasını değiştirdik. <br/><br/>son olarak, her gün 00.00’a kadar girilen entry’ler debe için değerlendirmeye alınacak ve liste her sabah saat 7.30’da güncellenecek. listemiz artık dağıtık bir sıralamada olacak.<br/><br/>kısacası, debe eskisinden çok daha güçlü bir şekilde bizimle. fikirleriyle bizi besleyen, <a rel="nofollow noopener" class="url" target="_blank" href="https://eksisozluk.com/iletisim" title="https://eksisozluk.com/iletisim">iletişim</a> sayfası üzerinden geri bildirimlerini eksik etmeyen yazarlarımıza teşekkür ederiz.<br/><br/>debe’leri piste alalım!
  entry_channels: ekşi-sözlük
---
