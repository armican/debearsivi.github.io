...
- entry_name: |
  ...
  entry_fav_count: 49
  entry_content: |
    selam,<br/><br/>yeni haliyle debe yarın yayında: (bkz: <a class="b" href="/entry/94669788">#94669788</a>)
...
- entry_name: |
  ...
  entry_fav_count: 48
  entry_content: |
    9,99999999.. = x<br/><br/>10x = 10 . 9,9999999... = 90 + 9,99999... <br/><br/>10x = 90 + x<br/><br/>9x = 90<br/><br/>x = 10
  entry_channels: eğitim
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 22
  entry_content: |
    yukarıda listeden kaçan 7 tane çaylak var. sadece 1 tanesi yazım ve noktalama hatası yapmamış. onulmaz dertlere saldı algoritma onayı bizi.
  entry_channels: ekşi-sözlük
- entry_name: |
    emre mor
  entry_id:  94671191
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    altyapıdan pırıl pırıl gençler geliyor. <br/>gelecek vaad edeni alın yetiştirin.
  entry_channels: ilişkiler
- entry_name: |
    nesine.com
  entry_id:  94667248
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    (bkz: <a class="b" href="/?q=30+a%c4%9fustos+2019+kayserispor+galatasaray+ma%c3%a7%c4%b1">30 ağustos 2019 kayserispor galatasaray maçı</a>) ’nda yerinde olmak istemediğim hakem.<br/><br/>verdiği kararlardan bağımsız çok şanssız bir maç olduğunu düşünüyorum.<br/><br/>oyuncular kötü niyetli, pozisyonlar muğlak, yardımcı hakemler yardımsız, sertlik fazla. kırmızılar, ofsaytlar, var kararları...
  entry_channels: spor
- entry_name: |
    sanal seks
  entry_id:  94663283
...
- entry_name: |
    galatasarayı bitirme operasyonu
  entry_id:  94674002
  entry_writer: kerem88gs
  entry_fav_count: 2
  entry_content: |
    şimdi maçı izlemeyen kuş beyinler burada "yaaavvv adamlar 8 kişi kaldı, bir de var'dan penaltı kazandınız. allah'tan korkun" falan diyecekler. işin aslı öyle değil. attığımız 2 nizami gol, ama görüntülerle ama çizgilerle oynanarak ofsayt haline getirildi. kalıbımı basarım buna. çünkü 2 pozisyonu da ilk gördüğüm anda net olarak ofsayt değil dedim. ancak sonradan var'dan gelen görüntülerde ve çizgilerde 2 pozisyon da farklıydı. bunun yanında kayseri'nin attığı golde marcao'ya atılan dirseğe faul verilmedi. fehgouli'ye ceza sahasında yapilan net penaltı verilmedi. hele ki emre mor'un atıldığı pozisyon tam komediydi. adama dokunmadı bile. sonuç olarak, verilmeyen 2 nizami gol, verilmeyen 1 net penaltı, haksız yere atılan emre mor. hepsinin dışında da 1.dakikadan itibaren tekme atmaya başlayan ve sürekli tekme atan kayserili oyunculara kartların çok çok geç gösterilmesi, bu akşam planlanmış bir oyunun hamleleriydi.
  entry_channels: spor
- entry_name: |
    fatih terim
  entry_id:  94674481
  ...
  entry_fav_count: 1
  entry_content: |
    az önce biz puan kaybederken yabancı konusu hiç açılmıyor bakın iki maç kazanalım yine konuşulmaya başlanır deyip şenol güneş ve nihat özdemir’in içinde gezdirmiştir.
...
- entry_name: |
    ...
    <li data-id="94669788" data-author="ekşisözlük" data-author-id="8275" data-flags="share report vote" data-isfavorite="false" data-ispinned="true" data-favorite-count="384" data-seyler-slug="" data-comment-count="0">
    entry_content: |
