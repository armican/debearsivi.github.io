...
- entry_name: |
  ...
  entry_fav_count: 434
  entry_content: |
    kız/kadın: k<br/>erkek: e<br/><br/>k: çok yorgunum saatlerdir çalışıyorum ya<br/>e: bakimm ;)))))<br/><br/>k: yemek yapıyorum, sonra konuşalım.<br/>e: at bakim ne yapıyosun ;))))<br/><br/>k: hastanedeyim ya serum taktılar<br/>e: bakimm, boydan olsun ama serum da gözüksün<sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup><br/><br/>şeklindeki diyaloglara ev sahipliği eden başlık.
...
- entry_name: |
  ...
  entry_fav_count: 143
  entry_content: |
    her böyle salak yüzünden biz evde 14 gün daha kalacağız<br/><br/>edit: atv binasını komple karantinaya alsınlar bence
...
- entry_name: |
  ...
  entry_fav_count: 113
  entry_content: |
    ben bir peygamberin ümmeti filan değilim ben türkiye cumhuriyeti vatandaşıyım. yeter artık inançlarınızı dayattığınız ve benim adıma konuştuğunuz.
...
- entry_name: |
  ...
  entry_fav_count: 96
  entry_content: |
    tabelalardaki türkiye cumhuriyeti kısaltmasını kaldırmak istediği günden beri, balkonumda yetiştirdiğim fesleğenlerime daha fazla saygı gösteriyorum.
...
- entry_name: |
  ...
  entry_channels: bilim,haber,eğitim
- entry_name: |
    yks 2020 sınavının herkese eşit yapılması
  entry_id:  106590231
  entry_writer: naufragio
  entry_fav_count: 76
  entry_content: |
    ailesi veya kendisi bu süreçte hastalık geçiren öğrenciler var sevgili davar.<br/><br/>tanım: empati kuramayan bir davarın tespit yapması.
  entry_channels: 
- entry_name: |
    mor ve ötesi şarkılarında geçen mükemmel sözler
  entry_id:  106548547
  entry_writer: esgincasir
  entry_fav_count: 74
  entry_content: |
...
- entry_name: |
    ahmet şık'ın hdp'den istifa etmesi
  entry_id:  106581613
  entry_writer: hokage
  entry_fav_count: 47
  entry_content: |
    ahmet şık, vicdanına güvendiğim ender insanlardan. vardır bir bildiği.
  entry_channels: siyaset
- entry_name: |
    cinayet süsü (film)
  entry_id:  106535133
...
- entry_name: |
    ekşi itiraf
  entry_id:  106535115
  entry_writer: 500tkizi
  entry_fav_count: 29
  entry_content: |
    son birkaç yıldır hiç bu kadar çok ağladığımı hatırlamıyorum. aşık olmamak için, birinden hoşlanmamak için, az bile olsa birine gönlümü kaptırmamak için ördüğüm duvarlar ne kadar da gerekliymiş. şimdi bırak duvarı, çin seddi kurucam. gözü kesen yaklaşsın.
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    iki çay bardağı yulafı 1 bardak süt ve 1 tatlı kaşığı bal ile geceden buzdolabına atıyoruz.<br/>sabah çıkarıp üzerine biraz toz tarçın serpip afiyetle yiyoruz.<br/><br/>bunu böyle 2 hafta yapınca 3. hafta kişnemeye başlıyosunuz.
...
- entry_name: |
    yeni nesili chp'li zanneden muhalif
  entry_id:  106589801
  entry_writer: birgaripadamimben
  entry_fav_count: 9
  entry_content: |
    aynen ,öyle bir nesil geliyorki büyük şehirleri tek tek kaybediyorsunuz. haramzadeler sizi.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  106536533
  entry_writer: kalemperest
  entry_fav_count: 6
  entry_content: |
    şunu da hiç anlamıyorum ''güzel kızlar yeşillendirebilir'' <br/><br/>ingiliz prensleri mi bunları yazanlar acaba?<br/><br/>ayrıca yardımcı olabileceğim konularda kız-erkek farketmeksizin soru sorabilirsiniz, tıp ile ilgili olanları daha rahat yanıtlayabilirim.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    dersim katliamının emrini veren kişi
  entry_id:  106589738
  entry_writer: jotaro
  entry_fav_count: 6
  entry_content: |
    (bkz: <a class="b" href="/?q=k%c3%bcrt%c3%a7%c3%bcler+ve+dincilerdeki+ortak+atat%c3%bcrk+nefreti">kürtçüler ve dincilerdeki ortak atatürk nefreti</a>)
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    galatasaray ve fatih terim lobisidir.<br/>not:galatasarayspor.
  entry_channels: siyaset,anket,ekonomi
- entry_name: |
    tez konusu bulamamak
  entry_id:  106591431
  entry_writer: dur bide sunu deniyim
  entry_fav_count: 4
  entry_content: |
    branşınız ile ilgili saygın journallerin (citation indexleri hesaplanmış olsun) son 6 ayda yayınlanmış sayılarını tarayın. ilgi alanınıza giren bir makale bulun. makalelerin sonunda araştırmacılar makalelerine kritik yaparlar. eksik yönlerini belirtip, ileride daha da geliştirilebilecek yönleri vurgularlar. işte bu nokta çıkış noktanız olabilir. ya belirttikleri eksiği giderecek veya daha ileriye taşıyabilecek alanda araştırmanızı yapabilir, hem de literatürde devamlılığı olan bir çalışma olacağından, tezinizi sonradan makaleye de dönüştürüp ilgili jorunal veya bir başka journalde yayınlama şansı da elde edebilirsiniz. yalnız bulduğunuz konunun bir tezi doldurabilecek düzeyde içerik ve araştırma gerektiriyor olmasına dikkat edin.
  entry_channels: bilim,eğitim
- entry_name: |
    ekşi sözlük dertleşecek insan veritabanı
  entry_id:  106548488
  entry_writer: henry wallace
  entry_fav_count: 4
  entry_content: |
    şurda bile tek "amaç" am sevdası. şansımıza artık düşürürsek konuşuruz, kandırabilirsekte artik nude isteriz.<br/><br/>birde lokasyon vermis amsalak. sadece hanımefendiler yazsın diyede o sikindirik aklıyla kıstas belirlemiş. sanıyor ki sözlüğün bütün kadınları ona yazacak.<br/><br/>olum harbiden acınacak haldesiniz. bomboş hayatlar yaşıyorsunuz..
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    spor salonu üyelik fiyatlarını arttırmak.
  entry_channels: spor
- entry_name: |
    tereyağı vs zeytinyağı vs margarin vs ayçiçek yağı
  entry_id:  106591065
  entry_writer: yucel34
  entry_fav_count: 1
  entry_content: |
    sağlıklı beslenmiş hayvanın sütünden halis bir tereyağı çıkarsa enfes.. halis soğuk sıkım asidi sıfır veya 0'a yakın sızma zeytinyağı varken yemeklere bile gerek kalmaz.. temiz ve mineralli su ise hepsinden önemli ve üstündür.. ayrıca gıdaların yenme içme zamanı miktarı ve nasıl olması gerektiği konusu bunlardan da önemlidir..<br/><br/>ayçiçek fındık kanola pamuk mısır yağları hammadde miktarına göre ne kadar yağ çıktığını öğrenirseniz hepsinin sentetik ve sahte olduğunu anlarsınız..<br/>zeytin medeniyettir.. zeytini önem verdikçe medenileşilir medeni kalınır vesselam
  entry_channels: anket,sağlık,yeme-içme
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=iban+ve+rant+ile+devri">iban ve rant ile devri</a>)
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    camilerin açılmasını bekleyenleri üzdü!
  entry_channels: siyaset,ilişkiler,sağlık,haber,eğitim,ekonomi
- entry_name: |
    bir laptop'ı on seneden fazla kullanmak
  entry_id:  106590848
  entry_writer: mustor
  entry_fav_count: 0
  entry_content: |
    eşimin tam 10. yılında marka samsung.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    mercedes benz g55 amg akülü araba 12v <br/>bluetooth kumandalı <br/>kapıları açılan<br/><br/>üste para da kalıyor hem de
