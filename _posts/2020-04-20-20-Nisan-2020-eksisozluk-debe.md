...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    (bkz: <a class="b" href="/?q=s%c3%b6zl%c3%bc%c4%9f%c3%bcn+iyice+inciye+d%c3%b6nmesi">sözlüğün iyice inciye dönmesi</a>)
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    şehrin koca bi tanıdık olması.<br/>toplu bi arkadas ortamında, ogrenciysenız kutuphanede, erkeksenız bi halısaha ortamında ne bilim ta lıseden unıversıteden... herhangi bi yerden mutlaka bi tanıdık cıkar. bu baskentin kuralıdır.
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    olum her aklınıza gelen soruya başlık açmak nedir? niye 3 ay? böyle gerizekalı başlık açacaksanız bari 1 hafta yazın da ne kadar gerizekalı olduğunuzu net olarak anlayalım. ayrıca öğrenilmez.
  entry_channels: anket,edebiyat,eğitim
- entry_name: |
    şu anda çalan şarkı
  entry_id:  105656439
  entry_writer: profosordr
  entry_fav_count: 9
  entry_content: |
    kurtar beni bu alemden<br/>kurtar beni bu yerlerden<br/>bırak aksın gözyaşlarım<br/>kurtar beni bu alemden <br/><a class="b" href="/?q=yavuz+%c3%a7etin">yavuz çetin</a>
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    çok kolay gerçekleştirdiğim eylem<br/><br/>bu meselede bir eşik var: bunu ilk kez yaptığınız an. yani birini hayatından çıkartıp iki gün sonra sanki o yokmuş gibi yaşadığınız an. bu genelde defalarca kez hayal kırıklığına uğradıktan sonra gerçekleşiyor. tecrübe sonucu herkesin üç aşağı beş yukarı aynı olduğunu anladığınızda, kimseye değer vermemeye başladığınızda oluyor.<br/><br/>işte o andan sonra o kadar kolay oluyor ki. birini çok sevseniz, sizi çok büyük hayal kırıklığına uğratsa bile silmek çok kısa sürüyor.<br/><br/>bazıları "kolay silebileceğim insanları hayatıma almam" demiş de, kimin seni hayal kırıklığına uğratacağını bilemiyorsun ki.
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    tanım: <a class="b" href="/?q=zecharia+sitchin">zecharia sitchin</a>'in hayal dünyası ile harmanladığı arkeolojik eserlerin önemsenmesi dileği.
  entry_channels: siyaset,tarih,eğitim
- entry_name: |
    can alıcı şiir dizeleri
  entry_id:  105698427
  entry_writer: softlock
  entry_fav_count: 0
  entry_content: |
    bulvar kahvelerinde arabesk bir duman<br/>sis ve intihar çöküyor bütün birahanelere<br/>bu kentin künyesi bellidir artık ve susuşun<br/>isyan olur milyon kere, hiç bilmez miyim<br/>sokul yanıma sen, ellerin sımsıcak kalsın<br/>devriyeler basıyor karartılmış evleri yine<br/><br/>gidersen yıkılır bu kent kuşlar da ölür<br/>bir tufan olurum sustuğun her yerde<br/><br/>daha bugün ezberlemiş bulundum bu kıtaları <br/><br/>(bkz: <a class="b" href="/?q=ahmet+telli">ahmet telli</a>) -gidersen yıkılır bu kent
