...
- entry_name: |
  ...
  entry_id:  100281309
  entry_writer: kanatsiz kuzgun
  entry_fav_count: 421
  entry_content: |
    ifşa twiti altına yazılan cevap twitlerden:<br/><br/>"ablacım madem rahatsız oldun ne diye cevap veriyorsun madem cevap verdin ne diye ifşa ediyorsun"
...
- entry_name: |
    nagehan alçı
  entry_id:  100263310
  entry_writer: sweedy180309
  entry_fav_count: 62
  entry_content: |
    sanirim hayatinin en kotu gununu gecirdi. boyle bir sey daha once gormedim. muharrem ince de baya silkelemisti ama imamoglu baska boyuta cikardi olayi. <br/><br/>ımamoglu'nun bilgisi, konusma teknigi, taktigi, donanimi muazzamdi. resmen ezdi gecti. boyle bir sey olamaz.<br/><br/>"haklisiniz, cenem dustu" bile dedirtti imam, buna. jesus fucking christ, imam sen neymissin ya...
...
- entry_name: |
  ...
  entry_fav_count: 50
  entry_content: |
    bu başlıktaki herkes sizi sikmek için yazıyor.<br/><br/>ben hariç. ben evli barklı adamım.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    on defa izleyip vurulmaya dair iz bulamadığım görüntü. <br/>vurulmuş olmasi için dışarıdan bir şey gelmesi gerekmiyor mu, karanlıkta iz bırakmayan füze mi yapılmış?<br/>uçağın havada infilak ettiği açıklamasını doğruluyor bu görüntüler.<br/>edit: gelen mesajlardan anladığım bir ben göremiyorum sanırım. bir göz doktoruna görüneyim en iyisi.
  entry_channels: siyaset,haber
- entry_name: |
