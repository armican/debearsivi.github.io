...
- entry_name: |
    dolar 5.85'e gerilerken sus pus olan ekşici
  entry_id:  100282685
  entry_writer: habuli
  entry_fav_count: 262
  entry_content: |
    bu başlık eskiden dolar 5.70’e düşünce sus pus olan eşkici değil miydi? <br/>başlık bile enflasyonun gazabına uğramış<br/>(bkz: <a class="b" href="/?q=dolar+5.70%e2%80%99e+d%c3%bc%c5%9f%c3%bcnce+sus+pus+olan+ek%c5%9fici">dolar 5.70’e düşünce sus pus olan ekşici</a>)
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    tsk'nın düşman pkk'nın dost sayıldığı dönem
  entry_id:  100280956
  entry_writer: radikalkemalist
  entry_fav_count: 36
  entry_content: |
    akp-pkk-fetö ittifakının ergenekon-balyoz kumpasları ile türk ordusunu hedef aldığı, şerefli türk askerlerinin uydurma delil ve belgelerle içeri atıldığı karanlık zaman dilimidir. yargıçlar ve savcılar fetöcü iken türk askerleri sanık, pkk'lılar da tanık olmuştur.<br/><br/>öyle ki artık türk ordusunu savunmak suç haline gelmiş, pkk ile de barış ve kardeşlik türküleri çığrılmıştır.<br/><br/>bunların hepsi akp döneminde olmuştur.
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    biraz yüz veren her kadından hoşlanan erkek
  entry_id:  100278541
  entry_writer: davulcu vedat
  entry_fav_count: 30
  entry_content: |
    ne yapsın garip. seçici olma hakkı verdiniz de o mu olmadı. yok işte hayatında kimse. bir kadından biraz ilgi görse akşam yastığında anlamsız bir gülümseme olur.<br/><br/>hiç mi bu yollardan geçmediniz. bir kadının sizi beğeniyor olmasını ilk hissettiğiniz zamanları düşünsenize. güzel bir duygu değil miydi?
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    <a class="b" href="/?q=halk+galeri">halk galeri</a><br/><br/>oldu olacak devlet ucuza pazar kursun,marul, domates sırasına girer gibi polo,fiesta,clio sırasına girelim
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    sözlükte kedi düşmanlığı yok amk nerenizden uyduruyorsunuz. ama köpek düşmanlığı var ve haklı bir düşmanlık. saldırgan köpekler itlaf edilmeli.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    "zamanında birileri tarafından parsel parsel satılmıştır, satın alınmıştır."
  entry_channels: anket
---
