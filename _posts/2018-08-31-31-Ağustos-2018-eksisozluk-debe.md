...
- entry_name: |
    defne samyeli'nin 47'sinde coşmasının sebepleri
  entry_id:  80779280
...
- entry_name: |
    vajinasına sarımsak sokan türk kızı
  entry_id:  80784145
  entry_writer: mevsimler
  entry_fav_count: 176
  entry_content: |
    (bkz: <a class="b" href="/?q=o%c4%9flum+nereden+buluyorsunuz+bunlar%c4%b1">oğlum nereden buluyorsunuz bunları</a>)
...
- entry_name: |
  ...
  entry_channels: spor,siyaset,tv,müzik,sinema
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 54
  entry_content: |
    loris karius'un kendisiyle rekabet etmek yerine neden apar topar türkiye'ye kadar kaçtığı belli oldu. adam götü zor kurtarmış.
  entry_channels: spor
- entry_name: |
    tarık çamdal
  entry_id:  80779099
...
- entry_name: |
  ...
  entry_channels: siyaset,anket,ekonomi
- entry_name: |
    yalnız yaşayan bir insan sırtına nasıl krem sürer
  entry_id:  80791973
  entry_writer: larker
  entry_fav_count: 40
  entry_content: |
    güzel soru. ben kremi önce duvara sürüyorum, sonra da duvara yanaşıp yukarı aşağı hareket ederek sırtımı da kremlemiş oluyorum.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 34
  entry_content: |
    tsi 19:00’da baslayacak kura cekimi.<br/><br/>bilgi girelim dedik. kime ne lan yaptiginiz dandik tahminlerden, simulasyonlardan? yok su gelecek, bu cikacak, at fava. ne kadar bos beles adamlarsiniz anlamadim gitti.<br/><br/>edit: kanal soranlar oldu, tv'de eurosport <sup class="ab"><a title="(bkz: thanks to ictihat ve telakki)" href="/?q=thanks+to+ictihat+ve+telakki" data-query="thanks to ictihat ve telakki">*</a></sup>, internet uzerinden ise <a rel="nofollow noopener" class="url" target="_blank" href="https://www.uefa.com/uefachampionsleague/season=2019/draws/round=2000980/" title="https://www.uefa.com/uefachampionsleague/season=2019/draws/round=2000980/">uefa.com</a> ve uefa'nin youtube kanalindan sifresiz izlenebilecek.
  entry_channels: spor,haber
- entry_name: |
    kaslı uzun saçlı dövmeli küpeli bronz tenli erkek
  entry_id:  80791367
  entry_writer: depressive mode
  entry_fav_count: 28
  entry_content: |
    "erkek" kısmını tutturuyorum. amorti var hiç olmazsa. gızlar yeşillesin.
...
- entry_name: |
    nerelisin diye sorulduğunda yerin dibine girmek
  entry_id:  80780910
  entry_writer: cabalarkebap
  entry_fav_count: 25
  entry_content: |
    insanlar birbirlerini tercih edemeyecekleri ögeler yüzünden neden sınıflandırır ya da yargılar anlamak mümkün değil bu da tam olarak onlardan biri. <br/><br/>ailenizi seçebiliyor musunuz?<br/>dünyaya geleceğiniz coğrafya'yı önceden işaretleyebiliyor musunuz?<br/>ten renginiz hakkında bir görüş bildirebiliyor musunuz?<br/><br/>-hayır! o zaman yargılamayı kes.
  entry_channels: anket,ilişkiler
- entry_name: |
    galatasaray balı
  entry_id:  80795540
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    (bkz: <a class="b" href="/?q=ya%c5%9fam+grubu">yaşam grubu</a>)
  entry_channels: spor
- entry_name: |
    30 ağustos 2018 beşiktaş fk partizan maçı
  entry_id:  80772098
  entry_writer: cayci kartal
  entry_fav_count: 18
  entry_content: |
    beşiktaş dünyanın en tehlikeli 2. tribününün önünde geçen hafta oynadı ve berabere kaldı. 1. sine ise bu gece partizan gelecek.<br/>hem de zafer bayramı'nda.<br/><br/>zafer bizim olacak.<br/><br/>edit: imla.
  entry_channels: spor
- entry_name: |
    izmir bomba tatlısı
  entry_id:  80793832
  ...
  entry_fav_count: 16
  entry_content: |
    izmirlilerin ülkenin geri kalanını "eşsiz bir lezzet, muhteşem bir gıda" şeklinde sikme kotası malesef boyoz ile doldu. o oyuna bir daha gelmez bu yüce millet.
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    cep telefonu ekran görüntüsünü paraya basmış adamlar.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    tatooine'den gelen bu çocuğu padawan kuyruğunu yeni kesip jedi knight olmuş obiwan'ın eline çırak olarak veren yoda'ya üfleyeyim.<br/><br/>versene çocuğu windu'ya. zıpkın gibi, fişek gibi olsun.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    bu sevdiğimizden kızıyoruzculara, sana tam destek veren taraftara orospu çocukları diyecek kadar hadsizleşerek aziz’in pavalı köpeği olduğunu içinde tutmayı başaramayanlara aldanma başkanım.<br/><br/>bizdeki kredin sonsuzdur. bu göt laleleri ve eski şeref yoksunu başkanlarının takımı ne halde bıraktıklarını biliyoruz. bu ortadoğulu çöl maymunlarına bakma sen. biz senin vizyonunu ve ne yapmak istediğini görüyoruz. <br/><br/>her daim yanındayız. yeterki fenerbahçe sevdanı ve vizyonunu kaybetme.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    allah herkese 1. torbadan lokomotiv moskova şansı versin. <br/><br/>ama yine de ne olur ne olmaz (bkz: <a class="b" href="/?q=manuel+fernandes">manuel fernandes</a>)
  entry_channels: spor
- entry_name: |
    evi ev yapan şeyler
  entry_id:  80794261
  entry_writer: ben cocukken de cooldum
  entry_fav_count: 1
  entry_content: |
    yeni demlenmiş çay kokusu. böyle mutfaktan yayılır, tüm evi sarar mis gibi.
  entry_channels: anket
- entry_name: |
