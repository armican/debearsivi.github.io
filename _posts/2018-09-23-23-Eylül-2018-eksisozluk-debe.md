...
- entry_name: |
    67 kişilik mevcudu olan 7.sınıf
  entry_id:  81529040
  entry_writer: hepinizoleceksiniz2
  entry_fav_count: 32
  entry_content: |
    ülkemizin eğitimde geldiği süpersonik ilerlemenin bir sonucudur. sosyalleşme, kalabalıkta neler yapılabileceği, olası toplumsal kargaşalardan nasıl korunulabileceği ancak böyle bir sınıfta öğrenilebilir.<br/>not: sınıfın da fotoğrafı var ancak öğrencilerin ifşa olmaması için yüklemedim.<br/><a rel="nofollow noopener" class="url" target="_blank" href="https://eksiup.com/56d835373969">https://eksiup.com/56d835373969</a><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://eksiup.com/2ba5966ca110">https://eksiup.com/2ba5966ca110</a><br/>edit: gündeme girerse okula gerekli müdahelenin yapılacağını düşünüyorum, yardımcı olunuz sevgili yazarlar.
  entry_channels: siyaset,haber,eğitim
- entry_name: |
    bir sabah böcek olarak uyanmak
  entry_id:  81534464
  entry_writer: bitkiolsagunduzfotosentezyapamayacakadam
  entry_fav_count: 29
  entry_content: |
    <a class="b" href="/?q=samsa">samsa</a> hadi kalk yerine yat
  entry_channels: anket,ilişkiler
- entry_name: |
    ismail devrim
  entry_id:  81530459
...
- entry_name: |
    sedanur güzel
  entry_id:  81534459
  entry_writer: hayalisuvari
  entry_fav_count: 11
  entry_content: |
    dün yayında annesini görmüştüm. çok umutluydu. çünkü hocaya gitmişler, korkuyor saklandığı yerden çıkamaz. tanıdık birileriyle arayın, tanıdık seslensin demiş hocaları... <br/><br/>cahillige ve sapkinliga kurban giden bir çocuk sedanur. çocuklara işlenen bu suçları hiç anlamadım, anlamayacağım. son olsun temennilerinde bulunuyoruz sürekli ama yok o da olmuyor. <br/><br/>dünyanın sonunun gelmesini dilediğimiz anlardan birini yaşıyoruz yine. ama gelmiyor...
  entry_channels: haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    şarj konusunda oldukça verimsiz ios sürümü. sanırım telefondan telefona ve kullanıma göre değişiyor. <a class="b" href="/?q=iphone+8+plus">iphone 8 plus</a> kullanıcısıyım. önceden normal kullanımda 9-10 saat çalışan pil şu an 5-6 saat seviyesinde. <br/><br/>verimlilik konusunda da gözle görülür bir değişiklik yok açıkçası. bildirimleri gruplama ve ekran kullanımını gösteren panel olmasa da olurdu. ayrıca eskisi gibi pil kullanımını açıkça göremiyorsunuz. sanırım bu da apple’ın kontrollü eskitme planları dahilinde, kullanıcının pil verilerine ulaşılması istenmiyor.
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    amatem’de terapi olmuş gibi davranması gereken güruh. böylece daha az tiner soluruz.<br/><br/>yolda belde ateş isteyen beşiktaşlı olursa “yok” diyerek geçiyorum, güvenli değil. kendiyle birlikte sizi de yakabilir.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    oldukça haklı bir önerme. güzelliğin sıfır maliyetli olduğunu iddia edenler de güldürdü. güzide türk dizilerimizde başrol saf kız varış mahalledeyken kimsenin dikkatini çekmezken zengin genç iş adamının verdiği partiye peri kızı gibi katılınca dikkatleri üzerine çeker. değişen ne; makyaj, muhteşem bir elbise, seksi görünmesini sağlayacak topuklu ayakkabı, ışıldayan özenle yağılmış saçlar ve elbette pahalı takılar. kız aynı kız, güzellik aynı güzellik ama eskiden kimsenin dikkatini çekmezken dakikalarca kendisine bakılmasa sebep olan şey günümüz güzellik algısına ulaşmış olması.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    goztepe formasiyla ates etmeye devam eden yildiz futbolcu, az once trabzonspora da yazdi ve golunu c.ronaldo sevinciyle taçlandirdi. keske demekten hoslanmam ama galatasarayda kalsaydi sampiyonlar liginde hahahahahahahaha devam edemeyecegim :) <br/><br/>ıyi ki defoldu gitti, yersiz aciklamalari, menajer oyunlari vs derken kendisinden iyice tiksindirmisti. goztepe'de ne hali varsa gorsun.
  entry_channels: spor
- entry_name: |
    ücretli öğretmenlik
  entry_id:  81540803
  ...
  entry_fav_count: 2
  entry_content: |
    o kadar çok eğitim fakültesi hocası konuşması dinledim şu ana kadar bir tanesi bile bu tür öğretmenliğin doğru olduğunu düşünmüyorken hala nasıl varlık göstermeye devam ediyor ilginç.
  entry_channels: eğitim
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    herkes sevişiyor şu an. bir tek o sevişmiyor.<br/>şu an disco'dayım, çıkışta ben de sevişeceğim.<br/><br/>sıradaki şarkı tüm eziklere gelsin:<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="http://youtu.be/CS9OO0S5w2k" title="http://youtu.be/CS9OO0S5w2k">village people - ymca</a>
  entry_channels: anket,ilişkiler
- entry_name: |
