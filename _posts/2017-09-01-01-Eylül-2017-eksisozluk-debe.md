...
- entry_name: |
    türkiye'nin dünya'nın 13. büyük ekonomisi olması
  entry_id:  70524461
  entry_writer: richter
  entry_fav_count: 401
  entry_content: |
    büyüklük değil işlev önemli sözünü hatırlatır. hindistan da 7. ama sokakları bok götürüyor. neden böyle oluyor, çünkü para tüm hintlilere eşit dağılmıyor. hükümete yak7n bir grup hintli iş adamına gidiyor o para ve her artan milli gelirde de o para onların kasasına gitmeye devam ediyor. en dipteki milyonlar için bir gelişne olmuyor. aynı durum bizde de geçerli. herkese eşit dağılsa 4 kişilik bir ailenin evine yılda 350.000 tl para girmesi gerekir. ama yılda toplam 25 bin tl ve altında para giren milyonlarca aile var. elalemin parasına sevinen fakirler de mutlu oluyor. ne güzel yutmuş millet zokayı yahu.
- entry_name: |
...
- entry_name: |
    hiç kimsenin yaşamın hakkını veremeyecek olması
  entry_id:  70520270
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    lan nasıl yapıyorsunuz? maaş olarak asgari ücretin birkaç tık üstünde olmama rağmen haftasonu gezmelerimi bile filtreliyorum, yetişemiyorum. helal olsun tatlı kıs...
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    20 yıl önce bugün hayatını kaybeden galler prensesi.<br/><br/>bence en güzel fotoğrafı şu; <br/><a rel="nofollow noopener" class="url" target="_blank" href="https://pbs.twimg.com/media/DIeeRUlVwAAslPT.jpg">https://pbs.twimg.com/media/dieerulvwaaslpt.jpg</a><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://twitter.com/KensingtonRoyal/status/902864437341773825" title="https://twitter.com/KensingtonRoyal/status/902864437341773825">https://twitter.com/…oyal/status/902864437341773825</a>
- entry_name: |
    arda turan
  entry_id:  70517117
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    51 yaşındaki <a class="b" href="/?q=%c5%9fenay+g%c3%bcrler">şenay gürler</a>'in ve 54 yaşındaki <a class="b" href="/?q=aydan+%c5%9fener%27">aydan şener'</a>in unutulduğu anket.<br/>not: <a class="b" href="/?q=ay%c5%9feg%c3%bcl+aldin%c3%a7">ayşegül aldinç</a> 59 yaşında
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    bizim ibnetor değildir. <br/><br/>ağzı yüzü kan içinde büyük ihtimal araba ezmiş bir halde ilk bulduğumda dört ayağı üstünde dururken avucuma sığıyordu, o kadar küçüktü. götürdüğüm veteriner bile çok küçük bu ölür, uyutalım isterseniz demişti de kardeş sen elinden geleni yap da ölürse ölür ne yapalım demiştim, inatla hayata tutundu ponçik kafa. yani yokluğun içinden çıktı da ruhu elitmiş herifin meğersem.<br/><br/>ulan herif vedat milor çıktı başımıza, proplan somonlu dışında bir şey yemiyor, kilosu 45 lira anasını satayım, ayda 3 kilo yiyor. bir defasında veterinerde somonlusu olmayınca tavuklusunu almıştım, adam 2 gün yemek yemedi, su içti sadece, gecenin körü 20 km yol gidip 24 saat açık bir veterinerden somonlusunu buldum. <br/><br/>5,5 kilo oldu şimdi, götünü yalıyor an itibariyle.<br/><br/>edit: yemediği tavukluyu ne yaptın diye soranlar oldu, sokaktaki kedilere dağıttım hepsini.
- entry_name: |
    lionel carole
  entry_id:  70529613
  ...
  entry_fav_count: 2
  entry_content: |
    geldiği zaman fena değildi, sonra üstüne de koydu. herkes scout transferi yapalım, carole gibi adamlar bulalım diyordu. ne olduysa adam dibe çakıldı. performansı tam bir çan eğrisi adamın. iyi haliyle 7 8 milyon eder diyorduk o zamanlar ama şu hali ile nereye ne kadara iteleniyorsa iyidir. kendisine yazık etti. yoksa çok kötü bir futbolcu olduğuna inanmıyorum, çünkü gayet güzel maçlar çıkardı. tembelliği ve salaklığı yüzünden şu anda bu durumda. yoksa zaten hayvan gibi sağ bek aldık dediğimiz adamı sevilla'dan aldık. adamlar o sağ beki verip bu carole'u sol beke yedek olarak bile alma niyetine girdiyse iyi performansı ve potansiyeli yüzünden.
- entry_name: |
    lg v30
  entry_id:  70516624
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bu kırmızı normal bir kırmızı değil.adeta sikecekmiş gibi bakan bir kırmızı.<br/><br/>bir <a class="b" href="/?q=keratokonus">keratokonus</a> hastası olarak gözümü sikip atmıştır.öyle ki siteye girdiğimde logonun üstüne yapışkan kağıtlardan yapıştırarak geçici bir çözüm ürettim.<br/><br/>tasarımınızı, minimalizminizi sikeyim.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=ericcah%c5%9f">ericcahş</a>)
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    iddia sahibi şunu demişti ancak kaçtı;<br/><br/>tuborg gerekli mayalanma süresini beklemeden ürünleri satışa çıkarmış. bu sebeple son zamanlarda içilen biralar asitli su gibiymiş. bu sebeple sağlığı tehdit ediyormuş. daha sonra anadolu efes bu durumu şikayet etmiş. denetim sırasında satışa uygun değil kararı çıkmış ve önümüzdeki 10 gün tuborg'un depolarından ürün çıkmayacakmış. <br/><br/>(bkz: <a class="b" href="/?q=m%c3%bcddei+iddias%c4%b1n%c4%b1+ispatla+m%c3%bckelleftir">müddei iddiasını ispatla mükelleftir</a>)
- entry_name: |
