...
- entry_name: |
    rte'nin muharrem ince'ye dava açması
  entry_id:  77482905
  entry_writer: circiriye
  entry_fav_count: 201
  entry_content: |
    hiçbir korkuya benzemez halkını satanın korkusu..<br/><br/>(bkz: <a class="b" href="/?q=t+a+m+a+m">t a m a m</a>) artık gidiyorsun.
...
- entry_name: |
  ...
  entry_fav_count: 67
  entry_content: |
    hiçbir koşulda şu algı değişmeyecektir:<br/>(bkz: <a class="b" href="/?q=orospu+%c3%a7ocu%c4%9fu+taksici">orospu çocuğu taksici</a>)
  entry_channels: siyaset,haber
- entry_name: |
    rte'nin çorlu mitinginde ince'yi izlettirmesi
  entry_id:  77490030
  entry_writer: nesli tukenmeyen panda
  entry_fav_count: 46
  entry_content: |
    muharrem ince'nin "ne istediler de vermedik" dahil, tüm akp milletvekillerinin, genel başkanının, bakanlarının fetö ve apo güzellemesi yaptığı videolardan bir derleme ile cevap vermesi gereken olaydır.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
    ali koç'un rte zırvalaması
  entry_id:  77489406
  entry_writer: wohan
  entry_fav_count: 21
  entry_content: |
    bu ülkede yüksek mevkide bulunan herkesin yapacağını yapmıştır. ülkenin cumhurbaşkanı adam ve destekleyen %50'lik kesimi var. kötülemesini beklemek hata olur.<br/><br/>ayrıca koç ailesini zora düşürmek isteyemez muhalifler orgazm olacak diye. bu kadar saf olmayın gençler.
  entry_channels: spor,siyaset
- entry_name: |
    29 mayıs 2018 kedimin fatih'te kaybolması
  entry_id:  77474965
  entry_writer: the tale of a warrior from snowy north
  entry_fav_count: 21
  entry_content: |
    umarım bulursunuz, zira farklı bi kedi, bulan satmak isteyebilir. hayvan satış sitelerine ve petshoplara ulaşmakta fayda olabilir.<br/><br/>edit: başımdan geçen bir şey anlatayım. bir gün kedim biz bakmıyorken balkondan aşağı düşmüş. uyuyor sanıyoruz falan 2 saat sonra anladık evde olmadığını. binanın dışına çıktık sitede arıyoruz ismini bağıra bağıra. aynı yerlerden 10 kere geçtim ismini söyleyerek ama yok hayvan. sonra nerden estiyse, önünden ismini söyleye söyleye 1 saattir geçip durduğum binanın arka tarafına atılmış kullanılmayan kanepenin, süpürgenin ıvır zıvırın içine bakmak geldi. şöyle bi baktım salak kedim orada, eşyaların arkasına saklanmış gık çıkarmıyor. ismini söyleye söyleye 10 kere geçtim oradan 10 ama aptal kedim ses etmemiş. kısacası "her yere" bakın.
  entry_channels: haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    erenköy<br/>caddebostan<br/>suadiye<br/>sahrayı cedit<br/>kızıltoprak<br/>fenerbahçe<br/>bostancı<br/>dragos
  entry_channels: anket,seyahat
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    burada yazılan cinsellikle ilgili sorulara cevap veriyor musunuz? veriyorsanız da neden veriyorsunuz? mal mısınız?
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    hdp mitinginde bozkurt yapan kadın
  entry_id:  77479970
  entry_writer: dedibirileri
  entry_fav_count: 15
  entry_content: |
    birisi mhp mitinginde zafer işareti yapsa kan gövdeyi götürürdü. bir de "ülkücüler kime ne yapmış lan" diyen tipler var. hiç ülkücü görmesek, bilmesek yutturacak haspam. burada ülkücülerin yaptığı katliamları yazmaya gerek var mı sence ? <br/>daha geçen gün saadet partililere saldırmışlar herif gelmiş ülkücüler kime ne yapmış diyor. sizin olduğunuz ortamda huzur yok huzur.
  entry_channels: siyaset
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    golem'e tp edip exp'e yatıran gotveren mageler.
...
- entry_name: |
  ...
  entry_channels: siyaset
- entry_name: |
    a haber'de en sık kullanılan söz
  entry_id:  77480155
  entry_writer: cakowx
  entry_fav_count: 14
  entry_content: |
    (bkz: <a class="b" href="/?q=m%c3%bcjde">müjde</a>)
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    terörist olmayan bir insana terörist diyen en basit haliyle hakaret etmektedir. cumhurbaşkanı olacak siz de karşısında esas duruşa geçeceksiniz.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    garantinin bir kartı var bende..<br/>ekstreye 197.50 tl yansıtmışlar.<br/>aradım, iptal ettiler. beklemesi, bağlanması 3 dk sürdü sürmedi.<br/><br/><a class="b" href="/entry/77464222">#77464222</a><br/>öyle şube müdürü falan araya adam sokmaya gerek yok. bunun için bölüm kurmuşlar adamlar. <br/>eminim ki şube müdürü senin kartın ücretinin iptal için harcadığı zamana üzülmüştür.<br/>sana harcadığı sürede vereceği 1 krediyle kart limitin kadar faiz yazar.<br/><br/>not: bankacı<br/>not: müfettiş
  entry_channels: ekonomi
- entry_name: |
    söylenmesi zevk veren latince kelimeler
  entry_id:  77461677
  entry_writer: paratonerimtrak
  entry_fav_count: 7
  entry_content: |
    digiti minimi (bkz: <a class="b" href="/?q=ser%c3%a7e+parmak">serçe parmak</a>)
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    kendim için söyleyebilirim ki doğru.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
    limoncello
  entry_id:  77486470
  entry_writer: sandalyeyikimaldibiryarsevdimkelkaldi
  entry_fav_count: 3
  entry_content: |
    italyan bir arkadaşın, ailesinin kendilerine kadar ürettiği miktardan ayırıp bir şişeyi bize getirmesiyle tanıştığım über içecek.<br/><br/>minik bir yağdanlık kadar olan limonçelloyu görünce önce ağız burun yaptık az olmasına, "yavaş için ağır gelebilir" uyarısını da ciddiye almadan hızlıca bitirdik. aile muhtemelen şekeri bilerek az koymuş, tadı ef-sa-ne idi. hem ferah, hem alkollü. bir limonata fanı olarak aklımı yitirdim. ardından arkadaşın kıkırdamaları başladı "sıçtınız" gibisinden, ayağa kalkınca da ebemizi gördük. çok tatlı bir sarhoşluğu var.<br/><br/>sonrasında değişik markaların hazır üretim şişelerinden alıp çokça denedim ancak ev yapımı olanı, çıtayı allahu ekber dağlarına çıkardığından olsa gerek hiçbiri lezzetli gelmedi. üstelik aşırı şekerliler.<br/><br/>eğer ailesi limonçello yapan italyan bir arkadaşınız varsa (seri imalat gibi değil, kendileri için) veya italya sınırlarında, bizdeki zeytinyağı üreten köylüler gibi limonçello satan dayılara denk gelirseniz o şekilde deneyiniz.
  entry_channels: yeme-içme
- entry_name: |
...
- entry_name: |
    aldi ve lidl marketleri
  entry_id:  77486114
  entry_writer: hosvelkam
  entry_fav_count: 2
  entry_content: |
    (bkz: <a class="b" href="/?q=aldi">aldi</a>)<br/><br/>(bkz: <a class="b" href="/?q=lidl">lidl</a>)
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    "0"<br/><br/>daha yeni sevgili olduğumuz zamanlardı. bütün gece whatsapp'da sohbet etmiş ve vedalaşmak üzereydik. sevgilim uykusu gelince harfleri filan karıştırır saçma sapan şeyler yazardı istemeden. seni çok seviyorum aşkım yazınca cevap olarak "0" yazmıştı.<br/><br/>şimdi "0" bile yazmıyor gerçi. 2,5 sene çıktık ve beni terketti.<br/><br/>(bkz: <a class="b" href="/?q=bu+da+b%c3%b6yle+bir+an%c4%b1md%c4%b1r">bu da böyle bir anımdır</a>)
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    bülent ortaçgil sesi ve şarkıları. herkes bayılıyor ama o kadar sevgi pıtırcığı içerikli ki dinlerken sinirlerim bozuluyor
  entry_channels: anket
- entry_name: |
    29 mayıs 2018 ankara yağmuru
  entry_id:  77488993
  entry_writer: buzman
  entry_fav_count: 1
  entry_content: |
    her sene bu vakitlerde yağar böyle. iç anadolu bölgesine has yağışlardır. henüz çok kuvvetli değil. yanlış hatırlamıyorsam 2015 yılında öyle bir yağmıştı ki istanbul yolu kapanmıştı.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    yeni açıktan çok güzel gelmişti izlediğimde<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=3Mf86Eyds5Q" title="https://www.youtube.com/watch?v=3Mf86Eyds5Q">ahanda bu</a>
  entry_channels: spor,anket
- entry_name: |
    izmir
  entry_id:  77473685
