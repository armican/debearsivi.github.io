...
- entry_name: |
  ...
  entry_channels: siyaset
- entry_name: |
    karpuzun yanında peynir yiyen midesiz insan
  entry_id:  77483651
  entry_writer: geri donusum kukusu
  entry_fav_count: 75
  entry_content: |
    ezine peyniri ve tatlı bir karpuz ile midesine bayram ettiren insan evladıdır.
...
- entry_name: |
    inşallah dinimize devam ediyoruz
  entry_id:  77494169
  entry_writer: plazma
  entry_fav_count: 14
  entry_content: |
    15 dakika paganizm arasından sonra dinimize devam ediyoruz.<br/><br/>not:<br/>aklıma böyle bir saçmalık getirmiştir. televizyona çıkıyorsanız ve hassas bir konuda konuşuyorsanız dikkat etmeniz gerekir.
  entry_channels: 
- entry_name: |
    aziz yıldırım
  entry_id:  77465085
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    hangi mersinli?<br/><br/>(bkz: <a class="b" href="/?q=y%c3%b6r%c3%bck">yörük</a>)<br/>(bkz: <a class="b" href="/?q=fellah">fellah</a>)<br/>(bkz: <a class="b" href="/?q=k%c3%bcrt">kürt</a>)<br/>(bkz: <a class="b" href="/?q=suriyeli">suriyeli</a>)<br/><br/>az da olsa<br/><br/>(bkz: <a class="b" href="/?q=m%c3%bcbadil">mübadil</a>)
  entry_channels: ilişkiler
- entry_name: |
    limoncello
  entry_id:  77486470
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    200 şınav 500 mekiğe göre daha az inandırıcı olan çalışma programı. <br/><br/>elbette istediğiniz egzersizi istediğiniz sayıda yaparsınız ama kasların yapısı, şınav ve mekikte kasların uygulaması gereken kuvvet düşünüldüğünde mekik şınava böre daha çok tekrarlı yapılması beklenen bir egzersizdir.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    dünya kupası modunu bugün çıkaran oyun. ingiltere saati ile sabah 11'de erişilebileceğini duydum. yanlışsam yeşillendirin editleyeceğim entryi. bu arada gameplayde bariz değişiklikler var mod içinde.<br/><br/>edit: ea menajerlerinden biri 11 utc'yi doğruladı. platformlara göre değişebilir<br/><br/>edit2: pc'de geldi arkadaşlar. 4 gb update.
