...
- entry_name: |
  ...
  entry_fav_count: 38
  entry_content: |
    (bkz: <a class="b" href="/?q=hani+bir+buton+vard%c4%b1%3b+neydi+o%3f">hani bir buton vardı; neydi o?</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 33
  entry_content: |
    bu seride silikon yeterince çözünmemiş demek ki.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 23
  entry_content: |
    tutuklanmış. sevinemiyorum zira tutuklanma sebebi "cihatçılık, kadın düşmanlığı, kin ve nefrete teşvik, nefret söylemi, dini duyguları istismar, laiklik karşıtı olmak" gibi sebeplere dayanmıyor. şu iğrenç, nefret dolu konuşması akp'ye göre bir sorun teşkil etmiyor örneğin: <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=C5kskgAg2O4">https://www.youtube.com/watch?v=c5kskgag2o4</a><br/><br/>akp'ye muhalefet eden bir çizgide olmasaydı tutuklanmayacaktı. müminlere bir kaşık bal vermeye çalışan arı, kovaladıkça kaçan ateş böceği ilan edilecekti ve tarikatının önüne ihaleler yığılacaktı. bir güç kavgasının sonucunda en zayıf halka seçildi ve içeriye atıldı.<br/><br/>ama sırf akp tutukladığı için "kuytul'a özgürlük" diyecek halimiz yok. şu kadar üzüldüysem ne olayım. umarım liberaller de böyle bir topa girip kendilerini bir kez daha rezil etmezler.<br/><br/>gününü bekleyip kahraman olmaya çalışacaktır.
- entry_name: |
    bafetimbi gomis'in çin'e transferi
  entry_id:  74102211
  entry_writer: eldorado kaymakami
  entry_fav_count: 22
  entry_content: |
    bu sporx şekip mosturoğlu'nun tahir kum'a "emenike galatasaray yolunda diye haber yaz" dediği ve tahir kum'un da detayları sorup şekip'in istediği özel ısmarlama yalan haberleri utanmadan yazdığı site değil mi?<br/><br/>evet.
- entry_name: |
...
- entry_name: |
    1999-2003 arası galatasary maçlarının ertelenmesi
  entry_id:  74114453
  entry_writer: siensi kuba
  entry_fav_count: 17
  entry_content: |
    2000-2001 sezonu<br/><br/>galatasaray'ın real madrid ile şampiyonlar ligi çeyrek finalinde real madrid ile oynayacaktır ve ligde oynayacağı beşiktaş maçının ertelenmesini talep etmiştir. fenerbahçe ise federasyona bu maçının ertelenmemesi için itirazda bulunmuş ve maç oynanmıştır. galatasaray, beşiktaş'ı 2-0 yenmiş, o zaman ki teknik direktörü mircea lucescu'da türk futbol literatürüne geçecek (bkz: <a class="b" href="/?q=k%c3%b6pekler+istedi+diye+atlar+%c3%b6lmez">köpekler istedi diye atlar ölmez</a>) sözünü kazıyacaktır. galatasaray, şampiyonlar ligi'nde de real madrid'i kendi sahasında 3-2 yenecektir.<br/><br/>yaşı yetmeyen ergenlere hatırlatmak isterim
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  74101552
  entry_writer: glenfarclas
  entry_fav_count: 1
  entry_content: |
    söylem doğru veya değil, 3. ağızdan duyulan markayı bağlar veya bağlamaz hiç oralarda değilim.<br/><br/>ama burada kaç tane adam gelmiş, çaykur muadili çay bulamıyormuş ondan katılmıyormuş. lipton kireçliymiş falan.<br/>yani "kardeşim ben vizyonsuzum, çomarım, hülocuyum" desen, diycem ki neyse bu adam da böyle.<br/><br/>ama çay lan bu, çay. daha iyisini içsen nolur az kötüsünü içsen nolur. bu mu yani senin bir markayı boykot etmedeki kriterin?<br/><br/>42 yıllık single malt deneyimi yaşıyor sanki pezevenk çaykur içerken.
- entry_name: |
    bulaşık yıkamak
  entry_id:  74110478
...
- entry_name: |
    ovis.com.tr
  entry_id:  74112567
  entry_writer: soulsmasher
  entry_fav_count: 0
  entry_content: |
    yeni açıldığı için ref linki olmadan kayıt olunmayan,<br/><br/>yani kayıt için ref olayı şu an opsiyonel değil <a class="b" href="/?q=mecbur">mecbur</a> olan,<br/><br/>kıbrıs temelli borsadır.<br/><br/>edit: ayrıca doğrulanmamış hesapta günlük limit 150 tl, aylık limit 3000 tl'dir. bu limitlerin yükseltilmesi için kimlik fotoğrafı yüklenmesi isteniyor.
- entry_name: |
    ethereum soft
  entry_id:  74108073
