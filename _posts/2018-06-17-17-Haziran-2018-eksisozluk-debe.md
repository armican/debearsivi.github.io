...
- entry_name: |
  ...
  entry_id:  78104933
  entry_writer: mitokondriyel adem
  entry_fav_count: 9
  entry_content: |
    güvenilir erkek bulmak zor değildir. güvenilir erkekler hiç bi şekilde kadınların ilgisini çekmez..
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    komidinin üstüne ne bırakırlarsa.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    acilen abdürrahim albayrağa ihtiyacı olan takım. herkes mutsuz. herkes önüne bakıyor. takım içi iletişim berbat. bu şekilde yarı finali geçemez.
  entry_channels: spor
---
