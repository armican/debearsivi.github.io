...
- entry_name: |
    instagram'da 400 kişiden fazla takipçisi olan kız
  entry_id:  80505859
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    istanbul'un en güzel olduğu zaman
  entry_id:  80520791
  entry_writer: dalaylamaninkabri
  entry_fav_count: 7
  entry_content: |
    şüphesiz ki arapların olmadığı zaman. atık çok uzağında olduğumuz zaman.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    "kısa bir süre için açtım" nedir amk ahagha.<br/>"kapatıyoruz" yazan dükkan, "15 dk içinde telefon ederseniz ekstra indirim" diyen tv pazarlama reklamlarından sonra gördüğüm en iyisi.
  entry_channels: anket,ekşi-sözlük
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  80531682
  entry_writer: chelengear
  entry_fav_count: 2
  entry_content: |
    inanan insanlara ve inandığı dine/değere asla laf etmem, tercihtir. ama koca koca okumuş adamların, kendi inançlarını ve değerlerini başkalarına zorla dikte etmelerini ve ikna olmazsan da seni kafir, inançsız, hain, yok edilmesi gereken kişi olarak yaftalamalarını anlayamıyorum dediğim olgu. <br/>ben ve benim gibilerdeki bakış açısı diğerlerinde de olsa sanki dünya bi güzelleşecekmiş gibi.
  entry_channels: anket
- entry_name: |
    tanrının asıl amacı
  entry_id:  80531681
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    daha huysuz daha agresif daha uzlaşma yoksunuyum daha daha ve daha yaşlandım,yüzümün hatları yorgun,bitkin ve yaşama maruz kaldı,sözcükler artık yük ve ağır geliyor,pogo yapmıyorum artık jazz dinliyorum,saçlarım beyaz omuzlarım çökük,peki sen nasıl aynı yaşta kaldın,sen nasıl hep aynı geliyorsun düşlerime,gecelerime.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bu ben değilim.<br/>hoş bir işim yok.<br/>sessiz değilim.<br/>sakin hiç değilim. <br/>evim yok. <br/>arabam yok. <br/>sadece erkek kısmıyla idare edecek kızlar eqlesin.
  entry_channels: anket,ilişkiler
---
