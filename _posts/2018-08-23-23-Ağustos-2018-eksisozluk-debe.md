...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    (bkz: <a class="b" href="/?q=johnny+sins">johnny sins</a>)<sup class="ab"><a title="(bkz: hiç birinde boş geçmiyor mübarek)" href="/?q=hi%c3%a7+birinde+bo%c5%9f+ge%c3%a7miyor+m%c3%bcbarek" data-query="hiç birinde boş geçmiyor mübarek">*</a></sup>
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    kariyeri zaten <a class="b" href="/?q=t%c3%bcrkiye">türkiye</a> <a class="b" href="/?q=g%c3%bczellik+krali%c3%a7esi">güzellik kraliçesi</a> olması ile başlamış kadın. neyin muhabbetini yapıyorsunuz?
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    kadın var, kadın var.<br/>kimi kendine kuaför sponsoru arar, kimi bebeği için damızlık arar. kimi de boşta kalmayayım bir an önce evleneyim diye ilk gözüne kestirdiğini kafalamaya çalışır.<br/>kimi gerçekten sevip ömrünü beraber geçireceği yoldaşını arar.<br/>çeşit çok. <br/>önemli olan senin ne istediğin delikanlı.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    herkes birini önermiş yeni seri çekilirse diye görüyor ve artıyorum o zaman, <a class="b" href="/?q=mike+ehrmantraut">mike ehrmantraut</a> babaya çeksinler, tarikat kur müridin olalım mike baba
  entry_channels: tv
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  80515618
  entry_writer: fakir degil fukara
  entry_fav_count: 0
  entry_content: |
    bir şeylere çakan
  entry_channels: anket,ekşi-sözlük
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    insan anlayamaz, bizim kafamız basmaz, biz salağız körü körüne inanırız sadece. aciz ve bilgisiz kafamızı, ufkumuzun yetmediği yerlere koyduğumuz yapay sınırlarla kısıtlarız çünkü. helal bize. <br/><br/>tanım: çözülemeyen amaçtır.
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    " yorgansız yatarım oğlansız yatmam" demiş bilmem kaçıncı murat
