...
- entry_name: |
    acil servis doktorlarının beceriksiz olması
  entry_id:  80515248
  entry_writer: melabaaa
  entry_fav_count: 151
  entry_content: |
    başkasının işi bilip bilmediğini bilmek icin o işi bilmek gerekir dediğim başlık.<br/><br/>acil servise gelenlerin yuzde 95 inin acil olmayan normal aile hekimleri trafindan cözülebilecek hastalıkları olduğunu bilmeyenler ahkam kesiyor.
  entry_channels: sağlık
- entry_name: |
...
- entry_name: |
    doktorların kibirli olması
  entry_id:  80522393
  entry_writer: affetmeyen genc
  entry_fav_count: 35
  entry_content: |
    "sen bana bakmak için okudun birader" <br/>hastaların kibir seviyesine yakın olan kibirdir.<br/><br/>(bkz: hastaların doktorları babalarının uşağı olarak görmesi)<br/>(bkz: <a class="b" href="/?q=doktorlar%c4%b1n+hasta+se%c3%a7me+%c3%b6zg%c3%bcrl%c3%bc%c4%9f%c3%bc">doktorların hasta seçme özgürlüğü</a>)<br/><br/>toplumun her kesiminde ve her durumda hizmeti alan taraf olabilecek en üst düzeyde hizmet almak ister. bu düzey insanların vicdanına göre değişir. toplumumuzun istediği doktor profili: çok para almasın, anası baba vefat etse bile bana güler yüzlü olsun, uyumasın, diğer hastalara değil bana öncelik versin, devlet parası deniz yemeyen keriz hesabı istediğim her ilacı bana yazsın, bir yandan nöbet tutsun bir yandan bana gülsün bir yandan da akşam eve gelince hiç yorulmadan tıp dünyasındaki yenilikleri takip etsin, ota boka izin almasın, hastalanınca rapor almasın, sigara wc molası vermesin vb.<br/>halkımızın istekleri bitmez. tamam. ok.
  entry_channels: sağlık
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 32
  entry_content: |
    kimsenin siklemediği whatsapp ve twitter gruplarında çük kadar beyinleriyle algı kastıklarını, gündem oluşturduklarını zanneden kekoların hedefindeki takım. sizi ciddiye alıp dava etmedikleri için kendinizi nimetten sayıp adam yerine koymayın.
  entry_channels: spor
- entry_name: |
    bafetimbi gomis
  entry_id:  80507048
...
- entry_name: |
  ...
  entry_fav_count: 26
  entry_content: |
    türkiye'de cinsellik, kadının erkeğe ödül olarak sunduğu bir eylemdir. <br/><br/>yani sen kadını besleyeceksin, hediyeler alacaksın, ilgileneceksin sonra da kadın kendisini sana ödül olarak sunacak ama yine aynı kadın kendisine it gibi davranan, hor gören, aşağılayan berkecan'a seks kölesi olacaktır.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    <a class="b" href="/?q=men+atat%c3%bcrk%27%c3%bcn+esgeriyem">men atatürk'ün esgeriyem</a> beyanı ile hatırladığımız değerli türk büyüğü.<br/><br/>ölüm yıl dönümünde ruhu bir kez daha şad olsun...
  entry_channels: siyaset,ekşi-sözlük,tarih,eğitim
- entry_name: |
    hıncal uluç
  entry_id:  80506047
  entry_writer: n8
  entry_fav_count: 16
  entry_content: |
    hayatinda hic birini sevmedigini ve kimse tarafindan sevilmedigini dusundugum kisi.<br/><br/>bir insanin her cümlesinden herhangi bir konuda her seferinde nefret damlar mi kardesim, damliyor iste.<br/><br/>defne joy olayina kadar ciddiye alinirdi ondan sonra 5 dk bile tahammül edilmeyecegi ortaya cikti.<br/><br/>bu, erman, reha, hasmet, sansal hicbirinin iyi birer insan olduklarini dusunmuyorum.
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    (bkz: <a class="b" href="/?q=koko">koko</a>)
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    gordugum kadariyla bu sezon da son hiz devam ediyor, genelde muhafazakar kesimde daha cok gozlemliyorum.
...
- entry_name: |
    rte'nin bu dünyaya dair hiçbir hırsının olmaması
  entry_id:  80528720
  entry_writer: french goddess
  entry_fav_count: 2
  entry_content: |
    olmayan hali bu ise, hırsı olsa tüm türkiye'yi yıkıp bütün ülkeyi saray yapardı heralde... neyse ki hırsı yok da aoç'deki ve marmaris'teki ağaç katliamlarıyla (1100 oda + 300 oda ile) yetindi; allah razı olsun..
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    çaylakların 5 para etmez kişiler olduğunu biliyordur
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    dekolte giyip göz kayması dahi olsa bakılması neden rahatsız ediyor.
  entry_channels: anket,ilişkiler,ekşi-sözlük
---
