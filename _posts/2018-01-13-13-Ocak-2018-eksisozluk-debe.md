...
- entry_name: |
    vekillerin diş implantı hakkının arttırılması
  entry_id:  73447668
  entry_writer: uff snne be slk
  entry_fav_count: 170
  entry_content: |
    yeterli bulmadığım uygulama. titanyum çene de dahil olsun. daha rahat kemirirler.
- entry_name: |
    ertuğrul özkök
  entry_id:  73444645
...
- entry_name: |
  ...
  entry_fav_count: 44
  entry_content: |
    bu seneki barcelona'ya karşı ronaldo ne yaptı ki bu maçta emre'den bir şeyler yapması bekleniyor.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    dünya’dan 400 km uzakta metal bir kutunun içinde (bkz: <a class="b" href="/?q=uluslararas%c4%b1+uzay+istasyonu">uluslararası uzay istasyonu</a>) sıkışıp kalmış olmanın ve çalışır durumda bir tuvalet olmamasının ne kadar korkunç bir şey olduğunu hayal edin. vakumlu bir idrar kavanozunu var çok sayıda tüp, pompa ve kablo bağlanmış. neden mi? çünkü idrarın içindeki suya ihtiyaçları var. <br/><br/>buradaki pompalar tıpkı yutak gibi çalışıyor, sistemdeki sıvıyı sıkıp itiyormuş. idrar tüplerden geçerek fırın büyüklüğündeki bir silindire girdiğinde buradaki vakumlu pompa içerideki havayı emerek basıncı ve böylece sıvının kaynama noktasını düşürüyor. yani hiç ısı uygulamadan su ayrıştırılmış oluyor.<br/><br/>bu damıtma yöntemiyle yapılan ayrıştırmada bir tarafta saf su, diğer tarafta da yoğun bir tuzlu atık ortaya çıkıyor. suyu astronotlar içiyor, atık ise işe yaramaz kapsüllere konularak dünya atmosferine girdiğinde yanarak yok oluyor.<br/><br/>yani sevgilinizle birlikte gece gökyüzünü izlerken, “aaa aşkım yıldız kaydı, dilek tutalım” romantizmini yaşarken dikkat edin. bir astronot dışkısına bakıyor olabilirsiniz. <br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="http://www.bbc.com/future/story/20150527-solving-a-space-stations-toilet-shaped-problem" title="http://www.bbc.com/future/story/20150527-solving-a-space-stations-toilet-shaped-problem">kaynak</a>
- entry_name: |
    ekşi itiraf
  entry_id:  73442332
...
- entry_name: |
    robin van persie
  entry_id:  73459033
  entry_writer: ayhankkk
  entry_fav_count: 10
  entry_content: |
    sağlık kontrolünden geçecekse transferine son ana kadar inanamayacağım profesyonel olmayan futbolcu.<br/><br/>fenerbahçe olarak milyon eurolara alınan futbolcuların çok mal durumlara geldiğini gördük fakat maldonado bile çalışıyordu, guiza desen öyle, yani simao bile geldiğinde bi şeyler yaptı kaç yaşına rağmen, van persie sanırım sadece fenerbahçe için değil türk futbol tarihinin gelmiş geçmiş en balon transferidir.
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    "her yerde tek bir adalet ilkesi vardır: <br/>güçlünün çıkarı." <br/><br/>platon
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    (bkz: <a class="b" href="/?q=allah">allah</a>)<br/><br/>kadrolu imamım...
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    suriyelilerin akın akın gelmesinden dolayı türkiye aşı takviminin 30 yıl geriye gitmiş olması.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.ntv.com.tr/saglik/kontrolsuz-multeci-girisleri-30-yillik-asi-takvimini-bozdu,PneSuYJO10uc_WWz4s7CNg" title="https://www.ntv.com.tr/saglik/kontrolsuz-multeci-girisleri-30-yillik-asi-takvimini-bozdu,PneSuYJO10uc_WWz4s7CNg">kaynak</a>
- entry_name: |
    şu anda çalan şarkı
  entry_id:  73442723
  ...
  entry_fav_count: 2
  entry_content: |
    (bkz: <a class="b" href="/?q=pentagram">pentagram</a>) - sonsuz
- entry_name: |
    iphone x
  entry_id:  73441781
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    allah kadar büyük bir işveren yok dünyada. ortadoğu cografyasında milyonlarca insan sadece bu tüzel kişinin adını kullanarak para kazanıyor. hatta bazıları dünyanın sayılı zenginleri arasına giriyor.
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    performans fiyat açısından sağlık sistemini örnek verebiliriz, ne sıra bekliyorsunuz (randevu alınca) ne de ciddi masraf oluyor, ayrıca aldığınız hizmetler de vasat ve üzeri durumda.
- entry_name: |
    koyu antoloji
  entry_id:  73451847
...
- entry_name: |
    herkes uyurken yapılabilecekler
  entry_id:  73443411
  entry_writer: pros
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=31+%c3%a7ekmek">31 çekmek</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  73459883
  entry_writer: turkcekarakteryazamadi
  entry_fav_count: 0
  entry_content: |
    sinirden oduna kafa atan panda ucurum da yokki atsin kendini
- entry_name: |
    korkudan alta sıçırtan bilgisayar oyunları
  entry_id:  73460116
  entry_writer: başlık taşıyan
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=en+iyi+korku+oyunlar%c4%b1">en iyi korku oyunları</a>)
---
