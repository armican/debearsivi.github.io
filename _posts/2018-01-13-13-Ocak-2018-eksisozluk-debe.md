...
- entry_name: |
  ...
  entry_fav_count: 39
  entry_content: |
    1903. entrym de size yazmak istedim.<br/><br/>iyi ki varsınız. <br/>siz olmadan rekabet olmazdı, trübün atışmaları, her maç için ayrı beste, her maç için birbirinden ayrı kareografi. <br/><br/>4 entry sonrada lacivert sarılara gidicem. <br/><br/>sevgiler.
- entry_name: |
    robin van persie
  entry_id:  73459243
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    (bkz: <a class="b" href="/?q=format%c4%b1n+alt%c4%b1na+s%c4%b1%c3%a7%c4%b1rtan+s%c3%b6zl%c3%bck+yazarlar%c4%b1">formatın altına sıçırtan sözlük yazarları</a>)<br/><br/>edit : başlık buralar dutluk iken "insanı altına şıçırtan bilgisayar oyunları" idi. benim serzenişim de bundan gayrı idi.
- entry_name: |
...
- entry_name: |
    ateizmi yaymanın mantık hatası olması
  entry_id:  73459889
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    şenol güneş forvetlere seviye atlatıyor diye önüne konacak yeni bir challenge gibi görünüyor. pas oyununa uygun değil, bel dönmüyor, mls'de bile tembel görünebilen bir adam. lukaku olsun diye beklerken eneramo çıkabilir bu çocuk. ben anlam veremiyorum.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    muhtemelen odtü mezunu olan ve "asgari ücret" yazamayan bir adet dalyarrağın troll denemesi.
- entry_name: |
    ludovico einaudi
  entry_id:  73456610
