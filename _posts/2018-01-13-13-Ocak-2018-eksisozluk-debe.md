...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    (bkz: <a class="b" href="/?q=erke%c4%9fin+poposu+yok+mu%3f">erkeğin poposu yok mu?</a>)
- entry_name: |
    tron coin
  entry_id:  73452682
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    --- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>zamanın mevcut akışını değiştirmek için yapılan her hamle zamanın tam da mevcut akışında olmasını sağlıyor. bir şeyleri değiştirmeye çalıştıkça hiçbir şeyin değişmemesini sağlıyorlar yani. geçmiş, gelecek ve şu an sürekli birbiriyle etkileşim halinde. yalnızca geçmiş geleceği değil gelecek de geçmişi şekillendiriyor. zamanı ileri ve geriye doğru değil döngüsel olarak tahayyül etmek gerek diziyi anlamak için. senaryoya göre insan iradesi bir ilüzyondan ibaret. <br/><br/>dizideki karakterlerden biri olarak düşün kendini. kendi iradenle aldığın bir karara göre bir eylem yapıyorsun ama o eylem sen daha onu yapmadan önce zaten yapılmıştı. senin yaptığın tek şey zaten yapılmış olanı tekrar etmek. yani senin kendi iradenle aldığını düşündüğün karar da zaten sen onu daha almadan önce alınmıştı. sonsuz bir tekrar ediş içindesin ve bu döngüden hiçbir kaçışın yok. bilakis kaçmak için sarfettiğin çabalar döngünün mevcudiyetini sağlıyor. <br/><br/>dizi sürekli kendi spoilerını veriyor.<br/><br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    hiç bir zaman ulaşamayacakları, ulaşsalar da ellerinde tutamayacakları hemcinslerimdir.<br/><br/>(bkz: <a class="b" href="/?q=mutlu+a%c5%9fk+yok+ki+d%c3%bcnyada">mutlu aşk yok ki dünyada</a>)
- entry_name: |
