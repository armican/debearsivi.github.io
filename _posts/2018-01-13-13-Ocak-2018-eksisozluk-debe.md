...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    bir <a class="b" href="/?q=sevildi%c4%9fini+bilmek">sevildiğini bilmek</a> değildir.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    yahu hayat çok kısa be abicim. para biriktireceğim diye kendinize eziyet etmeyin.<br/>çalışın para kazanın bunun karşılığı olarak da yiyin, için, gezin, eğlenin tadını çıkarın. ondan bundan kısıp şu kadar biriktirmek yerine varlığınızın dünya üzerinde ne kadar değerli olduğunu düşünün.<br/><br/>o elbiseyi alırsam ölür müyüm? yerine o elbiseyi alırsam ne kadar mutlu olurum? diye sorun kendinize.<br/>mutlu olun sizi ne mutlu ediyorsa peşini bırakmayın.
- entry_name: |
    şu anda çalan şarkı
  entry_id:  73442723
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=tanr%c4%b1lar+meri%c3%a7+istiyor">tanrılar meriç istiyor</a>)
- entry_name: |
    12 ocak 2018 savcılığın muharrem bebek kararı
  entry_id:  73456081
  entry_writer: sik kullanilanlar
  entry_fav_count: 0
  entry_content: |
    ohal'de bütün dosyaları aradan çıkarıyor devlet. gerçi devlet bile denmez artık bunlara.
---
