...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    gürültü yapan komşusunu uyaran gencin öldürülmesi
  entry_id:  91984469
...
- entry_name: |
    evcil köpeğe saldıran pitpull
  entry_id:  91987294
  entry_writer: mithradates pontus sovalyesi
  entry_fav_count: 132
  entry_content: |
    bazılarının “kim bilir ne yaptı da pitbull saldırdı” diye yaklaşacağı olay.<br/><br/>kayseri’de pitbullun paramparça ettiği kız çocuğu için bunu diyen hayvansever (!) şerefsizlere tanık oldu bu gözler.
  entry_channels: haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 102
  entry_content: |
    uçak gemisi uçuyorsa üzerinde tank taşısın bari.uçak taşıması saçma.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 33
  entry_content: |
    (bkz: <a class="b" href="/?q=sosyal+medya">sosyal medya</a>)<br/>(bkz: <a class="b" href="/?q=tinder">tinder</a>)<br/>(bkz: <a class="b" href="/?q=instagram">instagram</a>)<br/><br/>ve bilumum çöp uygulamalar. ulaşılabilirlik ilişkilerin belasıdır.
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    üç beş demeden destek olunması gereken yardım çağrısı. biz de antalya'da yaşayan ve annesi kansere yakalanan iki kız kardeştik. hikayemizim sonu güzel oldu. sizin için de aynısını dilerim.<br/><br/>iban numarasını yazmaya üşenenler için iban no: tr720001001963608631035001<br/>hesap sahibi: tuğçe kaya<br/>telefon no: 05326464244
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    - "çenenin yayını sikeyim harun, çenenin yayını sikeyim!!!"<br/><br/>- "la oğlum bak, amirim ondan habersiz böyle bir halt yediğimizi bir duyarsa hepimizi dazııır dazır siker..! " <br/><br/>- "yoook, sen bana hiç bir şey yapamazsın, yaparsan ben senin ağzını yüzünü sikerim...!" <br/><br/>tabi ki (bkz: <a class="b" href="/?q=behzat+%c3%a7.">behzat ç.</a>)
...
- entry_name: |
    1 temmuz 2019 benzin zammı
  entry_id:  92002636
  entry_writer: fovalio
  entry_fav_count: 1
  entry_content: |
    yakında 50 liraya 1 litre benzin alınacak.
  entry_channels: 
- entry_name: |
    trump vs putin vs kim jong vs erdoğan
  entry_id:  91999914
  entry_writer: sanfransiskolu mufettis
  entry_fav_count: 0
  entry_content: |
    sadece bir tanesini ülkesinde eleştirebilirsin, eleştirmek ne kelime, istersen maymun eder, yerin dibine sokar çıkarırsın. tabi ki bu kendisinin değil, ülkesinin sarsılmaz sisteminin sayesinde.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    tutmayacak siyasi partiye isim önerileri. bak bebek, milliyetçi + partiler bile seçmen bulabiliyorken sen bulamayacaksın, adım adım dinci patırtısın sen. iktidarken bile öyleydiniz, hala öylesiniz. patırtı kütürtü.
