...
- entry_name: |
  ...
  entry_content: |
    ...
    aktrolleri sevindiren iddiadır..<br/><br/>sen %100 emin misin fetöcü olduğuna?<br/><br/>yoksa gedikli takiyecilerden misin? yani bu bilgilere sahipsen demekki içerde dönen işlerden haberin var. lan yoksa abilik mi yapıyordu size? vay atillaya bak sen.
...
- entry_name: |
  ...
  entry_content: |
    ...
    olsa olsa yazarın göçmenler hakkındaki algısıdır.  <br/>çevremde ben bulgarım diyen bulgaristan göçmeni ne gördüm ne de duydum. hatta bulgar denmesi büyük hakaret sayılır. ayrıca göçmenlerin çoğunluğu türk milliyetçisidir.
...
- entry_name: |
  ...
  entry_content: |
    ...
    arkadaş bu tipler mağaradan yeni mi çıkıyor ben mi yeni görüyorum amk. adam bildiğin cumhuriyet devleti ele geçirdi dedi lan hahahaha. ulan bu devletin yönetim biçimi cumhuriyet zaten osmanlıda mı yaşıyor acaba hala? neyse kapattım ya. beynim örümceklendi.
...
- entry_name: |
    şeriatçılar neden arabistana göç etmiyorlar
  entry_id: 62726838
  entry_content: |
...
- entry_name: |
  ...
  entry_content: |
    ...
    buna çocuk gelin, çocuk istismarı gibi örnekler verenler türkleri 10 asırlık bir millet sanıyor herhalde. türkler'in çocuk istismarını mazur gören, küçücük kızlarla evlenme kültürünü yaratan, dışlarına bile yansıyan karanlık bir genetikleri ve zihinleri yoktur. türkler kadına, çocuğa, doğaya yönelik zulüm, aşağılama ve istismarda kendi seçtikleri yanlış lokasyonun kurbanıdır sadece. şu an düştükleri "kocasından dayak yiyip aptallaştıkça, yüzü gözü dağıldıkça, zavallılaştıkça kocasına daha çok bağlanan sefil kadın" gibi haline ben de üzülüyorum ama türkler'i başkasıyla karıştırmayın.
