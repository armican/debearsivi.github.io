...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    evde üşüye üşüye idareli kullandığımızda 200lira gelmişti, dedim sikerim anasını canımdan değerli mi, 400 geldi. nasıl olsa sokacaksınız, parasıyla değil mi amına koduklarım gönderin 1000 gelsin.
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    öyle olsun istemem ama potansiyel ahmet hakan izlenimi uyandırıyor.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    kenan çok bozdu bu kızı bi daha iflah olmadı.
...
- entry_name: |
  ...
  entry_id:  100381583
  entry_writer: cankoparan
  entry_fav_count: 0
  entry_content: |
    şimdi arkasına basılmış kundura hayal edin,<br/>işportadan alınmış 5 tanesi 5 lira erkek çorabı,<br/>ve kedili eve gelince, kedinin ayak kokusuna aşık olduğu bir doblolu eniştenin ayaklarını hayal edin.<br/><br/>şimdi dağılabilirsiniz.
  entry_channels: ekşi-sözlük
- entry_name: |
    ekşi sözlük dertleşecek insan veritabanı
  entry_id:  100382270
  entry_writer: soguktabircirkinkopek
  entry_fav_count: 0
  entry_content: |
