...
- entry_name: |
    sadece vize ve final öncesi ortaya çıkan tip
  entry_id:  67379091
  entry_writer: turkiyeden bikan pilot
  entry_fav_count: 54
  entry_content: |
    vize ve final öncesi derslerde ortaya çıkan tiplerdir.genelde erkek olurlar.<br/><br/>kendileri nadir gelişen osasuna atakları gibidir efendim dönem boyu gözükmez sınav öncesi gelip sağdan soldan not bulmaya çalışır.<br/><br/>sakallı bıyıklı, zayıf, 180 boylarında esmer bir tip olur genelde bu arkadaşlar.
- entry_name: |
...
- entry_name: |
    10 nisan 2017 kılıçdaroğlu habertürk showtv yayını
  entry_id:  67384692
  entry_writer: hep yer hep bakar
  entry_fav_count: 25
  entry_content: |
    bence show tv haber spikeri de ikna oldu.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    oha...az önce rüyamda çok net şekilde, sabah gazetesine ait şöyle bir başlık gördüm ""seçimde fetö parmağı"".<br/><br/>yemin ediyorum seçim oldu bitti ve hayır çıktı zannedip o sevinçle uyandım, hayatım boyunca bu kadar gerçekçi, adeta hd kalitede rüya görmüşlüğümün sayısı ya iki ya üçtür bu güne kadar. belki de günlerdir yapılan yayınlardan etkilendim ve bilinçaltım da bana "anca rüyanda görürsün bu sonucu" demek istedi, bilemiyorum.<br/><br/>birde ya 57 ya da 27 sayısını gördüm ama sevinme kısmıyla meşgulken kafam karıştı, unuttum...57 ise oyların oranı, 27 ise de herhalde haberin yapıldığı tarih filandır diye düşünüyorum (27 nisan vb.).<br/><br/>doğru çıkarsa gelir mehdiliğimi ilan ederim yalnız ona göre <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
- entry_name: |
    semih kaya
  entry_id:  67385635
...
- entry_name: |
    refah düzeyi arttı televizyonun girmediği ev yok
  entry_id:  67388710
  entry_writer: savaras
  entry_fav_count: 12
  entry_content: |
    peki reis de bizi görecek mi?<br/><br/>akp'den önce gaz lambasıyla oturduğumuz için insan merak ediyo vizontele nedir tam olarak.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    belki burayı okuyan 1-2 tane genel kurul üyesi vardır onlara sesleniyorum:<br/><br/>hepinizin sülalesini s*keyim. beceriksiz ibneler.
- entry_name: |
    dursun özbek
  entry_id:  67386102
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    celal'e büyük bir şapka giydirip kolormatik gözlük takarak 20 yıl gençleştirdiklerini(!) sandıkları dizi.<br/><br/>(bkz: <a class="b" href="/?q=flash+tv+ya%c5%9fland%c4%b1rma+tekni%c4%9fi">flash tv yaşlandırma tekniği</a>)<br/><br/>(bkz: <a class="b" href="/?q=i%c3%a7erde+gen%c3%a7le%c5%9ftirme+tekni%c4%9fi">içerde gençleştirme tekniği</a>)
- entry_name: |
    ekşi sözlük iş ağı
  entry_id:  67372047
  ...
  entry_fav_count: 2
  entry_content: |
    word ve pdf ile arası çok iyi, <br/>tamamı word ya da pdf veya bir kısmı word &amp; pdf olan dosyaları birleştirip başına içerik ekleyip basıma hazır kitapçık haline getirebilecek<br/>istanbul'da yaşayan<br/>maksimum 4 gün leventteki ofise gelebilecek <br/>maksimum 2 gün kendi evinden de çalışabilecek<br/>çalışma günlerini kendisi belirleyecek. ( sadece haftaiçi çalışalacak)<br/>13 - 20 nisan arası dilediği günler çalışacak.<br/>çalışma saatlerini kendisi belirleyecek ( 10:00 - 17:00 arası )<br/><br/>kişi aranmaktadır.. toplamda 6 farklı kitap dizini oluşturacak. toplam ödeyebileceğim bütçe 400 tl.<br/><br/>kişiye pc tedarik edilecektir. yanında bilgisini alıp gelmesi yeterlidir.<br/><br/>sadece talep edilen özellikle sahip olan kişilerin mesaj atmasını rica ederim.
- entry_name: |
    igor tudor
  entry_id:  67387595
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    ah benim bu nostalji tutkum...<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/5x7bN02CNuk" title="https://youtu.be/5x7bN02CNuk">yonca evcimik - tükendik</a>
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    doğru bir tespit. çağrı merkezinde çalışıyorum ben;<br/><br/>- iyi günler ben pba, size nasıl yardımcı olabilirim?<br/>+ ben doktor murtaza analyapar, elektrik yok.<br/>- yardımcı olmaya çalışayım, bölgeden ihbarlar geliyor ve ekip müdahale halinde yard...<br/>(sözümü kesiyor)<br/>+ böyle şey olur mu? doktorum ben ve elektrik yok.<br/><br/>içses; evde açık kalp ameliyatı yapacak pezevenk.<br/><br/>inanın yaşandı bu diyalog ve ne zaman doktor arasa tepkisi hep doktorluk üzerine. ben şahsen doktorlara sırf doktor oldukları için saygı duymama hakkımı kullanıyorum. insan olun.
- entry_name: |
    sözlükten erkek kaldırmanın çok zor olması
  entry_id:  67389033
  entry_writer: piruvikasit
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=k%c4%b1z+d%c3%bc%c5%9f%c3%bcrmek">kız düşürmek</a>)<br/>(bkz: <a class="b" href="/?q=erkek+kald%c4%b1rmak">erkek kaldırmak</a>)<br/>(bkz: <a class="b" href="/?q=nas%c4%b1l+s%c3%b6ylemler+bunlar+yahu">nasıl söylemler bunlar yahu</a>)
- entry_name: |
