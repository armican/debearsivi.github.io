...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    <a class="b" href="/?q=dark">dark</a> dizisini anlamaya calismak. gerilim, heyecan, gizem surekli bir seyler oluyor ama ben bir turlu parcalari birlestiremiyorum. siz de birbok anlamadiginizi soyleyin lutfen, yoksa gerizekali olduguma inanmaya baslayacagim. dizideki emin oldugum tek sey jonas'in sari yagmurlugu cunku.
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    türkiye'de en güzel kızların çerkeslerden çıkması
  entry_id:  99119232
  entry_writer: kuduzdoktorhektor
  entry_fav_count: 9
  entry_content: |
    (bkz: <a class="b" href="/?q=t%c3%bcrkan+%c5%9foray%c4%b1n+g%c3%bczel+san%c4%b1ld%c4%b1%c4%9f%c4%b1+%c3%bclke">türkan şorayın güzel sanıldığı ülke</a>)<br/><br/>şoray uzun bundan güzeldir mk.
  entry_channels: anket
- entry_name: |
    sigarayı bırakmak
  entry_id:  99093282
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    burdaki abazaların sorularını cidden cevaplamak için düşünüyor musunuz ?
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    hüseyin göçek’in galatasaray aleyhine hatalı penaltı verdiği konyaspor maçının asistan var hakemi. <br/><br/>mitroglou’nun son dakika golüyle kazandığımız akhisar maçında da maçın sonunda galatasaray’ın attığı tertemiz golü izlemesi için hakemi var odasına çağırmıştır.<br/><br/>önceki sezon kupadaki bucaspor maçında tolga’ya tekme atıp boğazını sıkan emre toraman’a da kırmızı vermeyen bu arkadaş, yasin’e aynı maçta yapılan net penaltıyı da esgeçmişti.
  entry_channels: spor
- entry_name: |
    younes belhanda
  entry_id:  99121463
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bu yaz trafik kazasında hayatını kaybeden, yerine yüz ameliyatı ile <a class="b" href="/?q=erhan+naml%c4%b1">erhan namlı</a> geçen hücum oyuncumuz.
  entry_channels: spor
- entry_name: |
    ekşi sözlük dertleşecek insan veritabanı
  entry_id:  99092820
  entry_writer: acandiyebiri
  entry_fav_count: 0
  entry_content: |
    derdine derman, katline ferman arayanlar yeşillendirebilir.
  entry_channels: anket,ilişkiler,ekşi-sözlük
---
