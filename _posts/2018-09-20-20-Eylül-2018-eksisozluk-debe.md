...
- entry_name: |
  ...
  entry_fav_count: 33
  entry_content: |
    -seni seviyorum.<br/>+bir şekilde herkes birilerini seviyor.
  entry_channels: anket,ilişkiler
- entry_name: |
    aykut kocaman
  entry_id:  81445170
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    kendisini evcil hayvan zanneden kadın beyanı. hayatı boyunca elle tutulur hiçbir başarısı olmayan; cebine parasını babasının koyduğunu, altındaki donu bile annesinin yıkadığını düşündüğüm insanlardır bunlar. parazit gibi çoğalır, sosyal medyada zehirli düşüncelerini serbestçe etrafa saçar, whatsapp gıybet gruplarında diğer kızları ağlarına düşürür, kadın programlarında gördükleri kıyafet ve ev eşyaları için ruhlarını satarlar. <br/><br/>evlenilmemesi gereken, azalarak değil birden tükenmeleri gereken insanlardır. ama malesef bizim abaza erkeklerimiz bunların kıçlarını kaldırıyor ve kendilerini nimetten saymalarına neden oluyorlar.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    türk futbolunun içine etmekle kendini görevlendiren iki futbol katilinin karşılaştırmasıdır.
  entry_channels: spor
- entry_name: |
    atilla yeşilada
  entry_id:  81429814
  ...
  entry_fav_count: 2
  entry_content: |
    şunlar, şunlar yapılmaz ise dolar 12 lira.<br/><br/>şunlar şunlar yapılırsa dolar 5,5 lira.<br/><br/>hangi söylemi kullanırsınız? olumluyu mu vurgularsınız? olumsuzu mu?<br/><br/>havuç mu? değnek mi? söyleyin, hangisini kullanırsınız?<br/><br/>yukarıdaki suserlerin odaklandıkları yere bakın: bir tahmin/öngörüyü bağlamından sıyırıyorlar ve öngörü gerçekleşmedi buyuruyorlar, allah bildiği gibi yapsın.
...
- entry_name: |
    patron
  entry_id:  81440069
  entry_writer: fake plastic free
  entry_fav_count: 0
  entry_content: |
    eminem'in kamikaze albümüyle yakaladığı diss hype'indan ekmeğini çıkaracak arkadaşımız, yolu açık olsun. piyasanın kızışması ve bunun etkisiyle çıkacak güzel işleri görmek için sabırsızlanıyorum.<br/>yine de eminem'in albüm sonrası sway ile yaptığı röportaj serisini izleyenler fark etmiştir, oradaki sanatçıların beslendikleri kaynaklar çok farklı. bizim müzik sektörümüzde patron ve benzeri isimler kuru ekmeğe tamah ediyorlardı ve trapçiler piyasaya girince renk geldi. konserleri dolmaya başladı. bu tip popülizm taşlamaları ister istemez miyadi dolmuş yaşlı solcuların beylik laflar etmesi gibi geliyor.
  entry_channels: siyaset,müzik,edebiyat,yeme-içme,moda,ekonomi
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    büyüklük takıntısı olan adamlar daralmayı göze almazlar.<br/>zamanında yapılsaydı neyse. asgari ücret 1500 olunca demiştim enflasyon getirir peşine kriz diye güldüler. her şey bir kelebeğin kanat çırpmasına bakıyor. elbette tek sebep bu değil ancak etkili. <br/><br/>vahşi doğada hayatta kalmak için enfeksiyon kapan bacağınızı kemerle sıkıp baltayla kesmeniz lazım, aksi takdirde acımazlar.
  entry_channels: ekonomi
---
