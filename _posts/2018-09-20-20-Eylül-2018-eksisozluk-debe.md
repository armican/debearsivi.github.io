...
- entry_name: |
  ...
  entry_fav_count: 37
  entry_content: |
    adam dünyanın bir ucunda kırmızı kart görüyor, mağdur olan yine bizim tinerciler. efsanesiniz.
...
- entry_name: |
  ...
  entry_fav_count: 28
  entry_content: |
    fransızca'da özledim denmezmiş. <br/>onun yerine, bende eksiksin denirmiş.<br/>sende olan giderse eksikliğini hissedersin ancak. <br/>kolun gibi, bacağın gibi, gözün gibi, tenin gibi.<br/>sende değilse o, eksiksin demezsin. <br/>özlersin en fazla..<br/><br/>hikmet anıl öztekin<br/><br/>fesleğen
  entry_channels: sanat,edebiyat,spoiler
- entry_name: |
    15 temmuz gecesinden akılda kalanlar
  entry_id:  81440159
  entry_writer: luis alonso
  entry_fav_count: 28
  entry_content: |
    bizim patron "helal olsun koçlarıma, biliyordum ulan bu ülkenin sahipsiz olmadığını. benim askerim vatanını kurtarıyor sonunda. aslanlarım benim" diye inletiyordu oteli. 2 gün sonra otelin önüne "milletimizin ve reisimizin yanındayız" yazılı dev bir erdoğan posteri astırdı. ulan patron :)
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    kız anlıyor ki dünyalar ayrı ali'ye kibarca bir bye bye<br/>ali diyor hay hay<br/>gözü parlıyor aniden kızın, şeytan tüyü var bu hınzırın<br/><br/>(bkz: <a class="b" href="/?q=ali+desidero">ali desidero</a>)
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    2 gün sonra <br/>ya gırgırına bi profil oluşturdum amma abarttın <br/><br/>4 gün sonra<br/>ya geyik olsun diye mesajlaşıp işletiyorum adamları<br/><br/>6 gün sonra<br/>ya geyik olsun diye buluşma ayarlıyıp gitmiyorum <br/><br/>8 gün sonra<br/>çok pişmanım bi hata yaptım beni affet
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    o kadar belli ki daha çocuk olup izlediginiz filmlerden etkilenip buraya 10 küsur maddelik bir kompozisyon yazdığınız. <br/><br/>herseyi anlatmışsın kendi dünyanca ama nerede uyuyacağım? hasta olursam ne halk edeceğim? sokakta başıma bir şey gelirse ne yapacağım? acil bir durum olursa evime nasıl dönebilirim?... gibi şu an aklıma gelmeyen bir çok bir sürü sorunun hiçbiri yok kafanda maalesef. bu gerçekten üzücü.<br/><br/>3 kıtada 3 ayrı ülkede+ 5 yıldır çalışıyorum. ben sana söyleyeyim o bilekliği gitarının sapına takar gitarıda omzuna verirler kara kalem başta olmak üzere bütün pastel renklere boyar şansın varsa ülkene döner yoksa o ülkede bir renk olarak kalırsın maalesef. senin adına üzgünüm biraz emek sarfedip yurtdışı bağlantılı şirketlerde iş aramalısın yoksa sonun hazin.
  entry_channels: 
- entry_name: |
    atilla yeşilada
  entry_id:  81448994
...
- entry_name: |
  ...
  entry_id:  81430002
  entry_writer: munchausenbyproxy
  entry_fav_count: 6
  entry_content: |
    orijinal yapımcılarının tam kontrolü elinde bulunduracağı bir "live action " versiyonunun netflix tarafından yapılacağı açıklanan efsane dizi.<br/><br/>umutlarım yüksek.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    rekabetin en yüksek olduğu ligte geleni geçeni deviren m. city ve guardiola'ya overrated diyorlar. yeminle bunlar ıslah olmaz.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    belhanda, sinan gibi isimlerin bu kadar şans bulabildiği bir takımda hiç tercih edilmemesi şaşırtıcı olan futbolcu. <br/><br/>ozan tufan gibi mi yapıyor antrenmanlarda napıyor acaba? fatih terim sırf gitmeyi reddetti diye bir futbolcunun üstünü çizmez tahminimce, her zaman eldeki kadrodan en yüksek verimi almaya çalışır. ha oynadı, ha oynayacak derken formayı unuttu adam. hocamın hiç inancı kalmadı sanırım kendisine. bu gidişle satamayız da...
  entry_channels: spor
- entry_name: |
