...
- entry_name: |
  ...
  entry_fav_count: 160
  entry_content: |
    sarhoşken denmez hayvan herifler, alkollüyken diyeceksiniz.<br/>sarhoşlukla alkollü olmanın farkını öğrenin, gerçek hayatta da çok işinize yarar.
...
- entry_name: |
  ...
  entry_fav_count: 85
  entry_content: |
    (bkz: <a class="b" href="/?q=y%c4%b1lan+yap+kendini">yılan yap kendini</a>)
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    2018 ekonomik krizi özellikle akp seçmenini vurdu
  entry_id:  81440965
...
- entry_name: |
  ...
  entry_fav_count: 32
  entry_content: |
    “değer verdiğin, sevdiğin insanlara karşı zor olmamak için kendini o kadar basitleştiriyorsun ki; bir süre sonra sana değer vermeye, saygı duymaya gerek duymuyorlar.”
...
- entry_name: |
  ...
  entry_channels: siyaset,haber,ekonomi
- entry_name: |
    hukukçularla tartışmanın imkansız olması
  entry_id:  81448390
  entry_writer: illuminatinin basindaki adam
  entry_fav_count: 3
  entry_content: |
    ne zaman bir hukukçuyla tartışmaya kalksam tekrar tekrar yüzüme tokat gibi inen hadise. arkadaş bir insan hiç mi var olan hukukun ötesinde düşünemez? hiç mi pozitif hukukun ekseninden çıkamaz? her şeyi var olan hukukla yargılarlar, yok bilmem ne yasasının bilmem ne fıkrasına göre bu yasak, yok hukuka göre şunu yapmak yasal değil bilmem ne. bunu konu var olan yasaları sorgulamak olduğunda veya ideal durumun ne olduğunu tartıştığınızda bile bu huylarını bir kenara bırakamazlar. <br/><br/>ben inanıyorum ki cehennemin en azından bir katında verilecek ceza sürekli olarak bir hukukçuyla tartışmak zorunda bırakılmak. allah sizi ıslah etsin ne diyim.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    insanların günahına giriyorsunuz!<br/><br/>ne belli bunun bir soyadı benzerhahuhahaeah. <br/><br/>way amk yaa. çaycıyı falan da araştırın lan kesin vardır bir akrabalığı muahahaha.<br/><br/>yemin ediyorum helal olsun. vallahi aferin. sülalecek bilim üretin amk.
