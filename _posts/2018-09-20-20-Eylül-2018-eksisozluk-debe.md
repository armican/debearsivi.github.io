...
- entry_name: |
  ...
  entry_fav_count: 27
  entry_content: |
    şu küçük kız ve ağlak suratı bıktırdı artık
  entry_channels: tv
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    yılan hikayesinde ben ve ailem için unutulmazı polis balosu.<br/>hatırlarsanız ilk bölümde bir polis balosu lafı çıktı ortaya 30 bölümmü geçti 40 bölümmü geçti ne her bölümde bahsi geçen balo bir türlü gerçekleşmedi.<br/>o günden sonra aile olarak bir türlü gerçekleşmeyen şeyler için hep "bu işte polis balosu işine döndü" tabiri kullanırız
  entry_channels: anket,tv
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    hayatımda gördüğüm en saçma kartı gördü. hiçbir anlamı yok hiçbir. hatta ingiliz spiker bile ortalığı yıktı “there’s nothing on that” diye.<br/><br/>resmen doğradılar adamı. şu pozisyonu görünce cidden real madrid geldi aklıma. aynı pozisyonu orada yapsa ki zamanında takım arkadaşları daha ağırlarını yaptı, görür müydü acaba kart.<br/><br/>ulan ramos salah’ı hastanelik etti final maçında, kart görmedi.
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    sesi itici olan şarkıcılar
  entry_id:  81452533
  entry_writer: oturan mirket
  entry_fav_count: 5
  entry_content: |
    açık ara (bkz: <a class="b" href="/?q=aydilge">aydilge</a>) +1 diyorum. yazarken bile sinir oluyorum.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    girileri başlığa gözüm çarptıkça okuyorum, az çok analiz yapabilecek düzeydeyim. biraz kabalaşabilirim, ama bu tespiti yapmak zorundayım. başlıktaki ana fikir şu ''derdini dinlerim, ama sikerim''.<br/><br/>insanın anası babası bile dert dinlemiyor, eloğlu acır mı sana bacım? sen eloğlunu bilmezsin, ben bilirim eloğlunu, eloğlu aslında benim ya neyse..<br/><br/>kadınların en savunmasız, en korunmaya muhtaç olduğu dönemler, aynı zamanda kendilerini en kolay cinsel olarak sunacakları dönemdir. o dönemlerde iyilik gördükleri erkeklere karşı cinsel ödüllendirme isteği duyarlar. bunu bilen arkadaşlarımızda oltayı atıp bekliyorlar başlıkta.<br/><br/>aklıma gelmişken sorayım, erkek erkeğe dertleşen var mı? daha doğrusu, erkek olduğunu anladığınız yazarla muhabbeti devam ettiriyor musunuz?
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    ios 12
  entry_id:  81438899
  entry_writer: isinlamayan skati
  entry_fav_count: 1
  entry_content: |
    2018’de bilgisayarında olmasa yokluğunu nerdeyse hissetmeyeceği flash player’ı isteyenleri memnun etmeyen güncelleme. adobe’un kendisi flash’ı salmış apple bu saatten sonra niye şimdi koysun telefona
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    avatar serisindeki ırk yelpazesinin azlığını düşünecek olursak (zenci yok mesela koca seride) bu yeni halinde mutlaka olacaktır. başka eksik düşündüklerini de ortaya çıkaracaklardır.
  entry_channels: tv,sinema,spoiler
- entry_name: |
    yurt dışında çalışmanın yolu
  entry_id:  81453428
  entry_writer: zeki yakisikli zengin
  entry_fav_count: 0
  entry_content: |
    başlık sahibinin bildiği türkçeden daha fazla ingilizce biliyorum. baştaki aşamaları atlayıp doğrudan ingilizce öğretmeni nasıl olabilirim merak ettiren başlık.
  entry_channels: 
- entry_name: |
    içinde eşek kelimesi geçen atasözleri ve deyimler
  entry_id:  81449417
  entry_writer: ichimaera
  entry_fav_count: 0
  entry_content: |
    eşeğe diken, insana siken yaranır.
...
- entry_name: |
    19 eylül 2018 manchester city lyon maçı
  entry_id:  81452860
  entry_writer: gunlerdenbugun
  entry_fav_count: 0
  entry_content: |
    city'nin savunmada bir anlık hatasını iyi değerlendiren lyon golü buldu. 26. dakika cornet
