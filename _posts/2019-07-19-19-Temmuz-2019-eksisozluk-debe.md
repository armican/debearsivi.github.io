...
- entry_name: |
  ...
  entry_fav_count: 97
  entry_content: |
    şu an evimde yavrularımla 12 kedi var. kumları otomatik kendini temizliyor yetmiyor üzerine günaşırı temizlik yapıyorum bütün bu emeğin verdiği yetkiye dayanarak kokan götünüzdür diyorum.
...
- entry_name: |
  ...
  entry_fav_count: 68
  entry_content: |
    babamı arayıp “kızınız çok başarılı olacak bize emanet edin hem kız ve erkek öğrencilerimiz ayrı eğitim görüyor” demeleri, babamın “iran mı lan burası” diyip kapatması..
...
- entry_name: |
  ...
  entry_fav_count: 36
  entry_content: |
    vucudumuz bunun için uygun değildir, diğer canlılara baktığımızda kürkleri, pençeleri, sivri dişleri var biz ise çaresiz işte bu çaresizlik beynimizi geliştirdi bugüne gelmemize sebep oldu. <br/><br/>çıplak kalsak en fazla 1 saat içinde güneş derimizi yakmaya başlayacaktır, kış olsa zaten direnmemiz çok zor. yürürken ayaklarımıza onlarca şey batacaktır vs vs. <br/><br/>sağlıkla tabiatla bütünleşmeyle filan da bir alakası yoktur. <br/><br/>çok fazla isteyen yağmurlu havadalarda çamur üzerinde çıplak ayakla yürüyebilir, ormanda takılabilir vs vs ama bunu tüm gün yapmak sağlıklı bir şey değildir.
...
- entry_name: |
  ...
  entry_fav_count: 22
  entry_content: |
    ağzına sıçın, feleğini şaşırtın, hayatını sikin.<br/><br/>yine de gitmiyosa seviyodur.
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    online bilgisayar oyunu oynamak. league of legends, counter strike gibi hatta fifa ve ufc gibi ps oyunları da öyle.<br/><br/>arkadaş grubuyla oyun oynamak, tanımadığın onlarca insanla oyun oynamaktan çok daha eğlenceli bence.
  entry_channels: anket
- entry_name: |
    ekşi itiraf
  entry_id:  92747136
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    hafif düzeyde otizm olan 6 yaşındaki bir ögrenci ozgurgencc öğretmenim sen harika bir öğretmensin dedi. mesleğim psikolog sevınsen mı üzülsem mi bilemedim ama su konuda vicdanım rahat elimden geldiğince güzel iletisim kurup ögrencilere bir seyler kazandırmaya çalışıyorum.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  92778673
  entry_writer: mark ford
  entry_fav_count: 4
  entry_content: |
    stevie ray vaughan<br/>joe bonamassa<br/>rory gallagher<br/>yavuz çetin
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    bilim teknik dergisinin verdiği gözlükle izlemiş nesildir ayrıca. bilen bilir. o dönemlerin en gözde bilim dergisi idi. özellikle benim için şuanki google dan daha değerlidir kendileri.
  entry_channels: anket,bilim,tarih
- entry_name: |
    üstteki bilmeceyi cevapla ve yenisini sor
  entry_id:  92778486
  entry_writer: suleimanthemagnificent
  entry_fav_count: 0
  entry_content: |
    cumartesi<br/><br/>bilmece bilmiyorum
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    istanbul göztepe civarındaki işyerimize ofisboy arıyorum.<br/><br/>en önemlisi ekşi yazarı olmalı (ekşi dayanışması)<br/><br/>mümkünse devam zorunluluğu olmayan öğrenci olsa süper olur.<br/><br/>ehliyeti olmalı ve aktif olarak araç kullanabilmeli.<br/><br/>müşterilere kestiğimiz faturaları götürecek,<br/><br/>aşçımızın alışverişleri için onu market &amp; pazara götürüp eşyaları ofise getirmeye yardım edecek,<br/><br/>temizlik gıda gider faturalarımızı &amp; fişlerimizi kayıt altına alacak,<br/><br/>prensipli, çalışma saatlerine dikkat edecek,<br/><br/>ofisin genel olarak idari işlerine bakacak, eksilen - biten - azalan malzemeleri takip edip temin edecek<br/><br/>özetle bizim elimiz kolumuz olacak.<br/><br/>iyi langırt oynayacak (opsiyonel)<br/><br/>sigortalı şekilde asgari ücretle çalışacak<br/><br/>cumartesi - pazar tatil<br/><br/>şirkette her öğlen yemek çıkıyor.<br/><br/>tüm bunlara uyan kabul eden dürüst arkadaş varsa yeşillendirin lütfen
  entry_channels: ekşi-sözlük
---
