...
- entry_name: |
    cumhurbaşkanımızla ilgili konularda soru sorulamaz
  entry_id:  70682906
  entry_writer: spiritus sanctus
  entry_fav_count: 175
  entry_content: |
    "evet" verilen referandum maddelerinden biri ve an itibariyle türkiye cumhuriyeti kanunudur.<br/><br/>yeni mi fark ettiniz?<br/><br/>hayırlı olsun.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    trabzon meydan'da yakın bi arkadaşımın kuruyemişçi dükkanı var. kap bildirimini filan siktir edin, o dükkana gelirse bu transfer bitmiştir. <br/><br/>kim o dükkana gelip uzun süre takılıp bir şey sipariş etmeden çıkıyorsa, o adam transfer oluyor diyor arkadaş. geçen esteban diye bi eleman geldi, kaleciymiş, bizim buraları çok sevmiş, kesin alırız bunu dedi. lan adam 3 senedir zaten bizde oynuyor diyemedim.
- entry_name: |
