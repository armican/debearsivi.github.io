...
- entry_name: |
  ...
  entry_fav_count: 155
  entry_content: |
    nasıl yüzüstü uyuduğu merak edilen kadındir. <br/><br/>yastık kullanmıyoruz. birini kafamızın altına, diğerini pike niyetine üzerimize çekiyoruz.<br/><br/>mesaj olayını düşünmemişim lan ben. delirdiniz mi amk. gerçek değil la, espri yaptım. bir sakinlesip, olaysız dağılalım genşler<br/><br/>en koptuğum, kontrol altında tutmak zor olmuyor mu sorusu oldu. tasmayla gezdiriyorum <sup class="ab"><a title="(bkz: hdhfhfjfj)" href="/?q=hdhfhfjfj" data-query="hdhfhfjfj">*</a></sup>
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    17 kasım 2019 alanya'da yaşanan motosiklet kazası
  entry_id:  97917836
  entry_writer: heavyvehicle
  entry_fav_count: 14
  entry_content: |
    bir vicdansız piçin eğlencesi neticesinde olan kadıncağıza olmuştur. çarpan orospuçocuğu geberseydi en azından ölüsünün arkasından etseydik şu küfürleri. <br/><br/>katilsin olm. senden daha orospuçocuğu birileri çıkıp da seni serbest bırakır belki birkaç yıl içinde. ama sen nereye gidersen git keyfi için cana kıyan bir piçsin bundan sonra.
  entry_channels: haber,motosiklet
- entry_name: |
    menzil'de çobanlık yapan üst düzey bürokratlar
  entry_id:  97902875
  entry_writer: aklazarar
  entry_fav_count: 12
  entry_content: |
    vay amk menzil şeyhiyle anıtkabir'i eş tutanlar var. vay amk.<br/><br/>edit: alakalı entry uçmuş. menzile gidenle anıtkabire giden aynıdır diyordu.
  entry_channels: siyaset,haber
- entry_name: |
    2020 yılında halen ingilizce bilmeyen insan
  entry_id:  97915314
  entry_writer: calistopace
  entry_fav_count: 8
  entry_content: |
    kuzenimdir. kendisi 9 aylık. ne ingilizce ne türkçe biliyor. yazık yazık. kendisine sorsan suçu eğitim sistemine atar. biraz kendinizi geliştirin kardeşim. sene 2020 2020
  entry_channels: 
- entry_name: |
    2019 brezilya gp
  entry_id:  97916957
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    şu en üstteki abaza , vasıfsız , tek derdi seks olan arkadaş her gün burada ilk entry'i yazıyor.. acınacak halde
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  97915873
  entry_writer: 001001001001
  entry_fav_count: 5
  entry_content: |
    -dünya geoit değil, kayısı şeklindedir.
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    sana benzemekten çok korkuyorum.
  entry_channels: anket,ilişkiler,edebiyat
- entry_name: |
    yürüyerek nepal'e giden kadının türkiye'ye gelmesi
  entry_id:  97919628
  entry_writer: insan donuna girmis telli turna
  entry_fav_count: 2
  entry_content: |
    polis koruması eşliğinde ülkeden sağ salim çıkması sağlanması gereken aktivist.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    sevgili imamoğlu istanbul’un bir çok bölgesinde ibb’ye ait sosyal tesisler var neden bunların bir yenisi bu bölgede olmasın, yanında yakınında hiç bir şey yok ve insanlar gelen eş dost akraba vb. kişileri aç susuz yol kenarlarında beklemekte. bunların yanında havalimanıyla dolaylı yoldan bağlantısı bulunan bir çok insan için fahiş fiyatlar ödeneden karnını doyuracağı çay kahve içebileceği bir sosyal tesis kış aylarınında yaklaşması sebebiyle ihtiyaç haline gelmiştir. umarım yakın bir zaman da böyle bir yapı görürüz
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    bu gözler rehberde <a class="b" href="/?q=ahiretli%c4%9fim">ahiretliğim</a> diye kayıtlı sevgili gördü.
  entry_channels: anket,ilişkiler
- entry_name: |
    sebastian vettel
  entry_id:  97919293
  entry_writer: kingdom xxx
  entry_fav_count: 1
  entry_content: |
    git emekli ol be amin oğlu. albon sikigine geçildin, yine kocan hamilton'i korudun. leclerc'i yariş dişi birakip öne doğru baski yapmasini engelledin. nasil bir spastiksin sen?<br/><br/>yariş dişi kalmasi bile kocasinin isine yaradi, hemen pite girdi çakal. allahim kafayi yiyeceğim. su adama tahammul edemiyorum artik.
  entry_channels: spor,otomotiv
- entry_name: |
    modern insanın en büyük problemi
  entry_id:  97918789
  entry_writer: johannesrommel
  entry_fav_count: 1
  entry_content: |
    çok fazla nedeni var. ama ilk aklıma gelen çok ama çok hızlı tüketim.
  entry_channels: anket,ilişkiler
- entry_name: |
    akp den sonra ne olacak
  entry_id:  97919470
  entry_writer: blackshark
  entry_fav_count: 1
  entry_content: |
    benzeri için aziz yıldırım sonrası fenerbahçe örneğine bakılabilir.
  entry_channels: siyaset
- entry_name: |
