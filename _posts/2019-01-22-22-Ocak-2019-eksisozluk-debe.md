...
- entry_name: |
  ...
  entry_fav_count: 28
  entry_content: |
    cemal süreya gibi.<br/>"dökmeye niyetim yok içimi,<br/>zor sığdırdım zaten".
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    bu filmi begenmeyenlere üzülürüm sadece. neymiş, <a class="b" href="/?q=16lik+ergen">16lik ergen</a>imiz yarısında kapatmış filmi. dayanamamış absürtlüğe. sen izleme zaten ulan ayı.<br/>edit: ilgili entri: <a class="b" href="/entry/85774233">#85774233</a><br/>ayrıca (bkz: <a class="b" href="/?q=entry+ve+nick+uyumu">entry ve nick uyumu</a>)
  entry_channels: sinema
- entry_name: |
    2019 grip salgını
  entry_id:  85772342
  entry_writer: simdikizaman
  entry_fav_count: 15
  entry_content: |
    asosyalliğim sayesinde bu sene uzak kaldığım grip türü.
...
- entry_name: |
    günümüz şartlarında ikinci çocuğa cesaret edememek
  entry_id:  85762326
  entry_writer: kulekcioglu
  entry_fav_count: 11
  entry_content: |
    iki kardeşim var ve işçi babamın bizi büyütürken yaşadığı zorluklara şahit oldum. en büyük çocuk olduğum için de bir devlet lisesinde yatılı okumak zorunda kaldım. daha iyi okulları da kazandım ama babamın “senden sonra iki kardeşin daha var, o okullara gidersen seni okutamam” deyişini unutamıyorum. sevmediğim bir mesleği maddi imkansızlık nedeniyle yıllardır yapıyorum. şimdilerde meslek değiştirmeye çalışıyorum. bir oğlum var ve ona babamın bana söylediğini söylememek için ikinci çocuğu düşünmüyorum. onun sevgisi bize yeter, maddi imkanlarımız da ona yetsin istiyorum.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    hadi ben kırıldım,<br/>toparlamak gelmedi mi aklına?
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    bugün fenerin başında olsaydı 2018-2019 sezonu iptal edilmiş, şubat itibariyle 2019-2020 sezonunu sıfırdan başlatmıştı, fenerin düşme hattında olduğu bir ligi oynatmaz bu adam.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    monosodyum glutamat'ların, e300'lerin havada uçuştuğu bir firmanın kola markasını değiştirmesi durumudur. yiten bişiy yok. <br/><br/>adana kebap, iskender, paça, şırdan, lahmacun, pide gibi şeyler yerine bunları yediğim gençliğime yazıklar olsun.
  entry_channels: 
- entry_name: |
    galatasaray
  entry_id:  85753684
  ...
  entry_fav_count: 6
  entry_content: |
    bir arkadaş futbol konusunda konuşmaya götü yemeyeceği için futbol dışında yatırım ya da başarı olmadığını iddia etmiş (futbol için de laf atmış da konuşmaya bile değmez, avrupa'daki futbol başarılarını yazsak çok uzar zira, onun yerine (bkz: <a class="b" href="/entry/53836125">#53836125</a>) der geçerim) . çok uzatmıyorum mevzuyu;<br/><br/>(bkz: <a class="b" href="/?q=18+nisan+2018+galatasaray+avrupa+%c5%9fampiyonu">18 nisan 2018 galatasaray avrupa şampiyonu</a>)<br/><br/>hadi şimdi siktir git...
  entry_channels: spor
- entry_name: |
    sadık çiftpınar
  entry_id:  85771862
  entry_writer: alptugk
  entry_fav_count: 5
  entry_content: |
    bugün bursaspor maçında olumlu sinyaller veren stoper.
  entry_channels: spor
- entry_name: |
    ersun yanal
  entry_id:  85773340
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=jeDBZpT7-RI" title="https://www.youtube.com/watch?v=jeDBZpT7-RI">simge - üzülmedin mi?</a><br/><br/>vuruldum<br/>aynı yerden üst üste vuruldum<br/>ama sustum<br/><br/>dağıttın hayatımı <br/>beni ağır yanılttın <br/>acım oldun<br/><br/>ve gördüm gerçeği<br/>içindeki seni<br/>buna rağmen tutuyordum o soğuk ellerini <br/>gidiyordum kaç defa <br/>ama tuttum kendimi<br/>yapamazdım, acıtamazdım asla senin gibi
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    klozete otururken saç kurutma makinesini açmak.
