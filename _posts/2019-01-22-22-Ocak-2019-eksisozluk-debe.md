...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    hasta rezaleti 10/10.<br/><br/>influenza genel olarak gribe verilen addır. normal gribin de ölüm riski vardır ama grip olduğunuz için "domuz gribinin bir versiyonuna yakalandım, ölümden bitki çayıyla döndüm." demek en hafif tabirle cehalettir.
  entry_channels: sağlık,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    sikimin efsanesi olan futbolcu. yakın zamanın efsaneleri ; hagi ve alex. takım geriye düştüğünde diğer oyuncular ve taraftarlar gözlerinin içine bakarlar bizi kurtar diye kurtar diye. onlarda sorumluluk alır, kurtarır.<br/><br/>beşiktaş'ta kimse q7 ye bakamaz. çünkü takım geriye düştüğünde çoktan çift girip kırmızıyı yemiştir q7.
  entry_channels: spor,haber
- entry_name: |
    igor tudor
  entry_id:  85765568
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    bazen konu dağıldığında "ne diyordum lan ben" diyip karşılık alamamaktır.
  entry_channels: ilişkiler,sağlık
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    gerekli gereksiz her şeyde ısrar etmek. mesela bir ikramı kibarca geri çevirdiğinizde daha da ısrar ediyorlar almanız için bir küfretmedikleri kalıyor. genelde ikramlar hamur işi olduğu ve ben hamur işi yemediğim için geri çeviriyorum da ısrar ettikten sonra kim bilir neler diyorlar. tamam da geç işte değil mi ne diye ısrar edersin daha ? şu ısrar olayı benim burada hala nedenini anlamadığım birkaç olaydan biri.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    çok doğru. <a class="b" href="/?q=basketbol">basketbol</a> ve <a class="b" href="/?q=beyzbol">beyzbol</a> izliyorum. kafam rahat. bir de ben <a class="b" href="/?q=fenerbah%c3%a7e">fenerbahçe</a>liyim onun da etkisi olabilir.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    tmmob'nin hiçbir işe yaramaması
  entry_id:  85763123
  entry_writer: qatal
  entry_fav_count: 0
  entry_content: |
    odayla işim gücüm yok. hatta oda yüzünden şirketimiz battı zamanında (uzun hikaye). yıllardır aidat ödemiyorum. geçen gün halimi hatırımı soran bir mektup göndermişler. 1500 lira da borç çıkarmışlar, avukatın aramasını bekliyorum. ne diyeyim ki allah belalarını versin. namuslu, kanuna, nizama uyan bir insansan, cebinden para çıkmadan nefes alamıyorsun bu ülkede.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    basit istatistik hesabıdır.<br/><br/>1000 kişiden çıkacak güzel insan sayısı, 100000 kişiden çıkacak güzel insan sayısından muhtemelen daha düşük olacaktır.<br/><br/>not: orta okul öğrencisi bir tanıdığım söyledi.
  entry_channels: anket,ilişkiler,ekşi-sözlük
---
