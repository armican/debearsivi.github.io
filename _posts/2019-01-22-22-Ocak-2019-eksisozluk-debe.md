...
- entry_name: |
    minibüsçü terörü zam yapılırsa çözülür
  entry_id:  85750888
...
- entry_name: |
    turknet'in yaran iş ilanı
  entry_id:  85757093
  entry_writer: kdrgztk
  entry_fav_count: 190
  entry_content: |
    esprili bir dille yazılmış ilan. bence komik... buz gibi soğuk bir dil kullanmalarındansa böyle bir dil kullanmaları daha güzel...
...
- entry_name: |
    at binemeyen ama erkeğim diye geçinen tip
  entry_id:  85755914
  entry_writer: su anda calan sarki
  entry_fav_count: 169
  entry_content: |
    sözlükte erkeklikle ilgili açılan başlıklarda ilk defa erkek olduğumu kanıtlayan über ötesi başlık.<br/><br/>daha önce erkekliğimi kaybettiğim bazı başlıklar;<br/><br/>boyum 1.90 dan kısa olduğu için erkeğim diyemiyordum kendime (1.82)<br/>otomatik vites araba kullandığım için kadınlar tuvaletini kullanmak zorundaydım.<br/><br/>çok zor günlerdi sözlük çok... ama şimdi hepsi geçti hamdolsun.
...
- entry_name: |
    kral salman'nin ivanka trump'a yaptığı teklif
  entry_id:  85753456
...
- entry_name: |
  ...
  entry_fav_count: 73
  entry_content: |
    (bkz: <a class="b" href="/?q=%c5%9fimdi+siki+tuttun+i%c5%9fte">şimdi siki tuttun işte</a>)<br/><br/>peşin edit : kedi severler bunu silkeler bu da entry silip kaçar.
...
- entry_name: |
  ...
  entry_fav_count: 25
  entry_content: |
    aradım, bulamadım, aramadığın zaman karşına çıkar dediler, aramayı bıraktım, bulamadım. evden bile çıkmıyorum artık, çok iyi aramazsam bayağı iyi bulamam diye düşünüyorum.<br/><br/>not: bir de güvenmiyordur kimseye
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 23
  entry_content: |
    orta çağ’da değil, milenyum çağı’nda yaşayan bir “bilim insanı”. orta doğu’nun aptal manevi duygularından ve arabesk saçmalıklarından, spiritüel kompleksler ve tabularından kendini arındırmış olan samimi ve gerçek bir materyalist. <br/><br/>modern ve batılı olduğu sanrısında debelenen, ne kadar kendini bu yönde pazarlamaya çalışsa da tasavvufi islam ve romantik anadolu adetleri adeta içine işlediği için, materyalist birini görünce asalaklaşan kuduz tayfa tarafından sık sık lince uğramaktadır.
...
- entry_name: |
  ...
  entry_channels: haber
- entry_name: |
    uganda'nın yerli otomobil üretmesi
  entry_id:  85762962
  entry_writer: sancili90
  entry_fav_count: 16
  entry_content: |
    uganda'nın yerli araç yapması, hemi de hibrit.<br/><br/>sahi bizim fişşek gibi bir yerli aracımız falan vardı, neden hala şahinler doğanlar görüyorum ben sokakta? yoksa o kadar güzel yaptık ki zamanda yolculuk mu yapıyor? e o zaman bizim zamana da bi ayarlasınlar şu kalibreyi de biz de görelim...<br/><br/>uganda diyorum ya.. yani daha ne olabilir? <br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.maksatistihdam.com/uganda-yerli-otomobil-uretti/" title="https://www.maksatistihdam.com/uganda-yerli-otomobil-uretti/">kaynak</a>
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: oyun
- entry_name: |
    1 kg yeşil mercimek'in 7.5 lira olmasının nedeni
  entry_id:  85763771
  entry_writer: panpatube
  entry_fav_count: 7
  entry_content: |
    <a class="b" href="/?q=t%c3%bcrkiye%27nin+kanada%27dan+mercimek+ithal+etmesi">türkiye'nin kanada'dan mercimek ithal etmesi</a>nin de etkisi olabilir mesela.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    riekerink'ten kötü teknik direktör. yani beden eğitimi öğretmeni bile olamıyor bizim taraftara mantığına göre. galatasaray'a geldiği gibi sneijder, podolski, bruma gibi oyunculara takması ne kadar arıza olduğunu gösteriyordu. <br/><br/>başakşehir'e karşı iki çıktığı maçta 9 yemiştir. sanırım böyle dokuz mokuzlu yazınca daha acı oluyor.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=karpuz">karpuz</a>)<br/><br/>(bkz: <a class="b" href="/?q=kavun">kavun</a>)
  entry_channels: anket,yeme-içme
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ön yargı + arka yargı sahibi insanların düşüncesi.
  entry_channels: anket
---
