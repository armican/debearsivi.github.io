...
- entry_name: |
    tıp profesörlerinin aylık 50 bin tl maaş alması
  entry_id:  84048139
  entry_writer: amipli dizanteri
  entry_fav_count: 129
  entry_content: |
    elimde üniversite hastanesinde çalışan tüm herkesin ne kadar döner ve maaş aldığına dair liste var. <br/>*prof. olup kalp nakli yapan kalp damar cerrahının eline toplam 22-25 bin arası para geçmekte(adam o ay kalp nakli yaptı)<br/>*gene 8-5 mesaiye+ek mesai ile akşamda çalışan yan dal hocası 21 bin tl civarı (döner+maaş)<br/>*geri kalan hocaların hepsi maksimum 18 bini görmekte (döner +maaş). bunlar içinde medikal onkoloji prof., hematolog, çocuk kardiyoloğu da mevcut.<br/>uzmanların eline ortalama 10.000-14.000 arası ki ek mesai yaparsa geçmekte. ortalama diyorum aralık ayında vergilerden komik rakamlar yatmakta.<br/><br/>benim babamın pide fırını var. ekmek pişiren ustaya sigortası ile beraber 5000 tl ödüyor (emekli olmayanın sigorta parası ödemiyir, prim yatırıyor)<br/>. eğer 7 yıl tıp+4 sene asistanlık+3 yıl yandal eğitimi yerine bu sürede fırıncılık yapsaydınız 50 yaşına kadar daha fazla para kazanmış olursunuz.
  entry_channels: haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    rüzgarda size tutunmak zorunda kalır. tutunmazsa uçar gider. sonra ara ki bulasın.
  entry_channels: ilişkiler,sağlık
- entry_name: |
    erkeklerden hoşlanan kızın asıl amacı
  entry_id:  84079155
  entry_writer: evrendeki karanlik madde
  entry_fav_count: 3
  entry_content: |
    heteroseksüeldir??
  entry_channels: 
