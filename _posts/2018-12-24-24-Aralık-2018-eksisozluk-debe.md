...
- entry_name: |
  ...
  entry_id:  84674816
  entry_writer: anubiscan
  entry_fav_count: 20
  entry_content: |
    bayiliyorum ya boyle bir hevesle ortaya cikip agzinin ortasina gelisine yemelerine bunlarin.<br/><br/>tanim: hem haberin altindaki hem buradaki yorumlardan anlasildigi kadariyla baskan'in kendi cebinden masrafini karsiladigi odadir.<br/><br/>bunu da gectim, adam maas bile almiyormus, hayirsever bir is adamiymis. ciddi ciddi yardim yapiyormus orada millete.<br/><br/>yani deseler ki bizi rezil kepaze et, boylesine bir hedef secemem arayip tarayip. en olmayacak adama yurumus kerizler (bkz: <a class="b" href="/?q=swh*">swh*</a>)
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    mesai sonrası eve gelip çıkarılan çorapların bacakta bıraktığı iz yerlerini kaşımak. yok böyle bir terapi.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    eskiden çok hırçındım. şimdi sikime takmıyorum. yoldan geçerken köpek de havlıyor dönüp bakmıyorsun. bağıran bağırdığıyla kalıyor. hatta adam yerine konulmadığı için sinir oluyor. <br/>size de tavsiye ederim. değmeyecek adamla tartışmaya girmeyin. kendini adam saymasın boş yere.
  entry_channels: ilişkiler
- entry_name: |
    şu anda çalan şarkı
  entry_id:  84701535
...
- entry_name: |
  ...
  entry_id:  84704049
  entry_writer: guvenilir bir kaynak
  entry_fav_count: 3
  entry_content: |
    benim hikayem kısmında şu geçiyor ‘ o anda resmen gozlerimdeki isik sondu.cok farkli bir his sanki annenizin olum haberini almis gibi oluyorsunuz.’ <br/>eğer yanlış anlamadıysam, umarım yanlış anlamışımdır, kız bakire değilim diyor. sende annenin ölüm haberini almış kadar üzülüyorsun. <br/>senin hiç annen öldü mü??<br/>memnun değilsen bırak ne büyütmüşsün olayı.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    30-40 yıl önce erkeklere bağımlı olmamak için o zor şartlar altında okumaya, kendini geliştirmeye ve kariyer yapmaya çalışan kadınlar vardı. imkanların çok daha arttığı bu dönemde ise zengin biri ile evlenip erkeğe bağımlı olmaya çalışan kadın sayısında rekor artış yaşandı. bu dönüşümü neye bağlıyorsunuz?
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    yeni yıldan beklentiler
  entry_id:  84706080
  entry_writer: belatrix
  entry_fav_count: 0
  entry_content: |
    kendimi daha çok dinleyeceğim, iç huzurumu yakalamaya odaklanacağım bir yıl olmasını istiyorum.<br/><br/>bir de hater'lık beni yordu. herkese mavi boncuk dağıtmak ve insanları biraz daha sevebilmek istiyorum.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ağzım açık izliyorum o nasıl gol oyle ya o nasıl soğukkanlılık ya.
  entry_channels: spor
- entry_name: |
