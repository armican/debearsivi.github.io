...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    ekşi herboku bilme timi tarafından eleştirilmeye başlandığına göre doğru yolda giden dizidir.ama bir yandan da hala inatla fizik kanunlarına göre o olmaz,bu mantıksız yazıp star wars'u bilim kurgu dünyası sanan saman kafalı dolu olması da insanı üzüyor.tamam kardeşim atomun iç yapısına kadar bildiğin için seni bu şeyler tatmin etmiyor çünkü fazla zekisin zamanını bunlara harcayamazsın sal bizi.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    (bkz: <a class="b" href="/?q=topuk+dikeni">topuk dikeni</a>)
  entry_channels: anket,ilişkiler
- entry_name: |
    çaylaklardan mesaj bekleyen yazarlar veritabanı
  entry_id:  98116404
  entry_writer: flycowing
  entry_fav_count: 4
  entry_content: |
    başlık içerisinde bir adet dahi dişi sineğin bile olmadığı, fakat gün aşırı gündeme düşen acınası başlık.
...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    pelin batu ile esg'nin aşırı entel muhabbeti
  entry_id:  98127557
  entry_writer: veritascyprus
  entry_fav_count: 2
  entry_content: |
    oranın <a class="b" href="/?q=k%c3%b6yl%c3%bcs%c3%bc">köylüsü</a> zannetmişler.. bizce çok <a class="b" href="/?q=haval%c4%b1">havalı</a> evet..(!)
...
- entry_name: |
    #bilkentkafeslerikaldır
  entry_id:  98148137
  entry_writer: i was in heaven
  entry_fav_count: 1
  entry_content: |
    bilkent’te oturuyorum. kafesi kim koyuyorsa bulup anasını sikme konusunda yardım edebilirim.
  entry_channels: ilişkiler
- entry_name: |
    şu anda çalan şarkı
  entry_id:  98148449
...
- entry_name: |
  ...
  entry_id:  98136370
  entry_writer: bouzouki
  entry_fav_count: 0
  entry_content: |
    değeri piyasaya sürülmeyen güzellik
  entry_channels: anket,sinema
- entry_name: |
    ekşi sözlük dertleşecek insan veritabanı
  entry_id:  98148654
  entry_writer: allahinbirkulu
  entry_fav_count: 0
  entry_content: |
...
- entry_name: |
  ...
  entry_id:  98146017
  entry_writer: binghamtonlu red john
  entry_fav_count: 0
  entry_content: |
