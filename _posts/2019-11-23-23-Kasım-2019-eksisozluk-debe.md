...
- entry_name: |
  ...
  entry_fav_count: 325
  entry_content: |
    başlığı açan sığır dahil ülkedeki herkesin annesi.
...
- entry_name: |
  ...
  entry_fav_count: 32
  entry_content: |
    beraberlik golu icin falcao isiniyormus ama evde isiniyormus kombiyi acmis ahahahhahah.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  98145667
  entry_writer: cinayetteki balta
  entry_fav_count: 25
  entry_content: |
    rodion romanoviç raskolnikov tabiki de. senin kafanın içinde neler dönüyor .
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 23
  entry_content: |
    senin kaşığın.<br/><br/>edit: başlık aşurenin içindeki en gereksiz ürün idi buraya taşınmış.
  entry_channels: anket,yeme-içme
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    (bkz: <a class="b" href="/?q=nescafe+%c3%bc%c3%a7%c3%bc+bir+arada">nescafe üçü bir arada</a>) <br/><br/>yazarken gastrit oldum.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    başlık altında övüldüğüne bakmayın, sosyal yaşamda ve erkek dünyada süslüler kadar itibar görmez.
  entry_channels: moda
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    rvp ile kıyas etmek için önce bi antremana, sonra da maçlara çıkması lazım. <br/><br/>krasiç geliyor aklıma ama o da en azından idmanlara çıkıyordu. bu ispanya’da tedavi ayağına paraları eziyor.<br/><br/>mevcut haliyle çiftlikbank tosunla kıyası doğru olabilir. zira keriz silkelemesi gibi duruyor.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    ya bu da bir şey mi, hayatta ne dertler var. ulan ne varsa var, adam buna üzülmüş işte.
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    “emre mor’u bir tek fatih terim adam eder”’ciler geldiyse onlara bir hareket yapıcaktım.<br/><br/>isteyen yeşillendirsin.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    cansu dere'nin hala taş gibi göründüğü dizi.
  entry_channels: tv
- entry_name: |
...
- entry_name: |
    banyo yapılır mı alınır mı sorunsalı
  entry_id:  98153086
  entry_writer: ref034
  entry_fav_count: 5
  entry_content: |
    banyo yapılır, duş alınır.
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    "birbirini tamamlamak üzere var olanlar<br/>birbirini tamamlamıyor,<br/><br/>kendime dökülüyorum,<br/>içime."<br/><br/><a class="b" href="/?q=birhan+keskin">birhan keskin</a>
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    elinini değil sikini de öpse transfer olamaz.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    takımın en formda oyuncusu da sezonu kapattığına göre istenilen kaos seviyesine ulaşıldı. şahsen bu seviyeye ulaşmak için bir yönetim değişikliği bekliyordum. o olmayınca geriye sadece sezon kapatıcı sakatlık alternatifi kalmıştı. önemli bir eşiği sezon başında aşması çok önemli. şimdiden şampiyonluğu hayırlı olsun.
  entry_channels: spor
- entry_name: |
    bira içmelik arkadaş veritabanı
  entry_id:  98139708
  entry_writer: selamkenk
  entry_fav_count: 3
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    diyalogların şahaneliği bir kenara dursun, ceylan'ın her filmde çıtayı biraz daha arttırarak gerçekçiliği filmlerine uyarlayabilmesi hayranlık verici. film adeta derin bir edebiyat kokuyor. hiçbir sahnesi boş değil, etik olarak olsun, felsefi olarak olsun her konuya parmak basılmış. <br/><br/>az önce bitirdim, garip bir burukluk bıraktı.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=dedim+dedim+inanmad%c4%b1n%c4%b1z">dedim dedim inanmadınız</a>)<br/><br/>babel’in ne halt olduğunu anlatanlara tepki gösteren galatasaraylı arkadaşlar sanırım artık ne demek istediğimizin farkına varmışlardır.
  entry_channels: spor
- entry_name: |
    okan buruk
  entry_id:  98143574
  ...
  entry_fav_count: 0
  entry_content: |
    geçen sene rize ile galatasaray'dan istanbul'da puan almıştı. bir sezon öncesinde de türkiye kupasında yine deplasmanda galatasaray'ı yenip finale çıkmıştır.
  entry_channels: spor
- entry_name: |
    kadınlar görünüşlerine önem veriyorsa neden şişman
  entry_id:  98153290
  entry_writer: sax endhoven
  entry_fav_count: 0
  entry_content: |
    çaresizlik. bebeğin gelişip büyüdüğü bünyeye sahip olmaları<sup class="ab"><a title="(bkz: evrim)" href="/?q=evrim" data-query="evrim">*</a></sup> yüzünden az bir kesimi hariç vücutları kilo almaya oldukça yatkın, kalori harcama konusunda oldukça verimlilerdir erkek bireylere göre.<br/>acun'un her sene türk halkına aynı tatta yutturduğu ve artık kabak tadı bile veremeyen survivor'da bu durumu rahatlıkla görebiliriz.<br/>o açlık(?) ortamında erkekler bir deri bir kemik kalmışken; kadınların vücutlarını su toplamış, basen/bacak/kalça bölümleri yağ depolamış tabiri caizse tosun gibi görürüz.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    yasli bir erkek hosuna gitmeyen bir kizla dipdibe ders calisir mi? 25, kadın.
  entry_channels: anket,ilişkiler,ekşi-sözlük
---
