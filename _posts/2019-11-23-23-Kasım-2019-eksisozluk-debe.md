...
- entry_name: |
  ...
  entry_id:  98117423
  entry_writer: sirfrancisgalton
  entry_fav_count: 23
  entry_content: |
    ne kadar kompleksli yaşıyoruz, ne kadar entrikalar çeviriyoruz. gerçekten anlam veremiyorum. sevenin sevdiğine sevdiğini söylemesi neden bu kadar zor? neden araya bin bir hinlik giriyor, taktik giriyor? dümdüz ve basit davranmak bu kadar mı zor? taktik yap, onu yedekte tut, dengesiz davran falan filan, belki de iyi olabilecek bir ilişkiye harcayacağımız enerjiyi boş yere bunlara harcıyoruz. abilerim ablalarım, çekinmeyin, atın adımınızı, komplekslerinizi aşın. basitleştirin, zorlaştırarak daha çok strese giriyorsunuz ve her şeyi mahvediyorsunuz.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    yazışırken 1.75 boyundayım diyen erkek
  entry_id:  98132738
  entry_writer: cihanna
  entry_fav_count: 14
  entry_content: |
    yazışırken 175 evde 15.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    ince dudak detayı, tespit gibi tespittir.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
    fransa'da bir yılda 137 kadının öldürülmesi
  entry_id:  98137059
  entry_writer: fraier
  entry_fav_count: 5
  entry_content: |
    oldurenler arastirilirsa katillerin gocmenler oldugu ortaya cikar. dogu kulturunde kadin olduren zihniyet batida da ayni cehaleti devam ettiriyor.
  entry_channels: haber
- entry_name: |
    barda yalnız içmek
  entry_id:  98139130
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    star wars uzmani bir adamdan teori dinlemek icin:<br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=jBHpsuSyNP4">https://www.youtube.com/watch?v=jbhpsusynp4</a><br/><br/>bu arada yeri gelmisken linkini vereyim. bu adamin cektigi guzel bir video:<br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=Ey68aMOV9gc">https://www.youtube.com/watch?v=ey68amov9gc</a>
  entry_channels: tv,sinema
- entry_name: |
    spora başlamak
  entry_id:  98145845
  entry_writer: walk these streets
  entry_fav_count: 1
  entry_content: |
    yola motivasyonla değil de disiplinle çıkarsanız başarılı olacağınız eylem.<br/><br/>motivasyon kaybolur; disiplin kaybolmaz. birisi çevreden gelir diğeri sizin içinizden. bu sebeple spora başlamak fiziken başlamak değildir aslında zihnen başlamaktır. ne zaman zihninize o spora başlayacağınıza inandırdınız işte o vakit fiziken spor başlar. yoksa spor yapıp da bir arpa boy alamaz; sadece bedeninizi yorar ve hayattaki en önemli olgudan, zaman, çalarsınız.<br/><br/>motivasyonu zamanla disipline döndürmek de mümkündür ki genelde böyledir bu. lakin başlangıcınız direk disiplinle olursa o zaman süperdir.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    kızın suratında <a class="b" href="/?q=yok+ebesinin+am%c4%b1+ali+sami">yok ebesinin amı ali sami</a> ifadesi oluşmuş.
  entry_channels: siyaset,haber
- entry_name: |
    1 günlüğüne takılmak istenilen roman karakteri
  entry_id:  98147436
  entry_writer: semiramisimsi
  entry_fav_count: 1
  entry_content: |
    tabii ki jane austen'ın mr. darcy'si.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=mohsen+namjo">mohsen namjo</a>) 'dan (bkz: <a class="b" href="/?q=dele+zaram">dele zaram</a>) şarkıdaki keman virtüözü ile ciddi düşünüyorum. bul beni.
  entry_channels: anket,müzik
- entry_name: |
    şu an okunan kitap
  entry_id:  98115009
  ...
  entry_fav_count: 0
  entry_content: |
    yaratıcı tür-david eagleman . <br/>çözeceğim ben bu insanoğlunun yapısını...
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    on a baisé tous les oiseaux sauf la cigogne.
  entry_channels: anket,edebiyat,eğitim,seyahat
- entry_name: |
    bira içmelik arkadaş veritabanı
  entry_id:  98128605
  entry_writer: oz hakiki kliseci
  entry_fav_count: 0
  entry_content: |
    bira makinasi ayağınıza geldi,17.30 sonrası beşiktaş'ta içilir, muhabbet edilir, goygoy yapılır, efendi efendi dağılınır.
