...
- entry_name: |
    kadınların kilo verince güzelleşeceğim sanması
  entry_id:  91408898
  entry_writer: invector
  entry_fav_count: 123
  entry_content: |
    kadınlarımıza sesleniyorum: kiloluysanız kilo verdiğinizde gerçekten güzelleşiyorsunuz. erkekler de aynı şekilde kilo verince yakışıklılaşılıyor.<br/><br/>çünkü çöpleri atıyorsunuz vücudunuzdan, kalan kısım kaliteli oluyor.
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    alsancak-üçkuyular arasında bulunan sahil şeridi.<br/>göz-göz-göztepe!
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    (bkz: <a class="b" href="/?q=ramsay+bolton">ramsay bolton</a>)<br/><br/>ramsuy da yazsa benim aklıma gelen bu. pislik.
  entry_channels: 
- entry_name: |
    kapalı maraş
  entry_id:  91426362
  entry_writer: plaza alerjisi
  entry_fav_count: 7
  entry_content: |
    an itibariyle kktc, maraş’ı açmaya karar verdi, bu saate kadar kapalı kalması hataydı. size gazı vereceğiz ey rumlar!
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    allah'ın kendisine "düzce'ye gitme" diyerek uyarıda bulunduğu rûh'ül kudüs mesih. <br/>allah'ı bu geniş vizyonundan dolayı kutluyorum, gel de inanma şimdi bu allah'a.
  entry_channels: siyaset,tarih
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    plajda cinsel ilişkiye giren sapıklar
  entry_id:  91428136
  entry_writer: dudenuken
  entry_fav_count: 0
  entry_content: |
    suriyeli değillermiş allah kahretsin.<br/><br/>o zaman <br/><br/>yav eğleniyorlar işte ne güzel aq, bırakın insanları artık serbest bırakın, sıkmayın yiaaaaav<br/><br/>(marjinal olmaya çalışan orospu çocuğu örneği)
  entry_channels: ekşi-sözlük,haber
- entry_name: |
    dota underlords
  entry_id:  91425167
  entry_writer: iron hand
  entry_fav_count: 0
  entry_content: |
    ilk yazana key vericem, hadi bakalımm
  entry_channels: oyun
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    yarın bütün türkiye'de aynı diyaloğun yaşanmasına neden olacak olay. <br/><br/>+kanka çıkmış yasa çıkmış yarın terhis oluyoruz.<br/>-ya bi siktirgit *mına koyum ya.
  entry_channels: 
---
