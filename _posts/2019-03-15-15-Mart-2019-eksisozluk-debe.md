...
- entry_name: |
    yazarların şahit olduğu kürt davranışları
  entry_id:  87735025
  entry_writer: haseki34
  entry_fav_count: 20
  entry_content: |
    çokken kavgacı olup tekken kavgadan kaçınmaları.
...
- entry_name: |
    kocası yerine sokaktan geçen genci vuran kadın
  entry_id:  87734253
  entry_writer: donjohnston
  entry_fav_count: 5
  entry_content: |
    ekşici dümbelekler, siz değil misiniz “seven kıskanırr, kıskanmayan gavattır” bilmem ne diye salyalar saçan. işte size layık bir kadın bu. ne hikmetse de hep aldatılan bu aşırı kıskanç kadınlar ve erkekler oluyor. oğlum çok enayisiniz lan. <br/><br/>aşırı kıskanç, takıntılı, saplantılı, kara sevdadan bahseden tüm tipler tedavi olmalı. sizin aşkınızı sikeyim ben.<br/><br/>olan masum bir cana olmuş. allah tüm bu saplantılı, “ya benimsin ya kara toprağın” zihniyetindeki tiplerin belasını versin.
  entry_channels: haber
- entry_name: |
    tüm yazarlar birer çaylak sahipleniyor kampanyası
  entry_id:  87710550
  entry_writer: moonguard
  entry_fav_count: 4
  entry_content: |
    nasıl tiplerse şu sitede yazmayı bir ayrıcalık ya da avantaj olarak görüyorlar. sahipleneceklermiş bir de laflara bak, halbuki kimsenin zerre kadar umurunda değil. bunu da ekşi sözlüğe açıldığından beri giripte üye bile olmayan birisi olarak söylüyorum.
