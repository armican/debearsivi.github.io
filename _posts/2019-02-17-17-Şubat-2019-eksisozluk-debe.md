...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    dindarsiniz veya degilsiniz bu farketmez, bir yasam bicimini ahlakin mutlak sebebi veya kaynagi sayamayiz. lakin ne tur hayat yasarsa yasasin insanlar artik dusunmuyorlar. mutlulugumuz artik bir takim metanin varligina endeksli oldu. zaman hizli geciyor ve bunun farkinda degiliz. varolussal hakikatimizi yitirdik. tekrar o derinlere inmek gereksiz geliyor. nasil olsa mutlulugu ve huzuru orada aramiyoruz.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    evet hatırladım<br/>küçük basit şeyler <br/>yetiyor kederlenmeye<br/>ya mutluluğa<br/><br/>(bkz: <a class="b" href="/?q=cahit+zarifo%c4%9flu">cahit zarifoğlu</a>)
  entry_channels: anket,edebiyat
- entry_name: |
...
- entry_name: |
    şu anda çalan şarkı
  entry_id:  86735286
  entry_writer: haydi kalk gidelim bu sehirden
  entry_fav_count: 2
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=vEH_7lMYeRQ" title="https://www.youtube.com/watch?v=vEH_7lMYeRQ">pinhani - sevmekten usanmam</a>
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    fırat aydınus denen şahıs tarafından gösterilmiştir.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bu insülin yükseltme mevzu yıllardır bilinen bir şey. kimine göre yararlı kimine göre zararlı<sup class="ab"><a title="(bkz: biraz da size bağlı olarak)" href="/?q=biraz+da+size+ba%c4%9fl%c4%b1+olarak" data-query="biraz da size bağlı olarak">*</a></sup>. aslına bakacak olursanız vücut geliştirme de doktorların yararlı veya zararlı olduğu konusunda mütabık kaldıkları bir aktivite değil. bazı doktorlar belli oranda kalp büyümesi iyidir, hem kas kütlesi de elde ediyorsun diyor bazıları kalbiniz büyüyor zaten toplamda atım yapabileceği sayı belli, eklemlerinize yazık falan diyor.
  entry_channels: spor
- entry_name: |
    en son gerçekten mutlu hissedilen an
  entry_id:  86761416
  entry_writer: uyurgezerdervish
  entry_fav_count: 0
  entry_content: |
    sıcak bir havada yağan sağanak yağmurun altında üşümeden ıslandığım günü hatırlıyorum, sanırım az daha tanrıyla sarmaş dolaş oluyordum, nirvanalıktan
  entry_channels: anket
- entry_name: |
