...
- entry_name: |
    tayyip erdoğan'ın seçim şarkısına eşlik etmesi
  entry_id:  86761699
  entry_writer: doxanddox
  entry_fav_count: 17
  entry_content: |
    herkes 14 milyar yıllık evrende akp dönemine mi denk geldim diye soruyor ya;<br/><br/>soru: ya onun şarkıcı olduğu döneme denk gelseydin?<br/><br/>tanım: (bkz: <a class="b" href="/?q=bir+olay">bir olay</a>)
  entry_channels: siyaset,müzik
- entry_name: |
    ataşehir'de muhtar adayından skandal vaad
  entry_id:  86765077
  entry_writer: mavericks
  entry_fav_count: 17
  entry_content: |
    20 sene ataşehirde yaşadım, bahsedilen mahalleden de çok defa geçtim. toplatmaktan kastı tam olarak nedir bilmiyorum öncelikle ama o bölgede ciddi bir sokak köpeği çetesi sorunu var. ben arabayla geçerken dahi korktuğumu biliyorum şaka değil, kaputun üzerine atlıyorlardı resmen.<br/><br/>gece acil bir şey olsa markete giderken 3 kere düşünürsünüz öyle söyleyeyim. muhtemelen bu sorunu görmüş ve vaatleri arasına eklemiş kendisi de. linç ederken bunları da göz önünde bulundurun.<br/><br/>edit: bahsettiğim 5 sene öncesi şu an durum nedir bilmiyorum. muhtemelen çok daha artmıştır.
  entry_channels: siyaset,haber
- entry_name: |
    erkek yazarlardan kadın yazarlara sorular
  entry_id:  86731872
  entry_writer: bendeniz hasmet ibriktaroglu
  entry_fav_count: 12
  entry_content: |
    içinizde hala kumbara kullanan var mı?
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    6 senedir görüşmediğim, bir kez dahi beni aramamış arkadaşım beni arayıp; daha dün berabermişcesine muhabbet etti. konuşmanın sonlarına geldiğimizde “param bitti de bana gönderebilcen mi” minvalinde bir cümle kurdu. insanların bu kadar yüzsüz olması gerçekten mide bulandırıcı.
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    buse ranzanın alt katında kalıyor ben üst katında kalıyorum o yüzden ranzayı biliyorum diye açıklama yapan bir adet yarışmacının yarıştığı programdır.<br/>canım bir zahmet ranzayı bil
  entry_channels: tv
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    bu başlığı açan kişi hiç program yazmadığına garanti veriyorum. 1 hafta her gün oturup program yazmaya çalışsaydı bu başlığı hemen silerdi.
  entry_channels: programlama
- entry_name: |
    lgbt kulübünün akıllara zarar projesi
  entry_id:  86768295
  entry_writer: gaiusjuliuscaesar
  entry_fav_count: 7
  entry_content: |
    yahu nerede nasıl kimle pompa yapıyorsanız yapın da cinsiyetsiz tuvaletle lgbtnin ne ilgisi var ?<br/><br/>ben pisuvarı kullanamıyorum daha yanda biri olunca.
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    ben bu adamın çocuğu hiç olmayacak diye korkmaya başladım. çocuk yapmıyorlar resmen. yapsanıza allah aşkına uykularım kaçıyor ya. ben çocuk yapmayacak bir insanım ama sen yapmalısın kıvanç.
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    10 kişi kalan konyaspor'u yenemeyen takımın yaratıcısı. kanuni sultan süleyman'dan sonra gelen sarı selim gibi bir şey.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    herkesi çıkarları yönetir.<br/><br/>buna aşk iş arkadaş ne dersen de herkesin belli çıkarları vardır ve çıkarların örtüşür aynı yolda yürürsün ancak bir gün çıkarlar uyusmadigi zaman herkes yoluna gider sanki hiç tanımamış gibi..<br/><br/>malesef insanlar çok acımasızdır.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    kadınları ortadan kaldıracaklar yakında, baya artık gerek yok gibi davranıyorlar.<br/>(bkz: <a class="b" href="/?q=lut+kavmi">lut kavmi</a>)
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    ekşide sol framede herhangi bir kadın-kız başlığı görmemek.<br/>pek mümkün olmuyor ama, olduğu gün bu detay beni mutlu edecek.<br/><br/>(bkz: <a class="b" href="/?q=kad%c4%b1nlar%c4%b1+rahat+b%c4%b1rak%c4%b1n">kadınları rahat bırakın</a>)
  entry_channels: 
- entry_name: |
    yazılımcıların kod dışında bir şey yazamaması
  entry_id:  86758900
  entry_writer: yavheyav
  entry_fav_count: 2
  entry_content: |
    yazılımcı kod dısında bir sey yazamaz, kadından yazılımcı olmaz, yazılımcılar asosyal olurlar bla bla bla. genellemeleriniz batsın.
  entry_channels: programlama
- entry_name: |
    bruno ganz
  entry_id:  86747698
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bugün. kangren olmuş uzuvlardan kurtulmak hafifletip huzur, mutluluk veriyor. dengeyi yeniden kurabilmenin keyfi paha biçilemez.
  entry_channels: anket
- entry_name: |
    alkol alınca gelen esrarengiz sıçma isteği
  entry_id:  86768676
  entry_writer: sana buradan bi korum
  entry_fav_count: 0
  entry_content: |
    alkolün sayısız faydalarından biridir. bağırsaklarını çalıştırıyor ve dışkıyı vücuttan atıyorsun, kabız olmuyorsun. <br/>maalesef bu ilaçtan devlet fena vergi alıyor. ssk da karşılamıyor.
