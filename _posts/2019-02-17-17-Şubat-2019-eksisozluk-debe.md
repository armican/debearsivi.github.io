...
- entry_name: |
  ...
  entry_fav_count: 235
  entry_content: |
    (bkz: <a class="b" href="/?q=%c3%b6lm%c3%bc%c5%9flerinin+can%c4%b1na+de%c4%9fsin">ölmüşlerinin canına değsin</a>)
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    akp'nin gizli ortağı olması kaynaklıdır.<br/><br/>yargıyı tamamiyle ele geçirmiş bir iktidar için hdp'yi kapatmaktan kolay bir şey yok.<br/><br/>birgün akp iktidardan düştüğünde akp-hdp ilişkileri ortaya döküldüğünde herkesin dudağı uçuklayacak. sabah küfür edip akşam görüşüyorlar.<br/><br/>siyaset pistir ama türkiye'de daha pistir.
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    öyle bir takım ki, küme hattında olmasına rağmen galatasay-trabzon maçına ağlar, powerpointlerle sunum yapar, ertesi hafta hakem rakibini katletmesine rağmen o maçta da sikilen taraf olur amk :) ezikliğin vücut bulmuş hali.
  entry_channels: spor
- entry_name: |
    tayyip erdoğan'ın secim sarkisina eslik etmesi
  entry_id:  86761699
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    her gecen gun artmaktadir. ateist nufusu ve bilincli musluman nufusu egitim seviyesiyle paralel olarak artiyor. ataturk'un vizyonu, gayesi ve yaptiklarini genelde egitim seviyesi yuksek insanlar benimsedikleri icin 100 yil sonra da, 200 yil sonra da sevilmeye devam edilecek. hatta bu egitimsiz toplumda su andakinden daha fazla deger verilecegini dusunuyorum.
  entry_channels: siyaset
- entry_name: |
    sigara haramdır
  entry_id:  86763329
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    fb-bjk maçında sahadan çıkan emenike'ye baktığı fotoğrafı olmasına rağmen "sahadan çıktığını görmedim" beyanı yaptığı gün hakemliği bitmeliydi. türk futbolunun kanayan yarası, hasta fenerli hakemdir.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    zirkonyum diş
  entry_id:  86764452
  entry_writer: kymksmv35
  entry_fav_count: 1
  entry_content: |
    zirkonyum diş kaplamada zirkonyumun ışığı geçirebilme özelliği sayesinde dişlerde meydana gelebilen mat görüntü kaybolarak, dişlerin orjinal haline en yakın bir görünüm alması sayesinde daha sağlıklı, daha şeffaf ve daha doğal bir görünüm elde edilir.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    geçen halı saha maçında orta sahadan yazdım açıkçası.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    tantuni, cağ kebap, mantı, et pirzola, börek çeşitleri, sarımsaklı yoğurtlu çılbır ve salata çeşitleri.<br/><br/>başka hiç bir yemek olmasa sadece üsttekiler olsa ölene kadar yiyebilirim sanırım sıkılmadan.
  entry_channels: anket,yeme-içme
- entry_name: |
    en son gerçekten mutlu hissedilen an
  entry_id:  86764525
  entry_writer: aysepusat
  entry_fav_count: 0
  entry_content: |
    hiçbir şekilde aklıma gelmeyen an. pottermore'da patronus testi çözerken bile "ulan benim en mutlu anım hangisi ki acaba?" diye düşünürken bir baktım test bitmiş. mutlu an mutlu anı, onların hepsi simülasyon bence. ya da bu hâle getirenler utansın.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    alex’i neden bu maçta davet ettiğini anlayamadığım başkan. planı aykut’u yuhalatmaksa çok ayıp eder. alex’le aykut’u elele tribüne çağırtmalıdır.<br/><br/>edit: vay anasını maaşlı trol ilan edildik:)
