...
- entry_name: |
    çağla şıkel'in paylaştığı garip fotoğraf
  entry_id:  74130963
...
- entry_name: |
    diyanet bütçesi vs falcon heavy bütçesi
  entry_id:  74119266
  entry_writer: adana kebapspor
  entry_fav_count: 46
  entry_content: |
    diyanet = 6 milyar tl<br/>falcon heavy = 350 milyon tl<br/><br/>diyanet falcon'un 17 katı.
- entry_name: |
    fırat çakıroğlu
  entry_id:  74122246
...
- entry_name: |
  ...
  entry_fav_count: 23
  entry_content: |
    erkek kişisinin hayatının sonuna kadar unutamayacağı anlara , sahne olan bir gecedir. ayrıca ilk gece ve sonrası için, foça bir liman, bense bir gemi , bir daha gelirsem , siksinler beni.
- entry_name: |
    arda kardeşler
  entry_id:  74126801
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    iyi niyeti sikerler.kötü olmak güç iyi olmak zayıflık bu ülkede.
- entry_name: |
...
- entry_name: |
    ergin ataman
  entry_id:  74123311
  entry_writer: kocakum
  entry_fav_count: 3
  entry_content: |
    ilk aydın örs başlığına yazacaktım ama tabi ki ergin ataman her zaman yaptığını yapıp bir adım öne çıktı. aslında konu türk basketbolu. en baştan başlarsak geçen hafta aydın örs, s spor kanalına röportaj verdi. türkiye'de her önüne gelen yabancı koç görev alamamalı sınırlama getirilmeli dedi. federasyona başvuru yaptık dedi. şimdi de ergin ataman çıkmış obradoviç için özel röportaj yapmış. bir de bunun ufuk sarıca ayağı var. <br/>aslında bizim bu bütün koçlarımız başarlı insanlar. ama genel olarak ülke sorunumuz iktidar mücadelesi olarak temiz bir rekabete gelemiyorlar. hep bir ayak oyunu. fenerbahçe şu anda basketbola en çok yatırım yapan kulüp. ve başındaki adam avrupanın en iyi koçu. obradovic olduğu sürece başarılı olma ihtimalleri yok. türkiye'den gitmesi için kırk takla atıyorlar. <br/>bizim basketbol dünyamızın önde gelen koçları türkiye'de dönen parayı paylaşmak istemiyorlar. mesela itudis banvit'ten cska'ya gitti. aydın örs'e göre itudis türkiye'de çalışmamalıydı. yardımcı koçluktan gelmişti çünkü. neyse işte türkiye'de bir grup var daha fazla kariyer daha fazla kazanç için türk basketbolunu bitirmeye yemin etmişler. ergin de bunların arasında en fevri olanı.
- entry_name: |
...
- entry_name: |
    greyfurt güzel midir kötü müdür
  entry_id:  74132687
  entry_writer: heinrichh
  entry_fav_count: 0
  entry_content: |
    son derece güzel bulduğum narenciye türüdür.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    çok iyi bir <a class="b" href="/?q=black+mirror">black mirror</a> bölümü olabilecek film.
- entry_name: |
    bitcoin
  entry_id:  74133443
  ...
  entry_fav_count: 0
  entry_content: |
    gelen haberlere göre, ergenler survivor 2018'i izlemeye başladıkları için bitcoin başlığını rahat bırakacaklarmış. panaroması filan derken 6 ay sonra sararlar yine. belki bu sayede link veren sayısı da azalır. <br/><br/>sanki azaldı mı ne ?
- entry_name: |
