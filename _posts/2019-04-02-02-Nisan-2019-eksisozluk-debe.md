...
- entry_name: |
  ...
  entry_channels: anket,ekşi-sözlük
- entry_name: |
    akp'nin yeniden seçim yapılsın kampanyası
  entry_id:  88421337
  entry_writer: anonimyus
  entry_fav_count: 63
  entry_content: |
    bu sefer oylarını çeşitli sebeplerden veremeyen yüzbinlerce chp'linin de oy vermesi demektir. bu sefer dsp'nin sp'nin oy alamaması demektir. akp'nin bu sefer tarihi fark yiyip, göz yaşı akıtmasıyla son bulacaktır.
  entry_channels: anket
- entry_name: |
    mansur yavaş
  entry_id:  88371592
...
- entry_name: |
  ...
  entry_channels: tv
- entry_name: |
    ysk'nın istanbul kararı
  entry_id:  88422673
  entry_writer: celiktepe stayla
  entry_fav_count: 53
  entry_content: |
    sana çok gerçekçi gelmeyen şeyi sikeyim amk matematikten habersiz öküzü. 100.000lik ilçeden gelen oyla 500.000lik gelen oy bir mi?
  entry_channels: siyaset
- entry_name: |
    buket aydın'ın alnı
  entry_id:  88411106
...
- entry_name: |
    erkekler hakkında büyük yanılgılar
  entry_id:  88412580
  entry_writer: butterflytruelove
  entry_fav_count: 35
  entry_content: |
    kendi adıma çok ilgi gösteren erkeğin değer verdiğini düşünürdüm. ben ne kadar sert davranırsam davranayım adam vazgeçmiyorsa, görüşmek için ısrar ediyorsa ; beni çok istiyor diye düşünürdüm. alakası bile yokmuş. adam sadece karaktersiz bir betaymış, çünkü alfa erkek ısrar etmez , kendisine kötü davranan kadının peşinden koşmazmış. kadın '' hayır '' diyorsa asla ona bir daha adım atmazmış.<br/><br/>bir erkek hem yüzsüz hem arsız hem de ısrarcı ise uzak durun. onun sevgisi , ilgisi sizi elde ettiği anda bitecek...
...
- entry_name: |
  ...
  entry_fav_count: 34
  entry_content: |
    çuval mı çalınmış? <br/>mühürsüz oy mu geçirilmiş?<br/>oy mu değiştirilmiş?<br/>müşahitler mi darp edilmiş?<br/>müşahitler mi öldürülmüş?<br/>açık oy mu kullandırılmış?<br/>haber ajansı mı bloke edilmiş?<br/>seçim süresi boyunca manipülasyon mu yapılmış?<br/>devletin bütün imkanları seferber edilerek seçim kampanyası mı düzenlenmiş? <br/><br/>sorularını akla getiren hashtag'dir.<br/><br/>hırsız varsa devlette sizsiniz poliste sizsiniz. buyurun göreve.
  entry_channels: siyaset
- entry_name: |
    canan kaftancıoğlu
  entry_id:  88379647
...
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    nettiniz mert'cim, sen, doblo, cengiz, deveci, sakallı ayı(türkçeye çevirdim nickini yerli ve milli olmak adına), hammell, sözlüğün en güzel kızı hamdi abiyi de aldınız içmeye mi gittiniz? içmek dediysem ayran yani. hehe. ittin bittin'i de unutmayın. kardeş kardeş için.
...
- entry_name: |
    mansur yavaş ve ekrem imamoğlu'nun ortak noktası
  entry_id:  88422856
  entry_writer: ebelerikorumadernegibaskani
  entry_fav_count: 7
  entry_content: |
    sağ muhafazakar seçmene de hitap edebilmesidir.
  entry_channels: siyaset
- entry_name: |
    hilal kaplan
  entry_id:  88402690
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/FHRT28JR2xU" title="https://youtu.be/FHRT28JR2xU">selahattin özdemir 2</a><br/><br/>sabah kahvaltıda çay deminin üstüne efes extra ekleyen, yazılan kaderi silemeyen, mutluluğun kendisine çok uzak olduğu, adeta eli kolu bağlanmış bir selo görüyoruz.<br/><br/>turşuyu gömdüler yalnız. <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup><br/><br/>tanım: sadece ikili ve ev ortamı olunca coşan youtube kanalı.<br/><br/>(bkz: <a class="b" href="/?q=isve%c3%a7">isveç</a>)
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    arayan yok ki cep telefonu melodim olsun. <br/><br/>dünyanın en yalnız adamıyım.
  entry_channels: anket,müzik
- entry_name: |
    beylikdüzü 1287 no'lu sandık
  entry_id:  88423138
  entry_writer: taze sicak smith
  entry_fav_count: 4
  entry_content: |
    ınsanlar bbp ye oy veremez mi kardeşim? <br/><br/>doğru gerçi sadece size verecekler. lan bi garipsiniz ya ..
  entry_channels: 
- entry_name: |
    fatih portakal ve ismail küçükkaya ile rakı içmek
  entry_id:  88423711
  entry_writer: degirmenderedeki smokinli adam
  entry_fav_count: 3
  entry_content: |
    ismail küçükkaya'nın masada diğer meyhane sahibi ile mesajlaşmasıyla sonuçlanacak olay
  entry_channels: 
- entry_name: |
    martın sonu bahar vs arap baharı
  entry_id:  88422461
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    ben kadın olsam çüke önem verirdim. çük önemli abi. yemişim parayı, zekayı ve tipi. benimki gibi küçük bir çükü olmasın, kocaman çükü olsun yeterli.
  entry_channels: anket,ilişkiler
- entry_name: |
    ekşi sözlük dertleşecek insan veritabanı
  entry_id:  88418244
  entry_writer: blue marine
  entry_fav_count: 1
  entry_content: |
    sozluk modeli pisikolog seansi seysi. <br/>bu platformda 10 yilda ogrendigim; ne derdimi anlatirim, ne de dert dinlerim. <br/>sutten agzi yanan yogurdu ufleyerek yermis. <br/>aslina bakarsan reelde de ayni seviyedeyim. ıcim sisiyor arkadas. <br/>bak yine gerildim.
