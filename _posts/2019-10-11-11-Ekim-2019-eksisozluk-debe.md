...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    yaya geçidinden geçen yaya pişkinliği
  entry_id:  96369458
...
- entry_name: |
    masterchef türkiye
  entry_id:  96361344
  entry_writer: architetto
  entry_fav_count: 20
  entry_content: |
    mehmet şef ve açelya arasında ilişki olduğunu iddia edenlere cevaben sanırım, açelya’nın elendiği açıklandıktan sonra mehmet şef tarafından neredeyse on kere falan ”evladım” denilerek ”senin yaşında kızım var” vurguları yapılan yarışma.<br/><br/>_____________________<br/><br/><a class="b" href="/?q=edit">edit</a>: konuyu bilmeyenler varmış. sosyal medyada, ekşi de dahil olmak üzere; açelya ile mehmet şefin ilişkisi olduğuna emin halde açıklama yapan insanlar oldu. argümanları da gerçekten çok acıklı. neymiş eğilip kulağına bir şey söylüyormuş, iyi davranıyormuş. (iyi mi davranıyormuş! yok artııııık! nasıl iyi davranır yaa..)<br/><br/>danilo başı çekmek üzere açelyayla az mı kafa bulup üstüne gittiler. bu bölümde bile “inek gördüm” dedi diye nasıl kafaya aldılar falan. gayet de onun seviyesine uygun bir şekilde iğneleyip duruyorlardı kızı. <br/><br/>neyse ne... insanların hayatlarına dokunacak yorumlar yapmadan önce bir durup onların da aileleri ve kamera arkasında bir hayatları olduğunu unutmamak lazım.<br/><br/>bu arada; açelya da gittiğine göre <a class="b" href="/?q=let+the+lin%c3%a7+begin">let the linç begin</a> for eda.
...
- entry_name: |
  ...
  entry_channels: anket,teknoloji
- entry_name: |
    buket aydın'ın barış pınarı harekatı pozu
  entry_id:  96392620
  entry_writer: herbokubenbilirim
  entry_fav_count: 18
  entry_content: |
    bu kadinin alni hala imara acilmadi.devlet burayi nasil atliyor anlayabilmis degilim
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    şeriatçı teröristlerden mütevellit silahlı grup. türk ordusu'nun bunlarla beraber hareket ediyor olması büyük rezalet.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: haber
- entry_name: |
    10 ekim 2019 bmgk kararı
  entry_id:  96391156
  entry_writer: iristug
  entry_fav_count: 12
  entry_content: |
    bm güvenlik konseyinde türkiye için kınama mesajı yayınlanmak istenmesi durumu.<br/><br/>veto edildi yayınlayamadılar.<br/><br/>kim veto etti : abd ve rusya<br/><br/>edit:<a rel="nofollow noopener" class="url" target="_blank" href="https://twitter.com/NewssLab/status/1182353747034464258?s=19" title="https://twitter.com/NewssLab/status/1182353747034464258?s=19">kaynak</a> <br/>rusya : "abd çizgimize geldi memnunuz". :)<br/><br/>edit 2: gelen bilgilerde hata varmış kurulda tasarı sunulmadığı için veto edilme durumu yokmuş.<br/>abd ve rusya niyeti belli edince fransa tasarıyı oylamaya sunmamış.
  entry_channels: siyaset,haber
- entry_name: |
    mondragon'un türkçe sinirlendiği anlar
  entry_id:  96388191
  entry_writer: nick ita gurbanov
  entry_fav_count: 8
  entry_content: |
    hakeme küfür etmiyor . faul yokmu amına koyyim diyor. götlük yapıp çarpıtmayın.bu tarz cümlelerde 'amına koyyım' bir durum saptaması olarak söylenir şahsın kendisene yönelik değildir .
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  96391196
  entry_writer: heryolroma
  entry_fav_count: 5
  entry_content: |
    ne var artık 20 yıl yönetsin, 40 yıl yönetsin ? 25 yaşında beni hayata küstürdükten sonra ? beni bu umutsuzluğa hapsettikten sonra ? ekonomisinden ayrı, siyasetinden ayrı, savaşlarından ayrı, depremlerinden ayrı golleri yedikten sonra ? varsın 40 yıl daha yönetsin. gelinen noktada benim için artık önemi yok zaten ekonomi ayrı bir çukur düzelene kadar olurum 45-50. üniversite hayatım siyasal islamla geçmiş, dolar almış başını gitmiş fakirleşmişim, hakaretlere, etiketlere maruz bırakılmışım, kadınlar yanı başımda öldürülmüş, bir ev almak için 10 senemi ipotek etmem gerekmiş. ne olacak daha ? daha kötü ne olacak ki ?
  entry_channels: siyaset
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    “yüzlerce yıldır yanyana yaşadığımız halk ile dialog kanalları açık tutulmalı. savaşın kazananı olmaz, barışın da kaybedeni olmaz”<br/><br/>demiş. bunun neresinde harekâta tepki var amına koduğumun propagandisti?<br/><br/>kadın uyarı mahiyetinde bir açıklama yapmış. neresi yalan? dialog kanalları kapalı mı tutulsun istiyorsunuz? yerel halk kucaklanmasın mi istiyorsunuz? öso istediği gibi at koştursun mi istiyorsunuz?
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    kışın bira yerine tercih edilecek en pratik içki
  entry_id:  96378978
  entry_writer: old school fucker
  entry_fav_count: 0
  entry_content: |
    yurt dışında iseniz sıcak şarap kesinlikle... özellikle noel pazarları yakında açılmaya başlar.. o pazarlardaki güzelim sıcak şarapları denemeden geri dönmeyin.. sıcak bira da güzel ama şarabın yerini tutmuyor. <br/>türkiye'de bir kaç denedim fakat kesinlikle turkiye'de sıcak şarabın ne olduğu hakkında kimseinin fikri yok.
  entry_channels: anket,yeme-içme
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    takım leş gibi oynuyor izledikçe için daralıyor o derece kötüler. bu sene çok saç baş yoldururlar.
  entry_channels: spor
---
