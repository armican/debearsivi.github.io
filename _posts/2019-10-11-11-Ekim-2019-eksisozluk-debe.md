...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    seküler kısmı değil, milliyetçi ırkçı kısmı tehdit oluşturuyor! bildiğiniz gibi değil! türkmenlere yaptıklarını sadece türkmenler biliyor!
  entry_channels: siyaset
- entry_name: |
    demirtaş'ın ağabeyinin operasyon açıklaması
  entry_id:  96388764
  entry_writer: sporyazariboksor
  entry_fav_count: 16
  entry_content: |
    aşağılık bir açıklamadır. <br/><br/>abd’nin fahişeliğini yapan pkk’nın kaybetmeye başladıkça daha da hırçınlaştığını görüyoruz ama türk ordusunun çelik pençesi artık uzak değil. <br/><br/>sizi bu coğrafyadan sonsuza denk sileceğiz. aylardır söylediğim şeyi söylüyorum: “sizi türkiye’nin elinden kurtarabilecek hiçbir güç yok.”
  entry_channels: haber
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: haber
- entry_name: |
    2500 yıllık türk askerine mehmetçik demek
  entry_id:  96380915
  entry_writer: donorcrimeperson
  entry_fav_count: 12
  entry_content: |
    bundan daha büyük garabet türk silahlı kuvvetleri için "islam'in son ordusu" ifadesini kullanmaktır. hayırdır birader hilafet tekrar mi geldi? türk ordusu türk milletinin hizmetindedir, personelin ezici bir çoğunluğu müslüman olsa bile islam ordusu filan değildir. ordumuza islam ordusu diyenler günün birinde askeri müslüman bir devletle carpistigimizda hangi tarafı seçecekler? iran ırak savaşında ya da tarihte sayısız defalar karşılaşmış müslüman ordularınin savaşlarında allah bir taraf tutuyor olabilir miydi sizce?<br/><br/>savaşların, zaferlerin, yenilgilerin allah'la ilgisi yok beyler başlatan da bitiren de insan.<br/><br/>muslumanspor.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    10 ekim 2019 ypg'nin katlettiği siviller
  entry_id:  96387151
  entry_writer: eskiye ragbet
  entry_fav_count: 5
  entry_content: |
    şerefsizler bugün sivilleri şehit ettiler.<br/><br/>ulan orospu çocukları, hani ypg barış güverciniydi? yazsanıza bunu gazetelerinizde, tv'lerinizde? harekata karşı çıkan şerefsiz köşe yazarları bakalım bunu da yazacak mı?<br/><br/>"suriye'nin kuzeyinde yürütülen 'barış pınarı harekatı'nda, tel abyad ile resulayn ilçelerinden teröristlerce akçakale ve ceylanpınar ilçelerine çok sayıda roket ve havan mermisi atıldı. şanlıurfa'nın ceylanpınar ilçesine teröristlerce atılan roket mermisi ile ağır yaralanan 11 yaşındaki elif terim, tedavi gördüğü hastanede şehit oldu. şanlıurfa sınırındaki saldırılardaki şehit sayısı 3'e yükseldi. teröristlerce atılan roket ve havan mermileriyle şanlıurfa'nın akçakale ilçesinde 1'i bebek, 2 kişi, mardin'in nusaybin ilçesinde de 3 kişi şehit olmuştu. böylece şehit olanların sayısı 6'ya çıktı."<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.dha.com.tr/yurt/akcakale-ve-nusaybinden-aci-haber-1i-bebek-6-sehit/haber-1726206" title="https://www.dha.com.tr/yurt/akcakale-ve-nusaybinden-aci-haber-1i-bebek-6-sehit/haber-1726206">link</a>
  entry_channels: 
- entry_name: |
    şu an okunan kitap
  entry_id:  96362729
...
- entry_name: |
    unutkanlığı azaltma yöntemleri
  entry_id:  96389230
  entry_writer: kayravekinyas
  entry_fav_count: 1
  entry_content: |
    kendi tecrübelerime göre en çok etkileyen; (bkz: <a class="b" href="/?q=uyku+d%c3%bczeni">uyku düzeni</a>)
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    <a class="b" href="/?q=kostas+sloukas">kostas sloukas</a>ın artık bu takıma zarar verdiğini gösteren maç.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    madem böyle bir veri tabanı var<br/>select * from caylaklar where cinsiyet="kadın" and yas between 27 and 35;<br/>sql sorgusunu çalıştırmak isterim. bakalım kimler varmış .
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    her ne sebepleyse artık, bilmiyorum, böyle bir dokümantasyon olsun istedim bugün. tam da bugün. tarihe burası vasıtasıyla da düşülmüş bir not olsun istedim:<br/><br/>yanımdan ayrıldığın bir saat ya oldu, ya olmadı... bir kokunun bir burunda hala bütün canlılığıyla öylece duruyor olabilmesi için çok uzun bir zaman bu; bir tenin, bir avuç içinin, bir kucağın, bir bakışın delicesine özlenmesi içinse çok çok kısa. ama işte öyle olmuyor. ne kokun burnumdan gidiyor, ne de içimde özlemin diniyor... seninle farklı işliyor sanki zaman, bambaşka işliyor. anlamlandırması güç. gerçekten güç.<br/><br/>ya ben seni kalbime, ciğerime sokabilmem, en içime işleyebilmem için bizi bu kadar beklemek zorunda bırakan hayat adına özür dilerim senden. bilmiyorum ne diyebilirim başka. alacaklısın sevgili. alacaklıyız. ve alacağız da! hayatın bize bu ayıbını biz beraber telafi edeceğiz seninle. söz olsun, sözüm olsun sana... :)<br/><br/>sen iyi ki varsın can parçası, iyi ki... seni seviyorum! saf, sonsuz, tuz kadar, deniz kadar...
