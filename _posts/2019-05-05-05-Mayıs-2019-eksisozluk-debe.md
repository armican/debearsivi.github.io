...
- entry_name: |
    4 mayıs 2019 ibb'nin pide kararı
  entry_id:  89667812
  entry_writer: spacetimereality
  entry_fav_count: 373
  entry_content: |
    yetmez. akp gibi yapmaları lazım, çarşaf çarşaf billboard'lara ilan vermeleri lazım. bu akape var ya bu akape, bunların zamanında pide bu kadardı, biz 1 liraya indirdik diye yazmaları lazım. herkesin gözlerine soka soka. 1000 puntoyla. balık hafızalı insanlar başka türlü anlamıyor.<br/><br/>edit: "geçen yıl da pide 1 tl imiş" diye mesaj atan bazı saf arkadaşlar var :) ah benim iyi niyetli arkadaşlarım. 90'larda camiler ahır yapıldı mı? ezan türkçe okundu mu? camiye ayakkabılarıyla girdiler mi? benim başörtülü bacılarıma saldırdılar mı? :) binali yıldırım çıktı, "eskiden halkımız internete bağlanamıyordu, şimdi bizim sayemizde hızlı internete giriyorsunuz" dedi. basit teknolojik bir gelişmeyi bile kendine yontmaya çalışan, ad hominem'in, straw man'in, red herring'in tillahını yapmış bir rakibin var. adamlar kafa-göz-belaltı-kroşe her türlü vuruyor. istediğinde boks, istediğinde karate, istediğinde sumo güreşi yapıyor. hakemler de onlardan. seyircinin çoğu onlardan. siz hala aman fair play'den ayrılmayalım derdindesiniz.<br/><br/>rakip her yolu mübah görüyorsa, gerektiğinde oy devşirmek için algı oyunları, çarpıtmalar yapıyorsa sen de acımayacaksın, bulduğun her fırsatı kullanacaksın. kendini öveceksin, icraatlerinin reklamını yapacaksın, rakibi halka şikayet edeceksin. eskiden pide 100 liraydı, biz 1 lira yaptık diyeceksin ve emin ol ki inananlar çıkacak. "zaten olması gereken bu, niye reklam yapalım ki" edebiyatının, efendiliğin zamanı değil. sen rakibini bir nakavt et, bağımsız yargıyı, erkler ayrımını, laik yapıyı tekrar kur, rakibini bir daha devleti ele geçiremeyecek hale getir, sonra yine efendi olursun.<br/><br/>edit 2: son bir tavsiyem de sosyal medyada, sözlükte, orada burada akp'lilerle tartışacak muhalif kardeşlerime: "sizin zamanınızda millet pide alamıyordu pide! ekrem başkan geldi pideyi 1 lira yaptı. bizim sayemizde millet pide yiyebiliyor." gibi argümanları sıkça kullanın. 10 kere kullanın, 20 kere kullanın, 100 kere kullanın. yeterince muhtelif defalar tekrarlarsanız ne kadar çok insanın size inanmaya başladığını görünce hayret edeceksiniz. (bkz: <a class="b" href="/?q=joseph+goebbels%2f7">joseph goebbels/7</a>)
...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    megan foxun bir türke mesaj göndermesi
  entry_id:  89678412
  entry_writer: dogx
  entry_fav_count: 110
  entry_content: |
    (bkz: <a class="b" href="/?q=abi+kalk+yerine+yat+istersen">abi kalk yerine yat istersen</a>)
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 33
  entry_content: |
    çok klişe olacak ama insanları kendim gibi zannetmek. <br/>mesela ben yalan söylemeyi beceremeyen, gerek de duymayan biriyim. kafam dümdüz çalışıyor, entrikadan yalandan kıvırmadan aldatmaktan anlamıyorum. bu yüzden otomatik olarak karşımdaki insanların sözlerinin doğruluğundan veya samimiyetlerinden şüphe duymuyorum. <br/>bunun zararını çok gördüm. bazı insanların çıkarları için söylemeyecekleri yalan, girmeyecekleri kılık yok. <br/><br/>bir de mütevazı olmayı bırakıcam arkadaş. bu ülkede mütevazı olunmaz. okuyamamış başaramamış bi baltaya sap olamamış kimseler aşağılık kompleksine girip, seni aşağıya çekmeye çalışır, okumuş ama adam olamamış demek için fırsat kollar hatta tuzak kurar. en iyisi bu tarz hazımsız insanlara peşinen yerini bildiricek ve ulaşılmaz görüneceksin ki seni yakandan tutup aşağı çekmeye çalışmasın.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 30
  entry_content: |
    ben ölmüş gitmişim. ailemin yüzünü kızartacak, ahlaksız şeyler yapmadığım sürece kim ne derse desin.<br/><br/>şuan da olduğu gibi kimse çükümde olmaz.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    acaba yuttu zaten de zaman algımızdaki farklılıktan ötürü tarafımızca henüz hissedilyor olamaz mı?<br/><br/>yani şunu demek istiyorum: kara deliklerin evreni yutuşunu izleyen devasa biri için bu süre 1024x hızda ama bizim gibi toz kadar ufak canlılar için olan hız; 0.000000000001x <br/><br/>buradan bakınca bir hareket yok ama karadeliği ufak bir delikçik olarak gören ultra-mega canlılar için tüm bu süreç 1-2 saniye olmasın sakın?
...
- entry_name: |
    bir erkeği yatağa bağlayıp tüm bedenini yalamak
  entry_id:  89676560
  entry_writer: exsequor
  entry_fav_count: 12
  entry_content: |
    sonrasında kedi sahiplerinin gayet iyi bildiği <a class="b" href="/?q=malt+macunu">malt macunu</a> yemeyi mutlak suretle tavsiye ediyorum. bu ürün kedilerin yuttukları tüylerin mideden atılımını kolaylaştıran bir ürün. hayırlı yalamalar.
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    senin o çıkık götünü bütün gana kabilesi elden geçirsin.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    memlekette güzel kız/yakışıklı erkek oranı 10/1 falan. mecburen böyle yani çirkinlere bayıldıkları için değil..
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  89681320
  entry_writer: what the makmuh
  entry_fav_count: 0
  entry_content: |
    “kimi aç ağlar, kimi rant sağlar.<br/>karşıki dağları kırıştı ağalar”<br/>(bkz: <a class="b" href="/?q=og%c3%bcn+sanl%c4%b1soy">ogün sanlısoy</a>)
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    testament (bkz: <a class="b" href="/?q=into+the+pit">into the pit</a>) <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=ePEFBxDGRw8" title="https://www.youtube.com/watch?v=ePEFBxDGRw8">*</a>
  entry_channels: anket,müzik
- entry_name: |
    fenerbahçe
  entry_id:  89655693
  ...
  entry_fav_count: 0
  entry_content: |
    burdan başkanı ali koç’a seslenmek istediğim camia. <br/><br/>allah rızası için seneye doğru düzgün bir kadro kurup şampiyonluğa oynayın. şu bjkli tinercilerle bizi muhattap etmeyin. biz şampiyonluk yarışında fenerbahçe ile oynamak istiyoruz. herkes yerine geçsin ya! ne işiniz var olum sizin 15. sırada!
  entry_channels: spor
- entry_name: |
