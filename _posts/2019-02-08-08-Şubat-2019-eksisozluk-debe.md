...
- entry_name: |
  ...
  entry_fav_count: 129
  entry_content: |
    ben idealist bir insanım. ülkemin bekasına, bölünmezliğine başımı koyarım.<br/><br/>atatürk ilkelerine ve cumhuriyet değerlerine önem veririm. ülkenin bölünmez bütünlüğüne kasteden benim düşmanımdır.<br/><br/>bu başlığı açan arkadaşa kızgın değilim. fikrini belirtmiş. "fikir" olduğu için şiddet aklımızın ucundan geçmez. her tür fikre saygımız var.<br/><br/>gel gör ki; bu arkadaş klavye karşısında, ergenler gibi, elinde cips paketi, döner koltukta tombul g*tünün üstüne otururken, umursamazca "ülke bölünsün" diyor.<br/><br/>ben onun yaşındayken, (ve bir çocuğum henüz 4 yaşındayken) kurşun yedim kolumdan. ülke bölünmesin diye... üç sene öncesine kadar kolumdaydı o çekirdek.<br/><br/>demem o ki; bizler ölmeden o dediğin olmaz çocum.
  entry_channels: siyaset
- entry_name: |
  ...
  entry_channels: siyaset
- entry_name: |
    kavga etmek istemeyen insan
  entry_id:  86402438
  entry_writer: ashelwash
  entry_fav_count: 120
  entry_content: |
    laf uzadıkça size ‘haklısın’ der, ‘doğrudur’ der çünkü umrunda değilsinizdir. susmanız onun için büyük bir lütuf olacaktır.
  entry_channels: 
- entry_name: |
    şule çet cinayeti
  entry_id:  86392325
...
- entry_name: |
    evlendikten 3 dakika sonra boşanmak isteyen kadın
  entry_id:  86409329
  entry_writer: cirkinbetty
  entry_fav_count: 57
  entry_content: |
    zararın neresinden dönülse kârdır diye düşünmüş gelin hanım. evlendiği adamın “salak” demesiyle önünde ki 30 seneyi 3 dakikada izleyerek vazgeçmiştir. iyi yapmıştır.
...
- entry_name: |
    sabaha bir padişah sözü bırak
  entry_id:  86399263
  entry_writer: balevso
  entry_fav_count: 49
  entry_content: |
    insanlara;" dinin nedir ? namaz kılıyor musun ? oruç tutuyor musun " gibi allah'ın soracağı soruları sormayın! insanlara : " aç mısınız ? bir şeye ihtiyacınız var mıdır ? bir sorunun var mı ? " gibi kulun kula soracağı sorun.<br/><br/>- fatih sultan mehmet<br/><br/>pek sevmediğim osmanlı ile ilgili ender güzelliklerden biri...
...
- entry_name: |
  ...
  entry_fav_count: 37
  entry_content: |
    (bkz: <a class="b" href="/?q=%c5%9feyh+said">şeyh said</a>)<br/>vahdettin’le bir olduk, halkı kışkırttık! (sürpriz içerir)
...
- entry_name: |
  ...
  entry_id:  86392513
  entry_writer: neverlander
  entry_fav_count: 35
  entry_content: |
    çerkezköy’de yaşıyorum. şehir merkezinden geçen caddemiz gayet geniş ve sık sık yaya geçitleri konuşlandırılmış. buraya kadar çok güzel. ancak ben aracımla yolun solundan giderken, bir yayaya yol vermek için durduğumda, sağ şeritten gelen araçların durmamasıyla resmen o yayanın canına kast ediyormuşum gibi oluyor. yayaları resmen diğer araçların önüne atıyormuşum gibi oluyor. <br/><br/>yerleşmiş yanlış kurallar öyle bir hal almış ki, kurallara uyan biri olarak ben eğer soldan geliyorsam yayaların can güvenliği için yayalara yol vermekten imtina eder duruma geliyorum. <br/><br/>kurallar herkes için.
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    33 yaşında işsiz kel göbekli altına işeyen erkek
  entry_id:  86409142
  entry_writer: nom
  entry_fav_count: 13
  entry_content: |
    hastadir. dalga gecmeyin.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    kimsenin gozu yok aga, hayrini gorun tolgay’inizin. kiskaniyor veya bokluyor olamayiz, biz verdik adami size amk. kadro disiydi bizde. <br/><br/>ben tolgay’dan nefret eden biri degilim. hatta hep performans gosterecegini sabirla bekleyenlerden biriydim. fakat burada konusulan baska. eger onceki takiminda soyunma odasina durum soylemekten kadro disi kalmis bir gevsegin bundan pismanlik duymamasi, hatta tassagini yapmasi sizi rahatsiz etmiyorsa, zaten sorun yok. aradiginiz adami buldunuz. <br/><br/>gamsiz azdi takiminizda, eksikligi kapatir.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    ilk sayfayı okuduğunda bakıyorsun herkes hataylı elini doladı yazıp favı çökertmiş ama şükelada esameleri yok. <br/><br/>gassay ekşi whatsapp grubu akşam mesaisine kalmış anlaşılan. onlar da biliyor yüzde yüz kırmızı kart olduğunu, varmayın üstlerine çocukların.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    jiletle tıraşın hele ki geleneksel tıraşın gelip geleceği versustur.<br/><br/>tıraş işini zorunluluktan yapıyorsanız ölene kadar eziyet gibi gelir ama işi keyif işine dönüştürürseniz tıraş vaktini iple çekersiniz. bu keyif işi haline getirmek de geleneksel tıraşla mümkün.
...
- entry_name: |
  ...
  entry_id:  86417577
  entry_writer: kravatini gevsetip viski icen psikolog
  entry_fav_count: 4
  entry_content: |
    saçma sapan duygu yüklü girdiler yazılmış. geçiniz kardeşim. taşşak yalatırken ki anıdır kesinlikle.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    mulakat mucizesi sayesinde hakkı olmayan koltuğa oturan boş beleş birinin çektiği video.
  entry_channels: haber,eğitim
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    babadan zengin elinde tespih, canti grand tuvalet giyimli, kısa saç sakal, en az d segment araba kolleksiyoneri, normalde üç koyunu bile güdemeyecek seri köz getircilere verilen ortak isim. <br/><br/>babaları tecrübesi ve nüfusuyla iş bağlayıp yağlı ihalelerin değişmez adamı iken, bunlar özcan deniz tripleriyle, erkeğin özü havalarında anlamsızca ortalarda dolaşırlar. özel işletme okur, genç girişimci, genç iş adamları derneklerinde boy gösterip, birbirlerine plaket vererek gün doldururlar..
  entry_channels: 
- entry_name: |
    ekşi itiraf
  entry_id:  86406815
