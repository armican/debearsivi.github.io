...
- entry_name: |
  ...
  entry_fav_count: 85
  entry_content: |
    ronaldinho<br/>cristiano ronaldo<br/>lionel messi
...
- entry_name: |
    türkler öğle yemeğine çıkar gibi savaşıyor
  entry_id:  96544774
  entry_writer: mazda
  entry_fav_count: 15
  entry_content: |
    oturdum hakikaten böyle bir şey demiş mi diye 23dk lık kaydı dinledim.demiş mi evet demiş ama başlık sahibinin belirttiği şekliyle dememiş."türkler kürtlerle yüzyıllardır savaşıyor sanki birinin öğle yemeğine gitmesi gibi(sık sık) savaşıyorlar" yani trump'ın demek istediği türklerin kürtlerle savaşması yüzyıllardır devam ediyor ve öğle yemeği yemek gibi alışılmış bir şey.buradan ooo biz süperiz trump bizim kahramanlığımızı övdü anlamı çıkaran yazarı tebrik ediyorum.
  entry_channels: 
- entry_name: |
    joker
  entry_id:  96514985
...
- entry_name: |
    14 ekim 2019 ezhel'in instagram paylaşımı
  entry_id:  96544285
  entry_writer: minortom
  entry_fav_count: 5
  entry_content: |
    kendisinden olmayan herkese pkk'lı damgası yapıştıran azmanlara kapak yaptığı paylaşımdır.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    hani bazen birine kızarsın da.ruhunu sikeyim! dersin.<br/>işte aynen sebepsiz,gereksiz,tanım bile yazmanın sadece vakit kaybı olacağı başlıkların açılması,ergen istilası,bastırılmış cinsel dürtülerin kimliksiz bir nick ardına sığınarak ortaya saçılmasından bıkkınlık geldi artık.<br/>birahaneye gidip ahmet abi'sine anlatılacak durumların bizimle paylaşılıyor olması ve genelde bu işin cinselliğe dayanması bir erkek olarak beni bile utandırmaktadır.<br/>bakanlığa sesleniyorum;<br/>üçkağıtçılık yapılıp içine viagra konulan içecek ve yiyecekleri toplatın.bundan sonra bizi ancak şap paklar.<br/>tanım:cinsel dürtüsü azmış bir yazarın dışa vurumu (gereksiz).
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    onlar katya dedikçe gözümün firdevs yöreoğlunu aradığı program. sen bize ne yaptın aşk-ı memnu.
  entry_channels: tv,yeme-içme
- entry_name: |
    hdp'nin niye hayla kapatılmaması
  entry_id:  96544694
  entry_writer: ecekil
  entry_fav_count: 2
  entry_content: |
    yok <a class="b" href="/?q=haylayf">haylayf</a> .
  entry_channels: 
- entry_name: |
    sabina urfan
  entry_id:  96545653
  entry_writer: yusuf yigit
  entry_fav_count: 1
  entry_content: |
    youtube açınca açtığım belli başlı sanatçılar var. ara ara da yeni sesler dinlemeyi severim. yeni sesler dinlemek istediğim zaman da türe göre bildiğim benzer bir parçayı açarım, youtube beni en geç birkaç saate hoşuma giden bir parçayı çalar. <br/><br/>bu kanalı 2. kez gördüm sanırım ama henüz dinlemedim. geçen başka başlıkta gördüğümü hatırlıyorum ama emin değilim.<br/><br/>bu kadar rastlantı olmayacağına inanıyor ve gecenin kalanında çalışma esnasında arka fonda dinleyerek hoşuma gideceğini ümit ediyorum.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=bitch+please">bitch please</a>)<br/><br/>(bkz: <a class="b" href="/?q=elektrikli+di%c5%9f+f%c4%b1r%c3%a7as%c4%b1">elektrikli diş fırçası</a>)
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    caylak hatunlarin cirkinligi nam salmis durumda. o yuzden uzulmesinler diye yapmadigimiz sey kalmadi. zaten hayatta yeteri kadar darbe almissiniz cirkinlikten bir de burada uzmeyelim sizi. siz yeter ki yazin sevgili caylak hatunlar. yazin ki cevaplayalim.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bir zamanlar <a class="b" href="/?q=eti+portakall%c4%b1+bisk%c3%bcvi">eti portakallı bisküvi</a> vardı. hala en sevdiğim bisküvidir. tekrar piyasaya sürülse de alsak dediğim.
  entry_channels: anket,yeme-içme
---
