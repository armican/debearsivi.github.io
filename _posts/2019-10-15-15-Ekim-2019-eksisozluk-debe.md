...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    bir filmden aklımda kalan konuşmayı hatırlatmıştır. <br/><br/>kadınlar ikiye ayrılır dostum.<br/>dürüst olmayan kadınlar <br/>dürüst gibi görünen kadınlar.
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    cevap veriyorum: piknik<br/><br/>25 kuruşluk piknikle büyüdük. nasıl ihanet ederim ona.
  entry_channels: anket,yeme-içme
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    ismini söylemek.<br/><br/>anamız, babamız düşünüp hepimize bir isim takmış. bunu yok saymak saçma.
  entry_channels: anket,ilişkiler
- entry_name: |
    ozan tufan
  entry_id:  96548062
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    kaliteli kamera ile fotoğraf çekmek
  entry_id:  96548127
  entry_writer: bosananyazar
  entry_fav_count: 1
  entry_content: |
    en iyi makina en iyi fotografı çekseydi, en iyi daktiloya sahip olan da en iyi romanı yazardı.<br/><br/><a class="b" href="/?q=ara+g%c3%bcler">ara güler</a>
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    çok hızlı mi gidiyorum:)
  entry_channels: anket
- entry_name: |
    ekşi sözlük dertleşecek insan veritabanı
  entry_id:  96544434
  entry_writer: sen adini getir
  entry_fav_count: 0
  entry_content: |
    35+ f ank. bir nevi güzin ablanız. dert uydurup gelmeyin, kırarım kalbinizi.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
