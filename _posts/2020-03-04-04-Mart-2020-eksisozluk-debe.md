...
- entry_name: |
    6000 tl maaş ile istanbul'da geçinme yolları
  entry_id:  102945444
  entry_writer: rastafay
  entry_fav_count: 506
  entry_content: |
    anadoludaki işinden ayrılınca maaşın da seninle birlikte mi geliyor ?
...
- entry_name: |
    hepsiburada'da satılan nazi amblemli sweatshirt
  entry_id:  102947416
  entry_writer: amprikuku
  entry_fav_count: 215
  entry_content: |
    (bkz: <a class="b" href="/?q=svastika">svastika</a>)<br/><br/>bir ruh hastası yüzünden<sup class="ab"><a title="(bkz: hitler)" href="/?q=hitler" data-query="hitler">*</a></sup> anlamını yitiren amblemi taşıyan sweatshirt'tur. <a rel="nofollow noopener" class="url" target="_blank" href="https://tr.wikipedia.org/wiki/Svastika" title="https://tr.wikipedia.org/wiki/Svastika">wikipedia</a><br/><br/>ilana gelirsek:<br/><br/>"adolf hitler nazi erkek sweatshirt"<br/><br/>ürün yorumu:<br/>"ürün ve kaite çokgüzel fiyat performans ürünü"<br/><br/>pezevenk yahudi avına mı çıkacak nedir. fiyat performans ürünüymüş...
  entry_channels: moda
- entry_name: |
...
- entry_name: |
    ateizmi yaymaya çalışan insanların amacı
  entry_id:  102957194
  entry_writer: eniyizamanoldurucu
  entry_fav_count: 151
  entry_content: |
    verdiği vergilerle dolmayan camiler yapılsın istemiyordur. <br/>her yer imam hatip olup, bilim ve fende ülke olarak geri kalmayalım istiyordur. <br/>sırf sevgilisi var diye öldürülen kız çocukları olsun istemiyordur. <br/>daha onlarcası.<br/>edit: yoğun istek üzerine 1-2 sebep daha ekleme kararı aldım. <br/>kadınlar ikinci sınıf insan muamelisi görsün istemiyordur. <br/>çocuk yaşta kızlar gelinlik giysin istemiyordur. <br/>mezhep savaşları olsun istemiyordur. (alevi-sünni)<br/>din savaşları olsun istemiyordur. <br/>iki insandan birisi kaplumbağaya bir diğeri zeus’a taptığı için düşman olsunlar istemiyordur. <br/>ramazan ayında su içip, yemek yediği için linç edilmek istemiyordur. <br/><br/>velhasıl kelam insanlar uyuşmasın istiyordur, insanlar artık gözlerini açsın, düşünsünler istiyordur. örümcek beyinlerindeki örümcek ağlarından kurtulsunlar. korkmasınlar, düşünebilsinler, sorgulayabilsinler istiyordur.
...
- entry_name: |
    3 mart 2020 ibb'nin müze ücreti zammı
  entry_id:  102956937
  entry_writer: gomugomunoo
  entry_fav_count: 62
  entry_content: |
    gerizekalı mısınız arkadaşım sırıtıyorsunuz? bir taraf zam koyar öbür taraf sırıtır, öbür taraf zam koyar bu taraf sırıtır. ne olduğunu zannediyorsunuz? iyi bir şey mi yani?<br/><br/>diğer her türlü zam gibi hoşumuza gitmeyen ve gelirimize gelen zamdan daha yüksek oranda yapılan zamdır. sebebi neydi ki?
...
- entry_name: |
  ...
  entry_channels: siyaset
- entry_name: |
    uras benlioğlu'nun arabasının yanması
  entry_id:  102959822
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    hdp'lilerin elini sikmaktan gocunmaz, ocalan'in kirmizi bultenle aranan kardesi trt'ye cikar tek laf etmez ama ne hikmetse 33 sehit verilmesinin sebebi kilicdaroglu'ymus gibi kemal kilicdaroglu'yla el sikismaz.<br/><br/>vallahi hayatimda chp'ye oy vermedim ama bu sapkin zihniyet yuzunden gidip chp'ye oy vericem. bunlar hem birlik beraberlikten bahsederler hem de cenaze merasiminde uzatilan eli geri cevirirler. bu olay siyasetten bagimsiz olarak ayiptir be, ayiptir. kac yasina gelmis adamsin, utan utan!
  entry_channels: siyaset
- entry_name: |
    bornozla oturmak
  entry_id:  102963305
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    ben well-done yiyorum, caiz midir hocam?
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    saygı, sevgi, sadakat ve seks. he bir de para :d
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    esad gitse yerine kim gelicek kılıçdaroğlumu onda liderlil vasfı yok.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ağzı da büyükse çok çekici olabilir.
