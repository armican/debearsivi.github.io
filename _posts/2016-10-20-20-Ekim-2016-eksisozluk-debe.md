...
- entry_name: |
  ...
  entry_content: |
    ...
    (bkz:  <a class="b" href="/?q=amac%c4%b1n%c4%b1n+futbol+oldu%c4%9funu+d%c3%bc%c5%9f%c3%bcnm%c3%bcyorum">amacının futbol olduğunu düşünmüyorum</a>)
...
- entry_name: |
  ...
  entry_content: |
    ...
    "sen beşiktaş'san hakemi de yeneceksin" diyen vedat okyar'a selam çakan takımım. ruhu şad olsun.
...
- entry_name: |
  ...
  entry_writer: admin
- entry_name: |
    bu ülke için en büyük tehlike kemalizmdir
  entry_id: 63576181
  entry_content: |
    
    en sevdiğim tatlı da kazandibidir..<br/><br/>kazandibi, dibi tutturularak hafifçe kızartılan muhallebi.<br/><br/>iki çeşit kazandibi vardır. normalde kazandibi tavukgöğsünden yapılır. tavukgöğsü katılmamış olanına "muhallebi kazandibi" adı verilir. muhallebi kazandibinin yapılışı aşağıdaki şekildedir.<br/><br/>süt, şeker, nişasta ve pirinç unu ile yapılır. pişirildikten sonra bir tepsiye pudra şekeri serpilir. pişen muhallebi, yarım parmak kalınlığında tepsiye dökülür. ateş üzerinde çevirerek dibi kızartılır. soğuduktan sonra karelere kesilir. bir keskiyle çıkartılan parçalar tabağa ters çevrilir. üzerine pudra şekeri ve gül suyu serpilir.
...
- entry_name: |
  ...
  entry_content: |
    ...
    ---  <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>poyraz mayıs 2016'da ölüp 2 sene sonra döndüğüne göre 2018'de geçmekte olan dizi. baktım da hala uçan arabalar yok. ne diyelim, "allah belanı versin mümtaz."<br/><br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---
...
- entry_name: |
  ...
  entry_content: |
    ...
    şu kurtardığı penaltıyı görünce aklıma ekşi suratın son galatasaray maçında doğru köşeyi bile tutturamadığı 5 penaltı aklıma geldi. bir inat uğruna güzelim kupayı cimboma hediye etti şenol güneş. yazık.
