...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/Xuz6n0a64XY" title="https://youtu.be/Xuz6n0a64XY">çok severim.</a>
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    ülkem ve bilim adına güzel gelişmeler bunlar. hazır yemek yerine uretmeyi seçen bu genç arkadaşlar her ortamda desteklenmeli. ayrıca araç konusunda da on paletlerin arkadan bağımsız olarak yukarı-asagi yonde hareket edebilmesi fikrini begendigimi belirtmek isterim.
- entry_name: |
    almerabet
  entry_id:  74704655
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    gol yemediği maç yok sanırım. kova lan bu.
- entry_name: |
