...
- entry_name: |
  ...
  entry_channels: siyaset
- entry_name: |
    seks videosu internete düşen ekşi sözlük yazarı
  entry_id:  79441859
  entry_writer: eksi sozluk yazari
  entry_fav_count: 30
  entry_content: |
    hakkımda asılsız olan haberdir. hangi otel hangi otel?
  entry_channels: 
- entry_name: |
    bedelli askerlik
  entry_id:  79426879
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    ikisi de değil. <br/>zira bazı güçlü aileler yönetiyor.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    "ben" diye başlayıp, "biz" diye biten rezalet. ne yaptın birader, para 1000 lira olunca ortak mı tuttun da paranın miktarı arttıkça "para kazanmaya başladım" olan yazı "paramızı çekmeye başladı" diye devam etti?<br/><br/>bence sen cimer'e yazın. mutlaka ilgilenirler.
  entry_channels: 
---
