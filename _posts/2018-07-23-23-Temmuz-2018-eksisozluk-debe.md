...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    karımın üstüne hiç gül koklamadım koklamam da
  entry_id:  79444932
  entry_writer: jerith royal
  entry_fav_count: 141
  entry_content: |
    aynen böyle türkçe mi demiş? yoksa “i’ve never smelled rose over my wife” mı demiş?<br/><br/>asparagasın kralı.
...
- entry_name: |
  ...
  entry_fav_count: 74
  entry_content: |
    salt batılı sazlar çalan erkekler için var olan çekiciliktir. kimse bana zurnanın sesi kötü demesin(bence de kötü)bağlama, koto, sitar ya da santurun sesi çok mu kötü ki hep keman çello mello çalan tipler hoşunuza gidiyor. hadi diğerlerini zaten çok bilinmediği için salladım bağlamayı bile çekici bulduğunu bildiren tek bir insan yok şu başlıkta. <br/><br/>kabul edin size enstrüman çalan adam çekici gelmiyor, batılı görünen adam çekici geliyor. he bu tabii ki eleştiriyi gerektirir bir durum değil ama gerçek bu. gerçeğin üstünü enstrüman filan deyip örtmeyin.
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    iki kişinin problemini bütün arkadaş grubunun problemi yapması , sır saklayamamasi.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    biri bonkörlük yazmış. hasiktir diyorum. sömürge ülkesi mi arıyosunuz sevgili mi aq? madem bu kadar eşitlikçisiniz kendi hesabınızı kendiniz ödeyin. ödeyemiyorsanız eşitlik diye zırlamayın.
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    bir koş git tek göğüs tavuk al. ortadan ikiye kestir ama kalın olursa içi pişmez. 3 lira kasapta. sonra git ciabatta ekmeği al. ben file'den alıyorum 1 lira o da etti sana 4 lira. <br/><br/>sarımsaklı mayonez ve konserve jalapeno al. bunlar 1 ay gider zaten. <br/><br/>büyükçe bir kaseye yağ yok. içine kekik,tuz,karabiber,toz kırmızı biber sonra iyice yedir ve tavukları at içine karıştır kapat bir kapak bırak dinlenmeye.<br/><br/>iki saat sonra ciaabbatı kes zemine sarımsaklı mayonez,üzerine iki dilim iyi domates, domates üzerine jalapenoları koy sonra tavukları yağda çevir en üste ekle hafif mayonez gezdir tekrar afiyet olsun.<br/><br/>uzun yazdığıma bakma 20 dakkanı almaz yapmaz.
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    bir düşmanı bağışlamak,<br/>bir dostu bağışlamaktan daha kolaydır.
...
- entry_name: |
  ...
  entry_id:  79436700
  entry_writer: anno domini
  entry_fav_count: 5
  entry_content: |
    her seferinde bir umutla bu başlığa giriyorum, ciddi ciddi dertleşebileceğim biri bulurum diye. yüzünü görmediğim, sesini duymadığım biri ile daha rahat konuşurum; o kişi de daha objektif yorumlarda bulunur diye...<br/>yok erkeğim yok kadınım yok bekarım yok sevişgenim de...<br/><br/>taleplerinizi karşılamak için (bkz: <a class="b" href="/?q=ek%c5%9fi+s%c3%b6zl%c3%bck+sevi%c5%9filebilecek+insan+veritaban%c4%b1">ekşi sözlük sevişilebilecek insan veritabanı</a>)<br/><br/>boşaltın burayı, istanbul'a çevirmişsiniz başlığı, ipini koparan gelmiş.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    doğurganlık dışındaki vasıflarını ve erdemlerini (eş, dost, hayat arkadaşlığı, saygı, hürmet, hoşgörü, güleryüz, hoşsohbet...) kaybetmiş cinsiyet türünün verdiği boş tavsiyeler. <br/>sizi mutlu etmek isteyen anlatın derdinizi.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    televizyonculukta gittikçe geriliyoruz, memedalibeeeey dönemleri vallahi daha komikti. leş gibi bir şey 5 dk dayanabildim, ben dayanamadım ama türk halkının içinden de izleyici kitlesi bulabileceğini sanmıyorum. eser'i de sevmem neden ısrarla parlatılmaya çalışılıyor bilmiyorum, 1 komik espirisi, repliği, canlandırdığı karakter hatırlayamıyorum. aliye dizisindeki o çocuk canlandırdığı en iyi karakterdi zirvede bırakmayı bilmeliydi, sonrası giderek berbatlaşıyor.
  entry_channels: tv
- entry_name: |
    ilişkiye girmek anlamında kullanılan fiiller
  entry_id:  79448765
  entry_writer: curet yab
  entry_fav_count: 2
  entry_content: |
    (bkz: <a class="b" href="/?q=sohbet+etmek">sohbet etmek</a>)<br/><br/>bkz: kız arkadaşın babasına dolapta yakalanmak) başlığında görülmüştür.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    william faulkner'ın ses ve öfke'sinde çok zorlanmıştım. kitap zaten ağır bir de öğrenciydim yolda, ders arasında okumaya çalışıyordum. sayfaları baştan ala ala zar zor bitirmiştim ama şaheserdir yani.
  entry_channels: anket,edebiyat
- entry_name: |
    şu anda çalan şarkı
  entry_id:  79430234
  entry_writer: hizir reis
  entry_fav_count: 0
  entry_content: |
    cır cır böceği senfonisi. hayır çiftleşme çağrısı olduğunu bilmesem sıkıntı olmayacak. insanlarda böyle bir olay olduğunu hayal bile edemiyorum.
