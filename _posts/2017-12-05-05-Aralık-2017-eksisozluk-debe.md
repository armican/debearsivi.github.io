...
- entry_name: |
  ...
  entry_fav_count: 57
  entry_content: |
    her gün üzülmek yerine bir kez üzülmeyi tercih eden insandır. zorlayacak gücü yoktur. ilişki dediğiniz şeyde bir yere kadar tek kişinin itmesiyle gidiyor.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 56
  entry_content: |
    8 senede 16 kupayı taktik maktik olmadan kazanan teknik adam.<br/><br/>elmander'e "thor yardımcın olsun" diyordu mesela.
- entry_name: |
    beş para etmez insanların ortak özellikleri
  entry_id:  72579374
  entry_writer: kitarobit
  entry_fav_count: 50
  entry_content: |
    hayvan sevmemeleri, yeşile düşman olmaları, kendilerinden başka kimseyi düşünmemeleri gibi paçalarından bencillik akan tipler olmaları.
- entry_name: |
...
- entry_name: |
    bill gates mark zuckerberg elon musk serkan inci
  entry_id:  72595296
  entry_writer: eksi peace
  entry_fav_count: 38
  entry_content: |
    esaretin bedeli, schindler'in listesi, forrest gump, cumali ceber gibi bir dörtlüdür.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    çok büyük ihtimalle daha erken ölmemi sağlayacak olsa da canı sağolsundur, çakmakla yaklaşmayınız..
- entry_name: |
    mehmet sarı
  entry_id:  72593022
  entry_writer: celikk
...
- entry_name: |
    evlenince ailemle yaşayacağım diyen erkek
  entry_id:  72579532
  entry_writer: zinaedenzidan
  entry_fav_count: 9
  entry_content: |
    bizi ilgilendirmeyen erkek. lan bizene amk. biz güzin abla mıyız ? sözlük lan sözlük ! anlamak bu kadar zor mu ? adam ailesi ile yaşamak istiyor, sense istemiyorsun. o zaman ayrıl olsun bitsin biz senin sahibin, sende bizim evcil hayvanımız değilsin. ne yapacağına biz karar veremeyiz. hassektör ya.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    umarım bu şekilde motor kullanmaya devam eder ve kısa sürede aramızdan ayrılır.
- entry_name: |
...
- entry_name: |
    kupa papazı aslında ölü mü sorunsalı
  entry_id:  72593703
  entry_writer: museha
  entry_fav_count: 1
  entry_content: |
    kafasını kaşıyordur<br/><br/>edit : daha detaylı bilgi verenler olacaktır ama kısa bir araştırmayla "suicide king" yani intihar eden kral ya da bizdeki haliyle papaz olduğunu gördüm. hatta ilk yıllarında hançer değil de baltaymış elindeki. daha detaylı bilgi için linki de bırakayım.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="http://www.wopc.co.uk/cards/suicide-king">http://www.wopc.co.uk/cards/suicide-king</a>
- entry_name: |
    aile arasında
  entry_id:  72578018
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    <a class="b" href="/?q=mavisakal">mavisakal</a>çalarak 20 li yaşlarımın sonuna beni sürükleyen dizi.. yalnız mekanlar aynı, devamlı boş boş sokakta gezinen tipler, hiç entrika yok, hic ters köse yok.. devamlı pis herifler .. tıkanıyor son iki bölümdür dizi.. ana karakterlerde aşk yok... zorlama bi şekilde böyle seksi gösterilmeye çalışılan mini etekli bir gelin devamlı aynı salaş barlara götürüp duruyo yamaç’ı.. iki karakter devamlı baş başa sahne çekiyor artık ne konuştuklarını dinlemiyorum.. çok zorlama çok..sıfır tutku..içim şişti.. eylem’le mert böyle miydi sorarım size?? bir de bu sena’nın yamaç’tan önce yaptığı bir iş bir icraat yok muydu? domestik eltileri gibi hep evde.. ilk bölümde son parasıyla tükürüklü köfte yiyen sena bu kıyafetleri falan nereden alıyo ediyo eve online siparis mi yollatıyor? bari biraz avm sahnesi falan koyun.. tıkılıp kaldınız senaristler ve görüntü yönetmenleri
---
