...
- entry_name: |
    akıllı bir insanı kitap okumaya iten motivasyon
  entry_id:  99229358
  entry_writer: luckdown
  entry_fav_count: 68
  entry_content: |
    tamam anladık sığır olduğunu söylemenin ayıp olmadığı, hiçbir şekilde rezil olunmadığı ve hissedilmediği dönemlerden geçiyoruz. sen dijitali kitapla nasıl mukayese edebildin de demeyeceğim çünkü en son cin ali okudun muhtemelen. kitap okuyan ile okumamış olanı ayırt edebiliyoruz biz merak etme sen. iş hayatında da sosyal hayatta da hangi makama gelip, ne kadar para kazanıyor olsa da bir sığır olarak yaşamaya devam ediyor.
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    (bkz: <a class="b" href="/?q=entry%27de+ya%c5%9fa+tak%c4%b1lanlar">entry'de yaşa takılanlar</a>)
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    1.5 ay önce 30 yaşına girmiş biri olarak beni sevindirmiş durum. ben de kendimi 21-22 yaşında hissediyordum zaten.
...
- entry_name: |
  ...
  entry_id:  99257656
  entry_writer: hectorevolution
  entry_fav_count: 2
  entry_content: |
    kafalarının ölümüne rahat olması
  entry_channels: anket,ilişkiler,eğitim
- entry_name: |
    kilo vermek
  entry_id:  99228131
  entry_writer: trefle12
  entry_fav_count: 1
  entry_content: |
    yav ugrastim durdum diyetisyene gittim if yaptim keto yaptim yav arkadas ben niye veremiyorum kilo. 2 ay spor yaptim gram degisiklik olmadi falan nasil veriyorsunuz arkadas bu kilolari. valla biktim artik. bi 15 kilom var vermem gereken sonra rahata ericem eremiyorum.
  entry_channels: sağlık,yeme-içme
- entry_name: |
    17 aralık 2019 ankara'daki sis
  entry_id:  99231463
  entry_writer: ucgeninicacilari
  entry_fav_count: 1
  entry_content: |
    geceden beri çukurambar da görüş mesafesini tahmini olarak 5-6 metrelere düşüren sistir. araba sürerken insan nereye gittiğini anlayamıyor. hele dikkatlice sokak lambalarına baktığınızda havadaki su buharının hareketlerini görebiliyorsunuz. sisin etkisiyle de yerler fena halde kaygan ve ıslak. sabah saatlerinde havanın - 1 lere düşeceğini düşünürsek umarım yerlerde çok fazla buzlanma yaşanmaz ve sabah trafiğinde kaza bela olmaz.<br/>tanım: ankara’da uzun süredir yaşanmayan hava durumu hadisesi.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    kıyafet için konuşursak, kokuyor. o tarz dükkanlara girdiğinizde bile kokuyor. sadece türkiye'deki dükkanlar değil, yurt dışındakiler de.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    sohbet edip vakit öldürebiliriz. <a rel="nofollow noopener" class="url" target="_blank" href="http://c2.me/demireksi" title="http://c2.me/demireksi">sözlük dışı</a>
  entry_channels: anket,ilişkiler,ekşi-sözlük
---
