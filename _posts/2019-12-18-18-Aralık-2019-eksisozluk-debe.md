...
- entry_name: |
  ...
  entry_id:  99247428
  entry_writer: efsanecayci
  entry_fav_count: 59
  entry_content: |
    açıklayabildiği (resmî) sayı bu kadarsa, gerçekte olanın en az iki katı olduğunu düşündürten suriyeli bebek sayısıdır.<br/><br/>sayıları rahat 5 milyonu bulan suriyelilerin ülkenin başına açtığı geri dönülemez belanın farkında olmamalarına imkan yok. (“kayıtlı” suriyeli sayısı 21 kasım 2019 tarihi itibarıyla toplam 3 milyon 687 bin 244 kişiymiş. resmî sayıya en az dörtte biri kadar da kayıtsız, öso-ışid vb durumlar için ülkede barındırılanları da eklemeli..)<br/>başlarına aldıkları belayı sadece müslümanlık ekseninde yüklenmiyorlar. patronların istediği ucuz ve kaçak işgücünü karşılamaları, artan konut stoğunun bir şekilde kullanılır hale getirilmesi, küçük yerlerde çok ucuza istihbarat bilgisi almada kullanmaları v.b. gibi basit/sıradan sebeplerin dışında, uluslararası arenada kendilerince pazarlık aracı da yapıyorlar “barındırdıkları” suriyelileri. kendi tabanına iç siyaset malzemesi olarak da çok güzel kullanıyorlar bu ‘din kardeşlerini’.<br/><br/>millet bir çocuk yaparken kılı kırk yarıyor. onlar ise habire ürüyorlar... bakalım nereye kadar!..
...
- entry_name: |
  ...
  entry_fav_count: 35
  entry_content: |
    <a class="b" href="/?q=cioran">cioran</a> kendisinin neden yazdığını şöyle anlatır,<br/><br/>''kitaplarımın her biri yılgınlık karşısında bir zaferdir. kitaplarımın birçok kusuru vardır ama onlar mamul değildirler, hakikaten sıcağı sıcağına yazılmışlardır: birine şamar atmak yerine, şedit bir şey yazarım. dolayısıyla söz konusu olan edebiyat değildir, parçalara dayalı bir tedavi usülüdür: intikamlardır bunlar.<br/>kitaplarım kendim için ya da birine karşı harekete geçmemek için yazılmış cümlelerdir. başarısızlığa uğramış eylemler. bildik bir olgudur bu, ama benim durumumda sistemlidir.''
...
- entry_name: |
  ...
  entry_id:  99255571
  entry_writer: konuralp bey
  entry_fav_count: 10
  entry_content: |
    sadece guzel değil; en anlamlı, en değerli hediye zamandır. ona verilen ucuz ya da pahalı bir hediye için harcanan şey paradan daha önemli olan zamandır. onu beklemek, yolunda yürümek, onunla vakit geçirmek, gülümsemesi için çabalamak... ona verdiğin değer, ona ayırdığın zamandan ibarettir çünkü zaman asla geri gelmeyecek olan tek şeydir
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    (bkz: <a class="b" href="/?q=ta%c3%a7s%c4%b1z+kral+pele">taçsız kral pele</a>)
  entry_channels: 
- entry_name: |
    sertleşme problemi
  entry_id:  99255310
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    bu ülkede her istediği eve girebilecek tek kişinin <a class="b" href="/?q=emily+ratajkowski">emily ratajkowski</a> olduğunu düşünüyorum. <br/><br/>eğer bu ismi saflarına katabilirlerse <a class="b" href="/?q=kanzuk">kanzuk</a>’la birlikte bu partiye seve seve katılırız.<br/><br/>t: bir iddia.
  entry_channels: siyaset
- entry_name: |
