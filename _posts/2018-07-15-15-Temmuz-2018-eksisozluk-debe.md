...
- entry_name: |
  ...
  entry_fav_count: 74
  entry_content: |
    muharrem ince’ nin 3’ de 1’ i, chp’ nin yarısı kadar oy almış, terörist dediği hdp’ den daha az milletvekili çıkarmış bir siyasi hareketin liderinin açıklamalardır. o yüzden çok ciddiye almamak gerekir.
  entry_channels: siyaset,haber
- entry_name: |
    mustafa ceceli
  entry_id:  79155393
...
- entry_name: |
  ...
  entry_fav_count: 61
  entry_content: |
    ben bu transferlerin sadece gelecek adına değil, bu sezon için de yapıldığını düşünüyorum. zaten mantık bu oyuncuların oynaması gerektiğini söylüyor. 27 yaşındaki alper oynayıp bizi kanser edeceğine 18-20 yaşındaki yetenekli gençler oynasın.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    kokain içmelik arkadaş veritabanı
  entry_id:  79174952
  entry_writer: the last realist sami
  entry_fav_count: 8
  entry_content: |
    (bkz: <a class="b" href="/?q=narkotik.avi">narkotik.avi</a>)
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    <a class="b" href="/?q=instagram">instagram</a> kullanmayı bırakmak, bu düşünceden kurtulmak için atılabilecek en önemli adımlardan biridir.
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    zeki yakisikli zengin
  entry_id:  79173579
  entry_writer: romantikateist
  entry_fav_count: 5
  entry_content: |
    potansiyel tecavüzcü ve katil. gece geç saatlerde bir kadın filan görürse saldırma ihtimali var.
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    1 iphone x yaklaşık eşittir 2 ton domates
  entry_id:  79169680
  entry_writer: cathars
  entry_fav_count: 1
  entry_content: |
    hemen 1 kilo domatesin fiyatını 10 tl yaparsak açığı bir hayli azaltmış oluruz.<br/><br/>bakan olmalıymışım aslında.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=baz%c4%b1+%c5%9fantiyelerin+%c3%a7ok+seksi+olmas%c4%b1">bazı şantiyelerin çok seksi olması</a>)
  entry_channels: eğitim
---
