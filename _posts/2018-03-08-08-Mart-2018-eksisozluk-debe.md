...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    gelir bahar aylari<br/>salona dolusur badici adaylari<br/>bana brad pitt vucudu yeter deyu<br/>verilir gym aidat paylari<br/><br/>protein tozunu cakarim<br/>ortamlara akarim<br/>agzim laf yapmaz emma<br/>vucuduma iyi bakarim.<br/><br/>2 ay oldu baslayali<br/>baya hissediyorum kaslari<br/>supplement kullansam diyorum<br/>gerci hergun yimirta yiyorum
- entry_name: |
...
- entry_name: |
    felsefe bölümü okuyanların filozof olması
  entry_id:  74806683
  entry_writer: la libertad
  entry_fav_count: 2
  entry_content: |
    felsefe bölümlerinde öğrenciyi analitik düşünceye sevk etmek yerine felsefe tarihine boğmaya devam ettiğimiz sürece imkansız olan. fransız ekolüne bakmak gerekir.
- entry_name: |
...
- entry_name: |
    reddedilip sekiz sene mücadele etmek
  entry_id:  74807353
  entry_writer: qunefee
  entry_fav_count: 1
  entry_content: |
    bir am için 8 sene; helal olsun yaman delikanlıymışsın.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    çok garip olmayan olaydır. sonuçta türkiye de silah ihracatı yapan bir ülke. dünyada 15. falan yanlış hatırlamıyorsam.
---
