...
- entry_name: |
  ...
  entry_id:  72242463
  entry_writer: thisnavy
  entry_fav_count: 58
  entry_content: |
    ''seni gördüğüm an, dünyada başka bir dünya daha olduğunu fark ettim.'' 1988<br/><br/>babamın anneme yazdığı ilk mektubun ilk cümlesi.
- entry_name: |
    green card
  entry_id:  72246649
...
- entry_name: |
    otopark girişlerindeki bagaj kontrolü
  entry_id:  72251779
  entry_writer: galove
  entry_fav_count: 24
  entry_content: |
    bagaj kapağını da hayvan gibi kapatmak şart sanırım bu kontrollerde.<br/><br/>bazen kendim inip açıp kapatasım geliyor. düşman bagajı mı olm bu.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    13 bölüm yerine 8 bölüm yapsalar çok iyi olurmuş.<br/>ilk 4 bölüm ve son 4 bölüm gerçekten çok iyiydi. diğer bölümler onlara göre sönük kalmıştı.<br/><br/>gerçi 33 bölüm olsa da izlenir jon bernthal çok iyi kıvırıyor bu işi.
- entry_name: |
    alparslan'a destek oluyoruz kampanyası
  entry_id:  72263689
  entry_writer: darkpoe
  entry_fav_count: 2
  entry_content: |
    alparslan 'ın adımlarını duymak ümidiyle desteklenmesi gereken kampanya.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    istanbul’da gayrimenkul işiyle uğraşıyorum elimde çeşitli kat karşılığı, satılık arsalar var bir tanede kadiköy’de avm projesi var ilgilenen arkadaşlar yeşillendirebilir.<br/><br/>sözlük dışı: ezelozanersoy@hotmail.com
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    --- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>yamaç daha gece karısı ittirince acıdan iki büklüm oldu, şimdi isa ile ölümüne kavga edecek. komik olmuş.<br/><br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---
---
