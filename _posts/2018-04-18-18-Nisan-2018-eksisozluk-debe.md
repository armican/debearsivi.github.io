...
- entry_name: |
    hitler kisin rusyaya gitseydi simdi koleydik
  entry_id:  76102177
  entry_writer: euronews
  entry_fav_count: 7
  entry_content: |
    9-b sınıfından rusya'ya güzelleme adlı "eseri" için arkadaşımıza teşekkür ediyoruz.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=%c3%a7ay">çay</a>)<br/>thcai, chai, thea, tea, tcee, tee, tchei, cai, chei, cay, çay, te, shay, çaj, ça, cha, teh ....
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    kafasına vurmak suretiyle , şuan zamanı olmadığını anlatabiliriz.
  entry_channels: anket,ilişkiler
- entry_name: |
    turgut özal
  entry_id:  76086935
  entry_writer: one april
  entry_fav_count: 0
  entry_content: |
    yerlere göklere sığdıramayıp, suikaste uğradığına inanan sevenleri varmış. o suikastin ne kadar fake olduğunu ilkokula giden çocuklar bile anladı.<br/><br/>askere haddini bildirmiş miş. asıl amerika bunun haddini bildirdi.
