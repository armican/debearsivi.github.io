...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    beğendiğim film olmuştur.. özellikle sömürücü bir ülkenin sömürülenler üstünden film yapıp dolaylı olarak para kazanması aklımı karıştırdı :)
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    fifa world cup 2002 oyununda yıldızlı topçular vurduğunda kaleye ateş çıkartarak giderdi.
- entry_name: |
    iphone se
  entry_id:  74315724
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    doya doya sevemedim vazgeçmek zorunda kaldım. sevdirtmedin kendini. alacağın olsun.
- entry_name: |
...
- entry_name: |
    nba all-star 2018
  entry_id:  74306329
  entry_writer: sokak papagani
  entry_fav_count: 5
  entry_content: |
    vince carter bu diyardan göçüp gitmiş olsa, mezarında ters dönerdi.<br/>aynı smacın 2 farklı versiyonunun arasında bu kadar estetik fark olması da gerçekten carter'a olan saygımı arttırdı.
- entry_name: |
    la casa de papel
  entry_id:  74313555
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    komplo teorisi basit: ali koç kazanamasın diye tüpçü kadim dostu aziz'e kıyak geçecek.
---
