...
- entry_name: |
  ...
  entry_fav_count: 134
  entry_content: |
    bir ortadoğulunun kendisini en üstün ırk zannedip yine farklı bir ortadoğuluyu sevmeyip ben senden üstünüm demesi kadar komik bir şey yok sanırım.
...
- entry_name: |
  ...
  entry_channels: ekonomi
- entry_name: |
    galatasaray bu kadro ile fenerbahçe'yi yener mi
  entry_id:  93937102
  entry_writer: xlarg3
  entry_fav_count: 87
  entry_content: |
    liverpool 11'ini alalım, üstüne galatasaray forması giydirelim yine kadıköy'de feneri yenemeyiz. öyle bir lanet.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    paralı kıro k*rtlerin sayfası.<br/><br/>yalnız şunu çok net biliyorum, vahşi olduğunuz için milyonlar da gasp etseniz beş para etmez bi yaşantınız var.<br/><br/>altınızda range rover da olsa, dağa silah sıkmaya giden hanzonun tekisiniz mk.
...
- entry_name: |
  ...
  entry_id:  93963511
  entry_writer: ali the terrible
  entry_fav_count: 3
  entry_content: |
    partizan’ın 6 numarası resmen üst oynamış. ayağını uzatsa kenara gönderirdi o topu.
  entry_channels: spor
- entry_name: |
    günaydın mesajı
  entry_id:  93938485
  ...
  entry_fav_count: 2
  entry_content: |
    e-5 bostancı istikametinde kaza var<br/>arkamdan korna çalan dangalak<br/>az önce gördüm ekşide takılıodun<br/>sanada günaydın
  entry_channels: ilişkiler
- entry_name: |
    devran çağlar
  entry_id:  93962202
...
- entry_name: |
  ...
  entry_id:  93961140
  entry_writer: yirminciyydanmektuplardakikarakedi
  entry_fav_count: 1
  entry_content: |
    sanki turk erkegi boy ortalamasi 1.70 degilmis , feminen ruhtan anlarmis, ulkede kisi basina dusen kitap sayisi yillik 5 degilmis, en derinlestikleri konular futbol degilmis, milliyetcilik/siddet/ ataerkillik damarlarindan akmazmis, karakter gelisimini ancak 40 yasinda tamamlamiyorlarmis (bkz: <a class="b" href="/?q=35+yasina+gelip+hala+20+yas+pesinde+kosmak">35 yasina gelip hala 20 yas pesinde kosmak</a>) gibi farkindaligi gelismemis, kendilerini her zaman en iyiye layik goren turk erkeklerinin hayalini susleyen iphone nun yeni serisidir.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
    pkk neden domaltılamıyor
  entry_id:  93962914
  entry_writer: sokrates06
  entry_fav_count: 0
  entry_content: |
    o kadar dış desteğe rağmen anaları zikilse de tam olarak domaltılması zor.
  entry_channels: siyaset,anket,tarih
- entry_name: |
    komşunun sevişmesini duymak
  entry_id:  93963686
  entry_writer: banateklifedenbucocuktu
  entry_fav_count: 0
  entry_content: |
    başka şeye de benzemiyor gürültü olsa duvara vurursun ama bunda yapamıyosun utanıyor insan
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    kafe sahibinin amcası gazi olduğunu bilseydik dövmezdik minvalinde bir açıklama yapıp tüy dikmiş... pardon yüreklere su serpmiştir. bu ülkede hala vicdanlı insanlar olduğunu görmek güzel.<br/><br/>adam %92 engelli raporluymuş, sadece engelli olsa dövmek mübah yani.
  entry_channels: 
- entry_name: |
