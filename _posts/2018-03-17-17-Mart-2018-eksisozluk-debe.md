...
- entry_name: |
  ...
  entry_fav_count: 29
  entry_content: |
    boyun eğmeyeceğiz ne? sen devletsin. boyun eğmeyeceğiz değil, izin vermeyeceğiz diyeceksin ve bir haftaya kalmaz izin vermediğinin ispatını gösteresin. ki devlet olasın.
- entry_name: |
...
- entry_name: |
    sözlük bank
  entry_id:  75093447
  entry_writer: bunickondokuzharfli
  entry_fav_count: 11
  entry_content: |
    bu kadar insanın salak olamayacağını düşündüm. ben de üye oldum.
- entry_name: |
    vücut geliştirme
  entry_id:  75082343
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    buradaki konu duman'ın en güzel şarkısının ne olduğu değildir. başlığın en başındaki favorilenen bir iki entry gerçeğidir. sen götünü yırtıp muazzamcık bi entry yazsan da o bir iki entry fav'lanacak şukulanacaktır. beşinci sayfanın ortasında bi yerde hangi şarkı neden en iyi falan döktürsen bile belki diğerlerinden biraz fazla dikkat çekecektir. dediğim gibi konu duman değil. hangi şarkısı en güzel sorunsalı hiç değil. konu buranın koyun sürüsü olması. insanların popülizmi, öğrenme ve merak etme dürtüsüne tercih etmesi. buraya denk geldi buraya yazdım. buna benzer bir şeyi sanırım bir iki kez daha yazmıştım. ölmez de sağ kalırsam yine yazarım.<br/><br/>bu arada duman'ın en güzel şarkılarından biri melankoli. bu da içimde kalmasın dedim.
---
