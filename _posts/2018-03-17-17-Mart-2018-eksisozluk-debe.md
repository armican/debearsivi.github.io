...
- entry_name: |
    lebron james'in insanüstü smacı
  entry_id:  75079652
  entry_writer: tfrlgz
  entry_fav_count: 107
  entry_content: |
    (bkz: <a class="b" href="/?q=yok+art%c4%b1k+lebron+james">yok artık lebron james</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 54
  entry_content: |
    şu an bu başlıkta 2424 giri var. <br/>para yatıran insan sayısı 77000. <br/>geri ödemeleri ve yatırım, reklam vs giderleriyle bu olusumun caldıgı para olsun olsun 100 milyon tl. <br/><br/>(bkz: <a class="b" href="/?q=cengiz+in%c5%9fa%c5%9fat%27%c4%b1n+vergi+borcunun+silinmesi">cengiz inşaşat'ın vergi borcunun silinmesi</a>)<br/><br/>bu baslıkta 213 entry var. parası calınan ınsan sayısı 80 mılyon. calınan para donemınde 422 mılyon tl su ankı kurla mılyar tl uzerinde...<br/><br/>ve hala devam ediyor.<br/><br/>(bkz: <a class="b" href="/?q=cengiz+holding%27in+devlet+s%c4%b1rr%c4%b1+kapsam%c4%b1na+al%c4%b1nmas%c4%b1">cengiz holding'in devlet sırrı kapsamına alınması</a>) <br/><br/>bu başlığa girilen entry sayısı 28<br/><br/>sozluk gündemi uzerinden turkiye cıkarımı yaparsak biz milletce amımıza konulmasını sevıyoruz. ciftlik bank gibiler sadece ön sevişme yaptıklarımız. <br/><br/>bence tosuncuk gangbang arkadaslarını yanlıs secti ve oyuzden patladı. <br/><br/>sevgiler.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    abi ben bu adamın transferindeki saçmalığı anlamadım. eskiden "hülle transferi" diye bir şey vardı. aynısını bu adam için uygulansa beşiktaş net para kazanır.<br/><br/>şimdi bu adam için city, united falan 40 milyon euro'yu gözden çıkarmış diyorlar. beşiktaş 21 milyon euro verince sorgusuz sualsiz talisca beşiktaş'a transfer oluyor mu? oluyor. <br/><br/>eee peki united ile beşiktaş anlaşsın " gel kardeşim ben sana bunu 30'a satayım sen de kazan ben de kazanayım" desin ve 21 milyon euro'ya alıp 30 milyon euro'ya satsın direkt. <br/><br/>bu duruma bir engel var mı? varsa da nedir?
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  75093711
  entry_writer: estetico
  entry_fav_count: 8
  entry_content: |
    amele gibi pişirilmemesi gereken makarna. makarna yarısı suya batacak şekilde tencereye dik bir şekilde yerleştirilir. 1-1,5 dakika içinde makarnanın suya batan kısmı yumuşar ve makarnayı bölmenize gerek kalmaz
- entry_name: |
    erdoğan arıkan
  entry_id:  75082131
  entry_writer: uuykaf
  entry_fav_count: 5
  entry_content: |
    bu baslikta bu memleketin neden bir sik olamayacagina dair nadide ornekte entryler goruyoruz. adam bize neden boyle dediler acaba diye sorgulayacagina kufur kiyamet ozur pesinde, istifa pesinde. bu tip sigirlarla yine iyi batmiyor lan bu memleket.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    ben <a class="b" href="/?q=masumiyet+m%c3%bczesi">masumiyet müzesi</a>ndeki kemal gibi sevmek isterdim. hani füsun’a aşık oluyor da bütün ömrü bu aşkla mahvoluyor. kendi sınırlarını keşfediyor. başkasından beklenti içinde olmadan. gerçek aşk adamı dönüştürüyor. <br/><br/>her şeyi kaybettikten sonra “herkes bilsin, mutlu bir hayat yaşadım.”
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    filmde o kadar çok sigara içiliyor ki yarıda bırakıp sigara içesi geliyor insanın.<br/><br/>sen nasıl bir adamsın yiğit özşener.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    habercilikte de aynen böyle taşşak geçmiyorlar mı? thats why i never watch news man. (bu yüzden haftaya sıkı giyinin kar yağacak).
- entry_name: |
    şu anda çalan şarkı
  entry_id:  75092599
...
- entry_name: |
    mehmet aydın'ın uruguay'daki evi
  entry_id:  75095776
  entry_writer: altairibnlaahad
  entry_fav_count: 0
  entry_content: |
    akıllı ise ki akıllı mağdurlardan biri değil evine, mahallesine giremez tosunun.
---
