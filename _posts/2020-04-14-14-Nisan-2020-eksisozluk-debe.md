...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    kemalist paşaların ülke yönettiği dönem
  entry_id:  105332795
  entry_writer: neyemeyilli
  entry_fav_count: 11
  entry_content: |
    dinci vakıflarda çocukları seks kölesi olarak işleten (bkz: <a class="b" href="/?q=ensar+vakf%c4%b1">ensar vakfı</a>), karşıt görüslü gençleri sokaklarda sopayla döverek öldüren (bkz: <a class="b" href="/?q=ali+ismail+korkmaz">ali ismail korkmaz</a>), kendi kızlarına şehvet fetvası veren, kafa kesen, çocuk ve kadınlara tecavüz edip kole pazarları kuran müslüman terörist örgütlere silah gönderen ve onları öfkeli çocuk olarak niteleyen manyak dincilerin olmadığı dönemdir.<br/><br/>işin insani gelişmişlik ve ekonomik refah kısmına hiç girmiyorum bile.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    38 milyon dolar yatırım almışsın arkadaş, duygusal istismar yapıp kuryen için bahşiş istemenin anlamı yok.<br/><br/>çalışanı motive etmek işverenin sorumluluğudur, müşterinin değil. bir zahmet aylık karından bütçe ayır çalışanlarına dağıt.
  entry_channels: ekşi-sözlük,programlama,edebiyat,teknoloji,yeme-içme,ekonomi
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    şaşırtmayandır.<br/>ruhi bey yabancı sitelerdeki videoları tercüme etmekte çok başarılı.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    kör babannemin önün 31 çektim, götüme tuvalet pompası soktum videoları 5 milyon izleniyor, gazeteciliği izlenmeyle ölçen dallamalar sktir olsun gitsin.
  entry_channels: siyaset,tv,haber,seyahat
- entry_name: |
    starbucks'ın olmazsa olmazları
  entry_id:  105331855
  entry_writer: moscow dream
  entry_fav_count: 3
  entry_content: |
    bardağı çekip story atanlar.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    a101'e git, buğdayla takas imkanı bile var.
  entry_channels: ekonomi
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    alışveriş icin en sik kullandigim site. ozellikle 75 tl uzeri bedava kargo hizmetine bayılıyorum. kac parca alirsan al fark etmiyor. ama kardesim bir urune olumsuz yorum yaptigimizda gizlemeyin sizde be. insanin guveni sarsılıyor.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    benim çevremde de maske alan yok. <br/>ama koskoca c.başkanı yalan söyleyecek değil yani.<br/><br/>bu durumda yalan söyleyen ben oluyorum. niye böyle oldu ki şimdi :(
