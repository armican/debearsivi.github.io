...
- entry_name: |
    imamoğlu'nun akbili 40 tl yapması
  entry_id:  90118467
  entry_writer: hononu
  entry_fav_count: 271
  entry_content: |
    bu imamoğlu'nun başarısıdır. tebrikler.
...
- entry_name: |
  ...
  entry_fav_count: 98
  entry_content: |
    bu adamla metrobüste otuzbir çeken sapık aynı adamdır. değilse bile potansiyeli vardır. <br/><br/>tanım: sapık, beyni çürümüş bir zavallının entrysi<br/><br/>silerse felan <a rel="nofollow noopener" class="url" target="_blank" href="https://eksiup.com/p/dn96438zqor5">https://eksiup.com/p/dn96438zqor5</a>
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    güvendiğin, sevdiğin, sevildiğin ile sokaktan bulduğun arasındaki fark olsa gerek. zira biri sevişme iken biri seks
  entry_channels: ilişkiler
- entry_name: |
