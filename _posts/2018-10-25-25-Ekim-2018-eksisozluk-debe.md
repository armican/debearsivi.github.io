...
- entry_name: |
  ...
  entry_fav_count: 76
  entry_content: |
    eskiden çok daha yaygın bir alışkanlıktı, zamanla unutuldu. tabi ara sıra denk geldiğinizde çomarlık cehalet falan diye yaygara çıkarıyorsunuz, derdinizi sikmekten başka elimden bişey gelmez.
...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    izmir metrosu'nda atatürk'e benzeyen amca
  entry_id:  82631117
  entry_writer: atini oksayan kovboy
  entry_fav_count: 42
  entry_content: |
    atatürk için türk değil derler anası babası belli değil derler ama türkiye de binlerce atatürke benzeyen kişi vardır. peki bana bir tane rte benzeri birisini göstersenize? hangisi daha çok türk?
...
- entry_name: |
  ...
  entry_fav_count: 40
  entry_content: |
    "bugün annem öldü. belki de dün, bilmiyorum."<br/>-yabancı-<br/><br/>tabii ki edebiyat tarihini tartabilecek yetide biri değilim. beni en çok etkileyen bu olmuştur. hatta kitabı okumaya gerek bile yoktur artık.
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    zeytinköy'ün tokatlayacağı versus
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    biraz önce ankara muhabirini gereksiz yere kıyafet konusunda bozdu. herifin kravatından sanane. iyicene havalandı bu.
...
- entry_name: |
    kemal kılıçdaroğlu'nun yaptığı en iyi şey
  entry_id:  82622584
  entry_writer: flightair
  entry_fav_count: 9
  entry_content: |
    (bkz: <a class="b" href="/?q=soru+sormak">soru sormak</a>)<br/><br/>yaptığı konuşmaları dinleyin, sadece soruyor, başka bir halt söylediği yok. cevap desen o da yok.
...
- entry_name: |
    tanrının insanlara eşit ömür vermemesi
  entry_id:  82628437
  entry_writer: al2che enon
  entry_fav_count: 7
  entry_content: |
    şuna da razıyız;<br/><br/>(bkz: <a class="b" href="/?q=%c3%bczg%c3%bcn+ge%c3%a7irdi%c4%9fimiz+s%c3%bcrenin+%c3%b6mr%c3%bcn+sonuna+eklenmesi">üzgün geçirdiğimiz sürenin ömrün sonuna eklenmesi</a>)
  entry_channels: 
- entry_name: |
...
- entry_name: |
    elit kesimin beğendiği sporlar
  entry_id:  82624535
  entry_writer: benjaminimsi
  entry_fav_count: 4
  entry_content: |
    (bkz: <a class="b" href="/?q=da%c4%9fc%c4%b1l%c4%b1k">dağcılık</a>) <br/><br/>zira ekipman masrafını elit olmayan kesim ödeyemez.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    geleneksel boru törenlerinin devamı başlık. eğlenceli de oluyor, art niyet aramamak lazım. ancak dikkat edilmesi gereken bir husus var;<br/>bjk ve fener taraftarlarını ima ederek 'sikeci ve tinerci' demeyin lütfen. <br/>zira bunlarin ikisi de sikeci olduğu tescillenmiş takımlardir. 'sikeci ve tinerci sikeci' diyin.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    ter atmak isteyen mü'minleri de buraya bekleriz.<br/>(bkz: <a class="b" href="/?q=kuran%27%c4%b1n+insan+yap%c4%b1s%c4%b1+oldu%c4%9funun+delilleri">kuran'ın insan yapısı olduğunun delilleri</a>)
  entry_channels: siyaset,anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=aoQApwEk6Uw&amp;index=4&amp;list=LLC35XkJFzUW85G0eWkjcyPw" title="https://www.youtube.com/watch?v=aoQApwEk6Uw&amp;index=4&amp;list=LLC35XkJFzUW85G0eWkjcyPw">two steps from hell - pegasus</a>
