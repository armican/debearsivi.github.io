...
- entry_name: |
  ...
  entry_fav_count: 52
  entry_content: |
    çok da büyütülecek bir olay değildir. ağzımı açık bırakan bir anımı paylaşmak isterim. arkadaşımın ninesi formunda o zamanlar. <br/><br/>- bul bi kız da evlen yiğidim. ikinizin de yaşı geldi.<br/>+ sen canını sıkma nine. zengin bi dul bulup işimi gücümü bırakıp hayatıma bakarım. o bana baksın. <br/>- (küfürleri geçiyorum) başkasının öğrettiği ata binilir mi?<br/><br/>başlığa konu olan durum çok hassas. bir şeyler yazarken dikkat etmek lazım. çevrenizde, ailenizde bu durumda olan birileri illa ki vardır. rastgele buraları okuyan depresyondaki boşanmış bir kadın için cehennem etkisi yaratacak entry'ler gördüm. dünya hali, bir gün başlığa konu olursunuz; belki kızınızla belki karınızla.
...
- entry_name: |
  ...
  entry_id:  82637520
  entry_writer: hayir da sananeki benim adimdan
  entry_fav_count: 32
  entry_content: |
    (bkz: <a class="b" href="/?q=sekkiz">sekkiz</a>)
...
- entry_name: |
  ...
  entry_fav_count: 32
  entry_content: |
    tam umreye gitmeye karar verdiğim günlerde bana gelip bir takım sorunlarından bahsederek yardım istemiş ve başımı sırrı ve ateşin adamlarıyla belaya sokmuştur.
  entry_channels: sinema,spoiler
- entry_name: |
    ideal kadın ayağı numarası
  entry_id:  82638307
  entry_writer: iboli
  entry_fav_count: 28
  entry_content: |
    aslında merak da etmiyorum biliyorum yanıltmazsınız da beni..<br/><br/>kadınlara yapmadığınız herhangi bir kategori kaldı değil mi?<br/>yıllardır şu <a class="b" href="/?q=%c3%a7%c3%b6p+ba%c5%9fl%c4%b1k">çöp başlık</a>ları açmak için mi <a class="b" href="/?q=%c3%a7aylak+onay+listesi">çaylak onay listesi</a> beklediniz?!<br/><br/>tanım: bir adet <a class="b" href="/?q=%c3%a7%c3%b6p+ba%c5%9fl%c4%b1k">çöp başlık</a> klasiği
  entry_channels: anket,ilişkiler,moda
- entry_name: |
    lara vs konyaaltı
  entry_id:  82627484
  entry_writer: vurucukobra
  entry_fav_count: 26
  entry_content: |
...
- entry_name: |
    24 ekim 2018 muharrem ince cnn türk yayını
  entry_id:  82637332
  entry_writer: az bilinen yonleriyle starklarin gelini
  entry_fav_count: 15
  entry_content: |
    seçim gecesi kılıçdaroğlu ve ekibinin oyununa gelip ortada bırakıldığına inanıyorum. hala sevdiğimi anladığım yayındır.
  entry_channels: siyaset,tv
- entry_name: |
    24 ekim 2018 abd seri bomba saldırı girişimi
  entry_id:  82635835
  entry_writer: pipi telli
  entry_fav_count: 15
  entry_content: |
    sözlüğün seviyesi için ; <br/><br/>(bkz: <a class="b" href="/entry/82635752">#82635752</a>)<br/><br/>???!?<br/><br/>bunu dışında ,nasıl sonuçlanacağını merak etmekteyim.
  entry_channels: siyaset,haber
- entry_name: |
    ekşi itiraf
  entry_id:  82625495
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    içinde bulunduğum durumu hemen hemen özetleyen başlık.<br/><br/>tek eksiğim düşük maaş. düşük müşük bir maaşımız olsa iyiydi tabi.<sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    ozan rakipte oynasaydı " adamlar 18 yaşında adamı şl. maçında oynatıyor. bizim defansta ahmet çalık, maicon var. " derdiniz.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    (bkz: <a class="b" href="/?q=erkek+yazarlar%c4%b1n+hep+geceleri+sormas%c4%b1">erkek yazarların hep geceleri sorması</a>)<br/><sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    görme engelliyim. haliyle sokaklarda beyaz bastonla yürüyorum. bir kısım arkadaşımız da yeni yeni rehber köpek kullanmaya başladılar. bu şekilde tek başına sokağa çıkan çok fazla arkadaşımız var ki bir kısmına etrafının farkında olan süserler de şahit olmuşlardır mutlaka. köpek, elimizdeki bastonu tehdit olarak algıladığından bazen nereden geleceğini kestiremediğimiz bir saldırı altında kalabiliyoruz. yahut bizim aslında tek başımıza hareket etmemizi kolaylaştırması maksadıyla yanımızda bulunan rehber köpeğe sarabiliyorlar. bu şekilde saldırıya uğrayıp köpekler tarafından ısırılan bildiğim çok arkadaşımız var fakat basına yansımıyor. güvenliğimiz ve özgürce hareket edebilmemiz için benim de desteklediğim önerme. tabii ki tutup "öldürün" de demiyorum, senin benim gibi onlar da can taşıyor. ama ülke genelinde, minimum tehlike arz edecek şekilde bir planlama yapılması gerektiğini düşünüyorum yazacaktım planlama diyince vazgeçtim. şimdiye kadar neyi adam gibi planlayıp uygulamışlar ki bunu yapsınlar. neyse siktir et olan olduğuyla kalır nasıl olsa her zamanki gibi, çenemizi yorduğumuza değmiyor.
  entry_channels: sağlık,haber
- entry_name: |
    iş yerinde her şeye karışan patron
  entry_id:  82624962
  entry_writer: checuba
  entry_fav_count: 6
  entry_content: |
    (bkz: <a class="b" href="/?q=her+%c5%9fey">her şey</a>)<br/>(bkz: <a class="b" href="/?q=i%c5%9f+yeri">iş yeri</a>)<br/><br/>başlıkın %50.si yalnış..<br/><br/>edit : beyler bayanlar, yazdığım cümlede sadece ''başlıkın'' kelimesi yanlış değil, cümlede geçen tüm kelimeler yanlıştır. sürekli sen de ''başlıkını'' yanlış yazmışsın diye öm atmanıza gerek yok, başlığa ithafen ironi yapılmıştır.<br/><br/>''başlıkın'' &gt; başlığın<br/>''%50.si'' &gt; %50'si<br/>''yalnış..'' &gt; yanlış...<br/><br/>''başlığın %50'si yanlış...''
  entry_channels: 
- entry_name: |
  ...
  entry_channels: sağlık,haber
- entry_name: |
    ülkücülükten sosyalizme evrilmek
  entry_id:  82614062
  entry_writer: danspistindekicocuk
  entry_fav_count: 5
  entry_content: |
    <a class="b" href="/?q=hilal+cebeci">hilal cebeci</a>nin bella ciao klibinden sonra tersini yaşadığım durum.
  entry_channels: siyaset,eğitim
- entry_name: |
    büyük iskender vs cengiz han vs timurleng
  entry_id:  82635900
  entry_writer: feanor fingolfin
  entry_fav_count: 5
  entry_content: |
    farklı zamanların, farklı şartların, farklı coğrafyaların farklı komutanları.<br/><br/>kendi devirlerinde en iyidirler. bugün olsa doğar doğmaz ölen cs oyuncusu gibi olurlar. o yüzden sadece kendi dönemleri ile kıyas edin. <br/><br/>zira insan birikimler ile gelişir.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    <a class="b" href="/?q=24+ekim+2018+galatasaray+schalke+04+ma%c3%a7%c4%b1">24 ekim 2018 galatasaray schalke 04 maçı</a>'nı kazandırırsa büyük ihtimal gruptan çıkacağımız için aldığı maaşların hakkını da ödemiş olur. takımın yarısı yok, hatta kendisinin de hafif sakatlığı var. bu şartlar altında bir kahramana ihtiyacımız var ve bunu bize borçlu olan adamların başında belhanda geliyor.<br/><br/>gol atmasan da 2 tane attır al şu maçı be arap. artık zamanıdır.
  entry_channels: spor
- entry_name: |
    müşteriyi azarlayarak konuşan esnaf
  entry_id:  82638824
  entry_writer: nabiyonenabimsennabiyoniyinabimsen
  entry_fav_count: 3
  entry_content: |
    geçenlerde örneğini yaşadığım esnaftır. su için aradım 45 dk oldu halen gelmedi. aradım dedimki her zaman 15 dk da gelen damacana uludağ dan yola çıktı galiba sorun nedir dedim elimde yoktu şimdi geldi dedi. 10 dk ya sende dedi. üzerinden 15 dk geçti sinir oldum aradım nerede kaldı dedim sana gelene kadar çok siparişim var dedi. peki neden bunu söylemedin seni aradım diye yoldan geçen sucu ya seslenip almadım bu nasıl esnaflık dedim çağır o zaman ondan al dedi ve suratıma kapattı. esnaflık bitmiş. sonra küçük esnaf zorda hiper marketlerden almayın rororo.. geç bunları şark kurnazı kaybettin bir müşteri daha...
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    7 haziran 2015 seçimlerinde muhalif seçmenin oylarıyla meclise girip iktidarla birlikte hareket eden ancak 24 haziran 2018 seçimlerinde iktidar secmeninin oylariyla meclise girip muhalefetle birlikte hareket eden parti. <br/><br/>akıl sır erdiremedim kendilerine.<br/><br/><a class="b" href="/?q=edit">edit</a>: neyse demin fabrika ayarlarına döndüler.
  entry_channels: siyaset,tarih,haber
- entry_name: |
    ekşi sözlük dertleşecek insan veritabanı
  entry_id:  82611367
  entry_writer: meteor76
  entry_fav_count: 1
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=KBx1Q3DEyDY" title="https://www.youtube.com/watch?v=KBx1Q3DEyDY">chris isaak - wicked game</a>
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    yıllardır yaptığım analizle istisnasız "boy"<br/><br/>bir kadın çok güzel olmasına gerek bile yok uzun boyluysa diğer kadınlar round başlamadan knockout.<br/><br/>hiçbir kadın inkar edemez bunu, üzgünüm kızlar.
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=bir+acayip+adam">bir acayip adam</a>)
