...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    (bkz: <a class="b" href="/?q=15+temmuz+demokrasi+%c5%9fehitleri+tayyaresi">15 temmuz demokrasi şehitleri tayyaresi</a>)
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    bneler, <br/>ergenler, <br/>feminaziler yazmasın. <br/><br/>yukarıda saydıklarımın dışında kalan herkes yazabilir. dertleşmek değil de muhabbet etmek tercihimdir
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    google -&gt; beşiktaş nöbetçi zımbacı
  entry_channels: spor
- entry_name: |
    nimet abla'da sıraya girenlerin zeka seviyesi
  entry_id:  84346866
  entry_writer: insanmuhendisii
  entry_fav_count: 0
  entry_content: |
    ilâhi adaletten bahsederler. namaz, oruç, haram, münafık ağızlarından eksik olmaz ama piyangodan gelecek haram lokmayı ağızlarına almaktan hiç ama hiç çekinmezler. <br/>istisnalar vardır tabii ama çoğunluğu kendini dinine bağlı olduğunu sanan insancıklardan oluşmaktadır. <br/>(bkz: <a class="b" href="/?q=dinde+%c5%9fark+kurnazl%c4%b1%c4%9f%c4%b1">dinde şark kurnazlığı</a>) <br/>zekâ konusuna hiç değinmiyorum bile!
  entry_channels: sağlık
- entry_name: |
