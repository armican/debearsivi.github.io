...
- entry_name: |
  ...
  entry_fav_count: 207
  entry_content: |
    bazı insanlara geç kalırsınız.<br/>sizden önce uğrayan, bütün güzellikleri yoketmiştir.<br/>siz yanlış zamanda yanlış yerde olan, o talihsizsiniz...
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    dert dinlemeye insan niye chat linki verir ki arkadaş? <br/>bi de yaş ve şehir sınırı koyanlar var. kriterlerinize uymayanın derdi dert değil galiba<sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    benim için engel'dir.<br/><a rel="nofollow noopener" class="url" target="_blank" href="http://youtu.be/x2rQzv8OWEY" title="http://youtu.be/x2rQzv8OWEY">engel</a>
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=izmir%27de+hdp+a%c5%9f%c4%b1%c4%9f%c4%b1+adaya+oy+verecek+iyi+parti%27li">izmir'de hdp aşığı adaya oy verecek iyi parti'li</a>)
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=iyi+parti+kurucu+%c3%bcyesinin+istifa+etmesi">iyi parti kurucu üyesinin istifa etmesi</a>) <br/>(bkz: <a class="b" href="/?q=cezmi+polat">cezmi polat</a>)
  entry_channels: siyaset,haber
- entry_name: |
