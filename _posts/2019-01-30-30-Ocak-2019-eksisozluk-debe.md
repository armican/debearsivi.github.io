...
- entry_name: |
  ...
  entry_fav_count: 32
  entry_content: |
    erkeklerdeki gibi askere gitmemek için değildir.
...
- entry_name: |
    türkeş mezardan çıksa iyi parti'ye şamarı vurur
  entry_id:  86080514
  entry_writer: nickbulamadimnolcak
  entry_fav_count: 30
  entry_content: |
    türkeş önce türkçülüğü ayaklar altına alan partiye giden oğluna vursun ne vuruyorsa.<br/><br/>t: gerzek ötesi bir tespit. senin aldığın maaşın sülalesini sikeyim senle beraber amına kodumun trolü.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 27
  entry_content: |
    muhtemelen sadece temel fizik parametrelerinden oluştuğu için değiştirmeye kalkarsanız evrenin amına koyacağınızı hesaplayarak yapmanız gerekenlerdir.
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    kadını buldukta sözü kaldı amına koyim. yatın uyuyun hadi geç oldu.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    o.cocugusun dese daha az koyardı herhalde.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    türk askeri suriye de suriyeliler için savaşsın. götüm götüm suriyeten kaçıp türkiye de paşalar gibi yaşatılan elin arabı, işsizlik yüzde 12 lerdeyken iş kur tarafından kayırılsın.<br/><br/>vallahi gel de sinirden saç baş yolma.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    trabzonspor'da mehmet ekici'yi çok beğeniyordum geldi, katkı sağlıyor devamlı olmasa da. beşiktaş'ta talisca'dan sonra en beğendiğim futbolcu, umarım gelir sakatlık problemi pek yaşamıyor büyük katkı sağlar.<br/><br/>not:uchehöghkemalettinspor
  entry_channels: spor
- entry_name: |
    şu anda çalan şarkı
  entry_id:  86063834
