...
- entry_name: |
  ...
  entry_fav_count: 103
  entry_content: |
    2090 temmuz öğretmen atamalari-tikla.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    ege'yi alaçatı zanneden troll beyanı.<br/><br/>alaçatı, ege olabilecek en son yerdir. sen git caddebostan'da çimmeye devam et.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    ben şu zamana kadar yüklemelerin hiçbirinden hiçbir bok anlamadım.<br/>nasıl anlıyorsunuz yağ gibi kaydığını falan lan.<br/>aynı işte normal aynı hızda açıyor.
- entry_name: |
    msn hatıraları
  entry_id:  75628045
  entry_writer: jujuu
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    10 aylık evliyiz. akşam okuldan gelince 5 ila 7 arası ben uyurum. 6 ila 10 arası eşim uyur. arada bi duş filan alınır. sonra tekrar uyuruz. şu an salonda tv karşısında horlama sesleri geliyor mesela. <br/><br/>ya da evlenmeyin. çok da bi bok yokmuş. çocuk yapmaya bile fırsat yok yani uyumaktan. eşim masa başı devlet memuru ve dünyanın en yorucu işini yaptığını düşünüyor. ben de bazen kurabiye yapıyorum. baya mutluyuz şimdilik.
- entry_name: |
    la casa de papel
  entry_id:  75628733
...
- entry_name: |
    sinirliyken yapılmaması gereken şeyler
  entry_id:  75644402
  entry_writer: suratsizbasci
  entry_fav_count: 3
  entry_content: |
    araba kullanmak. araba kullanırken de sinirlenmemek lazım tabi. her ikisi de acı bitebilir.
- entry_name: |
