...
- entry_name: |
  ...
  entry_fav_count: 66
  entry_content: |
    jack falan olmazdı çünkü türk kızı zengin adamla mutlu olurdu zaten.
...
- entry_name: |
  ...
  entry_fav_count: 49
  entry_content: |
    yaptığı işin arkasında durmayı sevmeyen bir arkadaş.<br/>bizim gurbetçilerimiz böyledir zaten. yeri gelince solcu olur, türkiye'ye gelir sağcı olur. işine gelince bir oluşum içinde yer alır, işine gelince kaçar.
...
- entry_name: |
  ...
  entry_fav_count: 45
  entry_content: |
    " bazı geceler geçmişe geri dönmek istiyorum; bir şeyleri değiştirmek için değil, bazılarını bi daha yaşamak için"
...
- entry_name: |
  ...
  entry_fav_count: 34
  entry_content: |
    düne kadar bu para nerdeydi demeyenler neden biranda nordo bu porolor otoboslor nodon porolı der oldu yav bi' kendinizden utanın kendinizden önce.
...
- entry_name: |
  ...
  entry_fav_count: 27
  entry_content: |
    bir tv programı hakkında yorum yapınca, hemen engellemek isteyenleri tek bir hareketle engellememe sebep olan yarışma.<br/>paşama eklenti yazayım da, zahmet etmesin, tek bir hareketle herkesi engellesin. size soracağız ne izleyip neye yorum yapacağımızı.
...
- entry_name: |
    akbankta 7 lira olan işlem en parada bedava olması
  entry_id:  95502665
  entry_writer: im yes perfecto
  entry_fav_count: 25
  entry_content: |
    (bkz: akbank'ta 7 lira olan işlemin enpara'da bedava olması)<br/><br/>yazdığınızı okumadan başlık açıyorsunuz.
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler,edebiyat
- entry_name: |
    dünyanın ilk vajina müzesi
  entry_id:  95508585
  entry_writer: lord joyce
  entry_fav_count: 14
  entry_content: |
    'am'müzement<br/><br/>(bkz: <a class="b" href="/?q=amusement">amusement</a>) (bkz: <a class="b" href="/?q=e%c4%9flence">eğlence</a>)<br/><br/>çok eğlenecüyük çok
  entry_channels: bilim,sanat,sağlık,haber
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    gurup seks esna'sında baslik acmayalim arkadaslar
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    bence en büyük sorun çocukların sokaklardaki parklardan koparılıp kapalı binalarda, havasız ortamda üstelik para odaklı bir çarka mahkum edilmeleridir. <br/><br/>fiyatlar 5 tl den başlıyor çocuk istedikçe istiyor anne baba çocuğu kırmamak için harcadıkça harcıyor. çocuğun istediklerini yapmasan çocuk vardan yoktan anlamıyor. sonuçta kasa her zaman kazanıyor.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  95516457
  entry_writer: nerdedallamavarburda
  entry_fav_count: 3
  entry_content: |
    her ne için hiç yapmadım deyip gurur duyduysam, eninde sonunda yaptım. o yüzden artık gurur duyacak bir şeyim de kalmadı. o da rahatladı ben de rahatladım.
  entry_channels: anket
- entry_name: |
    bürge için ses olun
  entry_id:  95508295
  ...
  entry_fav_count: 2
  entry_content: |
    ses değil. haykıralım. alkollü araç süren canilere karşı tek yürek olalım.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    rüşvet, torpil, adam kayırma teklifleri de "cinsel" teklifler kadar ahlaksızdır.<br/>ancak "sikiş"i ahlaksız bulan bu ahlaklılar, "memleketi siken" adamları ahlaksız bulmazlar.
  entry_channels: ilişkiler,ekonomi
- entry_name: |
    çaylaklardan mesaj bekleyen yazarlar veritabanı
  entry_id:  95520129
  entry_writer: sevimsizkedicik
  entry_fav_count: 0
  entry_content: |
    şu iyi huylu yazarınızı yeşillendirin..
  entry_channels: anket,ekşi-sözlük
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  95519750
  entry_writer: kdronal
  entry_fav_count: 0
  entry_content: |
    küresel zayıflama, ticaret savaşları ve suudi arabistan’da petrol tesislerine yapılan saldırı gibi riskler eşliğinde ekonomik büyümenin devamını sağlamak için bu yıl ikinci kez faiz indirimine gidecek gibi görünüyor. beklenti 25 baz puan indirim yapılması fakat enflasyon beklentileri sürpriz bir indirim gelmesine sebep olabilir.
  entry_channels: ekonomi
---
