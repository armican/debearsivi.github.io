...
- entry_name: |
    şeyma subaşı'yı ingilizce anlatmak
  entry_id:  83986656
  entry_writer: hastaruhlu
  entry_fav_count: 197
  entry_content: |
    (bkz: <a class="b" href="/?q=gold+digger">gold digger</a>)
  entry_channels: anket,magazin
- entry_name: |
    fransa'da vergi artışlarının askıya alınması
  entry_id:  83983749
  entry_writer: pasifik okyanusundaki mariana cukuru
  entry_fav_count: 183
  entry_content: |
    halkından korkmayan hükümetlerden korkun diye boşuna dememişler. fransa'da halk gücünü göstermiştir. helal olsundur. darısı korku imparatorluğunda yaşayan ülkelerin başına.
  entry_channels: siyaset,haber,ekonomi
- entry_name: |
    0553 832 04 88
  entry_id:  83993311
...
- entry_name: |
  ...
  entry_fav_count: 73
  entry_content: |
    walter'in, yardımcısı astrid'in ismini hiçbir zaman doğru söylememesi. astriks, asprin, astreod.
...
- entry_name: |
  ...
  entry_fav_count: 63
  entry_content: |
    şu ana kadar ne hatası oldu merak ettiğim kaleci.<br/><br/>14 hafta geride kaldı maksimum toplam 3 tane hata yapmıştır kendisi, o da tartışılır.<br/>kendisi süper lig standartların üstünde bir kalecidir, bunu beğenmeyen gs lileri anlamakta güçlük çekiyorum, adam penaltı kurtarmıyor diye eleştiriliyor cidden.<br/><br/>gidin bakın diğer kaleciler neler yaptı şu 14 haftada, biz karius'a sahip çıkıyoruz bunlar muslerayı eleştiriyor.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 48
  entry_content: |
    dağları delen, çölleri aşan, erleri kız başına yenen bu versusu da kaybetmez
...
- entry_name: |
    4 aralık 2018 antalya'da görülen mor bulutlar
  entry_id:  83996278
  entry_writer: eksi peace
  entry_fav_count: 28
  entry_content: |
    sansüre yeni bir soluk getirmiş bulutlardır.<br/><br/>paint tarafından ışınlanmış arkadaş. evet tarafından.<br/><br/>edit: abovv ikincisi daha fena, gözünü seveyim başka ekleme inandık tamam.
...
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    ali koç "benim dönemimde her şey şeffaf olacak" demişti, adama helal olsun, sözünde duruyor.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    herkes galatasaray’ı tutabilir, arkadaş kendince fetöyle galatasaray’ı birleştirmeye eski tarihlerde futbolcu olan kişilere atıfta bulunmuş. öncelikle sikmişim fetöyü; yıllarca fransız bağdaştırması yaptılar; çanakkale’de verdiğimiz liseli şehitleri görmezden gelerek, terörist başı galatasaraylı pkk takımısınız dediler ima ettiler, uefa kupasını aldık, kaleye taffarelin yerine kaleci rüştü’yü alıp dünya üçüncüsü olduk. bırakın arkadaşlar fanatikliği. var gelmişte adalet olmuş ulan bir hafta önce bütün dünya çalınan 2 puanımızı gördü amk beşiktaş maçı zaten ortada çift vuruş verdiği pozisyona minikler liginde bile devam derler. <br/>utanmadan fetö diyo ; hacım o küfürleri suçluluktan hakettiğin için yiyorsun, hakan şükür dediğin adam akp den milletvekiliydi, yani diyeceğim feto meto yoktu yani. hoca efendi deniliyordu. sen şimdiye bakacaksın var mı galatasaray camiasında herhangi bir durum onu konuşacaksın, arif yere atmışta kendini öyle olmasaymışta böyle olurmuş fetö yapmış. <br/>o zaman şimdi fenerbahçe şike yapamadığı için mi kümede kalma mücadelesi veriyor, anadolu takımlarının çizgiyi geçen golleri gol olmadı bu ülkede var gelmişte adalet olmuş .<br/>varınızı yoğunuzu ortaya koyun galatasaray o bahsettiğiniz fetöden de fetöcülerden de alayınızdan da büyüktür. 2 tane futbolcunun fetöcü olduğu yıllarda namağlup uefa kupasını aldık, peşinden madrid ‘den süper kupayı aldık. bence attığınız bu karalamalar haklılığınızdan değil ezikliğinizden geliyor.<br/>bu ülkeye önce tüm branşlarda galatasaray kadar hizmet edin, ondan sonra zaten çamur atmazsınız.
...
- entry_name: |
  ...
  entry_id:  83973467
  entry_writer: hodor12
  entry_fav_count: 7
  entry_content: |
    diagne'nin gol sayısı fenerbahçenin puanından fazla daya ne diyeyim.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    otobüs beklerken pufidik bir kedinin kucağıma atlayıp bana sokulduğu an. az önce...
  entry_channels: anket
- entry_name: |
    brief verilen junior'ın casefileları delete etmesi
  entry_id:  83998040
  entry_writer: twoface
  entry_fav_count: 3
  entry_content: |
    hiç bi şey anlamadım ama çok gergin girilmiş bir entry var ortada. hakkını vermek lazım. aynen kardeşim sikicen bunları ya sallandırcan.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    acıklamanın ozetını geceyım suraya kuşgiller ıcın,<br/><br/>fırıldak fiko,yalı cocugu ali ve hukumet yalakası goksel ıcın ben adama bilezik gibi geciririm acıklaması olmus.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    usulüne göre imzalanarak yürürlüğe girmiş anlaşmalar ve avrupa insan hakları mahkemesi kararları da ‘bizi bağlamadığına’ göre, beklenen onamadır.
