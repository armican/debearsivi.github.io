...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    hızlı bir şekilde bağımlılık yapmaktadır. kısa süreli <a class="b" href="/?q=psikotrop+madde">psikotrop madde</a> olarak kullanıldığında etkileri:<br/><br/>- kalp atış hızının ve vücut sıcaklığının artması<br/>- el, kol, baş hareketi yapma ve dengesiz davranışlar<br/>- <a class="b" href="/?q=paranoya">paranoya</a>, psikoz, <a class="b" href="/?q=hal%c3%bcsinasyon">halüsinasyon</a>lar<br/>- güç artışı, ketlenmiş acılar<br/><br/>uzun süreli kullanıldığında etkileri:<br/><br/>- akut psikozlar<br/>- kemik iliğinde tahribat<br/>- organ yetmezliği<br/>- böbrek yetmezliği<br/><br/>(fransızca vikipedi sayfasından çevirdim)
- entry_name: |
