...
- entry_name: |
  ...
  entry_fav_count: 225
  entry_content: |
    (bkz: <a class="b" href="/?q=hepinizi+de%c4%9fil+fakirleri+d%c3%bcz%c3%bccez">hepinizi değil fakirleri düzücez</a>)
- entry_name: |
...
- entry_name: |
    evlerdeki duvarların sabit olması saçmalığı
  entry_id:  71196107
...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    bu laf var ya bu laf, <a class="b" href="/?q=sonradan+g%c3%b6rm%c3%bc%c5%9fl%c3%bc%c4%9f%c3%bcn">sonradan görmüşlüğün</a> o kadar güzel bir özeti ki. altın varaklı koltuklar, acayip acayip desenli halılar, mermerden bilmemneler bunların hepsi itibar değil sonradan görmüşlüğün kralı.<br/><br/>maalesef bir milletin parası çöpe atılıyor; gösterişe, sonradan görmüşlüğe harcanıyor.<br/><br/>itibardan tasarrufun kralı olur kralı. ancak işte dini imanı para olan insanlar, itibarı da parayla satın alabileceğini sanıyorlar. ne kadar yanlış yolda olduklarını bu insanlara anlatamazsın. <br/><br/>müslümanlığa terstir yapılan açıklama. yazık, güzelim ülkenin içine ettiniz, tebrik ediyorum.
- entry_name: |
    aamir khan
  entry_id:  71187502
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    adam yasar kemal'in ince memed'ini okumus, siz burada aamir khan kim amk diyip cahilliginizle prim yapmaya calisiyorsunuz. <br/><br/>yasar kemal kim amk dememis, okumus. hanginiz okudu lan ince memed'i ? siz anca allah de otesini birak degil mi ?
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=hcZ8277KbRY" title="https://www.youtube.com/watch?v=hcZ8277KbRY">şunu bırakayım</a> daha da bir şey demeyeyim. manzarayı izleyip müziğini dinlerken keyif almak için illa oyunu oynamış olmanıza gerek yok, o derece.
- entry_name: |
    mother
  entry_id:  71188333
  ...
  entry_fav_count: 3
  entry_content: |
    nedendir bilmem ama ne zaman bir aronofsky filmi seyretsem kalp ve tansiyon rahatsızlıkları yaşıyorum. <br/><br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>filme gelecek olursak, dini metaforlar dışında hayata dair çokça şey anlatmakta idi. javier bardem tanrı figürü olarak görülse de peygambere daha çok yakındı. kitaplar ile halka seslenmesi, tabiat anadan, eşinden, ilham alması ve insanlara daima sabırla yaklaşması bunun bir örneğidir.<br/><br/>öykü ise; tabiat ana yeni bir yaşam alanı yaratıyor. hemen ardından oraya gelen 'insanlar' bilinçsizce ve tabiat ananın nasıl bir reaksiyon göstereceğini düşünmeden çoğalıyor. derken yeni bir kitap ve beraberinde yeni bir savaş geliyor. doğa yerle yeksan olunca tanrı yeni bir doğa yaratıyor (bu sahne ise javier bardem'in tanrı metaforu olma ihtimalini es geçmememiz gerektiğini söylüyor).<br/><br/>bununla beraber dini metforların dışına yer alan paramparça kristalimiz var. bu aslında javier bardem'in yeniden doğuşa ve yenileneceğine dair umudu. fakat aha sonra eşinin rahmine düşen bebek ise yenilenmeye değil, geleceğe dair umudunu temsil ediyor. ve iki umut imgesi de paramparça oluyor. <br/><br/>dikkatimi çeken şey şu oldu; bardem'in kristali parçalandığında eşi, olaylara sebebiyet verenleri kovuyorken bardem bebeğini parçalayanları dahi affetmeyi dile getirdi. bu da isa'nın çarmıha gerilirken "baba onları affet" deyişini çağrıştırdı.<br/><br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    (bkz: <a class="b" href="/?q=pipi">pipi</a>)
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    geçenlerde 500'dü sonra 5000 oldu şimdi de 500.000 yarın 5.000.000 olacak.artık siktirip gidin hala burda mısınız?
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    hala pesciler o atari gibi oyunu bırakıp gelip bu başlığa salça olmuyorlarmı madem daha iyi git oyununu oyna.
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    belli garantileri almak için görüşülüyor belli.<br/>melih ve oğlu ömürboyu dokunulmaz olacak, akpyi yakacak olan belgeleri de açıklamayacaklar.<br/>kimseye dokunulmayacak.
- entry_name: |
...
- entry_name: |
    5 eylül 2017 teknosacell rezaleti
  entry_id:  71203266
  entry_writer: jery
  entry_fav_count: 0
  entry_content: |
    rezalet puanı 8/10 olan rezalet, avea alt yapısı ile hizmet veren tüm kanallarda tt, bimcell, teknosacell vb 25 tl ye 2 gb yurt dışı paketi var, bir çok avrupa ülkesinde geçerli, o yüzden gidilen yerlerden local hat al demek çok pratik ve ekonomik bir seçenek değil. bence burada hata nede olsa 2 gb diye paketi zorlamak hata olmuş, roaming esnasında bir çok kullanım bilgisi esas operatöre geçikmeli geliyor, bu nedenden oluşan mevcuttaki gibi durumlara düşmemek için paketim ne olursa olsun maps, navigasyon uygulamaları, whatsapp mesajları ve mekan tavsiyeleri gibi düşük data kullanımı yapan işlemler dışında be hiç bir uygulamayı kullanmıyorum. yeri geliyor 2 gb paketin sadece 500-600 mb tükeniyor ama bu tarz bir tehlikeye kendimi atmıyorum, buradan herkese tavsiye ederim.<br/><br/>bir rezalette benden gelsin;<br/><br/>(bkz: <a class="b" href="/?q=5+ekim+2017+hepsiburada+rezaleti">5 ekim 2017 hepsiburada rezaleti</a>)
---
