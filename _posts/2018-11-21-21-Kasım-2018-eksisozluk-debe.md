...
- entry_name: |
    taş gibi kız arkadaşlarıyla tatile çıkan şişko kız
  entry_id:  83500884
  entry_writer: yuhannas
  entry_fav_count: 159
  entry_content: |
    nefret kusan başlıklarda bugün. bitmedi bir mükemmelmiş gibi başkalarına laf sokmalı lakaplarınız. şişko ne abi? ilkokul 3te bıraktık biz böyle lakapları. kilolu de, şişman de, obez de, iriyarı de vs vs. şişko nedir?<br/><br/>not: sandığınızın aksine şişko* olduğum için savunmadım,değilim.insan olduğum için savundum.
...
- entry_name: |
    maymunla çıkarım diyen türk kızı
  entry_id:  83512320
  entry_writer: eylul firtinasi
  entry_fav_count: 122
  entry_content: |
    böyle de haber mi olur amına koyayım.
...
- entry_name: |
  ...
  entry_channels: haber
- entry_name: |
    kadının kullandığı arabada ön koltuğa oturan erkek
  entry_id:  83515148
  entry_writer: yokonunjohnu
  entry_fav_count: 105
  entry_content: |
    sürücü koltuğunun pipisi olana zimmetli olmadığını bilen erkektir.
...
- entry_name: |
  ...
  entry_fav_count: 76
  entry_content: |
    tabi ki ezici çoğunluk ile<br/><br/>(bkz: <a class="b" href="/?q=%c3%a7ekirdek">çekirdek</a>)
...
- entry_name: |
    beşiktaşlılar sahaya 1 lira attı yalanı
  entry_id:  83519219
  entry_writer: heartbroker
  entry_fav_count: 26
  entry_content: |
    ne hikmetse o bahsedilen sezon ekşideki başlıklarda bu tarz bir olayın yaşandığından kimse bahsetmemiş.<br/><br/>(bkz: <a class="b" href="/?q=19+eyl%c3%bcl+2011+be%c5%9fikta%c5%9f+ankarag%c3%bcc%c3%bc+ma%c3%a7%c4%b1">19 eylül 2011 beşiktaş ankaragücü maçı</a>)<br/>(bkz: <a class="b" href="/?q=8+ocak+2012+ankarag%c3%bcc%c3%bc+be%c5%9fikta%c5%9f+ma%c3%a7%c4%b1">8 ocak 2012 ankaragücü beşiktaş maçı</a>)<br/><br/>olayın doğruluğunu kanıtlayan varsa, yeşillendirsin.
  entry_channels: spor
- entry_name: |
    deep turkish web
  entry_id:  83498369
  entry_writer: arpegius
  entry_fav_count: 20
  entry_content: |
    istedikleri kadar bozsunlar, gerçek kaybedenler kulübü ile ulaştıkları zirveyi uzun bir süre kimse geçemez.
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    hanımeli kokusu...<br/><br/>her sene baharda açan mis gibi hanımelinin kokusu.
  entry_channels: anket
- entry_name: |
    ekşi itiraf
  entry_id:  83499927
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    adam kadını özledi, başka kadına sarıldı.<br/>kadın adamı özledi, adamın yokluğuna sarıldı.<br/><br/>cemal süreya
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    asla katılmadığım düşünce. sözlüğü bilgi paylaşımı, sağduyu gerektiren toplumsal konularda farkındalık yaratmak ve bireyden yola çıkarak toplumun geneline ışık tutmak için kullanıyorlar. hiç bunun aksine rastlamadım.
  entry_channels: ilişkiler,ekşi-sözlük
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    bir gerçek var ki biri sizi bir kere sevmediyse ikinci kere de sevmez, üçte de... böyle uzar gider.<br/>sizi sevmeyen insanları beklemeyin, çünkü onların yolu beklenen yere hiç düşmeyecek...<br/>belki size işleri düşer ama içleri asla..
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    veritabanındaki arkadaşlardan rave'lerde blue punisher'ıyla birlikte dans ederken dehidrasyonla nasıl başa çıktıklarını da paylaşmalarını bekliyoruz.
  entry_channels: anket,ekşi-sözlük,müzik
- entry_name: |
    geceye bir şarkı bırak
  entry_id:  83525821
  entry_writer: goksuhu
  entry_fav_count: 0
  entry_content: |
    <a class="b" href="/?q=burcu+tatl%c4%b1ses">burcu tatlıses</a> <br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=tn_3-yJovNs" title="https://www.youtube.com/watch?v=tn_3-yJovNs">düşmedim daha</a><br/><br/>yeni albüm, yeni şarkı<br/>mis gibi
