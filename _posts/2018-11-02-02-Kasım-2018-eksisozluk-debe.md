...
- entry_name: |
  ...
  entry_channels: ilişkiler,tv,sinema,magazin
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 55
  entry_content: |
    fenerbahçe tarihinin en kötü dönemlerinden birini yaşıyor.<br/><br/>hocaları yok.<br/><br/>takım leş, kimya 0.<br/><br/>kısacası fenerbahçe galibiyeti için her şey uygun.
  entry_channels: spor
- entry_name: |
    ozan kabak
  entry_id:  82896652
...
- entry_name: |
  ...
  entry_fav_count: 30
  entry_content: |
    (bkz: <a class="b" href="/?q=miat">miat</a>)<br/><br/>tanım: 1. bir şeyin yapılması için tanınan süre. 2. bir şeyin yerine yenisinin verilebilmesi için kabul edilmiş bulunan süre, kullanma süresi.<br/><br/>kaynak: tdk<br/><br/>arapça kökenli diye linç etmeye gelecek olanlara not: yaygın kullanılan, hali hazırda kanıksanmış bir yabancı kelimeyi kullanmak, ingilizce kökenli bir kelimeyi sıfırdan devşirmekten daha iyidir. en azından kötünün iyisidir.
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    avrupa'nın romanya ile birlikte en dışlanmış ve fakir ülkesi olan bulgarlar ve ekonomik kriz altında ezilmekte olan yunanlıların da nedense çılgınlar gibi katıldıkları yağmadır.<br/><br/>halbuki türkiye, dünyanın en güçlü ekonomileri içinde yer alan, almanya'nın filan çılgınca kıskandığı, devamlı duble yollar filan yapan bir ülke ama.<br/><br/>ilginç bir durumdur.
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    evli bir adamı baştan çıkartan kadın
  entry_id:  82896425
  entry_writer: selamun aleykum kitty
  entry_fav_count: 8
  entry_content: |
    yazık lan cezai ehliyeti bulunmayan bu masum yavrunun müşkül durumundan faydalanmak isteyen birtakım tacizci kadınlar derhal yargılanmalı.
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    annem bugün ölmüş, belki de dün. tam hatırlamıyorum. (<a class="b" href="/?q=albert+camus">albert camus</a> - <a class="b" href="/?q=yabanc%c4%b1">yabancı</a>) giriş cümlesi.<br/><br/>çaylak bugün mesaj atmadı, belki de dün. tam hatırlamıyorum. (<a class="b" href="/?q=redkitin+neden+sevgilisi+yok">redkitin neden sevgilisi yok</a> - <a class="b" href="/?q=%c3%a7aylak">çaylak</a>) giriş cümlesi.
...
- entry_name: |
    erdoğan'ın ingilizce öğrenmeyi denememesi
  entry_id:  82900346
  entry_writer: anisston
  entry_fav_count: 4
  entry_content: |
    ne gerek var ki. kitap okumak yerine kitap özetlerini okuyan birinden bahsediyoruz.<br/><br/>türkiye'yi dünyaya biraz daha kapatırsa ingilizceye gerek kalmaz zaten.<br/><br/>edit: kitap yerine, hitap yazmışım. uyarı için teşekkürler
...
- entry_name: |
    başkentin istanbul'a taşınması
  entry_id:  82901450
  entry_writer: renksiz hayat
  entry_fav_count: 1
  entry_content: |
    bu kadar kalabalık yetmediğinden ve hala bir-iki götlük yer kaldığından desteklediğim teklif.
  entry_channels: siyaset
- entry_name: |
    kızların bekaretini hep kaza sonucu kaybetmesi
  entry_id:  82901613
  entry_writer: bir gun belki yani neden olmasin
  entry_fav_count: 0
  entry_content: |
    bakireyim diyen kızın bakire çıkmaması yalan ve güven sorunu yaratabilir lakin bakire değilim diyorsa baştan neyine takılıyorsun da sorguluyorsun ki durumun? nasıl olmuşsa olmuş. sana ne? geç git abi ilerle böyle mutlu olamazsın.
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    sırf cezalandırılmamak için iyi olmak mı vicdanını dinleyerek iyi olmak mı? insanın dini vicdanıdır.
  entry_channels: magazin
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    dert de dinlenir muhabbet de edilir. isteyen yeşillendirebilir. çaylaklar için de açıktır mesaj kutumuz tabi. herkes ribony paylaşmış ben de kaydolayım dedim<sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup> isteyen <a rel="nofollow noopener" class="url" target="_blank" href="http://ribony.com/vatsap" title="http://ribony.com/vatsap">oradan</a> da yazabilir elbette.
  entry_channels: anket,ilişkiler,ekşi-sözlük
---
