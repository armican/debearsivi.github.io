...
- entry_name: |
    volkan demirel'in hayvan barınağı yaptırması
  entry_id:  79059980
  entry_writer: siyahbeyaznegatif
  entry_fav_count: 290
  entry_content: |
    ehem...<br/><br/>ilk aklıma gelen espriyi yapmadım, kimse yapmasın lütfen.
...
- entry_name: |
    kylian mbappe
  entry_id:  79041966
  entry_writer: dreadshadow
  entry_fav_count: 36
  entry_content: |
    belçikalılar bu kadar dert etmemiştir yemin ediyorum. çok acayip milletiz.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    (bkz: <a class="b" href="/?q=nutella">nutella</a>)
  entry_channels: ekonomi
- entry_name: |
