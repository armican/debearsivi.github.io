...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    sırf kapalı olduğu için beğenmiyorsunuz eğer böyle değilse ben de jesicalay değilim. fularınızı az sıkın da beyninize oksijen gitsin<sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
  entry_channels: 
- entry_name: |
    bugüne kadar yaşanmış hayatın tek cümlelik özeti
  entry_id:  83456908
  entry_writer: kebap teknisyeni
  entry_fav_count: 0
  entry_content: |
    o neydi gıız
  entry_channels: anket,edebiyat
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    zverev kusursuz servis atıp, bir de rallilerde de sağlam kalınca djokovic'in özgüveni baltalandı.
  entry_channels: spor
---
