...
- entry_name: |
  ...
  entry_id:  68954182
  entry_writer: kafasallayangercekkessek
  entry_fav_count: 66
  entry_content: |
...
- entry_name: |
  ...
  entry_content: |
    rakitic :(
- entry_name: |
    akraba evliliği oranının yüzde 25 olduğu ülke
  entry_id:  68954915
  entry_writer: mesglsn sanirm bn yatiyrm
  entry_fav_count: 30
  entry_content: |
    çok normal. yengem kuzenimi bana kitlemeye çalışmıştı da "ne evlenmesi ulan manyak mısın" demiştim. başka bir kuzenimi de başka bir kuzenime kitlemeye çalışmışlardı. bizim nesil(80'lerin ortası-90'lar) akraba evliliği yapmadı hiç. daha bilinçli bir nesil var ortada.<br/><br/>sadece benim ailemde akraba evliliği yapmış 6 çift var ve hepsi bizim üst nesil. bir tanesinin engelli bir kızı var. benimle yaşıt o kız da. hani her fırsatta "yeni nesil niye böyle yaaa" diye laf ediyorlar ya, o laf ettikleri nesil kadar beyinlerini kullanamamışlar o dönem. hâlâ kullanamıyorlar ki, bana kuzenimi teklif ediyor yengem.
- entry_name: |
  ...
  entry_fav_count: 25
  entry_content: |
    fetö tarafından kandırıldığını, fetö tarafından kandırılanlara inanmadığını, kendisine inanmıyanlarınsa fetöcü olduğunu savunan patili cumhurbaşkanı.
- entry_name: |
    facebook'taki kanser eden 15 temmuz parası post'u
  entry_id:  68962810
  entry_writer: delixtarter
  entry_fav_count: 25
  entry_content: |
    ilgili guruhu costurmak isteyenler su gorseli paylasabilir: <a rel="nofollow noopener" class="url" target="_blank" href="https://karsidevrim.files.wordpress.com/2012/06/10-yc4b1l-hatc4b1ra-para.jpg?w=600&amp;h=237" title="https://karsidevrim.files.wordpress.com/2012/06/10-yc4b1l-hatc4b1ra-para.jpg?w=600&amp;h=237">https://karsidevrim.files.wordpress.com/…=600&amp;h=237</a><br/><br/>once olimpiyat hatira parasi bas,<br/>sonra olimpiyat yapanlarin yaptigi darbeyi alt ettigin hatira parasi bas,<br/><br/>bunlar done done tekrar ataturk'e gelecekler, benden soylemesi.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    adeta bir power rangers'a dönüşme <a rel="nofollow noopener" class="url" target="_blank" href="http://www.sozcu.com.tr/2017/gundem/doga-harikasi-olan-uzungol-simdi-havuzlu-siteye-dondu-1902273/" title="http://www.sozcu.com.tr/2017/gundem/doga-harikasi-olan-uzungol-simdi-havuzlu-siteye-dondu-1902273/">durumu</a>.<br/><br/>“akp’den önce doğa harikası olan uzungöl, şimdi havuzlu siteye dönmüş!<br/>üstüne bir köprü yapıp, duble yolla istanbul’a bağlandı mı tamamdır!”
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  68959444
  entry_writer: bosbakan ucan conan
  entry_fav_count: 6
  entry_content: |
    yazılanlara hızlıca göz attığımda gördüğüm buraya yazılan lüks saatlerin sayısı gerçekleşen üretimden çok daha fazla. ayrıca;<br/>(bkz: <a class="b" href="/?q=yalanc%c4%b1y%c4%b1+sikseler+kucaktan+inmezsin">yalancıyı sikseler kucaktan inmezsin</a>)
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    (bkz: <a class="b" href="/?q=fanta+diye+biliyorum+ben">fanta diye biliyorum ben</a>)
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    osmanlıyla oynayacaklara verebileceğim strateji şudur. avrupa'dan sadece bizansi, kosovayı ( altın madeni için) ve albania'yı alın (core var) sonra direkt doğuya yönelip savaşlarınızı hindistan ve afrika arasında koalisyon oluşmayacak şekilde dengeleyin. arada rusyanın kolonileşmesini engellemek için sınır hattını ele geçirebilirsiniz. hindistana geldikten sonra çin'in altında tribute olursanız koalisyon olayından iyice sıyrılır ve ming'in etrafını çok rahat bir şekilde temizlersiniz. tabii bu esnada bütün trade company olan bölgeleri alip trade company'e çevirip sıfır autonomy ve ekstra merchantlara ulaşım sağlayarak ekonomimizi hayvan gibi güçlü yapacaksınız kilit nokta bu. absolutism geldikten sonra hemen 50 abs'a ulaşıp +20 abs veren disaster'i tetikliyorsunuz. sonrasında zaten hayvan gibi admin efficiency ve adm+osmanlı idealarından gelen coring costs reduction oluyor. hatta bir de üstüne coptic giderseniz %10'da oradan alırsınız. neyse bu seviyeye geldikten sonra zaten kimse size bir bok yapamıyor o çok korkulan rusyaymış fransaymış falan eriyip gidiyor. bütün olay truce time'ları ve core'ların olmasını bekleyerek dünya fethine dönüyor.<br/><br/>bu taktik trade companylere erişimi olan her devlette işe yarıyor. kaldı ki ben three mountain achievementi için ryukyu ile oynarken de başkentimi avrupa'ya alarak trade companyleri kurmuştum. zaten bir süre sonra o kadar deli para kazanıyorsunuz ki tamamen paralı askerle savaşıyorsunuz. bu arada esas dünya fethi diplo 23'de imperialism cb'si ve client stateler açılınca başlar. o zamana kadar dünyanın 1/10u fethetseniz yine yeterli. burada önemli olan şey çok iyi bir ekonomi kurup absolutism makslamak. <br/><br/>bu arada size ryukyu wc'mden hatırladığım birkaç ufak tefek ipucunu daha vereyim.<br/><br/>şimdi benim kullandığım taktikle amerika'da koloni kuran devletleri uzun bir süre yalnız bırakmış oluyoruz. şimdi bu abileri abs maksladıktan sonra 2-3 savaşta direkt yutup kolonilerini üstümüze direkt alabiliyoruz. burada dikkat etmeniz nokta son 1 savaş kala bu abilerimiz çok güçsüz kalırsa koloniler bağımsızlıklarını ilan ediyor. o yüzden diyelim ki %150 warscore'luk bir yerleri kaldı. ilk savaş bittikten sonra truce break yapıp hemen ikinci savaşı açıyoruz ve full annex yapıyoruz, bildiğiniz gibi koloniler eğer savaşa katıldılarsa bağımsızlıklarını ilan edemiyor. full annex yapmak için bu adamların bütün koloni olmayan yerlerini almanız lazım. o yüzden ilk savaşlarda böyle uçsuz buçaksız yerlerdeki adalarını kalelerini falan alın. en son fethedeceğiniz yer ispanyanın içi olsun sadece. <br/><br/>bildiğiniz gibi ming bu patchlerde tam bir canavar. o yüzden yukarıda da belirttiğim gibi tribute olup etrafındaki diğer tributeleri yiyoruz. etrafını yeterince temizledikten sonra tribute'u iptal ediyoruz ( haraç yollamayı keserseniz onlar bir süre sonra otomatik iptal eder böylece stab hit yemezsiniz) bundan sonra mandate'lerinin düşmesini bekliyoruz. mandate sıfır olunca %50 fazla damage yiyor ve %50 daha az production düşüşü yaşıyorlar. yani çöpe dönüyorlar. eğer bir şekilde halledip kendiniz emperor of china olursanız adada olduğunuz sürece triubute'lardan dolayı mandate cezası yemezsiniz. bu ingiltere için bile geçerli. yalnız söylemekte fayda var e.o.c olursanız max abs. düşecektir. <br/><br/>trade olayını tekrar hatırlatmak istiyorum. ben bütün paramı trade ve productiondan kazanıyordum. bunun sebebi yeni patchlerle birlikte trade companylerin inanilmaz buff alması. trade sistemini iyice öğrenin çok karışık gibi dursa da aslında çok basit bir mantığı var. türkçe kaynak var mı bilmiyorum yoksa belki ben de yazarım bi trade guide ama zaten bu oyunu ingilizce bilmeden oynuyorsanız wc falan biraz hayal olabilir ahahaha<br/><br/>son olarak çok ufak çakallıklar:<br/><br/>eğer çok fazla limanı olan bir düşmana savaş açacaksanız ( kilwa , ingiltere gibi) savaşı açmadan önce bütün limanlarını kuşatır ve savaşın başında blockadeler sayesinde %25 war score elde ederseniz defansif savaşa müttefiklerini çağıramazlar ( %25 war scoreu aşmış olan savaşlara müttefik çağrılmaz)<br/><br/>diyelim bir ülke kalenizi kuşatıyor siz de bu kuşatmaya saldıracaksınız. kuşatmaya saldırır saldırmaz siege menüsüne gelip kaledeki askerlerinizin de savaşa katılmasını istiyorsunuz. ( 10 military point yer) normalde savaştan sonra bu askerler kaleye geri döner lakin savaşı kazandıktan hemen bir gün sonra oyunun durdurur ve normal askerlerinizle birlikte kaleden gelen stackleri birleştirirseniz para ve manpower harcamaksızın kaledeki asker kadar asker elde etmiş olursunuz. yalnız bu stratejinin bir kötü yani kaleyi boşaltmış oluyorsunuz. dolayısıyla kaleyi yakın zamanda savunmasız bırakırsanız çat diye ele geçirirler.<br/><br/>sınırsız para exploit'i de var onu da anlatayım kısaca isteyen olursa araştırır öğrenir. şimdi efendim oyundaki kodlamadan dolayı yaklaşık 3500 dev'iniz varsa ve bankrupt olup interest rate'inizi düşürürseniz aldığınız borçun geri ödemesi borçtan daha düşük oluyor. böylece borç alip geri ödeyerek para kazanabiliyorsunuz. ben bunu kullanmadım ama düzgün bir zamanda yaparsanız altın derdinden kurtulabiliyorsunuz. yalnız iyi araştırın konunun arkasında belli bir matematik var.<br/><br/>bir önceki patchlerde kyoto ile sınırsız adm+dip+mil+prestige elde etme yöntemi de vardı ama bu patchde kaldırdılar. eu4 kyoto exploit diye aratarak bulabilirsiniz. (1.21 patchinde geçerliydi)<br/><br/>aklıma geldikçe yeni şeyler eklerim. saygılar.<br/><br/>edit: bu anlattığım şeylerin bir kısmı yeni patchlerle düzeltilmiş olabilir. <br/><br/>normalde vassal feedlerken alınan aggressive expansion direkt overlord olarak size gidiyor lakin eğer siz de aynı zamanda tribute iseniz (yani sizin de overlord'unuz varsa) ae direkt olarak overlord'unuza geçer. bu sayede ae'yi hiç dert etmeden hayvan gibi vassal feed yapabilirsiniz. bu sistemin bir de şöyle bir açığı var diyelim birine savaş açtınız o esnada bir başka devlet de sizin savaş açtığınız devlete savaş açtı. hemen bu devleti vassal yapıyoruz. bu sayede onlara savaş açmış olan devet size ofansif savaş açmış oluyor ve overlord'unuz defansif savaş olarak yardımınıza geliyor. bu sayede overlordunuzun yardımıyla büyük bir devlete karşı savaş kazanabilirsiniz. <br/><br/>bilenler bilir katolik bir ülkeyle oynarken roma'yı fethederseniz baya çirkin bir modifier yiyorsunuz. bunu papal state ile oynarken şöyle bir avatantaja çevirmek için capital'inizi başka bir şehre alıyorsunuz. sonra roma'yı almak isteyen birine satıyorsunuz. daha sonrasında sattığınız bu devlet modifier'i yiyence büyük bir ihtimalle roma'yı size geri veriyor. yani aldığınız altınlar yanınıza kar kalıyor. yalnız ufak bir ihtimal de olsa vermeme şansı var satarken oyunu kaydetmeyi unutmayın (a.k.a savescumming)
- entry_name: |
...
- entry_name: |
    aynı anda dört erkeği idare etmek
  entry_id:  68957180
  entry_writer: alaskardan
  entry_fav_count: 3
  entry_content: |
    sözlük'te yaygın bir durumdur. sizin yüzünüzden hiç tanımadığım erkek yazarlar "ben sikeceğim onu" diye salça oluyorlar sonra. sikin güzel kardeşlerim de siz bana artizlik yaparken, taktığınız hatun başka sözlük yazarıyla sevişiyor zaten. kadınlar varlığını görünür kıldıkları erkekleri hedef yanıltıp sizi haksız çıkarma ve sonra suçlu hissettirmede kullanır genelde. az uyanın artık bir zahmet.
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    turuncu çete ne amk budist tapınağına girdi sanki.
- entry_name: |
    domagoj vida
  entry_id:  68959274
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=wicked+game">wicked game</a>) (bkz: <a class="b" href="/?q=chris+isaak">chris isaak</a>)
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    kapat, en sevdiğim şarkının tam ortasındayım. bu senfoninin süresi en az bir ömür eder.<br/>kapat, az evvel yürüyüşe çıktım, birazdan da koşarım. birkaç bin kilometre sürer.<br/>kapat, intihar etmek için içtiğim bir kutu ilaç midemi ekşitti. biraz kussam geçer.<br/>kapat, ana bülten başladı, cinayet haberlerine denk geldim. belki spiker benden de bahseder.<br/>kapat, gözümde gözlük olmayınca gözlüğü nereye koyduğumu bulamıyorum. sanıyorum küvette unuttum bu sefer.<br/>kapat, aklıma bir şey geldi, onu ağırlıyorum. yatıya kalmaz sanıyorum, akşamdan gider.<br/>kapat, üşümesinler diye kısık ateşte ocağa koyduğum akvaryumun altını açık unuttum. az daha kaynarsa dibi tutar.<br/>kapat, paltomu dolaşmaya göndermiştim, bende içindeymişim. o yüzden evde değilmişim meğer.<br/>kapat, telefonu bulan adamın telefon numarasını arıyorum. bir teşekkür edeyim, olur ya, bekler.<br/>kapat, yarı çıplağım. ve kan içinde.<br/>kapat, benim çarmıhım çelik. buz gibi de soğuk.<br/>kapat, gemim su alıyor. dümenim kırıldı.<br/>kapat, otopsiye lüzum yok. raporu kendim tuttum.<br/>kapat, kapıyı kırmalarına gerekmeyecek. zaten kırık.<br/>kapat, kendimi kaybettim. ilanlara gülen bir fotoğrafımı koysunlar.<br/>kapat, gövdemdeki parmak izlerini alkolle temizledim. seni yakalayamazlar.<br/>kapat, ahizeyi kaldıramayacak kadar yorgunum.<br/>kapat, dünyaya buradan bakabilecek kadar özgürüm.<br/>kapat, iniş takımları olmayan bir uçaktayım.<br/>kapat, kuleyle irtibattayım.<br/>kapat, konuşamayacak kadar ölüyüm.<br/>kapat!<br/>ben seni sonra anarım. <br/><a class="b" href="/?q=kaz%c4%b1m+baran+y%c4%b1lmaz">kazım baran yılmaz</a>
- entry_name: |
    better call saul
  entry_id:  68957973
  entry_writer: e a p
