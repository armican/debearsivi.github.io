...
- entry_name: |
  ...
  entry_fav_count: 45
  entry_content: |
    kendisi toprağın altında yatmaktadır. <br/><br/>çünkü elinde silahıyla garnizondan içeri girmeye çalışan bir grup darbeci askere karşı beylik silahıyla direnmiştir.<br/><br/>bunun komutanı ise, odasının içine kadar giren darbeci askere karşı süklüm püklüm olmuş, derdest edilmiş, değil beylik tabancasıyla ülkenin ordu komutanının makamını savunmak, "izin verin bi namaz kılıp geleyim" diye içerki odaya sıvışmış olduğu için hala genel kurmay başkanlığı görevini sürdürmektedir.<br/><br/>peki komutanın böyle olduğu yerde, ömer niye toprağın altında?
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    ya arkadaş, adam hayatında bir yerde bir ropörtaj vermiş, efendim ferrari kullananları görünce şöyle okkalı bir küfür etmiş falan filan.. toplasan 30 saniyelik mevzu.<br/><br/>şimdi adamı nerde görseniz "abi ferrari hehehe abi abii ferrariye biniyo musun eheheh" diye embesil embesil triplere giriyorsunuz. bu adama soracak başka sorunuz, diyecek başka kelamınız yok mu cidden?<br/><br/>kardeş bi aç oku, adam neler anlatıyor, ne söylüyor, sen burda basit bir küfüre gülüp eğlenirken dünya nereye gidiyor.. yok ama yok.. varsa yoksa recep ivedik misali ergen esprileri ile beyin uyuşturmaca.
- entry_name: |
    ekşin
  entry_id:  74352028
  ...
  entry_fav_count: 6
  entry_content: |
    ekşi sözlük yönetimi ve teknik ekibi tarafından bitirilmiş olduğunu sandığım uygulama. zira çağatay çallı'nın boş zamanlarında yazdığı bu uygulama sadeliği ve etkinliği ile, 5 yılda yazılan kimbilir ne kadar para dökülmüş mevcut resmi uygulamadan daha güzel ve tercih edilir idi hâlâ. bu uygulamanın çalışır durumda olması için ekşi sözlük sunucularında, web arayüz kodlarında bir değişiklik yapıldığında, uygulamada da bir şeyleri ona göre değiştirmek gerektiriyor. belki resmi uygulama tek alternatif olsun diye bu bilgiler paylaşılmıyor, işbirliği yapılmıyor.<br/><br/>diğer ihtimal ise ekşin'in tekrar eski fonksiyonuna kavuşması mümkün ama geliştiricinin <a class="b" href="/?q=%c3%a7a%c4%9fatay+%c3%a7all%c4%b1">çağatay çallı</a> 'nın buna vakti yok, bundan bir kazancı yok. kazancı olsa bu defa ekşi sözlük yönetimi hop bilader diyecek muhtemelen. ben şahsen 5 tl 10 tl gibi bir ücreti anında veririm, çalışan ve bir iki arzuladığım ek özellik gelen bir uygulama için.. benim gibi birkaç bin (belki onbinlerce) kişi kesin vardır. geliştiricinin dikkatine.<br/><br/>ekşi sözlük yönetimine buradan mesajım ise ekşin artık kullanılamaz hale gelince sözlükte daha az vakit geçirecek, mobil ortamda daha az içerik sağlayacak çok insan var haberleri olsun.
- entry_name: |
    bitcoin
  entry_id:  74349630
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    ülkenin ne denli ayrıştığını apaçık gözler önüne serecek ankettir.<br/>bekleyip hep birlikte göreceğiz.<br/>ben yinede uyarayım:konu futbol.<br/>din,dil,ırk ve ya siyasi ideolojimiz değil.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    lewandowski'yi harry kane ve cavani ile karsilastirmak icin matematik bilmemek ya da 11 yasinda olmak gerekir. <br/><br/>hepsi iyi forvetler ama lewa'nin sikleti farkli. <br/><br/>suarez kardesimiz yetenekli ama pisligin teki.
- entry_name: |
    şu anda çalan şarkı
  entry_id:  74352050
  ...
  entry_fav_count: 0
  entry_content: |
    kürşat başar / pera’da zaman<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://open.spotify.com/track/4RZUtOD0Zakm9wliyOibWs?si=ORdX8s3ETkCS8uLhICH26w" title="https://open.spotify.com/track/4RZUtOD0Zakm9wliyOibWs?si=ORdX8s3ETkCS8uLhICH26w">spotify linki için</a>
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=s%c3%bcrekli+cevapl%c4%b1yor+efendim+durduram%c4%b1yoruz">sürekli cevaplıyor efendim durduramıyoruz</a>)
---
