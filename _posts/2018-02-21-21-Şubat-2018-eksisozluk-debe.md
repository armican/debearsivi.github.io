...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    -lan bu gavur napıyor elindeki aleti üstümüze tutuyor?<br/>-hakketen dayı yav ne icatlar çıktı, bi sigara ver hele.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    9 dakikada 5 gol atan futbolcudan bahsediyoruz. maç boyunca 5 tane gol pozisyonuna giremeyen bir futbolcudan değil.
- entry_name: |
    atiba hutchinson
  entry_id:  74368663
  ...
  entry_fav_count: 5
  entry_content: |
    bir şarkı istiyorum kardeş senden son bir şarkı,<br/>bir ihtimal daha var o da ölmek mi dersin?<br/>son defa çal benim için..<br/><br/>hadi be kaptan..aç bir kez daha modu...
- entry_name: |
