...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    keşke sadece türkçe bilen yazarlar alınsa. çoğu ilkokul terk yazarın dil bilgisiyle alakası olmadığından entry'leri anlamak için yetenek gerekiyor.
- entry_name: |
...
- entry_name: |
    google earth açıp kendi evine bakan insan
  entry_id:  74366651
  entry_writer: hatalarla dolu adam
  entry_fav_count: 3
  entry_content: |
    evine bakmayı geç, görüntü tarihine bakıp acaba ben bu tarihte nerdeydim diye düşünüp kendini sokakta bulmaya çalışan gördüm ben.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    ve bunu diyen adam ülkenin en çok satan gazetelerinden birinde yazar.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    survivor'daki kadınların bikini giymediğini yıllardır fark etmeyip üstüne bunu "değişik" bir bakış açısı olarak lanse eden yazarları da göstermiş program.<br/><br/>gerçi ülkede artık normal bunlar sanırım. neyse ki rabbime bin şükürler olsun ayak bileklerini kapatmıyorlar henüz de bize de malzeme çıkıyor. iki üç de kayınvalide görsek tamamdır tadından yenmez.<br/><br/>çok kalmaz bir-iki seneye haşemayla çıkmaya başlar kadın yarışmacılar herhalde.
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    <a class="b" href="/?q=portishead">portishead</a>'ın çoğu şarkısı bu konuda favorimdir. sevişme öncesindeki striptiz gösterisi varsa da da en güzel <a class="b" href="/?q=only+you">only you</a> gider.
- entry_name: |
    kadiko belediyesi
  entry_id:  74367732
  entry_writer: fern owl
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=%c3%a7ok+mu+komik">çok mu komik</a>)
- entry_name: |
    altered carbon
  entry_id:  74350325
  ...
  entry_fav_count: 0
  entry_content: |
    ne övülerek göklere çıkartılacak kadar iyi ne de yerin dibine sokulacak kadar kötü. izlenilebilir bir dizi.<br/><br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>dizideki en orijinal karakter kesinlikle poe idi ve bu kadar basit bi şekilde harcanmamalıydı heleki ortega her durumda kurtulurken...<br/><br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---
---
