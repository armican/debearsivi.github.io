...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    yabancı sınırı gelsin diyenler tarık denen futbolcuya baksınlar ve tövbe etsinler.
  entry_channels: spor
- entry_name: |
    ekşi itiraf
  entry_id:  80970487
...
- entry_name: |
    sebastian vettel
  entry_id:  80977765
  entry_writer: iiceman
  entry_fav_count: 7
  entry_content: |
    "3 araba ile yarışıyorum. kimi yol vermeliydi!" 20 araba birbiri ile yarışıyor zaten koçum. <br/><br/>artık boş konuşan bir pilot.. raikkonen yerine bu gitsin yıllardır rekabetçi araba ile şampiyonluk alamıyor. hep suçu başkalarına atıyor. bu makale nedir gerçekse ayıp yaptığı artık.. ne singapuru bitti, ne fransası, ne baküsü ne almanyası ne bilmem nesi. saçmalıklarını anlatmıyor, yok vers suçlu yok kimi engelledi beni geçirin beni onun önüne, yok lewis napıyor, yok ping pong mu oynuyoruz or what.. ergen kılıklı çıkarcı tip. baskı altında rezillik yaratıyor.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.gpblog.com/en/news/20539/vettel-unhappy-with-raikkonen-i-m-racing-3-cars-.html" title="https://www.gpblog.com/en/news/20539/vettel-unhappy-with-raikkonen-i-m-racing-3-cars-.html">https://www.gpblog.com/…nen-i-m-racing-3-cars-.html</a><br/><br/>hamiltonu da sevmiyorum hareketlerini davranışlarını şımarıklıklarını (özellikle 1. olduğunda yaylanarak havalara girmesi ve yılışıkları-rosberge şapka fırlatması gibi vs, 2. 3. vb olduğunda somurtması-hatta monacoda tünel girişi virajda sola çekip podyuma geç gelmesi gibi hareketleri) ama ilk virajda temastan kaçınmak için direksiyonu nasıl da kırıyor, vettelden daha mantıklı bir sürücü en azından:<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/5_bCXbKgL_w?t=31s">https://youtu.be/5_bcxbkgl_w?t=31s</a>
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    şenol güneş’i çok seviyorum ve saygı duyuyorum ama umarım bu sene bizi şampiyon yaptıktan sonra milli takıma gider. bu kadar stresi ve en ufak yenilgide yapılan vefasızlığı kaldırmak için fazla yaşlı. dün burak alınmasın yeter ki şampiyon olmayalım diyenler sezon sonunda şenol güneş’e demediklerini bırakmadılar. hani lan burak alınmasın yeter ki şampiyon olmayalımdı? ben de hiç istemedim burak’ı ama cenk gittiğinde adım gibi biliyordum şampiyon olamayacağımızı.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    dağlık japonyayla, nispeten daha ovalık türkiye'nin, nüfusuyla, yüz ölçümünü karşılaştır kardeş. bakalım neye ulaşıyorsun.<br/><br/>tanım: suriyede bir kent.
  entry_channels: siyaset,tarih,seyahat
- entry_name: |
    iç mimar mısın dış mimar mı
  entry_id:  80996999
  entry_writer: vboychaos
  entry_fav_count: 1
  entry_content: |
    soranlara düz mimarım diye cevap verdiğin soru.<br/><br/>bazı insanlara piç mimarım demişliğim de vardır.<br/><br/>en azından halkımız iç mimarlık ve mimarlık diye iki farklı meslek olduğunu öğrenmiş.
  entry_channels: 
- entry_name: |
    hastasının kimlik bilgilerini paylaşan doktor
  entry_id:  80996233
  entry_writer: koministimam2
  entry_fav_count: 1
  entry_content: |
    eheheh bu herif rahatsız yaa yazık:) <br/>ulan bunun doktor olması bile garipti de, bu tarz saçmalıklarla elindeki mesleğinden de olacak saf yaa:)
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    hafta sonu için fiziksel efor gerektiren işlerde çalışabilirim. inşaatta amelelik olur, tarlada ırgatlık vs. her işte çalışabilirim. aslında beyaz yaka iyi bir işim var ama ben seviyorum ameleliği. doğrusu bazen kırbaçlanmak hoşuma gidiyor.<br/><br/>yer: ankara/etimesgut
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    alakanız olsun ya da olmasın, o an aşık olmaya hazırsanız karşınıza çıkan ilk canlıya/nesneye aşık olursunuz.
  entry_channels: ilişkiler
---
