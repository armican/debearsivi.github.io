...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    0 faktöriyelin aslında 1'e eşit olmaması
  entry_id:  93729072
  entry_writer: gezegen olan pluton
  entry_fav_count: 30
  entry_content: |
    bir şeyin yokluğunun tek durumu olması kanıtlanabilen bir şeydir 0!. öyle matematikçilerin işine geldiği gibi bir durum yoktur, faktöriyel özünde sıralama demektir; yani bir rafa 5 kitabı nasıl sıralarsanızdaki durum sayısını 5! ile buluruz. <br/><br/>0! de o kitaplığın boş olma durumudur, bu da bir tanedir. olaya bu şekilde bakınca her şey mantıklı.
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    imamın yapması halinde karışıklık çıkaracak olan hadise.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    ali koç'un kapısını bi tekmeyle kırmış ve içeri girip demiş ki; ceketim nerde lan?
  entry_channels: spor
- entry_name: |
    mbaye diagne
  entry_id:  93743182
  entry_writer: talihli bedevi
  entry_fav_count: 5
  entry_content: |
    30 gol attı yerin dibine sokuluyor demek ki elinizde ki islam slimani olsa adamı şimdiye kazığa oturturdunuz...
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    ciddi ciddi geleceğin epl, la liga yıldızı ışığı vermektedir. böyle adamlardan faydalanamayan türk hoca profiline ne desek boş.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    <a class="b" href="/?q=grotesk">grotesk</a> sahnelere gebe arap geleneği
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=ma%c3%a7a+k%c4%b1z%c4%b1">maça kızı</a>)
  entry_channels: ilişkiler
- entry_name: |
    erkeğin yaşam amacı
  entry_id:  93734124
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=di%c5%9fiyi+d%c3%b6llemek">dişiyi döllemek</a>)
  entry_channels: 
- entry_name: |
