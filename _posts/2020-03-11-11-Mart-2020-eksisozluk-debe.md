...
- entry_name: |
  ...
  entry_id:  103277706
  entry_writer: im just one
  entry_fav_count: 67
  entry_content: |
    türk hava yolları'nın işe alım süreçlerinden bir değil, iki değil, üç değil, tam dört kere elendim. ve bunların hiçbirisinde sınavla elenmedim, sınavları hep geçtim. hepsinde mülakat aşamasında elendim. araya sokabileceğim insanlar vardı. çok rahat yapabilirdim ama ben işlerin bu şekilde yürümesini istemediğim için, bu düzenin değişmesini istediğim için, içimin rahat etmeyeceğini bildiğim için, belki de birisinin hakkını yemiş olabileceğim için bunu yapmadım, yapmam.<br/><br/>liyakat çok önemli bir konu ve ben eminim ki o şirkette çalışanların %80'i (sen de dahil) nitelik olarak benim yanıma yaklaşamazsınız. türk hava yolları'nda çalışmak benim için her zaman çok güzel bir hayaldi, elimde olan süreçleri hep geçtim, elimde olmayan süreçlerde hep elendim. ilk çıktığı gün gördüm bu arkadaşın durumunu ve gerçek anlamda çok üzüldüm. çünkü ben tırnaklarımla kazıyarak bir yerlere gelmeye çalıştıkça, insanların bu şekilde başkalarının haklarını hiçe sayarak kariyer basamaklarını tırmanmalarını, nitelikleri uygun olmadığı halde o pozisyonları işgal etmelerini sindiremiyorum.<br/><br/>sana ve bu düzenin bütün parçalarına her gün lanet ediyorum, yazıklar olsun.<br/><br/>tanım: bir türk hava yolları çalışanı.
...
- entry_name: |
    corona ile en iyi mücadelenin yakalanmak olması
  entry_id:  103314753
  entry_writer: hemeu
  entry_fav_count: 4
  entry_content: |
    evet m.ö. 590 yılında sizin kadar süper zeka olmayan bir çinlinin de aklına gelmiş. ve yeni bir ürün icat etmiş.<br/><br/>(bkz: <a class="b" href="/?q=a%c5%9f%c4%b1">aşı</a>)
  entry_channels: sağlık
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    statükoculuk yapanın hıammmnıağ neyse olabilir tabi aşk bir sudur iç iç kudur.
  entry_channels: ilişkiler,sağlık
- entry_name: |
    sözlük yazarlarının duygu durumları
  entry_id:  103313696
  entry_writer: eksiksoz
  entry_fav_count: 0
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    kısaca;<br/><br/>(bkz: <a class="b" href="/?q=yunan+tanr%c4%b1s%c4%b1+heykeli">yunan tanrısı heykeli</a>)
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    herkes kendince bir şeyler çiziktirmiş, bana göre iki püf noktası var;<br/>1) başarı kriterinizi belirlemek<br/>2) adamına göre davranmak<br/>kendiniz olmayın, kendinizi geliştirin.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    <a class="b" href="/?q=earl+francis+lloyd">earl francis lloyd</a> 1950'de nba'de ilk oynayan siyahi basketbolcu oldugu icin, yazilan yilda siyahi basetbolcunun oynanamasi normal olan mac.
  entry_channels: spor
---
