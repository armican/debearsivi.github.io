...
- entry_name: |
    11 mart 2020 akaryakıt indirimi
  entry_id:  103290952
  entry_writer: kamerarkasi
  entry_fav_count: 270
  entry_content: |
    devede kulaktır.<br/><br/>lan petrol fiyatı %50 düşüyor ama benzin sadece %10.<br/><br/>aradaki %40 payı kim çalıyorsa sülalesini seveyim
...
- entry_name: |
    korona aşısının içine kısırlaştırıcı katacaklar
  entry_id:  103288862
  entry_writer: my little cookie
  entry_fav_count: 209
  entry_content: |
    bu siyasal islamcıların niye hep akli çükte, götte?<br/>abicim, koskoca din. bir milyardan fazla inananı var. ama tek meseleleri kadının götü, erkeğin çükü.<br/><br/>vay arkadaş.
  entry_channels: bilim,sağlık,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 53
  entry_content: |
    (bkz: <a class="b" href="/?q=ders+%c3%a7al%c4%b1%c5%9fmak">ders çalışmak</a>) .
...
- entry_name: |
  ...
  entry_fav_count: 48
  entry_content: |
    abartılı olmadığı sürece güzeldir.
...
- entry_name: |
  ...
  entry_channels: anket,ekşi-sözlük
- entry_name: |
    corona açıklanmamalı
  entry_id:  103319171
  entry_writer: live for holiday
  entry_fav_count: 29
  entry_content: |
    ulan millet ölüyor! başlatma ekonomine!
  entry_channels: sağlık
- entry_name: |
    çaylaklara tavsiyeler
  entry_id:  103301817
...
- entry_name: |
  ...
  entry_fav_count: 28
  entry_content: |
    kızım olsaydı ve uygun bir yaşta sevgilim var deseydi ilk yapacağım şey onunla uygun bir zaman diliminde tanışmak olurdu. itiraz ederek, karşı çıkarak onunla inatlaşıp kendimden uzaklaştırmaktansa ona görüşlerimi uygun bir dille anlatmak isterdim.
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    insan ilişkilerinde herkesin dengini bulduğuna ve hakettiğini yaşadığına inanan biriyim. kendi aldatılmalarım, kandırılmalarım, değersiz hissetmelerim<sup class="ab"><a title="(bkz: hissettirilmeler)" href="/?q=hissettirilmeler" data-query="hissettirilmeler">*</a></sup> dahi suçu kendimde ararım. ben farketmemişim, görmezden gelmişim, ben tongaya düşmüşüm diye düşünürüm. ben kendime fazla yükleniyor olabilirim o ayrı mesele. neyse, şunu demeye geldim ben ; şu başlığa girip okuyacak erkekler olarak bizzat sizin güvenilmez insanlar olmanızdan mütevellit evet güvenilir kadın bulmanız çok zor olacak. elinizdekiyle yetinmeyi, idare etmeyi öğrenin derim ben. benim yaptığım gibi kendinizden beklentiyi çok yüksek tutmayın böyle. çünkü sizden bir bok olmaz.
  entry_channels: ilişkiler
- entry_name: |
    tutunamayanlar (dizi)
  entry_id:  103317334
...
- entry_name: |
    telefonunu ingilizce dil seçeneğinde kullanan türk
  entry_id:  103298442
  entry_writer: khanjuris
  entry_fav_count: 13
  entry_content: |
    buna laf edene <a class="b" href="/?q=e%c4%9flence+%c3%a7ubu%c4%9fu">eğlence çubuğu</a> girsin.<br/><br/>liseliler bilmez, eskiden hiçbir yazılımda türkçe dil desteği yoktu. türkçe dil desteğinin yaygınlaşmaya başladığı dönemlerde ise yazılımların türkçe versiyonları abilerinizin <a class="b" href="/?q=windows+t%c3%bcrk%c3%a7esi">windows türkçesi</a> olarak da hatırlayacağı <a class="b" href="/?q=bellek+read+olamad%c4%b1">bellek read olamadı</a> seviyesindeydi. o dönemlerden geçmiş pek çok kullanıcı alışkanlık olarak dil ayarlarını ingilizce'de bırakır.
  entry_channels: teknoloji,eğitim
- entry_name: |
    yazarların üstünde taşıdıkları nakit para
  entry_id:  103299391
  entry_writer: elizsa
  entry_fav_count: 12
  entry_content: |
    patronun vergi yatırmaya gönderdiği elemanının açtığı başlık.<br/>peşin edit: düşmez.
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    işyerine sürekli mini etekle gelen kız
  entry_id:  103307406
  entry_writer: the ultimate driving machine
  entry_fav_count: 7
  entry_content: |
    bunu bir eleştiri veya ön yargı olarak yazmıyorum. tamamen 14 yıllık iş hayatımdaki gözlemlerim sonucu vardığım sonuçtur.<br/><br/>bu tip kızlar evlendikten sonra bir daha kolay kolay mini etek giymezler. yani yukarılardaki "evlenecek erkek arıyordur" argümanı kısmen doğru olabilir.
...
- entry_name: |
  ...
  entry_id:  103281941
  entry_writer: asminnn
  entry_fav_count: 5
  entry_content: |
    üniversite yıllarından<br/>(bkz: <a class="b" href="/?q=ceteris+paribus">ceteris paribus</a>)
