...
- entry_name: |
  ...
  entry_id:  83611601
  entry_writer: televizyonunu yeni acan izleyici
  entry_fav_count: 416
  entry_content: |
    geldi yine tipini ....... başlarlar şimdi adamlar haklı bilmem ne diye. lan adam haklı diyerek kendini küçük düşürüyorsun ama o kadar kendini toplumdan dışlamışsın ki bana demiyo ki sana diyo diye düşünüyorsun. nasıl bir ayrıştırmışsanız kafanızda toplumu kendinize hakareti bile hoş görüyorsunuz.<br/><br/>edit : fazla hızlı gitmişim.
...
- entry_name: |
  ...
  entry_fav_count: 160
  entry_content: |
    kilo vermeni istiyorum sağlığın için diyorsa güzel birşeydir. ama kilo ver yoksa ayrılırım işte beni utandırıyorsun diyorsa o kişiden acilen uzaklaşılması gerekmektedir.
...
- entry_name: |
    yağmuru seyrederken banyo yapıp kitap okuyan erkek
  entry_id:  83618987
  entry_writer: berettawolf
  entry_fav_count: 38
  entry_content: |
    yağmuru seyrederken nasıl banyo yapıyor onu anlamadım? şampuanı alıp oo hazır su diyip yağmurun altında mı yıkanıyor?
...
- entry_name: |
    öğretmenler günü
  entry_id:  83616177
  entry_writer: aydakidonsuzkedi
  entry_fav_count: 17
  entry_content: |
    sözlükteki öğretmen yazarların gününü kutlarım. iyi ki varsınız .... <br/>çağdaş , modern , yenilikçi öğrenciler yetiştirmeniz dileği ile...
...
- entry_name: |
    svihs için en uygun görsel
  entry_id:  83623331
  entry_writer: debeci
  entry_fav_count: 10
  entry_content: |
    bu ara bilhassa gelen son iki videodan sonra "svihs" yine havada uçuşuyor.<br/>bunun için nette denk gelen çok uygun bir görseli paylaşmak istiyorum, çoğu kişi bunu görmüş olabilir, ama başka önerileri olan varsa onlara da açığız. <br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://eksiup.com/753679900402">https://eksiup.com/753679900402</a>
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    sadece kyk yurtlarında kalan kızlara mal edilmemesi gereken durum. bir anadolu ilçesinden bildiriyorum. haftada en az iki gece yatılı kız lisesinden ambulansla bir kız öğrenci geliyor. ambulansın kapısını ise bizim att arkadaşlardan önce sevdiceğinin hastaneye kaldırıldığını öğrenen erkek aşığımız açıyor. ben bıktım. bu arkadaşların üniversite halini hayal bile edemiyorum.<br/><br/>ilçede zaten iki ambulans var, biri bu kızları taşıyıp duruyor inanın. olay tamamen ilgi manyaklığı. ailesinin evinde kendini odasına kapatmaya bile hakkı olmayan kız, bir erkeği nasıl ele geçireceğini, nasıl üzeceğini, nasıl ilgisini çekeceğini keşfediyor burada. kul köle ediyor kendine. erkekse sekonder kazançları uğruna bu kezbanlığa izin veriyor.<br/><br/>erkekler yapmıyor mu sorusuna cevabım yapıyor elbette ama inanın altından çok farklı şeyler çıkabiliyor.
  entry_channels: sağlık,eğitim
- entry_name: |
    artık yeni nesilin ingilizce biliyor olması
  entry_id:  83624222
  entry_writer: klarkkent
  entry_fav_count: 7
  entry_content: |
    tam tersini düşündüğüm iddia. <br/><br/>7 yıllık anadolu liseleri kalktıktan sonra yeni nesilde ingilizce olayının bittiğini gözlemliyorum. ingilizce bilgileri internet oyunlarıyla falan sınırlı.50-100 kelime falan. <br/><br/>ingilizce makale versen okuyamazlar. film açsan altyazısız izleyemezler. bir konuda ingilizce bir kaynaktan yardım almak durumunda kalsalar okuyup anlayamazlar.
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    biz, 80 olaylarında canından korkmuş neslin, apolitik büyütülmüş çocuklarıyız. yakışmaz bize siyasi olayları hatırlamak.
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    “sen içine yönel, dışından seni ‘habersiz’ sansınlar. ne güzel haldir ki o; sen akıllı ol, seni deli sansınlar.”
  entry_channels: anket,ilişkiler,edebiyat
- entry_name: |
    bir kıza yüzsüz gibi sürekli mesaj atmak
  entry_id:  83624723
  entry_writer: one does not simply walk into eksisozluk
  entry_fav_count: 3
  entry_content: |
    sohbetinden zevk alıyorsam atarım. sonuçta kendimi eğlendiriyorum. kızın veya başkalarının ne düşündüğü umrumda değil. sıkılırsam da atmam artık.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    çaylak hatunlar uykumu açabilir mi.. zira uykum geldi ve 2 saat daha ayakta kalmam gerek
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    valla kimse kusura bakmasın, tribün cezası var. öyle gişe fiyatının altı geyiğini bırakıp takımını düşünerek biletini devredeceksin. hem küfürler savurarak takımı eksik bırakıp (istisnalar kaideyi bozmaz) hem de para peşinde koşmayacaksın.<br/><br/>böyle kritik bir süreçte böyle bir ceza durumu varken para peşinde koşanları ciddiye almayın, kimseye para vermeyin, twitter'da galatasaray başlıklarına yazın, birileri takımını düşünerek ücretsiz devrediyor. <br/><br/>not:maça gitmeyeceğim. istanbul'da değilim.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    kesinlikle avrupayla alakasi olmayan minik köy bratislavadir.
  entry_channels: anket
- entry_name: |
