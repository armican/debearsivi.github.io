...
- entry_name: |
  ...
  entry_fav_count: 39
  entry_content: |
    benim de oldugum muhaliftir. reis biz seni yanlis anlamisiz, sen bu mallara vurdugun surece oyum sana!<br/><br/>adam gibi adam recep tayyip erdogan!
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 24
  entry_content: |
    yaptigi penaltidir, degildir tartismasini anlarim da, ayagi kirmalik hamle demek icin agir gerizekali olmak lazim. <br/><br/>hareket penalti degildir, serdar topa dokunmustur, rakip de serdar'in ayaginin ustune basip dusmustur. 3 tane var "hakemi" izleyip sacma huseyin gocekin kicini kurtarmak icin penalti demistir.<br/><br/>edit: 30 kez izledim, bence kesinlikle penalti degil ama hadi tarafliyim vs yaniliyorum diyelim. ayagi kirmak diyenler var, cildiriyorum. kor musun, beyinsiz misin, comar misin? yoksa hepsi mi? git curling izle, satranc, dama falan izle, futbol senin icin cok tehlikeli.
  entry_channels: spor
- entry_name: |
    evlenmek ve beraber yaşamak arasındaki fark
  entry_id:  83629323
  entry_writer: berries
  entry_fav_count: 24
  entry_content: |
    resmi nikah bir şeyi güzelleştirmez fakat birlikteliğinizde ortak kazançlar, tasarruflar, yatırımlar olacaksa muhakkak gereklidir. bunun dışında iyi günümüzde çok aklımıza getirmesek te hastalık, kaza, ölüm vs durumlarda partner üzerinde söz sahibi olabilmeniz için de gereklidir. 20 yıllık eşiniz acil bir ameliyata girerken hemşire gerekli evrakları size değil de senede bir kez ancak görüştüğü kardeşine verirse, onun müsaadesine başvurursa içinize oturabilir yumruk gibi.
  entry_channels: anket,ilişkiler
- entry_name: |
    yakaladığı impalayla aşk yaşayan leopar
  entry_id:  83624039
  entry_writer: dogru sozler
  entry_fav_count: 22
  entry_content: |
    leoparda bir gariplik yok yemeden önce her kedi gibi bir süre avıyla oynuyor. ama sıradan bir belgesel sahnesini ''aşk'' olarak değerlendirip saçma sapan romantizm yapan yazarın ciddi psikolojik sıkıntıları var.
...
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    paraniz varsa yeter beyler. gerek sosyal ve eski okul cevremde, gerekse sosyal medyadan gordugum kadariyla, zamaninda burun kivirdiklari erkeklerden daha cirkin(abartmiyorum cok ama cok cirkin) ancak zengin erkeklerle evlenip cocuk yapiyorlar. hani etrafinizda varsa suan ortalama tiplere dahi bakmayan, havali birileri, az sabredin bekleyin, universite bittikten sonra zengin ve cirkin birisi ile kesinlikle evlenecektir.<br/><br/>yok cenesi, yok gotu, yok alni, sakali. gecin bunlari hanimlar, bos yapmayin bi zahmet.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    türk futbolunda şike olur adı geçmez. football leaks belgeleri çılar adı geçmez.. ama hakkında dedikodu gırladır. <br/><br/>açık ara türk futbolunun yüz akı.
  entry_channels: spor
- entry_name: |
    mustafa cengiz
  entry_id:  83629790
  ...
  entry_fav_count: 15
  entry_content: |
    bu gece çıkıp federasyonun anasını sikmelidir<br/>aksi halde siktir olup gitmelidir<br/><br/>o nasıl bir penaltı amk
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    galatasaray'ı bitirme operasyonu
  entry_id:  83630556
  entry_writer: tucek
  entry_fav_count: 9
  entry_content: |
    bakın arkadaşlar gerçekten böyle durumları saçma sapan fanatizm olarak görürüm ama yuh ulan artık!<br/><br/>hayır gerizekalı diğer 2 büyük kendilerinin şampiyon olacağını sanıyorsa nah olursunuz...lafa gelince başakşehir olmasın da kim olursa olsun dersiniz ama burada alenen galatasaray'ı saf dışı bırakıyorlar siz gülüp eğleniyorsunuz.<br/><br/>sizin de samimiyetinize sokim.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    lan süper kupa finalinde cücü izledi yine kırmızı veremedi bugün olanlara mı şaşırıyosunuz.<br/><br/>gidin ananızın kıllı amına sokun o kameraları madem orospu çocukları.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    fatih erbakan ile birlikte siyasete atılan şahıs, kurulan partinin adı yeniden refah partisi.
  entry_channels: siyaset,tarih
- entry_name: |
    yıldırım demirören
  entry_id:  83632004
  ...
  entry_fav_count: 0
  entry_content: |
    arkasında iktidar ve muhalefet partisi olan; galatasaray düşmanlığını tüm federasyona yayan ve federasyon kurullarını galatasaray'ı biçmek için kullanan beşiktaşlı medya patronu. işini dört dörtlük yapıyor, tebrik etmek lazım.
  entry_channels: spor
- entry_name: |
    galatasaray ligden çekilsin kampanyası
  entry_id:  83631299
  entry_writer: bowersolufsen
  entry_fav_count: 0
  entry_content: |
    2 kasım'da dedim, galatasaray omurgalı olacak iki maça çıkmayacak ve seneye alt ligden devam edecek.
  entry_channels: spor
---
