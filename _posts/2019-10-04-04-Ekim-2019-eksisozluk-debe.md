...
- entry_name: |
  ...
  entry_fav_count: 132
  entry_content: |
    son dakika golü ile beşiktaş'ın mağlup olacağı maç.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 78
  entry_content: |
    gözlerimizi kapatıp etrafımızdaki 10 kişiye hristiyanlar hakkında ne düşündüklerini sorsak hepsi ırkçılık yapar (ki bu ırkçılık mı tartışılır) ama bu 10 kişi bir hristiyan görse, en az 9’u saygıda kusur etmez. türkiye boklayacağım diye kasmaya gerek yok.<br/><br/>tanım: irlanda’dır.
...
- entry_name: |
  ...
  entry_channels: siyaset,haber,ekonomi
- entry_name: |
    güven yalçının poposu
  entry_id:  96109100
  entry_writer: demiranka
  entry_fav_count: 47
  entry_content: |
    sözlükte sırtınızı duvara yaslamanız gerektiğini kanıtlayan başlık.
...
- entry_name: |
    konya'da yaşamayan konyalıların aydın olması
  entry_id:  96091837
  entry_writer: muozi
  entry_fav_count: 33
  entry_content: |
    (bkz: <a class="b" href="/?q=vedat+milor">vedat milor</a>)
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 31
  entry_content: |
    insanlara, onları size nankörlük yapmaya mecbur bırakacak kadar büyük iyiliklerde bulunmayın.
  entry_channels: anket,edebiyat
- entry_name: |
    kendi maaşına yüzde 85 zam yapan sendika başkanı
  entry_id:  96108826
  entry_writer: sefillermiyiz
  entry_fav_count: 25
  entry_content: |
    memur-sen'e bağlı sağlık-sen'in başkanı semih durmuş, beş yıldızlı otelde yaptığı kongrede, maaşına %85 zam kararı çıkartmış. başkanın zamlı maaşı 26 bin tl olarak belirlenmiş.<br/><br/>ayrıca aynı kongrede şube başkanlarına yapılan zamla şube başkanları da 14.037 tl alacak imiş. are you serious?<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.habernediyor.com/gundem/kendi-maasina-yuzde-85-zam-yapti-h7377.html" title="https://www.habernediyor.com/gundem/kendi-maasina-yuzde-85-zam-yapti-h7377.html">kaynak</a>
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 24
  entry_content: |
    büyük ihtimalle teklifi aldığı kişi de erkektir.
  entry_channels: ilişkiler
- entry_name: |
    3 ekim 2019 beyzanur un doğum günü rezaleti
  entry_id:  96110656
  entry_writer: pindugu
  entry_fav_count: 21
  entry_content: |
    başlığa bak<br/>entrye bak<br/><br/>son yıllarda ne yaptınız sayın yönetim? el sallayanı sözlüğe mi aldınız? merhaba diyene yazarlık mı hediye ettiniz?
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    bot hesapların tt tweetleri gibi olmuş takımın ismi.
  entry_channels: spor
- entry_name: |
    beşiktaş
  entry_id:  96080808
  ...
  entry_fav_count: 12
  entry_content: |
    gece gece iki tane orospu evladına dert olmuştur. tuğla kadar entryler yazdırmıştır.<br/><br/>8 de yedik evet. utanıp sıkılan yok. 3 puanlı sistemde 8 atana 5 puan yazılmıyor. futbol cehaletinizi başka yerde göz önüne getirin.
  entry_channels: spor
- entry_name: |
    en gereksiz vergi
  entry_id:  96106165
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    büyük sırra erişmiş, meseleyi çözmüş erkektir.kafası rahattır.
  entry_channels: ilişkiler
- entry_name: |
    mucize doktor
  entry_id:  96086136
  ...
  entry_fav_count: 7
  entry_content: |
    yapımcılara "otizm nedir, ne değildir, otizmin özellikleri nelerdir" anlatmak gerekiyor zira karakterin davranışları otizm değil. belki başka bir rahatsızlıktır ama değil. keşke otizmli bireyi olan ailelere, uzmanlara falan danışsalardı.<sup class="ab"><a title="(bkz: belki de danışmışlardır)" href="/?q=belki+de+dan%c4%b1%c5%9fm%c4%b1%c5%9flard%c4%b1r" data-query="belki de danışmışlardır">*</a></sup> otizme farkındalık yaratması, otizme dikkat çekmesi açısından güzel bir proje ben kendim ve kardeşim adına teşekkür ediyorum ama otizmi yakından tanıyan insanlar nasıl yani modunda izliyor. bir ara editleyerek anlatırım detaylı.<br/>not: otizmli birey ablası<br/><br/>edit: çok fazla "abd versiyonunu izlediniz mi onun hakkında ne diyorsunuz" mesajı geldi. yoğun kpss çalışıyorum ama en azından 1 2 bölüm izleyim diyorum. izleyince onun hakkında da editlerim:)
  entry_channels: tv,sağlık
- entry_name: |
    abdullah avcı
  entry_id:  96110883
  entry_writer: bisbasar
  entry_fav_count: 7
  entry_content: |
    dk. 85 beşiktaş taç kullanacak, acele etme diyor herif kenardan. ya senin allah belanı versin. çöplüğüne dön rezil herif. ahlaksız!
  entry_channels: spor
- entry_name: |
    nesine.com
  entry_id:  96080607
  ...
  entry_fav_count: 6
  entry_content: |
    kupon tutturduğunuzda saatlerce onaylayıp hesabınıza atmayan, canlısı iddia şirketi kaynaklı berbat olduğunu düşündüğüm sikko bahis sitesi... uzak durun...
...
- entry_name: |
    3 ekim 2019 trabzonspor basel maçı
  entry_id:  96086823
  entry_writer: analfistur
  entry_fav_count: 3
  entry_content: |
    trabzonspor'un sokup sokup çıkaracağı ve bana doğum günü hediyesi vereceği maçtır. <br/><br/>not: gs.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  96098319
  entry_writer: bazen boyle olur
  entry_fav_count: 0
  entry_content: |
    <a class="b" href="/?q=beyonce">beyonce</a> halo parçası <a class="b" href="/?q=postmodern+jukebox">postmodern jukebox</a> yorumu ile orijinalinden bin kat daha iyi bir parça haline gelmiş. <br/><a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/6fAK0MHs4xE" title="https://youtu.be/6fAK0MHs4xE">halo</a>
  entry_channels: anket,müzik
- entry_name: |
    ekşi sözlük dertleşecek insan veritabanı
  entry_id:  96095021
  entry_writer: soyulmus dudak derisi
  entry_fav_count: 0
  entry_content: |
    ***yenileme<br/><br/>aşırı saçma ve çocukça bir davranışta bulundum bir beyefendiye karşı ve şimdi ne yapacağımı bilmiyorum. yardımcı olabilecek beyleri bekliyorum mesaj kutuma, özellikle +30 olanları.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    3 ekim 2019 real madrid fenerbahçe beko maçı
  entry_id:  96111503
  entry_writer: chess n box
  entry_fav_count: 0
  entry_content: |
    obradoviçin hikmetinden sual olunmaz ama bu siktiğimin sloukasını izlemek zorunda mıyız? oyun kuramıyor, top elinde dolaşarak süre öldürüyor, boş üçlük kaçırıyor, dolu üçlük zaten atamıyor, sezon içinde 2-3 maçı iyi oynuyor ama final maçlarında hep hayalet..<br/>kesinlikle winner değil, kaybettiğimiz finallerde oynadığı oyun ortada, bence melih ve sloukasla vedalaşmalıyız artık, advocaat’ın da dediği gibi kusura bakma iyi bir insansın ama fenerbahçe için yeterli değilsin demeliyiz.
  entry_channels: spor
---
