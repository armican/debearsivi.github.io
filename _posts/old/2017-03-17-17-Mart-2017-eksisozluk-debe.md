...
- entry_name: |
  ...
  entry_id:  66873258
  entry_writer: abdurrezzak karabiyik
  entry_fav_count: 30
  entry_content: |
    son arazi yandaşa peşkeş çekilip imara açıldığında,son yetimin malına çöküldüğünde, son kibritkutusu siktepesi gökdelen dikildiğinde bu adam betonun gelecek vaad etmeyen bir şey olduğunu anlayacak.
- entry_name: |
    vatanım sensin
  entry_id:  66892689
...
- entry_name: |
  ...
  entry_fav_count: 23
  entry_content: |
    3. dalga söylentileri üzerine iski'de kriz masası toplanmıştır.
- entry_name: |
    deniz baykal
  entry_id:  66873074
  entry_writer: oci
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    duyduğun zaman iyi ki yaşıyorum dedirten, insanı keyif diyarına sürükleyen seslerdir.<br/><br/>* sabah uyandığında kulağına gelen kuş sesleri <br/>* deniz kıyısında uzanmisken kulağına vuran dalga sesleri <br/>* evde sakince otururken dışarıdan gelen yağmur sesi<br/>* uzaklardan gelen vapur, tren siren sesi <br/>* uzun süredir görüşmediğini birinin telefondaki sesi<br/>* sevdiğin birinin tüm pozitif enerjisiyle günaydın demesi <br/><br/>ve benzeri keyifli seslerdir.
- entry_name: |
    nicola leali
  entry_id:  66891737
  entry_writer: stenns
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    dertli gonullere kramp iste benim donald trump
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    beşiktaş'ımızın katılıp katılmayacağı daha belli olmayan kura çekimidir. umarım diyelim.<br/><br/>gaza gelmeyin lan hemen.
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=a%c4%9fr%c4%b1+kesici">ağrı kesici</a>) (bkz: <a class="b" href="/?q=ademhan+esen">ademhan esen</a>)<br/>(bkz: <a class="b" href="/?q=g%c3%b6%c4%9f%c3%bc+delen+adam">göğü delen adam</a>) (bkz: <a class="b" href="/?q=erich+scheurmann">erich scheurmann</a>)<br/><br/>okuyunca bana teşekkür edeceksiniz. yani edebilirsiniz, etmelisiniz.<br/><br/>edit: yazar isimleri.
- entry_name: |
    ilk alınan kaset
  entry_id:  66885294
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://connected2.me/echoatay" title="https://connected2.me/echoatay">buyursunlar</a> efendim.
- entry_name: |
    16 mart 2017 brose baskets fenerbahçe
  entry_id:  66893499
  entry_writer: yine ucurun
  entry_fav_count: 0
  entry_content: |
    bogdanovic'in durduk yere üçlük atan adamın üstüne uçup sonra da sakatlandığı maç. çocuğum ne gerenk vardı?
---
