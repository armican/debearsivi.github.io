...
- entry_name: |
  ...
  entry_fav_count: 77
  entry_content: |
    eşimle ilk buluşmamızda seviştik. yani; genellemelerinizi sikeyim afedersin.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 73
  entry_content: |
    yazıldı mı bilmiyorum ama bence (bkz: <a class="b" href="/?q=k%c3%b6y+kahvalt%c4%b1s%c4%b1">köy kahvaltısı</a>)..<br/><br/>insanlar eskiden bu doğal güzellikten kaçmak için herşeyi yaptı.. yok peynir kokusuymuş aman tereyağı da neymiş ve sair.. şimdi o kahvaltı için yüzliralar harcıyor..
- entry_name: |
...
- entry_name: |
    31 aralık 2017 depremi
  entry_id:  73196054
  entry_writer: monsieur boduc
  entry_fav_count: 18
  entry_content: |
    erdek açıklarında marmara denizinde 12.4 km derinlikte 4.3 şiddetinde olan depremdir. <br/>yazarların götü, kandilli'den hassas yemin ediyorum
- entry_name: |
    tek aktör için yaratılmış karakterler
  entry_id:  73176333
  entry_writer: milletvekili
  entry_fav_count: 15
  entry_content: |
    <a class="b" href="/?q=furkan+k%c4%b1z%c4%b1lay">furkan kızılay</a> - <a class="b" href="/?q=havu%c3%a7">havuç</a>
- entry_name: |
...
- entry_name: |
    31 aralık 2017 milli piyangonun bana çıkması
  entry_id:  73195916
  entry_writer: takeredpill
  entry_fav_count: 13
  entry_content: |
    bari çekilişin bitmesini bekleseydin.
- entry_name: |
    1 ocak 2018 2000'lilerin yetişkin olması rezaleti
  entry_id:  73192311
  entry_writer: efendi
  entry_fav_count: 10
  entry_content: |
    khk ile önüne geçilmesi gereken rezalet
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    anladığım kadarıyla tanıdığı ya da tanımadığı insanlara küçük gülümsemeler hediye etmeyi seven bir insan. <br/>an itibariyle yüzümü güldürmüştür. huzurlu bir yıl diliyorum kendisine..
- entry_name: |
    ekşi itiraf
  entry_id:  73176131
  entry_writer: vennus
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    herkesin acısı sevdiği kadar.<br/><br/>ah ulan.
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    lol 1937'den beri bilim insanlarinin derinligini kavrayamadigi bir mevzuyu bizim eksiciler cozmus. acikcasi sonuna kadar okuma zahmetine bile katlanmadim. evrenin simulasyon oldugunu dusunen birinin fikrini ne kadar sacma olursa olsun okurum ama "rutherford'un yaptiklarini anlayamadilar" falan deyip "deep web" diye sacmalayan birinin bilimsel acidan degere sahip herhangi bir sey yazmasini mumkun gormuyorum. bu tip sansasyonel sacmaliklarla ancak dusuk zekali, her bokta komplo teorisi arayan sorunlu tipleri etkileyebilirsiniz.
- entry_name: |
    yılbaşından rahatsız olan çomarlar
  entry_id:  73193038
  entry_writer: kumrengi
  entry_fav_count: 3
  entry_content: |
    kendi kültürüne sahip çık deyip de araplara özenen insanlardır.
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    kimseye yük olmadan olsun da nasıl olursa olsun. <br/>insan yükü ağırdır be kardeşim.<br/>hasta olup bakıma muhtaç olmak, yaşlanıp da ilgiye muhtaç olmak, yalnız olup iki kelama muhtaç olmak. <br/>istemez be kardeşim. birden olsun, aniden. bir yaz günü olsun, kimsenin ayakkabısı çamur olmasın gömerken, kimse üşümesin. <br/>kimse üzülmesin mesela, çocuğunu büyüttü, evlendirdi, torununu gördü desinler mesela.<br/>bırakacak param olsun, yensin içilsin arkamdan. babam gibi, annem gibi. kimseye borcum olmadan.<br/>ve en önemlisi bir kişiyi dahi üzmesin be.<br/>tanım: herkesin bir gün karşılaşacağı durumun nasıl olacağını yoklayan anket hedesi<br/>not: 1000. entry
- entry_name: |
    tron coin
  entry_id:  73191940
  ...
  entry_fav_count: 2
  entry_content: |
    saçma sapan referanslı linkler arasında bilgi içerikli entry arayanlara gelsin. üstte bir arkadaş "350'ye kadar önünde yaklaşık 100 btc'lik satış baskısı var. coin'in son 24 saat işlem hacmi ise 28 btc. hesabı siz yapın, yolu açık mı değil mi?" yazmış. şu anda son 24 saatlik işlem hacmi 28 btc değil 28 bin btc'dir. virgül ve noktaların kullanımını iyi öğrenelim öncelikle.<br/><br/>ayrıca 100 btc'lik duvar hiçbir şey. saniyeler içinde eriyebileceğine şahit olabilirsiniz. keza bugün 300 satoshi'deki 60 btc'lik duvar yaklaşık 30 saniyede eridi. bu duvarlar suni olarak yaratılıyor ve anlık oluşup yok olabiliyor bunu unutmayın. balinalara yem olmayın.<br/><br/>2 gün önce source code açıklandı ve reddit'teki developer'ların yorumlarını takip ederseniz oldukça sorunsuz ve sağlam bir teknolojik alt yapıya sahip olduğunu görebilirsiniz. bu oldukça önemli bir detay.<br/><br/>7 ocakta tron bazlı ilk oyun piyasaya sürülecek. justin sun bunun cryptokitties'e benzer bir oyun olacağını söyledi. cryptokitties'in ne kadar popüler olduğunu hatırlarsanız bunun ne derece büyük bir haber olduğunu anlarsınız.<br/><br/>ek olarak justin sun 2018'den itibaren her hafta tron'un yeni bir büyük borsada satışa açılacağını açıkladı. bittrex ve bitfinex'e gelecektir çok yakında. bunu da göz önüne alın.<br/><br/>sonuç olarak siz aldıktan sonra 3 gün içerisinde 10 katına çıkmadı diye bok atmayın. teknolojiye yatırım yapın ve açıklamaları takip edin.
- entry_name: |
    black mirror
  entry_id:  73175619
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    kardeş yarın tatil ama salı <a class="b" href="/?q=kbb">kbb</a> bak tekrar söylüyorum <a class="b" href="/?q=kbb">kbb</a>.<br/>(bkz: <a class="b" href="/?q=mal+beyan%c4%b1">mal beyanı</a>)
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="http://connected2.me/phoneutria">http://connected2.me/phoneutria</a>
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    belki de sadece bu yuzden kutlamaya ihtiyac vardir. yilin bir gunu insanlar aileleriyle, arkadaslariyla, sevdicekleriyle bir araya gelmis yemek yemis eglenmis cok mu? bir gunlugune tum dertlerini unutmus dans etmis niye bu kadar batiyor?
---
