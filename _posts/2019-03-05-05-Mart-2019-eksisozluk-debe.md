...
- entry_name: |
    çalışarak cip satın alabilen kadın
  entry_id:  87356000
  entry_writer: yaz gecesi
  entry_fav_count: 10
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="http://www.tdk.gov.tr/" title="http://www.tdk.gov.tr/">tdk.gov.tr</a><br/><br/>cip<br/>isim, ingilizce jeep<br/>1. "isim" her türlü arazide kullanılabilen motorlu taşıt<br/><br/>(bkz: <a class="b" href="/?q=so+what">so what</a>)
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    peder hipofiz bezi tümörü ameliyatına girdi. hastane odasında dakikaları saymak gerçekten boktan bir şey.<br/><br/>34 yaşında adam olmama rağmen babanın varlığının ne demek olduğunu anlatan bir sessizlikle bekliyorum. bir çok şeyi sorgulatıyor insana.<br/><br/>edit: güzel mesajlar için teşekkür ederim. çıktı ameliyattan, şu an için her şey yolunda.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    vokali <a class="b" href="/?q=keith+flint">keith flint</a> bu sabah evinde ölü bulunmuştur. toprağı bol olsun, hayatımızı çok sikti zamanında.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    genelde birilerinin cebe attigi paradır. enayi parası ile yaşamak bir sanattır ve türkiye'de enayi rezervi bayağı yüksek.
  entry_channels: anket,ekonomi
- entry_name: |
    rekabet kurumu'nun marketlere soruşturma açması
  entry_id:  87358928
  entry_writer: veveyabilhassa
  entry_fav_count: 3
  entry_content: |
    yaz kızım.. bu, şu, o marketler bizim olduğundan takipsizliğine, diğerlerine şu kadar ceza kesilmesine, itiraz edenin kapatılmasına.. <br/>tanım: antalya halinde 4 tl'ye aldığı domatesi, istanbul tanzim çadırında 3 tl'den satınca, zararı birilerine fatura etmenin gerekliliği ile yapılan eylem..
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    sözlük çok acil işe ihtiyacım var. 1 hafta önce işten ayrıldım faturalar ve ev kirası geliyor kenarda kuruş param kalmadı.<br/>mesleğim kaynakçılıkdemir doğrama ferforje baba mesleğim olduğu için işçilik açısından en temizine sahibim. yaşım 32 anadolu yakasında ikamet ediyorum sigorta istemiyorum sigortasız yevmiye çalışabilirim..<br/>şöförlüğüm de mevcut istenirse şoförlük dahi yaparım amalelik de yapabilirim hiç sıkıntı değil..<br/>çevreniz de eşiniz dostunuz her kim varsa bir sorun soruşturun. <br/>allah yardımcımız olsun.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://m.youtube.com/watch?v=-0_NiMSmW5c" title="https://m.youtube.com/watch?v=-0_NiMSmW5c">coldplay - fix you</a>
  entry_channels: anket,müzik
- entry_name: |
    şenol güneş
  entry_id:  87362706
  entry_writer: karda moonwalk yapan adam
  entry_fav_count: 1
  entry_content: |
    iyi teknik direktör fakat bir takımda verimli olarak maksimum 2 yıl durabiliyor. <br/><br/>2 yıldan sonra bir şeyler oluyor. geçmiş trabzonspor kariyerleri de hep böyleydi. ilk 2 yıl verimli oyun oynatır sonra bozardı.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    <a class="b" href="/?q=fifa">fifa</a> ve <a class="b" href="/?q=uefa">uefa</a> tarafından müthiş bir dikkatle takip edilen başlık
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    trabzonspor'un kendi yakınında olan üst ve alt tüm rakipleri kaybetti. takımda eksikler hala olmasına rağmen takım ritm tuttu. trabzonspor kazanırsa avrupa kupaları ihtimalinde iddialı bir yere gelecek. tüm bu olumlu şeyleri düşündüğümüzde trabzonspor'un bu maçı kazanmasının mümkün olmadığını söylemek istiyorum. bu maçta pek iddiamız olmasaydı koyar geçerdik diyebilirdim ama kazanırsak bir şeyler güzel olacak ya hani, heh işte bu yüzden kasımpaşa'nın içimizden geçeceğini düşünüyorum.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=youtube%27daki+cinsiyet+de%c4%9fi%c5%9ftirme+ameliyat%c4%b1+videosu">youtube'daki cinsiyet değiştirme ameliyatı videosu</a>)
  entry_channels: 
---
