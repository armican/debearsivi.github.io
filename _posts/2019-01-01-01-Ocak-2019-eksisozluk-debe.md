...
- entry_name: |
  ...
  entry_fav_count: 33
  entry_content: |
    "başını göğsüme sakla sevgilim<br/>güzel saçlarında dolaşsın elim<br/>bir gün ağlayalım, bir gün gülelim<br/>sevişen yaramaz çocuklar gibi.." <br/><br/>(bkz: <a class="b" href="/?q=sabahattin+ali">sabahattin ali</a>)
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    emre bol'lu, turgay demir'li yapılanma.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    fetöcüleri tipinden tanımak
  entry_id:  84964365
  entry_writer: dukkanin ortasinda bagiran kosnuk
  entry_fav_count: 1
  entry_content: |
    - götü kabak gibi çıkaran kumaş pantolon <br/>- random çıkan badem bıyık<br/>- 1.65 civarı boy<br/>- kısa kollu gömlek <br/>- sandaletin içine çorap giymek<br/><br/>ilk başta aklıma gelen bunlar, ayrıca hepsinin tipini zikim.
