...
- entry_name: |
  ...
  entry_fav_count: 105
  entry_content: |
    alo selâmünaleyküm serkan. nasılsın kardeş.
...
- entry_name: |
  ...
  entry_fav_count: 59
  entry_content: |
    benimdir bu. başkası tarafından ilmik, ilmik örülmüş bir yalnızlık. mutsuz olmam için dizayn edilmiş yıllar. vallahi ne diyeyim ki. aferin, çok iyi düşünmüşsün. sabahtan beri mutlu oluruz diye plan yapıp, akşamında tek başına cem adrian dinleyip bu dünyanın amına koyayım diyorum. acayip uçlardayım.
  entry_channels: anket
- entry_name: |
    7615536
  entry_id:  84982659
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    (bkz: <a class="b" href="/?q=o+ses+t%c3%bcrkiye+y%c4%b1lba%c5%9f%c4%b1+%c3%b6zel">o ses türkiye yılbaşı özel</a>) performansı ile hem güldürmüş hem de hayran bırakmıştır kendine.<br/><br/>not: mutlu olan insan güler<br/><br/>tanım : "mütemadiyen instagram story si at bebişim" ünlüsüdür.
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    "şahsen ben daha az ama iş değiştirsem dahi kaybetmeyeceğim bir tazminatı tercih ederim."<br/><br/>hacu bu saflıkla çalışma hayatında sikerler sizi.<br/>nasıl da saf saf "az olsun ama kaybetmiyeyim" diyor.<br/>az olması demek kaybetmenin başlaması demek zaten.<br/>o kalan azı da hakkıyla alabilecekmiş gibi yaptığınız propagandanıza sokayım sizin.
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    çenesi düşük iki adet hatun var . sunacağınız yarışmaya sokayım.
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    gururumuz, <a class="b" href="/?q=s%c3%bcmeyye+boyac%c4%b1">sümeyye boyacı</a>'nın şimdi yarıştığı yarışma.<br/><br/>hep yüzün gülsün inşallah.
  entry_channels: tv
- entry_name: |
...
- entry_name: |
    ismail metin temel'in terfi ettiği gerçeği
  entry_id:  84966357
  entry_writer: nickbulamadimnolcak
  entry_fav_count: 4
  entry_content: |
    polyanna' nın görse önünde diz çöküp tövbe edeceği iddia!
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    oraya +1 ile ekleyin demek isterdim ama maalesef ülser nedeniyle bana alkol yasak. benim içinde 1 kadeh sallayın amk. içemiyoruz bari benim yerime de sizler için...<br/><br/>edit : yemişim ülserini. bira + vodka ile oraya ekleyin lan beni de....
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    güzel bir aşk şarkısıyla 2018 i uğurlayalım.<br/><br/>selvi boylum al yazmalım <br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/AL2Nlt1Yezo">https://youtu.be/al2nlt1yezo</a>
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    yanılmıyorsam bütün baba metal grupların konser verdiği 2010 daki sonisphere festivaline yazın memleketi erken giderim nasılsa yine gelirler deyip gitmedim halen içimde uktedir.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    6.70-6.85 aralığı diyorum.<br/>at fav'a bekle.
  entry_channels: anket,ekonomi
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    kimsenin salladığı yok sanırım herkes net maaş alıyor. mart, nisan gibi dank edince kafaya buralar şenlenir.
  entry_channels: ekonomi
---
