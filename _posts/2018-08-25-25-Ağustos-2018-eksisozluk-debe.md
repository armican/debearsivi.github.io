...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    kürtsüz ve arapsız bir türkiye
  entry_id:  80599747
  entry_writer: enyakisikliyazar
  entry_fav_count: 38
  entry_content: |
    <a class="b" href="/?q=yozgat">yozgat</a>
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    kurbanlık danaya saldıran pitbull
  entry_id:  80586262
  entry_writer: webyusuf
  entry_fav_count: 22
  entry_content: |
    sahipleriyle birlikte karantinaya alınması gereken katil ruhlu bir laboratuvar imalatı köpeğin zavallı bir hayvana saldırdığı olay...
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=%c5%9fimdi+bu+yukar%c4%b1daki+usta+%c5%9fof%c3%b6r+he+mi%3f">şimdi bu yukarıdaki usta şoför he mi?</a>)
