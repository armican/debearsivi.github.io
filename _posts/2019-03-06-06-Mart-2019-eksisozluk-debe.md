...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    chp ve lord voldemort iş birliği
  entry_id:  87391521
  entry_writer: sallamakahve
  entry_fav_count: 202
  entry_content: |
    açık şekilde ingiltere'de ilan edilen yeni chp ve ingiltere işbirliği.<br/>ünlü ingiliz iş adamı lord voldemort uzun süren görüşmeler sonrasında chp ile ittifak kurma konusunda uzlaşmaya varıldığını ilan etti. <br/>gringotts bankasının finanse edeceği bu işbirliğine onay veren yetkili ingiliz birimin başında ingiliz kadın bakan dolores umbridge ismi bulunuyor.
  entry_channels: siyaset,haber
- entry_name: |
  ...
  entry_fav_count: 190
  entry_content: |
    "kılıçdaroğluna açtığım bütün davaları kazanıyorum" diyordu. neden acaba?
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 156
  entry_content: |
    kızı değil, çocuğu avlamaya çalışmış. taş çatlasa 12-13 yaşlarında bir kız çocuğu var videoda.<br/><br/>utanın azıcık ya.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 51
  entry_content: |
    motordan ses geliyor ama kaynağını bulamıyorum. yolda bırakır diye uzun yola da çıkmıyorum. kısa mesafe yapıyorum sadece
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    türk kadınının sürekli yorgun ve ağrılı olması
  entry_id:  87374280
  entry_writer: you know i am no good
  entry_fav_count: 48
  entry_content: |
    (bkz: <a class="b" href="/?q=d+vitamini+eksikli%c4%9fi">d vitamini eksikliği</a>)
...
- entry_name: |
  ...
  entry_fav_count: 26
  entry_content: |
    örf adet bana göre değil bebeyim,ben düğün müğün sevmem, sade nikah yeter. abartıya gerek yok. <br/><br/>———<br/><br/>kız istendi. <br/>gondollu çikolatalar geldi. <br/>tatlısı yendi. <br/>bohçalar açıldı. <br/>çeyizler serildi. <br/>kınalar yakıldı. <br/>göbekler atıldı. <br/>saçlar leylek yuvası yapıldı. <br/>bir otoğı kurulacak genişlikte gelinlik giyildi. <br/>araba süslendi. <br/>davullu zurnalı gelin alındı. <br/>baldıza açılmayan amerikan panel kapısı için bahşişler verildi. <br/>salona gelindi. <br/>veee yemekli düğün yapıldı.
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 25
  entry_content: |
    beni de ekleyin bu listeye. allah o ahaber'in belasını versin; ülkeyi gılışdar yönetiyor sanıyor babam. :(
...
- entry_name: |
  ...
  entry_fav_count: 24
  entry_content: |
    doların tavan yaptığı dönemde thy'nin zarar etme şansı yok.<br/><br/>çalışanlar türk lirası alıyor, en büyük gider personel maaşları iken en büyük gelirler de istanbul aktarmalı yurt dışı uçuşları.<br/><br/>dünyanın en çok noktasına thy keyfinden uçmuyor, 2 bin lira asgari ücretli türk halkı için de uçmuyor, hanginiz güney amerikaya, japonyaya gidiyorsunuz ki?<br/><br/>konumu nedeniyle sefer koyamayan çoğu avrupalı firmalar star alliance kapsamında istanbul'a gönderiyor yolcuları dolayısıyla buradan gidiyorlar. eskiden 2000 dolar olan japonya bileti 5-6 bin tl bırakırken şuan 10-11 bin tl bırakıyor. hangi salak zarar ettiğini söyledi de siz hangi iq ile buna inanabildiniz anlamıyorum.<br/><br/>izmir-ankara uçuşları fasa fiso, maksat işiniz görülsün seferleri yurt içi uçuşları. olay aktarmalı yurt dışılar ve gelen para döviz.
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    üst komşunun ayak sesleri.<br/>at gibi yürümesi.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    insanlara gemi yaptırmanın yolu onlara marangozluk öğretip görev vermek değil, engin denizlerin özlemini aşılamaktır. <br/><br/>saint exupery
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    2 kez yaptığım eylem, her ikisinde de edindiğim tecrübe şu; bitti kelimesinin altında aslında “benim peşimden koş, biraz köpeğim ol sonrasına bakarız” düşüncesi olduğunu anladım. çünkü her iki olayda da birkaç gün içerisinde “bu kadar kolay vazgeçeceğini bilmiyordum” vb cevaplar aldım. hemcinslerim hataya düşmeyin, bitti dediyse bye deyin.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    (bkz: <a class="b" href="/?q=%23t%c3%bcmpitbullaryokedilsin">#tümpitbullaryokedilsin</a>)
  entry_channels: bilim
- entry_name: |
    sesi yaşam sevincini arttıran şeyler
  entry_id:  87394156
  entry_writer: amofobik
  entry_fav_count: 8
  entry_content: |
    eve ilk girdiğiniz anda kedilerinizin çıkarttığı o karşılama sesleri var ya :) heh o işte...
  entry_channels: anket,sağlık
- entry_name: |
    çağlar cilara'nın tv5'den ayrılması
  entry_id:  87392267
  entry_writer: do you really want to know
  entry_fav_count: 7
  entry_content: |
    tv 5 ne amk'cılarla çağlar cilara kim amk'cılara yanıtım :<br/><br/>tv5 saadet partisine ait bir haber kanaldır. cnn türk ve ntv gibi kanallar nevşin mengü , şirin payzın gibi gazetecileri işten çıkartıp televizyona bile çıkartmazken onları ekranlara getiren bir kaç kanaldan biridir. ahu özyurt halen bu kanalda çalışmaktadır.<br/><br/>çağlar cilara ise değerli bir televizyoncudur. krt'de program yapmıştır . krt'de aynı tv5 gibi cnn türk ve ntv gibi yandaş kanalların çıkartmadığı değerli gazetecileri ekrana çıkartan tarafsız bir kanaldır. çağlar cilara krt'den sonra halk tv'ye ardından da tv5 'e geçmiştir. <br/><br/>edit: çağlar cilara son 5 ay içinde krt'den halk tv 'ye ordan tv5'e geçmiştir burdan da ayrıldığına göre tele1'dedir sıra. diğerlerinden neden ayrıldı bilmiyorum ama muhalif kanallar bunlar, çağlar ile tv5 arasında anlaşmazlık da olsa izlenebilir haber kanallarıdır.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    kendi kendinden hoşnut olmayan insanlardır.
  entry_channels: anket,ilişkiler
- entry_name: |
    kyle kuzma
  entry_id:  87387238
  ...
  entry_fav_count: 3
  entry_content: |
    kral çıplak demiş ve gerekeni yapmıştır.<br/><br/>lebron başlığındaki<sup class="ab"><a title="(bkz: #87166522)" href="/entry/87166522" data-query="#87166522">*</a></sup> "34 yaşındaki lebron yerine bi zahmet o gençler yapacak savunmayı" diyen vatandaşa en güzel cevabı vermiştir.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    (bkz: <a class="b" href="/?q=bence+%c3%b6ssggee+hakl%c4%b1">bence össggee haklı</a>)
  entry_channels: anket,ilişkiler
- entry_name: |
    geceye bir şarkı bırak
  entry_id:  87375562
  entry_writer: zagar77
  entry_fav_count: 2
  entry_content: |
    sok framede troll barış manço için elle tutulur bir eseri yok deyince aklıma geldi.<br/><a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/C2Kl8OaNHyE">https://youtu.be/c2kl8oanhye</a>
  entry_channels: anket,müzik
- entry_name: |
    5 mart 2019 ekrem imamoğlu ntv canlı yayını
  entry_id:  87402155
  entry_writer: rabbim kolla bizi
  entry_fav_count: 1
  entry_content: |
    muhtemelen sadece imamoğlu'na oy verecek olan seçmenler tarafından izlenecek yayındır.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    1- prison break <br/>2- battle star galactica<br/>3- spartacus <br/>4 - westworld<br/>5- person of interest
  entry_channels: anket,tv,sanat,sinema,spoiler
- entry_name: |
    sözlükçülerin en iyi futbol 11'i
  entry_id:  87404395
  entry_writer: falconhoof
  entry_fav_count: 0
  entry_content: |
    ----------------------------kahn-------------------------------<br/><br/>-----cafu------------------stam-------------r.carlos-----------<br/><br/>----------------------------vieira---------------------------------<br/><br/>------keane--------------------------------ronaldinho---------<br/><br/>------messi--------------zidane---------------apaçi-------<br/><br/>-----------------------------vieri----------------------------------
