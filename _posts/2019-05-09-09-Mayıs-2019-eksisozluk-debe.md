...
- entry_name: |
  ...
  entry_channels: spor,haber
- entry_name: |
    dallama altan'ı ekrem imamoğlu ile bir tutmak
  entry_id:  89851166
  entry_writer: ergenlige girememis pikachu
  entry_fav_count: 16
  entry_content: |
    sozluk sozluk olali boyle duyar gormedi.
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
      (nokta)..çünkü tam kanunsuzluktan yenileme kararı aldırmak işinize gelmedi; ilçe belediye ve belediye meclis seçimleri yenilenmesin diye ysk'ya olağanüstü itirazdan karar alırdınız. çünkü derdiniz kanun, kural, seçmen iradesi değil şark kurnazlığı. çünkü kahir ekseriniz sadece bu ülkede bu iktidar varken ciddiye alınabilecek, makam mevki sahibi olabilecek liyakatsiz kişilersiniz. çünkü haksız kazanımlarınızı kaybetmekten ve yaptığınız haksızlıkların, hukuksuzlukların hesabını vermekten ölümüne korkuyorsunuz. çünkü bahçeli'lye el ele koalisyonlar bitecek vaadiyle kirli bir referandumla getirdiğiniz tuhaf sistem sizi koalisyona mahkum etti. çünkü sistemi kilitlemek tehdidiyle aylardır sizi kukla gibi oynatan koalisyon ortağınız seçimin tekrarını istedi.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    stoya dediyse, cidden her şey çok güzel olabilir... çünkü ben bir filmde gördüm, dediğini yapıyordu. <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
  entry_channels: 
- entry_name: |
...
- entry_name: |
    imamoğlu milletin verisini çaldı
  entry_id:  89849255
  entry_writer: oddiedud
  entry_fav_count: 2
  entry_content: |
    veriyi korurken geriyi kaybeden bir adet a.k. partili içeren beyan. <br/><br/>o verilerden kaç ton kadayıf çıkacak hep beraber göreceğiz.
  entry_channels: 
- entry_name: |
    bülent yıldırım'ın hakemlikten atılması
  entry_id:  89852425
  entry_writer: mazut
  entry_fav_count: 1
  entry_content: |
    bülent ersoy'u engelleyeceğim aklıma gelmezdi ya bugün bu da oldu.
  entry_channels: 
- entry_name: |
    sıfır bir
  entry_id:  89851284
  ...
  entry_fav_count: 0
  entry_content: |
    turkish gomorrah. bu sezonda adamlar seviyeyi arşa çıkartmış, tebrikler.
