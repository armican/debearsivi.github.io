...
- entry_name: |
  ...
  entry_id:  89851047
  entry_writer: kardesce ve ozgurce yasamak
  entry_fav_count: 27
  entry_content: |
    düşünsenize istanbul'u binali yönetecekti bir de allah korusun.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
    istanbul'un ilk gay belediye başkanı
  entry_id:  89850499
  entry_writer: fosforik asit
  entry_fav_count: 24
  entry_content: |
    başlık sahibinin chp'den aday olması durumunda gerçekleşecek hadise.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: spor,haber
- entry_name: |
    kur yükseldikçe halk erdoğan'a daha çok bağlanıyor
  entry_id:  89847811
  entry_writer: stuzun
  entry_fav_count: 11
  entry_content: |
    sen öyle san ak-trol..<br/>o güruh ilkesizdir...para için sülalesini satar
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    silivri'deki fark 2000. 13000'e etki eden oraya etmiyor mu? çatalca'da 3000.
  entry_channels: 
- entry_name: |
    şu an okunan kitap
  entry_id:  89842950
...
- entry_name: |
    sıfır bir
  entry_id:  89848823
  entry_writer: tengrimizmenen61
  entry_fav_count: 2
  entry_content: |
    --- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>o nasıl bi finaldi be abi..<br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---
