...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    kendisine ayip edilen futbolcu. bence sabredilirse, mac sonuna kadar 3 kere topla bulusabilir
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    çocukken babam sayesinde gitmiştim. yaklaşık bir sene kadar kaldım. en son cuma namazında kot pantolon giydiğim yüzünden tokat yemiştim. hoca beni uyardı fakat namazdan sonra izin vardı ve evlere gidiliyordu, bende değiştirmedim daha sonra bana odasına inmemi söyledi. namaz bitti falan, bu geldi bir sürü laf bir de üstüne tokat attı. ben de bunu aileme söyleyince oradan almışlardı beni. bu pezevenkler acayip bir tarikat. namaz kılarken, ellerini açtıktan sonra böyle boyunlarını hafif sola doğru kalbe doğru büküp şey derlerdi işte oraya daha yakın oluyor, kalbe akıyor falan gibi acayip bi triplere giriyorlardı. süleymancı yurduna gidip millete istavroz çıkartan tek manyak ben vardım sanırım. fena zamanlar değildi ama bu ibneler yüzünden daha çok soğuyorsunuz. şimdi aklıma geldikçe hala sinirlenirim, bu ve bunun gibi cemaate üye olan ne kadar insan varsa...
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    buna da çöp demek için ya kör yada art niyetli futbol cahili olmak gerekir.
  entry_channels: spor
- entry_name: |
    28 eylül 2019 tarım destekleri azaltılıyor
  entry_id:  95910087
  entry_writer: mordor buyuk sehir belediye encumeni
  entry_fav_count: 3
  entry_content: |
    siksinler siksinler analarını siksinler bizim çiftçilere müstahak.<br/><br/>peşin edit: 7 kuşaktır çiftçiyiz.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  95912789
  entry_writer: heronero23
  entry_fav_count: 2
  entry_content: |
    futbol bana eskisi kadar heyecan vermiyor. eskiden tüm derbileri bırak, takımımın tüm maçlarını izler, stadyuma gider, her sene forma vs. taraftar ürünleri alır, takımı savunur tartışırdım. şimdi ise komik ve gereksiz geliyor. ama bunun olgunlukla alakası olduğunu düşünmüyorum. farklı hobilere yönelme olabilir. bıkkınlık olabilir.
  entry_channels: spor
- entry_name: |
    şu anda çalan şarkı
  entry_id:  95886493
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    gayet beğendiğim oyuncudur.bitiricilik konusunda da kendisini geliştirirse ligin en iyi 8 numarasıdır.
  entry_channels: spor
- entry_name: |
    fatih terim
  entry_id:  95913746
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    derbi öncesi yayın yok. vereceğiniz hizmete sokayım sizin. uzak durun <br/>göt oğlanlarına mesaj atıyoruz mesai saati değil diye otomatik mesaj atıyor ulan sikik millet maç izlemeye alıyor bu boku bu amına soktuğumun maçları da akşam oluyor göt laleleri
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    akademik kitap okumuyorum, akademik kitabın ne olduğunu bile bilmiyorum. hafta içi vakit olursa gelinim mutfakta izliyorum, nat co vayldda aslanların gündelik yaşamını seyretmek en keyif aldığım olay. bir de günün ortasinda bira içmeye başlıyorum, bu da dünyada keyif aldığım nadir şeylerden biri, kimi zaman zoraki olarak on yaşındaki arkadaşımın kitaplarını okuyorum ve ödev özeti çıkarıyorum, bunu yaptığımı babası asla bilmeyecek, hafta sonları magazin izliyorum. sonra öğleye doğru uyuyorum, zaten genelde uyuyorum, yazar, filozof her ne boksa hepsine uyuz oluyorum, onların yazdıklarını okuyarak bir bok olduklarını düşünen dallamalara da... mütemadiyen okuduğu kitabı yazanlara, tavsiye verenlere sikik kitapları beğenenlere de ayar olmaktayım. keyif kelimesinden de tiksiniyorum. hele hele şu okuma yapma diyen birini duyduğumda küsküyle dalasim geliyor.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    babelin saç rengine kurban olanlar şimdi babele küfür ediyor hahahaha.
  entry_channels: spor
- entry_name: |
    luiz gustavo dias
  entry_id:  95913805
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    sana yine kazanacağım demişmiydim? :) yine ben kazandım, aşk kazandı... şükürler olsun!
