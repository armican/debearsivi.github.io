...
- entry_name: |
  ...
  entry_fav_count: 87
  entry_content: |
    çok seviyorum ben bu başlığı. aynı şekilde 2018 ekonomik krizi basligini da çok severdim. hey gidi hey.<br/><br/>yazıyorsunuz ya 40 işçi çıkarttık falan. eskiden olsa uzulurdum ama şu an zerre üzülmüyorum. aklıma hemen o 40 kişinin seçim sonrası "koyduk mu" paylaşımı yapan akpliler olduğu düşüncesi geliyor ve istemsizce svihs diyorum. <br/><br/>ben kötü duruma dussem eminim bana da kimse üzülmeyecek ve svihs diyecekler.<br/><br/>sadece kendime bakarım artık. kendim ve en yakınlarım. gerisi umrumda değil. <br/><br/>yardım etmiyorum kimseye. ben de ne var da ne yardımı yapacağım. akıl soran olursa da 'ben ne anlarım git akp il başkanlığına onlara söyle" diyorum. <br/><br/>bu seçimde bu krize rağmen akp'nin yine götüreceğini düşünüyorum. ha umrumda da değil.
...
- entry_name: |
  ...
  entry_fav_count: 51
  entry_content: |
    kadının korunmaya, erkeğin ise sahiplenmeye ihtiyacı olması.
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    hasta adamın vücuduna sperm enjekte etmesi
  entry_id:  85618943
  entry_writer: skumbag
  entry_fav_count: 46
  entry_content: |
    (bkz: <a class="b" href="/?q=hep+i%c3%a7ine+atan+insanlar">hep içine atan insanlar</a>)
...
- entry_name: |
  ...
  entry_fav_count: 44
  entry_content: |
    sarıldığında nefesini boynunda hissedeceğin, parmak uçlarına kalktığında dudaklarınızın birleşebileceği ve ellerinizi beline doladığınızda başını omzunuza rahatça koyabilecek boyu olması ideal sanırım.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    spor salonlarındaki antrenörlerin cahil olması
  entry_id:  85621398
  entry_writer: gebar
  entry_fav_count: 9
  entry_content: |
    hayattaki tek başarısı ağırlık kaldırmak olan kişilerde bulunan bir özelliktir.<br/>kulaktan dolma bilgileri bilimsel argüman zannederek kurbanlarını yanlış yönlendirirler. <br/>sorsan iki tane kitap okumamış, okul bitirmeye götü yememiştir. ondan sonra da 'ben kendimi geliştirdim, al bunlar da sertifikalarım' edebiyatı yaparlar. <br/><br/>'asla pes etme, bahanelerinden daha güçlü ol, hedefe giden yolda çekilen çile kutsaldır' gibi cümleleri hayat felsefesi yapmaları bu durumu destekler.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    belhandayı bu kadar savunmasını bir kenara bırakıyorum iyi bir yorumcu.
