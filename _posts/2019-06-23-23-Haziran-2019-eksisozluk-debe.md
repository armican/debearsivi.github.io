...
- entry_name: |
    chp'liyim demeden chp'li olduğunu anlat
  entry_id:  91558288
  entry_writer: nickbulamadimnolcak
  entry_fav_count: 122
  entry_content: |
    teröristbaşı ve kardeşi oy verdiğim partiyi sevmez.
...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    22 haziran 2019 benim açıklamalarım
  entry_id:  91574259
  entry_writer: boylenickolnazolsun
  entry_fav_count: 14
  entry_content: |
    yeter artık bıktık açıklamalarınızdan. bi salın şu memleketi dediğimdir.<br/><br/>sevgilimden bile herhangi bir şeyin açıklamasını istememeye yemin ettirdiniz.<br/><br/>(bkz: <a class="b" href="/?q=a%c3%a7%c4%b1klama">açıklama</a>)<br/><br/>edit: 20.12 ek açıklamam: alkollü içecek satışı yalnızca istanbul'u mu bağlayacaktır. yoksa bira stoku yapılmalı mıdır? sorusuyla boğuşmaktayım. açıklama yapayım derken birasız kalma riskim yüksektir.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    orospu çocuğu vatan haini kara propagandacı köpekler!<br/><br/>ben hayatımda bu kadar şerefsiz bir kitle görmedim. 10 parmaklarında 10 kara her yeri kirletiyorlar. yazıklar olsun! sizin olmayan vicdanınızı, para için kendini satan karakterinizi sikeyim!
  entry_channels: siyaset
- entry_name: |
    2019 fransa gp
  entry_id:  91570666
  entry_writer: golfkilo
  entry_fav_count: 3
  entry_content: |
    yarın yarış yine kabak tadı verecek sıralama turlarından anlaşıldığı üzere. 3. olmak için red bull ve ferrari kapışacak .
  entry_channels: spor
- entry_name: |
    şu an okunan kitap
  entry_id:  91570921
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    allah rahmet eylesin, çok değerli insandı.
