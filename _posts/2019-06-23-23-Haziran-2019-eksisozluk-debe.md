...
- entry_name: |
  ...
  entry_fav_count: 110
  entry_content: |
    (bkz: <a class="b" href="/?q=%c3%a7ad%c4%b1r+i%c3%a7inde+%c3%a7ad%c4%b1r+kurmak">çadır içinde çadır kurmak</a>) <br/>(bkz: <a class="b" href="/?q=%c3%a7ad%c4%b1rception">çadırception</a>)
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bu kabataş v2 'nin olmaması daha faydalı, bunu gören ülkede muhalefet yayın var sanıyor.muhalefeti temsil eder gibi görünen araçlar<br/><br/>edit : üzerine çok kıymetli anlamlar yükleyenler varmış..chp den iyi muhalefet..tek sesimiz bu falan.. muhalefet olarak işimiz buna kaldıysa zaten vah halimize..aksine biz bu truvalara rağmen kazanacağız
  entry_channels: siyaset,tv,haber
- entry_name: |
