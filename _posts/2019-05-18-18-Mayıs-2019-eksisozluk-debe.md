...
- entry_name: |
    mario balotelli
  entry_id:  90178208
  entry_writer: doktorcumm
  entry_fav_count: 125
  entry_content: |
    kendi takımıma gelmesini istemeyeceğim, rakibime gidince üzüleceğim bir futbolcudur. <br/>aynen bu tanıma uyar balotelli. sürpriz yumurta gibi hangi takımda ne vereceği belli değildir.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    chp ile ne alakasi oldugunu anlamadigim olaydir.<br/><br/>hadi chp’yi gectim, sirf bu yuzden “yaziklar olsun imamoglu” demek ne demek?! sahsen ben de chp’nin katilmamasi taraftariyim ama kicimizda ayi bagirirken pire icin yorgan yakacak kadar secici degilim malesef!
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    aziz yıldırım'dan daha büyük bir loser olma yolunda ilerleyen fantastique başkan.
...
- entry_name: |
  ...
  entry_id:  90205337
  entry_writer: impossible girl
  entry_fav_count: 0
  entry_content: |
    geçmiş olsun inşaah beklediği ilacı bulur.
  entry_channels: sağlık
---
