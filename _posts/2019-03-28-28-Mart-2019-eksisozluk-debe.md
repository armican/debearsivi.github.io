...
- entry_name: |
  ...
  entry_channels: ekonomi
- entry_name: |
    lahmacunun abartılmış balon bir yemek olması
  entry_id:  88199906
...
- entry_name: |
  ...
  entry_fav_count: 36
  entry_content: |
    bu değerli kızı elinizde tutmak için yapmanız gerekendir. ancak güven bunalımı olursa, kız elindeki diğer varlıklarınızı satar uyarmış olayım.<br/><br/>uzun vadeli çözüm değildir, kısa vadede yapın.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    haftalık 140 tl <a rel="nofollow noopener" class="url" target="_blank" href="https://twitter.com/kacsaatolduson/status/1108282729215463424?s=21" title="https://twitter.com/kacsaatolduson/status/1108282729215463424?s=21">link</a>
  entry_channels: 
- entry_name: |
