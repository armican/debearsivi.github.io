...
- entry_name: |
  ...
  entry_fav_count: 41
  entry_content: |
    10 sene evvel ordudan ihraç etmeye çalıştığı kişiler 15 temmuz gecesi yurt genelinde terör estirirken kendisine o ihraçlarda karşı çıkan şahıs facetime'dan "meydanlara çıkın" dediğinde ne düşündüğünü ne hissettiğini çok ama çok merak ettiğim cumhurbaşkanım.<br/><br/>büyük devlet adamı olmak ileriyi görmektir, icabında kendi siyasi kariyerini bile tehlikeye atmaktır. büyük adamsın sen ahmet necdet sezer...
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  67196881
  entry_writer: hacim nasil oluyor yav
  entry_fav_count: 9
  entry_content: |
    hiç normal görünmeyen reklam. reklamda kullanılan slogan ve ses açıkçası ürkütücü. ağlayan bebek temalı reklamı anımsatıyor.
- entry_name: |
    büşra erdal
  entry_id:  67190014
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    türkiye'nin en hızlı taraf değiştiren kulübü. dün fetöcüydü, bugün akape zihniyetine dönm-- pardon az önce altyazı geçti şu anda fransız ve pekakalı olmuş. yarının tahminlerinde parçalı ışidli bir hava gözüküyor.
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    yeniden sesi kısılan ve miting iptal eden devletlümüz.<br/><br/>bi 5 10 gün rahatız anlayacağınız.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    mallıkta sınır tanımama hataları gelmeye başladı. her zamanki gibi yarak kürek sayı atan real öne geçti. şu reale yenilmek kadar saçma bişey yok.aslında fenerin her türlü sikebileceği bir takım real.<br/><br/>udoh oynamıyor, üçlükler antiçe kalmış, <a class="b" href="/?q=nunnaly">nunnaly</a> her zamanki gibi <a class="b" href="/?q=ne+diye+bu+tak%c4%b1mda">ne diye bu takımda</a> bilen yok, bi iki üçlük at lan amk...obradovicin kariyerinin en büyük hatası feneri f4'den edecek...yok yok yok...bu maç giderse cska siker atar kimse kusura bakmasın...istemem ama tam şampiyon türkiye'den çıkacak derken hüsran yılı olacak gibi...ülkeden sade efes f4'e kalırsa şaşırmam...<br/><br/>(bkz: <a class="b" href="/?q=obradovic%27in+nunnaly+transferi+hatas%c4%b1">obradovic'in nunnaly transferi hatası</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    <a class="b" href="/?q=doland%c4%b1r%c4%b1c%c4%b1">dolandırıcı</a> bir firma. <br/><br/>satıcısı ''<a class="b" href="/?q=hepsiburada">hepsiburada</a>'' ise çok dikkat edin. saat 17.00 'a kadar sipariş verirseniz ''aynı gün kargo'' gibi bir yalanı mevcut. günlerce bekleyebilir, saatlerce telefonu düşürmeye çalışabilir ve ulaştığınızda da ''kredi kartı güvenliğiniz açısından'' diye klişe bir yalana maruz kalabilirsiniz.<br/><br/>yine satıcısı ''hepsiburada' olan ilanlarda, ''bu kampanyanın bitimine 03 saat, 27 dakika, 35 saniye kaldı'' gibi bir sayaç ve geri sayım söz konusu.. ama nedense aynı üründe aynı fiyatla hergün bu manipülasyon mevcut.<br/><br/>tüketiciye ''hileli ve yalan bilgilerle'' satış yapan bu sitelerden uzak durmanızı tecrübelerime istinaden tavsiye ederim.<br/><br/>tck'da '' ..dolandırıcılık suçu, bir tüzel kişinin yararına işlendiğinde, kanun, 169. maddede, tüzel kişi hakkında güvenlik tedbiri uygulanmasını öngörmüştür. ancak bu hükmün, tüzel kişi hakkında uygulanabilmesi için; tüzel kişinin iradesini oluşturan organlarının, failin ''hileli davranışlarıyla bir kimseyi aldattığını'' , dolayısıyla tüzel kişiye bir yarar sağladığını bilmesi ve istemesi gerekir..'' demektedir. <br/><br/>bugün ''hukuk devleti''nde yaşıyor olsaydık ilk işim, gerekli adli merciler ile ilgili bakanlıklara suç duyurusunda bulunmak olurdu..
- entry_name: |
...
- entry_name: |
    31 mart 2017 internetin yavaşlaması
  entry_id:  67182890
  entry_writer: alea iacta est 2
  entry_fav_count: 1
  entry_content: |
    hadi evde adil kullanım kotası var metro ethernette de mi var bu kota?<br/>an itibariyle sosyal medya ve haber sitelerinde yine ne olmuş diye gezdiren sorun.
- entry_name: |
    şu anda çalan şarkı
  entry_id:  67182169
  entry_writer: naklen
  entry_fav_count: 0
  entry_content: |
    "bende bir resmin var yüzüme bakmıyor" emre aydın
- entry_name: |
    fi
  entry_id:  67197230
  ...
  entry_fav_count: 0
  entry_content: |
    can karakterinin psikolog mu yoksa psikiyatrist mi olduğunu anlayamadığım dizi. sanırım senaristler farkı bilmiyor.
- entry_name: |
    ekşi sözlük iş ağı
  entry_id:  67190686
  entry_writer: megrimegri
  entry_fav_count: 0
  entry_content: |
    eğer ofisiniz falan varsa çaycılık bile yapabilirim. aci işe ihtiyacım var. normalde bu kadar uzun süre işsiz kalmazdım. her yere başvuru yaptım ama hiç donuş alamadım. teşekkür ederim şimdiden. yeşillendiriniz.
---
