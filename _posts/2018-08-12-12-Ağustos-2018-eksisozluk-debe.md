...
- entry_name: |
    italyan escort sitesindeki aşık olduğum melek kız
  entry_id:  80159950
  entry_writer: fatalite
  entry_fav_count: 145
  entry_content: |
    açtığın başlığı ayrı,zevkini ayrı sikeyim dediğim kişinin aşık olduğu eskort kız.
...
- entry_name: |
  ...
  entry_id:  80158224
  entry_writer: proleter jakoben
  entry_fav_count: 37
  entry_content: |
    (bkz: <a class="b" href="/?q=yaran+ba%c5%9fl%c4%b1klar">yaran başlıklar</a>)<br/>muazzam sanat kariyerinin nihayetinde geldiği noktada saray soytarısı olmayı tercih etmiş pos bıyıklı amcanın veryansınıdır.
...
- entry_name: |
  ...
  entry_fav_count: 36
  entry_content: |
    yapılabilecek en mantıklı şey hayati olmayan harcamaların sınırlandırılması.<br/><br/>* ötv'li ürünlerden uzak durun, mümkünse kendiniz yapın (bkz: <a class="b" href="/?q=evde+bira+yap%c4%b1m%c4%b1">evde bira yapımı</a>)<br/>* kahve, çay gibi harcamaları yapmayın<br/>* dışarıdan yemek söylemeyin<br/>* kıyafet/mobilya gibi harcamaları erteleyin<br/>* henüz girişmediyseniz düğün dernek gibi harcamaları erteleyin<br/>* elinizde bağ/bahçe gibi büyük küçük bir toprak varsa değerlendirin. önceki krizlerden farklı olarak tarım konusunda da aşırı dışa bağımlı olduğumuzu unutmayın<br/>* e-ticaret şirketlerinden ürün almaktan sakının. bu şirketler sizden tl cinsinde o anın dolar kuruna göre sipariş alıp o siparişlere göre yurt dışından toplu ürün söyler. siz 6.5 usd/try kurundan 1000 dolarlık ürün aldığınızda adama 6500 verirsiniz ama kur bu arada 8'e çıkarsa adam 900 dolar verip de ürünü getirtemez<br/>* var olan paranızı çalkantılı olmayan bir döviz kokteylinde tutun. bütün türk lirası mevduatımı dolar, euro ve altına transfer ettim. tl cinsinden kazançlarınızı bu üçü arasında en az artmış olana koyun<br/>* bankalarda büyük paralar tutmayın. mevduatlara en konulmasını ya da mevcut bankaların batmasını beklemem ama günlük para çekim sınırları sertleştirilebilir<br/>* dolara olan müdaheleleri dikkatli takip edin. şu anda piyasa dolara yapılacak yapısal olmayan her müdaheleyi alım fırsatı olarak değerlendirecektir.<br/>* kimseye borç vermeyin<br/><br/>burada yazılanlar boykot çağrısı da yatırım tavsiyesi de değildir. 16 yıldır devletin her kurumunu ele geçirmiş, halktan istediği her yetkiyi almış iktidarın "ekonomik savaş" yalanlarıyla mağdur ettiği vatandaşların bireysel olarak hayatta kalmaları için tavsiyelerdir.<br/><br/>şunu da ekleyeyim, şu anda yazar kasa atılmıyorsa bunun en büyük sebebi orta sınfın henüz harcama yapmayı kesmemesidir. çok esnaf yakında siftahsız gün kapatacaktır.
  entry_channels: ekonomi
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    amerikan gemisindekilerin milyar dolarları var isviçre bankalarında. şimdi servetlerinin bir kısmı ve iktidarları ellerinden gidebileceği için zamanında bunlar bunlar diye höykürdüklerine aynı gemideyiz diyorlar. gemi batar, amerikan gemisinden amerikaya atar yapanlar gemiciklere biner giderler. olan geminin 3. mevkisindekilere olur.
  entry_channels: siyaset
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    ali koç başkan olmasa galatasaray'a küfürlü tezahürat yapabilir. bunun başkan olduktan sonra tribünlere verdiği küfürsüz tezahürat mesajıyla çelişen bir tarafı yoktur. zira bu ali koç'tan gelen şahsi bir mesaj değildir. fenerbahçe başkanının mesajdır.
  entry_channels: spor
- entry_name: |
    ekşi sözlük iş ağı
  entry_id:  80137160
...
- entry_name: |
  ...
  entry_id:  80136645
  entry_writer: aeternal
  entry_fav_count: 1
  entry_content: |
    yeteri kadar sevmiyormuş demek ki puff.s denilerek yapılan naz justify edilecektir. şaşmaz. zira kadın egosu her zaman haklıdır.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    orada <a class="b" href="/?q=mutlu">mutlu</a> olan var mı?<br/>bir tane süper diyen duymadım daha. <br/>üzülüyorum cidden.
  entry_channels: anket,ilişkiler
- entry_name: |
    11 ağustos 2018 gökyüzünde görülen cisim
  entry_id:  80160767
  entry_writer: hayrunissan
  entry_fav_count: 1
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://i.hizliresim.com/lZNz7l.jpg">https://i.hizliresim.com/lznz7l.jpg</a>
  entry_channels: 
- entry_name: |
    ilk alınan kaset
  entry_id:  80145090
