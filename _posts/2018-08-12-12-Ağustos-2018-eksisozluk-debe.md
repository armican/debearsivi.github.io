...
- entry_name: |
  ...
  entry_fav_count: 34
  entry_content: |
    ülkemiz çomarları tarafından "dünya lideri" olarak görülen hayal dünyasında ki bir ademoğludur kendisi.<br/><br/>darbe girişimi olur halkı sokağa, direnmeye davet eder, dolar ebesinin amı olur, ekonomik kriz kapıya dayanır bu defa da dolarlarınızı bozdurun çağrısı yapar. e sormazlar mı adama sen ne ayaksın la diye. devletin en tepesinde otur ama her seferinde halka topu at. ne güzel iş amk.
...
- entry_name: |
  ...
  entry_channels: haber
- entry_name: |
    sert insanların sözünün her yerde geçmesi
  entry_id:  80155473
  entry_writer: mkrit
  entry_fav_count: 10
  entry_content: |
    sorunlarınızı saygılı olup kibar kibar konuşarak çözemeyeceğinizi çok güzel bir şekilde öğretiyor canım ülkem
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    hakkı falan değildir amk. normal insan içki içebilir cübbeli ahmet hoca içemez bu kadar basit konu. sen işid militanı gibi gezersen faiz alamazsın.
...
- entry_name: |
  ...
  entry_id:  80138195
  entry_writer: sokratesin karisi
  entry_fav_count: 1
  entry_content: |
    istesem de katılamayacağım kampanyadır.<br/><br/>üniversite derecem, iki dilim, tasarım bilgilerim ve ben senelerdir maaşsız çalışıyoruz. <br/><br/>ülkende barındırmadığın idealiste el açmayacaksın devletçim, parayı yedirdiklerine haraç keseceksin. tam zamanı çünkü.
