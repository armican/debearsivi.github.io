...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    hayvanların özellikle sevilen yanları
  entry_id:  80147191
  entry_writer: damladamlazaman
  entry_fav_count: 14
  entry_content: |
    atlar sevdiği kişiyi özler, onunla konuşur. <br/><br/>gözlemlediğim, yavrusunu özlediğinde ve ona kavuştuğunda yaptığı şeylerin aynısını yapıyor insana da. hafif mırıldanır gibi sesler çıkarır, kaşlarını düşürür gözbebekleri büyür ve gözleri nemlenir. başını uzatır dokunmak ister.
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    sun tzu'nun, "let your plan be dark and impenetrable as night, and when you move, fall like a thunderbolt" <br/>diyerek referans noktasi oluşturduğu, çok doğru ve mantıklı bir hamledir.
  entry_channels: ilişkiler
- entry_name: |
    amerika'da ki über taksici kavgası
  entry_id:  80149317
  entry_writer: mutlu tuccar
  entry_fav_count: 13
  entry_content: |
    (bkz: <a class="b" href="/?q=taksicinin+her+yerde+taksici+olmas%c4%b1">taksicinin her yerde taksici olması</a>)<br/><br/>(bkz: <a class="b" href="/?q=k%c3%bcresel+taksici">küresel taksici</a>)<br/><br/>(bkz: <a class="b" href="/?q=der+ewige+taksici">der ewige taksici</a>)
  entry_channels: haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    dolarla yaptırdığı botokslar yüzünden suratı bazlamaya dönmüş heyecanlı bir kanal 7 kadın programı kadrolu ağlayıcısının isyanıdır.
  entry_channels: siyaset,tv,haber
- entry_name: |
    11 ağustos 2018 mudanya yangını
  entry_id:  80150728
  entry_writer: imkansizsever
  entry_fav_count: 5
  entry_content: |
    mudanya belediye başkanı hayri türkyılmaz'ın,rant için kasten çıkarıldığından şüphe duyduğunu açıkladığı yangın."yanan bölgenin imara açılmasına izin vermeyeceğiz,tekrar ağaçlandıracağız" diye eklemiştir.kimse heveslenmesin yani!
  entry_channels: haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    bunu sorgulayan net gizli eşcinseldir ve o kişinin şeyini de görmek istiyordur. yoksa sanane ki?<br/><br/>ben ise sıkışmışsam ve kabin doluysa kullanırım. <br/><br/>yanında başka adamlarla birlikte işemeyi sevenlere önerim şu başlığa bir göz atın ve kurallara uymaya çalışın<br/>(bkz: <a class="b" href="/?q=pisuvar+adab%c4%b1">pisuvar adabı</a>)
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    agzı durmayan, durmadan espri patlattıgını sanan gıcık bir ergen olarak yaptıklarım icin ,seneler sonra ozur dilemek istedigim kiz.<br/>ne bilelim iste biz de siz dusermisiniz diye oyle mal mal konusuyorduk. oyle dusmuyormus. sizi de rahatsız ettigimizle kaldık.<br/>bu an lise yıllarındaki anılarda bazen gozume gelir.kızlar onlerde dersi dinliyordur.arkada konusma sesleri. ufak tefek sesler. sonra arkadan dev bir kahkaha dalgası. sonra kızlar topluca doner.caresizce bakar. erkekler kıpkırmızı gulmekten.
  entry_channels: eğitim
- entry_name: |
    fabricio agosto ramirez
  entry_id:  80154258
  entry_writer: varsovali
  entry_fav_count: 0
  entry_content: |
    an itibariyle pl kariyerindeki ilk golünü yemiş canımız eski kalecimiz.
  entry_channels: spor
- entry_name: |
