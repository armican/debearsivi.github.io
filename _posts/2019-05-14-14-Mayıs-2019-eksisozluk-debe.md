...
- entry_name: |
  ...
  entry_fav_count: 32
  entry_content: |
    kaç yaşına gelmişsin, ülkedeki çoğu makam koltuğuna oturmuşsun, paran pulun var neden göz göre göre torunların büyüdüğünde utanacakları miras bırakıyorsun ki ?<br/><br/>okuduğunu kendin anlamıyorsun, dediklerinin yalan olduğunu biliyorsun, yalan söylüyorsun aleni. peki bu işin yarını var bunu da mı düşünmüyorsun ?<br/><br/>şu yayını izleyip bu adama oy veren insana da çok yazık gerçekten.
  entry_channels: siyaset,tv,haber
- entry_name: |
    sigara içenlerin aldatma ihtimali
  entry_id:  90048833
  entry_writer: immortal112
  entry_fav_count: 18
  entry_content: |
    hayatımda okuduğum en saçma hede.
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    buz gibi goldür. derin futbol yine iş başında.<br/><br/>not: izlemedim. tinerci taklidi yapıyorum.
...
- entry_name: |
    turgay demir'in a spordan kovulması
  entry_id:  90052357
  entry_writer: tasigardi
  entry_fav_count: 11
  entry_content: |
    tanim: bir pezevengin hak ettigini bulmasidir.<br/>pardon siri pezevenk yazmis kavas olucakti.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    buranın hasta insan kaynadığını düşünüyorum artık. kimseyi favlamamaya ve de takip etmemeye karar verdim. insanların egolarını şişirmek için değil, iki sevdiğim kelamı ya da bir şarkıyı paylaşayım diye varım sadece. <br/>işbu sebeple takip eden varsa silebilirler beni takip listesinden. güzel kalın..
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    youtube'taki, reddit'teki lakapları <a class="b" href="/?q=dumb+and+dumber">dumb and dumber</a> olan ikili.<br/><br/>(bkz: <a class="b" href="/?q=salak+ile+avanak">salak ile avanak</a>)
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    (bkz: <a class="b" href="/?q=kat%c4%b1">katı</a>)<br/>(bkz: <a class="b" href="/?q=rafadan">rafadan</a>)<br/>(bkz: <a class="b" href="/?q=c%c4%b1v%c4%b1k">cıvık</a>)<br/><br/>hanıııımm hanııım bunlar benim yavrularım.
  entry_channels: anket,tv,tarih
- entry_name: |
    hayal ettiğin ülkeyi tarif et
  entry_id:  90052028
  entry_writer: johnnytog
  entry_fav_count: 2
  entry_content: |
    tarife gerek yok goççum; made in usa.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    sözlük sol frame'in mütemadiyen çöpe çevrilmesi.<br/>spoiler başlıklar ve buna cevap veren timler.<br/><br/><a class="b" href="/?q=lord+of+the+rings">lord of the rings</a>'in çakması olan bir dizi niye izlenir ki ?
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    ortak proje yapmak için bir ürologla buluşmuştuk, bir ara. adamın akademik ilgi alanı da "erken boşalma"ymış (prematüre ejekülasyon tarzı bir adı var.). adam peniste boşalmayı sağlayan kasların makata yakın olduğunu söylüyordu. eğer elektriksel stimülasyonla bu sinirleri felç edebilirsek erken boşalma sorunu çözeriz demişti. halkın anlayacağı şekilde şöyle anlatayım. adamın kıçına bir alet sokacağız. sonra elektrik verip kaslarını uyuşturacağız. zaten erken boşalma adam için yüz kızartıcı mesele bir de kıçına alet sokmasını söylersen o iş hayatta olmaz.<br/><br/>öylece de proje kalmıştı.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    üzerinden ne kadar hortumlandığı ortaya çıkınca anlaşılacaktır.
  entry_channels: 
- entry_name: |
    sergen yalçın
  entry_id:  90052987
  ...
  entry_fav_count: 0
  entry_content: |
    zamanında tv'de yorumculuk yaparken bir yorumundan dolayı bu tirübünler onu çok üzdü,sergen de ne kadar üzüldüğünü anlattı, şimdi tirübüne çağırsan ne olacak ki,efsanesine bile tepki gösteren tribünlerimizin seba'ya yaptigi ayıptan sonra ikinci ayıbıydı sergen'e yaptıkları.
  entry_channels: spor
- entry_name: |
    iyi insan olmak
  entry_id:  90051613
  ...
  entry_fav_count: 0
  entry_content: |
    bi sike yaramadığını az evvel yeniden tecrübe etttim.
  entry_channels: ilişkiler
- entry_name: |
