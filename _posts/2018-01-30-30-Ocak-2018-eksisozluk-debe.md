...
- entry_name: |
    insan gibi duş alan fare
  entry_id:  73839554
  entry_writer: ab i hayat vardi pipet yoktu
  entry_fav_count: 298
  entry_content: |
    sadece insan gibi olmakla yetinmiyor, günaha bulanmış bir liselinin pişmanlık dolu gusül abdestini alması gibi yıkanıyor.<br/><br/>(bkz: <a class="b" href="/?q=i%c4%9fne+ucu+kadar+kuru+yer+kalmamal%c4%b1">iğne ucu kadar kuru yer kalmamalı</a>)
- entry_name: |
...
- entry_name: |
    yeni nesil gelinlerin edep bilmemesi
  entry_id:  73842543
  entry_writer: miss gibi
  entry_fav_count: 85
  entry_content: |
    üstte okuduğum örneğe göre;<br/>-ameliyat olan annesini bırakıp; tatile giden adamla evli, yeni gelindir.<br/><br/>ekleme: yazarın annesine geçmişler olsun dileklerimi iletiyorum.
- entry_name: |
...
- entry_name: |
    tsk'nın öso bayrağı altında savaşması
  entry_id:  73852537
  entry_writer: kadim kishi
  entry_fav_count: 20
  entry_content: |
    ekşi sözlük dezenformasyon timi mensubu arkadaşa selam eder; öso mensubu, tsk askeri kamuflajlı, tercüman askeri türk askeri sanmasını alkışlıyorum.<br/><br/>tabii aynı askerin semih paşanın isteği ile fotoğraf çektirmesini görmezden gelmesini (!)ise yok sayıyorum.<br/><br/>hadi canım hadi atom bombası atıyoruz afrine ona başlık aç.
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  73832690
  entry_writer: ben de yazar olucam
  entry_fav_count: 10
  entry_content: |
    sürekli gizemli havalarda olup, asla anlaşılmayacak sorunları varmış gibi davranan tiplerden uzak durulmalı kanımca. zira ince hastalığa düşürürler insanı.
- entry_name: |
    ölümlü dünya
  entry_id:  73838126
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    vartolu az önce beyefendi'nin içinden geçti. hatta hala geçmeye devam ediyor.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    başlığı “biz demokrasimiz için savaştık, ama türkiye yoketmek istiyor” olan yazı.<br/>gerisini okumadan hassssiktir çektim zaten.<br/>sizin anladığınız türden demokrasiyi sizin yöntemlerinizle getiriyoruz lan işte itoğlu itler daha ne?<br/>hadi bu sik kırığı teröristi de savunun lafta anti amerikancı, anti emperyalist yavşak pekeke sevici yazarlar hadi durmayın 5 kuruşluk karakterinizle!
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  73852812
  entry_writer: le flaneur
  entry_fav_count: 3
  entry_content: |
    avrupa maçlarındaki ihaneti asla unutulmayacak olan takım.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    insanoğlu'nun nefes alan almayan her türlü canlıya kerkindiğini gördülerse demek.
- entry_name: |
...
- entry_name: |
    14000 kalorilik sandviç
  entry_id:  73853251
  entry_writer: when dream and day unite
  entry_fav_count: 2
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://twitter.com/tasty/status/957704844105494528" title="https://twitter.com/tasty/status/957704844105494528">https://twitter.com/…asty/status/957704844105494528</a><br/><br/>yaklaşık 70 cm uzunluğa ve 6 kg ağırlığa sahip sandviç. 40 dakikada tek başına yiyene sandviçten para almadıkları gibi arzu ettikleri başka bir sandviçi de hediye ediyorlarmış. <br/><br/>benimse aklımda tek soru var: <a class="b" href="/?q=neden+olum">neden olum</a>
- entry_name: |
    doğu perinçek
  entry_id:  73853574
  ...
  entry_fav_count: 1
  entry_content: |
    <a class="b" href="/?q=mehmet+sar%c4%b1">mehmet sarı</a> gibi adamla aynı taraftaki bıyıklı. <br/><br/>zuhahahahahah...
---
