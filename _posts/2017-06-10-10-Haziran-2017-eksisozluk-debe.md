...
- entry_name: |
    türkiye kalkınırken zeytinin derdine düşmek
  entry_id:  68725532
  entry_writer: spinapubica
  entry_fav_count: 66
  entry_content: |
    'ölü taklidi yapın, sktirolup gider belki...'<br/><br/>--e.d.a.
- entry_name: |
    nihat doğan'ın deniz seki'ye torbacı demesi
  entry_id:  68715097
  entry_writer: yaban mersini
  entry_fav_count: 61
  entry_content: |
    bu adamin kapatma tusu yok mu acaba?
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 45
  entry_content: |
    hakikaten var böyleleri,nöbetteyken telefonuyla oynayan ,çay kahve içen hatta bir keresinde nöbetteyken tuvalete giden doktor bile gördüm ve aynı doktor yarım saat sonra hastane kantininde yarım tavuk döner yiyiyordu oysa o kişinin acil girişinde elektroşok yapmaya hazır bir vaziyette ,beş saniyede hastaya mudahale edebilecek gibi olması gerekiyordu yani er ve doktorlar dizisinde öyle oluyor.tabii başhekimin gece saat 230 uyuyor olup belkide kalp krizi geçiren hastanın yakınıyla görüşememe sorununa çözüm bulmaması ayrı bir rezalet.
- entry_name: |
    vatanım sensin
  entry_id:  68712063
  ...
  entry_fav_count: 44
  entry_content: |
    sürekli bu başlığa dizinin içeriği ile ilgili seri entry giriyorum fakat bu sefer anlatmak istediğim başka bir şey var.<br/><br/>hani bu sözlükte maaşlı sandığınız, aktroll dediğiniz insanlar var ya, ha işte onlar hiç de maaşlı değil. son derece gerçekler ve arkalarında hissettikleri güçten ötürü entry girer gibi konuşmaktan hiç korkmuyor, hiç çekinmiyorlar. çevremde böyle biri var. <br/><br/>'vatanım sensin çok güzel izlesene' dediğimde yüzüme küçümseyici bir ifade ile bakıp 'izlemem ben onu ya' dedi. gerçekten anlamadım, nedenini sordum. halit ergenç'i sevmiyormuş paşam. yalan.<br/><br/>geçenlerde sinirlenmiş. çünkü biri ona 'insanlar keşke kuran okuyacağına nutuk okusa' demiş. çok sinirlenmiş amın evladı. insanlar kuran okuduğu kadar nutuk da okumuş olsa bu ülke bu halde olmazdı, ama bunu bir sığıra anlatmak imkansız. atatürk'ün türk topraklarında islam'a yaptığı güzelliği anlatmak da imkansız. istiyordu ki herhalde, atalarını yunan, fransız falan siksin. ama bir şeye çok eminim. bu topraklarda hristiyan olarak doğmuş olsa, yine yobazın önde gideni olurdu. buna adım kadar eminim.<br/><br/><a class="b" href="/?q=mustafa+kemal+atat%c3%bcrk">mustafa kemal atatürk</a>'ü sevmiyor. o yüzden de kendisine her tür ideolojiden ve siyasi partiden uzak bir şekilde diziyi seyretmesini önermiş insana aşağılarcasına bakarak 'izlemem ben onu ya' diyerek dalga geçercesine o siktimin ağzında yavşak bir gülümseme oluşturma kuvvetini alıyor. nereden alıyor tahmin edersiniz. çünkü neden? çünkü orospu çocuğu.<br/><br/>senin o kuvveti aldığın yerleri sikeyim. soysuz ve kansızsın. dizi özelinde düşündüğümde küfür olarak yunan'ı bile kullanmam. keşke o dönemdeki şerefsiz yunanlardan biri olsan, ama daha kötü, senin kanın bile yok. adamların en azından bir helen ideali falan varmış, senin idealin nedir? kadınları metroda ayrı vagona bindirmek? senin vizyonunu sikeyim. senin zihnini, senin sapkınlığını sikeyim.<br/><br/>tarih boyunca bu ülkenin başına gelmiş en kötü şey sizsiniz.<br/><br/>imza: selanikli, pipisiolmayangil.
- entry_name: |
    vhs kaset kiralamak
  entry_id:  68722401
...
- entry_name: |
    diriliş ertuğrul dizisini elinde kılıçla izlemek
  entry_id:  68726071
  entry_writer: insanim insan
  entry_fav_count: 28
  entry_content: |
    <a class="b" href="/?q=breaking+bad">breaking bad</a>'i elinde bongla izlediğine bahse gireceğim dededir.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    hayret kimse yazmamis. <br/>(bkz: <a class="b" href="/?q=taharet+muslugu">taharet muslugu</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    <a class="b" href="/?q=iktirdi">iktirdi</a> nedir acaba aklima kotu kotu seyler geliyor.
- entry_name: |
    johnny depp
  entry_id:  68713725
...
- entry_name: |
    kadınların ayakta işeme sevdası
  entry_id:  68713026
  entry_writer: misery the pig
  entry_fav_count: 11
  entry_content: |
    erkeklerin memem olsa sürekli kendimi mıncıklarım sevdasıyla kapışabilecek sevdadır.
- entry_name: |
    kürtçülük
  entry_id:  68727568
  ...
  entry_fav_count: 10
  entry_content: |
    turkiyede solu sikip atanlarin buyuk cogunlugunu olusturan guruhtur.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    bu bir zamanlar bizde başkandı. <br/>ne büyük kulüpmüşüz ki bu bile bizi yıkamadı.
- entry_name: |
    gelinlikle oynayan dayı
  entry_id:  68719347
  entry_writer: travenian
  entry_fav_count: 6
  entry_content: |
    <a class="b" href="/?q=bi+k%c3%b6%c3%a7e%c4%9fin+j%c3%bcbilesi">bi köçeğin jübilesi</a> dir bence. başka mantıklı bi açıklama bulamadım. <br/><br/>işte bunlar hep <a class="b" href="/?q=votka">votka</a>.
- entry_name: |
    fi
  entry_id:  68729529
...
- entry_name: |
    sekste başarılı olmak
  entry_id:  68729707
  entry_writer: insannn
  entry_fav_count: 3
  entry_content: |
    sekste ilk 45 bindeyim, yarinki lys ile inşallah daha öne çekerim.<br/><br/>sekste çok stres yapmistim bakalim yarin nolcak?
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    kuzey kore'yi bitirmesi, kore yarımadasında konuşlanma sebebini de bitireceği içindir. ayrıca güney kore'yi dizginlemede, işe yarar bir araç olabilir.
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    evet geçmeseydi ölmeyecekti. öğretmen suçlu çünkü yoldan geçti, o amk teroristlerin, devletin, güvenlik zaafının hiç suçu yok.
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    erkan baş ve çetesinin faşistlerin aklına gelmeyecek yalan ve provokasyonlar eşliğinde üyelerine saldırdığı parti.<br/><br/>ayrıntılar şurada açıklanmış: <a rel="nofollow noopener" class="url" target="_blank" href="https://twitter.com/tkpninsesi/status/873252134350987270" title="https://twitter.com/tkpninsesi/status/873252134350987270">https://twitter.com/…sesi/status/873252134350987270</a>
- entry_name: |
    stanislas wawrinka
  entry_id:  68728091
  entry_writer: sifonyere carpan serce parmak
  entry_fav_count: 0
  entry_content: |
    kendisinin backhand ve forehandleri hiç bir zaman tartışma konusu olmamıştır. özellikle backhand tekniği ile ilgili sayfalarca analiz yapılabilir , methiyeler düzülebilir. buna karşın bir oyuncu mental olarak tekniğinin aksine ancak bu kadar zayıf olabilir. eğer bugün çift hanelerde grand slam kazanamadıysa tek sebebi mental yetersizliğidir.<br/><br/>onu hala neredeyse her maçında büyük inişler çıkışlarla izlesek de 2014'te kazandığı ilk grand slamden sonra özellikle ilk 5 sıradaki oyunculara karşı kendinden çok daha emin bir çizgide oldu hep. bunu kanıtlarmışçasına bugün 1 numara andy murray'e karşı setlerde 2 kez geri düşüp son seti 6-1 alarak roland garros'ta finale çıktı. bunu 32 yaşında gerçekleştirerek yaklaşık son 30 yıldır bunu yapan en yaşlı isim oldu.
- entry_name: |
