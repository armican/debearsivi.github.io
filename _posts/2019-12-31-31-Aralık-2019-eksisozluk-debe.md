...
- entry_name: |
  ...
  entry_fav_count: 45
  entry_content: |
    alican oyuncak hikayesi filmindeki şerife benziyor.<br/><br/>sonunda buldum kime benzediğini.
...
- entry_name: |
  ...
  entry_id:  99798692
  entry_writer: ode to sun
  entry_fav_count: 24
  entry_content: |
    (bkz: <a class="b" href="/?q=hayvan+%c3%a7iftli%c4%9fi">hayvan çiftliği</a>) vicdanlarına uyduramayanların mantıklarına uydurma çabası.
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    tuzlu fıstığın çerezlerin şahı olması
  entry_id:  99826868
  entry_writer: shooter mcgavin
  entry_fav_count: 12
  entry_content: |
    antep fıstığının kilosu olmuş 100 lira. zaten bedava vermezler. verirlerse yüzüne bakmazsınız tuzlu fıstığın. ekşi sözlük'te bedava antep fıstığı izdihamı başlığını görürüz sonra.
  entry_channels: anket,yeme-içme
- entry_name: |
...
- entry_name: |
    polis okulunda yasadışı yemin töreni
  entry_id:  99832536
  entry_writer: sah a gidelim
  entry_fav_count: 8
  entry_content: |
    o zaman ateist,deist,alevi gayrimüslimleri zorla askere almayacaksın. <br/>ha alacaksan bu kadar kişiye böyle yemin ettiren sorumluları memurluktan alıp hakimin karşısına çıkartacaksın.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    gecen sezon ilk yariyi liderin 6 puan gerisinde 5. sirada bitirip sezon sonu sampiyon olabilmis bir takimin, sezon sonu ligi 5 ila 7. sirada bitirecegine kesin gözüyle bakan tinercileri basligi altina toplamis takimim.<br/><br/>ben demiyorum ki kesin sampiyon oluruz ama sen galatasaray’in ligi kötü bir siralamada bitirecegine hangi done ile kesin gözüyle bakiyorsun onu anlat da bilelim sayin tinerci.<br/><br/>her sene ayni senaryo amk. ligin baslarinda ortalarinda hahaha bu sene bittiniz siz demeler sonunda küsküyü yiyip fetö, mhk, tff diye aglamalar. ulan esekler adam olur siz akillanmazsiniz vallahi.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    yörük kızıdır, sıkma da yapar.<br/><br/>ayrıca çökelik değil çökelek.
  entry_channels: ilişkiler,yeme-içme
- entry_name: |
    sadece adı ve soyadıyla e-mail alabilen insan
  entry_id:  99832777
  entry_writer: hem kucuk hem kara hem balik
  entry_fav_count: 3
  entry_content: |
    biri de benimdir bunun.<br/>istesem her yerden hâlâ alabilirim. öyle bi ad-soyad kombinasyonum var. :))
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    ünal karaman'ı biz göndermedik kendisi ayrıldı diyor ama abi o zaman neden kap bildiriminde yazdığı gibi adama gelecekteki ödemelerini de yapıyorsunuz?<br/><br/>hangi istifa eden adama gelecek ödemeleri de yapılır?
  entry_channels: spor
- entry_name: |
    yılbaşı kutlamayan ateist
  entry_id:  99823533
  entry_writer: fsmav
  entry_fav_count: 1
  entry_content: |
    yeni nesil ateizm esasen dine karşı değil de dinin yasaklarına karşı olduğu için olmayan ateisttir. zira dinin dayattığı yaşam tarzı yeni nesil tüketim toplumlarında bize dayatılan kapitalist kültür sanayisinin körüklediği yaşam tarzıyla çelişir. dolayısıyla hz. isa peygambermiş doğmuş da alakası yok sabahlara kadar party yeah.
  entry_channels: 
- entry_name: |
