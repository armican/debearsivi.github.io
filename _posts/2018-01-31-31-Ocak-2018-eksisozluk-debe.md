...
- entry_name: |
  ...
  entry_fav_count: 41
  entry_content: |
    eğitimsiz, kültürsüz, cahil, vasıfsız, bir bok olamayacağını anlayıp polis olmuş şu an iktidar tarafından tasmaları biraz gevşetilmiş organizmadır.<br/><br/>(bkz: <a class="b" href="/?q=t%c3%bcrk+polisi">türk polisi</a>)<br/>(bkz: <a class="b" href="/?q=polis+devleti">polis devleti</a>)<br/><br/>not: evet evet kahraman türk polisidir.<br/>evet başımıza bir şey gelse hemen polisi ararız.<br/>evet aslandır, kaplandır. <br/>aynen bro aynen.
- entry_name: |
...
- entry_name: |
    uzaylıların gelmeme sebebi
  entry_id:  73856079
  entry_writer: smitty werben
  entry_fav_count: 27
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://karikaturistan.files.wordpress.com/2013/01/uzaylilar-niye-gelmiyo-ozer-aydogan.jpg" title="https://karikaturistan.files.wordpress.com/2013/01/uzaylilar-niye-gelmiyo-ozer-aydogan.jpg">budur</a>
- entry_name: |
  ...
  entry_fav_count: 27
  entry_content: |
    bunun doğru olmadığını cümle aleme ispatlamak için bir şans istiyorum. gelir artınca mutluluğun da nasıl arttığını görsünler. allahım sen konuyu biliyorsun. aslında...borçlarımız bitsin o da yeter. çok şey mi istiyorum?
- entry_name: |
    ekşi itiraf
  entry_id:  73856140
...
- entry_name: |
    furkan vakfının kasasından 350 bin tl çıkması
  entry_id:  73868813
  entry_writer: 3lly
  entry_fav_count: 18
  entry_content: |
    diğerlerine göre fakir sayılırlar yandaş tarikat yapılanmalarının günlük cirosu 350 binden fazladır.
- entry_name: |
    beşiktaş
  entry_id:  73862986
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    erkek kız karma olarak oturduğumuz mekanda sürekli dedikodu yapmaları. ilgi alanlarının; twitter, instagram, dizi oyuncuları, aa şu çocuk çok yakışıklıaaa, abuk komik video ve capslerden ibaret olması. kısaca sığ olmaları. dış görünüşe aşırı takmaları ve birini eleştirdiklerinde sizden onay beklemeleri. tek umursadıkları şey cinsel içgüdüleri, statüler, güç, hormonları vs iken konuyla hiç alakaları yokmuş gibi davranarak sizin kafanızı sikmeleri. aptal numarasına yattığınızı anlayamayacak kadar salak ve kötü niyetli olmaları. iyi niyetinizden ve hatalarını yüzüne vuracak kadar alçalmıyor olmanızdan faydalanmaları. işlerine geldiğinde yalan söyledikleri halde yalandan nefret ederim diye ortalıkta dolaşmaları.
- entry_name: |
    turgay demir
  entry_id:  73875173
  ...
  entry_fav_count: 3
  entry_content: |
    beşiktaş amigosu gibi maç yorumlayan şahıs. beşiktaşlı halimle sinir oldum aq.<br/><br/>(bkz: <a class="b" href="/?q=30+ocak+2018+be%c5%9fikta%c5%9f+gen%c3%a7lerbirli%c4%9fi+ma%c3%a7%c4%b1">30 ocak 2018 beşiktaş gençlerbirliği maçı</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    bunlara kuvayi milliye diyen vatan hainidir. kuvayi milliye hem içerdeki işbirlikçi istanbul hükümetine hem de emperyalizme karşı, halkın kısıtlı imkanlarını kullanarak savaşmış bir bağımsızlık hareketidir.<br/><br/>öso ise suriye iç savaşı başladığı günden beri bizzat emperyalizm tarafından ağır silahlarla, tanksavarlarla açıktan desteklenen bir çetedir. <br/><br/>pkk ve ışid gibi başka terörist oluşumlara karşı iti ite kırdırmak dışında bir işlevi olamaz. bunlara kuvayi millliye yakıştırması yapanların özde kuvayi milliye düşmanı gericiler olması da ironi falan değil düz takiyyedir aslında.
- entry_name: |
    jeremain lens
  entry_id:  73875696
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    bir çok yunan arkadaş, aramızdaki ayrımın tamamen devletler arasında ve politik olduğunun bilincinde. <br/>türkiye'nin pek çok kentinde bu bakış açısı hayal olmakla beraber; izmirliler de tıpkı yunan halkının büyük çoğunluğu gibi düşünmektedir. <br/>yani biz aslında iki kardeş toplumuz; fakat politik tavır ve devletler arasında var olan köklü sıkıntılar yüzünden yunan kültürü ile haşır neşir olan bir türk ya da türk kültürüne sempati besleyen bir yunan garip karşılanmaktadır.<br/>özetle, izmirliler yunan ve yunanistan hayranı değil; kendi kültürüne yakın gördüğü ve birşeyleri aşmış olduğunu düşündüğü bir topluma sempati beslemektedir.<br/>not: bu yazıda marjinal kesimler kastedilmemektedir.
- entry_name: |
    bul beni
  entry_id:  73876140
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    vizyonsuz. kemalizm diye anlattığı şey kuru bir ezber. bize, dünyaya, ülkeye katabileceği hiçbir şey yok. kendisinden harika bir işe yaramaz, etkisiz, hükümsüz ana muhalefet lideri olacak. tam da reyisçilerin dilediği gibi. 22-25 olan oyu 29 yapar. bi soraki seçime 27 sonra 25. ortodoks kemalist takılan kitlenin kimseye faydası yok. kemalizm'e de faydaları yok. anca laf.<br/><br/>bu coğrafyada yüzlerce yıla meydan okurcasına yeni bir vizyonla kadere meydan okumuş bir adam diyebiliriz mustafa kemal için. 1920lerdeki laiklik vizyonu tek başına yeter. ya bu beyefendi? 30ların ezber pratiği ile karşımıza dikilmiş kemalizm taslıyor. ne boyu yeter, ne izanı. 6 ok da 6 ok diye tekrar ettiği 6 oktan 6ncısı inklapçılık ya da devrimcilik, bu beyefendi ne devrimi öneriyor bize? hiçbir şey, tarımda devrim önerir en fazla, eğitim sistemini elden geçirir devrim der. <br/><br/>bu beyefendi ya da kendisi gibi vizyonsuz kemalistlerle son kullanma tarihi geçmiş ulus devletin, kim olduğu, ne sevdiği, ne istediği devletçe belirlenmiş vasat bireyleri olabiliriz. üniterlik, devletin bekası laflarını obsesyona çevirmiş bir ülkede daha yüz yıl ifade hürriyetini ceza bilen diktatör bozmalarının eline kalırız. eşit vatandaşlık tabirini kafası almadığı için bunu bir ırk'la tanımlamak zorunda hisseden 1930 kafalıların elinde oyuncak oluruz ancak. izleyin görün...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    osmanlının amerika ya gitmemesi gayet doğal ve normal bir tavırdır.<br/>sokullu nun kanal projeleri uygulanabilse coğrafi keşiflerin olumsuz etkisi kırılabilirdi.<br/>asıl hatamız süveyş kanalını açmamak<br/>don - volga kanal projesinin arkasında duramamak.<br/><br/>amerikayı bulanların ispanyol ve portekizlilerin akibeti ortada.<br/>mesele sömürgeciliği sisteme koyan ingiltere olmakta.<br/>uzun konu.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    simit satmıştım. kafamın üstüne tahta dandik bi tezgah, mahallenin fırınından, mahalle sokaklarında komşulara satış yapıyordum. ilkokul başı ya var ya yok. sonra büyüdük, orta okulda da oto yıkama işine dayım girince biz de girmiş sayıldık<sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup> cam silme ve süpürge yeteneklerimi o günlerde keşfetmiştim<sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup><br/><br/>insan hep bir şeyler tecrübe etmeli.
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    turk feministlerinin isi olabilir.<br/><br/>simdi gencler icin uygulamali ogretelim. <br/><br/>bu basligi acan arkadasin baska bir basliga yazdigi:<br/>(bkz: <a class="b" href="/?q=t%c3%bcrk+k%c4%b1zlar%c4%b1ndan+nefret+etmek%2f%40yanilgi">türk kızlarından nefret etmek/@yanilgi</a>)<br/><br/>icinde su cumleyi bulabilirsiniz. <br/><br/>"......güleryüz borcum yok <a class="b" href="/?q=amk">amk</a> ortadoğu erkekleri."<br/><br/>evet dogru gordunuz, bir adet "amk" var. bu benim ilk tecrubem degil. bu dili kullananlarda hep bunu goruyorum. daha evvel de "bayan degil kadin diyeceksin amk" versiyonuna rastlamistim.<br/><br/>gunumuzde feminizm azcik da biz ezelim ideolojisine donustu. ayni eril dili kullanirlar ve bunu bayan kelimesini (haksiz olarak) elestirirken yaparlar.
- entry_name: |
