...
- entry_name: |
  ...
  entry_fav_count: 25
  entry_content: |
    "sikilen çocuklar" ne anlama geliyor biri bana açıklasın...<br/><br/>taciz edilen, tecavüz edilen, cinsel istismara uğramış vb. tabirler yerine "sikilen" kullanmak nasıl bir psikolojinin tezahürü?<br/><br/>olayı gözünde canlandırıp tecavüze uğradıklarını değil de "sikildiklerini" hayal edip mastürbasyon mu yapıyorsun hayırdır?<br/><br/>ilgili entryde islam dinine saldırı söz konusu olunca koşulsuz şartsız sövene hakaret edene sahip çıkan onun bunun evlatları da gelmişler hemen...<br/><br/>sadece bu yazarımsının değil, buralarda anonim bir rumuz arkasına saklanıp, klavye başında kin nefret kusarak içindeki pislikleri ortalığa saçan ne kadar yazar varsa ve onları destekleyenler de dahil olmak üzere uçurulsun...<br/><br/>pislik okumaktan bilgi edinemiyoruz doğru dürüst...
  entry_channels: ekşi-sözlük
- entry_name: |
    binali yıldırım
  entry_id:  78951595
  entry_writer: al sana nick it
  entry_fav_count: 23
  entry_content: |
    intihar girişiminde bulunan genci kurtardıktan sonra basına yansıyan fotoğraflardaki yüz ifadesine bakarsanız ne kadar iyi yürekli bir insan olduğunu sadece oradan anlayabilirsiniz. <br/><br/>siyasi görüşlerden bağımsız olarak gerçekten sevip saydığım bir insan.
  entry_channels: siyaset
- entry_name: |
    barış atay
  entry_id:  78949255
  ...
  entry_fav_count: 21
  entry_content: |
    bünyesinde alışkanlık olduğu için meclisin arka sıralarında oturacaktır.
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    31 ülke içerisinde türk öğretmenler matematikte 30'uncu okumada ise 31'inci olmuş. hadi bakalım.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bildiğim ve ailemle birlikte gittiğimiz otelde gerçekleşen üzücü olay. yazık olmuş çocuğa, resmen pisi pisine gitmiş. aile ihmali belki var, belki yok bunu bilemeyiz. benim anlamadığım konu şu...<br/>talihsiz olayın gerçekleştiği havuz 4 cepheden çok net görünen bir konumda. sırtınızı denize verdiğiniz zaman sağında atıştırmalıkların olduğu ve öğlen yemeklerinin de sunulduğu büyük bir kamelya var.<br/>solunda da animatörlerin olduğu alan. <br/>arka tarafınızda bolca şezlong ve yatanlar. direk karşınızda lobi girişi ve dışarıda masalar var. etrafta sürekli gezinen garsonlar var.<br/>havuz içerisinde de mutlaka birileri vardır. kimsenin çocuğu görmemesi gerçekten büyük bir talihsizlik. allah ailesine sabır versin.
