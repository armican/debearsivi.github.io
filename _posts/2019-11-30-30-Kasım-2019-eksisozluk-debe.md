...
- entry_name: |
    sokağında kimseyi rahatsız etmeden alkol almak
  entry_id:  98439268
  entry_writer: tayfak
  entry_fav_count: 41
  entry_content: |
...
- entry_name: |
    türklerin kahveyi çaydan daha çok sevmesi
  entry_id:  98447574
  entry_writer: eminmisin ki
  entry_fav_count: 4
  entry_content: |
    dünyada çay tüketimin de türkiye 1. sırada. <br/><br/>tespit yapmadan önce istatistiklere bakmak daha yararlı olur. ancak en çok çay tüketiliyor diye o daha çok mu seviliyor? diyebilir siniz tabi. onu da bilemem.<br/><br/>ama her sabah çoğu evde çay yapılır arkadaş. ya da dışarıda bir şey içeceksen bu çoğunlukla çaydır. çay bahçesinde çay içilir kahve yerlerinin çoğunda da çay içilir.
  entry_channels: anket,yeme-içme
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    anadolu’daki herhangi bir öğretmene bir kitap listesi çıkartın deseniz zaten bunları çıkartır. kim yapmışsa sıradanlık akıyor. meslek lisesi kütüphanesinde faulkner, joyce, proust, beckett, mann var. şu lisenin idaresi oturup kendini sorgulasın. öğretmenleri de dünya edebiyatını takip etsin biraz. okulun adına saygınız olsun.
  entry_channels: 
- entry_name: |
    ibrahim kalın'a gülenci geçmişinin hatırlatılması
  entry_id:  98425115
  entry_writer: kruemelmonster
  entry_fav_count: 3
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    böyle başlıkların en sevdiğim tarafı engellenecek dangalakları uğraştırmadan ortaya çıkarması.
  entry_channels: anket,ilişkiler
- entry_name: |
    trendyol
  entry_id:  98430451
...
- entry_name: |
  ...
  entry_id:  98425682
  entry_writer: alayli psikolog
  entry_fav_count: 0
  entry_content: |
    citroen c-elysee ile ilgili entrym den alp koyayım da belki fikir verir, faydalanan olur. <br/><br/>gazlayınca tüketim 12-13 lt ye ulaşıyor, tam muadili sayılmasa da sayan var egea da gaza abanınca hayret verici bir şekilde 6,5 -8 arası oynuyor dahada artmıyordu. yol şartları çok farklı koşullarda defalarca test ettim iki aracıda, yakıt konusunda genel olarak başarılı sayılsa da 4,5 lt leri görmek için bir gözüm yol bilgisayarın gazı ağır ağır pompalayarak gitmek zorunda kalıyorsun, başkası başka türlü yakalıyodur ama beni az yakmak için çok yoruyor, yemişim öyle az yakıtı.<br/><br/>yakıt ve performans konusundaki yorumlar kişiden kişiye değişebilir, bir çok kişi bu aracı performans ve yakıt konusunda çok başarılı buluyor, ben belkide geçmişte 2005 model 1.9 jtd motorlu doblo kullandığım için motor/performans/ yakıt üçgeninde en düşük beklentim o oluyor. ortalama bir araçla 120 ye nasıl çıkıyorsanız doblo 1.9 jtd motorda o 140 oluyordu. kesinilkle savrulma, viraj alma konularında araç başarısızdı, sonuçta bir ticariden bahsediyorum konforunu falan kıyasladığım yok sadece motorunu baz alıyorum doblonun.<br/><br/>demem o ki ben bir araçta ilk sırada motor performansı ve yakıt tüketimine bakıyorum.<br/><br/>c-elysee 1.6 hdı ile uzun yolda az yaksın diye kasıyorum 4.6 lt.<br/>c-elysee 1.6 hdı ile uzun yolda kasmadan, basmadan 5.2 lt<br/>c-elysee 1.6 hdı ile uzun yolda basarak 12 lt. yi gördüm içti resmen<br/><br/>doblo 1.9 jtd ile uzun yolda az yaksın diye hiç kasmadım hep bastım 6,1 -6,5 arası değişirdi bakım, yol, hava şartlarına göre, bana 1.9 jtd performansı verseydide bu kadar yaksaydı o zaman başarılı derdim, fişek gibi kavramı hepimizde çok farklı, 1.2 scirocco da kullandım ondaki başka bir olay, daha hızlısını kullanmadım.<br/><br/>çok uzun oldu kafa ütüledim kusura bakmayın ama yazdıklarım yanlış yönlendirmesin diye kendi beklentilerimi detaylı anlattım.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    alışveriş yapmamak bir tercihtir, saygı duyulması gerekir.<br/><br/>ama yapmak da bir tercihtir, ona da saygı duyulması gerekir.<br/><br/>alışveriş yapanı kerizlikle itham edip, sonra da ekonomi daraldı diye hayıflanana ise saygı duyulmaması gerekir.
  entry_channels: anket
---
