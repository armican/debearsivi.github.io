...
- entry_name: |
  ...
  entry_fav_count: 29
  entry_content: |
    napsın amk kömürlüğe mi insin.<br/><br/>markete şirkete sıçanların kafası bu.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    bu selin nedenin altyapı yetersizliği ve betonlaşma olduğunu pekala bilmektedir. başka birşey yazmaya gerek yok herhalde. anladınız siz onu.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    sev beni...<br/><br/>sevilmek istiyorum be sözlük...
  entry_channels: anket,edebiyat
- entry_name: |
    gider paşa gibi yatarım hiç sıkıntı değil
  entry_id:  94360955
  entry_writer: lordofsky
  entry_fav_count: 4
  entry_content: |
    başlığın en şükelalanan girdileri;<br/>beton sikme,<br/>sikinde olmama,<br/>paşa paşa batırma,<br/>hayatın sikilmesi,<br/>30 yıl karılık yapma şeklinde.<br/><br/>tepkilerde, beğeniler bile erkek üzerinden.
  entry_channels: haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    çok şanssız bir gol,neredeyse imkansızı attı adam ama yan toplarda saatli bomba.
  entry_channels: spor
---
