...
- entry_name: |
  ...
  entry_id:  94379545
  entry_writer: lazim olan adam
  entry_fav_count: 9
  entry_content: |
    korkuyla kaçmak. yoo kovalandığımdan filan değil. varlığımdan haberdar bile değiller. kaygı verici sadece. ilginç mesela çirkin kızlardan korkmam.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=hachi+a+dog%27s+tale">hachi a dog's tale</a>)
