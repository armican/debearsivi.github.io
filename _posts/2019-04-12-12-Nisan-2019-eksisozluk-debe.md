...
- entry_name: |
  ...
  entry_fav_count: 26
  entry_content: |
    sayın danışmanlar ve pek sayın başkanım öncelikle hayırlı olsun göreviniz.<br/><br/>25 yıldır oy vermediği için cezalandırılan bir çankayalı olarak kendi yarım yamalak vizyonum doğrultusunda bir şeyler karalayacağım.<br/><br/>1. ankara'nın pek çok yerinde mekan valelerinin trafik polisi edasında yol kesip 2-3 araç çekmesi / çıkartması için onlarca araç bekletiliyor. (bahçelievler, tunalı, ümitköy, kızılay, hoşderedeki çorbacılar vb.) bu konuda bir düzenleme mümkünse yapılması anlamsız tıkanıklıkları biraz da olsa çözebilir.<br/><br/>2. çetin emeç'i rahatlatamazsınız farkındayız. gerek hattı kullanan araç sayısı gerekse de alternatif bulunmaması nedeniyle iş trafiğinde korkunç durumda oluyor. çankaya'ya metro hattı da mümkün değil ama en azından kızılay'a gitmeden eskişehir yolu üzerinde devam eden bir hat bulunursa, rotanın başarısına göre pek çok insan bireysel araçları yerine toplu taşımaya yönelebilir. atakule çevresinde yaşayan birisi kızılay üzerinden 2 araç ile iş trafiğinde 1.5 saat civarında ancak kentpark-cepa'ya varabilmekte. yoğun nüfuslu yıldız-vb. bir yerden kalkarak konya yolu - eskişehir yolu üzerinden devam eden bir otobüs hattı yapılırsa bireysel araç kullanımının azalacağı kanaatindeyim. <br/><br/>3. belediye bünyesinde çakarlı araçlarla insanları sıkıştıran var ise veya bünyenizde olmasa dahi bunu yapanlara uygulayabileceğiniz herhangi bir yaptırım varsa lütfen elinizi ardınıza koymayın. bütün şehir bıktık bu yaratıklardan. kimseye eskortluk yapmıyorken dahi böyleler.<br/><br/>4. refüjlere, yol kenarlarına çiçek ekmek için bütçe ayırmayın. istihdam yaratmak için o paralarla atölye açın, öküz alın mandıra kurun ne bileyim naparsanız yapın ama 80le gidilen yolun yüksek refüjüne çiçek ekseniz ne ekmeseniz ne kime ne faydası var bunun kim görüyor ne kadar oksijen üretiyor küçücük otlar? oraya ayrılan adam/saate, arada bir sulamak için dökülen suya, araçların benzinine yazıktır. yeşillendirmeleri halkın kullanabileceği yerlere yapın lütfen.<br/><br/>5. belediye'nin meslek edindirme kurslarının salt iş gücü kazanımı için kullanılmasının doğruluğuna inanmaktayım. hobi kursu olarak kullanan kitleyi, ilçelerde yer alan "hanımlar lokali" tarzında yerlere açılacak farklı kurslara kaydırırsanız gerçekten ihtiyacı olanların oralarda yer bulmasının önü açılabilir. senelerdir aile büyüklerini olgunlaşma enstitüsü'ne götüren birisi olarak gerek kendi aile üyelerim, gerekse de orada bulunanların bu kurslara meslek edinme amaçlı değil, sosyalleşmeye gittiğini görmekteyim. sosyalleşme bir hak ve ihtiyaç olmakla birlikte, bunun sağlanması uğruna meslek edindirme kurslarında kontenjan doldurulmasının yanlış olduğunu düşünmekteyim. bu kurslardaki hocaların da kendi insiyatifleri doğrultusunda, kurslarda gelişme niyetinde olmayan insanlara yer sağladığını biliyorum.<br/><br/>gece gece aklıma bu kadar geldi. "bu zaten bizim işimiz değil" diyeceğiniz kısımları cahilliğime veriniz. hepinizin ellerinden öpüyorum.
  entry_channels: siyaset
- entry_name: |
    geceye devlet için ekstra bir gelir kaynağı bırak
  entry_id:  88792671
  entry_writer: kizilcikserbeti
  entry_fav_count: 26
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    köşeli kafasını siktiğimin primatları. zor gününde bunlara merhamet edenin de anasını sikeyim.
  entry_channels: haber
- entry_name: |
    ahmet davutoğlu
  entry_id:  88821467
