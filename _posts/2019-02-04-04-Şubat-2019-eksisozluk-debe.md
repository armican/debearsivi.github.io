...
- entry_name: |
  ...
  entry_fav_count: 68
  entry_content: |
    ''büyük beklentilerin olmasın.. <br/>eğer yaşadıklarından çıkardığın en önemli ders nedir diye sorsaydı biri bana, bu üç kelimeyle cevap verirdim duraksamadan.. <br/>"büyük beklentilerin olmasın".. <br/>bağırmayan anne, kırılmayan oyuncak, terketmeyen sevgili, bitmeyen oyun olmaz...''<br/><br/>(bkz: <a class="b" href="/?q=ali+lidar">ali lidar</a>)
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 38
  entry_content: |
    başkanlık sistemi gelince uçacak kaçacaktık.<br/><br/>şimdi 1 paket makarna neyinize yetmiyor diyorlar. <br/><br/>haysiyetsizler.
  entry_channels: siyaset,ekonomi
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    filmde iki güzel şey vardı:<br/><br/>1 - kıvanç tatlıtuğ,<br/><br/>2 - erdal tosun.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    halisaha macina bile cagrilmayacak adami bize iteledin ya atiba, alacagin olsun. evet senol gunes forvetlere fisildayan adam olabilir ama adamin top kontrolu bile kuruyemisci huseyin emmi'den kötü yani.
  entry_channels: haber
- entry_name: |
    evanescence'deki temiz yüzlü kız
  entry_id:  86275894
  entry_writer: versucher
  entry_fav_count: 4
  entry_content: |
    geceleri apartmanların kirişlerinde gezintiye çıkmayı ve düşme tehlikesi yaşamayı sever.
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    (bkz: <a class="b" href="/?q=ayval%c4%b1k+adalar%c4%b1">ayvalık adaları</a>)<br/>(bkz: <a class="b" href="/?q=bay+nihat">bay nihat</a>)<br/>(bkz: <a class="b" href="/?q=midilli+adas%c4%b1">midilli adası</a>)<br/>(bkz: <a class="b" href="/?q=ortun%c3%a7">ortunç</a>)<br/>(bkz: <a class="b" href="/?q=sar%c4%b1msakl%c4%b1+plaj%c4%b1">sarımsaklı plajı</a>)<br/>(bkz: <a class="b" href="/?q=setur+ayval%c4%b1k+marina">setur ayvalık marina</a>)<br/>(bkz: <a class="b" href="/?q=sevim+ve+necdet+kent+kitapl%c4%b1%c4%9f%c4%b1">sevim ve necdet kent kitaplığı</a>)<br/>(bkz: <a class="b" href="/?q=%c5%9feytan+sofras%c4%b1">şeytan sofrası</a>)<br/>(bkz: <a class="b" href="/?q=ta%c5%9f+kahve">taş kahve</a>)<br/>(bkz: <a class="b" href="/?q=zeytin+%c3%a7ekirdekleri">zeytin çekirdekleri</a>)
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    vakitsizlik.<br/><br/>aklımda çok fazla şey var yapmak istediğim. bir yıllık kendime zaman ayırma molası istiyorum. bunun havalı bir adı vardı da unuttum.<br/><br/>edit: sabat yılı deniyor. @uzuni hatırlattı.
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    fevkalade basit bir farktır.<br/><br/>aşk, normalde insan yerine koyup beş dakika konuşmayacağınız tiple kendinizi sok amıma, otur sikime derken bulmanıza sebep olurken; sevgi, normalde tipsiz, çirkin diyeceğinizle sevişmenize yol açar.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    3 şubat 2019 tarihinde oynanan antalya-beşiktaş maçında olmayan pozisyonda inanılmaz bir penaltı yaptırıp 40 metreden kullanılan serbest vuruşu sektirerek 2.gole de katkısını gördükten sonra futbolcu şansızlığı yaşayan kaleci diyeceğim ama bu ülkede bunun yüzde 1'i hatalara şike yorumu yapan o kadar çok geri zekalı var ki onlar muhtemelen gelir buradada şike var derler.
  entry_channels: spor
- entry_name: |
    bülent korkmaz
  entry_id:  86273090
