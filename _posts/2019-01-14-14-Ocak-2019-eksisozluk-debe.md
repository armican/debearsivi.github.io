...
- entry_name: |
    onur kıvrak
  entry_id:  85454128
  entry_writer: mutluluk hormonu isportacisi
  entry_fav_count: 32
  entry_content: |
    bu adam trabzonspor'dan keriz siker gibi senelik 3.2 milyon euro alıyordu. yani senede 20 milyon lira. bundan sonra herhangi bi takımdan bu adama gelecek en yüksek teklif yıllık 1-2 milyon lira civarı olur. ben ne futbol oynayacam artık deyip futbolu bırakmıştır eminim.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 25
  entry_content: |
    isa, havva, meryem gibi hristiyan mitolojisinden alınan isimlerle, bir çeşit incil efsanesi kahramanlarıymış gibi görünen aile. bir de recep tayyip var tabii. sanki bol göndermeli bir edebi metinle karşı karşıyayız.
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    yukarıda bir arkadaş yazmış kuyumcusu daha iyi faiz veriyormuş. şimdi bu arkadaş faizi alırken iyi yarın bu kuyumcu batınca kuyumcubank skandalı diye başlık açıp mağdur olduk devlet paramızı versin , adamı hapse atsın diye ağlayacak , anla kardeşim sen tefecilik yapıyorsun zaten zordaki adama para veriyorsun eninde sonunda o adam seni öpecek ,o zaman gelip buraya ağlama.
  entry_channels: teknoloji,ekonomi
- entry_name: |
    bayat ekmeği değerlendirme yöntemleri
  entry_id:  85448239
  entry_writer: isen buga
  entry_fav_count: 12
  entry_content: |
    yumurtalı ekmek.<br/>üstüne tanımam.<br/><br/>tost da diğer alternatif.
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    o kız doktorun emniyetidir kusura bakmayın da .<br/><br/>ondan sonra vay doktor bana tecavüz etti dendiğinde bir tek şahidi olmuyor doktorun . fahrettin cüreklibatur bir belgeselinde ben daha şalvarın altından iğne yapamadım diyor burası türkiye , farkında mısınız ?
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    (bkz: <a class="b" href="/?q=dabi+dabi">dabi dabi</a>)<br/><br/>edit: anladık ki dizide dabi dabiden başka bi bok yokmuş.
  entry_channels: anket
- entry_name: |
    man adası gerçekleri belgeseli
  entry_id:  85455373
  entry_writer: benburayaciplakgeldim
  entry_fav_count: 6
  entry_content: |
    "kemal kılıçdaroğlu gibi koltuk sevdalısı kişiler beceriksizliğini kabul edip istifa etmediği sürece daha ne belgeseller izleriz" diyebileceğim belgeseldir.
  entry_channels: siyaset,haber
- entry_name: |
    cumhuriyet rejiminin kadını özgürleştirdiği yanlış
  entry_id:  85452096
  entry_writer: doruk bey
  entry_fav_count: 6
  entry_content: |
    2012, acilim, akil insanlar ve taraf gazetesi akp is birligi anahtar kelimelerini animsatan feminist, hdp kokulu sosyoloji profesoru kadin aciklamasidir.<br/><br/>kemalizm elestirirken yine baska bir kemalizm dusmani tarafindan tutuklanmasi an meselesidir. <br/><br/>bugun bunca dert varken tutup su konudan dem vurmak kadar insanin tarafini ve fikirlerini gosteren az veri vardir.<br/><br/>eheheh ama racon bu. ıngiltere'de de feminist kadinlar sadece o ulkenin milletine ve sistemine dusman diye seriatci muslumanlara arka cikiyor. halbuki adamlar gorse taslayacak bunlari.
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    kayıtlara atatürk’e düşmanlığından ensest savunmasıyla geçecek, suyu emiklenmiş gibi duran teyze. <br/><br/>biliyorsun taylansu, cummuriyet tek tip vatandaş ister ve insanlara zorla şapka giydirdiler:((( sık gelir misin peki boğaziçi sosyolojiye??;))
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    “x kişisinin yaptığı şu hareketi yapamazdı” diye eleştirilen black jesus’tur. <br/><br/>büyük insandır, komple sporcudur, konu hareket çekmekse jump shot denerken havada 180 derece dönebilmiş insan evladıdır.<br/><br/>örnek olması açısından;kendisine yaklaşabilen en bilinen iki isim le bron ve kobe’dir. gerisini siz düşünün.
  entry_channels: spor
- entry_name: |
    günlük 50 tl ile yaşamak
  entry_id:  85474292
  entry_writer: pisagorte
  entry_fav_count: 4
  entry_content: |
    kira ve borcun yoksa bile az paradır.<br/><br/>yukarıdaki şartlarda bile , istanbul'daysan hiç birşeydir o para. ama yozgat'taysan harca harca bitmez(bkz: <a class="b" href="/?q=yozgat">yozgat</a>)
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    sizinle henüz iletişim kurulmamış olması, dünyalılar ile iletişim kurulmadığı anlamına gelmeyeceği için doğruluğu kesin olmayan önerme.<br/><br/>mezardakiler dahil dünyadaki herkese (herkesin içerisine hayvanlar da dahil) sormadan kimse emin olamaz.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    (bkz: <a class="b" href="/?q=gavat">gavat</a>)
  entry_channels: 
- entry_name: |
    ekşi itiraf
  entry_id:  85455297
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    whokares abisi, standard bir beyaz amerikali için sen hiçbir zaman onların seviyesinde olamayacaksın. seni asla kendilerinden biri gibi görmeyecekler, asla seni gerçekten sevmeyecekler... sevmeyecekler... sevmeyecekler... ühüüüüü! <br/><br/>hadi toparlanın türkiye'ye dönüyoruz. orada bizi sevecekler. hem de çok sevecekler.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ilk yarı yüksek tempolu geçti. tottenham’da sisokko’nun sakatlanması takımı çok kötü etkileyecek. orta sahada oynatacak adam neredeyse yok. hepsi sakat. <br/><br/>pogba’nın asisti de takdire şayandı. <br/><br/>ilk yarıyı 1-0 united, rashford’ın golüyle önde kapattı.
  entry_channels: spor
---
