...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    (bkz: <a class="b" href="/?q=don+%c5%9fuan">don şuan</a>)
- entry_name: |
    stefan hawking için izmirde lokma döktürülmesi
  entry_id:  75356563
...
- entry_name: |
    askkadiniyimdirbelki
  entry_id:  75342469
  entry_writer: kullanimdaolmayannickarayancaylak
  entry_fav_count: 4
  entry_content: |
    2 mesaj yollamış, "burdaki yazı sana mı ait?" diyerek bir link yolluyor. bunlara karşı bir önlem alınması gerekiyor artık. 1 yıldan az çaylak olanlara mesaj hakkı tanınmaması gibi mesela.
- entry_name: |
    meral akşener
  entry_id:  75342733
  ...
  entry_fav_count: 3
  entry_content: |
    iyi parti'nin trabzon il başkanlığı açılışındaki miting konuşmasını izledim.<br/>etkili bir konuşma idi. söylediği bir laf mealen şu idi:<br/>-fındıkçılar, eğer mazot niye bu kadar pahalı diye hakkınızı aramaya kalkışırsanız "tutuklanırsınız"<br/>-fındıkçılar, eğer elektrik niye bu kadar pahalı diye hakkınızı aramaya kalkışırsanız "tutuklanırsınız"<br/>-fındıkçılar, eğer genel olarak fındık için hakkınızı aramaya kalkışırsanız "tutuklanırsınız"<br/>-tutuklanırsınız...
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    (bkz: <a class="b" href="/?q=y%c4%b1ld%c4%b1ray+ba%c5%9ft%c3%bcrk">yıldıray baştürk</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    2 saat önce tam uyumaya hazırlanırken ilk bölümü biraz izleyeyim dedim ve şu an 2. bölümün ortalarındayım çok rahat bir şekilde izlediğim en iyi dizilerden biri olabilir hem yerli hem yabancı diziler dahil buna.oyunculuklar sahneler senaryo kalite kokuyor resmen.haluk bilginer öyle mükemmel bir oyuncu ki hangi role girse izlediğiniz kişinin haluk bilginer olduğunu unutuyorsunuz role inanıyorsunuz bunu yapabilen oyuncu sayısı kaçtır acaba.umarım devam eder.<br/><br/>bu arada ezel'den bu yana cansu dere'yi ilk defa bir projede görüyorum kadın şarap gibi yıllar geçtikçe dahada güzelleşmiş izlerken mest ediyor insanı.
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    cok fazla uzuldugum haberdir. eger isterlerse davalarina bakabilecek birilerini taniyorum. ıban numarami ozelden atarim ben.<br/><br/>(bkz: <a class="b" href="/?q=yetmez+ama+evet">yetmez ama evet</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    berlin'de staj yapmak isteyen erasmus+ hibeli adaylar başvurabilir.<br/><br/>sneakerlar üzerine açılacak bir online pazaryeri girişimi için:<br/><br/>- çok iyi derecede ingilizce ve/veya almanca bilen (bu dillerde çok ciddi yazılı ve sözlü mülakat yapılacak, let's continue in english veya lass uns auf deutsch weiterreden denecek, o yüzden başvurmadan önce emin olmakta fayda var)<br/>- tercihen sneakerlara ilgi duyan, marka ve modelleri, limited editionları, blogları ve dergileri takip eden, <br/>- staj için 6 ay ayırabilecek erasmus+ hibeli (çok önemli - diğer türlü vize için bürokrasi çok fena, denendi, olmadı) <br/><br/>öğrenciler aranıyor. <br/><br/>görevler ağırlıklı online pazarlama, sosyal medya, vendor management ile ilgili olacak.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    yakında otomobillerimize binebildiğimiz için bazılarımıza sokakta zengin gözüyle bakılmasını sağlayacaktır.<br/>(bkz: <a class="b" href="/?q=ooo+zengin">ooo zengin</a>)
- entry_name: |
    la casa de papel
  entry_id:  75347275
  ...
  entry_fav_count: 0
  entry_content: |
    abi, kadınlardaki o burun ne öyle ya? yemin ederim her kadının burnundan üç burun çıkar.
---
