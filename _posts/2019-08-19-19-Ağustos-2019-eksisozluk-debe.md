...
- entry_name: |
  ...
  entry_fav_count: 49
  entry_content: |
    metin hara'nın faaliyetine bilim diyen adam zaten gitsin acilen bir <a class="b" href="/?q=iq">iq</a> testi yaptırsın.<br/><br/>başka sözüm yok...
  entry_channels: ilişkiler,magazin
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 29
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.passportindex.org/byRank.php">https://www.passportindex.org/byrank.php</a><br/><br/>canınız sıkıldıkça bakarsınız
...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    jüriye türkçe cümle kuramayan bir adamı almak kimin fikriydi bilmiyorum. olmamış.<br/>ayrıca koskoca türkiyede şu jüride yer alacak bir kadın şef yok mu gerçekten?<br/>jüri 2 sezondur askerlik şubesi gibi resmen.
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    gol makinesi diye aldık viking kralı çıktı amk.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    kendisinde sonradan açılan türbanlı kız tipi var.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    hayırlı olsun ilk okul 1. sınıf'ı bitirdin de mi buraya geldin iyi yarışmalar.
  entry_channels: 
- entry_name: |
    berat albayrak'ın soylu'ya tokat atması
  entry_id:  94115384
  ...
  entry_channels: 
- entry_name: |
    360 derece değişiyorsun diyen kız
  entry_id:  94114840
  entry_writer: thehampaci
  entry_fav_count: 4
  entry_content: |
    matematiği zayıftır ama fiziği kuvvetliyse eksiğini kapatabilir.
  entry_channels: 
- entry_name: |
    yabancı öğrenciyi ölümle tehdit eden komşu
  entry_id:  94109056
  entry_writer: north blue
  entry_fav_count: 3
  entry_content: |
    gırtlağını keserim diyen ıraklı çocuk olsaydı eyvah ki eyvah! misafir getirme diyor, git köyünde otur o zaman istanbul'da ne işin var?
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    kampa gitmek istiyorum biriniz de demiyorsunuz ki beraber gidelim
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    yağmur ve kapalı hava seven insan
  entry_id:  94079449
  entry_writer: arada kalmis meta tutkunu
  entry_fav_count: 0
  entry_content: |
    hayata penceresi olmayan insanların somut ve ebleh bir pencereye oturup dışarıyı izlemekten duyduğu gereksiz hazzı size nasıl anlatayım? ilk aşk gibi bir şey, ama böyle hüzünlü de. böyle uzaktasın güvendesin, ama altında da olasın var. sen güvendesin, ama ıslananlar var.
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    iki genci düşünün: birinin çok parası var, bmw'nin son model arabasını almış. diğeri de fakir, zar zor fiat uno alabilmiş. bmw'nin sahibi aşırı hız yapıp ters şeride geçiyor ve kurallara uyan fiat uno'yla kafa kafaya çarpışıyor. bmw sahibine bir şey olmuyor ama fiat uno sahibi genç ölüyor.<br/><br/>bunu neden anlattım, adaletsizlik her yerde. parası olmadığı için bedelli yapamayıp gidip şehit olan da aynı durum maalesef. keşke herkes eşit şartlarda olsa ama ne yazık ki bu mümkün değil ama bedelli askerliğe gelene kadar çok şey var.
  entry_channels: 
---
