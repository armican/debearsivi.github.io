...
data:
- entry_name: |
    baktım emmanuel macron garip garip şeyler söylüyor
  entry_id:  75542710
  entry_writer: wolky arda
  entry_fav_count: 458
  entry_content: |
    (bkz: <a class="b" href="/?q=sonra+anlad%c4%b1m+ki+frans%c4%b1zca+bilmiyorum">sonra anladım ki fransızca bilmiyorum</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 390
  entry_content: |
    son 25 yıl için geçerli olan gerçek. aynı dönemde;<br/><br/>almanya'da tek büyük olduğu dünyaca kabul edilen bayern münih'in 14<br/>alex ferguson'a sir ünvanı kazandıran man utd'nin 13<br/>italya'nın şu an tek büyüğü 6 yıldır şampiyon olan juventus'un 12<br/>iki takım dışında çöp denilen la liga'da barcelona'nın 10 rakibi, real madrid'in 8<br/><br/>şampiyonluğu var.<br/><br/>değerli rakiplerimize içinde uefa kupası ve süper kupa olmayan bir argüman sunuyorum. açık ara ülkenin en başarılı kulübü bu iki kupa olmasa da galatasaray'dır, özellikle 2 yıl şampiyon oldular diye havaya giren renksizler iyi okusun.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    sorunlarını yazmaktansa sorun olmayan şeyleri yazmak daha mantıklı. evet dokununca açılıyor geçekten de çok başarılı bir ar-ge ve yazılım başarısı, tebrikler!<br/><br/>soru: <a class="b" href="/?q=nerde+yapt%c4%b1rd%c4%b1n%c4%b1z+bunu+afrikada+m%c4%b1%3f">nerde yaptırdınız bunu afrikada mı?</a>
- entry_name: |
    aziz yıldırım
  entry_id:  75541423
...
- entry_name: |
  ...
  entry_id:  75530057
  entry_writer: cometobeat
  entry_fav_count: 6
  entry_content: |
    bebek kokusu kesinlike evlilikten uzak olan bünyemi evliliğe yakınlaştıran bir büyüsü var biz hala eş dost alraba ortamlarında bebek sevelim..
- entry_name: |
    sevgilisi olan bir kadına bile bile yazan erkek
  entry_id:  75547782
  entry_writer: haginese
  entry_fav_count: 5
  entry_content: |
    bir kız karşılık vermediği sürece hiç bir erkek bariz bir şekilde sevgilisi olan kıza yazamaz. ha kendi içinde yaşadığını az çok belli eder karşı tarafa ama bu sadece bir kaç jestten öteye geçemez. <br/>ama eğer ki kız karşı tarafın kendisine olan hislerini bilmesine rağmen bunu aleni şekilde göstermesine izin veriyorsa ve bir şekilde bunun devamına yönelik karşılıklar veriyorsa, burada suçlanması gereken kişi kızdır, erkek değil. zaten kız eğer erkek arkadaşı var gibi davranmıyor, bunu karşı tarafa hissettirmiyor, çizgiyi çizmiyorsa, kendisinden etkilenmiş olan erkeğe de, o anki sevgilisine de hatta ve hatta kendisine de yalan söylüyor ve aldatıyordur.
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    hiç güzel bi kadın değilim.... ama sevenim hiç eksilmez...<br/><br/>güzel gülerim. güzel sarılırım. halden anlarım. çare olmaya çabalarım, umut saçarım, omuz veririm , dinlerim, minicik şeylerle mutlu olurum, kendime ait yüklerimi kendim çekerim, kimsenin hayatına yamanmam, özenmem , sevmeyene sevsin diye takla atmam, istenmediğim kalpte durmam, yapacağımı edeceğimi kimseye sormam.... benim olan yanlarımı adamına göre maske gibi takıp çıkarmam....<br/><br/>tümmm bu niteliklerim olunca da kendimi hiç çirkin bulmam.<br/><br/>güzellik tek başına emekliyemiyen, yürüyemeyen, yol almayan bi araç bence.
- entry_name: |
    ali koç
  entry_id:  75535067
...
- entry_name: |
    veganların ve feministlerin fazla asabi olması
  entry_id:  75534597
  entry_writer: harlemzencisi
  entry_fav_count: 3
  entry_content: |
    (bkz: <a class="b" href="/entry/75533090">#75533090</a>)<br/><br/>al sonra da aşağılık kompleksi bilmem ne. ulan karşı taraftaki daha baştan saygı duymadan başlıyor işe sen neyin asabiyetinden bahsediyorsun. <br/><br/>feminizm konusunda da aynı. entrylerin yarısı direk "bi sikişseler rahatlayacaklar" diye giriyor mevzuya. <br/><br/>hadi gelin sakin sakin tartışalım bu konuları. <br/><br/>teşekkürler.
- entry_name: |
...
- entry_name: |
    boğaziçi üniversitesi'ni çalkalayan mail
  entry_id:  75553789
  entry_writer: fetch me some wine will ya
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=ger%c3%a7ek+bakanl%c4%b1%c4%9f%c4%b1+bunu+be%c4%9fendi">gerçek bakanlığı bunu beğendi</a>)
- entry_name: |
    ben robot değilim
  entry_id:  75553640
...
- entry_name: |
  ...
  entry_id:  75531528
  entry_writer: mrgeneral
  entry_fav_count: 0
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=Lz49d94NLzc">https://www.youtube.com/watch?v=lz49d94nlzc</a>
---
