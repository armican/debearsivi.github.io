...
- entry_name: |
    uğur dündar'ın bile chp'li belediyeyi eleştirmesi
  entry_id:  91342372
  entry_writer: xxiiidec
  entry_fav_count: 24
  entry_content: |
    takım tutar gibi parti tutanlara dert olmuştur.<br/><br/>herkes kendi partisini eleştirdiği zaman daha güzel olacağını bir türlü anlayamadınız.
  entry_channels: siyaset,haber
- entry_name: |
    türkiye'de tatil yapılacak en güzel yer
  entry_id:  91334087
  entry_writer: bach baba
  entry_fav_count: 23
  entry_content: |
    buraya yazacak değiliz!
...
- entry_name: |
  ...
  entry_fav_count: 22
  entry_content: |
    çok iğrenç geliyor bu ve benzeri sünnet komiklikleri bana.
...
- entry_name: |
    fatih portakal
  entry_id:  91319887
  entry_writer: tipindenbelli
  entry_fav_count: 10
  entry_content: |
    kripto falan olduğunu düşünmüyorum, böyle misyonlar yüklememek lazım. araştırmadan, netleştirmeden ve güvensiz bir kaynaktan gelen(bunlar gazeteciliğin en önemli ilkeleri oysaki) bir habere <a class="b" href="/?q=objektif">objektif</a> imajı yaratmak için atladı. altında kaldığı bu olaydan da geri adım atamadığı için her geçen gün daha çok ezildi(yüzünden belli oluyor, üzülüyorum) ve saçma sapan bahanelerle olayı geçiştirmeye çalışıyor. ancak çok geç<br/><br/>adettendir tanım : eski bir gazeteci.
  entry_channels: siyaset,tv,haber
- entry_name: |
    inşaat mühendisliği
  entry_id:  91342104
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    erkek gay'lerin babalar günü
  entry_id:  91333138
  entry_writer: kedigozu
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=erkek+gay">erkek gay</a>)
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    yazan olmuş ve doğru yazmışlar; fare altlığı. en mantıklısı bu.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    yukarı taşınmaya ihtiyacı var konunun
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ekşi sözlüğü istanbul olarak düşünürsek bu başlık da esenler otogarının alt katıdır. <br/><br/>ırz düşmanlarının uğrak yeri. bir de ot falan içeriz diyor at organı.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
