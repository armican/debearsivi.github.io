...
- entry_name: |
  ...
  entry_fav_count: 31
  entry_content: |
    şampiyonlar ligini kazanıp<br/>liginde 8 de 8 yapıp<br/>tarihinin en iyi dönemlerini geçirirken ekşi sözlükte beğenilmeyen futbol kulübüdür.
  entry_channels: spor
- entry_name: |
    joker
  entry_id:  96203770
...
- entry_name: |
    manchester united
  entry_id:  96219444
  entry_writer: benim ne isim var ulan bodrumda
  entry_fav_count: 2
  entry_content: |
    bir instagram apaçisinin oyuncağı olmuş takım. günü kurtaran hamleleri bırakıp geleceğe yönelik planlar yapmalıdır.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=9hvA0wWTIv4">https://www.youtube.com/watch?v=9hva0wwtiv4</a><br/><br/>(bkz: <a class="b" href="/?q=i+put+a+spell+on+you">i put a spell on you</a>)
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=zer0">zer0</a>)
