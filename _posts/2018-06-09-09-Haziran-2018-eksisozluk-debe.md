...
- entry_name: |
    25 haziran 2018 sp'nin barajı geçmesi
  entry_id:  77863925
  entry_writer: az gelismislik az gelismisliktir
  entry_fav_count: 23
  entry_content: |
    moderatörün düzeltmeye korktuğu başlık. geçmesi mi geçememesi mi amk.
  entry_channels: 
- entry_name: |
...
- entry_name: |
    rte'ni okul arkadaşının ortaya çıkması
  entry_id:  77851382
  entry_writer: well cooked
  entry_fav_count: 20
  entry_content: |
    arkadaşının olması kadar şaşırtmamıştır.
  entry_channels: siyaset
- entry_name: |
    ekşi itiraf
  entry_id:  77834177
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    türkiye için<br/>fenerbahçe için<br/>kendisi için en iyi ihtimaldir kesinlikle. <br/>yukarıda yazmışlar zaten hocalık özelliklerinin milli takıma daha uygun olduğu yinelemeye gerek yok.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    durduk yere şeytan dürtüyor beni belki ama şu sahurda bira içeriz laflarının şaka olmasını umuyorum.<br/>“kabataş’ta camide bira içtiler” haberciliğinden sonra zaten böyle bir habere balıklama atlar havuz medyası.<br/><br/>oruç tutmuyorum, gün ayırmaksızın yılın istediğim gününde içki içiyorum ama bu miting süresince özellikle bu tür görüntüler peşinde koşacak çok insan var. hani böyle her şey yolunda giderken saçma sapan bir sebepten her şey rayından çıkar ya, öyle bir şey olacak diye çok korkuyorum. bir de bu kadıköy’de olursa kahrolurum.<br/><br/>gece orada olmak için program yapıyorum, bir aksilik olmazsa gelip sağda solda bira içenlerin eline kefir tutuşturacağım. taşkınlık yapanı direkt kalamış’tan denize dökeceğim, en fazla moda sahilden çıkar orda rahat rahat içerler.<br/>bir gece durun allah aşkına, zaten ortalık karışık.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
    ali koç'un mali tabloları görünce şoke olması
  entry_id:  77864844
  entry_writer: illuminatron
  entry_fav_count: 12
  entry_content: |
    eğer olur da erdoğan yerine bir başka aday cumhurbaşkanlığını kazanırsa göreceği tablo karşısında geçireceği şokun yanında devede tüy bile olmayan şoke olma halidir.
  entry_channels: spor
- entry_name: |
    anthony bourdain
  entry_id:  77852875
...
- entry_name: |
    bir seçim vaadi olarak bedava kek ve çay
  entry_id:  77862813
  entry_writer: tearhunter
  entry_fav_count: 10
  entry_content: |
    dereotlu poğaça da olacak mı ?<br/>olacaksa kusura bakmasınlarn nefret ederim. benden oy moy yok.<br/>blueberry muffin varsa düşünmeye değer tabii ki.
  entry_channels: 
- entry_name: |
    akp'nin başörtüsü yasağıyla ilgili reklam filmi
  entry_id:  77863995
  entry_writer: yagsag
  entry_fav_count: 10
  entry_content: |
    (bkz: <a class="b" href="/?q=siyasal+islam%27%c4%b1n+i%c4%9fren%c3%a7li%c4%9fi">siyasal islam'ın iğrençliği</a>)<br/><br/>bu arada imam hatipler kapatılsın.
  entry_channels: 
- entry_name: |
    ramazanda içki içen gavurlar
  entry_id:  77865190
  entry_writer: siradan biri one
  entry_fav_count: 9
  entry_content: |
    engelle geç döl israfı yazar beyanı
  entry_channels: 
- entry_name: |
    istanbullu gelin
  entry_id:  77863594
  ...
  entry_fav_count: 8
  entry_content: |
    faruk da konağı, herşeyimizi kaybedicez diye ne panik oldu be kardeşim. isviçre'de hiç mi paranız yok, ne biçim holding sahibisiniz. işi batınca kendisi de batan tek holding sahibi olarak tarihe geçeceksiniz.
  entry_channels: tv,magazin,spoiler
- entry_name: |
    eşcinsellerin hdp'ye oy vermesi
  entry_id:  77863477
  entry_writer: renksiz hayat
  entry_fav_count: 7
  entry_content: |
    parti programında lgbti vatandaşlarımıza yer veren tek çağdaş parti hdp'dir. tek başına oy verme sebebidir. tüm örselenmiş, dışlanmışların sığındıkları evdir hdp.
  entry_channels: siyaset
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    herkes sevdiklerinin meleği, sevmediklerinin de şeytanıdır. dolayısıyla şeytan da melek de aynı kişi.
  entry_channels: ilişkiler
- entry_name: |
    robert pires'in galatasaray'a transferi
  entry_id:  77863691
  entry_writer: doktor mussak
  entry_fav_count: 4
  entry_content: |
    (bkz: <a class="b" href="/?q=haim+fresco+devreye+girdi">haim fresco devreye girdi</a>)<br/>sırada gallardo var.
  entry_channels: spor
- entry_name: |
  ...
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    iyi parti'nin chp aramasına reklam vermesi
  entry_id:  77864855
  entry_writer: eksi peace
  entry_fav_count: 3
  entry_content: |
    (bkz: <a class="b" href="/?q=%c3%a7en+a%c3%a7%c4%b1%c4%9f%c4%b1m%c4%b1z%c4%b1+m%c4%b1+buldun+%c5%9fap%c5%9fik+%c3%a7ey">çen açığımızı mı buldun şapşik çey</a>)<br/><br/>devamında oyum doğu perinçek’e yazmamışsın ama şaşırtıyorsun beni. seni küçük şirin perinçektroll.<br/><br/>abartılmaması gereken olay, ittifak bile olsa her parti kendi koltuk sayısını önemseyecek ve buna göre hareket edecek. bilmeyenler açsın ittifak sisteminin ne olduğunu ve niye ittifak bölümünde partilerin ayrı ayrı tercih alanı olduğunu araştırsın.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  77864892
  entry_writer: moog modular
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=bel+f%c4%b1t%c4%b1%c4%9f%c4%b1">bel fıtığı</a>) vs (bkz: <a class="b" href="/?q=boyun+f%c4%b1t%c4%b1%c4%9f%c4%b1">boyun fıtığı</a>)
  entry_channels: 
- entry_name: |
    sense8
  entry_id:  77852234
  entry_writer: ugurbocukuu
  entry_fav_count: 1
  entry_content: |
    hiç bir sahnesi izlerken beni rahatsız etmedi. oyuncuların ne kadar cesur olduklarını düşündüm hep. çok ilginç bir şekilde hepsiyle bir bağ kuruyorsun izlerken. yalnızken mutsuzken senin nasıl hissetiğini bile hisseden birilerinin olması düşüncesi inanılmaz güzel değil mi? kısacası yalnız hissetmemek. iple çekiyordum bu günü, biran önce eve gidip bu cuma akşamını legen wait for it daaaaary yapmak istiyorum!
  entry_channels: tv
- entry_name: |
    davy klaassen
  entry_id:  77863311
  ...
  entry_fav_count: 1
  entry_content: |
    eğer haber doğruysa bir galatarasaraylı olarak çok kıskanacağım transfer. elmander'in oyun kurucu modeli.
  entry_channels: spor
- entry_name: |
    9 haziran 2018 cleveland cavs gs warriors maçı
  entry_id:  77854490
  entry_writer: jalal
  entry_fav_count: 1
  entry_content: |
    warriors'ın bu playofflarda eşleştiği 3 takım da warriors'a karşı en az 1 maç kazandı. <br/><br/>spurs ve pelicans 1'er maç kazandılar. rockets da 3 maçta üstün geldi. süpürdükleri tek takım cavaliers olacak gibi. bu maç lebron ve saz arkadaşları için onur mücadelesi olacak o bakımdan<sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    inter forvetlerinin ronaldo, zamorano, vieri, ventola, recoba beşlisinden ikisi olduğu yıllar. bu arada juventus'ta filippo inzaghi, kovacevic, del piero, esnaider, fonseca var.
  entry_channels: spor
- entry_name: |
    genel merkezin talimatıyla yazan troll chp'liler
  entry_id:  77854144
  entry_writer: jilsandersun
  entry_fav_count: 0
  entry_content: |
    ak partili trollerin chp'li trollere yükseldiği başlık. <br/><br/>sanırsam 10 ak trolle 1 chp trollü falan denk geliyordur sozlükte. genel merkezin talimatıyla yazsa ne olacak, siz adama müslüman mahallesinde salyangoz sattırır mısınız be.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    3 tane nerd metabolik sendromun soğuk savaş başlığı altında misafirleriyle karşılıklı anlamsız çığlıklar attığı youtube kanalı.
