...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    kendini ona göster ama onunla hiç ilgilenme.
  entry_channels: anket,ilişkiler
- entry_name: |
    bir ateist ile arkadaş olmak
  entry_id:  77840098
  entry_writer: fliegend
  entry_fav_count: 12
  entry_content: |
    bir ateistle sevgili olarak katmerlediğim olaydır. eski sevgilim kulakları çınlasın ateistti ama bir gün tutsam kolundan alsam götürsem aileme, sırf türk olduğu için direk müslüman olduğunu varsayar bunu sorgulamazlardı bile. şimdi yurt dışında yaşadığım, zaten ne türkleri, ne de ilişki yaşayışlarını sevmediğim için annem tahmin ediyor yabancılarla çıktığımı/çıkacağımı durup durup "hristiyan bir damat getirirsen redderim seni!!!" seni diye yakarıyor. aney aney! hristiyanı sen öp de başına koy! adam katolikti, iyi kötü allah'a peygambere inancı vardı. bir öncekinde o da yoktu!
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: siyaset
- entry_name: |
    yemek sektöründe çalışanların iyi bildiği şeyler
  entry_id:  77847840
  entry_writer: sherlockholbes
  entry_fav_count: 4
  entry_content: |
    künefe veya baklava gibi tatlıların üstündeki yeşillik çok koyu ise muhtemelen antep fıstığı değil bezelyedir.
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    8 haziran 2018 almanya suudi arabistan maçı
  entry_id:  77861619
  entry_writer: bolsheviks
  entry_fav_count: 2
  entry_content: |
    almanya'da, ikinci yarı klose ve ballack'tan birer gol beklediğim maç
  entry_channels: spor
- entry_name: |
    inşallah şehir hastanelerinin müşterisi artacak
  entry_id:  77835408
  entry_writer: mertkil
  entry_fav_count: 1
  entry_content: |
    çok sağlam bir deney ürünü değilsek gerçekten feci bir vaziyette olduğumuzu gösteren bir başka söylem.<br/><br/>bu adamlar neler demedi ki? hepsini tek tek buraya yazacak ya da bakınız verecek değilim. hepsini de biliyoruz zaten. umarım bir deneyizdir. belki bokumuzda boğulurken dünya'ya bir katkımız olur. <br/><br/>tanım: büyük bir sürpriz olmazsa türkiye cumhuriyeti cumhurbaşkanlığı seçimini kazanacak olan adamın "halkı" hasta edecek bir lafı.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    çok bekledik be reis.
  entry_channels: spor
- entry_name: |
    daha iyisini bulacağını sanan kız yanılgısı
  entry_id:  77863371
  entry_writer: badin
  entry_fav_count: 0
  entry_content: |
    seni terk ettilerse mutlaka daha iyisini bulacaklardır.<br/><br/>tespitlere bak ya, mal mal.
  entry_channels: ilişkiler
---
