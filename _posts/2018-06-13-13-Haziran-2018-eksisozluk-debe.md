...
- entry_name: |
  ...
  entry_id:  77993918
  entry_writer: whatsupyo
  entry_fav_count: 53
  entry_content: |
    dostum bu bildiğin (bkz: <a class="b" href="/?q=eternal+sunshine+of+the+spotless+mind">eternal sunshine of the spotless mind</a>)
...
- entry_name: |
  ...
  entry_id:  77968580
  entry_writer: pharmak
  entry_fav_count: 16
  entry_content: |
    saatlerce ders çalışmak kelime öbeğini okurken bile stres bastı. nicelikten ziyade nitelik onemlidir arkadaslar. <br/>benim en cok verim aldığım calisma sekli farklı kaynaklari onume acarak tek konuyu farkli perspektiflerden incelemektir. konuyu incelerken ögrendiginizi farketmiyorsunuz. calisma bitip de birileri ile sohbet ederken kendinizi adeta akademik ders verirken bulabilirsiniz. bu sekilde calistigim konulari hala hatirlarim (mezuniyet:2011, eczacilik)
