...
- entry_name: |
    türklerin tarihi düşmanı
  entry_id:  81067856
  entry_writer: nedemekulan
  entry_fav_count: 36
  entry_content: |
    türklerin kendisidir. unutmayın atatürk düşmanla 4 sene cahil türklerle 15 sene savaşmıştır. düşmanı tankla tüfekle yenmek kolay, cehaleti neyle yeneceksiniz?
...
- entry_name: |
  ...
  entry_fav_count: 28
  entry_content: |
    bunu eleştiren tipin de götünde seher yıldızı don yoksa ben de başka bir şey bilmiyorum.
  entry_channels: anket,moda
- entry_name: |
    milli maçların artık kimsenin umrunda olmaması
  entry_id:  81066735
  entry_writer: hadi git
  entry_fav_count: 25
  entry_content: |
    eskiden milli maç deyince akşamı zor ederdik. şimdi milli maç var, tv’yi bile açmadım. sadece bundan bile çok acıklı bir hikaye yazılır ama hepiniz biliyorsunuz uzun uzadıya yazmaya gerek yok. teşekkürler süpermen!
  entry_channels: spor
- entry_name: |
    ekşi itiraf
  entry_id:  81037850
...
- entry_name: |
    izmir deki pis kokuyu izmir'li olmayanların alması
  entry_id:  81067672
  entry_writer: comworldmastereng
  entry_fav_count: 8
  entry_content: |
    5 senedir izmir'de yaşıyorum. bok kokuyor şahidim.
...
- entry_name: |
    serel yereli
  entry_id:  81062138
  entry_writer: feodal bey
  entry_fav_count: 5
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=lVrZM1RSLmE&amp;feature=youtu.be" title="https://www.youtube.com/watch?v=lVrZM1RSLmE&amp;feature=youtu.be">https://www.youtube.com/…rzm1rslme&amp;feature=youtu.be</a><br/><br/>yeni şarkısı türkiye standartlarının kat kat üstünde olmuş<br/>eminimki ilk kıyaslanacağı kişi aleyna tilki olucak şöyle söyleyim<br/>aleylanın ulaşmak istediği çıtadan başlangıç yapmış nekadar kıyaslasalarda boş .
  entry_channels: tv,magazin
- entry_name: |
    şener özbayraklı
  entry_id:  81069051
  ...
  entry_fav_count: 4
  entry_content: |
    maçı götüyle izleyenlerin kendisine saydırdığı futbolcu. düzgün oynayan, deneyen bir o var lan.<br/><br/>hasan ali kaldırım kazması top almadığı için mi kötü oynamıyor gözükmekte.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    "ey sevgili…! <br/>güneş de benden uzakta, ay da..!<br/>ama hiçbir sabahım güneşsiz..<br/>hiç bir gecem aysız geçmiyor.. <br/>tıpkı yüreğim senden vazgeçemediği gibi..!<br/>tesbih gibi çektim seni; gelirrr, gelir, gelir diyee. "<sup class="ab"><a title="(bkz: alıntı)" href="/?q=al%c4%b1nt%c4%b1" data-query="alıntı">*</a></sup>
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    21 takımdan oyuncu alıp takım kurmak zorunda kalıyormuş kıyamam :(<br/><br/>dayı sen hiç zahmet etme, oynamak isteyen kampa gelip sahaya çıksın.<br/><br/>ne demek ulan zorunda kalıyorum, senin işin değil mi bu yavşak herif, niye alıyorsun bu kadar parayı o zaman?
  entry_channels: spor
- entry_name: |
    serdar aziz
  entry_id:  81068524
  ...
  entry_fav_count: 2
  entry_content: |
    ya 5 gün önce ligde sakatlık yüzünden oynamayan adam neden milli takım maçında ilk 11 çıkıyo ? galatasarayın zaten stoperi yok, olanı da milli takıma feda ettik ya. yazıklar olsun
  entry_channels: spor
- entry_name: |
  ...
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    ölümsüz olunca yapılacak ilk şey
  entry_id:  81041334
  entry_writer: wax simulacra
  entry_fav_count: 1
  entry_content: |
    xanax ve lustral depolarım. başka ne yapılır.
  entry_channels: anket
- entry_name: |
    anında uyuyabilen insanlar
  entry_id:  81068236
  entry_writer: zeynepsek
  entry_fav_count: 1
  entry_content: |
    yorgunlukla ilgisi olmadığını düşünüyorum.yorgunluktan uyuyamamak gibi bi olay var ağrı sızı inleye inleye uyursun.<br/>anında uyuyabilen insanlar cindir.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    milli takimin ve avrupanin en buyuk overratedi, bu adam nasil milan'da 10 numara oynuyor diye dusundurendir.
  entry_channels: spor
---
