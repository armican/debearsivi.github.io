...
- entry_name: |
  ...
  entry_fav_count: 29
  entry_content: |
    3 defa kanser, 700 gunden fazla hastane yatisi, sayisiz operasyon, tarifsiz agrilar, sancilar...<br/>hepsine katlandim. neden mi? yasamak cok guzel lan!<br/>1 gün daha fazla yasayabilmek icin her seyimi veririm...<br/>daha asik olacagim, evlat sevgisini tadacagim. <br/>nasipse torun bakacagim. hayali bile guzelken gerceklesmesi halinde yasayacagim mutlulugu dusunemiyorum bile.
...
- entry_name: |
  ...
  entry_id:  90706739
  entry_writer: dedication
  entry_fav_count: 19
  entry_content: |
    üstteki yazar utanmadan, sıkılmadan üç gün önce hakkında dolandırıcılık başlıkları açılan sitenin reklamını yapıyor. en iyi tahminci sizsiniz, böyle dolandırıcıların ağına düşmeyin.<br/><br/>(bkz: <a class="b" href="/?q=tahmingold">tahmingold</a>) başlığında da dolandırıcı olduğunu belirten bir entry var zaten, bunun haricinde sikayetvar'da da hakkında bir sürü şikayet okuyabilirsiniz.
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    geyik olsun diye mi cidden mi yazıyor anlamadığım entepliler ilginç bir mikromilliyetçilik yapmaya başlamış ahshsjfhdh.<br/><br/>adam post truth çağda yaşadığını belli edercesine "500 bin kişilik hatay'ın sesi, 3 milyonluk gaziantep'ten fazla çıkıyor" yazmış. futbol maçını kimin kazanacağıyla ne alakası var bilemedim nüfus ve ses çıkma olayının ama hadi önemli olsun da adamın verdiği rakamlar yalan. hatay nüfusu 1.6 milyonken gaziantep 2 milyon. bunu benim öğrenmem 15 saniyemi almazken paralel evrenlerde neler olduğunu bilemem tabii heheh.<br/><br/>neyse, çocukluk hayalimiz gerçekleşsin hatay çıksın da antepliler de azıcık yalan söyleyiversin ajshdjdj.
  entry_channels: spor
- entry_name: |
  ...
  entry_channels: haber
- entry_name: |
    30 mayis donald trump rte'ye teşekkürü
  entry_id:  90709565
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    eskiden amerika'da ayda 100-150 dolar civarına dijital tv hizmeti alıp 500-600 kanal izliyorduk. sonra netflix çıktı ve "izlemediğin yüzlerce kanala o kadar para ödeyeceğine izlediğin tek bir kanala ayda 10 dolar öde" dedi ve dijital tv'nin müşterilerini çalmaya başladı. sonra amazon prime geldi "bize de ayda 10 dolar öde, bizde netflix'te olmayan videolar var" dedi. sonra hulu 10 dolar istedi, hbo kendi streaming servisini kurdu, nba/nhl gibi ligler kendi streaming hizmetini başlattı. şimdi disney'in kendi hizmetini başlatması bekleniyor. youtube zaten paralı hizmete başladı. hepsini satın alsan yine ayda 100-150 dolara geliyor. tünelin ucu yine aynı yere çıktı. ha en azından ayda 150 dolar verip öküz gibi reklam izlemiyoruz.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    galatasaraylıyım, bunları yazınca özelden demediğini bırakmıyor insanlar. terim ile şaş'ın bu sene aldığı cezaları topla zaten bir sezonluk maç eder. tamam, şampiyonluk amacına ulaşıyoruz ama ortada rahatsız edici bir şeyler var.
  entry_channels: spor
- entry_name: |
    anne babanın birbirine düşkün olması
  entry_id:  90709109
  entry_writer: applefangirl
  entry_fav_count: 2
  entry_content: |
    bunu gören çocukların hayata 10-0 önde başladığına inandım hep, zira kendim hiç görmedim. sahipseniz kıymetini bilin. o örneği görmeyince, onu yaşayacağınıza da inancınız olmuyor pek. <br/><br/>düşkünlükleri daim olsun dediğim anne ve babadır.
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    yunanistan milli marşının ıslıklandığı maçtır.<br/><br/>(bkz: <a class="b" href="/?q=antalyal%c4%b1lar%c4%b1n+deniz+g%c3%b6rm%c3%bc%c5%9f+konyal%c4%b1+olmas%c4%b1">antalyalıların deniz görmüş konyalı olması</a>)
  entry_channels: spor
- entry_name: |
    serkan gölge
  entry_id:  90686269
  ...
  entry_fav_count: 1
  entry_content: |
    bu ülkede adalet adamına göredir. daha öğrenemediniz mi ekşiciler? arkan sağlam ise adalet işlemez. yazıklar olsun.<br/>(bkz: <a class="b" href="/?q=adalet+saray%c4%b1+vs+simit+saray%c4%b1">adalet sarayı vs simit sarayı</a>)
  entry_channels: siyaset
- entry_name: |
    güzel bir kadına güzel diyebilen kadın
  entry_id:  90696813
  entry_writer: narsistdipsoman
  entry_fav_count: 1
  entry_content: |
    daha güzeldir
  entry_channels: anket,ilişkiler
...
- entry_name: |
    şule çet
    <li data-id="90705571" data-author="ekşisözlük" data-author-id="8275" data-flags="share report vote" data-isfavorite="false" data-ispinned="true" data-favorite-count="26" data-seyler-slug="" data-comment-count="0">
    entry_content: |
...
- entry_name: |
    çağatay aksu
    <li data-id="90707579" data-author="ekşisözlük" data-author-id="8275" data-flags="share report vote" data-isfavorite="false" data-ispinned="true" data-favorite-count="1" data-seyler-slug="" data-comment-count="0">
    entry_content: |
        ankara batı 2. sulh ceza hakimliği'nin çağatay aksu’nun talebi üzerine verdiği 29.05.2019 tarih ve 2019/2586 d.iş sayılı kararı uyarınca şule çet ile ilgili başlıklarda bulunan içeriklere erişimin engellenmesi kararıyla ilgili bir açıklama yapmak isteriz.<br/><br/>ekşi sözlük, türk hukukuna tabi bir internet sitesi olarak mahkeme kararlarını uygulamak yükümlülüğündedir. dolayısıyla bu ve benzeri durumlarda elimize ulaşan mahkeme kararları doğrultusunda hareket ederek, ilgili başlıklardaki içerikleri kaldırmak durumundayız. <br/><br/>bu karara itiraz edecek olmakla beraber, itiraz sürecinin kararı uygulamayı ertelemediğini belirtmek isteriz.<br/><br/>tarafımıza iletilen kararların uygulanması yasa gereği olup, kararı benimsediğimiz veya olumladığımız anlamına gelmemektedir. <br/><br/>hukuk sistemimizdeki hataların, yanlışların, adalet duygusunu zedeleyen uygulama ve kararların giderilmesinin yolu, eleştirilerin doğru makam ve mercilere yöneltilmesinden geçer. genel olarak mahkemelerin içerik kaldırılmasına ilişkin kararlarındaki hoyratlık ve bu kararlara ilişkin itirazların incelenmesi süreçlerindeki özensizlik nedeniyle oluşan kamuoyu tepkisinin ilgili ve yetkili mercilere yönelmesi halinde bu hatalı işleyişin düzelmesi yönünde olumlu adımlar atılır diye umuyoruz.
  entry_channels: haber
- entry_name: |
