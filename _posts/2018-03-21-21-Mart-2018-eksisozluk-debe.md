...
- entry_name: |
    dolar 4 euro 5 benzin 6
  entry_id:  75197377
  entry_writer: eksimtrack
  entry_fav_count: 854
  entry_content: |
    4+5+6 = 15 <br/>(bkz: <a class="b" href="/?q=tek+c%c3%bcmle+ile+akp+y%c3%b6netiminin+15+y%c4%b1ll%c4%b1k+%c3%b6zeti">tek cümle ile akp yönetiminin 15 yıllık özeti</a>)
- entry_name: |
...
- entry_name: |
    tv8.5'un mustafa kemal ismini sansürlemesi
  entry_id:  75217811
...
- entry_name: |
    500 tl'lik banknota rte ve yss köprüsü'nü basmak
  entry_id:  75210999
  entry_writer: 2m3cm
  entry_fav_count: 150
  entry_content: |
    miktar olarak banknotun basılmasında bir sıkıntı yok ancak banknot’a rte fotoğrafı basmak...<br/><br/>yarın öbür gün vefat ettiğinde 15. gününde unutulacak bir cumhurbaşkanı için, üzücü ama; eziklik göstergesidir!<br/><br/>bu ülkenin kurucusu mustafa kemal atatürk’dür ve türkiye cumhuriyeti ortadan kalksa dahi bu böyle kalacaktır.<br/><br/>mareşaldir, gazidir, başkomutandır, başöğretmendir...<br/>tüm dünya’nın saygı duyduğu, hakkında methiyeler dizilmiş, ülkelerin örnek aldığı bir liderdir.<br/>bundan 80 sene önce kaleme aldıkları ile günümüzde siyasi hayatta yaşanacakları belirtmiştir. yol göstermiştir.<br/>yokluktan ülke kurmuştur!<br/><br/>paraların üstünde mutlak surette öncelikle mustafa kemal olacaktır.<br/><br/>tayyip mi?<br/><br/>unutulacaktır kardeşim...
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 57
  entry_content: |
    (bkz: <a class="b" href="/?q=rastgele+kaptan">rastgele kaptan</a>)<br/><br/>(bkz: <a class="b" href="/?q=derya+kuzusu+bunlar">derya kuzusu bunlar</a>)
- entry_name: |
...
- entry_name: |
    insanı sinir hastası eden firmalar
  entry_id:  75206374
  entry_writer: adgu
  entry_fav_count: 46
  entry_content: |
    (bkz: <a class="b" href="/?q=turktelekom">turktelekom</a>)
- entry_name: |
    çaylak onay listesi
  entry_id:  75189345
...
- entry_name: |
  ...
  entry_fav_count: 27
  entry_content: |
    ben hiç tıpçıyım diye gezen eczacı görmedim. bu arada esnafı hakaret görmek, insanlara sen esnafsın diyerek onları üzebileceğini sanmak hangi kafanın ürünü?
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    manyak mı lan bunlar. göz göre göre böyle yalan mı söylenir amk. amaçları ne ki?
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    oyumu trabzondan yana kullanıyorum. bu yıl bir ara portekiz'li turisti dövmüşlerdi.<br/><br/>olur mu? olur...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    oya'yi kimin ittigini, oya'ya sizi alt katta mutfakta bekliyorlar diyen garsona sorabilirler.<br/>hani belki en mantiklisi budur ha sayin senaristler? belki garson gelinlikli kadin mi, sari sacli olan mi, koyu renk sacli olan mi soyledi bilir ha?
- entry_name: |
    honda jazz'in 95 bin 800 liraya satılması
  entry_id:  75216908
  entry_writer: soyle buyurdu zerdust
  entry_fav_count: 1
  entry_content: |
    golf’un 160.700 olduğu yerde çok da pahalı değildir. <a rel="nofollow noopener" class="url" target="_blank" href="https://i.hizliresim.com/76LzWW.jpg" title="https://i.hizliresim.com/76LzWW.jpg">link</a>
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    son şampiyonun elinin falan titremediği maç. fener hep geriden gelip kazanan bir takım. 5 şampiyonluğunu da alıp götüne sokabilrsin.<br/><br/>not: 3-0spor
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=ama+babac%c4%b1%c4%9f%c4%b1m">ama babacığım</a>)
---
