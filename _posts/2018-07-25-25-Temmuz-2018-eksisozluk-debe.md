...
- entry_name: |
  ...
  entry_fav_count: 72
  entry_content: |
    mantıksız bir açıklama.<br/><br/>madem bundan sonra bedelliye gerek kalmayacak ve herkes temel eğitim alacak, ben niye 15 bin veriyorum? o zaman ben de gitmem
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    yine mi yaa diyerek başlığa girdim ama bu sefer öyle değilmiş. şaşırdım
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=momentum+19">momentum 19</a>)
