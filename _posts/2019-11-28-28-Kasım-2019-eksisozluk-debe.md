...
- entry_name: |
  ...
  entry_fav_count: 31
  entry_content: |
    başlıktaki firmayı konu dışında tutuyorum.<br/>kişisel bir tercih olarak hangi firma olursa olsun bana sen diye hitap eden hiç bir firmadan alışveriş yapmamayı tercih ediyorum. ben bile müşteri olarak siz diye hitap ederim siz diye cevap beklerim. samimi olalım müşteri dostu olalım sen diyelim emoji koyalım falan bunlar boş işler.
  entry_channels: 
- entry_name: |
...
- entry_name: |
    27 kasım 2019 sayısal sonuçlarının açıklanmaması
  entry_id:  98377103
  entry_writer: algoritma uzmani
  entry_fav_count: 26
  entry_content: |
    normalde 21:30'da açıklanması gereken sonuçların 22:06 olmasına karşın hala açıklanmaması durumudur. web sitesinde sürekli sıkıntılar gözükmektedir! arada site gelmesine karşın, hala geçen cumartesinin sonuçları gözükmektedir. ne yaptınız abi, yanlışlıkla dürüst çekiliş falan mı yaptınız? hehe :)<br/><br/>saat 22:10 itibariyle gelmiştir. ankara sincan 7 milyon tl ;))))
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    seks yapiyorsaniz prezarvatifi kontrol edin igneyle delmis olabilir.
  entry_channels: anket,ilişkiler
- entry_name: |
    aliexpress'teki 5 tl'lik ürüne 14 tl'lik vergi
  entry_id:  98376700
  entry_writer: sah ceken ayyas
  entry_fav_count: 10
  entry_content: |
    yaklaşık 1 ay önce <a class="b" href="/?q=aliexpress">aliexpress</a>'ten uyduruk birşey aldım 5 tl değerinde.bugün <a class="b" href="/?q=ptt">ptt</a> geldi 14 küsür tl vergi istiyor teslim için.<br/><br/>vergi kalemleri:<br/><br/><a class="b" href="/?q=g%c3%bcmr%c3%bck+sunum+%c3%bccreti">gümrük sunum ücreti</a>: 8 tl<br/><a class="b" href="/?q=damga+vergisi">damga vergisi</a> : 0.70<br/><a class="b" href="/?q=g%c3%bcmr%c3%bck+vergisi">gümrük vergisi</a> :5.61<br/><br/>toplam : 14.31<br/><br/>aldığım malın ederi 5 tl ha bu arada.verdiğim 14 tl.sonundaki <a class="b" href="/?q=31">31</a> de vatandaş olarak yüzümüze attırılan dölü temsil ediyor herhalde.daha da aliexpress alanı ziksinler. vatandaş mıyık <a class="b" href="/?q=s%c3%bcmeyye+b%c4%b1c%c4%b1+b%c4%b1c%c4%b1+partisi">sümeyye bıcı bıcı partisi</a> sponsoru mu belli değil.
  entry_channels: ekonomi
- entry_name: |
    osmanlıcanın buz gibi farsca olması
  entry_id:  98375626
  entry_writer: umutherzamanvardir
  entry_fav_count: 8
  entry_content: |
    osmanlıca bir dil değildir ki buz gibi farsça olsun. <br/>osmanlıca okuyan bir insan olarak söylüyorum; arap harfleriyle yazılmış döneminin arapça, türkçe ve farsça kelimelerinden oluşan, okuduğunuz zaman çoğunlukla buz gibi anlayabileceğiniz alfabedir ancak. <br/><br/>evet öz türkçe konuşalım ne güzel ama koskaca bir tarih var arkamızda ve arapça farsça katkılı ve alfabesi farklı ne yapalım çöpe mi atalım?
...
- entry_name: |
    mesleğini sormadan söyleyen insanlar
  entry_id:  98376748
  entry_writer: icimdekibeninsesi
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=avukat">avukat</a>) . bir de beni kırk elli yaşına gelmiş hâlâ hangi okul , hangi bölüm diye soranlar rahatsız ediyor. aşın artık bunları burası türkiye bir şeyi b*k etmeden duramayız. hukuk da bu duruma geldi.ülkenin dörtte üçü hukukçu.
  entry_channels: anket
- entry_name: |
    inanırsan her şeyi başarırsın yalanı
  entry_id:  98378135
  entry_writer: defoe
  entry_fav_count: 1
  entry_content: |
    başaramadığın şeylerin faturasını sana kesen kapitalist söylem.<br/>inansaydın olurdu be olum.<br/>hassiktir ordan.<br/>her şekilde adamlar kazanıyor. inandın yaptın, söz geçerli.<br/>inandın olmadı, yeterince inanmadın kardeşim.<br/>nasıl sistem. iyi değil mi.<br/>(bkz: <a class="b" href="/?q=outliers">outliers</a>)
...
- entry_name: |
  ...
  entry_id:  98340311
  entry_writer: misraterbiyecisi
  entry_fav_count: 0
  entry_content: |
    bana da mesaj atabilirsiniz saygıdeğer arkadaşlar.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    zeki müren - kahır mektubu : <a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/kuRyCSPsgP8">https://youtu.be/kurycspsgp8</a>
  entry_channels: anket,müzik,yeme-içme
- entry_name: |
    kendime saygım yok içecekleri
  entry_id:  98377312
  entry_writer: gesi baglarinda dolanan adam
  entry_fav_count: 0
  entry_content: |
    redbull.. bir insan kendine niye bunu yapar ?
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    birde tecrübelisine sorayım dersen 43 e ist.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    3 kasım 2019 yökdil sınavı
  entry_id:  98377228
  entry_writer: zifir nikotin karbon
  entry_fav_count: 0
  entry_content: |
    açıklanmıştır.sosyal alanında yüksek yapanlar nasıl yaptı bir yeşillendirebilir mi?
  entry_channels: eğitim
- entry_name: |
    27 kasım 2019 valencia chelsea maçı
  entry_id:  98377714
  entry_writer: yektaa
  entry_fav_count: 0
  entry_content: |
    kepa kaleci falan değil abi. herif resmen akrobasi yapıyor. öyle bir penaltı kurtarışı yok! <br/><br/>tanım: çok zevkli geçen maç.
  entry_channels: spor
---
