...
- entry_name: |
    istanbul soğuğu vs ankara soğuğu
  entry_id:  98353857
...
- entry_name: |
    vites geçişini hissettirmeyen şöför
  entry_id:  98351175
  entry_writer: copadamali
  entry_fav_count: 119
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 67
  entry_content: |
    borçlara zam yaparsa şaşırmayın :)
  entry_channels: siyaset,haber,ekonomi
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    "beyefendi" erkektir. <br/>tam olarak süreç nasıl işledi bilemiyorum ama şu an genç ve yetişkin olarak tanımlanabilecek kuşaklarda bir şekilde kadınlara kadınlığın, erkeklere erkekliğin unutturulduğunu düşünüyorum. adap gereksiz, nezaket anlamsız, saygı ise buralara hiç uğramamış. <br/>buluşmaya çiçekle gelen bu adamı da üzme kurma işte, yazıktır.
  entry_channels: ilişkiler
- entry_name: |
    steam
  entry_id:  98352533
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    chp genel merkezi bile ince'yi sallamazken, imamoğlu'nun konu hakkında iki yuvarlak cümleden fazlasını etmeyeceği yayındır.<br/><br/>onun ötesinde, ulusal medya görünümü (kendini anlatma bağlamında) hemen hiç olmayan imamoğlu için iyi bir fırsat. göreve geldiğinden beri hayvanlar gibi icraat yaptı. istanbul halkı biliyor ama, cumhurbaşkanlığı kampanyasını da bir yandan sürdürdüğüne göre, bunları tüm türkiye'ye duyurması fayda sağlayacaktır.<br/><br/>habertürk ve fatih altaylı da böyle iki gece arka arkaya akp'nin siyasal olarak sonunu getirecek, türkiye'yi yakın ve orta vadede şekillendirecek liderleri ekrana çıkarıyor. yürek yediler herhalde.
  entry_channels: siyaset,tv,haber
- entry_name: |
    geceye bir şarkı bırak
  entry_id:  98339595
  entry_writer: seawalkerr
  entry_fav_count: 1
  entry_content: |
    arabadaysan benfero- yaylan veya diskotek.<br/>sabit bir konumda isen duman- elimdeki saz yeter
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    30/ kadıköy/ <br/><br/>konu: insan evrimi
...
- entry_name: |
  ...
  entry_id:  98374643
  entry_writer: benoylebiseydemedim
  entry_fav_count: 0
  entry_content: |
    sana büyük caddelerin birinde rastlasam<br/>elimi uzatsam tutsam götürsem<br/>gözlerine baksam gözlerine<br/>konuşmasak ah anlasan
