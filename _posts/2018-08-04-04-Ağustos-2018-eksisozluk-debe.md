...
- entry_name: |
  ...
  entry_fav_count: 63
  entry_content: |
    m16 attığını vurur, ak47 vurduğunu devirir.
...
- entry_name: |
  ...
  entry_fav_count: 54
  entry_content: |
    hırsızlık. ar damarı çatlamış k falan toplamazmış bir de pezevenk. hırsız. arsız.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    milletin efendisi köylüye çomar diyen zihniyet
  entry_id:  79876761
  entry_writer: hadi git
  entry_fav_count: 14
  entry_content: |
    kimsenin köylüye çomar dediği yok. çomarın şehirlisi, köylüsü olmaz zira. çomar her yerde çomardır. çarpıtmayın konuyu aq.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  79866195
  entry_writer: sembune
  entry_fav_count: 13
  entry_content: |
    erkek arkadaşımla baş başa film izleyeyim diyorum var mı önerdiğiniz bir erkek arkadaş?
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    doların yükselmesi beni etkilemiyor diyen rektör
  entry_id:  79850607
  entry_writer: yagsag
  entry_fav_count: 9
  entry_content: |
    arkadaşlar konya rektörüymüş. tanrı ıslah eylesin. yorum yapmaya bile değmez. dağılalım.
...
- entry_name: |
  ...
  entry_channels: haber
- entry_name: |
    spor yaparken boşalmak
  entry_id:  79876665
  entry_writer: cerkez prens
  entry_fav_count: 6
  entry_content: |
    nasıl sporlar yapıyorsunuz lan siz ??<br/><br/>bizim anca götümüzden ter falan geliyor...
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    arkadaşlar pek bir dezavantajı yok, buraya yazanlar da sadece "ben uzun boyluyum ve bu çok cool, değil mi?" demek için yazmaktadır.
  entry_channels: anket,ilişkiler,sağlık
- entry_name: |
    yaptığı iyiliği yeri gelince hatırlatan kişi
  entry_id:  79877697
  entry_writer: gokcesadik
  entry_fav_count: 2
  entry_content: |
    durup dururken bunu yapmak adice tabii. ama bazen karşınızdaki öyle kadir kıymet bilmez, öyle haysiyetsiz, öyle ayarsız olur ki bağıra çağıra gözüne sokarsanız kendisine gelir, isabet olur.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    songül karlı'dan ben babamın kızıyam
  entry_channels: anket,müzik
- entry_name: |
    samuel eto'o
  entry_id:  79878548
  ...
  entry_fav_count: 0
  entry_content: |
    karakartallar bu fırsatı kaçırmamalı ,kendini geliştirirse iyi paraya satılabilir.
  entry_channels: spor
---
