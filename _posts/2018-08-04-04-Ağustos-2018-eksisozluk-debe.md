...
- entry_name: |
  ...
  entry_fav_count: 324
  entry_content: |
    do you copy ? aslında anladın mı tekrarlayabilir misiniz demektir. genelde telsiz görüşmelerinde kullanılılır. <br/>cevap olarak ; <a class="b" href="/?q=roger+that">roger that</a> denebilir...<br/><br/>mal gibi her şeye başlık açmayın amk.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    az evvel kankam tarafından maruz bırakıldığım soru. <br/><br/>ben 1 dedim. kendisi de 7 demiş. ben 7’ye kamburu çıkmış insan, 5’e de şişko obez dedim. ardından 1 demesem 3 derdim o da güzel dedim. o da 5’e yavşak dedi. çok garip bi muhabbet oldu, kimse çözemedi. çözemedik.
  entry_channels: anket
- entry_name: |
    bedelli askerlik
  entry_id:  79855955
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    az ilerde köprü var onun üstüne yapsaymış binayı daha mantıklı okurmuş.
  entry_channels: haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    şu tahminlere bakıyorum da ne kadar iyimsersiniz beyler. <br/>hani şu tl'den 6 sıfır attık ya, hatırlarsınız. sizce o 6 sıfır nasıl oluştu kızlar, haberiniz var mı? bir gecede cahil kalmadık ama, 60 ihtilalinden önce 2-3 lira olan dolar, ihtilalden hemen sonra 10 lira olmuştu. <br/>70'li yıllarda 20, 1980'de ise 100 lira dolaylarında. <br/>sonra işte biliyorsunuz 1-2 milyon diye telaffuz ediyorduk, bilin istedim. yani o kadar olmaz diyen arkadaşlar, marshall yardımları zamanında 1.5 lira olan dolar, 2000 yılında bir milyon oldu. milyon, evet.
  entry_channels: anket,ekonomi
- entry_name: |
    ekşi itiraf
  entry_id:  79848050
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    orta sahada çok güçlü bir direnç sağlayan futbolcumuzdu. sonra birden sakatlandı , kulubumuzun ozamanki doktoru yanlış tedavi uygulamıştı ve ayrıca kendini zorlayarak maça çıkmıştı. sonra kaç defa daha ameliyat oldu. ama bir türlü eski haline dönmedi. öncelikle bu oyuncu bizim takımımız için oynarken sakatlandı. mangal yaparken değil. ve sen sözleşme yaparken bunlari da hesaba katarsın. sakatlanınca da o para senin hakkındır. sen adama diyorsun ki ben senin iyileşeceğine formunu yakalayacağına inanmıyorum , bir nevi futbol hayatının bittiğine inanıyorum, bu yuzden istersen takımdan git şimdi sen. e doğal olarak kimse kabul etmez bunu, sonuçta senin için çalışırken meydana gelen bir kaza bu, eğer yollayacaksan tazminatı ödersin ben de hayatımı idame ettirmeye çalışırım. az biraz empati yapın. adamın kariyeri , psikolojisi vs bir sürü şey elinden kaydı bi anda.
  entry_channels: spor
- entry_name: |
    berat albayrak ile süleyman soylu'nun öpüşmesi
  entry_id:  79870621
  entry_writer: circle of eyes
  entry_fav_count: 4
  entry_content: |
    ikisi de birer telefonla hizaya çekilmiştir.<br/>(bkz: <a class="b" href="/?q=%c3%b6p%c3%bc%c5%9fmek+suretiyle">öpüşmek suretiyle</a>)<br/>(bkz: <a class="b" href="/?q=kafa+toku%c5%9furup+bar%c4%b1%c5%9fmak+noktas%c4%b1nda">kafa tokuşurup barışmak noktasında</a>)
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
    3 ağustos 2018 facebook'un çökmesi
  entry_id:  79873640
  entry_writer: hehe
  entry_fav_count: 3
  entry_content: |
    dünya genelinde facebook'a girilememesiyle ortaya çıkan durum. sayfa yüklenmiyor.<br/><br/>düzeltme: 10 dk sonra düzeldi.
  entry_channels: teknoloji
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    hangi makine olursa olsun en alta takıp yaptığım hede. makine ne olm dumbbell candır, heyecandır çünkü shoulder press yaparken sakatlanan insan sayısı çok fazladır.
  entry_channels: spor
---
