...
- entry_name: |
  ...
  entry_channels: siyaset,haber,ekonomi
- entry_name: |
    3 ağustos 2018 abd'nin rusyaya yaptırım uygulaması
  entry_id:  79874575
  entry_writer: 0game
  entry_fav_count: 12
  entry_content: |
    kartları dağ...<br/><br/>krupiyer öldü
  entry_channels: 
- entry_name: |
...
- entry_name: |
    kürdan yerine kullanılan nesneler
  entry_id:  79875695
  entry_writer: sessiz sakin suskun adam
  entry_fav_count: 0
  entry_content: |
    adam kesilmiş ayak başparmağınin tırnağı demiş. ığğğ yeminle ömrümde bu kadar salak, bu kadar gerizekalı görmedim. <br/>lan çorabı falan çıkarıp onunla uğrayacağına, makası al git tuvalet fırçasının telini kes dişini onla karıştır. mal herif seni. az zeki olun lan. ben öyle yapıyorum.
  entry_channels: anket
---
