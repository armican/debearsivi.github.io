...
- entry_name: |
  ...
  entry_fav_count: 184
  entry_content: |
    sana bir haberim var. tarifini yaptigin yer avrupa'da swinger club degil bildigin kerhane. cogu kerhane adina swinger club diyorlar ki müsteri ceksin(özellikle prag ve almanya'da). normalde oraya erkekler gider girerken ödemesini yapar ve swinger adi altinda aslinda konsematris kadinlar(hayat kadinlari) ile yatar(seni hazirlayan kadin gibi). oraya gelmenle muhtemelen cok sasirmis olucaklar ki böylesi bir durum her zaman mümkün degil. bedavaya kendini becertip swinger yaptigini zannetmissin.
...
- entry_name: |
  ...
  entry_fav_count: 65
  entry_content: |
    eskiden <a class="b" href="/entry/79830126">#79830126</a>'a katılırken artık umurumda olmayan hatta daha da büyümesini istediğim kriz. <br/><br/>türkiye'de öyle garip bir kültür var ki, ne zenginler içinde yaşadıkları, "halk"la muhattap olmadıkları ve içinde yaşayabilmek için saçma sapan harcamalar yapmaları gereken fanustan çıkmak istiyor ne de fakirler kendilerini geliştirmek ve sadakaya muhtaç olmaktan kurtulmak istiyor. <br/><br/>halinden şikayetçi olan sadece eğitimli ve çalışarak bir yerlere gelebilmek için boşuna çabalayan çok küçük bir kısım. bu %50 falan da değil bu arada kimse havaya girmesin. akpye oy vermeyip hatta çok muhalif olup düzenin değişmesini istemeyen, özal'lı günlere dönsek göbek atacak büyük bir grup var. chp'ye oy verenlerin çoğunun derdi dünkü bokların bugün kokmuş olması. yoksa sosyal devletmiş demokrasiymiş falan umurlarında bile değil. <br/><br/>tek bir çözüm var <a class="b" href="/?q=t%c3%bcrkiye%27den+siktir+olup+gitmek">türkiye'den siktir olup gitmek</a>. herkese ama özellikle basit bir hayatla yetinebilecek çalışkan ekşicilere tavsiye ederim. çünkü türkiye'de çalışarak bi bok olamayacaksınız. ya birilerini dolandıracaksınız ya da bağlantılarınız iyi olacak. başka şansınız yok. ben kanada'dayım burayı biliyorum ama başka yerler de vardır. aynen 70lerin 80lerin amerikan filmlerindeki gibi ne kadar çalışıyorsam o kadar kazanıp, kendi yağımla kavruluyorum. mis gibi. sosyal devlet de sağ olsun okuldu, hastaneydi, temiz havaydı, temiz suydu bütün temel ihtiyaçlarımı fazlasıyla karşılıyor. vergimi veriyorum karşılığını alıyorum. devletle münasebetim bununla sınırlı. <br/><br/>krize dönersek, şu anda istediğim türkiye'nin en ağır şekilde batması. insanlar açlıktan ne yapacaklarını bilemez hale gelsin. fakirler zengin mahallelerine dalıp zombi sürüsü gibi oraları yağmalasınlar. gerekiyorsa iç savaş çıksın millet birbirini boğazlasın ve yok olma noktasına gelsin. <br/><br/>atatürk'ün cumhuriyet projesinin bugün çökmüş olması sistem ne kadar iyi kurulursa kurulsun, halkın talep etmeden kazandığı hakların çok kolay suistimal edilebileceğini ve aslında o halkın büyük çoğunluğu için hiçbir değeri olmadığını kanıtladı bence. avrupalının 100 yıllarca mücadele ederek kazandığı haklar bizde kepçeyle dağıtıldı, sonuç ortada.<br/><br/>sistem tamamen çöktükten sonra aynı haklar savaşarak kazanılırsa belki bir değeri olur. <br/><br/>o yüzden batsın ekonomi, batsın yerli ve milli türkiye. beter olsun.
  entry_channels: siyaset,ekonomi
- entry_name: |
  ...
  entry_fav_count: 62
  entry_content: |
    bıkmıştır artık. hali kalmamıştır. hep aynı sonu yaşamak istemiyordur. inancı kalmamıştır. her türlü başlangıcı yaşadığından yine aynı son olacak diye çabalamıyordur.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 53
  entry_content: |
    seks kasedi çıksa, "görüntülerde tek kaybeden hanfendi olmuştur" der ve yine istifa etmez.
  entry_channels: siyaset,haber
- entry_name: |
    2 ağustos 2018 s. soylu'nun damada omuz atması
  entry_id:  79847830
  entry_writer: nicknickcik
  entry_fav_count: 51
  entry_content: |
    hulusi uyur, dolar akar;<br/>tayyip görür, damat bakar.<br/>soylu, pek bi boylu;<br/>berat'ı gördü omzu koydu...?
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    saka maka herif basaksehir'e siktiri cekmis.<br/><br/>"emre akbaba'nın tavırları kabul edilemez. bize karşı aldığı cephe çok kötü bir olay. biz onunla görüşmeye çalışıyoruz o gelmiyor ve telefonlara bakmıyor. istediği takıma gitsin." <a class="b" href="/?q=g%c3%b6ksel+g%c3%bcm%c3%bcsdag">göksel gümüsdag</a>
  entry_channels: spor
- entry_name: |
    ekşi itiraf
  entry_id:  79848050
...
- entry_name: |
    otobüs yolculuğunda yeni dönem
  entry_id:  79869353
  entry_writer: andromedalya
  entry_fav_count: 5
  entry_content: |
    eğer taviz verilmeden uygulanırsa güzel bir uygulama. çoğu firma belediye otobüsünden farksız hareket ediyor. sen binmişsin izmir'den adana'ya gidiyorsun yolun nerden baksan 13 saat sürecek, adam her kasaba köyde dura kalka seni 16 saatte sokuyor gideceğin yere. birşey diyemiyorsun, hakkını arayamıyorsun. yanında annen oluyor, karın oluyor rezillik olsun istemeyip sineye çekiyorsun. devlet sikecekse böyle firmaları siksin işte ona lafımız yok.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    telefon romantikliklerini samimi bulmuyorum.<br/><br/>nefesim, ömrüm, kirpim, hayatımın anlamı gibi birbirini kaydeden çiftlerin en ufak tartışmada nasıl canavar kesildiğine çok şahit oldum.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    aaa boyle bi gun mu varmis lan. hayreti mucip.<br/>ee bugunde icmek icin bi sebep cikti.<br/>alkolizm batagi super bi sey, icmek icin surekli olarak bi sebep bulabiliyorsun. mesela dun aksam kedim neden yemek yemiyor diye ictim. <br/><br/>bugun ise gitmedim, bira iciyordum.. iyi denk geldi. herkesin bira gununu kutlarim. her nerde iciyor ve iciriliyorsa..
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    görünmez mitolojik putlara "tanrı" diyerek hürmet etmek yerine, bu hayatta gerçekten var olmanı sağlayan atalarına hürmet etmektir. benim için ise hayatın anlamı türk olmaktır.<br/><br/>(bkz: <a class="b" href="/?q=bin+cihana+de%c4%9fi%c5%9fmem+%c5%9fu+%c3%b6ks%c3%bcz+t%c3%bcrkl%c3%bc%c4%9f%c3%bcm%c3%bc">bin cihana değişmem şu öksüz türklüğümü</a>)
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    balkona ne olur ne olmaz mancınık kurmak
  entry_id:  79874700
  entry_writer: oro
  entry_fav_count: 0
  entry_content: |
    duvarın arkasına monk basarak önlemimi aldım. evimi basan cihatcıları atayiz yapacağım.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    enzo perez ve umut nayirin kadroya ekleneceği turun ilk maçı.
  entry_channels: spor
- entry_name: |
    3 temmuz 2018 borçlanmada çin'e yönelme açıklaması
  entry_id:  79875591
  entry_writer: başlık taşıyan
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=d%c4%b1%c5%9f+bor%c3%a7lanmada+%c3%a7in+piyasas%c4%b1na+y%c3%b6neliyoruz">dış borçlanmada çin piyasasına yöneliyoruz</a>)
  entry_channels: siyaset,haber,ekonomi
---
