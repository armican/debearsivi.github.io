...
- entry_name: |
    1 günü 30 saat yapmak
  entry_id:  70621589
  entry_writer: caffee latte
  entry_fav_count: 105
  entry_content: |
    oda arkadaşım bir kız vardı. <br/><br/>aynı bu şekilde düşünüyordu. hatta durumu abartmıştı, dakikaları azaltmadan 30 saatlik bir gün tanımlamıştı kendine. bazen gece 2de kahvaltı sesine uyanırdık. sabah olmuş. gündüz 2-3 gibi gece oldu deyip yatardı. <br/><br/>içim ürperiyor hatırladıkça.
- entry_name: |
...
- entry_name: |
    şeyma subaşı
  entry_id:  70617394
  entry_writer: jayajaya
  entry_fav_count: 39
  entry_content: |
    namaz kılamıyorum çünkü burning man'deyim <br/>o yeah
- entry_name: |
    bedelli askerlik
  entry_id:  70621475
...
- entry_name: |
  ...
  entry_fav_count: 26
  entry_content: |
    (bkz: <a class="b" href="/?q=formda+tolga+ci%c4%9ferci">formda tolga ciğerci</a>)<br/><br/>dünyanın en kısa fıkrası amk. adkjaskdashd. bu gslilerdeki futbol cehaletinin maalesef tedavisi yok. evet.
- entry_name: |
    bitcoin
  entry_id:  70612347
...
- entry_name: |
  ...
  entry_id:  70613439
  entry_writer: kerim i fenasi
  entry_fav_count: 2
  entry_content: |
    ben insanların ve hayvanların boylarını aştım<br/>ve konuşuyorum, kimse konuşmuyor benimle; şaştım<br/>ben çok yalnız büyüdüm ve çok yükseğe çıktım<br/>bekliyorum, neyi bekliyorum ki, neye acıktım?<br/>bulutların tahtı bana çok yakın diyorum<br/>ilk çakacak şimşeği bekliyorum<br/><br/><a class="b" href="/?q=friedrich+nietzsche">friedrich nietzsche</a>
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    (bkz: <a class="b" href="/?q=a%c5%9fk%c4%b1m+sa%c3%a7%c4%b1m">aşkım saçım</a>)<br/>(bkz: <a class="b" href="/?q=a%c5%9fk%c4%b1m+%c4%b1%c5%9f%c4%b1k">aşkım ışık</a>)
- entry_name: |
    furkan korkmaz
  entry_id:  70612584
  ...
  entry_fav_count: 1
  entry_content: |
    lütfen bukadar övülmesin artık dediğim genç yetenek. ben de övmemek için zor tutuyorum kendimi, nazar değecek.<br/><br/>takımın bence en iyi oyuncusu. cediden biraz daha hırssız sadece, cediyle ileride milli takımda büyük bir duo olabilirler, ne kadar da çok yakışır...
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    net 5 tane topu ezmiştir aynı şekilde saçma sapan orta ve pas girişimleriyle. ağır bitmiş.
---
