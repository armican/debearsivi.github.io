...
- entry_name: |
  ...
  entry_fav_count: 114
  entry_content: |
    öyle bir takım düşünün ki taraftardan gelen maddi kazancı sıfıra yakın, naklen yayın gelirleri dışında neredeyse hiçbir geliri olmayan ama manchester city'nin sol bekini transfer edebilecek maddi kaynağa sahip. istanbul halkından aldığın vergilerle transfer yap sonra da o istanbul halkının taraftarı olduğu 3 büyük takıma rakip yarat.
- entry_name: |
    pepe
  entry_id:  69236830
...
- entry_name: |
    ekşi sözlük geleneksel ağaç dikme günü
  entry_id:  69227431
  entry_writer: ezoop
  entry_fav_count: 92
  entry_content: |
...
- entry_name: |
    suriyelilerin türkiyedeki suç yüzdesine etkisi
  entry_id:  69229370
  entry_writer: celomania
  entry_fav_count: 48
  entry_content: |
    genelde yedikleri tüm halt yanlarına kar kalıp, işlem yapılmayıp, serbest kaldıklarından istatistiklere yansımayan etkidir. <br/>gün içerisinde yanınızda eşiniz olmasına rağmen, ahlaktan yoksun şekilde hareket etmeleri bazı gavatlara dert olmaz, istatistiklere yansımaz o ayrı.<br/><br/>not: eşiyle gezerken suriyeli bir takım ahlak yoksunu metabolizmalarla sürtüşen yazarsporlu.
- entry_name: |
...
- entry_name: |
    yüksek lisans mülakatında dikkat edilecek hususlar
  entry_id:  69233928
  entry_writer: redddadmiral
  entry_fav_count: 35
  entry_content: |
    hocayı görmek! öncesinde tabi, yoksa mülakat filan formalite, kimi seçecekleri de bellidir. <br/><br/>giyim kuşam mevzusuna gelirsek;<br/>rektöre ulaşabiliyorsan hiçbir şey giymene gerek yok, <br/>dekanı tanıyorsan incir yaprağı kafi, <br/>bölüm başkanı tanıdıksa şort bile kurtarır,<br/>hoca tanıdığın varsa bi zahmet pantolon gömlek giyeceksin. <br/>hiç tanıdığın yoksa iki dirhem bir çekirdek olsan da nafile.
- entry_name: |
...
- entry_name: |
    şeyma subaşı
  entry_id:  69226956
  entry_writer: devrim on air
  entry_fav_count: 13
  entry_content: |
    ahmet hakan ile girdiği polemikten sonra tanıdım kendisini ki; ahmet hakan'dan günahım kadar haz etmem.<br/><br/>ne ola bu röportaj deyip, okuma gafletinde bulundum. bütün o ıvır zıvırları geçip tek bir cümleye odaklanmak istiyorum.<br/><br/>-hayattaki en büyük başarınız?<br/>+kızım!<br/><br/>zorunlu tanım: kızı olmasa çoktan meze olacağını bilen hanım kızımız. o çocuğun mahremiyetinin içine sıçması da bu yüzden.
- entry_name: |
    ekşi itiraf
  entry_id:  69222606
...
- entry_name: |
    gael clichy
  entry_id:  69222603
  entry_writer: balans12
  entry_fav_count: 12
  entry_content: |
    başakşehir ile sözleşme imzalamak için istanbul'a gelen sol bek. başakşehir bile city'den sol bek alıyor biz de ismail mi oynucak hasan ali mi diye kara kara düşünelim.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    takipçilerinin %90'dan fazlasının 14 yaş altı ufaklıklar olduğunu düşünmeden, <a class="b" href="/?q=s%c4%b1rf+para+i%c3%a7in">sırf para için</a> saçma sapan bir prim videosu yükleyen youtuber. hadi biz anlıyoruz bunu neden yaptığını ama <a class="b" href="/?q=9-10+ya%c5%9flar%c4%b1ndaki+hayranlar%c4%b1n">9-10 yaşlarındaki hayranların</a> senin için üzülecek, anne babalarına "lütfen yardım edelim polise söyleyelim" tarzı şeyler söyleyip ailelerini boş yere uğraştıracaklar. <br/><br/>ama <a class="b" href="/?q=ne+%c3%b6nemi+var">ne önemi var</a> değil mi, sonuçta parayı kazanan sen olacaksın.<br/><br/>ayrıca videoda bilerek adanın ismini vermeyip "ege açıklarında bir ada" demiş. çünkü biliyor ki adres verse başına iş açardı. şu an oturduğu otelinde yorumları izleyip adsense hesabını kontrol ediyordur.
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  69226377
  entry_writer: regenbogen
  entry_fav_count: 6
  entry_content: |
    yoktur. şişman + büyük "göğüslü" + tembel olmanın dezavantajları vardır. kolunuz patlıcan gibiyse büyük memeli değilsiniz üzgünüm, her yere yayılan yağlar oradan da nasibini almış sadece. kilo verme ve düzenli egzersizle sırt ağrılarınız yok olacaktır. kaliteli bir spor sütyenine yatırım yapın, spor yaparken zıplamayacak şekilde kavrarsa sarkma da olmaz. kilo verince de artan özgüven sayesinde sözlük dışında başka ve gerçek erkeklerle iletişim kurmaya başlayınca buradan ilgi dilenmek zorunda kalmayacaksınız, sorun çözülecek. kilo verene kadar da beyaz tenli olmanın dezavantajları başlığında "kizarıyrum yha çk ktü çkkk bktmm:(" yazabilirsiniz, sevgiler.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    basketbol tarihinin gelmiş geçmiş en iyi hocasının çalıştırdığı, son <a class="b" href="/?q=euroleague">euroleague</a> şampiyonu takıma transfer olmuştur.<br/><br/>adamın işi bu lan, mesleği bu. sektörünün lideri bir firmada çalışmak için yapmayacağı olmayan adamlar gelmiş burada laf söylüyor.
- entry_name: |
    peter sagan
  entry_id:  69238718
  entry_writer: indio
