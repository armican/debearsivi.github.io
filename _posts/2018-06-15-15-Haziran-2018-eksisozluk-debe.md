...
- entry_name: |
  ...
  entry_fav_count: 125
  entry_content: |
    yepyeni türkiye... <br/><br/>zorunlu edit: devletle, milletle, bayrakla dalga geçiyor diye laf edenlere şunu söylemek isterim; devleti liyakata değil biata göre adam atayarak kek edene, milleti kek dilimler gibi bölene, bayrağı mitinglerde götünün altına serip oturan, mitingden ayrılırken çöpe atan akepeli keklere laf edin bana gelene kadar... mal değnekleri sizi...
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 81
  entry_content: |
    bundan tam 10 gün önce 2. sırada iken, an iyibariyle 8. sırada olduğum liste. ha bugün ha yarın derken sözlüğün ciddi bir şekilde benimle dalga geçtiğini düşünmeye başladım. sıram sürekli nasıl geriliyor? kimbilir kaç sıra arkamdan insanlar yazar yapılıyor? yıllarca bekledik acaba sıranın başında ne kadar bekleyeceğim? daha bekleyecek olan arkadaşlara gerçekten sabır diliyorum.<br/>edit:galiba çıktım bişeyler oldu vr şuan 0 0 0.......0 yazan yerde entry sayım var ve “çaylak” ibaresi görünmüyor ama sıralamam yazıyor. eğer görünüyorsam aydınlatın lütfen.
...
- entry_name: |
  ...
  entry_fav_count: 52
  entry_content: |
    yedek subay olarak askerlik yaptığı dönemde, lise mezunlarının da yedek subay olabildiğini bilmeyen damacanaların savunduğu kişi.
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    24 haziran'a az kala artan provakasyonlar
  entry_id:  78065055
  entry_writer: oakpost
  entry_fav_count: 9
  entry_content: |
    birilerinin sandığı kaybedeceğini anlayıp yaptığı provakasyondur.<br/><br/>şurada 10 gün var,kimbilir neler duyacağız. muhalefetin aklı selim bir şekilde hareket etmesi gerekiyor. <br/><br/>ayrıca sosyal medyada herkes birbirini uyarmalı. sözcüklerimize dikkat etmeliyiz.<br/><br/>buna dair bir ekip dahi kurulabilir. provakasyon hazırlığında olanlara suç duyurusu yapılabilir.<br/><br/>havuz medyası eğer provakatörlük yapıyorsa hep beraber tepki koymalıyız. sözlük yönetimine de iş düşüyor, açılan provakatör başlıklara müdahale etmeli.
  entry_channels: siyaset
- entry_name: |
    iyi parti'nin hdp ile bayramlaşmaması
  entry_id:  78065200
  entry_writer: baytarafli
  entry_fav_count: 7
  entry_content: |
    meral akşener yarın bitlis ahlat'ta bayram sofrası kuruyor. çok bayramlaşmak isteyen gelir bayramlaşır.<br/><br/>kendini pkk'dan ayıramayan bir siyasi parti ile bayramlaşmak zorunda değil iyi parti.
  entry_channels: siyaset
- entry_name: |
    bedelli askerlik
  entry_id:  78037517
  ...
  entry_fav_count: 7
  entry_content: |
    seçim öncesi oy kaybettirir düşüncesini ilk kim ortaya attı merak ettirten.<br/><br/>abi 5 milyon insanı ilgilendiren bir problemini çözeceğin hamle nasıl oy kaybettiriyor sana allah aşkına ya.<br/><br/>yok gündemimizde değil, yok suistimal edilir vs. sonra her şey geçer, yaşı çekerler 28'e, fiyatı yaparlar 25. ne yaş ne para hiçbiri uymaz, kalırsın öylece. <br/><br/>abi bu olayın, yani şu an çıkmadığı haliyle bedelli olayının özeti; sizin yapacağınız işin amk'dir.
  entry_channels: siyaset,haber,ekonomi
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    bazı ak gavatların hala meselenin özüne inemediğine, keza beyinlerinin çalışmadığına tanıklık etmeye devam ediyoruz. <br/><br/>lan gerizekalı herif terörist oluşum pkk ile siyasal oluşum hdp aynı şeyler değildir. bırak sen o sırtımı oraya buraya yasladım diyenleri. ak gavatlık yapma! senin recep hocaefendi demedi mi? ne istedilerse vermedi mi? hdp ile pkk arasında da benzeri şeyler yaşanmış, hdp kanadı hala içerisinde tıpkı chp gibi terör sevicileri barındırıyor olsa da amına koyduğumun ak gavatı, meclis’te yüzlerce fetöcü oturmaya devam ediyorken senin o boklu ağzına sıçarım ben, kenarlarına da bir güzel bulaştırırım amına soktuğumun ak davarı. <br/><br/>pkk eli kanlı, silahlı ve haysiyetsiz bir terör örgütüdür. hdp tarafından ekmeğinin kesileceğini de iyi biliyor. valilere operasyon yapmayın diye emir verdik diyenlerin bokunu yiyerek uyuşacağına, biraz kafanı kaldır da önüne bak haysiyetine soktuğumun omurgasız ak davarı.
  entry_channels: haber
- entry_name: |
    oğuzhan özyakup
  entry_id:  78061586
  ...
  entry_fav_count: 1
  entry_content: |
    2022 'ye kadar sözleşmesi uzatılmış. hayırlı olsun.
  entry_channels: spor
- entry_name: |
    2018 rusya dünya kupası gol kralı
  entry_id:  78065698
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    şu güzel yaz gecesi karanlıkta çıkar, korkmadan bir başıma dolaşırdım.
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bayram boyunca istanbul’da tek başıma kalakaldım. <a class="b" href="/?q=b%c3%b6brek">böbrek</a> ihtiyacı olanlar yeşillendirebilir.
