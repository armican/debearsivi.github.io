...
- entry_name: |
    facebook'ta aşırı sayko paylaşım yapan abi
  entry_id:  94233116
...
- entry_name: |
  ...
  entry_fav_count: 229
  entry_content: |
    (bkz: <a class="b" href="/?q=ret">ret</a>) yememek için yapmanız gereken basit bir püf noktası olan vize.<br/><br/>eğer bir ülke size “burada kimseyi tanıyor musun?” derse, tanıyor olsanız bile onun adını vermeyin. kimseyi tanımıyorum, şeytan görsün yüzünü, ben otelde kalacağım, gezip görüp geleceğim, ne ben kimseyi tanırım ne kimse beni diyin ki durduk yerde (bkz: <a class="b" href="/?q=ret">ret</a>) almayasınız.<br/><br/>her ülke için geçerli bu, hele davet mektubu alıp bununla başvurmak tam bir intihar, “ben bu kişinin buraya gelmesini istiyorum ve kendisine kefil olacak kadar da yakın bağlarımız var” anlamına geldiği için her ülke direkt olarak “kaçak göçmen” gözünde görüyor sizi. yukarıdaki arkadaşın parası ile ilgili bir durum yok ortada tüm kriterleri fazlasıyla karşılamış sadece o davet mektubunu işin içine dahil etmese şu an neden <a class="b" href="/?q=ret">ret</a> yediğini sorgulamak yerine <a class="b" href="/?q=londra">londra</a> başlığına yazıyor olurdu.
...
- entry_name: |
  ...
  entry_fav_count: 26
  entry_content: |
    haftalardır "monaco yerine santrafor almadan falcao'yu bırakmayacak" cümlesindeki santrafor slimaniyse büyük taşşak geçerim ibnelerle<br/><br/>ulan bunca zamandır biz slimani'yi mi bekliyormuşuz<sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    21 ağustos 2019 kyk yurtlarına %20 zam yapılması
  entry_id:  94235897
  entry_writer: yarim kalan gufte
  entry_fav_count: 18
  entry_content: |
    ekonomimiz bu kadar iyiye giderken nereden çıkmış olan zamdır. <br/><br/>ha bir de; ülke genelinde %15in altında zam görmeyen herhangi bir ürün veya hizmet yokken, gözünü sevdiğimin(!) enflasyonu ve işçiye/memura verilen zamlar nasıl hala tek hanede kalabiliyor anlayan beri gelsin.
...
- entry_name: |
  ...
  entry_channels: ilişkiler,eğitim
- entry_name: |
    mesajlaşılan kişinin çaylak çıkması
  entry_id:  94247505
  entry_writer: birliktelik
  entry_fav_count: 16
  entry_content: |
    geçenlerde başıma gelen durum. üniversitede öğretim üyesiymiş. evren hakkında, evrim hakkında konuşuyoruz. bilgisi üst düzeyde tabi. ufkumu açıyor, bilmediklerimi öğreniyorum falan.<br/>tam saygı duyuyordum ki son dakka aklıma kontrol etmek geldi. çaylakmış maalesef. dünyam başıma yıkıldı. 1 haftadır kendime gelemedim.<br/>benim gibi asil bir yazar nasıl olur da bir çaylak parçasıyla mesajlaşır diye..<br/>günlerce allahım beni affet diye dualar ettim, tövbeler ettim. <br/>hala kendimi affetmiyorum...
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    kendini teşhir eden kadın
  entry_id:  94250142
  entry_writer: kemostapi
  entry_fav_count: 13
  entry_content: |
    hiçbir özelliği olmadığı için teşhir yolunu seçen kadındır.
  entry_channels: ilişkiler
- entry_name: |
    yaşayan en önemli insan
  entry_id:  94249448
  entry_writer: hicbisy
  entry_fav_count: 11
  entry_content: |
    şu anlık benim.<br/><br/>edit : hak verenler oldu. tartışmaya gerek yok galiba harbiden benim.
  entry_channels: 
- entry_name: |
    daniel sturridge
  entry_id:  94250657
  ...
  entry_channels: spor
- entry_name: |
    bir erkekte aranan ilk özellik
  entry_id:  94250515
  entry_writer: followtheleader
  entry_fav_count: 8
  entry_content: |
    dürüstlük diyen net yalan söylüyordur. ama kendine.<br/><br/>kim yalancı, sahtekar insan ister amk. herkes dürüst, çalışkan, başarılı, iyi kalpli bir insanla tanışmak ister. bu bir kıstas değil. hele ki dürüst olduğunu bildiği insanlara kapıyı kapayıp, kendisini defalarca aldatan erkeklere kul köle olan kadınlar ilk "dürüstlük abiğ" der sonra karşılarına çıkan ilk yavşağa tutulur. doğanın kanunu bu. <br/><br/>ben bir erkek olarak size söyleyeyim size kadınların bir erkekte ilk neye ve nelere baktıklarını. yaşlarına ve belli dönemlere göre bu kıstaslar değişiklik gösterir;<br/><br/>lisede popülerlik, sosyallik ortalamasına bakarlar.<br/>üniversitede tipine, giyim kuşamına, tavırlarına.<br/>üniversite sonrasında kariyer/meslek seçimlerine ve pozisyonlarına,<br/>olgunluk dönemindeki erkeklerde de en fazla paraya bakarlar.<br/><br/>itirazı olan götümü yesin.<br/><br/>edit: istisnalar kaideyi bozmaz.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    national geographic türkiye twitter sayfası az önce mehmet'in youtube kanalını "bu küçük kaşif en çok bizi heyecanlandırdı, gözümüz üzerinde!" yazarak paylaştı.<br/><br/>hadi bakalım :)
  entry_channels: teknoloji
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://twitter.com/alex_lighthouse/status/1163982883205394433" title="https://twitter.com/alex_lighthouse/status/1163982883205394433">adamın uçaktan indirilişi</a><br/>biraz hırpalamışlar adamı.
  entry_channels: 
- entry_name: |
    kaslı kadın vücudu
  entry_id:  94254022
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    özlem çerçioğlu'nun #volkswagencometoaydın tweeti
  entry_id:  94254677
  entry_writer: eskiincicilerden
  entry_fav_count: 2
  entry_content: |
    bir aydınlı olarak başkanıma gurur dutmamı sağlamış olan paylaşımdır.<br/><br/>istihdamın artmasına ihtiyacımız olan bu günlerde ilaç gibi olan bu girişim için tüm emeği geçenleri ayrı ayrı kutlarım.
  entry_channels: 
- entry_name: |
    fatma turgut
  entry_id:  94256652
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bilahare ilgilenilmesi gereken konudur nitekim.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ''tam rakı içilecek adamsın '' hem de çok defa duydum bunu, iltifat mı onu da bilmiyorum.
  entry_channels: anket,ilişkiler
- entry_name: |
