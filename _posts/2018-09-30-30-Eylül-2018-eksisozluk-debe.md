...
- entry_name: |
  ...
  entry_fav_count: 69
  entry_content: |
    zamanında dikey limit filmi sayesinde çözdüğüm karışıklık.<br/><br/>(film kötüydü orası ayrı)
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    unutulmaz ak parti seçmenleri
  entry_id:  81771803
  entry_writer: kuzgunumtrak
  entry_fav_count: 14
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=_8lbUyJ4cds" title="https://www.youtube.com/watch?v=_8lbUyJ4cds">ula ben senin taşaanı yiyim</a> diyerek r.t.e'nin alnına <a class="b" href="/?q=euro">euro</a> yapıştıran genç kız.
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    sistemin en kahrolası yanlarından biri insanların kendi hayatlarını yönetme hakkını ellerinde bulunduruyormuşçasına yaşayıp esasında buna sahip olamayışları. herkes ülke yönetimine oy vererek katıldığını zannediyor. fakat büyük bir kriz olduğunda acziyet ortaya dökülüyor. insanlar kendilerini bağladıkları büyük yapıların karar mekanizmasında söz sahibi olduklarını hissetmezlerse aidiyette kopuşlar yaşanır. 21. yüzyıldaki demokrasinin görevi bu bağı kurmaktır. eğer bu bağın geçersizliği ortaya çıkarsa tepkileri her yerde görebilirsiniz. türkiye, yaşadığı ekonomik buhranda kapana kısılmış gibi görünebilir. fakat esas kapana kısılanlar hayatlarının mahvolmasında hiçbir suçu olmayan ve düzeltmek için de hiçbir yetisi olmayan insanlar.<br/>baştan yanlış olan bir oyunda birilerinin yaptığı hataların cezasını çekiyorlar.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    ben de hep kızım olsun istedim. oğlum oldu. kısmet tabi. <br/><br/>şimdi gözüm yemiyor bir çocuk daha. çocuk büyütmek çok zor. ama kız olacağını bilsem kesinlikle bir çocuk daha yapardım. nasıl şirin olurdu sarı sarı.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    zorla geçinen insanların, öğrencilerin, bordrolu çalışan orta direğin ataköydeki amı bitlenmiş türk eskortlarla seks yapması evet ezikliktir. <br/><br/>lakin, 19’luk ilik gibi bir rusu inletmek ve diri vücuduna kütür kütür yerleştirmek için bar bar da dolaşılmaz. sırf bunun için arkadaşlık sitelerinde saatler de öldürülmez. ararsın en çıtırından hatunu, gelir otele, verirsin 1200 dolaresi, bir gece çakarsın. <br/><br/>parayla seks budur. gayet de güzeldir.
  entry_channels: anket,ilişkiler
- entry_name: |
    adem ljajic
  entry_id:  81780344
  ...
  entry_fav_count: 3
  entry_content: |
    sosa'nın beşiktaştaki halinin bir üst versiyonu.<br/><br/>takıma erken adapte olursa şampiyon yapar. olamazsa formayı grup vitaminsize(oğuzhan-tolgay) kaptırır
  entry_channels: spor
- entry_name: |
    masterchef türkiye
  entry_id:  81776524
...
- entry_name: |
    yalnızlığı hayvan gibi sevmek
  entry_id:  81781739
  entry_writer: arnavut votkamla erigi calistir ulan
  entry_fav_count: 1
  entry_content: |
    jean-paul sartre'a göre de diğer insanlar ile sürekli beraber olmak, cehennemin kendisidir.<br/><br/>(bkz: <a class="b" href="/?q=cehennem+ba%c5%9fkalar%c4%b1d%c4%b1r">cehennem başkalarıdır</a>)<br/><br/>insanlarla kurulan birliktelikler beraberinde yargılamaları da getirdiğinden, insanların her hareketinin sürekli olarak diğerleri tarafından bir değerlendirmeye alınıp yargılanmasına neden olacaktır. bu da sartre'ın cehennem tasviridir.
  entry_channels: 
- entry_name: |
    kim milyoner olmak ister
  entry_id:  81779198
  entry_writer: datdiridat
  entry_fav_count: 1
  entry_content: |
    tıp okuyan hanıma; “<a class="b" href="/?q=steteskop">steteskop</a> nedir ? “ diye sorsalar, muhtemelen yine joker hakkını kullanacaktı, hatta “yaşamak için oksijene ihtiyacımız var mı? a-evet, b-hayır” diye soru gelse “aklımda bir şık var ama tam emin değilim” diyecekti.
  entry_channels: tv
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    karanlıkta balkonda oturuyorum. binalar yakın. karşımdaki binada yeni evlenmiş bir çift var ve mutfakta birşeyler yapıp cıvıldaşıyorlar. yan komşuları ne konuştuklarını anlayabilmek için balkondan eğilmiş dinlemeye çalışıyor. beni farketmedi mal. birazdan gürültü çıkarıp panikletmeyi düşünüyorum. balkondan düşmesini umarak bekliyorum.<br/>biraz da o malzeme olsun.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    saçı 3 numaraya vurma nedenleri
  entry_id:  81781206
  entry_writer: kobe or not kobe
  entry_fav_count: 0
  entry_content: |
    kullanımı rahat.
