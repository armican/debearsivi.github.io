...
- entry_name: |
  ...
  entry_id:  70039631
  entry_writer: ne siyah ne beyaz
  entry_fav_count: 24
  entry_content: |
    eğer bahçende arı kovanı varsa ve sen de akıllı bir kişiysen kimsenin gelip dürtüklemesine izin vermezsin. sakince balını alır geçersin. eğer ki komşun senden daha güçlü ama biraz da akıllıysa yine gelip senin bahçendeki kovanı dürtmez. gider kendine uzaktaki birinin bahçesinden balını çalar. bilir ki dibindeki kovana çomak sokarsa o arılar bahçeyi aşar kendini de sokar.
- entry_name: |
    aziz yıldırım
  entry_id:  70051802
...
- entry_name: |
    bedelli askerlik
  entry_id:  70046218
  entry_writer: siensi kuba
  entry_fav_count: 6
  entry_content: |
    345. kd yapmış biri olarak yakın zaman da çıkmasını diliyorum. uzun uzun yazacak değilim. askerlik boşa giden bir zamandır. kimseye de önermiyorum. imkanı olan herkesin bundan faydalanmasını diliyorum.
- entry_name: |
    sen olsan bari
  entry_id:  70046130
  ...
  entry_fav_count: 4
  entry_content: |
    sanırım şarkıyı türk popuna yeni bir soluk olarak görmemin sebepleri şunlar:<br/>1- ağıza takılmak için ikileme yapmaya gerek duymuyor. dudu dudu, bangır bangır, of of, mış mış, kuzu kuzu, lol lol, hay hay diye giden ve artırılabilecek ikilemeli pop şarkılarından gına geldi artık. <br/><br/>2- klişe bi melodi ve dımtıstan da uzak kalmış, bunu tam olarak açıklayamayacağım ama tarkan bile aynısından yılda 5656564 tane çıkan şarkıdan yaptı en son.... kral tv'de şarkının değiştiğini anladığını sanmıyorum kimsenin. <br/><br/>3- pozitif aşk mesajı. çok şükür sevdiğinden nefret etmeyen, intikam almaya çalışmayan, onunla savaşmayıp sevişen de var. hep nispetten de gına gelmişti.
- entry_name: |
