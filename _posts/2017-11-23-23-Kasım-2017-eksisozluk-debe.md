...
- entry_name: |
  ...
  entry_fav_count: 295
  entry_content: |
    ekonomiden ben de hiç anlamıyorum ama bu şekilde saçmalamak için başka birşey lazım dedirten başlık.
- entry_name: |
...
- entry_name: |
    3 bin liralık taksi tarifesi
  entry_id:  72300194
  entry_writer: artisnotdead
  entry_fav_count: 143
  entry_content: |
    (bkz: <a class="b" href="/?q=orospu+%c3%a7ocu%c4%9fu+taksici">orospu çocuğu taksici</a>)<br/><br/>(bkz: <a class="b" href="/?q=orospu+%c3%a7ocu%c4%9fu+turizmci">orospu çocuğu turizmci</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 111
  entry_content: |
    öncelikle ülke elden gitmiyor. <br/><br/>daha fazla kandırılmazsak sıkıntı yok.
- entry_name: |
  ...
  entry_fav_count: 96
  entry_content: |
    zamanında kapıda olunduğumda beni uçağa almak zorunda mı?<br/>evet. <br/>geç binince biri yerimi mi kapıyor?<br/>hayır. <br/>ben dışarıdayken içeride çılgın bi parti mi var?<br/>hayır. <br/>erken binince uçakta beklemek eğlenceli mi?<br/>hayır. <br/><br/>benim gibi bir insan için bildiğin ödül gibi uygulama olmuş.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 62
  entry_content: |
    -liderliği garantilemek daha önce gruptan çıkamamış bir takım için, bizim için çok büyük bir başarı.<br/><br/>-erdoğan'ın geldiği ikinci maçı da kazanamadık.<br/><br/>-hakem genel olarak çok iyiydi ama bence cenk'in geçirdiği sinir krizinden önce cenk'e yapılan hareket penaltıydı.<br/><br/>-45-65 arası oynadığımız oyun ve kurduğumuz baskı inanılmazdı. bu oyun sonrası porto galibiyetten ümidi kesti. bu seviyede böyle oynayıp porto gibi bir takımı ürkütmek büyük iş.<br/><br/>-tolgay çok iyi oynadı, çok kaliteli bir adam. maç sonu röportajı da çok güzeldi. adam zaten taraftarı çok seviyor, her röportajda taraftardan bahsediyor. sağolsun müjdeyi de verdi 5 yıl uzattım diyerek. bir de eskiden futbolu bizden büyükler oynuyordu. şu anda bu takımda oynayan tolgay gibi kendimden küçük futbolcuları görünce kendimi bir garip hissediyorum. ama hepsini de kardeşim gibi seviyorum.<br/><br/>yolunuz açık olsun beyler...
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 29
  entry_content: |
    sözlükte refli faucet linki paylaşanlar okusun:<br/><br/>bedava bitcoin dağıtan site yapmak için hazır facuet scriptleri bitcointalk.org'dan temin edilebiliyor. scriptler bedava. geliştirenler transaction'lardan komisyon alıyor. isterseniz 10 dakikada bir faucet'e sahip olabilirsiniz. sizin için kurulumunu vb. yapanlar bile var.<br/><br/>scripti bir defa kurup 0.1 gibi bir bitcoin gönderiyorsunuz. script kimin ne kadar kazanacağını otomatik olarak belirleyerek binlerce sazanı aylarca her saat başı siteye çekiyor. bundan sonrası size kalmış. malware atanlar, reklam verenler, kendi exchange'lerinin reklamını yapanlar, js-miner ile arka planda monero kazdıranlar vb. var. <br/><br/>script'lerden birinde "0.1 bitcoin atarsanız en az bir yıl yeter" demişler. yani $830 gibi bir rakamı bölüşmek için onbinlerce insan bir yıl boyunca saat başı faucet'e geliyor. asdasduasdagsd<br/><br/>20 senedir web geliştiriyorum, sazan avının böylesini ne gördüm ne duydum.
- entry_name: |
    green card
  entry_id:  72311943
  entry_writer: pinata
...
- entry_name: |
    sucuklu kaşarlı kokoreçli mantarlı ketçaplı tost
  entry_id:  72311497
  entry_writer: zerdest
  entry_fav_count: 15
  entry_content: |
    (bkz: <a class="b" href="/?q=kusturmal%c4%b1+ek%c5%9fici+tostu">kusturmalı ekşici tostu</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    whatsapp’tan terk edilmeyle sonuçlarır.
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    (bkz: <a class="b" href="/?q=ba%c4%9flar+gazozu">bağlar gazozu</a>)<br/>(bkz: <a class="b" href="/?q=zafer+gazozu">zafer gazozu</a>)<br/><br/>(bkz: <a class="b" href="/?q=karab%c3%bck">karabük</a>)<br/>(bkz: <a class="b" href="/?q=denizli">denizli</a>)
- entry_name: |
    kendisini yatakta yakalayan oğlunu öldürmek
  entry_id:  72313209
  entry_writer: gayim ama para bende
  entry_fav_count: 6
  entry_content: |
    40'lı yaşlarında bir kadın komşusuyla sikişirken oğlu gelip bunları yakalıyor. sonra orospu karı çocuğu boğarak öldürüyor.<br/>rica ediyorum kadının tipine bir bakın!<br/>bir de başka insanlara ahlaksız der bu tipler.<br/>bakın ne demek istediğimi anlayacaksınız.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="http://www.hurriyet.com.tr/annesini-komsusuyla-yatakta-yakalayinca-sakaryada-kan-donduran-olay-40654565" title="http://www.hurriyet.com.tr/annesini-komsusuyla-yatakta-yakalayinca-sakaryada-kan-donduran-olay-40654565">işte bu orospu</a>
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    (bkz: <a class="b" href="/?q=dyatlov+ge%c3%a7idi+vakas%c4%b1">dyatlov geçidi vakası</a>)<br/>(bkz: <a class="b" href="/?q=aramaya+inanmak">aramaya inanmak</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    oda orkestrası oluyor da, oda pavyonu neden olmasın?<br/><br/>muhtemelen küçük bir yerleşim yerinde yapılan bir asker eğlencesidir.
- entry_name: |
    steam
  entry_id:  72311413
  entry_writer: swarley stinson
  entry_fav_count: 2
  entry_content: |
    görmeyen duymayan kaldıysa eğer, <a rel="nofollow noopener" class="url" target="_blank" href="http://store.steampowered.com/app/40990/Mafia/" title="http://store.steampowered.com/app/40990/Mafia/">mafia</a> 1 sonunda steam'de. bu indirim döneminde %50 falan alsa mükemmel olurdu.
- entry_name: |
    nur yerlitaş
  entry_id:  72312429
  entry_writer: uamustafa
  entry_fav_count: 1
  entry_content: |
    barbaros tr'ye laf etti diye adamı bi ikmedikleri kalmıştı. bu kaşar'ın ne ayrıcalığı var?
- entry_name: |
    şu anda çalan şarkı
  entry_id:  72306408
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    <a class="b" href="/?q=nev%c5%9fin+meng%c3%bc">nevşin mengü</a> şu an ağlıyormuş kesin bilgi, özellikle bazı kezbanlar erkek gibi falan demiş uyku uyumayacakmış. kız triatlona hazırlanıyor arkadaşlar kendisi ayrı hazırlanması ayrı bir mücadele, çoğunuzun bunun nasıl bir tatmin sunduğu konusunda zerre fikri yoktur.<br/>ha bu kadar sayfa yazıyoruz güzeldir çirkindir diridir ama asıl konu bunları takmıyor, umursamıyor ve takmayan insanlarla hayatını yaşıyor. siz selfinin açısını 10 kez değiştirip tekrar çekerken rastgele açıyla pehlivan gibi çıkmayı takmayacak şekilde stresten uzak hayatlar var. ne garip değil mi?
---
