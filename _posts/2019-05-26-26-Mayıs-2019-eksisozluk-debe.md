...
- entry_name: |
  ...
  entry_fav_count: 25
  entry_content: |
    bende de kavgam var ama neonazi değilim.
...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    bu dizi benim için littlefinger sansa'yı anlamsızca bolton'lara verdiğinde bitmişti, o noktadan sonra her bölümde zeka seviyesi sıfıra doğru yakınsadı. <br/><br/>son bölümdeki kral seçimi sahnesindeki diyalogların kalitesizliği ufak tefek cinayetlerle yarışacak düzeydeydi. konsey sahnesinde dizinin kendi parodisini yapacak kadar düşmeleri ise ibretlikti.<br/><br/>ned stark'ın yetiştirdiği evlada bir kadını öperken kalleşçe bıçaklattılar. bu karaktere en azından "kusura bakma ama şimdi seni öldürmek zorundayım" dedirtmeleri gerektiğini bile düşünmekten acizler.<br/><br/>hadi dragon yakmadı. dışarıda duran binlerce unsullied niye jon'u oracıkta kesmedi, peki ya dothrakiler? bu koskoca ordunun yaratılan güç vakumunda oracıkta darbe yapması ya da en azından kopup westeros'ta anarşi yaratması gerekmez mi? zaten dothrakilere bir son bile yazmaya zahmet etmemişler, buhar olup uçtu onlar. <br/><br/>özetle dizide işe yaramayan kim varsa bir halt oldu. got the broken.
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    yeni askerlik sisteminde gözlerden kaçan detay.<br/><br/>yeni askerlik sisteminin 45. madde 2. fıkrasına göre cumhurbaşkanı gerekli gördüğü hallerde istediği kişiyi askerlikten muaf tutabilecek.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.yenicaggazetesi.com.tr/yeni-askerlik-sisteminde-tartismali-madde-235723h.htm" title="https://www.yenicaggazetesi.com.tr/yeni-askerlik-sisteminde-tartismali-madde-235723h.htm">https://www.yenicaggazetesi.com.tr/…dde-235723h.htm</a>
  entry_channels: siyaset,haber
- entry_name: |
    eren derdiyok
  entry_id:  90508057
  ...
  entry_channels: spor
- entry_name: |
    benden ayrılırsan kendimi öldürürüm
  entry_id:  90485605
  entry_writer: ozgurgencc
  entry_fav_count: 14
  entry_content: |
    bagımlı kişilik bozukluğu düşünülebilir. o topa hiç girmeyin once psikiyatri sonrada psikologa yönlendirin.
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    sevdiğim <br/>hani kötü şarkılara bile klarnet girince şarkı aniden güzelleşiyor ya<br/><br/>keşke sana da klarnet girse
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    semavi dinlerin kalan ömrü
  entry_id:  90507161
  entry_writer: roadhouse
  entry_fav_count: 3
  entry_content: |
    açıkçası ne kadar ömrü kaldığıyla ilgili yorum yapmanın sağlıksız olduğunu düşünüyorum; çünkü hala nefis terbiyesi ile tutulduğu söylenen bir oruçta normalde eve alınmayan tatlıların/etlerin deliler gibi tüketildiği bir zamanda; bence dinler uzun uzun süreler daha hayatı meşgul eder gibi! dinde çoğu şey ibadet olmanın ötesinde, çoğu insan için esasında bir ritüele/geleneğe dönüşmüş; ruh ve bedenin bundan vazgeçmesi için önce mantığını devreye sokması gerekiyor gibi!<br/><br/>bilimden yararlanınız!
  entry_channels: anket
- entry_name: |
    melih gökçek'in twitterdaki son çırpınışları
  entry_id:  90507834
  entry_writer: baydanisko
  entry_fav_count: 3
  entry_content: |
    hayır bir de siyaseti bırakacagım falan demiş.<br/><br/>ulan zaten sana bıraktırmadılar mı siyaseti ahahhaha
  entry_channels: 
- entry_name: |
...
- entry_name: |
    rte'nin gerekçeli karara rağmen hırsızlar demesi
  entry_id:  90509879
  entry_writer: hic de yakisikli degilim
  entry_fav_count: 0
  entry_content: |
    la adam cumhurbaşkanlığı seçiminde 11 milyon oy fark attı, "çaldılar, çuvallarla oy getirdiler, anadolu ajansı yanlış gösterdi, aslında ince kazandı" diye bıdı bıdı edip durdunuz. hâlâ bıdı bıdı ediyorsunuz.<br/><br/>(bkz: <a class="b" href="/?q=11+milyon+farka+h%c4%b1rs%c4%b1zl%c4%b1k+11+bin+farka+hak+demek">11 milyon farka hırsızlık 11 bin farka hak demek</a>)
  entry_channels: siyaset
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    film arasından bildiriyorum (bkz: <a class="b" href="/?q=efsane">efsane</a>)
  entry_channels: anket,sinema,spoiler
- entry_name: |
    iran'da 30 kişiye yoga gözaltısı
  entry_id:  90509618
  entry_writer: bestman777
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=%c3%b6yle+yogayla+mogayla+bunu+ge%c3%a7i%c5%9ftirmezsiniz">öyle yogayla mogayla bunu geçiştirmezsiniz</a>)
  entry_channels: haber
---
