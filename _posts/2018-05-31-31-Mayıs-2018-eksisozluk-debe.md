...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    (bkz: <a class="b" href="/?q=loris+karius+niye+yer+als%c4%b1n+zaten+am%c4%b1na+kodu%c4%9fum">loris karius niye yer alsın zaten amına koduğum</a>)
  entry_channels: spor,anket
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: oyun
- entry_name: |
    uber'in türkiye'de yasaklanması
  entry_id:  77513761
  entry_writer: grandleozz
  entry_fav_count: 6
  entry_content: |
    saçmalıktır.<br/><br/>uber'in yasaklandığı iddia edilen ülkelerin çoğunda sadece <a class="b" href="/?q=uberx">uberx</a> ya da <a class="b" href="/?q=uberpop">uberpop</a> gibi paylaşımlı taşıma faaliyeti yasaklanmış durumda, uber'in kendisi değil.<br/><br/>italya'da son mahkeme kararı uber lehine çıktı, yani faaliyetine tekrar başlayacak.<br/><br/>ingiltere'de ise şu anda <a class="b" href="/?q=londra">londra</a>'da yasak, 1-2 şehir daha tartışıyor ama ingiltere'nin tamamında yasaklandığı falan yok. <br/><br/>çin ve rusya'nın sayılması ise komik, adamlar facebook, whatsapp, twitter ne varsa yasaklamış durumda. çin'de çocuk yaparken bile devlete soruluyor, ne uber'i?<br/><br/>uber, taksicilere değil, taksi plakası sahibi kalantorlara alternatiftir. uber, taksiciler için müthiş bir çıkış yoludur, alırsın aracını kimseye muhtaç olmadan taşıma yaparsın. bizim çoban sevdalısı zevat şunu anlamadı gitti..
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  77531977
  entry_writer: sozlukeksiyazari
  entry_fav_count: 6
  entry_content: |
    dakka başı sayın ocalan lafını duymakta olduğumuz yayın. no strateji, no zeka.
  entry_channels: siyaset,tv,haber
- entry_name: |
    ikarus marka otobüslere binmiş efsane nesil
  entry_id:  77520630
  entry_writer: potasyumokzalat
  entry_fav_count: 4
  entry_content: |
    yokuşlarda vites geçişlerinde senkron hareket etmiş, kara kışı yaşamış nesildir.
  entry_channels: tarih,teknoloji,otomotiv,ekonomi
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    fox tv'nin pkklıları canlı yayına çıkarması
  entry_id:  77532741
  entry_writer: kikina
  entry_fav_count: 1
  entry_content: |
    habur, açılım, oslo falan anlatmak istiyorum ama nefesim daralıyor halim yok
  entry_channels: siyaset
- entry_name: |
    izmir
  entry_id:  77530718
  ...
  entry_fav_count: 0
  entry_content: |
    bugün gezmeye başladığım şehir. şu an alsancaktayım. ortam çok farklı arkadaş. insanlar farklı. gerçekten istanbul'da yaşamanın hiç bir manası yok. <br/><br/>bu arada 2 hatun görüp vay lan izmir kızları denilen kişiler bunlarmış heralde dedim. yanımdan geçerlerken rusça konuştuklarını duydum. rusun yeri yine de ayrı.
