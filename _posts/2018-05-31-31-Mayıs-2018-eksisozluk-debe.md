...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    muharrem ince'yi desteklemek türkiye'ye ihanettir
  entry_id:  77505995
  entry_writer: esplendor
  entry_fav_count: 430
  entry_content: |
    (bkz: <a class="b" href="/?q=hayko+ba%c4%9fdat+kim+amk">hayko bağdat kim amk</a>)<br/><br/>hem selahattin demirtaş'ın dışarı çıkmasını istiyor hem de muharrem ince başkan olunca selahattin demirtaş'ı çıkartacağım dese de oy vermem diyor. nasıl bir omurgasızlıktır.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    1.80 m boyuyla kız düşürmeye çalışan pigme
  entry_id:  77514112
  entry_writer: culsuz kapitalist
  entry_fav_count: 233
  entry_content: |
    3 metre 42 cm boyumla gülerken sandalyeden düşmeme neden olan erkek. neyse ki uzun kollarımla arka duvardan destek aldım
  entry_channels: 
- entry_name: |
...
- entry_name: |
    otuz yaş üstü yazarların at gibi olması
  entry_id:  77519760
  entry_writer: ytse
  entry_fav_count: 140
  entry_content: |
    <a class="b" href="/?q=ka%c3%a7+ya%c5%9f%c4%b1nda+adams%c4%b1n+a%c3%a7t%c4%b1%c4%9f%c4%b1n+ba%c5%9fl%c4%b1%c4%9fa+bak">kaç yaşında adamsın açtığın başlığa bak</a>
...
- entry_name: |
    sosyal medyayı ikiye bölen at
  entry_id:  77501168
  entry_writer: defibrilator
  entry_fav_count: 114
  entry_content: |
    (bkz: <a class="b" href="/?q=sosyal+medyay%c4%b1+ikiye+b%c3%b6len+hz.musa">sosyal medyayı ikiye bölen hz.musa</a>)
  entry_channels: anket
- entry_name: |
    30 mayıs 2018 dolar kuru
  entry_id:  77502365
  entry_writer: bilgedodo
  entry_fav_count: 101
  entry_content: |
    italya'daki politik karışıklıkların, üzerinde yukarı yönde etkide bulunacağı kurdur.<br/><br/>italya'daki söz konusu karışıklığın aktörlerinden biri de silvio berlusconi dir. 2018 genel seçimlerinde yine aday olmuştur. benim anlamadığım ise böylesine ekonomik sıkıntı içindeki bir millet nasıl olur da berlusconi gibi bir orospu çocuğunu tekrar seçmeyi düşünebilir. yolsuzluklara bulaşmış, söz konusu ekonomik problemlerin mimarı olmuş böylesine bir amcık ağızlıyı seçmek hatta tekrar tekrar seçmek anlaşılır gibi değil... <br/><br/>ama bence siz anladınız. ;) anladınız, anladınız...
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    tek cümleyle iktidara veda
  entry_id:  77523996
  entry_writer: nuri
  entry_fav_count: 45
  entry_content: |
    (bkz: <a class="b" href="/?q=yarg%c4%b1lanacaks%c4%b1n%c4%b1z">yargılanacaksınız</a>)
...
- entry_name: |
  ...
  entry_channels: siyaset,tv,haber
- entry_name: |
    peugeotturkiye'nin yazarlara özel mesaj göndermesi
  entry_id:  77524465
  entry_writer: imba
  entry_fav_count: 37
  entry_content: |
    başlığa yazan herkese böyle bir mesaj gönderdiklerini düşünüyorum. bana da geldi. insanları son haddine kadar mağdur ettikten sonra yapılan bu çalışmaları kesinlikle samimi bulmuyor, halk nezdinde ‘bakın biz ilgiliyiz’ imajı yaratmaya çalışmaktan ileri görmüyorum. <br/><br/>insanları ezerken haksızlığa uğratırken aklınız neredeydi?<br/><br/><a class="b" href="/?q=pa%c3%a7a+tutu%c5%9fmas%c4%b1+101">paça tutuşması 101</a> dersimize hoşgeldiniz.
  entry_channels: ilişkiler,ekşi-sözlük,otomotiv,ekonomi
- entry_name: |
...
- entry_name: |
    öğretmenlern hiçbir işe yaramaması
  entry_id:  77529933
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    türkiye'nin bir savaş halinde karşılık verebilecek savaş uçakları bulunmaktadır ancak suriye'den gelen basit ve ucuz bir balistik füzeyi engelleyecek hava savunma sistemi yoktur. yani s400.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    ayrıştırmayı bırakın, bu adamın hangi şarkısını bir diğerinin önüne koyacaksınız. yapmayın.<br/><br/>allah çarpar sonra.
