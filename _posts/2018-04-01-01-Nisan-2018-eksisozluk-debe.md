...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    ismet badem'in tabiriyle topun el yaktığı dakikalarda yine skoru değiştirmiş yetenekli uşak. bu adamın oyunu ile tutunuyoruz lige şaka maka. o nedenle kusura bakmayın ama işini yapmaktadır.
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    gelişmekteolanyazar: yeni şafak ekonomi köşe yazari
- entry_name: |
    ready player one
  entry_id:  75575957
  entry_writer: optimistprime
  entry_fav_count: 0
  entry_content: |
    bence 10/8 lik bir film. oyun dünyasına bir gıdım sevginiz varsa oldukça beğeneceksiniz. imkanınız varsa imax izleyin derim.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    düşmüyor. görüyorsunuz. anlatmaya gerek yok.
- entry_name: |
    barış şimşek
  entry_id:  75587142
