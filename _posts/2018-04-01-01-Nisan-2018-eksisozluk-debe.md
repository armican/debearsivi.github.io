...
- entry_name: |
  ...
  entry_fav_count: 36
  entry_content: |
    buddha'ya "senden hoşlanıyorum" ile "seni seviyorum" arasındaki fark nedir? diye sormuşlar. <br/>buddha şöyle cevap vermis;<br/>"bir çiçekten hoşlanırsan onu koparırsın, ama bir çiçegi seversen, onu her gün sularsın.<br/>bunu anlayan kişi yaşamı anlar."
- entry_name: |
...
- entry_name: |
    türk erkeğinin yarısı biseksüel
  entry_id:  75573755
  entry_writer: nikini vermek istemeyen bir izleyici
  entry_fav_count: 26
  entry_content: |
    farkında olmadıkları biseksüelliktir. <br/><br/>şimdi hiç aklınıza gelmeyecek sayıdaki türk erkeği, pasif gay-cross dresser, travesti olarak tanımlayan kişilerle birlikte olmaktadır. <br/><br/>bu erkeklerin bu kişilerle birlikte olmalarının genel nedenleri şöyledir:<br/><br/>1) seksin çok kolay elde edilmesi,<br/>2) kadınlarla yaşanmayan cinsel fantezilerin çok rahatlıkla yaşanması,<br/>3) erkeğe karşı yatakta soğuk olan kadın nedeniyle erkeğin seksi bu yönelimlerdeki kişilerde araması.<br/><br/>şimdi burada sorulması gereken ve cevabını psikolog/psikiyatr/ ilgili dalların bileceği soru şudur:<br/><br/>-bu erkekler bu tür ilişkilere kadına ikâme olarak mı giriyorlar? eğer öyle ise bu onları eşcinsel/biseksüel yapar mı?<br/><br/>eşcinsellere göre bir erkeğin, bir erkekle ilişkiye girmesi onları tamamıyla eşcinsel yapar ama işe bu soru üzerinden bakılırsa bence öyle değildir diye düşünüyorum. çünkü adam aslında bir kadınla birlikte olmak istiyor ama para/imkan/sınır vs şeyler onu farklı şeye yöneltiyor.<br/><br/>bana göre burada biseksüel olarak tanımlanması gereken grup, dışarıda evli barklı işinde gücünde ve toplumun ondan beklediği o tam bir erkek portresini çizerken öte yandan bu yönelimdeki kişilerle gizli gizli ilişkiye giren ve aktif/pasif her türlü birleşmeyi yapan ve fermuarı çekip çıktıktan sonra normal yaşamına dönen kişilerdir.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    30 mart izmir buluşması sırasında bütün çocukları kürsüye alacak kadar ince, aziz yıldırım'a tek çatlak ses çıkmasına izin vermeyecek kadar vefakâr, konuşma bittikten sonra 2.5 saat daha kürsüde kalıp herkesle tek tek fotoğraf çektirecek kadar sabırlı ve iyi niyetli bir insan.
- entry_name: |
...
- entry_name: |
    polis akademisi'nin aslında o kadar komik olmaması
  entry_id:  75588167
  entry_writer: nickbulamadimnolcak
  entry_fav_count: 4
  entry_content: |
    doğru bir tespittir. o kadar komik değil, daha da komiktir. son film hariç tabi. moskova filmi hiç çekilmemeliydi.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    1-0'a yatmayan, maçı 2-0'a getirecek bir forveti bile bulunmayan takım.<br/>bu takımın bir tane normal standartlarda forveti olsaydı bugün alanyaspor'u 4'lük ederdi. yapabildiğimiz tek şey sonsuza kadar top çevirmek, çünkü ileride hareketlenebilen, top alabilen, şut çekebilen tek forvet oyuncusu bile yok.
- entry_name: |
    adam smith sarayı açmış
  entry_id:  75586769
  entry_writer: dougsampson
  entry_fav_count: 3
  entry_content: |
    <a class="b" href="/?q=david+ricardo+allah+var">david ricardo allah var</a>
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    günlerdir sol yandan düşmeyen ve tartışılması saçma olan başlık. olay legal ise kimseyi bağlayacak ve tartışılacak bir durum yok. reşit olan bir bireyle de, 60 yaşındaki insan da ilişkiye girse, olay pedofil diyemezsiniz. pedofil gibi son derece ciddi bir kavrami, insanlarin zihnine yanlış kazimayin lütfen. yalnız bu ilişki türünün abes görüneceği kesin, erkeğin 60 kadının 19 ya da tam tersinin söz konusu olduğu bir çifte herkes güler. 19- 32'ye ben gülmem ama 25-38'den daha az makul bir çift olduğu kesin. hem kız, hem oğlan yegenlerim 19 yasına geldiginde, 32 yaşındaki sevgililerini benimle tanıştırsaydi bir üzülürdüm. ortada manipülasyon olmadığından emin olmak isterdim. ilişkiye girdiği kişi hocası ya da patronu ise daha çok üzülürdüm örneğin.<br/><br/>bu iliski türü sadece süreklilik arz ediyorsa sıkıntılı bence. yani erkek sürekli cok genç kadın, kadin da sürekli yaşlı bir partner pesindeyse o zaman tuhaf bir durum olduğu kesin. aksi soz konusu oldugunda da tabii<br/><br/>bunun dışında kadının 14 yas büyük olduğu, iki cocuklu çok mutlu bir çift tanıyorum. kadin şu an yetmişlerini sürüyor olmali ve umarim hala mutludurlar. tersi de illaki vardır. insanlar anlaşıyor ve mutlularsa bir sorun yok bence.
- entry_name: |
...
- entry_name: |
    rakı kafası'nın güzel olmaması
  entry_id:  75586113
  entry_writer: ambulance chaser
  entry_fav_count: 1
  entry_content: |
    rakının kafası fena değildir de, şu rakı güzellemelerinden bıktım artık.<br/><br/>arkadaş rakı adabı, rakı kültürüne gösterilen ihtimam, özen arkadaşa, sevgiliye, aileye gösterilse eminim hayat daha güzel olacak.<br/><br/>rakının yanında ne iyi gider, başlangıcı neyle yaparsın, devamında ne yenir, arada çay içilir mi, rakıyla hangi müzikler iyi gider`:benim bira veya voktayla çok sanat müziği, türk halk müziği dinlemişliğim vardır. `, hangi insanla rakı içilir vs. vs.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    sanki şehirlerden çok uzakta,<br/>insanlardan,<br/>arabalardan,<br/>yani seslerden işte,<br/>hepsinden çok uzakta 2 saat geçirdim gibi. <br/><br/>bazen güldüm, bazen hüzünlendim, bazen arkadan gelen kuş seslerini dinleyip keyiflendim, aile üzerine düşünürken buldum kendimi sonra, bir ara bunlar ne biçim kardeş lan dedim, sonra siz ne tatlısınız ulan deyip filmi bitirdim.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bu adama hakem demek,eşyanın doğasına aykırı bir durum...<br/>kötü çok kötü bir hakem...
- entry_name: |
