...
- entry_name: |
    kortta akıl veren seyircinin oyuna davet edilmesi
  entry_id:  69552861
  entry_writer: annenin terlik isabet ettiremedigi evlat
  entry_fav_count: 192
  entry_content: |
    tenisçi kim clijsters'a laf atıp akıl veren bir seyircinin korta davet edilişi ve gelişen olayla bütünü.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=qzD4ioi8Wi4" title="https://www.youtube.com/watch?v=qzD4ioi8Wi4">izleyin ve insanlar nasıl da mutlu bir görün</a><br/><br/>biz de şikelere, kavgalara ve önüne gelene rahatça hakaret eden spor programlarına layığız.
- entry_name: |
...
- entry_name: |
    kızları şort giyiyor diye darp edilen aile
  entry_id:  69551172
  entry_writer: sandia
  entry_fav_count: 143
  entry_content: |
    şort bu konuda sadece basit obje. <br/><br/>muhtemelen olayın aslı şu; bu akrabalar kızı kendilerinden biriyle evlendirmek istemişlerdir, kız da kabul etmeyince bahane aramışlardır. şortu giyen erkek, dayak yiyen kız. başka mantıklı açıklaması yok.
- entry_name: |
...
- entry_name: |
    17 temmuz 2017 yüksekova patlaması
  entry_id:  69554373
  entry_writer: eksi peace
  entry_fav_count: 5
  entry_content: |
    15 temmuz yıldönümü haftası olduğundan kınamaların önümüzdeki ay yapılacağı patlamadır.<br/><br/>zaten yok edilmeye, itibarsızlaştırılmaya çalışan tsk'nın askeri sonuçta. bir haber değeri olmaz.<br/><br/>şehit haberi gelmemesini diliyorum.
- entry_name: |
    igor tudor
  entry_id:  69555030
  entry_writer: muto
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    dahil olmak istediğimdir. <a class="b" href="/?q=ye%c5%9fil">yeşil</a>i yakın lütfen şu boktan hayatta tek sevgim fenerbahçe
---
