...
- entry_name: |
  ...
  entry_channels: ekonomi
- entry_name: |
    murat övüç'ün reklam başına 20 bin tl alması
  entry_id:  106789324
  entry_writer: dik duranin gozyaslari
  entry_fav_count: 245
  entry_content: |
    "sonra niye okuyorsunuz ? manyak mısınız ?" deyince millet bana kızıyor. itü, odtü, boğaziçi'de bitirsen, bu adamın 1 reklamdan aldığı parayı ancak iyi bir firmada üst düzey yönetici olunca aylık maaş olarak alabilirsin. o konuma gelmek için bir sürü orospu çocuğu ve ayağını kaydırmaya çalışanlardan kurtulman gerekir. tabi önce pozisyonun boşalması lazım.<br/><br/>edit: reklam başına ve aylık maaş kargaşası nedeniyle düzeltme yapıldı.
...
- entry_name: |
    online oyunlarda küfür etkisi yaratan hareketler
  entry_id:  106775525
  entry_writer: uzun lafin turkcesi
  entry_fav_count: 117
  entry_content: |
    (bkz: <a class="b" href="/?q=12+mart+2020+okullar%c4%b1n+tatil+edilmesi">12 mart 2020 okulların tatil edilmesi</a>)
...
- entry_name: |
  ...
  entry_fav_count: 43
  entry_content: |
    acayip çöktüm eski sevgilimi takip bile ettim kabul etmedi gerçi iyi ki kabul etmedi.<br/><br/>kıç kadar bir apartta yaşam mücadelesi veriyorum. <br/><br/>çok ama çok sıkıldım yüksek bir sıkışmışlık bunalım internette bir şey bulamamak ve ders çalışmak zorunda olmak (tus).<br/><br/>yaptıklarınızın yapacaklarınızın rahatlatmamasını geç yapmadıklarımızın daha büyük huzursuzluk getirdiği durum.
...
- entry_name: |
  ...
  entry_id:  106769811
  entry_writer: nypmhalidae
  entry_fav_count: 24
  entry_content: |
    çarşıdan aldım bir tane eve geldim yedi tane.
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    keşke ekonomimiz, eğitim sistemimiz de bu tablolar kadar istikrarlı ve düzgün olabilse.<br/>şiir gibi yemin ediyorum tabloları gün gün yan yana koyun.<br/>muazzam!!!
...
- entry_name: |
  ...
  entry_id:  106809241
  entry_writer: thenakedking
  entry_fav_count: 7
  entry_content: |
    kıymetli dostlar rasathanesi
  entry_channels: siyaset,anket,ilişkiler,tv,sanat,teknoloji,haber,magazin,eğitim,ekonomi,havacılık,seyahat
- entry_name: |
    hdp'nin türk bayraklı tabelayı tuvalete koyması
  entry_id:  106813512
  entry_writer: typh00n
  entry_fav_count: 7
  entry_content: |
    görünce altlarına şıçıyorlar. heralde o yüzden koymuşlar.
  entry_channels: siyaset,haber
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    başaramazsın diyenler. <br/>sende bu işi yapacak yetenek yok diyenler. <br/>bu iş böyle yapılmaz diyenler. <br/><br/>"when someone says you can't do it. do it twice, and take pictures."<br/><br/>(bkz: <a class="b" href="/?q=negatif+motivasyon">negatif motivasyon</a>)
...
- entry_name: |
  ...
  entry_id:  106812850
  entry_writer: piyanocuu
  entry_fav_count: 1
  entry_content: |
    yaşımı tahmin edene benden canlı piyano konseri
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    cüneyt arkındır . bu adam hollywood da olsaydı bambaşka olurdu şansı
