...
- entry_name: |
    gaziantep'te suriyeli ve türklerin kavgası
  entry_id:  78182956
  entry_writer: buralarda11
  entry_fav_count: 676
  entry_content: |
    suriyeli senin kardeşinse, siktir git evine al kardeşlerini.
...
- entry_name: |
  ...
  entry_fav_count: 89
  entry_content: |
    ekşiciler, artık bilgisayar başındayım. sorularınızı merakla bekliyorum.<br/><br/>tanım: mitingler nedeniyle geç kaldığım etkinliktir.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://instagram.com/p/BkLUmnrBPlJ/" title="https://instagram.com/p/BkLUmnrBPlJ/">kanıt</a><br/><br/>not: soru cevap etkinliğini mobil ve web tarayıcınızdan takip edebilirsiniz.
...
- entry_name: |
  ...
  entry_fav_count: 30
  entry_content: |
    güney kore teknik direktörü maça çıkmadan önce oyuncularının forma numaralarını değiştirmiş. sebebi ise batılıların korelileri hep birbirine benzetmesi imiş. böylelikle kim nerde oynuyor rakibin kafası karışacakmış.<br/><br/>tipini siktimin sinsisi, güldürdü evet.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    ingilizler taharet musluğu kullanmadığı için sinekler götlerine yapışmış durumda.
  entry_channels: spor
- entry_name: |
