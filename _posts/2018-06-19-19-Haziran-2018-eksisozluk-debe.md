...
- entry_name: |
    18 haziran 2018 faytonların kaldırılması
  entry_id:  78196734
  entry_writer: mimarishvili
  entry_fav_count: 80
  entry_content: |
    empati platformundan barış şengün ün duyurusunu yaptığı açıklama. adalara elektrikli fayton geliyor. sonunda sesimizi duydular. seçim öncesi olsa bile oy almak için olsa bile bir sürü canın hayatı kurtuldu. darısı izmir’deki canların başına. uplayalım ki sesimiz büyüsün çoğalsın ve hapis yasası da gelsin. <br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://tr.sputniknews.com/turkiye/201806181033908667-adalar-elektrikli-fayton/" title="https://tr.sputniknews.com/turkiye/201806181033908667-adalar-elektrikli-fayton/">https://tr.sputniknews.com/…alar-elektrikli-fayton/</a>
  entry_channels: haber
- entry_name: |
...
- entry_name: |
    tayyip'in kafasını yiyen şarloton teyze
  entry_id:  78204142
  entry_writer: hbegec
  entry_fav_count: 58
  entry_content: |
    bu röportajı yapan benim :)) gerçekten çok enteresandı uzun versiyonunu izlemek isteyenlere linki bırakıyorum :)<br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=-MmkyFy5dWo">https://www.youtube.com/watch?v=-mmkyfy5dwo</a>
  entry_channels: siyaset
- entry_name: |
    bayramdan sonra ilk iş günü
  entry_id:  78183816
  entry_writer: benarist
  entry_fav_count: 49
  entry_content: |
    direnin arkadaşlar 9 günlük bayram tatiline 2 ay kaldı.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 32
  entry_content: |
    az önce "erdoğan, ben sana camiide çekilmiş fotoğrafımı göndereceğim söz, ama benim de senden bir isteğim var, sen de bana üniversitede çekilmiş bir fotoğrafını gönder" dedi.<br/>güldürdü ince reis.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    (bkz: <a class="b" href="/?q=%c3%a7al+keke">çal keke</a>)
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    15 dakıkadır tuvaletimi tutuyorum.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    yakında götüne bile makyaj yapacakların salladığı olay.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    sanatından ötürü bir insanı yargılamak türkiyemize özgü bir davranış şekli. bakınız ezhel içeride başkaları başka şekillerde... bir insanı da yazdığı şiirden ötürü ahlaki yönden vurmak ister necip fazıl yazmış olsun ister muharrem ince tarafından yazılmış olsun yakışmaz. tabii burada muharrem ince oyunu kuralına göre oynuyor; amacı "ne özeli yaa o genel genel" <sup class="ab"><a title="(bkz: hatırlarsınız o günleri)" href="/?q=hat%c4%b1rlars%c4%b1n%c4%b1z+o+g%c3%bcnleri" data-query="hatırlarsınız o günleri">*</a></sup> misali bir dejenerasyon değil.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    ilk buluşmadan kadına hesap kilitleyen erkek
  entry_id:  78203869
  entry_writer: carsafgibideniz
  entry_fav_count: 0
  entry_content: |
    ben yaptım bunu. <br/><br/>kuralım var bu konuda. parayı ben öderim. bu konuda sıkıntı yok ancak ben parayı ödesem bile en azından cüzdan çıkartıp ödemeyi teklif etmesini beklerim. etmiyorsa da hesabı kitlerim. <br/><br/>kitlediğim kişi ile önce ufak bir flört dönemi oldu ama sonra çok sıkı arkadaş olduk. ödettiğim paranın misliyle ısmarladım kendisine, sonra söyledim açık açık ama çok heyecanlı olduğundan unuttuğunu söylemişti. hala çok yakın dostumdur kendisi. <br/><br/>kadınlar pek farkında değil ancak erkekten ödemesini beklemek ve teklif dahi etmemek, kendisini para karşılığı sunmak anlamına geliyor benim kitabımda. kendisine saygısı olan kadın en azından ödemeyi teklif eder. kendisine saygısı olmayan kadının size ne saygısı olabilir ki?
  entry_channels: ilişkiler
- entry_name: |
    çaylak onay listesi
  entry_id:  78199356
