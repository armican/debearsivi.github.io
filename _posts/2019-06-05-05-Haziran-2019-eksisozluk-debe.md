...
- entry_name: |
  ...
  entry_fav_count: 27
  entry_content: |
    "ya sorunun bir çözümü vardır ve kaygılanmak boşunadır. ya da sorunun bir çözümü yoktur ve kaygılanmak yine boşunadır."<br/><br/>-aristotales
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    (bkz: <a class="b" href="/?q=yeni+klas%c3%b6r+i%c3%a7indeki+yeni+klas%c3%b6r">yeni klasör içindeki yeni klasör</a>)
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    mersinde olan varsa yazsın tanışalım, diğerleri vakit kaybı yaşatmasın.
  entry_channels: ilişkiler,ekşi-sözlük
- entry_name: |
    motosiklete artçı olacaklara tavsiyeler
  entry_id:  90889076
  entry_writer: mysticwarrior
  entry_fav_count: 1
  entry_content: |
    size bu sıcakta giyilmesi zor gelen ekipmanların hepsi hayati önemlidir. ihmale gelmez, giyerken mızmızlanmayın..
  entry_channels: anket,motosiklet
- entry_name: |
    en güzel seven kadın burcu
  entry_id:  90865323
  entry_writer: denerta1
  entry_fav_count: 1
  entry_content: |
    burçların safsata olmasından dolayı tüm burçlar sayılmış doğal olarak. tabii bir de işin " güzel sevmek ne aq?" boyutu var. ne pis geyiktir bu...
  entry_channels: anket,ilişkiler
- entry_name: |
    baklavanın dünyanın en sağlıksız tatlısı olması
  entry_id:  90890967
  entry_writer: zamanda
  entry_fav_count: 1
  entry_content: |
    ben de diyodum bugun ofistekilere bi baklava dagitayim hem bugun benim bayramim falan derim diyodum ama dusununce insanlari zehirlemek istemedim acikcasi. <br/>baklavanin fotografina bakinca bile disime agri giriyor.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/1lyu1KKwC74" title="https://youtu.be/1lyu1KKwC74">the verve-bitter sweet symphony</a><br/><br/>tabi ki.
  entry_channels: anket,müzik,edebiyat
- entry_name: |
    kızımdan farkın yok diyen kaynana
  entry_id:  90887475
  entry_writer: bozosnn
  entry_fav_count: 0
  entry_content: |
    bunu damadına demiyorsa sorun yoktur.
  entry_channels: 
- entry_name: |
