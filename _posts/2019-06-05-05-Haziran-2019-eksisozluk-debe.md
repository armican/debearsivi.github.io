...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    beşiktaş'ın barcelona'yı 3-0 yendiği maç
  entry_id:  90879364
  entry_writer: depremoldudiyeyazmakicingeldim
  entry_fav_count: 104
  entry_content: |
    galatasaray'ın uefa ve süper kupayı aldığı, arsenal'i, real madrid'i elediği, beşiktaş'ın barcelona'yı top gibi oynattığı sene 2000.<br/><br/>liyakatın olduğu, kaliteli türk futbolcuların yetiştiği eski türkiye. umarım ülkedeki kanserden kurtulup o eski günlere tekrar döneriz.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  90875124
  entry_writer: korsan patates
  entry_fav_count: 40
  entry_content: |
    olayın çok içinde birisi olarak biliyorum ki sebebi kesinlikle diğer servislerin kapalı olması değildir. öyle olsa milli bayramlarda ya da hafta sonları da benzer yoğunlukları beklememiz gerekirdi. sebebi bir yıl boyunca annesi babasıyla ilgilenmemiş akrabalarıyla ilgilenmemiş gençlerimizin bayram ziyareti sırasında hazır gelmişken bir de bizim kocamanı doktora çıkaralım düşüncesidir. bu sayede bayramda anne babalarına bir serum taktırınca hayırlı evlat olduklarını zannederler. acil servislerin anne babalarının kronik hastalıklarına çözüm üretebileceğini düşünmeleri ise maalesef üzücü bir durum.
...
- entry_name: |
  ...
  entry_fav_count: 39
  entry_content: |
    istanbul'da kendi posterlerinin olduğu billboardların ışıkları kapatılan kişi. bu adam kazanır kazanmaz o ayrı ancak ak parti denen oluşumdakilerin ne kadar alçalabileceğini bizlere gösterdi.
  entry_channels: siyaset,haber
- entry_name: |
  ...
  entry_fav_count: 35
  entry_content: |
    dikkat et yalnız 'kız arkadaşımın babasının beni domaltması' şeklinde başlık açmak durumun da kalma sonra.
  entry_channels: ilişkiler
- entry_name: |
    canan kaftancıoğlu
  entry_id:  90872218
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    erkeklerden çok kadınlarda daha sık rastlanan olgu.<br/>yaş ilerledikçe itiraf ediyorlar hepsi bu.
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    şu an içinde olduğum durum ve halimden fazlasıyla memnunum. sükunet kadar güzel bir şey var mı?
  entry_channels: ilişkiler
- entry_name: |
    hakkı alkan
  entry_id:  90888695
...
- entry_name: |
    starbucks'ta içilmemesi gereken şey
  entry_id:  90880115
  entry_writer: muz orta yapan topcu
  entry_fav_count: 1
  entry_content: |
    buz ve renkli konsantre sıvı karışımı tüm yazlık içecekler.
...
- entry_name: |
    kadını yatakta tatmin edince her şeyi affetmesi
  entry_id:  90890975
  entry_writer: sen adisin
  entry_fav_count: 1
  entry_content: |
    beyinsiz bir kadınla birlikte olduğunuzu gösterir. beyinsiz kadınla birlikte olanda da beyin yoktur. ahahahha, partner demişler bir de. sevgili demeye dilleri varmamış. erkekler partner lafını sadece cinsellikte kullanıyorlar. onların anladığı dilden partnerle her kadını aynı sanıyorlar. ahahaha, delik çoraplılar. <br/><br/>şu saçmalıklara bakın, kadını tatmin etmek ona değer vermekmiş. ahahaha. değer verdiğini göstermek için ceplerinden beş kuruş çıkarmaya korkarlar. bunların değer verdiklerini gösterecekleri tek şey pipileri. en baştan sakat bunlar. bunlar kim, kadını tatmin etmek kim? ahahahaha.
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://eksiup.com/p/7y244878uhnv">https://eksiup.com/p/7y244878uhnv</a>
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/YRerQwKAM2A" title="https://youtu.be/YRerQwKAM2A">kalbim tekliyor ah gel hasta gibiyim</a>
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    eski bir haber.<br/><br/>hayırlı olsun kardeşim internet bağlatmışsın...
  entry_channels: 
---
