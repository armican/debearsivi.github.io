...
- entry_name: |
    ideal mesai saatinin 9/3 arası olması
  entry_id:  82453841
  entry_writer: themonster
  entry_fav_count: 40
  entry_content: |
    sabah 9 çok erken,10-16 arası mesai daha ideal.
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    20 ekimde kim olacak acaba? heyecanlı bir durum. senin açacağın başlığı sikeyim.
  entry_channels: spor,ekonomi
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    28 defa yazılmadan anlamayan mallar ve sözlükte aynı başlığa kendisinden önce ne yazıldığını okumaktan aciz mallar için bir daha yazalım;<br/><br/>fenerbahçe'nin yeni forma sponsoru olmuştur..
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    orospu çocukluğunun, pezevenkliğin şekil bulmuş hâlidir âdeta. sizin ben o cümleleri yazan elinizi, beyninizi sikeyim orospu çocukları.
  entry_channels: ekonomi
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    supplementler.comda vip üye olalı asır olmuş erkeğe kıyasla daha normal olduğuna emin olduğum erkektir.
  entry_channels: anket,yeme-içme
- entry_name: |
