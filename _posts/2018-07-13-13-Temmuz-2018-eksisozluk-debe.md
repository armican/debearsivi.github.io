...
- entry_name: |
    berat albayrak'ın antipatik tavırlarının nedeni
  entry_id:  79093934
  entry_writer: dondurmayacipsbananadam
  entry_fav_count: 157
  entry_content: |
    şımarıklık. adam padişah'ın kızıyla evli, her türlü güce erişimi var, sırtı asla yere gelmez gibi hissediyor. hamuru da iyi yoğrulmamış olduğu için bu güce erişmek onun yüzünün ortaya çıkmasına sebep oluyor.
...
- entry_name: |
    kısmi ohal için isim önerileri
  entry_id:  79096055
  entry_writer: artsivi
  entry_fav_count: 111
  entry_content: |
    ohalcik
  entry_channels: anket
- entry_name: |
    türkiye'nin tekrardan sikkeye geçmesi
  entry_id:  79103571
  entry_writer: roriro
  entry_fav_count: 94
  entry_content: |
...
- entry_name: |
  ...
  entry_id:  79087885
  entry_writer: freesmiles951
  entry_fav_count: 55
  entry_content: |
    acaba bunu gören kadın çaylaklar şöyle mi düşünecek;<br/>ulan bu herife bu kadar kız yazıyorsa kesin bunda bir şey vardır, hadi hemen biz de yazalım. ama dur adam boş adam değil biraz özenli yazayım ki beni beğensin. aa çaylaklardan mesaj alımına kapattım yazmıştı ama dur bakiim gidecek mi, hooop gitti hakkaten, hadi hayırlısı.
  entry_channels: anket,ekşi-sözlük
- entry_name: |
    erkeklerin hep seks düşünmesi
  entry_id:  79082886
  entry_writer: valencia190
  entry_fav_count: 52
  entry_content: |
    ben elektrik faturasını düşünüyorum, yarın yatırmazsam kesecek ibneler.<br/><br/>(bkz: <a class="b" href="/?q=do%c4%9fru+olmayan+%c3%b6nerme">doğru olmayan önerme</a>)
...
- entry_name: |
  ...
  entry_fav_count: 51
  entry_content: |
    hendekçi şirin<br/>bombacı şirin<br/>kaçakçı şirin <br/>....
...
- entry_name: |
  ...
  entry_fav_count: 43
  entry_content: |
    (bkz: <a class="b" href="/?q=defense+mechanism">defense mechanism</a>)<br/>başka türlü hayatta kalınmaz çünkü bu bozkırlarda.
  entry_channels: 
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    berat albayrak'ın karizmasını hazmedememek
  entry_id:  79102652
  entry_writer: saintly
  entry_fav_count: 42
  entry_content: |
    özellikle <a class="b" href="/?q=frodo+baggins">frodo baggins</a> kendisini çok kıskanıyor.<br/><br/>(bkz: <a class="b" href="/?q=y%c3%bcz%c3%bcklerin+efendisi">yüzüklerin efendisi</a>)
  entry_channels: siyaset
- entry_name: |
    kucaklanıp götünü açan ingiliz holigan emmi
  entry_id:  79102973
  entry_writer: marihuanback
  entry_fav_count: 38
  entry_content: |
    (bkz: <a class="b" href="/?q=bunu+g%c3%b6rd%c3%bc%c4%9f%c3%bcm%c3%bcz+iyi+oldu">bunu gördüğümüz iyi oldu</a>)<br/>internet çok acayip bir şey. şu an rusya da götünü açan bir ingilizi türkiyeden görebiliyoruz.<br/><br/>tanım: omuzlara alınmış, antilop testisli ingiliz amcadır.
  entry_channels: spor,haber
- entry_name: |
    12 temmuz 2018 emrah serbes hakkında çıkan karar
  entry_id:  79097986
  entry_writer: ratm214
  entry_fav_count: 38
  entry_content: |
    allah kahretsin sizi bu nasil bir karar? adam geberene kadar icmis ve efsunlanmis, bir aileye sebep olmus. sadece 4-5 sene yatacak? oyle mi? bu gibilerine muebbet vermezsiniz ama sokakta ha keza iktidarinizi elestirmeye kalkanlara gunes yuzu gostermezsiniz. adaletiniz batsin be.
  entry_channels: haber
- entry_name: |
    11 haziran 2018 içişleri'nin özerklik yetkisi
  entry_id:  79100835
  entry_writer: yagsag
  entry_fav_count: 30
  entry_content: |
    vadedilmiş topraklar uğruna vatanını satan siyonist köpekler.
  entry_channels: siyaset,haber
- entry_name: |
    kürtler harika insanlar inanılmaz savaşçılar
  entry_id:  79099218
  entry_writer: skumbag
  entry_fav_count: 28
  entry_content: |
    (bkz: <a class="b" href="/?q=karde%c5%9fim+seri+k%c3%bcrt+getir">kardeşim seri kürt getir</a>)
  entry_channels: siyaset,haber
- entry_name: |
    2023 eyalet sistemi referandumu
  entry_id:  79101356
  entry_writer: spitzer
  entry_fav_count: 28
  entry_content: |
    ülkenin en az %52'si, reyiz dediyse vardır bunda da bir hikmet diyerek "evet" diyecektir. bunlar atatürk dönemi öncesi, cumhuriyet öncesi osmanlı tebalarıdır. nedenlerini sabaha dek tartışırız ama bu devlet bunları ne yazık ki eğit(e)memiştir. bunlar toplum olamamış, halk olamamış yığınlardır. bunlardan bir şey beklemeyin. enselerine vurun sesleri çıkmaz, el etek öptürün sesleri çıkmaz. hepsini zevkle de yaparlar, bunlar böyledir.<br/><br/>bazıları demiş iyidir güzeldir, ege trakya uçar gider filan. sizin gerçeklerle bağlarınız tamamen kopmuş. damadını devlet kasasına koyan adam sizin emeğinizi de size verir, hiç meraklanmayın.
  entry_channels: siyaset,anket
- entry_name: |
    muharrem ince
  entry_id:  79077481
...
- entry_name: |
  ...
  entry_fav_count: 25
  entry_content: |
    bir ailenin yok olmasına sebep olan ve 13 yıl 4 ay hapis cezası alan katil. <br/><br/>not: yüksek alkollü araç kullananların kaza yapmasalar dahi adam öldürmeye teşebbüs etmekten ceza almasını diliyorum.
...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    ya bakın en azından bak en azından diyorum adam ingilizce videoları türkçe'ye çeviriyor. başka bir sürü youtube kanalı var yurt dışından götüme çatapat soktum gibi içerikleri alıp aynen yapıyor. içerik çevirmek bir meslek değil mi arkadaşım? bu adam demiyor ki ben keşfettim burayı ya da ben keşfettim bu bilgiyi. bir konu hakkında bilgi derleyip paylaşıyor. aynı iş üzerine çalışan farklı insanlar ve ya şirketler olamaz mı? fifa futbol oyunu yapıyor diye konami orospu çocuğudur mu diyelim? kalabak su satıyor diye nestle orospu çocuğu mu? piyasa böyle arkadaşım! sektörde aynı işi yapan birden fazla kişi ve ya şirket olabilir. tercih edilir edilmez orasını bilemem ama sen de insanlara yaptığı iş üzerinden küfür edemezsin.
  entry_channels: teknoloji,magazin
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    ateistlerin kendini bilge zannetmesi
  entry_id:  79101834
  entry_writer: aeb putain
  entry_fav_count: 12
  entry_content: |
    dünyanın yarısından fazlası saçma sapan ilahi peri masallarına inanınca insan istemsiz bir şekilde kendini zeki hissediyor tabi. aynı şeyin başka bir versiyonu da akp'li olmadığı için insanın kendini bilge zannetmesidir. lakin gerçekleri baz alırsak başkalarının aptal olması insanı bilge yapmaz. sadece mevzubahis aptallığın bir parçası olmazsınız, o kadar.
  entry_channels: siyaset,haber
- entry_name: |
    10 temmuz 2018 ilica hotel rezaleti
  entry_id:  79102298
  entry_writer: turk eli
  entry_fav_count: 10
  entry_content: |
    rezalet puani 2/10 olan tatsizlik.<br/><br/>ondeki ciftten sonra 'pardon sirada ben vardim' denmesiyle bitecek bir konu iki taraf tarafindan yok yere sakiz gibi uzamis.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    beynimizin pekmezini akıttığı sıcaklar geldi.(bkz: <a class="b" href="/?q=welcome+to+hell">welcome to hell</a>)
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    açık ara farkla konya. ikinci sırada ise malesef ki yaşadığım şehir bursa gelir. eski bursa’ yı özlüyorum. evliyalar şehri ve lakabının hakkını veren yeşil bursa’m
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    iletişim ile ilgili konular tehlikeli konular. duman ile haberleşme diye konu acsaniz bile xiaomi manyaklari orayı basıp "bizimki daha iyi duman çıkarıyor " diyebilirler.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    zigana dağında yenen baharat katılmadan mangalda pişirilen 1 kg kuzu, yanında mayalı hamurdan ekmek, çoban salatası, içecek olarak da sürahide gelen su.
...
- entry_name: |
    12 temmuz 2018 beşiktaş şahtar donetks maçı
  entry_id:  79104895
  entry_writer: surekli f5e basan adam
  entry_fav_count: 0
  entry_content: |
    0-0 bitmiş olandır. <br/>beşiktaş’ın hazırlık maçından bile haz etmeyen kamilleri de görmüş olduk bu maç sayesinde.
  entry_channels: spor
---
