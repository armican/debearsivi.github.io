...
- entry_name: |
  ...
  entry_fav_count: 160
  entry_content: |
    gelecek kaygısı, bitmeyen ve durmayan düşünceler içerisinde batmak ve nasıl çıkacağını bir türlü bulamamak.
...
- entry_name: |
  ...
  entry_fav_count: 51
  entry_content: |
    sırf makine mühendisliği - taşak kokusu yazılsın diye açılmış bir başlık.
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    kış lastiği vs dört mevsim lastik
  entry_id:  85219473
  entry_writer: nietzsche musluman oldu
  entry_fav_count: 47
  entry_content: |
    kış mevsimi: kış lastiği&gt;dört mevsim lastik&gt;yaz lastiği <br/>yaz mevsimi: yaz lastiği&gt;dört mevsim lastik&gt;kış lastiği<br/>yani dört mevsim lastik kışın kış lastiğinin yerini tutmaz, yazın yaz lastiğinin yerini tutmaz.
...
- entry_name: |
    c. yılmaz'ın gazeteci kovdurmaya çalışması iddiası
  entry_id:  85232094
  entry_writer: skumbag
  entry_fav_count: 45
  entry_content: |
    kafayı cem yılmaz'la bozmuş olan bir müptezelin iddiasıdır.
  entry_channels: 
- entry_name: |
...
- entry_name: |
    yağan kar görüldüğünde akla gelen ilk şey
  entry_id:  85208643
  entry_writer: themerid
  entry_fav_count: 18
  entry_content: |
    kar sessizliği. gece kar yağmıştır sabah uyanırsın ses seda yok sanki bütün dünya susmuş gibidir. <br/>işte her kar yağdığında o sessizliğe uyanır mıyız diye düşünürüm hep.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  85208477
  entry_writer: cihanturk
  entry_fav_count: 16
  entry_content: |
    boş konuşuyorsunuz. <br/>aktif olarak siyasetle uğraşan biri zaten entelektüel olamaz. gerçek bir entelektüel ya aktif siyasete girmez ya da girdiyse kısa zamanda kenara itilir. hem entelektüel hem de siyasetçi olmak geçmişte de pek az karşılaşılmış bir durumdur. şu anda da büyük ve rant imkanı olan hiç bir partide (sağ-sol-milliyetçi-islamcı fark etmez) entelektüel insan siyaset yapamaz.
...
- entry_name: |
    suriyelilere kimse burada ne yapıyor diyemez
  entry_id:  85238589
  entry_writer: outdoor
  entry_fav_count: 13
  entry_content: |
    aynı kişi fethullaha övgüler dizip firari savcı öz için kahraman diyordu. unutmayalım. videolar youtube'da.
  entry_channels: siyaset,haber
- entry_name: |
    ekşi itiraf
  entry_id:  85209028
...
- entry_name: |
    cinsellik düşününce hapşırmak
  entry_id:  85230089
  entry_writer: imanli imansiz
  entry_fav_count: 13
  entry_content: |
    cinselliğe karşı alerjiniz olabilir, bi doktora görünülmesi gereken hede <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
...
- entry_name: |
    iyi bir grafikerin olmazsa olmazları
  entry_id:  85237562
  entry_writer: mungonmun
  entry_fav_count: 6
  entry_content: |
    mac bilgisayar ve “abi mac’te tasarım yapmak bi başka oluyoe yeaa” diye yayık konuşacak bir ağız.
  entry_channels: sanat,programlama
- entry_name: |
    en iyi ağrı kesici
  entry_id:  85209774
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    bir gece ansızın gelecektir. geldiğinde verilen kayıplar allahın taktiri değil, hükümetin almadığı önlem sebebiyle olacaktır.
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    fransız bir erkekle evlenmek
  entry_id:  85234130
  entry_writer: natalya tommiks texas julyet
  entry_fav_count: 4
  entry_content: |
    türk kadınlarına sesleniyorum. <br/>dünyada, evi geçindirmenin, kavgada öne atılmanın, musluğu tamir etmenin, araba, okul taksidi ödemenin bunun yanında muazzam bir kariyer yapmanın tüm sorumluluğunun hala erkekte olduğu son coğrafyalardan birinde yaşıyorsunuz. <br/>evet kadınlar da çalışıyor ama yarın istifa etseniz kimse size niye diye sormaz. erkek öyle mi? üç ay işsiz kalsan annen bile selam vermiyor. bu oğlan hayırsız çıktı diye. <br/>tadını çıkarın bir sonraki jenerasyonda herkes fransız erkeği olacak. garanti ediyorum bunu. o zaman tekrar konuşalım. <br/>araba değil bak tır kamyon tamirciliği yapan, çiğ tavukları kasa kasa pazara taşıyan mavi gözlü elfler diyarından seslendim.
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_channels: anket,ekşi-sözlük
- entry_name: |
    sevgilisi erkek bayan kuaförüne giden erkek
  entry_id:  85239611
  entry_writer: başlık taşıyan
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=sevgilisi+erkeklerin+%c3%a7al%c4%b1%c5%9ft%c4%b1%c4%9f%c4%b1+kuaf%c3%b6re+giden+erkek">sevgilisi erkeklerin çalıştığı kuaföre giden erkek</a>)
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    dış görünüşü ve tatlı bir havası olduğu kadar; hobileri olan, zevk sahibi ve kültürlü bireyler olmasıyla da bazen dikkatimi çeken kadın güzelliğidir. <a class="b" href="/?q=mersin">mersin</a>'de böyle bir kadına rastlamak; genellikle her yere makyaj, fönlü saçlar ile gittikleri ve ellerinden ön kamerası daima açık cep telefonlarını düşürmedikleri için oldukça güçtür.
  entry_channels: 
---
