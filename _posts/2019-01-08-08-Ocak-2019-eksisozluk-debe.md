...
- entry_name: |
    dünyada olmayan 6 element türkiye'de bulundu
  entry_id:  85209650
  entry_writer: deli bokun biri
  entry_fav_count: 672
  entry_content: |
    (bkz: <a class="b" href="/?q=g%c3%b6t%c3%bcnden+element+uydurma">götünden element uydurma</a>)<br/><br/>(bkz: <a class="b" href="/?q=chomarium">chomarium</a>)
...
- entry_name: |
  ...
  entry_fav_count: 197
  entry_content: |
    alkollü içkilerden alınan vergi yarı yarıya indirilsin, alkollü araç kullanmanın cezası ikiye katlansın .
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    palu ailesinin chp'li olması
  entry_id:  85228073
  entry_writer: yuksek muhendisim ben
  entry_fav_count: 93
  entry_content: |
    torunlarina koyduklari recep tayyip ismiyle ayan beyan ortada olan gercek!
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 60
  entry_content: |
    ne yapalım yani, asker gibi whatsapp'ın başında bekleyip her mesaja cevap mı yetiştirelim. fiziken ve ruhen müsait oldukça cevap yazıyoruz işte.
...
- entry_name: |
  ...
  entry_fav_count: 57
  entry_content: |
    xiaomi gibi yükseldi değerin,<br/>ederin çok olmasa da boynumu eğerim,<br/>ne bu, aşk mı? sanmam,<br/>ama ah bir gülsen, kralını tanımam... <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
...
- entry_name: |
  ...
  entry_fav_count: 50
  entry_content: |
    ing. bir şampiyona benzeyen kıza lanet olsun.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 42
  entry_content: |
    eveeeet. geldik yine fakir edebiyatının çılgın attığı başlıklardan birine daha.<br/><br/>arkadaşım kimse zengin ayağına yatmıyor, hava atmıyor. sıradan markalar olan nike ve adidas’ın spor ayakkabılarına bir bakın. 400-500 liraya bulduğun ayakkabının yüzüne bakılmıyor artık bırak zenginliği. zengin adam balenciaga’dan, prada’dan örnek verir sana için rahat olsun. <br/><br/>öğrenciyken bile iyi kötü alabildiğimiz ayakkabılardı bunlar. adam doğru söylüyor. fiyatlar şaka seviyesine geldi iyiden iyiye.<br/><br/>kinetix neymiş abi ayrıca? işimizi görürmüş. o çirkinlik abidesi, çapaklı yapışkanlı modeller işimizi falan göremez arkadaşım, siz de biliyorsunuz.
  entry_channels: moda
- entry_name: |
  ...
  entry_fav_count: 36
  entry_content: |
    yarın işte olacağım için spoiler yemekten cekindigim programdır... bakın akşam tekrarını izleyeceğiz, spoiler vermeyin ne olur.<br/><br/>kaderde müge anlı'dan spoiler yememek için dikkat beklemek de varmış.
  entry_channels: tv,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 23
  entry_content: |
    hele ki, orta doğu gibi bir lağımda, hatta türkiye gibi doğu-batı arasında kalmış, nasıl bir din yaşadıklarını o dinin mensuplarının da bilmediği, kuralları siyasi iktidar tarafından koyulan bir din ile domine edilen arabesk bir kültürde çocuk yetiştirliyorsa, vatana ve ulusa sağlıklı bir evlat yetiştirmek için, bilumum vitaminlerden ve bağışıklık aşılarından daha çok koruma sağlayan bir formüldür.<br/><br/>boynundaki haçı suya batırıp götüne sokarak ayin yapan delilerden, boktan bir duvarın altında ağlayarak dilek dileyen ruh hastalarından; haramı, yolsuzluğu, hırsızlığı, gıybeti, tecavüzü, ensesti, pedofiliyi ve diğer her türlü boku yiyip ahlak ve namustan bahseden pisliklerden çocuklarını uzak tutmaları için, aklı başında olan her türk ailesi, gerek doğru eğitim tercihleriyle, gerekse aile içinde verilen yönlendirmelerle, elinden geldiğini ardına koymadan; şahsını, çocuğunu her türlü dinden ve dinciden korumakla mükellef bilmelidir.
  entry_channels: 
- entry_name: |
    pintipanda
  entry_id:  85234400
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    (bkz: <a class="b" href="/?q=westworld">westworld</a>)
  entry_channels: anket,tv,müzik
- entry_name: |
    7 ocak 2019 eren erdem yakalama kararı
  entry_id:  85243145
  entry_writer: azdaolsacokseybilenadam
  entry_fav_count: 18
  entry_content: |
    gün içerisinde tahliye kararı verilen erdem için tekrar yakalama kararı çıkartılmasıdır. yargı iyice 23 nisan müsameresine döndü. koltuğa devamlı başkaları geçip farklı kararlar veriyor.
  entry_channels: siyaset,haber
- entry_name: |
    islam slimani
  entry_id:  85227872
  ...
  entry_fav_count: 16
  entry_content: |
    hazır lig arasındayken unutanlara hatırlatalım, bu amk avelinin ligde çektiği son 24 şut kaleyi bile tutmadı. en son 1 eylülde 5. hafta maçında gol atmış amk ki onun üstüne 11 maç daha oynamış. senin ben oynadığın futbolu ayrı oynayacağın futbolu ayrı sikeyim.
  entry_channels: spor
- entry_name: |
    ekşi itiraf
  entry_id:  85209028
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    ingiltere'de suikaste ugrayabilirim korkusuyla gitmeyen fetocu hain. aslinda oyle bir ihtimalin olmadigini biliyor. sirf karalamak icin camur atiyor. omurgasiz bir olusumun omurgasiz bir militani kendisi.
  entry_channels: spor
- entry_name: |
    chp'nin ordu bb adayının idris naim şahin olması
  entry_id:  85240355
  entry_writer: rafaello bi pacrio
  entry_fav_count: 15
  entry_content: |
    nereden inanayım bu haberin doğruluğuna? bi takla atsında görelim.
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    egitimli dusunmesini bilen insan sunu sorar. kopeklerin sokakta sehirde apartman dairesinde ne isi var?<br/><br/>cevabi verince zaten sorunda kokunden cozulur<br/><br/>abd de yasiyorum 26 yildir daha hayatimda hic sahipsiz kopegin sokakta dolastigini gormedim cunku gorulurse insanlar belediyeyi aninda ariyorlar belediye geliyor kopegi kediyi rakun yada hayvanin cinsi neyse alip hayvan bakim merkezine goturuyor. orada asisi bakimi temizligi yapiliyor yediriliyor. fotosu ve bilgileri internete konuyor isteyen bu hayvani sahipleniyor. 30 gun icinde kimse almazsa bu hayvani bedavaya o zaman uyku hapi verip olduruyorlar<br/><br/>bitti bu kadar.<br/><br/>turkiyedeki bu sokaklardaki 3. dunya savasi nedir arkadas? bilincsizlik okuzluk egitimsizlik kiroluk 4 sene universiteye gidip ahkam kesenler yada evinde 2 kopek var diye agzina gelen kufru edenler<br/><br/>bu nedir arkadas? neden bu kadar geriyiz neden sokaklar filler zurafalar ve zebralarla dolu? cunku ortada belediye yok cunku orasi dingonun ahiri. yaziklar olsun
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    erkek halimle değil okumaya, başlığa girmeye tırsmama neden olan sorulardır. <br/>zekice sorulmuş, insanı gülümseten sorular yok değil ama maalesef çoğu tek elle klavye kullanan ortaokul ergeni karakterindeki yazarlardan gelmiş ve türkiye'de cinselliğin ne hallerde olduğunu bizlere gösterip içten içe üzülmemize neden olmuştur.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
...
- entry_name: |
    luigi datome'nin türkçe konuşması
  entry_id:  85236778
  entry_writer: daenerys targaryen in askerleriyiz
  entry_fav_count: 7
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://twitter.com/sekermurat/status/1081880134095912960" title="https://twitter.com/sekermurat/status/1081880134095912960">https://twitter.com/…rat/status/1081880134095912960</a><br/><br/>fenerbahçeli basketbolcu, nam-ı diğer italyan ressam <a class="b" href="/?q=luigi+datome">luigi datome</a>'nin çatır çatır türkçe konuşması hadisesi. helal.
  entry_channels: spor,anket
- entry_name: |
    kadınları çözmüş erkek
  entry_id:  85225172
  entry_writer: serbest still
  entry_fav_count: 7
  entry_content: |
    “bir parçanı bozuk bırak, onarmaya aşık kadınlar için” mottosu ile hareket eder.
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=MwpMEbgC7DA" title="https://www.youtube.com/watch?v=MwpMEbgC7DA">tom odell - another love</a>
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    yüzü güzel, beyaz ve zayıfsa, biraz da memesi varsa inanılmaz asaletli görünen kızlardır. birinci tercihim bu kızlardır ancak özellikle ortadoğu'da bulmak çok zordur ve değeri çok yüksektir.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  85241991
  entry_writer: kimiraikkonen
  entry_fav_count: 1
  entry_content: |
    ateş benim yıkayan, yuyan, emziren annem.<br/>bir arınma kurnası olsa gerek cehennem.<br/><br/>(bkz: <a class="b" href="/?q=necip+faz%c4%b1l+k%c4%b1sak%c3%bcrek">necip fazıl kısakürek</a>)
  entry_channels: anket,edebiyat
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    müslüm gürses - küskünüm<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/Gusv0Il0TJI" title="https://youtu.be/Gusv0Il0TJI">müslüm gürses - küskünüm</a><br/><br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>küskünüm<br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/>her şey boş anlamsız şimdi gözümde<br/>bin öfke bin nefret her bir sözümde<br/>yılların çilesi belli yüzümde<br/>aynada baktığım yüze küskünüm
