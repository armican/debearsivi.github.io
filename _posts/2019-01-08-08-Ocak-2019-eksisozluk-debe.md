...
- entry_name: |
  ...
  entry_fav_count: 258
  entry_content: |
    haber sıçmak için yapılmış haberdir.<br/><br/>haber güzel haber sarıyo ama sormazlar mı adama türkiyede trafolara niye 34.5k volt elektrik geliyor diye.<br/><br/>sanayi tipi elektrik 38000 değil 380 volttur.<br/><br/>evdeki 220v elektrik bile insanı öldürmeye yeterliyken 38 bin volt bi insanın sülalesini ters yatırır düz sever.
...
- entry_name: |
  ...
  entry_fav_count: 56
  entry_content: |
    tam da fenerbahçe’nin ihtiyacı olan çiğ etle beslenen, ateşin bulunmasından bile haberi olmayan futbolcu ihtiyacını karşılayacak türden bir transfer hamlesi.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 28
  entry_content: |
    bu ülkeyi bizim gibi kıymet bilmez gerizekalı bir topluma bırakmasıdır.
...
- entry_name: |
    kyk erkek yurdunda banyoya sıçmak
  entry_id:  85245903
  entry_writer: yellowlist
  entry_fav_count: 19
  entry_content: |
    bir elimde şampuan diğer elimde havlu banyoya girdiğimde şok olduğum eylem. adam bildiğin organını sıçıp bırakmış rezillik diz boyu. bu ülkede yaşamak da öğrenci olmak da ayrı bi rezillik.<br/>edit: imla
  entry_channels: eğitim
- entry_name: |
    ilk türk swinger cluba isim önerileri
  entry_id:  85246472
  entry_writer: veritasunitascaritas
  entry_fav_count: 19
  entry_content: |
    (bkz: <a class="b" href="/?q=de%c4%9fi%c5%9fmeli+saplage%c3%a7">değişmeli saplageç</a>)
  entry_channels: anket,ilişkiler
- entry_name: |
    ekşi itiraf
  entry_id:  85209028
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    biraz eğitim ve farklı bir çevreyle siyasette çok başarılı olabilecek bir profil.<br/>zengin ve rahat bir hayat sürebilirdi.<br/>küçük oynamış, kaybetmiş.
  entry_channels: tv,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    kimse yazmamış; ama <a class="b" href="/?q=%c3%bcvey+baba">üvey baba</a> ülkedeki bu tarz yapımlardan sadece biridir.
  entry_channels: anket,tv,sinema
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    çok yazılmış ama kesin ve net çözümü ılık şekerli sudur.<br/><br/>bunca senedir yok minoset, yok apranax içip içip kendime eziyet etmişim. boşuna yıllık iznimden yemişim. <br/><br/>bir bardak ılık suya 4-5 adet küp şeker atıp karıştırdıktan sonra için. 15-20 dakikaya 100 metre engelli koşusuna çıkarsınız.
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    o an bulunan yeri terketmek, yürümek sonra uzun uzun
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    "tehlikeli sayılmam artık<br/>kalbimi kalın bir kitabın arasında kuruttum"<br/><br/><a class="b" href="/?q=didem+madak">didem madak</a>
  entry_channels: anket,edebiyat
- entry_name: |
...
- entry_name: |
    sözlükte kadınların aşağılanması
  entry_id:  85242946
  entry_writer: yani diyorum ki
  entry_fav_count: 4
  entry_content: |
    sözlükte aşağılanmayan canlı var mı ki amk, dedirten başlıktır. kediden, tibet öküzüne varana kadar dilimizden kurtulan bir şey bırakmamışız alimallah!
  entry_channels: ilişkiler,ekşi-sözlük
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    (bkz: <a class="b" href="/?q=milletvekilli%c4%9fi">milletvekilliği</a>)<br/><br/>en azından millet için öyle.
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    güzellik ve çekicilik farklı şeylerdir. minyon kadınlar kişilere göre olmak ile birlikte daha çekici olabilir. yalnız güzellik yüz görünümü ile alakalı. minyonluk ile alakalı değil diye düşünüyorum. dolayısıyla uzun ya da kısa boylu, zayıf ya da kilolu kadınlar güzel olabilir. çekicilik ayrı bir durumdur.
  entry_channels: anket
- entry_name: |
    amerikan gay'i vs türk gay'i
  entry_id:  85246537
  entry_writer: ogaltu
  entry_fav_count: 2
  entry_content: |
    gözlemlediğim kadarıyla türk olanlar "yok mu beni siken" modunda gezerken, amerikan olan normal sosyal hayatına devam ederken erkek arkadaş ediniyor ya da edinmiyor. bu ona rahatsızlık vermiyor.
  entry_channels: ilişkiler
- entry_name: |
    sözlükçülerin en sevdiği metal müzik şarkısı
  entry_id:  85246614
  entry_writer: jord
  entry_fav_count: 1
  entry_content: |
    sepultura - <a class="b" href="/?q=refuse%2fresist">refuse/resist</a>
  entry_channels: 
- entry_name: |
    bird box
  entry_id:  85222151
  ...
  entry_fav_count: 1
  entry_content: |
    tam bandersnatch tarzı yapmaya müsait bir film olmuş aslında büyük fırsat kaçmış.
  entry_channels: sinema,edebiyat,spoiler
- entry_name: |
    üstteki yazarın nickinin düşündürdüğü
  entry_id:  85248155
  entry_writer: cekilbakim
  entry_fav_count: 0
  entry_content: |
    gerginim dokunmayın<br/>yazmıştım ama geç kalmışım.<br/>o zaman bi tek tcsini yazmamış yazar
  entry_channels: anket,ekşi-sözlük
- entry_name: |
    tank fabrikasını koç'ların alması
  entry_id:  85245915
  entry_writer: stukatr
  entry_fav_count: 0
  entry_content: |
    koç'a değil; bmc'ye gidecek; sancak, sıfır maliyetle ordunun bütün zırhlı araç üretim faaliyetinin sahibi olacaktır. öyle ki, kurumda çalışanların maaşlarını dahi devlet ödeyecek. aynı sancak, şu aralar bmc markasını yeni bir şirkete<sup class="ab"><a title="(bkz: bornova motor company)" href="/?q=bornova+motor+company" data-query="bornova motor company">*</a></sup> çevirip önceki dönemden kalan alacakları olan işçilere kapıları kapatmanın, haklarını yemenin peşindedir.<br/><br/>t-155 fırtına obüsleri de aynı fabrikada yapılmıştı, fırtına 2 projesinde araçları üretecek olan kurum da buydu. o da bmc'ye gidecek.
  entry_channels: 
- entry_name: |
    lisede en başarılı olunan ders
  entry_id:  85245278
  entry_writer: a k q j 10
  entry_fav_count: 0
  entry_content: |
    matematik. matematik benim için bir dersten ötesi bir hayat tarzıdır. lise biteli 15 yıl olsa bile hala bitmeyen bir sevdadır.
