...
- entry_name: |
  ...
  entry_fav_count: 177
  entry_content: |
    66.53 tl fiyatı olan, gebeliği önleyici hap. regl düzenini bozar.<br/><br/>aklıma bir anım geldi, anlatayım.<br/><br/>nöbetçiyim, gece 3 civarı bir adam geldi 30 yaşlarında. ella istedi verdim ve bir bardak su istedi, onu da verdim. baktım ilacı içmeye teşebbüs ediyor. ne yapıyorsun demeye kalmadı gözümün önünde içti ilacı. <br/><br/>meğer sevgilisi demiş ki buna ilacı sen içeceksin, bu da sorgulama gereği bile duymadan inanmış kadına.<sup class="ab"><a title="(bkz: öyle de mal)" href="/?q=%c3%b6yle+de+mal" data-query="öyle de mal">*</a></sup>
...
- entry_name: |
    minimalist bir koylu
  entry_id:  85375366
  entry_writer: mulkunizam
  entry_fav_count: 23
  entry_content: |
    süri süri esad esad bom bom
  entry_channels: ekşi-sözlük
- entry_name: |
    fetöcüler'in atatürk'ten nefret etmesinin sebebi
  entry_id:  85393474
  entry_writer: scorpioraptor
  entry_fav_count: 20
  entry_content: |
    bu gibi ümmetçi yaratıkların en büyük özelliğiidir atatürk nefreti. yemin ederim atatürk kimdir bilmeseydim bile bu adamların nefret ettiği şeyi severdim o denli yani.
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    adına <a class="b" href="/?q=hayat">hayat</a> diyorlar.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    bizim örnekleme dersi öyleydi. 100 kişilik sınıfta 10 kişi falan anca geçerdi. adam 3- 4 senede bir birikenleri temizlemek için kolay sınav yapardı.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    bunu google'a sorsan şöyle derdi:<br/><br/>bunu mu demek istediniz: " mühendis erkeklerin çekici olmamalarının sebebi"
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    2 gündür ülkenin durumunu, türkiye'de yaşayan caniler hakkında o kadar çok gözlem yapma şansımız oldu ki. biz hayvanlara işkence edenlere, öldürenlere falan boşuna şaşırıyoz. ekşisözlük de bile bu kadar çok potansiyel hayvan katili varken ülke de kimbilir ne kadar hayvan katili ruh hastası vardır.<br/><br/>umuyorum ki cehennem vardır. umuyorum ki hak ettiğinizi en azından orda alırsınız.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    işin acı yanı da oradaki garibanın belki de ailesinin geçimini düşündüğü için bir şey diyememesi.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    hintli ve pakilerin konuştuğu ingilizce telaffuz açısından daha kötü olabilir ama türklerin genel olarak ingilizcesi daha kötü.<br/><br/>gerçi kendi dilini bu kadar kötü kullanıp, 30 civarında kelime barındıran kelime haznesiyle tüm hayatını idame ettiren bir kabile için yine iyi sayılabilir.
...
- entry_name: |
    uzaysal uyum var iken çam balını kuğurdayıp yemek
  entry_id:  85399442
  entry_writer: skumbag
  entry_fav_count: 2
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    zamanında <a class="b" href="/?q=ak%c3%bcn+sinemas%c4%b1">akün sineması</a> kapatılırken kılını kıpırdatmayan ibneler ,satılan incik,boncuk ve mısır'dan pay alamıyor diye ağlamayacak.sıra size de gelecek dediğimizde götleriyle gülüyorlardı.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    sürekli ona buna çakmaktan bahsetmiyorsa olmama ihtimali vardır.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    tramvay yapılmadan önce de sonra da üçer şerit gidiş-gelişten oluşan caddenin, tramvay yapıldıktan sonra bir şerit azaldığını iddia eden zeki sözlük yazarlarının yaşadığı şehir.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bir an önce evlenip çocuk yapma telaşına girdikleri için normal durumdur.
  entry_channels: ilişkiler
- entry_name: |
    iş alamayan sanatçının bodrum'a yerleşmesi
  entry_id:  85394411
  entry_writer: oric
  entry_fav_count: 0
  entry_content: |
    üst katta manzaralı dairenin kirasını ödeyememesi sebebiylendir
