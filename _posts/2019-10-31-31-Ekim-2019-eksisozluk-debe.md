...
- entry_name: |
    sarayın lisanssız windows kullanması
  entry_id:  97179516
  entry_writer: morphin
  entry_fav_count: 142
  entry_content: |
    1- kamu kuruluşlarında kms lisans server kullanılır. bazı durumlarda boot sonrası lisans çekilemeyebilir veya kms server down olabilir, bu sebeple deneme sürümü yazısı çıkabilir.<br/>2- deneme sürümü yazdığı için ortada kanunen yine bir sorun yoktur, çünkü crack'li değildir, adı üstünde deneme sürümüdür ve windows belirli bir süre bu şekilde kullanmaya izin vermektedir. <br/>3- sorun rapor edilmediği sürece it ekibi ne yapabilir? sorun rapor edildi mi veya bu bir sorun mu biliyor muyuz? belki sırf bu konuşma için yeni kuruldu veya kendi kişisel bilgisayarı? <br/>4- tai nin 2000 üzerinde enterprise volume lisansı vardı bildiğim kadarıyla. <br/>5- firmalar tek tek gezip lisans kontrolü yapmaz, pc adedi kadar lisans alır ve tek bir noktadan network'te boot olan cihazlara dağıtır, her boot sonrası lisans değişebilir hatta... boşta lisans yoksa o günlük lisanssız çalışabilir, bir sonraki gün iş yerine daha erken gelip kimse kapmadan kms'den lisans çekebilir. <br/>6- 4k pc varsa 2k lisans alınır orası ayrı ama bu microsoft ile yapılan anlaşma ile yine legaldir. microsoft ne kurtarırsam kardır şeklinde bir yaklaşım sergiler ve ses çıkarmaz. (bu konuyla ilgili çok mesaj aldım, evet arkadaşlar microsoft karnı doyduğu sürece ses çıkarmaz, acıkırsa eğer ekip gönderip kurumları inceleyebilir. bu ekip dediğim kişiler ekonomik tetikçilerdir ve şantaj, dayatma unsurları ile saldırıp koparır giderler.)<br/><br/>son olarak burada tartışılması gereken asıl konu neden windows kullanıldığıdır.
...
- entry_name: |
  ...
  entry_fav_count: 50
  entry_content: |
    kış, yaz gibi ilgi orospusu bir mevsim değildir. insanın ruh halini, yaşanmışlıklarını, hayata dair umutlarını yansıtan bir mevsimdir. iç dünyası karışık, karanlık ve buz gibi olan insanlar bu yüzden çok sever kış aylarını.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    burada genelleme yapan arkadaşlar için sadece şunu söylemek istiyorum.eve atamayacağınız erkekler de var.öyle eve gel diye yazana koşarak gitmiyoruz.
  entry_channels: anket,ilişkiler
- entry_name: |
    ekşi itiraf
  entry_id:  97163009
...
- entry_name: |
  ...
  entry_id:  97191039
  entry_writer: 12 angry women
  entry_fav_count: 6
  entry_content: |
    seğmenler’den tunalı’ya yürümek.
  entry_channels: anket,seyahat
- entry_name: |
    hayatınızdan 24 dakika çalacağım
  entry_id:  97191217
  entry_writer: yatacakyerimyok
  entry_fav_count: 5
  entry_content: |
    üzgünüm çalamadın :(
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    ligin ilk birkaç maçında yaptığı hataları görmezden geldim, düzeltir diye. ama her maç aynı hata yapılmaz ki kardeşim. yeter artık. bırak şu anlamsız paslaşma sevdasını. sanki tiki taka futbol oynana ligdeyiz de ısrarla pas yapmaya çlaışıyorsun. şişir gitsin.
  entry_channels: spor
- entry_name: |
    şu an okunan kitap
  entry_id:  97180724
  entry_writer: ellisande
  entry_fav_count: 1
  entry_content: |
    <a class="b" href="/?q=jose+saramago">jose saramago</a> - <a class="b" href="/?q=g%c3%b6rmek">görmek</a>
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    sarılmak. hicbir sey söylemeden sadece sarılmak.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    soğuk kış günlerinde:<br/><br/>- sıcacık odada kitap okumak mı? <br/>- karda yurümek mi? <br/>- eve kapanıp dizi izlemek mi?<br/>- sıcak şarap eşliğinde müzik dinlemek mi?<br/><br/>sıcak yaz günlerinde: <br/><br/>- otel havuzunda, denizde yüzmek mi? <br/>- tarihi yerleri gezmek mi? <br/>- kerpiç köy evinde köy tatili mi? <br/>- başını alıp gitmek mi? <br/><br/>hangisi?
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    midesizlikte master degree dediğim eylemdir. illa bunun yanında bir şey tüketilecek ise yoğurt en idealidir. ancak ayrı kâse'de servisi ile makbuldür. açık büfe usulü farklı farklı fantezilere girmemek gerek.
