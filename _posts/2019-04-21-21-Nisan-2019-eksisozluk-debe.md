...
- entry_name: |
  ...
  entry_fav_count: 409
  entry_content: |
    halkı sınıflandırıp ayrıştırmadıkları için sağ görüşlü olmadıkları kesin. sol görüşlü olmalarını bekleyen de yok onlardan. atatürk'ün ilke ve inkilaplarını kılavuzları olarak gördükleri sürece bizim açımızdan sıkıntı yok.
  entry_channels: siyaset,haber
- entry_name: |
    20 nisan 2019 ibb'deki işçi kıyımı
  entry_id:  89150437
  entry_writer: chingmai
  entry_fav_count: 326
  entry_content: |
    oğlum manyak misiniz?<br/><br/>merve kalfa diye resmi verilen kişi ünlü porno yıldızı mia khalifa.<br/><br/>hay ben sizin trollugunuzu sikeyim.
  entry_channels: moda,seyahat
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: siyaset,anket
- entry_name: |
    yunanlıların türkleri moğol diye aşağılamaları
  entry_id:  89139071
  entry_writer: coq
  entry_fav_count: 120
  entry_content: |
    moğol deyince neden aşağılanmış oluyoruz?<br/>bana söylemediğiniz bişey mi var olum?<br/>kötü bişey mi bu moğol olmak?<br/><br/>sorularını sorduran başlık.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
    fetullah gülen'e sarılan adam
  entry_id:  89149361
  entry_writer: i was tony montana
  entry_fav_count: 51
  entry_content: |
    (bkz: terörle mücadele kapsamında fetöyü tutup siken adam)
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    1 gb internetin 19 tl olması
  entry_id:  89146301
  entry_writer: veni vidi yaziyorum
  entry_fav_count: 41
  entry_content: |
    bu çağda hâlâ <a class="b" href="/?q=turkcell">turkcell</a> kullanılması daha acıdır. <br/><br/>(bkz: <a class="b" href="/?q=12+may%c4%b1s+2016+ensar+vakf%c4%b1+tecav%c3%bcz+skandal%c4%b1">12 mayıs 2016 ensar vakfı tecavüz skandalı</a>)<br/>(bkz: <a class="b" href="/?q=turkcell+hatlar%c4%b1m%c4%b1z%c4%b1+iptal+ediyoruz+kampanyas%c4%b1">turkcell hatlarımızı iptal ediyoruz kampanyası</a>)<br/>(bkz: <a class="b" href="/?q=turkcell%27in+ensar+vakf%c4%b1+sponsorlu%c4%9funa+devam+etmesi">turkcell'in ensar vakfı sponsorluğuna devam etmesi</a>)
  entry_channels: teknoloji,ekonomi
- entry_name: |
    ahmet hakan'ın terbiyesizleşmesi
  entry_id:  89148208
  entry_writer: iki kelam da biz edelim
  entry_fav_count: 37
  entry_content: |
    terbiyesizleşmedi. öyleydi, öyle kaldı.<br/><br/>şunu ekleyeyim ki, yazıyı okudum öyle girdim enrtiyi. normalde bu omurgasızın yazılarını tiksindiğimden dolayı okumuyordum okumak zorunda kaldım bu başlık yüzünden. yazının haklı bir tarafı yok. hala kadının twiterdaki bilmem kaç yıl önceki paylaşımları didiklenerek aşağılık bir propaganda yapılıyor. yazmış olduğu yazının başlığı bile seviyesini ortaya koyuyor. domuz yemek suçmuş gibi vurgulaya vurgulaya. göz önünde ayakkabı kutusundan çıkan paraları ve bu paraların akibetini sorun etmeyen, milletin hakkını çatır çatır yiyenlere söz edemeyen bu terbiyesizler insanların kendi paralarıyla yedikleri içtikleri şeyleri sorun ediyorlar. aslında inandıkları dinde sadece domuz eti değil haram yemek de günah ama dile getirmesi yok oluyor yedikleri içtikleri haram olunca. <br/>canan bu seçimin kazananıdır. her türlü ahlaksız saldırıya karşı canla başla çalıştı. cumhurbaşkanı makamına oturan şahıs kadının twitleri bir yığın insanın önünde kaç yüz tane kanalda canlı yayında yayınladı. sanki bir şey varmış gibi. ahmet hakanın da dahil olduğu bir sürü medya tetikçisi köpek gibi saldırdı her gün yazdıkları köşelerinde. kudurmaya devam edin. canan kazandı. sizin yeminizi keserler artık finans edecek güçleri kalmayınca. ondan böyle kudurmanız.
  entry_channels: siyaset,haber
- entry_name: |
    ekrem imamoğlu'nun 1 mayıs görüntüleri
  entry_id:  89157101
  entry_writer: neslini sevdigim
  entry_fav_count: 36
  entry_content: |
    bir ex-mhp seçmeni olarak gayette beğendiğim görüntülerdir. adam vatandaşın hep yanındaymış demek ki. secim zamanı birlik, beraberlik ayağı çekmiyormuş.
  entry_channels: siyaset,haber
- entry_name: |
    behzat ç.
  entry_id:  89142838
  ...
  entry_fav_count: 35
  entry_content: |
    harun yok. akbaba da yokmuş son habere göre. erdal beşikçioğlu da kesin değil yazmışlar. çekmeyin amk. hevesimiz kursağımızda kaldı yine.
...
- entry_name: |
  ...
  entry_fav_count: 25
  entry_content: |
    ölü beden saklıyoruz eyüp mezarlığında. hatırası var.
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    an itibariyle "kayserili futbolcu, emre'nin ayağına kafa attı" diyen gs'li de geldi.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    herhangi bir metallica şarkısı
...
- entry_name: |
  ...
  entry_id:  89146735
  entry_writer: obi1kenoybi
  entry_fav_count: 4
  entry_content: |
    osmanlı tuğralı doblolar.
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    galatasaray formasıyla 8 maçta 7 gol 1 asistle oynayan <a class="b" href="/?q=balon">balon</a>.<br/><br/>edit: bir gol daha attı <a class="b" href="/?q=balon">balon</a>.
  entry_channels: spor
- entry_name: |
    kısa boylu şişman elektro gitarist olmaması
  entry_id:  89160824
  entry_writer: oyuncak bulut
  entry_fav_count: 2
  entry_content: |
    rahmetli <a class="b" href="/?q=as%c4%b1m+can+g%c3%bcndi%c3%bcz">asım can gündiüz</a> var idi<br/>malsteen ortalama kalıyor.
  entry_channels: 
- entry_name: |
    erkekleri ağlatan filmler
  entry_id:  89139712
  entry_writer: evomengo
  entry_fav_count: 2
  entry_content: |
    (bkz: <a class="b" href="/?q=iftarl%c4%b1k+gazoz">iftarlık gazoz</a>)<br/>(bkz: <a class="b" href="/?q=incendies">incendies</a>)<br/><br/>ilkinde sevilimin yanında, ikincinside ise annemin yanında kendimi zor tuttum.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    - elma değil bu yediğ'miz gal'ba?!<br/><br/>(bkz: <a class="b" href="/?q=elma+de%c4%9fil+ayva">elma değil ayva</a>)
