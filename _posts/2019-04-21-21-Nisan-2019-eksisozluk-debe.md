...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    yıllardır bu başlığa bakıp dalga geçerdim ve bir şey yazacağım hiç aklıma bile gelmezdi. ama bazı dertler kimseye anlatılmıyormuş da insanın içinde kalıyormuş öyle, ne kelimeye geliyormuş ne söze. ama bilmelisin ki sen bir kaltaksın ve canımı fena acıttın.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/ejyajnoPWEE" title="https://youtu.be/ejyajnoPWEE">bir sana bir de bana</a>
...
- entry_name: |
  ...
  entry_id:  89164763
  entry_writer: derim ki
  entry_fav_count: 1
  entry_content: |
    şu an deli gibi ağrıyan bir dişim var. soğuk suymuş diye buradan okuduk. o ağrı ile dolaba zor yetiştim ve cam su şişesine konulmuş beyaz sirkeyi kafama diktim. dikmez olaydım. diş ağrısı yetmezmiş gibi birde midem ağzıma geldi yeminlen. ah anne ah. yalnız su iyi geliyor.
  entry_channels: anket,sağlık
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ankara’da olan kadın arkadaşlar sadece
