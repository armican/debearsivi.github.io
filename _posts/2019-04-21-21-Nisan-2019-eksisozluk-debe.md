...
- entry_name: |
    19 nisan 2019 microsoft'tan büyük devrim
  entry_id:  89136665
  entry_writer: samimi panda
  entry_fav_count: 389
  entry_content: |
    bilgisayar kullanmayı öğrendiğim ilk günden beri disk veri yazmadığı/okumadığı sürece "şrrrraaaakkkk" diye çektiğimden umurumda olmayan ultra gereksiz güncelleme
...
- entry_name: |
  ...
  entry_fav_count: 49
  entry_content: |
    hande soral'dan açık ara daha güzel kadındır.
...
- entry_name: |
  ...
  entry_fav_count: 36
  entry_content: |
    seçim bitti, imamoğlu mazbatayı da aldı. niye hala feyza altun'a maruz kalıyoruz merak ediyorum.
  entry_channels: siyaset,edebiyat,haber
- entry_name: |
    bebek bezini bıraktırma yolları
  entry_id:  89138763
  entry_writer: atcephesi
  entry_fav_count: 32
  entry_content: |
    bulaşık teli mi? yok, mayın koyun. utanmayın.<br/><br/>(bkz: <a class="b" href="/?q=ebeveynlik+ehliyete+tabii+tutulsun">ebeveynlik ehliyete tabii tutulsun</a>)
...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    olm aşk bir anda tutulmak degil mi?
...
- entry_name: |
    akp devri belediyelerin borçları sıralı tam liste
  entry_id:  89138952
  entry_writer: kayisili turta
  entry_fav_count: 15
  entry_content: |
    akp'den devir alınan belediyelerin borçları sıralı tam listesi diye açmak istemiştim başlığı. ama malumunuz, karakter sınırı.<br/><br/>(bkz: <a class="b" href="/?q=kirsehir+belediyesinin+462+milyonluk+borcu">kirsehir belediyesinin 462 milyonluk borcu</a>)<br/>(bkz: <a class="b" href="/?q=erbaa+belediyesinin+111+milyon+borclu+olmasi">erbaa belediyesinin 111 milyon borclu olmasi</a>)<br/>(bkz: <a class="b" href="/?q=kocaeli+bbnin+6+7+milyar+tl+borclu+olmasi">kocaeli bbnin 6 7 milyar tl borclu olmasi</a>)<br/>(bkz: <a class="b" href="/?q=tunceli+belediyesinin+68+milyon+tl+borcu+olmasi">tunceli belediyesinin 68 milyon tl borcu olmasi</a>)<br/>(bkz: <a class="b" href="/?q=kars+belediyesinin+338+milyon+tl+borcu">kars belediyesinin 338 milyon tl borcu</a>)<br/>(bkz: <a class="b" href="/?q=yuksekova+belediyesinin+680+milyon+borclu+olmasi">yuksekova belediyesinin 680 milyon borclu olmasi</a>)
  entry_channels: 
- entry_name: |
    galatasaray
  entry_id:  89159462
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    başlıkta aradım, 3-4 kere daha yazılmış. demek ki yaygın bir huy. bizimkisi de belgesel seslendirmeyi seviyor.<br/><br/>- ba ba bak, aslan şimdi atlayacakk! abooov nası ısırdı yaa.<br/><br/>zaten dış ses anlatıyor. üstüne üstlük de bizim aslanın ceylanın üstüne atladığını anlamaya yetecek kadar zekamız var allaha şükür. ama yok, illa anlatılacak o.
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    ılk dinleyişte aşık olduğum şarkıyı gün içinde de 29085 defa dinlediğim için gün sonunda nefret etme durumuna ulaşıyor malesef.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    1. pink floyd<br/>2. yes<br/>3. led zeppelin<br/>4. deep purple<br/>5. genesis<br/><br/>biraz eski bir liste oldu, ama gerçekler eskidikçe acılaşır.
  entry_channels: anket,müzik
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: anket,müzik
- entry_name: |
    tuzla'da köpekleri kesip yiyen kadın
  entry_id:  89168274
  entry_writer: woofy
  entry_fav_count: 0
  entry_content: |
    asıl tehlikeli olan akli dengesi yerinde olmayan bu kadın değil vukuatlarına engel olmayan ailesi ve serbest bırakanlardır.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    çok ciddi bir diş ağrısından bahsediyorsak, örneğin apse yapmış bir diş var ve doktora gittiniz, doktor antibiyotik ile majezik vb. bir ilaç reçete etti diyelim. ağrı kesici ağrınızı dindirmiyor ya da en fazla 2 saat süreyle ağrıyı hafifletiyorsa yapabileceğiniz en mantıklı şey en azından gece uyuyabilmek için acile başvurmak. çünkü bu anlattığım yoğun ağrılı süreç ortalama 2 gün sürüyor, diş zonk zonk ederken içeride iltihap büyüyor ve o ağrı kesiciden günde maksimum 2-3 adet alabilirsiniz. fazlası tehlikeli.<br/>acilde sağolsunlar, uyuyamıyorum ve artık ağrıya dayanamıyorum derseniz ikiletmeden totonuzdan bir ağrı kesici vuruyorlar ve hamur gibi olup beş dakika içinde rahatlayarak geceyi atlatabiliyorsunuz. diş ağrısı deyip durumunuzu küçümsemeyin, acile gelenlerin büyük çoğunluğu muhtemelen daha hafif ağrılar için iğne vurdurmaya gelmiştir.<br/>ancak ağrınız bir majezikle ortadan kayboluyorsa boşuna meşgul etmeyin hastaneleri hekimleri tabi.<br/>alkol, tuzlu su, karanfil, sarımsak vs. bunların hepsi boş iş tecrübeli bir diş hastası olarak sizi temin ederim. hafif bir vakaysa dışarıdan buz koymanız bile sizi rahatlatacaktır ya da hafif bir ağrı kesiciyle işi kotarabilirsiniz.
  entry_channels: anket,sağlık
- entry_name: |
    birden çok kişiyle aynı zamanda flört etmek
  entry_id:  89167831
  entry_writer: justice for hedgehogs
  entry_fav_count: 0
  entry_content: |
    birden cok kisiyle ayni zamanda flort de etmeyeceksek bu hayatin heycani meycani yok. biraz tadini cikarin ya. biraz californication flan izleyin, lutfen.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
    20 nisan 2019 van depremi
  entry_id:  89167463
  entry_writer: oyledusunmuyorum
  entry_fav_count: 0
  entry_content: |
    tam sözlükte gezdiğim esnada yaşanmıştır. hafifti fakat coğrafya itibariyle korkutuyor. devamı gelmez umarım.<br/><br/>edit: şöyle bir bakıyorum da, sözlükte ne çok van'da yaşayan insan varmış :d g.t korkusu bizi buraya topladı kardeşlerim. öyle hinarda kopmaya benzemez bu işler. müsterih olun...
  entry_channels: 
---
