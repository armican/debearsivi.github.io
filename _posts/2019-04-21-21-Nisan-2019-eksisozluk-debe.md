...
- entry_name: |
  ...
  entry_fav_count: 70
  entry_content: |
    gezi'de bizimle birlikte <a rel="nofollow noopener" class="url" target="_blank" href="https://pbs.twimg.com/media/D4X8EaoXsAERpPn.jpg" title="https://pbs.twimg.com/media/D4X8EaoXsAERpPn.jpg">gaz yemiş</a> biri. ve şimdi istanbul büyükşehir belediye başkanı. yani; hayalini kurduğumuz, güzelliklerle dolu türkiye'ye bir geçiş kapısı. <br/><br/>sevmeyelim de taşa mı dönelim?
...
- entry_name: |
  ...
  entry_fav_count: 24
  entry_content: |
    (bkz: <a class="b" href="/?q=devlet+adaml%c4%b1%c4%9f%c4%b1">devlet adamlığı</a>)<br/>(bkz: <a class="b" href="/?q=devlet+ciddiyeti">devlet ciddiyeti</a>)<br/>(bkz: <a class="b" href="/?q=nezaket">nezaket</a>)<br/>(bkz: <a class="b" href="/?q=kamu+mal%c4%b1n%c4%b1+israf+etmemek">kamu malını israf etmemek</a>)<br/>(bkz: <a class="b" href="/?q=tevazu">tevazu</a>)
...
- entry_name: |
    fare faare okunurken karenin kaare okunmaması
  entry_id:  89160446
  entry_writer: adi bogdan olmayan kisi
  entry_fav_count: 16
  entry_content: |
    fare dilimize arapcadan oldugu gibi alinirken, kare fransizca carré kelimesinden alinmistir.<br/><br/>sanirim yeterince acikliyor nedenini.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    valla hiçbirinizle uğraşamam. benim derdim bana yeter.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    1- bir erkek size flörtleşme döneminde her gün mesaj atmalı mı?<br/>2- siz bu dönemde erkeğe mesaj atarmısınız yoksa hep erkekten mi beklersiniz mesajı?
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    trabzon üniversitesi'nin yeni logosu
  entry_id:  89136572
  entry_writer: ampirikuka
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=trabzon+ilkokulu">trabzon ilkokulu</a>)<br/>evet şimdi 2-b sınıfından merve’nin 23 nisan isimli şiir çalışmasını dinliyoruz.
