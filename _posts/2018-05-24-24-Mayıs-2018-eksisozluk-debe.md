...
- entry_name: |
  ...
  entry_fav_count: 31
  entry_content: |
    nedir bu hayvanların cani ruhlu insanlardan çektikleri. allah belalarını versin. rektorluk@hacettepe.edu.tr adresine uzun bir şikayet içeren mail attım. bu katiller bulunsun biran önce.<br/>kedi onlar ya ufacık kediler. kötülük bilmezler sevilmek için gelir mırlarlar. niye attınız onları aşağı? dışkı suratlı menduburlar. kediciğin kalbini oyacağına gidip ananla uğraşsaydın soysuz şerefsiz.
  entry_channels: haber
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: siyaset,ekonomi
- entry_name: |
    23 mayıs 2018 keriz silkeleme operasyonu
  entry_id:  77276347
  entry_writer: dzingis
  entry_fav_count: 7
  entry_content: |
    keriz silkeleme'nin ne demek olduğunu bilmeyenler tarafından kuyuya taş atılarak ortaya çıkarılmaya çalışılan operasyon.<br/><br/>batıyoruz ve iktisadi olarak saçma sapan kararlar alınıyor. keriz silkeleme falan yok ortada. her konuda mutlaka bir fikrinizin olması gerekmiyor.
  entry_channels: ekonomi
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    bizimkiler dizisindeki favori karakterin
  entry_id:  77279234
  entry_writer: başlık taşıyan
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=yazarlar%c4%b1n+bizimkiler+dizisindeki+favori+karakteri">yazarların bizimkiler dizisindeki favori karakteri</a>)
  entry_channels: tv
- entry_name: |
