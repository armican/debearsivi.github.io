...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    aralarında bir fark kalmış, o farknan da çok güzel olmuş diye devam etmiş
  entry_channels: siyaset,haber,ekonomi
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    recep tayyip erdoğan'ın faize karşı olma sebebi
  entry_id:  77277632
  entry_writer: 52hz
  entry_fav_count: 3
  entry_content: |
    ekonomi'nin "e"sinden anlamaması.
  entry_channels: siyaset,ekonomi
- entry_name: |
