...
- entry_name: |
  ...
  entry_channels: haber
- entry_name: |
    pegasus airlines'ın tacize göz yumması rezaleti
  entry_id:  88222867
  entry_writer: alirsin iste boyle cevabini
  entry_fav_count: 161
  entry_content: |
    "fakat havacılık mevzuatında polis gelene kadar kapılar kapalı beklemesi gerekiyor"<br/><br/>sen beni güldürdün, allah da seni güldürsün hanım kızım, çok yaşa e mi.<br/><br/>tanım: kendini dünyanın merkezi sanan bir kadının muhtemelen hala kendini dünyanın merkezi sanmaya devam etmesidir.
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    türklerin kebapdan anlamaması
  entry_id:  88237688
  entry_writer: renksiz hayat
  entry_fav_count: 60
  entry_content: |
    şahap'ın fıstığından anlamayanlarca yapılan eleştiri.
...
- entry_name: |
  ...
  entry_fav_count: 44
  entry_content: |
    reisi bir kapayıp açalım bir şey olmasın?
  entry_channels: siyaset,haber,ekonomi
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    siyasi islamcilar cok ama cok acimasizlar. cok ama cok kotuler. ve hicbirisi de hayatini kaybeden bu genc cocugun kiymetine yanasamazlar.<br/><br/>dipnot olarak kendisinden yardim isteyen kanser hastasi kadinin cebine para sikistirmaya calisan akpli bakan da aklimizda.
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    imamların maaşına yaptığımız katkıları hesaplarlarsa alacaklı çıkarız.
...
- entry_name: |
    yerli elektrikli traktöre isim önerileri
  entry_id:  88229025
  entry_writer: alcapucino
  entry_fav_count: 11
  entry_content: |
    (bkz: <a class="b" href="/?q=t%c4%b1rrekt%c3%b6r">tırrektör</a>)
  entry_channels: anket
- entry_name: |
    seboreik dermatit hastalığını iyileştiren şampuan
  entry_id:  88231032
  entry_writer: mjorate
  entry_fav_count: 11
  entry_content: |
    seboreik dermatit, tedavisi olmayan bir hastalık. sebebi bilinmiyor ki, tedavisi bilinsin... belki buğday ve şeker ürünlerinden uzak beslenince bir nebze kontrol altına alınabilir, ama o kadar. dönem dönem iyi gelen şampuan ve krem türü şeyler, bir süre sonra etkisini yitirir. yenisini aramaya başlarsınız. atak dönemleri vardır, ara dönemleri vardır ve bunlar elbette kişiden kişiye değişir.<br/><br/>kesin tedavi deyip, insanları yanıltmamalı.<br/><br/>ekleme: başlığı açan entry'sini silmiş tabii ki. yarin entry'lerinin caps'larini eklerim buraya nasılsa.
  entry_channels: sağlık
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    süper overrated bir şehir. avrupa'nın diğer nefis şehirlerini bir kenara koyuyorum, fransa'nın diğer şehirleri bile, misal lyon, marsilya, hatta kıçıkırık bordeaux buradan daha özellikli. fransa'nın kırsal bölgeleri ayrıca müthiş. ve fakat paris o kadar overrated, o kadar turistik ki, şehrin tamamında sadece turistler yaşıyormuş hissine kapılmak mümkün. çoğu tur turisti olan bu arkadaşlar, şehrin içinde kırlangıç sürüleri gibi oradan oraya koşturuyor ve ellerindeki bucket listi tamamlamaya çalışıyorlar. bu telaş şehrin her yanına yayılmış durumda ve cidden paris'e ne zaman gitsem yaka silkiyorum.<br/><br/>turistik büyükşehir arıyorsanız roma'ya gidin.
  entry_channels: anket,tarih,seyahat
- entry_name: |
...
- entry_name: |
    rammstein
  entry_id:  88234126
  entry_writer: kuruuhu
  entry_fav_count: 4
  entry_content: |
    yeni album/singlelari 4-5 saat sonra <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=NeQM1c-XCDc" title="https://www.youtube.com/watch?v=NeQM1c-XCDc">buradan</a> yayinlanacak almanliktan aldigi tadi baska bir seyden alamayan grup.
