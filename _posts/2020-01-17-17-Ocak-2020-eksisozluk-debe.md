...
- entry_name: |
  ...
  entry_fav_count: 41
  entry_content: |
    fark ne biliyor musunuz, biz yensek de yenilsek de burdayız ama bazı orospu çocukları sadece yenildiğimizde burada. sonra spor başlıkları niye küfürden geçilmiyor derler, sokaktaki it kopuğu adam yerine koyup yazma hakkı verirsen gelir kışkırtır milleti, sonra yazdığını siler kaçar.<br/><br/>edit: küfrü savunmuyorum ama bunlara küfürden başka bir şey söylenmez.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    (bkz: <a class="b" href="/?q=matematik+yapmak">matematik yapmak</a>)
...
- entry_name: |
  ...
  entry_id:  100591377
  entry_writer: sosyalist sagci
  entry_fav_count: 8
  entry_content: |
    arkadaş salakmısınız siz bence evette kız düşürmek için niye ekşiyi kullanıyorsunuz, gidin instagramdan daha çok düşüyor.adam gelmiş utanmadan hobilerini yazıp isteği yaş aralığındaki kadınlardan mesaj bekliyor.mk asosyal koca gotlu sivilceli bonus kafalılar, kalkın pc başından da dışarı çıkın.bide sorsan dünya görüşü olan ekşi yazarıyım der. <br/>ayrıca gider tvdeki evlenme programlarıyla da dalga geçer. <br/>onlar yine özgüvenli siz ?
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    (bkz: <a class="b" href="/?q=ziya">ziya</a>)
  entry_channels: 
- entry_name: |
    16 ocak 2020 trabzonspor'a verilmeyen kırmızı kart
  entry_id:  100632663
  entry_writer: zincirlikuyu metrobus duragi
  entry_fav_count: 3
  entry_content: |
    rakip futbolcu hala yaşıyor. karar doğru.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    <a class="b" href="/?q=yar+y%c3%bcre%c4%9fim+yar">yar yüreğim yar</a> - <a class="b" href="/?q=seyyah+olup+%c5%9fu+alemi+ararsan">seyyah olup şu alemi ararsan</a> <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=YS9xmD4BDuY" title="https://www.youtube.com/watch?v=YS9xmD4BDuY">ikisi bir arada</a><br/><br/>önemli not: doz aşımına dikkat edin, bünyenizde yatkınlık varsa biraz dünyadan el etek çektirebilir.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    anlamak.<br/><br/>edit: anlatılanı gerçekten anlamak özel yetenektir sayın suserlar.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    normal fiyattır. paranız yoksa evde yapın kahvaltınızı en az 3 te bir fiyatına gelir dışarda yapmak niye ?
  entry_channels: 
- entry_name: |
    az konuşan insan
  entry_id:  100634672
  ...
  entry_fav_count: 0
  entry_content: |
    benim bu, aslında yukarıdaki entrilerin aksine anlatacak, konuşacak çok şeyim var ve pek utangaç da sayılmam ama vallahi bıktım aga konuşmaktan artık. konuş konuş, anlat anlat bi bok değişmiyor. belki çalıştığım ortam, isteyen kendini beğenmiş desin, siktiri boktan bi ortam, yani konuşacak adam gibi biri yok. yoksa ben de isterdim saatlerce sohbet etmeyi ama susup düşünmeyi ve okumayı daha çok seviyorum.
  entry_channels: ilişkiler,sağlık
- entry_name: |
    16 ocak 2020 christopher tolkien'in ölmesi
  entry_id:  100635911
  entry_writer: get loki
  entry_fav_count: 0
  entry_content: |
    zaten senin yorumunu almak için açılmadı bu başlık at yarraa.<br/><br/>ekşisözlük bilgi kaynağı sayesinde öğrendiğim üzücü olay. biz orta dünya severlerin başı sağolsun.
