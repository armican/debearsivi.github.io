...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    başlıkta fenerbahçe yazsaydı 10 dakikada 50 entry girilmişti.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    derhal bu mevzu aydınlatılmalı, silah meselesine açıklık getirilmeli. madem bu türden olaylar dükkanın içinde oluyor, neden en başta dile getirilmiyor da binbir türlü ajitaston kasılıyor?
  entry_channels: 
- entry_name: |
    çaylak onay listesi
  entry_id:  100610962
...
- entry_name: |
  ...
  entry_id:  100634003
  entry_writer: fedemirkan
  entry_fav_count: 0
  entry_content: |
    ben ilk aldığımda akasya avmde bulamamıştım çok fena bir durumdu :d
  entry_channels: 
- entry_name: |
    askerlikte ilk gece
  entry_id:  100635264
  ...
  entry_fav_count: 0
  entry_content: |
    sabah neyle karşılaşacağım acaba diyerek 2-3 saatlik uyku uyunulan geçen bir gece. sabahında ‘kalk kalk kalk, 15 dakikaya içtima ‘ sesleriyle nereye geldim ben amk düşüncelerine sevk olmuştum. güzel günlerdi, tadı vardı.
  entry_channels: anket
---
