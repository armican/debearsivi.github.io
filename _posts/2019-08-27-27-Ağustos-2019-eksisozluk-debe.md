...
- entry_name: |
  ...
  entry_fav_count: 88
  entry_content: |
    milletin yüzüne hiç çekinmeden ne bok olduğunu söyleyecek kadar cesareti olduğu için her zaman en favori futbol yorumcum olmuştur. mehmet demirkol'u da çok severim ama kendisi asla bu kadar açıksözlü değil.
...
- entry_name: |
  ...
  entry_fav_count: 22
  entry_content: |
    (bkz: <a class="b" href="/?q=roblox">roblox</a>)<br/><br/>saçma sapan, çoğu birbirine benzer yüzbinlerce oyun barındıran bir plaftormdur.<br/><br/>buna rağmen bazılarına o kadar takarsınız ki sabaha kadar oynadığınız oluyor.<br/><br/>yaşım 40, şaka yapmıyorum.
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    aferin onadır, tek elle telefondan instagrama mı girseydi yani.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    ergenlik zamanından kalan bir alışkanlıktır. bizim toplumda yok ki öyle çocuğuna özel alan tanıyan bir ebeveynlik anlayışı?<br/><br/>bir kulağında kulaklık diğeri kapıda, bir eli iş hallederken diğeri alt+f4’te porno izleyen bir nesilden bahsediyoruz. şöyle çocuğu bi rahat bırakıp evden gitmezler ki o da pornonun sesini sonuna kadar açıp bağıra bağıra boşalsın.<br/><br/>kısacası bizde durumlar malesef böyledir. ama şu da bir gerçek ki; bir kadını, sex anında erkeğin çıkardığı sesler kadar çok az şey tahrik edebilir.<br/><br/>tamam kabul, zevk diyarlarında at koşturuyormuşcasına çığlık atan bir dothraki olmak zorunda değilsiniz.. ama azcık da sesiniz çıksın beyler. anlayalım ki siz de zevk alıyorsunuz bu meseleden.<br/><br/>arada ufak hayvansı sesler çıkarın mesela, beceremiyorsanız dirty talking yapın. özellikle orgazm anında okula yeni başlayan çocuk gibi içinize kapanıp kafanızı yastığa gömmeyin. bağırın, çağırın, yıkın ortalığı, zevkin doruklarına çıkın!<br/><br/>dünyanın en güzel şeyini yapıyorsunuz ya, o tutku olsun içinizde..
  entry_channels: ilişkiler
- entry_name: |
    türkiyede mesaj bırakma alışkanlığı olmaması
  entry_id:  94481294
  entry_writer: yedinci element
  entry_fav_count: 8
  entry_content: |
    pahalı bi hizmet olduğu için olsa gerek.
...
- entry_name: |
    26 ağustos 2019 gazişehir gençlerbirliği maçı
  entry_id:  94481742
  entry_writer: beyeferdi
  entry_fav_count: 3
  entry_content: |
    penaltı pozisyonunda (tam emin olmamakla beraber) 9 dakika var beklendi. var odası pozisyona baktı, baktı, baktı ve orta hakemi çağırdı. ya anasını satayım, mhk başkanını çağırsaydınız. derbilerde falan da tff başkanı baksın pozisyona. bu ne rezilliktir arkadaş.<br/><br/>not: pozisyona penaltı+kırmızı kart verildi. bi yerlerde yeni sezon kurallarında penaltı verilirse kırmızı verilmeyeceğini okumuştum ama şu anda bulamadım. eğer okuduğum doğruysa bi rezillik de bu olacak
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    "son hızı 260" 'tan sonrasını okumadim. motorunu sikeyim.
  entry_channels: otomotiv
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    küçükkuyuda yazlıktayım hacılar. balkonda uzattım ayaklarımı denize karşı çay içiyorum gün batırıyorum
  entry_channels: anket
---
