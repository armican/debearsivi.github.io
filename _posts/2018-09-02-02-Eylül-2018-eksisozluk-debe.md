...
- entry_name: |
  ...
  entry_fav_count: 159
  entry_content: |
    belli bir iq üzerine hitap ediyor
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    sunu yazip da kendine fenerbahceli'yim diyen dalyaraklar istifa etse de hepimiz rahatlasak. butun ulkenin kanseri bunlar, bu tipleri toplu sinirdisi etsen ulke muasir medeniyetler seviyesini gececek.
  entry_channels: spor
- entry_name: |
    ali koç
  entry_id:  80851299
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    olayın salt güzellikten ibaret olmadığını düşünüyorum. <br/><br/>hanımefendinin hem çok karakteristik bir sesi var hem de vücudunu kullanmasını biliyor. dans ediyor. şarkı söylüyor. özgüveni yüksek. yaptığı işte çok başarılı. bakışları, tarzı neredeyse her yönü ortalama bir kadından "bana göre" daha etkileyici.<br/><br/>neyse efenim yine de önemli olan huyudur değil mi? huyu güzel olsun. delirdik komple. dua lipa ovırreytıd mıdır diye tartışıyoruz.<br/><br/>o malum soruya cevabı "nefessiz giderim" olacakları pistten alsak sözlük 2002 yılına geri döner şerefsizim.
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    2018-2019 sezonu fenerbahçenin küme düşmesi
  entry_id:  80867437
  entry_writer: running to the sea
  entry_fav_count: 2
  entry_content: |
    gerçekleşmesi durumunda bile gs'ın kadıköyde galibiyet için yine kafasını alacağı küme düşme serüveni olacaktır.
  entry_channels: spor
- entry_name: |
    türkiye'deki ekonomik krizi bitirecek tek hamle
  entry_id:  80863097
  entry_writer: koptugeliyor
  entry_fav_count: 1
  entry_content: |
    işten anlayanı, vatanı en çok seveni göreve getirmek. dünür damat değil.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    rahmetli dedemdir. söktüğü motoru, tekrar birleştirmeye çalışan mühendisi durdurmasaydı, parmakları gidecekti. mühendisler ve ustalar, farklı düşünen ve baış açılarına sahip insanlardır. mühendisler ve ustaların işi birbirine akıl öğretmek değil, birbirlerini tamamlamaktır. arada bir ego yarışması varsa, iletişim kanalları hatalı olduğundandır.
  entry_channels: eğitim
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    bu herif gotunu kaldirasiya sampiyonlar liginde (cekilen kuraya ragmen) rakipler istasyon yapar.
  entry_channels: spor
- entry_name: |
    ekşi itiraf
  entry_id:  80844878
...
- entry_name: |
    sözlüğe fotoğraf nasıl yüklenir
  entry_id:  80869219
  entry_writer: birliktelik
  entry_fav_count: 0
  entry_content: |
    hocam http:// bölümüne resmi yüklediğiniz sitenin linkini koyuyorsunuz, oluyor..<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://eksiup.com/85df0ee0516" title="https://eksiup.com/85df0ee0516">örneğin</a>
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    iddia edildiği gibi transfer sürecinin fatih hocadan bağımsız olduğunu sanmıyorum. fatih hoca geldi ilk iş cenk ergün ile yollar ayrıldı. hocanın da her türlü görüşmeden haberi olduğunu ve kalan alternatifler düşünüldüğünde forvet almadan transferi kapatma fikrini onayladığını düşünüyorum. bu yönetimde terim'den bağımsız hareket edebilecek futboldan sorumlu yönetici ya da sportif direktör yok. acemilik oldu; son güne kimseyi alamazsak cornelius var diye girdik, o da fransa'ya gidince böyle oldu. ne biçim yönetim bu, hocaya bu yapılır mı vs. gibi lafları anlamsız buluyorum.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    belli başlı yazarları engelleyince takribi 75 sayfa kısalân başlik.
  entry_channels: anket,ilişkiler,ekşi-sözlük
---
