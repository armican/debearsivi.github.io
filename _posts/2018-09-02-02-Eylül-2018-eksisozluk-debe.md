...
- entry_name: |
    yılmaz özdil'in 1 eylül 2018 tarihli yazısı
  entry_id:  80859287
  entry_writer: sahibindensahip
  entry_fav_count: 146
  entry_content: |
    ırkçılıkla ne alakası var lan davar ? buna ırkçılık diyen faşiste telekom girsin.
...
- entry_name: |
  ...
  entry_channels: haber
- entry_name: |
    bu da geçer ya hu'nun ingilizcesi
  entry_id:  80852798
  entry_writer: bacakkillarinitarayanadam
  entry_fav_count: 48
  entry_content: |
    ingilizce bilen arkadaşlar arapça bilmediği için anlamı yitik çeviriler oluyor.<br/><br/>hu arapçada allah demek.
...
- entry_name: |
  ...
  entry_fav_count: 34
  entry_content: |
    "dolar 2 tl olmuş"<br/><br/>son sevgilim demişti. bayadır yalnız olduğumu farkettim.
...
- entry_name: |
  ...
  entry_fav_count: 24
  entry_content: |
    ağlamıyorum gözüme sadece görevini yapan normal kaleci kaçtı :/
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 23
  entry_content: |
    kalede kaleci var yemin ediyorum.<br/><br/>edit: ya amk ahahaha zaa yazanlar maçı izliyorsa cümle alem siksin beni. amk ergen veletleri skora bakıp zaaa lıyor. kalede bugün volkan olsaydı skor şu anda 7-2 idi.
  entry_channels: spor
- entry_name: |
    tarık çamdal
  entry_id:  80856425
  ...
  entry_fav_count: 16
  entry_content: |
    yabancı sınırı diyene hemen tarık camdal diyin ve derin sessizliğin keyfini çıkarın.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    iki kızım. <br/><br/>cehaletimize güneş olsunlar umarım.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    stoper oyuncusu. görerek attığı kafa pasları çok hoşuma gitti. net idman eksiği var + stoper oynamalı. sonrasında harika olacak. i
  entry_channels: spor
- entry_name: |
    bernard mensah
  entry_id:  80862325
  ...
  entry_fav_count: 2
  entry_content: |
    fenerbahçe ve galatasaray badou ndiaye kasana kadar bu adamı neden düşünmezler anlamıyorum. dikine hücumun, driblingin kralını yapıyor.
  entry_channels: spor
- entry_name: |
    volkan demirel
  entry_id:  80862483
  ...
  entry_fav_count: 0
  entry_content: |
    fenerbahçem’in yedek kahahahaha.<br/><br/>sende ufacık onur olsa “yeter artık, buraya kadarmış” der ve futbolu hemen bu akşam bırakırsın. yıllardır çelme taktığın takımımıza son bir iyilik daha yapmış olursun.
  entry_channels: spor
- entry_name: |
    masterchef türkiye
  entry_id:  80862943
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    allahını seven ümraniye atatürk mahallesi bi kilo elektrik fırlatsın nolur la nolur ya çürüdüm ya çüüürüüüdüüm üç tane mum bitti sigaranın ışığıyla tuvalete gidiyorum la yardım
