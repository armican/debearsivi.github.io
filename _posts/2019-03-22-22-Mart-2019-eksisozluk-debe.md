...
- entry_name: |
    21 mart 2019 metropoll bursa seçim anketi
  entry_id:  87982557
...
- entry_name: |
  ...
  entry_channels: moda
- entry_name: |
    berat albayrak'ın aşırı sempatik dolar tespiti
  entry_id:  87982980
...
- entry_name: |
    sabah.com.tr'ye en başarılı haber sitesi ödülü
  entry_id:  87989976
  entry_writer: harunnalcaci
  entry_fav_count: 88
  entry_content: |
    <a class="b" href="/?q=vergi+m%c3%bcfetti%c5%9fleri+derne%c4%9fi">vergi müfettişleri derneği</a> de kim dedirtmiştir. <a class="b" href="/?q=kara+ambar+kamyoncular+derne%c4%9fi">kara ambar kamyoncular derneği</a> verse daha etkili olurdu.
  entry_channels: haber
- entry_name: |
...
- entry_name: |
    gökhan töre
  entry_id:  87981310
  entry_writer: protoculture
  entry_fav_count: 63
  entry_content: |
    hakkını savunmuş.helal olsun. <br/>yalnız bizim başkanda, kendisine muhalefet olan herkesi düşman görüyor. insanların ekmeğiyle oynanır mı? bir de para vermemek nedir lan? sen işçine nasıl para vermezsin. veremeyeceğin parayla, niye sözleşme yaparsın.<br/>yanan eve girdin, bir bidon da sen dök.<br/><br/>koltuk sevdası kangren gibi, yeminle herkeste var.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    ku klux klan tarikatı gibi olmuşlar aq. bacakları bilemedim :/
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    sözlük yazarları için pipidir. zaten yarısı kaybolmuş kalmış 5 cm. 70 yıllık evrime bakar.
