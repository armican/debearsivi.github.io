...
- entry_name: |
    nakşibendi şeyhinin öldürülmesi
  entry_id:  100828408
  entry_writer: alla turca
  entry_fav_count: 349
  entry_content: |
    zamanda geriye doğru yolculuğun kanıtıdır.<br/><br/>herifler bildiğin şeriat mahkemesi kurmuş, memleketin hukukuna karşı geliyor. ülkenin içişleri bakanı (esasen bunlara izin vermemekle mükellef olan) da arkalarından ağlıyor. neredeyse 1500 sene geriye gitmiş adamlar. bunlara "ilim adamı" denmesin de ne densin. bundan bir adım ötesi mağara adamlığı zaten.
...
- entry_name: |
    sincan yetiştirme yurdundan yardım isteyen çocuk
  entry_id:  100845918
  entry_writer: kalorifertamircisi
  entry_fav_count: 225
  entry_content: |
    maps kullanırken tesadüfen karşılaştığım olay.<br/>ciddi bir durum olabilir düşüncesiyle endişelendim ve paylaşma gereği duydum.<br/><br/>kaynak <a rel="nofollow noopener" class="url" target="_blank" href="https://maps.app.goo.gl/f3yMBSZZxnt9TFvT8">https://maps.app.goo.gl/f3ymbszzxnt9tfvt8</a><br/><br/>edit: arkadaşlar bir çoğunuz olayı yanlış anlamış.<br/>bu kardeşimiz (anneannesinin) evinde sıkıntı çekmiş. o yüzden google mapsdeki yurdun konumuna yorum atmış gelin beni kurtarın diye.<br/>yani yurt ile alakali bir problem yok, tam aksine yurttan yardım istemiş.
...
- entry_name: |
  ...
  entry_fav_count: 50
  entry_content: |
    "ayrılık ne biliyor musun? <br/>ne araya yolların girmesi, <br/>ne kapanan kapılar, <br/>ne yıldız kayması gecede, <br/>ne ceplerde tren tarifesi, <br/>ne de turna katarı gökte.<br/><br/>insanın içini dökmekten vazgeçmesi ayrılık!"<br/><br/><a class="b" href="/?q=%c5%9f%c3%bckr%c3%bc+erba%c5%9f">şükrü erbaş</a>
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    latif o zaman doğan slx binmeye devam edelim.
...
- entry_name: |
    tutunamayanlar (dizi)
  entry_id:  100869888
  entry_writer: peralta
  entry_fav_count: 0
  entry_content: |
    doğu demirkol "deli manyak" dedikçe kıl oluyorum.
  entry_channels: tv
- entry_name: |
    adil rami
  entry_id:  100867846
