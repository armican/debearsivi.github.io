...
- entry_name: |
  ...
  entry_channels: siyaset
- entry_name: |
    20 ocak 2020 coca cola ve fanta zammı
  entry_id:  100804077
  entry_writer: troll degilim ama olabilirim
  entry_fav_count: 297
  entry_content: |
    yıl 2020 olmuş hala, <br/>kola bırakıncılar gelir<br/>sigara bırakıncılar malum, <br/>alkolü bırakıncılar var, <br/>şekersiz çay içinciler var...<br/>gelmeyin, huzur verin. <br/>içiyorum her gün en az 3-4 kutu kola içiyorum.<br/>ben erken gebereceğim, <br/>sen sağlıklı yaşa.
...
- entry_name: |
    türkiyede son yıllarda uyuşturucunun yaygınlaşması
  entry_id:  100785339
  entry_writer: otomatikhurma
  entry_fav_count: 145
  entry_content: |
    tek sebebi alkole uygulanan ağır vergilerdir.
...
- entry_name: |
    20 ocak 2020 ttnet'e siber saldırı yapılması
  entry_id:  100811212
  entry_writer: oruc tutamiyorsan bluetooth
  entry_fav_count: 77
  entry_content: |
    türkiye'nin tüm internetini tekel yap, sonra basit siber saldırılardan bile hemen etkilen. verdiğimiz paralar kim bilir nerelere gidiyor, yazıktır.
...
- entry_name: |
  ...
  entry_fav_count: 52
  entry_content: |
    ahmet hakan içeren fotoğraf. ayaktakilerden 2. herifin arkasında(soldan), ahmet hakan'ın o nurlu yüzü belirmiştir.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
    brad pitt'in jenifer aniston'u hasretle izlemesi
  entry_id:  100797725
  entry_writer: yasayanolu
  entry_fav_count: 38
  entry_content: |
    bence normal bir şekilde izliyor.neden bir mana katıldı anlamadım.
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    çocuğunu ömür boyu kendine bakmak üzere yetiştirmeye kalkması.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
    düzenli şehir denince akla gelen şehirler
  entry_id:  100803390
  entry_writer: diyefisildadi
  entry_fav_count: 9
  entry_content: |
    eskişehir'dir. tire şehir değildir.
  entry_channels: anket,tarih,seyahat
- entry_name: |
    dağ evi+single malt+çiğ fındık+yer yatağı+soba
  entry_id:  100808812
  entry_writer: serzenik
  entry_fav_count: 9
  entry_content: |
    köy evi+anason kokusu + tuzlu fındık + yer yatağı + kuzine şuan yaşantım.
  entry_channels: anket
- entry_name: |
    türk televizyon tarihinin en kaliteli dizisi
  entry_id:  100811648
  entry_writer: zevktensonrakihuzur
  entry_fav_count: 8
  entry_content: |
    kesinlikle ezel'dir. kimse ile tartışmam bile.
...
- entry_name: |
    fetöcü sapıktan kan donduran ifadeler
  entry_id:  100814293
  entry_writer: z code
  entry_fav_count: 4
  entry_content: |
    hayırlı olsun. fiber mi normal mi?
  entry_channels: siyaset,haber
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    başlık kafa karıştırıcı olabilir, bilgisayarınızda sürekli yüklü olarak duran, uzun süre oynamasanız dahi silmediğiniz, yetersiz disk alanı uyarısıyla karşılaşsanız dahi silmeyi düşünmeyeceğiniz oyunlardır. <br/><br/>az önce fark ettim ki (bkz: <a class="b" href="/?q=civilization+v">civilization v</a>)'i ilk yüklediğimden beri silmemişim. aylarca oynamasam dahi mutlaka orada güncel ve oynamaya hazır bir şekilde duruyor. sid meir amca bir güzellik yapıp yerini tutacak bir oyun çıkarana kadar da silmeyi düşünmüyorum. civ 6 da güzel ama bir civ 5 değil benim için
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    içimdeki boşluk gitgide büyüyor.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=rektifikasyon">rektifikasyon</a>)
  entry_channels: otomotiv
- entry_name: |
    yabancı kadının dokunuşundan zevk alan erkek
  entry_id:  100808894
  entry_writer: kizawa
  entry_fav_count: 0
  entry_content: |
    yabancıdan kasıt? (bkz: <a class="b" href="/?q=turk%c3%a7edeki+adresleme+problemi">turkçedeki adresleme problemi</a>)
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    naim süleymanoğlu (bkz: <a class="b" href="/?q=naim+suleymanoglu">naim suleymanoglu</a>) olimpiyat şampiyonu olduğu ve hala kırılmayan rekoru...
