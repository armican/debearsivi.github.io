...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    "temaslı müdahale" ile öğrencilerine "enerji yükleme" ihtimali olan, kaçınılması gereken soytarının instagram hesabıdır.<br/><br/>(bkz: <a class="b" href="/?q=sana+enerji+y%c3%bckleyece%c4%9fim+birinci+olacaks%c4%b1n">sana enerji yükleyeceğim birinci olacaksın</a>)
  entry_channels: 
- entry_name: |
...
- entry_name: |
    kedi tokadı
  entry_id:  93194249
  entry_writer: sorunsuznickname
  entry_fav_count: 2
  entry_content: |
    özellikle kedinin karnını sevmeye çalışırsanız bundan nasibinizi alabilirsiniz.<br/><br/>kedi size karnını gösteriyorsa bu bir güven hareketidir. orasını sevmeniz için açmamaktadır. bu tokata maruz kaldığınızda bunu anlarsınız.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    şahsen hatay ya da değil dönerimde sos olmamasını tercih ederim. özellikle de dürüm dönerde, ısırıyorsun alttan foşur foşur çıkıyor zaten tadı da iyi olmuyor. balon mudur değil midir çok emin değilim fakat bana göre olmadığı kesin. objektif bir durum olmadığı için şöyledir böyledir diyememekle beraber, tamamen subjektif görüşüme göre döneri daha kötü hale getirmektedir.
  entry_channels: 
- entry_name: |
