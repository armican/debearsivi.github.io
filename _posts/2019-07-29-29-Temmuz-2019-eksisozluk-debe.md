...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    zihne ket vurmak.<br/><br/>yapması biraz zor ama yılmamak lazım, unutmak isteğiniz kişiyi düşünmeye başladığınızda zihninize dur demeniz lazım, hemen başka bir şey düşünmek ya da kafanızı meşgul edecek bir işe yönelmeniz lazım. <br/>o kişi hiç varolmamış gibi, öyle biri hayatınıza hiç girmemiş gibi yapmalısınız.<br/><br/>zamanla beyin buna inanıyor.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    cumhurbaşkanı cabbar el-suri nin cumhuriyet bayramı kutlamalarını yasaklaması
...
- entry_name: |
  ...
  entry_id:  93195341
  entry_writer: londra kaymakami
  entry_fav_count: 6
  entry_content: |
    ismail'in banu'ya yürümesiyle neticelenecek tartışma.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
    akp'nin nasıl bir türkiye bırakacağı sorunsalı
  entry_id:  93195807
  entry_writer: lahmacunmania
  entry_fav_count: 5
  entry_content: |
    akp'nin giderken orta da hala türkiye diye birşey bıracağını falan zanneden saf bir kardeşimizşn açtığı başlıktır. kaldır kafanıda bir etrafa bak kardeşim, tabelalarda bile yok tc.
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    mis gibi kokan bir erkek, erkek olarak beni bile etkiliyor. duştan çıktığım zaman o üzerimdeki parfüm kokusunun verdiği etkiyle bedenim hoşuma gitmeye başlıyor. kadınları etkilemekle birlikte, kendinizi de sevmeye başlıyorsunuz ve kesinlikle özgüveniniz artıyor. bununla birlikte ayrıca kolunuzda kaliteli bir saat varsa, muntazam şekilde taranmış bir saça sahipseniz, bir kadının sizden etkilenmemesi için ortada hiçbir olumsuz sebep göremiyorum. temiz kokun sevgili hemcinslerim.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    hadisenin son videosu hakkında aynı şeyi düşünüyorum, tepsi götlü
  entry_channels: ilişkiler,moda
- entry_name: |
    john wick 3 parabellum
  entry_id:  93165841
  entry_writer: disrupting force
  entry_fav_count: 1
  entry_content: |
    dün serinin birincisini izledim. bugün ikincisini izlerim. yarın da üçüncüyü. yeşilçamdaki eski cüneyt arkın filmleri gibi şerefsizim. bağımlılık yapıyor.<br/><br/>not: bu arada seri için ilk film en iyisiydi diyenler, tabi ki saygı duyuyorum ama bence seri filmler arasında yenisi yapıldıkça iyileşen nadir yapımlardandır.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    zaten 2023 başkanlık seçiminde arapları ertesi gün yolluyorum diyen seçimi kazanır. doğal olarak kazanan siyasetçi bu sözünü tutacaktır.
  entry_channels: 
- entry_name: |
