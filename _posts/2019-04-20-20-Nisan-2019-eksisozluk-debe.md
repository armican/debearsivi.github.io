...
- entry_name: |
  ...
  entry_fav_count: 221
  entry_content: |
    böyle bir şey olursa <a class="b" href="/?q=instagraml%c4%b1+soluyan+canl%c4%b1lar">instagramlı soluyan canlılar</a> ekran görüntüsü alıp beğeni sayısını hikayelerinde sergilemeye başlarlar.
...
- entry_name: |
  ...
  entry_fav_count: 24
  entry_content: |
    sikerim meslek etiğini de idealistligi de kolay para kazanayım.
  entry_channels: anket,ilişkiler,tarih,sinema,edebiyat
- entry_name: |
...
- entry_name: |
    sigarayı bırakamamanın asıl nedeni
  entry_id:  89118692
  entry_writer: quaketrigger
  entry_fav_count: 17
  entry_content: |
    medya ve sosyal çevre aracılığıyla insanların bilinçaltına yerleştirilen imajın çok güçlü olması.<br/>bu imaj;<br/>" özgür bir yetişkin birey sigara içmelidir "<br/>" sigara içmek kafanı rahatlatır "<br/>" sigara içmek seni karizmatik, çekici, seksi, etkileyici yapar "<br/>gibi asılsız mesajlarla siz daha çocukken veya ergenken kafanıza sokuluyor.<br/><br/>bu konunun uzmanları tarafından tütün ve sigara narkotik bir ürün olarak ele alınmıyor. tütün narkotik bir bitki değil. yani kafa yaptığı falan yok.<br/>küresel kapitalist merciilerin, sigara ve ilaç üreticilerinin ortak projesinin milyarlarca kurbanından sadece birisiniz. sizi köle edip size sigara satıyorlar. bir süre sonra sağlığınızı elinizden alıyorlar, türlü damar ve dolaşım hastalıkları boy gösteriyor, kanser olanlar oluyor. devletiniz bu ilaçları kendisi üretemediği için dışarıdan alıyor. <br/>ne oldu? elinizdeki parayı alıp size sigara sattılar. sonra sağlığınızı elinizden aldılar. üstüne bir de devletinize ilaç sattılar.<br/>bu hikayedeki enayi kim?<br/>uyanın artık. <br/>sigara aptallıktır.<br/>sigara pişmanlıktır.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    görse hayatının aşkı olacak adamı fuckbuddy başlığına yazan kezbanları ortaya çıkarmış başlık <br/><br/>bir örnek: (bkz: <a class="b" href="/entry/89124907">#89124907</a>)<br/><br/>benden size tavsiye, fuckbuddy aramanıza gerek yok, flörtleştiğiniz birisiyle seviştikten sonra duygusal olarak bir yakınlık hissetmiyorsanız, ama ikiniz de tekrar sevişmek istiyorsanız, fuckbuddysiniz demektir. başka bir özelliğe gerek yok, saydığınız tüm özellikler fuckbuddyde olması gereken özellikler değil,sizin cinsel kriterleriniz.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
    yüksel akyol
  entry_id:  89123544
  entry_writer: dursun yasbasar
  entry_fav_count: 13
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://tr.sputniknews.com/haberler/201904191038817337" title="https://tr.sputniknews.com/haberler/201904191038817337">https://tr.sputniknews.com/…rler/201904191038817337</a><br/><br/>ıbb'nin verilerinin incelenmesinden bu kadar korktuguna gore hirsiz bir kardesimiz olsa gerek. <br/><br/>yazik lan, bundan sonra her gun altina sicarak yasayacaksin. keske torbacilik falan yapsaydin, hic degilse cezasi daha dusuk olurdu. <br/><br/>fazla stres yapma yuksel, kalbine midene vurur, hastalanirsin.
  entry_channels: siyaset
- entry_name: |
    murat bardakçı
  entry_id:  89117549
...
- entry_name: |
    can gürkan'ın tahliye olması
  entry_id:  89127556
  entry_writer: inadiminat
  entry_fav_count: 10
  entry_content: |
    ''hukuk küçük sineklerin yakalandığı, büyük sineklerin ise delip geçtiği bir örümcek ağıdır'' çin atasözü<br/>not: avukat
  entry_channels: haber
- entry_name: |
...
- entry_name: |
    ilahi adalete inanmamak
  entry_id:  89125913
  entry_writer: passionflower
  entry_fav_count: 3
  entry_content: |
    yok ki aq neye inanalim?<br/><br/>yasini doldurmamis bebeklerin cenazesi cuvallarda tasindi bu ulkede. emegi calinan, hakki gasp edilen insanlar icerideyken, calanlar/gasp edenler serbest birakildi. kanitlanmis yolsuzluklar, cinayetler, derin devlet ifsalarina ragmen gundem degismedi. <br/><br/>hala daha yandas medya kanallarinda utanmadan, arlanmadan, serefsizce dunya kadar yalan soyleniyor. <br/><br/>normal adalet yok ki ilahisi olsun.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    19 nisan 2019 a. ihsan yavuz a haber canlı yayını
  entry_id:  89122376
  entry_writer: nickson
  entry_fav_count: 2
  entry_content: |
    cumhurbakanı seçimi bırakalım demedi, bunlara "ya alacaksınız bu seçimi ya da çıranızı yaktım" dedi. cumhurbaşkanı dünyaya mesaj vermek için seçim bitti, önümüze bakalım, kucaklaşalım mesajı veriyor ama arka planda istanbul'u asla bırakmıyor, ysk'ya ne tür baskılar yapılıyor bilemiyoruz.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    cinsellikle açtığı başlığı komik buldukları için kaliteli yazar diyorlar sanırım. bazen şu aptalca konuşanları alacaksın evire, çevire döveceksin sözlük. bilgi 0. yazdıkları komik. sonuç kaliteli!
