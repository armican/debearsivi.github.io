...
- entry_name: |
  ...
  entry_id:  89128072
  entry_writer: poyrazaslan
  entry_fav_count: 94
  entry_content: |
    babam ve oğlum. <br/>her erkeğin babasıyla bir kapışması ve bunun sonunda pişmanlıkları vardır.
...
- entry_name: |
  ...
  entry_fav_count: 37
  entry_content: |
    iyice düşündüm ve bu adamın en sevdiğim özelliğini buldum. ne şutu, ne driblingi, ne mükemmel ötesi pasları, bu adamın en sevdiğim özelliği darbe aldıktan sonra düşmemek için her şeyi yapması. adam bildiğin düşmekten nefret ediyor.<br/><br/>çocukluğunda asfaltta çok fazla maç yapmış olabilir.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    ilk buluşmada bimden cips kola alıp parka gitmek
  entry_id:  89125547
  entry_writer: otopsicocugu
  entry_fav_count: 13
  entry_content: |
    <a class="b" href="/?q=le+fl%c3%b6rt">le flört</a> olur kendileri..
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    çok uyumak <br/>insanlara aşırı değer vermek<br/>fazla konuşmak <br/>para kazanma takıntısı <br/>mutluluğu uzaklarda aramak<br/>insanlara hayran olmak <br/>her türlü maddi hırs <br/>her yere arabayla gitmek <br/>doğa hayatından uzakta kalmak <br/><br/>vb.
  entry_channels: 
- entry_name: |
...
- entry_name: |
    rte'nin imamoğlu'nun elini sıkmaması olayı
  entry_id:  89130122
  entry_writer: ykucuk
  entry_fav_count: 8
  entry_content: |
    imamoğlu'nun yararınadır.
  entry_channels: siyaset,haber
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    kalahari çöllerinde sıradan bir gün. siyah gölgede beliren beyaz çizgileriyle afrika savanlarının iflah olmaz 'am'a susamış sırtlan yazarları, avına düşürecekleri yeni bir çaylak ceylan arayışındaydı.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    sigarayı bıraktığı an. 24 saati geçti, az pohpohlayın la!<br/><br/>gündüz çok dert olmadı da gece kötü. tüm anket başlıklarına yazacağım bu gidişle
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    1-bu tip başlıkları ciddiye alıyor musunuz?<br/>2-bu tip başlıkları ciddiye alanları ciddiye alıyor musunuz?<br/>3-sizce ben bu tip başlıkları ciddiye alıyor muyum?
  entry_channels: anket,ilişkiler
- entry_name: |
    ekşi itiraf
  entry_id:  89107000
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    genelde uzun ince boylu olup sakar olmalarıyla bilinirler. sırtaki yapar gibi bulaşık yıkarlar...
  entry_channels: 
- entry_name: |
