...
- entry_name: |
    imamoğlu'nun erdoğan'la birlikte görünme çabası
  entry_id:  89127141
  entry_writer: alperencaca
  entry_fav_count: 21
  entry_content: |
    imamoğlu devlet terbiyesi olan biri. o yüzden herkesle iyi geçinmek için yapıyor o da farkında ayrışmanın bize birşey getirmeyeceğini. o yüzden toplumu kucaklayıp birleştirme peşinde. ama sizin gibi trollere maaş vermedi diye sevmeyeceksiniz tabi o da olsun o kadar
  entry_channels: siyaset,ilişkiler
- entry_name: |
    murat bardakçı
  entry_id:  89117549
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    varoştan gelip kendini geliştirmek yerine tüm pop camiasını adana yüreğir'e çevirdi. kadın bildigin karşısındaki insanlara söver gibi şarkı yapiyor guzel bir muzikle, tüm türkiye bunu soyluyor. sonra kızlarımız bu kelimeleri nereden ogreniyor oluyor. bakın mesela hit olacak diye cok konusulan yeni şarkısının nakaratı;<br/><br/>sus ya bi boş yapma<br/>sus ya bi boş yapma<br/>sus ya bi boş yapma<br/>kes! son ki<br/><br/>üç beş kişisel özel eşyan vardı topla<br/>çeneni kapat!<br/>sende kalan ne varsa gereksizdir at<br/>napıyorsan yap<br/><br/>yılmazı msn'den silecesin diyen kızlar işte bunlar.
  entry_channels: tv,magazin
- entry_name: |
    mit'e ait mahrem bilgilerin ibb'de olması
  entry_id:  89122924
  entry_writer: mataas
  entry_fav_count: 7
  entry_content: |
    darbe kalkışmasının bilgisini mit yerine <a class="b" href="/?q=eni%c5%9fteden">enişteden</a> alınmasından belliydi zaten.<br/><br/>mit'i de tebrik ederim. istihbarat bilgilerini <a class="b" href="/?q=belediyenin+veri+taban%c4%b1na">belediyenin veri tabanına</a> saklaması şeytanın bile aklına gelmezdi.<br/><br/>edit : ama mit aslında ülkenin güvenlik ve istihbari bilgilerini istanbul bbb yerine bayburt belediyesinin veri tabanında saklaması gerekirdi asıl o zaman çok iyi saklanmış olur hatta arasa kendileri bile bulamazlardı. bu konuda kendilerine darıldım doğrusu.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  89126983
  entry_writer: lunaticadam
  entry_fav_count: 2
  entry_content: |
    (bkz: <a class="b" href="/?q=30+kas%c4%b1m+2013+fenerbah%c3%a7e+be%c5%9fikta%c5%9f+ma%c3%a7%c4%b1">30 kasım 2013 fenerbahçe beşiktaş maçı</a>)
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    (bkz: <a class="b" href="/?q=pi+say%c4%b1s%c4%b1">pi sayısı</a>)<br/><br/>sapyoseksüel kızlar eqlesin. <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    sandro
  entry_id:  89127402
  entry_writer: hicbir sey ulkesindeki her sey
  entry_fav_count: 1
  entry_content: |
    birkaç gün önce durduk yere aklıma geldi. kuzulu, tavşanlı hikayeleriyle sarhoş olduğum zamanlar aklıma geldi ve "bir bakayım, hala buralarda mı" dedim. <br/><br/>gördüm ki gene karalamaya başlamış bir şeyler. okuduğum entry'lerde özlenen o sandro tadını bulamadım. cümlelerin, kurgularının ayakları daha yere basıyor, alice harikalar diyarı lezzeti kalmamış, cümleler daha kurallı. <br/><br/>değişen sen misin sandro, yoksa tavşanlar da mı kirlendi?
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=pushing+daisies">pushing daisies</a>)<br/>(bkz: <a class="b" href="/?q=lucifer">lucifer</a>)
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=s%c3%bctl%c3%bc+nuriye">sütlü nuriye</a>) varken ikisinin de esamesi okunmaz.
