...
- entry_name: |
  ...
  entry_fav_count: 36
  entry_content: |
    sabırsızlıkla beklediğimiz kıyım. analarının bellenişini izlemek keyifli olacak :d
  entry_channels: siyaset,haber
- entry_name: |
    murat bardakçı
  entry_id:  89117549
...
- entry_name: |
  ...
  entry_id:  89131375
  entry_writer: saykobad
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=elveda+rumeli">elveda rumeli</a>)<br/>(bkz: <a class="b" href="/?q=ye%c5%9fil+deniz">yeşil deniz</a>)
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    anonsçu yüzünden sessiz izlediğim maç. bence yararından çok zararı oluyor hem takıma hem seyirciye. <br/><br/>ağır fener basketbol takımı taraftarıyım onu belirteyim ama molalarda gelen fenere şampiyonluk yolunda başarılar reklamı hiç hoş olmamış. efes bu turu geçince fener ile eşlecek, efes de şampiyonluk adayı. iyi olan kazansın kupa türkiyeye gelsin istiyoruz.
  entry_channels: spor
---
