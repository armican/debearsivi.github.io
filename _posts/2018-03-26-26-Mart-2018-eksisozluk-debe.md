...
- entry_name: |
    30 mart 2018 istanbul'a uzay istasyonu düşmesi
  entry_id:  75376545
  entry_writer: seovi
  entry_fav_count: 165
  entry_content: |
    sefaköy’e düşerse çingeneler yüklenip hurdayıca 47 dakika içinde satar. oradan da artık jilet mi olur, çelik granül mü bilemem.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 136
  entry_content: |
    (bkz: <a class="b" href="/?q=%c3%bc%c3%a7gen+bi%c3%a7iminde+birbirimize+takaca%c4%9f%c4%b1z">üçgen biçiminde birbirimize takacağız</a>)
- entry_name: |
    muhsin yazıcıoğlu
  entry_id:  75370916
...
- entry_name: |
    tlc kanalındaki ev programları
  entry_id:  75380152
  entry_writer: uff snne be slk
  entry_fav_count: 54
  entry_content: |
    özellikle programdaki ev fiyatları ayıoğlu my kümes, itoğlu your mezar vs projelerindeki evlerle kıyaslandığında çok uygundur.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    suyun önemi. su hayattır.
- entry_name: |
    çocukken okunmuş unutulmaz kitaplar
  entry_id:  75386147
  entry_writer: bonus48
  entry_fav_count: 0
  entry_content: |
    <a class="b" href="/?q=r%c3%bczgar%c4%b1n+o%c4%9flu">rüzgarın oğlu</a> ve <a class="b" href="/?q=ergenekon+destan%c4%b1">ergenekon destanı</a>
---
