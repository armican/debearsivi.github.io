...
- entry_name: |
  ...
  entry_fav_count: 155
  entry_content: |
    ben bir şey diyecem. bu amı amınakoduğumun başlığında 7.000 den aşağı alan yok.<br/><br/>sizi akp başlıklarında görürsem sikerim
- entry_name: |
...
- entry_name: |
    derste not tutmayan öğrenci
  entry_id:  75361062
  entry_writer: promuyac
  entry_fav_count: 115
  entry_content: |
    yazimi okuyamiyorum. yazimi kimse okuyamiyo
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 53
  entry_content: |
    mutlu olmaktır. dünyevi zevklerin dibine vurup hem de.<br/><br/>ben asıl dindar olan insanların yaşama amacını anlamıyorum. dine göre bu hayat önemsiz, bu hayat değersiz, bu hayat geçici. ne varsa ölümden sonra var. neden bir an önce ölüp yaratıcılarına ve ahiretlerine kavuşmak istemiyorlar. neden bu yaşama amacı?
- entry_name: |
    ekşi itiraf
  entry_id:  75361791
  entry_writer: volga
...
- entry_name: |
    meme kültürü olarak amerika'dan 10 yıl öndeyiz
  entry_id:  75381469
  entry_writer: mucmell
  entry_fav_count: 50
  entry_content: |
    (bkz: <a class="b" href="/?q=yerli+ve+milli+meme">yerli ve milli meme</a>)
- entry_name: |
    ali koç'un ümit özat'ı locasından kovması
  entry_id:  75374459
  entry_writer: dusendeli
  entry_fav_count: 47
  entry_content: |
    üşenmedim araştırdım ümit özat fenerbahçe kariyerinde sadece 1 kez lig maçında kırmızı kart görmüş. o da 14 nisan 2002'de deplesmanda oynanan beşiktaş maçı. ali koç'un locasında izleyebileceği bir maç değil.<br/><br/>olay yalan.
- entry_name: |
  ...
  entry_fav_count: 44
  entry_content: |
    başlığa yazılmayan 139 milyon tl ile 10 tane çiftlik alırım. halkımız yine zengin olmak isterken iyice fakir oldu, o paranızı çocuğunuzun eğitimi için harcasanız ne olurdu.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    benim hatta bikac yas farkla. <br/><br/>ne evim var, ne arabam, ne sevgilim. ama hayat sadece bunlardan ibaret değilki, bana çok değer veren dostlarım var, yanımdan ayrılmayan ailem var, güzel bir işim var, en önemlisi sağlığım yerinde, yani demem şu ki, siz siz olun, hayata hangi yönden baktığınıza dikkat edin, nasıl bakarsanız o derece pozitif olursunuz.
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    iç savaştan evvel el bab, azez ve cerablus’ta dünya ateistler birliği kurultayı yapıldığı, kadın çalışmaları grubu eylemlerinde radikal feminizm propagandası yapıldığı için, şimdiki halleri bazı yazarları üzmüş. <br/><br/>“seküler suriye” miti gözleriniz önünde yıkıldığı için ülkem adına özür dilerim ama suriye iç savaştan evvel de erkek için çok eşliliğin olduğu (bkz: <a class="b" href="/?q=polygyny">polygyny</a>), mirastan kadınların erkeklere göre yarı pay aldığı, <a class="b" href="/?q=irtida">irtida</a> propagandasının yasak olduğu, zina halindeki eşini basan erkeğin eşini öldürmesi halinde ceza almadığı, zina söylentisi üzerine öldürdüğünde ise çok düşük cezalar aldığı, anayasal olarak devlet başkanının müslüman olması zorunlu olan bir yerdi. <br/><br/>aslı aydıntaşbaş’a önerim, derinlemesine bilgi sahibi olmadığı konularda bu kadar kolay ve lalettayin söz söylemesin. dünden bugüne, tedrici gelişmeler olmaksızın, bir anda insanların peçeye girebileceğini düşünecek kadar naif olmasın.<br/><br/>tanım: halen daha mayın ve eyp temizliği yapılmakta olan harekattır.
- entry_name: |
    25 mart 2018 boğaziçili bir grup öğrenciden mesaj
  entry_id:  75389717
  entry_writer: splint
  entry_fav_count: 15
  entry_content: |
    kimsenin umurunda olmayan mesaj.<br/><br/>hay bogazici kadar tas düssün basiniza. ulan dünyada mit, stanford ögrencileri sizin kadar kafa sikmiyor. herifler ilgi gördükce kendini kanaat önderi sanmaya basladi.
- entry_name: |
    jet sosyete (dizi)
  entry_id:  75390163
...
- entry_name: |
    nuri alço'nun mevlana'yı canlandırması
  entry_id:  75385782
  entry_writer: ortalama insan dusuncesine sahip insan
  entry_fav_count: 10
  entry_content: |
    (bkz: <a class="b" href="/?q=mevlana+celaleddin-i+nuri">mevlana celaleddin-i nuri</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    hemcinsleriyle ilişkiyi sevmiyordur.
- entry_name: |
    tehlikeli karım
  entry_id:  75388870
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    i said saçlar no dedim.<br/><br/>kesim: 50 türk lirası.<br/>boya: 200 türk lirası.<sup class="ab"><a title="(bkz: üzgün smiley)" href="/?q=%c3%bczg%c3%bcn+smiley" data-query="üzgün smiley">*</a></sup> <br/><br/>sonuç: bir daha saçını boyatanın...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=t%c3%bcrk+tipi+akademisyen">türk tipi akademisyen</a>)
- entry_name: |
