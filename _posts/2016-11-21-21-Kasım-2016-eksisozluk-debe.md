...
- entry_name: |
  ...
  entry_content: |
    ...
    adamlar tekel oldular ske ske bunlara gidiyoruz diyenler sayesinde ülke bu halde..<br/>gitme amk sanki oksijen sanki su.
...
- entry_name: |
  ...
  entry_content: |
    ...
    takıma futbolcu alırken en azından x futbolcunun genci diye alırsın, bunlar  <a class="b" href="/?q=semih+kaya">semih kaya</a>'nın yaşlısını almış. vizyonunuzu sikeyim.
