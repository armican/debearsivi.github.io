...
- entry_name: |
    sokakta staj arayan boğaziçili
  entry_id:  79023150
  entry_writer: ebelerikorumadernegibaskani
  entry_fav_count: 30
  entry_content: |
    eski bir boğaziçili olarak yaratıcığından etkilendiğim arkadaştır. ancak bu yollardan geçmiş biri olarak özellikle staj döneminde üniversite ya da bölümün etkisi çok düşük oluyor. bir şirkette dayın, halan, teyzen varsa bölüm birincisi olmandan daha fazla etkiye sahipler. yani sizin anlayacağınız dostlar staj arayan boğaziçili bile olsa liyakat yerine ahbap-çavuş ilişkileri her zaman daha etkin. affedersin ben böyle ülkenin...
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    tl üzerindeki resimlerine bakıp ağlayabilirsiniz, şu an türk lirasını tek değerli kılan şey o resimler...<br/><br/>(bkz: <a class="b" href="/?q=mumla+aramak">mumla aramak</a>)
...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    sadakatsiz olmakmış. beni aldatan eski sevgilim geçenlerde mesaj attı. konu beni aldatmasına geldi. önce dedi ki o kız sen varken de vardı seni aldatmadım fjsjsjsks sonra dedi ki sen sadakatten ne anlarsın "benden önce" kaç kişiyle yattın. ayrıntıyı fark ettiniz mi? ondan önce. ama o benleyken de başkasıyla ama beni aldatmamış ama ben sadakatsizim. niye çünkü ondan önce birçok kişiyle yatmışım. ulan bu nasıl bir iğrençlik ya? nasıl bu kadar iğrenç beyinler yetişebiliyor?
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: siyaset
- entry_name: |
    marmara bölgesi'nde artık yaz yaşanmaması
  entry_id:  79028911
  entry_writer: hazard ratio
  entry_fav_count: 7
  entry_content: |
    belanızı mı arıyorsunuz lan? biz burada patlıyoruz. klimasız oturamıyoruz. klima şu an 20 derecede ve soğuk fan açık. buna rağmen wc'ye gitmeye üşeniyorum çünkü odanın kapısını açar açmaz yüzüme sıcak ütü buharı üflüyorlar sanki.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    17 milyon öğrenci olduğunu hesaba katarsak gayet normaldir.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="http://www.meb.gov.tr/ogrenci-sayisi-17-milyon-588-bine-yukseldi/haber/10675/tr" title="http://www.meb.gov.tr/ogrenci-sayisi-17-milyon-588-bine-yukseldi/haber/10675/tr">http://www.meb.gov.tr/…bine-yukseldi/haber/10675/tr</a>
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    fenerliler dahil hepimizin bildiği şikelerden birini itiraf etmiş olan fenerin eski golcüsü.<br/><br/>bu kez golü aziz yıldırım'a atmış.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    ms 1'e 100 dolareslik ince bir bahis yaptık.<br/><br/>fransa'nın zencisi çok.<br/><br/>sürpriz beklemiyorum.
  entry_channels: spor
- entry_name: |
    çaylak onay listesi
  entry_id:  79032110
  ...
  entry_fav_count: 0
  entry_content: |
    çaylaklıktan çıkma tarihim çok manidar. yıllarca okuyucu olarak bulunduğum sözlük dünyasına bundan tam üç sene önce bir yaz günü yine kendimi çılgınca yalnız hissederken açmıştım üyeliğimi. 20 binlerdeydi sıram tabi o zamanlar. yazma isteği ve heyecanıyla doluydum ilk defa kayıt olan herkes kadar. şu an senelerin geçmesinden kaynaklı olsa gerek yazma istediğimden eser yok. koskoca 3 sene geçmiş neler yaşandı neler o günden bu güne. keşke niteliksiz troller yerine istekli insanlar yazar yapılsa.
