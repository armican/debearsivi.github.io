...
- entry_name: |
  ...
  entry_channels: siyaset,haber,ekonomi
- entry_name: |
    nargilenin hayatımıza bu kadar hızlı girme sebebi
  entry_id:  80069071
  entry_writer: sametal17
  entry_fav_count: 342
  entry_content: |
    nargile hep vardı, instagram yoktu.
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    gayet de beğendiğim logodur. siz <a class="b" href="/?q=ek%c5%9fi+s%c3%b6zl%c3%bck+hi%c3%a7bir+siki+be%c4%9fenmeme+timi">ekşi sözlük hiçbir siki beğenmeme timi</a>ne bakmayın. amerikan basketbolundaki logolar gibi olmuş. bir pazarlamacı olarak onayladım.
  entry_channels: 
- entry_name: |
    sinema tarihinin en iyi engelli rolleri
  entry_id:  80056734
  entry_writer: osurayim derken sican adam
  entry_fav_count: 14
  entry_content: |
    cumali ceber ( zihinsel )
...
- entry_name: |
  ...
  entry_channels: ekonomi
- entry_name: |
    türk polisine olan saygının azalma nedenleri
  entry_id:  80055625
  entry_writer: daha ne soyleyim
  entry_fav_count: 9
  entry_content: |
    garibana aslan kesilirken ensesi kalına kedicik gibi davranmak. güzelim polisler de bu tipler yüzünden arada kaynıyor.
  entry_channels: siyaset,anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    (bkz: <a class="b" href="/?q=ge%c3%a7en+yine+nas%c4%b1l+umurumda+de%c4%9fil">geçen yine nasıl umurumda değil</a>) ama entari yazmadan duramıyorum ayşe.
  entry_channels: spor
- entry_name: |
    ekşi itiraf
  entry_id:  80060552
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    türk entelektüelinin en önemli sorunlarından biri, bütünü daha iyi anlayabilmek için parçalara ayırırken konunun özünden uzaklaşıp detaylarda boğulması. ssg de böyle davranmış, konuyu sadece berrak tüzünataç'ın davranışına indirgemiş.<br/><br/>iddialı tespitler yapmaktan korkarım, ama buna türk entelektüelinin otisabileşme süreci diyebiliriz sanırım.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    ya doları geçtim, bulgar levası tl nin 3,5 katı oldu neredeyse daha hala papaz diyor millet. doların düşmesi için jetonun düşmesi lazım jetonun.
  entry_channels: 
- entry_name: |
