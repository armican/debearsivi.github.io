...
- entry_name: |
  ...
  entry_fav_count: 61
  entry_content: |
    kendisini düşüncelerinden dolayı dövdüren, ölümle tehdit ettiren, kanal binasını taşlatan ideolojiyi yalamakla meşgul olan kişi. <br/><br/>inanın derdim akp yanlısı olması değil. istediği kadar savunabilir politikalarını.<br/><br/>ama edep yahu, bunun bir utanma ölçüsü olmalı. ne biçim bir benliğin var. hiç mi kendine saygın yok. hiç mi yüzün kızarmaz kardeşim. skeçlerdeki abartılı fırıldak karakterleri canlı kanlı izliyoruz resmen. ben kendisi adına utanıyorum şahsen...
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    daha da uzağa daha da büyüğünü yaparak sorunu çözeceğimizi düşündüğüm havaalanıdır!<br/>sonuçta hala bu işten ekmek pardon pasta yemesi gerekenler var değil mi?
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    bu sınavı deneme amaçlı kullandı galiba. bu düzeneği yapan insan ehliyet sınavında da 70 puanı alabilirdi. bence yakalanmasaydı başka sınavlarda kullanacaktı. (bkz: <a class="b" href="/?q=komplo+teorisi">komplo teorisi</a>)
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    şok etkisi yapıyor bende acaba kim ne dedi diye korkuyorum bazen, bazen de heyecanlanıyorum tatlı tatlı acaba diyorum “o” mu? sonra bir bakıyorum su entariniz bu başlığa taşındı. imza bir tost <br/>te allam
...
- entry_name: |
    en güzel oje rengi
  entry_id:  100116018
  entry_writer: nastyenka
  entry_fav_count: 2
  entry_content: |
    toprak tonları
  entry_channels: anket,moda
- entry_name: |
    ehliyet sınavı için hazırlanan kopya düzeneği
  entry_id:  100154936
  entry_writer: axiwelet
  entry_fav_count: 2
  entry_content: |
    düzeneğin kalite kontrolü için tüm şartların sağlanması sebebiyle basit bir sınav seçilmiştir.<br/><br/>sonuç: <a class="b" href="/?q=rejection">rejection</a>.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    biskremin kurabiyeden yapilmis olani.
  entry_channels: yeme-içme
- entry_name: |
    hamsinin abartılmış bir balık olması
  entry_id:  100140456
  entry_writer: ilgeru
  entry_fav_count: 0
  entry_content: |
    canım ekmek arası hamsi çekti. şöyle az limonlu, soğanlı ve maydanozlu olacaktı var ya olum açmayın bu tarz başlıklar akşama hamsi aldırtacaksınız bana.
  entry_channels: anket,yeme-içme
- entry_name: |
