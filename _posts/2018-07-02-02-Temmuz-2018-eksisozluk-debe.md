...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    baraj altı kalmaya azimli ve kararlıyız anlamına gelen açıklama.
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    ziraat bankası genç çiftçilere 100 bin lira 18 ay sonra geri ödemeli sıfır faiz kredi veriyor. çiftçiler parayı döviz yapıyor.<br/>bu nasıl planlama, nasıl tarım destekleme. muhtemelen esnafa verilen kredilerde aynı şekilde döviz yapıyorlar.<br/>üretime dönük verilen krediler üretime dönük harcanmıyor. <br/>yani tarım ya da esnafı desteklemek sıfır faiz kredi vermekten mi geçiyor bunun başka yöntemi yok mu.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    gerçekte de itici olan kadında itici olmaktadır. <a class="b" href="/?q=zaten+itici+olmayan+kad%c4%b1nda+neden+itici+olsun+ki">zaten itici olmayan kadında neden itici olsun ki</a> <br/>bir tanıdık var, bu iticilerden. her ortamda illa rakı içer, bazen deriz iki bira içip kalkalım, yok bu abla rakı içecektir, ağzını gere gere tekrar eder, ben rakı içerim hep diye. <br/>sonra bir garsonu gözüne kestirir, ona o hizmet edecektir, başka garson gelince hiç de nazik olmayan bir ses tonu ve vurgulama ile, bana şuradaki arkadaşı çağır bana o getirsin der. neden, çünkü rakı kültürü vardır kendine has, o garson onu tanıyordur, meze falan önemlidir çünkü rakıda. o garson bunu biliyordur. lan sikindirik, kalabalık bir mekan işte, seni bilse ne olur, bilmese ne olur, gençlerin gittiği bira içip patates yediği yer işte ne bu havalar?<br/>normalinde kadınlarla alakalı olumsuz başlıklara yazmam ama bu kadın çok sinir be. en son bize gelmişti, rakı almış kız arkadaşım, zaten ikisi iyi arkadaş. ben katılmadım rakı işine, çok da sevmeme rağmen. çekemem hiç rakı muhabbeti.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    tam bir bomba denmiş de adam şuana kadar taş gibi oynadı nerenizle izliyonuz amk.
  entry_channels: spor
- entry_name: |
    bir insana yapılabilecek en kötü şey
  entry_id:  78730760
  entry_writer: gokcesadik
  entry_fav_count: 3
  entry_content: |
    umut verip sonra oralı olmamak<br/>vaat verip onu tutmamak<br/>güven aşılayıp sonra o güvenin içine etmek
  entry_channels: anket
- entry_name: |
...
- entry_name: |
    kemal kılıçdaroğlu
  entry_id:  78715822
  entry_writer: cenk tosun
  entry_fav_count: 2
  entry_content: |
    partisi fiilen bölünmüş olan atanmış genel başkan. beğenmediği, fetö suflesiyle diktatör dediği erdoğan, ülkenin en az %50'sinin desteğine sahip. bu adam chp seçmeni arasında dahi %30 alamaz. böyle de demokrasi aşığı bir adamdır. evet, hırsızlık sistemde var başkan, o delegeler daha iyi ifade edilemezdi.<br/>koyun olmayan seçmenin elinde şimdi son bir koz kaldı, o da yerel seçimler. yerel seçimlerde de dedesinin partisine oy verirlerse geçmiş olsun.<br/>kendisi artık kurt bir siyasetçidir, yeni bir adalet yürüyüşü planladığını tahmin etmek zor değil.
  entry_channels: siyaset,haber
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    geceye bir attila ilhan dizesi bırak
  entry_id:  78707651
  entry_writer: smyrnaninbabasi
  entry_fav_count: 2
  entry_content: |
    paris’in göklerinden uzanıp bir yıldız kopardım<br/>kırmızı bir karanfilmiş gibi yıldızı saçlarına taktım<br/>on beş dakika sonra bordeaux’ya bir tren kalkacak<br/>garın merdivenlerinde benim için ağlayacaksın<br/>ellerim yağmura açılmış sakallarım ıslak<br/>ben ki cehennemde bir allah gibi yalnızım...<br/><br/>*kaptan - attila ilhan
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    27 yaşındayım <br/><br/>14 yasında sevgili işleri başlasa 13 yılda 1-2 flört denemem olmustur..gerisinde nuh dediler peygamber demediler<br/><br/>13 gün kiev’de kaldım 7 kadınla birlikte oldum..4 tanesi ayrılmak istemedi evden zorla gönderdim..hala sabah akşam yazarlar gözlerime sakallarıma iltifat ederler...
  entry_channels: ilişkiler
- entry_name: |
    ekşi sözlük dertleşecek insan veritabanı
  entry_id:  78705130
  entry_writer: davaronunmixeri
  entry_fav_count: 0
  entry_content: |
    derdinizi sikiyim..
  entry_channels: anket,ilişkiler,ekşi-sözlük
