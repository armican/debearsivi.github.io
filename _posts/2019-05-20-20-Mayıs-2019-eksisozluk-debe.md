...
- entry_name: |
  ...
  entry_fav_count: 317
  entry_content: |
    kurallari bir yerinden uyduran bir kusun aglamasi
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    iran'da doğru düzgün bir civata fabrikası bile yok
  entry_id:  90256198
  entry_writer: zck
  entry_fav_count: 79
  entry_content: |
    öncelikle iran'in kendi üretim savaş uçağı yoktur. gotunuzden sallamayin. <br/>popülist bir şekilde abartarak söylenmiş, bir bakıma haklı ifadedir.
...
- entry_name: |
  ...
  entry_fav_count: 46
  entry_content: |
    (bkz: <a class="b" href="/?q=edemedi">edemedi</a>)!!!
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 25
  entry_content: |
    gayet iyi yönetti amk maç sonucuna tesir eden bir hatası yoktu. bu maçı yönetebilecek kalibrede tek adam oydu o da iyi yönetti, algı kasmayın.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    19 mayıs galatasaray'ın attığı golün ofsayt olması
  entry_id:  90277840
  entry_writer: baa bak sana iki cift sozum var
  entry_fav_count: 18
  entry_content: |
    "talimat diyor ki; savunma oyuncuları, herhangi bir rakip avantajını engellemek maksadıyla topla bilerek ve isteyerek oynar ancak topu uzaklaştıramaz ve o top ofsaytta bulunan oyuncuya giderse hakem oyunu devam ettirecektir. gol olmuşsa da golü verecektir."<br/>gol temiz. <br/>not:beşiktaş
  entry_channels: spor
- entry_name: |
    ersun yanal
  entry_id:  90249673
  entry_writer: piretorbasisaclicocuk
  entry_fav_count: 17
  entry_content: |
    eğitimsiz diye hakkında atılıp tutulan ama ligdeki birçok futbolcu eskisinin aksine besyo mezunu olan teknik direktörümüz. anana göre ayarlicak tabi antrenmanı; sana mı yakalansın koskoca adam donla ?
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    işid sakallı takım elbiseli kısa paçalı babet çoraplı mitayit oğlanları şuraya yazmayın lan. çok belli oluyorsunuz.<br/><br/>o bmw gidecek. üzgünüm.
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    bolton lanet olsun dostum bayadır savaşmıyoruz ne yapsak? dur önce kendimizi vuralım, sonra da şu ırak'la suriye'yi vuralım.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    son yıllarda izlediğim en ilginç futbolcu olabilir kendisi. çok ama çok acayip bir adam. beyinsiz falan diye seviyoruz ama cidden çok ilginç.<br/><br/>mesela bu herif sol kanattan sağ kanatta oynayan feghouli'ye gol attırıyor, belhanda'ya gol attıyor, linnes'e gol attırıyor. kendi de gol atıyor. gol attırmaktan kasıt asist yapmak değil bu arada, direkt gol pozisyonunu hazırlıyor ve savunmalar genelde yerleşik oluyor. <br/><br/>pas konusunda takımda ndiaye ile birlikte belki de en zayıf kısa pas atan adam olmasına rağmen finishingi çok yüksek. adam pas özürlü ama bitiriciliği lig ortalamasının üzerinde. üstelik sağ ayaklı sol kanat-forvet...<br/><br/>hava toplarını genelde rakibe bırakıp iki adam geri adım atıyor. o topu da bir şekilde alıyor.<br/><br/>gol atıyor, attırıyor. <br/><br/>var'ın olduğu ligde gol attıktan sonra forma çıkarıp sarı yiyor. ve bu goller ofsayt gerekçesi ile iptal oluyor. sadece bir ya da iki maçta gol olarak değer kazanmış gollerde forma çıkardı. buna rağmen ısrarla çıkarıyor.<br/><br/>keşke alabilsek ama imkansız gibi.<br/><br/>seni çok özleyeceğim beyinsiz reis. ama çok. belki de belhanda'dan bile çok... yolun açık olsun.
  entry_channels: spor
- entry_name: |
    emre belözoğlu
  entry_id:  90279361
  ...
  entry_fav_count: 6
  entry_content: |
    ömrün böyle galatasaray'ın şampiyonluklarını izlemekle geçicek küçük enişte. seneye fenerbahçe formasıyla da galatasaray şampiyonluğu izlersin. hep aynı forma olmaz.
  entry_channels: spor
- entry_name: |
    gsstorde hakem üniforması satılsın kampanyasu
  entry_id:  90280690
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    sözlük geliştiricileri emek vermiş, başlıkta ara kısmına "linkler" seçeneğini eklemiş. bazı yazarlar da gitmiş maçın yayınlandığı linkleri başlığa yazmış. yani tek tuş ile maç için link bulabilirsiniz. ama o tuşa bile tıklamaktan aciz orospu çocukları gelmiş hala link istiyor. amına kodumun prensesleri. ayağınızı koyacağınız tabureyi de çekelim mi?
  entry_channels: spor
- entry_name: |
    19 mayıs 2019 abdullah avcı açıklamaları
  entry_id:  90283335
  entry_writer: aydinnesty
  entry_fav_count: 3
  entry_content: |
    ahahahahahahahhahajahaha. abdullah sen onu bunu boş ver, arda turan, emre, robinho, adebayor bunların parasını nerden buldunuz. erkek adam bunları açıklar.
  entry_channels: spor,haber
- entry_name: |
    geceye bir şarkı bırak
  entry_id:  90254617
  entry_writer: icinde bebek uyuyan minik kar kuresi
  entry_fav_count: 0
  entry_content: |
    bilmeyenler için çok özür dileyerek paylaşıyorum, alın bununla yaşayın artık nasıl yaşarsanız. geçmiş olsun.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/wEcEjNsn1Io" title="https://youtu.be/wEcEjNsn1Io">to blossom blue</a>
  entry_channels: anket,müzik
- entry_name: |
    fetösaray futbol kulübü
  entry_id:  90280643
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=s%c3%b6zl%c3%bc%c4%9f%c3%bc+tinder+niyetine+kullanmak">sözlüğü tinder niyetine kullanmak</a>)
