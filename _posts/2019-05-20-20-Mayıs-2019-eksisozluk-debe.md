...
- entry_name: |
  ...
  entry_fav_count: 95
  entry_content: |
    ağlamayın lan, açık net kural şu:<br/><br/>"savunma oyuncuları, herhangi bir rakip avantajını engellemek maksadıyla topla bilerek ve isteyerek oynar ancak topu uzaklaştıramaz ve o top ofsaytta bulunan oyuncuya giderse hakem oyunu devam ettirecektir. gol olmuşsa da golü verecektir."<br/><br/>-oyna, devam
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    hassiktir ulan oradan şerefsiz pezevenk. sen siktir git de kümede kalmanızın getirdiği mutluluk ile ilgili başlıklar sıç.<br/><br/>(bkz: <a class="b" href="/?q=ota+boka+fet%c3%b6+diyen+amc%c4%b1k+a%c4%9f%c4%b1zl%c4%b1lar">ota boka fetö diyen amcık ağızlılar</a>)
  entry_channels: spor,siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    hadi abicim, hadi git milli takiminda korka korka oynat kimi istiyorsan. necipi al, zor maclarda on liberoya koyarsin falan, iyi, topculari 4-5 ay oynatma ki adam olsunlar. buyuk maclara korkarak cik. hadi laz hocam yolun acik olsun. umarim bi daha gorusmeyiz.
  entry_channels: spor
- entry_name: |
    henry onyekuru
  entry_id:  90246870
  ...
  entry_fav_count: 3
  entry_content: |
    akpilspor'un sağ kanadını bu gece kevgire çevirecek aslan.<br/>oyna lan. yürü.
  entry_channels: spor
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    2019-2020 sezonu sampiyonu galatasaray
  entry_id:  90279782
