...
- entry_name: |
  ...
  entry_fav_count: 64
  entry_content: |
    hakkında savcılığa <a class="b" href="/?q=fetch+me+some+wine+will+ya">fetch me some wine will ya</a> ile birlikte suç duyurusunda bulunduğumuz kişidir.<br/><br/>unutmadık, unutturmayacağız modunda hain vatandaşdır. <br/><br/>başsavcı ile kendisi <sup class="ab"><a title="(bkz: melaba furki)" href="/?q=melaba+furki" data-query="melaba furki">*</a></sup> hakkında yaptığım şikayeti uzun uzun konuştuk. kendisi bizzat ilgileneceğini söyledi.<br/><br/>ayrıntılar gelecek...
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 22
  entry_content: |
    lligde olan ligde kalır. gönlümüz, kalbimiz beşiktaşla.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    “az önce insanların neşesine neşe kattığım bir partiden geldim; dudaklarımdan nükteler döküldü, herkes güldü ve bana hayran kaldı –fakat ben ayrıldım- bu çizgi dünyanın yörüngesi kadar uzun olmalı<br/>ve <br/>kendimi vurmak istedim”<br/><br/>(bkz: <a class="b" href="/?q=soren+kierkegaard">soren kierkegaard</a>)
- entry_name: |
    beşiktaş
  entry_id:  71400166
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    lan zaten sunu kavrayacak zeka olsa, o cekirdegi yere atmaz.<br/><br/>ben size olacagi söyleyeyim.<br/><br/>o essegin yanina oturur, cekirdegi yere atar, sonra da essekle selfie cekinir.
- entry_name: |
    ekşi itiraf
  entry_id:  71385890
...
- entry_name: |
    friedrich nietzsche
  entry_id:  71387435
  entry_writer: theory of everything
  entry_fav_count: 6
  entry_content: |
    "<a class="b" href="/?q=olgu">olgu</a>lar yoktur, yalnizca yorumlar vardir."<br/>friedrich nietzsche
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    depresyon göstergesi sanırım. ortada yakın zamanda gerçekleşmiş ya da açıktan bir neden olması gerekmez, sadece sonsuz bir iç sıkıntısına sahip olabilir insan. dışarıdan çok anlaşılabilecek bir şey değil galiba.
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    kalıcı bir yöntemi, saç ekimi dışında yoktur.<br/><br/>dna'nızda ne yazıyorsa o olacak.
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    uzun süre sevgili olmak ( sabır katsayısını düşürür)<br/>iki kişilik düşünememek<br/>bencil davranmak<br/>aileleri evliliğe gereğindan fazla dahil etmek<br/>düğünden kalan borçlar<br/>senin paran benim param muhabbetleri
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=bunu+bilen+liseli+de%c4%9fildir">bunu bilen liseli değildir</a>)
- entry_name: |
    trabzonspor
  entry_id:  71398264
  ...
  entry_fav_count: 0
  entry_content: |
    <a class="b" href="/?q=ersun+yanal">ersun yanal</a> ve <a class="b" href="/?q=burak+y%c4%b1lmaz">burak yılmaz</a> bitmiş.
- entry_name: |
    şu anda çalan şarkı
  entry_id:  71387587
...
- entry_name: |
  ...
  entry_id:  71399822
  entry_writer: feministim ben
  entry_fav_count: 0
  entry_content: |
    baba ve piç öncesi dönemini severek okuduğum, sonrasını ise hiç beğenmeyerek okuduğum bir yazar elif şafak. daha önce de yazmıştım bunu sözlükte.<br/><br/>elif şafak'ı ilk okuduğum yıllardan beri, ki bu da lise yıllarıma - yani bir 10 sene öncesine dayanır, kitaplarından onun lezbiyen, en iyi ihtimalle biseksüel olduğunu hissetmiştim. elif şafak'ın kitaplarını, baba ve piç ve öncesini severek okuyan, bu kadını takip eden, düşünceleriyle ilgili fikir sahibi olan çoğu insan bunu anlayabilirdi. bir de, ben de geyim bunun da etkisi olabilir anlamamda. demem o ki, biseksüel olduğunu hep biliyordum, hissediyordum, ama kendi ağzından duyacağımı düşünmezdim. bu konuyla ilgili açıklamasını pr olarak görmüyorum, samimi buluyorum. <br/><br/>ay bu entry de "bakın bakın ben biliyordum hadi bana bir alkış" havası taşıdı şimdi ama öyle bir amacım yoktu sadece bazı salakça yorumlara binaen yazdım.
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    olmaz a<br/>bu saatte dert anlatacağınız tutar beklerim
- entry_name: |
    blade runner 2049
  entry_id:  71389767
  entry_writer: mepipi
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    "seyirciler var mı ? bebekler ..bebekler ?"<br/><br/>başka bebek var mı ?<br/><br/>bonus: obradovic delirmiş
---
