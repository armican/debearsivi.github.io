...
- entry_name: |
  ...
  entry_fav_count: 122
  entry_content: |
    nasıl duygulu, edebi bir dille yazmışsınız ya, ne olduğunu bilmeyen de edebiyat akımı falan sanar.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
    31 mart 2019 3 büyükşehir bahis oranları
  entry_id:  88085430
  entry_writer: wohan
  entry_fav_count: 92
  entry_content: |
    hazineyi binali yıldırım'a basıp dış borçları eritelim dedirten oranlardır.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
    titanic batarken çalmaya devam eden müzisyenler
  entry_id:  88086356
  entry_writer: excelsior was here
  entry_fav_count: 88
  entry_content: |
    berat albayrak'ı hatırlatan müzisyenlerdir.
  entry_channels: tarih,müzik,sinema
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 35
  entry_content: |
    pankartı açan kız 23 bin küsür tweet atmış. bilim adamları beynini açıp incelese görecekleri şey bilim dünyasını şoke edecektir muhtemelen.<br/><br/>(bkz: <a class="b" href="/?q=saman">saman</a>)
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    şimdi buradan beele dümdüz git sen kartal başkan .
  entry_channels: spor
- entry_name: |
    ekşi itiraf
  entry_id:  88082593
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    yufkacılar kapanacaktır. küçük ve çeşitli haplar gıdamız olur, yufkacılar da dolaylı olarak etkilenir ve yıllar içinde batar.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: siyaset
- entry_name: |
    hoverboard ile tavaf yapmak
  entry_id:  88095256
  entry_writer: imamihanife
  entry_fav_count: 1
  entry_content: |
    adam o makineyle kabeyi tavaf etmiyor, sadece yukarı balkondan gitmek istediği ikamete, sağlık sorunları nedeniyle hoverboard ile gidiyor.<br/><br/>ama tekerlekli sandalye ile tavaf eden engelli ve yaşlı insanlarımız var; <a class="b" href="/?q=hoverboard">hoverboard</a> ile de neden olmasın dediğim kolaylıktır.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  88093367
  entry_writer: enfeksiyoz mononukleozis
  entry_fav_count: 0
  entry_content: |
    an itibariyle bostanlı/izmir
