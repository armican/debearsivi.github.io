...
- entry_name: |
    2019-2020 sezonu galatasaray lehine hakem hataları
  entry_id:  93986599
  entry_writer: saintly
  entry_fav_count: 191
  entry_content: |
    fanatik fenerbahçeli cumhurbaşkanı, fanatik fenerbahçeli tff başkanı ve fanatik beşiktaşlı eski tff başkanına rağmen galatasaray'a ayrıcalık tanındığını ya da tanınanacağını düşünen beyin fukarası davarların yeni sezon ağlama duvarı başlığı.
  entry_channels: spor
- entry_name: |
    age of empires oynamış efsane nesil
  entry_id:  93990205
  entry_writer: arma yann tiersen
  entry_fav_count: 162
  entry_content: |
    (bkz: <a class="b" href="/?q=hala+oynuyorum+lan+ben">hala oynuyorum lan ben</a>)
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    bir kişi de (bkz: <a class="b" href="/?q=sabahattin+ali">sabahattin ali</a>) dememiş, yazıklar olsun..
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    instagram'da sürekli kilolu kadın fotoğrafları beğeneceğine biraz işiyle ilgilenmesi gereken akılsız.
  entry_channels: spor
- entry_name: |
    mbaye diagne
  entry_id:  94012419
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    isterse komple içine sıçsınlar. isterse atom bombası patlasın.. bu saatten sonra umrumda olmayacak durum.. uzungöl mü kalmış? bildiğin beton döküp uzun havuz yapmışlar. ancak araplar gidiyor. bir de bizim betonsever yerliler. <br/><br/>olm beton seviyorsanız gidin en yakın havuzun kenarında dolanın.. o da beton bu da beton. ne farkı var mk?<br/><br/>(bkz: <a class="b" href="/?q=svihs">svihs</a>)
  entry_channels: sağlık,haber
- entry_name: |
    sevgili aramayan yalnız insan
  entry_id:  93975903
  entry_writer: deep fly
  entry_fav_count: 5
  entry_content: |
    bu başlığa yazmaz.(bkz: <a class="b" href="/?q=paradoks">paradoks</a>)
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    youtube kanallarında 2001'den bu yana her gol kralının attığı goller ile ilgili video yayınlayan ama 2003-2004 sezonu gol kralı <a class="b" href="/?q=zafer+biryol">zafer biryol</a>'u yayınlamayan kanal.<br/><br/>kardeş adam fetö'den tahliye edildi. bu kadar korkmayın alt tarafı gol videosu.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    her memur zammı arefesinde çıkıp bağırırım. <br/>kim ulan o en düşük memur diye.<br/>zira ben hala haberlerin iddia ettiği en düşük memur maaşını alamıyorum.<br/><br/>ya ben memur değilim ya da o en düşük memur'a birileri iltimas geçiyor.<br/><br/>şimdi arkadaş da demiş ya oturduğunuz yerden 5 bin lira alıyorsunuz diye.<br/>hassiktir lan oradan.<br/>kim ulan o 5 bin alan.<br/>nerede çıkıp adam gibi desin ben 5 bin alıyorum diye.<br/>doktoru, mühendisi tabi ki alır da. <br/>arkadaş oturduğunuz yerden alıyor dediğine göre düz memurdan bahsediyor. <br/>nerde lan 5 bin alan memur. psikolojimi bozdunuz lan. 4'e de razıyım bak.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    değerli mesajlarınızı bekliyorum sevgili çaylaklar...
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    mide kanaması geçirdiğimde acıdan bayılmıştım.<br/><br/>bir yenisine davetiye çıkartmak üzereyim sanırım.
  entry_channels: anket,sağlık
- entry_name: |
    orgazmdan daha zevkli anlar
  entry_id:  94016616
  entry_writer: guzelabi
  entry_fav_count: 0
  entry_content: |
    öğretmenin'in 17 yaşındaki oğlunuz için "-çok iyi yetiştirilmiş bir cocuk" demesi
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    hele bı yaaa carakk.. klasik antepli özellikleri;<br/>yiğit , merttir, yalanı olmaz, çalışkandır, kebab yapmayı bilir, sevdin mi candan sever..eğer bu özellikleri sahip değilse kesinlikle orjinal değil, yan sanayidir..
  entry_channels: ekşi-sözlük
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bebe bebe bebe bebe.....düğüne gidin sosyallesin ankara bebeleri.
