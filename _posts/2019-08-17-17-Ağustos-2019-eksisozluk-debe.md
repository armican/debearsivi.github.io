...
- entry_name: |
    gül satan çingenelere kesin çözüm
  entry_id:  94002104
  entry_writer: kaptan pilot muhendis
  entry_fav_count: 342
  entry_content: |
    bok rahatsız etmiyorlar.
...
- entry_name: |
  ...
  entry_fav_count: 272
  entry_content: |
    çok heyecanlıyım, ilk defa bu fırsatı yakalıyorum.<br/><br/>reynmen kim amk?
...
- entry_name: |
  ...
  entry_fav_count: 47
  entry_content: |
    benim bu, geçen sene belimdeydi saçım ve bir anda çenemde kestirip<br/><a rel="nofollow noopener" class="url" target="_blank" href="https://m.facebook.com/sacimsacinolsun/?locale2=tr_TR" title="https://m.facebook.com/sacimsacinolsun/?locale2=tr_TR">saçım saçın olsun</a>’a bağışladım.<br/>kanser hastaları için peruk yapıyorlar. <br/>olurda saçınızı kestiricek olursanız 30cm’den uzun olduğu taktirde bağışlayabilirsiniz.<br/><br/>her zaman depresyondan kestirilmiyor saçlar.
  entry_channels: moda
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    16 ağustos 2019 galatasaray'a verilen 2. penaltı
  entry_id:  94014068
  entry_writer: sikekonankebelek
  entry_fav_count: 38
  entry_content: |
    bazen bu eşkici gerizekalıların futbolun kurallarını bilmediğini falan düşünüyorum. gsye niye penaltı veriliyormuş. ceza sahasında gsli oyuncuya faul yaparsan gsye penaltı verilir gerizekalı. ofsaytı falan da anlatmamı istersen çekinmeden yaz.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: moda
- entry_name: |
    yüzde 3.5 zammı beğenmeyen aç gözlü memur
  entry_id:  94015342
  entry_writer: hania
  entry_fav_count: 27
  entry_content: |
    işte bu orospu çocukları yüzünden esnaftan alışveriş yapmıyorum. suyu bile migrostan a101 den alıyorum. <br/><br/>yarrak yesin amk esnafı.
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    kuteybe bin müslüm iyi ki türkleri kesti
  entry_id:  94013984
  entry_writer: madonnanin yagli zencisi 2
  entry_fav_count: 26
  entry_content: |
    bir tarihçi yorumu<br/><a rel="nofollow noopener" class="url" target="_blank" href="https://twitter.com/madyaglizencisi/status/1162423595366322177?s=21" title="https://twitter.com/madyaglizencisi/status/1162423595366322177?s=21">https://twitter.com/…tatus/1162423595366322177?s=21</a><br/>(bkz: <a class="b" href="/?q=t%c3%bcrklerin+k%c4%b1l%c4%b1%c3%a7+zoruyla+m%c3%bcsl%c3%bcman+olmas%c4%b1">türklerin kılıç zoruyla müslüman olması</a>)<br/><br/>yoksa islamiyet ile şereflenemezmişiz (malum müslüman olmadan evvel şerefsiz şerefsiz geziyorduk!)
  entry_channels: siyaset,tv,bilim,tarih
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    eğilin ve yerden taş alıyormuş gibi yapın.
  entry_channels: anket,ilişkiler
- entry_name: |
    behzat ç.
  entry_id:  93975129
  ...
  entry_fav_count: 18
  entry_content: |
    sezonun tamami final sahnesine kadar mayis ayinda cekilmis bitmis adamlar hala saniyor ki senaristler sözlüge bakarak senaryoyu degistiriyor. nasil bi kafa la bu sinzinki. angara kafasi mi acaba.
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    16 ağustos 2019 denizlisporun verilmeyen penaltısı
  entry_id:  94015076
  entry_writer: sultan of rum
  entry_fav_count: 14
  entry_content: |
    aptallar pozisyonun ceza sahası dışında olduğundan bile habersizler.<br/><br/>aptallar.<br/><br/>edit; bazı arkadaşlar değişen kurallar diyerek açıklamaya gayret etmişler. herifler pozisyonun nerede olduğunu bilemeyecek kadar aciz ya da sadece algı kasıp saçmalamak için burada. niye yoruyorsunuz kendinizi?<br/><br/>edit2; ahahha salağın biri de ceza yayını ceza sahası çizgisi zannedip link veriyor, bakın içerde diye ağlıyor. <br/><br/>ahahahaha vallahi eğitilmezsiniz bile:)
  entry_channels: spor
- entry_name: |
    selçuk inan
  entry_id:  94013898
  ...
  entry_fav_count: 13
  entry_content: |
    saha içinde ısınma koşusu yapan üstüne de sezonun ilk maçında penaltıyı gerizekalıca kullanarak kaçıran türk futbolcu. gelsin amına koduğum yabancı sınırlaması. liginizin amk
  entry_channels: spor
- entry_name: |
    uzungöl'e lağım dökülmesi
  entry_id:  94013112
  entry_writer: sagliginiz icin
  entry_fav_count: 10
  entry_content: |
    betonladik yetmedi, icine de sicalim videosu.
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    kanser mk başka açıklamasi yok. 7 buçuk metre kalede 40cm lik kaleciyi vuruyor aminoglu.
  entry_channels: spor
- entry_name: |
    bir doktorun egosundan daha büyük olan şey
  entry_id:  93975862
  entry_writer: aksiprikizi
  entry_fav_count: 7
  entry_content: |
    hayatınızda hiç hakim savci görmediniz herhalde ya da o meslek gruplarını eleştirmek korkutuyor.
  entry_channels: anket,sağlık
- entry_name: |
    recep niyaz
  entry_id:  94011907
  entry_writer: bu benim nickim degil
  entry_fav_count: 6
  entry_content: |
    16 ağustos 2019 denizlispor galatasaray maçında gol ya da asist beklediğim on numara
  entry_channels: spor
- entry_name: |
    galatasaray
  entry_id:  93975196
  entry_writer: madmadness
  entry_fav_count: 6
  entry_content: |
    ulan takımımın yaptığı transferleri öbürleri yapsa maç filan izlemem futbola küserim bu nasıl yıldız kadro kardeşim.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    misafirlikte düğün videolarının izletilmesi
  entry_id:  94017319
  entry_writer: semovet
  entry_fav_count: 4
  entry_content: |
    bu adet bizim mahallede bitti. şöyle ki hanımların uzaktan akrabamin evindeki gün toplantisinda diyorlar ki şu kizinizin düğün kasetini koyun da izleyelim. kadınlar bir türlü becerip videoyu açamıyor. diyorlar ki haydar abiyi çağıralım. aile reisi. kahramanimiz geliyor eve . videoyu calistirdiginda görüntü fena. bizim ki donup kalıyor. kendi ağzından şöyle anlatıyor. video bir açıldı, adam yarağı kadinin ağzına vermis. heyecandan kapatamamis videoyu. sonra herkes dumur. utanan da var kahkaha atan da. artik kimse bu olayı hatirlamamak için düğün videosu izleyelim teklifi yapmıyor
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    bu başlıkları gördükçe hep şeyi düşünüyorum;<br/>gerçekten tanımadığınız biriyle mi bira içmek istiyorsunuz?<br/>muhabbetini, huyunu suyunu bilmediğiniz, tek bir kelam etmediğiniz?<br/><br/>alkol keyif işi.<br/>tanımadığı birine hadi gel içelim demeyi neden ve nasıl göze alabilir bir insan hiç anlayamıyorum.<br/><br/>bunun tek açıklaması yalnız olmak olabilir. sadece bu koşulda çok anlaşılabilir ve gerçekten de üzücü.<br/>onun dışında hiçbir motivasyon göremiyorum bunun için.<br/><br/>samimi olmayan kişiler arasındaki diyalogta, boşluklar büyür ve kocaman olur.<br/>sürekli sohbet etmeye çalışmaktan yorulmaz mısınız? <br/>söyleyeceklerim bu kadardı.
  entry_channels: anket,ilişkiler,ekşi-sözlük,yeme-içme
- entry_name: |
    ankara çaylak ve yazar veritabanı
  entry_id:  94014323
  entry_writer: gokcesadik
  entry_fav_count: 2
  entry_content: |
    herkes "yerimi ayırttım" yazmış. noldu, .. göğe erdi mi? ordan daha net mi görünüyor?
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=metastaz">metastaz</a>)<br/>barış x (terkoglu ve pehlivan)
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    ekşi sözlük'ün en güzel başlıklarından biridir. başlık sahibi ve bir kaç yazarın çabası ile yaklaşık 3 aydır gündemde tutulması ve yazarların desteği gerçekten hayata karşı kaybolan umutların yeniden canlanmasını sağlıyor.<br/><br/>entry giren elleriniz dert görmesin suser'lar.
  entry_channels: sağlık,haber
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    evrimsel sürecin insanlığı getirdiği noktada varoluşu tartışabiliriz mesela, ya da sanatsal imgeler üzerinden insan doğasına hayal gücüyle yolculuk edebiliriz. bunların hiçbirisi olmazsa da goygoy yapar, güleriz. maksat hoş sohbet olsun. <br/><br/>çaylak ve yazarlar mesaj yeşili yakabilirsiniz. <br/><br/><a class="b" href="/?q=ps">ps</a>: <a rel="nofollow noopener" class="url" target="_blank" href="http://connected2.me/thegreghouse" title="http://connected2.me/thegreghouse">sözlük dışı iletişim linki</a>
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    gaziantep yazar ve çaylak veritabanı
  entry_id:  94017306
  entry_writer: midesi bulanan semazen
  entry_fav_count: 0
  entry_content: |
    gidilecek mekanda içinizde bir tane dahi bakın bir tane diyorum urfalı çıkarsa masayı yıkar çıkar giderim.
  entry_channels: ekşi-sözlük
- entry_name: |
    fatih terim
  entry_id:  94016118
  entry_writer: 8th wonder
  entry_fav_count: 0
  entry_content: |
    valla hocama saygım büyük lakin bu sene klasik terim inadı ile taraftara büyük çile çektirecek gibi.<br/><br/>seri’yi defanstan top çıkarsın diye oynatıp selçuk inan denen arkadaşı b2b oynatmaya çalışması, selçuk yerine seri’yi çıkartması falan resmen facia şeyler. <br/><br/>hep böyle oluyor ama, hoca ne zaman garip garip işler yapıyor bir şekilde o sezonu tamamlayamıyor. gidip geri geliyor o sezon iyi oynatıyor. maalesef yine synı döngüye girdik gibi.
