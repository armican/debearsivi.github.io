...
- entry_name: |
    güneşin bir sabah ansızın batıdan doğması
  entry_id:  73425197
...
- entry_name: |
  ...
  entry_fav_count: 42
  entry_content: |
    geçenlerde okuduğum yabancı bir blog yazısından birkaç parça yazmak istiyorum. ripple'ı daha iyi anlamanızı sağlamasını umuyorum. yazı bana ait değildir, sadece biraz özetle çevirisini yapıyorum.<br/><br/>ripple'ın atasından, yani ripplepay'den bahsedeceğim. biraz geriye gidelim. ripple'dan, hatta bitcoin'den de öncesine. ripplepay, 2004 yılında ryan fugger tarafından kurulmuş p2p (bkz: <a class="b" href="/?q=peer+to+peer">peer to peer</a>) bir ödeme ağı. hala site <a rel="nofollow noopener" class="url" target="_blank" href="https://classic.ripplepay.com/about/" title="https://classic.ripplepay.com/about/">burada</a> duruyor ve basitçe anlatmış sistemi.<br/><br/>özetle ripplepay, ağda bulunan insanların güvene dayalı bir sekilde birbiri arasında kredi takası yapmasını sağlıyor. bir kağıt parçasına "50 tl değerindedir" yazıp imzalamanın sanal hali gibi düşünün. eğer o kağıt parçasını yazan kişiye güveniyorsanız o zaman o kağıdın değeri 50 tl olur ve yine o kişiye güvenen başka birisine o kağıdı verdiğinizde, o da kağıdı 50 tl değerinde görür.<br/><br/>bankaların fiziksel olarak ellerinde bulunmayan dolaşımdaki parayla işlem yapmaları da bunun gibidir.<br/><br/>normalde, örnek olarak verdiğim bu "50 tl değerindedir" yazan kağıt parçalarını birbirine güvenen bireyler arasında değiş tokuş etmek, nakit ödemeler için bir metod tasarlamaktan çok daha kolaydır. nakit ödemelerde ise karşınızdakine güvenmeniz gerekmez, değeri olan bir eşyayı takas edersiniz. karşı tarafın sizi kazıklama riskini göze almak yerine, bireyler takas ettiği nesnenin değerine güvenir. altın veya para gibi.. (teknik olarak para da aslında örnekte bahsettiğim gibi bir kağıt parçası, sadece birey değil devlet tarafından imzalanmış)<br/><br/>bunu sanallaştırmak da çok benzer bir şekildedir. ripplepay, bir sanal para sisteminin, mesela bitcoinin, bir ödeme sistemi olarak kullanılmasına göre çok daha basit bir çözüm. öncelikle bir ödeme sisteminde iki kere harcama gibi bir sorununuz yok. bu şu demek, size bir "50 tl değerindedir" diye kağıt versem, başka birisine de "50 tl değerindedir" diye bir kağıt verebilirim. bu işlemi iki kere yapmam, 2 kişiye de borçlu olmam demektir. eğer bir sanal para biriminde, aynı parayı 2 kere harcayabilirsem bu sahtekarlık olur. bunun önüne geçmek için bir sürü güvenlik önlemi alınması gerekir.<br/><br/>bir ödeme ağında küresel bir mutabakata ihtiyaç yoktur. benim ali'ye ne kadar borcum olduğunu, mehmet'in bilmesine veya onaylamasına gerek yoktur. ali ve ben, ve mehmet ve ben, birbirimize ne kadar borçlu olduğumuz konusunda hemfikir olduğumuz sürece, yerel bir mutabakat oluşur ve tüm gereken de budur.<br/><br/>bir ödeme ağında gereken, bireyler arasında güvenin sağlanmasıdır.<br/><br/>sana güvenmeyen birine borç çıkartamazsın. bu yüzden her bir bireye ne kadar güvendiğine dair bir güven sınırı çizmen veya bir kredi limiti koyman gerekir. bu güven sınırları ağ boyunca "dalgalanabilir". ripple ingilizce "dalgalanmak" anlamına gelir. bu da şu demektir; "50 tl değerindedir" yazan kağıdı tanımadığınız kişiler ile de, ikinizin de güvendiği aracılar sayesinde paylaşabilirsiniz. yani ali ve mehmet bana güveniyorsa, ali benim ona verdiğim "50 tl değerindedir" yazan kağıdı mehmet'e ödeme yaparken kullanabilir.<br/><br/>güven gereksinimine rağmen bir ödeme ağında her zaman sahtekarlık riski de vardır. ben o kağıda "50 tl değerindedir" yazarken bana güvenmiş olabilirsin, ancak ya istediğinde o 50 tl'yi ödemezsem veya ödeyemezsem?<br/><br/>güven gerektirmeden, sahtekarlık riski olmadan, elektronik bir şekilde ödeme yapabilmek, ancak birkaç yıl sonra, satoshi nakamoto dünya'ya, bu eski soruna kendi çözümünü (bkz: <a class="b" href="/?q=bitcoin">bitcoin</a>) tanıttığında mümkün hale geldi. pow (bkz: <a class="b" href="/?q=proof+of+work">proof of work</a>) sistemini kullanarak, sahtekarlığa karşı aşırı dirençli, karşı tarafın sizi kazıklama riski olmayan, güven gerektirmeyen, saklanabilir veya değiş tokuş edilebilir bir sanal para sistemine ilk gerçek çözümü yarattı.<br/><br/>yani güvene dayalı bir ödeme ağı olan ripplepay ile, bitcoin gibi güven gerektirmeyen bir sanal para ağı, birbirini tamamlayan ancak birbirinden tamamiyle farklı iki şeydir. ripplepay, birbirine güvenen kullanıcılar arasında bitcoin tabanlı bir ödeme ağının oluşturup yönetilmesine çok basit bir şekilde izin verebilir.<br/><br/>"1 bitcoin değerindedir" yazan bir kağıt parçasının elektronik hali bitcoin sisteminin kendisinde imkansız olsa da işe yarayabilirdi.<br/><br/>bitcoin'den birkaç yıl sonra opencoin, sonraki adıyla ripple labs, ripplepay'i satın aldı. ödeme protokolünü tamamiyle elden geçirdi. konsept değişmedi, yine bahsettiğim bu sanal kağıt parçalarının yönetimini yapıyor, ancak bitcoinden ilham alarak. bir de xrp adında bir coin çıkarttılar.<br/><br/>xrp<br/>bir kağıt parçası şeklinde olmayan bu paranın sisteme eklenmesi, yukarıda bahsettiğim, aynı paranın iki kere harcanmasına karşı bir güvenlik önlemi gerekmesi anlamına geliyor. yani küresel bir mutabakat gerekiyordu. çünkü artık ağdaki herkes paranın transferi ve sahipliği konusunda aynı fikirde olmalıydı.<br/><br/>biraz önce bahsettiğimiz bu basit konsept, şimdi epey karmaşık bir hale büründü ve bitcoin'in daha yeni aşmayı başardığı sorunlar ile karşı karşıya kaldı.<br/><br/>ve emek olmadan yemek olmaz; bitcoin konsept olarak her ne kadar devrimsel nitelikte olsa da, küresel dağıtılmış bir mutabakata erişebilmek için kayda değer fedakarlıklar gerektiriyor. elektirik tüketen pow (bkz: <a class="b" href="/?q=bitcoin+madencili%c4%9fi">bitcoin madenciliği</a>), işlem sürelerinin yüksekliği (işlemin çok kez onaylanması gerekiyor), sınırlı genişleme alanı (bu zamana kadar yapılmış tüm işlemleri içeren tek bir blockchain).<br/><br/>bunlar dağınık bir ödeme ağında olmaması gereken sorunlar.<br/><br/>ripple bu zorlukların üstesinden bitcoin'den daha farklı şekilde geldi. pow kullanmak yerine, yeni ve henüz kendini kanıtlamamış bir mutabakat protokolü kullanıyor. bu protokol, kullanıcıların, bu mutabakatı sağlayan onay sunucularına güvenmelerini gerektiriyor. pow yerine güvene dayanması ripple için anlaşılabilir aslında. sonuçta "50 tl değerindedir" yazan kağıtların işe yaraması için benzer bir güven ilişkisi gerekiyor.<br/><br/>ancak bu da xrp'nin bitcoin ile kesinlikle benzer olmadığı anlamına geliyor. sadece pow'un matematiğine güvenmek yerine, xrp'ye güveninin sağlanması için oluşturman gereken güven çizgisi kaçınılmaz bir şekilde ripple'da bitiyor. eğer ripple senin sunucunu güvenilir sınırlarına dahil etmezse, mutabakat işleminin bir parçası olamıyorsun.<br/><br/>bu yüzden ripple yüksek derecede merkezleştirilmiştir. xrp ise, bitcoin gibi güven gerektirmeyen bir sistem yerine daha çok bir paypal hesabına benzer.<br/><br/>tamamiyle xrp coinin eklenmesiyle gelen küresel mutabakat protokolüne olan gereksinim, bir yandan da genişleme alanı ve güvenlik açısındam ciddi sonuçlar doğuruyor. eğer xrp, bu ödeme ağının çok daha karmaşık, merkezi ve genişleme alanı düşük olmasına yol açacaksa, o zaman akla şu soru geliyor. neden xrp coin eklendi ki? tek bir küresel mutabakat veya blockchain gerektirmeyen bu sayede istediği gibi genişleyebilecek asıl konseptin ne sorunu vardı? <br/><br/>bununla ilgili sav ise, coinin ağda yapılabilecek spama karşı bir önlem olduğu. bu da pek iyi bir sav değil. spam başka şekillerde de engellenebilir. mesela işlem ücreti eklenip, bu ücretin sadece xrp üzerinden değil, ağ içindeki herhangi bir para birimiyle ödenebilmesi sağlanabilirdi. diğer bir sav ise xrp'nin ağdaki likidite sağlayıcıları veya bankalar tarafından rezerv birim olarak kullanılacağı.<br/><br/>bu da pek olası gelmiyor. özellikle de xrp'nin yüksek inişli çıkışlı, dengesiz fiyatını da düşününce, likidite sağlayıcıları veya bankalar neden daha yaygın rezerv para birimlerini, örneğin amerikan dolarını kullanmasın? <br/><br/>yani kısacası, xrp'nin ripple protokolü üzerinde neden var olduğununa dair mantıklı bir sebep bulmak zor. ripple labs'in inanılmaz miktarlarda para kazanmasını sağlaması dışında. ripple açıldığında, 100 milyar xrp token üretti. adil dağıtım yapıldığına benzer bir izlenim bırakmak için milyarlarca xrp'yi ücretsiz dağıttılar.<br/><br/>ancak şirket, kurucuları ve onlarla ilişkili kurumlar hala 100 milyar xrp'nin 60 milyarını elinde bulunduruyor. <br/><br/>bu miktar herhangi bir yatırımcıya, xrp'ye yatırım yaparken tekrar düşündürmeli.<br/><br/>nedense internetteki bazı kaynaklar, örneğin coinmarketcap.com, bu 60 milyar xrp'nin varlığını görmezden gelerek toplam arzı saptırıyor. xrp'nin gerçek arzı 100 milyardır ve bu da xrp'yi etherium'un üzerine, iki numaraya getirir. hatta birkaç gün öncesine kadar bitcoin'in de üzerinde olduğu anlamına geliyor.<br/><br/>bu satoshi nakamoto'nun cüzdanında bulunan yaklaşık 1 milyon bitcoini, sırf dolaşımda olmadığı için ve hatta belki hiçbir zaman dolaşıma girmeyeceği için yok saymak gibi bir şey.<br/><br/>bu 60 milyar xrp dolaşıma elbet girecek. bunların bir miktarı smart contracts veya farklı şekillerde geçici olarak kilitlenmiş olsa da, sadece 38 milyar xrp olduğunu varsaymak için bir sebep yok.<br/><br/>peki belli bir amacı ve kullanım alanı olmayan bir coin için bu kadar yüksek bir değer mantıklı mı? <br/><br/>ripple'a yatırım yapanlar şimdi ripple'ın finansal kurumlar ile olan stratejik partnerliklerini ve birkaç deneysel uyarlamalardan bahsedecekler. 160 çalışanının olduğunu, bu yüzden büyük ihtimalle en büyük blockchain şirketi olduğunu söyleyecekler. ripple'ın, protokolünü swift gibi para transferi sistemine bir alternatif olarak göstererek, asıl hedeflediği market olan bankalar ile anlaşmalarda geçen astronomik rakamlardan bahsedecekler.<br/><br/>bunların bazıları kesinlikle kabul edilebilir. ripple üzerinde gerçekten iyi mühendisler çalışıyor. bu da şüphesiz gerçek dünya sorunlarını çözecek bir şeylerin çıkmasını sağlayacaktır.<br/><br/>ancak asıl hedefleri olan swift'in yerine geçmek konusunda;<br/>öncelikle pow yani küresel mutabakata dayalı bir protokolün bu konuda doğru bir yaklaşım olduğunu ve bu kadar büyük bir seviyeye genişleyebileceğini hiç sanmıyorum. <br/><br/>ayrıca, swift şu anda bankaların kontrolünde. bu kontrolü küçük bir şirkete bırakıp, kendilerini de bu şirketin özel para birimine muhtaç hale getirmeleri ne kadar olası? bankaların böyle bir ihtiyacı yok. yani bunun gerçekleşmesi de pek olası görünmüyor.
- entry_name: |
    türk gitaristler
  entry_id:  73429118
  entry_writer: erika
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    hemen tercihimi piç erkekten yana yapardım.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    geçen gece izleyip de 'meeeh!' dediğim video.<br/><br/>olayın çıkış noktası <a class="b" href="/?q=g%c3%bclden+ergen">gülden ergen</a>'dir, lakin videoda bahsi geçen vasıfsız kişilerden kasıt gülibiş değil. <a class="b" href="/?q=seda+sayan">seda sayan</a> gülibiş'i ilk konuk ettiği zaman (aklama programı diyelim) yeşo ağa durumu ağır bir şekilde eleştirmiş, seda sayan'ın güvenilirliğine zarar verdiğini, zaten gülibiş'li bölümün de reytinglerde çakıldığını, cesareti varsa programa kendisini de davet etmesini söylemiştir.<br/><br/>seda sayan'ın buna cevabı, ertesi gün şu meşhur <a class="b" href="/?q=hale+soygazi">hale soygazi</a>'nin oğlu olduğu iddia edilen herifin yanındaki tuhaf kılıklı bestekar vesilesiyle oldu. herifin adını hatırlamıyorum, araştırmak da içimden gelmiyor. hani şu ekrana ekrana 'eyyy hale soygazi... ' diye her dakika bağıra bağıra çemkiren, saçları kirpi gibi, yaşlı tip. işte ertesi gün seda sayan akıllılık edip bu herif vasıtasıyla yeşim salkım'a laf sokuyor. herif kameraya 'yeşim salkım sen bana soytarı demişsin ama senin evliliğin kağıt üstündeydi, sen maşasın' diye çemkiriyor. tabir bu lafları kendisi mi düşündüüü, yoksa orda borusu öten biri mi söylettiii, arif olan anlar. <br/><br/>işte yeşo ağa da buna celalleniyor videolarda. 'yanındaki vasıfsızları kullanarak bana laf etme, açık açık kendin söyle' demeye getiriyor.<br/><br/>eyyorlamam bu kadar.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=%c3%b6lmem+mi+beni+da%c5%9flara+vurun">ölmem mi beni daşlara vurun</a>)
- entry_name: |
