...
- entry_name: |
  ...
  entry_fav_count: 56
  entry_content: |
    giderin varsa elinden tutar öğretirler, canını sıkma.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
    balkanların en güzel kızları sırp kızlarıdır
  entry_id:  82814064
  entry_writer: o degil de neyse
  entry_fav_count: 41
  entry_content: |
    yalnızca vizesiz ülkeler görmüş fakir yazar iddiası.
  entry_channels: ilişkiler
- entry_name: |
    müslüm gürses
  entry_id:  82808347
  ...
  entry_channels: tv,tarih,müzik,sinema,magazin
- entry_name: |
    ekşi itiraf
  entry_id:  82802888
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    (bkz: <a class="b" href="/?q=boxer+donun+tangaya+d%c3%b6n%c3%bc%c5%9fmesi">boxer donun tangaya dönüşmesi</a>)
  entry_channels: anket,sağlık
- entry_name: |
    çaylak onay listesi
  entry_id:  82816380
  entry_writer: useniyo
  entry_fav_count: 7
  entry_content: |
    bir kaç saat evvel mailime düşen bu sevindirici haber ile buraya yazıyorum. ne kadar mutluyum anlatamam. yıllardır yazar olmayı bekliyordum ve oldum. insanın sevdiği şeyi yapması ne de güzel bir bilseniz. ilk başlarda fazla bir para vermiyorlar ama ileride bu katlanarak artacaktır. para için ekşide takılmıyorum zaten. her neyse, çok mutluyum. darısı diğer çaylakların başına.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=16x+aaa">16x aaa</a>)<br/><br/>18 senedir bilgisayar oyunu oynarım, 30 yaşındayım, 5000 lira maaş alıyorum, hala açamadım.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=49Kh1mS4Fhs" title="https://www.youtube.com/watch?v=49Kh1mS4Fhs">unutursak çayımız soğusun</a>
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    şeyh uçmaz murit uçurur lafı geldi aklıma. <br/>koltuk sevdalısı bir rektör lafı. koltukta kalmak için yemeyeceği bir şey yok sanırım
  entry_channels: siyaset,haber
---
