...
- entry_name: |
    ricardo quaresma
  entry_id:  84445744
  entry_writer: darthrainos
  entry_fav_count: 3
  entry_content: |
    seni haftaiçi yaptıklarına rağmen bu maça ilk 11 yazan hocanla birlikte siktir ol git.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    bundan 10.000 yıl önce ağaçtan meyve toplayan, geyik avlayan, toprağa yalınayak basan adamı plaza katlarında latte içip cheesecake yiyen, ofis dedikodusu yapıp birbirinin kuyusunu kazan, internet indiriminden aldığı pufidik terliği teslim almak için kargo bölümüne inmekten ve öğle arasında yaptığı yarım saatlik pilatesten başka hareketi olmayan bir yaratığa evirip sonra da adını modern koymandır problem..
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    golden önce firmino’nun yoktan taç kazandırması sonra taçtan topu alıp asistin asistini yapması da her şeyin istatistik olmadığının çok güzel bir örneğiydi.
  entry_channels: spor
---
