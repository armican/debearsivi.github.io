...
- entry_name: |
  ...
  entry_fav_count: 110
  entry_content: |
    hizmet ettiği toplum tarafından lince uğraması, taciz edilmesi, tehdit edilmesi, dövülmesi, öldürülmesi. <br/>saçma sapan şikayet ve davalarla mahkeme köşelerinde süründürülmesi. <br/>hükümet tarafından hedef gösterilmesi ve sahipsiz bırakılması.
...
- entry_name: |
  ...
  entry_id:  84443595
  entry_writer: cicikcikcim
  entry_fav_count: 87
  entry_content: |
    sınırlar.<br/><br/>kanıt diyemem ama bu teorinin bana mantıklı gelmesini sağlayan ışık hızı, mutlak sıfır, daha doğrusu termodinamik yasaları gibi belli başlı fizik kuralları. bu kuralların dışına çıkamıyor oluşumuz, çevremizde tanımlayamadığımız bir el tarafından bir sınır çizildiğini ve bu sınırın içerisinde yaşıyor hissine kapıldığımızı düşündürtüyor bana.<br/><br/>tıpkı bir araba yarışı oyunu gibi... oyunda sistemin bize izin verdiği hızı aşamayız. sistemin izin verdiği kazaları yapabiliriz ve yine sadece sistemin izin verdiği yönde gidebiliriz. oyundaki arabanın bundan haberi olmaz ve biz bulunduğumuz evrende o araba yarışı oyunundaki araba olabiliriz.
...
- entry_name: |
    dorukhan toköz
  entry_id:  84447271
  entry_writer: think freud
  entry_fav_count: 76
  entry_content: |
    iki defa ismiyle gol anonsu yapılmasına rağmen hiç gol atmadığı ortaya çıkan oyuncudur. umarım kariyeri bu şansla devam etmez. <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
  entry_channels: spor
- entry_name: |
    the protector (dizi)
  entry_id:  84420956
...
- entry_name: |
    dell vs lenovo vs monster vs asus vs hp
  entry_id:  84448566
  entry_writer: getherefast55
  entry_fav_count: 47
  entry_content: |
    amaca göre birbirinin eline verebilecek versustur. <br/><br/>oyun için monster. <br/>ısıtıcı, tost makinesi olarak hp. <br/>gündelik kullanım için lenovo ve dell<br/>gündeliğin biraz üzerinde verimli ve sağlam kullanım için ise asus. <br/><br/>modeller olmadan kıyaslamak sizce de malca değil mi? ha laptop markası olarak yüzeysel versus yapıyorsak ben oyumu monster a basıyorum.<br/><br/>edit : msi de listeye eklenerek monster ve asus ile üçlü karşılaştırma yapılması tarafımda tavsiye edilir.
...
- entry_name: |
  ...
  entry_fav_count: 44
  entry_content: |
    2-0, trabzonspor taraftarı: üüüç üüüüç üüüç<br/>2-2, beşiktaş taraftarı: üüüüç üüüç üüüüç<br/>gol iptal, trabzonspor taraftarı: üüüüç üüüüç üüüç <br/><br/>ahahahaha komedi gibi maç lan amk
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 36
  entry_content: |
    gelecek bir emirle bütün belediye çalışanları, gençlik kolları. <br/><br/>hiç şüphe yok ki o gün üsküdar'da başakşehir'in şampiyonluğunu kutlayanlar olacaktır.
  entry_channels: spor
- entry_name: |
    gardırop fuat
  entry_id:  84430308
  ...
  entry_fav_count: 34
  entry_content: |
    * kuvvetli bir parmakla hayattaki tüm sorunların çözülebildiğine inanmaktadır.<br/>* kanuna vurup kaçmıştır.<br/>* kanunu itip kaçmıştır.<br/>* kanunu ezip kaçmıştır.
  entry_channels: sinema
- entry_name: |
    kuşburnu çayın kuştan yapılıyor olması
  entry_id:  84434004
  entry_writer: bilmesendahaiyi
  entry_fav_count: 33
  entry_content: |
    <a class="b" href="/?q=mevlana+%c5%9fekeri">mevlana şekeri</a>’nin içinde mevlana olduğunu duyduğumda ben de çok şaşırmıştım.
  entry_channels: 
- entry_name: |
    halil umut meler
  entry_id:  84448680
  ...
  entry_fav_count: 28
  entry_content: |
    adriano’ya değil kırmızı sarı bile verememiş hakem. sorsan “maçı trabzonspor’a vermek için elinden geleni yapan hakem” derler.
  entry_channels: spor
- entry_name: |
    2018 ekonomik krizi
  entry_id:  84438896
...
- entry_name: |
  ...
  entry_fav_count: 28
  entry_content: |
    galatasaray ile başakşehir arası puan farkı 8. <br/>yorumlar: puan farkını koruduk.devre arası bir forvet bir santrafor sampiyonuz. en büyük aday biziz.<br/>fenerbahçe bugün kazandığında galatasarayla puan farkı 9.<br/>yorumlar: fener küme düşüyor. burdan kurtulursa tff, mhk, dıj güçler, merkel trump.<br/>ben bu başlığı okuyacak papermoon kevaşelerinin a.q.<br/>edit:besiktaş ve trabzon berabere kaldı. demekki tüm şampiyonluk adayı muhteşem takımlarla 9 puan kalma ihtimali var
  entry_channels: spor
- entry_name: |
    ziya selçuk'tan anne babalara pazar mesajı
  entry_id:  84447315
  entry_writer: saatin arkasindaki civi
  entry_fav_count: 20
  entry_content: |
    okuldan gelir gelmez önlüğünü çıkarıp çıraklığa gitmek zorunda olanlara demiyor neyse ki.
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    maaş ödeyemeyen takıma rafael, brahimi'yi falan alalım diyen var. kafalara gel.
  entry_channels: spor,tarih
- entry_name: |
    sevgilisini simit sarayı'na götüren fakir erkek
  entry_id:  84420148
  entry_writer: erdembayer
  entry_fav_count: 14
  entry_content: |
    boş troll denemeleri sayfa 223.
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    burada kötüleyenlerden kat ve kat bilgi seviyesi ve eğitim düzeyi kesinlikle iyi seviyelerde olan <a class="b" href="/?q=youtuber">youtuber</a>dır. insanların <a class="b" href="/?q=o%27cu">o'cu</a> <a class="b" href="/?q=bu%27cu">bu'cu</a> diye yargılamayı ne zaman bırakacaklarını önceden merak ederdim şimdi etmiyorum. çünkü insanlarda gelir ve eğitim seviyesi düşük oldukça, kendisinden farklı insanları eleştirme ve kötüleme durumları daha da yüksek oluyor. üzgünüm ama gerçek böyle. <br/><br/>kendisi her şeye rağmen istanbul üni'de hukuk bitirmiş, kendisine ait tr'de faaliyet gösteren ve thy gibi büyük şirketlere hizmet sunan kreatif tasarım şirketine sahip bir kişidir.<br/><br/>youtube'a ilk giriş hikayesini burada ki birçok kişi bilmez ama anlatayım. kendisi kendi çapında sosyal medyada ki kitlenin yaş, izleme, dinleme oran ve orantılarını öğrenmek gibi deneysel tasarım seçenekleriyle youtube'a dalıyor. daha sonrasında iş çığrından çıkıyor ve bir youtuber olmaktan ziyade, <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=0JrACHf1B7U" title="https://www.youtube.com/watch?v=0JrACHf1B7U">youtube creators for change</a> isimlerinden birisi oluyor.<br/><br/>ezcümle türkiye'de gelmiş geçmiş en başarılı, orijinal içerikleriyle fark yaratan bir <a class="b" href="/?q=youtuber">youtuber</a>'dır barış abi.
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    yalancılığa terbiyesizliğe gerek yok.<br/><br/>bu adam, veya aslında hiçbir futbolcu için, hiçbir beşiktaşlı hiçbir zaman "dünyanın en iyi futbolcusu, en teknik ortasahası" vs. dememiştir. bunlar maalesef sizin sözlerinizdir, hep sizin komplekslerinizden kaynaklanmıştır. havalimanındaki görüntüler ise beşiktaşlı değil türk taraftar gerçeğidir.<br/><br/>beşiktaş siz ne kadar ilginçseniz ancak o kadar ilginç bir camiadır. abuk sabuk şeyleri kendinizden kırpıp beşiktaş'a yamamayı bıraktığınız an daha saygın olabilirsiniz.
  entry_channels: spor
- entry_name: |
    ricardo quaresma
  entry_id:  84446119
  ...
  entry_fav_count: 10
  entry_content: |
    maçtaki en tehlikeli kontrata çıkıyoruz. televizyondan o acı ile görünüyor mu bilmiyorum ama stattan net 3 e 3 pozisyon. sağdan 2 adamımız yardiriyor, solda da bu lavuk teke tek. arkasındaki 10 metrelik paralelde sahanın her yerinde 3-4 beşiktaş oyuncusu sprintte.<br/><br/>topu gidip ada veriyor. bakın adamı geçmeyi deniyor, pas kovalıyor falan demiyorum. topu adama veriyor. ardından en az 4 oyuncumuz oyun dışı kalanların yarısı tersten kalıyor. <br/><br/>bu şerefsizin topu kaptırdığı adam önünde, savunma namına hiç bir yarrak yapmıyor. bunu gram abartmadan söylüyorum, maçtaki en önemli atagımız, 5 e 3 trabzon hücumuna dönüşüyor ve golü yiyoruz. <br/><br/>bakın her sporcu her çalım denemesinde başarılı olacak diye bir kaide yok. yalnız bir sporcu hiçbir katkısı olmayacak, inanılmaz risk içeren hareketi ancak gerizekalı ise yapar. ya da sikinde değildir takım skor şu bu.<br/><br/>bu adamda ikisinden de var.<br/><br/>bu adam yerine tolga zengin oynamasına, 10 kişi oynamamiza razıyım. bunu sinirden falan söylemiyorum, gerçekten beşiktaş bu hain yokken 10 kişi de daha iyidir.<br/><br/>ömrümde beşiktaş'ta oynayıp nefret ettiğim tek adamdır.<br/><br/>adam falan da değil amk. kendisinden 10 yaş küçük, hayatını futboldan kazanan gencecik bir oyuncuya, malmo maçında yaptığını yapan ne sporcu dur ne adamdır.<br/><br/>senin hırsını ayrı, seni savunanları ayrı, ayağının dışını ayrı sikeyim.
  entry_channels: spor
- entry_name: |
    karakolda bekleyen adama saldıran yılan
  entry_id:  84450467
  entry_writer: swordsman was here
  entry_fav_count: 9
  entry_content: |
    önce amerika sonrasında hindistan sandığım video. sonrasında tayland kuzeyi çıktı ya la.<br/>muhtemelen yılan çıyanın çok görüldüğü yerler ki hem eleman ne yapacağını iyi kötü biliyor, hem de çevredekiler doğal davranıyor. bizde olsaydı var ya bütün karakol hatim indirerek yüz metre rekorları kıraraktan kilometrelerce uzaklaşmış, polisler de yılanı mermi manyağı yapmıştı <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
  entry_channels: haber
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    shakiri'nin iyi bilardocu oldugunu gosteren mac.<br/>carpa carpa atti 2 golu ama liverpool sonuna kadar haketti.<br/>gol girisimi 35-4 falan<br/><br/>united'a ondan sonra gelen tum td'leri toplasan, sir ferguson'un sakizi etmez
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    oltayı attım, ama balık gelsin de istemiyorum. oltayı toplayıp eve gitmek de istemiyorum. asfaltın üstüne düşen sonbahar yaprağı gibi yerimi yadırgıyorum işte.
  entry_channels: anket,ekşi-sözlük
- entry_name: |
    eve kız atma taktikleri
  entry_id:  84449056
  entry_writer: amkya
  entry_fav_count: 6
  entry_content: |
    +çok güzel türk kahvesi yaparım<br/>-aa öylemi <br/>+evet öyle bi ara elimden icersin<br/>-tmm olur <br/>+ne zaman?<br/><br/>genelde sonucu olan taktik tabi kızın seni ne kadar arzuladigi ilede alakali..
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
