...
- entry_name: |
  ...
  entry_fav_count: 113
  entry_content: |
    avm'ler açık ama gitmeyin.<br/>berberler açık ama gitmeyin.<br/>kuaförler açık ama gitmeyin.<br/><br/>v.s.<br/><br/>nerenin açılıp açılamayacağı konusunda hiçbir yetkisi olmayan bakanın açıklamalarıdır.
...
- entry_name: |
    karadeniz'de yeşillikler içinde yaşamak
  entry_id:  107100008
  entry_writer: buracat
  entry_fav_count: 65
  entry_content: |
    huzur anlamına gelmez. huzurun komşunun kim olduğu kadardır.
