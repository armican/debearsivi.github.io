...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    şu motorla yapılmış bir açık dünya lord of the rings oyunu... yıllardır bekliyorum ama çıkmıyor, çıkmıyor, çıkmıyor...
  entry_channels: 
- entry_name: |
    sigaraya %17 zam
  entry_id:  107110359
...
- entry_name: |
  ...
  entry_id:  107108853
  entry_writer: dishte kalan maydonos
  entry_fav_count: 6
  entry_content: |
    virüsü, havadan atılan klor gazı ile sersemletip yerden bitme kuşburnu ve nar çiçeğinin krav magası ile püskürtmeyi hedefleyen dayı.<br/><br/>ben diyom.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    müşteri hizmetlerine bağlanamazsın. mesaj bile atamazsın. site müşteri hizmetleri ile iletişime geçeceğin sayfalarda donuyor.<br/><br/>yukarıda bir yazar n11 den aldım 1 hafta sonra iptal ettim buradan aldım demiş mesela. işte hepsiburada da bunu yapamazsınız, ürünü aldıysanız kargoya 2 hafta verilmese bile iptal edemiyorsun. ürün kapına gelecek ve iade edeceksin. saçma sapan sistemleri olan ve sorun yaşarsanız kesinlikle çözemeyen diğer siteler gibi sıradan bir alışveriş sitesi.<br/><br/>bu ülkede işini layıkıyla yapan insan bulmak zor.
...
- entry_name: |
    mng kargo
  entry_id:  107087362
  entry_writer: cello ogrenmek ne zor
  entry_fav_count: 1
  entry_content: |
    ankara aktarma diye gizemli bir yerleri var. kargo buraya geliyor ve epey bir bekleyerek tüm virüslerden arınıyor. siz nankörler bunu göremiyorsunuz. ankara aktarma büyük bir dezenfekte ortamı. hala anlayamadınız mı?
  entry_channels: ekonomi
- entry_name: |
    ebru adındaki kızların genelde güzel olması
  entry_id:  107099996
  entry_writer: mors non est finis
  entry_fav_count: 1
  entry_content: |
    tanıdığım 4 ebru'nun da güzel olması hasebiyle şahsen onayladığım tespittir.
  entry_channels: anket
- entry_name: |
