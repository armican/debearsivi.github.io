...
- entry_name: |
  ...
  entry_fav_count: 161
  entry_content: |
    fatih'in vakfiyesinde böyle bir beddua yok. isteyen tapu kadastro'ya sorabilir. internette de açıklayan pek çok site var zaten (<a rel="nofollow noopener" class="url" target="_blank" href="https://www.malumatfurus.org/fatih-sultan-mehmetin-ayasofya-vakfiyesi-efsanesine-kanan-kosemenler/" title="https://www.malumatfurus.org/fatih-sultan-mehmetin-ayasofya-vakfiyesi-efsanesine-kanan-kosemenler/">örnek1</a>). bu prof dr ahmet akgündüz denen eleman doktorasını dicle üniversitesi'nden almış, erzurum ilahiyat mezunuymuş, şu anda konya üniversitesi'nde profesörmüş. ülkedeki sikko okullar ve profesör diye ortada dolaşan üçkağıtçılar için ufak bir numune.
...
- entry_name: |
  ...
  entry_fav_count: 90
  entry_content: |
    çubuk dondurması 5 lira olan şeyin yarım kilosunu 10 liraya satarlar demek hesap bilmemektir cidden.
  entry_channels: yeme-içme
- entry_name: |
    4 mayıs 2019 israil'in anadolu ajansı'nı vurması
  entry_id:  89687302
  entry_writer: millikan
  entry_fav_count: 78
  entry_content: |
    tam vuramamışlar, %98,8'de kalmış.
  entry_channels: siyaset,haber
- entry_name: |
  ...
  entry_fav_count: 68
  entry_content: |
    donmadan yayın yapan şerefsizlerin linki varsa paylaşırsanız sevinirim şikayet etmem gerekiyor da. halbuki aylık 130 tl gibi cüzi bir miktarda beinsport varken, bu bir vatandaşlık görevidir.
...
- entry_name: |
  ...
  entry_fav_count: 66
  entry_content: |
    ağır fenerliyim ve bjk duruşu ve takımından kendimi uzak görürüm ama bugün beşiktaş’ın içinden geçiyor hakem. demek ki sosyal medyada her gün bizim hakkımızı yiyorlar diye ağlarsan kupanın sahibi olabilirsin.
  entry_channels: 
- entry_name: |
    burak yılmaz
  entry_id:  89699579
...
- entry_name: |
  ...
  entry_fav_count: 48
  entry_content: |
    çıkması halinde ak parti'nin seçimi daha büyük farkla kaybedeceği yanılgısında bulunan tatlısu muhaliflerini görmemizi sağlayan muhtemel karar. dün rte'nin açıktan mesajı vermesi sonrası ysk'nın aykırı bir karar verme ihtimali neredeyse yok gibi. bu seçim tekrar edilirse memlekette seçimle hiçbir şeyin değişme ihtimali kalmamış demektir. bu da türkiye'nin hızlı adımlarla şeriata giderken aştığı son ciddi kilometre taşı olacaktır. şeriat geldikten sonra da geridönüş hiç olmayacak sürekli bir kabusta yaşayacağız.
  entry_channels: siyaset
- entry_name: |
    5 mayıs 2019 jokerbet dolandırıcılığı
  entry_id:  89704258
  entry_writer: tecrubeli yargic
  entry_fav_count: 36
  entry_content: |
    bir adet haksız mağdur bulunduran başlıktır.<br/><br/>be kardeşim yasal olmayan ve hatta dolandırıcı olma ihtimalleri yüksek bir siteye para yatırıyorsun sonra da dolandırılıp ağlıyorsun.<br/><br/>size tavsiyem her hıyarım var diyene koşmayın.<br/><br/>edit: site parayı vermiş gençler bırakın nasıl olsa geri gelecek.
  entry_channels: 
- entry_name: |
    bülent yıldırım
  entry_id:  89713747
  ...
  entry_fav_count: 35
  entry_content: |
    operasyon başlamış. beşiktaş'a geçmiş olsun.bulent 20 dakikada gösterdi niyetini. <br/><br/>not:alikocspor
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    daha ilk seferden yemeğe davet edilmez. önce bir kahve içmeyi teklif et. eğer işler yolunda giderse ikinci sefer, 2-3 gün öncesinden olmak şartıyla, “şu gün/akşam için herhangi bir planın yoksa bir yerlerde bişeyler yiyelim mi?” dersin ve güzel bir restauranttan rezervasyon yaptırırsın. yer ile ilgili bilgi vermeyi unutmayın. kadınlar giyeceklerini gidecekleri yere göre seçerler. sakın yer konusunda sürpriz yapmayın. evinden alabileceğinizi söyleyin. fakat ısrarcı olmayın. benzer durum yemek sonrası eve bırakma olayı içinde geçerlidir. teklif edin, ısrarcı olmayın. emri vakiliklerden uzak durun.
  entry_channels: ilişkiler,yeme-içme
- entry_name: |
    şenol güneş
  entry_id:  89700731
...
- entry_name: |
  ...
  entry_id:  89710858
  entry_writer: gigidatome1122
  entry_fav_count: 7
  entry_content: |
    şükürler olsun küme düşmek üzere olan ilçe takımı.<br/><br/>bu tip taraftarsız takımlar yerine <a class="b" href="/?q=kar%c5%9f%c4%b1yaka">karşıyaka</a>, <a class="b" href="/?q=altay">altay</a>, <a class="b" href="/?q=sakaryaspor">sakaryaspor</a>, <a class="b" href="/?q=kocaelispor">kocaelispor</a>, <a class="b" href="/?q=adana+demirspor">adana demirspor</a> gibi muazzam kitlelere sahip ekipleri ligde görmek dileğiyle.
  entry_channels: spor
- entry_name: |
    caner erkin
  entry_id:  89715256
  ...
  entry_fav_count: 6
  entry_content: |
    kendi ayağından taca çıkan top sonrası atılan gole tac bizim diye yine en çok itiraz eden ağlakspor topçusu.
  entry_channels: spor
- entry_name: |
    farih terim'in bein sports'a verdiği ayar
  entry_id:  89712310
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    beni vatandaştan saymayan bir adet başkan içeren bir açıklama. o kadar da gelir vergimi falan da veriyorum iliğim kurudu, yerlere çöp atmam, şimdiye kadar suç kaydını bırak karakolun içini gormuslugum yok. tezi yazamasak da yüksek lisans falan yapıyorum. sokaktaki hayvanlardan birini evlat edindim, yardıma ihtiyaçları olanlara bütçemiz bazında yardım etmeye çalışırım. vandalizm yapmam. vergimi günü gününe öderim. en ufak bir pisliğim olmamistir devlet babaya şimdiye kadar.<br/>amerikalıların deyişiyle komunutiyle sıkı bağlarım var üzerime düşeni yapmaya çalışırım hep bir ucundan tutabiliyorsam.<br/><br/>yine de adamdan sayilmadik ya. ben daha ne yapayım. vatandaş sayılmak için ne yapmak gerekiyor biri bana anlatsın ben galiba bir şeyleri atlıyorum çünkü. ben devletin bana zaten vermesi gereken şeye para vermem diyip kimliğimi yeniletmedim hala ondan mı oluyor acaba ya? ondan mı benim fikrimi sormuyorlar hiç. kim bu 'the vatandas' da seçim yenilensin istiyormuş. oy pusulası basan matbaacı mi?
  entry_channels: siyaset,haber
- entry_name: |
    taç hırsızlığı
  entry_id:  89716592
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    benim, hatta geçen gün kız kardeşim bi huylandı. olm böyle şeyler deme dedi, la nolacak yakışıklı işte herif dedim. <br/>kızlar huylanıyormuş galiba tanıdığım insanların yanında diyecem artık.
  entry_channels: ilişkiler
- entry_name: |
    mbaye diagne
  entry_id:  89698827
  ...
  entry_fav_count: 0
  entry_content: |
    kesinlikle bu gece gol atacaktır. rakipte adam yiyen bir yamyam kılıklı biri varsa kesinlikle beşiktaş ondan gol yer. değişmez bir doğa kuralıdır bu.
  entry_channels: spor
---
