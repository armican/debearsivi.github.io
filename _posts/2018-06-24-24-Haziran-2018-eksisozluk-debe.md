...
- entry_name: |
    cansu akın
  entry_id:  78382456
  entry_writer: midigidi
  entry_fav_count: 62
  entry_content: |
    hala yapılmamışsa yapmak isterim.<br/><br/>(bkz: <a class="b" href="/?q=cansu+ak%c4%b1n+kim+amk%3f">cansu akın kim amk?</a>)
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    son zamanlarda gördüğüm çomarlıklardan biri. sanki bebek görmeye gelenler yüzünü görmüyor bebeğin. madem nazara inanıyorsun tamam saygı duyuyorum hiç atma o zaman instagram gibi yerlere. zaten böyle fotoğrafların amacı da bebeğin yanında poz vermek. "bak yeğenim bu da ben" ya da "bak ben doğurdum" "bak beraber yaptık"
  entry_channels: ilişkiler,teknoloji,moda,magazin
- entry_name: |
    timo werner
  entry_id:  78417086
  entry_writer: bilalalib
  entry_fav_count: 4
  entry_content: |
    getirin ordan bi augsburg timo şov yapacak.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    ben genelde kişiyi yediği yemekler üzerinden analiz ederek tanımaya çalışırım. misal; <br/><br/>ilgili şahıs sabah kahvaltısını poğaça, börek, meyve suyu ile yapıyorsa o insandan bir bok olmaz. çünkü kişinin kaliteli olabilmesi için önce kendisine saygısı olması gerekir. pastaneden çıkmayan bir insanın hayalleri de aynen hamur gibidir.<br/><br/>kolay kabarır, hızlı söner.
  entry_channels: anket,ilişkiler
- entry_name: |
