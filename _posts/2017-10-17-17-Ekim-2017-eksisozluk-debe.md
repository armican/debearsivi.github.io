...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    genelde benim gözlemlediğim kadarıyla sinirli yapıdaki insanların hapşırma biçimi.<br/><br/>bir rahatlama biçimi.
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  71422038
  entry_writer: schrodingerin kedisi12
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=cape+town">cape town</a>) (bkz: <a class="b" href="/?q=%c3%bcmit+burnu">ümit burnu</a>)
---
