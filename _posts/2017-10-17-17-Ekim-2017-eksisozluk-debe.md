...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    cm 2001'den beri oynadığım oyunun son serisi olacak olan oyun. sadece yazılara dayalı bir simülasyondan, görselliğin ve detayın arttığı günümüze kadar tüm serileri eksiksiz oynamışımdır. son dönem detayların artmasını ben birçok arkadaşın aksine beğeniyorum. sadece takımları sahaya sür, 3 oyuncu değiştir, transfer dönemi oyuncu al olmamalı bu oyun. çok daha fazlası olmalı bence. senin taktiğin 10 hafta sonra çözülebilmeli. senelerce aynı taktikle devam edip her sene şampiyon olunmamalı. bunun yanında antrenmanlar konusunda daha detaya inilmeli. onun harici seçenekler artırılmalı, basın toplantıları çok daha gerçekçi hale getirilmeli. saçma sapan sorular sorulmamalı. "çamışgezek spor" teknik direktörü bir oyuncuyu kiraya vermedim diye bana düşman olmamalı. ve basın toplantısında bu olay dünyanın gündemindeymiş havası yaratılmamalı. "o kim la?" tepkisi verdirtmemeli oynayana. mesela 4v0 yendiğim maç sonrası, "bu akşamki maçta çok zorlandığınız görüldü." gibisinden sorular sorulmamalı. şampiyonluğa doğru emin adımlarla ilerlerken, "küme düşmemeyi matematiksel olarak garantilediniz, nasıl hissediyorsunuz kendinizi?" diye gerizekalıca sorular sorulmamalı. sene içerisinde 3 maç iyi oynayan adamın götü başı ayrı oynamamalı. sözleşme yenilemek için kapıma gelmemeli. büyük bir takım oyuncumu istediğinde, yahut henüz ortada teklif bile yokken angut oyuncum "hoca bırak beni gideyim. bak beni yollamazsan isyan çıkartırım ha." diye dakika başı beni tehdit etmemeli. mesela 73636272 maçtır gol atamayan elin kazması, sırf bende daha önce oynamış, takımımın eski bir oyuncusu diye bende niyeti bozmamalı. anladık eski takımına karşı gol atması çok güzel ve duygulandırıcı bir olay tamam ama, bir değil iki değil, orta açma yeteneği sabri'den hallice olan adam bende 3 asist yapıyor. ulan allahsız sezon boyunca yapamadığın asisti bana mı sakladın? sadece günlük hayattaki sisteme yaklaştırsınlar kafi şu oyunu. macera aramak yerine olması gerektiği gibi bi oyun çıkarsınlar yeterli.
- entry_name: |
    monster notebook
  entry_id:  71419527
  entry_writer: 832
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    "dünya cennete çok benziyor aksi takdirde sen burada olmazdın."<br/>(<a class="b" href="/?q=murat+mente%c5%9f">murat menteş</a>- <a class="b" href="/?q=ruhi+m%c3%bccerret">ruhi mücerret</a>)
- entry_name: |
    hepsiburada.com
  entry_id:  71415195
  entry_writer: epir
  entry_fav_count: 5
  entry_content: |
    üstteki yazarın yazdığı iade süreci entrysi doğrudur. iade ettiğiniz ürünü hiç birşey yazmadan sms atmadan email göndermeden ya da kutunun içine bir yazı iliştirmeden geri yolluyorlar. ulan insafsızlar bari el yazısıyla bir not yazın.<br/><br/>telefon açıp öğreniyorsunuz beyefendilerin hangi sebeple iadeyi kabul etmediğini. <br/><br/>hepsiburada'dan aldığınız ürün bumerang gibi desek yeridir. ne kadar geri gönderirseniz gönderin size geri gelir.<br/><br/>tüketici hakem heyetine dilekçeyi verince o bumerangı müsait biryerlerine sokacağım az kaldı.
- entry_name: |
    cingöz recai
  entry_id:  71405215
...
- entry_name: |
  ...
  entry_id:  71403946
  entry_writer: bu nick turkce harf icermez
  entry_fav_count: 4
  entry_content: |
    hiç gitmemiştim, gideceğimi de hiç düşünmemiştim.<br/><br/>bir gün dedi ki "iş görüşmesine gittim. erzurum'da iş teklif ettiler. sanırım kabul edeceğim"<br/>"git" dedim, "senin için daha iyi olacaksa git. ben her koşulda yardımcı ve destek olurum sana"<br/>gitti, kendi ellerimle uçağa bindirdim bir sabah. o işlerini yoluna koyup bir düzen kurana kadar bir kaç hafta geçti. sonunda bir haftasonu atladım uçağa gittim. kaç haftadır görüşmemiştik, özlemiştik birbirimizi. <br/>kaç ay sürdü bu böyle. iki ya da üç haftada bir erzurum'a gittim onu görmeye. tüm hayat düzeni mi de buna göre yeniden kurdum. birlikte geçirdiğimiz o haftasonunun arkamda bıraktığım hayata olan etkilerini toparlamak yine iki haftamı alıyordu ama mutluyduk. hep aynı otelde kaldık, hep aynı şarabı içtik, hep odamızın penceresinin önünden geçen sessiz sokağı seyrederek tüttürdük sigaralarımızı.<br/>erzurum'u çekici kılan şey sendin benim için.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    yakışıklı erkek yalnız olmaz ortalama tipli erkeler yalnızdır
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    6s'im de canavar gibi çalışan ios sürümü. yazılan hiç bir hatayı almadım. şarj konusu bile aynı. ya cihazdan cihaza fark var ya yazarlarımız inanılmaz takıntılı. bilemedim.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=seattle">seattle</a>)
---
