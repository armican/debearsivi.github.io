...
- entry_name: |
    tevfik göksu'nun imamoğlu'na verdiği efsane ayar
  entry_id:  97690011
...
- entry_name: |
    birbirinden habersiz yedi kadınla evlenen adam
  entry_id:  97683841
  entry_writer: yedinci element
  entry_fav_count: 137
  entry_content: |
    kadınlardan habersiz bu işi yürütemez. kadınların böyle şeyleri anlamaması imkansız, hele resmi nikah da yoksa.<br/><br/>adam güçlüymüş ki kadınlar duruma boyun eğmişler. şimdi ise ayağı kaymış olmalı ki kadınlar baş kaldırmaya karar vermişler.
  entry_channels: ilişkiler,haber
- entry_name: |
    7/24 mesai talep edilen fantastik iş ilanı
  entry_id:  97694642
  entry_writer: elestiri
  entry_fav_count: 135
  entry_content: |
    "aile işletmesiyiz samimiyet aramktayız" <br/><br/>doğrusu "aile işletmesiyiz köle aramaktayız" olacaktı sanırım yanlış yazmışlar.
...
- entry_name: |
    evde balık pişirtmeyen kadın
  entry_id:  97686395
  entry_writer: pek bi gercekci hanim
  entry_fav_count: 19
  entry_content: |
    balik pisirirken, bir yandan da su ve sirke kaynatirsaniz ev kokmaz. birakin evi, pisirirken bile kokmaz. <br/><br/>ayrica taze baligi iyi temizlerseniz yine kokmaz.<br/><br/>sirke yok ise, balik pisirilen ocak uzerine bir dilim limon koyarsaniz yine kokmaz. limon yanıyor ama olsun. koku yok.<br/><br/>haftada 2 3 kere evde balik pisiren ve aslinda allahin her gunu balik olsa pisirecek ve yiyecek bir insan olarak soyluyorum bunlari.
...
- entry_name: |
    inek şaban vs recep ivedik
  entry_id:  97689689
  entry_writer: kovuldun co
  entry_fav_count: 18
  entry_content: |
    ikisi de alt tabakadan cikmistir tespitini cani gönülden kutluyorum.<br/><br/>buradan dönem karsilastirmasi yapabiliriz.<br/><br/>o donemin alt tabakasi ile bu donemin alt tabakasi arasindaki devasa "ahlak" farkindan.
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    hiç almadım ki hayatımda. yemin ederim aklıma bir şey gelmiyor.
  entry_channels: anket,ilişkiler
- entry_name: |
    bir chp'liye laf anlatmak
  entry_id:  97701811
  entry_writer: dood
  entry_fav_count: 1
  entry_content: |
    "ama yol yapti diyorum anlamiyor ya?! la bildigin yol ustunde yurudugun arabayla gittigin yolu yaptilar iste daha ne diyorum? yok anlatamiyorsun!"
  entry_channels: siyaset
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    hemsire ve doktor hatasi nedeniyle eximer laseri anestezik damlasiz oldum. sene 2005<br/>yani turkcesi, canli canli gozumun ag tabakasini kestiler. kendimi kasarken acidan parmaklarimi catlatmisim.<br/>bobrek tasinin agrisiyla kiyaslayamiyorum, cok sukur hic basima gelmedi. ama arkadasimin annesi, ki kendisi normal dogumla ikiz dogurmus bir sahis, bobrek agrisinin dogum agrisindan beter oldugunu soyler.<br/>laser epilasyon diyenlere acidim. bu hayatta hic bir sey yasamamissiniz gencler.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    1,70'den uzun kadın travesti gibi duruyor . üzgünüm ama durum bu . kadın dediğin narin, zarif olur. ayaklar 40 numara, eller kocaman kadın olmaz, olmamalı.
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    oral seksi aşağılanma olarak görenlerden misiniz? yoksa sizin için (karşılıklı) olması gereken midir cinsel hayatta?
