...
- entry_name: |
  ...
  entry_fav_count: 352
  entry_content: |
    bugün cebeci plajındaydım. adamlar kumun bittiği yerde sergiyi sermişler, semaveri yakmışlar, nargilelere seri köz getirmişler. camış gibi siki taşşağı yayıp oturuyorlar, onun bunun karısının arkasından resimlerini çekip kahkaha atıyorlar.<br/><br/>senin 20 sene el bebek gül bebek büyüttüğün evladın bu amına koyduğumun orospu evlatları yüzünden sınırda şehit oluyor. 3 vardiya ve cumartesileri dahil çalıştığın iş yerinin verdiği maaştan; marketteki, benzinlikteki, konfeksiyondaki bütün işlemlerinden alınan vergilerle bu onun bunun evlatları nemalanıyor. bu evveliyatını siktiğim arapları bir süre önce "kafa kesecem kafa" diyordu ya...<br/><br/>bu işten kurtulmanın tek yolu...... ne desem gg!<br/><br/>edit: yazdıklarım münferit olaylarmış. ben size bıraktım. küfür serbest...
  entry_channels: siyaset,anket
- entry_name: |
    sagopa kajmer
  entry_id:  93208765
...
- entry_name: |
  ...
  entry_channels: müzik
- entry_name: |
    1.90 üstü avarellerin kendini nimetten saymasi
  entry_id:  93227875
  entry_writer: son kullanici sozlesmesi
  entry_fav_count: 119
  entry_content: |
    (bkz: <a class="b" href="/?q=lan+ben+naptim+evde+oturmu%c5%9f+%c3%a7ay+i%c3%a7iyordum+amk">lan ben naptim evde oturmuş çay içiyordum amk</a>)
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: magazin
- entry_name: |
    geceye bir esnaf cümlesi bırak
  entry_id:  93205261
  entry_writer: cykacyka
  entry_fav_count: 100
  entry_content: |
    ''oraya park etmeyin, mal gelecek.''<br/><br/>sonra kendi park eder. metafor da yapıyor ibne.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    kendi kanından canından olanı, sırf iyi partili diye döven bir takım orul orul orospu çocuğu sözde milliyetçi ve ülkücü çakalı sahaya davet ediyorum. ama yok orrospu dölleri siz vatanınıza türk'e türklüğe, atatürk'e nefret kusan ve türk vatanını yok etmeye adeta and içmiş olanlara köpeklik yapmayı seçtiniz değil mi? sizin kanınızı sikeyim anasını siktiğimin şerefsizleri.<br/><br/>tanım: bir adet anasını siktiğimin meslekten ihraç edilmesi gereken hatta vatandaşlıktan çıkarılması gereken orospu çocuğu vatan haini içeren video.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    kız arkadaşımla o bölgeye gidiyorum ve gitmeye devam edeceğim. plajın önünden geçerken birkaç sefer kıyı kanununu öne sürüp girmeyi düşünmüştüm ama kız arkadaşımın yanında tatsızlık çıksın istemiyordum. tepkinin bu olacağı zaten ayan beyan ortada, en kötü polis çağırıp yasal hakkımı kullanırım diye düşünüyordum ki sevgili suser arkadaş benden önce davranıp boyunun ölçüsünü almış. <br/><br/>böyle düzenin, kanunsuzluğun, adaletsizliğin gerçekten allah cezasını versin.
  entry_channels: haber
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    alman mahkemeleri bu adamın götünden kan alır türkiye'de ise serbest kalır. olay bundan ibaret.
  entry_channels: haber
- entry_name: |
    şu anda çalan şarkı
  entry_id:  93212173
