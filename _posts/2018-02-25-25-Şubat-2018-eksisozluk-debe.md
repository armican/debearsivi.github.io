...
- entry_name: |
    2000'li yılların en kötü yılı
  entry_id:  74452331
  entry_writer: mukan
  entry_fav_count: 106
  entry_content: |
    (bkz: <a class="b" href="/?q=2002">2002</a>)
- entry_name: |
...
- entry_name: |
    çaylaklara mesaj yasağı kampanyası
  entry_id:  74467066
  entry_writer: chevron
  entry_fav_count: 10
  entry_content: |
    ayarlar seçeneğindeki mesajlar bölümünden bihaber olan ekşici isteği.<br/><br/>(bkz: <a class="b" href="/?q=kazan%c4%b1lm%c4%b1%c5%9f+hak+geri+verilmez">kazanılmış hak geri verilmez</a>)
- entry_name: |
    airdrop
  entry_id:  74448189
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    az önce survivor tarihinde ilk kez duyduğumuz bişi oldu<br/><br/>"hilmicem ağır kaldı"
- entry_name: |
    ekşi itiraf
  entry_id:  74446344
...
- entry_name: |
  ...
  entry_id:  74471379
  entry_writer: perplexity
  entry_fav_count: 3
  entry_content: |
    kaç yıl oldu roma imparatorluğunu halen yıkan olmadı. imparator nerva'nın seneye tacitus'u consul suffectus yapması bekleniyor.. <br/><br/>hz. isa yaşasaydı 96 yaşandı olacaktı..<br/><br/>4 sene sonra 3 basamaklı yıllara geçeceğiz..
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    gece soğukta part time çalıştığı barın altında 4 saat boyunca sırf çıkışta yağmura yakalanmasın diye beklemek. <br/><br/>ilk yaptığım ve asla unutamadığım şeylerin başında bu gelir sanırım.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    icocular, airdropçular, refçiler de iyice azdı. yeni entrylerin yarısından çoğu bunlarla dolu. balon ya da asrın icadı diye kavga edenleri bile özledim.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    girona'ya atılan 2. gol esnasında kale önünde yaptıklarını fifa'da amatör mod'ta oynarken yapamazsın. kelimeler kifayetsiz.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/Son8h3PpMaM" title="https://youtu.be/Son8h3PpMaM">aşk ne ustam, hayatın sırrı ne?</a>
- entry_name: |
