...
- entry_name: |
  ...
  entry_fav_count: 136
  entry_content: |
    (bkz: <a class="b" href="/?q=kanka+gel+imparatorluk+siki+yar%c4%b1%c5%9ft%c4%b1r%c4%b1yoruz">kanka gel imparatorluk siki yarıştırıyoruz</a>)
...
- entry_name: |
  ...
  entry_channels: oyun
- entry_name: |
    theresa may'in kezbanvari istifası
  entry_id:  90462840
  entry_writer: mare nubium
  entry_fav_count: 98
  entry_content: |
    ben olsam bu olayı bu başlıkla açtığım için utanırdım.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 32
  entry_content: |
    biraz daha damardan girmesi gereken açıklamadır. örneğin;<br/><br/>“bak beyim, sana iki çift lafım var. koskoca adamsın; paran var, pulun var, her şeyin var. binlerce kişi çalışıyor emrinde! <br/><br/>seeenn! büyük patron, milyarder, para babası, fabrikalar sahibi falan bey! sen mi büyüksün? hayır! ben büyüğüm ben; recep tayyip erdoğan! sen benim yanımda bir hiçsin, anlıyor musun; bir hiç! gözümde pul kadar değerin yok!”
...
- entry_name: |
  ...
  entry_id:  90450377
  entry_writer: polistenkosarakkacanzenci
  entry_fav_count: 5
  entry_content: |
    saçları sabah kafayı yiyen, sağa sola karışmış bir vaziyette uyanan insandır, her gün duş almak zorundadır. allah yardımcısı olsundur.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    fatih hoca sözleşmesi biten futbolcuları ilk 11 oynatıp maçı bir nebze hunger games'e çevirmiştir.
  entry_channels: spor
- entry_name: |
    şenol güneş
  entry_id:  90464705
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=rosamund+pike">rosamund pike</a>)
  entry_channels: 
---
