...
- entry_name: |
    playstation plus
  entry_id:  102852060
  entry_writer: weihenstephaner
  entry_fav_count: 82
  entry_content: |
    ps plus uluslararası yıllık üyelik bedeli 60 dolardır. (abd, avrupa) türkiye fiyatı ise gelen zamla birlikte 30 dolardan 40 dolara çıkartıldı.<br/><br/>japonlar yıllar boyunca türkler için yapabilecekleri tüm güzellikleri yaptılar. türk lirasının korkunç değer kaybı adamların problemi değil arkadaşlar. sitem edecekseniz damat beyle görüşeceksiniz. <br/><br/>bunca yıl türk kullanıcılar için yapılan indirimler için teşekkürler sony. bu saatten sonra sanki konsolu bırakma vakti geldi gibi...
  entry_channels: oyun,teknoloji
- entry_name: |
    1 mart 2020 ab'nin olağanüstü toplantıya çağırması
  entry_id:  102863711
  entry_writer: blackline
  entry_fav_count: 63
  entry_content: |
    sınırları kapat diye çağırmıştır bunlar. başka birşey beklemeyin.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 36
  entry_content: |
    kalk siktir git buradan orospu cocugu.ak troll değilmiş.kendisi her alanda başarısız bir siyasetcidir.sadece ---gandi yapmayı bilir.
  entry_channels: siyaset
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    devlet bahçeli'nin kılıçdaroğlu'na attığı bakış
  entry_id:  102865707
  entry_writer: sir vival
  entry_fav_count: 31
  entry_content: |
    yaşını ve genel durumunu düşünürsek "kim di lan bu" bakışı olabilir.
...
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    madem elimizde amerikan'nın 1995 yılından beri kullandığı gibi ileri bi teknoloji vardı. 40 yıldır neden dağdaki 3-5 pkk'lıyla başa çıkamadık?
  entry_channels: siyaset,teknoloji
- entry_name: |
    ütü yap deyince kalk kendin ütüle diyen kadın
  entry_id:  102857139
  entry_writer: xariw
  entry_fav_count: 19
  entry_content: |
    erkek: ütü yap!<br/>kadın: kalk kendin ütüle!<br/><br/>ve burda sorun kadının cevabında öyle mi?
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    msb ye yeni bakan hazirlaniyor....kamuoyu olusturuluyor.....burda dursun....
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    bir andaval demiş boş kaleye gol atmada en iyisi falan filan... abicim adamın işi bu gol atmak... golün güzelini çirkinini mi arıyoruz? güzel gol olunca +2 mi oluyor? kaybolun gidin fanatizminizde bogulun
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    bir orospu çocuğu temennisi ama orospu çocuğu olduğuna dair detaylar henüz elime ulaşmadı. gerekli talimatları alıp sadece böyle bir detay olduğunu söylemem ısmarlandı. <br/><br/>kaynak: <a class="b" href="/?q=lombak">lombak</a>
  entry_channels: siyaset
- entry_name: |
    devlet başkanı ali babacan olan ülke
  entry_id:  102857166
  entry_writer: karni kasinan bidon kafa
  entry_fav_count: 9
  entry_content: |
    siyasal islamin bir uzantısı olduğundan bugünden pek farklı olmayacak bir ülkedir. düşman götüne
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: siyaset,haber,havacılık
- entry_name: |
    suriye'nin fethi sonrası yapılacak ilk işler
  entry_id:  102864732
  entry_writer: kacarkenkovaladim
  entry_fav_count: 6
  entry_content: |
    surileri vatanına gönderip, suriye sınırından başlayarak 300 metre genişliğinde bir kanal yapmak ve bu kanalı sınırı takip ederek karadeniz ile birleştirmek. <br/>ada ülkesi olmak.
  entry_channels: siyaset,anket
- entry_name: |
    tsk vurdukça sözlükte esedcilerin ağlaması
  entry_id:  102866652
  entry_writer: kalbini sokup okyanusa atan adam
  entry_fav_count: 4
  entry_content: |
    kimsenin ağladığı yok. esedci diye birileri de yok.<br/><br/>esedci, aktrollerin bu türkiye'nin değil erdoğan rejiminin savaşıdır, oğullarına çürük raporu alanların oğulları değil, türk evlatları ölüyor,(evet gürcü-arap kırması melez çocuklar değil, türk evlatları ölüyor) türkiye suriye'de bir diktatör bozuntusunun hataları yüzünden orda diyenlere attıkları bir iftira.<br/><br/>esed'in de amk, esad'ın da amk. <br/><br/>birileri 36 şehitten sonra kahkaha atacak, türk evlatları niye orda diyene esadcı diyeceksin ha. anasını suriyelilere siktire siktire boynuzları arşa değen aktroller.. o boynuzlarını keser sobada yakar, odayı ısıtır, analarınızı oda sıcaklığında sikerim.<br/><br/>amk şehit sayısı fazla olsun da savaşı meşrulaştıralım diyen orospu doğurdukları sizi. orospu evlatları 36 şehit vermemizle ilgili başlıklara bir tane entry girmezler, gelmiş burda suriye'yi başlık açarak fethederler. <br/><br/>ordu bizim, asker bizim. sizin gibi arap artıkları tsk'yi sahiplenemez. destur çek lan orospu evladı türk askerinin adını ağzına alırken.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    kadını erkekten ayıran en temel özellik
  entry_id:  102865491
  entry_writer: otoyoldaki kedi cesedi
  entry_fav_count: 2
  entry_content: |
    seks ihtiyaçlarını kendi içlerinde çok başarılı bir şekilde absorbe etmeleri. aşırı özendiğim bi özellik bu şahsen. mis gibi.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    etiyopyada ortaya çıkan ve hastalığa yakalanan bireyin gözleri kanayarak ölmesine neden olan salgın hastalık<br/><br/>dünya sağlık örgütü bu varsayımsal hastalığı öncelikli hastalık konumuna getirdi
  entry_channels: sağlık
- entry_name: |
    affedilmesi en zor kişi
  entry_id:  102866430
  entry_writer: esrefsoon
  entry_fav_count: 2
  entry_content: |
    en zor kişi kimdir bilemem ama bir insanı zamanında sevdiyseniz ve o insanla bir şeyler paylaştıysanız bir sebebten ötrü yollarınız ayrılmış olsa da o kişiyi tekrar affedebilirisiniz biliyorum gerçekten zor. bazı şeyler çok gururunuza dokunuyor ama seveceğiniz ve paylaşacağınız şeyler sizin gururunuza dokunanlardan daha çok.
  entry_channels: anket,ilişkiler
- entry_name: |
    1 mart 2020 galatasaray'ın verilmeyen penaltısı
  entry_id:  102865476
  entry_writer: darwinin mi indirgenemez karmasikligi
  entry_fav_count: 2
  entry_content: |
    hakem art niyetli değil, bildiğiniz çöp. hakemin çöpü yani üzerinize alınmayın size karşı yaptığı bir hareket değil adamın hakemlik yetisi yok süper ligde görev verilmemesi gerekiyor.<br/><br/>not: kruse
  entry_channels: spor
- entry_name: |
    sevilen şarkının en vurucu cümlesi
  entry_id:  102866399
  entry_writer: nemesis10
  entry_fav_count: 1
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bağış yapan tüm arkadaşlara kendi adıma teşekkür ediyorum.<br/><br/>haydi sözlükçüler desteklerinizi bekliyoruz.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    if you are into the nerd talk, waiting for your message
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    hamileyken ayrı, çocuk doğduktan sonra ayrı görmemişlik partileri düzenlemesi, kız arkadaşlarının pırlantalarına, marka çantalarına, gittikleri tatil yerlerine özenip bir fazlasını istemesi, ağzını ayıra ayıra konuşması.
  entry_channels: anket,ilişkiler
- entry_name: |
    100.577
  entry_id:  102867816
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=t%c3%bcrkiye%27den+ayr%c4%b1lan+g%c3%b6%c3%a7men+say%c4%b1s%c4%b1">türkiye'den ayrılan göçmen sayısı</a>)
  entry_channels: siyaset,haber
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    2 cm kısa ama ekstra olarak anksiyete sahibi olan şahsım; bu nick’in ardındaki beyin olarak yazım faaliyetlerini sürdürmektedir.
  entry_channels: ilişkiler
- entry_name: |
    1 mart 2020 real madrid barcelona maçı
  entry_id:  102862616
  entry_writer: alobenvahit
  entry_fav_count: 0
  entry_content: |
    en son oynanan barcelona lig maçını s sport youtube kanalı üzerinden vermişti. şu maçı da verse messi izlesek yine olmaz mı?<br/>tanım:la liga lig maçı.
  entry_channels: spor
---
