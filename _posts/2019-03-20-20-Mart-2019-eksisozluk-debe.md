...
- entry_name: |
  ...
  entry_channels: ilişkiler,ekşi-sözlük,moda,ekonomi
- entry_name: |
  ...
  entry_fav_count: 146
  entry_content: |
    bir kere ağlamıştır ve bir daha kimse için ağlamayacaktır.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 138
  entry_content: |
    misal, siyasetcilerin bir bölümü binlerce koruma olmadan tuvalete bile gidemiyor, cünkü yaptiklari is bir pornocuya göre milyonlarca kat daha pistir.
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 134
  entry_content: |
    sen kendi ülkende papaza hesap soramadın.<br/>yürüde endamını görelim.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    teröristin otel ücretini hdp'nin ödemesi
  entry_id:  87912076
  entry_writer: outdoor
  entry_fav_count: 59
  entry_content: |
    kapatsanıza partiyi amk. 17 yıldır tek başınıza iktidarsınız. kapatın bitsin gitsin. ama olur mu? mağduriyet olmazsa olmazınız. <br/><br/>"cehape zihniyeti parti kapattı demokrasii eyy ühüüüü" deyip zırladınız o yüzden mi kapatamıyorsunuz. bu millet oslo görüşmelerini de, haburdaki mobil mahkemeleri de, megri megrileri de, türk bayrağıyla göndere çektiğiniz kürdistan bayrağını da unuttu. kapatın gitsin.
...
- entry_name: |
    lcw maymununun geri dönmesi
  entry_id:  87917971
  entry_writer: galapagosadasindaturubilinmeyensurungen
  entry_fav_count: 35
  entry_content: |
    maymunu dondururler de o donemki kaliteyi asla!
  entry_channels: moda
- entry_name: |
    türk kızlarının çoğunun akıl yoksunu olması
  entry_id:  87921051
  entry_writer: archery
  entry_fav_count: 34
  entry_content: |
    üstteki entry’den burnuma elmalı nargile kokusu geldi.<br/><br/>edit: ben de isterdim bir türk erkeği ile vladimir nobokov, g.g. marquez kitapları üzerine konuşmayı. 12 angry men’de en sevdiğim sahneden bahsetmeyi, popular science’ın önceki sayısı var mı sende diye sormayı ama bırakın biz türk kızlarını, bu özellikler türklerin %80inde olmadığı için cinsiyetçi davranmayı bırakması gereken bir yazarın beyanıdır.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 28
  entry_content: |
    fetö güdümlü, ağızlarından yalan eksik olmayan orospu çocuğu trollerin, yüzsüzce fetöcülükle itham ettiği, bu orospu çocuklarının yine ek mesai yapmasına sebep olan tertemiz adam.<br/><br/>tehditlere karşı da boyun eğmeyip, 2014'te çalınan hakkını alacaktır inşallah.<br/><br/>domuz sürüsü siz de hass siktirin gidin sümüklü terörist fethullah piçine hoca efendi çekip, türkçe olimpiyatlarına katılan, dağdaki teröriste gerilla diyip, vatan için ölen evlada "niye öldükleri belli değil ehi ehi" diye sırıtan gözlüklü şirine.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    bunun nesi komik yav? <br/><br/>kedi bildigin travma yaşiyor. belki bi erkek tarafindan saldiriya ugramistir ya da erkeklere bir sebeple kıl kapmiş. belki yavrusunu arakladi biri sahipsiz ayagina. bu da gordu vs. zavalli hayvan. <br/><br/>bi kisim hayvanseverin hayvanlarin sikintilarindan hoşlanmasini hep saçma buluyorum.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    altına gururla imzamı atarım:<br/><br/>(bkz: <a class="b" href="/entry/87878976">kandırılmak/#87878976</a>)
  entry_channels: anket
- entry_name: |
...
- entry_name: |
    iki turistin kötü kokuyorsunuz diye kovulması
  entry_id:  87909779
  entry_writer: 0 derece
  entry_fav_count: 2
  entry_content: |
    olmayacak iş değildir.<br/>sene 98 side kumköy'de resepsiyonist olarak çalışıyorum, bi gün müşteriler başka bir müşterinin kokusundan şikayetçi oldular, bu şikayetlerden sonra personel de cesaret bulup şikayetini belirtti, ilgili tur operatörü çağrıldı adamla konuşuldu nasıl yapalım vs diyerek, adam "ben çöpçüyüm hijyen alışkanlığım yok, 1-2 senede bir para biriktirip tatile çıkıyorum, beni rahat bırakın" gibisinden laflar etti, sonra bi yol bulundu ama naptılar hatırlamıyorum.
  entry_channels: haber,yeme-içme,seyahat
- entry_name: |
    erkek aldatıyorsa suçlu kadındır
  entry_id:  87922765
  entry_writer: whatcanwedo
  entry_fav_count: 2
  entry_content: |
    kadın aldatıyorsa suçlu erkektir. evinde mutluluğu bulamayan kadın dışarıda arar mutluluğu.
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    55 bin cekip 5.45 den 36 ay vade ile yaptigim eylem. 2 bin lira odeme cerez parasi. kazanc da cerez parasi. sirf hakliydim dememek icin yaptim bu cilginligi. ne zaman bir firsat kacirsam uzuluyorum. bu sefer kendimi avutacagim.<br/><br/>ytd.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    sanırım sözlükte 13.bölüm lucky 13 i beğenen bir tek ben varım.<br/><br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/>bu bölümde ayrımcılık ve fişleme yapılan taşıyıcı gemimizin aslında bu sıfatı hak etmediği anlatılıyor. bu mevzuya sosyoloji cercevesinde bakarsak sadece diğerlerinden farklı olan yada kötü bir geçmişi var diye birisine kötü gözle bakılmaması gerektiği anlatılıyor aslında. bölüm sonunda bize cesaret madalyası verildi derken pilot aslında bunu hak edenin uçağı olduğunu vurguluyor. ben bu tür yani makinelerinde ruhu vardır kanusundan çok hoşlandığım için benim kalbimi kazanmış gözüme birşey kacırmış bölümdür. <br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>taş gibi bölümdür ayrıca<br/><br/>not: black mirror izliyimmi gençler varmı böyle bir bölüm dizide.
  entry_channels: tv
- entry_name: |
    ekşi sözlük dışarı çıkmalık arkadaş veritabanı
  entry_id:  87924273
  entry_writer: john rooney
  entry_fav_count: 0
  entry_content: |
    olm neden hep hanımlar lan?
  entry_channels: anket,ilişkiler,ekşi-sözlük
---
