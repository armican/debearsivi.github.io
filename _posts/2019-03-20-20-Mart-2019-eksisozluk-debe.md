...
- entry_name: |
    dolmuşçuların marmaray nedenli eylem yapması
  entry_id:  87905685
  entry_writer: antisosyalpsikopatgorunumludonjuan
  entry_fav_count: 116
  entry_content: |
    zamanında istanbul’da katip ve müderrisler de matbaaya karşı çıkmıştı. normaldir.
...
- entry_name: |
  ...
  entry_fav_count: 79
  entry_content: |
    bizim caddenin karşısında bir kedi duvarın üstünü mekan tutmuş. kendini gelene geçene sevdiriyor.<br/><br/>kızım mecbur muyuz seni sevmeye ? bizim canımız vahşetli, dehşetli, kavgalı, küfürlü şeyler istiyor. eyyyy kedi ! sen kimsin yaw ?
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 39
  entry_content: |
    bak hele at yarrağına bak uzun zamandır yazmıyormuş tespit sıçmaya gelmiş. adamın 9 tane euroleague kupası var. euroleague'in kalbinin attığı toplantı odasının adı zeljko obradovic ama bu at penisi gelip burada obradovic hakkında atıp tutabiliyor.<br/><br/>hayat çok acayip gerçekten kuşlar falan.
  entry_channels: spor
- entry_name: |
    no ceiling'in tutuklanması
  entry_id:  87924448
  entry_writer: mithradates pontus sovalyesi
  entry_fav_count: 36
  entry_content: |
    alevilerden şehit olmaz diyenin, atatürk’ün annesine o..pu diyenin tutuklanmayıp gününü gün ettiği ülkede ikinci paketleme vakası. <br/><br/>edit: ata’ya “ayyaş” diyen, balkan göçmeni türklere “ahlaksız” diyen şerefsizi unutmuşum. anladınız siz onu.
...
- entry_name: |
    hocam mı öğretmenim mi sorunsalı
  entry_id:  87911654
  entry_writer: nickicem ama
  entry_fav_count: 5
  entry_content: |
    (<a class="b" href="/entry/80567747">#80567747</a>)
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    yeni zelanda'daki orospu çocuğunun imkanı vardı 50 kişiyi öldürdü. bu orospu çocuğunun imkanı yok entry girdi. düşünce özgürlüğü değil bu, bir düşüncesi de yok entryi okumak yeter. ölen masum insanın dini, ırkı olmaz. fransa'da işid, insanları kamyonla ezdiğinde burada zevkten boşalan ibnelerden bunun bir farkı yok. kimin hangi tarafın insanı olduğunun önemi yok. empati yoksunu beş para etmez yavşak. bu yazdığımın linç kültürüyle alakası yok ayrıca.
...
- entry_name: |
    tunç soyer'in adam akıllı bir seçim vaadi olmaması
  entry_id:  87915076
  entry_writer: muhendis kizan
  entry_fav_count: 1
  entry_content: |
    chp belediyeciligi o kadar eleştiriliyor da sorsan hangi ilde yaşamak istersin diye ankara, ıstanbul, ızmir, bursa arasından hangisini seçer acaba? akp belediyeleri hükümet desteğine rağmen izmir, eskişehir standartına gelemedi? hadi buyuksehirleri geçtim gel ankarada pursaklar mi çankaya mi? esenler mi bakırköy mu? herkes ezbere konuşuyor. chp belediyeciligi çok kötü de sanki akp belediyeleri belediyecilikte devrim yaptı. <br/>ayrıca ızmir ve eskisehirde, daha geçen yıllarda belediyeye operasyonlar yapıldı, belediye binaları vs. arandı. hangi akp belediyesine yapıldı? fetönün yolsuzluk operasyonu yaptığı zamanlarda bile hiç birine dokunulmadı. bu hallerde bence iyi bile hizmet ediyor adamlar. siz önce ulkeden gitmesi gerekeni gönderin, yerine gelene ayarı sonra da verirsiniz? yola girmezse onu da gönderirsiniz.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    abd, kanada, ingiltere ve çoğu avrupa ülkesinde çıkacakmış, türkiye yok. zaten bu rezil internet hızlarıyla hayaldi, şimdi tam hayal oldu.
  entry_channels: oyun
- entry_name: |
    pendik'te köpeklerin iç organlarını yiyen kadın
  entry_id:  87926275
  entry_writer: eredgorgoroth
  entry_fav_count: 1
  entry_content: |
    bence büyü, muska işlerine girmiş bir ruh hastasıdır. akli dengesi yerinde değilse kapatılsın, akli dengesi yerindeyse de kapatılsın.
  entry_channels: haber
- entry_name: |
    öcalan siyasi figür oldu
  entry_id:  87925647
  entry_writer: geri donen mektup
  entry_fav_count: 1
  entry_content: |
    ak toto$lar nerdesiniz lan????<br/>serefini siktigimin parali itlerinin ugramadigi baslik.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    yine trolleri pr’a toplanmış. ben yüzleşme’yi övmeye değil gömmeye geldim.hiç şu masal isimli kızda bize gösterilen trajediyi yaşamış bir hal var mı? ulan kişiliğini gizliyon bu ana baba senin acından kanser olup gitse ne olacak? gerçek hayat böyle dizilere benzemez. yüzünde çişi gelmiş kız çocuğu ifadesiyle dolaşıp duruyor. böyle baş karakter olmaz. geçen bu işleri. sonra niye reyting almiir?
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    dosdoğru olmak insan fıtratı değildir;<br/>zira hatasız kul olmaz;<br/>gerçeklerin peşinden koşmak akıl karı değildir;<br/>zira dünya yalansız olmaz;
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    çocukken en çok sevilen çizgi film
  entry_id:  87918025
  entry_writer: sanitarium welcome home
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=tenten">tenten</a>)
  entry_channels: anket,tv
- entry_name: |
    arabayı güneşe doğru sürerken dinlenecek şarkılar
  entry_id:  87919372
  entry_writer: kabetaslayansatanist
  entry_fav_count: 0
  entry_content: |
    'trafikte cezayı kol gibi geçirmişler nazlı yare' (slow)<br/>orçun kunek
