...
- entry_name: |
    genç kız gibi görünmeye çalışan kadınlar
  entry_id:  74287772
  entry_writer: ay hatun
  entry_fav_count: 93
  entry_content: |
    her yaşta her koşulda paşa gönlü nasıl istiyorsa öyle görünen (görünmeye çalışan degil) kadınlardır. ister yirmi yaşında kırk gibi giyinir. isterse kırk yaşında yirmi gibi giyinir. <br/>hem topkapı sarayını gezmeye gelen yetmiş yaşındaki caroline teyzenin jean pantolonuna bakıp 'yaw adamlar hayatın tadını nasıl çıkarıyor, ruhları genç bunların, ben de böyle yaşlanmak istiyorum' deriz hem de etrafımızda gördüğümüz örnekleri eleştiririz.
- entry_name: |
    cengiz ünder
  entry_id:  74292840
...
- entry_name: |
    recep tayyip erdoğan'ın soy ağacı
  entry_id:  74287674
  entry_writer: tarzanbaba
  entry_fav_count: 66
  entry_content: |
    herkesin rahatlıkla ulaşabileceği, yerli ve milli soydur. <br/><br/>dosyası üniversite diplomasının yanında durmaktadır, isteyen gidip görebilir.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 47
  entry_content: |
    çocuklarınıza aşağıdaki güvenlik kurallarını mutlaka öğretin.<br/><br/>* yalnız yerler güvenli değil. ben hep arkadaşlarımla oynarım.<br/>* tanımadığım kişilerden şeker, hediye asla almam.<br/>* ailemden izinsiz kimsenin arabasına binmem.<br/>* kendi adımı, annemin, babamın adını bilirim. telefon numaralarımızla adresimizi de bilirim.<br/>* su birikintisine, kuyu nehir veya denize yanımda yetişkin olmadan yaklaşmam ve girmem.<br/>* istemediğim şeylere hemen “<a class="b" href="/?q=hayir">hayir</a>” derim. <br/>* tedirginsem, hemen oradan uzaklaşırım, kaçarım!<br/>* biri bana dokunduğunda kötü hissedersem, ''hayır, bana dokunma'' derim. bu benim en doğal hakkım.<br/>* sesim alarmımdır benim. tedirginsem, korkarsam hemen bağırırım. asla çekinmem!<br/>* başkalarıyla konuştuklarımı aileme de söylerim.<br/>* bir yere gitmeden önce aileme sorarım/haber veririm.<br/>* korkarsam, kötü hissedersem hemen birine söylerim.<br/>* büyük biri benden yardım isterse, yardım etmeden ailemden izin alırım.<br/><br/>evlatlarınıza susmamaları gerektiğini <a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/YD-HaiksC0I" title="https://youtu.be/YD-HaiksC0I">öğretin!</a>
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 34
  entry_content: |
    demek ki neymiş, o vücutlar filtre ile tutup inceltmeler ile olmuyormuş.<br/><br/>öyle vücudu olan herkese duyulması gereken saygıyı ispatlayan disiplininin meyvesini almış kadındır.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    harika bir gol attı az önce. hem pozisyonu hazırladı, hem de çok klas bitirdi. durdurulamıyor adam geldiği günden bu yana, iyice alex'e bağladı. <br/><br/>edit: şimdi de aatif'a verdiği muazzam pas ile ikinci golü yoktan var etti. daha dakika 26. <br/><br/>edit: ikinci golünü de atmıştır 60. dakika itibariyle.<br/><br/>tanım: ligin standartlarının 45 kat falan üstünde olan brezilya milli takımı oyuncusu.
- entry_name: |
...
- entry_name: |
    asosyal olduğunu zanneden başarısız insan
  entry_id:  74291997
  entry_writer: angry engineer
  entry_fav_count: 6
  entry_content: |
    kendi içinde ancak bu kadar gerzekalı bu yorum olabilir
- entry_name: |
    uber
  entry_id:  74287219
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    biraz yukarıda <a class="b" href="/?q=efsane+alevi+duyarlar%c4%b1">efsane alevi duyarları</a>ndan birine konu olmuş dizi. konjo süpersin beğenerek izliyoruz.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    izledim. <br/><br/>1- kıvanç tatlıtuğ'un performans filmi olmuş. her yeni işinde söylerim; üstüne koyarak ilerliyor oyunculukta. hafif şiveli, kasabalı genç bir balıkçı gibi balıkçı olmuş. oğluyla iletişim kurarken yaşadığı dramı, çaresizliği ve umudu beraber izleyiciye de yaşatıyor. öncelikle kıvanç tatlıtuğ için izlenir bu film. <br/><br/>2- çocuk! filmde bir sessizliğin içindeki çocuğuyla iletişim kurmaya çalışan balıkçı ali için üzüleceksiniz. çocuk efe o kadar iyi ki, bu kadar iyi olmasa büyüsü bozulurmuş filmin. o güzel çocuk için de izlenir film. <br/><br/>3- kaş görüntüleri mükemmel! ben arkadaş övgülerinden biliyordum kaş'ı ama antalya'ya sık gitmeme rağmen daha göremedim. filmde drone desteğiyle o kadar güzel görüntüler var ki! kaş'a da, tatil kasabası havasına da doyduk, üstüne bir yazı özledik. <br/><br/>müzikler de iyiydi ama pek anlamam bilenler yazar. ne de olda feridun düzağaç var ama film müziklerinde katkısı var mı bilmiyorum.
- entry_name: |
    bilgisayar toplayacaklara tavsiyeler
  entry_id:  74290429
  entry_writer: allmaringit
  entry_fav_count: 2
  entry_content: |
    world of warcraft çalıştıran bir konsol bulun da toplamayalım. oyun dediğin şeye sadece pes gözüyle bakanların verdiği tavsiyelerdir.
- entry_name: |
    78 yaşındaki insanı dövmek
  entry_id:  74294803
  entry_writer: soguktu ve yagmur ciseliyordu
  entry_fav_count: 2
  entry_content: |
    hukuk kurallarının değil, orman kanunlarının geçerli olduğu bir ülkede şaşırtmayandır.<br/><br/>amcanın gözyaşları kalbimi acıttı.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    tinercilerin şimdiden bahaneleri ürettiği maçtır.<br/><br/>yok aykut ağlamış da o yüzden tinerpsor feneri yenemeyecekmiş. ağlamasa tinerspor rahat kazanırmış. <br/><br/>tinerspor da forvet yok, orta saha zaten hiç yok, bir defansta pepe vardı o da haftaya yok.<br/><br/>fener bunları bu halde yakaladı mı mümkünatı yok parçalamadan bırakmaz.<br/><br/>tarihi fark geliceğini fark etmis durumdalar. ciyaklamaları ondan. <br/><br/>şimdiden gelecek hezimeti saçma bahanelerle yumuşatma derdindeler. aksi takdirde fikfik çok zor durumda kalacak.
- entry_name: |
    son zamanlarda izlenen en iyi film
  entry_id:  74279434
  entry_writer: jason mraz
  entry_fav_count: 0
  entry_content: |
    <a class="b" href="/?q=office+space">office space</a>
---
