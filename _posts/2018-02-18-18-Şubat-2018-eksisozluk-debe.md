...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    gece 11 yenibosna metrobüs üst geçidi gibi başlık. orada da herkes para istiyor, buranın linksizi.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    (bkz: <a class="b" href="/?q=cinemaximum">cinemaximum</a>) 'un vizyondaki filmler bölümünde "komedi" olarak sınıflandırdığı film...<br/><br/>farklı bir filmdi amenna, ama bildiğin dramdı ya.<br/><br/>izlenir mi, izlenir, <br/>ama komedi izleme niyetiyle gidecekseniz gitmeyin...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    “doktor mühendis cerrah mimar programcı” falan gibi en çok kafa patlatılan işler diyen mal süzgeci sözelcileri görmemizi sağlamış başlık. daha ülkedeki gişe sistemini kaldırıp insanları otomat makinelerinden para çekmeye, otobüs kartına para yüklemeye alıştıramadık. 80 yaşındaki nine de, 18 yaşındaki üniversite öğrencisi de sıra numarası alıp vezneden yatırıyor kira/harç parasını. siz neyin ele geçirmesinden bahsediyorsunuz?
- entry_name: |
...
- entry_name: |
    insanın ulaşamayacağı yerin kaşınması
  entry_id:  74294222
  entry_writer: iskemle ile kupe cicegi
  entry_fav_count: 1
  entry_content: |
    aklıma friends'in şu sahnesini getirmiştir. <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=ukVW8sELZQg" title="https://www.youtube.com/watch?v=ukVW8sELZQg">link</a>
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    düşünmek dahi istemiyorum!<br/><br/>edit: gerçi kendimi sıkıp düşünmeye çalıştım ama zaten başaramayacakmışım<br/><br/>not: gs uefa kupası'nı kaldırıldığı gece sabaha kadar tur atan bir fenerbahçeli
- entry_name: |
