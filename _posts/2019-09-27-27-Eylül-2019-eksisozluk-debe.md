...
- entry_name: |
  ...
  entry_channels: haber
- entry_name: |
    ahmet ercanlar'ın deprem sonrası attığı tweet
  entry_id:  95834138
  entry_writer: roneil
  entry_fav_count: 14
  entry_content: |
    tipik hayatta futboldan büyük derdi olmayan yurdum malı beyanı. kimdir hangi takımlıdır bilmiyorum ama sporunun amına koyayim, istanbul yıkılsa pet sişeden top yapıp maç yapmaya devam eder bunlar.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  95838726
  entry_writer: hulagukhan
  entry_fav_count: 3
  entry_content: |
    ziyadin çakır, mehmet sinan özeren ve celal şengör ile birlikte ekrem imamoğlu'nun da konuk olacağı, takip edilmesi gereken bir yayındır.<br/><br/>başlama saati 21:00'dir.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    evde izleyip izlememe arasında gitgel yaşadığım program. önceliğim eşim kendisi 99 depremini yakından yaşamış biri ve bu yüzden ekstradan tedirgin olmaması gerek bir yandan da konuyla alakalı bilgilenip alabileceğim önlem varsa almam gerekiyor sanırım evin bir köşesine sinip gizliden gizliye kulaklık takılı bir şekilde telefondan takip edeceğim.
  entry_channels: 
---
