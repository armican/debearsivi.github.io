...
- entry_name: |
  ...
  entry_channels: haber
- entry_name: |
    türk telekom'un deprem bahanesiyle sabote edilmesi
  entry_id:  95841110
  entry_writer: bi is bulayim hepsini ayarlicam
  entry_fav_count: 24
  entry_content: |
    evlere 3-4 mbit üstü upload hızı vermekten aciz altyapıya sahip türk telekom'u kimsenin sabote etmesine gerek yok.
  entry_channels: 
- entry_name: |
    mucize doktor
  entry_id:  95839990
...
- entry_name: |
  ...
  entry_id:  95807420
  entry_writer: zemberekusu
  entry_fav_count: 1
  entry_content: |
    acil şifalar diliyorum. iyileşmeyi bekleyen tüm hastalara..
