...
- entry_name: |
  ...
  entry_fav_count: 75
  entry_content: |
    celal hoca mustafa diye birini belediyeye sokmaya çalışıyor an itibariyle.
...
- entry_name: |
  ...
  entry_fav_count: 28
  entry_content: |
    (bkz: <a class="b" href="/?q=deprem+profes%c3%b6r%c3%bc">deprem profesörü</a>)<br/><br/>- öncü mü hocam?<br/>- bilmiyoruz<br/>- artçı mı hocam?<br/>- bilmiyoruz<br/>- büyük istanbul depremini tetikler mi hocam?<br/>- bilmiyoruz<br/><br/>işleri zor bilinmezlikler içinde.. adamlara 10 senede bir iş düşüyor.. onda da bişi bilmiyolar.. buna sinir mi dayanır..
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    cevabı için offshore bankalardaki muhtelif hesaplara bakılması gereken soru.<br/><br/>haram zıkkım olsun, biz soramazsak allah soracak hesabını, hiç merak etmeyin.
  entry_channels: siyaset,haber
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    toplanma alani toplanip bekleme, halay cekme, piknik yapma yeri anlamina gelmiyor. hos piknik yapacak olsan bile su ve elektrige ihtiyacin var. toplanma yerinden kasit, uzerine konteyner ve cadir kurulabilen, elektrigi, suyu, kanalizasyonu olan insanlarin konaklayabilecegi yer demek. kelimenin gercek anlamiyla istanbulda bulunan toplanma yeri sayisi kac adettir bilen varsa yazsin bir zahmet.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    yeni haberim oldu. acil sifalar dilerim.
  entry_channels: sağlık,haber
- entry_name: |
    ekşi sözlük dertleşecek insan veritabanı
  entry_id:  95809050
  entry_writer: forgosin
  entry_fav_count: 0
  entry_content: |
    ankara'dan dahil olduğum veritabanı. 30+ kadınlar yeşillendirebilir. no ergen.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    çok zengin olup, çok sağlam, bahçeli müsatakil bir evde oturmaktır. <br/><br/>olgunluk değildir o. olsa duramazsın zira.
  entry_channels: anket
---
