...
data:
- entry_name: |
    26 eylül 2019 gsm operatörlerinde hatların çökmesi
  entry_id:  95826134
...
- entry_name: |
  ...
  entry_channels: haber
- entry_name: |
    27 eylül 2019 büyük bir deprem olacak iddiası
  entry_id:  95841595
  entry_writer: quis custodiet ipsos custodes
  entry_fav_count: 320
  entry_content: |
    ya kardeşim deli misiniz. panik yapılmaması için söylenmemesi ne demek? insanlar uykularında ölsün mü istiyorlar? <br/><br/>depremi bu kadar net bir şekilde tahmin edecek bir teknoloji yok henüz. yemin ediyorum gezi zamanındaki "3 gün daha dayanırsak hükümet düşecek, kesin bilgi yayalım" diyen insanlardan farkınız yok ya. yahu okuduğunuz her şeye inanmadan önce iki saniye durup düşünün ya. bir de tetikte olmakta fayda var yazmış. kardeşim zaten bütün şehir tetikte şu an. ne garip insanlarsınız ya.
  entry_channels: haber
- entry_name: |
...
- entry_name: |
    kırılması gereken 45 kilometrelik fay hattı
  entry_id:  95841736
  entry_writer: patoschik
  entry_fav_count: 166
  entry_content: |
    kırılmazsa amına koyim
  entry_channels: bilim,tarih
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    26 eylül 2019 profesörlerin para dilenmesi
  entry_id:  95843656
  entry_writer: sokrataristo
  entry_fav_count: 146
  entry_content: |
    haberturk teke tek canlı yayınında itü profesörleri fay hattına yapılması gereken bir sualtı gözlem istasyonu için ibb başkanı ekrem imamoğlu'ndan para istedi.<br/><br/>projenin maliyeti 1.5 milyon euro.<br/>1.5 milyon<br/>1.5<br/><br/>koca itü böyle mühim bir misyon için bu bütçeyi sağlayamadı mı?<br/>hadi itü de zaten para yok, böylesi devede kulak bir miktar için kamu kurumları hiç mi devreye girmedi de koca koca profesörleri para istemeye muhtaç bırakıyorlar.<br/><br/>ulan bilim için teknik için istanbul depremi için gerekli olan paraya bak. <br/>sarayın 1 günlük elektrik faturası bu. <br/><br/>bu saatten sonra bu para finanse edilemezse, cümleten yazıklar olsun.
  entry_channels: haber
- entry_name: |
  ...
  entry_fav_count: 135
  entry_content: |
    bizim kediyi ben uyandırdım kalk deprem oluyor diye. demek ki hayvan olan benim.
...
- entry_name: |
  ...
  entry_fav_count: 89
  entry_content: |
    celal şengör: sayın başkan biz emrinizdeyiz.<br/><br/>imamoğlu: celal hocam biz de sizin emrinizdeyiz. bilimin karşısında boynumuzu bükeriz.<br/><br/>istanbul'a faydalı olacak sözler verilen yayın.
...
- entry_name: |
  ...
  entry_fav_count: 47
  entry_content: |
    en çok maaş almayı hak eder mi bilmiyorum ama bir insanın hayatının önemli olduğundan mütevellit öğretmenin hak ettiği maaşı alamadığını hatta çoğunun maaş bile alamadığını görüyoruz.
  entry_channels: anket,bilim,eğitim,ekonomi
- entry_name: |
    26 eylül 2019 çapa'daki deprem hasarı
  entry_id:  95843548
  entry_writer: samani zamani gecince saklayan adam
  entry_fav_count: 43
  entry_content: |
    neymis, beyin degerli bir organmis.<br/><br/>cerrahpasali genc doktorlarin protesto ettigi sey, hastalarin kolayca ulasabildikleri bir lokasyondan santajla cikarilmak istenmeleriydi, tabii ki de rant icin.<br/><br/>hastanelerini yenilemeyerek, ekipmanlarini almayarak, doner sermayelerini odemeyerek hem doktorlari hem de hastalari magdur eden rantci zihniyete karsi cikmakti.<br/><br/>yoksa turkiye'de ilk 400-500 ogrenci icinde sinavi kazanan bu insanlar aptal degil. insanca sartlarda, kendi yerlerinde hastalarina hizmet vermek istiyorlar, silivri'nin ucra koselerinde degil.<br/><br/>allah size akil ve fikir versin. umarim o doktorlara siz veya yakininiz muhtac olmaz.
...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    deprem anında tuvalette olmak
  entry_id:  95833768
  entry_writer: bilge cocuk
  entry_fav_count: 41
  entry_content: |
    (bkz: <a class="b" href="/?q=i%c5%9fte+%c5%9fimdi+s%c4%b1%c3%a7t%c4%b1n">işte şimdi sıçtın</a>)
  entry_channels: 
- entry_name: |
    seks esnasında olabilecek en kötü şey
  entry_id:  95809036
  entry_writer: sayfa hirsizi
  entry_fav_count: 35
  entry_content: |
    osurma diyenler siz hiç gece nöbetçi eczane aradınız mı?<br/>tabiki de içeri boşalmak.
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 35
  entry_content: |
    ikinci el yazmaya cidden gerek var mıydı?
...
- entry_name: |
  ...
  entry_fav_count: 32
  entry_content: |
    otizmli bir evlat sahibi olarak severek izlediğim dizi.
  entry_channels: tv
- entry_name: |
...
- entry_name: |
    26 eylul 2019 istanbul ikinci depremi
  entry_id:  95846782
  entry_writer: sam spade
  entry_fav_count: 19
  entry_content: |
    artciya da yeni deprem basligi acmayin.
  entry_channels: haber
- entry_name: |
    26 eylül istanbul ambulans takviyesi
  entry_id:  95844627
  entry_writer: naga
  entry_fav_count: 11
  entry_content: |
    ortaya sorumsuz bir iddia atıp halkı paniğe sevk etmektir.<br/><br/>kaçarsa: [<a rel="nofollow noopener" class="url" target="_blank" href="https://eksiup.com/p/hi186368duoh">https://eksiup.com/p/hi186368duoh</a> <a rel="nofollow noopener" class="url" target="_blank" href="https://eksiup.com/p/hi186368duoh">https://eksiup.com/p/hi186368duoh</a>]
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    “tanrı, kadınlara geçmişi ve geleceği, erkeklere bugünü armağan etti. kadınlar geniş bir zamana yayıldıkları için huzursuz, erkekler daracık bir zamana sıkıştıkları için anlayışsız olurlar.”
  entry_channels: anket,ilişkiler,edebiyat
- entry_name: |
    depremden korkmayacak olgunluğa erişmek
  entry_id:  95844021
  entry_writer: effectzone
  entry_fav_count: 6
  entry_content: |
    japonya'da yaşıyor olmayı gerektirir. bu ülkedeki yapı stoğuyla, deprem konusundaki umursanmazlıkla bu olgunluğa erişmek mümkün değildir. oturduğun konutun sağlam olduğunu bilsen bile büyük bir depremde şehirlerde oluşacak kaos ortamı insanı ürkütüyor. 17 ağustos sonrası bunu canlı canlı da gördük maalesef.
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    hidayet'e göre ülkenin en önemli kupası ama skorbord bozuk aq, sokayım böyle ülkenin en önemli kupasına.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=R8isnWHdj40" title="https://www.youtube.com/watch?v=R8isnWHdj40">thurisaz-endless</a><br/><br/>aldı ya beni içine! çıkamıyom.
  entry_channels: anket,müzik
- entry_name: |
    kanser hastasına yardım kampanyası
  entry_id:  95809393
  entry_writer: bravoteam
  entry_fav_count: 1
  entry_content: |
    bazıları yine yaymış ağzını. neymiş nufüs şöyle oldu da bilmem ne... <br/><br/>destek olunması gereken kampanya. ağzını yayanlarla birebir hesaplaşabilirim.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    <a class="b" href="/?q=me+too">me too</a> hareketi hakkındaki düşünceleriyle duygulara tercüman olmuştur.
  entry_channels: spor,siyaset,tv
- entry_name: |
    ahmet mete ışıkara
  entry_id:  95834266
  entry_writer: nadir bulunan bir koala turu
  entry_fav_count: 1
  entry_content: |
    ah hocam ah. ılkokulda 5 kisilik bi ekip secip hocanin konferansina yolladi hocalarimiz. tabi bende varim ekipte. gittik dinledik, ne tonton adam ya demistim. <br/><br/>neyse konferans bitti ee o zamanlar 2005 civari, telefonda kamera ne gezer? gittim yanina imzanizi alabilir miyim dedim. guldu ben popcu muyum dedi. ama imzaladi kagidimi. benden sonrakileri imzalamadi ama aa olmaz hadi hadi diyerek. daha sonra duman grubu, sebnem ferah vs bir takim unlulerle selamlasma sansi yakaladim ama aklima bile gelmedi ne imza ne resim. sanirim ben bilime asigim arkadaslar. ahmet dede sen gidince cok aglamistim. mekanin cennet olsun
  entry_channels: bilim
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    o paraya götüne don alabiliyorsa şanslıdır.
  entry_channels: anket,moda,ekonomi
- entry_name: |
    5 bin tl bandında android telefon
  entry_id:  95841743
  entry_writer: kumulatifvergimatrahi
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=r2-d2">r2-d2</a>)
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    aslında<br/>bir ömür vadedilmişken bize<br/>olmadı olduramadık<br/>ben ve <br/>benim gururum<br/>geride kalam iki kalp<br/>birbirinden kırık<br/>basit cümleler kurmak gerekirse<br/>aptal bir adam kadın aşık<br/>ve sen başka diyarlarda<br/>kafam karmakarışık
