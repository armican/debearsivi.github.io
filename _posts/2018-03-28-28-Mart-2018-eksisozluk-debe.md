...
- entry_name: |
    alper potuk türkiye'nin en iyi forveti olur
  entry_id:  75445963
  entry_writer: hastanelik petunya
  entry_fav_count: 79
  entry_content: |
    alper önce futbolcu olsun da sonra forvet de olur dediğim boş beleş iddia.
- entry_name: |
...
- entry_name: |
    çukur (dizi)
  entry_id:  75431362
  entry_writer: nazarboncuklucaybardagi
  entry_fav_count: 42
  entry_content: |
    tamam aylecek beğenerek izliyoruz diziyi fakat dizideki ana karakterlerin malesef çok yetersiz ve etkileyicicilikten uzak kaldığını söylemeliyim.<br/><br/>bir kurtlar vadisi’ndeki <a class="b" href="/?q=tilki+andrei">tilki andrei</a> karakterine bakıyorum bir de çukur’daki elvis karakterine. arada dağlar kadar fark var. <br/><br/>tilki andrei ceketinin iç cebinde taşıdığı konyak şişesiyle, sardığı sigarasıyla, votka içme içirme rajonuyla, karizması ve konuşmasıyla komple bir karakterdi. <br/><br/>çukur’daki elvis karakterinde ise sadece saçma sapan bir konuşma şekli var başka da bir şey yok.<br/><br/>16-17 sene önceki yapım olan kurtlar vadisi’nde karahanlı, kılıç, laz ziya, testere necmi ve birçok sayamayacağımız her biri efsane olan karakterler varken, 2018 yapımı çukur’daki karakterlere bakıyoruz emrah amir, beyefendi, aliço, paşa, emmi gibi tırt karakterler.<br/><br/>dolayısıyla kurtlar vadisi gibi bir dizinin yanında bu çukur dizi falan değildir. ha izliyoruz o ayrı ama izleyici olarak daha kaliteli bir yapım beklemek hakkımız kimse kusura bakmasın.
- entry_name: |
...
- entry_name: |
    erdoğan'ın kapısında temizlikçi olurum
  entry_id:  75449324
  entry_writer: scanman
  entry_fav_count: 19
  entry_content: |
    soyadının kendisine çok yakıştığını düşündüğüm, 14 yıldır bilecik beldiye başkanlığı yapan akp'li selim yağcı'nın beyanı. <a rel="nofollow noopener" class="url" target="_blank" href="http://haber.sol.org.tr/toplum/belediye-baskani-yagci-erdoganin-kapisinda-temizlikci-de-olurum-233049" title="http://haber.sol.org.tr/toplum/belediye-baskani-yagci-erdoganin-kapisinda-temizlikci-de-olurum-233049">kaynak</a><br/><br/>(bkz: <a class="b" href="/?q=ba%c5%9fkas%c4%b1+ad%c4%b1na+utanmak">başkası adına utanmak</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    cahil adamı değil devlet hiç kimse koruyamaz. paranı birine teslim ederken garanti istemen gerekir. örneğin devlet onaylı resmi bankalar gibi. bu bankaların zaten devlet garantisi belirlidir. ancak sen paranı belirsiz kişilere emanet edersen tabi ki kazıklanmaya mahkumsun. bütün paranı neden piyango biletlerine harcamıyorsun, bak büyük ikramiye ne kadar fazla? bütün paran ile piyango bileti al o zaman. sonra git bana niye çıkmadı diye devlete şikayet et zararın telafisini iste, bu mümkün değil tabi ki.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    öyle bir beceriksiz ve başarısızım ki şurada derdimi anlatmak istesem onu da beceremem.
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    mesaj kaygısı gütmeden soru soranların soruları kabul olmuyor sanırım. hayatınızdaki hayrullahlardan tokatı yiyip bir de üstüne gelip bize hayrullah'ınız gibi davranmayın. bize ne, kılığına kıyafetine karışılmasından ya da birilerinin seni değişime zorlama çabasından.
- entry_name: |
