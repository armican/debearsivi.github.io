...
- entry_name: |
    şak diye x günlük rapor alan memur
  entry_id:  85575412
  entry_writer: hem memur hem muhendis
  entry_fav_count: 207
  entry_content: |
    ben memur olsam şak diye 10 gün alırım. insanlar şaşırır. <br/>sonra şak bir 10 daha alırım. şaşırılar, noluyor derler. <br/>sonra şak bir 10 daha alırım. <br/>herkes çil yavrusu gibi dağılırlar. <br/>dolar da 2.85 olur.
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    16 ocak 2019 münbiç patlaması
  entry_id:  85582064
  entry_writer: uskubi
  entry_fav_count: 33
  entry_content: |
    abd’nin suriye’den çekilmemek için kullanacağı bir bahane olarak tarihe geçecektir.
  entry_channels: siyaset,haber
- entry_name: |
    tarık çamdal
  entry_id:  85564948
  ...
  entry_fav_count: 32
  entry_content: |
    bu tip oyuncuların takımlarımıza tekrar musallat olmasını istemiyorsak, her platformda yabancı sınırı getirilmesine karşı kamuoyu oluşturmalıyız.<br/><br/>unutmayın veysel sarı’lar, tarık çamdal’lar, ozan tufan’lar, alper potuk’lar ve niceleri bu yerli oyuncu seviciliği yüzünden peydah oldu.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    asiri bos konusmalari, hele atarli giderli klise soylemleri tahammul edilebilir seviyelerin cok cok otesine gecen akp milletvekili.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  85590759
  entry_writer: mrbrain
  entry_fav_count: 10
  entry_content: |
    sol frame i okuyasım gelmiyor benim , okusam da dolu bir şey yok, çoğu laklak, geyik , dolu olanlar alt sıralarda kayboluyor. bilgi olunca giriyorum, bazen bilgi ihtiyacımı gideriyorum ama sanki bu başlığa yazmak bile aynı kalabalığı devam ettirmek gibi. yavaştan reddit’e kayıyorum.
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    feminist olarak, 'kadına ne yaptın da böyle oldu?' falan demem. benzer bir kaç vaka duydum, birine ise birinci elden şahit oldum. psikolojik rahatsızlıklar, arıza olmak, dengesizlik erkeklere mahsus bir özellik değil. taciz etme de aynı şekilde. hatta çoğu zaman arıza sinyali veren bir kadın, eğer güzelse, erkek tarafından bu özelliği örtülüyor. bunda biraz erkeklerin kadını hafife alması ve kendisine zarar veremeyeceğini düşünmesinin de etkisi var. oysa ben eski sevgilisinin hayatını cehenneme çeviren çok kıskanç ve arıza kadınlar tanıyorum. <br/><br/>siz şu an eski sevgiliniz tarafından sistematik olarak tacize uğramaktasınız. öncelikle ilgili kişiyi size ulaşabileceği tüm mecralardan engelleyin ve kesinlikle hiçbir araması ya da mesajına cevap vermeyin. daha sonra ise ilk iş savcılığa gidip, tacize uğradığınıza dair dava açın. size gelen mesajlar sayesinde elinizde yazılı kanıtınız olmuş. ek olarak hakaret davası da açılabilir belki, onu hukukçulara danışın. şahitleriniz de olduğuna göre işiniz çok kolay. bildiğim kadarıyla bu davalarda önce hapis cezası para cezasına çevriliyor, tekrarında ise kişi hapse giriyor.<br/><br/>şimdiden geçmiş olsun diyor, davanızda bol şans diliyorum.
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    30 dakika işe geç gelir, 30 dakika kahvaltı ardından cuğara molasına çıkarak saati 10:30 yapar.<br/><br/>(bkz: <a class="b" href="/?q=%c5%9funun+%c5%9furas%c4%b1nda+%c3%b6%c4%9fle+aras%c4%b1na+ne+kald%c4%b1">şunun şurasında öğle arasına ne kaldı</a>)
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ben de ben de dedigim turnuvadir.
  entry_channels: oyun
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    dert dinlemiyorum kızlar. muhabbet edelim. dertleşme işini seviştikten sonra yaparız. sevişmeden olmuyor. özellikle istanbullu kızların derdini dinlemeye talibim. ama şeyden sonra*<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="http://ribony.com/zeller">http://ribony.com/zeller</a>
  entry_channels: anket,ilişkiler,ekşi-sözlük
---
