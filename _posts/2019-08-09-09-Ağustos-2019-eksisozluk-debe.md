...
- entry_name: |
  ...
  entry_fav_count: 118
  entry_content: |
    başlık başa kalmadan yazıyorum;<br/>hiç motor kullanmamış birinin bu başlığı açması kadar saçma değildir.<br/>1-kask kullanmadan motor kullanırsanız e80 km/saat süratten itibaren en iyi ihtimalle göz kuruluğu başlar,göz kuruluğu başlayınca gözünüzü kısıp ananızınkine bakar gibi yola devam eder ve önünüzü görmezsiniz başkasının başını belaya sokarsınız.<br/>2-kask kullanmadan motor kullanırsanız gözünüze kaçan sinek ,böcek bünyesindeki tüm mikrobu,bakteriyi gözünüze enjekte eder.<br/>3-kask kullanmazsanız karıştığınız trafik kazasında ölmeme ihtimaliniz varken bu ihtimali sırf kask kullanmamakla yok ettiğiniz icin başkasının başını belaya sokarsınız.<br/>4-başınızı belaya sokacağınıza ,başınızı ebenizin amına sokacağına kaska sokun.<br/>5-kask takmadığınızda ölürseniz yakınlarınıza,yaralanırsanız size ödenecek tazminat yargıtay'ın son uygulamaları gereği ^% 20 civarında düşürülüyor.<br/>6-aşağıda motorculara ana avrat saydıran,doğal seleksiyondan filan bahsedenler var onlara tek bir sözüm olacak"sizin çocuğunuz da bir gün motosiklet kullanırsa trafikte sizin gibilere denk gelmesin,çocuklarınızın da ,motor kullananların da ,yayaların da ,diğer araç sürücülerinin de aynı kıymette insan evladı olduğunu bilin,insanları sevmekten zarar görmezsiniz.görürseniz de korkmayın,bir gün telafi olur.<br/>edit:entrydeki maddeleri tabii ki mantıklı bulacaksınız;<br/>tanıdıklarınız arasında 43 yıldır motosiklet kullanan kaç kişi var ? benim tanıdıklarım arasında kalmadı ,en az on beş arkadaşımın bağırsakları asfalta yayıldı.götüne pamuk bile tıkayamadılar bir çoğunun çünkü göt deliğini bulamadılar,cenazeleri tabuta üçer beşer poşetler icinde konuldu.<br/>not:55 yaşındayım ve motor kullanırken avcıdan kaçan tavşan kadar tedbirliyim lakin ölüm bir şekilde gelecekse ben ölürken başkasının başı ağrımasın,özelden soran olmuş;"bu cenazeyi yıkayamam bayılırım" diyen imam ,(adam haklıydı,yıkanan cenaze kurban kesimi sonrası kuyuya gömülen artıklardan farklı değildi)hortumu uzaktan tutup hakkı geçmesin diye bahşiş verilen ölü yıkayıcısı gördüm ben.
  entry_channels: 
- entry_name: |
...
- entry_name: |
    xiaomi'nin iphone'dan daha iyi olması
  entry_id:  93655293
  entry_writer: paranoid humanoid
  entry_fav_count: 74
  entry_content: |
    xiaomi'nin artıları:<br/>- çok daha ucuz<br/>- şarjı çok daha iyi, elinizde powerbank ile dolaşmıyorsunuz.<br/>- çok daha özgür bir platform (istediğin kulaklığı kullan, istediğin zil sesini, duvar kağıdını saniyeler içinde ayarla, istediğin romu yükle vs) <br/>- kamera (gcam ile harikalar yaratıyor)<br/><br/>iphone artıları<br/>- stabil (edit: olm ben bu maddeyi taşak için yazdım lan ciddiye almayın bu kadar askfkaldjja) <br/><br/>edit: konusu açılmışken aklıma geldi. çalıştığım iş yerine bir kız başlamıştı, iki ay kadar çalıştı sonra istifa edeceğini duydum. dedim neden çıkıyorsun, "iphone almak için girmiştim zaten, aldım dün" dedi. ciddiyim, gerçek hikaye. bunu iphone "pros" kısmına mı "cons" kısmına mı yazarsınız size kalmış. ;)<br/><br/>edit 2: yığınla mesaj geliyor. bakın arkadaşlar, son bir not. apple dünyanın en iyi donanımını xiaomi'nin yarı fiyatına da satsa, elinde böyle bir imkan olduğu halde telefonlarına inatla düşük kapasite batarya koyduğu sürece tarafımdan tercih edilmeyecektir. şimdiye kadar telefona koydukları en yüksek kapasiteli batarya 3000 bile değil. bundan 3 sene önce çıkan lenovo p2 5100 mah bataryaya sahip, keza orta ve üst sınıf tüm android telefonlar artık min. 4000 mah batarya ile geliyor. çinli peeh diye eziklemeye çalıştığınız firma bile 3 sene önce bunu yapıp ortaya incecik bir telefon çıkardıysa teknoloji buna elverişli demek ki. peki sizin inovasyon devi apple'ınız neden hala yapamıyor bunu, tesis mi yok? hayır, çünkü ürünleri eskitilmeye dayalı ve düzenli aralıklarla yenisini size satamadıkça ayakta kalamayacak.<br/><br/>3 yıllık p2 kullanan ve hala 2 günde şarjını bitiremeyen biri olarak, iphone'unuz ve şarj destek üniteniz ile size mutluluklar. ;)
...
- entry_name: |
    kızları umursamayan gizemli ve yakışıklı erkek
  entry_id:  93670865
  entry_writer: mgmar48
  entry_fav_count: 46
  entry_content: |
    kızlar tarafından çekici bulunduğunu sanan yalnız erkektir.<br/><br/>kimse arayıp sormuyor beyler, hiç gerek yok..
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    (bkz: <a class="b" href="/?q=site+sahibine+%c5%9fafak+operasyonu">site sahibine şafak operasyonu</a>)
  entry_channels: 
- entry_name: |
    emily ratajkowski
  entry_id:  93674160
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    kendim adına konuşmak gerekirse. <br/>(bkz: <a class="b" href="/?q=cool+olmak">cool olmak</a>)
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    şarap içmiştik... 22 yaşımdaydım... her şarap içtiğimde ağlardım o zamanlar.<sup class="ab"><a title="(bkz: artık ağlamıyorum)" href="/?q=art%c4%b1k+a%c4%9flam%c4%b1yorum" data-query="artık ağlamıyorum">*</a></sup> <br/><br/>rastgele toplanmıştı saçlarım, üstümde salaş beyaz bir tişört. yüzümü ellerinin arasına aldı, gülümsedi, aşkla değil şefkatle, hayranlıkla, yeni bir şey keşfeder gibi söyleyiverdi: çok güzelsin lan!<br/><br/>sonra aynayı uzattı. "bak bi kendine. insan ağlar mı? seni üzerin a... koyayım, bak" <br/><br/>baktım. şişmiş,kırmızı gözler , pembe düğme burun,yüzüme yapışmış saçlar...neyimi beğendin be adam? <br/><br/>ama başlığı ne zaman görsem, aklıma o akşam gelir. sevgilim değil, dostumdu. ikimiz de aşık olmadık hiç. sevgili olmayı düşünmedik. ama en içten, en mutluluk verici iltifattı duyduğum. neye benzediğim ve nasıl göründüğüm önemli değil. çok güzel baktı, çok güzel gördü. mühim olan o.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    yemek için olan yumurta döllenmemiş yumurtadır. tavuğun adetini yiyoruz arkadaş, bebeğini değil.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
    erivan'da hepimiz türküz diyebilmek
  entry_id:  93673927
  entry_writer: eksi 18
  entry_fav_count: 3
  entry_content: |
    bu sorunun benzerini hrant dink canlı yayında şöyle cevaplamıştı. <br/>" bu yüzden türkiye' den hiç bir yere gitmiyorum. burada hepimiz ermeniyiz diyebiliyoruz, burada bizi dinleyenler var. burası böyle bir devlet. ermenistan' la farkı olacak tabi. "
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    benim de vazgeçemediğim. sıfır fakat manzarasız evde oturmaktansa, dökülen fakat manzaralı evde oturmayı tercih ederim.<br/><br/>nitekim öyle yapıyorum. ev dökülmüyor da bina eski hehe. 30 saniyede sahildeyim ayrıca.
  entry_channels: moda
- entry_name: |
    sözlük nick'lerinden meslek tahmini yapmak
  entry_id:  93677707
  entry_writer: wilddoctor
  entry_fav_count: 0
  entry_content: |
    liordi non enjoy engbia = öğretmen
  entry_channels: anket,ekşi-sözlük
- entry_name: |
    alexander sörloth
  entry_id:  93676984
  entry_writer: kamikaze0649
  entry_fav_count: 0
  entry_content: |
    az önce çok hoş bir gole imza attı.
  entry_channels: spor
---
