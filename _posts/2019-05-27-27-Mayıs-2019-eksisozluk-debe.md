...
- entry_name: |
  ...
  entry_fav_count: 171
  entry_content: |
    atatürk'ten sonraki en büyük figürmüş. <br/><br/>2002'de 1.5 lira olan dolar bugün 7 liraya dayanmış, satılıp peşkeş çekilmeyen tek bir kurum dahi kalmamış, müşteri garantili yapılan yol, köprü, hastane, havalimanı üzerinden vatandaş haraca bağlanmış, çiftçi, esnaf, eğitim, ekonomi bitmiş, ülke neredeyse sömürge devlet haline gelmiş bir dönemin siyasi lideri;<br/><br/>-kelimeler yetmez ama-<br/>ülkesi için onlarca cephede savaşmış, vatanı kurtarmış, cumhuriyeti kurmuş, devrimler gerçekleştirmiş, ülkesinin makus talihini yenmiş, kitaplar yazmış, tüm dünyanın saygınlığını kazanmış, büyük önderimiz mustafa kemal atatürk'ten sonraki en büyük figürmüş.<br/><br/>ak partinin madde bağımlılığı ile ilgili soru önergesini neden reddettiğini şimdi daha iyi anlıyorum.
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    galatasaray vs ajax şampiyonluk kutlaması
  entry_id:  90535730
  entry_writer: fredy013
  entry_fav_count: 67
  entry_content: |
    ilk entry'de yer alan <a class="b" href="/?q=andre+rieu">andre rieu</a> konseri görüntüsü ajax'ın şampiyonluk töreninden değil, <a class="b" href="/?q=18+mart+2009+ajax+marsilya+ma%c3%a7%c4%b1">18 mart 2009 ajax marsilya maçı</a>ndan.<br/><br/>(bkz: <a class="b" href="/?q=kutsal+bilgi+kayna%c4%9f%c4%b1">kutsal bilgi kaynağı</a>)
  entry_channels: spor
- entry_name: |
    yıldırım ac mi dc mi
  entry_id:  90517010
...
- entry_name: |
  ...
  entry_fav_count: 26
  entry_content: |
    durup durup hortlayan başlık. <br/>arada unutulur gibi oluyor, sonra biri çıkıp<br/><br/>- malların tercihi, salaklık, enayilik<br/><br/>gibi bir girdi ekliyor ve seyreyleyin cümbüşü <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup><br/><br/>sonra olanlar:<br/>*spotify öğrenci takılanlar<br/>*yanında şuna buna da para harcayanlar<br/>*farklı mailler ile 3 ay 3 ay takılanlar<br/>*youtube video izleme yeridir, mobil paketi öper açıklamaları<br/>*”sana ne amk” diye s?ktir çekenler<br/>*kayıplı kayıpsız müzik tartışmaları<br/>*sizde kulak yok diyenler<br/>*istiklal marşı<br/>*kapanış<br/><br/>aynı şeyleri durmadan yazıp çizip tartışıyoruz. <br/><br/>ben de gideyim de vw golf başlığına “tok kapı sesli buzdolabı, alan gösteriş meraklısı maldır” yazayım, orası da şenlensin
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    aids'li ebola'lı ve frengili bir kızla sevişmek
  entry_id:  90544453
  entry_writer: sen gelsene bi
  entry_fav_count: 21
  entry_content: |
    sanal seks yapiliyorsa gayet guvenlidir. yine de antivirus programi olsin noolur noolmaz.
...
- entry_name: |
  ...
  entry_id:  90540541
  entry_writer: aborijin
  entry_fav_count: 11
  entry_content: |
    otuz yaş üstü amca ve teyzeler de gitse sözlüğü abaza erkek öğrenci evi gibi bok götüreceğinin farkında değiller. şimdi en azından çok çocuklu evleri götürdüğü kadar bok götürüyor. 'çocuktur, öğrenir' deyip görmezden geliyoruz.
  entry_channels: anket,ekşi-sözlük
- entry_name: |
    zara'da çalışanların egodan patlayacak olması
  entry_id:  90545907
  entry_writer: siteps
  entry_fav_count: 9
  entry_content: |
    mağazalarda çalışanların %85'i üniversite öğrencileridir ve boğaziçi, itü, ytü'de okuyan oldukça donanımlı ve bu başlığı açan dallamayı her konuda sollayabilecek elemanlar mevcuttur.ben de daha önce mağazalarda çalıştım, mükemmel insanlar gördüm fakat mağazacılık oldukça yorucu bir iştir. bir yandan okuyup bir yandan çalışmanın verdiği yorgunlukla suratlar biraz porselen gibi görünebilir. bunu porsukların anlamaması ve yermesi gayet doğaldır.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    (bkz: <a class="b" href="/?q=bunu+okursam+beni+siksinler">bunu okursam beni siksinler</a>)
  entry_channels: ilişkiler
- entry_name: |
    bursaspor'un küme düşmesi
  entry_id:  90531787
  entry_writer: tuhafcocuk
  entry_fav_count: 5
  entry_content: |
    bursaspor taraftarı olarak benimde umudumu kestiğim durum.he umrumda mı değil.neden diye sorarsanız 2 sene küme düşmekten kurtulmuş takıma aynı yöneticileri getiriyorsan ve buna kimse bir şey demiyorsa kulüp dünya kadar gelirden borç batağına düşmüş kimse gıkını çıkarmıyorsa kusura bakma arkadaş düşelim.sözlüğün bursa düşmanlığını az çok anlamlandırabiliyorum.bursa akp nin kalesi gibi ancak içlerinde bizler gibi çağdaş insanlarda var her ne kadar çok olmasakta.siyasal islamın girdiği neresi ayakta kalmış ki sözlük söylesenize?
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler,ekşi-sözlük,magazin
- entry_name: |
    yengeci süper olan mekanlar rehberi
  entry_id:  90543615
  entry_writer: shadowelves
  entry_fav_count: 3
  entry_content: |
    herkes gurme olmuş aq bi ben ezmeyim sanırım.<br/>tanım: katkıda bulunamayacağım rehber.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  90518095
  entry_writer: kimalmisbenimnickimi
  entry_fav_count: 0
  entry_content: |
    gel.
