...
- entry_name: |
    devletin gizlice dolar basması
  entry_id:  77192280
  entry_writer: uckuruslukopera
  entry_fav_count: 123
  entry_content: |
    ordusunun darbe yapacağını rus elçiden öğrenen devletlerde gizli bir şey yapılabileceğini düşünenlerce ihtimal dahilinde görülen uygulama.
...
- entry_name: |
  ...
  entry_fav_count: 89
  entry_content: |
    (bkz: <a class="b" href="/?q=55+kilo+t%c3%bcrkiye+botoks+%c5%9fampiyonu">55 kilo türkiye botoks şampiyonu</a>)
...
- entry_name: |
  ...
  entry_fav_count: 48
  entry_content: |
    milletin karısı kızı şehylere şıhlara helal, it gibi çalıştığın şirketten kovulunca kıdem almak helal değil.<br/>nasıl iş la bu? matematiği nedir bu işin?
  entry_channels: siyaset,haber,ekonomi
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    son yayınını yarıda kapattım ve bir daha izlememe karar verdim. <br/><br/>erdoğan’a suikast konusunu işlerken ödlek tavırlarla içinden geçenleri söyleyemeyip “acaba bu işi niye medya ile paylaşıyorlar ki çok ilginç allah allah” modunda aman ilişmeyeyim de ne olur, ne olmaz şeklinde takılırken muharrem ince’nin saman balyalaması olayına “hehehehehehe hala prim yapıyor mu yaaa? hihihihi 70’lerde kalmadı mı bunlar pıhahahaha” şeklinde sırıta sırıta, dalga geçer gibi konuşması artık yeter dedirtti.<br/><br/>kardeşim bak inceye içinden geleni söyleyebiliyorsun, erdoğan’a gelince ötesinden berisinden dolanarak ima bile etmekten korkuyorsun. içinden geleni söyle, düşünceni söyle kime ne söylersen umrumda değil ama beceremiyorsan bunu yapma bu işi ve kendini gazeteci olarak tanımlama.
...
- entry_name: |
    muharrem ince'yi bir anda iyi eden mucize aşı
  entry_id:  77205329
  entry_writer: altairibnlaahad
  entry_fav_count: 11
  entry_content: |
    damarlarındaki asıl kandır o aşı değildir, aşı olsa duramazsın.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    oruç olmadığı için , ramazan ayında bu şehirde gündüz yemek yiyilcek yer bulamadığını belirtip ağlayanlara itibar etmeyiniz , her tarafta onlarca insan lokantalarda öğlen yemeğini yiyor şu anda. isteyen orucunu tutar , isteyen tutmaz. herkesin ibadeti kendine. <br/><br/>hem dindarlara hem bursa’ya sallamak için entry girmiş arkadaşa tavsiyem , önyargılarından arınması.
...
- entry_name: |
    acayip kıyafetiyle minibüse binen adam
  entry_id:  77189209
  entry_writer: geldi ggiine tipini s2ktigim
  entry_fav_count: 8
  entry_content: |
    amerika'da açıklanır hep, zamanda yolculuk yapan adam yolun ortasına düştü. yok şöyle oldu böyle oldu. gelsinler de bir de buradaki kendi zamanında yolculuk yapamayan denyoları görsünler.
...
- entry_name: |
  ...
  entry_id:  77205910
  entry_writer: kopek olduren sarap
  entry_fav_count: 6
  entry_content: |
    sosyal medyada konya olduğuna dair bir şeyler gördüğüm piyango. hatta haber:<br/>"konya'da oruç tutmayan adamı döven adamın oruç tutmadığı öğrenilince halk tarafından dövüldü" şeklindedir.<br/>araştırılmasını öneriyorum.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
    ahlat ağacı (film)
  entry_id:  77205430
  entry_writer: yalansayalan
  entry_fav_count: 2
  entry_content: |
    1 haziranda vizyona girecekmiş.<br/><br/>bu seyirciyi düşünmektir. bu gerçekten seyirciyi düşünmektir.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    1- spotify premium<br/>2- kaliteli bir parfüm <br/>3- güzel bir saat<br/>4- kaliteli bir kalem <br/>5- stolichnaya<br/>6- sevilen sanatçının albümü
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    abuk subuk seçim şarkılarından sonra bünyeye ilaç gibi gelmiştir. yeni neslin gözünde yaşlıların siyaseti zaten değerini kaybederken gençleri bu şekilde kucaklamak iyi olacaktır. genç bir birey olarak beni etkiledi açıkçası. hele ki çocuğun bilgisayarda girdiği sitenin yasaklanma ayrıntısı. <br/><br/>bizde devlette de ataerkil bir sistem var. devlet babadır ve sorgusuz sualsiz itaat ister. o yüzden yasaklamalar normal karşılanır. devlet herseyinize karışır. fakat burada devlet baba evlatlarına bakan bir baba figürü değildir. tam tersi evlatları üzerinden beslenen bir babadır. siz çalışır ve babanıza bakarsınız. cebinize 3 kuruş para koymaz tam tersi sizin cebinizdeki tüm parayı alır ve ne iş yapacağından ne giyeceğine neyi beğenmen gerektiğine kadar karışır. <br/><br/>siyasette genç görüşün hâkim olması evlata bakması gereken kişinin baba olması gerektiği algısının artmasını sağlayacaktır diye düşünüyorum. <br/>akp ne kadar seçilme yaşını düşürse de ne kadar adaylarını gençlerden seçmeye çalışsa da o treni kaçırdı artık. zaten sectirdigi adaylara da asalak baba figürü olarak davranacak yine kendi bildiğini yapacaktı. bu durumda iyi olan kazansın demek düşer.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    tahminimce kendi isteğiyle aday olmamıştır. bir kaç gün öncesinde siyasetin kendisine uygun olmadığını belirtmiştir:<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://twitter.com/yusufhalacoglu/status/997880178683596800" title="https://twitter.com/yusufhalacoglu/status/997880178683596800">https://twitter.com/…oglu/status/997880178683596800</a>
  entry_channels: siyaset,haber
- entry_name: |
    güzel ama soğuk olan kız
  entry_id:  77206959
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    diktatör olmanın olumsuz yanları
  entry_id:  77204938
  entry_writer: ari maya
  entry_fav_count: 0
  entry_content: |
    salak olmak. <br/><br/>en sevdigim ornek <a class="b" href="/?q=pol+pot">pol pot</a><br/>neden en populer diktator hitler anlamiyorum.<br/>halbuki <a class="b" href="/?q=pol+pot">pol pot</a> cok orijinal bir diktator.
  entry_channels: siyaset
- entry_name: |
    1600 lira ile çok iyi geçiniyorum diyen seçmen
  entry_id:  77206804
  entry_writer: denekadam
  entry_fav_count: 0
  entry_content: |
    istanbul times röportajlarındaki ihtiyarlardır, net. <br/><br/>arkadaş biz başka bir ülkede mi yaşıyoruz, bu ihtiyarlar kendilerine özel bir ekonomik devrim mi yaptılar da bizim yaşayamadığımız paraya yaşıyor, <a class="b" href="/?q=bundan+iyisi+%c5%9fam%27da+kay%c4%b1s%c4%b1">bundan iyisi şam'da kayısı</a> kıvamına geldiler anlamak mümkün değil.
  entry_channels: siyaset,anket
---
