...
- entry_name: |
  ...
  entry_fav_count: 179
  entry_content: |
    galatasaray bu maçın ilk yarısında oldukça kalın şekilde doğranmıştır. öyle kararlar verilmişti ki, tüm tribünler ve kenar yönetimi çileden çıkmıştı.<br/><br/>algı manipülasyonu yapan dezenformasyonculara prim vermeyiniz.
  entry_channels: spor
- entry_name: |
    betizmmm'in kiki dansı yaparken ölümden dönmesi
  entry_id:  95070865
  entry_writer: currency
  entry_fav_count: 159
  entry_content: |
    az kalsın hayatımın en iyi videosunu izleyecektim ama maalesef fenomenimiz ölümden dönmüş. umarım birdahaki sefere.
  entry_channels: haber,magazin
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  95054138
  entry_writer: basyargic
  entry_fav_count: 138
  entry_content: |
    anksiyete.<br/><br/>kendimden yola çıkarak bu tarifi yaptım.
...
- entry_name: |
    galatasaraylıların ali koç'u kıskanma nedenleri
  entry_id:  95069798
  entry_writer: nejat amca
  entry_fav_count: 81
  entry_content: |
    ali koç... kazandığı savaş yok aq
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 23
  entry_content: |
    -bilim okuryazarlığı, <br/>-haksızlığa karşı duruş, cesaret<br/>-işini hakkıyla yapmanın ahbap-çavuş ilişkisinden çok çok daha fazla kabul görmesi.
  entry_channels: anket
- entry_name: |
    2019 italya gp
  entry_id:  95049353
...
- entry_name: |
  ...
  entry_channels: spor,otomotiv
- entry_name: |
    8 eylül 2019 pkk'nın fabrika yangınını üstlenmesi
  entry_id:  95081953
  entry_writer: celaliyimcelalisincelali1
  entry_fav_count: 14
  entry_content: |
    8 eylül’de istanbul pendik’te polyester fabrikası ile sultanbeyli’de bir yatak fabrikasında çıkan yangınları terör örgütü pkk'nın üstlenmesi hadisesidir.<br/><br/>terör örgütü pkk: fabrikaları, ormanları biz yaktık.<br/><br/>pembe götlü cihangir solcusu: yok siz yakmamışsınızdır.<br/><br/>terör örgütü pkk: lan valla biz yaktık.<br/><br/>pembe götlü cihangir solcusu: yav yok siz yapmamışsınızdır.<br/><br/>hele atatürkçüyüm deyip, terör örgütü pkk'ya sırtını yasladığını söyleyen hdp'ye koz kondurmayanlar şizofrenler var. atatürk, türkiye cumhuriyetinin kurucusu değil mi? her fabrika bir kaledir diyen kişi değil mi? ankara bataklığında orman çiftliğini kuran değil mi? <br/><br/>o ağzınızdan düşürmediğiniz ulu atatürk'ü zerre anlamış kişiler değilsiniz. atatürk sizi görseydi eminim ki sonunuz şeyh sait gibi olurdu. ormanları, fabrikaları yakanlar şeyh sait torunu olduğunu iddia etmiyor mu?<br/><br/>edit: şizofrenler damlamış. klasik vasatlıklarını sıçıyorlar. megri megriyi, habur rezaletini, terörist başı aponun abisi osman öcalanın trt'ye çıkarılmasını savunan kim? nasıl bir hayal dünyanız var sizin? konu buradan oraya nasıl geldi?<br/><br/>edit2: vatanperver solcu kardeşlerimiz, pembe götlü cihangir solcularını çok iyi bilirler. vatanperver solcu kardeşlerimiz ellerinde türk bayrağıyla kaz dağlarında yurdunun ormanı için direnir. onlar türkiye'nin ırmağının akışına sadece şarkılarda değil, gerçekte de ölürler.
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    iki büyük avantajını çok iyi kullanan adam. hem kitap okumayan hem yabancı dil öğrenememiş çok büyük bir yığına hitap ediyor. birileri bu boşluğu kullanacaktı tabi. en azından yalan yanlış bilgilerle doldurmuyor. buna da şükür.
  entry_channels: siyaset,bilim,sanat,teknoloji,eğitim
- entry_name: |
    hem namuslu hem akp'li olmak
  entry_id:  95080179
  entry_writer: haydarduzen
  entry_fav_count: 9
  entry_content: |
    mümkündür tabiî ki. çok naif ve iyi niyetli akp'liler var.<br/><br/>ama hem akıllı, zeki olup akpli olan namuslu insan bulamadım hiç. hepsi cukka derdinde, ve hepsi muktedire yakın olmak için çabalıyor.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    yakışıklı rapçi.<br/><br/>o yüzden çok haklı.
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    araç satmayanların araç piyasasını yükseltmesi
  entry_id:  95078505
  entry_writer: star is tired
  entry_fav_count: 1
  entry_content: |
    konuyla alakali olarak: (bkz: <a class="b" href="/?q=limon+problemi">limon problemi</a>)
  entry_channels: otomotiv,ekonomi
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    tanrım başlığı okuttun nasip et yarabbin alemin subhanallah bugün başvuru yaptığım şehir dışı ilanlardan 3’ü 5’i çağırsın yarabbinalemin amin
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    soru değil tavsiye, yanınızda çok iyi bildiğiniz güvenilir bir erkek yoksa içmeyin, alkol yani, sürekli gittiğim sahilde görüyorum kadınlar yere düşecek şekilde alkollü, yanındaki erkeklere bakıp başına bir iş gelir mi diye düşünmeden edemiyor insan, dün yere düşmüş birini kaldırmaya bile çalışmadı adam, bu ne cesaret neden bu rahatlık, içerken arada bir tuvalete kalkıp durumunuzu kontrol edin, alkolü yüksek içkiler içmeyin(rakı votka viski vs), o anda iyi olsanız bile ilerleyen saatlerde kanınıza daha çok alkol karışacak ve kontrolü kaybedeceksiniz, kontrolü kaybedeceğinizi hissettiğinizde tuvalete gidip kusun çekinmeyin, geri döndüğünüzde bişeyler atıştırın mutlaka, aç iken başlamayın kesinlikle bişeyler yemiş olun başlarken, son olarak lütfen az için devam etmek istiyorsanız evinizde devam edin güvenli ortamda yani.<br/><br/>edit: içmeye başlamadan yağlı meze ya da yemeklerden atıştırın, bir kahve fincanı zeytinyağı en iyisidir.
  entry_channels: anket,ilişkiler
---
