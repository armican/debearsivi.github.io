...
- entry_name: |
  ...
  entry_fav_count: 395
  entry_content: |
    ne desem bilemedim. oranın normalde 3,45 açılmayacağı malum, hatalı açmışlar. ama şöyle de bir şey var; eğer bu kupon yatsaydı yatırılan parayı geri ödeyecekler miydi?
  entry_channels: haber
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  95614324
  entry_writer: bilinmeyenyolculuk
  entry_fav_count: 33
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 22
  entry_content: |
    depresyonun ne olduğu konusunda en ufak fikri olmayan ergenler ve cahilleri bir kenara bırakıyorum. en okumuşu en iyi niyetlisi bile aşağıdaki cümleyi kurabiliyor.<br/><br/>"antidepresan çare değil pozitif düşünmeyi öğrenmen gerekiyor"<br/><br/>insan başına gelmeden ne de kolay ahkam kesebiliyor. yapmayın. başınıza gelmeyen şeyler hakkında hayat dersi vermeyin.
...
- entry_name: |
  ...
  entry_fav_count: 22
  entry_content: |
    (bkz: <a class="b" href="/?q=iyi+o+da+seni+soruyor">iyi o da seni soruyor</a>)
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    kol gibi para cezasına çarptırılması gereken.<br/>(bkz: <a class="b" href="/?q=fakiri+d%c3%b6vme+%c3%bcst%c3%bcn%c3%bc+ba%c5%9f%c4%b1n%c4%b1+y%c4%b1rt">fakiri dövme üstünü başını yırt</a>) <br/>bu tarz tiplerin anasını sik, cebinden 5 lira çıkartma yeter ki. dövmek, şiddet falan bu adama vız gelir.<br/>dayasınlar bi 5.000-10.000'i asıl o zaman dersini nasıl alıyor görürsünüz.
  entry_channels: haber
- entry_name: |
    yedi bela hüsnü
  entry_id:  95640962
...
- entry_name: |
    21 eylül 2019 ülke geneli uyku çökmesi
  entry_id:  95636501
  entry_writer: 88fingerslouie
  entry_fav_count: 11
  entry_content: |
    uyanıp okuyup hak verdiğim tespit
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    40 milyon doları kabul eder 20 sini serenay'a veririm herkes mutlu olur.<br/><br/>(bkz: <a class="b" href="/?q=ad%c4%b1m+an%c5%9ftayn+14+ya%c5%9f%c4%b1m">adım anştayn 14 yaşım</a>)
  entry_channels: 
- entry_name: |
    adil rami
  entry_id:  95641800
...
- entry_name: |
    iyi parti
  entry_id:  95641829
  entry_writer: ben olmadan olmaz
  entry_fav_count: 4
  entry_content: |
    siyasal islam sıçmığından bir chp’liden on kat daha fazla nefret eden eski mhp yeni iyi parti seçmeni olarak herkesin bilmesi gereken bu partinin köküne kadar seküler türk milliyetçilerinin partisi olduğudur. bunu değiştirme çabalarını biz de görüyor ve izliyoruz. böyle bir şey gerçekleşirse ki ihtimal vermiyorum, tarihin çöplüğüne gömeriz hepsini. biz kim miyiz? emevici yamyamlara meze olmamak için 40 yıllık davasını gömen adamlarız.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    şimdi ankaragücü kural hatası falan fişman diye itiraz edebiliyor mu?<br/>edemiyor değil mi? çünkü bu haakem hatası. adalet, hak, hukuk kimsenin sikinde değil. kural hatası olaydı herkes bağırışırdı. hakem hatasıysa sus pus.<br/>hee pardon susun len, fetö, himmet, sucukkgdgajsgsgdjsjshdhd di mi?
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    normal mesajlaşma, hatta 1000 sms hediye tarzı kampanyalar vardı. 1000 sms'i de bitirirdik sevdiceğimle.<br/><br/>kablolu telefon ise daha da eski. normal mesajlaşma'nın çok pahalı olduğu, 1 sms'in 2 kontör olduğu yıllar. o zamanın parasıyla telefon faturası 80-90 tl geliyordu.
  entry_channels: ilişkiler,tarih,teknoloji
- entry_name: |
    mathias zanka jorgensen
  entry_id:  95641399
  entry_writer: siz hepiniz ben tek
  entry_fav_count: 1
  entry_content: |
    gerçekten çok kötü bir futbolcu. hem yavaş hem kötü. attığın golün de amk ayrıca.
  entry_channels: spor
- entry_name: |
    luiz gustavo dias
  entry_id:  95642874
  entry_writer: far from the madding crowd
  entry_fav_count: 1
  entry_content: |
    bir fenerbahçe taraftarı olarak söylüyorum, <a class="b" href="/?q=appiah">appiah</a> gibi bir efsane ile kıyaslayacak cüreti nereden buluyorsunuz çok merak ediyorum.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    acil doktorlarının gaita testi yaptırmaması
  entry_id:  95641495
  entry_writer: karamolla
  entry_fav_count: 1
  entry_content: |
    gaita testi yapılacak hastalıklar acil değildir. siktir git polikliniğe. ibne seni
  entry_channels: 
- entry_name: |
