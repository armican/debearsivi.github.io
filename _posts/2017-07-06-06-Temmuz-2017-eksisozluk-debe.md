...
- entry_name: |
    sevişemeyen yazarlarımızı seviştiriyoruz
  entry_id:  69251670
  entry_writer: dreamfactory
  entry_fav_count: 78
  entry_content: |
    lüzumsuz kampanya çünkü tüm yazarlar, durmaksızın sevişiyoruz, bir tek sen mi sevişmedin yoksa?
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 27
  entry_content: |
    valla ben resmi tatillere bakardım.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    "bu milli bir meseledir." <br/>bu cümle ne güzel herşeyi açığa kavuşuyor yahu. <br/><br/>bir akp yetkilisi bu cümle kalıbını kullanıyorsa, kesinkes bir rant veya bir çıkar söz konusudur.
- entry_name: |
    ekşi itiraf
  entry_id:  69252426
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    gerçek olmamasını umduğum haberdir.<br/>türkmenlere silah yardımı yapıyoruz diyip , ışıda silah gönderen herkesin allah belasını vsrsin.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    bu bir televizyonculuk başarısıdır. bu engin bir zeka örneğidir. bu bir utanan burcu'dur. bu bir fenomendir. <br/><br/>yav bu nedir kardeşim. <br/><br/>20 dakikadır seyrediyorum. kanalı değiştiremedim.<br/><br/>büdüt: o berberin çıkardığı sesler nedir yahu. komaya girme garantili sahne. fena, fena..<br/><br/>zübüt: banu hintli tıfıla yürüdü. çocuğun pipisi düşebilir. gerçi afriditken havuz sahnesinde neyse şimdi.
- entry_name: |
