...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    ilk <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=tHScSo67VfA" title="https://www.youtube.com/watch?v=tHScSo67VfA">fragmanı</a> yayınlanmıştır.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    iyi bir kurumda çalışıp iyi bir bölümden mezun olan kızlardan mesaj bekliyorum:)
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
