...
- entry_name: |
  ...
  entry_channels: siyaset,anket
- entry_name: |
    senin papazın olduğunu bilmiyordum al vur beni
  entry_id:  82234901
  entry_writer: discodisco
  entry_fav_count: 123
  entry_content: |
    bir başkan sözü olma ihtimali yüksek.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    dün akıllıydım, dünyayı değiştirmek istedim;<br/>bugün ise bilgeyim, kendimi değiştirdim.
  entry_channels: anket,edebiyat
- entry_name: |
    akıncı-4 vs boston dynamics
  entry_id:  82244060
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    restorant işletmecisi abi, lokumun her türlüsüne saplantılı kardeşine küp küp keserek kuş lokumu kıvamına getirdiği kuyruk yağını unladıktan sonra afilli bir kutuya koyup ikram eder.<br/><br/>mutluluk göz yaşları eşliğinde avuç dolusu "lokumu" ağzına atıp bir kaç saniye çiğnedikten sonra öğürmeler eşliğinde nefesi kesilircesine kusan kardeş, o saatten sonra ne lokum nede adana kebabın adını bile duymaya tahammül edemez.
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    bir hukuk devleti olarak türkiye
  entry_id:  82242165
  entry_writer: jashjash
  entry_fav_count: 3
  entry_content: |
    olmayan türkiye’dir. olsa olsa çıkar devleti, kara para aklama devletidir.<br/>(bkz: <a class="b" href="/?q=rahip+gitti">rahip gitti</a>)
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    sübyansever kesim ilgi göstermiş ve sadistler de desteklemiş bu başlığı.<br/>155-160 boy 45-50 kg kızmı olur . olsa olsa çocuk olur bu boyutlarda.<br/>hormonlu fastfood yiyerek empotans olan normal görsellikten cinse faaliyetten erekte olamayanların tercihi. (165-170 boyunda 60-70 kg arkadaşları tenzih ederim onlara uygun hatunlar.)
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    aleyna tilki, arda, volkan vs muhabbetinin artık sıkması
