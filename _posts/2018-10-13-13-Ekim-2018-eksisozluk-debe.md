...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    bi 50.000kişi açık artırmayla hiç gitmesek güzel gelir olur devlete aslında.<br/><br/>edit: mesajlara göre ben 21 gün gittim, sizde gideceksinizci yeni bir tür türemiş.
...
- entry_name: |
    rahip brunson için yapılacak filme isim önerileri
  entry_id:  82238954
  entry_writer: alatras
  entry_fav_count: 0
  entry_content: |
    hali hazirda yapilmisi var. <br/><br/>(bkz: <a class="b" href="/?q=money+talks">money talks</a>)
  entry_channels: siyaset,anket,tv,sinema
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bazılarına göre önüne geleni terörist ilan edip bilmem kaç kez ağırlaştırılmış müebbet vermeyince bağımsız olamıyor. geçiniz.
  entry_channels: siyaset
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=kahkahalarla+g%c3%bcl%c3%bcnen+en+son+%c5%9fey">kahkahalarla gülünen en son şey</a>)<br/>edit:(bkz: <a class="b" href="/?q=ak%c4%b1nc%c4%b1-4">akıncı-4</a>)'ü anımsayınca gülme tutuyor. gözümden yaş getiren versus.
