...
- entry_name: |
  ...
  entry_id:  103677405
  entry_writer: her seyin bir nedeni degil nedeni vardir
  entry_fav_count: 34
  entry_content: |
    köpeğini gezdirmek senin zorunluluğun. <br/><br/>evine ekmek götürmek de başkalarının zorunluluğu olabilir mi belki? ama tabii köpeğini gezdirmek daha mühim bir sorumluluk ve zorunluluk olduğundan sen dışarı çıkabilirsin. yanlış yapmış ötekiler. otursunlar evlerinde. köpek önemli.
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    sanattan anlayan esprili 172cm boyunda güzel kadın
  entry_id:  103653569
  entry_writer: marmara66
  entry_fav_count: 23
  entry_content: |
    kadın olma dışında hepsini tutturduğum başlık.
...
- entry_name: |
  ...
  entry_channels: sağlık
- entry_name: |
    dünyanın sonu 2012 mayalar
  entry_id:  103681820
  entry_writer: nickidegistirebiliyozmu
  entry_fav_count: 21
  entry_content: |
    2012'de mayaladılar şimdi tuttu.
  entry_channels: 
- entry_name: |
    kapitalizmin çöküşü
  entry_id:  103660787
...
- entry_name: |
    tutunamayanlar (dizi)
  entry_id:  103678521
  entry_writer: vettini vezzeytuni
  entry_fav_count: 7
  entry_content: |
    <a class="b" href="/?q=arda+kural">arda kural</a>‘ı görünce mutlu oldum. küçük prens olmak öyle yakışmış ki. tatlı tatlı sakin bir ruh haliyle oynuyor. şair lütfü gibi arda’nın o çocuksu haline sarılmak geldi içimden. ha kötü oynasa da kabulümdü. reklam arasında röportajlarına baktım. baya toparlamış görünüyor. muhtemelen dizi ekibi de farkındaydı. küçük prens üzerinden kendini anlatmasını sağlamışlar. böyle bir şıklık tutunamayanlar gibi sevimli bir projeye yakışırdı. çok kral dizisiniz. sizleri seviyorum.
...
- entry_name: |
    karantinadan kaçanlar cinayetle yargılansın
  entry_id:  103676903
  entry_writer: shiftetelli
  entry_fav_count: 6
  entry_content: |
    olmaması için hukuksal olarak hiçbir sebep göremediğim ve katıldığım ceza fikridir.
  entry_channels: 
- entry_name: |
    italya'da korona virüs ölüm oranının %43 olması
  entry_id:  103681296
  entry_writer: abico
  entry_fav_count: 6
  entry_content: |
    oynanan büyük oyunların türkiye'ye değil italya'ya olduğunun kanıtı niteliğindedir. şaka bir yana bunun sebebi italya'nın yaşlı nüfusunun fazla olması ve salgının çok hızlı yayılması sebebiyle hastanelerde yer kalmamasıdır.
...
- entry_name: |
  ...
  entry_id:  103681083
  entry_writer: batiyaka
  entry_fav_count: 3
  entry_content: |
    asistan ve sekreter adetli olarak var ama çayını kendi alanlardan olmadım daha.
