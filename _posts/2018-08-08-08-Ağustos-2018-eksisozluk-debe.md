...
- entry_name: |
  ...
  entry_channels: anket,ekonomi
- entry_name: |
    ülkemizin en güzel 2 cici kızı
  entry_id:  80010788
  entry_writer: dusakabinn
  entry_fav_count: 9
  entry_content: |
    entry ve nick hic bu kadar uymamisti.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    ıki tane biliyorum yeryüzüne ateş atmaya gelmiş nefes kesen baktıkça bayılirsınız vücut boy meslek para kariyer falan hayal ötesi erkekler.<br/><br/>bir de çirkinler var onlara değinmeyeceğim. ellerim kirlenir o kadar ıyyy.<br/><br/>ben mi ? çoğzelim.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    mayışı bitirdiğimden bursa'dan ben değilim. pas geçiyorum. "bir bira 10 lira olur mu ulen!!!!!!"
