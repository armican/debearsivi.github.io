...
- entry_name: |
  ...
  entry_fav_count: 39
  entry_content: |
    (bkz: <a class="b" href="/?q=ne+diyorsun+am%c4%b1na+koyay%c4%b1m">ne diyorsun amına koyayım</a>)
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 33
  entry_content: |
    iyi ki cb olmadı. bu krizle kendisi baş etmek zorunda kalacaktı. bırakın şimdi çomarlar düşünsün.
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    vw polo'nun opsiyonlarla 160.510 tl olması
  entry_id:  80000214
  entry_writer: lordum
  entry_fav_count: 12
  entry_content: |
    bir alman'ın 10 birim çalışıp aldığı araca bizim 100 birim çalışmak zorunda kalmamız ne acı. bu kadar çalışmamıza rağmen bu kadar fakir bir ülke olmamız...<br/>fabrikalara gir sabahtan akşama kadar soluksuz çalıştırıyorlar, telefon yasak, tuvalet mola saati dışında yasak, mesai olursa zorunlu gibi gibi uzar gider ve bu adamlar asgari ücret alıyorlar.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    hiç izlemedim ama ne zaman bu diziyi duysam tek bir şey geliyor aklıma; <a class="b" href="/?q=i+wanna+do+bad+things+with+you">i wanna do bad things with you</a>
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    aslında söylenmek istenen şu: ekşisözlük gece gece siki avuçlayınca ribony'den birbirlerine "karı mısın?" "memen var mı?" diye soracak mallar sürüsü veritabanı olacak. yani hızla oraya doğru gidiyor bu başlık.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    ağlayan birini sakinleştirmeye çalışmak genelde daha çok sinirlenmesine sebep olur. bu nedenle en doğru yol ağlamasının durmasını beklemektir.<br/><br/>tabii bu durumda kadının ben ağlarken benle ilgilenmedin tribine katlanmak gerek.
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bundan 3 sene önce bir arkadaşımla 60tl karşılığı 20 euro takas etmiştim. hala cüzdanımda ve 120 tl ediyor.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    keşke böyle olsa vallaha. bir gün aramadım başımın etini yedi yeminle.
  entry_channels: ilişkiler
- entry_name: |
    domagoj vida
  entry_id:  80002538
  ...
  entry_fav_count: 0
  entry_content: |
    bugün içinde ya arsenal, ya monaco, ya manchester united yada wolves'e transferi açıklanacak olan hırvat futbolcu.<br/><br/>wolves ile 22 milyon euro için iki kulüp arasında anlaşma sağlanmıştı ama vida'nın daha büyük bir kulübe gitmek istemesi transferi bekleme aşamasına geçirdi. bugün her şey netleşecek.<br/><br/>edit: bana gelen bilgiye göre arsenal ile anlaşma tamam.
  entry_channels: spor
- entry_name: |
    devletin ekşi sözlük'ü kapatmama sebebi
  entry_id:  80015725
  entry_writer: medusasul
  entry_fav_count: 0
  entry_content: |
    havadisleri ekşisözlükten takip ediyor oluşudur.
  entry_channels: siyaset,anket,ekonomi
---
