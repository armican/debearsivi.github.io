...
- entry_name: |
    ekrem imamoğlu benim ayarım değil
  entry_id:  90299346
  entry_writer: nickson
  entry_fav_count: 1686
  entry_content: |
    birisi sayın cumhurbaşkanı'na hatırlatsın; zaten ekrem başkan da cumhurbaşkanı adayı değil, istanbul belediye başkan adayı. yani kendisi senin ayarın olmaya çalışmıyor, işini gücünü bırakıp istanbul'da miting yapan sen ekrem imamoğlu'nun ayarı olmaya çalışıyorsun.<br/><br/>aradaki farkı anlatacak yürekte bir gazeteci veya danışman olmadığı için anlamayacaksın haliyle.
  entry_channels: siyaset,haber
- entry_name: |
    game of thrones
  entry_id:  90295006
...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    tiyatro abartılmış tarih öncesi bir sanattır
  entry_id:  90303356
  entry_writer: harzem
  entry_fav_count: 219
  entry_content: |
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    19 mayıs 2019 hdp'nin pontus soykırımı mesajı
  entry_id:  90298057
  entry_writer: 0 5 ucu olan adam
  entry_fav_count: 89
  entry_content: |
    türk ve türkiye cumhuriyeti'ne dair her şeye yıkıcı şekilde karşı olan hdp'nin yeni bir anti-türkiye kategorisi: pontus soykırımı.<br/><br/>hdp mardin milletvekili tuma çelik: "<a class="b" href="/?q=pontus+rum+soyk%c4%b1r%c4%b1m%c4%b1">pontus rum soykırımı</a>'nda hayatını kaybedenleri saygıyla anıyorum." <a rel="nofollow noopener" class="url" target="_blank" href="https://twitter.com/TumaCelik/status/1130156764966596609?s=20" title="https://twitter.com/TumaCelik/status/1130156764966596609?s=20">https://twitter.com/…tatus/1130156764966596609?s=20</a><br/><br/>hayatlarını türkiye ve türk karşıtlığı üzerine kurgulayan parazit yaşam formları bunlar.<br/><br/>not: bir başka parazit (bkz: <a class="b" href="/?q=acun%27un+sunucusunun+pontus+soyk%c4%b1r%c4%b1m%c4%b1+mesaj%c4%b1">acun'un sunucusunun pontus soykırımı mesajı</a>)
  entry_channels: siyaset,haber
- entry_name: |
    bran stark
  entry_id:  90296198
...
- entry_name: |
  ...
  entry_fav_count: 35
  entry_content: |
    (bkz: <a class="b" href="/?q=y%c4%b1ld%c4%b1z+tilbe">yıldız tilbe</a>)<br/>uyanmış cinsel dürtüyü tekrar uykuya sokabilir. ha sesi muhteşemdir ona laf yok.
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    hayvanlara da insanlara olduğu gibi sağlık sigortası gelirse çözülebilecek sorundur.<br/><br/>kedimin dişi çekildi 840 tl dediler amk. bu kadar masraf olacağına sigorta olsa primini ödemeyi tercih ederim.
  entry_channels: sağlık
- entry_name: |
...
- entry_name: |
    ben de koca parası yemek istiyorum
  entry_id:  90316571
  entry_writer: leilakhaled
  entry_fav_count: 12
  entry_content: |
    stresli sınav dönemlerinde kız yurdunda bolca duyulabilecek cümle. <br/>bu şekilde başlayan geyik bir süre sonra toplumsal cinsiyete bağlanır, istiklal marşı ve kapanışın ardından herkes dersinin başına geri döner.
  entry_channels: 
- entry_name: |
    maaşa mayış diyen insan
  entry_id:  90307226
  entry_writer: kutub u sikeste
  entry_fav_count: 11
  entry_content: |
    her şeyi anlamsızlaştırır. <br/><a rel="nofollow noopener" class="url" target="_blank" href="https://eksiup.com/p/ma13009zwmg8">https://eksiup.com/p/ma13009zwmg8</a>
  entry_channels: anket
- entry_name: |
    acun'un sunucusunun pontus soykırımı mesajı
  entry_id:  90308533
  entry_writer: bu kacinci uyelik
  entry_fav_count: 11
  entry_content: |
    <a class="b" href="/?q=15+may%c4%b1s+1919">15 mayıs 1919</a> izmirdeki yunan mezalimini anmayan acur efendi utansın !<br/>hoş niye analım.. bizde yenilgileri, üzüntüleri anmak diye bir gelenek yok..<br/>bunlar gibi minik devletler, ellerine kıymık batsa onun yıldönümünü kutlar.<br/><br/>mesajı alsın popişine soksun sakis efendi...<br/><br/>anlamsız mesajdır.
...
- entry_name: |
    gül çörüş
  entry_id:  90312340
  entry_writer: ozgurlukarayan
  entry_fav_count: 6
  entry_content: |
    kendisi eski iş arkadaşım. intihar edeceğini bildiren kişilere yönelik üslubun dikkatli olması gerektiğini bilmekle birlikte ruhsal problemleri olduğuna emin olduğum ara ara ataklar geçiren birisi. <br/><br/>her gittiği yerde genelde olay çıkaran ve dikkat çekmeye çalışan biri. çok ciddi delüzyonları var bu kişinin. acil yardım alması gerekiyor.<br/><br/>sol framede ismini görünce şaşırıp açtım ve yazılanları okuyunca şaşırmadım. kendisiyle çok yakın çalıştım yaklaşık bir sene. gerçekten bu kişinin yardım alması gerekiyor hehangi bir kişiye psikoterapiye yeltenmemesi dahi gerekir. <br/><br/>çok iyi rol yapar, ilk tanıyanlar mükemmel ve çok saf biri olduğunu düşünebilirler. yakından bakmaya başladıkça delüzyonlarına bir bir tanık olursunuz. <br/><br/>not: kendisiyle şahsi hiçbir olay yaşamadım fakat çok şeye tanık oldum.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    teoride doğru olsa da pratikte sıçan laftır. zira iş yerinde yaptığınız şey hiçbir zaman hobinizin tam karşılığı olmuyor.<br/><br/>mesela yemek yapmak benim hobim. yemek yapmaya bayılıyorum, eskiden boş zaman diye bir şeye sahipken saatlerce mutfaktan çıkmadığım zamanlar olurdu.<br/><br/>fakat microstan peş peşe fişler çıkarken; ızgaranın, salamander'ın, fırının, ocakların sıcağı her bir tarafına vururken; şef tepende bağırırken sipariş çıkartmaya çalışmak bu hobinin tam karşılığı değil ne yazık ki.<br/><br/>ha hala işimi seviyorum, birkaç gün izinde işi özlüyorum, işten çıkınca ne gündü be diyorum ama gün içinde meslek seçimimi sorguladığım zamanlar oluyor.
  entry_channels: moda,eğitim
- entry_name: |
    george r. r. martin
  entry_id:  90310210
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=qq4ytGufb1Q">https://www.youtube.com/watch?v=qq4ytgufb1q</a>
  entry_channels: anket,müzik,edebiyat
- entry_name: |
    sultanahmet camii'ndeki restorasyon skandalı
  entry_id:  90317921
  entry_writer: black adam
  entry_fav_count: 1
  entry_content: |
    haberi okumak yerine sığır gibi foto üzerinden yorum yapanları gösteren, olmayan skandal.<br/><br/>çok biliyorsunuz her şeyi amk. <br/><br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/>restorasyonla ilgili bilgi veren istanbul vakıflar birinci bölge müdürü mürsel sarı, çalışmaların bilim kurulu gözetiminde titizlikle devam ettiğini söyledi, “pencere dediğiniz yerlere biz 'içlik' ve 'dışlık' diyoruz. işte bunları söktük" diyen sarı, "bunlar, 1960'lardan sonra yapılmış ve orijinal olmayan yapılar. sosyal medyada az önce baktık. birisi, '414 yıllık pencereyi ne yaptın' diye soruyor. bu orijinal değil ki. bunlar çimentodan yapılmış donatılar. biz bütün çimentoları yapıdan uzaklaştırıyoruz. çünkü günümüz restorasyon tekniğine zarar veriyor. 14.11.2011 tarihinde bilim kurulu tarafından alınan karar var. bu kararda, 'çimentolu niteliksiz içlik ve dışlıkların sökülmesine' diye karar vermiş. karara göre bir numune yaptık ve restorasyonda bunları yapıya uygulayacağız. şimdi tüm bunları bilmeden sosyal medyada paylaşmak, başta vakıflar çalışanı olarak emeğimize saygısızlıktır. ayrıca bilim heyeti hocalarımızın bilimine ve ilmine yapılmış saygısızlıktır. bakın biz burada çelik platform koyduk, alttaki orijinal döşemelere zarar vermesin diye ahşap takozlar koymuşuz" dedi.<br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    sanki kuşlar hep ötüyor ama etraftaki ses yığını bizim kuşları duymamızı engelliyor gibi de düşünüldüğünde, sahip olduğumuz hengameye apayrı üzülüyorum. <br/><br/>kuşlar ötecek, hava hafif bir serinlikten aydınlığa dönecek. merkez camisinin hopörlerinden titrek bir ses çıkacak. <br/><br/>akmaya başlayacak zaman.
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    fenerbahçe taraaftarının gs'li çocuğa saldırması
  entry_id:  90320036
  entry_writer: servetinsumugu
  entry_fav_count: 1
  entry_content: |
    çocuğa saldırıldığı nerede görülüyor? arabanın içinde çocuk. çocuk dışarıdaki arbededen korkup ağlamış olabilir fakat çocuğa saldırıldı demek manipülasyon değil mi? <br/><br/>hadi onu geçtim fenerbahçeliler oraya galatasaraylıları alsa bunlar "semtinize girdik" diye dalga geçecek. bağdat caddesi'nde kutlama yapmayın kardeşim. gelenektir bu, biz de mecidiyeköy'de yapmayız. adet budur.<br/><br/>beyoğlu cimbomundur diyip bayrak açanlara saldıranlara bak sen. saldırdın mı saldırmadın mı? doğru konuşalım şimdi. 4 mayıs'ta fenerbahçeliler orada bağıra çağıra gezdi sesiniz çıkmadı.
  entry_channels: 
- entry_name: |
...
- entry_name: |
    ysk için gerekçeli karar örneği bırak
  entry_id:  90318034
  entry_writer: gssd
  entry_fav_count: 0
  entry_content: |
    biz reyis için seçimi iptal ettik.gerekçeyi de halk bulsun .<sup class="ab"><a title="(bkz: gerekçe taze bitti)" href="/?q=gerek%c3%a7e+taze+bitti" data-query="gerekçe taze bitti">*</a></sup>
  entry_channels: anket
- entry_name: |
    nickimin ustune tanimam
  entry_id:  90309062
  entry_writer: theredviolin
  entry_fav_count: 0
  entry_content: |
    spoilerlı başlık açarak ezikliğini saklamak ve ilgi toplamak isteyen bir adet gerizekalıdır.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    buraya kadar geldim, nurgül yeşilçay diyeni görmedim. neyse ben demiş olayım yürürken yere bile seksilik damlatan hatunu..
  entry_channels: anket,ilişkiler,moda,magazin
- entry_name: |
    ekmek yok diyen bakkala hiç mi yok demek
  entry_id:  90319137
  entry_writer: the lodger
  entry_fav_count: 0
  entry_content: |
    aynı zamanda <a class="b" href="/?q=kim+o">kim o</a> sorusuna <a class="b" href="/?q=ben">ben</a> diye cevap veren insandır.
  entry_channels: 
---
