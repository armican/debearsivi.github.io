...
- entry_name: |
    lord eddard stark uçurulmadıkça sözlüğe yazmıyoruz
  entry_id:  74580247
  entry_writer: attolos
  entry_fav_count: 144
  entry_content: |
    siz hala fetocu furkiyi mi takip ediyorsunuz?<br/>(bkz: <a class="b" href="/?q=engelle">engelle</a>)<br/>(bkz: <a class="b" href="/?q=ba%c5%9fl%c4%b1klar%c4%b1n%c4%b1+engelle">başlıklarını engelle</a>)
- entry_name: |
...
- entry_name: |
    ekşi sözlük'ten alınan ilk maaşla yapılanlar
  entry_id:  74583490
  entry_writer: metrobuste yer kapan muhendis
  entry_fav_count: 65
  entry_content: |
    metrobüs aldım. saat başı zincirlikuyudan kalkıyor. sadece premium üyeliği olanlar binebiliyor. bazen diyorsunuz ya hani "ya bomboş gidiyor niye durmadı durakta" aha o metrobüste biz varız. teşekkürler ekşi.<br/><br/>kızgın edit: beddua mı ettiniz naptınız. oturduğum koltuk ıslaktı. götüm ıslandı.
- entry_name: |
...
- entry_name: |
    çukur (dizi)
  entry_id:  74575729
  entry_writer: bunickdemikullanimda
  entry_fav_count: 14
  entry_content: |
    --- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>bu cemil ilerleyen bölümlerde hem selim hem de ayşe'yi, karı-koca ikisini de bafileyecek gibi ama bakalım hayırlısı <br/><br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    merak etmeyin kime gülüp kiminle eğleneceğini iyi biliyordur.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    selda bağcan mütevazı konuşsa samimiyetsizlik etmiş olur.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    cep telefonlarına getirdiği ekstra vergi yükü.!<br/>bir de aşırı derece de yüzsüz olmaları. herşeyi sağdan soldan topla , montaj bandında birleştir, sonra da <a class="b" href="/?q=yerli+ve+milli">yerli ve milli</a> de. yersen tabi....
- entry_name: |
    erdoğan küpeli
  entry_id:  74571736
  entry_writer: karadutveyahutcingene
  entry_fav_count: 1
  entry_content: |
    ben de bunun gibi organizmalarla karşılaşmıştım . henüz 16- 17 yaşındaydım . benim yardımcı olacak kimsem yoktu. korkudan zangır zangır titrediğimi bilirim . başlığı yukarda tutalım ki bunun gibiler cesaretlenmesin .
- entry_name: |
