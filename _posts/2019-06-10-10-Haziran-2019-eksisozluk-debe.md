...
- entry_name: |
    imamoğlu 23 haziran'da 200bin farkla kaybedecek
  entry_id:  91066991
  entry_writer: eksi peace
  entry_fav_count: 84
  entry_content: |
    işsizlerin binali yıldırım’a oy vermesi ne büyük ironi yarabbim.<br/><br/>kaynağı göt olan iddia.
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    astronot cesedinin başka gezegene yaşam götürmesi
  entry_id:  91078995
  entry_writer: imamihanife
  entry_fav_count: 45
  entry_content: |
    insan cesedine ne gerek var. <br/><br/>götür oraya 5 tane suriyeli aile, 5 senede o gezegene koloni kurarlar.
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    ankara'nın overrated bir şehir olması
  entry_id:  91076584
  entry_writer: xcode
  entry_fav_count: 17
  entry_content: |
    bir ankaralı olarak ne zaman rated idi de hangi ara over oldu diye merak ettiğim önermedir<br/><br/>not: başlık başıma kalmış.
  entry_channels: tarih,seyahat
- entry_name: |
    sadece alkol alınca mutlu olabilmek
  entry_id:  91064845
  entry_writer: ofis canlisiyim multinetle beslenirim
  entry_fav_count: 13
  entry_content: |
    alkol almadan hayatin ne kadar sikici, yapilan tum aktivitelerin bos ve gerekesiz oldugu sanrisi.<br/><br/>dunya ve insanlara ayikken katlanabilme ihtimalinin cokca dusmesi. cogu insan kabul etmez ama gercekler maalesef ki acidir.
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    (bkz: <a class="b" href="/?q=dede">dede</a>) <br/><br/>sayıca fazla insana dokunmuş kişilerin ölümü belki o toplum için bir karanlık olmuş olabilir.<br/>fakat bir çocuğun minicik kalbine büyük sevgiler koyan bir dedenin ölümü diğer çoğunluğun yanında çok fazla değerlidir.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    bir yandan nihat özdemir - aziz yıldırım fotoları,<br/>bir yandan bakanlarla olanlar, <br/>bir yandan bankalarla borç yapılandırmak zorunda olduğu için hükümetin ağzına bakması..<br/><br/>bir gs'li olarak bu kurtlar sofrasından nasıl çıkacak merak ettiğim kişi. adamın harbi harbi üzerine gidiliyor. ben olsam yeter be diyip basar istifayı kanarya adalarında tatilimi yapardım.
  entry_channels: spor,siyaset,ekonomi
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    para ve iktidar için herşeyi yapabilen bir insan dünyanın ne tehlikeli insanları arasındadır.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    o kadar gerizekalisiniz ki oyle boyle yapa yapa adami kahraman yaptiniz. hepsi sizin sayenizde oldu. bu adama 1 nisan sabahi mazbatasini verseydiniz belki de simdi kimse imamoglundan bahsediyor olmayacakti. caldi dediniz, pontus dediniz, televizyonda konusturmadiniz, elinden mazbatasini aldiniz, simdide vip olayi. adam sizin sayenizde belki de insanlara umut oldu. iyi de oldu.
  entry_channels: 
- entry_name: |
    hoşlanılan erkeğe açılmamak
  entry_id:  91079447
  entry_writer: slippery nipple
  entry_fav_count: 0
  entry_content: |
    ben yaptım bunu zamanında sanki küfür etmişim gibi yüzüme baktı sonra da hayır dedi.
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    erkeklerde yaygın yanılgılardan birisi olan bir duruma dair sebeptir.<br/><br/>30'u geçen erkekler piyasada rağbet gören bir ürün değil. çoğunuz anca otuzları geçince hayattaki pek çok meselenizi az halledip yontulmuş oluyorsunuz ve haliyle de kadınlarla işiniz daha bir yolunda gitmeye başlıyor.<br/><br/>karşı cins meselelerinde olay yaş meseleleri değildir, neye sahip olduğunuzdur. sahip olunması gerekenlere kimi 20'lerinde sahip olur kimi otuzlarında... kimi ne otuzlarında ne kırklarında.
  entry_channels: anket,ilişkiler
---
