...
- entry_name: |
    rte'den önce akıllı telefonu olmayan türbanlı bacı
  entry_id:  91047954
  entry_writer: agzinda sigarayla kavga ayiran adam
  entry_fav_count: 156
  entry_content: |
    yalan mı arkadaşım?<br/><br/>bu millet akıllı telefonla akp döneminde tanıştı.<br/><br/>rte'den önce imax teknolojisi de yoktu. benim başörtülü bacılarıma 2d filmler izlettiler.<br/><br/>3 mayıs 1999 tarihini hatırladınız mı? hatırlamazsınız tabi ya kahhar, siz o sırada bankamatik kuyruğunda para çekiyordunuz. cepten bankacılık işlemleri yoktu çünkü.neyse ki para zamanında yetişti de fayt kılaba bilet alabildik.
...
- entry_name: |
  ...
  entry_fav_count: 23
  entry_content: |
    (bkz: <a class="b" href="/?q=%c5%9feyma+suba%c5%9f%c4%b1">şeyma subaşı</a>)<br/>sen tam olarak kimsin ya?
  entry_channels: 
- entry_name: |
    rafael nadal
  entry_id:  91053113
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    bu mezhepçi kafatasçı gerizekalıların temizliği için uzman doktor beşar esad beyfendilerinin yanında olmamız gerekiyor iken bu pislikleri beslememiz ayrı bir ayıp.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    yarım saat kadar önce haklı olarak sinirlensem de bir arkadaşını kırarak örneğini gösteren kişi olarak ben. huyuma s.okayım. aynı b.ku yeyip yeyip sonra pişman olarak insanlardan özür dilemekten ben usandım. bir tahtaya çaktığın çivileri sonradan sökünce delikler de orada kalıyor üstelik. ama inşallah törpüleyeceğim bu kötü özelliğimi.<br/>küfürler için kusura bakmayın.
  entry_channels: anket,ilişkiler
- entry_name: |
