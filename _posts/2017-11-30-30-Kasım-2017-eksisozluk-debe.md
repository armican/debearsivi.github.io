...
- entry_name: |
  ...
  entry_fav_count: 341
  entry_content: |
    biz mağaza görevlileri olarak arada müşteri taklidi yapıyoruz ondandır, her gün yüzlerce kişiyle kim ilgilenecek amk.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 54
  entry_content: |
    arkasına türk bayrağı koyarak amerika ajanı aklanmışlığı vardır<a rel="nofollow noopener" class="url" target="_blank" href="http://odatv.com/images/resimler/hqdefault(1).jpg" title="http://odatv.com/images/resimler/hqdefault(1).jpg">.</a><br/><br/>ajan olduğu ise burhan kuzu'ya göre devletçe biliniyormuş. <br/>(bkz: <a class="b" href="/entry/72461598">#72461598</a>)<br/><br/>derhal hesap sorulmalıdır.
- entry_name: |
    egemen bağış
  entry_id:  72478782
...
- entry_name: |
    hırvat generalin mahkemede zehir içmesi
  entry_id:  72471985
  entry_writer: ah minel aski ve halatihi
  entry_fav_count: 18
  entry_content: |
    atalarına özenmişse.<br/><br/>(bkz: <a class="b" href="/?q=adolf+hitler">adolf hitler</a>)<br/>(bkz: <a class="b" href="/?q=heinrich+himmler">heinrich himmler</a>)<br/>(bkz: <a class="b" href="/?q=joseph+goebbels">joseph goebbels</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    ahımın rüzgarı üşütür seni <br/><br/>benden başkasına ısınamazsın <br/><br/>yorgun şarkılarda anarsın beni <br/><br/>öyle kolay değil unutamazsın <br/><br/>unutamazsın <br/><br/>-unuturum diye yorma kendini-
- entry_name: |
    devlet bahçeli
  entry_id:  72461531
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    burada referans linki verenler dolandırıcılık yaptıkları için sözlükten uçurulmalıdır. net.
- entry_name: |
    btcturk
  entry_id:  72476414
  ...
  entry_fav_count: 1
  entry_content: |
    eveeet, bir kez daha türkiye'de bu tarz işler neden yapılmaz anlamama sebep olmuştur. stop emrini geçmiş, limit emrini geçmiş, şimdi de bakiyemde para olmasına rağmen satmama izin vermiyor, başka cüzdana atmama izin vermiyor, bakiyem 0 gibi davranıyor. var mı bu sorunu yaşayan başka biri?
- entry_name: |
    istanbul new york londra paris tokyo
  entry_id:  72482246
  entry_writer: yetkili bi abla
  entry_fav_count: 0
  entry_content: |
    e) hepsinin yazılı olduğu ucuz nevresim takımı.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    seksine baglidir. <br/><br/>bazen guvenlik kulubesine gidip ahmet abiyle sohbet etmek istedigim oluyor.<br/><br/>bazen keske hayatim su an bitse de en guzel yerinde olsem dedigim oluyor.
- entry_name: |
    aktif bank
  entry_id:  72476966
