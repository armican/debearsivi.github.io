...
- entry_name: |
    29 kasım 2017 çevre bakanlığı deprem uyarısı
  entry_id:  72472013
  entry_writer: bilinmeyene kosan adam
  entry_fav_count: 172
  entry_content: |
    ''tedbir alacagiz'' degil de ''tedbir almamiz gerekiyor'' denilmis. sanirim bize soyluyor.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 115
  entry_content: |
    evladım gerizekalı mısınız? <br/><br/>mevzu bahis belgeleri savcılığa verince ne olacak? belgelerdeki finansal hareketlerin hukuken bir yaptırımı yok ki.<br/><br/>ancak dünyanın her yerinde bu işlemler, hele de devleti yönetenlerin en yakınları tarafından yapılıyorsa etik değildir. utanç kaynağıdır, istifaya vesiledir.<br/><br/>ha bunlarda utanma, arlanma olmadığı için zaten böyle bir aksiyon beklenmez de, onun yerine eşek gibi anırıyorlar "sahteee bu belgeleeer"..<br/><br/>e dava açtın işte. iftira davası. hani açtıysan, orda iddia makamına sunulur bu belgeler "bakın iftira değil, aha da belgesi" diye.<br/><br/>nedir bu acelen kuzum? madem belgeler sahte, neyin merakında, telaşındasın?
- entry_name: |
...
- entry_name: |
    abd mahkeme tiyatrosu
  entry_id:  72480844
  entry_writer: kafayi kurtaran adam
  entry_fav_count: 91
  entry_content: |
    adamın iyi kötü bi mahkemesi var yeğen, sende artık o da kalmadı.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 75
  entry_content: |
    ''zulm ile âbâd olanın, âkıbeti berbâd olur.''<br/><br/>ziya paşa
- entry_name: |
    a haber
  entry_id:  72478188
...
- entry_name: |
  ...
  entry_fav_count: 29
  entry_content: |
    85 bin nüfuslu bir ada ülkesine, gerçekten ticaretle 5 milyon dolar gibi bir para soksan, adaya senin altından heykelini yapar sabah akşam sütle o heykeli yıkarlar. ada sakinlerinin tanrısı gibi bir şey olursun. afrikadan deve ithal edip senin onuruna her gece bir tane keserler. <br/><br/>bakkalındaki sakızdan, kilisesinin vitraylarına kadar her şeyi söküp satsalar o kadar para etmez lan. kimle neyin ticaretini yaptınız. vergi kaçırmak dışında hangi amaçla o paralar oralara gitmiş olabilir. keşke cevap verseniz de kıvırmanızı izleyip biraz daha gülsek.
- entry_name: |
    29 kasım 2017 boğaz köprüsünün trafiğe kapatılması
  entry_id:  72481191
  entry_writer: oric
  entry_fav_count: 29
  entry_content: |
    (bkz: <a class="b" href="/?q=t%c3%bcrkiye+g%c3%bcndeminin+uzay+zaman+d%c3%bczlemini+b%c3%bckmesi">türkiye gündeminin uzay zaman düzlemini bükmesi</a>)
- entry_name: |
  ...
  entry_fav_count: 26
  entry_content: |
    size bir sır vereyim. insanların ömrü uzadı ve yaş kriterleri değişti.<br/>0-14 yaş arası çocuk<br/>15-17 yaş arası ergen<br/>18-55 yaş arası genç<br/>56-75 yaş arası orta yaş<br/>76 üstü yaşlı kabul ediliyor.<br/>siz ekici piçler en iyisini bilirsiniz tabi.
- entry_name: |
    bitcoin
  entry_id:  72460245
...
- entry_name: |
    wingsuit uçuşu ile uçağın içine atlamak
  entry_id:  72473243
  entry_writer: the spirit of olguness
  entry_fav_count: 18
  entry_content: |
    (bkz: <a class="b" href="/?q=am%c4%b1na+kodumun+zenginleri">amına kodumun zenginleri</a>)
- entry_name: |
...
- entry_name: |
    dolma'nın çok abartılması
  entry_id:  72475676
  entry_writer: exfreak
  entry_fav_count: 8
  entry_content: |
    "ben dolmayı sevmiyorum" - başlıklarda ara - dolmanin çok abartilmasi - hede hödö enter<br/><br/>aferin.
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    insanlar önemsemeyecek diye bir kenara bırakılmaması gereken fikir. <br/><br/>hiç bir şey yapılamıyorsa siyah beyaz çıktısını alıp kargo bandıyla elektrik direklerine bile yapıştırılabilir. <br/><br/>bu millete benim güvenim kırılmış olabilir, senin güvenin de kırılmış olabilir; ama atatürk bu millete güvenerek bu ülkeyi kurdu. belki de güvenmek lazım.<br/><br/>bugün belgelerle alakalı rte'yi ve şürekasını aklayıcı yaygara koparanların tümü maaşlı trolldür veya akp'den çıkarı olan insanlardır. <br/><br/>türkiye cumhuriyetinde sadece saf duygusuyla, dini bakış açısıyla akp'ye oy atan bir sürü insan var. haberleri olması lazım. en azından böyle bir şeyden haberleri olması lazım. trt nin yayını kestiği, atv nin vs. hiç bir şey açıklanmadı dediği ortamda, insanları bilgilendirmek gerçek vatandaşlık borcu olabilir. <br/><br/>a4 e çıktısını al. bankta unut. metroda unut. otobüste unut. yere at. direğe yapıştır. yap. kapı kapı dolaşmıyorsan bunu yap. yapabilirsin; o zaman durma.<br/><br/>çıktısı alınabilecek görsel; <a rel="nofollow noopener" class="url" target="_blank" href="https://pbs.twimg.com/media/DPuLNbQWsAAQMcO.jpg">https://pbs.twimg.com/media/dpulnbqwsaaqmco.jpg</a>
- entry_name: |
    reza zarrab davası sonrası yaşanacaklar
  entry_id:  72480485
  entry_writer: galektersiz
  entry_fav_count: 7
  entry_content: |
    simdiden soyleyelim de sonra laga luga yapilmasin.<br/><br/>espri kasacaklar, bisey olmayacakcılar, sabaha unutulurcular siktirsin gitsin. basliga adim dahi atmasin
- entry_name: |
    ebru gündeş
  entry_id:  72472324
  ...
  entry_fav_count: 6
  entry_content: |
    özel jetle gittiği miami'den thy'nin tarifeli uçağıyla dönen insan olarak bütün hikayenin en acıklı rolünü üstlenmiştir. <br/><br/>gül gibi şarkıcısın, paran var, seviliyorsun be güzelim. senin bu hikayede ne işin vardı? niye bu kadar açgözlüsünüz hepiniz?
- entry_name: |
    halk bankası
  entry_id:  72480842
  entry_writer: heil
  entry_fav_count: 3
  entry_content: |
    sınavına hazırlandığım banka.<br/><br/>forex şirketlerine başvurdum spk mevzuatı değiştirdi, bunun sınavına başvurdum, uluslararası kriz çıkardı. kpss'ye girsem işgal ediliriz herhalde. şansımı sikeyim.
- entry_name: |
    devlet bahçeli
  entry_id:  72461531
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    siteyi kapatip vurgun yapmamak icin bir sebepleri yok. daha sitenin ne yaptigini bilmeden, 2 ghz mhz gordunuz diye "cloud mining" diyorsunuz, ustune birilerini de sisteme dahil etmeye calisiyorsunuz, etmeyin amk. <br/><br/>adamlarin cuzdaninda su anda 28 btc <a rel="nofollow noopener" class="url" target="_blank" href="https://blockchain.info/address/3BTiBAEjmsP6aAkECJjb7qmqCT1srYesM9" title="https://blockchain.info/address/3BTiBAEjmsP6aAkECJjb7qmqCT1srYesM9">var</a>. su anda siteyi kapatip gitseler kimsenin gikini cikaramayacagi 280.000 dolar yani. alti ustu bir <a class="b" href="/?q=hyip">hyip</a> sitesi, her hafta biri acilir digeri kapanir. bir de "guvenilir, sade, mining bu iste" diye savunuyorsunuz, yuregime yumru oturuyor yapmayin. ya da yatirin buraya birikiminizi, dogal seleksiyon islesin biraz.
- entry_name: |
    cüneyt özdemir
  entry_id:  72463688
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    <a class="b" href="/?q=halk+bank">halk bank</a>'la yırtacaklar sanıyorduk, <a class="b" href="/?q=aktif+bank">aktif bank</a>'la açılış yaptı adam resmen. yandı gülüm <a class="b" href="/?q=passolig">passolig</a>ler.<br/><br/>(bkz: <a class="b" href="/?q=29+kas%c4%b1m+2017+reza+zarrab%27%c4%b1n+tan%c4%b1k+ifadesi">29 kasım 2017 reza zarrab'ın tanık ifadesi</a>)
- entry_name: |
    45 milyon euro
  entry_id:  72479493
  ...
  entry_fav_count: 0
  entry_content: |
    750.000 euro’dan 60 tane saat alınır.
---
