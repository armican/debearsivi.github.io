...
- entry_name: |
  ...
  entry_fav_count: 98
  entry_content: |
    "çocukların kumbarasındaki paraya talip olanlar ile çocukların kumbarasına para koyanlar eş değer görülüyor. ben bu sözlerle hocamı bir kez daha selamlamak istiyorum. dante'yi bilirsiniz. ilahi komedya'yı yazdı. yaşasaydı bunu yeniden yazardı." diyerek yalı çocuğu vizyon reisi üzen nizip lordu. <br/><br/>seni savunacağız.<br/><br/>edit: 6622'den ceza alacak ilk kardeşimiz de başlığı altında debeleniyor. <a class="b" href="/entry/92379386">#92379386</a> önce egm'ye sonra da galatasaray idare kadrosundaki baş hukuk müşaviri petek arslan hanımefendiye direkt mail attım. geçenlerde bir twitter kullanıcısının 1 saat içerisinde toz olmasına rağmen açılacak davanın haberini yusuf günay vermişti :) küfür etmeden, efendice fikir beyan etmeyi böyle böyle öğreteceğiz size. nizip lordu'nun yaptığı gibi...<br/><br/>edit2: entryi düzenlemeye çalışmış einstein arkadaşımız. bak ne var burada... <br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://eksiup.com/p/u649526jg9sr">https://eksiup.com/p/u649526jg9sr</a>
  entry_channels: spor
- entry_name: |
    emre mor
  entry_id:  92374765
...
- entry_name: |
    sırf zengin diye 45 yaşında adama yazan 20'lik kız
  entry_id:  92365710
  entry_writer: bibakhele
  entry_fav_count: 63
  entry_content: |
    ülkedeki maddi gidişatı, genç işsizlik oranını, düşen eğitim seviyesini göz önünde bulundurunca sayıları her gün daha da artacak olan kız modelidir.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://eksiup.com/p/r849506n4x6v">https://eksiup.com/p/r849506n4x6v</a>
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    kartallar 2 tane yumurtlar. yumurtadan çıkan yavrular bir süre sonra liderlik savaşı verir ve güçlü olan hayatta kalır. yani sürekli iyi genlere sahip güçlü kartal yaşar.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    yalnız başlık altındaki bjk’lilerin “acaba mı lan?” hevesiyle, ve fb’lilerin “öyle olmuyor o işler, kupayla alakası yok o işin, yok yok hiç şe’yapmayın” tedirginliğiyle yazdıklarını okumak epey eğlenceliymiş..<br/><br/>bu topa giren fb’liler büyük hata yapıyorlar tabi ayrı konu da kime diyorsun<sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
  entry_channels: spor,anket
- entry_name: |
    balenciaga giymemiş yazarlar veritabanı
  entry_id:  92360180
  entry_writer: venusteki limon agaci
  entry_fav_count: 3
  entry_content: |
    ömrümde gördüğüm en yarrak kürek bu ayakkabının fiyatı mesela 250 lira olsa, piyasada bunu giyen ne kadar soft türkücü tipli yaşından 20 yaş büyük gösteren abla ya da paralı ancak fotoğraflarından bile ayak kokusunu hissettirebilir zengin keko varsa bırakın giymeyi giyeni aşağılarlardı. <br/><br/>kabul edilme nesneleri ve zengin göstersin diye alınan/giyilen/binilen her şey sizi yürüyen bir köy peynirine çevirirken bu ayakkabılar sizi paletle yürüyen devasa bir köy peynirine çeviriyor. sad but true, nesneyle sınıf atlamaya çalışan orta sınıfın üst tabaka kekoları. öpücükler.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    gungoren koyici cocuguyum, 6-7 sene evvel bir dostumu goturdum, o zaman bana kirli bardakta nescafe icmek icin 5 lira veriyorsun bu iyiymis iyi ki getirdin beni buraya demisti. fikri degismediyse starbucks iyidir fakat turkiye’de bunun isletmesini shaya denilen arap sermayesi yapiyor, sikik araba bosa para kazandirmayin, gidin baska bir yerde icin kahvenizi
  entry_channels: anket,yeme-içme
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    satan bir yer bulabilirsek, konya'da ben varim. olmadı elma içeriz.
