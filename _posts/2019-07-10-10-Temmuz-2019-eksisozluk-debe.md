...
- entry_name: |
  ...
  entry_fav_count: 618
  entry_content: |
    her yıl 1.3 milyar ton gıda israf ediliyor.<br/>dünyada 124 milyon çocuk ve ergen obez.<br/>üretilen meyve ve sebzenin yüzde 50'si çöpe gidiyor.<br/>gıda israfı ,iklim değişikliğe sebep olan en büyük 3.etken . bugün neredeyse 1 milyar kişi aç . etin yüzde 20'si, deniz ürünlerinin yüzde 35'i israf ediliyor . sera gazı emisyonlarının yüzde 8'i gıda israfından kaynaklanıyor .gıda israfı her yıl 990 milyar dolara mal oluyor.<br/>düzeltme : bir kaç etken madde daha eklenmiştir .<br/><br/>teşekkürler.
...
- entry_name: |
  ...
  entry_fav_count: 216
  entry_content: |
    (bkz: <a class="b" href="/?q=%c5%9fu+makarnayi+yemeyin+art%c4%b1k+yemeyin">şu makarnayi yemeyin artık yemeyin</a>)
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 92
  entry_content: |
    6 - şampiyonlar ligi tarihinde bir maçta en çok gölü yiyen takım. (8 gol)
  entry_channels: spor
- entry_name: |
    mustafa cengiz
  entry_id:  92379387
...
- entry_name: |
  ...
  entry_fav_count: 64
  entry_content: |
    (bkz: <a class="b" href="/?q=adana">adana</a>) valla çok medeni bi şehir. <br/><br/>2 gündür buradayım önüne gelen kebap ısmarlıyor.
...
- entry_name: |
    ahmet hakan'ın rte'nin uçağında verdiği poz
  entry_id:  92385516
  entry_writer: boya takintisi olan adam
  entry_fav_count: 36
  entry_content: |
    yüzyılın ikinci topacının verdiği değersiz bir pozdur.<br/>ayrıca fotoğrafa bakınca yoğun bir ağız kokusu alıyorsunuz.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 26
  entry_content: |
    tayyip erdoğan bir yıkım projesidir. onun ülkenin başında bulunduğu her saniye ülke çöküşe büyük bir hızla ilerlemektedir<br/><br/>tanım: tayyibin ensarını, allah ve peygamber sevdalısı suriyeliyi içeren başlık<br/><br/>saygılar, hayırlı işler
  entry_channels: haber
- entry_name: |
    aslen selanikliyiz
  entry_id:  92375783
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    9 temmuz 2019 abd'nin ankara'ya nota vermesi
  entry_id:  92387305
  entry_writer: post translational regulation
  entry_fav_count: 11
  entry_content: |
    espri yapmasınız olmaz mı? konu ile ilgili bir yorum okuyalım bir şeyler öğrenelim diye geliyoruz sizin mal mal esprileriniz yüzünden zehir oluyor sözlük.
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    don kişot<br/><br/><a class="b" href="/?q=ka%c3%a7%c4%b1p+evden+uzaklara+%c5%9fehre+gidelim+aylak+aylak">kaçıp evden uzaklara şehre gidelim aylak aylak</a>
  entry_channels: anket,müzik
- entry_name: |
    milli eğitim sisteminin sorunları
  entry_id:  92385687
  entry_writer: lingincin
  entry_fav_count: 9
  entry_content: |
    milli eğitim sistemimizin hangi yönüne baksak elimizde kalıyor. tek merkezden yönetilen devasa büyüklükteki koca yapı her yerinden tel tel dökülüyor. hiç konuşulmayan ve yok sayılan zorunlu-kitlesel eğitimin yapısal sorunlarını ayrı tutarak şu sorun alanlarını ilk anda sıralayıverelim: <br/><br/>aylardır sürekli takvimi değişen ve bir türlü becerilemeyen, nihayet geçen hafta yapılabilen yönetici atama…<br/><br/>öğretmenini asgari ücretin altında çalıştırdığı ücretli öğretmenlik…<br/><br/>aile mefhumunu yok sayan sözleşmeli öğretmenlik… <br/><br/>yasada işveren lehine yapılan değişiklik nedeniyle özel okul öğretmenlerinin asgari ücretle sömürüye açık hale getirilmesi…<br/><br/>öğretmen maaşlarının en düşük memur maaşı haline gelmiş olması…<br/><br/>atama bekleyen yüz binlerce öğretmenin yaşadığı mağduriyet…<br/><br/>‘’paydaş sendikanın’’ okullara ve taşra teşkilatlarına yönetici atamadaki etkisi ve kadrolaşma merakı, mülakat adaletsizliği…<br/><br/>değiştirilen liselere giriş sisteminin içinden çıkılamaz hal alması ve verdiği büyük zarar…
  entry_channels: eğitim
- entry_name: |
    türk ordusunun 1933'teki askeri geçit töreni
  entry_id:  92385719
  entry_writer: barbar savasci
  entry_fav_count: 8
  entry_content: |
    savaşlardan harap bitap düşmüş ve kurulalı daha 10 yıl olmamış bir ülkenin askerlerinin geçit töreni. şahsen yürüyüşteki disiplini nizam ve intizamı görünce çok şaşırdım. bu kadar düzenli beklemiyordum. atatürk harbiden kısa zamanda çok ve büyük işler başarmış.<br/>şu an silahlı kuvvetlerde bu şekil düzgün yürüyebilecek bir birlik maalesef yoktur.<br/>kapatılmadan önce harbiye ve askeri liseler ancak böyle yürüyebilirdi belki. şimdi oralarda askerlikten daha çok cuma namazını hangi cemaat kıldıracak kavgası var. askeri liseler mi? onlar çoktan kapatıldı.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  92384669
  entry_writer: enantiodromia
  entry_fav_count: 7
  entry_content: |
    "kadını götürüp mutfağa ya da süsleme odasına kapatıyor, sonra da ufkunun darlığına şaşırıyoruz; kanatlarını kesiyor, sonra da uçamıyor diye yakınıyoruz."<br/>simone de beauvoir<br/><br/>simone de beauvoir'dan haberi olmayan dolayısıyla varoluşçu felsefeyi duymayanların yaptığı çıkarımdır.
...
- entry_name: |
  ...
  entry_channels: ilişkiler,bilim,haber
- entry_name: |
    adana'nın ülke dışına taşan bankamatikçileri
  entry_id:  92386804
  entry_writer: babamukuru
  entry_fav_count: 4
  entry_content: |
    al kardeş, <a class="b" href="/?q=adana+b%c3%bcy%c3%bck%c5%9fehir+belediyesi">adana büyükşehir belediyesi</a>nin resmî sitesinden yapılan duyuru: <a rel="nofollow noopener" class="url" target="_blank" href="http://www.adana.bel.tr/versiyon4/azerbaycandan-bankamatikci-tespit-edildi/" title="http://www.adana.bel.tr/versiyon4/azerbaycandan-bankamatikci-tespit-edildi/">haysiyetsiz biatçılara şok</a>. bilip bilmeden ahkam kesmeyin artık ulan! kandilmiş!!! sensin kandil mensubu. sensin terörist! apo denen katilden medet uman biz değiliz! sensin!<br/><br/>edit: vur zeydan başkan!
  entry_channels: haber
- entry_name: |
    çakmak isteyince yakıp uzatan tip
  entry_id:  92386414
  entry_writer: cardinental
  entry_fav_count: 2
  entry_content: |
    amk bu kadar rahatsız oluyorsanız gidin 1 tane çakmak alın milletten ateş istemeyin sizde.<br/><br/>adam belki kibarlık yapmaya çalışıyor hemen aklınıza ibnelik geliyor.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    amına koduğum bucasından +1'imle katıldığım veritabanı.
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    güzel evinç yardım kampanyası
  entry_id:  92386891
  entry_writer: sarcastic robot
  entry_fav_count: 1
  entry_content: |
    aradigi yardimi bulabilir umarim. bu tur durumlarda devletin yetisemedigi yerlerde islevsel bir kitlesel fonlama imkani veya bir kurulus olsa diye dusunmuyor degilim.
