...
- entry_name: |
    khk'lıların seçme hakkı olmamalı
  entry_id:  89035428
  entry_writer: zerdest
  entry_fav_count: 151
  entry_content: |
    arttırıyorum, yaşlıların da olmamalı. belki "tayyibe vermeyecez kime verecez? aleviye mi" diyen tonton dedelerin, teyzelerin elinden oy hakkı alınır da huzura ereriz.<br/><br/>(bkz: <a class="b" href="/?q=ahmet+t%c3%bcrk+ya%c5%9fl%c4%b1+mazbatay%c4%b1+bize+verin">ahmet türk yaşlı mazbatayı bize verin</a>)
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 31
  entry_content: |
    belediye çalışanlarının, hizmeti belediye başkanına yaptığını sanan gerizekalı vatandaş yorumu.<br/><br/>zihniyetin böyle ise siktir git zaten.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    google.com &gt; az bilinen ressamlar ve eserleri &gt; yapıştır
  entry_channels: anket,sanat
- entry_name: |
    imamoğlunun mazbatayı alınca söyleyeceği ilk söz
  entry_id:  89045232
  entry_writer: drgoku
  entry_fav_count: 9
  entry_content: |
