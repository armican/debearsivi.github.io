...
- entry_name: |
  ...
  entry_fav_count: 22
  entry_content: |
    buyurun benim. çok da abartılacak bir şey değil bence.<br/>tanım: yine kadınlarla ilgili bir başlık.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    bu yıl 50 kilo vererek yapacağım eylem.<br/><br/>bu hafta ilk 2yi verdik. hadi bakalım...
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    bu seçim yok hükmündeymiş diyor yandaş cem.<br/>insanda azıcık utanma olur.<br/>mühürsüz oylarla kazandığınız seçim esas yok hükmünde, unutma. bunu diyen de sami selçuk. ayakkabısının altındaki toz olamayacağın sami selçuk.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    seçimle gelebileceği bir işe atılması.
  entry_channels: 
- entry_name: |
    çaylaklardan mesaj bekleyen yazarlar veritabanı
  entry_id:  89055054
  entry_writer: kakaolucikolat
  entry_fav_count: 0
  entry_content: |
    bizzat benim de bulunduğum veritabanıdır. fantastik kıyafetler giymeyi seven, minik memeli kalın belli şirin kızları bekliyorum. yer istanbul.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    dolar alıp terste kalmış gibiyim.
  entry_channels: anket
- entry_name: |
    thy take-off 2019
  entry_id:  89063075
  ...
  entry_fav_count: 0
  entry_content: |
    445 puan ile geçemediğim sınav.<br/><br/>sağlık olsun.
  entry_channels: eğitim,havacılık
- entry_name: |
    17 nisan 2019 teşekkürler afişlerinin sökülmesi
  entry_id:  89063746
  entry_writer: başlık taşıyan
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=te%c5%9fekk%c3%bcrler+istanbul+afi%c5%9flerinin+s%c3%b6k%c3%bclmesi">teşekkürler istanbul afişlerinin sökülmesi</a>)
  entry_channels: siyaset,haber
---
