...
- entry_name: |
  ...
  entry_channels: siyaset
- entry_name: |
    evlerdeki sürpriz bubi tuzakları
  entry_id:  89025347
  entry_writer: kekremsibirtat
  entry_fav_count: 102
  entry_content: |
    evde çocuk varsa, bu tuzağın adı legodur. üzerine bastığım anda ibrahim tatlıses tarafından topuğuma sıktırılmış gibi sekiyorum evin içinde.
  entry_channels: anket
- entry_name: |
    buket aydın
  entry_id:  89046121
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    binali yıldırımın en büyük hatası
  entry_id:  89061926
  entry_writer: cerlo
  entry_fav_count: 12
  entry_content: |
    meclis başkanlığı gibi onurlu ve ülkenin en gururla taşınması gereken unvanlarından birini bırakıp bir şehre belediye başkan adayı olmasıdır. <br/><br/>yaptığı sadece kendi şahsına değil, o makama da saygısızlıktır.
  entry_channels: 
- entry_name: |
...
- entry_name: |
    21. yüzyılda hala klasik müzik dinleyen insan
  entry_id:  89056467
  entry_writer: lateralus 85
  entry_fav_count: 6
  entry_content: |
    22. yüzyılda da dinlenmeye devam edecektir ama senin dinlediğin sikimsonik müzikler çoktan unutulmuş olacaktır.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    aklıma etraflarında hiç mi kadın yok diye deli sorular geliyor bu başlığı okuyunca. neleri merak ediyorsunuz siz öyle ya
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    yazarların şu anki durumunu anlatan en iyi cümle
  entry_id:  89062427
  entry_writer: niveyasi
  entry_fav_count: 0
  entry_content: |
    kendi kulemde oturmus yeni diyarlari fethetmek icin planlar yapiyorum, bir yandan da korkuyorum. sinirlarimi genisletiyorum yavas yavas, calisiyorum. tek basimayim.
  entry_channels: anket
---
