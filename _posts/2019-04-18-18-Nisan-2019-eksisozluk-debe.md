...
- entry_name: |
  ...
  entry_fav_count: 22
  entry_content: |
    belediye meclis toplantılarını halka açmış. çok fena göt yakıyor 1 haftadır. nerede rantçı, beleşçi biatçı var kan alıyor kan. çok seviyoruz seni mansur başkan.
  entry_channels: siyaset
- entry_name: |
    game of thrones
  entry_id:  89036448
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    dertleşmek demeyelim de...<br/><br/>hasta olan ve çok sevdiğim birinin sağlığına tekrar kavuşması adına, rica etsem, inandığınız şey üzerine dua eder misiniz?<br/><br/>soru ya da cevap beklemiyorum, sadece iyi ve saf hislerle duanızı talep ediyorum.<br/><br/>çünkü önünde daha çoook uzun bir yolu var yürümesi gereken.<br/><br/>teşekkürler.
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    erkeğin sakalındaki bakterileri köpeğinkilerle kıyaslamayı akıl etmiş isveçli bilim adamlarını ve norveçli balıkçıların ellerini soğuğa karşı korumayı dert edinebilmiş norveçli bilim adamlarını tebrik etmemiz gereken tespit. <br/>dünya sizinle güzel bir yer oluyor.<br/><br/>zahmet olmazsa kansere de birara bakıverseniz boş vaktinizde, saygılar abi.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    spotifyda her zaman klasik müzik dinlerim ve yenilerini keşfetmeye çalışırım. bunda ne gibi bir sorun olduğunu açıkçası anlayamadım?
  entry_channels: 
- entry_name: |
    17 nisan 2019 anadolu efes barcelona lassa maçı
  entry_id:  89055376
  entry_writer: tarkanin avukati
  entry_fav_count: 0
  entry_content: |
    istanbul büyükşehir belediye başkanı <a class="b" href="/?q=ekrem+imamo%c4%9flu">ekrem imamoğlu</a>'nun da tribünden takip ettiği karşılaşma.
  entry_channels: spor
---
