...
- entry_name: |
  ...
  entry_fav_count: 66
  entry_content: |
    parıl parıl parlamaktadırlar. onların bu ülkenin umutlarıdır.<br/>hepsine sarılıyorum. iyi ki varsınız!
...
- entry_name: |
  ...
  entry_id:  97966220
  entry_writer: zhonienf
  entry_fav_count: 33
  entry_content: |
    rapstar<br/>bir pesimistin gözyaşları <br/>bu ikisinin üstüne albüm benim için gelmemiştir önerileriniz varsa bir yeşil uzaktayım dostlar
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    tatile çıkılacak araç demişler.<br/>gözlerimi kapatıp 5 kişilik ailemle birlikte, bu araçla karadeniz gezisinden ankaraya dönerken hayal ediyorum kendimi; ziganaya yatsı civarı tırmandım, tünelleri geçip kestirmeden şirana doğru gidiyorum. dün uzungöl yokuşundayken bi ara kavrama şöyle bi titretmişti aklıma geldi birden arabadakilere çaktırmadım ama soğuk terler popoya doğru akmaya başladı, bir şey olmaz dedim, ışıklarda p'ye alıyorum ben... tam aklımdan çıkmıştı ki tok bir ses küttttt!!!! dağ başında gecenin ikisinde araba önce bi ileri geri silkeledi sonra da kitlendi kıpırdamıyor. telefon çekmiyor, arabadakiler korku içinde, durduracak kamyon bekliyorum, "bunu alacağıma boş paket japon alaydım" serzenişleri ve kapanış....<br/>(bkz: <a class="b" href="/?q=dsg">dsg</a>)<br/><br/>tanım: güzel araba, alın. yumoş yumoş plastikleri filan var.
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    1946 parlamenter sisteme geçiş<br/>1980 parlamenter sistemin askıya alınması<br/>2016 parlamenter sistemin kaldırılması<br/>parliament sinema kulübü sundu!
...
- entry_name: |
    15 bin tl maaş alıp huzuru bulamamak
  entry_id:  97955447
  entry_writer: alezengi
  entry_fav_count: 6
  entry_content: |
    20.000 ile artırıyorum. bir kadın hocamız ve eşinin ayrılık hikayesi:<br/><br/>hocam: yardımcı doçent<br/>eşi: doçent<br/><br/>öyle kötü ayrıldılar ki kocası " şişko kadın sikimi kaldıramıyor bile o vücutla " dedi. <br/><br/>kadın da " pipisi 7 cm oluyor en fazla" diye mahkemeye yazılı açıklama yaptı. <br/><br/>hatta mahkemeye bunu kanıtladığına dair söylemler vardı ajhsjsjs
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    "zamanın çoktan sildiği bir hata için cezalandırılabilir miydi insan?.."<br/>(bkz: <a class="b" href="/?q=stefan+zweig">stefan zweig</a>) / (bkz: <a class="b" href="/?q=korku">korku</a>)
  entry_channels: anket,sanat,edebiyat
- entry_name: |
    sevgilisinin giyimine karışan erkek
  entry_id:  97969583
  entry_writer: denizgibiyim
  entry_fav_count: 1
  entry_content: |
    giyimini kuşamını kendinizce uygun bulmadığınız biriyle sevgili olmazsanız böyle sığ ve ucuz davranışlar sergilemenize gerek kalmaz.
  entry_channels: anket,ilişkiler,moda
- entry_name: |
    pazardan don alan erkeğin asıl amacı
  entry_id:  97960687
  entry_writer: hypertext
  entry_fav_count: 1
  entry_content: |
    bedelli askerliğe gidecek ve don yıkamaktansa gerektiğinde giydiğini atıp yenisini giymektir.
...
- entry_name: |
  ...
  entry_id:  97943054
  entry_writer: tanri beni seviyor mu
  entry_fav_count: 0
  entry_content: |
    ahuramazda geliyor. (iyilik tanrısı, zerdüştlük dini.)
  entry_channels: anket,ekşi-sözlük
- entry_name: |
    verildikten sonra rahatlanılan şey
  entry_id:  97968440
  entry_writer: bakyinekonustu
  entry_fav_count: 0
  entry_content: |
    tez
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=matematik+korkusunun+heba+etti%c4%9fi+hayatlar">matematik korkusunun heba ettiği hayatlar</a>)
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    30 ve üstü yaşlarda, başladığını hissettiğin an insanı deli gibi tırstıran olay. öyle yeni yetmelikte olduğu gibi kelebekler gökkuşağı falan olmuyor ödü kopuyor insanın nereden düştük gene bu abuk subuk hislere diye.<br/><br/>(gözlerin, dudakların alev alev çağırıyor yangınlara. öyle bir şey var ki sende çözemediğim, insanı çılgınlıklara sürüklüyor.) durumu.<br/>ahahaha te allaam. <br/>ama gerçekten psikolojik bir rahatsızlık bu bence. olmamalı yani. neden oluyor böyle?<br/>(bkz: <a class="b" href="/?q=dopamin">dopamin</a>)
  entry_channels: ilişkiler
---
