...
- entry_name: |
    büşra nur çalar
  entry_id:  97931428
  entry_writer: cool lemur
  entry_fav_count: 49
  entry_content: |
    bu görüntüler hakkında yazılacak çizilecek tartışılacak tonla şey var aslında. ama özet geç derseniz 16 17 yıllık akp iktidarının nasıl halkın nefesi sesi olma bahanesiyle gelip halkın gırtlağına çöküp nefessiz bıraktığının örneklerinden sadece birisidir. orta sınıf bir aileden yetişen bir genç olarak, biz yıllarca sınavdan sınava koşturalım milyonlarla yarışalım, yıllarca okuyalım elimize uyduruk bir diploma verilsin sonra işsiz parasız kalalım, devlet bazılarımıza öğrenim kredisi diye borç versin, fetvalarla bas bas faiz haram diye hocaları bağırtsın ama kendisi en büyük tefeciliği yapsın. kim için ne amaçla tefecilik yaptıkları belli oluyor. bizim sırtımıza vurulan semerle eş dost akraba çocuğu diye vasfına alanına uymayan bölümlere değişik sıfatlarla atanan yeğenlerin el kadar bebekleri için yüz binlerce liralık masraflar yapılsın, benim memur anam babam hâlâ kirada otursun, her ay 3 4 bin liralık kredi kartı borcunu ödemek için ezik büzük olsun ama onlar küçücük bebeğin parmağına pırlanta yüzük taksın. <br/>kelimler kifayetsiz kalıyor.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    dünya çapında patlak veren halk isyanları
  entry_id:  97943142
  entry_writer: pamih
  entry_fav_count: 29
  entry_content: |
    haklı isyanlardır. devlet insan içindir anlayaşı insan devlet içindir anlayışına evrilince insanlar benim faydama olmayan devlet benim değildir diye isyan ediyor.<br/>sahi devlet ne içindi?
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    bir musluman olarak soyluyorum ki bu gorgusuzler yuzunden insanlar islamdan, muslumanliktan nefret ettiler. bu yaptıklarınızın her zerresi o cocuklarınız dahil yedi sülalenizden çıksın.<br/><br/>ayrıca bu bildiğin (bkz: <a class="b" href="/?q=eyes+wide+shut">eyes wide shut</a>)
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    edirne’de dur işaretinin altında bir tabelada stop yazar. biz avrupalıyız olm. anadolu’dan ayrılsak avrupa birliğine gireriz ama yinede gavurdan dost olmaz diyip yine anadolu’ya sığınıyoruz.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
    ajdar'ın günümüzün barış mançosu olması
  entry_id:  97960607
  entry_writer: gelmiyim oraya
  entry_fav_count: 5
  entry_content: |
    barış manço isterse kaliteli bir şarkı yapabilir ama ajdar istese de yapamaz.
  entry_channels: 
- entry_name: |
    ırkçı olmak suç mu
  entry_id:  97959646
...
- entry_name: |
  ...
  entry_id:  97931216
  entry_writer: anhydra
  entry_fav_count: 2
  entry_content: |
    <a class="b" href="/?q=gaslighting">gaslighting</a> mağduru olabilir. <br/>yanlış anlaşılmaları, iletişim sorunlarını istisna tutarsak, ortada bir <a class="b" href="/?q=duygusal+%c5%9fiddet">duygusal şiddet</a> söz konusu olabilir.<br/>bu insan sevdiği kişinin sistematik olarak <a class="b" href="/?q=duygusal+manip%c3%bclasyon">duygusal manipülasyon</a>una maruz kalmakta olabilir. <br/>insan başta sonuna kadar haklı olduğunu düşündüğü bir konuya dair diyaloğun sonunda "allah da benim belamı versin" noktasına kolay kolay gelmez. o noktaya adım adım götürülmüş olabilir.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    libidosu yüksek olan çaylakları beklediğim veritabanı
...
- entry_name: |
    masterchef türkiye
  entry_id:  97964182
  entry_writer: dodododi
  entry_fav_count: 0
  entry_content: |
    program başlamış. yargı dağıtacak bir arkadaş vardı . nerede o ya göremedim ?
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    kafam güzeel :)<br/><a rel="nofollow noopener" class="url" target="_blank" href="http://c2.me/expanik">http://c2.me/expanik</a>
  entry_channels: anket,ilişkiler,ekşi-sözlük
---
