...
- entry_name: |
  ...
  entry_fav_count: 37
  entry_content: |
    insanın kendi başına vakit geçirmesini kolaylaştırmasıdır. <br/>yani; tek başına oturmuş çay icerken yapacak bişeydir. otobüsü beklerken zaman geçirmektir.
...
- entry_name: |
    shaquille o'neal
  entry_id:  92051830
  entry_writer: crembears
  entry_fav_count: 9
  entry_content: |
    216cm boyunda, 148 kg ağırlığında bir basketbolcunun sergileyebileceği en çevik hareketler nelerdir? bu boyda bir insan en fazla ne kadar atletik olabilir sorularının akıllarda cevap arayan sağır edici sesine cevap olan adamdır. muazzam bir patlayıcılığa sahip, oyunun her iki yanını da layikiyla oynayan, kariyer zirvesinde ligin en dominant oyuncusu olmuş, gelmiş geçmiş en iyi 5 numaralardan biri ve sonuncusudur.<br/><br/>shaquille o'neal son büyük pivotlardan edindiği tecrübelerle ligi birbirine katmış, kazanılacak ne varsa kazanmıştı.<br/><br/>kariyeri boyunca iki kez sayı kralı olmuş, kariyer sayı ortalaması 24.3 olan bi oyuncu düşünün. ligde tüm zamanların en yüksek yüzdeli hücum eden 2. oyuncusu olduğunu hesaba katın bu istatistiğe bakarken.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    iyilesmesi ve geri donmesi serefine kufurlu esprilerinden birini benim de paylasmak istedigim basarili sovmen.<br/><br/>fox'ta carkifelek'i sundugu zamanlarda, fox-2 isimli bir kanalin acilacagi duyrulmustu (sonra yalan oldu sanirim). hatta yarisma hostesi, duyuru olarak carkifelek'in bu kanalda yayinlanmaya devam edecegini soylemisti.<br/><br/>mali de duyuruya devam etti. baslarini tam hatirlamasam da soyleydi:<br/>"evet, neymis? fox-2 kanali acilinca, carkifelek artik orda yayinlanacakmis.<br/>unutmayalim. fox-2<br/>fox-2, fox-2, fox-2"<br/><br/>son kismindaki tekrarlari siritarak soyluyordu tabi. (siz de kanal ismini ust uste sesli sekilde tekrar ederek soylemeyi deneyebilirsiniz <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>)
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    neydi lan o başlık?<br/><br/>"birine kırmadan çirkin olduğunu söylemek" miydi?
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    ekşisözlüğün arkadaş veritabanıdır. flört veritabanı değildir. ilişki maksadıyla münasebete girmek isteyen sözlük yazarlarının ilgili başlığa entry yazması gerekmektedir.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  92056322
  entry_writer: zaknafein dourden
  entry_fav_count: 0
  entry_content: |
    jokey/eşek
