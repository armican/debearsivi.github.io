...
- entry_name: |
    24 eylül 2017 iran'ın kuzek ırak'ı bombalaması
  entry_id:  70979889
  entry_writer: recond1te
  entry_fav_count: 141
  entry_content: |
    tezkere mezkere yok, bam bam bam...
- entry_name: |
  ...
  entry_fav_count: 120
  entry_content: |
    kız sokakta gördüğü her erkeğin resmini çekmiş, ilgi çekmeye çalışan bir hollanda kezbanı gibi duruyor..
- entry_name: |
    igor tudor
  entry_id:  70988799
...
- entry_name: |
    fener maçını video hakem yönetse bitecek skor
  entry_id:  70984463
  entry_writer: oneringtorulethemall
  entry_fav_count: 93
  entry_content: |
    13-4 beşiktaş galibiyetiyle biterdi muhtemelen.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 40
  entry_content: |
    allah'im sofiane feghouli.<br/><br/>40 bin kusur bursalinin onunde sol ayagiyla 90'a yuvarladi ya lan topu. aynen 90'a yuvarladi. <br/><br/>cok basit bir sey yapiyormus gibi, kimse yokmus gibi, takimi 1-0 geride degilmis gibi, ligde cektigi ilk sut degilmis gibi, oyuna gireli birkac dakika olmamis gibi.<br/><br/>allahim, sofiane feghouli.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    sen konusma ayi.<br/><br/>agzinin da gozunun de ayari yok. fenerbahcelisin diye seni koruyacak degilim. siktir git bok gibi yapistigin yerinden.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    galatasaray düşmanlarının yine operasyona çıktığını gösteren kaptanımız.<br/><br/>adam muslera gitsin diyecek utanmasa. böylelerini siklemeyin. engelleyip geçin.
- entry_name: |
    ios 11
  entry_id:  70972873
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    birkaç saat önce taksim altgeçitte arkadaşlarla otobüs beklerken küçük bir kız çocuğu dikkatimi çekti. merdivenlerde yalnız başına oturmuş, elinde poşetiyle bekliyordu. 5-6 yaşlarında, üstü düzgün, yüzü gözü pasaklı olmayan bi kızdı o yüzden suriyeli olduğunu düşünmedim. acaba annesini mi kaybetmiş diye düşünürken yanına bi kız geldi, biraz konuştuktan sonra küçük kızı öpüp gitti, kızın türk olduğuna iyice emin olmuştum. ben bu düşünceler içerisindeyken kız yerinden kalkıp diğer insanlara poşetindeki mendilleri satmaya çalıştı. bi iki kişiye gittikten sonra yanıma geldi, konuşmadan öylece yüzüme baktı. renkli gözlü, kumral saçlı acayip tatlı bi kızdı. biraz sevimlilik yaptı ben de tamam anlaşıldı deyip bi lira çıkarıp verdim, uzattığı mendili almadım ama ısrar etti. arapça bi şeyler söyledi. en son kabul edip, mendili poşetinin içine atmaya çalıştım. yok almıyo illa bende kalmalıymış. sonra kayboldu bi daha da göremedim. kız aşırı sevimli bir şeydi umarım başına bir şey gelmez. hayat bazı insanlara hiç iyi davranmıyor.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://i.hizliresim.com/0G7958.jpg" title="https://i.hizliresim.com/0G7958.jpg">kızın bana verdiği mendil</a>
- entry_name: |
    düşün ki o bunu okuyor
  entry_id:  70981544
  entry_writer: velethan
  entry_fav_count: 3
  entry_content: |
    gel<br/>ben sana gelemem<br/>sen gel
- entry_name: |
