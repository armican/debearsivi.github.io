...
- entry_name: |
    yardım bekleyen kanser hastası çocuk
  entry_id:  102909601
...
- entry_name: |
    kedisi olan erkeğin ilişkiye 1-0 önde başlaması
  entry_id:  102903567
  entry_writer: frondie
  entry_fav_count: 28
  entry_content: |
    varolmasina 16 senedir var da ya kedi bozuk ya ben.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    metroda ayna görünce farkettiğim hadise.
  entry_channels: ilişkiler
- entry_name: |
    şaka maka erdoğan'ın bir siyaset dehası olması
  entry_id:  102917265
  entry_writer: bence11
  entry_fav_count: 14
  entry_content: |
    bir seyyar pilavcı haberi vardı. pilavını yiyen hayran kalıyor diye.<br/>pilavcıya neden bu kadar beğeniliyor pilavınız diye sormuşlardı, pilavcı da "pilav normal siz gerizekalısınız" demişti. o geldi aklıma.
  entry_channels: siyaset
- entry_name: |
    izmir bomba tatlısı
  entry_id:  102911428
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    bir gün okulun alım satım için oluşturulan bir facebook grubuna bi ilan koymuştum. kızın biri yazdı şu fiyattan olur mu diye ,fiyatta anlaşırız o sorun değil dedim. muhabbete biraz daha devam etti. ama çok eğlenceli bi kız . sürekli şakalaşıyoruz falan , muhabbet en baştan öyle başladı hep öyle devam ediyor. mühendislik okuduğum için ilk defa böyle bir şey yaşamıştım. bi kızın benle random atarak mesajlaşması falan benim için çok uç şeyler. kız da güzeldi.dışarda ağzım kulaklarımda gezdim o gün. yalnız kız bana en başından beri sürekli bro, knk vs diyordu. dedim tarzı öyle herhalde. neyse satacağım şeyi teslim etmek için okulda belli bir saatte buluşmayı kararlaştırdık. ben tabi gitmeden önce kızı biraz daha etkileyebilmek için önceki muhabbetlere dayanan birkaç espri hazırladım . buluşma saati geldi ,heyecanla buluşma yerine doğru gidiyorum uzaktan bir baktım yanında bir erkek var. sarmaş dolaş konuşuyorlar. olayı geç de olsa anladım. ürünü teslim edip hızlıca ayrıldım. ama epey utanmıştım. kız benim gerizekalılığımı anlamış whatsapp’tan yine yerli yersiz mesaj atmayım diye sevgilisiyle gelmiş ürün teslimine. kafamı skim . kız öncesinde anlamam için her türlü imâda bulunmuş ben nasıl bir malsam anlamamakta ısrar etmişim. bundan sonra bir kız apaçık şekilde yeşil ışık yakmadıkça yürümem sanırım.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    2 mart 2020 abd savunma bakanlığı açıklaması
  entry_id:  102918225
  entry_writer: orientem
  entry_fav_count: 11
  entry_content: |
    ne suriye sorunu ne akdeniz sorunu ne rahip sorunu ne s-400 sorunu varken 2011 yılında amerika yine bize silah vermiyordu. ne yaptık ne ettik amerika'dan iha alamadık o dönem. heron'lar dolayısıyla israil'i o kadar eleştirdik ama o dönem israil'den başka da bize düzgün bir iha satan olmadı.
  entry_channels: siyaset,haber
- entry_name: |
    1 mart 2020 rusya'nın idlib'e asker yerleştirmesi
  entry_id:  102916232
  ...
  entry_channels: 
- entry_name: |
    iyi parti mvnin şehit cenazesinde poz vermesi
  entry_id:  102916615
  entry_writer: metetulpar
  entry_fav_count: 10
  entry_content: |
    nihat doğan ın dişi versiyonu. ulan bari namaz bitene kadar bekle. <br/>namaz kılanın önünden geçilmez bu 1, matem rengi siyahtır bu 2. <br/>şehit cenazesine milletle dalga geçer gibi beyaz kürkle gelmişsin. <br/><br/>zürefanın düşkünü beyaz giyer kış günü. bide kürk yani.
  entry_channels: siyaset
- entry_name: |
    hiç yakışıklı ismail olmaması
  entry_id:  102914744
  entry_writer: nickson
  entry_fav_count: 7
  entry_content: |
    (bkz: <a class="b" href="/?q=ismail+cem">ismail cem</a>)
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    2-3 günde iki binin üzerinde tweet okuyup olayı herkesin gözünden görmek istedim. okuduğum tweetler arasında telkin,dezenformasyon ve bir kısmı analiz üzerindeydi. <br/><br/>okuduklarımdan çıkardığım bir kaç şey var.<br/><br/>*ruslar yazılanın aksine natodan korkmuyor. savaşın içine birilerini kattıkları sürece petrol fiyatlarını zıplatmaya devam edecekler. o yüzden gel gel yapıyorlar. <br/>*iranlılar bizim ile çatışmaya girmek istemiyor. sebepleri yine korkmak değil.sonuçları hesapladıklarında koz vermek istemiyorlar. o yüzden bizi ikna ile durdurmaya çalışıyorlar. <br/>*aynı zamanda iranlılar rusların rejim üzerindeki baskısından rahatsızlar. kendi istedikleri şeyleri rejime yaptıramıyorlar.<br/>*rejimin tüm hareket ve stratejilerini ruslar belirliyor. rejim sadece görüntü.
  entry_channels: siyaset,haber
- entry_name: |
    2 mart 2020 amazon.com.tr rezaleti
  entry_id:  102909912
  entry_writer: bakin burasi cokomelli
  entry_fav_count: 6
  entry_content: |
    arkadaşın ilk rezalet başlığı olduğu için tecrübesizliğini göz önünde bulundurarak, kanaatimi kullanarak <sup class="ab"><a title="(bkz: emek var sonuçta)" href="/?q=emek+var+sonu%c3%a7ta" data-query="emek var sonuçta">*</a></sup> 2/10 puan verdiğim rezalettir.
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    (bkz: <a class="b" href="/?q=yakacakla+sikece%c4%9fin+k%c3%b6t%c3%bcs%c3%bc+olmaz">yakacakla sikeceğin kötüsü olmaz</a>)
  entry_channels: ilişkiler
- entry_name: |
    en sevdiğin filmden bir replik bırak
  entry_id:  102918484
  entry_writer: ebenin de oyuncaklari var
  entry_fav_count: 3
  entry_content: |
    "asuman çok küçük değil, ibrahim çok mu büyük demek istiyorsun yani sen."<br/><br/>(bkz: <a class="b" href="/?q=hassiktir+be+r%c4%b1fat+abi">hassiktir be rıfat abi</a>) <br/>(bkz: <a class="b" href="/?q=pardon">pardon</a>)
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    eski kız arkadaşımla iddaa oynardık, amk kızı ecdadımızı sikti. verdiği her kupon yatıyordu. ama yine de bu özelliği çekiciydi. <br/>lan arkadaş geniş bültende hiç mi bir kuponu gelmez insanın, ocağımıza incir ağacı dikti. en son icra memurlarıyla beraber maç izliyorduk.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  102903811
  entry_writer: teateacher
  entry_fav_count: 1
  entry_content: |
    havuçlu tarçınlı kek ve ezine peyniri. hayat gibi bir şey tatlı, tuzlu.
  entry_channels: anket,yeme-içme
- entry_name: |
    o kadar kız varken neden ben
  entry_id:  102903259
  entry_writer: nick olmasa da olur olur mu olur
  entry_fav_count: 1
  entry_content: |
    düşünsene bu soruyu duyan adamın aniden uyanışa geçtiğini, farkındalık kazanıp kendini sorguladığı ama cevap bulamadığını. onun için cevabını kaldıramayacağın soruyu sorma bir zahmet :)
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    buharda brokoli , kereviz vs , <br/><br/>bol limonlu zeytinyağlı enginar , <br/><br/>ıspanak.<br/><br/>* (bkz: <a class="b" href="/?q=karaci%c4%9fer+ya%c4%9flanmas%c4%b1">karaciğer yağlanması</a>)<br/>* (bkz: <a class="b" href="/?q=her+g%c3%bcn+bir+saat+ko%c5%9fmak">her gün bir saat koşmak</a>)
