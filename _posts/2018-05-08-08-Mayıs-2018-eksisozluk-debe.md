...
- entry_name: |
  ...
  entry_fav_count: 27
  entry_content: |
    -öğrenci evi hikayeleri<br/>-solculuk<br/>-futbol takımı taraftarlığı
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  76745510
  entry_writer: yaverofgod
  entry_fav_count: 24
  entry_content: |
    dedi temmuz'da passoligini yakıp eylül'de yenisini çıkaran otoban yosması
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    "üzerimizden kimsenin prim yapmasını istemiyoruz" diyerek yenilgiyi baştan kabul etmiştir.<br/><br/>(bkz: <a class="b" href="/?q=korktun+mu">korktun mu</a>)
  entry_channels: siyaset,tv
- entry_name: |
    alişan
  entry_id:  76725994
  ...
  entry_fav_count: 4
  entry_content: |
    nikah esnasında evet demek için izin isteyen türkücü.<br/><br/>(bkz: <a class="b" href="/?q=izninizli+cimhirbi%c5%9fkinim">izninizli cimhirbişkinim</a>)
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    kendisi direkt kırmızı kart görmesine rağmen bir maç ceza alan oyuncular kervanına katılmış. cezasını, oynanmayan, oynansa oynayacağı maçta çekmiştir. <br/><br/>(bkz: <a class="b" href="/?q=neler+diyorum+ben">neler diyorum ben</a>)
  entry_channels: spor
- entry_name: |
    salih mirzabeyoğlu
  entry_id:  76744835
  ...
  entry_fav_count: 1
  entry_content: |
    gün itibariyle ölmüş şeriatçıdır. <br/>darısı diğer şeriatçıların başına.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    körfez savaşında abd tankı üzerinde <a class="b" href="/?q=%c4%b1rak">ırak</a> 'ta arzı endam etmiş arkadaştır. ne kadar kuş beyinli ve acınacak millet olduğumuzu yukarıda yazılanlara bakarak anlayabilirsiniz. peşin edit: muhabirlik filan deyip ahmaklığınızı ortaya çıkarmayın.<br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=WL9gSlHcGW4" title="https://www.youtube.com/watch?v=WL9gSlHcGW4">cüno</a>
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    sigara içmenin zeka ile aptallık ile alakası yok arkadaşım. bu iki değişkeni ilişkilendiren birinin ıq derecesi de eminim zorla 90 da duruyordur. bir insan sigaraya birilerini rol-model alarak başlar. daha sonra sıgaranın içinde bulunan belli bir miktar nikotin vücutla tanışır. vücut nikotini tanıdıkça daha çok sevmeye başlar. sevdikçe de ister. bu kadar basit. her gün milyonlarca insan sigarayı bırakıyor milyonlarca insan bırakmaya çalışıyor milyonlarca insan da sigaraya başlıyor. bu böyle devam eder gider. sigara içmek bazı insanlar için bir zevktir. aynı senin halısahaya futbol oynamaya gitmen ya da haftanın bir günü özel bi yerde yemek yemen gibi. sen de o da parasını verir bu zevki satın alır. birisi zararlıdır birisi değildir. zararlı olduğu için sigara içen birinin içmemesini isteyebilirsin ama o kişiye aptal ya da gerizekalı diyemezsin. o da sana halısahaya gidiyorsun diye hakaret edemez.
  entry_channels: anket
---
