...
- entry_name: |
    cem uzan
  entry_id:  76717890
  entry_writer: agregas
  entry_fav_count: 41
  entry_content: |
    <a class="b" href="/?q=star+gazetesi">star gazetesi</a> bir ara bedava kaset dağıtıyordu. <a class="b" href="/?q=cem+uzan">cem uzan</a> bizim bakkala sadece özcan deniz kaseti göndermiş. ben de hiç yoktan iyidir dedim aldım bir tane. meğer hiç yoktan iyi değilmiş...
  entry_channels: siyaset,ekonomi
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    7 mayıs 2018 beşiktaş'ın hükmen mağlup olması
  entry_id:  76747853
  entry_writer: hasictearcont
  entry_fav_count: 0
  entry_content: |
    ertelenmiş olabilir de aynı maç lan. aynı maçın normal olarak ikinci yarısına çıkmamış olacaktı yani. bu adamın cezasını bir sonraki maçta çekmesi gerekmiyor mu?<br/>bu nasıl kural harbiden birisi açıklasın şunu saçma. ayrı maç gibi sayılacaksa bjk sahaya 11 kişi neden çıkamıyor o zaman bunları açıklayın lan!
  entry_channels: spor
---
