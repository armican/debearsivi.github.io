...
- entry_name: |
  ...
  entry_fav_count: 86
  entry_content: |
    boyu çok uzun alçaktan gelen toplara eğilemez bu arkadaş <br/><br/>kafası kel olduğu için hava toplarını yumuşatamaz ayarı kaçırır rakibe indirir.<br/><br/>fazla iri olduğu için muslera sahayı net göremeyebilir. önündeki seri gözükmez.<br/><br/>büyük ellere sahip olduğundan ceza sahasında top ellerine değer penaltı olur.<br/><br/>bu yüzden pek faydalı olmaz.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 60
  entry_content: |
    haddinden fazla empati geliştirmesidir. farklı hikayeler, karakterler gördükçe olaylara karşı birbirinden farklı yüzlerce bakış açısına tanıklık ettikçe günlük hayattaki sıradan olaylara bile sadece kendi perspektifinizden bakamaz hale geliyorsunuz.<br/><br/>çıkar çatışmalarından ibaret bu hayatta bu durum bir dezavantaja dönüşüyor.
...
- entry_name: |
  ...
  entry_id:  93885764
  entry_writer: feristahh
  entry_fav_count: 32
  entry_content: |
    aynı ortamda uzun süre bir birliktelik yaşamayınca çoğunlukla günübirlik bir muhabbetten öte gitmeyen ilişkidir. etrafınızdaki tüm dostlarınıza sevdiklerinize bakarsanız aslında kendi tercihiniz olarak gördügünüz ilişkilerinizin bile bir nevi maruz kalma olduğunu fark edebilirsiniz.
...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    anonim olarak sağa sola bok atmanın keyif vermesi. çünkü pembe götlü ekşici olmak bunu gerektirir.
  entry_channels: anket,ekşi-sözlük
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    burası ilkbahar ve sonbahar'da insana huzur veriyor. sonbaharda çatır çatır yapraklara basarak yürümesi, havadaki üşütmeyen tatlı serinlik vs. anlayamazsınız.<br/><br/>bunu bir kenara bırakırsak yazını ayrı kışını ayrı sikeyim ankara. insan yaşayacak lan burada insan!!
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    düğün arifesindekilerin bir anda hal hatır sorması
  entry_id:  93914919
  entry_writer: yyildirayy
  entry_fav_count: 10
  entry_content: |
    kesinlikle düğününe gidilmeyecek kişidir bunlar benim gözümde.<br/>onların gözünde 1 çeyrek altın olarak görünmekteyiz
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    göt alıp stoklayalım mı, nedir yani.
...
- entry_name: |
  ...
  entry_id:  93888993
  entry_writer: bana nick lazim ya
  entry_fav_count: 3
  entry_content: |
    soruların hepsi seks üzerine, ben okurken sıkıldım siz de sıkılmadınız mı?
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    şah değildir. şah en değerli taştır. en güçlüsü vezirdir. tıpkı gerçek tarihteki gibi. ülkeleri krallar yönetir ama kralları vezirler yönlendirir.
  entry_channels: oyun
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    eskisehirdeyim iki günlüğüne. 6 sene okudum bu şehirde eskilerden kim var bi buluşalım :)
