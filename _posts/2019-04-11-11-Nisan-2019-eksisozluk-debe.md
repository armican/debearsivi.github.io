...
- entry_name: |
  ...
  entry_fav_count: 162
  entry_content: |
    bahse konu görüntü yaklaşık 55 milyon yıl öncesine aittir. <br/><br/>yani bir başka deyişle tarihin en eski fotoğraflarından biri çekilmiştir.
...
- entry_name: |
  ...
  entry_fav_count: 80
  entry_content: |
    gençler mazbatayı alan çıksın, oyun çok kasıyor.
...
- entry_name: |
  ...
  entry_id:  88755778
  entry_writer: esmer burcusoy
  entry_fav_count: 51
  entry_content: |
    79.dakikada belhanda'nın yapacağı anlamsız faul sonucu penaltıdan bile tehlikeli olacak serbest vuruş çık aklımdan...
  entry_channels: spor
- entry_name: |
    falana felan demek
  entry_id:  88778524
...
- entry_name: |
  ...
  entry_fav_count: 47
  entry_content: |
    her konuda ağzının suyu aka aka evropa evropa diyen sözlükçülerin konu sokak köpekleri olduğunda özüne dönmesine çok gülüyorum kusura bakmayın. batı toplumlarında sokakta sahipsiz hayvanlar yok. <br/><br/>burada herkes kadıköy’ün beslenmekten semirmiş ve kimseye sataşmayan köpeklerinin arasında yaşamıyor. her gün haberlerde köpekler tarafından saldırıya uğrayan insanlar görüyoruz. hayvanların bakılamadığı ortada. hem çevreye hem de kendilerine zarar veriyorlar. o zaman yaşam alanlarının ortasında olmamalılar, onlara ait yaşam alanları sağlanmalı.<br/><br/>- - -<br/>edit: ben ki sineği bile öldürmek yerine uzaklaştıran bir insanken, bu güne kadar yazdığım herhangi bir entryde hayvanlar ölsün dedim mi? hayvanların sağlıklı ve mutlu yaşayabileceği, kontrollü üreyecekleri ortamları olmalı. evcil hayvanların sokağa terk edilmesinin caydırıcı yaptırımları olmalı. sokaklar yavruyken bir hevesle alınıp, büyüyünce atılan hayvanlarla dolu. bu olmamalı. <br/><br/>not: okuduğunu anlayabilmek önemli meziyettir ki sizi yanlış triplere girip saçma sapan mesajlar atmaktan kurtarır.
  entry_channels: sağlık,haber
- entry_name: |
    10 nisan 2019 ysk khk'lı aday kararı
  entry_id:  88784836
  entry_writer: bos gezenin bos ustasi
  entry_fav_count: 32
  entry_content: |
    çok basit bir soru soracağım: neden aday olmasına müsaade ettiniz o zaman?
  entry_channels: siyaset
- entry_name: |
  ...
  entry_fav_count: 30
  entry_content: |
    "anadolu ajansının veri akışını durdurması, o akşam binali yıldırım'a kazandık diye açıklama yaptırılması, gece kazandık diye afişler astırılması bir darbe girişimiydi, biz bu darbeyi engelledik."<br/><br/>hem chp hem imamoğlu bu seçim gerçekten çok akıllı hamleler yaptı. hem chp nin seçim sistemini halka açması, hem ekrem imamoğlu'nun saat başı çıkıp elindeki sonuçları vermesi, 2 gün sonra anıtkabir'e gitmesi gerçekten kasparov gibi hamlelerdi. o gün burada da eleştrildi mazbatanı almadan napıyorsun diye, eğer ekrem imamoğlu o hareketleri yapmasaydı akp nin astığı kazandık afişleri önünde kornalar çalarak sokağa dökülmüş halk eşliğinde oldu bitti yapılıp galibiyet ilan edilecekti. özellikle o gece hiç uyumadan saat başı veri paylaşması ve en son sabaha karşı "ben karşınızda ibb belediye başkanı olarak duruyorum" açıklamaları akp nin planlarını bozdu.<br/><br/>seçim gecesi rakının gözüne vurup kendini odaya kitleyen muharrem beye de buradan selam olsun.
  entry_channels: siyaset,tv,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    sadi güven'in görevinden istifa ettiği iddiası
  entry_id:  88785484
  entry_writer: beat junkie
  entry_fav_count: 18
  entry_content: |
    (bkz: <a class="b" href="/?q=olmam%c4%b1%c5%9f+olaylar+hakk%c4%b1nda+olmu%c5%9f+gibi+ba%c5%9fl%c4%b1k+a%c3%a7mak">olmamış olaylar hakkında olmuş gibi başlık açmak</a>)<br/>ne çok meraklıymışsınız küfür yemeye.
  entry_channels: 
- entry_name: |
    karadelik fotoğrafına inanan insan saflığı
  entry_id:  88785690
  entry_writer: fenasi rinlerim
  entry_fav_count: 18
  entry_content: |
    ay'ın veya mars'ın varlığına inanan bir adet kekonun açtığı başlıktır. büyük resmi gördüğünü zannetmişsin ama benimkini görmüşsün kardeş ancak.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    kendisine buradan seslenmek istediğim kişidir. seçimi kazanıp mazbatayı alınca hemen metro sıklığını değiştirdiler. bunun kendisinin bilgisi dahilinde olmadığını düşünüyorum. sabahları rahatça bindiğimiz metro şimdi tıklım tıklım. kovmayacağız rahat olun dediğiniz akpliler sizi halkın karşısında küçük düşürmek istiyorlardır mutlaka. aman diyim.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    ibb başkanı imamoğlu'nu sevmek zorunda değilim
  entry_id:  88786825
  entry_writer: kocgiri
  entry_fav_count: 12
  entry_content: |
    değilsin.<br/><br/>hadi şimdi şurdan git.<br/><br/>edit : başlık başa kalmış, harbi gitmiş adam. lan oğlum git derken mecazi dediydim.
  entry_channels: siyaset
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    bir zamanlar yazarların dertleştiği, birbirlerine sıkıntılarını anlattığı güzide bir veritabanıydı. şimdilerde ise abazanların hatun düşürmeye çalıştığı sıradan bir başlığa dönüştü. test etmesi çok kolay: mesajlaştığınız kişi ile aynı cinsiyette olduğunuzu belli ederseniz en fazla 10 mesaj sonra hat kopuyor. <br/><br/>(bkz: <a class="b" href="/?q=ek%c5%9fi+s%c3%b6zl%c3%bck+sertle%c5%9fecek+insan+veritaban%c4%b1">ekşi sözlük sertleşecek insan veritabanı</a>)<br/><br/>sertleşin bakalım gençler. bu kafayla da anca öyle sert sert gezersiniz zaten...
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    erdal bakkal haricinde katildigim tespit. <br/><br/>oyuncular da gayet sacmaydi bence. hic oyle oturup da izlemedim ama denk gelince bakiyodum. hadi ne zaman gulcem diye bekliyodum amk<br/><br/>bence absurt konsepti arabeskle heba etmis bi dizi bu. turkiyede ne bekliyosun zaten. bu altyapiyla cidden zekice ve guzel bi dizi yapilabilirdi.<br/><br/>ek olarak "abi nasil gondermeydi ama" cilari da anmak istiyorum. cok iyi bi gondermeydi. ananin amina gonderiyodu<br/><br/>"hollywood filminde turk bayragi goren gencin heyecani" ni gormekten kusma noktasina da getirmislikleri var. bahsetmeden gecmek istemedim
  entry_channels: tv
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    (bkz: <a class="b" href="/?q=%c5%9f%c3%b6yle+biraz+ge%c3%a7mi%c5%9fe+gidiyorum">şöyle biraz geçmişe gidiyorum</a>)<br/><br/>(bkz: <a class="b" href="/?q=%c5%9f%c3%b6yle+biraz+ge%c3%a7mi%c5%9fe+gidiyorum+deyip+1862%27ye+gitmek">şöyle biraz geçmişe gidiyorum deyip 1862'ye gitmek</a>)<br/><br/>hatırlamayanlar için; <a class="b" href="/?q=soma+maden+facias%c4%b1">soma maden faciası</a> sonrası diğer ülkelerdeki maden kazalarından örnek vermek için fi tarihinden örnekler dinlemiştik.
  entry_channels: siyaset,anket
- entry_name: |
    büyükçekmece'de 13-14 bin seçmen sonucu değiştirdi
  entry_id:  88785859
  entry_writer: avasas
  entry_fav_count: 4
  entry_content: |
    bir <a class="b" href="/?q=mevl%c3%bct+uysal">mevlüt uysal</a> beyanı.<br/><br/>"ya bir insan toplamda 3 bin silinmiş, yaklaşık 14 bin kayıt yapılmış, yüzde 3 gibi dersek 4500 civarında, 3 bin de kaydı silinenlerden dersek 13-14 bin seçmenin burada oy kullanıp seçim neticesini değiştirmesi söz konusu"<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="http://www.hurriyet.com.tr/gundem/mevlut-uysal-turkiyenin-hicbir-yerinde-olmayan-secmen-hareketi-yasanmis-41178721" title="http://www.hurriyet.com.tr/gundem/mevlut-uysal-turkiyenin-hicbir-yerinde-olmayan-secmen-hareketi-yasanmis-41178721">http://www.hurriyet.com.tr/…eketi-yasanmis-41178721</a><br/><br/>iki gün önce:<br/><br/>"13-14 bin oy farkla kimsenin kazandım deme hakkı yoktur. " <a class="b" href="/?q=recep+tayyip+erdo%c4%9fan">recep tayyip erdoğan</a><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.bloomberght.com/erdogan-13-14-bin-oy-farkla-kimsenin-kazandim-deme-hakki-yoktur-2210593" title="https://www.bloomberght.com/erdogan-13-14-bin-oy-farkla-kimsenin-kazandim-deme-hakki-yoktur-2210593">https://www.bloomberght.com/…e-hakki-yoktur-2210593</a><br/><br/>arkadaş siz nasıl bir teşkilatsınız? <br/>cumhurbaşkanı "15-20 bin oy" demiş olsaydı büyükçekmece'deki yolsuzluk iddiası da 15-20 bin mi olacaktı? <br/><br/>bunlar organize işler tamam da ya herkesi kör alemi sersem sanıyorsunuz ya da artık öyle pervasızlaştınız ki açıkça dalga geçiyorsunuz.
  entry_channels: haber
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    (bkz: <a class="b" href="/?q=ankara">ankara</a>)<br/>(bkz: <a class="b" href="/?q=y%c3%bcz%c3%bcnc%c3%bcy%c4%b1l">yüzüncüyıl</a>)<br/>(bkz: <a class="b" href="/?q=%c3%a7i%c4%9fdem+mahallesi">çiğdem mahallesi</a>)<br/>(bkz: <a class="b" href="/?q=odt%c3%bc">odtü</a>)<br/><br/>niye bu radde şiddet meraklısısınız? ağzının ortasına çakacakmış hocam diye hitap edenin? bu seni neden böyle gersin? çok dertliysen o semtten taşın git başka yerde yaşa. <br/>git bakayım üçgen çarşıda ya da odtü’de hocam diye hitap eden birinin ağzının ortasına çak, çakabiliyor musun? <br/>başlayacağım ironinize de şakanıza da komikliğinize de artık.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    gece olmasını beklemeden bıraktığım gelir kaynağıdır.<br/><br/>emekliler de <a class="b" href="/?q=bireysel+emeklilik+sistemi">bireysel emeklilik sistemi</a>ne dahil edilsin ve zorunlu olsun.<br/><br/>ayda 250 lira ödesinler misal. 30 yıl zaman sınırı olsun. 30 yıldan önce de paraları çekemesinler. 30 yılı dolduranlara paraları verilsin.<br/><br/>eleştiren olursa da "emeklilerimizin yaşlılıkta rahat etmesi" dersiniz.<br/><br/>çok güzel fikir lan.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    kadınlara seksten başka soru soramayan yazarların toplandığı başlık.<br/><br/>içlerinden bir adet favori seçtim.<br/><br/>“neden sevişirken kızılaya kan bağışı yapıyormuş gibi hareketsiz kalıp libidomuzu düşürüyorsunuz?” <br/><br/>aa, ne kadar da sevişken, esprili, alfa bir erkek. kadınların ham yapacağı cinsten.<br/><br/>neyse sen hatayı kadınlarda aramaya devam et.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    yunan alfabesinin bilmem kaçıncı harfi
  entry_channels: anket,ekşi-sözlük
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    10 yıldan fazladır içinde bulunduğum ve her defasında da iyi ki erken evlenmişim dediğim durumdur.
  entry_channels: ilişkiler
- entry_name: |
    2023 için imamoğlu mu ince mi sorunsalı
  entry_id:  88786649
  entry_writer: a k q j 10
  entry_fav_count: 1
  entry_content: |
    işte bu kafalar yüzünden liderliğin zorlu basamaklarını tırmanma gereği duymuyor bizde siyasetçiler. hele birkaç yıl geçsin daha 3 ay önce imamoğlu kim diyordunuz.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    tabi ki değiliz. kimse de yasal olarak kıllarınızı almak zorundasınız diye bir yaptırımda bulunmuyor bulunamaz da, fakat derdiniz insanların beğenilerini değiştirmekse bu yaptığınız zorbalığa girer. beğenmeyen şahıs da kalkar der ki ben kıllarını almayan kadını beğenmek çekici bulmak zorunda değilim. bana itici geliyor istemiyorum der çıkar . <br/><br/>bacaklarını traş etmiyorsun diye hakarete şiddete uğrarsan , zorla traş ettirirler , ağda bezlerini orana burana zorla yapıştırırlarsa eyvallah da, neden beğenmiyorsunuz ille de kıllı beğenin bizi demek saçmalığın dik alası. <br/><br/>beğeniler çeşit çeşit, kıl sevenler , hatta kıl fetişi olanlar dahi oldukça fazla toplumda. sizi o tarafa alalım
