...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    türk kızlarından başka kız tanımamış erkeklerin altında atıp tuttuğu başlık.<br/><br/>her kadın sever geniş omuz.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
    falana felan demek
  entry_id:  88779628
  entry_writer: falan felan filan
  entry_fav_count: 12
  entry_content: |
    ayıp oluyor ama arkadaşlar. <br/><br/>:(
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    olgun kadın siker atar. <br/><br/>afedersiniz, olgun kadının bin basacağı versus.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    az önce mevlüt uysal'ın seçmenlerin soy adından akp'ye oy verdiğini belirleyebiliyoruz iddiasına yönelik bir süre konuştuktan sonra kameraya gülümsemeyle beraber öyle bir bakış atmıştır ki; sözlükteki meali <a class="b" href="/?q=ne+desem+gg">ne desem gg</a> dir. sesli güldüm. :)
  entry_channels: siyaset,tv,haber
- entry_name: |
    çaylaklardan mesaj bekleyen yazarlar veritabanı
  entry_id:  88757846
  entry_writer: shaman yildizi
  entry_fav_count: 6
  entry_content: |
    serengetide yine bir av gecesi <br/>aç timsahlar acemi ceylanlari sikmek için suya davet ediyorlar
  entry_channels: ilişkiler,ekşi-sözlük
- entry_name: |
    sp'li pamukova belediye başkanının ilk icraatı
  entry_id:  88782444
  entry_writer: babayarisi
  entry_fav_count: 5
  entry_content: |
    oha aylık o kadar kira mı verilir 7 yaşında arabaya
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    (bkz: <a class="b" href="/?q=benim+babam%c4%b1n+siki+kutu+kola+gibidir">benim babamın siki kutu kola gibidir</a>)
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    asılsız iddiaları şak şak şak çürütüyor başkan.<br/><br/>eğer seçim iptal edilirse darbedir, kalkışmadır.<br/><br/>kalkın şu koltuktan kalkın artık.<br/><br/>tanım: adam kazandı.<br/><br/>tanım: istanbul büyükşehir belediye başkanı sayın ekrem imamoğlu.
  entry_channels: siyaset,tv,haber
- entry_name: |
    ekşi itiraf
  entry_id:  88760002
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    var ise, sadece baba oğul arasında olabilecek bir ihtiyaçtır. isterdim ki babam okşasın saçlarımı, aslan oğlum deyip sırtımı sıvazlasın.<br/><br/>şahsen gerisine hiç ihtiyacım olmadı, fakat sizin ihtiyaçlarınızı yargılamak da bana düşmez. nasıl mutluysanız öyle yaşayın.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  88783171
  entry_writer: paranoyak fotografci
  entry_fav_count: 1
  entry_content: |
    hayvan sever faşizminin geldiği dorukları şaşırarak izliyoruz şu an, umarım mamayla satın aldığınız "aşırı masum" sevgilerin gazabına uğramasınız.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  88780048
  entry_writer: muzigi ben buldum
  entry_fav_count: 0
  entry_content: |
    bende yaratmadı
  entry_channels: anket,ekşi-sözlük
