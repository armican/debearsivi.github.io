...
- entry_name: |
  ...
  entry_fav_count: 60
  entry_content: |
    <a class="b" href="/?q=caddebostan">caddebostan</a> fena değil. <br/>market, bakkal, balıkçı, kasap, elektrikçi hepsi elimizin altında.<br/>mahalle pastanemizde çay, muzlu rulo imkanı. bütün esnaf 20-30 senedir aynı. hepsi ile ahbapsın. daha ne isterim.
...
- entry_name: |
  ...
  entry_fav_count: 41
  entry_content: |
    birlikte hiç resim çektirmemiştik. bir sürü şey gibi bunu da yapamadık nedense; bir türlü olmadı. bir koşuşma, durmadan bir şeylerle uğraşma... neden koşuyorduk, acelemiz neydi?<br/><br/>korkuyu beklerken - <a class="b" href="/?q=o%c4%9fuz+atay">oğuz atay</a>
...
- entry_name: |
  ...
  entry_fav_count: 40
  entry_content: |
    akp van milletvekili abdulvahat arvas'a ait açıklama. arvas, akp’nin seçimleri kazanamaması durdumunda silahlı çetelerin peydahlanacağını, başörtülülerin sokakta yürüyemeyeceğini öne sürdü.<br/><br/>gezi tartışmaları yeterli verimi sağlamayınca tekrar türban mağduriyetine geri dönülmüş. akp'liler ekonomik krizin ve tepkilerin o kadar farkındalar ki çeteler, baskılar, iç savaş tehditleri başlamış. <br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="http://www.diken.com.tr/akpli-arvas-korkuttu-kazanamazsak-basortululer-sokakta-yuruyemez/" title="http://www.diken.com.tr/akpli-arvas-korkuttu-kazanamazsak-basortululer-sokakta-yuruyemez/">link</a>
...
- entry_name: |
  ...
  entry_fav_count: 29
  entry_content: |
    twitter’da, ınstagramda veya işte ne bileyim sağda solda insanların çok güzel fotoğraflarını görüp, açtığınız galeride kendinize ait bir tek fotoğraf bile bulamadığınız an anlıyorsunuz fotoğrafınızı dahi çekecek kimsenizin olmadığını. yalnız olduğunuzu.
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    oğuzhan uğur'a verilen tarihi ayar
  entry_id:  85737420
  entry_writer: neslini sevdigim
  entry_fav_count: 11
  entry_content: |
    <a class="b" href="/?q=babala">babala</a> fanlarının, 2 saat 11 dakika 58 saniye görüntü bekleyeceği video.
  entry_channels: 
- entry_name: |
    emre belözoğlu
  entry_id:  85736017
  ...
  entry_fav_count: 11
  entry_content: |
    tugay gibi bir kalas cümlesi acı bir tebessüme sebep olmuştur.<br/><br/>not: beşiktaş
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    alex ile organik bağ kurması gereken takım. premier ligdeki götü kalkık rejectleri takıma doldurmaktansa brezilyadan topçu getirelim allah aşkına. brezilyalı topçu türkiye liginde iş yapıyor. fenerbahçede iş yapıyor. ciddi ünlü brezilyalı futbolcu, teknik dirketör eskilerimiz de var. iyi kötü bir rep var yani oralarda. premier ligin şımarık çöplerine milyonlar ödeyeceğimize brezilyalıları izleyelim. illa genç, yeni neymar, bok püsür vs. olmasına bile gerek yok. devre arası transferini güney amerikadan yapsanıza arkadaş. adamların ligi bitti. transfer sezonu açıldı. yazın zor oralardan topçu almak kışın kolay. hadi be abicim be.<br/><br/>edit: takım bitiricilik sıkıntısı çekiyor belli bariz. yok mu oralarda adam gibi bir forvet? nobre fenere devre arası gelmişti. bulun bir nobre ya idare etsin bizi 6 ay.<br/>edit 2: lan olmadı ara alex'i sor amk comollisi. kaptan muhakkak takip ediyordur brezilya liglerini. kimi alalım de ya vallahi biri comolli'ye dünya haritası versin fenerbahçe'nin son 20 yılından falan bahsetsin.
  entry_channels: spor
- entry_name: |
    türk kızı
  entry_id:  85734549
  ...
  entry_fav_count: 4
  entry_content: |
    bu başliğin altinda kezban diye tanim yapan türk erkekleri, parayı da siz yediriyorsunuz, kendinizi de siz ezdiriyorsunuz. sanki o kezo dedikleriniz italyanlarla takiliyor. kezban sizin yarattiğiniz bi karakter, her yansımasında kendinizden bir parça görebilirsiniz.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
    erkeğin sarhoşluğu komik kadınınki iticidir
  entry_id:  85737132
  entry_writer: cok testisli adam
  entry_fav_count: 4
  entry_content: |
    erkek, kadın farketmez komiklik veya iticilik sarhoşluğun derecesiyle ölçülür.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  85710336
  entry_writer: shanuko
  entry_fav_count: 3
  entry_content: |
    uçlu kalemin tepesindeki silgiyi asla kullanmam şayet başkası benim uçlu kalemimin tepesindeki o silgiyi kullanmışsa ufak çapta sinir krizi geçiririm. <br/><br/>bir silgiyi kullanmaya hangi tarafından başladıysam bitene kadar hep o tarafını kullanırım.<br/><br/>kitap üzerinde tükenmez kalem ile gereksiz karalama yapılması, işaret konulması durumunda yine ufak çapta bir sinir krizi geçiririm.
  entry_channels: anket,ekşi-sözlük
- entry_name: |
    saç beyazlamasına çözüm
  entry_id:  85737692
  entry_writer: miss illyrian
  entry_fav_count: 2
  entry_content: |
    gelmesini istemediğim çözümdür.<br/>bir erkeğe en çok yakışan şey bence.<br/>tabii haydar dümen gibi bembeyaz değil yani.<br/>hemen şımarmayın pişmaniye kafalar.<br/>hafif beyazlar seksidir yani. hayret yazarken artık hiç utanmıyorum.
  entry_channels: 
- entry_name: |
    kova burcu kadını
  entry_id:  85737498
  ...
  entry_fav_count: 2
  entry_content: |
    en ulvi ve de muhteşem özellikleri bünyesinde taşıyan kadınlardır. onlar öyle kadınlardır ki heykeli yapılası, pamuklara sarıp sarmanası, klonlanıp klonlanıp çoğaltılası kadınlardır.<br/><br/>yapılmış olan negatif tanımlara uygun kova burcu kadınları yükselen burçlarının etlisindedirler. <br/><br/>kova burcu kadını olmak onbir burcun sultanı olmaktır.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    <a class="b" href="/?q=mor+ve+%c3%b6tesi">mor ve ötesi</a> - <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=kyRXWArpl8Y" title="https://www.youtube.com/watch?v=kyRXWArpl8Y">bir derdim var</a>(senfonik)
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    2 hafta icinde ayrilacak diye bir soylenti cikan futbolcu.<br/><br/>2 defa daha besiktas formasi giyerse porto'yu bir macla gecip kariyerinde en cok forma giydigi takim besiktas oluyor. bu da mi tesaduf?<br/><br/>edit: porto’ya donuyormus zaten. haberi bile yoktur muhtemelen ama biz aylaklar...
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    operasyon insanı. gönder gabar dağına 2 faul 3 kırmızı kartla pkk'yı bitirsin.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://open.spotify.com/track/2M6ShgvnuxvR4XDEtUzu6U?si=c2e1VZ7OTCmN3B0c2ed-tQ" title="https://open.spotify.com/track/2M6ShgvnuxvR4XDEtUzu6U?si=c2e1VZ7OTCmN3B0c2ed-tQ">zülfü kaküllerin amber misali</a>
  entry_channels: anket,müzik
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  85734514
  entry_writer: nicholai hel
  entry_fav_count: 0
  entry_content: |
    "yemeksepeti uygulamana kredi kartımı tanımladım, uğraşma yemekle falan karıcım." bence uygun.
