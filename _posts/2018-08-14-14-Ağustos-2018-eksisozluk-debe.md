...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    13 ağustos 2018 nişantaşı'nda çekilen fotoğraf
  entry_id:  80225185
  entry_writer: mutlu tuccar
  entry_fav_count: 114
  entry_content: |
    talancı arap içeren fotoğrafdır.<br/><br/>edit: gerçi biraz gereksiz olmuş, talancı olmayan arap mı var sanki.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    dolar ve ısrarla artırılmayan faiz meselesi yüzünden burda da saçma işler oluyor. bilhassa kamu borçlanma araçları ağırlıklı fonlarda tutuyorsanız paranızı sene başından beri eksidesiniz. para biriktirmek için bir yere para bağlıyorsunuz ve paranız azalıyor. muhteşem bir oksimoron.<br/><br/>bes şirketlerinin buna acil el atması gerek yoksa büyük bir çıkış yaşamaları olası.
  entry_channels: siyaset,ekonomi
- entry_name: |
