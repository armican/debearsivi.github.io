...
- entry_name: |
  ...
  entry_fav_count: 68
  entry_content: |
    "peki geri kalanını amazon yerlileri mi fethetmişti?" sorusunu akla getiren saptayamayış.
- entry_name: |
    jack daniel's
  entry_id:  67936898
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    bu malı kulübe alanı mahkemeye vermek lazım.
- entry_name: |
    deniz baykal
  entry_id:  67943033
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    biliyorum merak ediyorsun<br/>insan işte<br/>aklına, kalbine düşmeye görsün<br/>ne olursa olsun kaldırmıyor düşeni<br/>hep düşsün istiyor<br/>hiç söyleyemiyor.<br/><br/>biliyorum merak ediyorsun<br/>yalnızlık işte<br/>ilk akla gelen <br/>en çok sevilen<br/>fakat hiç sevilmeyen. <br/><br/>biliyorum merak ediyorsun<br/>sevgi işte<br/>yıllar geçse de geçmiyor<br/>sevgi de bir çeşit acı sanki<br/>ömrünün sonuna kadar sürüyor<br/>insanın en güzel en acı sızısı<br/>sızlıyorsun ansızın<br/><br/>biliyorum merak ediyorsun<br/>hayat işte<br/>birbirine benzeyen <br/>birbirine paralel <br/>iki yalnız<br/>aynı yöne uçan kuşlar gibi<br/>kendi yalnızlığımıza konduk. <br/><br/>biliyorum merak ediyorsun. <br/>etme. <br/>sen gibiyim.<br/>sen nasılsan <br/>ben de öyleyim.
- entry_name: |
    kemal kılıçdaroğlu
  entry_id:  67950284
  ...
  entry_fav_count: 2
  entry_content: |
    kaybettiği için değil toplumun değişim ve geleceğine sahip çıkma isteğini pasifize ettiği için gitmelidir, gönderilmelidir ve hatta devrilmelidir. kendisi düzgün, iyi niyetli ve dürüst bir insandır. toplumu sokaktan uzak tutmak isteğini sorumluluk olarak göremiyoruz artık. çocuklarımızın gelecek 10 yılları gidiyor, özgürlükler gidiyor koskoca cumhuriyet gidiyor. zaman "ya istiklal ya ölüm" sözünün gerektirdiğini yerine getirme zamanıdır kemal bey. siz bunu anlamıyorsanız anlayan birinin koltuğunuza oturmasına izin verin.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    şu ana kadar zaten aynı yoldan gecikmeli olarak geçiyoruz. parti devleti, tek adam, rezil ekonomi, yüksek işsizlik, makarna ile kandırılan halk, sadece inşaata yoğunlaşıp bunlarla halkı kandırmak vs vs vs<br/><br/>venezuela, kuzey kore, suriye karışımı bir ülkeye doğru hızla gidiyoruz
- entry_name: |
    şu anda çalan şarkı
  entry_id:  67941711
