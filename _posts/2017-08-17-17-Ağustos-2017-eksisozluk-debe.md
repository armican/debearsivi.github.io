...
- entry_name: |
    700 bin tl verip 2+1 daire alan insan
  entry_id:  70222158
  entry_writer: galektersiz
  entry_fav_count: 81
  entry_content: |
    üst edit: arkadaşlar şu kısa yazarlık hayatımda bu entryden dolayı aldığım mesajı başka hiç bir yerden alamadım. öncelikle belirteyim 700.000 lira olduğu gibi kalacak değil biliyorum. 10 20 yılda anca erir bu para. eriyene kadar da sizi insan gibi yaşatır. siz de zaten eşek değilsiniz ya 10 20 yılda işe de girersiniz biraz üzerine koyarsınız. <br/><br/>üst edit 2: ayrıca hangi banka veriyor bu faizi diyenler var. enpara'dan bakıp söyledim ben. 7000den fazla veriyor hatta net faiz.<br/><br/>şimdi eğri oturup doğru konuşalım ben mi hatalıyım siz söyleyin.<br/><br/>diyelim elimde 700.000 lira var. ben buna istanbulda 2+1 ev almak yerine faize yatırsam aylık 7.000 lira net para geçer elime.<br/><br/>7.000 lira ile antalya'ya gittim. hadi diyelim o kadar yoktur ama 1.500'e lüks bir daire kiralayabilirim lara'da konyaaltın'da hurma'da. <br/><br/>elimde 5.500 lira para kaldı. hiç bir işe girmediğimi farz edersem 5.500 lira ile gayette güzel yaşayabilirim. yok yani yaşanabilir. öyle kıt kanaat de değil bildiğin güzelce yaşanır yani.<br/><br/>çok değişik hayatlar var.
- entry_name: |
    domagoj vida
  entry_id:  70212335
...
- entry_name: |
    torku konyaspor olan araba
  entry_id:  70221398
  entry_writer: dusun dusun boktur nickin
  entry_fav_count: 36
  entry_content: |
    (bkz: <a class="b" href="/?q=bi+k%c3%b6%c5%9fede+%c3%b6l%c3%bcr+m%c3%bcs%c3%bcn+l%c3%bctfen">bi köşede ölür müsün lütfen</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 29
  entry_content: |
    --- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>altına kraliçeden temiz, iyi huylu bir ejderha çekmiş olan reis. mızrakla dart atar gibi,kolu oynamadan 2 km uzaklıktaki ejderhayı vurabilme yeteneğine rağmen kıstırdırdığı 100 metre önündeki jon snow ve çetesine bir şey fırlatmama kararına saygı duyuyorum fakat böyle savaş kazanılmayacağını bilmesini isterim.<br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---
- entry_name: |
...
- entry_name: |
    açıktan spoiler veren suser uçurulsun kampanyası
  entry_id:  70229335
  entry_writer: explorateur
  entry_fav_count: 23
  entry_content: |
    elzem olandır. moderatörlerden ricadır.<br/><br/>şu anki haliyle sadece kısa süreli çaylak yapılıyor bu aptallar. ayrıca trollüğünde bir kalitesi var lan. azıcık yaratıcı olun.<br/><br/>--- <a class="b" href="/?q=if%c5%9fa">ifşa</a> ---<br/>... <br/>spoiler link içermektedir.<br/>...<br/>ifşa: <a class="b" href="/entry/70228743">#70228743</a> nicki <a class="b" href="/?q=mapy">mapy</a><br/>--- <a class="b" href="/?q=if%c5%9fa">ifşa</a> ---
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    (bkz: <a class="b" href="/?q=orospu+cocugu">orospu cocugu</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    ' daha çok anlat ' dedim.<br/>' hoşuna gidiyor mu? '<br/>' çok. elimden gelse seninle sekiz yüz elli iki bin kilometre hiç durmadan konuşurdum. '<br/>' bu kadar yola nasıl benzin yetiştiririz? '<br/>' gider gibi yaparız. ' j. mauro de vasconcelos - şeker portakalı.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    an itibariyle star tv'de oynamaktadır. <br/><br/>kemal sunal'ın yüzünü görmemle birlikte yüzümde hüzünlü bir tebessümle izlemeye başladım. ulan gece gece içim ısındı sanki ailemden birini gördüm.<br/><br/>"belediyemizin parkına hoşgeldiniz efem" <br/><br/>"efenim ben, belediyenin 2548 yaka numaralı temizlik işçilerinden apti şakrak. hasan ile seher'den doğma. anam babamın ikinci karısı zannederim. yozgat'ın şefaatli ilçesi'nden, 1948 doğumluyum. okumam yazmam ilk okulun üçüne kadar olup, sicilim son derece temizdir. nişanlımı kaçırma vukuatını saymazsak tabi..."<br/><br/>kezban türk kızının temellerini <a class="b" href="/?q=ay%c5%9fen+gruda">ayşen gruda</a> bu filmde atmıştır efendim. <br/><br/>edit: ekleme.<br/>edit1: ekleme.
- entry_name: |
    bitcoin
  entry_id:  70222470
  ...
  entry_fav_count: 3
  entry_content: |
    <a class="b" href="/?q=spk">spk</a>'nın <a class="b" href="/?q=bitcoin+ara%c5%9ft%c4%b1rma+raporu">bitcoin araştırma raporu</a>'nda bitcoin'in balon veya <a class="b" href="/?q=ponzi+scheme">ponzi scheme</a> olduğu iddialarına karşı şöyle bir ifade geçiyor: <br/><br/>"bitcoin kaldıraç etkisiyle işlem görmez, satın alınması tam finansmanla olur, bu sebeple<br/>balon değildir. bitcoin'in sahibi yoktur, fiyatı tamamen piyasa koşullarında belirlenir,<br/>fiyatındaki oynaklık sebebiyle kar veya zarar edilmesi önceden tahmin edilemez. bu sebeplerle,<br/>bir tür saadet zinciri de (ponzi scheme) değildir [35].<br/><br/>bitcoin'in başlardaki yatırımcılarının çok kazandığı iddiası da tam olarak doğru değildir.<br/>yatırımcıların bir kısmı, o dönemlerde fazla önemsemediklerinden gizli anahtarını kaybetmiş<br/>durumdadır, ilk başlarda fazla değerli olmadığından, büyük tutarlar transfere konu olmuştur.<br/>uzun dönemde baktığımızda, bugün bitcoin satın alanların, yarınların "sisteme erken girenleri"<br/>olup olmayacağı da bilinemez [35]."
- entry_name: |
    olan biten
  entry_id:  70228787
  ...
  entry_fav_count: 2
  entry_content: |
    ekşi sözlük 'te bakım nedeniyle bir süre erişim sıkıntısı olabileceğine dair entry girilmiş. <br/>mükemmel. <br/>ancak bunu favorilere almak nasıl bir kafanın ürünü onu anlayamadım. <br/>yani durup durup <br/>" ahhh ülennn ne guzel bakıma alınmış bea. işte böyle girilir entry ...ahhhhhğ beeaaa"<br/>şeklinde naralar mı atılıyor. <br/>vallahi anlamadım.
- entry_name: |
    ateizmin mitoloji yapısı olduğunun delilleri
  entry_id:  70228490
  entry_writer: bi degisik ormanci
  entry_fav_count: 2
  entry_content: |
    atezim=tanrıtanımazlık.<br/>tanrının yokluğu.<br/><br/>bu "ateistler aslında inançlı ki ehehehe" tribini anlamıyorum.<br/>adam diyor ki; tanrı yok. bu hala çabalıyor hahahahaha.
- entry_name: |
    16 ağustos 2017 real madrid barcelona maçı
  entry_id:  70227072
  entry_writer: ortalama insan dusuncesine sahip insan
  entry_fav_count: 2
  entry_content: |
    barcelona'nın arda'nın yokluğunu hissetmeyeceği maç.
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="http://ribony.com/dardanian" title="http://ribony.com/dardanian">geyiğin sağlamsa gel</a>. <br/>bir de +30 falan olun. <br/>altındaysan hiç zahmet etme.
---
