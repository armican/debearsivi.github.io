...
- entry_name: |
    dede diye kime denir büyükbaba diye kime denir
  entry_id:  70219937
  entry_writer: balici koala
  entry_fav_count: 14
  entry_content: |
    büyükbaba, noelde sana ve kız kardeşine hediye alan adama denir.<br/><br/>dede, sıçtı mı gök gürleten bir canlıdır. daha samimidir.
- entry_name: |
    bitcoin
  entry_id:  70211653
  ...
  entry_fav_count: 12
  entry_content: |
    coursera.org sitesinde princeton üniversitesi hocaları tarafından online bitcoin ve şifreleme teknolojileri dersleri açıla dursun bizim ekşici dantel tayfa hala balon amk diyedursun.<br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.coursera.org/learn/cryptocurrency">https://www.coursera.org/learn/cryptocurrency</a><br/><br/>işte öyle bir şey.
- entry_name: |
...
- entry_name: |
    konsere gitmenin mantıksızlığı
  entry_id:  70216101
  entry_writer: yedinci element
  entry_fav_count: 9
  entry_content: |
    konsere gitmek bence mantıksız değil ama düşününce konser bir garip.<br/><br/>üç beş insan +x yönüne bakıp önceden belirlenmiş bazı sözleri ritmik olarak tekrarlıyor, bu sırada çok daha kalabalık olan bir grup -x yönüne bakarak o insanları izliyor dinliyor falan.<br/><br/>bir çeşit ayin gibi.
- entry_name: |
...
- entry_name: |
    papaz nikah kıyıyor müftü niye kıymasın
  entry_id:  70221221
  entry_writer: garda
  entry_fav_count: 8
  entry_content: |
    çünkü orada irtica tehlikesi yok. <br/>bir yerde bir tehlike varsa orada bazı özgürlükler kısıtlanır. mesela almanya'da milli marş, aşırı milliyetçi olmak, çok fazla bayrak göstermek sıkıntılıdır. neden? nazi belası vardı da ondan. 2006 sonrası şansolye artık almanlar bayraklarını saklamıyor diye açıklama yapmıştı mesela. o günleri atlatıyoruz münvalinde.<br/>oysa türkiye 100 yıl önceki irticanın kucağında. <br/>anladın mı sayın aptal taklidi yapan çakal ordusu?<br/>işine gelince batıyı örnek al işine gelince eleştir ne güzel iş amk.
- entry_name: |
    night's king
  entry_id:  70228871
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    (bkz: <a class="b" href="/?q=bana+sa%c4%9fc%c4%b1lar+adam+%c3%b6ld%c3%bcr%c3%bcyor+dedirtemezsiniz">bana sağcılar adam öldürüyor dedirtemezsiniz</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    gelin muhabbet edelim. tanışır, hoşlaşırız belki. <br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="http://connected2.me/keskinustura">http://connected2.me/keskinustura</a>
- entry_name: |
    ejdarha ölmesi
  entry_id:  70229950
  entry_writer: ekşisözlük
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=%c3%b6l%c3%bcmc%c3%bcl+ejderha">ölümcül ejderha</a>)
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    sözlük iyice <a class="b" href="/?q=no+man%27s+land">no man's land</a> kıvamına geldi. sabahtan beri spo spamliyorlar ama yönetimden kimsenin taktığı yok sözlüğü veya öyle gözüküyor. bakalım ne olacak denilecek öneri.
---
