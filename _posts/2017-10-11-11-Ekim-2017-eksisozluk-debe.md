...
- entry_name: |
  ...
  entry_id:  71285319
  entry_writer: skyturx
  entry_fav_count: 37
  entry_content: |
    böyle rezalet olmaz olsun.<br/>görüntü yan çekilmiş, ayrıca net değil.<br/>insan zoom filan yapar, 16:9 full hd çeker de bu terörist sevicinin yediği dayağı güzelce izler iç yağlarımızı eritir, keyifle çayımı höpürtedirtim.<br/><br/>ha dayak olayımı, ona dayak demezler eğitim derler. dersini vermiş arkadaşlar ellerine sağlık.
- entry_name: |
    şebnem ferah
  entry_id:  71291920
...
- entry_name: |
    3'ün 5'e eşit olduğu gerçeği
  entry_id:  71300732
  entry_writer: nigdegazozu
  entry_fav_count: 26
  entry_content: |
    maliye bakanlığı zam açıklamasında kullanılabilecek hesaptır.
- entry_name: |
...
- entry_name: |
    gelin fetö'yü alın deseler sınırı geçemiyoruz
  entry_id:  71299487
  entry_writer: mamut bonfilesi
  entry_fav_count: 17
  entry_content: |
    hani demezler de, ola ki dediler, sınırı geçecek vizemiz yok lan ne acı.
- entry_name: |
...
- entry_name: |
    beşiktaş'ın milli takımı taşıyamaması
  entry_id:  71294863
  entry_writer: syntax terror
  entry_fav_count: 13
  entry_content: |
    bazıları için her yol beşiktaş'a çıkıyor arkadaş.<br/>oysa asıl sorun kulüpten bağımsız.<br/>(bkz: <a class="b" href="/?q=baz%c4%b1+primseverlerin+milli+formay%c4%b1+ta%c5%9f%c4%b1yamamas%c4%b1">bazı primseverlerin milli formayı taşıyamaması</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    istanbul levent cıvarında part-time veya full-time olarak bisikletli kuryelik yapmak isteyenlere yardımcı olabileceğim oluşum! şartlar da baya iyi hani. <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
- entry_name: |
    ekşi itiraf
  entry_id:  71288048
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    fransa, almanya ve ab katalonya'nın bağımsızlığını tanımayacağını geçtiğimiz günlerde açıklamıştı. işler ciddileşmeye başlayınca barcelona belediye başkanı bile bağımsızlık için erken bir zaman olduğunu söyledi. katalan lider defalarca bugünü işaret ederek bağımsızlıklarını ilan edeceğini, madrid ise böyle bir durum karşısında müdahale edeceğini söylemişti. hatta bağımsızlık açıklaması yapılması durumunda ispanyol polisinin katalan lideri gözaltına alacağı söylentileri de var.<br/><br/>şu an gözler türkiye saatiyle 19.00'da açıklama yapacak olan katalan lider carles puigdemont'da. kendisi için iki seçenek var. ya bağımsızlığı ilan etmeyecek, bunun yerine sembolik bir konuşma yapıp, madrid ve brüksel'e diyalog çağrısı yapacak. ya da katalonya'nın bağımsızlığını ilan edecek ve diğer bağımsızlık yanlısı politikacılarla gözaltına alınacak, katalonya karışacak. arkasında desteğini aldığı katalanlar karşısında ise kendi topraklarındaki özerk yönetimlerin de bağımsızlık sevdasına düşmesinden korkan avrupa'nın ağır topları var. muhtemelen bağımsızlığı erteleyeceğini düşünüyorum fakat kendisi bir daha bugünkü gibi bir fırsatı çok uzun bir süre boyunca elde edemeyebilir. bunu kendisi de biliyor.<br/><br/>ne olacağını kestirmek güç fakat kesin olan bir şey var ki o da özellikle ortadoğu'da her toplumsal olayda devlet politikalarını en ağır şekilde eleştiren ve teröristlerin de desteğini alan özerk yönetimlerin bağımsızlık ilan etmelerine açık destek veren avrupa'nın aynı olaylar kendi içinde görüldüğünde görüşlerinin 180 derece değiştiğidir.<br/><br/>keser döner sap döner gün gelir hesap döner.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=asgari+ucret+2800tl+olacak">asgari ucret 2800tl olacak</a>)
---
