...
- entry_name: |
  ...
  entry_fav_count: 138
  entry_content: |
    yaptıkları kürt ırkçılığını artık gizlemeye de gerek duymayan parti'nin yeni haltı. <br/><br/>buldak'ın linkteki videoda da bulabileceğiniz açıklamalarından alıntıdır:<br/><br/>"mardin'i kürtler, araplar, ezidiler, süryaniler, mıhallemiler, kadınlar, gençler ve emekçiler yönetecektir"<br/><br/>mardin'de bir tane türk yok mu? nedir bu alerji? <br/>"kürt" kelimesinin yanına istedikleri kadar etnik grup eklesinler, onları umursamadıkları, dertlerinin türk düşmanlığı olduğu ayan beyan ortada.
...
- entry_name: |
    miha zajc
  entry_id:  86167383
  entry_writer: caysevenadam
  entry_fav_count: 82
  entry_content: |
    üstteki yazar umarım şaka yapıyordur. ömrümde bu kadar kötü kadro kurma görmedim.
  entry_channels: spor
- entry_name: |
    zor okunan kitaplar
  entry_id:  86151762
...
- entry_name: |
  ...
  entry_fav_count: 73
  entry_content: |
    bir an gerçekleşirse nasıl açıklayacak seçmene diye düşündüm, sonra kulaklarımda erdoğan'ın miting sesini duydum yemin ediyorum. blinçaltıma düşünce yapıları nasıl işlemişse.<br/><br/>"e biz bunlara zamanında borç verdik, biliyorsunuz. şimdi dedik "sen hele bizim sana verdiklerimizden biraz ver." hemen işi yokuşa sürüyorlar. o parayı vereceksiiiin, kimin parasını kime vermiyorsun sen ya? artık güçlü bir türkiye vaaaar, cehape zamanındaki türkiye yooooook, bu da böyle biline!"<br/><br/>sorgu sual olmadığı için adam için bu kallavi dönüş bile 2-3 cümle ile açıklanabilir halde şu anda.
  entry_channels: siyaset,haber,ekonomi
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 62
  entry_content: |
    soldado, moses ve ekici'nin golleriyle 3 atıp göndeririz.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    yeşil rengin en çok yakıştığı araba modeli
  entry_id:  86154148
  entry_writer: uyeolmadanlinkigoremeyenadam
  entry_fav_count: 32
  entry_content: |
    (bkz: <a class="b" href="/?q=el+arabas%c4%b1">el arabası</a>)
...
- entry_name: |
    31 ocak 2019 ziraat bankası rezaleti
  entry_id:  86152589
  entry_writer: dimswart
  entry_fav_count: 19
  entry_content: |
    olmayan rezalet. <br/><br/>12:30 da öğle arası başlıyor, 12:25 te müşterinin işi bitmiş. ee senin işin de 5 dklık iş değil. gayet doğal olarak öğle arasından sonra halledeceksin. sen kimsin ak?
  entry_channels: ekonomi
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    bunun en kolayı ya mülakat koymayacaksın ya da mülakatlar kameraya alınacak. <br/><br/>ama bunlar işlerine gelir mi? gelmez.
  entry_channels: siyaset,haber,eğitim
- entry_name: |
    osmanlı padişahlarının çılgınlıkları
  entry_id:  86165901
  entry_writer: asi koreli
  entry_fav_count: 16
  entry_content: |
    3.mehmet'in tek gecede en büyüğü 13 yaşında olan 19 kardeşini katletmesi,rezil herif seni.
...
- entry_name: |
    iyi ki almışım denilen kararlar
  entry_id:  86147880
  entry_writer: defoe
  entry_fav_count: 11
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    dudaklarında şarkı, <br/>göğsünde nefes olmak...<br/><a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/SvjB8SjDqW8" title="https://youtu.be/SvjB8SjDqW8">olmalı, olacak, istiyorum - nilüfer &amp; kayahan</a>
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    ömer baba'nın olur olmadık yerde kafa ütülemesi.
...
- entry_name: |
    ışık hızına çıkılırsa g force ne olacak sorunsalı
  entry_id:  86168412
  entry_writer: angry engineer
  entry_fav_count: 6
  entry_content: |
    (bkz: <a class="b" href="/?q=geforce+experience">geforce experience</a>)
...
- entry_name: |
    bozkır (dizi)
  entry_id:  86166220
  entry_writer: thedeadpoet
  entry_fav_count: 3
  entry_content: |
    çok iyi bir bölümle final yapan dizi. bölüm içinde verilen ince mesajlar, heyecanlı yanı ve final sahnesiyle uzun süre hatırlanacaktir diye düşünüyorum.<br/><br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>illa düşününce şunun da cevabı verilmedi dedigim bir seyler cikar ama genel olarak olaylar, altinda yatan psikolojiler vs. konusunda tatmin oldum. geçen netflix'teki ted bundy belgeselinde de izledigim gibi, seri katiller icin oldurmek adeta bir tutku. abbas ve fikret'in bu tutkularinin neler dogurdugunu ve aralarindan hassas olanin nelere evrilebilecegini gayet güzel anlattı. başından beri abbas'a kıldım ama katil cıkacagıni dusunmuyordum nedense. ah be benim deli fisek nuri'm. sen dedin de kimse adam yerine koyup seni dinlemedi.<br/><br/>bölümün bir baska sevdigim yanı ise emniyet mudur ve cevresindeki polisler uzerinden saglam bir adalet ve sistem elestirisi yapmis olmasiydi. genel olarak 10 bölümde de bu elestiri mevcuttu zaten. ayrica futbol uzerinden uyutulan halk betimlemeleri de bayağı iyiydi. kendi halinde sıkışmış kalmış bir iç anadolu şehri ancak bu kadar güzel anlatılırdı zaten.<br/><br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>son olarak seyfi amir ve nuri pamir sizi çok özleyecegiz. son zamanlarda türk dizilerinde kendini bu kadar iyi tamamlayan bir ikili olmamıştı. son sahnedeki o müzik ve o diyaloglar nefisti. ayrıca nuri'nin hiç susmadan konuştuğu araba sahnesi filan da pek şahaneydi<sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>yiğit özşener ve ekin koç gönlünüze bereket, çok iyi iki oyunculuktu.<br/><br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>amirim ben ilk defa vuruluyorum biliyor musun...<br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    annem için tüm tavsiyelere açık olduğum, herkesin fikrini alabileceğim aksiyon.<br/><br/>annemin derhal sigarayı bırakması gerekiyor ama geçmişte "ya ben ya sigara?" dediğimde "sen akıllı çocuksun, böyle bir şeye girmezsin" diyebilecek kadar bağımlı birinden bahsediyoruz. günde 4 paket içtiği günleri biliyorum, neyse ki o günler geride kaldı ama yine günde 1 paketten aşağı düşmüyor ve bu kadın 60 yaşında şu an. bir sürü sağlık problemiyle uğraşıyor, sen ben soğuk algınlığını bir haftada atlatırken onunki bir ay sürüyor. çoğunlukla zatürreye çeviriyor falan.<br/><br/>babam da yaklaşık 40 sene içtikten sonra 2009'da bir gecede tamamen bırakmış biri ve evde anneme sürekli bırakması için telkinde bulunuyor ancak bunun işe yaramadığı çok açık ortada. artık telkinden ziyade teknik bir yöntem arayışımız söz konusu. bilen, duyan varsa yeşillendirsin lütfen.
  entry_channels: anket,sağlık
- entry_name: |
    prag denince akla gelenler
  entry_id:  86171419
  entry_writer: kedili seksi erkek
  entry_fav_count: 1
  entry_content: |
    bir noel zamanı old town’da elimde ballı şarap gülüp eğlediğim aklıma geldi.
  entry_channels: anket,tarih,seyahat
- entry_name: |
    çarpışma (dizi)
  entry_id:  86168964
  entry_writer: kurek operatoru
  entry_fav_count: 1
  entry_content: |
    hadi veli ve çetesini anladım bunlar parayı buluyor <br/>ama kadir adalı ve ailesi nereden buluyor parayı onu anlamadım yani yemek yiyecek parayı nerden buluyorlar
  entry_channels: tv,spoiler
- entry_name: |
    geceye bir siyasi slogan bırak
  entry_id:  86170616
  entry_writer: maximuss
  entry_fav_count: 0
  entry_content: |
    68 hareketlerindeki en ikonik cümlelerden çok da hoşuma gider.<br/><br/>“sous les paves la plage!” - “kaldırım taşlarının altında plaj var!”<br/><br/>fransızlar acayip millet, haklarını ararken veya baş kaldırırken bile estetik olmayı unutmuyorlar.
  entry_channels: siyaset
- entry_name: |
    31 ocak 2019 bayern münih fenerbahçe beko maçı
  entry_id:  86171213
  entry_writer: italiano20
  entry_fav_count: 0
  entry_content: |
    at avrat yunan guard atasözüne güvendiğim maç. henüz izlemeye başladım ama sloukas’ı görünce alırız bu maçı dedim. obra yine agresif, sloukas’ta bir “ben yaparım” havası, kalinic yine görev adamı iceman, datome soğukkanlı seri katil imajında; kısacası 70-80 gibi alırız bence bu maçı.
  entry_channels: spor
---
