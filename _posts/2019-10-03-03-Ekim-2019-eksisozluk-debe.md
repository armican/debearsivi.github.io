...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    tiffany diyen ekşiciler yavaştan entry silmeye başlamıştır diye tahmin ediyorum <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    (bkz: <a class="b" href="/?q=odam+kire%c3%a7+tutmuyor">odam kireç tutmuyor</a>) <br/>(bkz: <a class="b" href="/?q=benzemez+kimse+sana">benzemez kimse sana</a>) <br/>(bkz: <a class="b" href="/?q=evvelim+sen+oldun+ahirim+sensin">evvelim sen oldun ahirim sensin</a>) <br/>bu üçünü dinleyerek bir 35'lik içebilirim...
...
- entry_name: |
  ...
  entry_id:  96070230
  entry_writer: gokyuzudenizveozgurluk
  entry_fav_count: 1
  entry_content: |
    şöyle tazecik <a class="b" href="/?q=fava">fava</a>.
  entry_channels: anket,yeme-içme
- entry_name: |
    şu an dinlenen şarkıdan bir cümle
  entry_id:  96074267
  entry_writer: sira bize de gelir mi
  entry_fav_count: 0
  entry_content: |
