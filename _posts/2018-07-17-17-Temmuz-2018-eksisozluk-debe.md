...
- entry_name: |
    şule çet cinayeti
  entry_id:  79224322
  entry_writer: violetsky
  entry_fav_count: 28
  entry_content: |
    bu olay yıllar önce ankara'da okurken parti time çalıştığım şirketin patronuyla yaşadıklarımı getirdi aklıma. büyük bir şirketti ( ankara merkezli bir holding) tunalı hilmi yakınlarında 10-12 katlı bir binası vardı. en ust kat patronun ofisiydi ve o kata asansörle çıkmak ya da o kata asansör çağırmak için anahtar gerekiyordu merdivenlere açılan kapı için de öyle. <br/>cumartesiler öğlen 1e kadar orada oluyordum her cumartesi saat 1e 10 kala patron arayıp asansöre bin ben seni yukarı çekeyim derdi. ilk seferinde projelerle ilgili bir şey söyleyecek diye gittim bana bodrum'daki yatının fotoğraflarını gösterdi 'artik mezun oluyorsun, bu yaz güzel bir tatil yapmak istersin bence' dedi. bakalım dedim ben de. ankara'da kalıp kalmayacağımi o şirkette tam zamanlı çalışıp çalışmak istemediğimi sordu. ben hep gecistirdim bakalım göreceğiz dedim. yurtta kalıyordum ev tutalım sana gitme ankara'dan dedi. sonra italyadan çok güzel şaraplar getirdim içelim dedi. saat 2 oldu gideyim ben okul projeleri var yetistirmem gereken dedim. çıktım odadan sekreteri gitmiş asansörün de merdivenin de anahtarı yok bende. çağırdı asansörü indim. inanılmaz korktum. paraya ihtiyacım vardı çalışmaya devam ettim. ama cumartesiler odamdaki telefon çalınca acmamaya başladım. insan kaynaklarından cep numaramı alıp cep telefonumu aramaya başladı yukarı gel diye. gitmedim hiç en fazla kovar ne yapayım dedim. 2 ay böyle devam etti. iki ayın sonunda haftaici çalıştığım günlerden birinde müdürüm beni odasına çağırdı. gittim patron orada. müdür 'x bey konusacakmış sizinle kata gelmişken ben çağırdım sizi' dedi çıktı gitti. adam bana sana zam yapalım dedi öyle konuşmuştuk dedi. ne kadar zam istiyorsun dedi. ben birseyler söyledim. sonra durdu sen burada çalışma en iyisi dedi. kovdu sonunda derken sen benim burslu öğrencim ol dedi sen her ihtiyacın olunca benden para iste ben veririm dedi. ben sizden para isteyemem dedim. e tabi samimiyetimiz yok isteyemezsin ama daha yakın olsak istersin dedi. mesela sevgili oluruz ne olacak dedi ev de tutarım sana yurtta kalmazsın dedi. ne diyorsunuz siz dedim ne var bunda sevgili olalım dedi. ben tepki veremedim kaldım öyle. neyse sen şimdi fazla sinirlendin git düşün haftaya kararını ver dedi. ertesi gün ise gitmedim. ama şimdi düşünüyorum beni tekrar tekrar yukarı çağırdığında gitseydim beni oraya kilitleseydi ne olurdu diye düşünüyorum.
  entry_channels: haber
- entry_name: |
...
- entry_name: |
    bir kadın için erkekleri çekici yapan özellikler
  entry_id:  79240764
  entry_writer: limon kimyon zorro
  entry_fav_count: 7
  entry_content: |
    görüyorsunuz canım okurlar türk erkeği işini asla şansa bırakmıyor. <a class="b" href="/?q=erkekleri+%c3%a7ekici+yapan+%c3%b6zellikler">erkekleri çekici yapan özellikler</a> diye başlık açsa, erkekler de o başlık hakkında fikir beyan edebilir ama türk erkeği ne yapıyor oraya nal gibi kocaman "<a class="b" href="/?q=bir+kad%c4%b1n+i%c3%a7in">bir kadın için</a>" kısmını ekliyor. işte bu azim ve kararlılık türk erkeğini tüm diğer erkeklerden ayıran özelliktir.<br/><br/>türk erkeği garanticidir.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    balık, yengeç ve akrep ölümüne yarışır romantiklikte. aşk yaşamak isteyen her kadının yolu bir gün mutlaka biri ile kesişince, inanın inim inim inletirler. aralarında bir tek balık kolayca sıyrılır, serilikte üstüne yoktur. bir kuyruk darbesi ile sizi çarpar, kaçar. dönsün gelsin diye yıllarca bekleyebilirsiniz.
  entry_channels: ilişkiler
- entry_name: |
    yaş 25 bedel 15
  entry_id:  79239448
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    sonucu itibarıyle travmatik ve dramatik bir seçimin ertesinde gülerek basın toplantısı yapan chp'nin looser genel başkanı..muharrem ince o gece çıkıp açıklama yapmadı da sen niye yapmadın? teşkilatın başı sen değil misin? neredeydiniz milleti yalnız bıraktınız? oy çuvallarını yastık yapıp uyudu millet!!
  entry_channels: siyaset,haber
---
