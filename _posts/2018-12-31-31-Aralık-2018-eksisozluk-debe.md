...
- entry_name: |
  ...
  entry_fav_count: 37
  entry_content: |
    bok gibi çünkü. türkiye'de pub kültürü olmayıp, meyhane kültürü olduğundan sivrilmiş bir içki. içenlerin %90'ı hala storye rakı kadehi atmak için içiyor. 2 saat sonra da kusuyor zaten.
  entry_channels: anket,yeme-içme
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 26
  entry_content: |
    "o bu değil de sizin enişte dobloyu sattı mı?" diye devam etmesini beklediğim diyalogdur..<br/><br/>(bkz: <a class="b" href="/?q=diplomaside+yeni+ak%c4%b1m">diplomaside yeni akım</a>)
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
    konya'nın izmir'den daha medeni olması
  entry_id:  84941711
  entry_writer: mmrr
  entry_fav_count: 17
  entry_content: |
    haha ne güzel söylemişler. istanbul'dan izmir'e değil de konya'ya göçün , biz de rahat edelim.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    ya mesele yas falan degil. hakatten degil. 32 yasindayim. millettin bu baslikta /duzenli hayat/ adi altinda gomdugu herseyi yapmisim. ha milletin /duzenli hayat antitezi/ olarak soyledigi herseyi de yapmisim, yapiyorum. bak hepsini 32 seneye sigdirmisim mesele bu yuzden yas degil. merak eden buyursun x y z denedin mi desin,cevabim buyuk ihtimalle evet olacaktir. ha mesele nedir? mesele ve esas sikinti, bu basliktaki durus. insanlarin /sorumluluktan ve disiplinden/ kacmak icin zihinlerinde olusturduklari koruma kalkani var, bunun adi da “kaliplara dahil olmamak, normlara,dayatilana karsi cikmak” gibi ulvi bir sosla sunuluyor. <br/><br/>ben daha cok kisinin hayatina yas bolu meydan okunan sey olarak bakiyorum. sonuc deger ne kadar kucukse , kendini begenmislik/muskulpesentlik/camdan kristal kuleler de o kadar kucuk oluyor. <br/><br/>35 yasinda /ev almadim/ise girmedim/evlenmedim vs diye kendini norm disi sanarak oven kisiler bu acidan baksinlar, yaptiklari duzene bir meydan okuma mi gercekten, yoksa sorumlulukan kacmak mi?<br/><br/>burayi okuyan genc arkadasim, bu ayrimin cok iyi bilincinde ol. kayserinin bir kasabasinda sana dayatilan bir an onve evlenip tarla tapan islerine kosup iyi bir musluman olmansa, abd ye aile destegini reddederek , evlenmeden, work and travele gidip orada tutunup isini kurmak ve diger kayserili genclere yol gostermek buyuk bir meydan okumadir ve devrimci bir harakettir. kendi adina sorumluluk alip basarmissin bravo. <br/><br/>ama sehirli munasip bir ailede buyuyup, uzerinde hemen hemen hic bir kisit/baski olmaksizin uniyi bitirip, bu kisitlar baskilarin yoklugunda sorumluluk almak , meydan okumak nedir hic ogrenmedigin icin, en ufak bir sorumluluktan “yoknyok o normal olmak demek ben normal olamam” diye konusuyorsan afedersin bir s.k degilsin burada ruzgar yapip gencleri yanlis yonlendirme. <br/><br/>hemen her giride soyledigim gibi,<br/>erkek cinsiyetine mensup iseniz,<br/>kalkin, savasin, isirin, sizin olani ve sizin olmasini istediginiz seyi elinizle ensesinden tutun, kendinize dogru cekin, kaslariniz gerilsin, tuyleriniz diken diken olsun, sirtiniz terlesin, damarlariniz sissin ve yorgunlukla yere yikilin. <br/>bir daha kalkin, bir daha meydan okuyun. <br/>tekrar yere sersin sizi. <br/>tekrar kalkin, tekrar meydan okuyun. <br/><br/>kadin olmayi hic deneyimlemedigim icin, kadinlar icin bir sey diyemiyorum, kadin yazarlar kusura bakmasin artik.
  entry_channels: anket,ilişkiler
- entry_name: |
    bizimle grev denilen olaylar ortadan kalktı
  entry_id:  84947047
  entry_writer: sartlari kabul ediyorum
  entry_fav_count: 13
  entry_content: |
    meali: grev yapmaya kimsenin götü yemiyor.
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    takip edenlerle kesinlikle anlaşamadığımı farkettim.
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    hep unutulur, hatırlatmakta fayda var. üst düzey lüks aracını yabancı uyruklu hanımının üzerine alarak, bizim vergilerimizle maaş aldığı halde, aldığı araba için vatandaşı olduğu ülkeye vergi vermemiştir. satmıştır sonra orasını bilmem.
  entry_channels: spor,siyaset,anket,motosiklet
- entry_name: |
    mesajınız var yeşili
  entry_id:  84919883
  entry_writer: mestiar
  entry_fav_count: 8
  entry_content: |
    düşünülen:<br/><br/>aha biri mesaj atmış, bakalım kiminle tanışacağız?<br/><br/>aslında olan:<br/><br/>(#fjsjdırjfjfkdk) numaralı entryniz, o başlıktan bu başlığına taşınmıştır.
...
- entry_name: |
    ilişkiye zarar veren şeyler
  entry_id:  84946064
  entry_writer: monurknbr95
  entry_fav_count: 7
  entry_content: |
    geçmişte yaşananlara çok fazla kafayı takmak ve her açıkta geçmişi suratına vurmak
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    4 sezon önce y.malatyaspor 2.lig beyaz grupta oynarken bu çocuk bizim takıma geldi. takım yükseldikçe sadık da yükseldi. işin ilginci 2.ligdeyken, 1.ligdeyken ve şimdi süper ligde takımın en dikkat çeken en başarılı ismi oldu. yani kısmet olur uefa maçları oynarsak orda da yıldızını parlatacak bundan eminim.<br/><br/>malatya halkı onu çok sevdi o da taraftarı çok seviyor. tribünle en içli dışlı olan oyuncumuzdur. elbet günün birinde buradan gidecek ama temennimiz hem takıma kazandırıp gitsin hem de banko oynayacağı efsane olacağı bir takıma gitsin.
  entry_channels: spor
- entry_name: |
    torku şişe bira 30cl
  entry_id:  84946703
  entry_writer: doza te doza meye
  entry_fav_count: 4
  entry_content: |
    yerli ve milli olduğu için ben hep 50 tl lik alıyorum.
  entry_channels: yeme-içme
- entry_name: |
    bon jovi'nin en iyi şarkısı
  entry_id:  84947932
  entry_writer: ll
  entry_fav_count: 4
  entry_content: |
    biraz kıyıda köşede kalmış olsa da <a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/e7Bkp4pAo1k" title="https://youtu.be/e7Bkp4pAo1k">ugly</a> bence.
  entry_channels: anket,müzik
- entry_name: |
    iphone xs max kullanan asgari ücretli insan
  entry_id:  84948421
  entry_writer: gddr5
  entry_fav_count: 2
  entry_content: |
    alırken ekşi sözlük ulemalarına danışmayarak çok ayıp etmiştir. halbuki her konuda olduğu gibi ekşi sözlükteki muhasebecilere hesap vermesi gerekiyordu kendi kazandığı parayı harcarken.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=adnan+oktar+ve+kedigiller">adnan oktar ve kedigiller</a>)
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    hem kel hem fodul olunca daha bir büyüyen seksilik.
  entry_channels: ilişkiler
- entry_name: |
    145 kişinin aşık olduğu iran prensesi
  entry_id:  84949371
  entry_writer: cay sigara
  entry_fav_count: 0
  entry_content: |
    ben de aşık oldum.ama link çalışmıyor, göremedim henüz.
