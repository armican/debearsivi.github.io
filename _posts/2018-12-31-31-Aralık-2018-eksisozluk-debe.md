...
- entry_name: |
    serdar aziz gökhan töre takası
  entry_id:  84945657
  entry_writer: baska zamanlardan gelen adam
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=g%c3%b6khan+t%c3%b6re+kim+amk">gökhan töre kim amk</a>)
  entry_channels: spor
- entry_name: |
    kel erkek seksiliği
  entry_id:  84949150
  ...
  entry_fav_count: 0
  entry_content: |
    olmayan seksiliktir.seksi olmak için allah vergisi yakışıklı olmak gerekir oda çok çok zor..
  entry_channels: ilişkiler
- entry_name: |
