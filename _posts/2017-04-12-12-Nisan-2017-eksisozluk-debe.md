...
- entry_name: |
    ahmet necdet sezer'in en büyük başarısı
  entry_id:  67391807
  entry_writer: zubizelatte
  entry_fav_count: 365
  entry_content: |
    -- ''insan'' olması, <br/><br/>-- gerçek bir atatürkçü olması, <br/><br/>-- tam anlamı ile demokrasiyi benimsemiş olması, <br/><br/>-- mütevazi olması, <br/><br/>-- devletin kaynaklarını israf etmemesi, <br/><br/>-- koltuk hastası olmaması,<br/><br/>-- kültürlü ve eğitimli biri olması,<br/><br/>-- din istismarcısı veya cemaatçi olmaması,<br/><br/>-- herkese eşit şekilde yaklaşması,<br/><br/>-- kanunların çizdiği çerçevede kalması,<br/><br/>-- megaloman bir medya maymunu olmaması,<br/><br/>-- kadın haklarına müthiş derecede önem vermesi,<br/><br/>-- geçmişinin de tertemiz olması,<br/><br/>-- gerçek manada ''ahlaklı'' olması,<br/><br/>-- eğitime ve bilime çok önem vermesi,<br/><br/>gibi say say bitirelemeyecek hünerlerdir.
- entry_name: |
...
- entry_name: |
    11 nisan 2017 diyarbakır patlaması
  entry_id:  67396470
  entry_writer: opak
  entry_fav_count: 70
  entry_content: |
    daha bu sabah çevremde hayırın önde olup olmadığını bu haftayı sakin geçirip geçirmememizle anlayacağız demiştim. zira propogandaların etki edeceği süreci geçtik.<br/><br/>bu işin arkasında hangi orospu çocukları var bilemem ama 11 nisan 10:00 gibi hayır'ın önde olduğuna emin gibiyim artık.<br/><br/>edit: bu yorumu yapmamla ölen veya yaralanan olmamasını ummadığımı düşünmek nasıl bir kafanın ürünüdür? siz nasıl bir kara propaganda aracısınız?<br/><br/>patlama ardından olayı siyasete bağlamamıza kızanlar, pardon da neye yoracaktık bunu? patlamalarla geçen seçim süreçlerini, miting meydanlarında ağızlara sakız edilen katliamları görünce bunun arkasında siyasi bir çıkar aramak mı abes? geçiniz lütfen.<br/><br/>pkk'nın neden öyle bir şey yapacağını soranlara da buradan topluca cevap vereyim,<br/><br/>(bkz: <a class="b" href="/?q=paul+henze%27in+2006+t%c3%bcrkiye+raporu">paul henze'in 2006 türkiye raporu</a>)<br/>(bkz: <a class="b" href="/?q=7+haziran%27dan+sonra+pkk%27n%c4%b1n+silaha+sar%c4%b1lmas%c4%b1">7 haziran'dan sonra pkk'nın silaha sarılması</a>)<br/><br/>hoş, kaza olduğuna dair haberler geliyor şu an.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    (bkz: <a class="b" href="/?q=bir+se%c3%a7im+vaadi+olarak+idam">bir seçim vaadi olarak idam</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    2000 lerin başında ve 2000 ler öncesi üniversiteye girenler arasında fazlaca rastlanabilecek bir durum. <br/>tıpların puanı mühendisliklerden çok yüksek değildi önceden, bilmeyenler olabilir . 99 da yıldıza girdiğim puanla 9 eylül tıp kazanabiliyordum,şimdi arada uçurum var.
- entry_name: |
    paulo dybala
  entry_id:  67408124
  entry_writer: xii
