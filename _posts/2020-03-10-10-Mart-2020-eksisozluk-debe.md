...
- entry_name: |
  ...
  entry_fav_count: 60
  entry_content: |
    8 mart'ta yürüyüş yapmak isteyen kadınlardan gözaltına alınan birinin, onlarca polis tarafından dövülmesi <a rel="nofollow noopener" class="url" target="_blank" href="https://mobile.twitter.com/BirGun_Gazetesi/status/1236914462944354304" title="https://mobile.twitter.com/BirGun_Gazetesi/status/1236914462944354304">olayıdır.</a> helal olsun size be. vatanı kurtardınız(!)<br/><br/>edit: "shetasla" isimli yazar bu kadın neden gözaltına alındı onu da yaz demiş. neden? gözaltı sebebine göre dayağı mı meşrulaştıracaksın çakal? siz adam olmazsınız.<br/><br/>edit 2: "nopain34" isinli yazar demiş ki "provokatörlügü bırak. böyle bir muamele yapıldıysa allah bilir ne yapmıştır". benim bildiğim biz hukuk devleti (!)nde yaşıyoruz. ortada bir suçlu varsa ve yakalandıysa çok değerli hakimlerinize savcılarınıza teslim edersiniz gerekeni yaparlar. kadın olsun erkek olsun farketmez, araya alıp tekme tokat dayak atmak yasalarda suçtur. ha yasayı sallayan kim biz cezamızı kendimiz keseriz diyorsanız o sizin bileceğiniz iş.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 54
  entry_content: |
    gs kaç isabetli şut atarsa ondan 1 2 eksik gol atar.<br/><br/>(bkz: <a class="b" href="/?q=loris+karius">loris karius</a>)
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    sözlükçülerin yaptıkları en büyük hatalar
  entry_id:  103267965
  entry_writer: larker
  entry_fav_count: 49
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 32
  entry_content: |
    konu savaş ve strateji olunca, diğer 11 burcun hepsini bir araya getirin akrebin kesip attığı tırnak etmez. akrep hepsinin içinden geçer.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 31
  entry_content: |
    bir erkek size bir sıcak bir soğuk davranıyor, bir aşka meşke boğup bir acıdan öldürüyorsa ya ruh hastasıdır yahut bu istatistikteki kişi.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    otuz milyon turk yasayan iran hastaliktan kiriliyor. simdi orada hic bir turke bulasmamis mi?
  entry_channels: sağlık
- entry_name: |
    zeynep bastık'ın türk müziğinin yeni divası olması
  entry_id:  103270700
  entry_writer: guyiks
  entry_fav_count: 5
  entry_content: |
    dedi zeynep bastık'ın manaajeri.<br/><br/>hadi anam troll yapma dükkanın önünü açın.
  entry_channels: 
- entry_name: |
