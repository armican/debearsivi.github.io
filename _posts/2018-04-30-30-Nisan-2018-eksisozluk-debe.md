...
- entry_name: |
    29 nisan 2018 seda sayan'ın hastaneye kaldırılması
  entry_id:  76461214
  entry_writer: lahmacunmania
  entry_fav_count: 444
  entry_content: |
    bunlara bir bok olmuyor. ibrahim tatlıses'i kafasından keleşle vurdular herif yamuldu ama ölmedi. gidenler hep bizden.
...
- entry_name: |
  ...
  entry_channels: moda
- entry_name: |
    çıkar sevişmelerinde hiç orgazm olmadım
  entry_id:  76463518
  entry_writer: 0game
  entry_fav_count: 195
  entry_content: |
    (bkz: <a class="b" href="/?q=%c3%a7%c4%b1kar+sevi%c5%9fmelerini+ne+dedi%c4%9fin+anla%c5%9f%c4%b1lm%c4%b1yor">çıkar sevişmelerini ne dediğin anlaşılmıyor</a>)<br/><br/>ama inşaat işçisi öyle mi ya? galp galp
  entry_channels: magazin
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  76452885
  entry_writer: naytmeyi
  entry_fav_count: 83
  entry_content: |
    birazcik kafasi calisan sorgulama ,analiz etme yetenegi olan biri zaten tum kutsal kitaplari okuduğunda bir insan tarafindan yazildigini anlayacaktır. dinler insanlari yola sokmak icin zamaninin anayasasisidir iste ,nasil bu kadar kisiyi hala hipnotize olmus gibi pesinden koşturuyor; asil soru budur. aslinda cevabi da cok basittir :ölüm korkusu ve bilinmezlik.
  entry_channels: 
- entry_name: |
    tkp'yi iki kelimeyle anlat
  entry_id:  76455661
  entry_writer: extagon
  entry_fav_count: 80
  entry_content: |
    iki kelimemiz var ise birini devlete vereceğimiz için tek kelime ile anlatmamız gereken durum.
...
- entry_name: |
    bedelli askerlik
  entry_id:  76452535
  entry_writer: andywarhols
  entry_fav_count: 65
  entry_content: |
    ulan gbt'den çevirmelerden kaça kaça pablo escobar gibi oldum be.
...
- entry_name: |
  ...
  entry_fav_count: 52
  entry_content: |
    golfün orada ne işi var dedirten versus. ek olarak her seyi anlarim ama a serisi( fwd), 1 serisini(rwd) yol tutus konusunda nasil geciyormus anlamadim.
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    fatih sultan mehet yaşasa üye olucağı parti
  entry_id:  76475071
  entry_writer: bi gitme be
  entry_fav_count: 11
  entry_content: |
    fatih sultan mehet diye bir insan yaşasa nüfusa yanlış yazdırmışlar geyiğinden özgüveni eksik olur siyasete girmezdi.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    (bkz: <a class="b" href="/?q=ciasal+i%24lam">ciasal i$lam</a>)
  entry_channels: siyaset,anket
- entry_name: |
