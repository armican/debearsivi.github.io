...
- entry_name: |
  ...
  entry_fav_count: 73
  entry_content: |
    (bkz: <a class="b" href="/?q=gelinlik">gelinlik</a>) <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
...
- entry_name: |
  ...
  entry_fav_count: 65
  entry_content: |
    <a class="b" href="/?q=ismet+%c3%b6zel">ismet özel</a> der ki "<a class="b" href="/?q=ikna+edilmi%c5%9flerle+yola+%c3%a7%c4%b1k%c4%b1lmaz">ikna edilmişlerle yola çıkılmaz</a>. <a class="b" href="/?q=yola%2c+inanm%c4%b1%c5%9flarla+%c3%a7%c4%b1k%c4%b1l%c4%b1r">yola, inanmışlarla çıkılır</a>."<br/><br/>elini bırakmak isteyenin, zorla elini tutup onunla bir yola çıkmaya çalışma sonra zararlı çıkarsın.
...
- entry_name: |
  ...
  entry_fav_count: 50
  entry_content: |
    hayatımda hiç akp'ye oy vermemiş biri olarak...<br/><br/>bunu mutlaka bir yere iliştirin ki aktroll olduğunuz anlaşılmasın. hepsinde aynı taktik. biraz kendinizi geliştirin be.
...
- entry_name: |
  ...
  entry_fav_count: 41
  entry_content: |
    bu ekonomik ortam, yaşama stresi içinde azıcık kafa dağıtmak çomarların da hakkı.<br/>+1 benden dediğim olay.
...
- entry_name: |
  ...
  entry_fav_count: 35
  entry_content: |
    "tutunacak baska dalin yoksa, hazir ol son sokusu ben yapiyorum kardesim" dir.
...
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    depresyon kaynaklıdır. 30-35 bu işin zirvesidir. öncesi çocuksu maceralardan ibarettir.
  entry_channels: ilişkiler
- entry_name: |
    fb+tff+akp+bjk+mb ittifakı günlüğü
  entry_id:  95307080
  entry_writer: orlando balon
  entry_fav_count: 19
  entry_content: |
    ingiltere krali, rahmetli başkan kennedy, taçsız kral pele, backenbauer, kaleci mayer, nadia komanaçi, brigitte bardot ve fenerbahçeli cemil’in eksikliğinin hissedildiği ittifaktır.
  entry_channels: 
- entry_name: |
    okan bayülgen
  entry_id:  95276160
...
- entry_name: |
    antep'teki restorasyon faciası heykel
  entry_id:  95304089
  entry_writer: angara beyefendisi
  entry_fav_count: 14
  entry_content: |
    roma dönemine ait bir büstün <a rel="nofollow noopener" class="url" target="_blank" href="https://pbs.twimg.com/media/EEOEZjhX4AAaMq8.jpg" title="https://pbs.twimg.com/media/EEOEZjhX4AAaMq8.jpg">gözüne yapılan restorasyon</a> bakan gözleri kanatıyor.<br/><br/>müzeden ise "biz yapmadık, kaçakçılar yapmış, biz bozulur diye ellemedik ve böyle sergiledik" minvalli bir açıklama var. <br/><br/>bak bunu kim yaptıysa çiğköfte gibi oraya fırlattığına eminim. eğlenmesini bilen birisi yapmış bunu.<br/><br/>şimdi diğer faciaları hatırlayalım:<br/>(bkz: <a class="b" href="/?q=tuvalette+ekmek+yemi%c5%9f+%c3%a7izgi+karakterli+dondurma">tuvalette ekmek yemiş çizgi karakterli dondurma</a>)<br/>(bkz: <a class="b" href="/?q=madeira+havaliman%c4%b1ndaki+cristiano+ronaldo+heykeli">madeira havalimanındaki cristiano ronaldo heykeli</a>)<br/>(bkz: <a class="b" href="/?q=ispanya%27da+restore+edilen+hz.+isa+portresi">ispanya'da restore edilen hz. isa portresi</a>)<br/><br/>ekleme: <a rel="nofollow noopener" class="url" target="_blank" href="https://www.ntv.com.tr/sanat/roma-heykeli-kacakci-dolgusuyla-sergilenmeli-mi-alay-konusu-oldu,YJahNnAzPk-uz3ECK1tsrA" title="https://www.ntv.com.tr/sanat/roma-heykeli-kacakci-dolgusuyla-sergilenmeli-mi-alay-konusu-oldu,YJahNnAzPk-uz3ECK1tsrA">kaynak</a>
  entry_channels: 
- entry_name: |
...
- entry_name: |
    türkçenin bir come on'u bir vamos'u olmaması
  entry_id:  95306529
  entry_writer: yarasa talag
  entry_fav_count: 8
  entry_content: |
    (bkz: <a class="b" href="/?q=hadi+len">hadi len</a>)
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    bir mekan çıkışında muhabir darp eden, sonra da utanmadan sırıtan karaktersiz herifin teki.
  entry_channels: müzik,magazin
- entry_name: |
    13 eylül 2019 evanescence istanbul konseri
  entry_id:  95293089
  entry_writer: monte kristo contu
  entry_fav_count: 7
  entry_content: |
    haykonun lafi koydugu (bkz: <a class="b" href="/?q=kisi">kisi</a>) imis. comara bak ya. kac yasinizdasiniz olum siz.
...
- entry_name: |
    eğitim bakanı olunsa değiştirilecek ilk şey
  entry_id:  95278548
  entry_writer: rengimelek
  entry_fav_count: 6
  entry_content: |
    çok idealist olup görevden alınmaya niyetim yok. makam aracımı değiştirirdim. bugün <a class="b" href="/?q=yenik%c3%b6y">yeniköy</a>de gördüm beğenmedim.<br/>sonra bir sürü manzara resmi çeker, şiirler eşliğinde <a class="b" href="/?q=instagram">instagram</a>da paylaşır, öğretmenlerin beni like'lamasını seyrederdim. pardon ama bu yapılıyor galiba. neyse aklıma yenilikler geldikçe yazarım.
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    kayınbabasının dudağını ısıran damat
  entry_id:  95305706
  entry_writer: usengecotu
  entry_fav_count: 4
  entry_content: |
    ya ulan. gözümde canlandırmaya çalışıyorum ama cıksssss, olmuyor. imkanı yok yani. şimdi sen bir insana sinirlisin, öyle bir sinirlisin ki öldürmek için üstüne saldırıyorsun. ama sonra ne yapıyorsun? gidip adamın dudağına yapışıyorsun... ulan! türk milleti siz bana kafayı mı yedirtmek istiyorsunuz? yani tamam git kolunu ısır, kafasını ısır, ne bileyim en kötü kulağını falan ısır da; dudakların dudaklarına değdiğinde bile hiç "laaaaan, noluyo?!" demedin mi be adam? sljkhkldhlskh sinirlerim bozuldu.
  entry_channels: 
- entry_name: |
...
- entry_name: |
    giden yaz mevsimine bir mesaj bırak
  entry_id:  95286811
  entry_writer: sinayderin sag ayagi
  entry_fav_count: 1
  entry_content: |
    hiç gelmesin neden gelmiyosun demem
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    insanoğlu haddin bilir kem söz söylemez iken<br/>elalemin namusuna yan gözle bakmaz iken<br/>bir sofra kurulmuş ki halil ibrahim adına.
  entry_channels: anket,müzik,edebiyat,teknoloji
- entry_name: |
    kadıköy kızı
  entry_id:  95284043
  entry_writer: suursuz kabalak
  entry_fav_count: 0
  entry_content: |
    özellikle kadınlar çocuklar hakkında yapılan genellemelerin stereotip olduğunu düşünsem de burada bir eleştiri getirmem gerekiyor.<br/>bahsedilen kişiler olagelmiş kadıköy kültürüne sonradan eklenmiş kişilerdir ve bir çoğu ne yazık ki imitasyon olmaktan öteye geçememişlerdir. <br/>bu sonradan eklenenlerin bir çoğu taksim cihangir tayfası iken şimdi kadıköylüyüz biz ya dese de işim aslı öyle değil.<br/>kadıköy insanının zihin aritmetiğini caz a benzetiyorum bir hayli. şu dönemde caz dinlemeye başlayan kuvvetle muhtemel özenerek başlar ve felsefesini anlayıp idrak ederek dinlemeye başlayana kadar bir çoğu çok sıkıcı bulmaya devam ettiği için bu müzikten kopar gider.<br/>yani sizin kadıköy kızı dedikleriniz yarın karaköy daha “trend” olduğunda uçup gidecekler oraya.<br/>kadıköy insanı candır, kendimi diğer herşey gibi çok ait hissetmesem de candır, akıllıdır. <br/>sizin her türlü çılgınlığı yapmakta beis görmediğini iddia ettikleriniz konar göçer tayfa, gerçek kadıköy kızları ile ancak felsefe sosyoloji filan tartışabilirsiniz aç köpekler
  entry_channels: ilişkiler,müzik,moda
- entry_name: |
    bira içmelik arkadaş veritabanı
  entry_id:  95307205
  entry_writer: spanoullis
  entry_fav_count: 0
  entry_content: |
    kuşadası veya izmir'in yakın ilçeleri için katılabileceğim veritabanı.
