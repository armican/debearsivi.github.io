...
- entry_name: |
    13 eylül 2019 galatasaray'a verilen penaltı
  entry_id:  95284744
  entry_writer: a place for my head
  entry_fav_count: 260
  entry_content: |
    henüz olmamasına rağmen bazı şey evlatlarına öyle dert olmuştur ki rüyasına girip kabusu olup sabah daha ağzı kokarken entry girdirmiştir. bunu söyleyen ya ezik siklenmeyen bir beşiktaş taraftarıdır, ya da 25 dakkada üç penaltı kullanan yüzsüzlerdendir.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    #devleti tehdit etme galatasaray
  entry_id:  95303542
  entry_writer: rasrasras
  entry_fav_count: 101
  entry_content: |
    polis arabalarını yakan taraftarlar tarafından açılan hashtag.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 26
  entry_content: |
    1.) siyasal islam şebekelerine demokrasi, milli irade, oy hakkı gibi bahanelerle müsamaha göstermek.<br/><br/>2.) daha en temel demokratik kaidelerden habersiz yığınların, kaderlerini tayin edecek anayasal değişiklikleri ‘torba’ referandumlarla oylamasını kabullenmek.<br/><br/>3.) kamu ihale kanunu gibi istikrarla korunması gereken mevzuatı yüzlerce kez değiştirmek.<br/><br/>bu üç durum, akp örgütünün çökmesiyle geride kalacak ve türkiye’nin önü açılacaktır.
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    kayınpederine beyzbol sopasıyla saldıran damat
  entry_id:  95304609
  entry_writer: sylviaplath21
  entry_fav_count: 19
  entry_content: |
    kayınpedere bunu yapan karısını illaki öldürür.<br/>hala damadı dinlemeyen var diyor birileri nesin dinleyeceksin? böyle şiddetin ne tarafı savunulabilir şehir magandaları
  entry_channels: 
- entry_name: |
    real madrid ve fenerbahçe beko'nun nba'e katılması
  entry_id:  95298443
  entry_writer: frtslck
  entry_fav_count: 17
  entry_content: |
    imkansız olmasa da mantıksız bir olaydır.<br/><br/>nba yönetimi "biz abd ve kanada takımlarına özel bir ligiz" demiyor, bu bütçeyi kaldırabilecek her takıma açık olduklarını söylüyorlar hep ancak bir avrupa takımının oraya katılması demek uzun deplasman serileri anlamına geliyor. <br/><br/>zaten epeydir nba şampiyonuna "dünya şampiyonu" da diyorlar. <br/><br/>ekonomik açıdan hiçbir problem olmasa bile avrupa'da kalıp taraftar desteğinden yararlanmayı istemek lojistik açıdan büyük problem yaratır. ben abd'ye giderim, orada bir salon yaparım ya da franchise'ımı nba geçmişi olan bir şehre taşırım diyen çıkabilir, yeter ki ekonomik güç olsun elde. yalnız öyle fenerbahçe-real madrid-cska gibi 30-40 milyon euro ile o iş dönmez. en az 100-120 milyon euro bütçe koyman lazım ki onunla da playoff iddialısı bile olamazsın.
  entry_channels: spor
- entry_name: |
    okan bayülgen
  entry_id:  95276160
...
- entry_name: |
  ...
  entry_id:  95304729
  entry_writer: kaisareis
  entry_fav_count: 8
  entry_content: |
    yalniz ölmek elaleme muhtaç yaşamaktan daha iyidir
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    canını kaburgandan alırım, apoletime kanını bulaştırma.<br/>ıste dakika sürmez, ruhunu cehennemine ulaştırmam.<br/>öl bu sırla, ben rhyme yüklü tırla gelirim hızla.<br/>tanımam gariban emmi ıpnelikle dolu, sizde. gırlaa...
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bu akşam bursa.<br/><br/>suriyeli berberim abi beyazları boyayalım dedi kendi dilinde anlamadan tamam dedim,beyazlar oldu yeşil.<br/><br/>yeşil yeşil geziyorum hippi sevenler tam size göreyim...
