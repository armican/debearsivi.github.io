...
- entry_name: |
  ...
  entry_fav_count: 57
  entry_content: |
    ya ben anlamıyorum arkadaş bu orospu evlatları bayrama seyrana ülkesine gidiyor mu abi? gidiyor. bayramda resmi tati mi amına kodumunun savaşı ya da ne sikimse? bu adamlar bayramda memleketne gidebiliyorsa ne diye gittikten sonra kapıyı çekmiyorsun? oraya gidebiliyorsan orada da kalabilirsin babacım yani keriz mi sikiyorsunuz? <br/><br/>geçen foça'da 2 tane kadın tam sahilde yürüyoruz, geldi yanıma para mı ne istiyor. ''tayyip'ten iste dedim tayyip'den. kim getirdiyse sizi ondan iste'' diye uzaklaştırdım ama tayyip kelimesini anlıyorlar 7 düvelini ırkını evveliyatını siktiklerim! zaten ben tayyip'ten iste deyince hemen döndü götünü gitti. anlıyor abi demek ki yani .<br/><br/>artık zerre acımıyorum, hiç de acımadım kusura bakmasın kimse. ulan suudi arabistan dediğiniz ülke islam'ın merkezi değil mi? kaç suriyeli almış allah aşkına bi bakın? biz kayıtlı kayıtsız toplamda 7-8 milyon adam aldım amına koyim ya! nüfusun %10'u yapar lan! <br/><br/>herifler alaçatı'da bilgisayar çıktısı almışlar lan öyle dileniyorlar. alaçatı'ya kadar gelmişler yani nasıl geldilerse siktiğimin suri surileri! <br/><br/>bayramda gidebiliyorsan abi memleketine gidebiliyorsundur. humanizminizi siktirin gidin başka yerde kusun. gördüğüm yerde böyle bacağıma falan yapışan veletleri gelişine zbam! diye savuruyorum. herifler 5 sene olacak 5 senede kaç kere sikişip çocuk yaptı senin haberin var mı? sonra neymiş savaş mağduru bilmem ne. savaş mı kaldı amına kodumunun yerinde? bayrama giden adama mermi işlemiyor mu? nedir yani?<br/><br/>bi gun o kul köpek olduğunuz uzun öldüğünde arkasından en çok da bu piçleri başımıza sardığı için küfür yiyecek biliyorsunuz değil mi? hem de öyle böyle değil.
- entry_name: |
    paris saint-germain
  entry_id:  70543966
  entry_writer: tucek
...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    başlığı altında kadrosunun beşiktaş ile aynı seviyede olmadığı söylenen takım. uzun süredir ilk kez bir beşiktaşlıyla aynı fikirdeyim. kadromuz aynı seviyede değil. boy verin de görelim!
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  70552178
  entry_writer: savklis
  entry_fav_count: 5
  entry_content: |
    pkk yandaşlarının zoruna gider.
- entry_name: |
...
- entry_name: |
    us open 2017
  entry_id:  70544887
  entry_writer: sheva37
  entry_fav_count: 1
  entry_content: |
    federer'in çok küçümsendiği turnuva. avustralya açık'ta melzer karşısında bok gibi bi tenis oynuyodu bu adam ve o kupayı nishikori,berdych,wawrinka,nadal'ı yenerek aldı. dünde kendisi söyledi zaten sırtımda bi problem yok diye. ki bence de sırttan ziyade daha çok gerginlik var üzerinde,oynadıkça açılacaktır. yarı finale kadar gelirse de bu kadar hızlı kortlarda nadal'ın federer karşısında pek şansı yok bence.
- entry_name: |
...
- entry_name: |
    isbanki.com
  entry_id:  70550486
  entry_writer: ssgnin kankasi
  entry_fav_count: 1
  entry_content: |
    iş bankasının çakması, şifrenizi ele geçirmeye çalışan <a class="b" href="/?q=doland%c4%b1r%c4%b1c%c4%b1">dolandırıcı</a> site
- entry_name: |
    feminizm
  entry_id:  70539494
  ...
  entry_fav_count: 1
  entry_content: |
    aptallığın bir sınırının olmadığını gösterir bazen.<br/><br/>askerlerin yaptığı rezilliği savunabilecek denli düşer kendisiyle sorunu olan kimileri.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bi boka benzemeyen 3-4 şarkıyı albüm diye çıkarmış olan rapçidir.<br/><br/>hala umudum vardı ama, artık yeni şarkısını beklemem. görünce dinlemem.<br/><br/>büdüt: eleştirdim diye twitter'den ekleyen sago, burdan eleştirimi görünce çıldırıyodur herhalde. bu büdütü görünce de ukalalık yapıp "hah çokta tın" deyip kendini kandırıyodur.
- entry_name: |
    cedi osman
  entry_id:  70551951
