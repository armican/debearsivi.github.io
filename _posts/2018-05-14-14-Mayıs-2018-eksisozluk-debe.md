...
- entry_name: |
  ...
  entry_id:  76921109
  entry_writer: darknesss
  entry_fav_count: 35
  entry_content: |
    aptallıkla eş değer oluyor bir süre sonra. malum insan kalmadı bu devirde.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  76943710
  entry_writer: ismail hakki
  entry_fav_count: 17
  entry_content: |
    hayvanlar alemininde çivisinin çıktığının kanıtıdır. <br/>karacanın bacakları ayırıp canlı canlı yiyen bir babun videosu vardı (link gelirse editlerim) işte o video sonrası ciddi şüphelerim vardi çivi hususunda. bu video ile emin oldum. kıyamet yakındır arkadaşlar kendinizi ayarlayın.<br/><br/>aslana not: senin ben vicdanına tüküreyim. içimi cızlattın içimi. yeme demiyorum ye ama öldür de ye arkadas.<br/>böyle hayvanlık mı olur!<br/>babun sen tam bir ocsun!
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    klasik ingiliz çomarıdır. ben hayatımda bu herifler kadar götüyle içip, sapıtan başka bir millet görmedim. ruslar falan bunların yanında beyefendi kalır.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    keşke tüm cumhurbaşkanı adaylarının olduğu bir canlı yayın yapılsa. ama işte dünya liderimiz 'gariban' <a class="b" href="/?q=muharrem+ince">muharrem ince</a>'den, 'hain' <a class="b" href="/?q=meral+ak%c5%9fener">meral akşener</a>'den, hala eski 'gömleği' giyen <a class="b" href="/?q=temel+karamollao%c4%9flu">temel karamollaoğlu</a>'ndan, hatta hapiste yatan <a class="b" href="/?q=selahattin+demirta%c5%9f">selahattin demirtaş</a>'tan korkuyor.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    -aaa gamzen mi var? <br/>-evet <br/>-gülsene bi daha...<br/>-:)<br/>-aaa diğer tarafta da varmış<br/>-evet <br/>-çok şirin <br/>-şirin ne orospu çocuğu çocuk mu seviyon<br/>-?!?!?!!
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    özel okulda altta ders kalıyor mu ki? ben daha duymadım özelde okuyup da alta ders bırakacak kadar bir geri zekalıyı...
  entry_channels: 
- entry_name: |
    oğuzhan özyakup
  entry_id:  76944795
  ...
  entry_fav_count: 1
  entry_content: |
    kendisine artik kizmiyorum.<br/><br/>besiktas'in 10 numarali formasi bu kadar ayaga düsmemeliydi.
  entry_channels: spor
- entry_name: |
