...
- entry_name: |
    vincent aboubakar vs bafetimbi gomis
  entry_id:  74954181
  entry_writer: aikanavo
  entry_fav_count: 195
  entry_content: |
    hayır neden türkiye'de oynayan bir futbolcuyla portekiz'de oynayan birini karşılaştırıyoruz. ha illa yapacam diyorsanız şöyle ki abubakar beşiktaşın en ihtiyacı olan anda oyundan atılacağını bile bile cirkeflik edebilecek bir oyuncuyken, gomis hastalığı nedeniyle bayılsa bile oyundan çıkmak istemeyecek kadar karakterli bir oyuncudur ve bence bir futbolcunun yeteneği ne kadar yüksek olursa olsun karakteri olmadan anca küfür yer. ayrıca ben gomis'in başka bir oyuncuyla itişip kakışacak kadar tartıştığı bir an aklıma gelmiyor. bir de artık başka takımın oyuncularına hallenmeyi bırakın, giden gitti.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 64
  entry_content: |
    <a class="b" href="/?q=11+mart+2018+t%c3%bcrk+u%c3%a7a%c4%9f%c4%b1n%c4%b1n+iran%27da+d%c3%bc%c5%9fmesi">11 mart 2018 türk uçağının iran'da düşmesi</a> sonucu hayatını kaybetmiş pilot. <br/><br/>hayatı fetullahçılar tarafından karartılmış, o yılmamış mücadele etmiştir. ancak ne yazık ki çok sevdiği üniformasına yeniden kavuşamadı. ruhu şad olsun.<br/><br/>(bkz: <a rel="nofollow noopener" class="url" target="_blank" href="http://www.kokpit.aero/melike-kuvvet-iran-kaza-feto" title="http://www.kokpit.aero/melike-kuvvet-iran-kaza-feto">http://www.kokpit.aero/…elike-kuvvet-iran-kaza-feto</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 38
  entry_content: |
    geceleyin alkol alip, eglenmememiz adina alinmis son derece orospu cocugu bir uygulama.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    aceleyle evlenmis eski futbolcu. 7 ay sonra <a class="b" href="/?q=arda+turan+jr">arda turan jr</a> piyasaya cikar diyorum.
- entry_name: |
...
- entry_name: |
    12 mart 2018 dolar kuru
  entry_id:  74960291
  entry_writer: kumulatifvergimatrahi
  entry_fav_count: 12
  entry_content: |
    1,1 kuruştur o, 110 kuruş olsa duramazsın.
- entry_name: |
    uber
  entry_id:  74959828
...
- entry_name: |
    mont giysem mi giymesem mi havası
  entry_id:  74942313
  entry_writer: freshmeatt
  entry_fav_count: 2
  entry_content: |
    akıllara umut sarıkaya'nın unutulmaz şiirini getirir.<br/><br/>mont beni<br/><br/>tedarikliyim diye sevindim durdum<br/>sıcağı görünce yandım kavruldum<br/>mecnun oldum çöllere savruldum<br/>kırk kapıya muhtaç eyledi mont beni...<br/><br/>bir garip ercanım bu dünyada konar göçerim<br/>gâhi ağlar, gâhi gülerim<br/>mont elde diyar diyar gezerim<br/>onulmaz dertlere saldı mont beni...
- entry_name: |
    97 aldığı için ağlayan öğrencinin şimdiki hali
  entry_id:  74943664
  entry_writer: whereismykidney
  entry_fav_count: 1
  entry_content: |
    9'da iş başı yapılan iş yerine 1 saat erken gidip 10'da gelenleri görüp ağlamaya devam etmektedir.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=ain%27t+nobody+got+time+for+that">ain't nobody got time for that</a>)
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    sana verdiğim değeri, sevgiyi hiç haketmemişsin şimdi anlıyorum. bana döndüğün o nisan ayında seni kabul etmekle çok büyük bir hata etmişim. biliyorum beni özlediğini ama bencilliğin ve korkaklığın yüzünden zoru görünce kaçtığını.
- entry_name: |
