...
- entry_name: |
    gyro drop ismi verilen eğlence aleti
  entry_id:  91270979
  entry_writer: swollenmember
  entry_fav_count: 45
  entry_content: |
    bayilmayanlari nasa g-force egitimine aliyormus.
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    be the first..<br/>or be the best.<br/>or be different....
...
- entry_name: |
  ...
  entry_id:  91258256
  entry_writer: yeminini bozan papa
  entry_fav_count: 2
  entry_content: |
    fanboylarının "her zaman söylerim zaten warriors nba takımlarında en kötü yedeklere sahip takımlardan biri" şeklinde yorumladığı nba takımı. neden acaba sayın suser, neden? <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
  entry_channels: spor
- entry_name: |
