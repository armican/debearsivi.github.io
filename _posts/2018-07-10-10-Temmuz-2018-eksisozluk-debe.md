...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    odtü'yü kapatalım hayvanat bahçesi yapalım
  entry_id:  78991296
  entry_writer: moffle
  entry_fav_count: 303
  entry_content: |
    anca o şekilde girebilirsiniz zaten.
  entry_channels: haber
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    nicolas maduro'nun türkiye'ye gidiyorum videosu
  entry_id:  78973119
  entry_writer: dickhead duru
  entry_fav_count: 75
  entry_content: |
    beginner ispanyolca'm ile anladığım kadarıyla "<a class="b" href="/?q=haydi+bir+kaset+koy+da+%c5%9f%c3%b6yle+bir+ne%c5%9felenelim+semra">haydi bir kaset koy da şöyle bir neşelenelim semra</a>" diyor.
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    paralel evrende çoktan ölmüş olmak
  entry_id:  78979204
  entry_writer: ozicoke
  entry_fav_count: 31
  entry_content: |
    (bkz: <a class="b" href="/?q=rick+and+morty">rick and morty</a>)
...
- entry_name: |
  ...
  entry_fav_count: 23
  entry_content: |
    (bkz: <a class="b" href="/?q=mart%c4%b1+ba%c4%9f%c4%b1rmas%c4%b1">martı bağırması</a>)
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    fakirlik bünyem f-16 uçak yerine "klavye üzerinde f16 mı vardı lan?" diye düşündürttü. uçak olduğunu çok geç anladım. bu da böyle fakir bir anım oldu.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    son senem talihsiz şekilde yaz okuluna kaldım çok para değil 600 700 lira gibi para bulsam karşılarım gerisini ancak günler kaldığı için bulamıyorum. <br/>1-2 gün kaldı borç veya burs verecek yazar varsa yeşillendirsin lütfen.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    cüneyt çakır
  entry_id:  78998847
  ...
  entry_fav_count: 0
  entry_content: |
    2018 dünya kupası yarı finalindeki ingiltere- hırvatistan maçını yöneteceği açıklanan fifa kokartlı hakemimiz.
  entry_channels: spor
- entry_name: |
