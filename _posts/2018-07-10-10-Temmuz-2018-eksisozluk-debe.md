...
- entry_name: |
    ruhsar pekcan
  entry_id:  79002687
  entry_writer: mutlu yillar sana
  entry_fav_count: 1
  entry_content: |
    habertürk tv'de, söylenene göre bakan olduğunu (kesin olmamakla birlikte) havaalanında öğrenmiş, şu anda meclise doğru geçmekte olan ticaret bakanı.<br/><br/>tobb kadın girişimciler başkanı, an itibariyle instagram'da 624 gönderi-<br/>59 takipçi - 65 takip istatistiklerine sahip, itü 'den mezun, orta doğu'da boru sektöründe çok aktif olan karon mühendislik'in ceo'su.
  entry_channels: siyaset,ekonomi
- entry_name: |
    ziya selçuk
  entry_id:  79001371
...
- entry_name: |
    hulusi akar'ın milli savunma bakanı olması
  entry_id:  79002117
  entry_writer: a rainy day in falkreath
  entry_fav_count: 0
  entry_content: |
    asker devlet bekasını düşününce; askeri vesayet.<br/>asker yıkama yağlama yapınca; bakanlık.<br/><br/>(bkz: <a class="b" href="/?q=yeni+t%c3%bcrkiye">yeni türkiye</a>)
  entry_channels: siyaset
- entry_name: |
