...
- entry_name: |
  ...
  entry_fav_count: 155
  entry_content: |
    öncelikle çok samimi buldum, inanın günlerce yoğun bakımdasın bir uyanıyorsun kafan taşşak gibi, kaç saattir sigara içmemişsin. o ne güzel hemşiredir gelip bir kısa parlement versin zipposuyla yaksın sonra kulağıma fısıldasın "benden almadın tamam mı?" desin de cennetler olsun onca günden sonra...<br/><br/>haberi okudum videoya baktım, ama iş burada farklı, düşündüğümden başka imiş. adamla dalga geçmek, eline verip kamerayla çekmek elinden geri almak kahkahalar falan. <br/><br/>işte bu tam bir şerefsizlik dostum.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    piyasanın mal insan dolu olduğunu gösteren erkektir.<br/><br/>neymiş?<br/><br/>sütü gibi kendisi de ılıkmış!<br/><br/>ama süt ılıkken yapıldığını biliyo bak.<br/><br/>aferin. <br/><br/>aynen devam
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    ilgisiz ve ne yapması gerektiğini bilmeyen velilerdir. <br/>velilere hep şunu söylüyorum. insana yatırım yapmak çok uzun vaadeli bir yatırımdır. etkisini belki hemen yarın göremezsiniz ama siz şimdi doğru davrandıkça ileride 'keşke şöyle yapsaydık' yerine 'iyi ki o zaman şöyle yapmışız' diyeceksiniz. lütfen kendinizi bu şekilde motive edin ve bu çocukları görün. bir çocuğa 'biz televizyon izliyoruz sen de hadi git odana ders çalış' demekten daha saçma bir şey yoktur herhalde. hele başarısı düşük bir çocuğun bunu kendi kendine yapması neredeyse imkansız. hepsi bir ekip işi. çocuk başarı gösteremiyorsa o ailedeki herkesin burda payı var demektir. veli oturup çocukla birebir ilgilenmeli. hatta okuluna gidip derslerde ne yapıyor uzaktan izlemeli. çocuğunu tanımalı. küçük hedeflerle başarıyı tattırmalı. çocuğun durumuna göre adım adım ilerlemeli. bunlar bir çocuğun, bir öğretmenin veya bir velinin tek başına halledebileceği şeyler değil. ciddi bir emek ve zaman gerekiyor.<br/>bunlarla uğraşmak istemiyorum diyen veliler için de şunu söylemek istiyorum. bu öğrenciler bizim belki birkaç yıl öğrencimiz olur, sonra mezun ederiz gider ama sizin hayatınız boyunca çocuğunuz. lütfen bu gerçeği görün ve çocuklarınızla çocukken ilgilenin.
- entry_name: |
...
- entry_name: |
    okuduğu bilimsel makale sayısıyla övünen insan
  entry_id:  70929461
  entry_writer: ssg
  entry_fav_count: 3
  entry_content: |
    bu ilginç değil bence. ama okuduğu makale sayısını bilen insan ilginç.
- entry_name: |
    ios 11
  entry_id:  70917364
  entry_writer: maykil
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    pinokyo <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=RM0SibtOTUA" title="https://www.youtube.com/watch?v=RM0SibtOTUA">intro</a>sudur.
- entry_name: |
    şu anda çalan şarkı
  entry_id:  70926746
...
- entry_name: |
    en büyük fiziksel acı
  entry_id:  70929162
  entry_writer: sireltoro
  entry_fav_count: 0
  entry_content: |
    diş ağrısı. <br/><br/>konuyla alakalı klasik bir rivayet de vardır. <br/>adamın biri fi tarihinde sokağın birinde dolaşırken çığlıkların geldiği eve doğru yönelmiş. evin önünde toplaşan insanlara içerde ne olduğunu sorduğunda bir kadının doğum yaptığını söylemişler. bunun üzerine adam da; ben de birisinin dişi ağrıyor sandım diyerek oradan uzaklaşmış. <br/><br/>bu nedir ya dediğinizi duyar gibiyim. bu da böyle bir hikaye işte.
- entry_name: |
    çekilişle bir şeyler kazanmış şanslı yazarlar
  entry_id:  70930245
  entry_writer: modocus
  entry_fav_count: 0
  entry_content: |
    kucukken aldigim cipsten taso bile cikmamasi sonucu, hicbir cekilise veya sans oyunu oynamayarak konu disinda kaldigim hadise.
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  70924052
  entry_writer: catinthebox
  entry_fav_count: 0
  entry_content: |
    sözlük olarak çoğumuzun maslak’ta köle olarak çalıştığımızı gösteren yağmur.
---
