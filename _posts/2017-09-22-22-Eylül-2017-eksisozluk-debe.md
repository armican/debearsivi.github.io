...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    adamdır. <br/>galatasaraylı olmama rağmen rakibimizin başına geçmesinin istedigim başkan adayıdır.<br/>vizyonu olan yaptığı işlerden dolayı futbol camiasında ufkumuzu genişletecek kişidir.
- entry_name: |
