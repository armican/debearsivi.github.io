...
- entry_name: |
  ...
  entry_fav_count: 28
  entry_content: |
    <a class="b" href="/?q=antakya">antakya</a> ve <a class="b" href="/?q=iskenderun">iskenderun</a>. bu iki ilçe de hatay'ı tanımaz. buralı olan kişilere nereli olduğu sorulduğu zaman direkt ilçenin adını söylerler ve buraların halkı anlam veremediğim şekilde sürekli rekebet halindedir.
  entry_channels: anket
- entry_name: |
    ekrem imamoğlu
  entry_id:  97129667
  ...
  entry_fav_count: 28
  entry_content: |
    cumhuriyet kutlamaları için sultanahmet ve uskudar meydanlarini sectigi icin tebrik ettigim baskan. <br/><br/>arapçıların kale dediği ilçelerin bile 4 ay once dinsiz dedikleri partinin rengine burunmesinden sora, 25 yilda kendince kutsal gordukleri her seyin tarihin coplugune donme zamani geliyor. <br/><br/>%25 gibi komik bir oyla kazandiklari donemde sehri mekke’ye cevirmeye kalkanlar bir zahmet %54 oy almis adamin sultanahmet meydani’nda cumhuriyet bayrami kutlamasina da karismayacak.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 23
  entry_content: |
    hiç got izlememiş biri got hakkında nasıl yorum yapabilir ki? pardon, burası ekşi sözlük burada herkes her şeye yorum yapar.
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    izlenmemesi gereken video. küfür az, ceza az bu yaratığa. almanyasının da amk.
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    bütün minyon kadınlar bu gruba girer
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
    fatih tezcan
  entry_id:  97128499
  entry_writer: romeikaay
  entry_fav_count: 6
  entry_content: |
    kendisiyle beraber türevlerinin sosyal medyadaki etkinliği daha da artması gereken kişi. ak partiye kaybettirdikleri oyun haddi hesabı yok. özellikle gençlerin çoğu bunun gibiler yüzünden anne babası ak partili olsa bile ak partiye oy vermiyor. bunun çevremde o kadar çok örneği var ki.
  entry_channels: haber
- entry_name: |
    cinayet süsü
  entry_id:  97123915
...
- entry_name: |
  ...
  entry_id:  97147518
  entry_writer: kraft71
  entry_fav_count: 4
  entry_content: |
    nefret ediyorum nefreeeeet böyle insanlardan!!!
...
- entry_name: |
    insanın uzaylılar tarafından yaratılmış olması
  entry_id:  97146758
  entry_writer: what is gravity
  entry_fav_count: 3
  entry_content: |
    uzaylıların nasıl yaratıldığı sorusunu akla getireceğinden, nihai sorunun peşinde koşmayan, onu öteleyen bir yaklaşımdır.<br/><br/>asıl sorulması gereken soru, nedensellik ilkesi gereği canlılığın hangi neden-sonuç ilişkisi sonucu doğmuş olduğudur? canlılığa neden gerek vardır? canlılık evrende hangi olmazsa olmaz sebepler sonucu varolmuştur? canlılık evrende hangi işlevleri yerine getirmektedir ve canlılık olmazsa evrende eksik kalacak özellikler nelerdir?<br/><br/>tüm bu soruların bir ulu yaratıcı vasıtasıyla açıklanması, ilkel insan toplulukları açısından bir dönem doyurucu bir cevap niteliği taşıyabilmiş olsa da, günümüzde kozmolojik bakış açısından bakıldığında insanın yada daha kapsayıcı olarak canlılığın evrende ne gibi bir işlevi yerine getirdiği, cevabı net şekilde verilebilmiş bir soru değildir.<br/><br/>bilim dünyasındaki son gelişmeler ışığında dünyaya suyun kuyruklu yıldızlar vasıtasıyla gelmiş olabileceği ihtimali üzerinde durulmaktadır. daha da ileri gidilerek dünyaya canlılığın da kuyruklu yıldızlar vasıtasıyla güneş sistemi dışından gelmiş olma ihtimali değerlendirilmektedir.<br/><br/>şüphesiz ki bilim her geçen gün önümüzdeki karanlığı biraz daha aydınlatarak, evreni daha iyi anlayabilmemizin önündeki engelleri sırayla kaldırmaktadır. evreni anlayabilmemiz için elimizdeki tek güvenilir araç bilimsel metodolojidir. bunun aksini düşünmek ahmaklıktır.
  entry_channels: 
- entry_name: |
    yeşil gözlü erkek
  entry_id:  97153598
...
- entry_name: |
  ...
  entry_id:  97141500
  entry_writer: bak postaci geliyor
  entry_fav_count: 0
  entry_content: |
    peynir
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bari sırtımı tıraş edeyim de bu tanımlama bana cuk oturmasın.. üzen kategoridir.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    kadikoy. evet an itibariyle kadikoydeyim 3-5 satir kod yazdim. bir sure daha calisacagim. buralarda olanlar yesillendirebilir. bira icip olaysiz evlerimize dagilabiliriz.
