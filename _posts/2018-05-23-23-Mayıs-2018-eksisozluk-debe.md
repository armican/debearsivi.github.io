...
- entry_name: |
  ...
  entry_fav_count: 125
  entry_content: |
    o değil de 11880’den mit numaralarının öğrenilebildiğini göstermiştir. şaka mı lan bu?<br/><br/>edit: defaatle gelen mesajlar üzerine belirtme gereği duydum mit de devlet kurumu olduğundan numaralı gizli değilmiş ama arandığında genelde muhatap bulunmazmış arkadaşların dediğine göre. aydınlatma için teşekkürler.
  entry_channels: siyaset,haber
- entry_name: |
    tamer tuna
  entry_id:  77237228
...
- entry_name: |
  ...
  entry_fav_count: 105
  entry_content: |
    kimse kusura bakmasın ama en absürd ve cahilce olanı ''aleyna'' dır. bu isim özellikle muhazakar kesimin islamı ne kadar şekilci ve boş yaşadığını, kuran'dan ne kadar habersiz olduğunun timsalidir. <br/><br/>aleyna kendi başına hiç bir anlamı olmayan arapça bir zarftır. ''ala'' üzeri, üst demek, 1. çoğul şahıs eki ''na'' yani bizim üzerimize. aynı zarfın diğer kullanımları: aleyye, aleyke, aleykum: benim üzerime, senin üzerine, sizin üzerinize. <br/><br/>bir kelimenin kuran'da geçmesi isim olması için yeterli değil. tersini düşünen varsa buyursun çocuğuna kuran'ın en uzun sureleri olan bakara veya enam isimlerini koysun. birisi inek öbürü de hayvan demek. hem aleyna gibi manasız da değiller.
...
- entry_name: |
  ...
  entry_fav_count: 94
  entry_content: |
    elektrik elektronik mühendisliği okuyorum. öğrenci olduğum için kendime mühendisim diyemiyorum. ama 2023 yılında bor ile çalışan %120 verimli elektrik motoru yapacağım. azıcık sabredin.<br/>edit: utanarak bu düzeltmeyi yapıyorum. %120 verim zaten olamayacağı için yazmıştım. hani konyalı mühendislerin ürettiği uzay araçları gibi. bunu ciddi anlamda yazdığımı düşünerek yorum yapılması gerçekten komik.
  entry_channels: bilim,teknoloji,ekonomi
- entry_name: |
    kadınların ekonomik krizi pek umursamaması
  entry_id:  77244857
  entry_writer: yeni dunya duzeni
  entry_fav_count: 89
  entry_content: |
    kadinlarin hayatinda destek olacak bir erkek hep vardir babasi, dayisi, sevgilisi, kocasi vs. ama erkek yapayalnizdir
  entry_channels: ekonomi
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 58
  entry_content: |
    ben bunu askerde fark ettim. cehaleti gösteren iki şey var:<br/><br/>1- empati eksikliği<br/><br/>2- uzun vadeli düşünememek<br/><br/>cahil insanlar kendisini karşısındakinin yerine koymakta çok zorlanıyor ya da bunun için çabalamıyor. bu bencillikten de kaynaklanabilir.<br/><br/>ayrıca cahil birine 'şimdi çalış sonra keyif sürersin' dediğinde hiçbir şey ifade etmiyor. bugünkü keyfinden asla ödün vermek istemiyor. bu yüzden de gelecekte sürekli sorun yaşıyor.
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    yaş ilerleyip kırka gelince, bitmiş ilişkilerden kalan bilgilerle insan neyi istemediğini çok daha iyi anlıyor. bu istenenler listesi de bu doğrultuda bir hayli spesifik bir hal alıyor, <a class="b" href="/?q=afyonlu+katolik+gay+ta%c5%9ff%c4%b1r%c4%b1n+ustalar%c4%b1">afyonlu katolik gay taşfırın ustaları</a> arayan ilanlara benzemeye başlıyor.
  entry_channels: anket,ilişkiler
- entry_name: |
    ramazan'da içki içerken fotoğraf paylaşan saygısız
  entry_id:  77246179
  entry_writer: malum zihniyet
  entry_fav_count: 14
  entry_content: |
    sanane lan!
  entry_channels: siyaset
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    devlet fetişisti insanların beğenmediği adam. oysa devlet millet için vardır, parası milletin parasıdır, meclis milletin meclisidir. vatandaşı devletin kulu olarak görmek faşizmin özünü oluşturur. solcu içinse devlet, olsa olsa vatandaşın huzur ve refahını tesis etmek için oluşturulmuş bir organizasyondur. devletin içinde bir takım adamlar, kendi kafalarına göre göya devletin selameti adına bir takım karanlık işlere giriştiğinde (bkz: <a class="b" href="/?q=9+kas%c4%b1m+2005+%c5%9femdinli+gerginli%c4%9fi">9 kasım 2005 şemdinli gerginliği</a>), evet teröristlik yapmış olurlar.<br/><br/>kendi siyasal görüşünüzü anlamak için şu küçük klavuzdan yararlanabilirsiniz:<br/>-<a class="b" href="/?q=devletin+bekas%c4%b1">devletin bekası</a> için <a class="b" href="/?q=insanl%c4%b1k">insanlık</a>tan ne kadar çıkılabilir? hepimiz "tamamen" ve "asla" arasında bir yerlerdeyiz.
  entry_channels: siyaset,haber
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    başımı sokacak bir ev. kirada oturmak kadar kötü bir şey yok şu dünyada. bildiğin evsizlik işte. bir ay maaş alama, işten atıl hoop sokaktasın. o yüzden kesinlikle bir adet ev gerekli şu dünyada.
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    yaza merhaba partisi değil oscar ödül töreni sanki amk. herkeste bir goygoy bir nümayiş. <br/>alt tarafı iki yüz metrekare çimenlikte elinde şaraf etrafa bakınacan birader.
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    akp'nin erdoğan için bağış kampanyası başlatması
  entry_id:  77244438
  entry_writer: birazfasistbirazkomunist
  entry_fav_count: 5
  entry_content: |
    çok para toplanacağını sanmam. ak parti seçmeninin ekonomisi çoh eyi olduğu için para vermezler. geçen reis adlı filmin gişesine 1 ayda 50.000 kişi gitmemişti. buna da çok büyük katkılar sağlanmaz. üç kuruşa zor geçinen fedailerin paralarının toplamı ne kadar ederse.<br/><br/>çankırı çorumlular derneği bile ak partiyi öven reklamlar bastırıyor. ak partinin kampayaya ne ihtiyacı var o da merak konusu.
  entry_channels: 
- entry_name: |
    en yakındaki kitabın 56. sayfasının 5. cümlesi
  entry_id:  77244419
  entry_writer: oyle iste hayat
  entry_fav_count: 0
  entry_content: |
    zilyetlik, zilyedin durumuna göre çeşitli açılardan ayrıma tabi tutulabilir.
  entry_channels: anket,edebiyat
---
