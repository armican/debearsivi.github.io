...
- entry_name: |
  ...
  entry_fav_count: 249
  entry_content: |
    şu an o fiyata sadece sepet alınabiliyor.<br/>içindekileri hayal ediyorsunuz.
...
- entry_name: |
    2 aralık 2019 c. başkanlığı seçim anketi
  entry_id:  98569657
  entry_writer: remaker
  entry_fav_count: 248
  entry_content: |
    anketleri pek sevmem ama imamoğlunun tayyibin önünde olduğunu sol tarafta akepeli yazarların yana yakıla açtığı propaganda başlıklarından anlıyorum.
...
- entry_name: |
  ...
  entry_fav_count: 241
  entry_content: |
    ömür boyu uçmayı seçsem kesin ibnenin biri keyif için beni havada vurur.en iyisi her zaman ki gibi para.
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    anasınıfında dini eğitime başlanması
  entry_id:  98572399
  entry_writer: allegro molto
  entry_fav_count: 189
  entry_content: |
    imam hatiplerle istenilen itaat seviyesine ulaşılamadığı görülmüş olacağından başlanılan uygulama. bir de 'dinimi seviyorum, öğreniyorum' denmiş. hangi dinin hangi mezhebi öğretilecek, bu belirtilmemiş. hoş, hepimiz biliyoruz hangisi olduğunu...<br/><br/>yazık şu memlekette doğan çocuklara.
...
- entry_name: |
  ...
  entry_fav_count: 137
  entry_content: |
    hem sakallı hem de sakalsız halimle çirkin olduğum için benle alakası olmayan erkektir.
...
- entry_name: |
  ...
  entry_fav_count: 67
  entry_content: |
    bu tarz görüntülere devam. sike sike eski yaşantımıza geri döneceğiz.
...
- entry_name: |
  ...
  entry_fav_count: 66
  entry_content: |
    nedendir bilmiyorum ama insanlari fakir diye etiketlemeyi gec, bu baslik altinda biseyler yazmayi bile ayip olarak nitelendiriyorum. burdan birsey okuyup, kendiyle butunlestirip gönlü kirilacak, incinecek insanlarimiz vardir belki. ne gerek var ki.
...
- entry_name: |
    bankacı kadınlar
  entry_id:  98577056
  entry_writer: deer hunter
  entry_fav_count: 46
  entry_content: |
    görünüşte çok cool ,şık, prezentabllar ama işin içyüzünde berbat iş koşulları, kota hedefleri, mobbing ve sürekli gülümseme zorunluluğundan vs psikolojileri berbat durumdalar ve antidepresansiz uyuyamiyorlar. işte bunlar hep etiketli iş sevdasının sonuçları.<br/><br/>edit: ulan şu entrye meriç misin diye mesaj atan olmuş . ulan biz de biliyoruz çok seksi olduklarını. zaten yüz defa yazılmış. siz portakalda vitaminken abiniz sadece telefonda konuşarak bankanın karanlık arşiv odalarında orgazm sırasına sokuyordu bankacı hatunları. illa söyleteceksiniz her şeyi.
  entry_channels: anket,ekonomi
- entry_name: |
    aleyna tilki'nin dahi olduğunu iddia etmesi
  entry_id:  98578848
  entry_writer: eeuummm
  entry_fav_count: 33
  entry_content: |
    madde etkisinde bende aynı hisleri yaşıyorum . sonra düşüş oluyor bütün bu hisler gidiyor hiçlik hissi ortama hakim oluyor.<br/><br/>kokaini azaltmasını tavsiye ediyorum.
...
- entry_name: |
  ...
  entry_fav_count: 24
  entry_content: |
    (bkz: <a class="b" href="/?q=caps+lock+tu%c5%9fu">caps lock tuşu</a>)
  entry_channels: anket,teknoloji
- entry_name: |
    bekar erkeğin yaptığı ev temizliği
  entry_id:  98577968
  entry_writer: bulutlari bekleyen
  entry_fav_count: 24
  entry_content: |
    pasaklılığı, tembelliği mizah ve hatta zeka göstergesi sanan tiplerin garipsediği olay.<br/><br/>temiz olmanın bekar ya da öğrenci olmakla alakası yok, öz saygı ile alakası var.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: siyaset
- entry_name: |
    muhafazakarların bilime bakış açısı
  entry_id:  98570769
  entry_writer: yepisyeniydi
  entry_fav_count: 17
  entry_content: |
    işine geldiği gibidir.<br/><br/>bilimsel gerçek hoşlarına giderse zaten kuran'da yazıyordur.<br/>hoşlarına gitmezse zındıklıktır, yalandır, günahtır.<br/><br/>teknolojiyi de parası neyse verip arkasındaki bilime, üreten kişiye kafa yormadan dibine kadar kullanır bu mübarekler. en lüks arabalar, en son model telefonlar, en şahane şatafatlı edavat hep bunlardadır maşallah...
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    hayatım kadınlara hizmet veren sektörlerde çalışanlara imrenmekle geçti. <br/><br/>birincisi ekonomik kriz her zaman onları teğet geçiyor. (kadınların parası nedense hep var). <br/><br/>ikincisi, devlet veya özel sektör büyük kurumlar kurup, tepelerine zorla patron olamıyor. (hepsi şahsi müteşebbis). <br/><br/>harbi kuaför olmak vardı. <br/><br/>not: doktorum.
  entry_channels: ilişkiler,haber,moda,ekonomi
- entry_name: |
    michael jordan
  entry_id:  98575064
  ...
  entry_fav_count: 11
  entry_content: |
    jordan’ın kıyaslanabileceği oyuncular <br/>michael phelps <br/>michael schumacher<br/>usein bolt <br/>roger federer(gönlümün en iyi tenisçisi)<br/>messi/ronaldo<br/>muhammed ali<br/>bu ve bunun gibi sporcularla dünyanın en iyi sporcusu olarak kıyaslanabilir.<br/><br/>edit: muhammed ali eklendi @balporsugu na teşekkürler
  entry_channels: spor
- entry_name: |
    msn + winamp + ultima online + kaşarlı tost
  entry_id:  98570231
  entry_writer: rick wright
  entry_fav_count: 9
  entry_content: |
    telefonumun sağ altında akınsoft belirdi şu an.
  entry_channels: oyun
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    anıtkabir’deki ismet inönü'nün mozolesi gibiyim. kimse fark etmiyor beni...
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    bana şimdiye kadar gelen tavsiyeleri evlenme amk şeklinde oldu.
  entry_channels: ilişkiler
- entry_name: |
    atm'lerde para bakiyesinin görünmesi saçmalığı
  entry_id:  98580957
  entry_writer: anubismillahirrahmanirahim
  entry_fav_count: 6
  entry_content: |
    haklı bir serzeniştir günümüz türkiyesinde güvenlik sorunun teşkil etmektedir.
  entry_channels: haber,ekonomi
- entry_name: |
    50 milyon dolar vs ölümsüzlük
  entry_id:  98579095
  entry_writer: saykoizmir
  entry_fav_count: 6
  entry_content: |
    ben ölümsüzlüğü seçiyorum...ölümsüzüm yani.. ne 50 milyonlar kazanırım anlatamam..!
  entry_channels: anket
- entry_name: |
    can yaman
  entry_id:  98564982
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    ustteki entrye ekleme olarak hersey var bir de,<br/><br/>neyse konuya gelelim, sana senin dilinle cevap verelim; gardas nakit yok nakit. herkes bogazina kadar borc icinde, kriz yoksa bile birileri cikip bana 4 yil evvel 130 liraya aldigim ayakkabiyi neden 350 liraya, 8 liraya aldigim sigarayi neden 18.50 liraya, 4 liraya aldigim deodoranti neden 17.65 liraya aldigimi aciklamali.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    birkaç entry üstte "izmir soğuğu gibi içinize işlemez, kuru soğuktur" denilen soğuktur. izmirliler soğuğa gevrek demiyor muydu?
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    film önerebilirsiniz.<br/><br/>kitap önerisi yazıp; kitaplardan ve filmlerden konuşabiliriz. <br/><br/>sizde antalyadaysanız kitap kafe ya da tiyatro önerebilirsiniz.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    amk trollemeninde adabı var. sağda solda ekşide yazarım diye konusu geçince millet bir değişik bakmaya başladı bana. hatta" araya adam soksak benim kardeşim üniden yeni mezun oldu onuda yazar yapsak" diyen mallar türedi. açık ve net diyorum ekşi sözlük kesinlikle hiç bir yazara herhangi bir ödeme yapmıyor. haaaa sen chp'nin, akp'nin trollusundur onlardan maaş alıyorsundur o ayrı. ama cidden inanan insanlar var buna. bakın tekrar söylüyorum ''ekşi hiç bir şekilde hiç bir yazara kesinlikle ödeme yapmıyor' ' sonra sarmayın millete benide yazar yapın diye.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    kayyım atanan firma. online alışveriş yaptığım zaman eğer kargo firması sürat ise almıyorum. en son alışverişim olduğunda ki çok acil bir bilgisayar parçasıydı. zar zor gittim kendim aldım.<br/><br/>-neden kargoyu getirmediniz?<br/>-abi personel yok. olan da maaş alamadığı için istifa etti. firma arabalara yakıt bile koymuyor artık. <br/><br/>gibi bir diyaloğa girdik. birçok kez arayıp da telefonu açmadıklarını da ekleyeyim. bulaşmayın.
  entry_channels: ekonomi
- entry_name: |
    bira içmelik arkadaş veritabanı
  entry_id:  98585058
  entry_writer: benburayaniyegeldim
  entry_fav_count: 0
  entry_content: |
    izmir 27/e
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    dünya üzerinde var olmuş en yetenekli sporcu <a class="b" href="/?q=lionel+messi">lionel messi</a> üstadımın alacağı ödül
  entry_channels: spor
---
