...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    4 iyi partilinin mhplilerce bıçaklanması
  entry_id:  76712884
  entry_writer: selim alai
  entry_fav_count: 110
  entry_content: |
    biri de demiş ki "eskiden ülkücü dendi mi bir ağırlığı olurdu".<br/><br/>arkadaş ben hangi ülkede yaşıyorum lan. ben kendimi bildim bileli ülkücü-milliyetçi dendi mi aklıma; kaba-saba, neye inandığını bilmeyen, ağzı bozuk, eli tespihli, beli silahlı, boş-beleş mahalle kabadayıları geliyor.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 81
  entry_content: |
    herkes apple gibi amazon gibi devlerin bütçesinden ve bu bütçenin türkiyeyi satın alabilecek güçte olduğundan bahsediyor. ama asıl görmemiz gereken nokta şu: apple, amazon gibi devler niye hep amerikadan çıkmış? cevabı basit. dünyada amerikadan daha iyi bir yatırım yapılabilecek bir ülke daha yok. nüfusuyla büyük bir pazar, yetişmiş insan gücü var, teknolojik alt yapı var ve ucuz, devlet her daim arkanda, demokratik bir hukuk devletinin tüm gerekleri de harfiyen uygulanıyor. üstelik dünyadaki rezerv para birimi olan dolar amerikanın kendi para birimi. yani amerika diyorki "sen yeter ki bana bi fikirle gel. eğer o fikre inanırsam seni abad ederim"
...
- entry_name: |
    ahdim olsun faizler enflasyon ve cari açık düşecek
  entry_id:  76714719
  entry_writer: burakowski
  entry_fav_count: 42
  entry_content: |
    (bkz: <a class="b" href="/?q=bir+g%c3%bcvence+olarak+ahdim+olsun">bir güvence olarak ahdim olsun</a>)<br/>(bkz: <a class="b" href="/?q=allah+kuran+%c3%a7arps%c4%b1n+d%c3%bc%c5%9fecek+karde%c5%9flerim">allah kuran çarpsın düşecek kardeşlerim</a>)
...
- entry_name: |
  ...
  entry_fav_count: 38
  entry_content: |
    bir sürü vardır mutlaka, tek tek sayarım da...<br/><br/>ama bir tanesi var ki hiç aklımdan çıkmıyor. annemi yıkayan kadınlar ablama vermişler saçından çıkarıp; bir tane lastik toka. <br/><br/>uyduruk, hiçbir esprisi olmayan, şimdi nerede olduğunu bilmediğim sıradan bir toka. <br/><br/>niye bu kadar etkiledi bilmem. ablam avucunu açıp gösterdi, aynı anda ağladık uzun süre. <br/><br/>nur içinde yat annem...
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 36
  entry_content: |
    hocam golü attık niye 9dk veriyorsun amk.
  entry_channels: spor
- entry_name: |
    sahte avukatla nişanlanıp dolandırılan öğretmen
  entry_id:  76711295
  entry_writer: lennonade
  entry_fav_count: 31
  entry_content: |
    nerden buluyolar o kadar parayı ya, ben dolandırılcak olsam maksimum 10bin lira bulurum ordan burdan.
  entry_channels: haber
- entry_name: |
  ...
  entry_fav_count: 31
  entry_content: |
    medyanın tamamen iktidar elinde olması nedeniyle muhalefet kendini anlatma fırsatı bulamamaktadır. bu fırsat eşitliği ilkesine aykırıdır. cnn ve ntv haber kanallaridir ve mitingleri görmezden gelemez. trt kimsenin çiftliği değildir. elbette protesto edilmelidir. her ne kadar sistem tarafından fonlansalar da en azından reklam gelirleri azalacaktır. "yav ben zaten bu kanalları izlemiyorum, bu devirde tv izleyen mi kaldı yhaa" diye ağız yaymaya kimsenin hakkı yok. sen izlemiyorsun ama anadolu halkı twitter'dan takip etmiyor olan biteni. "bana ne ben zaten izlemiyorum" demek, benzin zamlarından sonra "bana ne ben zaten hep elli liralık alıyorum" demek kadar ahmaklıktır.
...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    ankara'daki selde rafting yapan çocuk
  entry_id:  76714081
  entry_writer: abilerin casio saati
  entry_fav_count: 15
  entry_content: |
    küreğin yardımıyla bir türlü ilerleyememesi üzmüştür.
  entry_channels: 
- entry_name: |
    cengiz ünder
  entry_id:  76714122
  ...
  entry_fav_count: 12
  entry_content: |
    gol atmalara doyamayan cengaver. ben gol atsam bu kadar sevinmem. <br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=01VL8NrOXms" title="https://www.youtube.com/watch?v=01VL8NrOXms">link</a> de verelim.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    yine kütüğü kayseri ve erzurum olan ekşicilerinin birbirlerine ana avrat sövdüğü maç. ahahaha
  entry_channels: spor
- entry_name: |
    yusuf yerkel
  entry_id:  76712405
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    winner demek buydu işte romalılar. galatasaray burdan bırakmaz. ne tetikçi hakemleriniz ne de onursal başkanınız tüpçü durdurabilir bizi.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    sigarayı bırakalı bir seneye yaklaşmış biri olarak o dertle yüzleşmek diyorum.<br/><br/>sigara içtiğim zamanlarda bir sorun karşısında "nabıcaz be kamil" diyip bir sigara yakarken; şimdi gidip iyisiyle kötüsüyle yüzleşiyorum. tavsiye ederim.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    burdaki entrylere bakarken dertleşecek insan veritabanından ziyade fuck buddy aranıyor ilanlarıyla benzer entryler görüyorum genelde. başlığa yazılan yalnızca yaş ve cinsiyet olunca dertleşecek, ekstra olarak boy, kilo, eğitim durumu ve servet eklenince fuck buddy ilanına evriliyor. ya da bana öyle geliyor, bilemedim şimdi.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    şu anda çalan şarkı
  entry_id:  76715285
  entry_writer: red erik
  entry_fav_count: 0
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=wbeQVzXvtok" title="https://www.youtube.com/watch?v=wbeQVzXvtok">tarja turunen - ı walk alone</a>
  entry_channels: anket,müzik
- entry_name: |
    bir kadından soğuma sebepleri
  entry_id:  76716013
  entry_writer: bir eylul karacasulu
  entry_fav_count: 0
  entry_content: |
    hep o haklıdır<br/>hep o istediği zaman başlar <br/>hep o istediği zaman biter<br/>hep o küfür eder<br/>hep o hakaret eder<br/>hep o istediği zaman ulaşabilir<br/>asla ama asla aynaya bakıp da benin için deli olan bu adama ne oldu da böyle oldu demez. ben nerde bu adamı kaçırdım demez. kendini hep senin üzerinde görür ve bunu inçe inçe hep vurgular. en ufak bir karşılık verince da suratına da tükürür, ana avrat küfür de eder, evden de kovar. <br/>değersiz olduğunu hissetirene kadar rahatladım diyene kadar saatlerce hatta aylarca sürer.<br/>ne zaman uygun görürse seni köpek gibi, kenara attığı bir oyuncağı gibi geri alır. sıkılınca tekrar atar bu bir döngü olur. ama artık ortam buz gibi olmuştur.
  entry_channels: anket,ilişkiler
---
