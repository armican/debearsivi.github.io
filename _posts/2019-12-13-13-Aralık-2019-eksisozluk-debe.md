...
- entry_name: |
    12 aralık 2019 abd'nin ermeni soykırımını kabulü
  entry_id:  99034980
  entry_writer: redthepublic
  entry_fav_count: 232
  entry_content: |
    kendimi bildim bileli bir ermeni tasarısıdır uzar gider! senatoya sunulurken geri çekilir, bir tehdit unsuru olarak kimi zaman kartı açılır, sonra hop blöf ya da pas geçilir.<br/><br/>ortada bir durum varsa kabul et ya da etme amenna; ama neden sakız gibi uzatılır ki?<br/><br/>edersen ekime etmezsen...<br/><br/>bir ömürlük hayatımız var, yok annan planı, yok ermeni tasarısı yok şu bu, yetti bea!
...
- entry_name: |
  ...
  entry_fav_count: 137
  entry_content: |
    köpek dişleri olan tek otoburlar biziz o zaman. gözlerimizin de yine otoburlardaki gibi yanda değil, etoburlardaki gibi yüzün önünde olması falan komple yanlış olmuş o vakit.<br/><br/>ekleme: bu arada fırsat buldukça bahsettiğim bir şey; biliyorsunuz biz sindirim sistemimiz otobur canlılar ile beslenmeye daha müsait, bu bağlamda full vegan arkadaşları da yiyebileceğimizi düşünüyorum. bu hem dünyadaki açlık sorununu hem de gereksiz nüfus fazlalığını çözecek bir öneridir.<br/><br/>okuduğunu anlayamayan ama başlık açabilen editi: köpek dişinle çiğ et ye yazmıyor, madem et yemek doğanda yok, neden köpek dişin var yazıyor.
  entry_channels: 
- entry_name: |
    daron acemoğlu
  entry_id:  99014046
...
- entry_name: |
    kediyle uyumak
  entry_id:  99032524
  entry_writer: ortalamamuhendis
  entry_fav_count: 132
  entry_content: |
    normal şartlar altında deseler ki bana bir kedi sahipleneceksin ileride hadi be ordan derdim. arada arkadaşlarım tek yaşıyorsun bir kedi sahiplen arkadaş olur sana dedikleri zaman "yaaa ben köpek seviyorum, kedilerden çok hoşlanmam ki" derdim. <br/><br/>çok fena bir şekilde köpek aşığıyım, hâlâ da öyleyim. ileride bahçeli bir evim olursa ilk işim bir köpek sahiplenmek olacak. <br/><br/>günler günleri kovalarken bir arkadaşım kedisinin yavruladığını istersem bir yavru alabileceğimi söyledi. evine ziyarete gittim ve o an o yavruya vuruldum. tamam dedim biraz daha büyüdükten sonra eve getirdim minik kızımı. böyle bir şey olamazdı, sürekli beni izleyen bir çift göz vardı koca evin içerisinde. yadırgayacağımı düşünmüştüm ilk başta fakat evde dolaşıp dolaşıp benim kucağıma gelip uyuklamaya başlayınca dedim ki ben şimdiye kadar eksikmişim. evin içerisinde her nereye gidersem meraklı gözlerle ne yaptığımı hâlâ anlamaya çalışıyor eve gelince bacağıma atlayıp miyavlıyor. ilginç bir ilişkimiz oldu kendisiyle. <br/><br/>ilk gece kucağımda uyurken benim de uykum geldiği için gidip yatmak istedim. peteğin önünde ona yapmış olduğum yatağa yatırdım ve yatağıma gittim. aradan 1 dakika geçtikten sonra yatağa tırmanmaya çalışan miniği gördüm. çıkmaya çalışıyor fakat çıkamayıp ağlıyordu. aldım yatağa koydum, sanki kırk yıldır benle beraber yarıyormuş gibi partilerini omzuma attı be o şekilde uykuya daldı. o an ki mutluluğumu sanırım şimdiye kadar hayatımda bir kaç kez anca yaşamışımdır. artık oturma odamın ışığını kapattığım zaman koşarak yatağa gidip oturuyor, ben gelene kadar bekliyor gelince koluma, omzuma, göbeğime bir yere neresi rahat gelirse oraya kıvrılıp yatıyor. haa bir de mırıldaması var, mırıldamadan ziyade gurulduyor gerçi ama olsun. yalnızlık çektiğim için mutlu etmiyor beni bu da yanlış anlaşılmasın da, bazen karşılıksız, saf temiz duygulara ihtiyaç duyar ya insan o duyguları ben minik yavruda buldum. böyle saf bir sevgi gösterisinden kim mutlu olmaz ki? :)
...
- entry_name: |
  ...
  entry_fav_count: 81
  entry_content: |
    kusura bakma ama bu duruma getirilecek en akılsız çözümü sunmuşsun. bu durumda oluşacak iş verinin maddi kayıplarını çalışandan çıkarılması çözümü yerine, iş verene devlet desteği çözümünü önermelisin. devlet zaten bunun için var. devlet bir şirket değildir, vatandaşı korumak için varlığını sürdüren bir kurumdur. senin önerdiğin çözüm tam suriyeye pakistana yaraşan bir çözüm sayın yazar arkadaş. bu konuda batı hukukuna bakabilirsiniz.<br/><br/>edit: özelden mesajlar geliyor yok meriçlikten çıkın bilmem ne falan diye. olum mal mısınız amk savunduğunuz şeye bakın. valla bunu desteklemek için gerzek falan olmak lazım. siktirin gidin sözlükten ergen kadın düşmanları. o zaman ne kadınlara yükleniyorsunuz götünüz yiyorsa gidin patrona atar yapın "bu benim işim değil diye".
...
- entry_name: |
  ...
  entry_fav_count: 55
  entry_content: |
    bırakın düşürsünler dediğimdir. ne olur yani düşürseler. şuradan mutlu mutlu ilişkiler çıksa herkes birbirini sevse. en ufak konuyu küfür kıyamet tartışanlar daha mı iyi sanki... ablanız olarak sonuna kadar destekliyorum.<br/><br/>edit: başlık bana kalmış ama aslında benden önce tatlı bir kızımız başlatmıştı. kendisi sözlükten erkek düşürmeyi sevdiğini belirtmişti. o yüzden bana yürümeyin.
...
- entry_name: |
  ...
  entry_id:  98997385
  entry_writer: jahizir
  entry_fav_count: 48
  entry_content: |
    (bkz: <a class="b" href="/?q=mezuna+kalmak">mezuna kalmak</a>) kim sıçtı olum bu lafı?
  entry_channels: anket
- entry_name: |
    greta thunberg
  entry_id:  99031193
...
- entry_name: |
    13 aralık 2019 davutoğlu'nun yeni partiyi ilanı
  entry_id:  99019829
  entry_writer: mahibathi
  entry_fav_count: 37
  entry_content: |
    yorumlardan bir tanesi tebessüm ettirmiştir;<br/>''parti ambleminden yorumlarsak, islamcı bir kanada modeli var herhalde :)''
  entry_channels: siyaset,haber
- entry_name: |
    ekşi itiraf
  entry_id:  98998511
...
- entry_name: |
    ibb'nin papaz istihdam etmesi
  entry_id:  99037295
  entry_writer: noktas
  entry_fav_count: 28
  entry_content: |
    istanbul gibi bir medeniyet beşiği şehir adına gurur verici bir olay.
  entry_channels: 
- entry_name: |
    can yaman'ın türkiye'nin tek alfa erkeği olması
  entry_id:  99035243
  entry_writer: zita
  entry_fav_count: 27
  entry_content: |
    (bkz: <a class="b" href="/?q=seviyorsan+arka+odaya+git+bence">seviyorsan arka odaya git bence</a>)
...
- entry_name: |
  ...
  entry_fav_count: 24
  entry_content: |
    ilk entry yeterli bence erkeklerin neye aşık olduğunu bilmek için. gerisi çöp. en çok da "karaktere" cevabını verenlere güldüm, katıla katıla hem de. o saf, temiz ruhlar sadece orospulara aşık oldundugunu fark eder etmez orospulasma çabası içine giriyorlar. herkes sevilmeye, ölesiye sevilmeye muhtaç.
  entry_channels: anket,ilişkiler
- entry_name: |
    12 aralık 2019 fenerbahçe beko anadolu efes maçı
  entry_id:  99037131
  entry_writer: colcester
  entry_fav_count: 20
  entry_content: |
    zengin piçin birisi atıldı:). zengin ya her şeyi mübah zannediyor.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    hiç ayağa kalkmadan kazandığı maçta obra ile olan rekabete noktayı koymuştu. şimdi helvasını yapıyor.
  entry_channels: spor
- entry_name: |
    ismail şenol
  entry_id:  99034033
  ...
  entry_fav_count: 13
  entry_content: |
    adamın twitter'da çarşaf çarşaf genç fenerbahçeliler tişörtü ile fener tribününde olduğu fotolar piyasadayken hala karşıyaka taraftarı olduğunu düşünenleri göstermiş olan spikerdir...<br/><br/>karşıyakalıyim diyecek ne diyecek amk...fenerliyim galatasarayliyim diyemeyen futbol yazarları da gençlerbirliği taraftarıyım diyor.
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=Y1KJy4hvU04" title="https://www.youtube.com/watch?v=Y1KJy4hvU04">geri gelen mektup</a><br/><br/>ruhun mu ateş, yoksa o gözler mi alevden? <br/>bilmem bu yanardağ ne biçim korla tutuştu? <br/>pervane olan kendini gizler mi hiç alevden? <br/>sen istedin ondan bu gönül zorla tutuştu. <br/><br/>gün, senden ışık alsa da bir renge bürünse; <br/>ay, secde edip çehrene, yerlerde sürünse; <br/>her şey silinip kayboluyorken nazarımdan, <br/>yalnız o yeşil gözlerinin nuru görünse... <br/><br/>hançer gibi keskin ve çiçekler gibi ince <br/>çehren bana uğrunda ölüm hazzı verince <br/>gönlümdeki azgın devi rüzgarlara attım; <br/>gözlerle günah işlemenin zevkini tattım. <br/><br/>gözler ki birer parçasıdır sende ilahın, <br/>gözler ki senin en katı zulmün ve silahın, <br/>vur şanlı silahınla gönül mülkü düzelsin; <br/>sen öldürüyorken de vururken de güzelsin! <br/><br/>şiir: hüseyin nihal atsız
...
- entry_name: |
    müzik bir insan olsaydı kalbi hangi şarkı olurdu
  entry_id:  99039894
...
- entry_name: |
    mucize doktor
  entry_id:  99035502
  entry_writer: amanmadam
  entry_fav_count: 1
  entry_content: |
    fermanın kız kardeşi (bkz: <a class="b" href="/?q=dilek+k%c3%b6se">dilek köse</a>) o nasıl güzel oyunculuktur yaaa kesinlikle ilerde senin adını daha çok duymalıyız.
  entry_channels: tv
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    psg'den de 5 yedik.<br/><br/>(bkz: <a class="b" href="/?q=bravo+%c3%a7ocuklar">bravo çocuklar</a>)
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    sene sonu nba'ye gidip, bir sene sonra maccabi formasiyla avrupaya geri dönecektir. <br/>büyük oyuncu, ama bir naumoski degil.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    net mandalina. uğraştırmaz, elinize yüzünüze bulaşmaz. bir oturuşta bir kilo bitirirsiniz, yormaz sizi.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ağaç olsanız, hangisini tercih edersiniz?
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    12 aralık 2019 wolverhampton beşiktaş maçı
  entry_id:  99019289
  entry_writer: bene bene
  entry_fav_count: 0
  entry_content: |
    üstteki yazar arkadaşa sonuna kadar katılıyorum. tüm rotasyonlara eyvallah ama karius'un olmaması çok canımızı sıkabilir. ha karius öyle çok ahım şahım bir kaleci olduğundan değil ama en azından bu seviyeleri bilen eden adam. utku ingiltere'de deplasmana çıkma seviyesinden çok uzak bir oyuncu ve maç çok kısır geçecek olsa dahi erkenden yiyeceği saçma sapan 1-2 golle maç çok farklı noktalara gidebilir. umarım maç sonunda dönüp bu tercihe sayıp sövmeyiz.
  entry_channels: spor
- entry_name: |
    12 aralık 2019 basel trabzonspor maçı
  entry_id:  99033734
  entry_writer: kendimikeserim
  entry_fav_count: 0
  entry_content: |
    trabzonspor'un yedeklerini sahaya süreceği karşılaşma.<br/><br/>trabzonspor ; <br/>kalede erce<br/>sağ bekte serkan asan<br/>stoperde hosseini ve fernandes<br/>sol bekte abdürrahim dursun<br/><br/>libero da doğan<br/><br/>kanatlarda avdidaj ve fıratcan<br/>orta alanda abdülkadir ve onazi <br/><br/>ileri uçta ise ekuban ile maça başlayacaktır.<br/><br/>maç 20:55'te başladı beinsports hd 1 kanalından canlı olarak yayınlanıyor.
  entry_channels: spor
---
