...
- entry_name: |
  ...
  entry_fav_count: 118
  entry_content: |
    8-0 yenilip, 6 puan alınan grup olmuştur. alamayanlara girsin.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    sudan'dan gelecek at ve eşek eti
  entry_id:  99022800
  entry_writer: this person causes mental retardation
  entry_fav_count: 35
  entry_content: |
    ekrem coşkun çok iyi moruq.<br/><br/>gramı 11 tele len mq.<br/><br/>o değil de adamlar doları durdurmak için merkez bankasını boşalttılar, eti durdurmak için de malarialı at eti ithal ediyorlar.<br/><br/>allahtan escort piyasasından haberleri yok, aidsli ukraynalıları doldururlar animallah buraya.
...
- entry_name: |
    anne dırdırını savuşturmak için yapılması gereken
  entry_id:  99020729
  entry_writer: sizofrenx
  entry_fav_count: 15
  entry_content: |
    bırakın konuşsunlar. geçmişe dönüp keşke öyle konuşsaydı da ben dinleseydim onu dersiniz.<br/>canım annem.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    kanal istanbul'dan çıkan toprakla boğazı kapatmak
  entry_id:  99030927
  entry_writer: sedanter
  entry_fav_count: 12
  entry_content: |
    la birşeye de gülün geçin amk. hee litolojiyle kayaç, bir de kalker. herkes salak, bir sen akıllısın<br/>tanım: son derece mantıklı bir icraat
  entry_channels: 
- entry_name: |
    82'li hatunlar
  entry_id:  99001508
...
- entry_name: |
  ...
  entry_id:  98999358
  entry_writer: deniz1402
  entry_fav_count: 9
  entry_content: |
      (nokta)..aldım çiçeğimi şurama bastım,<br/>bastım ki yalnızlığımmış.<br/>(bkz: <a class="b" href="/?q=cemal+s%c3%bcreya+(bir+%c3%a7i%c3%a7ek)">cemal süreya (bir çiçek)</a>)
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    çalışsa dert, çalışmasa dert, çiftçilikten uzak olsa dert, yakın olsa dert, sokakta gezse dert, evde otursa dert, sesli gülse ayrı ağlasa ayrı dert, soyunsa dert, giyinse dert, evet dese dert, hayır dese dert... <br/><br/>kadın size dert, siz dünya'ya dert...
...
- entry_name: |
    ms hastası öğrenciye atak geçirten öğretmen
  entry_id:  99030441
  entry_writer: burnteam
  entry_fav_count: 3
  entry_content: |
    yaklaşık 9 yıldır ms hastası olan bir annenin oğluyum. 9 yıl önce koşan annem şuan %93 engelli. her sene engeline engel katarak ilerleyen bu hastalığa, herkes ama herkes saygı duymak zorunda. bu bir çocuk olabilir ya da sokakta karşılaşılan bir yetişkin. herkes sağlığını seçemiyor. velevki benim anam hayatında kapalı pakette ürün bile yememiş bir kadın. cips kola bile yememiştir, sigara bile içmemiştir.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    başlıkta "yok öyle bir şey bizi kendinizle karıştırmayın" diyen fenerliler hızlıca entry siliyorlar<sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup> omurgasız olmak böyle bir şey...
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    ankara soğuğunu seviyorum diyenler <br/><br/>neredeler??
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  99027186
  entry_writer: mffettah
  entry_fav_count: 1
  entry_content: |
    dedikodu arasında neden krem ikramı yapıyorsunuz?
  entry_channels: anket,ilişkiler
- entry_name: |
