...
- entry_name: |
  ...
  entry_id:  92212054
  entry_writer: slimxshady
  entry_fav_count: 246
  entry_content: |
    “burada, yaşayan en güçlü ve en zeki erkekleri görüyorum. bu potansiyeli görüyorum. ve hepsi heba oluyor. lanet olsun!.. bütün bir nesil benzin pompalıyor, garsonluk yapıyor yada beyaz yakalı köle olmuş. reklamlar yüzünden araba ve kıyafet peşinde... nefret ettiğimiz işlerde çalışıp, gereksiz şeyler alıyoruz... bizler tarihin ortanca çocuklarıyız. bir amacımız yada yerimiz yok. ne büyük savaşı yaşadık nede büyük buhranı. bizim savaşımız ruhani bir savaş. en büyük buhranımız hayatlarımız... televizyonla büyürken milyoner film yıldızı yada rock yıldızı olacağımıza inandık ama olmayacağız. bunu yavaş yavaş öğreniyoruz. ve o yüzden çok çok kızgınız...’’<br/>(bkz: <a class="b" href="/?q=fight+club">fight club</a>)
...
- entry_name: |
  ...
  entry_id:  92238366
  entry_writer: basroldumhakkimiyediler
  entry_fav_count: 105
  entry_content: |
    ilk şart ne bilmiyorum ama bazı şeyler var.<br/>yaş geldiğinden artık evlilik lafıyla sürekli muhattap olmak zorunda kalan biri olarak şunları söyleyebilirim. <br/><br/>sigarası, alkolü olmasın, evi olsun, arabası olsun, düzenli bilmem kaç k geliri olsun, boyu olsun, ailesi iyi olsun, modern olsun, zeki olsun, olsun da olsun bu liste böyle uzayıp gidiyor. bunlar varsa, evlen gitsin diye bakıyor herkes ama öyle değil işte. içini ısıtsın, ben bir ömür bu adamla geçinebilirim diyebil yoksa, bunları hepsi olsa da hiçbir faydası yok. ama şu da var, sadece içini ısıtsın bunların hiçbiri olmasın o da olmuyor. ay evlenmiycem lanet gelsin. soğudum yeminle. kariyer de yapamıyorum istediğim gibi. bu yazı da bi yere bağlanmıyor. yine kafamın içi çok dolu. ben bu sözlüğü günlük olarak kullanıyorum galiba. anonim olmak çok hoş istediğin kadar saçmala, kim ne bilecek.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 51
  entry_content: |
    uber ne güzel sikiyordu bunları<br/>bok vardı kaldırdınız güzelim uygulamayı.<br/>güzel olan her şeye karşıyız aq<br/><br/>edit:imlâ
  entry_channels: haber,ekonomi
- entry_name: |
    cüneyt özdemir'in şeyma subaşı ile dalga geçmesi
  entry_id:  92211647
  entry_writer: simple human
  entry_fav_count: 46
  entry_content: |
    birinin bir başkasını eleştirdiği konuda ondan iyi olması gerekmez. sütten çıkmış olması hiç gerekmez. cüneyt özdemir doğruları ve yanlışları göz önünde bulundurulunca bir insana bir şey katabilecek kapasitededir. diğer hanımefendi ise kendisi hakkında cümle kurmaya bile gerek duymadığım biri. kötü biri demiyorum, cüneyt özdemir'in yanında bomboş kalıyor. adam kendince eğlenmiş, hakaret etmemiş, eleştirmemiş bile. rahatsız olunacak bir şey yok.
...
- entry_name: |
  ...
  entry_fav_count: 39
  entry_content: |
    troller ekrem başkanı gömebilmek için mansur başkanı övüyor.<br/><br/>tanım: trollerin ayarlarını bozan adam.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    ülkeniz için düşmanla sevişir misiniz
  entry_id:  92246718
  entry_writer: tixanthrope
  entry_fav_count: 25
  entry_content: |
    (bkz: <a class="b" href="/?q=hain+d%c3%bcsman+al+sana+pompe">hain düsman al sana pompe</a>)
  entry_channels: anket,ilişkiler
- entry_name: |
    ekşi itiraf
  entry_id:  92209997
...
- entry_name: |
  ...
  entry_fav_count: 22
  entry_content: |
    cidden bu erkekler komik. burda doğallık överler. ama dışarı çıksan yeşil saçlı, mavi lensli kızlarla sevgili olurlar. bu yeşil saçlı kızların yanında da hep doğal bir kız olur. işte o kıza da bakan olmaz.
  entry_channels: moda
- entry_name: |
    thy'nin konstantinopolis ifadesini kullanması
  entry_id:  92246155
  entry_writer: stagflation
  entry_fav_count: 17
  entry_content: |
    yunanistan’da ıstanbul demek yasak mi?
  entry_channels: siyaset
- entry_name: |
    instagramda beğenilerin artık görünmemesi
  entry_id:  92248026
  entry_writer: svobodaozgur
  entry_fav_count: 14
  entry_content: |
    evet arkadaşlar. kara haber geldi. artık başkalarının kaç beğeni aldığını göremeyeceğiz. diğerlerinin kaç beğeni aldığını göremeyeceksek ya da bizim kaç beğeni aldığımızı başkaları göremeyecekse lüks yerlere gidip yemek yemenin, ülke ülke dolaşıp hava atmanın ne anlamı var. fenomenler boku yediniz. :)
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    gariptir ki bu cesaret ali ipek'in rahmetli oldugu hafta gelmistir...
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    sakin, huzurlu, işinde gücünde bir 90lar. <br/>insanların ve siyasetçilerin daha kaliteli ve diyaloğa açık olması, din tüccarlığı yapmaya kalkanların itin götüne sokulması. <br/>mirkelam kalitedir, huzurdur. o zamanlar tarkan'dan daha çok severdim bu manyağı.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    adam cumhuriyeti kurdu da bu kadar reklamını yapmadı. ne 15 temmuzmuş arkadaş. demek hayırlı bir şey yapsa 100 yıl kafa sikecek bunlar.
  entry_channels: siyaset
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    çevremdeki kadın arkadaşlarımın, teker teker 28 yaşına bastıkça evlendiklerine şahidim şu yaz aylarında. ben bu kadın arkadaşlarımı, evlendikleri erkeklerden çok daha iyi tanıyorum. evlendikleri erkekleride, hemcinslerim oldukları için direkt çözüyorum. maalesef bu erkekler cidden çok iyi kimseler. o kadar iyiler ki, tam bir mecnunlar, evlendikleri kişilerle gerçekten anlaşabiliyorlar mı, gerçekten felsefi açıdan uyumlular mı hiç düşünmemişler, sadece "düşmüşler" ve evlenmişler. benim kadın arkadaşlarım biraz kurnazlar. kaptıkları kişilerin patronu olacaklarını çok iyi biliyorlar. henüz kapılmamış hemcinslerim, bu bağlamdan bakarsanız günün birinde belkide şirinleri bile görebilirsiniz ama kapılanlar göremez.<br/><br/>(bkz: <a class="b" href="/?q=subliminal">subliminal</a>)
  entry_channels: ilişkiler
- entry_name: |
    şu an okunan kitap
  entry_id:  92234521
...
- entry_name: |
    6 temmuz 2019 arjantin şili maçı
  entry_id:  92249343
  entry_writer: aegeus
  entry_fav_count: 2
  entry_content: |
    bizim derbilerden ve hakemlerden daha kötü ne olabilir derken bu maça denk geldim; bizimkileri öpüp başımıza koyalım.
  entry_channels: spor
- entry_name: |
    antalya
  entry_id:  92243834
  ...
  entry_fav_count: 1
  entry_content: |
    garip yer<br/>şahane manzara<br/>dehşet kale içi<br/>böyle yer dünyada sadece 20 tanedir.
  entry_channels: tv,tarih,seyahat
- entry_name: |
    sütyenden dışarı hoyratça taşan meme
  entry_id:  92249281
  entry_writer: smskceyhun
  entry_fav_count: 0
  entry_content: |
    nerede bu sosyologlar?? bu adamları muhakkak araştırın. tedavi edilsin.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    <a class="b" href="/?q=robert+pires">robert pires</a> bir bu ibne iki.. gençliğimiz bunların gelmesini beklemekle geçti. <br/>(bkz: <a class="b" href="/?q=robert+pires%27in+u%c3%a7a%c4%9f%c4%b1">robert pires'in uçağı</a>)<br/><br/>hani olmaz ya falcao gelirse biz bu kadroyla ligin içinden geçer, ek olarak bir de melo familyasından sağlam bir <a class="b" href="/?q=dmc">dmc</a> alırsak şampiyonalar liginde çeyrek final yaparız.
  entry_channels: spor
- entry_name: |
    gary medel
  entry_id:  92249621
  ...
  entry_fav_count: 0
  entry_content: |
    messi tarafından kürek kemiklerinin arasına müdahale ayağına darbe yiyen, tepki göstermekte haklı, ama gereksiz yere abartılı sinirlenmiş olan adam.
  entry_channels: spor
- entry_name: |
