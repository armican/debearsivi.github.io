...
- entry_name: |
  ...
  entry_fav_count: 78
  entry_content: |
    sizin hala umudunuz mu var diyenler olmasa şu şekilde olacak sonuçlardır:<br/>%55 hayır %45 evet<br/>evet amınakoduğum benim hala umudum var ve herzaman olacak.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 61
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="http://i.hizliresim.com/nROmE1.png">http://i.hizliresim.com/nrome1.png</a>
- entry_name: |
    survivor 2017
  entry_id:  67215919
...
- entry_name: |
  ...
  entry_fav_count: 29
  entry_content: |
    bağırsak florasını toparlamak. burası 2. beyin ve bağışıklığın önemli kısmı burada oluşuyor. şeker, karbonhidrat, hazır gıda ve antibiyotikler bu florayı mahvedip, bağırsak duvarını hırpalıyor ve geçirgenliği arttırıyor. faydalı bakterilerin oranı azalırken zararlı bakteriler ve mantarlar çoğalıyor (candida gibi). bunların sonucunda proteinler kana sızıp, antijen oluşturup antikor artışına ve bir çok alerjiye sebep olduğu gibi, vitamin sentezi de bozuluyor. bağırsaklar sentezleyemediği için b 12, d vitamini, selenyum, demir depoları sürekli boşalıyor salgın gibi herkeste eksiklikler oluyor. ayrıca alerjen sızmaları sonucunda bir yerde vücut kendi yapılarını rakip görüp saldırmaya başlıyor. sonra gelsin bilumum otoimmun hastalıklar, (diyabet, tiroit, artriti ms gibi) gelsin geniz akıntıları, sinüzitler, astımlar, farenjitler, gripler. bozulan florayı tamir etmek zor değil. şeker ve karbonhidratı minumumda tüketip, probiyotik takviyeleri alır (dışardan kapsül veya şase formunda), prebiyotik gıdalarla beslenip (ev yoğurdu, turşu, kefir gibi), sarımsak ve elma sirkesini bolca tüketirseniz floranız zamanla inşallah tamir oluyor. yıllar boyu geçmeyen alerjik sinüzit ve geniz akıntım bu yolla hamd olsun minimuma indi. sırf probiyotik takviyesi sayesinde hastalık yaşamayan tanıdıklarım var. bir de omega 3 takviyesi tabii ki. unutmayın zehirlenmek istemiyorsanız şeker, ekmek, hazır gıda, hamur, kömür tüketmek yok veya minimum da. uygulayın dua edersiniz.<br/><br/>yağ (zeytinyağı ve tereyağı olmak şartıyla) ve protein ise serbest bol bol yiyin. unutulmasın ki tahıllardaki gluten ve bazı bünyelerde süt (artı bazen yoğurt dışındaki süt ürünleri) en önemli alerjenler ve duyarlılık (histamin) yaratanlar.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="http://beslenmebulteni.com/beslenme/allerjik-hastaliklar-ve-beslenme/" title="http://beslenmebulteni.com/beslenme/allerjik-hastaliklar-ve-beslenme/">alerjik hastalıklar, bağışıklık, bağırsak sağlığı ve beslenme</a><br/><br/>ayrıca bir çok hastalığın temelindeki sinsi düşmanımız için (bkz: <a class="b" href="/entry/61562724">candida/#61562724</a>)
- entry_name: |
    fi
  entry_id:  67218993
...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    ilginç bir kıza, yarışma tarihi boyunca gördüğüm en kolay soruları sorarak 15 bin tl kazandıran yarışma. sorular ciddi adaletsiz.
- entry_name: |
    trt arşiv
  entry_id:  67218123
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    o kan toplamış gözüne rağmen ayağa kalktın ya fabri, artık beton fabrikası lazım bize.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    kalbi kırılmış ve hikayesi asla ilgi çekici bulunmadığı için kalbinin neden kırıldığı asla bilinmeyen beyaz bir tavşan varmış. tavşan sadece dağa değil saç telinden tırnağına kadar, karincasindan filine kadar, anasından 7 ceddine kadar küsmüş.
- entry_name: |
    beşiktaş
  entry_id:  67230151
...
- entry_name: |
    2 nisan 2017 rafael nadal roger federer maçı
  entry_id:  67230723
  entry_writer: lordofphantom
  entry_fav_count: 4
  entry_content: |
    nadal bitmiş...<br/>nadal'ın kariyerini özetlemek gerekirse hani goal filminde bir sahne vardı. antrenmanı durdurup, muniez'e topun ondan hızlı gidebileceğini gösteriyordu. işte nadal uzunca bir süre o toptan daha hızlı gitti. bir yere kadar yetmeyince ise şimdi federer işim adeta kolay rakip oldu. bedenini hoyratça kullanmanın bedelini ödedi. ne eskisi gibi olabildi ne de başka stilde eskisi kadar başarılı olabildi. ama sağlık olsun tenisi onun sayesinde sevmiştim ben.<br/>vamos rafa
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    (bkz: <a class="b" href="/?q=a%c5%9f%c4%b1k+mahzuni+%c5%9ferif">aşık mahzuni şerif</a>)
- entry_name: |
    özel sektörün iyi yanları
  entry_id:  67230896
  entry_writer: kemerindegergedantasiyanadam
  entry_fav_count: 3
  entry_content: |
    eğer cidden üretme hevesindeki şirketleri kovalarsanız, meritokrasiyi azıcık ucundan deneyimleyebilme ihtimaliniz vardır.<br/><br/>yatmadan, çalışmadan para kazanma hayalindeki memur zihniyetli tipler bu gibi yerlerde tutunamaz genellikle, memlekete dönüp büfe falan açarlar.<br/><br/>becerikli olanlar ise çok kısa sürede çok önemli işler başarabilir. kazancı da buna paralel olarak oldukça hızlı artar.<br/><br/>layık olduğunuz kadar para kazandığınız tek yerdir.<br/><br/>bizim türk milleti çalışmanın ve üretmenin acısını çekmeyi çok sevmediğinden, yatmayı tercih ettiğinden ve bu sebeple burada tutunamadıklarından, özel sektöre sövmeye de bayılırlar.
- entry_name: |
    oy ve ötesi
  entry_id:  67225796
  ...
  entry_fav_count: 2
  entry_content: |
    şimdiki duruşunu beğenmiyorum, ayrıca zamanında oy çalındıysa bile çok cüzi oranda olduğunu düşünüyorum. fakat başında köpek gibi nöbet tuttuğumuz sandıklarda hırsızlık çıkmamasını "hani nerede çalınan oylar" diye malca yorumlayanlara da göz yumacak değilim. <br/><br/>bu oluşumun amacı çalınan oyları yakalamak değil, oy çalınmasını engellemekti. aktif olduğu yerlerde de belli ki etkili olmuşlar, ve bunu gene malların iddia ettikleri gibi açıklayamamış falan değiller, kapı gibi de çekinmeden açıkladılar zamanında.<br/><br/>ek: bu arada "sonuçlara etki edecek düzeyde" hile yapılmadığını açıklamıştılar. yoksa ülkenin pek çok yerinde yüzlerce hile tespit edilmişti akp lehine. a haber, akit, sabah falan dışında da birşeyler okuyup izlerseniz, fikir sahibi olabilecek bilgi düzeyine gelirsiniz belki.
- entry_name: |
    roger federer
  entry_id:  67230926
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    hayatımda izlediğim en komik videoya konu olan eroin satıcısı.<br/><br/>-tahminen 250 bin kişiyi zehirleyebilir.<br/><br/>pezevenk sanki elma satıyor, faydalarını anlatıyor.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    buram buram ayak kokan çalışma.
- entry_name: |
