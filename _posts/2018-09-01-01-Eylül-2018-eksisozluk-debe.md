...
- entry_name: |
  ...
  entry_fav_count: 62
  entry_content: |
    takımı monaco-porto-shaktar yapma yolunda yapılmış akıllı bir transfer daha.<br/><br/>bu işler böyle böyle olur beyler. bu saydığımız takımlar genç ve çok duyulmamış oyuncu ala ala böyle oldular.<br/><br/>o takımların da sizler gibi zamanında "ya bu kim hiç duymadık amk" diyen vizyonsuz taraftarı vardı mutlaka.<br/><br/>olur böyle.
  entry_channels: spor
- entry_name: |
    tolga ciğerci
  entry_id:  80817502
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    aslında kimse yazmamış ama içler acısı bir durum. çünkü ülkede kaliteli denebilecek okul kalmadı. odtü dahi kendi kalitesini kaybedip yavaş yavaş ankara'nın okulu olmaya başladı. <br/>önce bir sorun "bu kadar insan neden boğaziçine gitmek istiyor?" diye. cevap basit: "başka okul yok." eğitim açısından yerlerde sürünüyoruz ve 17837 yıl sonra bile değişen bir şey olmayacak.
...
- entry_name: |
    akp gittiğinde yargılanacaklar listesi
  entry_id:  80833467
  entry_writer: selimisik
  entry_fav_count: 7
  entry_content: |
    şimdiden hazırlamaya başladığım listedir. "milletin amına koyacağız" deyip yüzlerce milyonluk vergi borcunu sildirenler; iki silahı, yüzlerce mermisi olan -sözde- ekonomistler; hırsız bir pezevengin önüne yatanlar, yıllarca sümüklüye 'hoca efendi' deyip sonra pişkince suçu o oluşumdan hazzetmeyen, uzak duran kişilere suç atanlar, para sıfırlayanlar, koltuk değnekliği yapanlar, penguen belgeseli gösteren -sözüm ona- bağımsız medyanın patronları, hükümeti beğenmeyen herkesi hain ilan eden 'dede'ler. siyasi tercihleri dolayısıyla koskoca şehri tehdit eden patronlar. anayasal bir hakla seçime giren partiye oy atan seçmenleri ve o partinin milletvekillerini tehdit eden 'soy'u şüpheli bakanlar... hepsi bu listede var. şu an kan kusan insanlar da bir liste yapsa pek çok ortak kişi çıkacaktır. gün döndüğünde yürekli birileri hesap soracaktır. şimdi güçlü görünüyor olabilirler, yarın daha da güçlenebilirler ama yarının da yarını var.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    transferin kapandığını bildirmiştir.<br/>(bkz: <a class="b" href="/?q=resmen+fazia">resmen fazia</a>)
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    venezuela'nın petrolü var
  entry_id:  80831889
  entry_writer: sir real lancelot
  entry_fav_count: 3
  entry_content: |
    mahfi hoca'nın "gerçekten de venezuela'dan beter mi oluyoruz hocam ? :/" sorusuna verdiği fena halde anlamlı efsane cevap. <br/><br/>(bkz: <a class="b" href="/entry/80828831">#80828831</a>)/yorum/5771#yorum<br/><br/>(bkz: <a class="b" href="/?q=titrerim+m%c3%bccrim+gibi+bakt%c4%b1k%c3%a7a+istikbalime">titrerim mücrim gibi baktıkça istikbalime</a>)
  entry_channels: ekonomi
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    diyetteyken arada kaçamak olarak tüketebileceğimiz temiz ve basit tatlı örnekleri arayışında olanlar için paylaşayım.<br/>evde olan kuru yemişleri kullanıyorum fakat temel malzeme yulaf ezmesi. <br/>çiğ kaju da varsa şahane olur çünkü verdiği kıvam ve lezzet bir dengeleyici tat oluşturuyor. <br/>şeker yerine tatlandırmak için de hurma ya da incir. <br/><br/>-yulaf ezmesi<br/>-çiğ kaju<br/>-hurma <br/>-çiğ badem<br/>-tercihen bitter çikolata (ben yüzde 80 kakao olanlardan kullanıyorum) <br/><br/>hurmaları suda bekletiyoruz. <br/>ardından önce yulaf ezmesini rondodan geçiriyoruz. ardından kaju, badem ve çikolata. <br/>en son da süzülen hurmaları ekleyip hepsini rondoda çırpıyoruz. <br/>elimizde yuvarlanacak kıvama gelince top top yapıp, hindistan cevizine buluyoruz ve dolapta biraz beklettikten sonra kahveyle löp löp gömüyoruz.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    1,5 yıl sonunda seni tamamen unuttuğumu hissettim bugün.<br/>hayatımın en güzel günlerini ve en mutlu anını yasattığın için tesekkür ederim. seni her zaman iyi hatırlayacağım.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    reddedişin ertesi haftası boyu pişmanlık sancılarına girmesi muhtemel erkektir. bakın bu ruhsal olarak regl sancısı gibi bir şeydir erkek açısından. şeytan kafa adam ama çok tehlikeli birisi.<br/><br/>edit: tersi durum için de geçerlidir.
  entry_channels: anket,ilişkiler
- entry_name: |
    fatih terim
  entry_id:  80835103
  ...
  entry_fav_count: 0
  entry_content: |
    "tek forvet oynayacağız" derken lafın nereye gideceğini kestiremedi zaar
  entry_channels: spor
- entry_name: |
