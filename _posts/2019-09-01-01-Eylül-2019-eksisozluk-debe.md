...
- entry_name: |
    barış manço müzesi önündeki pembe şortlu kız
  entry_id:  94710719
  entry_writer: cnknv
  entry_fav_count: 114
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 42
  entry_content: |
    olası istanbul depreminde denize 0 değil -15 -20 olacaktır .
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    bodrum'da bir tatil köyünün barında plajda halvet isimli içkimi yudumlarken turist hatunları kesiyorum. neyse ki rus değil ingilizler de özgüvenim yerlerde sürünmüyor.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    (bkz: <a class="b" href="/?q=sikimin+%c5%9fehzadesi">sikimin şehzadesi</a>)<br/><br/>şehzade ne ulan?
