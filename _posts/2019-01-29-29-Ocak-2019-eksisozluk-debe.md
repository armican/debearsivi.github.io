...
- entry_name: |
  ...
  entry_id:  86027155
  entry_writer: ayemetvork
  entry_fav_count: 23
  entry_content: |
    sosyal medyada burç vs gibi zırvaları paylaşan insanlar var, bunlar söz sporcu. bunu takip edip okuyan ya da like atan yüzbinlerce insan var. ot geldiniz ot gideceksiniz. ondan sonra hayatta başına gelen her bok için gezegenleri suçlarlar. e aq kader var gezegenler var. sen yat bütün gün zaten bütün hayatın bunlarla yazılmış. çaba harcamana ne gerek var?<br/><br/>tanım: doğru önermedir. görece doğru değil hemde bilimsel doğrudur.
...
- entry_name: |
    mabel matiz
  entry_id:  86023845
  entry_writer: seviyosan git konus bence abi
  entry_fav_count: 12
  entry_content: |
    tek başına ülkedeki müzik, klip, sanat seviyesini muasır medeniyetler seviyesine çıkaran insan.
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    kasımpaşa'nın başakşehir'e çelme takmayacağı maç hele ki galatasaray'ın kazandığı hafta hiçbir şekilde çelme takmazlar.<br/><br/>başakşehir 2 farkla kazanır. kasımpaşa başakşehir'e şampiyonluk yolunda başarılar diler.
  entry_channels: spor
- entry_name: |
    90'lı yılların unutulmaz ikinci lig takımları
  entry_id:  86035896
  entry_writer: bada
  entry_fav_count: 3
  entry_content: |
    (bkz: <a class="b" href="/?q=%c3%a7anakkale+dardanelspor">çanakkale dardanelspor</a>)
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    an itibariyle hdp'nin ittifaka katılmaya çalıştığı istanbul, izmir ve adana'da ittifakı bozsa, izmir ve adana'da eminim çok ciddi oy alabilecek parti. ama şu an yönetimin bu topa gireceğini zannetmiyorum.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    "the girl who leapt through time"dan spoiler: (bkz: <a class="b" href="/?q=toki+o+kakeru+shoujo%2f%40ssg">toki o kakeru shoujo/@ssg</a>)
  entry_channels: anket,ilişkiler,edebiyat
---
