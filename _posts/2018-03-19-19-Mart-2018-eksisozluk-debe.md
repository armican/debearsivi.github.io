...
- entry_name: |
  ...
  entry_fav_count: 35
  entry_content: |
    bir gülme efekti. tüyü yolunmuş kartal görünce olur genelde insana.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 29
  entry_content: |
    "yaşamın anlamı gece duyumsanır ve sorgulanır. kimse bunu öğle yemeği sırasında tartışmaz. yaşam, gecenin konusudur."<br/><br/>-cehenneme övgü, gündüz vassaf
- entry_name: |
    ekşi itiraf
  entry_id:  75134177
...
- entry_name: |
  ...
  entry_id:  75133289
  entry_writer: benceboyle
  entry_fav_count: 26
  entry_content: |
    taktik yaptığını sanan flörtöz kadın veya erkek davranışıdır. taktiklerinize sokayım.
- entry_name: |
...
- entry_name: |
    atiba hutchinson
  entry_id:  75149473
  entry_writer: esnaf olacam ben
  entry_fav_count: 14
  entry_content: |
    gitsin. ama defolup gitmesin. emeği çok beşiktaşım'da. formsuzken oynatan hocaya çemkirin
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    sahanın en kötüsü<br/><br/>ama olsun lens’e küfür edelim de gelenek bozulmasın
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    (bkz: <a class="b" href="/?q=john+arne+riise">john arne riise</a>)<br/>(bkz: <a class="b" href="/?q=roberto+carlos">roberto carlos</a>)
- entry_name: |
...
- entry_name: |
    tolgay ali arslan
  entry_id:  75147595
  entry_writer: devegormez
  entry_fav_count: 5
  entry_content: |
    bugün de kritik bölgede top kaybederek rakibe gol attırmıştır. senelerdir kendi yarı alanında basit oynamayı öğrenemedi.
- entry_name: |
...
- entry_name: |
    ateizm bizim kutsalımızdır
  entry_id:  75149287
  entry_writer: opethian
  entry_fav_count: 2
  entry_content: |
    mesela birisi ateistlerin kutsalına dokununca ateistler sözle karşılık verirken bu mağdur kesimin kutsalına dokunulunca bakalım neler oluyormuş, söz maide 33'te;<br/><br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>maide 33: allah’a ve resûlüne savaş açanların ve yeryüzünde bozgunculuk çıkarmaya çalışanların cezası; ancak öldürülmeleri, yahut asılmaları veya ellerinin ve ayaklarının çaprazlama kesilmesi, yahut o yerden sürülmeleridir. bu cezalar onlar için dünyadaki bir rezilliktir. ahirette de onlara büyük bir azap vardır.<br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---
- entry_name: |
    tomb raider
  entry_id:  75145403
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    --- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>soygundan sonra neler olduğu ile ilgili mesajı hangardan çıkışta verdiğini düşündüğüm dizi. <br/>nairobi: bebek arabasıyla çıktı, demekki çocuğunu aldı ve mutlu mesut yaşadı.<br/>tokyo ve rio: beraber çıkıp ayrı yönlere doğru gittiler. yani hiçbir zaman beraber olmadılar.<br/>denver ve monica: kolkola çıktılar, bir ömür mutlu yaşadılar.<br/>--- <a class="b" href="/?q=spoiler">spoiler</a> --- <br/>dizi soygun dizisi, soygundan sonraki yaşam dizisi değil. bu yüzden soygundan sonrası ile ilgili bir şey paylaşmamaları bence gayet yerinde bir karar.<br/><br/>not: spoiler alanı içindeki yorumlar tamamen şahsıma aittir, tamamı alakasız çıkarımlar olabilir. sadece tahmin.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    kendisine 21 milyon euro ödemek gibi bir hata yapmamamız gereken futbolcu. bu seneki oyunumuzun yegane sorumlulularındandır. gol atması ve bazı kişisel kabiliyetleri kendisinin takım oyununa vurduğu baltayı gölgelemektedir.
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    neredeyse gol başına 1 milyon euro alan futbolcudur. adam resmen keriz silkeliyor, hem de bu yaşta. tam bir ispanyol boğası, hey yavrum hey.
---
