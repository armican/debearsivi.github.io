...
- entry_name: |
    hülya avşar'lı #kadıngüçlüolursa reklamı
  entry_id:  74856530
...
- entry_name: |
  ...
  entry_fav_count: 38
  entry_content: |
    alanyaspor'un gol dışında en az 3 tane daha %100 gol pozisyonuna girip değerlendiremediği karşılaşma. <br/><br/>vagner love'u almasaydık, bu maçta başakşehir'e atacağı gollerle beşiktaş'a şampiyonluk yolunda daha çok faydası olabilirdi.
- entry_name: |
...
- entry_name: |
    mantarın enfekte ettiği karınca
  entry_id:  74872716
  entry_writer: bir zamanlar cok mutluyduk
  entry_fav_count: 23
  entry_content: |
    katil bir mantar türü tarafından enfekte olan karıncanın halini gösteren, bana çok ilginç ve korkunç gelmiş videodur. karıncanın sonu pek iyi olmamış. (video bbc'ye ait)<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=XuKjBIBBAL8">https://www.youtube.com/watch?v=xukjbibbal8</a>
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    - eyvallah etmemesi<br/><br/>- görmezden gelmesi<br/><br/>- süründürmesi<br/><br/>- isteyince elinize geçmemesi <br/>(afedersiniz, vermemesi)<br/><br/>- sizi kullanırken kendini kullandırmaması
- entry_name: |
    torku boykotu
  entry_id:  74859756
...
- entry_name: |
    yıldırımdan elektrik enderjisi depolamak
  entry_id:  74865627
  entry_writer: omurgam dalagim bobreklerim
  entry_fav_count: 2
  entry_content: |
    ender görülen bir depolama biçimidir.
- entry_name: |
    la casa de papel
  entry_id:  74850137
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    - alice in wonderland'deki dev canavar.<br/>- hayalet avcılarındaki lord vigo.<br/>- clementine'deki ateş.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    biribanadedi : kadrolu dedikoducu.
- entry_name: |
    9 mart 2018 zalgiris fenerbahçe doğuş maçı
  entry_id:  74873637
  entry_writer: yakisikliolmaksucmu
  entry_fav_count: 0
  entry_content: |
    kötü başladığımız ama takıma güvendiğimden dolayı galip geleceğimize inandığım maç. hadi çocuklar obra reis'e güzel bir doğum günü hediyesi olsun.
---
