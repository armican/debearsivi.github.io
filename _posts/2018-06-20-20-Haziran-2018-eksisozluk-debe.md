...
- entry_name: |
    muharrem ince'nin şark hizmetinden kaçması
  entry_id:  78229932
  entry_writer: hepdedingelmedim
  entry_fav_count: 1335
  entry_content: |
    şunun bile belgesi varken bir diplomanın örneğinin olmaması çok enteresan.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    denizli mitinginde bir vatandaşın ezan sessizliği sırasında, kendisine hitap ettiği lakap gayet uygundur bence.<br/>(bkz: <a class="b" href="/?q=gariban+o%c4%9flan">gariban oğlan</a>)
  entry_channels: siyaset,anket
- entry_name: |
    19 haziran 2018 rusya mısır maçı
  entry_id:  78247170
  entry_writer: johannsbach
  entry_fav_count: 0
  entry_content: |
    kabalik ve irkcilik birseydir ama bunlarla gurur duymak bambaska birseydir. evet ruslardan bahsediyorum dogru bildiniz.<br/>mulayim topcu salah askina haydi misir diyoruz.
  entry_channels: spor
---
