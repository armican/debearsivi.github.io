...
- entry_name: |
    türk kızlarının bu kadar güzel olmasının sebebi
  entry_id:  107032209
  entry_writer: elmsokagininkabizi
  entry_fav_count: 117
  entry_content: |
    (bkz: <a class="b" href="/?q=premium+meri%c3%a7">premium meriç</a>)
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
    ekşi itiraf
  entry_id:  107013564
  entry_writer: nagato uzumaki
  entry_fav_count: 34
  entry_content: |
    küçükken annem ile babam ayrıldığında bir süre babamla kaldım.en büyük keyfim babamla o zamanlar ntv’de yayınlanan formula 1 yarışlarıydı.birgün bende orda yarışacağıma inanıyordum,olmazsa da hep hayalim olan komiser olacaktım nasılsa :)<br/>lisede ortaya çıkan hastalığıma kadar ...<br/>epilepsi demişti doktorlar bırak komiser olmayı bırak yarışçı olmayı ehliyet bile alamıyordum,askere gidemiyordum <br/>ilaçlar kullanmaya başladım 75 kg’dan 100 kilo oldum kız gibi olan saçlarım ilaçların etkisiyle oluk oluk döküldü kel kaldım kaşlarım bile döküldü..<br/>kullanmasam nöbet geçiriyordum <br/>zorundaydım...<br/>her şeye engel oldu bana ,hayalimdeki meslek ,sevdiğim kadın ,tipim,ruh halim,<br/>çevremde hep sabıkalı muamelesi gördüm <br/>-sen neden gitmedin askere<br/>-neden ehliyetin yok <br/>-neden kaşların az,saçların erken döküldü <br/><br/>zamanla geçti sözlük ben kazandım galiba şükürler olsun ilaçları bıraktım uzun bir süre geçti ve artık ,gün itibari ile, ehliyet alabilir raporu aldım <br/>hayatımda ilk defa sevinçten ağladım bugün :) <br/>ben sadece filmlerde olur zannediyordum mutluluk gözyaşları ..<br/>oluyormuş işte .. :) <br/>evet çok şeye mal oldu ama artık bir şeyleri kazanmaya başladım artık galiba <br/>hah bu arada atandım ben doğuda öğretmenim :) <br/>ve çok güzel çocuklar yetiştiriyorum <br/>eşitliği öğretiyorum onlara :)<br/>adaleti öğretiyorum <br/>birlik olmamızı öğretiyorum <br/>evet çok şey kaybettim ama bir şeyleri kazanmaya başladım <br/>bu arada ehliyet almama bakmayın hiç param yok ve çok borcum var ( 3-4 yıl araba hayal yani :) )<br/><br/>ama artık sabıkalı damgasını kırdım galiba hafiften :)
...
- entry_name: |
  ...
  entry_fav_count: 24
  entry_content: |
    giriş cümlesi ''iyi olan kaybetsin'' dir.
  entry_channels: ilişkiler,bilim,sanat,tarih,müzik,sinema,edebiyat,sağlık
- entry_name: |
...
- entry_name: |
    12 mayıs 2020 erkan petekkaya'nın insta paylaşımı
  entry_id:  107051741
  entry_writer: psychiatry
  entry_fav_count: 17
  entry_content: |
    saçma olmuş erkan bey. şimdi kim dalyarak dese akla siz geleceksiniz, halbuki düne kadar böyle bir şey yoktu.<br/><br/>neyse ki sizden önce akla ozan güven geliyor ama başka şekilde.
...
- entry_name: |
    hepsiburada.com
  entry_id:  107024383
  entry_writer: liquortr
  entry_fav_count: 8
  entry_content: |
    ilginç bir sistemleri var. bir ürün aldım rengi yanlış gönderilmiş kasıtlı bir şekilde sonrasında mağazayı buldum mail attım aradım vs tavır çok kötüydü üstüne üstlük web sitelerinde bana göndermedikleri ürünü satıyorlardı. her neyse burası o mağazayla ilgili hepsiburada ile ilgili kısma geleyim. ürünü 5 gündür yorumlayıp 1 puan verip olanları yazıyorum ne hikmetse hep reddediliyor. ve hep de dedikleri kurallar çerçevesinde yazıyorum her seferinde red. işin ilginci bütün yorumlar 5 yıldız 60 küsür yorum var. yani deneyimleri aktarmakta bile aleni şekilde algı yapıyorlar. çünkü o ürün satıcılarında mağaza olarak kendileri de var. son alışverişimdi kendilernden. tez zamanda hak ettiklerini bulurlar umarım
...
- entry_name: |
    ekrem imamoğlu'nun ilginç selamlaşma stili
  entry_id:  107048411
  entry_writer: kaptanhadok
  entry_fav_count: 4
  entry_content: |
    ekrem imamoğlu neden böyle selamlaşmış ya, temasla bulaşan bir virüs falan mı çıktı?
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    size ne milletin maaşından? 5 alsın 10 alsın günde 1 saat çalışıp 100 alsın size ne ya? olm bu üniversiteler herkese açık değil mi? girin sınavına, bitirin bölümünü siz de alın o paraları. bu nedir abi yaa bir gün öğretmene bir gün doktora bir gün mühendise salya akıtmak nedir? ulan <a class="b" href="/?q=kutsal+bilgi+kayna%c4%9f%c4%b1">kutsal bilgi kaynağı</a> mı ağlama duvarı mı belli değil. hayret bişey yaa.
  entry_channels: 
- entry_name: |
    tamirci çırağı söylenen ilginç dini program
  entry_id:  107026615
  entry_writer: domine deyus
  entry_fav_count: 1
  entry_content: |
    bence amcanın biraz farklı bir geçmişi var. o arada masadaki bardaktan bir fırt alıp geri bırakma hareketi vakti zamanında zamanla kazanılmış bir harekete benziyor.
  entry_channels: tv,müzik
- entry_name: |
    ptt'nin çalışanlarına 2000 tl vermesi
  entry_id:  107052482
  entry_writer: ted schmosby
  entry_fav_count: 1
  entry_content: |
    kapalı şubeleri de açıp yoğunluğu azaltırlar umarım. ayrıca bu olaya gelirsek bütün kargo şirketleri şu an paraya para demiyor, o yüzden yapmaları gerekeni yapmışlar, pttye iyi yapmış demeyeceğim, diğerleri neden yapmıyor diyeceğim, malum bu süreçte en çok kazanan sektör lojistik sektörü oldu
  entry_channels: 
- entry_name: |
    esra elönü
  entry_id:  107016799
  ...
  entry_fav_count: 1
  entry_content: |
    f. tezcan bir yandan bu bir yandan b. arınç'ı becermeye çalışıyor. tabi arınç da bunları becermeye çalışıyor. güzel bir porno filmi bizleri bekliyor gibime geliyor.
  entry_channels: siyaset,tv,haber
- entry_name: |
    yazarların en iyi beş dizi listesi
  entry_id:  107055276
  entry_writer: nick kullanmak da sart mi
  entry_fav_count: 0
  entry_content: |
    friends<br/>spartacus<br/>tatlı hayat <br/>ezel <br/>bitmedi ama the last dance son koltuğu alabilir.
  entry_channels: anket,tv,ekşi-sözlük
- entry_name: |
    wc'de canlı yayın yaparken telefonu düşüren bakan
  entry_id:  107053687
  entry_writer: demiray
  entry_fav_count: 0
  entry_content: |
    ben canlı yayına çıkacak olsam 1 hafta öncesinden su bile içmem tuvaletim gelmesin diye. adam sıçarken canlı yayına bağlanıyor özgüvene bak.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    deve tuncay ile abidin’in dialogları fena değildi.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/KPgLgL6FlEY" title="https://youtu.be/KPgLgL6FlEY">bana mutluluğun resmini çizebilir misin abidin?</a>
