...
- entry_name: |
    1945 yılında niğde'de poz veren polisler
  entry_id:  86776300
  entry_writer: hak yeme fuck yeah
  entry_fav_count: 202
  entry_content: |
    <a class="b" href="/?q=ss">ss</a> subayları zannettim ilk başta. <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup><br/><br/>oturan üçlüden ortadaki kadir inanır mı la o ?
...
- entry_name: |
    izmir'in en verimli eshot hattı
  entry_id:  86789154
  entry_writer: akarui me
  entry_fav_count: 10
  entry_content: |
    eski (bkz: <a class="b" href="/?q=70">70</a>) cumartesi gecesi alsancak cami durağından dönüş. çok bereketliydi.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    erdoğan'ın balıkesir mitinginde açıkladığı yeni sistemi anladığım kadarıyla anlatayım:<br/><br/>kısa-uzun dönem askerlik: birleştirilmiş gözüküyor. herkes için 6 aya düşüyor. isteğe bağlı olarak 6.aydan sonra maaş alma karşılığında bir 6 ay daha yapabiliyorsunuz. yapmak istemezseniz 6.aydan sonra terhis oluyorsunuz.<br/><br/>asteğmenlik: aynı şekil devam. 12 ay maaşlı askerlik<br/><br/>yedek astsubaylık: bu yeni bir olay. 2 yıllık meslek yüksek okulu mezunları için yine ordunun ihtiyacına bağlı 12 aylık maaş karşılığı yedek astsubaylık yapılabilecek. bir nevi düşük rütbeli asteklik.<br/><br/>bedelli askerlik: bedelli için kalıcı sistem getireceklerini söyledi. yani belli periyotlarda bedelli askerlik çıkacak. 1 aylık temel eğitimden sonra terhis olunacak. ayrıca dövizli askerlik ile bedelli askerliğin ücreti eşitleniyor. yani türk lirası karşılığı ne ise döviz ücreti ona endekslenecek.<br/><br/>hayırlı uğurlu olsun.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    aşık olan,hiç kaçınmadan ve her fırsatta bunu seni seviyorum cümlesiyle ortaya koyan erkek arızalıdır.erkeğin aşık olması için arızalı,bozuk ve çaresiz olması gerekir.o yüzden aşık olan adamdan uzak durulması lazım aslında.<br/><br/>öte yandan samimiyetle sevmek diye bir şey vardır bizde.bunu uygularken çok bilinçli yapmıyoruz ama bu doğrudur,sağlıklıdır ve gerçektir.aradaki farkı anlarsınız.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    ali koc baskan geldikten sonra, mamasi kesilmis kedi gibi alttan alttan ersun hoca' ya ve baskana giydiren capsiz yorumcu. sevgili seytan, biz seni sikimize takmiyoruz. aykut' un maclarindan sonra yaptigin yorumlari da biliyoruz. aziz ve aykutla birlikte senin de devrin gecti. bosuna yirtma bi tarafini.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    adam kenardan hakemi kovalıyor 3 çeyrek boyunca, aralıksız hakeme itiraz ediyor sonra teknik çalınınca tripli tavırlar. ulan kaç kere uyardı hakem seni zaten. ne yapsın adam başka? senin yüzünden fenerden önce efesli olan ve basketbolu seven ben efesten soğudum!
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    kendisine guvenen fenerbahce taraftarindan besiktasli bir orospu cocugu rahatsiz oluyor. <br/><br/>cok ilginç ...
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    bir kaç dakika önce; kızımın yatakta yanıma gelip günaydın babacım diyerek yanıma sokulması. misssss
  entry_channels: anket
- entry_name: |
...
- entry_name: |
    uzaylıların dünyaya toplu şekilde geleceği gün
  entry_id:  86798069
  entry_writer: aslan2
  entry_fav_count: 0
  entry_content: |
    bilim adamlarından "halı sahada maç yapalım" teklifi aldıkları gün olabilir.
  entry_channels: bilim,tarih,teknoloji,havacılık,seyahat
- entry_name: |
    sofiane feghouli
  entry_id:  86800032
  ...
  entry_fav_count: 0
  entry_content: |
    kendine güveni geldiğinde, takımın lider oyuncusu olduğunu hissettiğinde durdurulamayan kanat oyuncusu.
  entry_channels: spor
- entry_name: |
    mahmoud hassan
  entry_id:  86799152
  ...
  entry_fav_count: 0
  entry_content: |
    10 milyon euro eden diagne değil bendim dedirtmek için oynayan oyuncu.<br/><br/>haksız da değil gibi.
  entry_channels: spor
- entry_name: |
