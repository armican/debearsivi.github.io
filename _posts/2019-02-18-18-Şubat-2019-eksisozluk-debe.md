...
- entry_name: |
  ...
  entry_fav_count: 24
  entry_content: |
    "seninle aramızdaki yakınlaşmanın bir hududu, bir sonu olmamasını ne kadar isterdim.<br/>beni asıl, bu ümidin boşa çıkması üzüyor..."<br/><br/>kürk mantolu madonna, sabahattin ali
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    çöp hakemlere ve ciddi eksiklere rağmen kupayı aldığımız maç. kudur lan ataman. izleyen ezik 6sliler de susmuş oldu.
  entry_channels: spor
- entry_name: |
    ekşi itiraf
  entry_id:  86771610
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    nickimizi nerden değiştiriyoruz 14 sene önce yazmıştım ben bu nicki anca sıra geldi büyüdüm mevsimler değişti yardım edin..
...
- entry_name: |
  ...
  entry_id:  86785802
  entry_writer: manyak ananas
  entry_fav_count: 1
  entry_content: |
    diziye yakışır bir yorum yapayım bari “ zaman kaybı “
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bence torpil ve referans ayri iki konu.<br/><br/>ornegin sadece biri referans verdi diye ise alindiysan bu torpil.<br/><br/>biri referans verdi diye bir gorusmeye gittiysen bu torpil degil. yine ayni surece gidiyorsun, sadece biri senin yeteneklerine ve bilgine onay vermis oluyor.
  entry_channels: siyaset
- entry_name: |
