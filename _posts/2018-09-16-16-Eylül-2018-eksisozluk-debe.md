...
- entry_name: |
  ...
  entry_fav_count: 26
  entry_content: |
    söylediklerinizi duyurmak için kimseyi <a class="b" href="/?q=kolundan+tutma">kolundan tutma</a>yın; <br/>çünkü insanlar sizi dinlemeye istekli değilseler, <br/>onları tutacak yerde <a class="b" href="/?q=%c3%a7enenizi+tut">çenenizi tut</a>mak daha hayırlıdır.<br/><br/><a class="b" href="/?q=lord+chesterfield">lord chesterfield</a>
...
- entry_name: |
  ...
  entry_channels: haber
- entry_name: |
    stokçulara baskın yapacağız
  entry_id:  81309962
  entry_writer: 260611
  entry_fav_count: 11
  entry_content: |
    geçen gün ucuza antep fıstığı buldum bir yerde. kendi çapımda stok yaptım akşam evde yerim diye. bu haberi görünce heycanladım, ellerimi başımın üstüne koyup yere yüzüstü yattım bekliyorum.
  entry_channels: siyaset,haber,ekonomi
- entry_name: |
    tinder'da koca arayan 40 yaşındaki kezban
  entry_id:  81321667
  entry_writer: tixanthrope
  entry_fav_count: 10
  entry_content: |
    kendisine profilini, resmini beğenip match olduğu bi adamın yaptığı işi öğrenince (başka bi kriterden değil) unmatch yapması hasebiyle kezban denmektedir ki kendisi kezbanın allahıdır.<br/>profillerinize bohem, marjinal resimleri, cümleleri doldurmakla olmuyo o işler yurdumun kezbanları.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    beşiktaş bu fosil kafalı orta kafa gol şablonunu değiştirmezse etkili olamayacak futbolcu. biz adem’den takımın oyun şablonunu değiştirmesini bekliyoruz. gerçekçi olalım öyle bir dünya yok. adam pas almak için sürekli boşa çıkıyor, geri geliyor, sıkışan adamın yanına koşuyor rahatlatmak için. ama bizimkiler bok var gibi her topu ileri şişiriyor. böyle giderse adem de sikerim deyip maçın içinden izlemeye başlar diğer topçularımız gibi. içimiz şişti bu sıkıcı oyundan. gerçekten yeter artık.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    koskoca felsefi,sosyolojik,siyasi bir akımı, böylesine çamur bir ağızla, seviyesiz insanlara meze ederek tartışmaya ;<br/><br/>gerçekten solcu isen utanmıyor musun?<br/><br/>değilsen utanmıyor musun?
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    seksi bir erkek olmanın getirdiği şuh yalnızlık
  entry_id:  81321573
  entry_writer: kedi canini senin
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=ev+seksisi">ev seksisi</a>)
  entry_channels: anket,ilişkiler
- entry_name: |
    jeremain lens
  entry_id:  81323136
  ...
  entry_fav_count: 0
  entry_content: |
    yok aga bunu boylu poslu at gibi koşuyor kontenjanından topçu yapmışlar da bunda ciddi ciddi zeka geriliği var amk. futbolcu da beyin olacak önce.
  entry_channels: spor
- entry_name: |
