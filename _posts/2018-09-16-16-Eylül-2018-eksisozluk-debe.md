...
- entry_name: |
  ...
  entry_id:  81303712
  entry_writer: genizdengelen
  entry_fav_count: 199
  entry_content: |
    bana daha çok kan uyuşmazlığı gibi göründü.
...
- entry_name: |
    muharrem ince'nin market alışverişi göndermesi
  entry_id:  81318106
  entry_writer: playhard
  entry_fav_count: 72
  entry_content: |
    üstteki yazara istinaden, ince çok iyi olabilir çok kötü de olabilir bildiğim tek bir şey var <br/>eğer seçilseydi şuankinden daha iyi olacaktı. yani asıl sana olan zaten olmuş akp yi başa getirmişsin daha kendine ne yapabilirsin ki?
...
- entry_name: |
  ...
  entry_fav_count: 60
  entry_content: |
    bir de şey var gerçek hayatta kız görünce dili tutulan, iki kelime edemeyen ama sosyal medyada ettiği lafın ölçüsü olmayan türk erkeği.
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    verginin haraç olduğunu düşünen solcu
  entry_id:  81322339
  entry_writer: sonadora
  entry_fav_count: 43
  entry_content: |
    "vergi" ile "haraç" arasındaki ince çizgi, size geri dönüşüdür.<br/><br/>ve evet türkiye'deki "haraç"tır, bunu algılayabilmek için solcu olup olmamanız fark etmez, embesil olmasanız yeter.
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    izmir ev arkadaşı yüksek lisans
  entry_id:  81323237
  entry_writer: onur a
  entry_fav_count: 36
  entry_content: |
    kelimeleri biz mi birleştiriyoruz?
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 34
  entry_content: |
    üniversite mezunlarının aklı selim, rasyonel seçimler yapan, doğruyu bilimle arayan insanlar olduğu düşüncesi gerçek dışı olduğu kadar da tehlikelidir. türkiye'de üniversite mezunlarının çok büyük bir kısmı sünepe, işe yaramaz, okuduğu bölümden çakmayan tiplerdir. bunun yanına anormal sayıda üniversitenin ülkeyi işgal etmiş olduğu gerçeği eklenince durumun ne kadar vahim olduğunu anlamak için herhangi bir salak olmanız yeterli olacaktır.<br/><br/>(bkz: <a class="b" href="/?q=il+ba%c5%9f%c4%b1na+iki+%c3%bcniversite+d%c3%bc%c5%9fmesi">il başına iki üniversite düşmesi</a>)<br/><br/>o "cahil kesim" kendi emeklerine ve ülkelerine karşı seçimler yapıyorsa bunun nedeni okumuşlardır zaten, üniversite mezunlarıdır. esas sorun yüksek okul bitirmemişler değil, yüksek okul bitirip memleketini sikebileceğini zanneden omurgasız hainlerdir. yani yüzlerce senedir hiçbir şey değişmedi, biz hala <a class="b" href="/?q=burjuvazi">burjuvazi</a> ile çatışma halindeyiz. zannediyoruz ki burjuvazinin kışkırttığı köylüler problemimizin kaynağı. hayır. ülkenin buhranlara girip çıkmasının, siyasi çalkantıların, darbelerin, katliamların ve toplumsal paranoyanın ardında hep zenginler ve "servet düşmanısınız" diye ağzını çemkire çemkire bağıran zıbışlar vardı ve bu insanlar modern dünyanın kanserli hücreleri oldular. işin kötü yanı, geçmiş çağların problemlerini de bu şerefsizler yaratıyordu. hiçbir şey değişmedi, sadece cebimize çok ince bilgisayarlar girdi.
...
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    (bkz: <a class="b" href="/?q=hachiko">hachiko</a>) / hachi: a dog's tale<br/>ağladığı tek filmdi.
...
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    (bkz: <a class="b" href="/?q=g%c3%b6rg%c3%bcs%c3%bczl%c3%bck">görgüsüzlük</a>)<br/>(bkz: <a class="b" href="/?q=sonradan+g%c3%b6rme">sonradan görme</a>)<br/>(bkz: <a class="b" href="/?q=vizyonsuzluk">vizyonsuzluk</a>)<br/><br/>bu üç bakınız yeterli olacaktır umarım.
  entry_channels: siyaset
- entry_name: |
    ricardo quaresma
  entry_id:  81323126
  ...
  entry_fav_count: 19
  entry_content: |
    sik aslanım, daha güzel sik anasını maçın. ohh değmesinler keyfine. al topu bi oyana bi buyana çekerek sik maçın anasını. sik ki sana daha çok bağırsınlar "oley oley quaresma oley oley" diye, sik bu takımın anasını çünkü bu takımın taraftarı bu takımın anasını sikildikçe daha da yüksek sesle bağırıyorlar senin adını. sik aslanım, sik bu takımın anasını. sikmekten beter et, sike sike komaya sok. aferin adamım.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    (bkz: <a class="b" href="/?q=david+tennant">david tennant</a>)<br/><br/>üstüne kimseyi tanımam. harika bir adam, harika bir aktör, harika bir doktor.
  entry_channels: anket,ilişkiler
- entry_name: |
    şenol güneş
  entry_id:  81300045
  ...
  entry_fav_count: 18
  entry_content: |
    konu şenol güneş'in fatih terim'den iyi veya kötü olması değil. kimse de kusura bakmasın. adam lig liderine karşı ozan kabak'ı stoper'e monte ediyor. yerinde oynaması gereken kişi 'maicon' adlı yabancı. ve şenol güneş yabancı sınırlamasına isyan ederken kimseyi 1 maç bile yerinden edemiyor abi.<br/><br/>beşiktaş'ın alt yapısı mı yok? halbuki beşiktaş bu ligte iyi alt yapısı ile bilinen bir takım. çıkmıyor mu abi? <br/><br/>bırakın şimdi lobi mobi ayaklarını. lobisi olan adam kebapçıyla kavga etti diye apar topar yollanmaz. onun gerçek sebebini de hepimiz biliyoruz.<br/><br/>beşiktaş taraftarı bu sürreel mantık ile takımını nereye götürdüğünü kestiremiyor. eleştiri iyidir abi. bırakın şenol hocanız da eleştirilsin, fikret forrest'iniz de. eleştiri diri tutar. (edit: salağın biri burda orman olan forest'i kast ettiğim için 'önce ingilizce öğren' diyor. oğlum forest'in yazılışını bilmek için ultra bir ingilizce gerekmiyor. amına koduğumun yerinde telefon diye bişey var, forest yazmak isterken forrest yazmışım, bi akıllı sensin ya ayar verecek. ama bu burada dursun. kendisi milyonluk bir forrest gump zekasına sahip camiaya başkan olmuş madem, ironik olarak kalsın en azından)<br/><br/>bak o galatasaray taraftarı çirkef olmasa bugün dursun başkan, hamza kulübede dengeleri gözetiyordu. az uyanık olun. o hamza ki kovulduğu senenin öncesi en yok zamanda şampiyon yapmıştı. <br/><br/>tudor'un yaptığının yarısı beşiktaş'ta yapsa sizden sökmek için 25 maç geçmesi lazımdı.<br/><br/>edit: abicim fatih terim kusursuz mu bana sanki. sinan ısrarı mesela belki çok puan kaybettirecek. ama cesur cesur. yapısal değişiklikten ve kendini yenilemekten korkmuyor. evet aşırı egoist ama bu egosu biraz göstermelik. misal taraftarı direk dinliyor. egosu yüksek adam sikerim atarınızı der maicon'u 11'de tutmaya devam eder. ama reform yapabiliyor. bir adam 24 yıl önce domine ettiği ligi bugün de domine edebiliyorsa orda bi değişim vardır zaten.<br/><br/>korkmayacaksın abi. korkanın çocuğu olmuyor. real'den 6 yiyen de, taraftarına 4-4 diye bağırtan da aynı adam. çaktın mı?
  entry_channels: spor
- entry_name: |
    tinder kullanmış bir kadınla evlenmek
  entry_id:  81322709
  entry_writer: tutsky yanchek
  entry_fav_count: 17
  entry_content: |
    yorumum yok. <br/>espri yapıp gideceğim.<br/><br/>(bkz: <a class="b" href="/?q=how+i+swiped+your+mother">how i swiped your mother</a>)
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    15 eylül 2018 kadir can turan'ın dayak yemesi
  entry_id:  81322315
  entry_writer: ccigarr
  entry_fav_count: 12
  entry_content: |
    (bkz: <a class="b" href="/?q=esenler+otogar%c4%b1+kim+aq">esenler otogarı kim aq</a>)
  entry_channels: haber
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    (bkz: <a class="b" href="/?q=te%c5%9fbihte+hata+olmaz">teşbihte hata olmaz</a>) <br/>dogrusu benzetme yaparken özenli ol, teşbih hata kaldırmaz anlamında kullanılir.
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    (bkz: <a class="b" href="/?q=et+bal%c4%b1k+kelle+koklan%c4%b1r+bunlar+burunla">et balık kelle koklanır bunlar burunla</a>)<br/><br/>edit: şu an elenen yarışmacıya çok üzüldüm. seyirciyi de kınıyorum.<br/><br/>edit2: çok ilginç bir gün oluyor. şimdi de tolga sünter geldi.
  entry_channels: tv
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    haksızlık yapmamak lazım çiftlik bank, saadet zinciri tarzı yatırımlarda da uzmandır türk insanı <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>.
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    birisinin " artık söylem değil eylem vakti sayın bakanım" demesi gereken kişi.<br/><br/>yolda bulduğun 20 tl 'yi bile teknoloji eğitimine yatırman gerekirken, birileri hâlâ adım başı imam hatip açıyorsa hakiki milli eğitim bakanı kim diye sorgulanır.
  entry_channels: siyaset,eğitim
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    hamilton'un gene vettel'i döve döve pole pozisyonunu aldığı bir sıralama turuna sahne olan yarış. <br/><br/>bu sezon hamilton sadece vettel'i mahvetmekle kalmadı, muhteşem performansı ve istikrarı ile ferrari fanlarının vettel'e olan güvenini de sıfırladı. vettel kontrat bitimine kadar mucize yaratamazsa ferrari'nin vettel yerine arayışlara girmesi gerekir.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    ev yapımı birası olan hanımlar yeşillendirebilir. <br/><a rel="nofollow noopener" class="url" target="_blank" href="https://connected2.me/escap">https://connected2.me/escap</a>
  entry_channels: anket,yeme-içme
- entry_name: |
    adem ljajic
  entry_id:  81323718
  ...
  entry_fav_count: 1
  entry_content: |
    beşiktaş'lı bazı futbolcuların malatya maçında pas atmadığı futbolcu. sizi şımartanı skmk lazım da neyse.
  entry_channels: spor
- entry_name: |
    roma döneminden kalan kaleye pvc pencere takmak
  entry_id:  81300370
  entry_writer: yada oyle demesek mi
  entry_fav_count: 0
  entry_content: |
    elleri değmişken zemini de keşke parke yapsalardı dedirten olaydır. uzmanları yokmuş, öyle bir açıklama da yapmışlar üstelik. 1500 yıllık kaleye pimapen takmamak için uzman bilgisine ihtiyaç duyuyorlar demek ki.
  entry_channels: sanat,tarih,haber
- entry_name: |
    ekşi sözlük iş ağı
  entry_id:  81319908
  entry_writer: kaypsehir
  entry_fav_count: 0
  entry_content: |
    yukarıda yazan arkadasa ek olarak ben de ankarada öğrenciyim, part time is verebilecek olanlar yesillendirirse ben de sevinirim.
