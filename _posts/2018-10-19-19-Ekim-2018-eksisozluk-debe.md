...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    gözaltı kararını <a class="b" href="/?q=hakim">hakim</a> vermez, <a class="b" href="/?q=savc%c4%b1">savcı</a> verir. hele hele ağır ceza mahkemesi başkanı hiç vermez.<br/>mesnetsiz iddia.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    özgüven kazanılan bir şeydir.<br/><br/>ego kazanılmadan hava atılan şeydir.<br/><br/>ego elinde olmayan bir şeyin gösterişidir, özgüven kendinde geliştirdiğin bir aposterioridir.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=qGVS_Ugb92c&amp;app=desktop" title="https://www.youtube.com/watch?v=qGVS_Ugb92c&amp;app=desktop">evgeny grinko-jane maryam</a><br/><br/>sağ tıklayıp döngüye alıyorsunuz efendim, içinize müthiş bir huzur doluyor :)
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    izleyenlerin acil bir iq testi yaptırması gereken dizi. tehlikeli boyutlarda olabilir. yalnız devlet yardımları yapılıyor sizin için galiba.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    işe yarayıp yaramadığı hakkında aklında sorusu olanlar için<br/>1 haftadır çalışıyorum <a class="b" href="/?q=ek%c5%9fi+s%c3%b6zl%c3%bck+i%c5%9f+a%c4%9f%c4%b1">ekşi sözlük iş ağı</a> sağ olsun.
