...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    ekrem imamoğlu'nun bana sen demesi
  entry_id:  91229453
  entry_writer: shyspy
  entry_fav_count: 254
  entry_content: |
    içerik okumadan yorum yapan yazarları ortaya çıkaran ironi yazılardan biri.
...
- entry_name: |
    sol şeritte yavaş gidenler terör örgütü
  entry_id:  91235155
  entry_writer: germe beni germe
  entry_fav_count: 19
  entry_content: |
    ekseriyetle deneyimsiz veya öküz şoförlerdir, kasten yaptığını düşündüklerim de mevcuttur. <br/><br/>sol şerit seyir şeridi değil, sollama şerididir. sollamanı bitirince sağa geçeceksin kural budur. trafik sağdan akar. bak tek cümle trafik kuralı tamam mı, o kadar da zor bir şey değil.<br/><br/>ekleme: hız sınırlarına riayet eden şoförler doğrusunu yapmaktadırlar, ama hız yapan şoförlere fiziki müdahele hakları yoktur; zirâ kendileri trafik polisi değillerdir. dolayısıyla hız yapan adamın önüne kırmak, fren yapıp yavaşlatmak da hız yapmak kadar trafik suçudur.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  91209297
  entry_writer: forum donanim haber olucusu
  entry_fav_count: 7
  entry_content: |
    bi kere bu tip işler sektör mühendislik sektörü olmaz. daha çok ekonomi/finans/bankacılık sektöründe olur iş öğretme oda borsa sektöründe. <br/><br/>eğer sen bana bu cümleyi wall street'te yıllık kazancı 1m $ olan bir tacir olarak deseydin:bırak asgari ücreti ben sana para verirdim işi öğretmen için. <br/><br/>ama kusura bakma sikik fason üretimi yapan bi sektörde kimse az paraya çalışmaz. çünkü gelecek vaad etmiyor. <br/><br/>bu yüzden bugün gidin bakın mühendislik çıkışlı kişilerin biraz eli yüzü düzgün olan kişiler banka sınavlarına giriyor. <br/><br/>haa sonra dersin ''bu kadar eğitiyoruz sonra başka firmalara kaptırıyoruz'' diye. <br/>bu ülkede özel sektörde çalışanların %60 akşamları vakitlerini kariyer sitelerinde başka firmalrın iş ilanlarına bakmak/incelemekle geçiyor.
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    canan kaftancıoğlu'nun el açıp dua etmesi
  entry_id:  91234516
  entry_writer: yamuk
  entry_fav_count: 3
  entry_content: |
    canan kaftancınoğlu'nun neye inananıp neye inanmadığı zaten kimsenin sikinde değil. ancak işinize gelmeyen herkese din tüccarı deyip, kendi kafanızdan olana size ne amcık dersen, o amcık sen olursun.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  91210065
  entry_writer: verderveremen
  entry_fav_count: 1
  entry_content: |
    umarım tez zamanda şifa bulursunuz. geçmiş olsun.
