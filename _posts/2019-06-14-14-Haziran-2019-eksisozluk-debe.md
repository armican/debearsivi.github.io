...
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    bazı orospu çocuklarını tanımlamaya kelimeler yetmiyor.<br/><br/>ben ruhum acımadan o fotoğrafa bakamıyorum bile lan. o yazıyı nasıl yazabildin?
  entry_channels: 
- entry_name: |
  ...
  entry_channels: anket,edebiyat
- entry_name: |
    mhp'li vekilin aşırı ırkçı suriyeli açıklaması
  entry_id:  91241683
  entry_writer: mezariserif
  entry_fav_count: 18
  entry_content: |
    "lan yarr$#½, bunları getiren adamlarla neden ittifak kurdun o zaman?" diye sormazlar mı be adama, baki'ciğim?
  entry_channels: 
- entry_name: |
    ekşi itiraf
  entry_id:  91210512
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    benim duyduğum en enteresan istek şu şekilde vuku buldu;<br/><br/>" yirmi metre sonra inebilir miyim..!!! " dedi adamın biri.<br/><br/>şöför kapıyı açtı , "abi 22 metre oldu ayarlayamadım idare et " dedi. <sup class="ab"><a title="(bkz: swf)" href="/?q=swf" data-query="swf">*</a></sup>
...
- entry_name: |
  ...
  entry_id:  91211774
  entry_writer: askmesk
  entry_fav_count: 11
  entry_content: |
    kardeşime harçlık vermiştim. o da 10 sene sonra doğumgünümde verdiğim parayı çerçeveletip bana hediye etti...
  entry_channels: anket,ekonomi
- entry_name: |
    porno yıldızlarının çirkin olması
  entry_id:  91240873
  entry_writer: swollenmember
  entry_fav_count: 9
  entry_content: |
    katılmadığım durum.<br/>bence gayet güzeller.<br/><br/>ee n'oldu şimdi, sen evet dedin ben hayır dedim ve anlamsızca bi süre bakıştık. <br/>bu başlığı açmaya değdi mi, bence değmedi. çünkü son derece subjektif bir durum.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    söyle de biz de bilelim. rezil edelim onu. ekşi sözlükte yazar olmanın şanına yakışır sekilde linç edelim.<br/>bir daha yeltenmesin. haddini bilsin herkes <br/>bak nasıl sinirlendim ya
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    perde asmak. sadece en nefret ettiğim ev işi değil tüm hayatım boyunca en nefret ettiğim şey olmuştur.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    tatile gidip ayağının fotoğrafını çeken kız
  entry_id:  91241638
  entry_writer: camel icen deve
  entry_fav_count: 4
  entry_content: |
    "kavrulurum yaz sıcağında, hunharca zıplarım kucağında, doya doya asıl aslanım, tüy bile yok bacağımda" mesajını verip, 31ci asosyallerin gününü şenlendiren kızdır, instadan takip edilesidir.
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    hatun diyen adamların kuzenidirler.
  entry_channels: ilişkiler
- entry_name: |
    şu anda çalan şarkı
  entry_id:  91209896
  entry_writer: laurusnobiliss
  entry_fav_count: 3
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/UUQDNHGfJIo" title="https://youtu.be/UUQDNHGfJIo">teoman - uçurtmalar</a>
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    yoldayım mesaj bekliyorum biraz sıkıcı bir gece.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    birinci yaşı kapsamında ülkenin dört bir yanında kurduğu arkadaşlık ağlarıyla birlikte art arda zirveler düzenleyecek olan gruptur.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=suriyelilerin+eczane+a%c3%a7mas%c4%b1">suriyelilerin eczane açması</a>)
  entry_channels: ekonomi
- entry_name: |
    sevişmelik arkadaş veritabanı
  entry_id:  91242654
  entry_writer: hitrock
  entry_fav_count: 0
  entry_content: |
    abazalıkların ve koflukların kaydedildiği veritabanı.
  entry_channels: ilişkiler
---
