...
- entry_name: |
  ...
  entry_id:  91218881
  entry_writer: isyankar muhasebeci
  entry_fav_count: 13
  entry_content: |
    numan: hadi biz gidiyoruz mükremin. biz kaplıcadayken dükkan sana emanet. <br/><br/>- mükremin: hiç merak etme numan amca, gözün arkada kalmasın. zira gözlerin sana orada lazım olacak. feriştah yengeyi kontrol bakımından.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    rakı masası kutsayıcıları. bu tipler masadaki her hareketinize karışıp "rakı sofrası adabı" dersleri vermeye kalkar ve bütün akşam buzun şeklinden mezelerin sırasına kadar kafa siker. içkiyi muhabbeti tatlandıran bir araç olmaktan çıkarıp masanın efendisi haline getirenleri çağırmamalı.
  entry_channels: anket,yeme-içme
- entry_name: |
