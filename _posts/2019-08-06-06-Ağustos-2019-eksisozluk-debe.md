...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    van tıp mezununun boun mezunundan fazla kazanması
  entry_id:  93510917
  entry_writer: oculomotorius
  entry_fav_count: 126
  entry_content: |
    klasik bir olmamış insan sezenişi. ister boun mezunu ol ister bonn; nato kafa nato mermer.<br/><br/>kazandığınız paranın az olmasından değil, başka bir x kişisinin kendinizden fazla kazandığı için hayıflanıyorsanız arkadaşlar bilin ki: tam olarak hak ettiğiniz parayı kazanıyorsunuz. bunu bir doktor olarak söylemiyorum. size doktorluğun zorluğundan vs de bahsetmeyeceğim. o doktor arkadaşın da hak ettiğinin altında maaş almasından vs.<br/><br/>bir öğretmenden bahsedelim mesela. her tatil dönemlerinde kudurduğunuz, aldığı maaş gözünüze gelen öğretmenlerden.<br/><br/>ben onların da çok daha fazla maaş almasını istiyorum çünkü. insan yetiştiren insanlardan bahsediyoruz çünkü. bir nesil yetiştiren insanların para peşinde koştuğu bir ülke asla ilerleyemez çünkü.<br/><br/>hayatını insanların hayatlarına, dertlerine adamış insanların da hakeza<br/><br/>öğretmenler, doktorlar vs vs şu kadar kazanıyor, şöyle kazanıyor böyle kazanıyor diye hayıflanacağınıza<br/><br/>bu ülkede neden insanlar açlık sınırında yaşıyor, <br/><br/>bu ülkede eğitimli insanlar neden asla değer görmüyor,<br/><br/>bizler neden hiçbir şekilde hak ettiğimiz hayatı yaşayamıyoruz, <br/><br/>biz bu kadar çalışırken çalıştığımızın karşılığını alamıyorsak bu para kimlerin cebine gidiyor,<br/><br/>gibi soruları soramıyorsan dostum:<br/><br/>öss'de kaçıncı olmuşsun, ne tercih yapıp ne olmuşsun, hangi üniversiteden mezunsun bunlar tamamen teferruat<br/><br/>zira sadece sürüdeki bir başka çomar olmaktan ileri gidememişsin ne yazık ki<br/><br/>üzgünüm.<br/><br/>senin emeklerin her zaman birilerinin bikaç bin dolarlık çantalarının, arabalarının, saraylarının bir parçası olmaya mahkum olacak.
...
- entry_name: |
  ...
  entry_id:  93511292
  entry_writer: wes flocon
  entry_fav_count: 55
  entry_content: |
    (bkz: <a class="b" href="/?q=memleketinde+ya%c5%9famama+vergisi">memleketinde yaşamama vergisi</a>)<br/>nüfusa kayıtlı olduğu yerin dışında yaşayanlardan alınabilecek vergi.<br/>detaylar için <a rel="nofollow noopener" class="url" target="_blank" href="https://www.drdatastats.com/herkes-kendi-memleketinde-yasasaydi-illerin-nufusu-ne-olurdu-haritasi-2018-yili/" title="https://www.drdatastats.com/herkes-kendi-memleketinde-yasasaydi-illerin-nufusu-ne-olurdu-haritasi-2018-yili/">şu istatistiklere</a> bakılabilir.<br/>yandınız olm urfalılar, gonyalılar, diyarbakırlılar...
...
- entry_name: |
  ...
  entry_fav_count: 24
  entry_content: |
    bir entari vardı aylar belki de yıllar öncesinde. bir seçim sonrası akp konvoyları/kutlamaları başlığında uzuun uzun yazmıştı bir yazar maddi durumunu. özetle demişti ki ulan beni paranın durumu ülkenin ekonomisinin iyi olması senin kadar etkilemiyo şimdi gelmiş nasıl kazandık ama çekiyosun. senin iyiliğini düşünüyorum senin için çektiğimiz cefa vs vs demişti. hah. hatırladınız o entry'yi dimi. ben unutmuyorum. biraz daha canlarının acımasını bekleyin.<br/><br/>edit: imladır<br/>edit2:entry'yi bulursam editleyeceğim.
...
- entry_name: |
    behzat ç.
  entry_id:  93521765
  entry_writer: filteke
  entry_fav_count: 8
  entry_content: |
    40 dakika cok kisa, tam anlayamiyoruz, dogallik yok bir behzatin abisi bir de basgan ayni performansi veriyor digerleri yerlerde
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    savaşa mı gidiyorsunuz, konar göçer misiniz, ablalarım bunlar nedir.
  entry_channels: anket,ilişkiler
- entry_name: |
    ekşi itiraf
  entry_id:  93516932
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    tüh iptal edilmiş. hebele gubele vak vak vak hareketlerini izlemeyeceğiz demek artık.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    6 sayfa avukat yazılmış. içim rahatladı, mission completed. bir gün doktor ve pilotları tahtından indireceğiz.
  entry_channels: anket,ilişkiler
- entry_name: |
    insanı çocukluğuna götüren tatlar
  entry_id:  93516088
  entry_writer: sansasyoner
  entry_fav_count: 0
  entry_content: |
    algida max. veya panda sticksin muzlu olanı
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=yol">yol</a>) <br/>(bkz: <a class="b" href="/?q=mustafa+hakk%c4%b1nda+hersey">mustafa hakkında hersey</a>) <br/>(bkz: <a class="b" href="/?q=babam+ve+o%c4%9flum">babam ve oğlum</a>) <br/>(bkz: <a class="b" href="/?q=a%c5%9fk+filmlerinin+unutulmaz+y%c3%b6netmeni">aşk filmlerinin unutulmaz yönetmeni</a>) <br/>(bkz: <a class="b" href="/?q=kibar+feyzo">kibar feyzo</a>)
  entry_channels: sinema
- entry_name: |
    atatürk'ün gay olduğu iması yapılan kapak tasarımı
  entry_id:  93552383
  entry_writer: siyahkotlu
  entry_fav_count: 0
  entry_content: |
    ultra çomar, yapacağın analize tüküreyim senin.
  entry_channels: 
---
