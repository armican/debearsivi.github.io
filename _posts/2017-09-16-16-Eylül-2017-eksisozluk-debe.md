...
- entry_name: |
  ...
  entry_fav_count: 40
  entry_content: |
    sevil adında bir müşterim vardı.oldukça başarılı tasarımları olduğundan konu estetik anlayışından açıldı ve sanata geldı ben bu ikilemi ona sorduğum sırada ince sigarasının filtresini ağır nefeslerle ıslak dudaklarındaki rujla kırmızıya boyamaktaydı..cevap vermeden önce , sigarasını üflediği son dumanla eş zamanlı kırmızı dudaklarından, kırmızı hojeli tırnaklarının arasına aldı ve küllüğe sapladı "sanat sanat ya da halk için değil,sanat seks içindir" dedi.<br/>o an saplanan tek şey sigara değildi.ama ticari ahlakımız var müşteri sikilmez sevilir hele birde adı sevilse...<br/><br/>neyse...6 ay sonra..<br/>sevilin iki tane çeki vardı ikisi de elimde patladı.telefonlarımı açmıyor.<br/>binaenaleyh sevil beni sikti, çok sanatsal sikti.(bkz: <a class="b" href="/?q=sanat+seks+i%c3%a7indir">sanat seks içindir</a>)(bkz: <a class="b" href="/?q=empirizm">empirizm</a>)
- entry_name: |
...
- entry_name: |
    roma pers savaşı ve ateist hezeyanı
  entry_id:  70823837
  entry_writer: return of the kedi
  entry_fav_count: 6
  entry_content: |
    (bkz: <a class="b" href="/?q=harry+potter+ve+z%c3%bcmr%c3%bcd%c3%bcanka+yolda%c5%9fl%c4%b1%c4%9f%c4%b1">harry potter ve zümrüdüanka yoldaşlığı</a>)
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    arkadaşlar sizin kafanız güzel mi ?<br/><br/>- biz barzani bayrağını zaten havaalanına asmadık mı ?<br/>- ırak hükümetinden bağımsız olarak bunlarla ilişkileri geliştirmedik mi ?<br/>- adama devlet başkanı muamelesi çekmedik mi ?<br/>-kürdistan bayrağının kuzey ırak dışında tek dalgalandığı ülke biz olmadık mı ? <a rel="nofollow noopener" class="url" target="_blank" href="http://www.yenicaggazetesi.com.tr/ataturk-havalimanina-kurdistan-pacavrasi-157887h.htm" title="http://www.yenicaggazetesi.com.tr/ataturk-havalimanina-kurdistan-pacavrasi-157887h.htm">havalimanında bayrak olayı</a><br/><br/>yani biz bunları referandum bile yapmadan bağımsız bir devlet olarak tanıdık zaten. şimdi milliyetçilerin gazını almak için sert bir açıklama yapılır. ardından gündemi değiştirmek için bir muhalif tutuklanır , unutulur gider. bop projesi tüm hızıyla sürüyor, kerizliğin lüzumu yok.
- entry_name: |
...
- entry_name: |
    the red pill
  entry_id:  70824621
  entry_writer: mavimikirmizimi
  entry_fav_count: 2
  entry_content: |
    sırf erkekler arasında tartışılabilen bir şey olsa erkeklerin çoğu bunu destekler. ve erkekler kendi aralarında yaptıkları konsensüse göre kadınlara karşı böyle hareket etse kadınlar da bunu destekler. ama şartlar böyle değil. bir kız "o öyle diil taam mı?" diyor ve erkekler de "beyler ortamda kız var, lütfen!" diyip ona göre pozisyonunu değiştiriyor.
- entry_name: |
...
- entry_name: |
    çiçek almayan sevgili
  entry_id:  70824629
  entry_writer: retronology
  entry_fav_count: 1
  entry_content: |
    "ben seni kırdımsa çiçek, <br/>bütün dünya da beni kırsın."<br/><br/>sizi kırmasın yeter o sevgili, çiçek almasa da olur.
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    selam beyler adım bogdan mekanın sahibiyim..
- entry_name: |
