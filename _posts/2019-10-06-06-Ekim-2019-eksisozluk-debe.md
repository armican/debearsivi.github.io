...
- entry_name: |
  ...
  entry_fav_count: 89
  entry_content: |
    -vslm mi?<br/>+ne?<br/>-svslm mi?<br/>+ne diyosun ya?<br/>-gizlice diyorum svşlm mi diyorum
...
- entry_name: |
  ...
  entry_fav_count: 49
  entry_content: |
    olm siz nasıl bir denyosunuz lan?<br/><br/>istiklal marşındaki kelime sayısını bilmiyor diye millet birbirini gömüyor.<br/><br/>cidden gerizekalı kaynıyor sözlük. ben de diyorum ki; "gençliğe hitabede kaç tane a harfi olduğunu bilmeyen bu ülkede yaşamasın"<br/><br/>ulan gerçekten gerizekalısınız. gerçekten bak.
  entry_channels: tv
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  96156812
  entry_writer: prosesor
  entry_fav_count: 22
  entry_content: |
    huzurla uyumaktır. başka türlü mümkün olmuyor zira.
...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    kadroda sene başından bu yana orta sahada forma giydiğinde beklenmediği kadar iyi performans gösteren <a class="b" href="/?q=%c3%b6mer+bayram">ömer bayram</a> varken, futbolla ne mental ne de fiziksel anlamda alakası kalmamış <a class="b" href="/?q=sel%c3%a7uk+inan">selçuk inan</a> ilk 11 olarak oynuyorsa hiç kimse bana fatih terim'in adil olarak forma dağıttını söylemesin. <br/><br/>yaptığı futbola ve takıma ihanettir. inanılır gibi değil...<br/><br/>tanım; adaleti olmayan antrenör...
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    sanattır dostum, hem de garip bir sanattır. herkesin baktığı şeye bakıp, herkesin kullanabildiği bir aleti kullanıp, herkesten farklı bir şey görür, gösterirler. <br/><br/>aklıma serdar reis geldi. 8 notadan ne kadar farklı şarkı yapılabilir felan demişti herhalde.<br/><br/>edit:(bkz: <a class="b" href="/?q=topu+topu+7+nota+var+ka%c3%a7+ayr%c4%b1+beste+yap%c4%b1labilir+ki">topu topu 7 nota var kaç ayrı beste yapılabilir ki</a>) demiş.
...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    gs berbat oynadi ama kunde atti adam nerdeyse, onu da bir zahmet var'a bak be hakem.
  entry_channels: spor
- entry_name: |
    younes belhanda
  entry_id:  96183751
  ...
  entry_channels: spor
- entry_name: |
    futbolda bahis şikesi
  entry_id:  96192408
  entry_writer: metal69
  entry_fav_count: 16
  entry_content: |
    fenerbahçe 0-1 antalya<br/>gençlerbirliği 0-0 galatasaray<br/><br/>malatya 5-1 denizli<br/>kasımpaşa 1-4 konya<br/>göztepe 4-0 kayseri <br/><br/>heyt yavrum heyt. <br/><br/>artık gözle görülür bir seviyeye gelmiş olan şike olayları.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    sevgilisi olan insanların %90’ından daha mutlu ve daha özgür olan insandır
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
    abd'nin bahçeli'yi öldürme ihtimali
  entry_id:  96191311
  entry_writer: hayatinseyirdefteri
  entry_fav_count: 12
  entry_content: |
    (bkz: <a class="b" href="/?q=bigpicture.jpeg">bigpicture.jpeg</a>)
  entry_channels: siyaset
- entry_name: |
    gençlerbirliği naçında feghouli'nin kurşunlanması
  entry_id:  96194758
  entry_writer: civilate
  entry_fav_count: 6
  entry_content: |
    bir ara sabah programinda sabri amca vardi. allah diyerek birkac parende atmisti. yasiyorsa allah selamet versin:)
  entry_channels: spor
- entry_name: |
    aydın'da babasının penisini kesip kaçan genç
  entry_id:  96195617
  entry_writer: hekatecc
  entry_fav_count: 6
  entry_content: |
    (bkz: <a class="b" href="/?q=oedipus+kompleksi">oedipus kompleksi</a>) <br/><br/>(bkz: <a class="b" href="/?q=kastrasyon+korkusu">kastrasyon korkusu</a>)<br/><br/>şöyle bir vakada freud'u anmadan geçmek olmaz.
  entry_channels: sağlık,haber
- entry_name: |
    abd büyükelçiliği'nin fetöcü tweet'ini beğenmesi
  entry_id:  96193370
  entry_writer: 0 5 ucu olan adam
  entry_fav_count: 6
  entry_content: |
    ergun babahan'ın azılı bir fetöcü firari olduğu bilmeyen cahillere normal gelen olay.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    “türk gazetelerindeki tek doğru şey, <br/>günün tarihidir.”
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    şu an metrobüste yanımda nişanlı bir çift oturuyor.<br/><br/>çocuk 25, kız 21-22 yaşlarında.<br/>ikisininde sağ parmağında yüzük var.<br/><br/>çocuğun telefonunun arka planında hanımının fotoğrafı var.<br/>eli yüzü düzgün bir çocuk.<br/>hanımıda, efendi ve sakin bir tip.<br/>hanım hanımcık olduğu her halinden belli.<br/><br/>bir poşete elbiselerini koymuş çocuk. muhtemelen işe gidecek.<br/>hanım kızda çalıştığından falan bahsetti.<br/>kısaca ikiside maaşlı çalışan.<br/><br/>sohbet ettiler, gülüştüler, metrobüste bile mutlular.<br/>çocuğun arabası yok, havalı elbiseleri yok, telefonu ıphone bile değil.<br/><br/>şu an telefonu çıkarmış bir kulaklıkla video izliyorlar.<br/>kulağın biri çocukta diğeri kızda.<br/><br/>bir elinde çubuk kraker öyle sessizce metrobüste video izliyorlar.<br/><br/>mutluluk bu kadar basit işte, o arayıp bulamadığınız mutluluk, maddelerde aradığınız mutluluk ; işte, metrobüs köşelerinde yaşanıyor.<br/><br/>mutluluk sahip olduğun şeylerde saklı.<br/>mutluluk dışarda değil kendi içinde.<br/><br/>ben yaşça ikisindende büyüğüm.<br/>benim arabam var.<br/>belki ikisindende fazla para kazanıyorum.<br/><br/>sor bi lan ! <br/><br/>acaba ikisi kadar mutlu muyum?<br/><br/>düğününüz ne zaman bilmiyorum, ama siz mutlu olmayı çoktan başarmışsınız la.<br/><br/>olurda bu entryi okursanız göbekli abiniz size bir ömür boyu mutluluklar diler.
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    kotu yıkamadan apış arası kokusunu gidermek
  entry_id:  96194240
  entry_writer: bendebiseydiycem
  entry_fav_count: 3
  entry_content: |
    1-) bim veya a101'e gidin<br/>2-) ucuz bir deodorant alın -misal; axe-<br/>3-) kot pantolonu giyin<br/>4-) ayna karşısında dizlerinizi yana doğru hafif kırarak parantez şekli oluşturun<br/>5-) tam apış arasına deodorant'ı basın<br/>6-) afiyetle evden çıkın<br/><br/>ya da<br/><br/>bir kotu on beş gün giymeyin üç günde bir değişin hafta sonu çamaşır yıkayın. azıcık medeniyetten zarar gelmez.
  entry_channels: 
- entry_name: |
    halil umut meler
  entry_id:  96187412
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    ototerapi yap güzel kardeşim. yalnızsan bundan iyi fırsat olmaz. kendine sorular sor, kendine dürüstçe cevap ver. bunu sesli biçimde yap. en kötü ne olabilir, sorusunun cevabını didik didik et. biz onları sesli dile getirene kadar zihnimizde parazit gibi yaşayan bazı işlevsiz düşüncelerin farkına varamıyoruz. ve işte o faydasız düşünceler bizi ruhsal çalkantılara, olumsuz duygulara sevk edip var olan bir sorunu olduğundan fazla algılamamıza sebep oluyor. o yüzden neden böyle hissediyorum diye başlayarak sesli biçimde kendinle konuşman iyi gelebilir. kimseyi kalbinizdeki bulantıları, zihninizdeki karışıklığı dinlemesi için zorlamayın, kimseyi lütfedip de size zaman ayırıyormuş pozisyonuna sokma haksızlığınızı kendinize yapmayın. kuyunun en dibine düşmüşsünüz ve tek çareniz birilerinin oradan geçmesi, aşağıya bir yardım ipi sallandırıp sizi oradan çıkarmasıymış gibi bir hisse kapılabilirsiniz. "gecenin en karanlık olduğu an; şafağa en yakın olduğu andır" hesabı, bu aslında o sıkıntılı eşikten geçip gitmekte olduğunuzun işaret fişeği olabilir.
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    yataktayım. kaloriferi sonuna kadar açtım, odam hamam gibi oldu. sıcağın içime işlemesini bekliyorum.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
    arda ayten
  entry_id:  96196159
  entry_writer: sonsavasci
  entry_fav_count: 0
  entry_content: |
    başarısız bir pr çalışmasının baş rolü. amacına da ulaştı.
  entry_channels: tv,magazin
- entry_name: |
    6 ekim 2019 beşiktaş aytemiz alanyaspor maçı
  entry_id:  96194606
  entry_writer: nickyokidareet
  entry_fav_count: 0
  entry_content: |
    abdullah hocamızın çıkış maçı (beşiktaş'tan)
  entry_channels: spor
---
