...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    5 ekim 2019 istanbul yağmuru
  entry_id:  96159342
  entry_writer: theformulaxx
  entry_fav_count: 101
  entry_content: |
    ulan deprem psikolojisinin üstüne gök gürültüsü de cila gibi ağzıma sıçtı gece vakti.<br/><br/>konum tabii ki avcılar. nereden geldik buraya anlamadım ki. bi çığ düşmedi amk.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    1 katrilyon dolarla yapılabilecekler
  entry_id:  96161828
  entry_writer: okuram kalem yazmaz
  entry_fav_count: 43
  entry_content: |
    evde yemek yapmazdım her gün dışarıdan sipariş verirdim.
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    fragmani cikmis. bu seri nasil 6 oldu ki ya?! türk sinemasi yerlerde sürünüyor. demek talep var ki izleniyor. yazik!<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=BPXtVB2Qp-4">https://www.youtube.com/watch?v=bpxtvb2qp-4</a>
...
- entry_name: |
  ...
  entry_id:  96160794
  entry_writer: sonkovboy
  entry_fav_count: 5
  entry_content: |
    maşallah herkes jöh c timi... beyler fazla önemsemeyin kendinizi hepimizi piyade yaparlar patır kütür leblebi gibi dökülürüz en önde... bir de strateji belirlerim diyen var amk sanırsın genelkurmay harekat başkanı.
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    kalori falan umursamadan patates kızartması yiyebilmek.
  entry_channels: 
- entry_name: |
    5 ekim 2019 galatasaray'a verilmeyen kırmızı kart
  entry_id:  96188512
  entry_writer: laz goril
  entry_fav_count: 4
  entry_content: |
    bence yumruk yiyene sarı kart verilmeli. yumruk gelmiş sırtına hala gidiyorsun hırbo kendini atıp kıvransana anca öyle verirler kırmızı
  entry_channels: spor
- entry_name: |
    selçuk inan
  entry_id:  96188188
...
- entry_name: |
  ...
  entry_id:  96155518
  entry_writer: elektrinist
  entry_fav_count: 1
  entry_content: |
    kral boy egoya sahip olduğunu düşünen mülayim, mutevazi bir tip.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    <a class="b" href="/?q=ara+g%c3%bcler">ara güler</a> ile arkadaşlığım yok fakat takip edenler bilir kendisine göre fotoğraf bir sanat dalı değildir.<br/>ustadan iyi bilemeyeceğimi düşünmekle beraber bazen bazı fotoğraflar o kadar etkileyici oluyor ki onun bir sanat eseri olduğunu düşünüyorum.<br/>hep aklıma takılır...<br/>siz bir fotoğraf çekiyorsunuz. içerisinde etkileyici bir kadın var ve sert bakışlarla size bakıyor. şimdi sanat olur mu onun görüntüsünü sabitlemek? yoksa sanat eseri olarak değerlendirilmesi gereken, fotoğraftan daha çok öne çıkan ve bir sanat eseri kadar cesur bakışlarla sahip kadının ta kendisi midir?
