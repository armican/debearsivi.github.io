...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    bu performansla devam ederse galatasaray'ın bu sezonki kahramanı olabilir.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    <a class="b" href="/?q=kan%c4%b1m+kaynamaya+ba%c5%9flad%c4%b1+pezevenge">kanım kaynamaya başladı pezevenge</a> loading %5.........
- entry_name: |
