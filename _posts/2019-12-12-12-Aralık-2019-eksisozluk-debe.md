...
- entry_name: |
  ...
  entry_fav_count: 143
  entry_content: |
    dedenin sözlerinde hiçbir hakaret olmamasına rağmen beni alın zindana atın diye belirtme gereği duyuyor. adalet yok, korku var, kayırma var artık. çok yazık.
...
- entry_name: |
  ...
  entry_fav_count: 35
  entry_content: |
    takım disiplininden kopmazsak en fazla 4 yeriz.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    hindi füme salam görünce veya kokusunu alınca ruhunu teslim ediyor. <br/><br/>en sevdiği şey.
  entry_channels: anket,yeme-içme
- entry_name: |
    ali palabıyık
  entry_id:  98966045
  ...
  entry_fav_count: 6
  entry_content: |
    bu hakemin aziz yıldırım döneminden beridir fenerin ne zaman kritik bir maçı olsa o maça atanması durumu bu hafta yine yaşandı. sivas-fener maçına atanmış. <br/><br/>her maçında mutlaka fener lehine bariz oyuna yön verir ama ne hikmetse basında hiç tartışılmaz. fener maçlarının dışında bariz hatalar yaptığı dönemlerde de gündeme oturmasıyla unutulması bir olur. ne hikmetse spor müdürlerinin ekseriyetinin fenerbahçeli olduğu ülkemizde hiç şaşırılacak bir durum da değildir. misal özellikle fenerbahçe aleyhine hata yapan hakemlere standart üslubunun dışına çıkıp çok ağır eleştiriler yapan rıdvan dilmen bu hakemi hep övmüştür. zira fırat aydunusu da. fırat aydunusun da pek farkı yoktur. <br/><br/>ali palabıyıkın ilk pr çalışmasını bizzat aziz yıldırım bi canlı yayında yapmıştı. hakemleri eleştirirken "genç pırıl pırıl hakemlerimiz var artık onlara şans verilmeli. ali palabıyık var mete kalkavan var" şeklinde bir demeci olmuştu. bazılarınız hatırlar. kısacası bir fenerbahçe projesidir. hayırlı işler.
  entry_channels: spor
- entry_name: |
    dindar nesil mühendisliği tutmadı
  entry_id:  98981677
  entry_writer: peyamisafa
  entry_fav_count: 4
  entry_content: |
    konda genel müdürü ağırdır'ın ifade ettiği gerçek.<br/><br/>konda genel müdürü bekir ağırdır, 2008-2018 yılları arasında gençlerle ilgili yapılan araştırmaları referans göstererek “ak parti’nin ‘dindar nesil yetiştirme çabalarının boşa çıktığını, oruç tutup namaz kılan kişilerin sayısının yıllar içerisinde düştüğünü” söyledi.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.independentturkish.com/node/102616/haber/konda-genel-müdürü-ağırdır-dindar-nesil-mühendisliği-tutmadı-oruç-tutan-namaz" title="https://www.independentturkish.com/node/102616/haber/konda-genel-müdürü-ağırdır-dindar-nesil-mühendisliği-tutmadı-oruç-tutan-namaz">detaylar tam da burada</a>
  entry_channels: siyaset,haber
- entry_name: |
    ekşi itiraf
  entry_id:  98959618
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    bbg evi gibi değil mi yaa <sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup> takipçi var kim olduğu belli değil.
  entry_channels: ekşi-sözlük
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    oto muayene isinde 11. senesine girmis biri olarak diyebilirim ki, clio aliyorsaniz ya cok paraniz vardir ya da cok az.<br/><br/>orta halli biriyseniz 2001'den sonra 6. nesil 2002-2008 arasinda üretilen kasayi düsünmeden alin derim. 1.4 tdci 300küsür bini deviren dizeline de denk geldim, 150ps'lik st olanina da.. bence bu klasmandaki dayaniklilik konusunda fiyat/performans canavari kesinlikle fiestadir. bak ayni seyi focus ve mondeo icin söylemem misal.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  98982772
  entry_writer: cok gezen adam
  entry_fav_count: 0
  entry_content: |
    yanlış biliyor olabilirim ama abd hükümetinin senatodan geçen herşeyi uygulamak gibi bir mecburiyeti yok. bu yaptırımların senatodan geçeceği uzun zamandır söyleniyordu dolayısıyla piyasalar çoktan alıp sattı bu yüzden ben ekonomide ani bir şok geleceğini sanmam ancak tabi ilerleyen günlerde peluş kafa ok ben bunları yerine getireceğim derse bak o zaman sıkıntı büyük olur, neyse izleyelim görelim.
  entry_channels: 
---
