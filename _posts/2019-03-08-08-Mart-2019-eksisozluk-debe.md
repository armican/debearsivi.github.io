...
- entry_name: |
    beni aldatırsan sana kızmam diyen kız
  entry_id:  87455560
...
- entry_name: |
    eczacılık fakülteleri kapatılsın
  entry_id:  87451913
  entry_writer: sameland
  entry_fav_count: 159
  entry_content: |
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
    8 mart 2019 kadın yazar alımı
  entry_id:  87463081
  entry_writer: tektonik
  entry_fav_count: 9
  entry_content: |
    inşallah gerçekleşmez dediğim haldir. zira abazan sözlük yazarlarının açtığı şu boyda şu kiloda esmer sarışın vs vs tarzı "kız" başlıklarına gelip" bu benim" demekten başka bir halt yapmayacak bir çoğu.
  entry_channels: anket,ekşi-sözlük
- entry_name: |
...
- entry_name: |
    sahte piyango biletiyle 70 milyon tl'yi almak
  entry_id:  87457605
  entry_writer: mrtbsrk
  entry_fav_count: 4
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://gifer.com/en/7gLO">https://gifer.com/en/7glo</a><br/><br/>hıh al koçum...
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    şu hayatta kimseye kendinden fazla değer vermemen gerektiğini öğrendiğin, sağlıklı olduğun, işi işte bırakmayı bildiğin nefes aldığın her andır aslında.
...
- entry_name: |
  ...
  entry_id:  87471183
  entry_writer: neydikisimdibu
  entry_fav_count: 1
  entry_content: |
    eksi basliklarinin olmadigi bir dunyadir
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    pazar akşamına konan maçın ebesiyle ilişkiye gireyim. konya maçı 4. kategori 401. blok (basın yanı) kombineyi devredicem. fiyat 139,99 tl.<br/><br/>not: gişe fiyatı 195 imiş.
  entry_channels: spor
- entry_name: |
    mehmet özhaseki'nin kayseri'ye deniz getirme vaadi
  entry_id:  87470645
  entry_writer: bakhele sen bugun cok komiksin ha
  entry_fav_count: 0
  entry_content: |
    maşallah iktidar kanadında çılgın proje bitmiyor özhaseki'nin akp'deki selefi i. melis pardon melih de ankara'ya boğaz getirecekti bugün insanlar ankara'da boğazını doyuramıyor bunların politikaları yüzünden
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    bugün bu başlığa aşağıdaki entry girilmiş;<br/><br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>birisi kabuk tutmuş yaralarımızı okşamaya başladığında, cırt diye açılıveriyor ve kanamaya başlıyor yeniden oluk oluk. birine teslim olduğumuzda ve içimizi döktüğümüzde, bedenimiz ve ruhumuz kan içinde kalıyor. o yüzden değil mi içimizi tutmalarımız, birine teslim olmaktan korkmalarımız, ortalıkta gergin ve tedirgin dolanmalarımız? “anlatsam mı, anlatmasam mı?” kararsızlığımız. “bu sevgi beni acıtır mı?” kuşkularımız.<br/><br/>gabriel garcia márquez <br/>yüz yıllık yalnızlık<br/>--- <a class="b" href="/?q=spoiler">spoiler</a> ---<br/><br/>ben bu kitabı okudum. içinde böyle bir cümle geçeceğini sanmıyorum, yine de varsa lütfen sayfa numarası bildirilsin. ama berbat bir pasaj bu, kitapta olsa da fikrim değişmez. ağlak, gereksiz, bin kere benzeri yazılmış bir pasaj. bu da kitabın pdf'si;<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="http://www.kkoworld.com/kitablar/qabriel_qarsia_markez_yuz_illik_tenhaliq-turk.pdf" title="http://www.kkoworld.com/kitablar/qabriel_qarsia_markez_yuz_illik_tenhaliq-turk.pdf">http://www.kkoworld.com/…uz_illik_tenhaliq-turk.pdf</a><br/><br/>burada da kabuk, cırt, dolanma gibi kelimeleri aradım ama böyle bir cümle bulamadım.<br/><br/>edit: internette pek çok sayfada marquez'in sözü diye paylaşılmış, en bilinen kitabı yüzyıllık yalnızlık olduğundan ondan diye de paylaşılmış sanıyorum. ancak tüm kitabı ezbere bilmesem de linkini verdiğim pdf formatında alternatifli şekilde bu cümleyi aramama rağmen bulamadım. zaten dediğim gibi üslup hiç benzemiyor yüzyıllık yalnızlık'ın üslubuna. sanıyorum oğuz atay'a ait olmadığı halde tutunamayanlar'dan diyerek paylaşılan ya da cemal süreya'ya ait olmadığı halde cemal süreya mısrası/şiiri diye paylaşılan şeylerden biri gibi bu da.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    fiziksel ve zihinsel rahatlıktan alıkoyan şeylere ve insanlara hayatında yer vermemek.
  entry_channels: anket,ilişkiler
- entry_name: |
