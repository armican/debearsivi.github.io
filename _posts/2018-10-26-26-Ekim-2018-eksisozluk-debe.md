...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    25 ekim 2018 google kürdistan rezaleti
  entry_id:  82649881
  entry_writer: deadgodinme
  entry_fav_count: 322
  entry_content: |
    ispanya'da katalanlar için böyle bir harita yok.<br/><br/>bask için yok.<br/><br/>belçika'da flamanlar için yok.<br/><br/>fransa'da bretonya için yok. korsika için yok.<br/><br/>almanya'da bavyera için yok.<br/><br/>çekler için moravia da yok.<br/><br/>italya'da sicilya için yok. veneto, lombardia, tirol, sardunya için yok.<br/><br/>ama şak diye kürdistan çıkıyor türkiye'nin içinden... yok ya?
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 88
  entry_content: |
    kimin kimi kopardığıyla ilgilenmeyen, herkesi kendi payına davet eden bir abidir
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    41 bin 800 liraya satılan ceket
  entry_id:  82656218
  entry_writer: spam adamim
  entry_fav_count: 51
  entry_content: |
    bunu recep ivedik giymemişmiydi
  entry_channels: moda
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    ingiliz dili kendisi için yeterlidir.
  entry_channels: sinema
- entry_name: |
