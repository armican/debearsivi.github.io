...
- entry_name: |
  ...
  entry_fav_count: 83
  entry_content: |
    1.65 boyundaki erkek kısadır. kısadır diyen kız da haklıdır.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
    klozetten lağım faresi çıkması
  entry_id:  82670088
  entry_writer: farakan
  entry_fav_count: 60
  entry_content: |
    sıçılan yerden sıçan çıkması normal. hahah espiriye bak amunüyum. sıçan, sıçılan falan sözcüklerle dans ediyorum.
...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    özellikle kar yağdığı zaman ihtiyaç duyuyorum. kurtulun artık şu köylü bakış açınızdan.
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    form doldururken sex alanına çok isterim yazmak
  entry_id:  82670148
  entry_writer: yalapeno
  entry_fav_count: 15
  entry_content: |
    bir temel fıkrasıdır<br/><br/>- sex?<br/>+ yes please<br/>- ı mean male or female?<br/>- doesn't matter
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    gelmişini geçmişin sikeyim. lise 1 öğrencisi vücudu var amk çocugunda.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    - neden içiyorsun?<br/>- unutmak için.<br/>- neyi?<br/>- neden içtiğimi. <br/><br/>bir dizinin mi filmin mi ne diyaloğuydu. çok da iyi değil bence ama aklıma geldi.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    büyük ekranlı pembe general mobile telefon kullanırlar
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    kendisini sildiğim kadındır.<br/>eşyalarını toplarken de "bak gidiyorum ha " dedi şener şen'in fake atması gibi, çok sinir etmişti git dedim. bak şimdi düşünüyorum da üzüldüm yine ulan.<br/>ilişki yürümese de, kavgayla kötü laflar da sarf edilse de iyi ayrılmak lazım sözlük.
  entry_channels: anket,ilişkiler
- entry_name: |
    şu anda çalan şarkı
  entry_id:  82651681
  ...
  entry_fav_count: 0
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="http://youtu.be/F2Uim4KFfgs" title="http://youtu.be/F2Uim4KFfgs">wankelmut &amp; emma-louise - my head is a jungle</a>
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    <a class="b" href="/?q=snatch">snatch</a> filmindeki brad pitt ve çetesi.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    fenerbahçe'nin bu kadar güzel başladığı euroleague maçı nadirdir. çok doğru işler yapan bir takım ve koçun kenar desteğine bile ihtiyaç olmayan ilk çeyrek..
  entry_channels: spor
---
