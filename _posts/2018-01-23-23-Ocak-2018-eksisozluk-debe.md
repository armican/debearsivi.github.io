...
- entry_name: |
  ...
  entry_fav_count: 43
  entry_content: |
    büyük usta mimar sinan, selimiye camiinde yanan kandillerin islerinin toplanması için is odaları yapıyor. hava akımıyla kandillerin tüm isleri cami içinde herhangi bir kararmaya sebep olmadan bu odaların duvarında toplanıyor. <br/><br/>bu bile ufuk açıcı birşeyken ardından bu islerin ne olduğunu öğreniyoruz. bu isler toplanarak, mekke'ye giden develerin boynuna asılıyor. develerin boynunda sallanarak mekke'ye yani kutsal topraklara kadar gidip gelen bu isler, yolculukları boyunca mürekkep halini alıyor. ve dönemin el yazması kur'anları bu mürekkeplerle yazılıyor.<br/><br/>edit: bir kaç farklı yazar arkadaş uyardı aynı ritüel süleymaniye için de geçerliymiş.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 39
  entry_content: |
    darth vader'ı ya da coyote yi tutmakla uzaktan yakından alakası yoktur.<br/><br/>darth vader'ı tutmanın altında yaşadığı acı, keder ve düzene başkaldırı asiliği ile yapılan bir empati vardır.<br/><br/>coyote ile olan empatinin altında ise peşinden koşup koşup ulaşılamayan hedefler ve bu uğurda türlü eziyetlere zorluklara katlanmak vardır.<br/><br/>sauron ne? yanan kuku. neyin empatisini kurayım onla?
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  73686486
  entry_writer: northkorean
  entry_fav_count: 26
  entry_content: |
    lanet olasi barcelona ucagim rotar yapti. onu beklemekle.mesgulum. yoksa simdiye coktan sehrin yarisini gezip bitirmistim.
- entry_name: |
    ekşi itiraf
  entry_id:  73667666
...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    güzel bir andır. en azından benim için.<br/><br/>dilerseniz hep birlikte bakalım nasıl da güzel bir anmış benim için;<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="http://sketchtoy.com/68504362">http://sketchtoy.com/68504362</a>
- entry_name: |
    sinan gümüş
  entry_id:  73686811
  ...
  entry_fav_count: 15
  entry_content: |
    bugün puan kaybetseydik dayağı yemişti. hasan sağlı sollu girişirdi valla
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    bi' zamanlar internet cafe işletirken bir müşteri geldi. ilk kez pc başına geçtiği belliydi. <br/><br/>gelip bana; "yav arkadaş bilgisayarlarınız bozuk, mausu yukarı itiyorum aşağı gidiyor bi' bakar mısın?" dedi.<br/>ben de nasıl olur diyip yanına gittim. mausu yukarı-aşağı götürüyor, dediği gibi de oluyordu. bi' dakka bana verir misin mausu dedim ve elini çekince bir de ne göreyim; mausu ters tutuyor. hemen gidip masayı kapattım ve pc bozuk diyip parasını verdim yolladım.<br/><br/>bu da böyle bir anımdır/başkasının mallığıdır.
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    sanırım bizim ordunun motivasyonu bu olsa gerek. <br/>- 6 ayda alınamaz<br/>- 1 sene geçse girilemez<br/>1 saat sonra <a class="b" href="/?q=tsk">tsk</a>: <a class="b" href="/?q=ba%c5%9fka+bir+arzunuz">başka bir arzunuz</a>?
- entry_name: |
    şırnak uludere ortaköyü ilkokulu yardım kampanyası
  entry_id:  73688162
  entry_writer: neboktanhayatimvar
  entry_fav_count: 5
  entry_content: |
    yardım edelim de sadece şırnak, hakkariye, mardine değil. karadenizde o kadar kötü durumda olan okullar var, ege de bitap köy okulları gördüm. birgün de egedeki bir köy okuluna yardım diye bir kampanya görelim isterim ekşide. doğudan batıya herkese selamlar,
- entry_name: |
    çukur
  entry_id:  73686688
  entry_writer: muti90
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    sağolsun kendisi bu akşam engel listemi güncellememi sağlamıştır.<br/><br/>ne kadar çer, çöp, zeka kırıntısı taşımayan yazar varsa engelledim.
- entry_name: |
    bitcoin
  entry_id:  73680802
  entry_writer: krnja
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    aylardır hakettiği yere yedek kulübesine geçmiştir. şut çekemeyen sorumluluk alamayan 10 numara olmaz. belki aklı başına gelir pezevengin.
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    (bkz: <a class="b" href="/?q=the+fountain">the fountain</a>)<br/>(bkz: <a class="b" href="/?q=what+dreams+may+come">what dreams may come</a>)
- entry_name: |
    fernando muslera
  entry_id:  73686881
  ...
  entry_fav_count: 1
  entry_content: |
    <a class="b" href="/?q=22+ocak+2018+kayserispor+galatasaray+ma%c3%a7%c4%b1">22 ocak 2018 kayserispor galatasaray maçı</a>ndan alınan 3 puanın yarısı kendisinindir.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=k%c4%b1z%c4%b1l+kestane">kızıl kestane</a>)
---
