...
- entry_name: |
    anaokulu 4 yaş öğrenciden 1 top a3 kağıt istemek
  entry_id:  70861161
...
- entry_name: |
    tuğçe kazaz'ın ak parti'den soğuması
  entry_id:  70866932
...
- entry_name: |
    başakşehir stadında çocuklara yapılan eziyet
  entry_id:  70867773
  entry_writer: cinmax
  entry_fav_count: 63
  entry_content: |
    "bu arada beşiktaş kulübü, iki çocuğu bulmak için harekete geçti. siyah-beyazlılar, pazartesi akşamı oynanacak olan beşiktaş - atiker konyaspor maçının seremonisine, iki çocuğu trabzonspor formasıyla çıkarma kararı aldı."<br/><br/>not: alıntı<br/><br/>(bkz: <a class="b" href="/?q=gururlan+buras%c4%b1+be%c5%9fikta%c5%9f">gururlan burası beşiktaş</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 46
  entry_content: |
    bir brezilyalı iyidir.iki brezilyalı risklidir.üç brezilyalı teknik direktörü işinden eder.<sup class="ab"><a title="(bkz: arsen wenger)" href="/?q=arsen+wenger" data-query="arsen wenger">*</a></sup>
- entry_name: |
    beşiktaş
  entry_id:  70867033
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    yazdıklarına edebi, derin bir hava katmaya çalışan yazardır. üç nokta tırt edebiyatçının sığınağı, kurtarıcısı, en büyük yardımcısıdır. (hayır efendim, her üç nokta kullanan tırt edebiyatçı değildir tabii ki, ancak tırt edebiyatçı bol bol üç nokta kullanır.)<br/><br/>bir de, #şiirsokakta tayfası pek sever özellikle bu üç nokta kullanımını. adına şiir dedikleri şöyle şeyler yazarlar duvarlara:<br/><br/>"haydi gel, sevişelim.<br/>halvet olursak sigara, olmazsak çay içelim...<br/>bir de, göğe bakalım...<br/>#şiirsokakta"
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    sonbaharla birlikte depresyonum yine depreştiği için tam olarak o kafadayım yine, yeni, yeniden. <br/><br/>evet bir taraftan hayatı seviyorum, bağlıyım, gitmek çok zor geliyor ama yok yani yaşamaktan zevk almadığım günlerdeyim yine. arkadaşlar, sohbetler, etkilikler, kafa dağıtıcı uğraşlar, yediklerim, içtiklerim, her şey tatsız, her şey bomboş. içimde o kadar kocaman bir boşluk var ki, dolmuyor, bu anlamsızlık, amaçsızlık geçmiyor.. <br/><br/>ha yine "ölmök östöyöröm" diye zırlamamanın tek sebebi bence prozac. ama ona rağmen her şey bu kadar anlamsız geliyorsa bilmiyorum altan, bilemiyorum..
---
