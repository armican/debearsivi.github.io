...
- entry_name: |
    metal müzik dinleyenlerin loser olması
  entry_id:  75909809
  entry_writer: polyphase
  entry_fav_count: 143
  entry_content: |
    en azından <a class="b" href="/?q=loser">loser</a> yazabilecek yetiye sahip olan müzik dinleyicileridir.<br/><br/>ps: technospor
...
- entry_name: |
    menzil'de çok güzel bir gün geçirmek
  entry_id:  75916422
  entry_writer: sabitfikirliadam
  entry_fav_count: 78
  entry_content: |
    bunlar gavsın salladığı hortumu tutup cennete gideceğini sanan şirk içindeki insanlar değil mi yav ? sorusunu akılda canlandırmış video.
...
- entry_name: |
  ...
  entry_fav_count: 52
  entry_content: |
    kırgınlık. <br/>her sey gecse de o gecmiyor. insanin icine batiyor.
...
- entry_name: |
  ...
  entry_fav_count: 47
  entry_content: |
    galatasaray’ıma fetöspor diyen orospu evlatlarının başlığına doluştuğu maç.<br/><br/>bu orospu çocuğu muhtemelen, bir kaç sene öncesine kadar zırhlı mercedes ile gezen savcıyla halı saha maçı yapan orospu çocuklarından biridir.
  entry_channels: spor
- entry_name: |
    börü
  entry_id:  75928865
...
- entry_name: |
  ...
  entry_fav_count: 14
  entry_content: |
    3. dünya savaşı ispanya-italya arasında başlayacak, anlaşıldı.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    hep konuşup eyleme geçmeyenler,<br/>fakirlik edebiyatı yapıp her yediğini içtiğini sosyal medyada paylaşanlar,<br/>duygu sömürüsü yapıp ilgi bekleyen, ruhu dilenci olanlar,<br/>engellilerle ilgili aşırı duyarlı konuşup, girdiği ortamda engelli görünce dünya dışı varlık görmüş gibi davrananlar,<br/>içine doğduğu dili ne sözlü ne yazılı olarak doğru kullanamayanlar,<br/>hakkını aramayıp ağlayan ama başkası kendisi için arasın, kendinin değil o başkasının başı derde girse daha iyi olur diyenler,<br/>çocuğunun mahremiyetini korumayı bilmeyenler,<br/>kendi eksikliğini kapatmak için eğitimli, kültürlü, konunun uzmanı insanla dalga geçerek sindirmeye çalışan ezikler,<br/>vasıfsız olduğunu bildiği halde hep fazlasını talep edenler,<br/>her türlü duygu mastürbatörleri,<br/>belli bir yaşa geldiği halde bir tane bile gerçek arkadaşı olmayan ve bundan kendini sorumlu tutmayı akıl edemeyenler,<br/>mücadeleden kaçanlar,<br/>ve elbette, her yerde kurallar olsun ve başkaları da bu kurallara uysun ama bana hep istisnalar uygulansın diyenler.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    "mesleki ve teknik anadolu lisesi" dedikleri eğer bildiğimiz meslek liseleriyse, afedersiniz analarına atlayayım ben onların. türkiyenin en büyük ilçelerinden birisinde iki tane mesleki teknik anadolu lisesi, bir tane eskinin iyi, şimdinin tercih edilmeyen lisesi ve bir tane fen lisesi var. fen lisesi tutturamayanlar yandı bitti kül oldu? inşallah okul isimleri değiştiğinden ben bilemiyorumdur, dört liseden ikisi meslek lisesi değildir?
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    bunu yapan insanların içine düştüğü en büyük hata kapasitelerinin çok üzerinde ağırlıklara abanmaktır. ne kadar zorlanırsam o kadar faydalı olur mantığıyla. ilk bakışta mantıklı gibi görünse de aslında hiç alâkası yoktur. hatta gelişiminizi yavaşlatır. önemli olan ağır basmak değil, hareketi doğru yapmak ve dolayısıyla doğru kas grubunu çalıştırmaktır. siz çok ağır bir yükü girdiğiniz zaman çalıştırmayı istediğiniz kastan çok zorlandığınız için daha çok destek aldığınız, vücudunuzun diğer kasları çalışıyor. en başta beliniz. eğer kol çalışıyorsanız, kol kaslarınızdan çok beliniz, omuzunuz, sırtının, bacak kaslarınız çalışıyor. sırf o yükü kaldırmak için. bunun sonucunda ne oluyor peki? bir, hareketi doğru yapamıyorsunuz(ki bu çok büyük bir kayıp), iki, çalıştırdığınız bölgeye pompalanması gereken kan vücuda dağılıyor, şişmesi istenen kas yeteri kadar beslenip, yanmıyor. yani boşuna kıçınızı terketmiş oluyorsunuz. kalbinizi yorması ve oluşturacağı riskler şöyle dursun. velhasıl, çok ağır çalışmayın. emin olun ki 5 kg'lik dambılla yapacağınız set zar zor kaldırdığınız 20-30 kg'lik dambılla yaptığınız setten çok daha verimli olur sizin için.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    her türlü eleştiriye hakarete açığım, fakat bir türlü şu kanal projesi aklıma yatmıyor. hayatımda duyduğum en saçma işlerden biri olabilir.
  entry_channels: haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    bunlar ankaragücü taraftarını temsil etmiyor diyen arkadaş büyük olasılıkla ironi yapıyor. <br/><br/>yoksa başka bi açıklaması yok. 20 yılı aşkın bir süredir ankarada oturuyoruz, yemeyin bizi :))
  entry_channels: spor
- entry_name: |
