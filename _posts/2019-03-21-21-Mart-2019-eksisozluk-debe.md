...
data:
- entry_name: |
    kekeme kadın olmaması
  entry_id:  87934655
  entry_writer: kimliksizdevlet
  entry_fav_count: 1055
  entry_content: |
    sol framede görüp üstüne "hassiktir doğru lan" diyerek atladığım önermedir. hiç görmedim ve duymadım. gören duyan ses etsin.
...
- entry_name: |
  ...
  entry_fav_count: 381
  entry_content: |
    yılların el alışkanlığı nedeni ile elinde olmadan bu siteyi açanların.<br/><br/>c:\windows\system32\drivers\etc klasöründe bulunan hosts dosyasını noteapad ile açıp son kısmına :<br/><br/>127.0.0.1 www.hurriyet.com.tr<br/>127.0.0.1 hurriyet.com.tr<br/>127.0.0.1 www.hurriyet.com<br/>127.0.0.1 hurriyet.com<br/><br/>satırlarını ekleyerek engelleyebilecekleri , yakın zamanda el değiştirmiş basılı yayın(gazete demeye dilim varmadı)
...
- entry_name: |
  ...
  entry_channels: siyaset,tv
- entry_name: |
    aragorn'un yanlış kişiyle evlendiği gerçeği
  entry_id:  87940417
  entry_writer: benibenim
  entry_fav_count: 135
  entry_content: |
    yok öyle bir gerçeklik bin kere olsa gene arwen'i seçerdi aragorn. eowyn çok bariz bir ezik.<br/><br/>çorba yapabiliyor diye kraliçe mi alınır lan. köy evine gelin mi alıyon amk.
...
- entry_name: |
  ...
  entry_fav_count: 26
  entry_content: |
    çaresizliğinden beslenmek. kaybedecek bir şeyi olmayan insan en güçlü insandır. beterin beteri, dibin dibi var. daha bir şey görmediniz. bittim ben dediğin var ya, nah bittin. daha ölmediniz arkadaşlar, her şey ölünce biter. nefes aldığınız sürece güçlüsünüz, nasıl güçlü olacağınızı bilirseniz.
...
- entry_name: |
    20 mart 2019 konsensus ankara seçim anketi
  entry_id:  87962545
  entry_writer: excelsior was here
  entry_fav_count: 24
  entry_content: |
    şu özhaseki'nin aldığı oy oranı direkt ankara'nın cehalet oranıdır. hata payı 0.
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    iş bulmak vs eş bulmak
  entry_id:  87961665
  entry_writer: winstonhafif
  entry_fav_count: 3
  entry_content: |
    imzayı atana kadar karşıdakine kendini beğendirmeye çalışma aktiviteleri içeren benzer konulardır.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    dünyanın en büyük hayvanseveri <a class="b" href="/?q=john+wick">john wick</a>'e hayat vermiştir.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/3HW8vRk-ApY" title="https://youtu.be/3HW8vRk-ApY">zülfü livaneli - sevda değil</a>
