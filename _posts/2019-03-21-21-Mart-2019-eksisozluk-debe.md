...
- entry_name: |
  ...
  entry_fav_count: 47
  entry_content: |
    belki 100 sefer yazılmıştır ama bir daha yazalım. mesaj attınız okudu ve cevap vermedi ya da geçiştirdi başından sizi. lütfen yalvarıyorum o ikinci mesajı atmayın şunlara.<br/><br/>zaten o saatten sonra yüzlerce mesaj da atsan sonucu değiştiremezsin, üstüne götlerini kaldırdığınla kalıyorsun ve kendini küçük düşürüyorsun. gözünüzü seveyim yapmayın.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
    takside şoförün yanına oturan kişi net fakirdir
  entry_id:  87954166
  entry_writer: fuzzy olmak istemistim
  entry_fav_count: 15
  entry_content: |
    ben brüt fakir olduğum için beni ilgilendirmeyen önerme.
...
- entry_name: |
  ...
  entry_id:  87961977
  entry_writer: ben de mesudum
  entry_fav_count: 4
  entry_content: |
    hakkındaki saplarla samanların ayrılması gereken olaydır. fatih terim bu parayı tff'ye gol atmak için bu kadar uğraşarak aldı. sizce adamın ihtiyacı mı vardı? demirören'i morartma keyfini yaşadı önce sonra da babalar gibi bağış yaptı. kudurmayın beyler hoca söz konusu olunca kuduruyorsunuz... :)
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    abdullah gül parti kursa alacağı oy oranı
  entry_id:  87953018
  entry_writer: forabandit
  entry_fav_count: 3
  entry_content: |
    henüz partinin adını tartışmayı bitiremedik ne ara oy almaya başladı?
  entry_channels: siyaset,anket
- entry_name: |
    keanu reeves
  entry_id:  87961703
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    kesinlikle (bkz: <a class="b" href="/?q=fc+barcelona">fc barcelona</a>)
  entry_channels: spor
---
