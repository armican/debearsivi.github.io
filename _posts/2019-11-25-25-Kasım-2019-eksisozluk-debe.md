...
- entry_name: |
    başöğretmen recep tayyip erdoğan
  entry_id:  98217810
  entry_writer: oxoemre
  entry_fav_count: 781
  entry_content: |
    (bkz: <a class="b" href="/?q=s%c3%b6zl%c3%bc%c4%9fe+yeni+mallar%c4%b1n+gelmesi">sözlüğe yeni malların gelmesi</a>)
...
- entry_name: |
  ...
  entry_fav_count: 761
  entry_content: |
    öğretmen olmak için üniversite bitirmek, sınav ve mülakatlardan geçmek gerekirken vali olmak için ilkokul mezunu olmak ve saraya yakın olmanın yeterli olduğunu gösterir cümle.
...
- entry_name: |
  ...
  entry_channels: ekonomi
- entry_name: |
    cübbeli ahmet hoca'nın mini etekli kıza yorumu
  entry_id:  98224938
  entry_writer: boxer kisot
  entry_fav_count: 171
  entry_content: |
    (bkz: <a class="b" href="/?q=akp%27nin+%c3%a7%c3%b6k%c3%bc%c5%9f%c3%bcn%c3%bc+%c3%b6ng%c3%b6ren+c%c3%bcbbeli+hocadan+salto">akp'nin çöküşünü öngören cübbeli hocadan salto</a>)
  entry_channels: haber
- entry_name: |
...
- entry_name: |
    30'luk yazarların sözlükte takılma amacı
  entry_id:  98207213
  entry_writer: koyu renkler
  entry_fav_count: 138
  entry_content: |
    şu sözlükte bilmem kac yasinda yıldır varım. amma okur, amma yazar. belki onbinlerce başlık gördüm, troll falan ne ararsan. fakat böylesini ilk kez görüyorum, olum hiç mi moderatör kalmadı lan? maaşlarını ödeyemiyorsanız aramızda toplarız abicim, noluyo ya?<br/>forumdan da öte bir noktaya gidiyoruz.<br/><br/>edit: (bkz: <a class="b" href="/?q=hay%c4%b1rl%c4%b1+feysbuk%27lar">hayırlı feysbuk'lar</a>)
...
- entry_name: |
    yavaş yavaş imamoğlu'nun gerçek yüzünün görülmesi
  entry_id:  98230405
  entry_writer: thor44
  entry_fav_count: 135
  entry_content: |
...
- entry_name: |
    a haber'in muharrem ince'yi desteklemesi
  entry_id:  98219452
...
- entry_name: |
  ...
  entry_id:  98202556
  entry_writer: staffordshire
  entry_fav_count: 117
  entry_content: |
    eıh hiıh eih hih hih hih eağh hih hih eağh hihhhih hih hih eağh hih hih hih <br/><br/>laz ziya
  entry_channels: anket,tv
- entry_name: |
    black mesa'da iş güvenliği uzmanı olmak
  entry_id:  98221607
  entry_writer: arthorian
  entry_fav_count: 117
  entry_content: |
    bugün bana teklif edilen iş pozisyonu. <br/><br/>riskli bir ortamı yokmuş. zaten kurulu bir düzeni varmış. çayını, kahveni içer gidersin diyorlar. ama yol sorunu var, trenle yolculuk yapmak gerekiyormuş. mevcut işimi bırakıp geçsem mi ikilemde kaldım.
...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    berat albayrak'ın akp'nin başına geçmesi
  entry_id:  98222587
  entry_writer: excelsior was here
  entry_fav_count: 97
  entry_content: |
    (bkz: <a class="b" href="/?q=entry+ve+nick+uyumu">entry ve nick uyumu</a>)<br/><br/>ekonomiden sonra akp’yi şaha kaldıracak tek kişi kendisidir. bir muhalif olarak üzer. çok açık ve net söylüyorum.
...
- entry_name: |
  ...
  entry_fav_count: 90
  entry_content: |
    bir sürü çaylak edilesi gerizekalı sivilceli ergen içeren başlık. çok komiksiniz aq. her başlığı çöpe dönüştüren şu tipleri uçurun artık arkadaş. zeka yok. komik desen değil.<br/><br/>vörmöyö döşündöğöm söpöröşü ulöştörön sitö hohoahau <br/><br/>aq salakları.
...
- entry_name: |
    depresyon beyaz yakalı işidir
  entry_id:  98222574
  entry_writer: atgmuls
  entry_fav_count: 39
  entry_content: |
    burjuva kelimesi anlamini bilmeden cumle icinde kullanilmis. burjuva üretim araçlarını elinde bulunduran ve bunlari isleten sinifa denir. yani fabrikası olan patron burjuva sinifindandir. beyaz yakali burjuva degil, proleterya sinifindadir. yani bildigin isci sinifindandir. zira ücret karşılığı emeğini satan herkes proleter, yani işçidir. fabrikada ucret karsiligi calisan genel mudur de isci sinifindandir. beyaz yakali da isci sinifindadir. hatta mavi yakali sendikasi olan isci iken beyaz yakali işçinin sendikasi da yoktur. beyaz yakalinin esas sorunu işçi sınıfı oldugunu kabul etmeyip buna gore yasamamasidir. ve haklari icin birlik olamamasi, sendikasini kuramamasidir.<br/><br/>not: beyaz yakalı
  entry_channels: anket
- entry_name: |
  ...
  entry_fav_count: 39
  entry_content: |
    maşallah hiç ara vermeden chp içinde çatlak yaratmak için koşturuyor. <br/><br/>24 haziran seçim gecesi yaşattıkları ile zaten gözden düşmüşken, şimdi de bu şekilde chp'de çatlak olması için avucunu kaşıyanların değirmenine su taşıması ile iyice kendinden soğuttu. yok efendim o gece genel merkez kumpas kurmuşta, yok efendim mağdur edilmişte falan filan. yerel seçimlerde ekrem imamoğlu partiden ayrı kendi gönüllü ekibini kurmadı mı? kurdu. peki seçim gecesi kurduğu sistem işledi mi? işledi. bunlar genel merkezin değil imamoğlunun becerisiydi. peki muharrem bey neden böyle bir sistem kurmadı? cevap hazır; "genel merkez engelledi." yazacak çok şey var da neyse... seçimden önce büyük büyük konuşup "şu kadar avukatla ysk önünde olcaz" diyip sonrasında ortalığa bile çıkmayan birinin söyledikleri ne kadar güvenilir size kalmış artık. <br/><br/>gündeme gelmek için partisini al aşağı etmekten çekinmeyen bir insan artık...
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 30
  entry_content: |
    kesinlikle siyah zeytin. yanında sadece ekmek olsun kafi. her öğünü karşılar. her yiyeceğin yanında gider. bir kaç tane değil en az 10-15 tane yersin yinede dokunmaz. çerez gibi yenileni kuru seledir.
  entry_channels: anket,yeme-içme
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    kırmızı kart diyor hala.<br/><br/>1) pozisyon ofsayt<br/>2) öncesinde ozan'a yapılan pozisyon kartlık. faul'un verilmemesi fiyasko.<br/><br/>edit: ahahaha. hakem oralı bile olmadı lan ozan'a yapılan harekete. aynısı suriyelilere yapılsa, başlığı çoktan açılmıştı.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    askere gidenler,babaannesi 20.kez ölenler,cok onemli isi olanlar ve sehir disinda olanlar,bayi toplantısı olanlar say say bitmez yine bütün cingeneler toplanmis.bu takim insallah daha kötüye gider de o kombineleri gotunuzden cikartamazsiniz insallah.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    bilim insanlarının beşinci temel kuvveti bulması
  entry_id:  98217220
  entry_writer: delpiyeroskoors
  entry_fav_count: 3
  entry_content: |
    içerik temel doğa gücü başlık element...<br/>benim bildiğim periyodik cetvelde bunun yirmi katından fazla element var ama olsun.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    fenerbahçe'nin asil evladı. <a class="b" href="/?q=24+kas%c4%b1m+2019+yeni+malatyaspor+fenerbah%c3%a7e+ma%c3%a7%c4%b1">24 kasım 2019 yeni malatyaspor fenerbahçe maçı</a>nda malatya'nın 40. dakikada attığı net golü iptal ederek emekleri hiç etmiştir.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=john+noble">john noble</a>)<br/>(bkz: <a class="b" href="/?q=walter+bishop">walter bishop</a>)
  entry_channels: anket,tv
---
