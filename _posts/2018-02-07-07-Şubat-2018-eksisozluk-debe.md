...
- entry_name: |
    sahibinden.com'daki araba ilanı
  entry_id:  74033869
...
- entry_name: |
    6 şubat 2018 adnan oktar'ın rtük'ten ceza alması
  entry_id:  74037505
  entry_writer: cisar
  entry_fav_count: 43
  entry_content: |
    birilerinin kuyruğuna basmadan adnan oktar’ın ceza almaması olayı. <br/><br/>o değil de mayışlar kerhane vergileriyle ödeniyor mu, ödenmiyor mu?
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 35
  entry_content: |
    kimse oralı olmamış ama “platform gözetleme-dinleme yapmamaktadır” lafı çok acıklı. herkes birbirini tanıyor bu ülkede. kader, kimseyi böyle açıklama yapmak zorunda bırakmasın.<br/><br/>ayrıca bir tek dileğim var; whatsapp kullanımına kısıtlama getirmeyin de ne yaparsanız yapın.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 29
  entry_content: |
    (bkz: <a class="b" href="/?q=hey+there+i+am+using+pttmessenger">hey there i am using pttmessenger</a>)
- entry_name: |
    türk televizyonlarında sansür mü var
  entry_id:  74033210
  entry_writer: pocoyo
  entry_fav_count: 28
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 28
  entry_content: |
    resmi olarak evde kalma yaşları bu yıl ile başlamıştır. 89 lulardan geriye başlayarak kendi kafalarındaki bütün potansiyel eşlere mesajlar yağdırmaya başladılar bile. lisedeki sivilceli mehmete, üniversitedeki sessiz, asosyal buğraya, işyerindeki loser okana gün doğdu. hadi yine iyisiniz, sonunda ilgilenilmeye layık görüldünüz. hadi bakalım doğru bankaya, evlilik kredisi çekmeye
- entry_name: |
    erdoğan terörist başını ankara'da ağırladı
  entry_id:  74034352
  entry_writer: insan donuna girmis telli turna
  entry_fav_count: 27
  entry_content: |
    yargıtay'ın "pyd terör örgütü terör örgütüdür" kararına rağmen, erdoğan'ın salih müslüm'ü ankara'ya çağırması <a rel="nofollow noopener" class="url" target="_blank" href="http://www.cumhuriyet.com.tr/m/haber/siyaset/920912/Kilicdaroglu_ndan_Erdogan_a__Senin_yerliligin_de_batsin__milliligin_de_batsin.html" title="http://www.cumhuriyet.com.tr/m/haber/siyaset/920912/Kilicdaroglu_ndan_Erdogan_a__Senin_yerliligin_de_batsin__milliligin_de_batsin.html">olayı</a>. kılıçdar'ın ifadesidir:<br/><br/>• burada pyd terör örgütü olarak tanımlanıyor. ardından yargıtay'a geliyor, burada da pyd/ypg/pkk terör örgütüdür diyor. 21.5.2015'te. bir mahkeme kararı kabul ediyor. bu karardan sonra yargıtay'ın bu kararından sonra bunlar pyd'nin başkanı salih müslim'i ankara'ya davet ediyorlar. ben de sana soruyorum bay recep, sen mahkeme kararına rağmen terör örgütü saymasına rağmen hangi vatansever duygularla salih müslim'i ankara'ya davet ettin, ayağına halılar serdin. yiğitsen açıkla.<br/><br/>• bu bana sorulduğunda, 2016'da kim pkk'ya destek veriyorsa, biz onu pkk'nın yan organı olarak görürüz. meşru organların terör örgütleri ile ilişki kurmalarını asla kabul etmeyiz. ey amerika diye bağıran cumhurbaşkanı, amerika dönüp sorsa sen pyd'nin liderini ankara'ya davet ettin. sen onun terör örgütünün bir üyesi olduğunu bilmiyor muydun? tutuklatmak gerekmiyor muydu? <br/><br/>• her ağzımı açtığımda dünya kadar laf eder ben ona diyorum ki, sen fetö'ye, pkk'ya, el nusra'ya, ışid'e yardım ve yataklık yaptın, mahkemeye veremiyor. sen terör örgütlerine yardım ve yataklık yaptın diyorum, mahkemeye veremiyor. mahmut tanal karşımda oturuyor. salı günü dilekçeni ver. mahkeme kararlarını da vereceğim. o karardan sonra salih müslim'i buraya kim davet ettiyse işbirliği içindedirler. onlar bizi kendileri gibi sanıyorlar. onlar kendi ülkelerinin çıkarlarını değil, kendi çıkarlarını savunurlar. 15 milyon dolarlık malı sattığın şirket hangi şirket? tık yok. senin yerliliğin de batsın, milliliğin de batsın.
- entry_name: |
  ...
  entry_fav_count: 26
  entry_content: |
    (bkz: <a class="b" href="/?q=15+temmuz+demokrasi+ve+tabipler+birli%c4%9fi">15 temmuz demokrasi ve tabipler birliği</a>)<br/>(bkz: <a class="b" href="/?q=15+temmuz+demokrasi+ve+barolar+birli%c4%9fi">15 temmuz demokrasi ve barolar birliği</a>)
- entry_name: |
    ben danla bilic sorularınızı bekliyorum
  entry_id:  74024058
  entry_writer: unknown89
  entry_fav_count: 22
  entry_content: |
    defolup gitmiş sanırım hanımkız. gerizekalılık seviyesini arşa taşımış videoları ve tripleriyle, birboka yaramaz varlığını bir de ekşi üzerinden primlemek... istenmediğin yerde ısrarcı olmanın anlamı yok. çek videonu izleyen izlesin, ama buradan s.ktir git bi zahmet.
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  74023768
  entry_writer: polaroidandroid
  entry_fav_count: 16
  entry_content: |
    (bkz: <a class="b" href="/?q=arapas%c4%b1+atkinson">arapası atkinson</a>)<br/><br/>gençler bilmez
- entry_name: |
...
- entry_name: |
    türk ifadesinin kaldırılması gerekli
  entry_id:  74033074
  entry_writer: aslagelmeyecektelefonubekleyenadam
  entry_fav_count: 14
  entry_content: |
    yakın geçmiş zamanda beyan edilen ve uygulanan aşağıdaki unsurlar akıllara gelir;<br/><br/>(bkz: <a class="b" href="/?q=t%c3%bcrkiye%27nin+ad%c4%b1+de%c4%9fi%c5%9fsin">türkiye'nin adı değişsin</a>)<sup class="ab"><a title="(bkz: anadolu cumhuriyeti)" href="/?q=anadolu+cumhuriyeti" data-query="anadolu cumhuriyeti">*</a></sup><br/><br/>(bkz: <a class="b" href="/?q=yeni+t%c3%bcrkiye+cumhuriyeti">yeni türkiye cumhuriyeti</a>)<sup class="ab"><a title="(bkz: cia projesi)" href="/?q=cia+projesi" data-query="cia projesi">*</a></sup><br/><br/>(bkz: <a class="b" href="/?q=t%c3%bcrk%c3%a7%c3%bcl%c3%bck+yapmak+b%c3%b6l%c3%bcc%c3%bcl%c3%bckt%c3%bcr">türkçülük yapmak bölücülüktür</a>) <br/><br/>(bkz: <a class="b" href="/?q=t%c3%bcrk+bayra%c4%9f%c4%b1n%c4%b1n+ad%c4%b1+de%c4%9fi%c5%9ftirilsin">türk bayrağının adı değiştirilsin</a>)<sup class="ab"><a title="(bkz: devlet&#39;e hakaret edip devlet&#39;ten ödül almak)" href="/?q=devlet%27e+hakaret+edip+devlet%27ten+%c3%b6d%c3%bcl+almak" data-query="devlet&#39;e hakaret edip devlet&#39;ten ödül almak">*</a></sup><br/><br/>(bkz: <a class="b" href="/?q=tc+ibaresinin+okul+tabelalar%c4%b1ndan+kald%c4%b1r%c4%b1lmas%c4%b1">tc ibaresinin okul tabelalarından kaldırılması</a>)<br/><br/>(bkz: <a class="b" href="/?q=kurum+tabelalar%c4%b1ndaki+tc+ibaresinin+kald%c4%b1r%c4%b1lmas%c4%b1">kurum tabelalarındaki tc ibaresinin kaldırılması</a>)<br/><br/>dipnot: yeni osmanlıcılık ne idi hatırlayalım (bkz: <a class="b" href="/entry/70260848">#70260848</a>)
- entry_name: |
    mehmet ekici
  entry_id:  74032345
  ...
  entry_fav_count: 8
  entry_content: |
    trabzonspor "ya beşiktaş'ın malı olacaksın ya da yatacaksın." dediği için mehmet bu durumda degil. trabzonspor'daki son 2 sezonuna bakarsaniz kronik sakat oldugunu ve kac mac kacirdigini goreceksiniz. <br/><br/>ayrica biz degil feto da yapmis olabilir boyle.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    herkes göte gelebilir, her göt tahta oturabilir.
- entry_name: |
    fi
  entry_id:  74030664
  ...
  entry_fav_count: 5
  entry_content: |
    şu diziyi izleyip de duru' ya "orospu eyşan" diyen arkadaşların psikolojik destek almalarını öneriyorum. normal değilsiniz.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://loverslanecloud.blob.core.windows.net/images/products/1_152362_ZM.JPG" title="https://loverslanecloud.blob.core.windows.net/images/products/1_152362_ZM.JPG">https://loverslanecloud.blob.core.windows.net/….jpg</a>
- entry_name: |
...
- entry_name: |
    muharrem ince ekşi sözlük'e gelsin kampanyası
  entry_id:  74039841
