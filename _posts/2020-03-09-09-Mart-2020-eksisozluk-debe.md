...
- entry_name: |
  ...
  entry_fav_count: 43
  entry_content: |
    sadece ankaralı kadınlara ait olmayan, tüm türkiye'ye ait olan psikolojik bozukluk.<br/><br/>bu kadınları bu hale getiren de bozuk toplum kodlarıdır. kadınları delirtip sonra psikolojileri bozuk demek haksızlıktır.
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    7500tl gelirle arabası değil bisikleti olan toplu taşımaya bile sadece kış aylarında para veren biriyim.
...
- entry_name: |
    marcelo saracchi
  entry_id:  103218441
  entry_writer: killinganarab
  entry_fav_count: 11
  entry_content: |
    türkiye ligi gibi vasat bi lige neden gönderildiği belli olan onun bunun çocugu.fener maçında da bu maçta da rakibe göz göre göre tekme atıyor basıyor ayağıyla itiyor ve sarı kart görüyor sadece.fener maçında sarı bile görmedi.tam bir velet tipi olan sabaha kadar tokatlamalık karaktersiz topçu.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    bugünkü maçta beklenenin aksine kendisini değil, falcao-feghouli ikilisinden birisini kahraman yapacaktır. imparator hafta boyunca "fener maçındaki gibi onyekuru'yu kaçırarak gol arayacağız" haberlerini boşuna sızdırmadı.
  entry_channels: spor
- entry_name: |
    sözlük erkeklerinin genelde yalnız olmaları
  entry_id:  103217485
  entry_writer: okyanussss
  entry_fav_count: 1
  entry_content: |
    önüne gelene yazarlar. hatta sahalara oynayan yazılarıyla ilgi açlığını gidermeye çalışırlar, belki birini denk getiririm düşüncesiyle. sözde aşık ama herkese yeşil ışık yakarlar. ne yaptıkları belli değil, kime yandıkları belli değil. çocuğum olsa diyemem baban böyle yürüyordu diye. <br/>kimseye de zorla bir şey yaptıramazsınız. o insanın içinde varsa vardır, yoksa yok.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    tamamen o anki modumdan kaynaklı gelen çekiciliktir.<br/><br/>modum düşerse büyü bozulur.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    üstlerine biraz östrojen fışkırtsaydınız keşke, kendiliğinden dağılırlardı.<sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup>
  entry_channels: siyaset,haber
- entry_name: |
    mert hakan yandaş
  entry_id:  103215460
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    sensiz geçen yıllarımızın ta amk 2013'te tüpçünün peşine gitmeseydin ne vardı be hoca.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    dert mi? o da ne? derdinize sokam bana güzel haberlerle gelin amk.
  entry_channels: anket,ilişkiler,ekşi-sözlük
---
