...
- entry_name: |
  ...
  entry_fav_count: 23
  entry_content: |
    <a class="b" href="/?q=fernando+muslera">fernando muslera</a> o topu centilmenlik namına dışarı atmasa belki o pozisyon incelenmezdi bile ah muslera ah.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 22
  entry_content: |
    adam doğru söylemiş. rusya'da evini boyatmak için boyacı tesisatçı çağırıyorsun kadın işçi geliyor. sanayiye arabanın yağını değiştirmeye gidiyorsun kadın değiştiriyor. yükleme indirme bindirme işi oluyor. hamallığı kadınlar yapıyor. fırıncı ustaları kadın. garsonlar kadın. her işte en pis olanında bile kadınlar çalışıyor. siz hangi işte çalıştınız ki bu adamın söylediğini eleştiriyorsunuz? adam ayan beyan gerçeği söylemiş.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    alarm sesi yapıp duymamak için 10 dakika erkenden uyandığım şarkı. <br/>sağol kont.<br/>-alıntı-
  entry_channels: müzik
- entry_name: |
    mete kalkavan
  entry_id:  103217778
...
- entry_name: |
  ...
  entry_id:  103218566
  entry_writer: akdenizmavisi
  entry_fav_count: 17
  entry_content: |
    yalnızlık.<br/><br/>yoruyor çünkü bir zamana kadar seçimken bir yerden sonra üstüne yapışan o yalnızlığı söküp atamıyor.<br/>çok yordu.
  entry_channels: anket,ilişkiler
- entry_name: |
    marcelo saracchi
  entry_id:  103218932
...
- entry_name: |
    hiçbir işini ertelemeyen insan
  entry_id:  103221422
  entry_writer: joker poker
  entry_fav_count: 8
  entry_content: |
    başarılıdır.
  entry_channels: 
- entry_name: |
  ...
  entry_id:  103184290
  entry_writer: kisaltmakablosu
  entry_fav_count: 8
  entry_content: |
    “kafam karışık”<br/><br/>aslında cevap çok net ama söyleyecek göt yoktur. erkekler korkaktır sevgili sözlük. ya yeni kuracağı hayatın “garanti” olmasını ya da senin ondan önce mutlu olma ihtimalini düşünürler. bu kafa karışıklığı esnasında senin de ayrılığa katkın olacak hatanı beklerler.
  entry_channels: anket,ilişkiler
- entry_name: |
    9 mart 2020 erdoğan avrupa birliği görüşmesi
  entry_id:  103222640
  entry_writer: zampara ferit
  entry_fav_count: 7
  entry_content: |
    görüşme şu havada gerçekleşecektir:<br/><br/>ab:sınırı kapa sana yunanistana verdiğimizin 1/10'u kadar para verelim.<br/><br/>tr: tm<br/><br/>ab:tşk<br/><br/>tr:öd
  entry_channels: siyaset
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    at şikecileri şimdiden başlamış ağlamaya
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    şenol güneş
  entry_id:  103223195
  entry_writer: lordofarts
  entry_fav_count: 0
  entry_content: |
    milli takım teknik direktörü.<br/><br/>bu adamın fbye teknik direktör olacağını ahmet ercanlar adlı futbol yorumcusu diyemeyeceğim zat ima ediyor. ya abi bu adam fbye gelse kadıköyde maçlara bordo mavi kravat takarak çıkmazsa ben de bişey bilmiyorum. cidden bu adama teklif götüren falan varsa yönetimde, bi zahmet yarın istifa etsin, sıkıldık cidden.
  entry_channels: spor
- entry_name: |
    sözlük yazarlarının tuttuğu takımlar
  entry_id:  103223346
  entry_writer: janissaire
  entry_fav_count: 0
  entry_content: |
    küçükken anket defteri alıp içindeki "en sevdiğin renk, hobilerin, en sevdiğin yemek" tarzındaki soruları yanıtlaması için arkadaşlarımıza verirdik ya aklıma o geldi. bu ne oğlum ne kadar saçma bi' başlık bu.
  entry_channels: 
- entry_name: |
    sivasspor galatasaray maçındaki kural hatası
  entry_id:  103223326
  entry_writer: hop hop hop temas yok
  entry_fav_count: 0
  entry_content: |
    galatasaray taraftarinin manyaklastigini gosteren bir iddia. ligde oynanmis binlerce oynanan macta olan hakem hatasini, kural hatasi diye baslik acarken utanirdim. ayrica falcao, ceza yayi icerisine de sivasli futbolcu ile birlikte girmisti.
  entry_channels: spor
- entry_name: |
    rıza çalımbay
  entry_id:  103221645
  ...
  entry_fav_count: 0
  entry_content: |
    bugünkü maçı beşiktaş’a karşı bu şekilde bitirseydi 2 hafta kanal kanal gezer ağlardı. ama öyle karaktersiz bir adam ki, konu gassaray olunca(bunca hakem hatasına rağmen)“güzel bir maç izlettik” oluyor.<br/><br/>tanım: beşiktaş’ın efsane oyuncusu.
  entry_channels: spor
- entry_name: |
    mert hakan yandaş
  entry_id:  103215460
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    mondragon,rüştü,volkan,taffarel,cordoba çok büyük kaleciler izledim.musleranın hepsinden bence tek farkı var.<br/>misal bizim rüştü top class kaleciydi ama gününde değilse sıçar batırır takımın anasını bellerdi.örnek olarak yaşı yetenler bilir panathinakos eşleşmesi gibi.bunun yanında süper oynadığı brezilya maçı da var.işin özeti dengesizdir.aynı şekilde volkanın da tt arena hasan alinin gol attığı karşılaşmada insanüstü performansı vardır ama kasımpaşaya sıçar batırır.<br/>muslera ise her maç çok iyi veya iyi seviyede top oynuyor.10 yıldır kendisini izlerim aklıma gelen tek hatası 2012 yılı orduspor maçında degaj sonrası selçuğa çarpıp giren top.<br/>işin özeti adamın en büyük özelliği "istikrar"
  entry_channels: spor
- entry_name: |
    fatih terim
  entry_id:  103220256
  ...
  entry_fav_count: 0
  entry_content: |
    üstteki yazar sanırım maçın son 5 dakikasını izlemiş, sezonda da izlediği tek maç sanırım. mariano'yu eleştirdi adam şaka gibi ve bunu fatih terim üzerinden yaptı. neyse ne desem gg.<br/><br/>tanım : maç
  entry_channels: spor
- entry_name: |
