...
- entry_name: |
  ...
  entry_fav_count: 296
  entry_content: |
    "zeki insanlar asla bir baltaya sap olamaz, onlar yalnız aptallardır." dostoyevski
  entry_channels: eğitim
- entry_name: |
    8 mart 2020 erkeklerin miting alanından kovulmasi
  entry_id:  103211387
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    muhafazakar ve kemalistleri birleştirecek lider
  entry_id:  103204567
...
- entry_name: |
    8 mart 2020 galatasaray lehine verilen penaltı
  entry_id:  103193936
  entry_writer: gurolgurol
  entry_fav_count: 191
  entry_content: |
    ligin ilk yarısında galatasaray kötü oynarken ve ligde 7. sıradayken biz ne hakemlerle ilgili konuştuk ne de farklı mazeretler ürettik. teknik direktörümüz çıkıp ocak ayını bekleyin dedi. nzonzi ve babel gitti, nagatomo'nun sözleşmesi donduruldu. onyekuru ve saracchi ile sol kanadı otoban yaptık. kimsenin vazgeçilmez olmadığını gösterince fatih terim, bir anda mariano da eski haline döndü. bakın üst üste goller atan emre akbaba şu anda kadroya giremiyor taraftar karşısında kredisi olmasına rağmen, peki neden? çünkü hala güçsüz. onun yerine seri, lemina, ömer orta sahası daha diri duruyor. her neyse sizler ali koç'u eleştireceğinize yine galatasaray'a sarmaya başladığınıza göre 5. yıldız çok yakında armaya işlenir. hatayı hep başkasında arayan bir ülke olduk, sokaktaki vatandaşından tutun da klüp başkanlarına kadar, meclis kürsüsündekileri saymıyorum bile.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  103199701
  entry_writer: halilibrahimsofrasi
  entry_fav_count: 132
  entry_content: |
    türkiye'nin normalleşmesinde önemli bir rol üstleneceğini düşündüğüm parti.
...
- entry_name: |
  ...
  entry_fav_count: 71
  entry_content: |
    bu arkadaşta tam kız mevzularında başarısız olduğu için saç sakal bakımını ihmal etmeye başlamış makine mühendisliği üçüncü sınıf öğrencisi tipi var. muhabbeti de sağlam olur böylelerinin.
...
- entry_name: |
  ...
  entry_fav_count: 34
  entry_content: |
    nesi olay anlamadıgım kadın. "uranyum kavururum. yanına da domuz kanı içeriz" dese hadi tartışalım da.<br/><br/>olm harbi mi işiniz gücünüz yok. sapık mısınız ne boksunuz bıkmadınız mı bilmem ne yapan kadın bilmem ne yapan erkek işlerinden hay amk :d
...
- entry_name: |
  ...
  entry_fav_count: 29
  entry_content: |
    insanlar sevgilerinden varını yoğunu ortaya koyuyorlar. al benim kalbim bu, ister tut ister parçala. bunu gören kişi genelde ikinci şıkkı seçiyor. çünkü sevgi nedir bilmiyor. hayatta bir olmanın getirdiği mutluluğu yaşamamış insanlardan çok şey bekliyorsunuz.<br/>edit: önce terk ederler, sonra yapamazlar, sonra yine terk ederler.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 22
  entry_content: |
    2. sarıdan seri atılmadı. dün tolgay 2. sarıdan atılmıştı vay amk.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    <a class="b" href="/?q=lost">lost</a> bile bu kadar uzun sürmemişti. 3. sezondan sonrası tırttı.
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    markut.<br/>rahmetli anneannemin biz kudurunca tırsıtmak amaçlı kullandığı hayali canavar.<br/>pirinç karyolada zıplarken gelirdi en çok markut.<br/>mum olurduk o duvardaki güm güm sesini duyunca. <br/>ahh bee keşke bir anlığına çocuk olsam; markut da, pirinç karyola da, anneannem de geri gelse...
  entry_channels: anket
- entry_name: |
    mert hakan yandaş
  entry_id:  103214909
  ...
  entry_fav_count: 8
  entry_content: |
    bugün fatih terim'in ilk on ikide başlattığı futbolcu.
  entry_channels: spor
- entry_name: |
    ekşi itiraf
  entry_id:  103180800
  ...
  entry_fav_count: 8
  entry_content: |
    sen "şovale"ye," şövalye" diyen kızı takibe almışsın ya, işte o zaman bittin içimde.
...
- entry_name: |
    8 mart 2020 carrefoursa'da rencide edilmem
  entry_id:  103216038
  entry_writer: slmcmn
  entry_fav_count: 7
  entry_content: |
    not kimse entry girmesin bir daha rencide olsun.
  entry_channels: 
- entry_name: |
    türk siyaset tarihinin en ilginç figürü
  entry_id:  103216117
  entry_writer: bir dokuz sifir yedi
  entry_fav_count: 5
  entry_content: |
    (bkz: <a class="b" href="/?q=hasan+mezarc%c4%b1">hasan mezarcı</a>)<br/><br/>adam peygamberliğini ilan etti lan var mı daha ötesi
  entry_channels: siyaset
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    ince bel, ince bilekler ve boyun
  entry_channels: anket,ilişkiler
- entry_name: |
    geniş omuzlu olmanın avantajları
  entry_id:  103213797
  entry_writer: guneste demlerim senin cayini
  entry_fav_count: 5
  entry_content: |
    <a class="b" href="/?q=r%c3%b6va%c5%9fata">rövaşata</a> öncesi topu göğüste yumuşatmak için daha çok alana sahip olmak.
  entry_channels: 
- entry_name: |
    ankaralı kadınların psikolojisinin bozuk olması
  entry_id:  103204193
  entry_writer: bach baba
  entry_fav_count: 5
  entry_content: |
    (bkz: <a class="b" href="/?q=genellemelerde+8+mart+%c3%b6zel+g%c3%bcndemi">genellemelerde 8 mart özel gündemi</a>)
...
- entry_name: |
  ...
  entry_channels: ilişkiler
- entry_name: |
    kişinin çocuğuna vereceği ilk nasihat
  entry_id:  103212245
  entry_writer: husobs9
  entry_fav_count: 3
  entry_content: |
    en önemli şey sahayı geniş görmektir, sahanın en hızlısı yada en kuvvetlisi sen değilsin ama en akıllısı her zaman sen ol.<br/>ps: evet arkadaşlar yaklaşık 35 yıl sonra oglumu sampiyonlar liginde veya nba playofflarinda izleyebilirsiniz ismini vermiyorum<br/>psno2: entry 35 yil sonra editlenecektir.
  entry_channels: anket,ilişkiler
- entry_name: |
    fatih terim
  entry_id:  103190944
  ...
  entry_fav_count: 3
  entry_content: |
    öyle şeyler yaşattın ki uğrunda ölmeye değer..<br/><br/>sağol, varol, hep başımızda ol hocam!
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    tavuk arkadaşlar 9 yumurta bırakmışlar bugün bahçeye. gezen tavuk bunlar, kafalarına göre takıldıkları için sürpriz oldu, mutlu oldum.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    ali palabiyiktan sonra en cok nefret ettigim 2.hakemdir. hem kotu niyetli hem de yeteneksizdir.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    erkek doktorların genellikle daha başarılı ve daha anlayışlı olduğunun farkındadır.
