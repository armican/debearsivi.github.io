...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    net kırmızıdır. neyi tartışacaksın. ha benzerinde fb-gs derbisinde sarı bile çıkmamıştır.
  entry_channels: 
- entry_name: |
    pepe
  entry_id:  76163724
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    siyasi kariyerinin bitmesine 65 gün kalmayan kişi. chp'de bu yönetim oldukça 30 seçim de kaybetse hem kendisi genel başkanlık adayı olacak, hem de yönetim kendisini seçecektir. dolayısıyla ömrü yettiğince kendisi chp genel başkanı olacaktır. akp seçmenini koyun olarak gören gerçek koyun chp seçmeni de kendilerine oy atmaya devam edecektir.<br/><br/>akp stepnesi yeni chp'li olmak bunu gerektirir.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=vurmay%c4%b1n+tamam+%c3%b6ld%c3%bc">vurmayın tamam öldü</a>)<br/><br/>kabul ediyorum iç çamaşırı fotoğrafı paylaşmak biraz absürd olmuş.<br/>komidinin üstündeki parfümlerin avon katoloğundan ay ay alınıp biriktirilmişliği, çamaşırların kalitesi, evdeki eşyaların kalitesi gibi fotoğraflara bakınca anlaşılıyor. belli imkanlarla bir ev kuran insanlar bunlar.<br/><br/>belki de bu kadar yeni eşyayı da bir arada görmediği için sevincinden böyle bir fotoğraf paylaştı.<br/><br/>umarım akranlarla yarışma sevdasını bırakıp, evliliklerinde mutlu olup, az çocuk yapıp, güzel eğitimlerle vatana millete faydalı bireyler yetiştirirler.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    lanet olsun şu içimdeki "yarım bırakamama" güdüsüne.<br/>yazık zamanınıza.<br/>izlediğim, uzak ara en kötü netflix dizisi.
