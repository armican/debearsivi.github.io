...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    kıymeti bilinmeyendir.<br/>(bkz: <a class="b" href="/?q=e%c5%9fek+ho%c5%9faftan+ne+anlar">eşek hoşaftan ne anlar</a>)
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    bursalı yamyamlarla birlikte primitif voltron oluşturan gelişmemiş topluluk. hayreti mucip.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    üsküp abi dizinin favori karakteridir.
  entry_channels: tv,magazin
- entry_name: |
    erman toroğlu
  entry_id:  83657490
  entry_writer: perili evin perisi
  entry_fav_count: 0
  entry_content: |
    hıncal uluç olma yolunda hızla ilerlemektedir
  entry_channels: spor,tv
- entry_name: |
    bir kadına söylenebilecek en güzel şey
  entry_id:  83646956
  entry_writer: sapsal cocuk
  entry_fav_count: 0
  entry_content: |
    yalan söylemek. kadınlar çok sever bunu.
