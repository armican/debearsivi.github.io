...
- entry_name: |
    23 mart 2020 işe gidenler
  entry_id:  103994119
  entry_writer: eksimtrack
  entry_fav_count: 82
  entry_content: |
    borcum var gitmeliyim.<br/>önlem olarak ölenler işe gelmesin dendi. büyük şirketin yeri ayrı canım.
  entry_channels: ekonomi
- entry_name: |
...
- entry_name: |
    eba tv'nin kafa kesmeli korkunçlu yapımı
  entry_id:  104020559
  entry_writer: hudri
  entry_fav_count: 46
  entry_content: |
...
- entry_name: |
    rtük'ün tele1 kanalına inceleme başlatması
  entry_id:  104018881
  entry_writer: wowza
  entry_fav_count: 32
  entry_content: |
    mantıksız bir uygulama. televizyona çıkıp şeriat istiyoruz, laikliğe karşıyız denilse hiçbir şey yapılmaz ama birisi çıkıp başörtülü öğretmenden rahatsızlık duyduğunu belirtince hemen ayrımcılık diye soruşturma başlatılsın. böyle saçmalık mı olur? adam küfretmemiş, hakaret etmemiş sadece durumdan duyduğu rahatsızlığı belirtmiş. herkes sizinle aynı fikirde olmak zorunda değil.
  entry_channels: siyaset,tv,haber
- entry_name: |
    czn burak'ın mütevazi evi
  entry_id:  104021498
  entry_writer: lin yallen
  entry_fav_count: 29
  entry_content: |
    (bkz: <a class="b" href="/?q=m%c3%bctevaz%c4%b1">mütevazı</a>)
  entry_channels: magazin
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  104024405
  entry_writer: opus magnumm
  entry_fav_count: 5
  entry_content: |
    yarın patrona yönetime el koyduğumu ve yalnızca kendimi kapsayan genel bi sokağa çıkma yasağı ilan ettiğimi açıklayan bi manifesto göndereyim whatsaap’dan<br/><br/>başlığı açan kaçmış küfür etmeyin oğlum benle bi alakası yok
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    insan hayatı iki oya değer mi lan şerefsizler... inşallah hapisten çıkamazsınız. adalet yerini bulsun, gündemde kalsın.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    tutku, şehvettir ve sevgi, şefkat. <br/><br/>aşk ise; şehvet ile şefkatin aynı kişiye duyulması. tutkulu sevgi demek de çok yanlış olmas öyleyse..
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    dünden beri üzüyor kendileri. bir buçuk senedir tık dememişti halbuki. iki gündür, modemde her şey normal gözüküyor ama internet bağlantısı alamıyorum. oyun ortasında kopuyor bazen ve piç ediyor tüm zevki. kısa sürede normale dönmesini temenni ediyoruz ailecek
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    kanada'dan sonra avustralya'nın da sporcu göndermeyeceği olimpiyatlar. her iki ülkenin olimpiyat komiteleri oyunların 2021'e ertelenmesini istiyor.<br/><br/>4 haftalık süreyi falan boş verin ve şunu erteleyin artık.
  entry_channels: spor
---
