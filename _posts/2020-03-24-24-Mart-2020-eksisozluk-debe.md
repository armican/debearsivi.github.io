...
- entry_name: |
    mehdinin gelmesi
  entry_id:  103989224
  entry_writer: redoano
  entry_fav_count: 322
  entry_content: |
    (bkz: <a class="b" href="/?q=mehdinin+youtuber+olmas%c4%b1">mehdinin youtuber olması</a>)
...
- entry_name: |
  ...
  entry_fav_count: 138
  entry_content: |
    senin derdini sikiyorlar.<br/><br/>edit:<br/>gercek manada merak ediyorsan bak bunu yapiyorlarmis.<br/>(bkz: <a class="b" href="/entry/104027482">#104027482</a>)
...
- entry_name: |
  ...
  entry_fav_count: 123
  entry_content: |
    daha değil. kapitalizmin canı tatlıdır, sadece birazcık topalladı ve derhal sosyalizmin öncü dinamiklerine tutundu. yakın tarihte bunun onlarca örneği var. iyileştiğinde tekrar itip bir kenara atacaktır.
...
- entry_name: |
  ...
  entry_channels: 
- entry_name: |
    ziraatbankası şube personeli ölmek istemiyor
  entry_id:  103999549
...
- entry_name: |
  ...
  entry_fav_count: 8
  entry_content: |
    wikipedia herhangi bir içerik paylaşmıyor, senin benim gibi insanlar paylaşıyor, geliştiriyor, güncelliyor. 500 yıldır wikipedia'nın mantığını anlayamadı koskoca ülke bir de yasakladılar bu yüzden. doğrusu; <a class="b" href="/?q=wikipedia%27da+payla%c5%9f%c4%b1lan+t%c3%bcrkiye+corona+haritas%c4%b1">wikipedia'da paylaşılan türkiye corona haritası</a>.
  entry_channels: sağlık,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    haydarabad yoresel kriket turnuvasini bedava izleyebilecegim icin cok sevincliyim, muhtesemsin bein...
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    1 saat boyunca boş boş konuşup habire ona-buna teşekkür etmesi.
  entry_channels: anket,ilişkiler
- entry_name: |
    ahmet hakan
  entry_id:  104024818
  ...
  entry_fav_count: 4
  entry_content: |
    böyle yalakalık görmedim.<br/>vallahi fahrettin koca açıklamaları böyle sunmadı.<br/>çook çok önemli açıklamalar yapılmış.<br/>ya bi si...
  entry_channels: siyaset,tv,haber
- entry_name: |
    vahşi geyiğin masum köpeği öldürme anı
  entry_id:  104029500
  entry_writer: fesbasimaa
  entry_fav_count: 3
  entry_content: |
    geyik başta ne kadar sempatik ve masum görünüyordu. eski sevgilim geldi aklıma.
  entry_channels: 
- entry_name: |
    şu anda çalan şarkı
  entry_id:  103992239
  ...
  entry_fav_count: 1
  entry_content: |
    o salanikos. uzo yada mastika içerken yunan müziği güzel gidiyor. rakı çok pahalı maalesef<br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=TIEj6QRAq6I">https://www.youtube.com/watch?v=tiej6qraq6i</a>
  entry_channels: anket,müzik
- entry_name: |
    ya istiklal ya ölüm dizisi
  entry_id:  103988586
  entry_writer: kataskoposuolanaziz
  entry_fav_count: 1
  entry_content: |
    üstteki entryinin ufak bir karıştırması olmuş, kronolojik olarak "geldikleri gibi giderler" sözü 13 kasım 1918'de istanbulda ilk işgal olduğunda söylenmiştir.bu işgalde idareye el konulmamıştır.idareye 16 mart 1920'de ikinci işgal ile el konulmuştur(ilk bölümdeki başlangıç tarihi de 1920 yılıdır, paşa da bu yıllarda ankaradadır.)
...
- entry_name: |
  ...
  entry_id:  104029711
  entry_writer: aprilella
  entry_fav_count: 0
  entry_content: |
    o gelmedi ben de gittim
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    abdullah çoban'ı tanırım tahmininizden çok daha donanımlı bir bilim adamıdır, aynı zamanda mühendis kökenlidir.<br/><br/>buldum diyorsa bir bildiği vardır, bence dikkate almaya değer.<br/><br/>biraz değişik bir adamdır, geleceğe dönüşteki profesör gibi ama bilgilidir, <br/>haberdeki fotoğrafına filan da kanmayın bankada hiç yoksa kimya sektöründen kazandığı 10 - 20 milyon euro parası vardır.
  entry_channels: 
---
