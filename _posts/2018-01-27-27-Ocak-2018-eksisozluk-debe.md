...
- entry_name: |
  ...
  entry_fav_count: 21
  entry_content: |
    doğrudan gazinin sözü bu. ajanlıkla, etkiyle, dış güçlerle ne alâkası var anlamadım.<br/><br/>gazi anlatırken yanındakiler bile şaşırdı, tekrar sordular. gazi aynen söyledi.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    kendi fotoğrafını atarak bir çeşit şaka/espri/komik durum yaratmaya çalışan yazar fotoğrafıdır. zerre komik değilsin. yüz kaslarım milim oynamadı. hadi kumda oynamaya devam.
- entry_name: |
...
- entry_name: |
    beşiktaş
  entry_id:  73774526
  entry_writer: iyi cocuk aslinda
  entry_fav_count: 6
  entry_content: |
    borç için demirören'i aratmaktadır demek için ileri derece zeka geriliği olması lazım bir insanın.<br/><br/>kimse kusura bakmasın. arkadaş demirören kadar borç yapıp ancak oraya kocaman bir stad sığdıran, beşiktaş'ın şu ana kadarki en geniş ve kaliteli kadrosunu kuran adama demirören demek saçmalıktır. hataları yok mudur, vardır illa ki. ancak borç konusuna dikkat çekmek için saçma sapan örnekler vermeyin.<br/><br/>borç konusu ciddidir, evet. fikret orman geldiğinde;<br/><br/>dolar kuru 1.7918<br/>euro kuru 2.3736<br/><br/>şimdi;<br/><br/>dolar kuru 3,7497<br/>euro kuru 4,6670<br/><br/>borcun alıp yürümesinin tek sebebi budur. beşiktaş her kazandığını faize geri vermektedir. üstelik bunu yaparken normal faaliyetlerini de devam ettirmek durumunda. ne yapmasını bekliyordunuz? bu adam stad yapmamış olsa geliri artmayacaktı. ama bu borç yine hayvan gibi yükselecekti. işte o zaman haklıydınız. ancak tablo böyleyken ''demirören'i ararız demek'' kepazeliktir. ayık olun az.
- entry_name: |
    arif v 216
  entry_id:  73776681
  entry_writer: ug tek
...
- entry_name: |
    aile arasında
  entry_id:  73762608
  entry_writer: elmali kurabiyeee
  entry_fav_count: 4
  entry_content: |
    son zamanlarda izlediğim en güzel komedi filmi. çok eğlendim. zaten çevremden de sürekli olumlu yorumlar duyuyordum. bir de diğer filmlerde biletler aynı fiyatta satılırken bu filmde kampanya olması dikkatimi çekti. çok ucuz olunca elimdeki indirimli fişi bile kullanmam pahalıya geliyordu.<br/><br/>filmde erdal özyağcılar'ın olmasına ekstra sevindim. kendisi çok beğendiğim biri. filmde de yine çok iyiydi. babasını arif erkin'in oynaması da iyi bir seçim olmuş. uyumlu bulurum kendilerini. bana yabancı damat kadrosunu anımsattı. orada da baba ile oğulu canlandırıyorlardı. gülse birsel'in de yüzünde gözle görülür bir değişiklik vardı. estetikten sanırım. bir de engin günaydın devamlı aynı karakteri oynuyor diyenler var. adamın konuşması gerçek hayatta da öyle. bence filmin en eğlenceli sahneleri de kendisinin olduğu kısımlardı.<br/><br/>kesinlikle gidilmesi gereken, bazılarının aksine küfür etmeden de kaliteli komedi filmi çekilebileceğini gösteren bir film olmuş. umarım seviye böyle böyle yükselir.
- entry_name: |
    nuriye gülmen
  entry_id:  73782842
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    ılık süt gibiydin <br/>sen.<br/>benim ağzımda bir zehir vardı, <br/>beni bu dünyaya ağzımda, <br/>bu zehirle bıraktığında <br/>ben senin kötü olduğunu, <br/>senin kötü olduğunu <br/>anlamamak için, <br/>çok çalıştım.<br/><br/>benim seninle ilgili <br/>bildiğim her şey bir <br/>yalandı. buna çalıştım. <br/>tersinden bir adaletsizliği <br/>anlamam gerekti benim, <br/><br/>ve ben <br/><br/>ben bunun için bir afrikalı gibi<br/>çalıştım.<br/><br/>ılık süt gibi, <br/>ılık süt gibi olduğun, <br/><br/>benim uydurmamdı.
- entry_name: |
    sözlükçülerin iyi ki almışım dediği şeyler
  entry_id:  73775815
  entry_writer: smeagal
  entry_fav_count: 0
  entry_content: |
    tchibo iç çamaşırı
- entry_name: |
