...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    cocuklarinizi dindarlardan koruyun.
...
- entry_name: |
    erkek dediğin kıskanır diyen kadın
  entry_id:  79564574
  entry_writer: komunistsirine
  entry_fav_count: 1
  entry_content: |
    kıskançlıktan ne anladığınıza bağlı.<br/>kıskançlık kısıtlamak değil sahiplenmektir. bu sahiplenme de "ya benimsin ya kara toprağın" anlayışı değil hani derler ya "kem göz" den sevdiğini sakınmaktır. "korumacı" yaklaşımdır. sadece kadın için de değil erkek için de kıskançlık dozunda iyidir. anlayışa göre değişir.
  entry_channels: ilişkiler
- entry_name: |
    özgür güneri
  entry_id:  79562885
  entry_writer: maskeyle maca cikan servet
  entry_fav_count: 0
  entry_content: |
    sorularımızı cevaplamaya gelecek olacak btcturk ceo'su.
...
- entry_name: |
    eva green
  entry_id:  79564658
  entry_writer: azorahai
  entry_fav_count: 0
  entry_content: |
    300 spartalı’daki sevişme sahnesiyle gönüllere taht kurmuş dünyalı. <br/>uğruna son kalan 55 liram ve kartımdaki 13.95 lirayı harcayabilirim. ama varya 2 hafta beklerse kayekam yatıyor çıldırırız.
