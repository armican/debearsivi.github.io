...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    burhan kuzu'nun saçma sapan lozan twiti
  entry_id:  93107776
  entry_writer: chevron
  entry_fav_count: 36
  entry_content: |
    anayasa sözde profesörü burhan kuzu'nun akıllara durgunluk veren saçma sapan lozan antlaşmasıyla alakalı <a rel="nofollow noopener" class="url" target="_blank" href="https://twitter.com/BurhanKuzu/status/1153986089645957122" title="https://twitter.com/BurhanKuzu/status/1153986089645957122">twiti</a><br/><br/>''2.5 milyon kilometre kare olan vatan toprağının,lozan antlaşması ile 780 bin kilometre kareye düşmüştür.sevr anlaşması diye adlandırılan metni osmanlı devleti onaylamadığı için geçerliliği yoktur.üstad kadir mısıroğlu’nun “lozan zafer mi,hezimet mi?” adlı eserini mutlaka okuyun''<br/><br/>öyle bir yazmış ki sanki bu antlaşma yapılmadan önceye kadar osmanlı sınır bütünlüğünü korumuştu da ankara hükümeti sırf savaştan çıkmak uğruna batıya boyun büküp sınırların küçülmesini içeren antlaşmayı imzaladı. bide iddiasını güçlendirmek için örnek verdiği kişiye bak kadir mısıroğlu. <br/><br/>osmanlı devleti lozan'ı değil sevr'i onayladı. yani türklerin geleceğini yok eden türkleri batı boyundurluğuna sokan ve bulunduğumuz topraklarda bizleri kiracı yapan antlaşmayı. lozan antlaşmasına gelene kadar değil osmanlı, anadolu paramparçaydı. atatürk önderliğindeki anadolu halkı örgütlenerek anadolu'yu tekrar birleşti. türklere bir ev inşaa ettiler. o vakte kadar türkler osmanlıdan ayrılan ülkelerin sınırlarında dört bir yana dağılmıştı. milli bir ülke kuruldu. osmanlı'nın padişahların götü tahttan kalkmasın diye sevr'de verdiği anadolu toprakları geri alındı. anadolu halkı elinden gelen herşeyi yaparak 783.000 kilometre karelik vatan toprağı üzerinde egemenlik kurdu. düşman masaya oturdu ve türkiye cumhuriyeti kuruldu. <br/><br/>yani yoktan var edildi. <br/><br/>bu adamın tbmm'nin bahçesinde bile dolaşması bu ülke için utançtır!
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 30
  entry_content: |
    izleyin daha amina kodumun çukur 01 gibi dizilerini. bunlardaki karakterleri fenomen yapın. <br/>ha bu dalyaraklar da bunlara özenip "çatışmaya devam babba" diye gezsinler zaten kafatası içinde margarin taşıyorlar. <br/>aferin abisi aferin.
...
- entry_name: |
  ...
  entry_id:  93107782
  entry_writer: amonyak tuzu
  entry_fav_count: 16
  entry_content: |
    lan abartmayın amk ilgi manyakları sizi.<br/><br/>insan olan verir bu kadar net, ha ben zaten insan değilim hayvanım diyorsan siktir et kaldırma o götü. ayıptır ya ayıp.
...
- entry_name: |
  ...
  entry_channels: bilim
- entry_name: |
    iğreti eden suriyeli hanzolukları
  entry_id:  93101353
  entry_writer: baboli
  entry_fav_count: 6
  entry_content: |
    iğreti ne ulan ayı.<br/>(bkz: <a class="b" href="/?q=irite">irite</a>)<br/><br/>edit: başlık başa kalmış
  entry_channels: anket,tarih
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    koyu koyu koyu koyu koyuveririm dissine,<br/>ölüp gidersin pisi pissine,<br/>yatakta bitler, konuşuyor itler.<br/>pimin ucu bende, gümleme sende.<br/><br/>edit: yeah.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    size pasaport veren memurun, yetmiyor gibi vize verip girmenize izin veren ülkenin sınır güvenliğinin ellerini silkeyim denesi tespit.
  entry_channels: yeme-içme
- entry_name: |
    ilk kez mastürbasyon yapacaklara tavsiyeler
  entry_id:  93114588
  entry_writer: meraxes blackfyre
  entry_fav_count: 0
  entry_content: |
    çıkarabileceğiniz şeylere sokun veya çıkarabileceğiniz şeyleri sokun.
  entry_channels: anket,ilişkiler
- entry_name: |
    blutv
  entry_id:  93100727
...
- entry_name: |
  ...
  entry_id:  93114945
  entry_writer: san marino teknik direktoru
  entry_fav_count: 0
  entry_content: |
    oynanacağı gün özellikle istanbulun avrupa yakası tarafında çekirdek ve kola satışlarının patlama yapacağını düşündüğüm maç.<br/><br/>ayrıca bilenler bilir bayern münchen’ın pek allahı kitabı yoktur dinle diyanetle işi olmaz. heyecanla bekliyoruz.
  entry_channels: spor
---
