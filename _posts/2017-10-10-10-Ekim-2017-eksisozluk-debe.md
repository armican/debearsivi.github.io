...
- entry_name: |
  ...
  entry_fav_count: 396
  entry_content: |
    sağ el ile yazılmış, tamamiyle cenâbet cümlelerden mürekkep ergen beyanatı.<br/><br/>ekleme: savaş, mahallede kavga edince annenin eteğinin altına saklanmaya benzemez evlad. -diyeceğim de mahallede yok ki, kesin hormonlu apartman çocuğusundur.<br/><br/>ekleme iki: (bkz: <a class="b" href="/?q=ats%c4%b1z">atsız</a>)ı oldukça severim. kendisi bir türkçe dâhisi ve uzmanıdır. harika ve lezzetli şiirler yazar. türk coğrafyasında çıkmış (aşırı uçları da olsa) iyi bir türk ve türkçe bilginidir. fakat bu onun hayalperest olduğunu değiştirmez. şiirleri bolca gaza getiren kelimeler içerir; ama ne devir atsız'ın devri ne de ittihat artığı enver paşa fikirleriyle savaş borazanlığı yapma devridir! <br/><br/>(bkz: <a class="b" href="/?q=ne+mutlu+t%c3%bcrk%c3%bcm+diyene">ne mutlu türküm diyene</a>) düstûrü bâkidir fakat (bkz: <a class="b" href="/?q=yurtta+sulh%2c+cihanda+sulh">yurtta sulh, cihanda sulh</a>) ile birliktedir.
- entry_name: |
...
- entry_name: |
    televizyon dalgasının wifi'ye dönüştürülmesi
  entry_id:  71278608
  entry_writer: rxpu
  entry_fav_count: 111
  entry_content: |
    wifi çift yönlü bir dalga, televizyon dalgası ise tek yönlü. bu nedenle tv sinyalini tek taraflı olarak her tarafa dağıtmak nispeten daha basit bir iş, halbuki wifi sinyali her bir alıcı ve verici arasında iletişim sağladığından her bir alıcı ve verici için bir adres ve kodlama gerekli.<br/>büyük bir meydanda bir siyasetçinin 1 milyon kişiye hitap ettiğini düşünün işte bu tv sinyali, aynı siyasetçinin o 1 milyon kişi ile tek tek görüşüp tartıştığını hatta 1 milyon kişinin yine kendi aralarında iletişim kurduğunu düşünün, işte bu da wifi sinyali.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 41
  entry_content: |
    ya siz ne biçim insansınız aq, böyle bir dayak üzerinden seviniyorsunuz. <br/><br/>dayak dediğin eşek sudan gelinceye kadar olur, osmanlı tokadı olur. daha sağlam dövün şu piçleri bir dahakine(:
- entry_name: |
    9 ekim 2017 türkiye'nin abd'ye uyguladığı ambargo
  entry_id:  71276756
  entry_writer: yarali sisman
  entry_fav_count: 40
  entry_content: |
    biz niye böyleyiz ya diye düşündüren ambargodur.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 19
  entry_content: |
    eğer korunuyorlar ise sevişmelerinde bir beis görmediğim çiftlerdir.<br/><br/>zira batan geminin malları giderek pahalanıyor. bir bebeğin sadece bokunun temizlenme masrafı bile o kadar ciddi meblağlara ulaşıyor ki aklınızı oynatırsınız.<br/><br/>kamu spotu: korunun.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    kutsal bilgi kaynağı dediler müptezel kaynağı çıktı.<br/>(bkz: <a class="b" href="/?q=ek%c5%9fi+s%c3%b6zl%c3%bck">ekşi sözlük</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    sozu soyleyen sahsin iki cumlesi dikkat cekmistir:<br/><br/>"bati yine deneyecek" <br/><br/>"türkiye bulunduğu bölgenin en güçlüsü olacak"
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    --- <a class="b" href="/?q=meyan+k%c3%b6k%c3%bc+%c5%9ferbeti+tarifi">meyan kökü şerbeti tarifi</a> ---<br/><br/>malzemeler:<br/>• meyan kökü<br/>• 1 çay kaşığı karbonat<br/>• 2-3 tane karanfil<br/>• 1 kabuk tarçın<br/>• 1 litre su <br/><br/>yapılışı:<br/>bir avuç meyan kökünü bez bir torbaya yada süzgece koyun. içine karbonat, karanfil ve tarçını ilave edin. en son olarakta 1 litre suyu ekleyip 2-3 saat boyunca demlendirin. demlenen şerbeti süzüp buz ilave ederek soğuk olarak servis edin.<br/><br/>afiyet olsun.<sup class="ab"><a title="(bkz: copy-paste yapmanın dayanılmaz hafifliği)" href="/?q=copy-paste+yapman%c4%b1n+dayan%c4%b1lmaz+hafifli%c4%9fi" data-query="copy-paste yapmanın dayanılmaz hafifliği">*</a></sup><br/><br/>--- <a class="b" href="/?q=meyan+k%c3%b6k%c3%bc+%c5%9ferbeti+tarifi">meyan kökü şerbeti tarifi</a> ---
- entry_name: |
