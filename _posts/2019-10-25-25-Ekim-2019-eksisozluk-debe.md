...
- entry_name: |
  ...
  entry_channels: haber
- entry_name: |
    24 ekim 2019 surinam ile vizelerin kalkması
  entry_id:  96929210
  entry_writer: super kahraman donu
  entry_fav_count: 38
  entry_content: |
    aklıma surinam asıllı hollandalı topçuları getirmiştir.<br/><br/>(bkz: <a class="b" href="/?q=clarence+seedorf">clarence seedorf</a>)<br/><br/>biz de denesek mi acaba surinam asıllı futbolcu
...
- entry_name: |
  ...
  entry_fav_count: 22
  entry_content: |
    türkiye'nin suriye savaşında yaptığı en büyük hata ve kaçırdığı en büyük fırsat kobani. bütün dünya'nın desteği kazanılabilir, ülke içindeki kürt vatandaşa devletin kürtlerin de devleti olduğu mesajı verilebilirdi. ışid'den savunulan toprak olduğu için operasyonun meşruiyeti tartışılmaz olurdu. ama devletimiz ne yaptı? kürt düşmanlığından, mezhepçilikten olsa gerek "kobani düştü düşecek" deyip ellerini ovuşturdu. sonra baskıya dayanamayıp peşmergeyi sınırların içinden geçirdi. güneyde kurulacak olan kürt devletinin en büyük mimarı ne abd ne rusyadır. türkiye cumhuriyedir.
...
- entry_name: |
  ...
  entry_fav_count: 20
  entry_content: |
    gerizekalı algısıdır. etrafımda onlarca şekersiz çay içen insan var, hiç kimsenin umurunda değil bu durum. şekerli içen, şekeri iade ediyoruz diye övgü bekliyoruz sanıyor. durum bizden değil ki tatlım, tamamiyle sizin salak algınızdan. övgü bekleyen yok yani.
  entry_channels: anket,sağlık,yeme-içme
- entry_name: |
    türk futbolunun en fiyasko 3 transferi
  entry_id:  96929227
  entry_writer: tibetderetarla
  entry_fav_count: 19
  entry_content: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    -bir daha da atlar mıyım? bakacaz.
  entry_channels: 
- entry_name: |
    z kuşağındaki aptallıkta ısrar motivasyonu
  entry_id:  96923198
  entry_writer: hhey joe
  entry_fav_count: 6
  entry_content: |
    z’lerle sürekli içli dışlı olan biri olarak tespitlere katıldığım başlıktır. <br/>bugün z lerin yine dersindeyim. dersin 30. dakikası kapı açıldı,eleman sallana sallana sırasına yürümeye başladı. ilk başta zil çaldı sandım. kurs olduğu için zilden sonra çok sallamıyorum gireni çıkanı. <br/>baktım daha zile var. verdim veriştirdim kovdum elemanı sınıftan. <br/>ders bitti kapıda bekliyor çocuk. heralde hocam kusura bakmayın falan diyecek diye içimden geçiriyorum. hiç tık yok öyle mal gibi bekliyor. <br/>bu çocuk öyle aykırı bir tip de degil. standart düzgün çocuk diyebileceğimiz tiplerden. ama ya düşünemiyorlar ya düşünmek istemiyorlar. bir üşengeçlik çökmüş üstlerine her şey zor geliyor. tanıdığım 10 adamdan 7’si böyle.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  96952152
  entry_writer: mahmut abi ben geldim
  entry_fav_count: 0
  entry_content: |
    evet arkadaşlar , başlıktan da anlaşılacağı üzere bir üstteki yazara kitap önerisinde bulunalım . okunur mu okunmaz mı bunu bilemeyiz ama en azında kıyıda köşede kalmış , belki adını sanını hiç duymadığımız kitapların , yazarların isimlerini öğreniriz . araştıracak , alacak , okuyacak vs. kişiler olacaktır elbet. bu başlığı okuyanlar için de faydalı olacağını düşünüyorum . hadi o zaman ilk bana gelsin kitap önerisi .
  entry_channels: 
- entry_name: |
    çocukken sahip olunan lakap
  entry_id:  96952588
  entry_writer: layer luna
  entry_fav_count: 0
  entry_content: |
    "acı"<br/>tatlı denilemeyecek kadar yaramaz bir çocuk olduğum için her fırsatta camdan kafasına tükürdüğüm yetişkin komşumuz tarafından üzerime yapıştırılmıştı. çok şükür büyüdüm kurtuldum.
  entry_channels: anket,ilişkiler
- entry_name: |
    oğuzhan özyakup
  entry_id:  96951320
