...
- entry_name: |
  ...
  entry_fav_count: 330
  entry_content: |
    a haber sunucusu kadının o saatte fransa'da ne işi varmış?<br/>hayal mahsulü bir iddiadır.
...
- entry_name: |
    bira bardağında rakıyı fondip yapan kız
  entry_id:  96934599
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    fanta'yı kim içiyor sorunsalı
  entry_id:  96918977
  entry_writer: dara xweziya sin nabe
  entry_fav_count: 34
  entry_content: |
...
- entry_name: |
  ...
  entry_channels: anket,ilişkiler
- entry_name: |
    5 metre yükseklikten spor amaçlı atlamak
  entry_id:  96952570
  entry_writer: 260611
  entry_fav_count: 14
  entry_content: |
    ne çok kamera varmış amına koyduğumun yerinde. derbilerde golün tekrarında bile o kadar değişik açı yok.
  entry_channels: spor
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    yaşamın gereksizce uzun olması
  entry_id:  96947511
  entry_writer: taegutec
  entry_fav_count: 11
  entry_content: |
    vatandaşa ötenazi hakkı tanınmalıdır.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    pas oyununu her macta gelip senin basligin altinda s.kecegim hoca. takimin anasini s.ktin pas pas pas pas baska bi bok yok
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    topuza bakmadan vites değiştirme becerisi ile erkeklik arasında bağlantı kuran kişi vurduruyordur.
  entry_channels: 
- entry_name: |
    caner erkin
  entry_id:  96954120
...
- entry_name: |
  ...
  entry_channels: spor
- entry_name: |
    entry'lerini okumak beni heyecanlandırıyor
  entry_id:  96952006
  entry_writer: kentbozukcalari
  entry_fav_count: 1
  entry_content: |
    başlığı görünce heyecanlandım. umarım senin için yeterli olur.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    dumbo...dumbo nedir yahu? şimdiki halimi bilseler bu lakabı takarlar mıydı bana?
  entry_channels: anket,ilişkiler
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=ilk+m%c3%bcsl%c3%bcman">ilk müslüman</a>)<br/>(bkz: <a class="b" href="/?q=lesley+hazleton">lesley hazleton</a>)<br/>agnostik bir yahudinin (ırk olarak) gözünden hz. muhammet’in hayatı.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    penaltı atarken kaleci yerine topa bakan mal !
  entry_channels: spor
---
