...
- entry_name: |
  ...
  entry_fav_count: 27
  entry_content: |
    (bkz: <a class="b" href="/?q=you+blow+my+mind">you blow my mind</a>)<br/><br/>aklımı başımdan alıyorsun.<br/><br/>şarkısı bile var.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/Wt88GMJmVk0" title="https://youtu.be/Wt88GMJmVk0">let me blow your mind(aklını başından almama izin ver)</a>
- entry_name: |
    galatasaray
  entry_id:  74923637
...
- entry_name: |
    kalp ile akıl çatışması
  entry_id:  74912632
  entry_writer: luckdown
  entry_fav_count: 20
  entry_content: |
    her zaman kalbin kazandığı, aklın ve senin kaybettiğin çatışmadır. <br/>kalbin umudu ve olasılığı savunur. aklın ise her zaman seni. umut ve olasılıklar her zaman daha parlaktır.
- entry_name: |
    aykut kocaman
  entry_id:  74923617
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    evet yediği golde elini çekti. yarış atı verdik, satın aldık. "penaltıyı kurtar, girdiğimiz bütün pozisyonları kurtar ama 87. dakikada bir şut çekeceğiz onu bilerek ye serkan, öylesi daha ekşın olur" dedik. <br/><br/>eee türkiye'de şike serbestti nasıl olsa? yakalansak bile en fazla "kupayı iade ediyoruz" deyip kolpadan şov yaparız, birkaç ay sonra başbakan araya girer, "deliller hukuksuz toplanmış" der, yeniden yargılatır... sonunda beraat kararı hoppala ve de cuppala. <br/><br/>bugüne kadar yapmamamız hataydı zaten. topu sahada oynayalım diye uğraşıp boşu boşuna yorduk kendimizi.
- entry_name: |
    jet sosyete (dizi)
  entry_id:  74935945
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    'ırmaklarından şaraplar akacak' diyorsun<br/>cennet-i alâ meyhane midir?<br/>'her mümin'e iki huri' diyorsun<br/>cennet-i alâ kerhane midir?<br/><br/>ömer hayyam’ın “şarap” şiirinden.
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    (bkz: <a class="b" href="/?q=medieval+2+total+war">medieval 2 total war</a>)
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    yıllar sonra gassaray'ın kadıköy'de kazanmaya en yakın olduğu maç. bunu bir fenerli olarak net söylüyorum. bu maç belki de bizim için milad olacak. bu mağlubiyet aziz ve o aşortmanlıdan kurtulma sebebi olabilir. eğer bu beladan kurtulacaksak neden olmasın?
- entry_name: |
    en lezzetli ikili
  entry_id:  74936379
  ...
  entry_fav_count: 0
  entry_content: |
    bulgur pilavı ve kornişon turşu.
- entry_name: |
    ailecek şaşkınız
  entry_id:  74929601
  ...
  entry_fav_count: 0
  entry_content: |
    vaktinize yazik dedigim filmdir.
- entry_name: |
