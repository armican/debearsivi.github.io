...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    birini tanıyamadıysan,<br/>kimin ve neyin peşinde olduğuna bak! anlarsın...<br/><br/>hz. mevlana
- entry_name: |
    börü
  entry_id:  75034326
...
- entry_name: |
    pelin çift trt'den kovulsun kampanyası
  entry_id:  75027018
  entry_writer: hidrolikrotrecan
  entry_fav_count: 8
  entry_content: |
    pelin çift trt'den kovulmaz, trt pelin çift gibilerin cirit attığı bir yer zaten. kovacaklarsa trt'nin tüm çalışanlarını kovmaları gerekir ki kimseye hak geçmesin.
- entry_name: |
    vagner love
  entry_id:  75036079
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    <a class="b" href="/?q=14+mart+2018+be%c5%9fikta%c5%9f+bayern+m%c3%bcnih+ma%c3%a7%c4%b1">14 mart 2018 beşiktaş bayern münih maçı</a> ilk golu attirip ikinci golu atmasiyla fenerbahce efsanesi besiktas kestanesi olmustur.<br/><br/>edit: 3. golde de aslan payini almistir.
- entry_name: |
...
- entry_name: |
  ...
  entry_content: |
    du bakalım
- entry_name: |
    13 mart 2018 istanbul su kesintisi
  entry_id:  75015948
  entry_writer: spr
  entry_fav_count: 1
  entry_content: |
    altyapısını hala tamamlamaya çalışan şehirde görülen kesintidir.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    30 yaşın çok üzerinde işi de olmayan insan diye düzeltilse aralarına gireceğim insanlar topluluğu.
---
