...
- entry_name: |
  ...
  entry_fav_count: 72
  entry_content: |
    centilmenliği, efendiliği ve nezaketi, ikiyüzlülük ve yumuşak başlılık sanan embesiller var. ali koç’u yolda görse ceketini ilikleyecek adamlar anonim olarak buradan sallıyor.<br/><br/>ha bu arada; kebapçıda dayak yiyip geri vites yapan imparatorunuzu siz bence çok da büyütmeyin.
...
- entry_name: |
    kadın düşmanlığı başlıklarının artarak çoğalması
  entry_id:  82975432
  entry_writer: aparkat hamdi
  entry_fav_count: 32
  entry_content: |
    kadinin magduriyetinin istismar edilmesi amerika'da trump tayfasi tarafindan bitirildi. buna ecnebiler magduriyetin silahlastirilmasi diyor. <br/><br/>brett kavanaugh davasinda bir ornegi goruldu bunun. artik o bana bunu yapti deyip bi insani mahkemeye verip tum kariyerini yerle bir edemiyorsunuz. <a class="b" href="/?q=hard+evidence">hard evidence</a> dedikleri elle tutulabilir kanit gerekiyor.<br/><br/>turkiye de politikalarinin tamaminda amerika etkisi altinda olan bi ulke olarak ayni yoldan gidiyor. gitmeli de. kimbilir kac kisinin cani haksiz suclamalarla yandi. bi tarafi desteklerken diger tarafi magdur ederseniz kavga bitmez. kavganin bitmesi icin adil cozum sarttir.<br/><br/>(bkz: <a class="b" href="/?q=weaponized+victimhood">weaponized victimhood</a>)<br/><br/>edit: <a class="b" href="/?q=cicimici">cicimici</a> isimli yazarin bana ozelden konuyla ilgili cevabi; 'gerizekali, siz ancak tecavuz edin, kadin dövün, medeniyetsiz' vs. <br/><br/>iste fikrini duzgun bir sekilde anlatan herkese gerizekali tecavuzcu falan diyebilme hakkiniz oldugunu dusundugunuz icin feminizmin ici bosaldi ve hic bir yere gidemiyor. tam bir <a class="b" href="/?q=cringe">cringe</a> akimi.
  entry_channels: ekşi-sözlük
- entry_name: |
    0.5 euro'ya kıta değiştirip vık vık ötmek
  entry_id:  82994048
  entry_writer: nickachu
  entry_fav_count: 31
  entry_content: |
    (bkz: <a class="b" href="/?q=jeopolitik+trol">jeopolitik trol</a>)
...
- entry_name: |
    ankaragücü
  entry_id:  82984656
  entry_writer: medeline
  entry_fav_count: 8
  entry_content: |
    takım döktürüyor maşallah ama bir göğüs sponsorumuz yok amk.
  entry_channels: spor
- entry_name: |
    içime boşal
  entry_id:  82997400
  ...
  entry_fav_count: 6
  entry_content: |
    (bkz: <a class="b" href="/?q=konu%c5%9fan+du%c5%9fakabin">konuşan duşakabin</a>)
  entry_channels: ilişkiler,sağlık
- entry_name: |
    ekşi itiraf
  entry_id:  82969211
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    duyarlı müslüman bir kadını çok rahatsız etmiş. <br/>bunun bir sorun olduğunu ve ancak finlilerin kitlesel göçüyle bu sorunun çözülebileceğini iddia ediyor üstelik.<br/><a rel="nofollow noopener" class="url" target="_blank" href="https://twitter.com/MarkACollett/status/1058334174006910976" title="https://twitter.com/MarkACollett/status/1058334174006910976">https://twitter.com/…ett/status/1058334174006910976</a>
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    istanbul dışından hiçbir kızla görüşmemek.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    hahaha daha dün fb yönetiminin açıklamasına “vizyon akıyo len qardeşim” “taşı gediğine oturtan başkanımız var mq” diyen arkadaşlar gelmiş buraya. <br/>ultraslan’a cevapları da sadece ama sadece sucuk ekmek konusu. siz koçsanız, bizde çobanız. minyatür azizciler sizi.
  entry_channels: spor
- entry_name: |
    o ses türkiye
  entry_id:  82980526
