...
- entry_name: |
    askerlere akıllı telefon yasağı getirilmesi
  entry_id:  74141855
  entry_writer: ristretto bianco
  entry_fav_count: 68
  entry_content: |
    21 yaşındaki gencecik çocuklara askerlik yasağı getirsek nasıl olur? <br/><br/>türk milleti askerliği böyle öve öve bitiremez, ama askerleri yemekten zehirlenip ölür, <br/>eğitim diye toplasan 50 defa ateş etmez, karakol baskınında pisi pisine ölür, <br/>üstüne uygun kamuflaj verilmez bol kıyafetle gezer, <br/>ayağına uygun bot verilmez ayakları mahvolur, <br/>hasta olur revirde tabib yüzbaşıdan azarı yeyip eğitime devam eder, <br/>sabun verilmez tabldotlardaki yağı temizleyemez,<br/>saç traşı diye kafası paslı makineyle sıfıra vurulur eşek götü gibi gezer,<br/>.<br/>.<br/>.<br/><br/>en büyük asker bizim asker, ertesi gün istikamet geriniz **** yediniz imzalı tuvalet kapısına bakarken bulursun kendini....
- entry_name: |
    türkiye iran ve rusya abd'yi vursun
  entry_id:  74145812
  entry_writer: madonnanin yagli zencisi 2
  entry_fav_count: 66
  entry_content: |
    (bkz: <a class="b" href="/?q=vurursunuz+eyvallah+da+%c3%b6lmezsem+s%c4%b1k%c4%b1nt%c4%b1+b%c3%bcy%c3%bck">vurursunuz eyvallah da ölmezsem sıkıntı büyük</a>)
- entry_name: |
    özgecan aslan
  entry_id:  74140174
  entry_writer: paluka
...
- entry_name: |
    afrin'deki iran-ypg koalisyonu
  entry_id:  74148102
  entry_writer: psikopatkoala
  entry_fav_count: 27
  entry_content: |
    başlık sahibi bir iddia ortaya atmış, topladığı belgeleri (iran'ın ypg ye verdiği silahlar,iran devlet televizyonu yayınları, hükümet açıklamaları vs) linkleriyle ispatlarıyla başlığa taşımış. <br/><br/>öküzün teki de gelmiş, iran'ın ypg yi desteklemediğini kanıtlayacak en azından kendi çapında belgeler sunmadan "bir malın iddiasıdır vs" diye çapsız çapsız konuşmuş. işte ekşi sözlüğün genel profili bu şekildedir. biri bir şeyleri araştırır, belge sunar,emek verir,bunun gibi angutlar da "swh", "başlıkları engelle" diyerek, ya da olaya bir bakış açısı dahi getirmeden küfür edip giderler.
- entry_name: |
...
- entry_name: |
    suriyelileri eğitin ülkeleri için savaşsınlar
  entry_id:  74150656
  entry_writer: curvaturkey
  entry_fav_count: 15
  entry_content: |
    plajlarda nargile içen, hastanelerde bedava tedavi olan suriye'liler gitsin savaşsın. yeter başkalarının topraklarında öldüğümüz. gitsinler savaşsınlar. doğru söylemiş gandi.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    kontrat zamanları coşan nba oyuncularını benzedi iyice. başkanım beni al, manu beni istiyor diye yakında yine başlar. adam ligin ilk yarısında ligde sadece 3 gol atabilmiş. şampiyonlar liginde ise vitrini beğenince 6 maçta 4 golü var; ikinci yarıda da baktı kontrat zamanı yaklaşıyor yine coştu paşamız. <br/><br/>böyle yetenekli bir futbolcunun iyi yaptığı işe ihanet etmesini anlamıyorum. biraz kendisini futbola vermeye başladı ikinci yarıda, bursaspor maçında adam markajından kurtulamadığından etkili olamadı ama 4 maçta 6 golü var. konyaspor maçında ise kendisini bayern deplasmanına saklarsa sahada hayalet gibi dolanmasını izleyebiliriz, alabileceği topa bile ayağını uzatmayadabilir ama bir anda şapkadan çıkarıp inanılmaz bir gol de atabilir. çift taraflı bıçak gibi adam.
- entry_name: |
