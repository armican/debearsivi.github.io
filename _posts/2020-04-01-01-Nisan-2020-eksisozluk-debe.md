...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    ronaldinho’nun üzerine kimseyi tanımam. bazı teknik futbolcular vardır alır çalım atar, etrafında döner vs ama skora ya da takım oyununa katkı sağlamaz. fizik olarak da sağlam değilse plaj ya da salon futbolcusu muamelesi görür. ama ronaldinho hem seyir zevki hem katkı hem yaratıcılık bakımından zirvedeydi benim gözümde.
  entry_channels: spor,anket
- entry_name: |
    bekarlar karantinada ne yapıyor sorunsalı
  entry_id:  104505404
  entry_writer: karameseli
  entry_fav_count: 5
  entry_content: |
    <a class="b" href="/?q=siz+benim+neler+%c3%a7ekti%c4%9fimi+nereden+bileceksiniz">siz benim neler çektiğimi nereden bileceksiniz</a>
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    öncelikle adettendir. <br/>(bkz: <a class="b" href="/?q=kokore%c3%a7%c3%a7i+hilmi+kim+amk">kokoreççi hilmi kim amk</a>)<br/><br/>kimsenin işi, itibarı, etnik kökeni falan umrumda değil. ayrıca mesleğine "bok temizlemek" diyenleri de kınıyorum. kişiden bağımsız olarak, binlerce kokoreççi var, hepsine gitmiş oluyor bu mesnetsiz sözleriniz. <br/><br/>ancak gerçekten toz duman dağıldığında, şimdi tehditler savuran, hakaretler eden tiplerin yargılanmasını keyifle izleyeceğim. bakalım birilerine biat etmediğini kanıtlamak için ne taklalar atacaklar.
...
- entry_name: |
  ...
  entry_id:  104506144
  entry_writer: kutuptaki vaha
  entry_fav_count: 2
  entry_content: |
    <a class="b" href="/?q=%c5%9fah%c4%b1slar%c4%b1n+efendisi">şahısların efendisi</a>
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    doğru kişiden gelmediği sürece fazla önemsemiyorum.
  entry_channels: ilişkiler,ekşi-sözlük
- entry_name: |
    karantina sırasında diş ağrısı
  entry_id:  104505179
  entry_writer: spontan adam
  entry_fav_count: 0
  entry_content: |
    dişi ağrıyan arkadaşlar şifanız bende. size amme hizmeti vereyim, hastanelere gitmeyin şu zamanda.<br/><br/>ağrınızi dindirmek için: ağrıyan dişiniz ağız içindesağ taraftaysa elinize bir parça buz alın ve sağ elinizin perdeli kısmına 10 dakika sürün. isaret ile baş parmak arasına yani. (diş soldaysa sol elin perdeli kısmı). dediğim gibi 10 dakika içinde acı hafifletecektir. <br/><br/>haa sonra gelin teşekkür edin. :)
  entry_channels: sağlık
- entry_name: |
    ilk dinleyişte aşık olunan şarkılar
  entry_id:  104482273
  entry_writer: nalaka olm
  entry_fav_count: 0
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://open.spotify.com/track/6fts1XbxJmnSxPShuQtJo4?si=4MoERdQnQzev7301bKqyBg" title="https://open.spotify.com/track/6fts1XbxJmnSxPShuQtJo4?si=4MoERdQnQzev7301bKqyBg">yeniden</a>
