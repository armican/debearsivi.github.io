...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    bein sports'ta kadın spiker dönemi
  entry_id:  97018706
  entry_writer: o2ke
  entry_fav_count: 344
  entry_content: |
    evet loris karius bugün çok yakışıklı.
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    ağzına kürekle vurulası ergen bir kızın şu anda yarıştığı yarışmadır. <br/><br/>eskiden bilgi yarışması olan bu programın soytarı yarışması haline gelmesinde emeği geçen herkesin allah belasını versin.
  entry_channels: tv
- entry_name: |
    fenerbahçe
  entry_id:  97020672
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    kendisi müsait mi acaba? bilen var mı? <br/><br/>ahahahahahah
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    kesinlikle..<br/>üniversite personeli de unutulmasın.. o da öğretmen aslında.. çok da ayırmamak lazım.
  entry_channels: 
- entry_name: |
    yazarların bu akşamki alkol tercihi
  entry_id:  97031390
  entry_writer: purpulacielo
  entry_fav_count: 2
  entry_content: |
    rakı arkadaşlar. 3 haftadır günde ortalama 14 saat çalıştım. tatil günüm yoktu. bugün artık telefonumu kapatıp saat 4'te kendimi meyhaneye attım. çalışmaktan aklımızı mı kaçıralım? pamuk gibiyim şimdi. hepinize tatlı hafta sonları.
  entry_channels: anket,ekşi-sözlük,yeme-içme
- entry_name: |
    thiago motta'nın 2-7-2 taktiği
  entry_id:  97031892
...
- entry_name: |
    şu anda çalan şarkı
  entry_id:  97028452
  entry_writer: patetesliketcap
  entry_fav_count: 1
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=tGJTG-JfDrU" title="https://www.youtube.com/watch?v=tGJTG-JfDrU">birsen tezer-nefes</a>
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    cumartesi gecesi evde oturup örgü ören ezik ve yalnız ve hasta insan olarak bütün acımalarınızı kendime çekiyorum.
  entry_channels: anket,ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    max yarış başında uçmazsa o uzun düzlükte ferrarilerin ilk tur performansına karşı işi zor, kaza da olabilir, yarışın ortasında yağmur da olacak, gezegenler insanlık tarihinin en şanslı insanı hamiltonu birinci yapmak için sıralanmış gibi gözüküyor.
  entry_channels: spor
---
