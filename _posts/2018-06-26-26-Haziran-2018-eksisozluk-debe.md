...
- entry_name: |
  ...
  entry_channels: siyaset
- entry_name: |
    ekonominin hiç de kötü olmaması
  entry_id:  78503076
  entry_writer: delimine
  entry_fav_count: 44
  entry_content: |
    (bkz: <a class="b" href="/?q=hi%c3%a7+de">hiç de</a>)<br/>türkçeden haberi yok, ekonomi analizi yapmaya çalışıyor yazık kimin çocuğuysa.<br/><br/>edit: başlığı açan "hiçte" diye açmıştı, taşınmış doğru yazılışına. ibret-i alem için dursun bu entri.
  entry_channels: ekonomi
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 18
  entry_content: |
    eksiyi ozune donduren kadindir.<br/>baslasin cinsel seksli basliklar.
  entry_channels: ilişkiler
- entry_name: |
    bedelli askerlik
  entry_id:  78476578
...
- entry_name: |
    izmir
  entry_id:  78504567
  entry_writer: probiyotik
  entry_fav_count: 5
  entry_content: |
    ben izmir olsam eyalet olurdum bu çağda..
...
- entry_name: |
    westworld
  entry_id:  78478908
  entry_writer: penguenleri severim
  entry_fav_count: 2
  entry_content: |
    dizi tarihinin en iyi bölümlerinden biri ile sezon finali vermiş olan sanat eseri.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    trt 1'de neden yayınlanmadığını anlamadığım maç. iki takımın da gruptan çıkma ihtimali var. <br/><br/>trt 1'den yayınlanacak ispanya-fas maçında fas'ın çıkma ihtimali yok.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    3 yaşında ki kızım için süreki yaparım. mağaza çalışanları artık "gene geldi deneyip deneyip almayanlar"der gibi bakıyorlar suratımıza.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://twitter.com/bulendecevit/status/1011182623631269888?s=21" title="https://twitter.com/bulendecevit/status/1011182623631269888?s=21">şu yazılanlar</a> neden başarılı olmadığının demosu olan parti. chp yalnızca imajı kötü değil, organizasyonu da çok başarısız bir parti. nasıl güneydoğu'dan yeterince veri gelmediğini analiz edemeyip ince'yi seçim gecesi boyunca muğlakta bırakırlar? ya erdoğan'ın dediği gibi koyun güdemeyecek kadar beceriksizler ya da kötü niyetli. iki durum da birbirinden kötü. <br/><br/>muhalefete muhalefet eden tiplere her zaman uyuz olmuşumdur ama ince, yarattığı sinerjiyle chp'nin iyi bir portansiyeli kötü kullandığını gösterdi. zaten oy vermeye başladığımdan beri hep memnuniyetsizce chp'ye verdiğim için bir alternatif görür görmez iyi parti'ye verdim. chp'nin akp'yi istemeyen standart 21. yüzyıl insanlarından oluşan türklerin mecburi toplanma noktası haline gelmesi maalesef en büyük şanssızlıklarımızdan biri.
  entry_channels: siyaset,haber
- entry_name: |
