...
- entry_name: |
    t c 1. başkanı recep tayyip erdoğan
  entry_id:  78506466
  entry_writer: birazdurupgidicem
  entry_fav_count: 37
  entry_content: |
    t.c 1.başkanı için (bkz: <a class="b" href="/?q=mustafa+kemal+atat%c3%bcrk">mustafa kemal atatürk</a>)
  entry_channels: siyaset
- entry_name: |
    kemal kılıçdaroğlu
  entry_id:  78465355
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    ailesi ile yaşayan kadın mutsuzluğundan daha azdır.<br/>gönül ister ki 30 yaşındaki her kadınımız tek yaşasın.<br/><br/>ama ne yazık ki;<br/>sabah akşam "efendim anne"
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_channels: siyaset
- entry_name: |
    mağazada deneyip webden satın almak
  entry_id:  78505856
...
- entry_name: |
    ince'nin cumhurbaşkanlığı yardımcılığına oynaması
  entry_id:  78506679
  entry_writer: napsak inansakmi
  entry_fav_count: 10
  entry_content: |
    torbacının numarasını versene.
  entry_channels: siyaset
- entry_name: |
    ekşi itiraf
  entry_id:  78472146
...
- entry_name: |
  ...
  entry_channels: siyaset,anket
- entry_name: |
    kafire rahmet okunmaz
  entry_id:  78503915
  entry_writer: fedelatte
  entry_fav_count: 6
  entry_content: |
    sen allah mısın? merhumun kafir olduğunu nerden biliyon. demek ki sen şirk koşan bir münafıksın ve katlin vacip. girişelim mi sana şimdi dallama?
  entry_channels: 
- entry_name: |
    belki de biz yanlışız
  entry_id:  78505844
  entry_writer: dont judge me im an advertiser
  entry_fav_count: 4
  entry_content: |
    bu sabah kafalarda beliren soru. <br/><br/>ama bu soruyu kendimize sorma nezaketini gösteriyor olmamız bile bence yanlış olmadığımızı gösteriyor. kendimizi sorgulayacak kadar hala bilinçliyiz en azından. şaşırtıcı ki bunca olana rağmen bir yanlışa saplanıp kalmaktan korkacak kadar aklımız yerinde hala. işte tam da bu yüzden bunca yanlışın içinde eriyip gitmeyelim, boyun eğmeyelim, susmayalım. atatürk mezarında ters döndü yemin ederim ya, bari ona olan vefa borcumuz için doğrularımıza, doğru bildiklerimize sahip çıkalım.
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    bu maçın trt spor'dan, <a class="b" href="/?q=25+haziran+2018+ispanya+fas+ma%c3%a7%c4%b1">25 haziran 2018 ispanya fas maçı</a>nın trt'den yayınlanmasının sebebi, ispanya maçının daha zevkli olma ihtimalinin yüksek olmasıdır.<br/><br/>euro 16'yı portekiz kazandı, portekizliler dahil kimsenin hafızasında tek bir maç kalmamıştır, öyle boktan top oynuyorlar.<br/><br/>not: böyle dedim ya, maç kesin 8-4 filan biter.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    (bkz: <a class="b" href="/?q=borderline+ki%c5%9filik+bozuklu%c4%9fu">borderline kişilik bozukluğu</a>)
  entry_channels: siyaset,anket,haber
- entry_name: |
    muharrem ince'nin erdoğan'ı tebrik etmesi
  entry_id:  78504741
  entry_writer: ataman bogdan khmelntsky
  entry_fav_count: 2
  entry_content: |
    oldukça erdemli bir davranışı, kendisine yakışanı yapmıştır.
  entry_channels: siyaset
- entry_name: |
    ince'nin demirtaş yüzünden seçimi kaybetmesi
  entry_id:  78505625
  entry_writer: dickhead duru
  entry_fav_count: 2
  entry_content: |
    "milliyetçilik anlayışıyla kurulan ve üniter devleti benimseyen atatürk’ün partisi"nden fazla oy almıştır.<br/><br/>(bkz: <a class="b" href="/?q=geri+zekal%c4%b1lar%c4%b1+ni%c3%a7in+engellemeliyiz">geri zekalıları niçin engellemeliyiz</a>)
  entry_channels: siyaset
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/8CB9KY1p8uo" title="https://youtu.be/8CB9KY1p8uo">sorarım sana, sayın...</a>
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    cam damacana alıp onu da evdeki cam şişelere doldurup dolaba koyarak tüketerek dahil olduğumuz grup.<br/>lakin beyaz yakalı değiliz , mavi yakalıyız , asgari ücretin biraz üzerinde bi gelirimiz var fakat gelirimizi sağlığımıza uygun ama malesef nispeten pahalı ürünler alıp, gereksiz harcamaları kısarak harcıyoruz.<br/>çevremiz, kendimiz ve geleceğimiz için.
  entry_channels: sağlık,yeme-içme
- entry_name: |
    yağmur ve kapalı hava seven insan
  entry_id:  78502375
  entry_writer: hammer off
  entry_fav_count: 0
  entry_content: |
    müziklerin ve filmlerin efendisidir. tadını alabilen anladı bunu.
  entry_channels: anket,ilişkiler
- entry_name: |
    ileride devlet bahçeli nasıl hatırlanacak
  entry_id:  78506619
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    kapatılmasının zamanı çoktan gelmiştir. zaten sağ seçmenin de oyunu alacam diye diye var olan oylarını da erittiler. %30 kemik oyu vardı %22'lere kadar düştü. <br/><br/>git dyp ol anap ol ama ben chp'yim diye dolaşma ortalıkta.
  entry_channels: siyaset,haber
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=ziki">ziki</a>)
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    levent özçelik, maçın başından beri gereksiz averaj ve kart hesaplarıyla kafa ütülüyor.
  entry_channels: spor
---
