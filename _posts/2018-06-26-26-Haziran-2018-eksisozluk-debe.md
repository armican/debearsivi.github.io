...
- entry_name: |
  ...
  entry_channels: siyaset
- entry_name: |
    tc 1. başkanı recep tayyip erdoğan
  entry_id:  78506466
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    temelde akıl sağlığı yerinde olmayan topçuları çok seviyorum, ayrıca negredo filan olacak iş değilmiş, gördük. <br/><br/>gel lan sığır, özledim seni.
  entry_channels: spor
- entry_name: |
