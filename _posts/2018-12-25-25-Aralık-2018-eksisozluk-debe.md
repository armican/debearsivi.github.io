...
- entry_name: |
  ...
  entry_fav_count: 60
  entry_content: |
    atatürk heykeli, bandırma vapuru, bulvar, çiftlik caddesi, 56'lar,samsun pidesi,tütün, atakum sahili..<br/><br/>ve yağmur..
  entry_channels: anket,tarih
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    -sabah kalkınca muhabbet kuşlarımın kafesinin örtüsünü kaldırıp kuşların ayaklarını ve kanatlarını gererek uyanmalarını izlemek.<br/><br/>-evin önünde beslediğim sahipsiz köpeklerle top oymamak ve onları beslemek.
  entry_channels: anket,sağlık
- entry_name: |
...
- entry_name: |
    ters yöne girip kaza yapan motorcu
  entry_id:  84732338
  entry_writer: ben hastayim
  entry_fav_count: 2
  entry_content: |
    yıl olmuş 2019 hala <a class="b" href="/?q=do%c4%9fal+seleksiyon">doğal seleksiyon</a> devam ediyor. o değil beyaz aracın şoförüne boşu boşuna travma yaşatacaklar, gidip bir duvara vurmaları daha mantıklı olurdu.<br/><br/>ayrıca, video bir adet avını kovalayan dakik çekici içerir.
...
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    mansur yavaş'a belediye başkanlığı için teklif getiren partilerin arasında ak parti de vardı,bu teklife itabarımi kaybederim diyerek,chp'den aday oldu;şimdi,paslı demir mi olmuş.geçiniz.
  entry_channels: siyaset
- entry_name: |
    karı kız için solcu takılmak
  entry_id:  84730406
  entry_writer: sicilyalimafia
  entry_fav_count: 1
  entry_content: |
    adam dövebilmek,sindirebilmek için ülkücü,akp’li olma ezikliğinden iyidir.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    evlilikte karşılığı düzenli olarak hiç birlikte olmamaktır.<br/>bekarlık ne güzeldir, çalışır tanışır konuşur sevişirsin.
  entry_channels: ilişkiler
- entry_name: |
    doğalgaz faturası
  entry_id:  84737174
  ...
  entry_fav_count: 0
  entry_content: |
    190 m2 dublex eve 454 tl gelmiş faturadır. açıkçası sevindim, hatta halen bir yanlışlık olduğunu düşünüyorum. yakmadan önce full petek ve kombi temizliği yaptırdık ve sürekli en düşük seviyede yakıyoruz.<br/><br/>bunlar tüyo mu bilmiyorum ama gerçekten bir yanlışlık olduğunu düşünüyorum. yoksa minimum 750 gelmesi lazımdı. çünkü bu ülkede yaşamak bunu gerektirir.
  entry_channels: ekonomi
- entry_name: |
    ateistlerin ahlak temeli olmadığı gerçeği
  entry_id:  84731035
  entry_writer: apranax0
  entry_fav_count: 0
  entry_content: |
    kaynakları olmadığı için ateistlerin ahlak temeli, bulunduğu mekanin ve zamanın ahlaki değerlerine göre şekillenir. kenyadaki ateistle turkiyedeki ateistin doğruları ve yanlışları aynı olmayabilir.
  entry_channels: anket
- entry_name: |
