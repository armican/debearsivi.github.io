...
- entry_name: |
  ...
  entry_fav_count: 48
  entry_content: |
    geveze, namussuz ve utanmaz bir erkek tarafından kandırılması olasıdır.
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    kutsal kitapları okuyup anlamayan dindar, okuyup anlayan deist/ateist, hem okumayıp hem anlamayanlar ise yobaz olur.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    bu koç grubunun kuş serisini millete araba diye , bir ev parasına 40 sene sattığını unutan ergenler savunup duruyor şunu. <br/>cep telefonu çıktığında boş iş bu diyip ihalesine dahi katılmayan sonra kafasını duvarlara vuran vizyoner bir ailenin ferdidir kendileri.<br/>dallama comolli ve yarattığı takım bu vizyonun eseridir.<br/>toslaya dur koçum benim.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    oh be en sonunda güzel bi bölüm. <br/><br/>senaristlerin kendine geldiği dizi... <br/><br/>not: yazarken sena akşın celasun sahnesi geldi. allah belanızı versin. siktiniz diziyi!
  entry_channels: tv
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    adam akıllı tepki hayatta olsalardı merhum <a class="b" href="/?q=tar%c4%b1k+akan">tarık akan</a> ve <a class="b" href="/?q=levent+k%c4%b1rca">levent kırca</a>'dan çıkardı. destek verenler; başım belaya girmeden <a class="b" href="/?q=nas%c4%b1l+destek+veririm">nasıl destek veririm</a> derdinde.
...
- entry_name: |
    şaka maka fenerbahçe'nin küme düşecek olması
  entry_id:  84742510
  entry_writer: punkrock1907
  entry_fav_count: 0
  entry_content: |
    ya merve yayıncı kuruluş buna izin vermez tamam mı?
  entry_channels: spor
- entry_name: |
    roman neustadter
  entry_id:  84732941
  ...
  entry_fav_count: 0
  entry_content: |
    aykut zamanında değil, advocaat zamanında gelmiştir. hatta hafızam beni yanıltmıyorsa vitor pereria daha kovulmadan gelmişti.
  entry_channels: spor
- entry_name: |
    kevin spacey
  entry_id:  84743762
  ...
  entry_fav_count: 0
  entry_content: |
    sapık ve pedofili suçlamalarının ve kanıtlarının ardından, bırak piyasaya dönmeyi; intihar etmeyen ünlü yok amerikada. bu adam piyasaya geri dönüyor.<br/><br/>işte bu tamamen mükemmel ötesinde oyunculuk yeteneğine sahip olmanın getirdiği bir ayrıcalık. bu adam kadar iyi ve hala hayatta olan bir erkek aktör, bir elin parmaklarını geçmez. piyasa bu adamı kaybedemez o yüzden.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ekrem imamoğlu'nu ilk defa izlediğim, hakkında da gayet olumlu izlenimler edindiğim yayın.<br/><br/>adam diyor ki, ak parti ilçe başkanlığına kaç defa gittim, 2014 belediye başkanlığı yarışında o zamanki ak parti belediye başkanının toplantısına katıldım, "ne işin var senin burada?" diye esprili bir dille sordu, ben de projelerini öğrenmeye geldim, güzel projen varsa uygulayacağım" dedim diyor. <br/><br/>gayet sempatik geldi bana.
