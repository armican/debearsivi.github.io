...
- entry_name: |
    çocuk var diye boşanmamak
  entry_id:  83471664
  entry_writer: burusuk sacli abla
  entry_fav_count: 80
  entry_content: |
    çocuklara yapılan en büyük kötülüklerden biridir. annemle babam keşke biz çocukken ayrılsaydı da o sağlıksız, her an bir bağırış çağırış olma ihtimalinin olduğu gergin ortamda, içimizde bir korkuyla büyümeseydik. siz sorunlarınızı çocuğunuza yansıtmadığınızı düşünüyor olabilirsiniz ama en büyük yanılgıdır budur. çocuk anlam veremese bile hissediyor o gerginliği. <br/><br/>ayrıca çocuklarınız büyüdüğünde, "sizin için şu kadar yıl katlandım" gibi cümleler kurup, kendi seçimlerinizden doğan mutsuzluğunuzu, başarısızlığınızı çocuklarınızın psikolojisini daha da bozarak, kendilerini suçlu hisetmelerini sağlayarak tatmin etmeye çalışacaksanız, bunu dile getirmiyorsanız bile en ufak bir imada bulunacaksanız, taaa en başından boşanın. sizin mutsuzluğunuzun sebebi çocuğunuz değil, kendinizsiniz. kimseyi bunun için suçlayamazsınız.<br/><br/>boşandığınızda daha mutlu olacaksınız, sizin mutlu olmanız da çocuklarınızın daha mutlu büyümesi demektir. gergin ev ortamından daha çabuk kurtulabilmek için saçma sapan hatalar yapmaması demektir. bilmem anlatabildim mi?
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    pedikürden artan derileri yiyen adam
  entry_id:  83472122
  entry_writer: sezouchka
  entry_fav_count: 32
  entry_content: |
    kusturan başlıkların önde gidenidir.
  entry_channels: haber,yeme-içme
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    amına koyduğum avcısı. köpek değil köpek sürüsüyle gelmiş piç. herhalde bir 25-30 tane köpek var.<br/>tek tek saydım düşen piçleri:8<br/><br/>bir av tezgahı.<br/>akşam editi: ulan biz de biliyoruz yazık o köpeklere, onlar o şekilde eğitilmiş. <br/>tamam da amk avcısı ve videoya alan kankası her ne sikimlerse hiç köpeklerinin düştüğüne aldırış bile etmiyorlar, dertleri avları olmuş. sen de duyar kasıyorsun.
  entry_channels: haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    pasif içiciliğin dibine vurduğum yıllardır. ileride hiç sigara içmediğim halde akciğer kanseri olursam sorumlusu bu ibnelerdir.
  entry_channels: tarih,oyun,teknoloji
- entry_name: |
    mesleğinin adını söylemeden anlat
  entry_id:  83492876
  entry_writer: maruldeth
  entry_fav_count: 0
  entry_content: |
    seeee aaaa ses kontrol soundcheck
  entry_channels: anket
- entry_name: |
    en iyi enstrümental parçalar
  entry_id:  83467136
  entry_writer: yesil corap
  entry_fav_count: 0
  entry_content: |
    benim için:<br/><a class="b" href="/?q=death">death</a> - <a class="b" href="/?q=the+voice+of+the+soul">the voice of the soul</a> ve <a class="b" href="/?q=opeth">opeth</a> - <a class="b" href="/?q=ending+credits">ending credits</a>
  entry_channels: anket,müzik
---
