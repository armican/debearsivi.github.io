...
- entry_name: |
  ...
  entry_fav_count: 233
  entry_content: |
    birinci olan kizin hak ederek kazandigi yarisma. <br/>kendisi gercekten cok yakisikli.
...
- entry_name: |
    19 kasım 2018 balerin heykeline tecavüz girişimi
  entry_id:  83477413
  entry_writer: yusuf hayran
  entry_fav_count: 119
  entry_content: |
    türkiye düzlüklerinde sıradan bir gün.
...
- entry_name: |
  ...
  entry_fav_count: 93
  entry_content: |
    sizi terkettikten sonraki ilk iki hafta.
...
- entry_name: |
  ...
  entry_fav_count: 78
  entry_content: |
    insanımız psikolojik rahatsızlık konusunda aşırı bilgisiz, veya bu konuyu göz ardı edip mastürbasyon yapmaya çabalıyor. çözemedim. <br/><br/>bebeğini 'kucağımda örümceğe dönüştü, ben de duvara fırlattım' diye öldüren birine 'inşallah sen de geberirsin caniiiiiiii şlasdşas' falan diyince gerçekten rahatlıyor musunuz? dışarıdan ne menem bir aptal olduğunuz anlaşılır diye hiç mi korkmuyorsunuz merak ediyorum.<br/><br/>aynı sesler kadını bu kocaya satıp ondan sağlıklı bir aile yaşantısını bekleyenlere söyleniyor mu peki? cevap malum.
...
- entry_name: |
    şeker pancarı üreticilerine destek veriyoruz
  entry_id:  83469110
  entry_writer: cemaat abisi
  entry_fav_count: 56
  entry_content: |
    şeker pancarı üreticileri bence etkili bir protesto yapmak istiyorsa şeker pancarını götlerine sokabilirler. zaten hem oy verip hem giriyordu yıllardır, çok da acıtmaz.
...
- entry_name: |
  ...
  entry_channels: anket,ekonomi
- entry_name: |
    ordu millet kıraathanesinde kek dağıtılması
  entry_id:  83481192
  entry_writer: altay horda
  entry_fav_count: 52
  entry_content: |
    reisimizin 24 haziran öncesi ümmete vermiş olduğu sözü tutmasıdır.<br/><br/>işte ordu'nun merkez altınordu ilçesi millet kıraathanesinde kek dağıtımı <a rel="nofollow noopener" class="url" target="_blank" href="https://streamable.com/wbq5a" title="https://streamable.com/wbq5a">görüntüleri.</a><br/><br/>bu da herkese kapak olsun.<br/>artık bu ümmetin millet kıraathaneleri var.<br/>keki var.<br/>bedava çayı var.<br/>başka hiçbir şey lazım değil.<br/><br/>bir tek su veren itfaiye lazım.
  entry_channels: haber,yeme-içme
- entry_name: |
    evrenin varoluş sebebi
  entry_id:  83485463
  entry_writer: thegunluk
  entry_fav_count: 39
  entry_content: |
    "tek bildiğim birşey", "tek bildiğim birşey", "tek bildiğim birşey", "tek bildiğim birşey" kafamı sallayarak bu tamlamayı tekrarlıyorum şu anda evreni filan siktir ettim.
...
- entry_name: |
  ...
  entry_channels: anket
- entry_name: |
    mebs okul ve eğitim komutanlığı
  entry_id:  83474821
  entry_writer: benbenlebirim
  entry_fav_count: 30
  entry_content: |
    otogardan ulaşım sağlayacak arkadaşlar için aşti<sup class="ab"><a title="(bkz: aşti)" href="/?q=a%c5%9fti" data-query="aşti">*</a></sup> den ankaray<sup class="ab"><a title="(bkz: ankaray)" href="/?q=ankaray" data-query="ankaray">*</a></sup> a binildikten sonra son durak dikimevi<sup class="ab"><a title="(bkz: dikimevi)" href="/?q=dikimevi" data-query="dikimevi">*</a></sup> durağında inilip merdivenleri çıktıktan sonra 100 metre ilerideki otobüs durağından 329 numaralı ego otobüsüne binilip giriş kapısına kadar rahatça ulaşılabilir.<br/>hayırlı teskereler.
  entry_channels: 
- entry_name: |
    binali yıldırım için alternatif pozisyon önerileri
  entry_id:  83475404
  entry_writer: fanari
  entry_fav_count: 25
  entry_content: |
    veleybol bakanlığı bu önerilerden biridir.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 22
  entry_content: |
    çok haklı bir önermedir, kendimden biliyorum.
...
- entry_name: |
  ...
  entry_channels: anket,ekonomi
- entry_name: |
    hava er egitim tugay komutanlığı
  entry_id:  83474371
  entry_writer: corsairsgold35
  entry_fav_count: 15
  entry_content: |
    (bkz: <a class="b" href="/?q=g%c3%b6t+da%c4%9f%c4%b1">göt dağı</a>)
  entry_channels: 
- entry_name: |
...
- entry_name: |
    instagram'da takip isteğini beklemede bırakan kız
  entry_id:  83485829
  entry_writer: banana for scale
  entry_fav_count: 11
  entry_content: |
    (bkz: <a class="b" href="/?q=ne+yapmak+nereye+varmak+istemektedir">ne yapmak nereye varmak istemektedir</a>)
  entry_channels: anket,teknoloji
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    tavşan taşa sürtmüş dağı siktim demiş. bu ankara itleriyle bu zamana kadar 120 maç yapmışız, bizi 13 kere yenebilmişler. birinde de golü hakem attıydı zaten altı pastan. sonra ortamlarda biz beşiktaş'ın düşmanıyız diye gezerler bu bursa'nın göt yalayıcıları.<br/><br/>(bkz: <a class="b" href="/?q=ahmet+ak%c3%a7ay">ahmet akçay</a>)
...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    çirkin kadın daha güzel sevişir
  entry_id:  83487482
  entry_writer: blefaroplasti
  entry_fav_count: 7
  entry_content: |
    okuyacağınız entry tamamen hayal ürünüdür ve hiçbir kurum veya kuruluş ile bir ilgisi yoktur.<br/><br/>meriç (entry) ;<br/><br/>çirkin demeyelim de güzel görünmek için vakti veya fırsatı olmayanlar diyelim.<br/><br/>her kuşu siktik bir leylek kaldı (entry) ;<br/><br/>çok ama cok güzel seviştiklerini zamanında tecrübe etmisimdir.<br/><br/>leyla mecnun (entry) ;<br/><br/>özünde sevmek olan bir eylemi çirkin olduğunu düşündüğün bir kadınla hayata geçiriyorsan onun içinde güzellik bulman çok zor. ama dene yine de. en son varıcağın nokta da şu olucak "sevilen kadın daha güzel sevişir". porno filmi değil hayat bu çünkü.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    ne kadar vizyon kattığım, ufkunu açtığım insan varsa iletişimi koparınca whatsappda story atacak seviyeye düşüyor. hayır herkes kendine beni çok bağlamaz da en azından emeğe saygı orospu çocukları ya
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    (bkz: <a class="b" href="/?q=an%c4%b1tkabir">anıtkabir</a>)<br/><br/>daha da üstüne söz söylemeye gerek yok.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    hocam bana ordan <a class="b" href="/?q=etli+california+roll">etli california roll</a>.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    sabahın erken saatlerinde 3 hafta olan sakatlık süresi öğlene doğru 6 haftaya çıkan futbolcu. ulan sakatlıkta bile ekstradan sakatlanıyor bizim futbolcular.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    fakirlerin birbirini gazladığı başlığa dönmüş soru. cevap üzerinde tartışılmayacak kadar nettir. yapar. <br/>.
  entry_channels: anket,ekonomi
- entry_name: |
    58. piyade er eğitim alayı
  entry_id:  83474252
  entry_writer: his airness
  entry_fav_count: 3
  entry_content: |
    2019 ocak - 9b<br/>sevk tarihi : 5 ocak 2019<br/>3 üncü p.eğt.tug. tırt.arç.sür.eğt.a./burdur merkez<br/><br/>bizimki de 58'in icinde mi acaba yoksa burdur icinde baska bir tugay mi merak ettirendir.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    kemal sunalın hemen hemen tüm filmleri. nerede hangi replik kullanılacak aklımda .
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    futbolla pek alakam yok. <br/><br/>ama bu kafayla yarın öbür gün ankaragücü'nü başka bir gökçekgile emanet edersiniz sonra ankaragücü'nün helaya gitmeye parası kalmayınca fi tarihinde 3-5 beşiktaş taraftarı bize 1 lira atmıştı diye kan davası güdersiniz. koskoca beşiktaş taraftarı lan bu. çin de bile taraftarı var. kimi neyle suçluyorsunuz allah'ın gerizekalıları. <br/><br/>onu geçtim suçluları nerede arıyorlar? 18-19 yaşında çocuklar tek forma ile aç karna maç oynuyormuş. bitmedi bu ülkenin mağduriyeti, iğrençliği. sanırsın gabon halbuki türkiye cumhuriyetinin başkenti. <br/><br/>ahmet gökçek de evinde scotch viskisini yudumlayıp sırıtıyordur şu an. <br/><br/>alın bakın ankaragücü'nü nasıl <a rel="nofollow noopener" class="url" target="_blank" href="http://www.cumhuriyet.com.tr/koseyazisi/332392/Ankaragucu_nu_boyle_batirdilar.html" title="http://www.cumhuriyet.com.tr/koseyazisi/332392/Ankaragucu_nu_boyle_batirdilar.html">batırdılar</a>.
  entry_channels: spor
- entry_name: |
    şu anda çalan şarkı
  entry_id:  83490123
  ...
  entry_fav_count: 0
  entry_content: |
    " gönül bir kabedir yap da ol hacı... "<br/>(bkz: <a class="b" href="/?q=davut+sulari">davut sulari</a>) <br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/dwIwpWd6xIg" title="https://youtu.be/dwIwpWd6xIg">cem adrian&amp; ahmet aslan- kirpiğin kaşına değdiği zaman</a>
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    mimar olarak dahil olduğum iş, şirketimi mevcut durumlardan ötürü ve gelen bir iş teklifi sebebiyle 3 ay önce askıya aldım ve yeni işime başladım.<br/>3 ayda ofisin tüm eskiye dönük pis işlerini ( 2 adet mukayeseli keşif, 5 adet imar affı, mukayeselisi yapılan işin kesin hesabı, ve yeni aldıkları 2 işin super pozeleri ve metrajları) yaptırıp şu anda iş sözleşmeme son veriyorlar.<br/>hakkaniyetli çalışabileceğim ve sömürülmeyeceğim bir iş arıyorum.<br/>ankara içi olursa sevinirim, yurt dışına balıklama giderim.<br/>not: evliyim.
