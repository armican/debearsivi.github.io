...
- entry_name: |
  ...
  entry_fav_count: 30
  entry_content: |
    bu yollar sana çıkmayacak ama yürüdüğümü bil...
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    ya şu adama mehmet demirkolun çok iyi diyip balon çıkması geliyo hep aklıma , bu arada mehmet demirkolu dinlemeyi konuşmasını çok severim ama kime iyi bu futbolcu diyosa hepsi balon çıkıyo
  entry_channels: spor
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    aslında bu hastalığın temelinde benim karakterim yatıyor. hayatta doğru düzgün hiçbir sorumluluk almadan anne babanın arkasında yıllarca yaşadıktan sonra sorumluluk alma vakti gelince apışıp kalma durumu bir bakıma. ama neresinden dönersem kardır diye düşünerek hayata tutunmalıyım. başka çarem yok.
...
- entry_name: |
  ...
  entry_id:  85160127
  entry_writer: tlgclky
  entry_fav_count: 7
  entry_content: |
    ihtiyacımız olan mevkiler dışında her bölgeye 10 transfer politikası
  entry_channels: spor
- entry_name: |
    hakan şükür
  entry_id:  85158886
