...
- entry_name: |
    türk kızlarının genelde pis olması
  entry_id:  67658917
  entry_writer: betaleonis
  entry_fav_count: 80
  entry_content: |
    türk erkeklerinin yanında temizlik abidesi sayılırlar.<br/><br/>edit: daha bugün spor salonunun soyunma odasında nefes almadan giyinmeye çalıştım. ayak kokusu, ter, kıl, tüy, yün ne ararsan var maşallah. ha türk kızları süper mi? değil. çıktığım kızlardan temiz olanı da vardı pek dikkat etmeyeni de. fakat erkeklerle mukayese edilemez.
- entry_name: |
...
- entry_name: |
    eşek bağlasan mezun olur
  entry_id:  67657933
  entry_writer: carol ferris
  entry_fav_count: 46
  entry_content: |
    kişi eşşekse her bölümden mezun olmuş olabilir. bu bölümün suçu olamaz.
- entry_name: |
...
- entry_name: |
    bolu'da bir tane u olması
  entry_id:  67657334
  entry_writer: duncan misali gonlum
  entry_fav_count: 39
  entry_content: |
    fatih tekke'de iki k olması zamanında mevzu bahis edilmişti. bunlar oluyor.
- entry_name: |
...
- entry_name: |
    23 nisan 2017 kemal kılıçdaroğlu meclis konuşması
  entry_id:  67663283
  entry_writer: zoltarinmabedi
  entry_fav_count: 33
  entry_content: |
    ismail kahraman (mecliz başkanı)<br/>-türkiye kuvvetler birliği'ni 1950'ye kadar tatbik etti. şimdi kuvvetler ayrılığı'na geçiyor.<br/><br/>akp'den önce yasama-yürütme-yargı tek kişiye bağlanmıştı, meclis yoktu demeye getiriyor<br/><br/>yalan sizin mayanızda var!
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=-cN6EMTuSZ4" title="https://www.youtube.com/watch?v=-cN6EMTuSZ4">ağır kapı aksak lisan kelimeler yetmiyor</a>
---
