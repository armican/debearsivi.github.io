...
- entry_name: |
    bahçeli'nin muharrem ince'ye apolet yanıtı
  entry_id:  77784852
  entry_writer: care drogba
  entry_fav_count: 222
  entry_content: |
    genelkurmay başkanını terörist diye hapise atacak kişi anasının karnından doğmuş da apolet sökecek mi doğmamış?
...
- entry_name: |
  ...
  entry_fav_count: 48
  entry_content: |
    arabamın arka camını süsleyen çıkartma, arabamı paha biçilemez derecede değerli kılıyor.
...
- entry_name: |
    türkiye'ye genişbant interneti ak parti getirdi
  entry_id:  77787002
  entry_writer: cemu
  entry_fav_count: 42
  entry_content: |
      (nokta)..dedi zamanında youtube, twitter, wikipedia yasaklamış birisi.
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
    yolcunun üzerine kusmakla tehdit eden psikopat
  entry_id:  77778537
  entry_writer: metin yazar
  entry_fav_count: 39
  entry_content: |
    metro turizm diye geldim amma lakin ki öyle değilmiş.
...
- entry_name: |
    benzinin türkiye'de avrupa'dan ucuz satılması
  entry_id:  77787223
  entry_writer: chapulmaster
  entry_fav_count: 36
  entry_content: |
    almanya’da asgari ücret 1.498 euro<br/>türkiye’de asgari ücret 1.603,12 tl (298,45 euro)<br/><br/>türkiye’de asgari ücretin 8.040 türk lirası olması halinde onaylanabilecek önerme...<br/>(bkz: <a class="b" href="/?q=pratik+zeka">pratik zeka</a>)
...
- entry_name: |
  ...
  entry_fav_count: 22
  entry_content: |
    sevgili illimünati, bu sefer gerçekten sübliminalin bokunu çıkarmışsın dedirten klip. bir insan bardağı <a class="b" href="/?q=baphomet">baphomet</a> simgesi şeklinde tutuyor, karşısındaki adamın yakasına sarılırken elleriyle aynı simgeyi yapıyorsa daha ne diyeyim ben. hep diyordum çıktığı günden beri aleyna bir proje diye, tam gaz devam ediyorlar uygulamaya bu kız üzerindeki planları. bu klibin fragmanı başkaydı sanki instagramda bol bol çıkıyordu her köşeden. küçük kızımız kızlık zarını simgeleyen bembe duvarı yırtıp masumiyetini kaybediyordu. gözleri yukarı kaya kaya kendinden geçiyordu. şimdi de bu klipte kaçırılıp tecavüze uğruyor düpedüz. hayallerindeki prensi arabanın bagajına tıkıp postalıyorlar, üstelik bu eyleme beyni yıkanan aleyna da dahil oluyor. tipik bir "<a class="b" href="/?q=good+girl+gone+bad">good girl gone bad</a>" klibi. on sekizini dolduran kızımız artık şeytana hizmet eden bir seks objesi olduğunu açık açık duyurma hakkına sahip oluyor. <br/>sübliminalci abilerin yaptığı en bariz şey el attıkları şarkıcının kendi klibinde o kişi üzerinde uyguladıkları veya uygulayacakları planı yansıtmaktır. burada da görüyoruz neler olduğunu ve olacağını. ilk başta yüzündeki masumiyet,acı, çaresizlik sonunda kendini şeytani gülüşlere ve kadınsılığa bırakıyor. gece gece yüzeysel olarak izleyince bu kadarcığı dikkatimi çekti. zaten derin derin irdeleyip de kimsenin ekmeğine yağ sürmeye gerek yok. ama tüm bunları kıçtan uydurulan paranoyak zırvası olarak görme körlüğünden kurtulmak da lazım. çoluğa çocuğa gençlere izletmemek lazım en azından. konunun fularlısı değilim, eminim kare kare neyin ne olduğunu bilecek kadar derin bilgiye sahip yazarlarımız mevcuttur. benimkisi naçizane kahvehane eyyorlaması.<br/><br/>not: yarın türk dil kurumuna bu iki yeni deyimi güzel dilimize kazandırma teklifiyle başvuracağım; (bkz: <a class="b" href="/?q=bir+konunun+fularl%c4%b1s%c4%b1+olmak">bir konunun fularlısı olmak</a>)<br/>(bkz: <a class="b" href="/?q=kahvehane+eyyorlamas%c4%b1">kahvehane eyyorlaması</a>)<br/>unutursak kalbimiz kurusun hesabı, unutmuş olan veya bilmeyen varsa diye: (bkz: <a class="b" href="/?q=eyyorlamam+bu+kadar">eyyorlamam bu kadar</a>)
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    ben öğrenci evimden çıkarken yapmıştım, ev sahibim piç herifin tekiydi. ev zaten küçücük bir evdi ve sürekli küf sorunlarıyla falan uğraştım. oldukça cimri bir tipti zaten, kirasını her ay belirtilen tarihten daha önce yatırmama rağmen gene de yaranamadım. öğrencilik bitip çıkmak isteyince eve emlakçıyı yollamış hasar falan var mı diye. baktım depozitonun üstüne yatacak suyu, elektriği yatırmadan çıktım,depozitodan ödesin diye. üstüne kendi taktığım güzel ahizelerimi de alıp çıktım. başka öğrencilere verdim. pişman değilim gene olsa gene yaparım.
...
- entry_name: |
  ...
  entry_fav_count: 9
  entry_content: |
    fecr suresinde anlatılan şekilde;<br/><br/>"ey mutmain olmuş nefs<br/>rabbine geri dön<br/>o senden sen de o'dan razı olarak<br/>kullarımın arasına dahil ol<br/>gir cennetime."<br/><br/>sufiler buna irciî hitabını işitmek derler. mutmain olmuş bir nefs ile irciî (geri dön) hitabını işiterek olsun da nerede ve nasıl olduğunun bir önemi yok ölümün.<br/><br/>allah nasip etsin.
  entry_channels: anket,sağlık
- entry_name: |
    cleveland'lıyım ama üçüncü maçta oyum curry'ye
  entry_id:  77777560
  entry_writer: vizontele de benimdir lucy de
  entry_fav_count: 9
  entry_content: |
    evet bunu itiraf etmenin zamanı geldi. king <a class="b" href="/?q=lebron+james">lebron james</a> için canım feda fakat cavs yönetimi davadan uzaklaşmıştır. biz şampiyonluğa oynayacak takım yaratacaklar, lebron'a layık adamlar getirecekler derken müptezel samet kılıklı jr smith'e, tıpkı karius gibi yakışıklı ama salak <a class="b" href="/?q=kyle+korver">kyle korver</a>'a kaldık.<br/><br/>o yüzden üçüncü maçta da, nihai mvp seçiminde de oyum genç ve heyecanlı olan <a class="b" href="/?q=stephen+curry">stephen curry</a>'ye.
  entry_channels: spor,siyaset
- entry_name: |
    yazlık saray için 50 bin ağaç kesmek
  entry_id:  77776254
  entry_writer: kunteperbaba
  entry_fav_count: 6
  entry_content: |
    milletin muhteşem cumhurbaşkanı sayın tayyip erdoğan ‘ın yeni icadı. ürperdim canım acıdı. sizin yatacak yeriniz var mı ? sizi kabul edecek toprak bulursanız en büyük ödülünüz bu olacak. <br/><br/>kaynak : <a rel="nofollow noopener" class="url" target="_blank" href="http://www.diken.com.tr/talana-devam-okluktaki-yazlik-saray-icin-50-bin-agac-kesildi/" title="http://www.diken.com.tr/talana-devam-okluktaki-yazlik-saray-icin-50-bin-agac-kesildi/">http://www.diken.com.tr/…-icin-50-bin-agac-kesildi/</a>
  entry_channels: 
- entry_name: |
