...
- entry_name: |
  ...
  entry_fav_count: 149
  entry_content: |
    bedelli bekleyen arkadaşlar, sırf bu vaat uğruna gidip bunlara oy verirse de yazıklar olsun.<br/><br/>1 seneyi kurtarıcam diye hayatının geri kalanını feda etmek akla mantığa sığar mı ?
  entry_channels: siyaset
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  77783148
  entry_writer: eledhwen
  entry_fav_count: 18
  entry_content: |
    tanım: laik kelimesinin yanlış kullanıldığı ve karalama nedeni ile açılmış bir başlık.<br/><br/>yazarın yorumu: bunlar<sup class="ab"><a title="(bkz: saçma başlıkları açan aktroller)" href="/?q=sa%c3%a7ma+ba%c5%9fl%c4%b1klar%c4%b1+a%c3%a7an+aktroller" data-query="saçma başlıkları açan aktroller">*</a></sup>, kendilerini osmanoğlu sanıyorlar ama gerçekte hepsi amınoğlu.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    eve nasıl girdiysen öyle çıkarsın. ampuller vardı da giderken söktüysen bi cacık olmaz senden. üç beş ampulle çakallık yaptığını düşünen insandan kimseye fayda gelmez.
  entry_channels: ilişkiler
- entry_name: |
