...
- entry_name: |
    billy porter'ın oscar'a damga vuran kıyafeti
  entry_id:  87089944
  entry_writer: johanericcalvinelmander
  entry_fav_count: 112
  entry_content: |
    oscar'ın özetidir.<br/><br/>zenci. check.<br/>gay. check.<br/>sıradan bir tip. check.<br/><br/>tebrikler, oscar kazandınız.
  entry_channels: sinema,moda,magazin
- entry_name: |
    düz dünya teorisi
  entry_id:  87085547
  entry_writer: efthio
...
- entry_name: |
  ...
  entry_fav_count: 39
  entry_content: |
    "dünyada bir tek insana inanmıştım. o kadar çok inanmıştım ki, bunda aldanmış olmak, bende artık inanmak kudreti bırakmamıştı."<br/><br/>112. yaş günü olan muhteşem insan.
...
- entry_name: |
  ...
  entry_fav_count: 35
  entry_content: |
    yorumcu; “fenerbahçe’nin şoku atlatması için 3-4 pas arka arkaya yapması gerekir” diyor. hiç bu kadar küçük düşürülmemiştim.
  entry_channels: spor
- entry_name: |
    sadık çiftpınar
  entry_id:  87109327
...
- entry_name: |
  ...
  entry_fav_count: 15
  entry_content: |
    aykut kocaman'a laf edenler dakika 18 de "uc uc uc" seslerini duyuyordur umarim.<br/><br/>t: bu kahinatin en buyuk balonudur.<br/><br/>edit: 3 de oldu. merakla bekliyorum efsane teknik direktorumuz ne twit atacak.
  entry_channels: spor
- entry_name: |
    aykut kocaman
  entry_id:  87108268
  ...
  entry_fav_count: 12
  entry_content: |
    fenerbahçe hainlerinin yüzünden takımımızdan uzaklaştırılan stephen hawking zekiliğinde kurnaz cevher. bu adamı nasıl kaçırdık elimizden inanılır gibi değil. elbet bir gün yeniden buluşacağız hocam. <br/><br/>(bkz: <a class="b" href="/?q=bir+sevdad%c4%b1r+aykut+kocaman">bir sevdadır aykut kocaman</a>)
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    gunahkar sokaklarin tovbekar cocugu
  entry_id:  87106197
  entry_writer: obturator
  entry_fav_count: 8
  entry_content: |
    aha da yazıyorum;<br/><br/>bu orospu çocuğu, döl israfı, örümcek kafalı, cumhuriyet ve atatürk düşmanı şerefsiz irticacı iti bu sözlükte tutanlar utansın amk.<br/><br/>uçurun lan şunu artık!!!
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    ersun gelince 19 maçta 19 galibiyet alacağını zannedenlerin yeni ve nemli rüyası.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    ona vermemektir.<br/><br/>sizinle cinsellik için mi birlikte olmak istiyor yoksa, sevişmeden uyuyalım duygusallığında mı, bunu anlamanın en garanti yolu budur.<br/><br/>er kişisi ile cinselliğin olmadığı bir ilişkiyi uzun vadede sürdürür ve bu durum er kişinin size olan hislerini törpülemeyip tersine daha da güçlendiriyorsa o erkek doğru erkektir.<br/><br/>yok er kişisi daha ilk buluşmada partnerine kur yapan taklacı erkek güvercin gibi sizi yatağa atmak için olmadık şaklamanlıklar yapıyor ise; daha yolun başında götüne tekmeyi yapıştırın o erilin. ondan size hayır gelmez.
  entry_channels: 
- entry_name: |
    shinji kagawa
  entry_id:  87085008
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    son zamanlarda kendisinden pek haz etmesem de, kendisi ile zımba diyerek dalga geçtiğini sanan andavallara bugün zımbalamasını umduğum teknik direktördür. <br/><br/>not: espri kasmayan rakip takım taraftarlarının alınmalarına gerek yoktur.
  entry_channels: spor
- entry_name: |
    volkan demirel
  entry_id:  87092665
  ...
  entry_fav_count: 3
  entry_content: |
    türkiye ligi uzmanı da geldiğine göre şu konuya parmak basayım. bu mal değneği kaos çıkarıp kendisi sakin kalacağı(!) yerde geçen yıl türkiye kupası maçında dünyanın en saçma kırmızı kartını görüp oyun ve oyuncu üstünlüğünü beşiktaş'a vermiş ve maç 2-2 bitmiştir. 30 yıllık fenerbahçeliyim fenerbahçe tarihinde bu balon ve kovadan başka bu kadar abartılan bir oyuncu görmedim.
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 2
  entry_content: |
    1984 özel basım<br/><br/>böyle bir eseri uzun zamandır tekrar okumadığım için kendime çok kızıyorum.<br/><br/>not: elimde özel olmayan basım var
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    adam fenerbahçe kaptanlığı yapmış, gelmiş beşiktaş formasıyla fenerbahçe’ye gol atmış ama sevinmiyor. <br/><br/>bizim andaval lavaşçı, forma öpmeler bilmemneler, alttan üstten sürekli bir laf sokmalar. <br/><br/>yahu bunlar milyonlarca euro’luk adamlar. insan bir danışman tutar kendine, bu hareketleri yapayım mı yapmayayım mı? bana faydası mı olur zararı mı olur? en azından baktın yanlış oldu gelir düzeltir yapma bu hareketleri der. ama nerdee??
  entry_channels: spor
- entry_name: |
    fenerbahçe
  entry_id:  87110548
  ...
  entry_fav_count: 1
  entry_content: |
    bir tek bizim yenemedigimiz takım. bak kim olduğumuzu yazmıyorum bile ak.
  entry_channels: spor
- entry_name: |
    ekşi itiraf
  entry_id:  87080628
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    fenerbahçe'ye sezon başından beri yapılan operasyonun bir parçası. sezon başından beri fener'in nereden baksan 80 puanını hakemler yedi. ee ses çıkarmayan, mıy mıy konuşan yönetim olursa böyle acımazlar.
  entry_channels: spor,siyaset
- entry_name: |
    jason momoa'nın kızını taciz etmesi
  entry_id:  87109503
  entry_writer: milonguero
  entry_fav_count: 0
  entry_content: |
    siktirin gidin aq.<br/><br/>9 yaşında kızlara kerkinenlerle fazla vakit geçirmekten oluyor bunlar.
  entry_channels: 
---
