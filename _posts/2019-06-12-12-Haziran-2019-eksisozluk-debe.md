...
- entry_name: |
  ...
  entry_channels: yeme-içme
- entry_name: |
    ekrem imamoğlu'nun pontus haritasıyla sırıtması
  entry_id:  91140771
  entry_writer: nickbulamadimnolcak
  entry_fav_count: 120
  entry_content: |
    furkan senin ananı sikeyim.<br/>furkan senin sülaleni sikeyim.<br/>furkan senin gelmişini geçmişini soyunu sopunu sikeyim.<br/>furkan senin gen haritanı sikeyim.<br/><br/>t: işte bu yukarıdaki götün tespiti. kendisi katıksız bir fetöcü orospu evladı olduğu için böyle tespitler sıçması normaldir.
...
- entry_name: |
  ...
  entry_fav_count: 25
  entry_content: |
    olay sonrasında çayını hep kendisi koymuştur.
  entry_channels: ilişkiler,tarih,magazin
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    bence rap yapan adamlardan sonra alınmış olması gerekirdi bu kararın.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    galatasarayliyim.<br/>elestirilecek bir harekettir ama sener ozbayrakli bunu yapan ilk futbolcu degil, hatta bu tarz transferlere konu olan cogu futbolcu bunu yapiyor.<br/><br/>hatta yanlis hatirlamiyorsam daha yakin zamanda serdar aziz'de benzerini yapti.<br/><br/>ben hepsini sacma ve saygisizca buluyorum.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    ekşi siyasetçiler imamoğlu yıldırım zirvesi
  entry_id:  91158609
  entry_writer: kayisili turta
  entry_fav_count: 1
  entry_content: |
    sınırlara takılmamış hali "ekşi siyasetçiler &amp; ekrem imamoğlu ve binali yıldırım canlı yayını zirvesi" olan ekşi siyasetçiler etkinliğidir. <br/><br/>yenilenen istanbul seçimleri ile ilgili olarak bir araya gelen iki adayı izlemek üzere patlamış mısırlarımız ve çekirdeklerimizle 16 haziran pazar günü istanbul'da bir araya geleceğiz. <br/><br/>başvurular bir yeşil kadar uzağınızda.
  entry_channels: siyaset,tv,haber,eğitim,ekonomi
- entry_name: |
    binali yıldırım
  entry_id:  91127394
  ...
  entry_fav_count: 1
  entry_content: |
    binali yıldırım kazanırsa eşitlik olması için 1,5 ay sonra bir seçim daha yapılmalıdır.
  entry_channels: siyaset,haber,ekonomi
- entry_name: |
    şu an okunan kitap
  entry_id:  91137603
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=amat">amat</a>)<br/>(bkz: <a class="b" href="/?q=ihsan+oktay+anar">ihsan oktay anar</a>)
  entry_channels: anket,edebiyat,eğitim
- entry_name: |
    çocukken doğadan yenilen abuk subuk şeyler
  entry_id:  91160208
  entry_writer: spes bona
  entry_fav_count: 0
  entry_content: |
    bebekken kumsalda oynarken kaşla göz arasında kum yermişim. annem panik yapıp engellemeye çalıştığında da kumsaldaki teyzeler “bırak yesin kızım, vücudun ona da ihtiyacı var” derlermiş. ah canım teyzeler.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ilkokulda yazılı kağıdına kurukafa çizdiğim için.<br/><br/>lisede bi forumda hocalarla alay ettiğim için. (ne alaka aq)<br/><br/>üniversitede de hocalarla papaz oldum, biraz serbesti olmasa yine ceza meza bi şeyler alırdım asdf.
  entry_channels: 
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    yıllardır severek dinlediğim nev 'i üzülerek protesto ediyorum. sermiyan midyat bu sözleri yazabiliyorsa sandalyeyi denk getirememiş demektir. güzelce oturtsaydı <a rel="nofollow noopener" class="url" target="_blank" href="http://img05.blogcu.com/v2/images/big/c/e/m/cemedib/cemedib_142037810361.jpg" title="http://img05.blogcu.com/v2/images/big/c/e/m/cemedib/cemedib_142037810361.jpg">ağızın da dağılması</a> gerekirdi.
  entry_channels: magazin
- entry_name: |
    ergin ataman
  entry_id:  91154218
  entry_writer: tozlu leblebi
  entry_fav_count: 0
  entry_content: |
    maça kulaklıklarla çıkmış koç. ilginç duruyor hahaha
  entry_channels: spor
---
