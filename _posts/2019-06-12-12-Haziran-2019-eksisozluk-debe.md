...
- entry_name: |
  ...
  entry_channels: haber
- entry_name: |
    erdoğan'ın 39 ilçede mitinglerini iptal etmesi
  entry_id:  91136908
  entry_writer: kissofh3ll
  entry_fav_count: 354
  entry_content: |
    içerisinde<br/>“chp, istanbul seçimlerini cumhurbaşkanımız ile bir yarışa dönüştürmeye çalışıyor. tayyip erdoğan’a kaybettirme üzerine bir strateji izliyorlar. buna izin vermeyeceğiz.” şeklinde cümle yer alan haberdir. bu da cehapeni suçu oldu. yahu siz 31 mart öncesinde beka meselesi, vatan millet elden gidiyor goygoyu yapmıyor muydunuz?
...
- entry_name: |
    haber sitesi clickbait klişeleri
  entry_id:  91136914
  entry_writer: safagi sokmeyen cocuk
  entry_fav_count: 113
  entry_content: |
    (bkz: <a class="b" href="/?q=bedelli+askerlik+ile+ilgili+fla%c5%9f+geli%c5%9fme">bedelli askerlik ile ilgili flaş gelişme</a>)<br/><br/>nereden baksan 600 bin tıkı var.
...
- entry_name: |
  ...
  entry_fav_count: 26
  entry_content: |
    çok güzel oynuyor bu adam ya. başarılarının devamını sikeyim.
  entry_channels: spor
- entry_name: |
    ekşi itiraf
  entry_id:  91127511
...
- entry_name: |
    çocuk sahibi olmak
  entry_id:  91165622
  entry_writer: multipl skleroz
  entry_fav_count: 1
  entry_content: |
    kimsenin "neden" diye sormadığı topluluk. çevrenize bir göz gezdirin, çocuk sahibi olan kişilerin kaçı bu vasıflara uygun. <br/><br/>eğitimlisi ve eğitimsizi arasında fazla bir fark yoktur. sohbetlerde hepsi her olan bitenden şikayetçi ama o zaman neden çocuk yaptın diye sorsan ufacık olsun mantıklı tek açıklama yok. çocukları büyüdüğünde böyle bir ülkede hatta böyle bir dünyada ne akla hizmet çocuk yaptınız diye sorsa ne cevap vereceklerini çok merak ediyorum.
  entry_channels: anket,ilişkiler
---
