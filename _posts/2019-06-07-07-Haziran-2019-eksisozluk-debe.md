...
- entry_name: |
    amerikan köprüleri ile fotoğraf çekilme lowluğu
  entry_id:  90944922
...
- entry_name: |
    imamoğlu'nun hangi sıfatla vip kullanmak istemesi
  entry_id:  90946661
  entry_writer: captain torero
  entry_fav_count: 117
  entry_content: |
    (bkz: <a class="b" href="/?q=ebru+g%c3%bcnde%c5%9f%27in+havaalan%c4%b1nda+vip+kullanmas%c4%b1">ebru gündeş'in havaalanında vip kullanması</a>) <br/><br/>bu yüzden sen sus aktroll, gözlerin konuşşsun.
  entry_channels: siyaset,ilişkiler,haber,havacılık
- entry_name: |
...
- entry_name: |
    ordu valisine it deyip demirtaş'a methiye düzmek
  entry_id:  90961437
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    how yazacaktim hoe olmus daha da cevap gelmedi.
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    kaldırımda otururken, dengesizin birinin gelip beni arabayla ezmesi.
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ailedeki her ayrıntıyı biliyor, müzevir müzeyyenlik yapıyorsa hiç kaçmaz
  entry_channels: anket,ilişkiler
---
