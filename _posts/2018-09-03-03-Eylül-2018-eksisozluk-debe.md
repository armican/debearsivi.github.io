...
- entry_name: |
  ...
  entry_fav_count: 83
  entry_content: |
    <a class="b" href="/?q=rus+ruleti">rus ruleti</a> öneririm, daha heyecan verici. :)
  entry_channels: ilişkiler,sağlık
- entry_name: |
...
- entry_name: |
  ...
  entry_channels: ekonomi
- entry_name: |
    murat yıldırım'lı konut kampanyası reklamı
  entry_id:  80882424
  entry_writer: peder payildi
  entry_fav_count: 69
  entry_content: |
    birkaç gün önce televizyonda gördüğüm ve bugün tekrar görünce aslında ne kadar aşağılık bir çalışma olduğunu farkettim.<br/>özetle dövizinizi tlye çevirin ve emlak sektörüne yatırın diyor. bunu yapacak kerizlere selam olsun.<br/>ekranlarda resmen vatandaşı dolandırmaya çalışan bir reklam oynuyor ve bunu sunan kişi de malum kanaldaki programın sunucusu.<br/>murat yıldırım ile hiçbir derdim yok ancak malum kanalda gönüllü çalışan herkes bir nevi üniformalıdır.
  entry_channels: tv
- entry_name: |
...
- entry_name: |
    halkbank'tan 4.6 milyon dolar alınması
  entry_id:  80894576
  entry_writer: mikail bey olmez
  entry_fav_count: 22
  entry_content: |
    yemin ederim buradaki aptal yorumları görünce halk bankasına hak verip ülkeye acıdığım durum. gece yarısı swift yapmıştır diyeni mi ararsın, yarı fiyatına döviz satışıyla karpuz satışını ya da toplu alımı bir tutanı mı, kendi ülkesinin kanunlarından bihaber olanı mı her türlü gerizekalı burada dile gelmiş.
  entry_channels: haber
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    bok kokusu. <br/><br/>adamlar mumbai’de sıçacak yer bulamayıp muhteşem kumsallarını hela olarak kullanıyorlar.<br/><br/>leşler. koku, pis koku, bok kokusu başka da bişe gelmiyor aklıma.<br/><br/>bir de ganj kusacak artık bu ibnelerden. hem yıkanıp, hem sıçıp , hem suyunu içip hem de ölülerini aynı nehirde yakıyorlar.
...
- entry_name: |
  ...
  entry_fav_count: 10
  entry_content: |
    bir pilot, bir takımın emeğini, üstelik açık ara favori olduğu pistte nasıl piç eder? işte tam olarak böyle.<br/>mal oğlu mal, rai'nin arkasında bir tur bile gitmeye razı gelmiş, takım arkadaşını geçmek yerine en büyük rakibini savunmaya çalışmış olsa, ferrari takımı kontrollü şekilde, güle oynaya duble yapacaktı. şimdi hem puan farkı dünya kadar açıldı, hem de kimi'nin hakkı olan galibiyet hamilton ağlağına gitti.<br/>şu yarışa kadar hamilton şampiyonluğu dışında her şeye razıydım, artık beni için en büyük mutluluk kaynağı vettel'in şampiyonluğu kaybetmesi olacak.
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    <a class="b" href="/?q=yemekteyiz">yemekteyiz</a> 'den ve <a class="b" href="/?q=ver+f%c4%b1r%c4%b1na">ver fırına</a> 'dan birçok yarışmacıyı transfer eden yeni program.<br/><br/>özellikle yemekteyiz'deki psikopat kel aşçı murat'ı görünce kahkaha attım.
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    3 erkek 1 kiz olarak sinifin butun yaramazligini ustlendigimiz grubumuz tabi ki lise bitti ve gorusmeler de azalarak bitti. o gruptan sadece biriyle cok sik gorusuyorum. hocalar veli toplantilarinda bunlar okumaz diyordu<br/>x: insaat muhendisi oldu ve butik bir insaat sirketi kurdu. <br/>y: kariyerine akademik anlamda devam karari aldi akademisyen oldu<br/>z: girisimci oldu hayati kolaylastiran cozumler uzerine dijital bir platform olusturdu<br/>w: askere gitmeye hazirlaniyor. hic bir iste tutunabilmis degil. (hocalar en cok ondan umitliydi)<br/>gercek hayat okuldan ibaret degildir.
...
- entry_name: |
  ...
  entry_id:  80880938
  entry_writer: dies irae
  entry_fav_count: 0
  entry_content: |
    "depresyon testi puanınız: 0"<br/><br/>teşekkürler <a class="b" href="/?q=the+red+pill">the red pill</a>.
