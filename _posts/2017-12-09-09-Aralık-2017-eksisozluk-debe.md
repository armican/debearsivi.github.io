...
- entry_name: |
    nihat doğan'ın sözlüğe batının lejyoneri demesi
  entry_id:  72670915
  entry_writer: plaza communisti
  entry_fav_count: 314
  entry_content: |
    nihat doğan kimdir, hangi üniversitenin hangi bölümünden mezundur? <br/><br/>tanımam etmem, neden insanlar tanır, başlığı açılır fikrim yok.
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  72677548
  entry_writer: gslibaykus
  entry_fav_count: 157
  entry_content: |
    daha önce defalarca yazıldı ama yine yazalım , leş mekanlarda duman altı nargileli ortamlarda yine leş bir filtre kahveye dokuz(9) tl verip bir de kahve bittikten sonra dakika başı çay içer misin dayatmalarıyla muhabbet bile ettirmeyen garsonlarla muhatap olmaktansa giderim orta boy filtre kahveme 6.25 veririm arkadaşlarımla rahat rahat muhabbette ederim kafamı da dinlerim bu da bana ucuz gelir.<br/><br/>edit: yazım hatası düzeltildi syd barrett uyarısı ile
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 119
  entry_content: |
    benimdir. ben de babamı 14 yaşında kaybettim ama bu doğum günü meselesinin onunla ne ilgisi var onu anlayamadım.
- entry_name: |
...
- entry_name: |
    trafik cezasından ihbarcıya komisyon vermek
  entry_id:  72675111
  entry_writer: koca nickli zenci
  entry_fav_count: 114
  entry_content: |
    trafik terörünün ve trafikte ki magandaların azalmasına katkı sağlayabilecek uygulama. dünya da uygulaması var mıdır?, uygulanabilirliği nasıl olur, uzmanlarının bileceği iş. trafik ihbar hattı gibi bir hatta trafikteki başka sürücülerin yollayacağı, kesin kanıtlı ihlallere ceza kesilsin. bunu fahri trafik polisleri de yapabilir. karşılığında kesilen cezadan %10, %20 pay alsınlar. <br/><br/>artık çoğu araçta yol kamerası var. seyir halinde iken önde ki araç sinyalsiz sollama mı yaptı, kırmızı ışıkta mı geçti, motorcu önüne mi kırdı, araç motorumu sıkıştırdı, şerit ihlali mi yapıldı, hatalı park mı gördün, görüntünün ihlal kısmını yolla trafik ihbar hattına, maganda cezayı yesin, yollayan kişi de kesilen cezadan komisyonunu alsın. o zaman trafik nasıl düzene girer görürüz.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 95
  entry_content: |
    daha 90larda çocukken dalga geçilen koca popom seneler sonra moda olacak da bir de üzerine zekamın teyiti olacakmış deseler yemin ediyorum çocuk halimle boşa üzülmezdim.<br/><br/>hayat bana güzel lan tralalay. gidin squat kasın kuru götler nıhaha.
- entry_name: |
    28 yaşında evlenme zamanının geldiğini anlamak
  entry_id:  72681307
...
- entry_name: |
    bıçakladığı sürücüden dayak yiyen motorlu
  entry_id:  72676662
  entry_writer: moon shaped pool
  entry_fav_count: 85
  entry_content: |
    bir motosiklet kullanıcısı olarak "ülkede güzel şeyler de oluyor" dememe neden olmuş olaydır. haberin içeriği:<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="http://www.hurriyet.com.tr/sislide-korkunc-anlar-bicakla-saldirdi-dakikalarca-dayak-yedi-40671772" title="http://www.hurriyet.com.tr/sislide-korkunc-anlar-bicakla-saldirdi-dakikalarca-dayak-yedi-40671772">http://www.hurriyet.com.tr/…rca-dayak-yedi-40671772</a><br/><br/>kavganın çıkış sebebine dair herhangi bir görüntü olmadığı için bu hususta yorum yapmak imkansız. ancak, kavga süreci için denilebilecek tek şey, otomobil sürücüsünün eline, dövmesine izin veren halkın da inisiyatifine sağlık. sen elinde bıçakla karşı tarafa saldırırsan adam senin ağzını yüzünü de kırar, amına da koyar. millet de böyle etraflıca dayağını ye diye ayırmaya çalışanlara engel olur.<br/><br/>iyice hayvana bağlayan, doğru düzgün motosiklet kullananları da zan altında bırakan bu heriflerden iyice gına geldi. madem bu herifleri engelleyebilecek bir adalet sistemi mevcut değil, o zaman en temizi bu yöntem.<br/><br/>emaneti eline alınca götü kalkan tüm şahıslara ibret olmasını diliyorum.
- entry_name: |
    ali palabıyık
  entry_id:  72677677
  ...
  entry_fav_count: 56
  entry_content: |
    yukarıda birisi ünlü q7'nin bileğe basmasını koymuş ve beşiktaş'ın çocuğu diye de ali palabıyık bu pozisyonda sarı kart gösterdi yazmış. caps almıyorum istediği zaman silebilir. maçın hakemi mete kalkavan'dı ve o maçtan sonra tüm basın kartal pençesi hareketi ile mete kalkavan'ı eleştirdi. <br/><br/>ali palabıyık dediğimiz adam ise rvp'nin tüm pisliklerini görmezden gelip maçı katleden bir hakemdi. o da bir türkiye kupası maçıydı.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 41
  entry_content: |
    çocukluğuma götüren olay, anlayamazsınız. mutluluk böyle bir şey.<br/>edit: kesin bilgi, gönüller rahat olsun.<sup class="ab"><a title="(bkz: swh)" href="/?q=swh" data-query="swh">*</a></sup> bu konuda şaka yapılır mı?
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    pozisyonun penaltı olmadığına dair hiçbir mantıklı argüman ileri sürülemeyecek maçtır. nitekim tek dedikleri ezbere "ali palabıyık :(" "penaltı diyen gerizekalıdır. " vs. bursalı oyuncular bile itiraz etmedi zaten, o kadar net penaltı.<br/><br/>vücut çalımı atan soldado'yu, destek bacağına vurarak düşüren bursalı sebebiyle penaltı çalınan maç.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    allah'ın <a class="b" href="/?q=renault+clio">renault clio</a>'sunun en boş <a class="b" href="/?q=joy">joy</a> paketi 67.000 tl, symbol adlı teneke 60.000 tl iken, aynı paketi 57.000 tl'ye alınabilen, rakiplerine göre daha sağlam ve şık bir otomobil. yine giriş paketi için şirket arabası kılıklı <a class="b" href="/?q=ford+fiesta">ford fiesta</a> 73.000 tl çekmektedir.<br/><br/>ha o paraya 2.elde enfes araçlar alınır ve şu 4 modelin hiç biri o paraları hak etmez o ayrı ama sıfır araç fiyatlarını bilmeden götten sallamanın da alemi yok.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 4
  entry_content: |
    harika olay. sakal, cübbe, sarık ve ter kokusu daha mı güzel ey müslümin?
- entry_name: |
    iphone x
  entry_id:  72669729
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    referans ile bir üye kazandıran kişinin çıkarı nedir merak etmekteyim. başlığın altındaki entrylerin abartısız yarısı referanslı link verenlerin boş entryleri ile dolmuş. değiyor mu gerçekten?
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    para kazanmanın sadece diploma ile olacağını sanan yazarları da ortaya çıkarmıştır ayrıca.
- entry_name: |
    aile arasında
  entry_id:  72678865
  ...
  entry_fav_count: 0
  entry_content: |
    ekşici piçlerin en sevdiğim yönlerinden biri insanda hemen her şeye karşı beklenti düşürmeleri. <a class="b" href="/?q=ek%c5%9fi+s%c3%b6zl%c3%bck+hi%c3%a7bir+siki+be%c4%9fenmeme+timi">ekşi sözlük hiçbir siki beğenmeme timi</a>sağ olsun indiriyor beklentiyi ve gerçekle karşılaşınca mutlu oluyorsun. bu film de benim için öyleydi ve yerli filmleri zor beğenen biri olarak gayet keyif aldım. <br/>öncelikle belirtmeliyim; filmdeki <a class="b" href="/?q=doksanlar+pop">doksanlar pop</a> örnekleri efsaneydi. insan arıyor o güzel şarkıları. burhanım altıntopumun yaşlanmaya başlanması üzse de hala fevkaladenin fevkinde performansa sahip <a class="b" href="/?q=engin+g%c3%bcnayd%c4%b1n">engin günaydın</a>. şuh kadın sevmediğimden <a class="b" href="/?q=demet+evgar">demet evgar</a>'a pek ilgi duymazdım ama ne hoş kadınmış ya. oyunculuğu, dansı, kendisi çok iyiydi. ayrıca ağzından kaçırdığı argo espriler ve sonrasında gözlerini belertmesine bayıldım. sonuç olarak, gayet izlenebilesi, eğlenceli bir sinema filmi.
---
