...
- entry_name: |
  ...
  entry_channels: siyaset,haber
- entry_name: |
    4 nisan 2019 akp genel sekreteri açıklaması
  entry_id:  88545223
  entry_writer: scorpioraptor
  entry_fav_count: 211
  entry_content: |
    bu adamlar türk değil !
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
    migrosun bedava dondurma dağıtması
  entry_id:  88544699
  entry_writer: herseyi birakip gitmek istiyorum
  entry_fav_count: 59
  entry_content: |
    dandik bir max karşılığı tüm bilgilerinizi verdiğiniz bir kampanyadır. bedava değil kişisel verilerinizi satıyorsunuz arkadaşlar.
...
- entry_name: |
    4 nisan 2019 ömer çelik'in açıklaması
  entry_id:  88545562
  entry_writer: always good
  entry_fav_count: 30
  entry_content: |
    abd seçimlerinde iktidarın itirazı üzerine sayım yapılmadı yalnız muhalefet partisinin itirazı üzerine sayım yapıldı.<br/><br/>benzer durumda chp ya da başka bir muhalefet partisi olsa sonucun ne olacağını dünya alem biliyor ;)
  entry_channels: siyaset,haber
- entry_name: |
    4 nisan 2019 ysk'nın olağanüstü toplanması
  entry_id:  88545660
  entry_writer: damperli orkid
  entry_fav_count: 27
  entry_content: |
    artık ucunu kaçırdığım konu.<br/><br/>itirazın itirazına yapılan itirazın reddinin kabul edilmesine yapılan itirazı .... oyyy kendimi taşla ezmek istiyorum.
  entry_channels: siyaset,haber
- entry_name: |
    ekşi itiraf
  entry_id:  88511571
...
- entry_name: |
    290 bin vatandaşın oyunun sayılmadığı seçim
  entry_id:  88542975
  entry_writer: kedisini arayan sahip
  entry_fav_count: 17
  entry_content: |
    ironi yapmadıysa tam bir orospu çocuğu beyanıdır.<br/><br/>geçen yerel seçimlerde geçersiz sayılan 400 bin oy için de aynısını yazdınız mı acaba sayın göt?
  entry_channels: 
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 12
  entry_content: |
    top sakal.<br/>eğer yaşınız 70+, tüyleriniz beyaz ve <a class="b" href="/?q=titr">titr</a>iniz prof. falan değilse yapmayın şu lanet şeyi.
  entry_channels: anket,ilişkiler
- entry_name: |
    bir evde huzur olduğunu gösteren detay
  entry_id:  88539335
  entry_writer: kimyamtutmaz
  entry_fav_count: 12
  entry_content: |
    çocukların size gülümseyerek bakması, kaçmaması ürkmemesi. evdeki kedinin ve köpeğin de siz gelince kaçacak delik aramaması. evin babasıyla da annesiyle de normal alçak sesle diyaloglar kurulabilmesi. kimsenin sesini duyurmak için bağırmaması. evdeki çiçeklerin sağlıklı olması, çünkü bitkiler elektrikli, sürekli kavga gürültü yaşanan evlerde solarlar,ölürler.
  entry_channels: anket
- entry_name: |
    eskişehir
  entry_id:  88532140
  entry_writer: shantiyeci
  entry_fav_count: 10
  entry_content: |
    güzelliği sadece maddiyatta arayanların manevi güzelliğinden bihaber oldukları şehir. eskişehir’in medeni ve hoşgörülü insanı hiç bir yerde yoktur, her fikirden insan huzur içinde yaşar. bu huzur ortamı da şehre maddi olarak da yansır. türkiye’ de hiç bir şehirde medeniyet seviyesi eskişehir kadar değildir.
  entry_channels: seyahat
- entry_name: |
    sözlüğe bir keko repliği bırak
  entry_id:  88545692
  entry_writer: ertansahannn
  entry_fav_count: 8
  entry_content: |
    ben seni üzerim kızım.
  entry_channels: anket
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    hele ki uzun ilişkisi yeni bitmiş biriyle ilişki yaşamak, akıllara zarar. <br/><br/>acaba onu düşünüyor mu? onun alışkanlıklarını özlüyor mu? o mesaj atsa ne yapar acaba? ya sürekli aklındaysa da bana söylemiyorsa? gibi bir sürü paranoyakça sorular alır başını gider aklınızda. peki siz mutlu olabilir misiniz bu cevapsız sorularla? hiç sanmıyorum. o yüzden mutlu olmak istiyorsanız uzun süreli ilişkisi bitmiş birinden uzak durun derim...
  entry_channels: ilişkiler
- entry_name: |
    şu anda çalan şarkı
  entry_id:  88510240
  ...
  entry_fav_count: 3
  entry_content: |
    <a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/OT2bxfGC4UA">https://youtu.be/ot2bxfgc4ua</a><br/><br/>scorpions-still loving you
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    böle bi kalıp peynir, biraz zeytin bi de tuvalet kağıdı.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    şu anda her kelimesi yalan olan açıklamalar yapıyor. <br/><br/>hukuk demiyo mu..çıldırıyorum.
  entry_channels: siyaset
- entry_name: |
    küçücük pipisiyle kız peşinde koşan erkek
  entry_id:  88546516
  entry_writer: rikousan
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=rahats%c4%b1z+edici+ba%c5%9fl%c4%b1klar">rahatsız edici başlıklar</a>)
  entry_channels: anket,ilişkiler
---
