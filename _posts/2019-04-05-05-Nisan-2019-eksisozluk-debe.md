...
data:
- entry_name: |
    binali beyin artıya geçmesine çok az kaldı
  entry_id:  88511183
  entry_writer: kalemi kilicindan keskin olan adam
  entry_fav_count: 1345
  entry_content: |
    kendinizce kurmuşsunuz tezgahı; kendiniz çalıp, kendiniz söylüyorsunuz.<br/><br/>(bkz: <a class="b" href="/?q=hayallerde+ya%c5%9f%c4%b1yor+baz%c4%b1+ibneler">hayallerde yaşıyor bazı ibneler</a>)
...
- entry_name: |
  ...
  entry_fav_count: 145
  entry_content: |
    zaten 3 gündür ne yapıyorlar aq
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
    vücut geliştirme
  entry_id:  88509783
  entry_writer: andrew crysanthe
  entry_fav_count: 101
  entry_content: |
    kendinizi karşı cinse beğendirmek için yapmayın denmiş. doğru, malazgirt meydan muharebesine katılmak için yapın.
...
- entry_name: |
    4 nisan 2019 internet problemi
  entry_id:  88529720
  entry_writer: dinazorlar turkmus haci
  entry_fav_count: 91
  entry_content: |
    aklına hemen malum ihtimal gelen bir ben değilimdir umarım. önce kendi internetimde sorun var dedim ama sosyal medya sitelerinde belirgin bir yavaşlama var şu an.
...
- entry_name: |
  ...
  entry_fav_count: 52
  entry_content: |
    'biz burada bir aileyiz' cümlesini duyduğun anda uzaklaş.
  entry_channels: anket,ekonomi
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    fetö projesi olmasın bu reis. bir darbe girişimi olsa halkı havalimanına çağırsan millet gidene kadar darbe bitmiş olur, emin miyiz?
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    bir erkeğe dönüşseniz yapmak isteyeceğiniz ilk şey ne olurdu?
  entry_channels: anket,ilişkiler,ekşi-sözlük
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    zamanında uzun bir ilişkinin sonunda sadece facebook tan uzun bir mesaj ile terkedilip, sonuna da yazma diye belirtildiği için sebebini sormak için bile yazmadım.<br/>normal bir muhabbette yada daha yürüme aşamasındayken mi yazacağım?<br/>doğalı bu öğrenin lütfen.
  entry_channels: ilişkiler
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=s%c4%b1kbo%c4%9faz+etmek">sıkboğaz etmek</a>)
