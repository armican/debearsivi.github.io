...
- entry_name: |
  ...
  entry_fav_count: 92
  entry_content: |
    valla gencler, bir lider benim de babami(yunanlilar), amcami (ingilizler), ve dedemi (araplar) ayni anda itin gotune sokmus olsaydi, ben de o liderden nefret ederdim. dolayisiyla ne yunan asilli ingiliz vatandasi arap yalayicisi bu herifcioglunda ne de bu herifcioglunu destekleyen islamcilarda bir celiski goremiyorum.
...
- entry_name: |
    afganistan'da kendini köpeğe becerten yaratık
  entry_id:  89450809
  entry_writer: faizlbisi
  entry_fav_count: 59
  entry_content: |
    ne gerek var böyle başlıklara..izle geç işte neden oto boka başlık açıyorsunuz.
  entry_channels: haber
- entry_name: |
  ...
  entry_channels: haber
- entry_name: |
    ensest ilişkinin neden yasak olduğunu anlayamamak
  entry_id:  89448371
  entry_writer: lucass
  entry_fav_count: 54
  entry_content: |
    (bkz: <a class="b" href="/?q=eni%c5%9ftenle+sevi%c5%9fip+ne+yapacaks%c4%b1n+o%c4%9flum">eniştenle sevişip ne yapacaksın oğlum</a>)
  entry_channels: ilişkiler
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 49
  entry_content: |
    ---18:35 : üç tane birden bulundu ekşi sözlük. hepinizin gözlerinden öpüyorum. ---<br/><br/>görenler entry girerse iyi olur. <br/><br/>yarın yapılacak kalp ameliyatı için acil b rh + (pozitif) kana ihtiyacımız var.<br/><br/>istanbul - koşuyolu kalp hastanesi <br/><br/>kan vermek isteyen kişilerin bugün gelip test yaptırması ve yarın sabah 8'de kan vermesi gerekiyor. <br/><br/>bulduğumuz kişilerden biri veremedi. yedeklere de ulaşamıyoruz bu yüzden başlık açmak zorunda kaldım.
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    (bkz: <a class="b" href="/?q=fet%c3%b6%27den+sonra+liverpool%27+un+bitmesi">fetö'den sonra liverpool' un bitmesi</a>)<br/><br/>yabanci bir bir takimi "biz gecen hafta cardiff'i deplasmanda yendik ee sonucta riverside takimiyiz aga" seviyesinde desteklemek nedir? yada "premier ligde 20 senedir sampiyon olamadik amuagoyum uzuluyom tarzi yorumlar da fena" oglum sen kayserilisin lan nasil sampiyon olacaksin premier ligde. cok itici coook.<br/><br/>tanim:altinda yozgatli ve kayserili fanatiklerin birbirleriyle loserpool, serrafsiz amergan takimi falan diye kavga ettikleri baslik.
  entry_channels: spor
- entry_name: |
    youtube'daki fantastik roman düğünü
  entry_id:  89448176
