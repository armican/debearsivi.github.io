...
- entry_name: |
  ...
  entry_fav_count: 58
  entry_content: |
    ama nedense kendisi at binmede ve ok atmada değil gemicilikte zirvede olan kişi beyanı.
...
- entry_name: |
  ...
  entry_fav_count: 46
  entry_content: |
    akhisarin 2 oyuncusunun kokeni senol gunesin ninesinin goctugu kuzey kirim hanligindan, akhisardaki brezilyali serginho talisca'nin esi'nin annesinin gorumcesi ile rio'dan akraba. <br/>seleznyov biliyorsunuz ukraynali, tosic sirp, bunlar ayni kiliseye bagli herifler.<br/><br/>bu macin sonu belli beyler boyle ahlaksizlik olmaz.
  entry_channels: spor
- entry_name: |
...
- entry_name: |
    ilkokul kitabında müstehcen ifadeler bulunması
  entry_id:  75983331
  entry_writer: betada don bebegim yok diye uye oldum
  entry_fav_count: 26
  entry_content: |
    halk diliyle eğitim verelim o zaman dedirten yorumlar yapılan bir haber.<br/><br/>ağzımı bozacağım: lan yavşak, oldu o zaman halkımız eşek sikiyor diye okullarda eşek de siktirelim. bazı şeyler alt kültürdür, bazıları ise kültür. kültürünü inkar et denmiyor, ama argonun da dahil olduğu alt kültürünü git sokaktan öğren, ilkokulda değil. yavşak. sinirim geçmedi. yavşak.
...
- entry_name: |
    ekşi sözlük'ün mason locası olması
  entry_id:  75989999
  entry_writer: mr dodo
  entry_fav_count: 3
  entry_content: |
    bu durumda biz de mason oluyoruz.<br/><br/>iyi de, fakir mason mu olur mk?! açız aç!
  entry_channels: 
- entry_name: |
    düşün ki o bunu okuyor
  entry_id:  75964167
  entry_writer: denizdemantaramsikitartar
  entry_fav_count: 3
  entry_content: |
    sevdiğim, insanız ölüyoruz.
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    önemi yokluğunda hissedilen forvet
  entry_channels: spor
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    ötv muafiyeti olan engelli bir sürücü için en fazla 200 bin lira olan arabadır.
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=olmaz+mayk%c4%b1l+bende+de+yok">olmaz maykıl bende de yok</a>)
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    <a class="b" href="/?q=ayhh+%c5%9feker+krizim+tuttu">ayhh şeker krizim tuttu</a> diyen erkektir.
