...
- entry_name: |
  ...
  entry_fav_count: 96
  entry_content: |
    bu adam tam olarak ne lan? 2 sikindirik dizide rol alıp twitter'da tayyip defol twitleriyle fenomen olunca meclise girebiliyor muyuz cidden? meclis bu kadar boktan bi yer mi?<br/><br/>gerçi karşı tarafın vekilleri de o biçim.<br/><br/>hak ettiğimiz kişi başta zaten. boşverelim bence.
...
- entry_name: |
  ...
  entry_channels: siyaset
- entry_name: |
    26 haziran 2018 kemal kılıçdaroğlu'nun istifası
  entry_id:  78510169
  entry_writer: xweser
  entry_fav_count: 18
  entry_content: |
    bok gerçekleşecektir afedersin
  entry_channels: siyaset,haber
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    haklı serzeniştir, fakat maddi gerekçeleri vardır.<br/><br/>halk tv'nin kullandığı kameralar ve altyapısı hd yayın için uygun, son model son sistem değil ama hd yayın yapılabilir. fakat türksat üzerinden kiralanan tp'nin bant genişliği düşüktür (tahminen 1 mbit civarı) bu nedenle sen ne kadar hd kamera ile çekim yapsanda uydudan kiraladığın bant genişliği kadar görüntü uplink edebilirsin.<br/><br/>hd yayın için minimum 5 mbit bir bant genişliği kiralamak gerekiyor, bunun da aylık fiyatı yüksek. yandaşlar saraydan beslendiği için 10 tane hd kanal yapıyorlar onları sarsmıyor. chp kanalı gibi görünen fakat chp'den resmi bir yardım almayan halk tv'nin eldeki imkanları bu kadar maalesef.<br/><br/>edit: youtube yayını da aynı diyenler olmuş. ana yayın sd formata göre yürüdüğünden youtube'a verdikleri yayında türksat'a gönderdikleri çıkıştan veriliyor yada hiç uğraşmadan uydudan dönen yayını veriyorlardır youtube'a.
...
- entry_name: |
  ...
  entry_channels: siyaset,anket,haber
- entry_name: |
    muharrem ince arada bir öylesine miting yapsın
  entry_id:  78511792
  entry_writer: hapsuruktan tayyare
  entry_fav_count: 14
  entry_content: |
    o kadar yoğun geçen 50 günün ardından, hem kendisi hem de dinleyicileri bu yoğun tempoya alışmışken.. ne bileyim, insan hamlar.. <br/><br/>hani uzuuuun bir zaman sonra halı sahada maç yaparsın, ertesi gün yataktan kalkamazsın ya, tam da öyle olur işte.. <br/><br/>o yüzden, şu geçiş sürecinde, en azından iki haftada bir çıkıp konuşsun bir yerlerde kampanyası bu..<br/><br/>kendisine oy vermemiş olanlar bile ister belki..
  entry_channels: siyaset
- entry_name: |
    akp seçmeni
  entry_id:  78470738
  ...
  entry_fav_count: 12
  entry_content: |
    bugün itibariyle; suriyelilerden, euro ve dolar artışından, benzin fiyatlarından, asgari ücret ve hayat pahalılığından, her türden şeye gelecek zamlardan şikayet etme hakkı ortadan kalkmış seçmen kitlesidir.
  entry_channels: siyaset
- entry_name: |
    ekşi itiraf
  entry_id:  78472146
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    iran son dakikalardaki net pozisyonu kacirmamis olsa messiden once elenmis olacakti. <br/>ve balon oldugunu söyleyecek ergenler ortaliga sacilacakti. ayni messi gibi linc edilecekti de allah korudu.<br/><br/>messi'den sonraki en iyi futbolculardan bir tanesi.
  entry_channels: spor
- entry_name: |
    25 haziran 2018 yeni akit'in ekşi sözlük haberi
  entry_id:  78511557
  entry_writer: ay dios mio
  entry_fav_count: 3
  entry_content: |
    yaa öyle mi? çok üzüldük, öyle böyle üzülmedik, acayip üzüldük.<br/><br/>tuvalet kağıdı bile olmayacak gazetenin haberi.
  entry_channels: 
- entry_name: |
