...
- entry_name: |
    4 gün tatil sonrasında çalışmak
  entry_id:  69105444
  entry_writer: gevrekli
  entry_fav_count: 57
  entry_content: |
    çok güzeldir. hele ki dönüş çarşambaya denk geldiğinde. çünkü 3 gün çalışıp yeniden tatil olacaktır.<br/><br/>gençler, şükredelim çalışacak bir işimiz ve çalışabilecek sağlığımız olduğu için.<br/><br/>öptüm, kib. bye.
- entry_name: |
    canan karatay
  entry_id:  69100011
...
- entry_name: |
  ...
  entry_fav_count: 36
  entry_content: |
    (bkz: <a class="b" href="/?q=hayat%c4%b1+gta+tad%c4%b1nda+ya%c5%9famak">hayatı gta tadında yaşamak</a>)
- entry_name: |
...
- entry_name: |
    28 haziran 2017 13 günlük bebeğin açlıktan ölmesi
  entry_id:  69119213
  entry_writer: supremeelitefirstclass
  entry_fav_count: 22
  entry_content: |
    kendini doyuracak parası yokken amından <a class="b" href="/?q=k%c3%bcsk%c3%bc">küskü</a> eksik etmezsen böyle günahsız çocukların sonu olur işte. senin gibi ebeveyni sikeyim amına kodumun suriyelisi.<br/><br/>mütemadiyen çocuk yapmak yerine otur efendi efendi bir kendini kurtar önce, sonra pompaya düşersin..<br/><br/>gram beyni olmayan gerizekalı bir aile sebebi ile ölen bebek..
- entry_name: |
    tıbbın çare bulamadığı hastalıklar
  entry_id:  69120602
  entry_writer: aynali misket
  entry_fav_count: 21
  entry_content: |
    minik kızımın cebelleştiği lanet hastalık, <a class="b" href="/?q=krabbe+hastal%c4%b1%c4%9f%c4%b1">krabbe hastalığı</a>. çok nadir görülen, nörodejeneratif metabolik bir hastalık. her şeye rağmen umut ayakta. o mucize gelecek. diren kuzum.
- entry_name: |
...
- entry_name: |
    türkiye'de tacize uğramayan bayan olmaması
  entry_id:  69114944
  entry_writer: birgunolursun
  entry_fav_count: 14
  entry_content: |
    (bkz: <a class="b" href="/?q=bayan+de%c4%9fil+kad%c4%b1n">bayan değil kadın</a>)
- entry_name: |
    bıçak parası doktorun hakkıdır
  entry_id:  69120613
  entry_writer: brian fantana
  entry_fav_count: 14
  entry_content: |
    hastaları ve hasta yakınlarını en zayıf ve çaresiz anında söğüşlemeye çalışan durumu da savunan var ya yazık diyorum.
- entry_name: |
    ekşi itiraf
  entry_id:  69103669
...
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    maaşı yüksek denilerek gönderilmeye çalışılan sneijder'den taş çatlasa 500bin euro az kazanan ama ne hikmetse yıllık 12 trilyon kazanması kimseyi rahatsız etmeyen top tepici. ben sneijder olsam bunun aldığının 3 kat fazlasını isterdim.
- entry_name: |
    deep web'te bulunan türkiye'nin en anlamsız karesi
  entry_id:  69119696
  entry_writer: seovi
  entry_fav_count: 7
  entry_content: |
    gerçekten birbiriyle bağlantısız bu kadar şeyi nasıl bir hikaye bir araya getirmiş olabilir ki diye merak ediyor insan. <br/><br/>maskeli balo?<br/><br/>dur en iyi tahminimi yapıyorum;<br/><br/>kırşehir belediye tiyatrosunda, aynı gün türk tarihi ile ilgili ve ii. dünya savaşı ile ilgili bir oyun vardır. oyuncular kendi arasında eğleniyordur.
- entry_name: |
...
- entry_name: |
    ii abdulhamid'in 250 milyon dolarlık mirası
  entry_id:  69118528
  entry_writer: kozmikrastlanti
  entry_fav_count: 6
  entry_content: |
    yazık la ola ola 250 milyon dolarmıymış mirası. şimdi ki takipçileri kaç katını zor sıfırladı.
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    sen gideli üç koca ay oldu. sensiz ilk bayramımızı yaşarken hiç kimsenin yokluğuna alıştığı yok. herkes gözlerinde yaşlarla senden bahsediyor. her an bir yerden çıkacak ve ne yaptınız diye soracaksın diye bekliyoruz sanki...<br/><br/>kuzenlerin çocukları büyüyor, görsen peşlerinden ayrılmazsın. senin sevdiğin gibi sevmeye çalışıyorum. senin gibi olmak ne mümkün... <br/><br/>bayram tatlısı yapmadık. kimse de gelmedi zaten eve. biz de evde durmadık. herkes seni bir ziyaret etti ama. herkes çiçeğinden bahsetti. tomurcuğa durmuş. evdeki çiçeklerini soruyorlar bana. duruyor hepsi, sapa sağlam. kuruyan menekşelerinin yerine yenilerini diktim ama ancak iki tane tuttu. sen diksen hepsi tutardı...<br/><br/>bir bahar geçti sen gideli ve artık yaz geldi. bundan sonra kalan zamanımın sensiz geçeceğine hâlâ inanamıyorum. olmayışına inanmıyorum.
- entry_name: |
    söz'de karar'da milletindir
  entry_id:  69110490
  entry_writer: sammy van rijn
  entry_fav_count: 5
  entry_content: |
    türkçe de milletindir. keşke daha güzel kullanabilsek dediğim yazıdır.
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    aromasını evde asla yakalayamayacağınız, katrandan hallice ilginç içecek.
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    genelde vücudu güzel olup yüzü güzel olmayanlar ve <br/>yüzü güzel olup vücudu kilolu olanlarda sıkça<br/>rastlanan durumdur. ilgisel ya da özgüvensel olabilir.
- entry_name: |
...
- entry_name: |
    ayda 21 defa boşalan erkek
  entry_id:  69119200
  entry_writer: heil titsler
  entry_fav_count: 2
  entry_content: |
    ben hep 50 defa boşaldığım için beni ilgilendirmeyen haberdir.
- entry_name: |
    28 haziran 2017 portekiz şili maçı
  entry_id:  69121573
  entry_writer: kizlar 7 beni
  entry_fav_count: 2
  entry_content: |
    maç kazanamadan avrupa şampiyonu olan takım, penaltı bile atamadan bu sefer elenmiştir. <br/>türk atasözü: çekirge her zaman sıçramaz.
- entry_name: |
...
- entry_name: |
    yaşını söylemek yerine doğum yılını söyleyen kadın
  entry_id:  69120556
  entry_writer: victory90
  entry_fav_count: 0
  entry_content: |
    muhtemelen 25'ini geçmiş olan kadın. ismini vermek istemediğim bir hanımefendi arkadaşım bir ortamda yaş muhabbeti geçtiğinde doğum yılını söylemişti, ben de 27 yaşındasın işte kızım demiştim ve ağzıma sıçmıştı.
- entry_name: |
    şu anda çalan şarkı
  entry_id:  69100620
