...
- entry_name: |
    9 yakınını belediyede müdür yapan belediye başkanı
  entry_id:  67100241
  entry_writer: arma yann tiersen
  entry_fav_count: 236
  entry_content: |
    “başkanlık sistemi için pilot bölge seçilen düzce'de uygulama sorunsuz bir şekilde ilerliyor” <br/><br/>notuyla yarmış haberdir
- entry_name: |
...
- entry_name: |
    gelmiş geçmiş en beyin yakan film
  entry_id:  67092643
  entry_writer: bensinemaseverim
  entry_fav_count: 45
  entry_content: |
    (bkz: <a class="b" href="/?q=memento">memento</a>)
- entry_name: |
    survivor 2017
  entry_id:  67094606
...
- entry_name: |
    ücretsiz belgesel kanalının olmaması
  entry_id:  67106636
  entry_writer: nerede o eski bayramlar
  entry_fav_count: 39
  entry_content: |
    (bkz: <a class="b" href="/?q=trt+belgesel">trt belgesel</a>)
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 23
  entry_content: |
    adam kayırma, mülteci, kadına şiddet vs. bu liste uzar gider.
- entry_name: |
...
- entry_name: |
    burdur'a düşen gizemli uçan cisim
  entry_id:  67113270
  entry_writer: buyuk orta dunya procesi
  entry_fav_count: 18
  entry_content: |
    bir klasik olarak ilk yorumuyla yarmış:<br/><br/>---<br/>sh3llsh3ll<br/>22 temmuz 2015 - 16:00<br/>çok enterasan değişik bir madde ,demir gibi de değil, tahta gibi de değil, yarak gibi<br/>---
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    2 tane oscar'ı vardır.<br/><br/>aynştayn editi: ben de senaryo oscar'ını kastetmiştim zaten. çevir kazı yanmasın, oldu mu?
- entry_name: |
  ...
  entry_fav_count: 17
  entry_content: |
    fesih yetkisi, m.vekillerinin;<br/><br/>-5 yıllığına seçildikleri halkın vekilliğini yapmaktansa, her an kellelerini alabilecek başkana vekillik yapmaya başlamalarına, <br/><br/>sebep olabileceği gerekçesiyle anti demokratiktir.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    55 tl'ye istanbul - dalaman gidiyorum. otobüs 105 tl. <br/><br/>suya sandviçe laf söyleyeni siksinler. yemeğe ekstra para versen bile otobüsten ucuz amk.<br/><br/>ayrıca eski olsada benim için hala çok özel olan birisi burada çalışıyor. buradan kendisini güzel dudaklarından öpüyorum.
- entry_name: |
    isimsizler
  entry_id:  67111656
  entry_writer: good bad ugly
  entry_fav_count: 9
  entry_content: |
    bu tarz dizilerin yapılma amacı öyle sanıldığı gibi propaganda falan değildir. paragöz yapımcılar havayı koklar ve toplumun beklentilerine yönelik işler yaparlar. mantar gibi türeyen romantik komedilerden sonra, şimdi de bu tarz dizilerin yapılması tamamen duygusal. amaç toplumsal bir tutum oluşturmak değil, toplumun tutumunu sömürmektir. propaganda işler için (bkz: <a class="b" href="/?q=trt">trt</a>)<br/><br/>ek: tamamını izlememekle birlikte, stv göndermelerine katıldığım, kanal d dizisi.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    gençler iki fragman + 1 sneak peek ile bütün bölümü vermişler, izlemenize gerek yok anlatıyorum.<br/><br/>-kudret mezardan çıkıyor tabi ki, 2 bölümde ölmek için girmedi uğur yücel.<br/><br/>-intikam olarak mustafa'yı kaçırıyor.<br/><br/>-daha sonra bununla yetinmeyerek yeşim'i arıyor, mustafa karşılığında melek'i ver diyerek anlaşıyor. (sneak peek'teki sarp vurulmuş oyunuyla melek'i yolda yakalatıyor)<br/><br/>-kudret melek'i de yakalayıp mustafa'yı da bırakmıyor ve celal'e birini seç diyor. (ona hayatının en zor seçimini yaptıracağım-1.fragman)<br/><br/>-sarp ve mert de gidip ikisini kurtarmaya çalışacak.<br/><br/>- end of 120 minutes!
- entry_name: |
...
- entry_name: |
    27 mart 2017 istanbul'da gezen helikopter
  entry_id:  67104946
  entry_writer: hatip ha tip
  entry_fav_count: 6
  entry_content: |
    sebebi türkiye 15 temmuz şehitleri ve imam hatip galaksi lideri cumhurbaşkomutan gazi mareşal hz anam babam tayyip erdoğan'ın şehre şeref vermesidir
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    "milliyetçilik osuruk gibidir, herkes kendisininkinin daha güzel koktuğunu düşünür."<br/>(bkz: <a class="b" href="/?q=bernard+shaw">bernard shaw</a>)
- entry_name: |
    ekşi itiraf
  entry_id:  67096389
...
- entry_name: |
    trabzonspor'un fifa'dan sonra pes'e başvurması
  entry_id:  67112823
  entry_writer: semsi pasa pasasinda sesi buzuseciciler
  entry_fav_count: 1
  entry_content: |
    trabzonspor'un fifa'dan da istediğini alamayınca pes'e başvuracak olması hadisesi.<br/><br/>(bkz: <a class="b" href="/?q=pes">pes</a>)<br/><br/>sonuçta trabzonspor'un parasını iç etmek için, hukuk fakültesinin önünden geçmeden "hukukçu" etiketiyle ortalarda dolaşan çakallar olduğu sürece bu işin nasa'ya kadar yolu var.<br/><br/>elon mask mars'a koloni kurarsa 2217'de de mars koloniler birliği başkanlığı'na da başvururlar.<br/><br/>trabzonspor taraftarı, akpli zihniyetiyle bunların yalanlarını gerçekmiş gibi düşünüp, her seferinde hayal kırıklıklarını yeni bir başvuruyla resetliyorken, enseye vuran çok olur. <br/><br/>haydi hayırlı tıraşlar.
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    kanunda mal olarak geçen bi canlı için adaleti yasalardan beklemek bence de saçma... bu ülkeyi bu yüzden çok seviyorum (!).<br/><br/>ancak, <br/>bu kadının sokakta yürüyemeyecek kadar psikolojik baskı hissetmesi,<br/>pes edip kamuoyu önünde muro'dan, onun sahiplerinden ve hepimizden özür dilemesi, ve bir daha asla nefes alan bir tek canlıya bile böyle bir şey yapmayacağını belirtmesi bile bi adalettir.<br/><br/>acılar içinde yaşa pislik yaratık. acılar içinde yaşa ve acılar içinde geber.
- entry_name: |
...
- entry_name: |
    ekşi sözlük referandum kampanyası
  entry_id:  67112475
  entry_writer: dedi ne haber dedim umut verme
  entry_fav_count: 0
  entry_content: |
    aktrolleri korkutmuş kampanya. <br/><br/>bence fikir de metnin dili de güzel. desteklenmeli.
- entry_name: |
...
- entry_name: |
    abdurrahman dilipak'ın 26 mart 2017 tarihli yazısı
  entry_id:  67113855
  entry_writer: savaras
  entry_fav_count: 0
  entry_content: |
    o değil de chp niye dağılıyo bey amca. senin beyin iyice sulanmış.
---
