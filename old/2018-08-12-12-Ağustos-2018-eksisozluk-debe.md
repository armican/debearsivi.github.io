...
- entry_name: |
    sadece içki içenlerin geçinemediği gerçeği
  entry_id:  80160505
  entry_writer: siradan biri one
  entry_fav_count: 13
  entry_content: |
    aranan ekonomi bakanı ekşideymiş.
  entry_channels: 
- entry_name: |
...
- entry_name: |
    türkiye'nin yeni para birimi
  entry_id:  80163988
  entry_writer: tekkullanimlikhesap
  entry_fav_count: 4
  entry_content: |
    problemin para biriminin adında olduğunu zannedenlerin aklına gelen cin fikre konu olan para birimidir. ülkenin adını da almanya yaparsak dünya endüstri devi olabiliriz mesela aynı mantıkla. almanlar ses çıkarırsa burası öz hakiki almanya der sıyrılırız işin içinden.
  entry_channels: 
- entry_name: |
...
- entry_name: |
    ankara'da olan ankara'da kalır
  entry_id:  80146029
  entry_writer: savata
  entry_fav_count: 2
  entry_content: |
    <a class="b" href="/?q=kurcala">kurcala</a> ekibinin çekeceği olası sinema filminin adı.<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://youtu.be/qMca9tIdspA" title="https://youtu.be/qMca9tIdspA">hangover'a çok benziyor</a>
...
- entry_name: |
  ...
  entry_fav_count: 1
  entry_content: |
    oldukça iyi maç yönetiyor, gördüğünü çalmaya çalışıyor, ne seyirci etkisi altında, ne eyyam derdinde. tabi ki arada hata yapacaktır ama kendinden emin, bu başarısını sürdürürse yakında şampiyonlar liginde izleriz.
  entry_channels: spor
- entry_name: |
    reis döneminde yaşanan değişiklik
  entry_id:  80163196
  entry_writer: quee
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=dolarin+kuru+birakip+pornoya+donmesi">dolarin kuru birakip pornoya donmesi</a>)
  entry_channels: 
- entry_name: |
    reha kapsal
  entry_id:  80161791
