...
- entry_name: |
  ...
  entry_id:  69533538
  entry_writer: there me goes
  entry_fav_count: 26
  entry_content: |
    buz gibi gerçektir. <br/><br/>akp oy malzemesi olarak kullanabildiği kadar kullanacaktır tabi.<br/><br/>2 tane tankla, havada efekt yapan birkaç f16 ile ve yalanlarla kışla dışına çıkarılan askerlerle darbe yapılması sonucu yüzlerce insan boşuna ölmüştür.<br/><br/>fıkra gibi gelmiyor mu kulağa?
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 13
  entry_content: |
    adamın chpli olduğunu anlamak zor değilmiş. lan adamın soyadı altıoklar. afsfsgs.
- entry_name: |
    çağın hastalığı
  entry_id:  69535917
...
- entry_name: |
  ...
  entry_fav_count: 6
  entry_content: |
    yaz aksamlari uyuyacak serinligi saglamasi. uyunmayan nem, sicak da gordu bu bunye.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 3
  entry_content: |
    bak bu metin hara kişisi şöyle bir şey. kitaplarında okuyucuya ruh parçam diyecek kadar ılık, nefes alma tekniklerini öğretirken burnumuzdan nefes almamızın önemini "mesela hamburgeri nerenizle yiyorsunuz? ağzınızla değil mi? işte nefesi de burnunuzu kullanarak alacaksınız" diye çocukça örnekler verecek kadar abuk birisi. kişisel gelişimci denen insanın sesi insanı harekete geçirmeli, anlattıkları feyz vermeli, dimağı açmalı. ama bunun youtube'da yanılıp yıkılıp da bi videosuna filan denk gelirseniz, hayattan soğursunuz. bırak kendine gelmeyi kendinizden tiksinirsiniz, o kadar kötü. <br/>ha, adriana lima bu tiplerden hoşlanıyordur, o ayrı, bu herif kendi çabasıyla adriana'yı tavlamıştır, o da ayrı, bizi ilgilendirmez. ama bu adam yazar değil. adriana lima'nın yazar sevgilisi olarak sunmayın bu beceriksiz şeyi insanın önüne. sadece adriana lima'nın sevgilisi diye sunun da biz erkek tarafı olarak, "la bu tipsiz nasıl tavladı bunu, vay uyanık.." diyelim, diğerleri de kız tarafı olarak, "ayy bu mu adriş'in yeni flörtü, ay kıçım, nerden bulmuş bunu..." filan derler belki.
- entry_name: |
    yirmi birinci yüzyılda hala içki içmek
  entry_id:  69542171
  entry_writer: jason mason
  entry_fav_count: 2
  entry_content: |
    8000 yıldır bilimin pek de gelişmediğinin göstergesi. 2017'ye geldik hala birazcık keyif versin diye sürüyle zararı olan maddeyi kullanıyoruz. yuh bize !
- entry_name: |
...
- entry_name: |
  ...
  entry_id:  69522968
  entry_writer: maviadam
  entry_fav_count: 1
  entry_content: |
    yapan bir çocuk değil ise; yapanın, onaylayıp buna para verenin sanat adına allah belasını versin dedirten korkuşlu, tanımlanamayan cisim.
- entry_name: |
    jodie whittaker
  entry_id:  69538382
  ...
  entry_fav_count: 0
  entry_content: |
    <a class="b" href="/?q=doctor+who">doctor who</a>'nun yeni sezonunu az evvel bitirdim ve sözlüğü açınca kendisi karşıladı beni. yeni doktorun kadın olmasıyla ilgili bir derdim yok. dilerim ki başarılı olsun.
- entry_name: |
    eljif elmas
  entry_id:  69542824
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    internette tanışılan kişilerle ister istemez yaşanan bir durum. kimiyle 1 ay, kimiyle 1 hafta, kimiyle 1 saat bilim, kültür sanat, politika, spor gibi konuları içeren entelektüel sohbetler et, yine de bir şekilde konu <a class="b" href="/?q=seks">seks</a>e gelsin... öyle bir şey ben yaşamadım ama bazı çakal sözlük erkekleri bu işte uzman olabilir. bana öyle geliyor.
---
