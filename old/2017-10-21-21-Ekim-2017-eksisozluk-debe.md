...
- entry_name: |
    finalde 5-1 vs ligde 6-0
  entry_id:  71517976
  entry_writer: zibonaj
  entry_fav_count: 13
  entry_content: |
    galatasaraylıyım ve şu 6-0'a karşı kullanılan 5-1'den her zaman tiksindim. tam bir ezik kafa tatmini. oradaki en önemli ayrıntı "sıfır"dır. 7-1 bile denk gelmez. adamlar gol yemeden 6 gol atmış lan, ne kasıyorsun? sakin, fanatikleşmeye gerek yok.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 5
  entry_content: |
    abartılmış biri. sırtında çocuğuyla tarlada çalışan kadınları unutan ne çok insan varmış. avukat hanım'ın çocuğu dışarda babasıylaymış. sonra annesini istemiş. anne de çocuğu içeri almış. benim böyle öğretmenlerim oldu. sınıfa bebekleriyle girdiler. kıyamet kopartılacak bir durum yok yani.
- entry_name: |
...
- entry_name: |
    kışın gelen yalnızlık hissi
  entry_id:  71524723
  entry_writer: bebilotto
  entry_fav_count: 0
  entry_content: |
    yazın eğlence, bar, karı kız, dımtıs dımtıs ve bilumum sefahatlerinden mütevelli kullanmadığımız beynimizin bize kalması ve düşünmeye gark olması olayıdır; ayıkmaya başlayan geceden kalmalar gibi. <br/><br/>ha bir de bence gecelerinin uzun olmasından. <br/><br/>ha bir de, kışın herşey ölerekten ölüm gerçeğini vurmasındandır tesbih gibi yüzümüze <sup class="ab"><a title="(bkz: takır takır)" href="/?q=tak%c4%b1r+tak%c4%b1r" data-query="takır takır">*</a></sup>.
- entry_name: |
    göztepe
  entry_id:  71522890
