...
- entry_name: |
  ...
  entry_fav_count: 130
  entry_content: |
    hayatimin fon sesidir. ınsanda raki icme hissi uyandirir. huzur verir, eski turkiyedir. yaza merhabadir.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 80
  entry_content: |
    tanımadığı birine "kanka"diyen eleman. lan pezevenk zaten sevmediğim bir laf, bir de beni tanıyormuş gibi, sinirlendim bak.<br/>edit: imla
- entry_name: |
...
- entry_name: |
    rusya'nın çıkaracağı yapay meksika krizi
  entry_id:  75493304
  entry_writer: umberto d
  entry_fav_count: 28
  entry_content: |
    (bkz: <a class="b" href="/?q=ba%c5%9fl%c4%b1k+a%c3%a7ay%c4%b1m+derken+%c3%a7%c4%b1%c4%9f%c4%b1r+a%c3%a7mak">başlık açayım derken çığır açmak</a>)<br/><br/>tam da bu işte.<br/><br/>edit: başlığın ilk hâlinde anlamsız söz öbeklerinin ortasında noktalardan müteşekkil bir ova vardı.
- entry_name: |
    getcontact
  entry_id:  75466639
...
- entry_name: |
  ...
  entry_fav_count: 16
  entry_content: |
    4 yıl boyunca bi telefonu sıkıntısız, kasmadan kullanabilmek.
- entry_name: |
...
- entry_name: |
  ...
  entry_fav_count: 11
  entry_content: |
    diziyi kısa bir süre içerisinde izleyince akıllarda ronaldinho kalıyor.hay sizin reklamınızın...<br/><br/>(bkz: <a class="b" href="/?q=ronaldinho+ronaldinho+ronaldinho">ronaldinho ronaldinho ronaldinho</a>)
- entry_name: |
...
- entry_name: |
    sevişmek için yoldan alınan kızın akraba çıkması
  entry_id:  75494309
  entry_writer: themammi
  entry_fav_count: 9
  entry_content: |
    (bkz: <a class="b" href="/?q=at+yalan%c4%b1">at yalanı</a>)
- entry_name: |
  ...
  entry_fav_count: 7
  entry_content: |
    (bkz: <a class="b" href="/?q=metro+turizm%27in+pizza+i%c5%9fine+girmesi">metro turizm'in pizza işine girmesi</a>)
- entry_name: |
    spor spikerlerinin unutulmaz sözleri
  entry_id:  75495612
  entry_writer: taksi kime
  entry_fav_count: 5
  entry_content: |
    (bkz: <a class="b" href="/?q=heryerinden+%c3%b6p%c3%bcyorum+r%c3%bc%c5%9ft%c3%bc">heryerinden öpüyorum rüştü</a>)
- entry_name: |
    kendinizi tanıtın denince evliyim diyen kadın
  entry_id:  75492584
  entry_writer: realjaew
  entry_fav_count: 1
  entry_content: |
    valla eksisozlukte kadin oldugunuzu belli eden bir entri girdiginizde gelen onlarca<br/>mesaj uzerine edit olarak evliyim yazmama sebep olanlar utansin.
- entry_name: |
    erdoğan'ın 2019 seçimini kaybetmeyeceğini düşünmek
  entry_id:  75495072
  entry_writer: unfug
  entry_fav_count: 1
  entry_content: |
    2019 seçimini kaybetmenin en büyük nedeni olan düşünce. bu süreçte en büyük mücadelenin verilmesi gereken kişiler de bu düşünceye sahip olan kişiler olacaktır.<br/><br/>bu düşünce üç sonucu yaratmakta.<br/>1. muhalif olup oy vermeye istekli olmamaya<br/>2. erdoğan şaibeli olarak kazandığında direniş gösterme arzusundan uzaklaşmaya<br/>3. erdoğan’a oy verdiği halde erdoğan’dan bu seçimde vazgeçebilecek potansiyeldeki seçmeni ‘kaybetmeyecek nasıl olsa bari yerimi koruyayım’ hissiyatına sahip olmasına ve dolaysıyla tekrar erdoğan’a oy vermeye.
- entry_name: |
...
- entry_name: |
    adı murat olanların ekseriyetle ayı olması
  entry_id:  75494771
...
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    nevresimi tümüyle ters çevirip kollarınızı içine sokup iki kulaktan tutarak yorganın iki kulağını tutup silkelediğinizde (koltuk vs üstünden daha kolay) nevresimin çoğu yorgan üzerine geçmiş oluyor. yatak üzerine serdikten sonra kalan kısımları çekerek düzeltiyorsunuz.<br/>bu kadar.
- entry_name: |
  ...
  entry_fav_count: 0
  entry_content: |
    "time, there's always time<br/>on my mind<br/>pass me by, i'll be fine<br/>just give me time"<br/><br/><a rel="nofollow noopener" class="url" target="_blank" href="https://www.youtube.com/watch?v=uj21oODGpEU">https://www.youtube.com/watch?v=uj21oodgpeu</a><br/><br/>durduk yerde değil ama<br/><br/>(bkz: <a class="b" href="/?q=durduk+yerde+adam%c4%b1n+am%c4%b1na+koyan+%c5%9fark%c4%b1lar">durduk yerde adamın amına koyan şarkılar</a>)
- entry_name: |
    serkan reçber
  entry_id:  75494545
  ...
  entry_fav_count: 0
  entry_content: |
    <a class="b" href="/?q=%c5%9fenol+g%c3%bcne%c5%9f">şenol güneş</a>'le iyi bir ikili olamaz. şenol hoca 3 senedir bizde hala tanıyamadınız mı hocamızı? <a class="b" href="/?q=%c5%9fenol+g%c3%bcne%c5%9f">şenol güneş</a>, 2014 yazında <a class="b" href="/?q=bursaspor">bursaspor</a>'la anlaşmadan önce, bursaspor sportif direktörlük görevi için <a class="b" href="/?q=serkan+re%c3%a7ber">serkan reçber</a> ile anlaşmış, ancak şenol güneş teknik direktör olduktan sonra sportif direktörlük diye bir şey istemediğini belirttiği için <a class="b" href="/?q=bursaspor">bursaspor</a> kendisi ile yolları ayırmıştır. <a class="b" href="/?q=serkan+re%c3%a7ber">serkan reçber</a>, bu durumu trt spor'da bir programda anlatmıştı. hatta " şenol hoca sportif direktör olaylarına pek sıcak bakmaz, çift başlılık olduğunu düşünür, saygı duyarım " tarzı bir şeyler söylemişti. <a class="b" href="/?q=%c5%9fenol+g%c3%bcne%c5%9f">şenol güneş</a> olduğu sürece kendisi olmaz yani. sadece kendisi değil kimse olmaz. bizlerde şenol hoca'dan memnun olduğumuza göre iki ihtimal var; ya şenol hoca ile yollar ayrılacak - bana pek mantıklı gelmiyor- ya da klasik olarak hürriyet'in şenol güneş'le fikret orman'ın arasını nasıl bozarız haberlerinden biri. karar sizin.
- entry_name: |
    ne ne bağlacının hatalı kullanılması
  entry_id:  75478659
  entry_writer: takimin ucuncu kalecisi
  entry_fav_count: 0
  entry_content: |
    (bkz: <a class="b" href="/?q=neither%2c+nor">neither, nor</a>)
- entry_name: |
    herkesle seks yapmanın ilkellik olması
  entry_id:  75493959
  entry_writer: evilinacloset
  entry_fav_count: 0
  entry_content: |
    abi bu 'ahlaklı' guruh neden surekli 'ahlaksız' guruh hakkında atıp tutuyor. <br/><br/>seks benim icin begendigim biriyle guzel bir deneyim yasamak. bunu yapıyorum diye neden ilkel oluyorum ben simdi anasını satayım. bir insanın vucudunun baska biri tarafindan takdir edilmesi, insanin kendi vucudundan keyif almasi ve insanin begendigi birinin vucudundan keyif almasi neden ilkel oluyor ki. <br/><br/>seksin hala sadece ureme araci oldugunu iddaa edenler var. ben gayim gay seks yapiyorum. simdi ben hayatim boyunca seks yapmayacak miyim partnerim hamile kalmayacak diye. hetero olup kısır olsam da mi seks yapmayacaktim. <br/><br/>bir de kendini cok 'ozel' saniyor bunlar. sanki her insan icin dunya uzerinde sadece tek bir insan varmis gibi. sayamayacagim kadar cok kisiyle seks yaptım su hayatta. ve bazıları oyle sekslerdi ki oyle anlar yasadim ki hala aklıma geldikce tebessum yaratıyor bende. <br/><br/>bu kadar 'ahlaklı' olmayin. dunyaya bir kez gelmisiz. tanri yok cehennem yok gunah yok. baskasina zarar vermediginiz surece hayatin keyfini cikararak istediginiz gibi yasayin.
---
